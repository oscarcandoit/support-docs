...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-storage/get-details-of-a-bucket\#client-libraries)

- [JavaScript](https://github.com/supabase/storage-js)
- [Dart](https://github.com/supabase/storage-dart)

### Additional links [\#](https://supabase.com/docs/reference/self-hosting-storage/get-details-of-a-bucket\#additional-links)
