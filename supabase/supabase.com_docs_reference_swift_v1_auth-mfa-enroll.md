---
url: "https://supabase.com/docs/reference/swift/v1/auth-mfa-enroll"
...
Auth
  ...
  - Auth MFA
    ...
    [Auth MFA](https://supabase.com/docs/reference/swift/v1/auth-mfa-api) - [Enroll a factor](https://supabase.com/docs/reference/swift/v1/auth-mfa-enroll)
- [Create a challenge](https://supabase.com/docs/reference/swift/v1/auth-mfa-challenge)
- [Verify a challenge](https://supabase.com/docs/reference/swift/v1/auth-mfa-verify)
- [Create and verify a challenge](https://supabase.com/docs/reference/swift/v1/auth-mfa-challengeandverify)
- [Unenroll a factor](https://supabase.com/docs/reference/swift/v1/auth-mfa-unenroll)
- [Get Authenticator Assurance Level](https://supabase.com/docs/reference/swift/v1/auth-mfa-getauthenticatorassurancelevel)
- * * *
