---
url: "https://supabase.com/docs/reference/python/order"
...
Database
  ...
  - Using modifiers
    ...
    [Using modifiers](https://supabase.com/docs/reference/python/using-modifiers) - [Order the results](https://supabase.com/docs/reference/python/order)
...
### Install with PyPi [\#](https://supabase.com/docs/reference/python/order\#install-with-pypi)
