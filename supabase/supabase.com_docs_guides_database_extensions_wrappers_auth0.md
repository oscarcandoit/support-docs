...
5. [Connecting to Auth0](https://supabase.com/docs/guides/database/extensions/wrappers/auth0)
...
## Preparation [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#preparation)

Before you can query Auth0, you need to enable the Wrappers extension and store your credentials in Postgres.

### Enable Wrappers [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#enable-wrappers)
...
### Enable the Auth0 Wrapper [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#enable-the-auth0-wrapper)
...
create foreign data wrapper auth0_wrapper  handler auth0_fdw_handler  validator auth0_fdw_validator;
```

### Store your credentials (optional) [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#store-your-credentials-optional)
...
-- Save your Auth0 API key in Vault and retrieve the created `key_id`select vault.create_secret(  '<Auth0 API Key or PAT>', -- Auth0 API key or Personal Access Token (PAT)  'auth0',  'Auth0 API key for Wrappers');
```

### Connecting to Auth0 [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#connecting-to-auth0)
...
create server auth0_server  foreign data wrapper auth0_wrapper  options (    url 'https://dev-<tenant-id>.us.auth0.com/api/v2/users',    api_key_id '<key_ID>' -- The Key ID from above.  );
```

### Create a schema [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#create-a-schema)
...
## Entities [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#entities)

The Auth0 Wrapper supports data reads from Auth0 API.

### Users [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#users)
...
#### Operations [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#operations)

| Object | Select | Insert | Update | Delete | Truncate |
| --- | :-: | :-: | :-: | :-: | :-: |
| Users | ✅ | ❌ | ❌ | ❌ | ❌ |

#### Usage [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#usage)
...
create foreign table auth0.my_foreign_table (  name text  -- other fields)server auth0_serveroptions (  object 'users');
```

#### Notes [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#notes)

- Currently only supports the `users` object

## Query Pushdown Support [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#query-pushdown-support)

This FDW doesn't support query pushdown.

## Limitations [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#limitations)
...
## Examples [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#examples)

### Basic Auth0 Users Query [\#](https://supabase.com/docs/guides/database/extensions/wrappers/auth0\#basic-auth0-users-query)
...
create foreign table auth0.auth0_table (  created_at text,  email text,  email_verified bool,  identities jsonb)  server auth0_server  options (    object 'users'  );
```
...
[Edit this page on GitHub](https://github.com/supabase/wrappers/blob/docs_v0.5.6/docs/catalog/auth0.md)
...
[Preparation](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#preparation) [Enable Wrappers](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#enable-wrappers) [Enable the Auth0 Wrapper](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#enable-the-auth0-wrapper) [Store your credentials (optional)](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#store-your-credentials-optional) [Connecting to Auth0](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#connecting-to-auth0) [Create a schema](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#create-a-schema) [Entities](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#entities) [Users](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#users) [Query Pushdown Support](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#query-pushdown-support) [Limitations](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#limitations) [Examples](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#examples) [Basic Auth0 Users Query](https://supabase.com/docs/guides/database/extensions/wrappers/auth0#basic-auth0-users-query)
