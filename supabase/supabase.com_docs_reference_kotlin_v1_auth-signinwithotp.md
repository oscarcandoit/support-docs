---
url: "https://supabase.com/docs/reference/kotlin/v1/auth-signinwithotp"
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v1/auth-signinwithotp\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v1/auth-signinwithotp\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v1/auth-signinwithotp\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v1/auth-signinwithotp\#pkce-authentication-flow)
