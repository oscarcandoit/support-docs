---
url: "https://supabase.com/docs/reference/dart/auth-signinanonymously"
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/auth-signinanonymously\#presence)
