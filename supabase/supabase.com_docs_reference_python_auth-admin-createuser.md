---
url: "https://supabase.com/docs/reference/python/auth-admin-createuser"
...
### Install with PyPi [\#](https://supabase.com/docs/reference/python/auth-admin-createuser\#install-with-pypi)
