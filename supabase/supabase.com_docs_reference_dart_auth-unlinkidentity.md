---
url: "https://supabase.com/docs/reference/dart/auth-unlinkidentity"
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/auth-unlinkidentity\#presence)
