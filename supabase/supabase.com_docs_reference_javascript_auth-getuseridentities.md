---
url: "https://supabase.com/docs/reference/javascript/auth-getuseridentities"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/auth-getuseridentities\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/auth-getuseridentities\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/auth-getuseridentities\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/auth-getuseridentities\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/auth-getuseridentities\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/auth-getuseridentities\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/auth-getuseridentities\#response-types-for-complex-queries)
