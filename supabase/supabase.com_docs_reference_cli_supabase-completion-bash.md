---
url: "https://supabase.com/docs/reference/cli/supabase-completion-bash"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-completion-bash\#additional-links)
