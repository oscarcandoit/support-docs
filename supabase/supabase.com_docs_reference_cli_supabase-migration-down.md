---
url: "https://supabase.com/docs/reference/cli/supabase-migration-down"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-migration-down\#additional-links)
