---
url: "https://supabase.com/docs/reference/javascript/auth-refreshsession"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/auth-refreshsession\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/auth-refreshsession\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/auth-refreshsession\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/auth-refreshsession\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/auth-refreshsession\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/auth-refreshsession\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/auth-refreshsession\#response-types-for-complex-queries)
