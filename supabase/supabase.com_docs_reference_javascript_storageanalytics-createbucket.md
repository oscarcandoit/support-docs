---
url: "https://supabase.com/docs/reference/javascript/storageanalytics-createbucket"
...
Storage
  ...
  - File Buckets
    ...
    [File Buckets](https://supabase.com/docs/reference/javascript/file-buckets) - [Access a storage bucket](https://supabase.com/docs/reference/javascript/storageclient-from)
...
- [Check if file exists](https://supabase.com/docs/reference/javascript/storage-from-exists)
- [Get file metadata](https://supabase.com/docs/reference/javascript/storage-from-info)
- [List files (v2)](https://supabase.com/docs/reference/javascript/storage-from-listv2)
- [Convert file to base64](https://supabase.com/docs/reference/javascript/storage-from-tobase64)

  - Analytics Buckets



    [Analytics Buckets](https://supabase.com/docs/reference/javascript/analytics-buckets) - [Create a new analytics bucket](https://supabase.com/docs/reference/javascript/storageanalytics-createbucket)
- [List analytics buckets](https://supabase.com/docs/reference/javascript/storageanalytics-listbuckets)
- [Delete an analytics bucket](https://supabase.com/docs/reference/javascript/storageanalytics-deletebucket)
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/storageanalytics-createbucket\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/storageanalytics-createbucket\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/storageanalytics-createbucket\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/storageanalytics-createbucket\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/storageanalytics-createbucket\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/storageanalytics-createbucket\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/storageanalytics-createbucket\#response-types-for-complex-queries)
