---
url: "https://supabase.com/docs/reference/dart/auth-linkidentity"
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/auth-linkidentity\#presence)
