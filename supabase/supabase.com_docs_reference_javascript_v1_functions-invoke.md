---
url: "https://supabase.com/docs/reference/javascript/v1/functions-invoke"
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#upgrade-the-client-library)
...
### Auth methods [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#auth-methods)
...
#### Sign in with email and password [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#sign-in-with-email-and-password)
...
#### Sign in with magic link [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#sign-in-with-magic-link)
...
#### Sign in with a third-party provider [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#sign-in-with-a-third-party-provider)
...
#### Sign in with phone [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#sign-in-with-phone)
...
#### Sign in with phone using OTP [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#sign-in-with-phone-using-otp)
...
#### Reset password for email [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#reset-password-for-email)
...
#### Get the user's current session [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#get-the-users-current-session)
...
#### Get the logged-in user [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#get-the-logged-in-user)
...
#### Update user data for a logged-in user [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#update-user-data-for-a-logged-in-user)
...
#### Use a custom `access_token` JWT with Supabase [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#use-a-custom-accesstoken-jwt-with-supabase)
...
### Cookie methods [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#cookie-methods)
...
### Data methods [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#data-methods)
...
#### Insert and return data [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#insert-and-return-data)
...
#### Update and return data [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#update-and-return-data)
...
#### Upsert and return data [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#upsert-and-return-data)
...
#### Delete and return data [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#delete-and-return-data)
...
### Realtime methods [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#realtime-methods)

#### Subscribe [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#subscribe)
...
#### Unsubscribe [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#unsubscribe)
...
### Applying Filters [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#applying-filters)
...
### Chaining [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#chaining)
...
### Conditional Chaining [\#](https://supabase.com/docs/reference/javascript/v1/functions-invoke\#conditional-chaining)
