...
title: "Roles, superuser access and unsupported operations | Supabase Docs"
---
...
5. [Superuser Access and Unsupported Operations](https://supabase.com/docs/guides/database/postgres/roles-superuser)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/database/postgres/roles-superuser.mdx)
