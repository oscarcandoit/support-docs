---
url: "https://supabase.com/docs/reference/self-hosting-auth/sends-an-invite-link-to-the-user"
...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-auth/sends-an-invite-link-to-the-user\#client-libraries)

- [JavaScript](https://github.com/supabase/gotrue-js)
- [Dart](https://github.com/supabase/gotrue-dart)

### Additional links [\#](https://supabase.com/docs/reference/self-hosting-auth/sends-an-invite-link-to-the-user\#additional-links)
