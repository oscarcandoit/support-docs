---
url: "https://supabase.com/docs/reference/dart/v1/not"
...
Database
  ...
  - Using filters
    ...
    [Using filters](https://supabase.com/docs/reference/dart/v1/using-filters) - [Column is equal to a value](https://supabase.com/docs/reference/dart/v1/eq)
- [Column is not equal to a value](https://supabase.com/docs/reference/dart/v1/neq)
- [Column is greater than a value](https://supabase.com/docs/reference/dart/v1/gt)
- [Column is greater than or equal to a value](https://supabase.com/docs/reference/dart/v1/gte)
- [Column is less than a value](https://supabase.com/docs/reference/dart/v1/lt)
- [Column is less than or equal to a value](https://supabase.com/docs/reference/dart/v1/lte)
- [Column matches a pattern](https://supabase.com/docs/reference/dart/v1/like)
- [Column matches a case-insensitive pattern](https://supabase.com/docs/reference/dart/v1/ilike)
- [Column is a value](https://supabase.com/docs/reference/dart/v1/is)
- [Column is in an array](https://supabase.com/docs/reference/dart/v1/in)
- [Column contains every element in a value](https://supabase.com/docs/reference/dart/v1/contains)
- [Contained by value](https://supabase.com/docs/reference/dart/v1/containedby)
- [Greater than a range](https://supabase.com/docs/reference/dart/v1/rangegt)
- [Greater than or equal to a range](https://supabase.com/docs/reference/dart/v1/rangegte)
- [Less than a range](https://supabase.com/docs/reference/dart/v1/rangelt)
- [Less than or equal to a range](https://supabase.com/docs/reference/dart/v1/rangelte)
- [Mutually exclusive to a range](https://supabase.com/docs/reference/dart/v1/rangeadjacent)
- [With a common element](https://supabase.com/docs/reference/dart/v1/overlaps)
- [Match a string](https://supabase.com/docs/reference/dart/v1/textsearch)
- [Match an associated value](https://supabase.com/docs/reference/dart/v1/match)
- [Don't match the filter](https://supabase.com/docs/reference/dart/v1/not)
- [Match at least one filter](https://supabase.com/docs/reference/dart/v1/or)
- [Match the filter](https://supabase.com/docs/reference/dart/v1/filter)
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/v1/not\#install-from-pubdev)
