---
url: "https://supabase.com/docs/reference/kotlin/v2/auth-admin-inviteuserbyemail"
...
Auth
  ...
  - Auth Admin
    ...
    [Auth Admin](https://supabase.com/docs/reference/kotlin/v2/admin-api) - [Retrieve a user](https://supabase.com/docs/reference/kotlin/v2/auth-admin-getuserbyid)
- [List all users](https://supabase.com/docs/reference/kotlin/v2/auth-admin-listusers)
- [Create a user](https://supabase.com/docs/reference/kotlin/v2/auth-admin-createuser)
- [Delete a user](https://supabase.com/docs/reference/kotlin/v2/auth-admin-deleteuser)
- [Send an email invite link](https://supabase.com/docs/reference/kotlin/v2/auth-admin-inviteuserbyemail)
- [Generate an email link](https://supabase.com/docs/reference/kotlin/v2/auth-admin-generatelink)
- [Update a user](https://supabase.com/docs/reference/kotlin/v2/auth-admin-updateuserbyid)
- [List all factors for a user](https://supabase.com/docs/reference/kotlin/v2/auth-admin-mfa-listfactors)
- [Delete a factor for a user](https://supabase.com/docs/reference/kotlin/v2/auth-admin-mfa-deletefactor)
- * * *
...
### Add one or more modules to your project [\#](https://supabase.com/docs/reference/kotlin/v2/auth-admin-inviteuserbyemail\#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required) [\#](https://supabase.com/docs/reference/kotlin/v2/auth-admin-inviteuserbyemail\#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization [\#](https://supabase.com/docs/reference/kotlin/v2/auth-admin-inviteuserbyemail\#serialization)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v2/auth-admin-inviteuserbyemail\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v2/auth-admin-inviteuserbyemail\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v2/auth-admin-inviteuserbyemail\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v2/auth-admin-inviteuserbyemail\#pkce-authentication-flow)
