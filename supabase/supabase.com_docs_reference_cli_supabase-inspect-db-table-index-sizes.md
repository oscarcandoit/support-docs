---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-table-index-sizes"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-table-index-sizes\#additional-links)
