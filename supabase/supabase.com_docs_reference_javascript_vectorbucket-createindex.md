---
url: "https://supabase.com/docs/reference/javascript/vectorbucket-createindex"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/vectorbucket-createindex\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/vectorbucket-createindex\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/vectorbucket-createindex\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/vectorbucket-createindex\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/vectorbucket-createindex\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/vectorbucket-createindex\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/vectorbucket-createindex\#response-types-for-complex-queries)
