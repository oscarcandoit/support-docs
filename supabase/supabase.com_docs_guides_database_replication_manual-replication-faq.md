...
title: "Manual Replication FAQ | Supabase Docs"
---
...
[Setting up](https://supabase.com/docs/guides/database/replication/manual-replication-setup)
[Monitoring](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring)
[FAQ](https://supabase.com/docs/guides/database/replication/manual-replication-faq)
...
3. More
5. [Manual replication](https://supabase.com/docs/guides/database/replication/manual-replication-setup)
7. [FAQ](https://supabase.com/docs/guides/database/replication/manual-replication-faq)
...
## Which connection string should be used? [\#](https://supabase.com/docs/guides/database/replication/manual-replication-faq\#which-connection-string-should-be-used)
...
## The tool in use does not support IPv6 [\#](https://supabase.com/docs/guides/database/replication/manual-replication-faq\#the-tool-in-use-does-not-support-ipv6)

You can enable the [IPv4 add-on](https://supabase.com/docs/guides/platform/ipv4-address) for your project.

## What is XMIN and should it be used? [\#](https://supabase.com/docs/guides/database/replication/manual-replication-faq\#what-is-xmin-and-should-it-be-used)
...
## Can replication be configured in the Dashboard? [\#](https://supabase.com/docs/guides/database/replication/manual-replication-faq\#can-replication-be-configured-in-the-dashboard)
...
## How to configure database settings for replication? [\#](https://supabase.com/docs/guides/database/replication/manual-replication-faq\#how-to-configure-database-settings-for-replication)

Using the Supabase CLI, you can [configure database settings](https://supabase.com/docs/guides/database/custom-postgres-config#cli-configurable-settings) to optimize them for your replication needs. These values can vary depending on your database size and activity.

## What are some important configuration options? [\#](https://supabase.com/docs/guides/database/replication/manual-replication-faq\#what-are-some-important-configuration-options)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/database/replication/manual-replication-faq.mdx)
...
[Which connection string should be used?](https://supabase.com/docs/guides/database/replication/manual-replication-faq#which-connection-string-should-be-used) [The tool in use does not support IPv6](https://supabase.com/docs/guides/database/replication/manual-replication-faq#the-tool-in-use-does-not-support-ipv6) [What is XMIN and should it be used?](https://supabase.com/docs/guides/database/replication/manual-replication-faq#what-is-xmin-and-should-it-be-used) [Can replication be configured in the Dashboard?](https://supabase.com/docs/guides/database/replication/manual-replication-faq#can-replication-be-configured-in-the-dashboard) [How to configure database settings for replication?](https://supabase.com/docs/guides/database/replication/manual-replication-faq#how-to-configure-database-settings-for-replication) [What are some important configuration options?](https://supabase.com/docs/guides/database/replication/manual-replication-faq#what-are-some-important-configuration-options)
