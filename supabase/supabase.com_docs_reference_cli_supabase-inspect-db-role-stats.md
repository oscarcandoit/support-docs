---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-role-stats"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-role-stats\#additional-links)
