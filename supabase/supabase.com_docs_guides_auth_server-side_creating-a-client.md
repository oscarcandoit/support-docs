...
### Write utility functions to create Supabase clients [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client\#write-utility-functions-to-create-supabase-clients)
...
[View source](https://github.com/supabase/supabase/blob/c86ff5bd3adec556edc06ee770d02d5a45314b1c/examples/auth/nextjs/utils/supabase/client.ts)

### Hook up middleware [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client\#hook-up-middleware)
...
[View source](https://github.com/supabase/supabase/blob/c86ff5bd3adec556edc06ee770d02d5a45314b1c/examples/auth/nextjs/middleware.ts)

## Congratulations [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client\#congratulations)
