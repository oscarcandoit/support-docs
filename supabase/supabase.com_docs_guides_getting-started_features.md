...
### ETL replication [\#](https://supabase.com/docs/guides/getting-started/features\#etl-replication)

Automatically replicate your database to external destinations like data warehouses and analytics platforms. [Docs](https://supabase.com/docs/guides/database/replication/etl-replication).
...
Export Supabase logs to 3rd party providers and external tooling. [Docs](https://supabase.com/docs/guides/platform/log-drains).
