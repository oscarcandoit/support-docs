---
url: "https://supabase.com/docs/reference/cli/supabase-migration-fetch"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-migration-fetch\#additional-links)
