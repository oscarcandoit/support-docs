---
url: "https://supabase.com/docs/guides/database/bloat"
title: "Not found"
---
...
[**Database Advisor: Lint 0020\_table\_bloat**](https://supabase.com/docs/guides/database/database-advisors?queryGroups=lint&lint=0020_table_bloat) [**Estimates space allocated to a relation that is full of dead tuples** \\
\\
CLI Reference: supabase inspect db bloat](https://supabase.com/docs/reference/cli/supabase-inspect-db-bloat) [**Understanding PostgreSQL Logging Levels and How They Impact Your Project**](https://github.com/orgs/supabase/discussions/29877) [**Debugging and monitoring** \\
\\
Inspecting your Postgres database for common issues around disk, query performance, index, locks, and more using the terminal.](https://supabase.com/docs/guides/database/inspect) [**Understanding Database and Disk Size** \\
\\
Understanding how database size applies to your subscription.](https://supabase.com/docs/guides/platform/database-size) [**Interpreting Supabase Grafana IO charts**](https://github.com/orgs/supabase/discussions/27003)
