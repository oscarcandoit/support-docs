---
url: "https://supabase.com/docs/reference/javascript/vectorindexapi-deleteindex"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/vectorindexapi-deleteindex\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/vectorindexapi-deleteindex\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/vectorindexapi-deleteindex\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/vectorindexapi-deleteindex\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/vectorindexapi-deleteindex\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/vectorindexapi-deleteindex\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/vectorindexapi-deleteindex\#response-types-for-complex-queries)
