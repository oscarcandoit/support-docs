...
title: "Connecting with Beekeeper Studio | Supabase Docs"
---
...
Download your SSL certificate from the Dashboard's [`Database Settings`](https://supabase.com/dashboard/project/_/database/settings)![SSL](https://supabase.com/docs/img/guides/database/connecting-to-postgres/beekeeper-studio/certificate.png)
