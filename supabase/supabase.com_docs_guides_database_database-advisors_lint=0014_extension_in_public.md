---
url: "https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public"
...
## Using the Advisors [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public\#using-the-advisors)
...
## Available checks [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public\#available-checks)
...
### Rationale [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public\#rationale)
...
### How to Resolve [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public\#how-to-resolve)
...
### Example [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public\#example)
...
[Using the Advisors](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public#using-the-advisors) [Available checks](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public#available-checks) [Rationale](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public#rationale) [How to Resolve](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public#how-to-resolve) [Example](https://supabase.com/docs/guides/database/database-advisors?lint=0014_extension_in_public#example)
