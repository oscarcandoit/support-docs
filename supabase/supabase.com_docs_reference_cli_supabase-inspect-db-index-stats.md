---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-index-stats"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-index-stats\#additional-links)
