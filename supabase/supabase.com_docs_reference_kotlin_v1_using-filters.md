---
url: "https://supabase.com/docs/reference/kotlin/v1/using-filters"
...
Database
  ...
  - Using filters
    ...
    [Using filters](https://supabase.com/docs/reference/kotlin/v1/using-filters) - [Column is equal to a value](https://supabase.com/docs/reference/kotlin/v1/eq)
- [Column is not equal to a value](https://supabase.com/docs/reference/kotlin/v1/neq)
- [Column is greater than a value](https://supabase.com/docs/reference/kotlin/v1/gt)
- [Column is greater than or equal to a value](https://supabase.com/docs/reference/kotlin/v1/gte)
- [Column is less than a value](https://supabase.com/docs/reference/kotlin/v1/lt)
- [Column is less than or equal to a value](https://supabase.com/docs/reference/kotlin/v1/lte)
- [Column matches a pattern](https://supabase.com/docs/reference/kotlin/v1/like)
- [Column matches a case-insensitive pattern](https://supabase.com/docs/reference/kotlin/v1/ilike)
- [Column is a value](https://supabase.com/docs/reference/kotlin/v1/is)
- [Column is in an array](https://supabase.com/docs/reference/kotlin/v1/in)
- [Column contains every element in a value](https://supabase.com/docs/reference/kotlin/v1/contains)
- [Greater than a range](https://supabase.com/docs/reference/kotlin/v1/rangegt)
- [Greater than or equal to a range](https://supabase.com/docs/reference/kotlin/v1/rangegte)
- [Less than a range](https://supabase.com/docs/reference/kotlin/v1/rangelt)
- [Less than or equal to a range](https://supabase.com/docs/reference/kotlin/v1/rangelte)
- [Mutually exclusive to a range](https://supabase.com/docs/reference/kotlin/v1/rangeadjacent)
- [With a common element](https://supabase.com/docs/reference/kotlin/v1/overlaps)
- [Match a string](https://supabase.com/docs/reference/kotlin/v1/textsearch)
- [Don't match the filter](https://supabase.com/docs/reference/kotlin/v1/not)
- [Match at least one filter](https://supabase.com/docs/reference/kotlin/v1/or)
- [Match the filter](https://supabase.com/docs/reference/kotlin/v1/filter)
- * * *
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v1/using-filters\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v1/using-filters\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v1/using-filters\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v1/using-filters\#pkce-authentication-flow)
