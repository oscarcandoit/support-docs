---
url: "https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs"
...
[Auth](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs)
...
## Install [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs\#install)
...
## Set environment variables [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs\#set-environment-variables)
...
## Create a client [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs\#create-a-client)
...
### Write utility functions to create Supabase clients [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs\#write-utility-functions-to-create-supabase-clients)
...
### Hook up middleware [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs\#hook-up-middleware)
...
## Congratulations [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs\#congratulations)
...
## Next steps [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs\#next-steps)
...
[Install](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs#install) [Set environment variables](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs#set-environment-variables) [Create a client](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs#create-a-client) [Write utility functions to create Supabase clients](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs#write-utility-functions-to-create-supabase-clients) [Hook up middleware](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs#hook-up-middleware) [Congratulations](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs#congratulations) [Next steps](https://supabase.com/docs/guides/auth/server-side/creating-a-client?router=pages&queryGroups=framework&framework=nextjs#next-steps)
