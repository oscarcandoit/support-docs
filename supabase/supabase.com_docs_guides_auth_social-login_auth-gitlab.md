...
[Auth](https://supabase.com/docs/guides/auth/social-login/auth-gitlab)
...
7. [Gitlab](https://supabase.com/docs/guides/auth/social-login/auth-gitlab)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/auth/social-login/auth-gitlab.mdx)
