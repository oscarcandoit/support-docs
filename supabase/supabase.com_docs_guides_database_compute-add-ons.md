---
url: "https://supabase.com/docs/guides/database/compute-add-ons"
title: "Not found"
---
...
\\
Choosing the right Compute Add-on for your vector workload.](https://supabase.com/docs/guides/ai/choosing-compute-addon) [**Read Replicas** \\
\\
Deploy read-only databases across multiple regions, for lower latency and better resource management.](https://supabase.com/docs/guides/platform/read-replicas) [**About billing on Supabase**](https://supabase.com/docs/guides/platform/billing-on-supabase) [**Database Backups** \\
\\
Learn about the available backup methods for your Supabase project.](https://supabase.com/docs/guides/platform/backups) [**Billing FAQ** \\
\\
This documentation covers frequently asked questions around subscription plans, payments, invoices and billing in general](https://supabase.com/docs/guides/platform/billing-faq) [**High Disk I/O**](https://github.com/orgs/supabase/discussions/33286)
