---
url: "https://supabase.com/docs/reference/kotlin/v1/storage-from-list"
...
Storage
  ...
  - File Buckets
    ...
    [File Buckets](https://supabase.com/docs/reference/kotlin/v1/file-buckets) - [List all buckets](https://supabase.com/docs/reference/kotlin/v1/storage-listbuckets)
- [Retrieve a bucket](https://supabase.com/docs/reference/kotlin/v1/storage-getbucket)
- [Create a bucket](https://supabase.com/docs/reference/kotlin/v1/storage-createbucket)
- [Empty a bucket](https://supabase.com/docs/reference/kotlin/v1/storage-emptybucket)
- [Update a bucket](https://supabase.com/docs/reference/kotlin/v1/storage-updatebucket)
- [Delete a bucket](https://supabase.com/docs/reference/kotlin/v1/storage-deletebucket)
- [Upload a file](https://supabase.com/docs/reference/kotlin/v1/storage-from-upload)
- [Replace an existing file](https://supabase.com/docs/reference/kotlin/v1/storage-from-update)
- [Move an existing file](https://supabase.com/docs/reference/kotlin/v1/storage-from-move)
- [Copy an existing file](https://supabase.com/docs/reference/kotlin/v1/storage-from-copy)
- [Create a signed URL](https://supabase.com/docs/reference/kotlin/v1/storage-from-createsignedurl)
- [Create signed URLs](https://supabase.com/docs/reference/kotlin/v1/storage-from-createsignedurls)
- [Create signed upload URL](https://supabase.com/docs/reference/kotlin/v1/storage-from-createsigneduploadurl)
- [Upload to a signed URL](https://supabase.com/docs/reference/kotlin/v1/storage-from-uploadtosignedurl)
- [Retrieve public URL](https://supabase.com/docs/reference/kotlin/v1/storage-from-getpublicurl)
- [Download a file](https://supabase.com/docs/reference/kotlin/v1/storage-from-download)
- [Delete files in a bucket](https://supabase.com/docs/reference/kotlin/v1/storage-from-remove)
- [List all files in a bucket](https://supabase.com/docs/reference/kotlin/v1/storage-from-list)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v1/storage-from-list\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v1/storage-from-list\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v1/storage-from-list\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v1/storage-from-list\#pkce-authentication-flow)
