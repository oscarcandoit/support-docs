---
url: "https://supabase.com/docs/guides/storage/vector"
title: "Not found"
---
...
[**Vector Buckets** \\
\\
Store, index, and query vector embeddings at scale with similarity search.](https://supabase.com/docs/guides/storage/vector/introduction) [**Storing Vectors** \\
\\
Insert and update vector embeddings with metadata using the JavaScript SDK or Postgres.](https://supabase.com/docs/guides/storage/vector/storing-vectors) [**Semantic search** \\
\\
Learn how to search by meaning rather than exact keywords.](https://supabase.com/docs/guides/ai/semantic-search) [**Vector Bucket Limits** \\
\\
Understanding capacity, quotas, and billing for vector buckets.](https://supabase.com/docs/guides/storage/vector/limits) [**Creating Vector Buckets** \\
\\
Set up vector buckets and indexes using the dashboard or JavaScript SDK.](https://supabase.com/docs/guides/storage/vector/creating-vector-buckets) [**OrioleDB Overview** \\
\\
A storage extension for PostgreSQL which uses PostgreSQL's pluggable storage system](https://supabase.com/docs/guides/database/orioledb)
