...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/order\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/order\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/order\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/order\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/order\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/order\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/order\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/order\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/order\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/order\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/order\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/order\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/order\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/order\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/order\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/order\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/order\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/order\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/order\#presence)
