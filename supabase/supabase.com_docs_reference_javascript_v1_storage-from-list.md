---
url: "https://supabase.com/docs/reference/javascript/v1/storage-from-list"
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#upgrade-the-client-library)
...
### Auth methods [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#auth-methods)
...
#### Sign in with email and password [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#sign-in-with-email-and-password)
...
#### Sign in with magic link [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#sign-in-with-magic-link)
...
#### Sign in with a third-party provider [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#sign-in-with-a-third-party-provider)
...
#### Sign in with phone [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#sign-in-with-phone)
...
#### Sign in with phone using OTP [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#sign-in-with-phone-using-otp)
...
#### Reset password for email [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#reset-password-for-email)
...
#### Get the user's current session [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#get-the-users-current-session)
...
#### Get the logged-in user [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#get-the-logged-in-user)
...
#### Update user data for a logged-in user [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#update-user-data-for-a-logged-in-user)
...
#### Use a custom `access_token` JWT with Supabase [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#use-a-custom-accesstoken-jwt-with-supabase)
...
### Cookie methods [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#cookie-methods)
...
### Data methods [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#data-methods)
...
#### Insert and return data [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#insert-and-return-data)
...
#### Update and return data [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#update-and-return-data)
...
#### Upsert and return data [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#upsert-and-return-data)
...
#### Delete and return data [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#delete-and-return-data)
...
### Realtime methods [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#realtime-methods)

#### Subscribe [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#subscribe)
...
#### Unsubscribe [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#unsubscribe)
...
### Applying Filters [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#applying-filters)
...
### Chaining [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#chaining)
...
### Conditional Chaining [\#](https://supabase.com/docs/reference/javascript/v1/storage-from-list\#conditional-chaining)
