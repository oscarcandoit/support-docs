---
url: "https://supabase.com/docs/reference/javascript/storage-from-listv2"
title: "Not found"
---
...
[**from.list()** \\
\\
JavaScript Reference: List all files in a bucket](https://supabase.com/docs/reference/javascript/storage-from-list)
