...
title: "PrivateLink | Supabase Docs"
---
...
5. [PrivateLink](https://supabase.com/docs/guides/platform/privatelink)
...
## How PrivateLink works [\#](https://supabase.com/docs/guides/platform/privatelink\#how-privatelink-works)
...
## Requirements [\#](https://supabase.com/docs/guides/platform/privatelink\#requirements)
...
## Getting started [\#](https://supabase.com/docs/guides/platform/privatelink\#getting-started)

#### Step 1: Contact Supabase support [\#](https://supabase.com/docs/guides/platform/privatelink\#step-1-contact-supabase-support)
...
#### Step 2: Accept resource share [\#](https://supabase.com/docs/guides/platform/privatelink\#step-2-accept-resource-share)
...
#### Step 3: Configure security groups [\#](https://supabase.com/docs/guides/platform/privatelink\#step-3-configure-security-groups)
...
#### Step 4: Create connection [\#](https://supabase.com/docs/guides/platform/privatelink\#step-4-create-connection)

In your AWS account, you have two options to establish connectivity:

##### Option A: Create a PrivateLink endpoint

01. Navigate to the VPC console in your AWS account
02. Go to [Endpoints](https://console.aws.amazon.com/vpcconsole/home#Endpoints:) in the left sidebar
03. Click [Create endpoint](https://console.aws.amazon.com/vpcconsole/home#CreateVpcEndpoint:)
04. Give your endpoint a name (e.g. `supabase-privatelink-[project name]`)
05. Under Type, select **Resources**
06. In the **Resource configurations** section select the appropriate resource configuration
    - The resource configuration name will be in the format `[organisation]-[project-ref]-rc`
07. Select your VPC from the dropdown. This should match the VPC you selected for your security group in Step 3
08. Enable the **Enable DNS name** option if you want to use a DNS record instead of the endpoints IP address(es)
09. Choose the appropriate subnets for your network
...
#### Step 5: Test connectivity [\#](https://supabase.com/docs/guides/platform/privatelink\#step-5-test-connectivity)
...
#### Step 6: Update applications [\#](https://supabase.com/docs/guides/platform/privatelink\#step-6-update-applications)
...
# Before (public)postgresql://user:pass@db.[project-ref].supabase.co:5432/postgres# After (private)postgresql://user:pass@your-private-endpoint.vpce.amazonaws.com:5432/postgres
```

#### Step 8: Disable public connectivity (optional) [\#](https://supabase.com/docs/guides/platform/privatelink\#step-8-disable-public-connectivity-optional)
...
## Alpha limitations [\#](https://supabase.com/docs/guides/platform/privatelink\#alpha-limitations)
...
## Compatibility [\#](https://supabase.com/docs/guides/platform/privatelink\#compatibility)
...
## Next steps [\#](https://supabase.com/docs/guides/platform/privatelink\#next-steps)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/platform/privatelink.mdx)
...
[How PrivateLink works](https://supabase.com/docs/guides/platform/privatelink#how-privatelink-works) [Requirements](https://supabase.com/docs/guides/platform/privatelink#requirements) [Getting started](https://supabase.com/docs/guides/platform/privatelink#getting-started) [Alpha limitations](https://supabase.com/docs/guides/platform/privatelink#alpha-limitations) [Compatibility](https://supabase.com/docs/guides/platform/privatelink#compatibility) [Next steps](https://supabase.com/docs/guides/platform/privatelink#next-steps)
