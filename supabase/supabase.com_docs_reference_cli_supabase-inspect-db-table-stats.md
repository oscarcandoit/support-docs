---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-table-stats"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-table-stats\#additional-links)
