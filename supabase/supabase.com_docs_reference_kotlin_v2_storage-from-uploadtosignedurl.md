---
url: "https://supabase.com/docs/reference/kotlin/v2/storage-from-uploadtosignedurl"
...
- [Introduction](https://supabase.com/docs/reference/kotlin/v2/introduction)
- [Installing](https://supabase.com/docs/reference/kotlin/v2/installing)
- [Initializing](https://supabase.com/docs/reference/kotlin/v2/initializing)
- * * *


Database

  - [Fetch data](https://supabase.com/docs/reference/kotlin/v2/select)
  - [Insert data](https://supabase.com/docs/reference/kotlin/v2/insert)
  - [Update data](https://supabase.com/docs/reference/kotlin/v2/update)
  - [Upsert data](https://supabase.com/docs/reference/kotlin/v2/upsert)
  - [Delete data](https://supabase.com/docs/reference/kotlin/v2/delete)
  - [Call a Postgres function](https://supabase.com/docs/reference/kotlin/v2/rpc)
  - Using filters
...
Auth
  ...
  - [Overview](https://supabase.com/docs/reference/kotlin/v2/auth-api)
  - [Create a new user](https://supabase.com/docs/reference/kotlin/v2/auth-signup)
  - [Listen to auth events](https://supabase.com/docs/reference/kotlin/v2/auth-onauthstatechange)
  - [Create an anonymous user](https://supabase.com/docs/reference/kotlin/v2/auth-signinanonymously)
  - [Sign in a user](https://supabase.com/docs/reference/kotlin/v2/auth-signinwithpassword)
  - [Sign in with ID token (native sign-in)](https://supabase.com/docs/reference/kotlin/v2/auth-signinwithidtoken)
  - [Sign in a user through OTP](https://supabase.com/docs/reference/kotlin/v2/auth-signinwithotp)
  - [Sign in a user through OAuth](https://supabase.com/docs/reference/kotlin/v2/auth-signinwithoauth)
  - [Sign in a user through SSO](https://supabase.com/docs/reference/kotlin/v2/auth-signinwithsso)
  - [Sign out a user](https://supabase.com/docs/reference/kotlin/v2/auth-signout)
  - [Send a password reset request](https://supabase.com/docs/reference/kotlin/v2/auth-resetpasswordforemail)
  - [Verify and log in through OTP](https://supabase.com/docs/reference/kotlin/v2/auth-verifyotp)
  - [Retrieve a session](https://supabase.com/docs/reference/kotlin/v2/auth-getsession)
  - [Retrieve a new session](https://supabase.com/docs/reference/kotlin/v2/auth-refreshsession)
  - [Retrieve a user](https://supabase.com/docs/reference/kotlin/v2/auth-getuser)
  - [Update a user](https://supabase.com/docs/reference/kotlin/v2/auth-updateuser)
  - [Retrieve identities linked to a user](https://supabase.com/docs/reference/kotlin/v2/auth-getuseridentities)
  - [Link an identity to a user](https://supabase.com/docs/reference/kotlin/v2/auth-linkidentity)
  - [Unlink an identity from a user](https://supabase.com/docs/reference/kotlin/v2/auth-unlinkidentity)
  - [Send a password reauthentication nonce](https://supabase.com/docs/reference/kotlin/v2/auth-reauthentication)
  - [Resend an OTP](https://supabase.com/docs/reference/kotlin/v2/auth-resend)
  - [Set the session data](https://supabase.com/docs/reference/kotlin/v2/auth-setsession)
  - [Exchange an auth code for a session](https://supabase.com/docs/reference/kotlin/v2/auth-exchangecodeforsession)
  - Auth MFA
...
Edge Functions
  ...
  - [Invokes a Supabase Edge Function.](https://supabase.com/docs/reference/kotlin/v2/functions-invoke)
- * * *


Realtime

  - [Listen to database changes](https://supabase.com/docs/reference/kotlin/v2/stream)
  - [Subscribe to channel](https://supabase.com/docs/reference/kotlin/v2/subscribe)
  - [Unsubscribe from a channel](https://supabase.com/docs/reference/kotlin/v2/removechannel)
  - [Unsubscribe from all channels](https://supabase.com/docs/reference/kotlin/v2/removeallchannels)
  - [Retrieve all channels](https://supabase.com/docs/reference/kotlin/v2/getchannels)
- * * *
...
Storage
  ...
  - File Buckets
    ...
    [File Buckets](https://supabase.com/docs/reference/kotlin/v2/file-buckets) - [List all buckets](https://supabase.com/docs/reference/kotlin/v2/storage-listbuckets)
- [Retrieve a bucket](https://supabase.com/docs/reference/kotlin/v2/storage-getbucket)
- [Create a bucket](https://supabase.com/docs/reference/kotlin/v2/storage-createbucket)
- [Empty a bucket](https://supabase.com/docs/reference/kotlin/v2/storage-emptybucket)
- [Update a bucket](https://supabase.com/docs/reference/kotlin/v2/storage-updatebucket)
- [Delete a bucket](https://supabase.com/docs/reference/kotlin/v2/storage-deletebucket)
- [Upload a file](https://supabase.com/docs/reference/kotlin/v2/storage-from-upload)
- [Replace an existing file](https://supabase.com/docs/reference/kotlin/v2/storage-from-update)
- [Move an existing file](https://supabase.com/docs/reference/kotlin/v2/storage-from-move)
- [Copy an existing file](https://supabase.com/docs/reference/kotlin/v2/storage-from-copy)
- [Create a signed URL](https://supabase.com/docs/reference/kotlin/v2/storage-from-createsignedurl)
- [Create signed URLs](https://supabase.com/docs/reference/kotlin/v2/storage-from-createsignedurls)
- [Create signed upload URL](https://supabase.com/docs/reference/kotlin/v2/storage-from-createsigneduploadurl)
- [Upload to a signed URL](https://supabase.com/docs/reference/kotlin/v2/storage-from-uploadtosignedurl)
- [Retrieve public URL](https://supabase.com/docs/reference/kotlin/v2/storage-from-getpublicurl)
- [Download a file](https://supabase.com/docs/reference/kotlin/v2/storage-from-download)
- [Delete files in a bucket](https://supabase.com/docs/reference/kotlin/v2/storage-from-remove)
- [List all files in a bucket](https://supabase.com/docs/reference/kotlin/v2/storage-from-list)
...
### Add one or more modules to your project [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-uploadtosignedurl\#add-one-or-more-modules-to-your-project)
...
implementation(platform("io.github.jan-tennert.supabase:bom:VERSION"))implementation("io.github.jan-tennert.supabase:postgrest-kt")implementation("io.github.jan-tennert.supabase:gotrue-kt")implementation("io.github.jan-tennert.supabase:realtime-kt")
```

### Add Ktor Client Engine to each of your Kotlin targets (required) [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-uploadtosignedurl\#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-uploadtosignedurl\#serialization)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-uploadtosignedurl\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-uploadtosignedurl\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-uploadtosignedurl\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-uploadtosignedurl\#pkce-authentication-flow)
...
supabase.from("characters").update(    {       Character::name setTo "Harry"       //or       set("name", "Harry")    }) {    filter {        Character::id eq 1        //or        eq("id", 1)    }}
```
...
supabase.from("countries").select(columns = Columns.list("name")) {    filter {        or {            Country::id eq 2            Country::name eq "The Shire"            //or            eq("id", 2)            eq("name", "The Shire")        }    }}
```
...
val toUpsert = Character(id = 2, name = "Leia")val count = supabase.from("characters").upsert(toUpsert) {    select()}.decodeSingle<Character>()
```
...
supabase.from("countries").select {    limit(count = 1)}
```
