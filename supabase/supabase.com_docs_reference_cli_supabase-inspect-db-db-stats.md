---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-db-stats"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-db-stats\#additional-links)
