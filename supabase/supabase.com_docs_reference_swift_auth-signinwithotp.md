---
url: "https://supabase.com/docs/reference/swift/auth-signinwithotp"
...
### Install using Swift Package Manager [\#](https://supabase.com/docs/reference/swift/auth-signinwithotp\#install-using-swift-package-manager)
...
### Handling deep links [\#](https://supabase.com/docs/reference/swift/auth-signinwithotp\#handling-deep-links)

#### UIKit app lifecycle [\#](https://supabase.com/docs/reference/swift/auth-signinwithotp\#uikit-app-lifecycle)
...
#### SwiftUI app lifecycle [\#](https://supabase.com/docs/reference/swift/auth-signinwithotp\#swiftui-app-lifecycle)
