---
url: "https://supabase.com/docs/guides/troubleshooting?errorCodes=templatemailer_template_body_parse_error"
...
templatemailer\_template\_body\_parse\_error
...
- [**Can’t Access Supabase Project When Using Lovable Cloud**](https://supabase.com/docs/guides/troubleshooting/cant-access-supabase-project-lovable-cloud)
...
- [**Errors when creating / updating / deleting users**](https://supabase.com/docs/guides/troubleshooting/dashboard-errors-when-managing-users-N1ls4A) `500 unexpected_failure`, `500 unexpected_failure`, `500 unexpected_failure`, `500 unexpected_failure`, `500 unexpected_failure`, `500 unexpected_failure`, `500 unexpected_failure`,
...
- [**Edge Function deploy failed due to an internal error**](https://supabase.com/docs/guides/troubleshooting/edge-function-fails-deploy) `500`, `500`
...
- [**Edge Function shutdown reasons explained**](https://supabase.com/docs/guides/troubleshooting/edge-function-shutdown-reasons-explained) `546`,
...
- [**Email template not updating**](https://supabase.com/docs/guides/troubleshooting/email-template-not-updating) `templatemailer_template_body_parse_error`
...
- [**Error: Failed to run sql query: Connection terminated due to connection timeout**](https://supabase.com/docs/guides/troubleshooting/failed-to-run-sql-query-connection-terminated-due-to-connection-timeout) `500`
...
- [**High CPU and Slow Queries with \`ERROR: must be a superuser to terminate superuser process\`**](https://supabase.com/docs/guides/troubleshooting/high-cpu-and-slow-queries-with-error-must-be-a-superuser-to-terminate-superuser-process)
...
- [**How to bypass cooldown period**](https://supabase.com/docs/guides/troubleshooting/how-to-bypass-cooldown-period)
...
- [**Identifying Lovable backend: Lovable Cloud or Supabase**](https://supabase.com/docs/guides/troubleshooting/identify-lovable-cloud-or-supabase-backend)
...
- [**PGRST106: "The schema must be one of the following..." error when querying an exposed schema**](https://supabase.com/docs/guides/troubleshooting/pgrst106-the-schema-must-be-one-of-the-following-error-when-querying-an-exposed-schema) `PGRST106`
...
- [**SSO Error: "You do not have permissions to join this organization" or prompts to create new organization**](https://supabase.com/docs/guides/troubleshooting/sso-error-you-do-not-have-permissions-to-join-this-organization-or-prompts-to-create-new-organization)
