...
## Install [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs\#install)
...
## Set environment variables [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs\#set-environment-variables)
...
## Create a client [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs\#create-a-client)
...
### Write utility functions to create Supabase clients [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs\#write-utility-functions-to-create-supabase-clients)
...
[View source](https://github.com/supabase/supabase/blob/77a63e2ee1c53b8f3952b7b0d31aaee92889a951/examples/auth/nextjs/utils/supabase/client.ts)

### Hook up middleware [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs\#hook-up-middleware)
...
[View source](https://github.com/supabase/supabase/blob/77a63e2ee1c53b8f3952b7b0d31aaee92889a951/examples/auth/nextjs/middleware.ts)

## Congratulations [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs\#congratulations)
...
## Next steps [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs\#next-steps)
...
[Install](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs#install) [Set environment variables](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs#set-environment-variables) [Create a client](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs#create-a-client) [Write utility functions to create Supabase clients](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs#write-utility-functions-to-create-supabase-clients) [Hook up middleware](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs#hook-up-middleware) [Congratulations](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs#congratulations) [Next steps](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=nextjs#next-steps)
