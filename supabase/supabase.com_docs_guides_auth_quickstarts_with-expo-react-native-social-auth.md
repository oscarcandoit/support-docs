...
For more information, follow the [Supabase Login with Apple](https://supabase.com/docs/guides/auth/quickstarts/docs/guides/auth/social-login/auth-apple) guide.
