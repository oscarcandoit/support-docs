---
url: "https://supabase.com/docs/reference/javascript/storageanalyticsclient-listbuckets"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/storageanalyticsclient-listbuckets\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/storageanalyticsclient-listbuckets\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/storageanalyticsclient-listbuckets\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/storageanalyticsclient-listbuckets\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/storageanalyticsclient-listbuckets\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/storageanalyticsclient-listbuckets\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/storageanalyticsclient-listbuckets\#response-types-for-complex-queries)
