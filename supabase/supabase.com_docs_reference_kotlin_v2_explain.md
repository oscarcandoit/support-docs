---
url: "https://supabase.com/docs/reference/kotlin/v2/explain"
...
Database
  ...
  - Using modifiers
    ...
    [Using modifiers](https://supabase.com/docs/reference/kotlin/v2/using-modifiers) - [Return data after inserting](https://supabase.com/docs/reference/kotlin/v2/db-modifiers-select)
- [Order the results](https://supabase.com/docs/reference/kotlin/v2/order)
- [Limit the number of rows returned](https://supabase.com/docs/reference/kotlin/v2/limit)
- [Limit the query to a range](https://supabase.com/docs/reference/kotlin/v2/range)
- [Retrieve one row of data](https://supabase.com/docs/reference/kotlin/v2/single)
- [Retrieve as a CSV](https://supabase.com/docs/reference/kotlin/v2/db-csv)
- [Using explain](https://supabase.com/docs/reference/kotlin/v2/explain)
- * * *
...
### Add one or more modules to your project [\#](https://supabase.com/docs/reference/kotlin/v2/explain\#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required) [\#](https://supabase.com/docs/reference/kotlin/v2/explain\#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization [\#](https://supabase.com/docs/reference/kotlin/v2/explain\#serialization)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v2/explain\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v2/explain\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v2/explain\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v2/explain\#pkce-authentication-flow)
