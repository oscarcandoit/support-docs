...
However, it's important to note that certain [differences](https://supabase.com/docs/reference/self-hosting-analytics/fetch-endpoint#differences) may arise due to the platform's infrastructure.
...
### Rotate Encryption Keys Regularly [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-endpoint\#rotate-encryption-keys-regularly)
