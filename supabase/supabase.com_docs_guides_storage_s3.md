---
url: "https://supabase.com/docs/guides/storage/s3"
title: "Not found"
---
...
[**Cyberduck** \\
\\
Integration](https://supabase.com/docs/partners/integrations/cyberduck) [**S3 Compatibility** \\
\\
Learn about the compatibility of Supabase Storage with S3.](https://supabase.com/docs/guides/storage/s3/compatibility) [**Iceberg Catalog**](https://supabase.com/docs/guides/storage/analytics/connecting-to-analytics-bucket) [**File Storage** \\
\\
Use persistent and ephemeral file storage](https://supabase.com/docs/guides/functions/ephemeral-storage) [**Self-Hosting with Docker** \\
\\
Learn how to configure and deploy Supabase with Docker.](https://supabase.com/docs/guides/self-hosting/docker) [**S3 Authentication** \\
\\
Learn about authenticating with Supabase Storage S3.](https://supabase.com/docs/guides/storage/s3/authentication)
