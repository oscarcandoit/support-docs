---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-outliers"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-outliers\#additional-links)
