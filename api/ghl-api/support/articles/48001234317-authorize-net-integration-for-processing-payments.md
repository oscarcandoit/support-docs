---
source: https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments
category: articles
type: article
scraped: 2025-10-28T15:58:14.427Z
title:  Authorize.net  integration for processing payments : LeadConnector 
status_code: 200
---

#  Authorize.net  integration for processing payments : LeadConnector 
...
## Authorize.net integration for processing payments  [Print](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\# "Print this Article")

Modified on: Wed, 1 Mar, 2023 at 9:56 PM
...
```
Until this feature goes live, you will need to enable it in the Labs tab to access it:

```

#### **Covered in this Article**

#### [**Which Payment Processor to use?**](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#Which-Payment-Processor-to-use?)

#### **[Requirements to use Authorize.Net](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#Requirements-to-use-Authorize.Net)**

#### **[How to integrate Authorize.Net as a Payment Gateway?](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#How-to-integrate-Authorize.Net-as-a-Payment-Gateway?)**

#### **[Side Notes for using Authorize.Net](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#Side-Notes-for-using-Authorize.Net)**

#### [**Test cards for Authorize.net integration.**](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#Test-cards-for-Authorize.net-integration.%C2%A0)

#### [**FAQ**](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#FAQ)

#### [Why don't I see Paypal among the default gateway options?](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#Why-don't-I-see-Paypal-among-the-default-gateway-options?)

#### [What will change in the reporting of transactions done with Authorize.net? Where will I be able to keep track of all payments?](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#What-will-change-in-the-reporting-of-transactions-done-with-Authorize.net?-Where-will-I-be-able-to-keep-track-of-all-payments?)

#### [Where will I be able to find the subscriptions created via Authorize.net? I cannot relate to the subscription status defined on the Subscriptions page.](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#Where-will-I-be-able-to-find-the-subscriptions-created-via-Authorize.net?-I-cannot-relate-to-the-subscription-status-defined-on-the-Subscriptions-page.)

#### [How do I Cancel/End a subscription created via Authorize.net? I am not able to do so in the merchant portal.](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#How-do-I-Cancel/End-a-subscription-created-via-Authorize.net?-I-am-not-able-to-do-so-in-the-merchant-portal.)

#### [Will I be able to refund transactions as well within the application itself?](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#Will-I-be-able-to-refund-transactions-as-well-within-the-application-itself?)

#### [I am using FDS filters with Authorize.net to hold transactions for review if the address is not submitted, the card code is not submitted, etc. Is the system compatible with handling those cases?](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#I-am-using-FDS-filters-with-Authorize.net-to-hold-transactions-for-review-if-the-address-is-not-submitted,-the-card-code-is-not-submitted,-etc.-Is-the-system-compatible-with-handling-those-cases?)

#### [When will Authorize.net be available for SaaS and Memberships?](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments\#When-will-Authorize.net-be-available-for-SaaS-and-Memberships?)
...
[How to integrate Authorize.net as a Payment Gateway?](https://www.loom.com/share/48a47926cee941f2b8b9209fca6bb352 "How to integrate Authorize.net as a Payment Gateway?")

0

[Loom](https://www.loom.com/share/48a47926cee941f2b8b9209fca6bb352 "Open video in Loom")
...
As the next step, we are working towards enabling [Authorize.net](https://authorize.net/) integration in the Memberships area this quarter. Please vote on the ideas board for enabling this integration for selling SaaSallowing this integration.
...
![Article views count](https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments/hit)

---

*Scraped from GoHighLevel Support: https://help.leadconnectorhq.com/support/solutions/articles/48001234317-authorize-net-integration-for-processing-payments*  
*Generated on: 2025-10-28T15:58:14.427Z*
