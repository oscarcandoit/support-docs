---
source: https://marketplace.gohighlevel.com/docs/ghl/funnels/funnel/index.html
scraped: 2025-10-11T22:45:45.461Z
title: Create order fulfillment | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/payments/create-order-fulfillment/index.html#__docusaurus_skipToContent_fallback)
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/payments/create-order-fulfillment/index.html\#request "Direct link to Request")
...
**notifyCustomer** booleanrequired

Need to send a notification to customer

Example:`true`

## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/payments/create-order-fulfillment/index.html\#responses "Direct link to Responses")
...
```
name:  [Authorization](https://marketplace.gohighlevel.com/docs/ghl/payments/payments-api#authentication)type: httpscopes: payments/orders.writescheme: bearerbearerFormat: JWTin: headerdescription: Use the Access Token generated with user type as Sub-Account (OR) Private Integration Token of Sub-Account.
```
