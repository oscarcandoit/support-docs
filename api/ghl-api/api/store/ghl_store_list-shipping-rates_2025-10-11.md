---
source: https://marketplace.gohighlevel.com/docs/ghl/store/list-shipping-rates/index.html
category: store
scraped: 2025-10-11T23:15:42.524Z
title: Get Shipping Zone | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/store/get-shipping-zones/index.html#__docusaurus_skipToContent_fallback)

# Get Shipping Zone

```
GET https://services.leadconnectorhq.com/store/shipping-zone/:shippingZoneId
```
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/store/get-shipping-zones/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/store/get-shipping-zones/index.html\#responses "Direct link to Responses")
