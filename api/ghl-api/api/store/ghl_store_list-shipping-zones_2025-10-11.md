---
source: https://marketplace.gohighlevel.com/docs/ghl/store/list-shipping-zones/index.html
category: store
scraped: 2025-10-11T23:15:42.525Z
title: Create/Update Store Settings | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/store/create-store-setting/index.html#__docusaurus_skipToContent_fallback)
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/store/create-store-setting/index.html\#request "Direct link to Request")
...
**emailTemplateId** stringrequired
...
**storeOrderFulfillmentNotification** object
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/store/create-store-setting/index.html\#responses "Direct link to Responses")
