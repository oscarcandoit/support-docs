---
source: https://marketplace.gohighlevel.com/docs/ghl/objects/search-object-records/index.html
category: objects
scraped: 2025-10-11T23:15:11.869Z
title: Create Blog Post | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/blogs/create-blog-post/index.html#__docusaurus_skipToContent_fallback)
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/blogs/create-blog-post/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/blogs/create-blog-post/index.html\#responses "Direct link to Responses")
...
```
name:  [Authorization](https://marketplace.gohighlevel.com/docs/ghl/blogs/blogs-api#authentication)type: httpscopes: blogs/post.writescheme: bearerbearerFormat: JWTin: headerdescription: Use the Access Token generated with user type as Sub-Account (OR) Private Integration Token of Sub-Account.
```
