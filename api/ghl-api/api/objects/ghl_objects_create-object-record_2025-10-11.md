...
category: objects
scraped: 2025-10-11T23:15:11.867Z
title: Create User | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/users/create-user/index.html#__docusaurus_skipToContent_fallback)
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/users/create-user/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/users/create-user/index.html\#responses "Direct link to Responses")
