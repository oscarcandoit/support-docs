...
title: Cancel an scheduled invoice | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/cancel-invoice-schedule/index.html#__docusaurus_skipToContent_fallback)

# Cancel an scheduled invoice

```
POST https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/cancel
```
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/cancel-invoice-schedule/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/cancel-invoice-schedule/index.html\#responses "Direct link to Responses")
