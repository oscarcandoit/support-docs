...
title: Create Invoice from Estimate | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html#__docusaurus_skipToContent_fallback)
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html\#request "Direct link to Request")
...
**markAsInvoiced** booleanrequired
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html\#responses "Direct link to Responses")
...
**frequencySettings** objectrequired
