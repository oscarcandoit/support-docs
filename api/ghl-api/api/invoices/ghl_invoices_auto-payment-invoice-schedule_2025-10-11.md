...
category: invoices
scraped: 2025-10-11T23:12:21.762Z
title: Create Estimate Template | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-estimate-template/index.html#__docusaurus_skipToContent_fallback)

# Create Estimate Template

```
POST https://services.leadconnectorhq.com/invoices/estimate/template
```
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-estimate-template/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-estimate-template/index.html\#responses "Direct link to Responses")
