...
title: Update scheduled recurring invoice | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/update-and-schedule-invoice-schedule/index.html#__docusaurus_skipToContent_fallback)

# Update scheduled recurring invoice

```
POST https://services.leadconnectorhq.com/invoices/schedule/:scheduleId/updateAndSchedule
```
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/update-and-schedule-invoice-schedule/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/update-and-schedule-invoice-schedule/index.html\#responses "Direct link to Responses")
