...
title: Void invoice | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/invoices/void-invoice/index.html#__docusaurus_skipToContent_fallback)

# Void invoice

```
POST https://services.leadconnectorhq.com/invoices/:invoiceId/void
```
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/void-invoice/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/invoices/void-invoice/index.html\#responses "Direct link to Responses")
