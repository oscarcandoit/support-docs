---
source: https://marketplace.gohighlevel.com/docs/ghl/locations/task-search/index.html
scraped: 2025-10-11T22:45:02.426Z
title: Update User | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html#__docusaurus_skipToContent_fallback)
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html\#request "Direct link to Request")
...
OTP to change the email ID of the user
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html\#responses "Direct link to Responses")
