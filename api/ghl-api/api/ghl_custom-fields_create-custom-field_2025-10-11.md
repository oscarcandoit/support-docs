---
source: https://marketplace.gohighlevel.com/docs/ghl/custom-fields/create-custom-field/index.html
scraped: 2025-10-11T22:35:36.428Z
title: Update Custom Field By Id | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/custom-fields/update-custom-field/index.html#__docusaurus_skipToContent_fallback)
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/custom-fields/update-custom-field/index.html\#request "Direct link to Request")
...
Options for the field. Important: Providing options will completely replace the existing options array. You must include all existing options alongside any new options you wish to add. Removal of options is not supported through this update. Applicable only for SINGLE\_OPTIONS, MULTIPLE\_OPTIONS, RADIO, CHECKBOX, TEXTBOX\_LIST types.
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/custom-fields/update-custom-field/index.html\#responses "Direct link to Responses")
