---
source: https://marketplace.gohighlevel.com/docs/webhook/OpportunityUpdate/index.html
category: webhooks
scraped: 2025-10-11T23:13:46.940Z
title: Appointment | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/webhook/AppointmentDelete/index.html#__docusaurus_skipToContent_fallback)

On this page

Called whenever an appointment is deleted

#### Schema [​](https://marketplace.gohighlevel.com/docs/webhook/AppointmentDelete/index.html\#schema "Direct link to Schema")
...
#### Example [​](https://marketplace.gohighlevel.com/docs/webhook/AppointmentDelete/index.html\#example "Direct link to Example")
