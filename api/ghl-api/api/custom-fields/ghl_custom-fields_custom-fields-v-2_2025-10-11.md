...
title: Get Custom Field / Folder By Id | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/custom-fields/get-custom-field-by-id/index.html#__docusaurus_skipToContent_fallback)

# Get Custom Field / Folder By Id

```
GET https://services.leadconnectorhq.com/custom-fields/:id
```
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/custom-fields/get-custom-field-by-id/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/custom-fields/get-custom-field-by-id/index.html\#responses "Direct link to Responses")
