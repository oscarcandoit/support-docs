...
title: Delete Contact from Workflow | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/contacts/delete-contact-from-workflow/index.html#__docusaurus_skipToContent_fallback)
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/contacts/delete-contact-from-workflow/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/contacts/delete-contact-from-workflow/index.html\#responses "Direct link to Responses")
