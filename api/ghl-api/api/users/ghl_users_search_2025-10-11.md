---
source: https://marketplace.gohighlevel.com/docs/ghl/users/search/index.html
category: users
scraped: 2025-10-11T23:15:11.866Z
title: Create Record | HighLevel API
---

[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/objects/create-object-record/index.html#__docusaurus_skipToContent_fallback)
...
## Request [​](https://marketplace.gohighlevel.com/docs/ghl/objects/create-object-record/index.html\#request "Direct link to Request")
...
## Responses [​](https://marketplace.gohighlevel.com/docs/ghl/objects/create-object-record/index.html\#responses "Direct link to Responses")
...
```
name:  [Authorization](https://marketplace.gohighlevel.com/docs/ghl/objects/custom-objects-api#authentication)type: httpscopes: objects/record.writescheme: bearerbearerFormat: JWTin: headerdescription: Use the Access Token generated with user type as Sub-Account (OR) Private Integration Token of Sub-Account.
```
