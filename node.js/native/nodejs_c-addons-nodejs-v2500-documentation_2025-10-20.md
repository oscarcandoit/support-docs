---
source: https://nodejs.org/docs/latest/api/addons.html
scraped_at: 2025-10-20T14:07:37.876Z
title: C++ addons | Node.js v25.0.0 Documentation
description: 
category: native
module: addons
---

[Skip to content](https://nodejs.org/docs/latest/api/addons.html#apicontent)
...
- Node.js v25.0.0
- [Table of contents](https://nodejs.org/docs/latest/api/addons.html#toc-picker)
...
- [Index](https://nodejs.org/docs/latest/api/addons.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/docs/latest/api/addons.html#alt-docs)


01. [24.x](https://nodejs.org/docs/latest-v24.x/api/addons.html)
02. [23.x](https://nodejs.org/docs/latest-v23.x/api/addons.html)
03. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/addons.html)
04. [21.x](https://nodejs.org/docs/latest-v21.x/api/addons.html)
05. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/addons.html)
06. [19.x](https://nodejs.org/docs/latest-v19.x/api/addons.html)
07. [18.x](https://nodejs.org/docs/latest-v18.x/api/addons.html)
08. [17.x](https://nodejs.org/docs/latest-v17.x/api/addons.html)
09. [16.x](https://nodejs.org/docs/latest-v16.x/api/addons.html)
10. [15.x](https://nodejs.org/docs/latest-v15.x/api/addons.html)
11. [14.x](https://nodejs.org/docs/latest-v14.x/api/addons.html)
12. [13.x](https://nodejs.org/docs/latest-v13.x/api/addons.html)
13. [12.x](https://nodejs.org/docs/latest-v12.x/api/addons.html)
14. [11.x](https://nodejs.org/docs/latest-v11.x/api/addons.html)
15. [10.x](https://nodejs.org/docs/latest-v10.x/api/addons.html)
16. [9.x](https://nodejs.org/docs/latest-v9.x/api/addons.html)
17. [8.x](https://nodejs.org/docs/latest-v8.x/api/addons.html)
18. [7.x](https://nodejs.org/docs/latest-v7.x/api/addons.html)
19. [6.x](https://nodejs.org/docs/latest-v6.x/api/addons.html)
20. [5.x](https://nodejs.org/docs/latest-v5.x/api/addons.html)
21. [4.x](https://nodejs.org/docs/latest-v4.x/api/addons.html)
22. [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/addons.html)
23. [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/addons.html)

- [Options](https://nodejs.org/docs/latest/api/addons.html#options-picker)


- [View on single page](https://nodejs.org/docs/latest/api/all.html)
- [View as JSON](https://nodejs.org/docs/latest/api/addons.json)
- [Edit on GitHub](https://github.com/nodejs/node/edit/main/doc/api/addons.md)
...
[`require()`](https://nodejs.org/docs/latest/api/modules.html#requireid) function can load addons as ordinary Node.js modules.
...
Refer to [C/C++ addons with Node-API](https://nodejs.org/docs/latest/api/n-api.html) for more information on
Node-API.
...
[Linking to libraries included with Node.js](https://nodejs.org/docs/latest/api/addons.html#linking-to-libraries-included-with-nodejs) for additional information.
...
In order to support [`Worker`](https://nodejs.org/docs/latest/api/worker_threads.html#class-worker) threads, addons need to clean up any resources
...
[`require()`](https://nodejs.org/docs/latest/api/modules.html#requireid) to the built `addon.node` module:
...
to `.dll` or `.so`). The [`require()`](https://nodejs.org/docs/latest/api/modules.html#requireid) function is written to look for
files with the `.node` file extension and initialize those as dynamically-linked
libraries.

When calling [`require()`](https://nodejs.org/docs/latest/api/modules.html#requireid), the `.node` extension can usually be
omitted and Node.js will still find and initialize the addon. One caveat,
however, is that Node.js will first attempt to locate and load modules or
JavaScript files that happen to share the same base name. For instance, if
there is a file `addon.js` in the same directory as the binary `addon.node`,
then [`require('addon')`](https://nodejs.org/docs/latest/api/modules.html#requireid) will give precedence to the `addon.js` file
and load it instead.
...
or [Native Abstractions for Node.js](https://github.com/nodejs/nan) APIs, the functions available
in the Node-API are used.

Creating and maintaining an addon that benefits from the ABI stability
provided by Node-API carries with it certain
[implementation considerations](https://nodejs.org/docs/latest/api/n-api.html#implications-of-abi-stability).
