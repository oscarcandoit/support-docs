---
url: https://developers.elementor.com/docs/editor-controls/control-wysiwyg/
scraped_at: 2025-10-20T00:58:01.800Z
---

# [\#](https://developers.elementor.com/docs/editor-controls/control-wysiwyg/\#wysiwyg-control) WYSIWYG Control

Elementor CoreBasic![WYSIWYG Control](https://developers.elementor.com/docs/assets/img/controls/control-wysiwyg.png)

Elementor WYSIWYG control displays a WordPress rich-text editor based on the [TinyMCE(opens new window)](https://www.tiny.cloud/) library.
...
## [\#](https://developers.elementor.com/docs/editor-controls/control-wysiwyg/\#arguments) Arguments
...
## [\#](https://developers.elementor.com/docs/editor-controls/control-wysiwyg/\#return-value) Return Value

( _`string`_) The WYSIWYG field value.

## [\#](https://developers.elementor.com/docs/editor-controls/control-wysiwyg/\#usage) Usage
...
←
[Textarea Control](https://developers.elementor.com/docs/editor-controls/control-textarea/)[Code Control](https://developers.elementor.com/docs/editor-controls/control-code/)
→