---
url: https://developers.elementor.com/docs/scripts-styles/editor-scripts/
scraped_at: 2025-10-20T01:02:19.422Z
---

# [\#](https://developers.elementor.com/docs/scripts-styles/editor-scripts/\#editor-scripts) Editor Scripts

Elementor CoreIntermediate

When you develop addons that extend [Elementor Editor](https://developers.elementor.com/docs/editor/) and you have custom scripts, use `elementor/editor/before_enqueue_scripts` or `elementor/editor/after_enqueue_scripts` action hooks, which are fired when editor scripts are registered and enqueued.

## [\#](https://developers.elementor.com/docs/scripts-styles/editor-scripts/\#registering-editor-scripts) Registering Editor Scripts
...
←
[Frontend Styles](https://developers.elementor.com/docs/scripts-styles/frontend-styles/)[Editor Styles](https://developers.elementor.com/docs/scripts-styles/editor-styles/)
→