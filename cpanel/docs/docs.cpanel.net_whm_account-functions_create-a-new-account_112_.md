---
url: "https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/"
title: "Create a New Account | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#main-content)
...
[Overview](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#overview)

* * *

[Domain Information](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#domain-information)

* * *

[Package](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#package)

* * *

[Account Enhancements](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#account-enhancements)

* * *

[Manual Resource Options](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#manual-resource-options)

* * *

[Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#settings)

* * *

[Mail Routing Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#mail-routing-settings)

* * *

[Package Extensions](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#package-extensions)

* * *

[Reseller Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#reseller-settings)

* * *

[DNS Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#dns-settings)

* * *

[Create the account](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#create-the-account)

* * *

[Visitor experience](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#visitor-experience)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#table-of-contents-toggle)
...
_Valid for versions 112 through 122_
...
The _Manual Resource Options_ section appears when you select the _Select package options manually_ checkbox in the [_Package_](https://docs.cpanel.net/whm/account-functions/create-a-new-account/112/#package) section.
