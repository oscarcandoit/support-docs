---
url: "https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/"
title: "MySQL/MariaDB Upgrade | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#main-content)
...
[Overview](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#overview)

* * *

[Before installation](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#before-installation)

* * *

[Installation limitations](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#installation-limitations)

* * *

[CloudLinux’s MySQL Governor](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#cloudlinuxs-mysql-governor)

* * *

[The phpinfo file](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#the-phpinfo-file)

* * *

[Amazon Relational Database Service](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#amazon-relational-database-service)

* * *

[Available versions](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#available-versions)

* * *

[Upgrade or reinstall MySQL or MariaDB](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#upgrade-or-reinstall-mysql-or-mariadb)

* * *

[The MySQL Upgrade Checker Utility](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#the-mysql-upgrade-checker-utility)

* * *

[MySQL upgrade log](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#mysql-upgrade-log)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/#table-of-contents-toggle)
...
In cPanel & WHM version 120 and later, we renamed this interface to [_Upgrade Database Version_](https://docs.cpanel.net/whm/database-services/upgrade-database-version/) and its section in the WHM interface to [Database Services](https://docs.cpanel.net/whm/database-services/).
