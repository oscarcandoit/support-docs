---
url: "https://docs.cpanel.net/whm/scripts/whm-scripts/108/"
title: "WHM Scripts | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/scripts/whm-scripts/108/#main-content)
...
[Overview](https://docs.cpanel.net/whm/scripts/whm-scripts/108/#overview)

* * *

[Scripts](https://docs.cpanel.net/whm/scripts/whm-scripts/108/#scripts)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/scripts/whm-scripts/108/#table-of-contents-toggle)
...
- If your server runs the AlmaLinux OS 8, CentOS 7, CloudLinux™ 7 or 8, Red Hat® Enterprise Linux® (RHEL) 7, Rocky Linux™ 8, or Ubuntu® operating systems, we do **not** recommend that you use this script due to the way in which these operating systems manage firewalls.
