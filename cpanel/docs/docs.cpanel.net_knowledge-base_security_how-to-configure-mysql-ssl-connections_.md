---
url: "https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/"
title: "How to Configure MySQL SSL Connections | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#overview)

* * *

[Configure MySQL SSL connections](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#configure-mysql-ssl-connections)

* * *

[Create the directory to store the SSL keys](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#create-the-directory-to-store-the-ssl-keys)

* * *

[Create the SSL keys](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#create-the-ssl-keys)

* * *

[Edit the MySQL configuration](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#edit-the-mysql-configuration)

* * *

[Test the SSL configuration](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#test-the-ssl-configuration)

* * *

[Create a user and allow remote access](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#create-a-user-and-allow-remote-access)

* * *

[Test the remote MySQL connection](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#test-the-remote-mysql-connection)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/#table-of-contents-toggle)
...
- You **must** possess `root` access to the client and host servers to complete this tutorial.
- MariaDB® version 11.4 automatically configures the server with a [Self-Signed Certificate](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#ssl-certificate). To configure the server with a signed SSL certificate, follow the directions in this document.
...
1. Navigate to cPanel’s [_Manage My Databases_](https://docs.cpanel.net/cpanel/databases/manage-my-databases/) interface ( _cPanel » Home » Databases » Manage My Databases_) and create your database user.

2. Add the remote server’s IP address to cPanel’s [_Remote Database Access_](https://docs.cpanel.net/cpanel/databases/remote-database-access/) interface ( _cPanel » Home » Databases » Remote Database Access_).
