---
url: "https://docs.cpanel.net/cpanel/email/set-up-mail-client/"
title: "Set Up Mail Client | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/email/set-up-mail-client/#main-content)
...
[Secure SSL/TLS Settings (Recommended)](https://docs.cpanel.net/cpanel/email/set-up-mail-client/#secure-ssl-tls-settings-recommended1764175695544176844)
...
[Non-SSL Settings (NOT Recommended)](https://docs.cpanel.net/cpanel/email/set-up-mail-client/#non-ssl-settings-not-recommended1764175695544383465)
