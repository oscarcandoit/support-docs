---
url: "https://docs.cpanel.net/knowledge-base/third-party/how-to-install-wordpress-with-cpanel/104/"
title: "How to Install WordPress® With cPanel | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/third-party/how-to-install-wordpress-with-cpanel/104/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/third-party/how-to-install-wordpress-with-cpanel/104/#overview)

* * *

[Install WordPress](https://docs.cpanel.net/knowledge-base/third-party/how-to-install-wordpress-with-cpanel/104/#install-wordpress)

* * *

[Install WordPress from WP Toolkit](https://docs.cpanel.net/knowledge-base/third-party/how-to-install-wordpress-with-cpanel/104/#install-wordpress-from-wp-toolkit)

* * *

[Install WordPress manually](https://docs.cpanel.net/knowledge-base/third-party/how-to-install-wordpress-with-cpanel/104/#install-wordpress-manually)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/third-party/how-to-install-wordpress-with-cpanel/104/#table-of-contents-toggle)
...
To change the database’s username or password, use cPanel’s [_MySQL® Databases_](https://docs.cpanel.net/cpanel/databases/mysql-databases/) interface ( _cPanel » Home » Databases » MySQL® Databases_).
