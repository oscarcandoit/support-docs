---
url: "https://docs.cpanel.net/whm/server-configuration/initial-quota-setup/102/"
title: "Initial Quota Setup | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/initial-quota-setup/102/#main-content)
...
[Overview](https://docs.cpanel.net/whm/server-configuration/initial-quota-setup/102/#overview)

* * *

[Quota setup](https://docs.cpanel.net/whm/server-configuration/initial-quota-setup/102/#quota-setup)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/initial-quota-setup/102/#table-of-contents-toggle)
...
- If you disable and then reenable quotas, servers that use the XFS® filesystem and run AlmaLinux OS 8, Rocky Linux™ 8, CentOS 7, CloudLinux™ 7 or 8, Red Hat® Enterprise Linux™ (RHEL) 7, or Ubuntu® require additional actions for quotas to function properly:
  ...
  - **Command Line** — Run the `/scripts/fixquotas` script and then remount the file system.
...
- CloudLinux 7 or 8 updates may break quotas. For this reason, after each CloudLinux 7 or 8 update, you **must** run the `/usr/local/cpanel/scripts/fixquotas` script and then remount the file system.
