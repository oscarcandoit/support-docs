---
url: "https://docs.cpanel.net/whm/dns-functions/delete-a-dns-zone/"
title: "Delete a DNS Zone | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/dns-functions/delete-a-dns-zone/#main-content)
...
[Overview](https://docs.cpanel.net/whm/dns-functions/delete-a-dns-zone/#overview)

* * *

[Delete one zone](https://docs.cpanel.net/whm/dns-functions/delete-a-dns-zone/#delete-one-zone)

* * *

[Delete multiple zones](https://docs.cpanel.net/whm/dns-functions/delete-a-dns-zone/#delete-multiple-zones)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/dns-functions/delete-a-dns-zone/#table-of-contents-toggle)
