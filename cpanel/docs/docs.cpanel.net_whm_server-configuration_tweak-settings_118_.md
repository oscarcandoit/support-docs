---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/118/"
title: "Tweak Settings | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/118/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/118/#installation-toggle)
...
- [Compression](https://docs.cpanel.net/whm/server-configuration/tweak-settings/compression/118)
- [cPAddons Site Software](https://docs.cpanel.net/whm/server-configuration/tweak-settings/cpaddons-site-software/118)
- [Development](https://docs.cpanel.net/whm/server-configuration/tweak-settings/development/118)
- [Display](https://docs.cpanel.net/whm/server-configuration/tweak-settings/display/118)
- [Domains](https://docs.cpanel.net/whm/server-configuration/tweak-settings/domains/118)
- [Logging](https://docs.cpanel.net/whm/server-configuration/tweak-settings/logging/118)
- [Mail](https://docs.cpanel.net/whm/server-configuration/tweak-settings/mail/118)
- [Notifications](https://docs.cpanel.net/whm/server-configuration/tweak-settings/notifications/118)
- [Packages](https://docs.cpanel.net/whm/server-configuration/tweak-settings/packages/118)
- [PHP](https://docs.cpanel.net/whm/server-configuration/tweak-settings/php/118)
- [Redirection](https://docs.cpanel.net/whm/server-configuration/tweak-settings/redirection/118)
- [Security](https://docs.cpanel.net/whm/server-configuration/tweak-settings/security/118)
- [Software](https://docs.cpanel.net/whm/server-configuration/tweak-settings/software/118)
- [SQL](https://docs.cpanel.net/whm/server-configuration/tweak-settings/sql/118)
- [Stats and Logs](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-and-logs/118)
- [Stats Programs](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/118)
- [Status](https://docs.cpanel.net/whm/server-configuration/tweak-settings/status/118)
- [Support](https://docs.cpanel.net/whm/server-configuration/tweak-settings/support/118)
- [System](https://docs.cpanel.net/whm/server-configuration/tweak-settings/system/118)
