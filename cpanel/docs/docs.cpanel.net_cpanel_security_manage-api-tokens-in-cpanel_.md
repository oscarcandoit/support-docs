---
url: "https://docs.cpanel.net/cpanel/security/manage-api-tokens-in-cpanel/"
title: "Manage API Tokens in cPanel | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/security/manage-api-tokens-in-cpanel/#main-content)
...
[apitoken](https://docs.cpanel.net/tags/apitoken/) [authentication](https://docs.cpanel.net/tags/authentication/)

#### Table of Contents

[Overview](https://docs.cpanel.net/cpanel/security/manage-api-tokens-in-cpanel/#overview)

* * *

[Create an API token](https://docs.cpanel.net/cpanel/security/manage-api-tokens-in-cpanel/#create-an-api-token)

* * *

[The API tokens table](https://docs.cpanel.net/cpanel/security/manage-api-tokens-in-cpanel/#the-api-tokens-table)

* * *

[Manage an API token](https://docs.cpanel.net/cpanel/security/manage-api-tokens-in-cpanel/#manage-an-api-token)

* * *

[Rename Token](https://docs.cpanel.net/cpanel/security/manage-api-tokens-in-cpanel/#rename-token)

* * *

[Revoke the Token](https://docs.cpanel.net/cpanel/security/manage-api-tokens-in-cpanel/#revoke-the-token)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/security/manage-api-tokens-in-cpanel/#table-of-contents-toggle)
...
![](https://docs.cpanel.net/img/cpanel-icons/api_tokens.svg)
