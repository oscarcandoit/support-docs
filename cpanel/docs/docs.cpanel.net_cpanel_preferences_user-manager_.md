---
url: "https://docs.cpanel.net/cpanel/preferences/user-manager/"
title: "User Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/preferences/user-manager/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/preferences/user-manager/#overview)

* * *

[Link accounts](https://docs.cpanel.net/cpanel/preferences/user-manager/#link-accounts)

* * *

[Add a Subaccount](https://docs.cpanel.net/cpanel/preferences/user-manager/#add-a-subaccount)

* * *

[Services](https://docs.cpanel.net/cpanel/preferences/user-manager/#services)

* * *

[Logging in](https://docs.cpanel.net/cpanel/preferences/user-manager/#logging-in)

* * *

[Edit a Subaccount](https://docs.cpanel.net/cpanel/preferences/user-manager/#edit-a-subaccount)

* * *

[Delete a Subaccount](https://docs.cpanel.net/cpanel/preferences/user-manager/#delete-a-subaccount)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/preferences/user-manager/#table-of-contents-toggle)
...
- You cannot use email services on [temporary domains](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#temporary-domain). Contact your [hosting provider](https://docs.cpanel.net/knowledge-base/cpanel-product/how-to-identify-your-hosting-provider/) or use cPanel’s [_Manage the Domain_](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain) interface to replace the cPanel account’s temporary domain with a registered domain to add Subaccounts with email services.
...
7. Select the Subaccount’s services. For more information, read the [Services](https://docs.cpanel.net/cpanel/preferences/user-manager/#services) section below.
