---
url: "https://docs.cpanel.net/whm/scripts/the-copy_user_mail_as_root-script/"
title: "The copy_user_mail_as_root Script | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/scripts/the-copy_user_mail_as_root-script/#main-content)
...
4. The copy\_user\_mail\_as\_root Script
...
[Overview](https://docs.cpanel.net/whm/scripts/the-copy_user_mail_as_root-script/#overview)

* * *

[Run the script](https://docs.cpanel.net/whm/scripts/the-copy_user_mail_as_root-script/#run-the-script)

* * *

[Options](https://docs.cpanel.net/whm/scripts/the-copy_user_mail_as_root-script/#options)

* * *

[Example](https://docs.cpanel.net/whm/scripts/the-copy_user_mail_as_root-script/#example)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/scripts/the-copy_user_mail_as_root-script/#table-of-contents-toggle)
...
## The copy\_user\_mail\_as\_root Script

_Valid for versions 96 through the latest version_

#### Version:

#### [96](https://docs.cpanel.net/whm/scripts/the-copy_user_mail_as_root-script/)
