---
url: "https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/"
title: "The cpanel.config File | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/#overview)

* * *

[Cached values](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/#cached-values)

* * *

[Configuration setting validation](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/#configuration-setting-validation)

* * *

[Absent cpanel.config file](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/#absent-cpanelconfig-file)

* * *

[Absent values](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/#absent-values)

* * *

[Invalid values](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/#invalid-values)

* * *

[Keys and default settings](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/#keys-and-default-settings)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/120/#table-of-contents-toggle)
