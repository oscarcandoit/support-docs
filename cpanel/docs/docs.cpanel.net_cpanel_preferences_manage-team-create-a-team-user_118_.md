---
url: "https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/118/"
title: "Manage Team — Create a Team User | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/118/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/118/#overview) [Create a Team User](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/118/#create-a-team-user) [MySQL® and team users](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/118/#mysql-and-team-users) - [Edit a Team User](https://docs.cpanel.net/cpanel/preferences/manage-team-edit-a-team-user/)

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/118/#installation-toggle)
