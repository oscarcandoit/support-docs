---
url: "https://docs.cpanel.net/whm/dns-functions/email-dns-record-manager/"
title: "Email DNS Record Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/dns-functions/email-dns-record-manager/#main-content)
...
[Overview](https://docs.cpanel.net/whm/dns-functions/email-dns-record-manager/#overview)

* * *

[Enable DMARC records](https://docs.cpanel.net/whm/dns-functions/email-dns-record-manager/#enable-dmarc-records)

* * *

[Customize DMARC records](https://docs.cpanel.net/whm/dns-functions/email-dns-record-manager/#customize-dmarc-records)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/dns-functions/email-dns-record-manager/#table-of-contents-toggle)
