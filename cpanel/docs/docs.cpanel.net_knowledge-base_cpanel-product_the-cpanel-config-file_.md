---
url: "https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/"
title: "The cpanel.config File | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/#overview)

* * *

[Cached values](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/#cached-values)

* * *

[Configuration setting validation](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/#configuration-setting-validation)

* * *

[Absent cpanel.config file](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/#absent-cpanelconfig-file)

* * *

[Absent values](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/#absent-values)

* * *

[Invalid values](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/#invalid-values)

* * *

[Keys and default settings](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/#keys-and-default-settings)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/cpanel-product/the-cpanel-config-file/#table-of-contents-toggle)
...
| `autodiscover_proxy_subdomains` | [_Domains_](https://docs.cpanel.net/whm/server-configuration/tweak-settings#domains) | _Thunderbird and Outlook autodiscover and autoconfig support (enables service subdomain and SRV record creation)_ | `1`<br>Warning:<br>- This value is dynamic. You must perform additional steps to update it manually. We recommend only modifying this value in the interface.<br>- If you set this value to `0`, your users may have issues when they set up their email, calendars, or contacts. |
...
| `cpdavd_caldav_upload_limit` | [_System_](https://docs.cpanel.net/whm/server-configuration/tweak-settings#system) | _Max upload size for CalDAV/CardDAV server_ | `10` |
...
| `create_account_dmarc` | [_Domains_](https://docs.cpanel.net/whm/server-configuration/tweak-settings#domains) | _Enable DMARC on domains for newly created accounts_ | `1`<br>Important:<br>DMARC **requires** valid SPF and DKIM records. To enable DMARC, you must **also** set the `create_account_spf` and `create_account_dkim` keys to `1`. |
...
| `display_cpanel_promotions` | [_Display_](https://docs.cpanel.net/whm/server-configuration/tweak-settings#display) | _Display announcement banner._ | `1` |
...
| `jailmountbinsuid` | [_System_](https://docs.cpanel.net/whm/server-configuration/tweak-settings#system) | _Jailed /bin mounted suid_<br>Note:<br>This setting has no effect on servers that run the CloudLinux™ 8, AlmaLinux OS 8, Rocky Linux 8, or Ubuntu operating systems. | `0` |
...
| `mysql-version` | No _Tweak Settings_ equivalent. | This sets the MySQL® version. You can upgrade to a new MySQL version in WHM’s [_Upgrade Database Version_](https://docs.cpanel.net/whm/database-services/upgrade-database-version/) interface ( _WHM » Home » Database Services » Upgrade Database Version_). | `undef`<br>Warning:<br>This value is dynamic. You must perform additional steps to update it manually. We recommend only modifying this value in the interface. |
| `mysql-host` | No _Tweak Settings_ equivalent. | This sets the MySQL host. You can specify a remote MySQL host in cPanel’s [_Remote Database Access_](https://docs.cpanel.net/cpanel/databases/remote-database-access) interface ( _cPanel » Home » Databases » Remote Database Access_). | `localhost`<br>Warning:<br>This value is dynamic. You must perform additional steps to update it manually. We recommend only modifying this value in the interface. |
...
| `proxysubdomains` | [_Domains_](https://docs.cpanel.net/whm/server-configuration/tweak-settings#domains) | _Service subdomains_ | `1`<br>Warning:<br>- This value is dynamic. You must perform additional steps to update it manually. We recommend only modifying this value in the interface.<br>- If you set this value to `0`, your users may have issues when they set up their email, calendars, or contacts. |
...
| `securetmp_file_size` | [_System_](https://docs.cpanel.net/whm/server-configuration/tweak-settings#system) | _Size, in MB, for the /tmp partition secured by securetmp_ | `undef`<br>Warning:<br>- If this value is set to `undef`, the system determines the size of the file that the `/tmp` partition uses. <br>- Changing this setting will **delete** the contents of your `/tmp` partition. |
...
| `share_docroot_default` | [_Domains_](https://docs.cpanel.net/whm/server-configuration/tweak-settings#domains) | _Share the document root by default when creating a domain_ | `1` |
