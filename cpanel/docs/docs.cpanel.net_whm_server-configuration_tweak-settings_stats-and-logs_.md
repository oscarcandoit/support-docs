---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-and-logs/"
title: "Tweak Settings — Stats and Logs | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-and-logs/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-and-logs/#installation-toggle)
