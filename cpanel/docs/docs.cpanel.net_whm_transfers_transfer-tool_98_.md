---
url: "https://docs.cpanel.net/whm/transfers/transfer-tool/98/"
title: "Transfer Tool | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#main-content)
...
[Overview](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#overview) [Before getting started](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#before-getting-started) [Warnings](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#warnings) [DNS transfers](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#dns-transfers) [Data transfers](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#data-transfers) [Important notes about account transfers from Plesk](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#important-notes-about-account-transfers-from-plesk) [Perform a transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#perform-a-transfer) [Live Transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#live-transfer) - [Prepare The Source Server](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/)
...
[**Table of Contents**](https://docs.cpanel.net/whm/transfers/transfer-tool/98/#installation-toggle)
...
_Valid for versions 98 through 116_
...
- The Transfer Tool feature **replaces** the source server’s files with the destination server’s zone files when the following conditions are true:

  - The destination server resides in the same Domain Name System (DNS) cluster as the source server.
  - The source server and the DNS nodes use the _Synchronized Changes_ DNS role.
    For more information about DNS clusters, read our [DNS Cluster](https://docs.cpanel.net/whm/clusters/dns-cluster) documentation.
...
- A destination server with IPv6 enabled will point any remote-related AAAA record to the account’s shared IPv6 address in the domain’s locally-managed zone file.
...
- Do **not** use the `skip-name-resolve` setting in your server’s MySQL® configuration. This setting can cause problems on any server. It will create **more** problems on source MySQL servers during account transfers.
...
- If you experience problems with session timeouts, increase the number of seconds in the _Number of seconds an SSH connection related to an account transfer may be inactive before timing out_ setting in the _System_ section of WHM’s [_Tweak Settings_](https://docs.cpanel.net/whm/server-configuration/tweak-settings) interface ( _WHM » Home » Server Configuration » Tweak Settings_).
