---
url: "https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/"
title: "Transfer Tool — Select What to Transfer | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/#main-content)
...
[Overview](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/#overview) [Accounts](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/#accounts) [How to copy accounts](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/#how-to-copy-accounts) [Packages](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/#packages) [How to copy packages](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/#how-to-copy-packages) [Package and feature list naming](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/#package-and-feature-list-naming) [Service Configurations](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/#service-configurations) - [The Transfer Process](https://docs.cpanel.net/whm/transfers/transfer-tool/the-transfer-process/)
...
[**Table of Contents**](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/#installation-toggle)
...
4. Click _Default_ to open the _Account Information_ section. The following sections will appear:
...
When you change a setting in this section, the interface will display _Custom_ instead of _Default_.





   - The _What to Transfer_ section. You can select the following settings in this section:
   ...
   - The _Live Transfer_ section. Set the toggle to _Enabled_ if you want to use [Live Transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/#live-transfer) to transfer your server.
   - The _Update DNS Zone section_. Set the toggle to _Enabled_ to update the DNS records on the destination server to match the source server’s settings.
   - The _Linked Node Options_ section. This section **only** appears if your server uses a [linked node](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-use-server-profiles). The following settings will appear:
...
5. Click _Apply_ to save the settings for this account. You can click _Apply to other selected accounts_ to apply these settings to all currently selected accounts. To apply the default settings for this account, click _Reset_.
6. The _Overwrite_ column displays a menu that allows you to overwrite local data for the transfer.
...
7. Click _Copy_. The transfer will begin, and the [_Account Transfer_](https://docs.cpanel.net/whm/transfers/account-transfer/) interface will appear.
