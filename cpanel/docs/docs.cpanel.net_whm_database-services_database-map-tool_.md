---
url: "https://docs.cpanel.net/whm/database-services/database-map-tool/"
title: "Database Map Tool | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/database-services/database-map-tool/#main-content)
...
[Overview](https://docs.cpanel.net/whm/database-services/database-map-tool/#overview)

* * *

[Grant ownership to database objects](https://docs.cpanel.net/whm/database-services/database-map-tool/#grant-ownership-to-database-objects)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/database-services/database-map-tool/#table-of-contents-toggle)
...
#### [120](https://docs.cpanel.net/whm/database-services/database-map-tool/)
