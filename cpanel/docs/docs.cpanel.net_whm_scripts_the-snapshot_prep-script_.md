---
url: "https://docs.cpanel.net/whm/scripts/the-snapshot_prep-script/"
title: "The snapshot_prep Script | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/scripts/the-snapshot_prep-script/#main-content)
...
[Overview](https://docs.cpanel.net/whm/scripts/the-snapshot_prep-script/#overview)

* * *

[Run the script](https://docs.cpanel.net/whm/scripts/the-snapshot_prep-script/#run-the-script)

* * *

[Options](https://docs.cpanel.net/whm/scripts/the-snapshot_prep-script/#options)

* * *

[Create a third-party plugin](https://docs.cpanel.net/whm/scripts/the-snapshot_prep-script/#create-a-third-party-plugin)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/scripts/the-snapshot_prep-script/#table-of-contents-toggle)
...
- A remote MySQL® profile set up in WHM’s [_Manage Database Profiles_](https://docs.cpanel.net/whm/database-services/manage-database-profiles) interface ( _WHM » Database Services » Manage Database Profiles_).
...
| `--instance-packages` | Include a comma-delimited list of packages to install on the first boot of instances created from an image. Use this option for packages that generate per-instance data during installation. When you use this option, you avoid saving per-instance data to your deployment image. | `--instance-packages=package1,package2`<br>Note:<br>In this example, `package1` and `package2` represent the packages you wish to install. |
...
For a description of these tasks, as well as all other tasks in this script, use the [`--list-tasks`](https://docs.cpanel.net/whm/scripts/the-snapshot_prep-script/#options) option.
