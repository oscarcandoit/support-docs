---
url: "https://docs.cpanel.net/whm/transfers/transfer-tool/124/"
title: "Transfer Tool | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#main-content)
...
[Overview](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#overview) [Before getting started](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#before-getting-started) [Warnings](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#warnings) [DNS transfers](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#dns-transfers) [Data transfers](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#data-transfers) [Important notes about account transfers from Plesk](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#important-notes-about-account-transfers-from-plesk) [Perform a transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#perform-a-transfer) [Live Transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#live-transfer) - [Prepare The Source Server](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/)
...
[**Table of Contents**](https://docs.cpanel.net/whm/transfers/transfer-tool/124/#installation-toggle)
