---
url: "https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/"
title: "Exim Configuration Manager Basic Editor | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#main-content)
...
[Overview](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#overview)

* * *

[All](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#all)

* * *

[ACL Options](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#acl-options)

* * *

[Access Lists](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#access-lists)

* * *

[Domains and IPs](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#domains-and-ips)

* * *

[Filters](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#filters)

* * *

[Mail](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#mail)

* * *

[RBLs](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#rbls)

* * *

[Security](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#security)

* * *

[Apache SpamAssassin™ Options](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#apache-spamassassin-options)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#table-of-contents-toggle)
...
_Valid for versions 116 through 120_
...
[Click to view...](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#click-to-view---1764175702354668497)
...
- [Trusted mail users](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/116/#trusted-mail-users) can bypass this setting.
