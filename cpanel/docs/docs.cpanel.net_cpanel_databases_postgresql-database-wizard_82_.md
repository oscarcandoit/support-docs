---
url: "https://docs.cpanel.net/cpanel/databases/postgresql-database-wizard/82/"
title: "PostgreSQL Database Wizard | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/databases/postgresql-database-wizard/82/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/databases/postgresql-database-wizard/82/#overview)

* * *

[Set up a database](https://docs.cpanel.net/cpanel/databases/postgresql-database-wizard/82/#set-up-a-database)

* * *

[Additional options](https://docs.cpanel.net/cpanel/databases/postgresql-database-wizard/82/#additional-options)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/databases/postgresql-database-wizard/82/#table-of-contents-toggle)
