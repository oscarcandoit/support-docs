---
url: "https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/"
title: "PostgreSQL Databases | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#overview)

* * *

[Create a database](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#create-a-database)

* * *

[Current Databases](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#current-databases)

* * *

[Remove a user](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#remove-a-user)

* * *

[Rename a database](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#rename-a-database)

* * *

[Delete a database](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#delete-a-database)

* * *

[Add a PostgreSQL user](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#add-a-postgresql-user)

* * *

[Add a user to a database](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#add-a-user-to-a-database)

* * *

[Current Users](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#current-users)

* * *

[Change a PostgreSQL user password](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#change-a-postgresql-user-password)

* * *

[Change a PostgreSQL user name](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#change-a-postgresql-user-name)

* * *

[Delete a PostgreSQL user](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#delete-a-postgresql-user)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/databases/postgresql-databases/82/#table-of-contents-toggle)
...
_Valid for versions 82 through 118_
...
- This interface **only** appears in your cPanel account if your hosting provider installs and configures PostgreSQL in WHM’s [_Configure PostgreSQL_](https://docs.cpanel.net/whm/sql-services/configure-postgresql/) interface ( _WHM » Home » SQL Services » Configure PostgreSQL_).
