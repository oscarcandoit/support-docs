---
url: "https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/"
title: "Upgrade Database Version | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#main-content)
...
[Overview](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#overview)

* * *

[Before installation](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#before-installation)

* * *

[Installation limitations](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#installation-limitations)

* * *

[CloudLinux’s MySQL Governor](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#cloudlinuxs-mysql-governor)

* * *

[The phpinfo file](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#the-phpinfo-file)

* * *

[Amazon Relational Database Service](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#amazon-relational-database-service)

* * *

[Available versions](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#available-versions)

* * *

[Upgrade or reinstall MySQL or MariaDB](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#upgrade-or-reinstall-mysql-or-mariadb)

* * *

[The MySQL Upgrade Checker Utility](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#the-mysql-upgrade-checker-utility)

* * *

[MySQL upgrade log](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#mysql-upgrade-log)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/#table-of-contents-toggle)
