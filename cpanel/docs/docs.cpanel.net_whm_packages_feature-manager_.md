---
url: "https://docs.cpanel.net/whm/packages/feature-manager/"
title: "Feature Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/packages/feature-manager/#main-content)
...
[Overview](https://docs.cpanel.net/whm/packages/feature-manager/#overview)

* * *

[Predefined feature lists](https://docs.cpanel.net/whm/packages/feature-manager/#predefined-feature-lists)

* * *

[default](https://docs.cpanel.net/whm/packages/feature-manager/#default)

* * *

[Mail only](https://docs.cpanel.net/whm/packages/feature-manager/#mail-only)

* * *

[disabled](https://docs.cpanel.net/whm/packages/feature-manager/#disabled)

* * *

[Create and edit a feature list](https://docs.cpanel.net/whm/packages/feature-manager/#create-and-edit-a-feature-list)

* * *

[Delete a feature list](https://docs.cpanel.net/whm/packages/feature-manager/#delete-a-feature-list)

* * *

[Selectable features](https://docs.cpanel.net/whm/packages/feature-manager/#selectable-features)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/packages/feature-manager/#table-of-contents-toggle)
