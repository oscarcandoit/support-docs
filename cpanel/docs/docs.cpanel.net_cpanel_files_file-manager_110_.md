---
url: "https://docs.cpanel.net/cpanel/files/file-manager/110/"
title: "File Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/files/file-manager/110/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/files/file-manager/110/#overview)

* * *

[Change Settings](https://docs.cpanel.net/cpanel/files/file-manager/110/#change-settings)

* * *

[Character encoding verification dialogs](https://docs.cpanel.net/cpanel/files/file-manager/110/#character-encoding-verification-dialogs)

* * *

[Working with files and folders](https://docs.cpanel.net/cpanel/files/file-manager/110/#working-with-files-and-folders)

* * *

[Create or copy files or folders](https://docs.cpanel.net/cpanel/files/file-manager/110/#create-or-copy-files-or-folders)

* * *

[Move files or folders](https://docs.cpanel.net/cpanel/files/file-manager/110/#move-files-or-folders)

* * *

[Update file or folder permissions](https://docs.cpanel.net/cpanel/files/file-manager/110/#update-file-or-folder-permissions)

* * *

[Delete or restore files and folders](https://docs.cpanel.net/cpanel/files/file-manager/110/#delete-or-restore-files-and-folders)

* * *

[Other item actions](https://docs.cpanel.net/cpanel/files/file-manager/110/#other-item-actions)

* * *

[Search for an item](https://docs.cpanel.net/cpanel/files/file-manager/110/#search-for-an-item)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/files/file-manager/110/#table-of-contents-toggle)
...
_Valid for versions 110 through 124_
...
When you edit a file with the _Edit_ action, an interface appears to confirm the file’s character encoding. Use the menu to select the correct character encoding for the file. Then, click _Edit_ to continue.
