---
url: "https://docs.cpanel.net/whm/account-functions/create-a-new-account/"
title: "Create a New Account | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#main-content)
...
[Overview](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#overview)

* * *

[Domain Information](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#domain-information)

* * *

[Package](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#package)

* * *

[Account Enhancements](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#account-enhancements)

* * *

[Manual Resource Options](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#manual-resource-options)

* * *

[Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#settings)

* * *

[Mail Routing Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#mail-routing-settings)

* * *

[Package Extensions](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#package-extensions)

* * *

[Reseller Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#reseller-settings)

* * *

[DNS Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#dns-settings)

* * *

[Create the account](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#create-the-account)

* * *

[Visitor experience](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#visitor-experience)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#table-of-contents-toggle)
...
- _Domain_ — The domain name for the account (for example, `example.com`). You may choose one of the following two options:
  ...
  - _Choose a domain later_ — cPanel & WHM will assign a [temporary domain name](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#temporary-domains) to the account.
...
- You **cannot** change an existing cPanel account to use a temporary domain.
...
- You can **only** create temporary domains with new cPanel accounts or when creating an addon or parked domain.
...
The _Manual Resource Options_ section appears when you select the _Select package options manually_ checkbox in the [_Package_](https://docs.cpanel.net/whm/account-functions/create-a-new-account/#package) section.
...
- [Modify an Account](https://docs.cpanel.net/whm/account-functions/modify-an-account/)
