---
url: "https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/"
title: "cPanel Glossary | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#main-content)
...
[A](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#a)

* * *

[B](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#b)

* * *

[C](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#c)

* * *

[D](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#d)

* * *

[E](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#e)

* * *

[F](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#f)

* * *

[G](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#g)

* * *

[H](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#h)

* * *

[I](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#i)

* * *

[J](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#j)

* * *

[K](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#k)

* * *

[L](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#l)

* * *

[M](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#m)

* * *

[N](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#n)

* * *

[O](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#o)

* * *

[P](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#p)

* * *

[Q](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#q)

* * *

[R](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#r)

* * *

[S](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#s)

* * *

[T](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#t)

* * *

[U](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#u)

* * *

[V](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#v)

* * *

[W](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#w)

* * *

[X](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#x)

* * *

[Y](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#y)

* * *

[Z](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#z)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#table-of-contents-toggle)
...
An email protocol that helps combat [phishing](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#phishing), [spoofing](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#spoof), and [spam](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#spam). ARC verifies email authentication in messages that your server forwards or redirects. Google and other large email providers may require ARC headers in these types of messages.
...
The companion software to [WHM](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#whm). WebPros International, LLC designs cPanel to simplify website maintenance for website owners.
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#release-tiers). WebPros International, LLC supports this version for a period of one year before designating the next LTS version.
...
A server that sends mail to and receives mail from other servers. Mail exchangers use [MX entries](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#mail-exchanger-mx-entry) to determine where to send mail.
...
The background software that runs all of the other software applications on your system. The OS is a required part of any server or computer. cPanel & WHM supports specific versions of the [AlmaLinux OS](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#almalinux), [Rocky Linux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#rockylinux), [CloudLinux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#cloudlinux), and [Ubuntu](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#ubuntu) operating systems.
...
- [CloudLinux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#cloudlinux)
- [AlmaLinux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#almalinux)
- [Rocky Linux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#rockylinux)
...
A temporary domain is an automatically-generated `cpanel.site` subdomain that can be a cPanel user’s primary domain, an addon domain, or a parked domain. You can use a temporary domain to design and collaborate with others on a website without a registered domain.

Accounts with temporary domains cannot use email services, [Search Engine Optimization](https://docs.cpanel.net/cpanel/domains/search-engine-optimization/) or [Site Quality Monitoring](https://docs.cpanel.net/cpanel/metrics/site-quality-monitoring/). You cannot edit a temporary domain’s DNS information.
...
An integrated set of credentials that server administrators can use to log in to cPanel & WHM servers. You can use WebPros Account to log in to WHM accounts on servers that use [External Authentication](https://docs.cpanel.net/whm/security-center/manage-external-authentications/) methods.

More:

For more information, read our [WebPros Account](https://docs.cpanel.net/knowledge-base/accounts/webpros-account) documentation.
...
Real-time content editing that looks the same as on the actual web page.
