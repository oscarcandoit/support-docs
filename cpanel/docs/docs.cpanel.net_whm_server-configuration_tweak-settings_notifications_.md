---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/notifications/"
title: "Tweak Settings — Notifications | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/notifications/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/notifications/#installation-toggle)
