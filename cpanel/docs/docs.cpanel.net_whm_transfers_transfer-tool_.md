---
url: "https://docs.cpanel.net/whm/transfers/transfer-tool/"
title: "Transfer Tool | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/transfers/transfer-tool/#main-content)
...
[Overview](https://docs.cpanel.net/whm/transfers/transfer-tool/#overview) [Before getting started](https://docs.cpanel.net/whm/transfers/transfer-tool/#before-getting-started) [Warnings](https://docs.cpanel.net/whm/transfers/transfer-tool/#warnings) [DNS transfers](https://docs.cpanel.net/whm/transfers/transfer-tool/#dns-transfers) [Data transfers](https://docs.cpanel.net/whm/transfers/transfer-tool/#data-transfers) [Important notes about account transfers from Plesk](https://docs.cpanel.net/whm/transfers/transfer-tool/#important-notes-about-account-transfers-from-plesk) [Perform a transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/#perform-a-transfer) [Live Transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/#live-transfer) - [Prepare The Source Server](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/)
...
[**Table of Contents**](https://docs.cpanel.net/whm/transfers/transfer-tool/#installation-toggle)
...
- The Transfer Tool feature **replaces** the source server’s files with the destination server’s [DNS Zone Files](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#zone) when the following conditions are true:
  ...
  - The _Update DNS Zone_ setting for the domain in the Transfer Tool is set to _Enabled_.
...
If you do **not** want to update the domain’s nameserver entries on the destination server, set the _Update DNS Zone_ option to _Disabled_ when preparing the transfer.
