---
url: "https://docs.cpanel.net/whm/server-configuration/basic-webhost-manager-setup/"
title: "Basic WebHost Manager Setup | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/basic-webhost-manager-setup/#main-content)
...
[Overview](https://docs.cpanel.net/whm/server-configuration/basic-webhost-manager-setup/#overview)

* * *

[Contact Information](https://docs.cpanel.net/whm/server-configuration/basic-webhost-manager-setup/#contact-information)

* * *

[Basic Config](https://docs.cpanel.net/whm/server-configuration/basic-webhost-manager-setup/#basic-config)

* * *

[Nameservers](https://docs.cpanel.net/whm/server-configuration/basic-webhost-manager-setup/#nameservers)

* * *

[Save your changes](https://docs.cpanel.net/whm/server-configuration/basic-webhost-manager-setup/#save-your-changes)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/basic-webhost-manager-setup/#table-of-contents-toggle)
