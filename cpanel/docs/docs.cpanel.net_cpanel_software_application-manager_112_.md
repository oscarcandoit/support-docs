---
url: "https://docs.cpanel.net/cpanel/software/application-manager/112/"
title: "Application Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/software/application-manager/112/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/software/application-manager/112/#overview)

* * *

[Requirements](https://docs.cpanel.net/cpanel/software/application-manager/112/#requirements)

* * *

[Applications](https://docs.cpanel.net/cpanel/software/application-manager/112/#applications)

* * *

[Create an application](https://docs.cpanel.net/cpanel/software/application-manager/112/#create-an-application)

* * *

[Register an application](https://docs.cpanel.net/cpanel/software/application-manager/112/#register-an-application)

* * *

[Environment Variables](https://docs.cpanel.net/cpanel/software/application-manager/112/#environment-variables)

* * *

[Add environment variables](https://docs.cpanel.net/cpanel/software/application-manager/112/#add-environment-variables)

* * *

[Edit an application](https://docs.cpanel.net/cpanel/software/application-manager/112/#edit-an-application)

* * *

[Unregister an application](https://docs.cpanel.net/cpanel/software/application-manager/112/#unregister-an-application)

* * *

[Log files](https://docs.cpanel.net/cpanel/software/application-manager/112/#log-files)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/software/application-manager/112/#table-of-contents-toggle)
...
_Valid for versions 112 through 130_
...
| Package | Description |
| --- | --- |
| `ea-apache24-mod_env` | This module allows your application configuration to set [environment variables](https://docs.cpanel.net/cpanel/software/application-manager/112/#environment-variables) for your application. |
