---
url: "https://docs.cpanel.net/whm/packages/feature-manager/124/"
title: "Feature Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/packages/feature-manager/124/#main-content)
...
[Overview](https://docs.cpanel.net/whm/packages/feature-manager/124/#overview)

* * *

[Predefined feature lists](https://docs.cpanel.net/whm/packages/feature-manager/124/#predefined-feature-lists)

* * *

[default](https://docs.cpanel.net/whm/packages/feature-manager/124/#default)

* * *

[Mail only](https://docs.cpanel.net/whm/packages/feature-manager/124/#mail-only)

* * *

[disabled](https://docs.cpanel.net/whm/packages/feature-manager/124/#disabled)

* * *

[Create and edit a feature list](https://docs.cpanel.net/whm/packages/feature-manager/124/#create-and-edit-a-feature-list)

* * *

[Delete a feature list](https://docs.cpanel.net/whm/packages/feature-manager/124/#delete-a-feature-list)

* * *

[Selectable features](https://docs.cpanel.net/whm/packages/feature-manager/124/#selectable-features)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/packages/feature-manager/124/#table-of-contents-toggle)
...
| _Zone Editor (A, CNAME, MX)_ | Enables cPanel’s [_Zone Editor_](https://docs.cpanel.net/cpanel/domains/zone-editor/) interface ( _cPanel » Home » Domains » Zone Editor_) and allows cPanel account users to create A and CNAME records. <br>Note:<br>This feature **only** applies to A, CNAME, and MX records that the cPanel account user created. To allow cPanel account users to view the system’s default A, CNAME, and MX records, and to modify their domains’ DMARC records, enable the _Zone Editor (AAAA, CAA, DMARC, SRV, TXT)_ feature. |
| _Zone Editor (AAAA, CAA, DMARC, SRV, TXT)_ | Allows cPanel account users to create or modify AAAA, CAA, DMARC, SRV, and TXT records in cPanel’s [_Zone Editor_](https://docs.cpanel.net/cpanel/domains/zone-editor/) interface ( _cPanel » Home » Domains » Zone Editor_). This feature also controls whether a cPanel account user can view the existing default A, MX, and CNAME records. <br>Note:<br>cPanel & WHM enables this feature by default. |
