---
url: "https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/"
title: "Manage Service SSL Certificates | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#main-content)
...
[Overview](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#overview)

* * *

[Free cPanel-signed certificate](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#free-cpanel-signed-certificate)

* * *

[Service SSL Certificates](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#service-ssl-certificates)

* * *

[Service](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#service)

* * *

[Certificate Domains](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#certificate-domains)

* * *

[Certificate Expiration](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#certificate-expiration)

* * *

[Certificate Key](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#certificate-key)

* * *

[Actions](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#actions)

* * *

[Install a New Certificate](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#install-a-new-certificate)

* * *

[iOS Mail push notifications](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#ios-mail-push-notifications)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#table-of-contents-toggle)
...
- [PKCS #12 (iOS APNs **only**)](https://docs.cpanel.net/whm/service-configuration/manage-service-ssl-certificates/118/#ios-mail-push-notifications).
...
- The system will replace certificates issued by any other provider with Let’s Encrypt™-provided certificates. For example, the Dovecot service’s custom certificate expires in less than 25 days. The system will install a Let’s Encrypt-provided hostname certificate to replace the old one.
