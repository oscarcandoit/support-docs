---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/"
title: "Tweak Settings — Stats Programs | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/#installation-toggle)
