---
url: "https://docs.cpanel.net/cpanel/files/gitweb/"
title: "Gitweb | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/files/gitweb/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/files/gitweb/#overview)

* * *

[The Gitweb interface](https://docs.cpanel.net/cpanel/files/gitweb/#the-gitweb-interface)

* * *

[Gitweb reports](https://docs.cpanel.net/cpanel/files/gitweb/#gitweb-reports)
...
[Search Gitweb data](https://docs.cpanel.net/cpanel/files/gitweb/#search-gitweb-data)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/files/gitweb/#table-of-contents-toggle)
...
- WebPros International, LLC does **not** develop or own Gitweb. For more information, read Git’s [Gitweb](https://git-scm.com/docs/gitweb) documentation.
...
- Throughout the interface, icons indicate the branches for which a commit is the HEAD commit:
  - Green icons indicate local branches, grey icons indicate remote branches, and yellow icons indicate Git tags. For example, a green _master_ icon (![The Gitweb master icon.](https://docs.cpanel.net/img/gitwebmaster.png)) indicates the HEAD commit for the local _master_ branch.
