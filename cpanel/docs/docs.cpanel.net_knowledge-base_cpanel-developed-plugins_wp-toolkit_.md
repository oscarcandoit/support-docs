---
url: "https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/"
title: "WP Toolkit | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#overview)

* * *

[Install WP Toolkit](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#install-wp-toolkit)

* * *

[WHM Marketplace](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#whm-marketplace)

* * *

[Manual installation](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#manual-installation)

* * *

[WHM configuration](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#whm-configuration)

* * *

[Updates to WP Toolkit](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#updates-to-wp-toolkit)

* * *

[Troubleshoot WP Toolkit](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#troubleshoot-wp-toolkit)

* * *

[Uninstall WP Toolkit](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#uninstall-wp-toolkit)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/#table-of-contents-toggle)
...
- WordPress **only** supports MySQL® version 5.7 and later. To update your server’s version of MySQL to 5.7 and later, use WHM’s [_Upgrade Database Version_](https://docs.cpanel.net/whm/database-services/upgrade-database-version/) interface ( _WHM » Home » Database Services » Upgrade Database Version_).

- Enable the \[ _PHP-FPM Service for cPanel Daemons_\] option in WHM’s [_Service Manager_](https://docs.cpanel.net/whm/service-configuration/service-manager/#service-daemons) interface ( _WHM » Home » Service Configuration » Service Manager_), which must **remain** enabled to use the _WP Toolkit_.
...
- The _WP Toolkit_ plugin requires a PHP `memory_limit` value of 128 MB or higher. You can set this limit in WHM’s [_MultiPHP INI Editor_](https://docs.cpanel.net/whm/software/multiphp-ini-editor/) interface ( _WHM » Home » Software » MultiPHP INI Editor_).

- In WHM’s [_Feature Manager_](https://docs.cpanel.net/whm/packages/feature-manager) interface ( _WHM » Home » Packages » Feature Manager_), enable the following features:
  - _WP Management_
  - _MySQL_
  - _Subdomains_
  - _MIME Types_
...
_WP Toolkit_ is available in a standard version and a _Deluxe_ version. To use _WP Toolkit Deluxe_ features, enable **both** the _WP Management_ and _WP Toolkit Deluxe_ features in WHM’s [_Feature Manager_](https://docs.cpanel.net/whm/packages/feature-manager) interface ( _WHM » Home » Packages » Feature Manager_).
