---
url: "https://docs.cpanel.net/cpanel/databases/database-wizard/"
title: "Database Wizard | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/databases/database-wizard/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/databases/database-wizard/#overview)

* * *

[Set up a database](https://docs.cpanel.net/cpanel/databases/database-wizard/#set-up-a-database)

* * *

[Additional options](https://docs.cpanel.net/cpanel/databases/database-wizard/#additional-options)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/databases/database-wizard/#table-of-contents-toggle)
...
[MySQL 5.7 and later](https://docs.cpanel.net/cpanel/databases/database-wizard/#mysql-5-7-and-later1764175694884732667)
...
[MariaDB](https://docs.cpanel.net/cpanel/databases/database-wizard/#mariadb1764175694884797238)
