---
url: "https://docs.cpanel.net/whm/security-center/host-access-control/"
title: "Host Access Control | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/security-center/host-access-control/#main-content)
...
[Overview](https://docs.cpanel.net/whm/security-center/host-access-control/#overview)

* * *

[Host Access Control for CloudLinux, AlmaLinux, and Rocky Linux](https://docs.cpanel.net/whm/security-center/host-access-control/#host-access-control-for-cloudlinux-almalinux-and-rocky-linux)

* * *

[Add a rule](https://docs.cpanel.net/whm/security-center/host-access-control/#add-a-rule)

* * *

[Host Access Control for Ubuntu](https://docs.cpanel.net/whm/security-center/host-access-control/#host-access-control-for-ubuntu)

* * *

[Allow or deny access](https://docs.cpanel.net/whm/security-center/host-access-control/#allow-or-deny-access)

* * *

[Example](https://docs.cpanel.net/whm/security-center/host-access-control/#example)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/security-center/host-access-control/#table-of-contents-toggle)
...
Servers that run CloudLinux™, AlmaLinux OS, or Rocky Linux™ control service access by port number. For a list of ports and their related services, read the _Ports_ section of the [How to Configure Your Firewall for cPanel Services](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/#ports) documentation.

Warning:

If you accidentally lock yourself out of WHM when you use this interface, [edit the `nft` rules](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/#almalinux-os-8-and-cloudlinux-8-firewall-management) through the command line to regain access.
