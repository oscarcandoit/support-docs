---
url: "https://docs.cpanel.net/cpanel/domains/domains/"
title: "Domains  | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/domains/domains/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/domains/domains/#overview) [Domain DNS and registration](https://docs.cpanel.net/cpanel/domains/domains/#domain-dns-and-registration) [Create a New Domain](https://docs.cpanel.net/cpanel/domains/domains/#create-a-new-domain) [The List Domains table](https://docs.cpanel.net/cpanel/domains/domains/#the-list-domains-table) [Manage the Domain](https://docs.cpanel.net/cpanel/domains/domains/#manage-the-domain) - [Create a New Domain](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/)
- [Manage the Domain](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/)

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/domains/domains/#installation-toggle)
