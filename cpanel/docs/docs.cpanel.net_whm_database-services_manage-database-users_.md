---
url: "https://docs.cpanel.net/whm/database-services/manage-database-users/"
title: "Manage Database Users | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/database-services/manage-database-users/#main-content)
...
[Overview](https://docs.cpanel.net/whm/database-services/manage-database-users/#overview)

* * *

[Database users](https://docs.cpanel.net/whm/database-services/manage-database-users/#database-users)

* * *

[Rename a database user](https://docs.cpanel.net/whm/database-services/manage-database-users/#rename-a-database-user)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/database-services/manage-database-users/#table-of-contents-toggle)
...
[MySQL 5.7 and later](https://docs.cpanel.net/whm/database-services/manage-database-users/#mysql-5-7-and-later1764175699711190154)
...
[MariaDB](https://docs.cpanel.net/whm/database-services/manage-database-users/#mariadb1764175699711272806)
