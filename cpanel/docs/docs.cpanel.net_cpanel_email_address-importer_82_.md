---
url: "https://docs.cpanel.net/cpanel/email/address-importer/82/"
title: "Address Importer | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/email/address-importer/82/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/email/address-importer/82/#overview)

* * *

[Create the import file](https://docs.cpanel.net/cpanel/email/address-importer/82/#create-the-import-file)

* * *

[Import the file](https://docs.cpanel.net/cpanel/email/address-importer/82/#import-the-file)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/email/address-importer/82/#table-of-contents-toggle)
