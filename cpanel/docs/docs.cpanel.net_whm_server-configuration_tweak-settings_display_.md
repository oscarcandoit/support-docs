---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/display/"
title: "Tweak Settings — Display | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/display/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/display/#installation-toggle)
...
| _Display announcement banner._ | This setting allows you to display the [Announcement banner](https://docs.cpanel.net/cpanel/the-cpanel-interface/the-cpanel-interface/#announcement-banner) in the cPanel interface. cPanel users can dismiss this banner. | - _On_ — Enable<br>- _Off_ — Disable. | _On_ |
