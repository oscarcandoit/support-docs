---
url: "https://docs.cpanel.net/cpanel/preferences/manage-team-audit-log/"
title: "Manage Team — Audit Log | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/preferences/manage-team-audit-log/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/preferences/manage-team-audit-log/#overview) [Search text box](https://docs.cpanel.net/cpanel/preferences/manage-team-audit-log/#search-text-box) [Audit Log table](https://docs.cpanel.net/cpanel/preferences/manage-team-audit-log/#audit-log-table) - [Create a Team User](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/)
- [Edit a Team User](https://docs.cpanel.net/cpanel/preferences/manage-team-edit-a-team-user/)

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/preferences/manage-team-audit-log/#installation-toggle)
