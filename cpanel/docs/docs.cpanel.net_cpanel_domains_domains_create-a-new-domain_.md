---
url: "https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/"
title: "Create a New Domain | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#overview) [Create a New Domain](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#create-a-new-domain) [Create a registered domain](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#create-a-registered-domain) [Create a temporary domain](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#create-a-temporary-domain) [Certificates](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#certificates) - [Manage the Domain](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/)

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#installation-toggle)
...
- [Registered Domain](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#create-a-registered-domain)
- [Temporary Domain](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#create-a-temporary-domain)

### Create a registered domain

To create a registered domain, perform the following steps:

1. Select _Registered Domain_.
...
[Click to view...](https://docs.cpanel.net/cpanel/domains/domains/create-a-new-domain/#click-to-view---1764175695045955380)
...
1. Select _Temporary Domain_.
2. Click _Submit_ or click _Submit and Create Another_.
