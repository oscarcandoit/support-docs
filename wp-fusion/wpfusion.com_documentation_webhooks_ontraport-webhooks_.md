---
url: "https://wpfusion.com/documentation/webhooks/ontraport-webhooks/"
title: "Ontraport Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/\#using-rules-ontraport-pro-accounts) Using Rules (Ontraport Pro accounts)
...
[![](https://wpfusion.com/wp-content/uploads/2016/08/ontraport-webhook-1-1024x961.jpg)](https://wpfusion.com/wp-content/uploads/2016/08/ontraport-webhook-1.jpg)

**Note:** The best rule triggers for webhooks are **_When Contact is added to a Tag_** or **_When a field is updated_**.

If you use the **_Contact is created_** trigger then the webhook will send as soon as you click the _Add Contact_ button, before you’ve entered any contact details. WP Fusion will then try to import an empty contact, and this will log an error.

#### [\#](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/\#inside-a-campaign-all-accounts) Inside a Campaign (all accounts)

You can also send a webhook as part of a campaign. The syntax is the same as when using a Rule. To add a webhook to a campaign, click Add New Item and choose _Send A Webhook_ from the Advanced pane.
...
#### [\#](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/\#create-a-new-user) Create a new user
...
#### [\#](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/#overview)
- [Using Rules (Ontraport Pro accounts)](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/#using-rules-ontraport-pro-accounts)
- [Inside a Campaign (all accounts)](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/#inside-a-campaign-all-accounts)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/ontraport-webhooks/#user-passwords)
