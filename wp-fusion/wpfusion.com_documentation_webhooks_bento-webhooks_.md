---
url: "https://wpfusion.com/documentation/webhooks/bento-webhooks/"
title: "Bento Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/bento-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/bento-webhooks/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/webhooks/bento-webhooks/\#setup) Setup

Navigate to Bento » Automate and create a new workflow to handle the webhook. Select a ‘Trigger’ (such as New Pageview).

[![](https://wpfusion.com/wp-content/uploads/2021/08/bento-webhook-trigger-1-1024x453.png)](https://wpfusion.com/wp-content/uploads/2021/08/bento-webhook-trigger-1.png)

Add an action and Select **Send Webhook**.

[![](https://wpfusion.com/wp-content/uploads/2021/08/bento-webhook-action-1024x467.png)](https://wpfusion.com/wp-content/uploads/2021/08/bento-webhook-action.png)
...
### [\#](https://wpfusion.com/documentation/webhooks/bento-webhooks/\#webhook-url-parameters) Webhook URL parameters
...
#### [\#](https://wpfusion.com/documentation/webhooks/bento-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/bento-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/bento-webhooks/\#create-a-new-user) Create a new user
...
#### [\#](https://wpfusion.com/documentation/webhooks/bento-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/bento-webhooks/#overview)
- [Setup](https://wpfusion.com/documentation/webhooks/bento-webhooks/#setup)
- [Webhook URL parameters](https://wpfusion.com/documentation/webhooks/bento-webhooks/#webhook-url-parameters)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/bento-webhooks/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/bento-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/bento-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/bento-webhooks/#user-passwords)

### You may also like

[![bento review features pricing connect with wordpress (complete guide)(1)](https://wpfusion.com/wp-content/uploads/2024/08/Bento-Review-Features_-Pricing_-Connect-With-WordPress-Complete-Guide1-300x150.jpg)](https://wpfusion.com/reviews/bento-review-features-pricing-connect-with-wordpress-complete-guide/)
...
#### [Bento Review: Features, Pricing, Connect With WordPress (Complete Guide)](https://wpfusion.com/reviews/bento-review-features-pricing-connect-with-wordpress-complete-guide/)

Bento is an email marketing & automation tool that offers a comprehensive suite of features to enhance customer engagement, optimize marketing campaigns, streamline workflows, and a lot more.
