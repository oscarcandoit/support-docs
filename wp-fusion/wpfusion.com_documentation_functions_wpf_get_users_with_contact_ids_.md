---
url: "https://wpfusion.com/documentation/functions/wpf_get_users_with_contact_ids/"
title: "wpf_get_users_with_contact_ids() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_users_with_contact_ids/#content)
...
# wpf\_get\_users\_with\_contact\_ids()
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_users_with_contact_ids/\#overview) Overview

This function retrieves an array of WordPress user IDs with a saved CRM contact ID.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_users_with_contact_ids/\#return) Return

_(array)_`$user_ids` The user IDs.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_users_with_contact_ids/\#get-an-array-of-users-with-contact-ids) Get an array of users with contact IDs
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_users_with_contact_ids/#overview)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_users_with_contact_ids/#return)
- [Get an array of users with contact IDs](https://wpfusion.com/documentation/functions/wpf_get_users_with_contact_ids/#get-an-array-of-users-with-contact-ids)
