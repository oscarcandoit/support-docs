---
url: "https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/"
title: "wpf_forms_apply_tags | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/#content)
...
### [\#](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/\#alternate-filters) Alternate filters
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/\#parameters) Parameters

- `$apply_tags` _(array)_: This is an array of tags that will be applied to the person who submitted the form
...
### [\#](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/\#apply-an-additional-tag-based-on-a-cookie) Apply an additional tag based on a cookie

This example checks to see if the person submitting the form came to the site via an [AffiliateWP](https://wpfusion.com/go/affiliatewp/) affiliate link, and is being tracked with the `affwp_ref`cookie. If so, the tag _Affiliate Tag_ is applied.
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/\#use-round-robin-assignment-for-leads) Use “Round Robin” assignment for leads

This example randomly assigns each lead a tag of either _Tag A, Tag B_ or _Tag C._ This is similar to the “Round Robin” owner assignment in sales CRMs like Infusionsoft, and can be used to randomly assign leads to a sales rep.
...
- [Overview](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/#overview)
- [Alternate filters](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/#alternate-filters)
- [Parameters](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/#parameters)
- [Examples](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/#examples)
- [Apply an additional tag based on a cookie](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/#apply-an-additional-tag-based-on-a-cookie)
- [Use "Round Robin" assignment for leads](https://wpfusion.com/documentation/filters/wpf_forms_apply_tags/#use-round-robin-assignment-for-leads)
