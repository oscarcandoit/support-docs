---
url: "https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/"
title: "wpf_salesforce_query_args | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/#content)
...
### [\#](https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/\#parameters) Parameters

- `$query_args` _(array)_: The query arguments
...
**Method: load\_contacts**

```php
array( "q" => "SELECT EntityId from TopicAssignment WHERE TopicId = '{$topic_id}'" );
```

### [\#](https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/\#use-a-custom-email-field-for-contact-lookups) Use a custom email field for contact lookups
...
- [Overview](https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/#overview)
- [Parameters](https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/#parameters)
- [Examples](https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/#examples)
- [Use a custom email field for contact lookups](https://wpfusion.com/documentation/filters/wpf_salesforce_query_args/#use-a-custom-email-field-for-contact-lookups)
