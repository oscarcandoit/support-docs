---
url: "https://wpfusion.com/documentation/functions/wpf_get_current_user_email/"
title: "wpf_get_current_user_email() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_current_user_email/#content)
...
# wpf\_get\_current\_user\_email()
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_current_user_email/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/functions/wpf_get_current_user_email/\#return) Return

_(mixed)_ A `string` of the users email address or `false` if nothing is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_current_user_email/\#get-the-current-users-email-address) Get the current user’s Email Address
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_current_user_email/#overview)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_current_user_email/#return)
- [Get the current user's Email Address](https://wpfusion.com/documentation/functions/wpf_get_current_user_email/#get-the-current-users-email-address)
