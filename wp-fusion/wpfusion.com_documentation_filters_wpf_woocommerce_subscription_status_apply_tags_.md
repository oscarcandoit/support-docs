---
url: "https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/"
title: "wpf_woocommerce_subscription_status_apply_tags | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/#content)
...
# wpf\_woocommerce\_subscription\_status\_apply\_tags
...
### [\#](https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/\#parameters) Parameters

- `$apply_tags`: This is an array of tags that will be applied to the customer
- `$status`: The current [subscription status](https://docs.woocommerce.com/document/subscriptions/statuses/) (i.e. _active, pending-cancel, on-hold)_
- `$subscription`: The subscription object

### [\#](https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/\#dont-apply-any-tags-when-a-subscription-status-changes-to-active) Don’t apply any tags when a subscription status changes to active
...
- [Overview](https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/#overview)
- [Parameters](https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/#parameters)
- [Examples](https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/#examples)
- [Don't apply any tags when a subscription status changes to active](https://wpfusion.com/documentation/filters/wpf_woocommerce_subscription_status_apply_tags/#dont-apply-any-tags-when-a-subscription-status-changes-to-active)
