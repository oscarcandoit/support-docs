---
url: "https://wpfusion.com/documentation/functions/wpf_is_field_active/"
title: "wpf_is_field_active() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_is_field_active/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_is_field_active/\#overview) Overview

This function checks if a WordPress meta key is enabled for sync with the CRM.

#### [\#](https://wpfusion.com/documentation/functions/wpf_is_field_active/\#parameters) Parameters

```php
wpf_is_field_active( $meta_key )
```

- `$meta_key` _(array) (Required)_: The meta key to check.

#### [\#](https://wpfusion.com/documentation/functions/wpf_is_field_active/\#return) Return

_(bool)_ Whether or not the field is active.

#### [\#](https://wpfusion.com/documentation/functions/wpf_is_field_active/\#check-if-a-meta-key-is-enabled) Check if a meta key is enabled
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_is_field_active/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/wpf_is_field_active/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_is_field_active/#return)
- [Check if a meta key is enabled](https://wpfusion.com/documentation/functions/wpf_is_field_active/#check-if-a-meta-key-is-enabled)
