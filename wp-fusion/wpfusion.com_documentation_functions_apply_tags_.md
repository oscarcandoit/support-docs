---
url: "https://wpfusion.com/documentation/functions/apply_tags/"
title: "apply_tags() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/apply_tags/#content)
...
### [\#](https://wpfusion.com/documentation/functions/apply_tags/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/functions/apply_tags/\#parameters) Parameters

```php
apply_tags( $tags, $user_id = false )
```

- `$tags` _(array) (Required)_: The array of tags to apply to a user.
- `$user_id` _(int) (Optional)_: The user ID to apply the tags to.

#### [\#](https://wpfusion.com/documentation/functions/apply_tags/\#return) Return

_(bool)_ The success status.

#### [\#](https://wpfusion.com/documentation/functions/apply_tags/\#apply-tags-to-the-current-user-infusionsoft-and-others-which-use-tag-ids) Apply tags to the current user (Infusionsoft and others which use tag IDs)
...
#### [\#](https://wpfusion.com/documentation/functions/apply_tags/\#apply-tags-to-the-current-user-activecampaign-and-others-which-dont-use-tag-ids) Apply tags to the current user (ActiveCampaign and others which don’t use tag IDs)
...
#### [\#](https://wpfusion.com/documentation/functions/apply_tags/\#apply-tags-to-a-specific-user-id) Apply tags to a specific user ID
...
- [Overview](https://wpfusion.com/documentation/functions/apply_tags/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/apply_tags/#parameters)
- [Return](https://wpfusion.com/documentation/functions/apply_tags/#return)
- [Apply tags to the current user (Infusionsoft and others which use tag IDs)](https://wpfusion.com/documentation/functions/apply_tags/#apply-tags-to-the-current-user-infusionsoft-and-others-which-use-tag-ids)
- [Apply tags to the current user (ActiveCampaign and others which don't use tag IDs)](https://wpfusion.com/documentation/functions/apply_tags/#apply-tags-to-the-current-user-activecampaign-and-others-which-dont-use-tag-ids)
- [Apply tags to a specific user ID](https://wpfusion.com/documentation/functions/apply_tags/#apply-tags-to-a-specific-user-id)
