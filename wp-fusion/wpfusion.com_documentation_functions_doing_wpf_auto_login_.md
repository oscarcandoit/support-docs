---
url: "https://wpfusion.com/documentation/functions/doing_wpf_auto_login/"
title: "doing_wpf_auto_login() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/doing_wpf_auto_login/#content)
...
### [\#](https://wpfusion.com/documentation/functions/doing_wpf_auto_login/\#overview) Overview

This function checks if the current session is an auto-login session.

#### [\#](https://wpfusion.com/documentation/functions/doing_wpf_auto_login/\#return) Return

_(bool)_ Whether the session is an auto-login session.

#### [\#](https://wpfusion.com/documentation/functions/doing_wpf_auto_login/\#checks-if-the-session-is-an-auto-login-session) Checks if the session is an auto-login session
...
- [Overview](https://wpfusion.com/documentation/functions/doing_wpf_auto_login/#overview)
- [Return](https://wpfusion.com/documentation/functions/doing_wpf_auto_login/#return)
- [Checks if the session is an auto-login session](https://wpfusion.com/documentation/functions/doing_wpf_auto_login/#checks-if-the-session-is-an-auto-login-session)
