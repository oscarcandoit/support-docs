---
url: "https://wpfusion.com/documentation/filters/wpf_redirect_url/"
title: "wpf_redirect_url | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/filters/wpf_redirect_url/#content)
...
### [\#](https://wpfusion.com/documentation/filters/wpf_redirect_url/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_redirect_url/\#parameters) Parameters

- `$redirect`: Represents the URL the user will be redirected to.
- `$post_id`: Post ID for the post being requested.

### [\#](https://wpfusion.com/documentation/filters/wpf_redirect_url/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/filters/wpf_redirect_url/\#send-logged-out-users-to-a-login-page-and-send-logged-in-users-to-upsell-pages-based-on-their-applied-tags) Send logged out users to a login page, and send logged-in users to upsell pages based on their applied tags
...
- [Overview](https://wpfusion.com/documentation/filters/wpf_redirect_url/#overview)
- [Parameters](https://wpfusion.com/documentation/filters/wpf_redirect_url/#parameters)
- [Examples](https://wpfusion.com/documentation/filters/wpf_redirect_url/#examples)
- [Send logged out users to a login page, and send logged-in users to upsell pages based on their applied tags](https://wpfusion.com/documentation/filters/wpf_redirect_url/#send-logged-out-users-to-a-login-page-and-send-logged-in-users-to-upsell-pages-based-on-their-applied-tags)
