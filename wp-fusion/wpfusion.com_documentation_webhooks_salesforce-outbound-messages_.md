---
url: "https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/"
title: "Salesforce Outbound Messages"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/\#getting-started) Getting started

First, head to _Workflow Actions_, in the Salesforce setup and an action of type _Outbound Message_.

[![](https://wpfusion.com/wp-content/uploads/2023/05/1.-Salesforce_Outbound_Message-1024x674.png)](https://wpfusion.com/wp-content/uploads/2023/05/1.-Salesforce_Outbound_Message.png)

For the Endpoint URL put the URL to your site, following the formats [described below](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/#webhook-url-formats). In this example we’re using the “update” method.

Give your outbound message a name and save it.

Then create a Flow in Salesforce by navigating to _Setup » Process Automation » Flows_.

[![](https://wpfusion.com/wp-content/uploads/2023/05/2.-Flow_Trigger-1024x679.png)](https://wpfusion.com/wp-content/uploads/2023/05/2.-Flow_Trigger.png)
...
[![](https://wpfusion.com/wp-content/uploads/2023/05/3.-Salesforce_Add_Action.png)](https://wpfusion.com/wp-content/uploads/2023/05/3.-Salesforce_Add_Action.png)

Add an action to your flow, and from the actions menu, select Outbound Message.

[![](https://wpfusion.com/wp-content/uploads/2023/05/4.-Salesforce_Flow_Action_Select_Existing_Outbound_Message-1024x749.png)](https://wpfusion.com/wp-content/uploads/2023/05/4.-Salesforce_Flow_Action_Select_Existing_Outbound_Message.png)
...
[![](https://wpfusion.com/wp-content/uploads/2018/09/salesforce-flow-debugger-1024x746.jpg)](https://wpfusion.com/wp-content/uploads/2018/09/salesforce-flow-debugger.jpg) The flow debugging tool lets you test each step in your flow with sample contact edits.

### [\#](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/\#webhook-url-options) Webhook URL options

#### [\#](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/\#create-a-new-user) Create a new user
...
#### [\#](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/#overview)
- [Getting started](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/#getting-started)
- [Webhook URL options](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/#webhook-url-options)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/salesforce-outbound-messages/#user-passwords)
