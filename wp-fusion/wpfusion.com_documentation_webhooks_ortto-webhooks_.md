---
url: "https://wpfusion.com/documentation/webhooks/ortto-webhooks/"
title: "Ortto Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/ortto-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/ortto-webhooks/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/webhooks/ortto-webhooks/\#setup) Setup

In Ortto, head to More » Data Sources and click **New Data Source**.

[![](https://wpfusion.com/wp-content/uploads/2023/03/ortto-webhooks-data-sources-1024x571.jpg)](https://wpfusion.com/wp-content/uploads/2023/03/ortto-webhooks-data-sources.jpg)

Enter the URL to your site, with the `access_key` and `wpf_action` parameters (see below).

[![](https://wpfusion.com/wp-content/uploads/2023/03/ortto-webhooks-1-1024x964.jpg)](https://wpfusion.com/wp-content/uploads/2023/03/ortto-webhooks-1.jpg)

You can un-check the setting for _Send activity payload_. Otherwise leave the settings as their defaults.

Finally, head to Campaigns and create a new campaign. Select a trigger, and from the list of actions choose your webhook.

[![](https://wpfusion.com/wp-content/uploads/2023/03/ortto-campaign-webhooks-1024x736.jpg)](https://wpfusion.com/wp-content/uploads/2023/03/ortto-campaign-webhooks.jpg)
...
### [\#](https://wpfusion.com/documentation/webhooks/ortto-webhooks/\#webhook-url-parameters) Webhook URL parameters
...
#### [\#](https://wpfusion.com/documentation/webhooks/ortto-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/ortto-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/ortto-webhooks/\#create-a-new-user) Create a new user
...
**Note:** By default, user accounts will be created with their email address as the username and a randomly generated password. However, if you have created a custom username field and password field in Ortto , and enabled these fields in WP Fusion for sync with `user_login` and `user_pass` on your website, the new users will be given the usernames and passwords stored in their Ortto contact record.

#### [\#](https://wpfusion.com/documentation/webhooks/ortto-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/ortto-webhooks/#overview)
- [Setup](https://wpfusion.com/documentation/webhooks/ortto-webhooks/#setup)
- [Webhook URL parameters](https://wpfusion.com/documentation/webhooks/ortto-webhooks/#webhook-url-parameters)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/ortto-webhooks/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/ortto-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/ortto-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/ortto-webhooks/#user-passwords)
