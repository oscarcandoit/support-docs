---
url: "https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/"
title: "wpf_event_tickets_attendee_data | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/#content)
...
# wpf\_event\_tickets\_attendee\_data
...
### [\#](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/\#parameters) Parameters

- `$update_data`: _(array)_ This is an array of key value pairs representing WordPress meta fields and their corresponding values.
...
### [\#](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/\#override-attendee-emails) Override attendee emails

This example overrides the email addresses of attendees to include the event name that the attendee registered for.

The email address synced to the CRM will then be formatted like email+{event\_name}@domain.com
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/\#sync-custom-event-fields) Sync custom event fields

This example registers a custom field for sync in the [Contact Fields settings](https://wpfusion.com/documentation/getting-started/syncing-contact-fields/), and then populates that field value based on a postmeta entry attached to the event ID, with field key `custom_field_key`.
...
- [Overview](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/#overview)
- [Parameters](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/#parameters)
- [Examples](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/#examples)
- [Override attendee emails](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/#override-attendee-emails)
- [Sync custom event fields](https://wpfusion.com/documentation/filters/wpf_event_tickets_attendee_data/#sync-custom-event-fields)
