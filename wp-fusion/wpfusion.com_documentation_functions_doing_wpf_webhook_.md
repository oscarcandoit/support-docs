---
url: "https://wpfusion.com/documentation/functions/doing_wpf_webhook/"
title: "doing_wpf_webhook() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/doing_wpf_webhook/#content)
...
### [\#](https://wpfusion.com/documentation/functions/doing_wpf_webhook/\#overview) Overview

This function checks if WP Fusion is handing a webhook.

#### [\#](https://wpfusion.com/documentation/functions/doing_wpf_webhook/\#return) Return

_(bool)_ Whether WP Fusion is currently handing a webhook.

#### [\#](https://wpfusion.com/documentation/functions/doing_wpf_webhook/\#check-if-wp-fusion-is-handing-a-webhook) Check if WP Fusion is handing a WebHook
...
- [Overview](https://wpfusion.com/documentation/functions/doing_wpf_webhook/#overview)
- [Return](https://wpfusion.com/documentation/functions/doing_wpf_webhook/#return)
- [Check if WP Fusion is handing a WebHook](https://wpfusion.com/documentation/functions/doing_wpf_webhook/#check-if-wp-fusion-is-handing-a-webhook)
