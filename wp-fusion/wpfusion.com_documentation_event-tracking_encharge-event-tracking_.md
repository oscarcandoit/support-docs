---
url: "https://wpfusion.com/documentation/event-tracking/encharge-event-tracking/"
title: "Encharge Event Tracking | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/event-tracking/encharge-event-tracking/#content)
...
### [\#](https://wpfusion.com/documentation/event-tracking/encharge-event-tracking/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/event-tracking/encharge-event-tracking/\#how-it-works) How it works
...
[![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-buddyboss-1024x961.jpg)](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-buddyboss.jpg) Syncing events from [BuddyBoss](https://wpfusion.com/documentation/membership/buddypress/#event-tracking) allows you to send additional details like the forum topic title, content, and group name (when someone joins a group).

Each event can contain a title, and any number of key/value pairs containing the event data.

[![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-woocommerce-multi-key-1024x990.jpg)](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-woocommerce-multi-key.jpg) In this example [WooCommerce](https://wpfusion.com/documentation/ecommerce/woocommerce/#event-tracking) product purchases and new orders are configured to send events to Omnisend.
...
[![](https://wpfusion.com/wp-content/uploads/2024/01/event-tracking-learndashuser-957x1024.jpg)](https://wpfusion.com/wp-content/uploads/2024/01/event-tracking-learndashuser-scaled.jpg) WP Fusion’s [event tracking with LearnDash](https://wpfusion.com/documentation/learning-management/learndash/#event-tracking) supports course progress and quiz attempts.
...
### [\#](https://wpfusion.com/documentation/event-tracking/encharge-event-tracking/\#how-it-looks) How it looks

Events are displayed in the activity timeline on Encharge subscriber records.

[![A subscriber record in Encharge showing events added by WP Fusion](https://wpfusion.com/wp-content/uploads/2024/05/encharge-events-timeline-1024x648.jpg)](https://wpfusion.com/wp-content/uploads/2024/05/encharge-events-timeline.jpg) Events from WordPress appear on the subscriber’s activity timeline in real time.
...
[![A screenshot showing the configuration of an event trigger in an Encharge flow.](https://wpfusion.com/wp-content/uploads/2024/05/ecnharge-event-triggers-1024x786.jpg)](https://wpfusion.com/wp-content/uploads/2024/05/ecnharge-event-triggers.jpg) Events can trigger Flows in Encharge. In this example an email is sent when a user completes the second lesson in the course.
...
- [Overview](https://wpfusion.com/documentation/event-tracking/encharge-event-tracking/#overview)
- [How it works](https://wpfusion.com/documentation/event-tracking/encharge-event-tracking/#how-it-works)
- [How it looks](https://wpfusion.com/documentation/event-tracking/encharge-event-tracking/#how-it-looks)
