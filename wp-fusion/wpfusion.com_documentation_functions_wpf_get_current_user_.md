---
url: "https://wpfusion.com/documentation/functions/wpf_get_current_user/"
title: "wpf_get_current_user() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_current_user/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_current_user/\#overview) Overview

This function works similarly to the [wp\_get\_current\_user function](https://developer.wordpress.org/reference/functions/wp_get_current_user/), but it will also work during [an auto-login session](https://wpfusion.com/documentation/tutorials/auto-login-links/).

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_current_user/\#return) Return

_(WP\_User)_ Returns a `WP_User` object or `false` if no user is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_current_user/\#get-the-current-user) Get the current user
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_current_user/#overview)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_current_user/#return)
- [Get the current user](https://wpfusion.com/documentation/functions/wpf_get_current_user/#get-the-current-user)
