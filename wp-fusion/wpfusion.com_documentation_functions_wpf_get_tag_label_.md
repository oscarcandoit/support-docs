---
url: "https://wpfusion.com/documentation/functions/wpf_get_tag_label/"
title: "wpf_get_tag_label() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_tag_label/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_tag_label/\#overview) Overview

This function retrieves the tag name of a given tag ID as a string, returning `false` if there is no name.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_tag_label/\#parameters) Parameters

```php
wpf_get_tag_label( $tag_id )
```

- `$tag_id` _(int) (Required)_: The tag id to get the label of.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_tag_label/\#return) Return

_(mixed)_ Returns a `string` of the tag label, or `false` if nothing is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_tag_label/\#get-a-tag-name) Get a tag name
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_tag_label/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/wpf_get_tag_label/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_tag_label/#return)
- [Get a tag name](https://wpfusion.com/documentation/functions/wpf_get_tag_label/#get-a-tag-name)
