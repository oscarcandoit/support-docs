---
url: "https://wpfusion.com/documentation/functions/wpf_get_field_type/"
title: "wpf_get_field_type() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_field_type/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_field_type/\#overview) Overview

This function retrieves the Field Type on the Contact Fields list for a given field.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_field_type/\#parameters) Parameters

```php
wpf_get_field_type( $meta_key, $default = 'text' )
```

- `$meta_key` _(string) (Required)_: The meta key to retrieve the field type of.
- `$default` _(string) (Optional)_: The default value to return if no type is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_field_type/\#return) Return

_(string)_ The field type.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_field_type/\#get-a-fields-field-type) Get a fields Field Type.

```php
$field_type = wpf_get_field_type( $meta_key );
```

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_field_type/\#get-a-fields-field-type-but-pass-a-string-if-no-field-type-is-found) Get a fields Field Type, but pass a string if no Field Type is found
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_field_type/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/wpf_get_field_type/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_field_type/#return)
- [Get a fields Field Type.](https://wpfusion.com/documentation/functions/wpf_get_field_type/#get-a-fields-field-type)
- [Get a fields Field Type, but pass a string if no Field Type is found](https://wpfusion.com/documentation/functions/wpf_get_field_type/#get-a-fields-field-type-but-pass-a-string-if-no-field-type-is-found)
