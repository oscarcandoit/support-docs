---
url: "https://wpfusion.com/documentation/functions/wpf_get_tag_id/"
title: "wpf_get_tag_id() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_tag_id/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_tag_id/\#overview) Overview

This function retrieves the tag ID of a given tag name as an integer, returning `false` if there is no ID.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_tag_id/\#parameters) Parameters

```php
wpf_get_tag_id( $tag_name )
```

- `$tag_name` _(string) (Required)_: The tag name to search.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_tag_id/\#return) Return

_(mixed)_ Returns a `string` of the tag ID, or `false` if nothing is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_tag_id/\#get-a-tag-id) Get a tag ID
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_tag_id/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/wpf_get_tag_id/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_tag_id/#return)
- [Get a tag ID](https://wpfusion.com/documentation/functions/wpf_get_tag_id/#get-a-tag-id)
