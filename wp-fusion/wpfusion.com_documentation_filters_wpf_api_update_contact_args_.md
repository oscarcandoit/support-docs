---
url: "https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/"
title: "wpf_api_update_contact_args | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/#content)
...
# wpf\_api\_update\_contact\_args
...
### [\#](https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/\#overview) Overview

This filter is run before WP Fusion syncs any custom field data to your CRM for an existing contact.

It can be used to modify the field data only in cases where a contact record already exists (as opposed to [wpf\_user\_update](https://wpfusion.com/documentation/filters/wpf_user_update/) which only runs for registered users, or [wpf\_woocommerce\_customer\_data](https://wpfusion.com/documentation/filters/wpf_woocommerce_customer_data/), which run for both new and existing contacts).

It runs after user meta keys have been mapped to CRM field keys, and all data has been formatted via the [wpf\_format\_field\_value](https://wpfusion.com/documentation/filters/wpf_format_field_value/) filter.

#### [\#](https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/\#parameters) Parameters

- `$args` _(array)_: The array of arguments being passed to the CRM API class.

  - `0` _(string)_: The CRM contact ID being updated.
  - `1` _(array)_: An associative array of CRM field keys and their values.

### [\#](https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/\#never-update-the-first-name-of-an-existing-contact-with-activecampaign) Never update the first name of an existing contact, with ActiveCampaign
...
- [Overview](https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/#overview)
- [Parameters](https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/#parameters)
- [Examples](https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/#examples)
- [Never update the first name of an existing contact, with ActiveCampaign](https://wpfusion.com/documentation/filters/wpf_api_update_contact_args/#never-update-the-first-name-of-an-existing-contact-with-activecampaign)
