...
[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
[**Which sender email should the leads be getting the emails from?**](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#Which-configured-sender-email-will-the-leads-be-getting-the-emails-from?)

**[How to check if the contacts are assigned or unassigned](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#How-to-check-if-the-contacts-are-assigned-or-unassigned)**

[**Places you can configure the sender email - Manual email**](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#Places-you-can-configure-the-sender-email---Manual-email)

- [Conversation tab](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#Conversation-tab)

[**Places you can configure the sender email - Automated emai** l](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#Places-you-can-configure-the-sender-email---Automated-email)

- [Email template](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#Email-template)
- [Bulk action - Send Email](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#Bulk-action---Send-Email)
- [Workflow Send Email Action](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#Workflow-Send-Email-Action)
- [Campaign configuration](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#Campaign-configuration)
- [Triggers - Send email action](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address#Triggers---Send-email-action)
...
0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/48000979925-sending-priority-from-name-address)
