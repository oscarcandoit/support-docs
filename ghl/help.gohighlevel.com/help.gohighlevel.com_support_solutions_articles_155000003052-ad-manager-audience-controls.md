---
url: "https://help.gohighlevel.com/support/solutions/articles/155000003052-ad-manager-audience-controls"
title: " Ad Manager: Audience controls : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/155000003052-ad-manager-audience-controls#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/155000003052-ad-manager-audience-controls#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
Modified on: Sun, 1 Dec, 2024 at 4:21 PM
...
- [Where to find Audience Controls in Ad Manager campaign creation process?](https://help.gohighlevel.com/support/solutions/articles/155000003052-ad-manager-audience-controls#Where-to-find-Audience-Controls-in-Ad-Manager-campaign-creation-process?)
- [How to include/exclude geographic location as part of the target audience group?](https://help.gohighlevel.com/support/solutions/articles/155000003052-ad-manager-audience-controls#How-to-include/exclude-geographic-location-as-part-of-the-target-audience-group?)
- [What are the different types of Intended Audiences categories and how can one use them?](https://help.gohighlevel.com/support/solutions/articles/155000003052-ad-manager-audience-controls#What-are-the-different-types-of-Intended-Audiences-categories-and-how-can-one-use-them?)
...
1. Budget - Refer [https://help.gohighlevel.com/support/solutions/articles/155000003050-ad-manager-campaign-budget-definition](https://help.gohighlevel.com/support/solutions/articles/155000003050-ad-manager-campaign-budget-definition) for a detailed understanding on budget definition.
...
1. ```
Up to 15 lookalike and 15 retargeting audiences can be selected from the respective dropdown.
```

2. ```
The ready and not ready state of the audience in the dropdown refers to their eligibility to be used as an audience to draw enough traction for the ad campaign. If state is "Ready" audience can be selected and will give satisfactory results and if the status of any audience is "Not Ready" we do not allow that to be selected as designed by Facebook and the reason on why it cannot be selected will be shown as a tooltip next to it.
```

3. ```
Combination of all three or any two intended audiences can also be used for a campaign but it is not advised as it will narrow down the audience size considerably resulting in undesired turnaround.
```
...
- [Create custom audiences in Ad Manager](https://help.gohighlevel.com/support/solutions/articles/155000003236-create-custom-audiences-in-ad-manager)
- [Pump Up Your Gym Memberships: Master Local Ads](https://help.gohighlevel.com/support/solutions/articles/155000004952-pump-up-your-gym-memberships-master-local-ads)

**X**

0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/155000003052-ad-manager-audience-controls)

[Home](https://help.gohighlevel.com/support/home) [Knowledge base](https://help.gohighlevel.com/support/solutions)![Article views count](https://help.gohighlevel.com/support/solutions/articles/155000003052-ad-manager-audience-controls/hit)