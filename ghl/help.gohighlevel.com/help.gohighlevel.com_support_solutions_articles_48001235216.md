---
url: "https://help.gohighlevel.com/support/solutions/articles/48001235216"
title: " How to Set Up Two Way Email Sync for Gmail : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/48001235216#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/48001235216#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
Modified on: Wed, 2 Jul, 2025 at 10:20 AM
...
Gmail Two-Way Sync must be set up from within a sub-account, not at the agency dashboard level. You must either be logged into the sub-account directly or use the “Login As” feature from the agency view to access the sub-account. This ensures the Gmail connection applies to conversations inside the correct CRM location.
```
...
#### **[What is Gmail Two way sync?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#What-is-Gmail-Two-way-sync?)**

#### **[Steps to connect](https://help.gohighlevel.com/support/solutions/articles/48001235216\#Steps-to-connect)**

#### **[How does the 2-way sync work between the CRM and your email account?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#How-does-the-2-way-sync-work-between-the-CRM-and-your-email-account?)**

#### [**Other functionalities**](https://help.gohighlevel.com/support/solutions/articles/48001235216\#Other-functionalities)

#### [Update Email:](https://help.gohighlevel.com/support/solutions/articles/48001235216\#Update-Email%3A%C2%A0)

#### [Disconnect Email:](https://help.gohighlevel.com/support/solutions/articles/48001235216\#Disconnect-Email%3A%C2%A0)

#### [BCC Address](https://help.gohighlevel.com/support/solutions/articles/48001235216\#Auto-Bcc-Sync)

#### [Does Two-way sync only work with individual emails or bulk emails and workflows?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#Does-Two-way-sync-only-work-with-individual-emails-or-bulk-emails-and-workflows?)

#### [**FAQs**](https://help.gohighlevel.com/support/solutions/articles/48001235216\#FAQs)

#### [What happens to emails received from existing contacts?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#What-happens-to-emails-received-from-existing-contacts?)

#### [Will removing a synced account delete existing emails?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#Will-removing-a-synced-account-delete-existing-emails?)

#### [Do new emails get synced after an account is removed?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#Do-new-emails-get-synced-after-an-account-is-removed?)

#### [Will all my existing contacts in Gmail be synced with the CRM?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#Will-all-my-existing-contacts-in-Gmail-be-synced-with-the-CRM?)

#### [What happens when a new email is received from a contact?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#What-happens-when-a-new-email-is-received-from-a-contact?)

#### [What happens to sent emails from the CRM or Gmail?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#What-happens-to-sent-emails-from-the-CRM-or-Gmail?)

#### [How are cc/bcc recipients handled in the sync?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#How-are-cc/bcc-recipients-handled-in-the-sync?)

#### [What if a contact emails someone else but includes the CRM user?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#What-if-a-contact-emails-someone-else-but-includes-the-CRM-user?)

#### [How is the conversation thread managed when multiple recipients are involved?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#How-is-the-conversation-thread-managed-when-multiple-recipients-are-involved?)

#### [What if the same contact exists in multiple locations for the same synced email address?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#What-if-the-same-contact-exists-in-multiple-locations-for-the-same-synced-email-address?)

#### [What is Auto Bcc Sync, and how does it work?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#What-is-Auto-Bcc-Sync,-and-how-does-it-work?)

#### [How is the secure connection handled if Gmail login credentials change?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#How-is-the-secure-connection-handled-if-Gmail-login-credentials-change?)

#### [What happens when an email is forwarded from Gmail?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#What-happens-when-an-email-is-forwarded-from-Gmail?)

#### [What if there are duplicate emails with multiple contacts?](https://help.gohighlevel.com/support/solutions/articles/48001235216\#What-if-there-are-duplicate-emails-with-multiple-contacts?)
...
## **Steps to Setup the Two Way Gmail Sync**

```
Note: You will only see the Profile tab if you are added to the sub account for which you are viewing at that time. You can also use the Login As Feature to login as a user of that sub account to access the Profile tab.
```

### **Step 1:** Navigate to Email 2-Way Sync

1. Click on **Settings** from your sub-account.



![](https://jumpshare.com/v/7Yb8LGJ3LSFo2USuXU9A+/Screen+Shot+2025-07-02+at+7.58.18+PM.png)

2. Click on **My Profile** tab.



![](https://jumpshare.com/v/92XmJ3ntxlcA7hDNtzh5+/Screen+Shot+2025-07-02+at+7.59.57+PM.png)

3. Scroll down to the **Email (2-way Sync)** section.

4. Select **Gmail** and click on the **Connect** button.



![](https://jumpshare.com/v/QX3Wp9qahXn19tO9N2RF+/GIF+Recording+2025-07-02+at+7.54.29+PM.gif)


### **Step 2:** Connect Gmail Account

## 1. When prompted, select an **existing Gmail account** from your browser or **connect a new one**.             ![](https://jumpshare.com/v/pyfsQ5yCK84VSJVlqYrl+/Screen+Shot+2025-07-02+at+8.12.03+PM.png)     2. Review the permission request from LeadConnector and click on **Continue**.             ![](https://jumpshare.com/v/3Fc5qPd96ToyGYIXqsVG+/Screen+Shot+2025-07-02+at+8.15.06+PM.png)     3. Review access request and click on **Allow**.             ![](https://jumpshare.com/v/hM5TOUUORZy9NJL4LzRA+/Screen+Shot+2025-07-02+at+8.20.01+PM.png)     4. After completing the steps, your selected **Gmail account will appear under the Email Two-Way Sync** tab.             ![](https://jumpshare.com/v/ht8e2lZdUhloQsIBkHeB+/Screen+Shot+2025-07-02+at+8.32.10+PM.png)                     **How does the 2-way sync work between the CRM and your email account?**
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/48287100704/original/n1NZvUej6xWS0WzV2yaUOKHk26_hCz7Q_w.png?1678792018)
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/48287100962/original/TLimKgIGciSFjVlNRy0jRHtoAQdktaxIpA.png?1678792076)
...
- [Two Way Email Sync for Outlook](https://help.gohighlevel.com/support/solutions/articles/48001229663-two-way-email-sync-for-outlook)
- [Email Failure: Insufficient Permission for 2-Way Sync](https://help.gohighlevel.com/support/solutions/articles/155000006053-email-failure-insufficient-permission-for-2-way-sync)
- [Conversations FAQs](https://help.gohighlevel.com/support/solutions/articles/155000002741-conversations-faqs)

**X**

0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/48001235216)

[Home](https://help.gohighlevel.com/support/home) [Knowledge base](https://help.gohighlevel.com/support/solutions)![Article views count](https://help.gohighlevel.com/support/solutions/articles/48001235216-how-to-set-up-two-way-email-sync-for-gmail/hit)