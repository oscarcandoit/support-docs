---
url: "https://docs.gravityforms.com/resetting-results/"
title: "Resetting Gravity Forms Results"
---
...
- [Summary](https://docs.gravityforms.com/resetting-results/#h-summary)
- [Reset by Deleting Entries](https://docs.gravityforms.com/resetting-results/#h-reset-by-deleting-entries)
- [Reset by Deleting the Field](https://docs.gravityforms.com/resetting-results/#h-reset-by-deleting-the-field)
- [Example Animations](https://docs.gravityforms.com/resetting-results/#h-example-animations)

## Summary

Results for [Polls](https://docs.gravityforms.com/using-the-polls-add-on/), [Quizzes](https://docs.gravityforms.com/using-quiz-add-on/), and [Surveys](https://docs.gravityforms.com/using-the-survey-add-on/) are calculated when needed using form entry data. This means to reset your results, you cannot just reset a counter, but you must delete the entry data associated with the fields of your Results type.
...
You can trash entries via the [Entry detail page](https://docs.gravityforms.com/entry-detail/), or you can trash either individual entries, or entries in bulk, via the [Entry list page](https://docs.gravityforms.com/entries/). See the [short animation](https://docs.gravityforms.com/resetting-results/#h-example-animations) at bottom.

Consider [exporting your entries](https://docs.gravityforms.com/exporting-form-entries/) **before deletion** if you would like to keep a copy the existing data, just in case!
...
Short animation showing the effect of bulk deleting entries on the Poll results.Short animation showing the effect of deleting the poll field on the Poll results.
...
[Algolia](https://docs.gravityforms.com/resetting-results/# "Algolia")
