---
url: "https://docs.gravityforms.com/quiz-merge-tags/"
title: "Quiz Merge Tags - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Quiz Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/quiz-add-on/)    - [{quiz\_passfail} Merge Tag](https://docs.gravityforms.com/quiz_passfail-merge-tag/ "{quiz_passfail} Merge Tag")
    ...
    - [Setting up a Quiz Field](https://docs.gravityforms.com/setup-the-quiz-add-on/ "Setting up a Quiz Field")
    - [Configure Quiz Settings](https://docs.gravityforms.com/configure-quiz-settings/ "Configure Quiz Settings")
    - [Using the Quiz Add-On](https://docs.gravityforms.com/using-quiz-add-on/ "Using the Quiz Add-On")
    - [Viewing Quiz Results](https://docs.gravityforms.com/viewing-quiz-results/ "Viewing Quiz Results")
    - [Quiz Scoring](https://docs.gravityforms.com/quiz-scoring/ "Quiz Scoring")
    - [Quiz Merge Tags](https://docs.gravityforms.com/quiz-merge-tags/ "Quiz Merge Tags")
    - [Quiz Add-On Changelog](https://docs.gravityforms.com/quiz-change-log/ "Quiz Add-On Changelog")
...
- [List of Quiz Merge Tags](https://docs.gravityforms.com/quiz-merge-tags/#h-list-of-quiz-merge-tags)
- [Where are Merge Tags Used?](https://docs.gravityforms.com/quiz-merge-tags/#h-where-are-merge-tags-used)

## List of Quiz Merge Tags

The Quiz Add-On introduces several new Gravity Forms [Merge Tags](https://docs.gravityforms.com/category/user-guides/merge-tags-getting-started/) that can be used anywhere within Gravity Forms where merge tags are supported.

| Tag | Description |
| --- | --- |
| **[{all\_quiz\_results}](https://docs.gravityforms.com/all_quiz_results-merge-tag/)** | Displays the results of all Quiz Fields that exist in the form. |
| **[{quiz\_score}](https://docs.gravityforms.com/quiz_score-merge-tag/)** | Displays the total score for the quiz. The score is affected by [weighted scoring](https://docs.gravityforms.com/weighted-quiz-scoring/). |
| **[{quiz\_percent}](https://docs.gravityforms.com/quiz_percent-merge-tag/)** | Displays the percentage score the user achieved. This is affected by [weighted scoring](https://docs.gravityforms.com/weighted-quiz-scoring/). |
| **[{](https://docs.gravityforms.com/?p=29462) [quiz\_grade](https://docs.gravityforms.com/quiz_grade-merge-tag/) [}](https://docs.gravityforms.com/quiz_passfail-merge-tag/)** | Displays the Grade the user achieved based on Letter Grading configured in the Quiz Settings. |
| **[{quiz\_passfail}](https://docs.gravityforms.com/quiz_passfail-merge-tag/)** | Displays either Passed or Failed based on the Pass/Fail settings configured in the Quiz Settings. |
| **[{quiz:id=x}](https://docs.gravityforms.com/quiz-merge-tag/)** | Displays the specific quiz question along with your answer and the correct answer |

## Where are Merge Tags Used?

Merge Tags can be used:

- in form [Confirmation](https://docs.gravityforms.com/configuring-confirmations/) messages
- in form [Notification](https://docs.gravityforms.com/configuring-notifications-in-gravity-forms/) messages
- in the [Quiz Confirmation messages](https://docs.gravityforms.com/configure-quiz-settings/#h-grading-settings)

[![](https://docs.gravityforms.com/wp-content/uploads/2022/01/CleanShot-2022-01-18-at-14.42.01.png)](https://docs.gravityforms.com/wp-content/uploads/2022/01/CleanShot-2022-01-18-at-14.42.01.png)

[![](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-22-at-15.33.42.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-22-at-15.33.42.png)
...
[Algolia](https://docs.gravityforms.com/quiz-merge-tags/# "Algolia")
