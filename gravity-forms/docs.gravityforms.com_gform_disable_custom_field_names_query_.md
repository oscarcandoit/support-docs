---
url: "https://docs.gravityforms.com/gform_disable_custom_field_names_query/"
title: "gform_disable_custom_field_names_query - Gravity Forms Documentation"
---
...
# gform\_disable\_custom\_field\_names\_query

- [Description](https://docs.gravityforms.com/gform_disable_custom_field_names_query/#h-description)
- [Usage](https://docs.gravityforms.com/gform_disable_custom_field_names_query/#h-usage)
- [Example](https://docs.gravityforms.com/gform_disable_custom_field_names_query/#h-example)
- [Placement](https://docs.gravityforms.com/gform_disable_custom_field_names_query/#h-placement)
- [Since](https://docs.gravityforms.com/gform_disable_custom_field_names_query/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_disable_custom_field_names_query/#h-source-code)
...
**Note:** If your form has a post [custom field](https://docs.gravityforms.com/post-custom/) and you enable this filter, you won’t be able to map it to a custom field.
...
- **$disable\_query** [boolean](https://docs.gravityforms.com/boolean)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_disable_custom_field_names_query'``,``'disable_query'``, 10, 1 );`<br>`function``disable_query(``$disable_query``) {`<br>```return``true;`<br>`}` |
...
This filter is located in GFFormsModel::get\_custom\_field\_names() in _forms\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_disable_custom_field_names_query/# "Algolia")
