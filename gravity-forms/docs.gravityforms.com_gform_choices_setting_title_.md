---
url: "https://docs.gravityforms.com/gform_choices_setting_title/"
title: "gform_choices_setting_title - Gravity Forms Documentation"
---
...
# gform\_choices\_setting\_title

- [Description](https://docs.gravityforms.com/gform_choices_setting_title/#h-description)
- [Usage](https://docs.gravityforms.com/gform_choices_setting_title/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_choices_setting_title/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_choices_setting_title/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_choices_setting_title/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_choices_setting_title/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_choices_setting_title'``,``'change_title'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_choices_setting_title'``,``'change_title'``);`<br>`function``change_title(``$title``) {`<br>```return``'My Custom Title'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_choices_setting_title/# "Algolia")
