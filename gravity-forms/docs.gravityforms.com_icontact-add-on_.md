---
url: "https://docs.gravityforms.com/icontact-add-on/"
title: "Setting Up the iContact Add-On - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [iContact Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/icontact-add-on/)    - [Setting Up the iContact Add-On](https://docs.gravityforms.com/icontact-add-on/ "Setting Up the iContact Add-On")
    - [Creating a Feed for the iContact Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-icontact-add-on/ "Creating a Feed for the iContact Add-On")
    - [iContact Changelog](https://docs.gravityforms.com/icontact-change-log/ "iContact Changelog")
...
- [Pre-Requisites](https://docs.gravityforms.com/icontact-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/icontact-add-on/#h-setup)
- [Creating an iContact Application ID](https://docs.gravityforms.com/icontact-add-on/#h-creating-an-icontact-application-id)
- [Add-on Framework Hooks](https://docs.gravityforms.com/icontact-add-on/#h-add-on-framework-hooks)
...
- An [iContact](https://www.icontact.com/) account
...
4. Enter your **Application ID**, **Account Username**, **and API Password**. These are obtained from iContact. See below for [instructions on how to create an application ID](https://docs.gravityforms.com/icontact-add-on/#creating-an-icontact-application-id).
...
[![Image showing iContact Settings.](https://docs.gravityforms.com/wp-content/uploads/2024/12/image-1024x603.png)](https://docs.gravityforms.com/wp-content/uploads/2024/12/image.png)

### Creating an iContact Application ID

1. Visit iContact’s [application registration page.](https://app.icontact.com/icp/core/registerapp/)
...
Once you have entered your API information, you’re ready to begin [creating a feed for the iContact Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-icontact-add-on/).

## Add-on Framework Hooks

Because the iContact Add-On is built using the [Add-On Framework](https://docs.gravityforms.com/category/developers/php-api/add-on-framework) it also inherits any hooks available in the framework methods it uses such as:

- [gform\_short\_slug\_field\_value](https://docs.gravityforms.com/gform_short_slug_field_value) for changing a field value before it is passed to iContact.
...
[Algolia](https://docs.gravityforms.com/icontact-add-on/# "Algolia")
