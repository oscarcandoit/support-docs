---
url: "https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/"
title: "gform_display_field_select_columns_entry_list - Gravity Forms"
---
...
# gform\_display\_field\_select\_columns\_entry\_list

- [Description](https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/#h-description)
- [Usage](https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/#h-placement)
- [Since](https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_display_field_select_columns_entry_list'``,``'your_function_name'``, 10, 3 );` |

To target a specific form, append the form id to the hook name. (format: gform\_display\_field\_select\_columns\_entry\_list\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_display_field_select_columns_entry_list_1'``,``'your_function_name'``, 10, 3 );` |

To target a specific form’s field, append the form id and field id to the hook name. (format: gform\_display\_field\_select\_columns\_entry\_list\_FORMID\_FIELDID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_display_field_select_columns_entry_list_1_1'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$display** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_display_field_select_columns_entry_list'``,``'show_hide_fields'``, 10, 3 );`<br>`function``show_hide_fields(``$display``,``$field``,``$form``){`<br>```if``(``$field``[``'id'``] == 4 ){`<br>```return``true;`<br>```}`<br>```return``false;`<br>`}` |
...
This filter is located in GFSelectColumns::select\_columns\_page() in _gravityforms/select\_columns.php_.
...
[Algolia](https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/# "Algolia")
