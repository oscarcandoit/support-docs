---
url: "https://docs.gravityforms.com/gform_activecampaign_tags/"
title: "gform_activecampaign_tags - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_activecampaign_tags/#h-description)
- [Usage](https://docs.gravityforms.com/gform_activecampaign_tags/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_activecampaign_tags/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_activecampaign_tags/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_activecampaign_tags/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_activecampaign_tags/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_activecampaign_tags/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_activecampaign_tags'``,``'your_function_name'``, 10, 4 );` |

Applies to a specific form:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_activecampaign_tags_4'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$tags** [array](https://docs.gravityforms.com/array)
The current tags.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_activecampaign_tags'``,``function``(``$tags``,``$feed``,``$entry``,``$form``) {`<br>`$tags``[] =``'some tag'``;`<br>`return``$tags``;`<br>`}, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_activecampaign_tags'``,``$form``[``'id'``],``$tags``,``$feed``,``$entry``,``$form``);` |
...
[Algolia](https://docs.gravityforms.com/gform_activecampaign_tags/# "Algolia")
