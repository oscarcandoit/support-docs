---
url: "https://docs.gravityforms.com/gform_preview_init/"
title: "gform_preview_init - Gravity Forms Documentation"
---
...
# gform\_preview\_init

- [Description](https://docs.gravityforms.com/gform_preview_init/#h-description)
- [Usage](https://docs.gravityforms.com/gform_preview_init/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_preview_init/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_preview_init/#h-examples)
- [Since](https://docs.gravityforms.com/gform_preview_init/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_preview_init/#h-source-code)

## Description

The “gform\_preview\_init” action is triggered when the form preview page loads, allowing further actions to be done.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_preview_init'``,``'my_function'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `function``my_function() {`<br>```// Do something here`<br>`}`<br>`add_action(``'gform_preview_init'``,``'my_function'``);` |
...
[Algolia](https://docs.gravityforms.com/gform_preview_init/# "Algolia")
