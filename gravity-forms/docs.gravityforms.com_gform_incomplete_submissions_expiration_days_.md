---
url: "https://docs.gravityforms.com/gform_incomplete_submissions_expiration_days/"
title: "gform_incomplete_submissions_expiration_days - Gravity Forms"
---
...
# gform\_incomplete\_submissions\_expiration\_days

- [Description](https://docs.gravityforms.com/gform_incomplete_submissions_expiration_days/#h-description)
- [Usage](https://docs.gravityforms.com/gform_incomplete_submissions_expiration_days/#h-usage)
- [Example](https://docs.gravityforms.com/gform_incomplete_submissions_expiration_days/#h-example)
- [Placement](https://docs.gravityforms.com/gform_incomplete_submissions_expiration_days/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_incomplete_submissions_expiration_days/#h-source-code)

## Description

Overrides the number of days until incomplete submissions are purged from the database.

**Note:** Using this filter does not change the value displayed in the save and continue confirmation and notification messages. You would need to manually update those messages in the [Confirmations](https://docs.gravityforms.com/configuring-confirmations/) and [Notifications](https://docs.gravityforms.com/configuring-notifications-in-gravity-forms/) areas of the Form Settings.
...
- **$expiration\_days** [int](https://docs.gravityforms.com/int)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_incomplete_submissions_expiration_days'``,``'change_incomplete_submissions_expiration_days'``);`<br>`function``change_incomplete_submissions_expiration_days(``$expiration_days``) {`<br>```GFCommon::log_debug(``'gform_incomplete_submissions_expiration_days: running.'``);`<br>```$expiration_days``= 90;`<br>```return``$expiration_days``;`<br>`}` |

## Placement

This code should be placed in the [functions.php](http://codex.wordpress.org/Theme_Development#Functions_File) file of your active theme or within its own plugin.
...
[Algolia](https://docs.gravityforms.com/gform_incomplete_submissions_expiration_days/# "Algolia")
