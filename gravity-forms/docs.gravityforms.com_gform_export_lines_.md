---
url: "https://docs.gravityforms.com/gform_export_lines/"
title: "gform_export_lines - Gravity Forms Documentation"
---
...
# gform\_export\_lines

- [Description](https://docs.gravityforms.com/gform_export_lines/#h-description)
- [Usage](https://docs.gravityforms.com/gform_export_lines/#h-usage)
- [Example](https://docs.gravityforms.com/gform_export_lines/#h-example)
- [Placement](https://docs.gravityforms.com/gform_export_lines/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_export_lines/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_export_lines/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_export_lines'``,``'your_function_name'``);` |

## Parameters

- **$lines** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_export_lines'``,``'fix_csv_entry_export'``);`<br>`function``fix_csv_entry_export (``$lines``) {`<br>`return``mb_convert_encoding(``$lines``,``'UTF-16LE'``,``'UTF-8'``);`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `$lines``= apply_filters(``'gform_export_lines'``,``$lines``);` |
...
[Algolia](https://docs.gravityforms.com/gform_export_lines/# "Algolia")
