---
url: "https://docs.gravityforms.com/gform_temp_file_expiration_days/"
title: "gform_temp_file_expiration_days - Gravity Forms Documentation"
---
...
# gform\_temp\_file\_expiration\_days

- [Description](https://docs.gravityforms.com/gform_temp_file_expiration_days/#h-description)
- [Usage](https://docs.gravityforms.com/gform_temp_file_expiration_days/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_temp_file_expiration_days/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_temp_file_expiration_days/#h-example)
- [Placement](https://docs.gravityforms.com/gform_temp_file_expiration_days/#h-placement)
- [Since](https://docs.gravityforms.com/gform_temp_file_expiration_days/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_temp_file_expiration_days/#h-source-code)

## Description

The gform\_temp\_file\_expiration\_days filter can be used to override the number of days before temporary file uploads are deleted.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_temp_file_expiration_days'``,``'your_function_name'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_temp_file_expiration_days'``,``'temp_file_expiration_days'``);`<br>`function``temp_file_expiration_days(``$expiration_days``) {`<br>```$expiration_days``= 90;`<br>```return``$expiration_days``;`<br>`}` |
...
This filter is located in GFFormDisplay::clean\_up\_files() in _form\_display.php_.
...
[Algolia](https://docs.gravityforms.com/gform_temp_file_expiration_days/# "Algolia")
