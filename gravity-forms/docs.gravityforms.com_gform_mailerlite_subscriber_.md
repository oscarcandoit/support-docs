---
url: "https://docs.gravityforms.com/gform_mailerlite_subscriber/"
title: "gform_mailerlite_subscriber - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [MailerLite Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/mailerlite-filters/)          - [MailerLite Feed Meta](https://docs.gravityforms.com/mailerlite-feed-meta/ "MailerLite Feed Meta")
          - [gform\_mailerlite\_subscriber](https://docs.gravityforms.com/gform_mailerlite_subscriber/ "gform_mailerlite_subscriber")
...
# gform\_mailerlite\_subscriber

- [Description](https://docs.gravityforms.com/gform_mailerlite_subscriber/#h-description)
- [Usage](https://docs.gravityforms.com/gform_mailerlite_subscriber/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_mailerlite_subscriber/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_mailerlite_subscriber/#h-examples)
- [Unsubscribe a contact based on the feed name being processed.](https://docs.gravityforms.com/gform_mailerlite_subscriber/#h-unsubscribe-a-contact-based-on-the-feed-name-being-processed)
- [Placement](https://docs.gravityforms.com/gform_mailerlite_subscriber/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_mailerlite_subscriber/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_mailerlite_subscriber/#h-since)

## Description

Allows the subscriber properties to be overridden before the update request is made. Refer to the [MailerLite API docs](https://developers.mailerlite.com/docs/subscribers.html#create-upsert-subscriber) for more information about available subscriber properties
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mailerlite_subscriber'``,``'your_function_name'``, 10, 5 );` |

To target a specific form, append the form id to the hook name. (format: gform\_mailerlite\_subscriber\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mailerlite_subscriber_123'``,``'your_function_name'``, 10, 5 );` |
...
- **$existing\_subscriber** [array](https://docs.gravityforms.com/array/)
...
- **$form** [Form Object](https://docs.gravityforms.com/array/)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11 | `// Unsubscribe a contact based on feed name being processed`<br>`add_filter(``'gform_mailerlite_subscriber'``,``function``(``$subscriber``,``$existing_subscriber``,``$feed``,``$form``,``$entry``) {`<br>``<br>```if``( rgars(``$feed``,``'meta/feedName'``) ==``'Unsubscribe the Contact'``) {``// Replace 'Unsubscribe the Contact' with your feed name.`<br>```gf_mailerlite()->log_debug(``'Sending unsubscribe request'``);`<br>```$subscriber``[``'status'``] =``'unsubscribed'``;`<br>```}`<br>``<br>```return``$subscriber``;`<br>``<br>`}, 10, 5 );` |
...
[Algolia](https://docs.gravityforms.com/gform_mailerlite_subscriber/# "Algolia")
