---
url: "https://docs.gravityforms.com/gform_field_choices/"
title: "gform_field_choices - Gravity Forms Documentation"
---
...
# gform\_field\_choices

- [Description](https://docs.gravityforms.com/gform_field_choices/#h-description)
- [Usage](https://docs.gravityforms.com/gform_field_choices/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_field_choices/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_field_choices/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_field_choices/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_field_choices/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_field_choices'``,``'form_submit_button'``, 10, 2 );` |

## Parameters

- **$choices** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1 | `<option>Item 1</option><option>Item 2</option>` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_field_choices'``,``'decode_specialchars'``, 10, 2 );`<br>`function``decode_specialchars(``$choices``,``$field``) {`<br>`$choices``= htmlspecialchars_decode(``$choices``);`<br>`return``$choices``;`<br>`}` |
...
- GF\_Field\_Checkbox::get\_checkbox\_choices() in _includes/fields/class-gf-field-checkbox.php_
- GF\_Field\_Radio::get\_radio\_choices() in _includes/fields/class-gf-field-radio.php_
...
[Algolia](https://docs.gravityforms.com/gform_field_choices/# "Algolia")
