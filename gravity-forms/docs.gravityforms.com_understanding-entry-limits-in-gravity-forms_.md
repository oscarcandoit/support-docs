---
url: "https://docs.gravityforms.com/understanding-entry-limits-in-gravity-forms/"
title: "Understanding Entry Limits in Gravity Forms - Gravity Forms Documentation"
---
...
- [Entry Limit Settings](https://docs.gravityforms.com/understanding-entry-limits-in-gravity-forms/#h-entry-limit-settings)
- [How Entry Counting Works](https://docs.gravityforms.com/understanding-entry-limits-in-gravity-forms/#h-how-entry-counting-works)
- [Examples](https://docs.gravityforms.com/understanding-entry-limits-in-gravity-forms/#h-examples)
- [Limit entries per day with a custom HTML entry limit message.](https://docs.gravityforms.com/understanding-entry-limits-in-gravity-forms/#h-limit-entries-per-day-with-a-custom-html-entry-limit-message)
- [Settings Reference](https://docs.gravityforms.com/understanding-entry-limits-in-gravity-forms/#h-settings-reference)
- [Resources](https://docs.gravityforms.com/understanding-entry-limits-in-gravity-forms/#h-resources)

The Entry Limit feature in [Form Settings](https://docs.gravityforms.com/form-settings/#h-restrictions) allows you to restrict the number of submissions a form can receive.
...
| Entry Status | Counts Toward Limit |
| --- | --- |
| **“Processing” payment status** | Yes |
| **“Failed” payment status** | Yes |
| **“Pending” payment status** | Yes |
| **“Refunded” payment status** | Yes |
| **“Pending” user registration status** | Yes |
| **“Approved” user registration status** | Yes |
| **Spam entries** | No |
| **Trash entries** | No |
| **Partial Entries** | No |
...
[![Image custom entry limit message with HTML format.](https://docs.gravityforms.com/wp-content/uploads/2025/04/image-21-1024x508.png)](https://docs.gravityforms.com/wp-content/uploads/2025/04/image-21.png)[![Image showing inactive form with custom limit message.](https://docs.gravityforms.com/wp-content/uploads/2025/04/image-22-1024x508.png)](https://docs.gravityforms.com/wp-content/uploads/2025/04/image-22.png)

## Settings Reference

[![Image showing Limit number of entries setting](https://docs.gravityforms.com/wp-content/uploads/2025/04/image-19-1024x353.png)](https://docs.gravityforms.com/wp-content/uploads/2025/04/image-19.png)

| Setting | Description |
| --- | --- |
| **Number of Entries** | Set the maximum number of entries allowed. This can be a total limit or per time period. |
| **Time Period** | Choose when to reset the entry counter:<br>– Total entries (never resets)<br>– Daily (resets every day)<br>– Weekly (resets every week)<br>– Monthly (resets every month)<br>– Yearly (resets every year)<br>_The reset time will be based on your WordPress site’s timezone setting at Settings > General > Timezone._ |
| **Entry Limit Message** | Custom message displayed to users when the form has reached its entry limit. Supports HTML. |
...
[Algolia](https://docs.gravityforms.com/understanding-entry-limits-in-gravity-forms/# "Algolia")
