---
url: "https://docs.gravityforms.com/gform_password/"
title: "gform_password - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_password/#h-description)
- [Usage](https://docs.gravityforms.com/gform_password/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_password/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_password/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_password/#h-source-code)
...
To target a specific form append the form id to the hook name. (format: gform\_password\_FORMID)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_password_185'``,``'set_password_label'``, 10, 2 );`<br>`function``set_password_label(``$sublabel``,``$form_id``) {`<br>```return``'Enter a password'``;`<br>`}` |

## Source Code

This filter is located in GF\_Field\_Password::get\_field\_input() in _includes/fields/class-gf-field-password.php_.
...
[Algolia](https://docs.gravityforms.com/gform_password/# "Algolia")
