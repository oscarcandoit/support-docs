---
url: "https://docs.gravityforms.com/gform_personal_data/"
title: "gform_personal_data - Gravity Forms Documentation"
---
...
# gform\_personal\_data

- [Description](https://docs.gravityforms.com/gform_personal_data/#h-description)
- [Usage](https://docs.gravityforms.com/gform_personal_data/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_personal_data/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_personal_data/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_personal_data/#h-placement)
- [Since](https://docs.gravityforms.com/gform_personal_data/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_personal_data/#h-source-code)

## Description

The “gform\_personal\_data” filter in Gravity Forms allows custom data exporter and erasers to be registered with WordPress so they are also run when WP data cleanup occurs.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_personal_data'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$custom\_items** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22 | `add_filter(``'gform_personal_data'``,``'filter_gform_personal_data'``, 10, 2 );`<br>`function``filter_gform_personal_data(``$items``,``$form``) {`<br>```$items``[``'test'``] =``array``(`<br>```'label'``=>``'A custom item'``,`<br>```'exporter_callback'``=>``'gf_custom_data_exporter'``,`<br>```'eraser_callback'``=>``'gf_custom_data_eraser'``,`<br>```);`<br>```return``$items``;`<br>```}`<br>```function``gf_custom_data_exporter(``$form``,``$entry``) {`<br>```$data``=``array``(`<br>```'name'``=>``'My Custom Value'``,`<br>```'value'``=>``'ABC123'``,`<br>```);`<br>```return``$data``;`<br>```}`<br>```function``gf_custom_data_eraser(``$form``,``$entry``) {`<br>```// Delete or anonymize some data`<br>```}` |
...
This filter is located in GF\_Personal\_Data::get\_custom\_items() in _gravityforms/includes/class-personal-data.php_.
...
[Algolia](https://docs.gravityforms.com/gform_personal_data/# "Algolia")
