---
url: "https://docs.gravityforms.com/gform_address_city/"
title: "gform_address_city - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_address_city/#h-description)
- [Usage](https://docs.gravityforms.com/gform_address_city/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_address_city/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_address_city/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_address_city/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_address_city/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_address_city'``,``'change_address_city'``, 10, 2 );` |

Applies to a specific form. In this case, form id 5.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_address_city_5'``,``'change_address_city'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_address_city'``,``'change_address_city'``, 10, 2 );`<br>`function``change_address_city(``$label``,``$form_id``) {`<br>```return``"Town"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_address_city/# "Algolia")
