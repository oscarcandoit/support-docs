---
url: "https://docs.gravityforms.com/shipping-field/"
title: "Shipping Field CSS Selectors - Gravity Forms Documentation"
---
...
- [Container](https://docs.gravityforms.com/shipping-field/#h-container)
- [Label](https://docs.gravityforms.com/shipping-field/#h-label)
- [Price](https://docs.gravityforms.com/shipping-field/#h-price)
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield .ginput_container_singleshipping {``border``:``1px``solid``red``;}` |

example: shipping field container (div) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields .gfield .ginput_container_singleshipping {``border``:``1px``solid``red``;}` |

example: shipping field container (div) – applies just to specific container (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields #field_XX_X.gfield .ginput_container_singleshipping {``border``:``1px``solid``red``;}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield_shipping .gfield_label {``border``:``1px``solid``red``;}` |

example: shipping field label (label) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields .gfield_shipping .gfield_label {``border``:``1px``solid``red``;}` |

example: shipping field label (label) – applies just to specific container (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields #field_XX_X.gfield_shipping .gfield_label {``border``:``1px``solid``red``;}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield .ginput_container_singleshipping .ginput_shipping_price {``color``:``red``;}` |

example: shipping price (span) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields .gfield .ginput_container_singleshipping .ginput_shipping_price {``color``:``red``;}` |

example: shipping price (span) – applies just to specific container (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields #field_XX_X.gfield .ginput_container_singleshipping .ginput_shipping_price {``color``:``red``;}` |
...
[Algolia](https://docs.gravityforms.com/shipping-field/# "Algolia")
