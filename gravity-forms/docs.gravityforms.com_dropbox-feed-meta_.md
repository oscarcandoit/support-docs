---
url: "https://docs.gravityforms.com/dropbox-feed-meta/"
title: "Dropbox Feed Meta - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/dropbox-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/dropbox-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the Dropbox Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `$feed``[``'meta'``] =``array``(`<br>```'feedName'``=>``'Dropbox Feed 1'``,`<br>```'fileUploadField'``=>``'all'``,`<br>```'destinationFolder'``=>``'/local.wordpress.dev'``,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **fileUploadField** [string](https://docs.gravityforms.com/string)

The ID of the field containing the files to be uploaded to Dropbox or ‘all’ to upload files from all relevant fields.

- **destinationFolder** [string](https://docs.gravityforms.com/string)
...
[Algolia](https://docs.gravityforms.com/dropbox-feed-meta/# "Algolia")
