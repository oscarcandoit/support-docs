---
url: "https://docs.gravityforms.com/gform_getresponse_contact/"
title: "gform_getresponse_contact - Gravity Forms Documentation"
---
...
# gform\_getresponse\_contact

- [Description](https://docs.gravityforms.com/gform_getresponse_contact/#h-description)
- [Usage](https://docs.gravityforms.com/gform_getresponse_contact/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_getresponse_contact/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_getresponse_contact/#h-example)
- [Placement](https://docs.gravityforms.com/gform_getresponse_contact/#h-placement)
- [Since](https://docs.gravityforms.com/gform_getresponse_contact/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_getresponse_contact/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_getresponse_contact'``,``'your_function_name'``, 10, 5 );` |

To target feeds for a specific form append the form id to the filter name. (format: gform\_getresponse\_contact\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter( 'gform_getresponse_contact_1', 'your_function_name', 10, 5 );` |

## Parameters

- **$contact** [array](https://docs.gravityforms.com/array) The contact properties.
- **$existing\_contact** [bool](https://docs.gravityforms.com/bool) \| [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_getresponse_contact'``,``function``(``$contact``) {`<br>```$contact``[``'dayOfCycle'``] = 0;`<br>```return``$contact``;`<br>`} );` |
...
This filter is located in _gravityformsgetresponse/class-gf-getresponse.php_.
...
[Algolia](https://docs.gravityforms.com/gform_getresponse_contact/# "Algolia")
