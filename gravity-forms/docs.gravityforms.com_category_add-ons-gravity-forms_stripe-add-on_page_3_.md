---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/page/3/"
title: "Stripe Add-On Archives - Page 3 of 3 - Gravity Forms Documentation - Page 3 of 3"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Stripe Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/)    - [Stripe Getting Started](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-getting-started/)
    - [Stripe Feeds And Entries](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-feeds-and-entries/)
    - [Stripe Payment Methods](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-payment-methods/)
    - [Stripe Advanced Customization](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-advanced-customization/)
    - [Stripe Changelog](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-changelog/)
    - [Stripe Knowledge Base](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-knowledge-base/)
    - [Stripe 6.0 Key Features](https://docs.gravityforms.com/stripe-6-0/ "Stripe 6.0 Key Features")
...
Instructions for installing, configuring, and connecting the Gravity Forms Stripe Add-On.](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-getting-started/) [**Stripe Feeds And Entries** \\
Guidance on creating, managing, and troubleshooting Stripe Add-On feeds and entries.](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-feeds-and-entries/) [**Stripe Payment Methods** \\
Overview of Stripe’s payment collection methods.](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-payment-methods/) [**Stripe Advanced Customization** \\
Details on customizing with shortcodes and troubleshooting the Stripe Marketplace app.](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-advanced-customization/) [**Stripe Changelog** \\
View the change log for the Stripe Add-On.](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-changelog/) [**Stripe Knowledge Base** \\
Articles related to the official Gravity Forms Stripe Add-On.](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-knowledge-base/)

## Articles

[**Upgrading to Stripe version 2.6** \\
Discover features and notes pertaining to upgrading to version 2.6 of the Stripe Add-On.](https://docs.gravityforms.com/stripe-documentation-2-6/ "Upgrading to Stripe version 2.6") [**Troubleshooting the Stripe Marketplace App** \\
This troubleshooting guide can help track down issues when connecting the Gravity Forms for Stripe marketplace app back to your Gravity Forms site.](https://docs.gravityforms.com/troubleshooting-the-stripe-marketplace-app/ "Troubleshooting the Stripe Marketplace App") [**Stripe Marks Charge As Recurring When It Is Non-Recurring** \\
Charges made through the Stripe Add-On have shown up flagged as "recurring", when they are not part of a recurring subscription plan.](https://docs.gravityforms.com/stripe-marking-charges-as-recurring/ "Stripe Marks Charge As Recurring When It Is Non-Recurring") [**Why did the Stripe Feed Subscription Name Change?** \\
With Gravity Forms Stripe Add-On version 3.7.2 and greater you may occasionally notice the value of the Subscription Name setting on your Stripe feed changes to include additional numbers and underscores.](https://docs.gravityforms.com/why-did-the-stripe-feed-subscription-name-change/ "Why did the Stripe Feed Subscription Name Change?") [**Stripe Customer Portal Shortcode Action** \\
The Stripe Add-on adds an action to the Gravity Forms shortcode that can be used to display the logged in users subscription information, and a link that redirects to the payment gateway for each.](https://docs.gravityforms.com/stripe-customer-portal-shortcode-action/ "Stripe Customer Portal Shortcode Action") [**Gravity Forms Stripe Marketplace App FAQ** \\
This article covers some of the most common questions regarding the Gravity Forms for Stripe app that can be found on the Stripe App Marketplace.](https://docs.gravityforms.com/gravity-forms-stripe-marketplace-app-faq/ "Gravity Forms Stripe Marketplace App FAQ") [**Using the Gravity Forms for Stripe Marketplace App** \\
This article describes the features of the Gravity Forms for Stripe app available from the Stripe Marketplace.](https://docs.gravityforms.com/using-the-gravity-forms-stripe-marketplace-app/ "Using the Gravity Forms for Stripe Marketplace App") [**About Stripe Link** \\
...
View the change log for the Stripe Add-On.](https://docs.gravityforms.com/stripe-change-log/ "Stripe Changelog") [**How Stripe Chooses Which Payment Methods To Show** \\
This article describes the factors that determine which payment methods are presented to your customers when they come to your Gravity Form with a Stripe payment option embedded.](https://docs.gravityforms.com/stripe-payment-methods/ "How Stripe Chooses Which Payment Methods To Show") [Previous](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/page/2/) [1](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/) [2](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/page/2/) 3

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/page/3/# "Algolia")
