---
url: "https://docs.gravityforms.com/category/developers/php-api/add-on-framework/settings-api/page/2/"
title: "Settings API Archives - Page 2 of 2 - Gravity Forms Documentation - Page 2 of 2"
---
...
[**Section Properties** \\
This article outlines the Section Properties in the Settings API](https://docs.gravityforms.com/section-properties/ "Section Properties") [**User Select Field Type** \\
The user\_select type field, part of the Settings API, allows the user to select a user object from a drop down.](https://docs.gravityforms.com/user-select-field-type/ "User Select Field Type") [Previous](https://docs.gravityforms.com/category/developers/php-api/add-on-framework/settings-api/) [1](https://docs.gravityforms.com/category/developers/php-api/add-on-framework/settings-api/) 2

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/php-api/add-on-framework/settings-api/page/2/# "Algolia")
