---
url: "https://docs.gravityforms.com/gform_disable_registration/"
title: "gform_disable_registration - Gravity Forms Documentation"
---
...
# gform\_disable\_registration

- [Description](https://docs.gravityforms.com/gform_disable_registration/#h-description)
- [Usage](https://docs.gravityforms.com/gform_disable_registration/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_disable_registration/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_disable_registration/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_disable_registration/#h-source-code)

## Description

The “gform\_disable\_registration” filter allows add-ons to prevent the User Registration add-on from registering/updating a user.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_disable_registration'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$is\_disabled** [bool](https://docs.gravityforms.com/bool)
True or false.
...
- **$fulfilled** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15 | `add_filter(``'gform_disable_registration'``,``'disable_registration'``, 10, 3 );`<br>`function``disable_registration(``$is_disabled``,``$form``,``$entry``) {`<br>```//check form id and if not the form being checked simply status passed in to function`<br>```if``(``$form``[``'id'``] != 160 ) {`<br>```return``$is_disabled``;`<br>```}`<br>```//check submitted values to decide if registration should be stopped`<br>```if``( rgar(``$entry``,``'4'``) ==``'No'``&& rgar(``$entry``,``'5'``) ==``'No'``) {`<br>```//disable registration`<br>```return``true;`<br>```}``else``{`<br>```return``false;`<br>```}`<br>`}` |
...
This filter is located in GF\_User\_Registration::process\_feed() in _class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_disable_registration/# "Algolia")
