---
url: "https://docs.gravityforms.com/gform_post_form_views_deleted/"
title: "gform_post_form_views_deleted - Gravity Forms Documentation"
---
...
# gform\_post\_form\_views\_deleted

- [Description](https://docs.gravityforms.com/gform_post_form_views_deleted/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_form_views_deleted/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_form_views_deleted/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_form_views_deleted/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_post_form_views_deleted/#h-source-code)

## Description

The “gform\_post\_form\_views\_deleted” action is triggered when a form view count has been reset to zero, allowing further actions to be performed.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_post_form_views_deleted'``,``'my_function'``, 10, 1 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_post_form_views_deleted'``,``'my_function'``, 10, 1 );`<br>`function``my_function(``$form_id``) {`<br>```// perform action after the form view count has been reset to zero`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_post_form_views_deleted/# "Algolia")
