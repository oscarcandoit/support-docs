---
url: "https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/"
title: "gform_stripe_payment_intent_pre_create - Gravity Forms Documentation"
---
...
# gform\_stripe\_payment\_intent\_pre\_create

- [Description](https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/#h-examples)
- [1\. Add the statement\_descriptor property](https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/#h-1-add-the-statement-descriptor-property)
- [Placement](https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/#h-source-code)

**Note:** Use the [gform\_stripe\_session\_data](https://docs.gravityforms.com/gform_stripe_session_data) filter instead if using Stripe Checkout.

## Description

The gform\_stripe\_payment\_intent\_pre\_create filter allows for the changing of the payment intent data before creating it.

**Note:** This filter is applicable only to Products and Services feeds. Subscription feeds do not utilize Payment Intents, so this filter cannot be used. Please use the [gform\_stripe\_subscription\_params\_pre\_update\_customer](https://docs.gravityforms.com/gform_stripe_subscription_params_pre_update_customer/) filter to target subscription feeds.
...
- **$data** [array](https://docs.gravityforms.com/array)
...
The following example shows how you can add the statement\_descriptor property to the payment intent data.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_stripe_payment_intent_pre_create'``,``'add_statement_descriptor'``, 10, 2 );`<br>`function``add_statement_descriptor(``$data``,``$feed``) {`<br>```$data``[``'statement_descriptor'``] =``'STATEMENTDESC'``;`<br>``<br>```return``$data``;`<br>`}` |
...
This hook is located in GFStripe::create\_payment\_intent() in _class-gf-stripe.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_payment_intent_pre_create/# "Algolia")
