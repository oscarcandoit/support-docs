---
url: "https://docs.gravityforms.com/gform_multiselect_placeholder/"
title: "gform_multiselect_placeholder - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Field Filters](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/)        - [Image Choice Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/image-choice-fields/)
        ...
        - [Multiselect Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/multiselect-fields/)          - [gform\_dropdown\_no\_results\_text](https://docs.gravityforms.com/gform_dropdown_no_results_text/ "gform_dropdown_no_results_text")
          - [gform\_multiselect\_placeholder](https://docs.gravityforms.com/gform_multiselect_placeholder/ "gform_multiselect_placeholder")
...
# gform\_multiselect\_placeholder

- [Description](https://docs.gravityforms.com/gform_multiselect_placeholder/#h-description)
- [Usage](https://docs.gravityforms.com/gform_multiselect_placeholder/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_multiselect_placeholder/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_multiselect_placeholder/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_multiselect_placeholder/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_multiselect_placeholder'``,``'your_function_name'``, 10, 2 );` |

To target a specific form append the form id to the hook name. (format: gform\_multiselect\_placeholder\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_multiselect_placeholder_6'``,``'your_function_name'``, 10, 2 );` |

From 1.9.13.19 you can also target a specific field by appending both the form id and the field id to the hook name. (format: gform\_multiselect\_placeholder\_FORMID\_FIELDID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_multiselect_placeholder_6_3'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_multiselect_placeholder_185'``,``'set_multiselect_placeholder'``, 10, 2 );`<br>`function``set_multiselect_placeholder(``$placeholder``,``$form_id``) {`<br>`return``'Click to select your options...'``;`<br>`}` |
...
This filter is located in GF\_Field\_MultiSelect::get\_field\_input() in _includes/fields/class-gf-field-multiselect.php_.
...
[Algolia](https://docs.gravityforms.com/gform_multiselect_placeholder/# "Algolia")
