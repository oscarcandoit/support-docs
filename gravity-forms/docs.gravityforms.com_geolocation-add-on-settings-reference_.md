---
url: "https://docs.gravityforms.com/geolocation-add-on-settings-reference/"
title: "Geolocation Add-On Settings Reference - Gravity Forms"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Geolocation Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-ons-geolocation/)    - [Setting up the Geolocation Add-On](https://docs.gravityforms.com/setting-up-the-geolocation-add-on/ "Setting up the Geolocation Add-On")
    - [Geolocation Add-On Settings Reference](https://docs.gravityforms.com/geolocation-add-on-settings-reference/ "Geolocation Add-On Settings Reference")
    - [Using the Geolocation Add-On](https://docs.gravityforms.com/using-the-geolocation-add-on/ "Using the Geolocation Add-On")
    - [Geolocation Changelog](https://docs.gravityforms.com/geolocation-change-log/ "Geolocation Changelog")
...
- [Introduction](https://docs.gravityforms.com/geolocation-add-on-settings-reference/#h-introduction)
- [Add-On Settings](https://docs.gravityforms.com/geolocation-add-on-settings-reference/#h-add-on-settings)
...
These settings are available within the [Gravity Forms Settings](https://docs.gravityforms.com/settings-page/) Page under the tab for “Geolocation”.

## Add-On Settings

[![Geolocation Add-on Settings Reference accessed under Gravity Forms Setttings Page](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-31-1024x808.png)](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-31.png)

| Settings | Description |
| --- | --- |
| **Google Places API Key** | To use Geolocation, you will need a Google Places API key. A green checkmark indicates a valid API key. |
| **Form Submission Geolocation Settings** | If enabled, location data for the user submitting the form will be collected and displayed on the Entry Detail page. |
| **Google Maps Conflicts** | If you have other plugins enabled that load the Google Maps JavaScript library, you can enable this setting to avoid conflicts when Geolocation is enabled. Unless you are experiencing JavaScript conflicts, it is safest to leave this setting disabled. |
| **Enable the New Google Places API** | Turn on this option to start using the new Google Places API. Please note that any custom functionality you’ve added to your address autocomplete field will not be compatible with the new API. |
...
[Algolia](https://docs.gravityforms.com/geolocation-add-on-settings-reference/# "Algolia")
