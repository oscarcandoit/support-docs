---
url: "https://docs.gravityforms.com/gform_hubspot_submission_data/"
title: "gform_hubspot_submission_data - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [HubSpot Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/hubspot-hooks-filters/)          - [gform\_hubspot\_custom\_settings](https://docs.gravityforms.com/gform_hubspot_custom_settings/ "gform_hubspot_custom_settings")
          - [gform\_hubspot\_form\_object\_pre\_save\_feed](https://docs.gravityforms.com/gform_hubspot_form_object_pre_save_feed/ "gform_hubspot_form_object_pre_save_feed")
          - [gform\_hubspot\_output\_tracking\_script](https://docs.gravityforms.com/gform_hubspot_output_tracking_script/ "gform_hubspot_output_tracking_script")
          - [gform\_hubspot\_submission\_data](https://docs.gravityforms.com/gform_hubspot_submission_data/ "gform_hubspot_submission_data")
          - [Hubspot Feed Meta](https://docs.gravityforms.com/hubspot-feed-meta/ "Hubspot Feed Meta")
...
# gform\_hubspot\_submission\_data

- [Description](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-description)
- [Usage](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-examples)
- [Change value for pageName (Conversion Page)](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-change-value-for-pagename-conversion-page)
- [Remove cookie value](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-remove-cookie-value)
- [Custom cookie value](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-custom-cookie-value)
- [Change pageUri](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-change-pageuri)
- [Send Consent field data to the HubSpot property "Legal basis for processing contact's data"](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-send-consent-field-data-to-the-hubspot-property-legal-basis-for-processing-contact-s-data)
- [Placement](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-placement)
- [Since](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_hubspot_submission_data/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_hubspot_submission_data'``,``'your_function_name'``, 10, 4 );` |

To target a specific form, append the form id to the hook name. (format: gform\_hubspot\_submission\_data\_FORMID):

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_hubspot_submission_data_1'``,``'your_function_name'``, 10, 4 );` |
...
The HubSpot submission data to be filtered. For more information about the data in this array, see [HubSpot’s documentation](https://developers.hubspot.com/docs/methods/forms/submit_form).
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_hubspot_submission_data'``,``'change_hubspot_submission_data'``, 10, 4 );`<br>`function``change_hubspot_submission_data(``$submission_data``,``$feed``,``$entry``,``$form``){`<br>```global``$post``;`<br>```$title``= get_the_title(``$post``->ID );`<br>```$submission_data``[``'context'``][``'pageName'``] =``$title``;`<br>```return``$submission_data``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_hubspot_submission_data'``,``'remove_cookie_value'``, 10, 4 );`<br>`function``remove_cookie_value(``$submission_data``,``$feed``,``$entry``,``$form``){`<br>```GFCommon::log_debug(``__METHOD__``.``'(): running.'``);`<br>```unset(``$submission_data``[``'context'``][``'hutk'``] );`<br>```return``$submission_data``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_hubspot_submission_data'``,``'custom_cookie_value'``, 10, 4 );`<br>`function``custom_cookie_value(``$submission_data``,``$feed``,``$entry``,``$form``){`<br>```$submission_data``[``'context'``][``'hutk'``] = rgar(``$_COOKIE``,``'your-cookie-name'``);`<br>```return``$submission_data``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_hubspot_submission_data'``,``function``(``$submission_data``) {`<br>```$submission_data``[``'context'``][``'pageUri'``] =``strtok``(``$submission_data``[``'context'``][``'pageUri'``],``'?'``);`<br>```return``$submission_data``;`<br>`} );` |

### Send [Consent](https://docs.gravityforms.com/consent/) field data to the HubSpot property “Legal basis for processing contact’s data”

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16 | `add_filter(``'gform_hubspot_submission_data'``,``'gf_add_consent_to_hubspot'``, 10, 4 );`<br>`function``gf_add_consent_to_hubspot(``$submission_data``,``$feed``,``$entry``,``$form``) {`<br>```// Get value and text from a Consent Field with id 4.`<br>```$consent_value``= rgar(``$entry``,``'4.1'``);``// Update 4 to your Consent field id number.`<br>```$consent_text``= rgar(``$entry``,``'4.2'``);``// Update 4 to your Consent field id number.`<br>```if``( !``empty``(``$consent_value``) ) {`<br>```$consent_value``= true;`<br>```}``else``{`<br>```$consent_value``= false;`<br>```}`<br>```// Assign consent value and consent text to HubSpot parameters.`<br>```$submission_data``[``'legalConsentOptions'``][``'consent'``][``'consentToProcess'``] =``$consent_value``;`<br>```$submission_data``[``'legalConsentOptions'``][``'consent'``][``'text'``]             =``$consent_text``;`<br>```return``$submission_data``;`<br>`}` |
...
This filter is located in GF\_HubSpot::generate\_form\_submission\_object() in _class-gf-hubspot.php_.
...
[Algolia](https://docs.gravityforms.com/gform_hubspot_submission_data/# "Algolia")
