---
url: "https://docs.gravityforms.com/gform_quiz_show_choice_values/"
title: "gform_quiz_show_choice_values - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_quiz_show_choice_values/#h-description)
- [Usage](https://docs.gravityforms.com/gform_quiz_show_choice_values/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_quiz_show_choice_values/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_quiz_show_choice_values/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_quiz_show_choice_values/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_quiz_show_choice_values'``,``'gquiz_show_values'``);` |

## Examples

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_quiz_show_choice_values'``,``'gquiz_show_values'``);`<br>`function``gquiz_show_values(){`<br>```return``true;`<br>`}` |
...
This filter is located in GFQuiz::quiz\_field\_settings() in _gravityformsquiz/class-gf-quiz.php_.
...
[Algolia](https://docs.gravityforms.com/gform_quiz_show_choice_values/# "Algolia")
