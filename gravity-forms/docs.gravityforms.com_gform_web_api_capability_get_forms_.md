---
url: "https://docs.gravityforms.com/gform_web_api_capability_get_forms/"
title: "gform_web_api_capability_get_forms - Gravity Forms Documentation"
---
...
# gform\_web\_api\_capability\_get\_forms

- [Description](https://docs.gravityforms.com/gform_web_api_capability_get_forms/#h-description)
- [Usage](https://docs.gravityforms.com/gform_web_api_capability_get_forms/#h-usage)
- [Example](https://docs.gravityforms.com/gform_web_api_capability_get_forms/#h-example)
- [Source Code](https://docs.gravityforms.com/gform_web_api_capability_get_forms/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_web_api_capability_get_forms'``,``function``(``$capability``) {``return``'my_custom_capability'``; } );` |
...
[Algolia](https://docs.gravityforms.com/gform_web_api_capability_get_forms/# "Algolia")
