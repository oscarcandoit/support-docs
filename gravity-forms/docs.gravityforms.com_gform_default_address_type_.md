---
url: "https://docs.gravityforms.com/gform_default_address_type/"
title: "gform_default_address_type - Gravity Forms Documentation"
---
...
# gform\_default\_address\_type

- [Description](https://docs.gravityforms.com/gform_default_address_type/#h-description)
- [Usage](https://docs.gravityforms.com/gform_default_address_type/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_default_address_type/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_default_address_type/#h-examples)
- [Australia](https://docs.gravityforms.com/gform_default_address_type/#h-australia)
- [Placement](https://docs.gravityforms.com/gform_default_address_type/#h-placement)
- [Since](https://docs.gravityforms.com/gform_default_address_type/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_default_address_type/#h-source-code)

## Description

The gform\_default\_address\_type filter can be used to override the default address type for new fields. It can be used together with the [gform\_address\_types](https://docs.gravityforms.com/gform_address_types) filter to add support for new country specific address types.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_default_address_type'``,``'your_function_name'``, 10, 2 );` |

To target a specific form append the form id to the hook name. (format: gform\_default\_address\_type\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_default_address_type_5'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$default\_address\_type** [string](https://docs.gravityforms.com/string)
...
This example shows how the default address type can be set to Australia. The Australian address type would need to have been added by the [gform\_address\_types](https://docs.gravityforms.com/gform_address_types) filter.

|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_default_address_type'``,``function``(``$default_address_type``,``$form_id``) {`<br>```return``'australia'``;`<br>`}, 10, 2 );` |
...
This filter is located in GF\_Field\_Address::get\_default\_address\_type() in _includes/fields/class-gf-field-address.php_.
...
[Algolia](https://docs.gravityforms.com/gform_default_address_type/# "Algolia")
