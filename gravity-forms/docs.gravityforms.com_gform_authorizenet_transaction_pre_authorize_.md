---
url: "https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/"
title: "gform_authorizenet_transaction_pre_authorize - Gravity Forms"
---
...
- [Description](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/#h-description)
- [Usage](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_authorizenet_transaction_pre_authorize'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$original\_transaction** [AuthorizeNetAIM Object](https://developer.authorize.net/api/reference/)
The payment transaction.

- **$form\_data** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_authorizenet_transaction_pre_authorize'``,``'change_authorization'``, 10, 4 );`<br>`function``change_authorization(``$original_transaction``,``$form_data``,``$config``,``$form``){`<br>```return``$original_transaction``;`<br>`}` |
...
This filter is located in GFAuthorizeNet::authorize() in _gravityformsauthorizenet/class-gf-authorizenet.php_.
...
[Algolia](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/# "Algolia")
