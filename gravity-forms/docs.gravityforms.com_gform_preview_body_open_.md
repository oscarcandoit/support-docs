---
url: "https://docs.gravityforms.com/gform_preview_body_open/"
title: "gform_preview_body_open - Gravity Forms Documentation"
---
...
# gform\_preview\_body\_open

- [Description](https://docs.gravityforms.com/gform_preview_body_open/#h-description)
- [Usage](https://docs.gravityforms.com/gform_preview_body_open/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_preview_body_open/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_preview_body_open/#h-examples)
- [Since](https://docs.gravityforms.com/gform_preview_body_open/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_preview_body_open/#h-source-code)

## Description

The “gform\_preview\_body\_open” action is triggered when the body of the form preview page loads, allowing further actions to be done.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `function``my_function() {`<br>```//Do something here`<br>`}`<br>`add_action(``'gform_preview_body_open'``,``'my_function'``, 10, 1 );` |
...
[Algolia](https://docs.gravityforms.com/gform_preview_body_open/# "Algolia")
