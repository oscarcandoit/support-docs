---
url: "https://docs.gravityforms.com/gform_file_upload_whitelisting_disabled/"
title: "gform_file_upload_whitelisting_disabled - Gravity Forms Documentation"
---
...
# gform\_file\_upload\_whitelisting\_disabled

- [Description](https://docs.gravityforms.com/gform_file_upload_whitelisting_disabled/#h-description)
- [Usage](https://docs.gravityforms.com/gform_file_upload_whitelisting_disabled/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_file_upload_whitelisting_disabled/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_file_upload_whitelisting_disabled/#h-example)
- [Placement](https://docs.gravityforms.com/gform_file_upload_whitelisting_disabled/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_file_upload_whitelisting_disabled/#h-source-code)

## Description

The “gform\_file\_upload\_whitelisting\_disabled” filter in Gravity Forms allows the disabling of file upload whitelisting. This filter applies to all forms.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_file_upload_whitelisting_disabled'``,``'__return_true'``);` |
...
|     |     |
| --- | --- |
| 1 | `$whitelisting_disabled``= apply_filters(``'gform_file_upload_whitelisting_disabled'``, false );` |
...
This filter is located in _includes/upload.php_ and _includes/fields/class-gf-field-fileupload.php_.
...
[Algolia](https://docs.gravityforms.com/gform_file_upload_whitelisting_disabled/# "Algolia")
