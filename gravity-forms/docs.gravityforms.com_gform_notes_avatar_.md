---
url: "https://docs.gravityforms.com/gform_notes_avatar/"
title: "gform_notes_avatar - Gravity Forms Documentation"
---
...
# gform\_notes\_avatar

- [Description](https://docs.gravityforms.com/gform_notes_avatar/#description)
- [Usage](https://docs.gravityforms.com/gform_notes_avatar/#usage)
- [Parameters](https://docs.gravityforms.com/gform_notes_avatar/#parameters)
- [Examples](https://docs.gravityforms.com/gform_notes_avatar/#examples)
- [1\. Replace the Avatar with a custom Avatar for Gravity Flow](https://docs.gravityforms.com/gform_notes_avatar/#h-1-replace-the-avatar-with-a-custom-avatar-for-gravity-flow)
- [Placement](https://docs.gravityforms.com/gform_notes_avatar/#h-placement)
- [Since](https://docs.gravityforms.com/gform_notes_avatar/#since)
- [Source Code](https://docs.gravityforms.com/gform_notes_avatar/#source-code)
...
- **$avatar** [string](https://docs.gravityforms.com/string/)

URL of the avatar image to use
- **$note [array](https://docs.gravityforms.com/array/)**
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13 | `function``custom_gravityflow_notes_avatar(``$avatar``,``$note``) {`<br>```// Check if the note_type matches the specific type for the addon`<br>```if``(``$note``->note_type ===``'gravityflow'``) {`<br>```// Provide your custom avatar URL`<br>```$custom_avatar_url``=``'https://example.com/path/to/custom/avatar.jpg'``; // Replace with your custom avatar URL`<br>```$avatar``=``'<img src="'``. esc_url(``$custom_avatar_url``) .``'" alt="Gravity Flow Avatar" />'``;`<br>```}`<br>```return``$avatar``;`<br>`}`<br>`// Apply the filter`<br>`add_filter(``'gform_notes_avatar'``,``'custom_gravityflow_notes_avatar'``, 10, 2 );` |
...
This filter is located in class `GFEntryDetail` in _/entry\_detail.php_.
...
[Algolia](https://docs.gravityforms.com/gform_notes_avatar/# "Algolia")
