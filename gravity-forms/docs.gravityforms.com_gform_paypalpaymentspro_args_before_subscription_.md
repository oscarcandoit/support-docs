---
url: "https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/"
title: "gform_paypalpaymentspro_args_before_subscription - Gravity Forms"
---
...
- [Description](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/#h-examples)
- [1\. Set the Start Date](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/#h-1-set-the-start-date)
- [Placement](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypalpaymentspro_args_before_subscription'``,``'your_function_name'``, 10, 5 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_paypalpaymentspro_args_before_subscription'``,``function``(``$subscription``,``$form_id``) {`<br>```if``(``$form_id``== 3 ) {`<br>```$subscription``[``'START'``] =``'07152015'``// date format need to be MMDDYYYY`<br>```}`<br>```return``$subscription``;`<br>`}, 10, 2 );` |
...
This filter is located in GFPayPalPaymentsPro::subscribe() in _class-gf-paypalpaymentspro.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/# "Algolia")
