---
url: "https://docs.gravityforms.com/how-to-determine-the-form-id/"
title: "How to determine the Form ID - Gravity Forms Documentation"
---
...
# How to determine the Form ID

There are a number of cases whereby you may need to know the ID of a particular form. For example, when using the [Gravity Forms shortcode](https://docs.gravityforms.com/shortcodes/) to embed a form on a page, or for many of the Gravity Forms filters, hooks and API methods we provide [for developers](https://docs.gravityforms.com/category/developers/). This short guide details one way to determine your form ID.

1. Log into your WordPress admin dashboard.
2. On the left side navigation menu, hover over **Forms** and click on **Forms**.
3. Find the form you need the ID for.
4. Look for the ID under the ID column

[![](https://docs.gravityforms.com/wp-content/uploads/2023/04/Form_Id-1024x308.png)](https://docs.gravityforms.com/wp-content/uploads/2023/04/Form_Id.png)
...
[Algolia](https://docs.gravityforms.com/how-to-determine-the-form-id/# "Algolia")
