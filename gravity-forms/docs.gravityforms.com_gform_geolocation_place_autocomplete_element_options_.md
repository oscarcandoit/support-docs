---
url: "https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/"
title: "gform_geolocation_place_autocomplete_element_options - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Geolocation Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/geolocation-filters/)          - [gform\_geolocation\_place\_autocomplete\_element\_options](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/ "gform_geolocation_place_autocomplete_element_options")
          - [gform\_geolocation\_place\_autocomplete\_element\_place\_details](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/ "gform_geolocation_place_autocomplete_element_place_details")
          - [gform\_geolocation\_autocomplete\_options\_pre\_init](https://docs.gravityforms.com/gform-geolocation-autocomplete-options-pre-init/ "gform_geolocation_autocomplete_options_pre_init")
          - [gform\_geolocation\_autocomplete\_mappings\_pre\_populate](https://docs.gravityforms.com/gform-geolocation-autocomplete-mappings-pre-populate/ "gform_geolocation_autocomplete_mappings_pre_populate")
...
# gform\_geolocation\_place\_autocomplete\_element\_options

- [Description](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/#h-description)
- [Usage](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/#h-examples)
- [Limit the address selected options to only the United States.](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/#h-limit-the-address-selected-options-to-only-the-united-states)
- [Placement](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/#h-since)

## Description

The `gform_geolocation_place_autocomplete_element_options` filter allows you to edit the constructor of the [PlaceAutocompleteElement](https://developers.google.com/maps/documentation/javascript/place-autocomplete-new#constrain-autocomplete-predictions).
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `gform.addFilter(``'gform_geolocation_place_autocomplete_element_place_details'``,``function``(placeDetails, formId, fieldId, address) {`<br>```// Your Custom Logic`<br>```return``placeDetails;`<br>`});` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **placeDetails** | [object](https://docs.gravityforms.com/object/) | The Field options. |
| **formId** | [number](https://docs.gravityforms.com/number/) | The ID of the form the address field belongs to. |
| **fieldId** | [number](https://docs.gravityforms.com/number/) | The ID of the address field autocomplete is to be initialized for. |
| **address** | [element](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/#) | The Address field element. |

More information about the API: [https://developers.google.com/maps/documentation/javascript/reference/place#Place.fetchField](https://developers.google.com/maps/documentation/javascript/reference/place#Place.fetchField)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `gform.addFilter(``'gform_geolocation_place_autocomplete_element_options'``,``function``(options, formId, fieldId, address) {`<br>```// Places API requires ISO 3166-1 Alpha-2 codes (like us, ca, gb, au, etc.).`<br>```options.includedRegionCodes = [``'us'``];`<br>```return``options;`<br>`});` |
...
[Algolia](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_options/# "Algolia")
