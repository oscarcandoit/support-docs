---
url: "https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/"
title: "FAQ: Gravity Forms Language Translation"
---
...
- [Introduction](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/#h-introduction)
- [Frequently Asked Questions?](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/#h-frequently-asked-questions)
- [What has changed for Gravity Forms language files?](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/#h-what-has-changed-for-gravity-forms-language-files)
- [What triggers a language file download?](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/#h-what-triggers-a-language-file-download)
- [Can I download language files manually?](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/#h-can-i-download-language-files-manually)
- [What locale translation files are managed by Gravity Forms?](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/#h-what-locale-translation-files-are-managed-by-gravity-forms)
- [What other locale translation files are available?](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/#h-what-other-locale-translation-files-are-available)
- [Where are the language files stored now?](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/#h-where-are-the-language-files-stored-now)
- [What about if the WordPress user has their own selected locale?](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/#h-what-about-if-the-wordpress-user-has-their-own-selected-locale)
...
- When the [site language](https://wordpress.com/support/language-settings/#site-language) is changed on the WordPress _My Site → Settings_ page.
- When using the [WP-CLI `wp language plugin` commands](https://developer.wordpress.org/cli/commands/language/plugin/).

There are also a few conditions that can stop the download of the language file, such as if the installed translation _last updated date_ is the same as the available version, or the translation language/locale is not found.

#### **Can I download language files manually?**

Language files can be downloaded for manual installation from the [Translations](https://www.gravityforms.com/my-account/downloads/translations/) page, which is accessible from the Help menu on the [Gravity Forms](https://www.gravityforms.com/) site.
...
With customers all over the world, there are many other language translations for Gravity Forms that have been authored and reviewed by volunteer contributors. A full list of these can be found on the [Translations page](https://www.gravityforms.com/my-account/downloads/translations/) on our website, noted under the manual download menu. Note that these are unofficial translations. Although as much care is taken as possible, Gravity Forms cannot guarantee the accuracy, speed or coverage of these updates. We do log all feedback received through our support channels, and provide it back to the contributors responsible.

To volunteer as a translation contributor, please see the [Translation page](https://www.gravityforms.com/my-account/downloads/translations/).

#### **Where are the language files stored now?**

The translations are stored in _WP\_LANG\_DIR/plugins/_, where [WP\_LANG\_DIR](https://developer.wordpress.org/reference/functions/wp_set_lang_dir/) is your WordPress language directory. For example, _/wp-content/languages/plugins/_.

They can also be stored in _WP\_LANG\_DIR/gravityforms/_, and files here will be loaded before those in the default location mentioned above.

#### **What about if the WordPress user has their own selected locale?**

Support for the user selected locale was added in [Gravity Forms v2.5.6](https://docs.gravityforms.com/gravityforms-change-log/). The user locale will be used first if set, and the default locale otherwise.
...
[Algolia](https://docs.gravityforms.com/faq-about-gravity-forms-language-translation-files/# "Algolia")
