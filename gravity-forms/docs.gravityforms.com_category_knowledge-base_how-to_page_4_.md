---
url: "https://docs.gravityforms.com/category/knowledge-base/how-to/page/4/"
title: "How To Archives - Page 4 of 5 - Gravity Forms Documentation - Page 4 of 5"
---
...
By default, Gravity Forms is available in US English. However, with users on every continent, island, and corner of the globe, we have built Gravity Forms to support many different languages.](https://docs.gravityforms.com/how-to-change-your-language-in-gravity-forms/ "How To Change Your Language In Gravity Forms") [**Using the Gravity Forms “gform\_validation” Hook** \\
The gform\_valiation hook will allow you to modify how your forms are validated.](https://docs.gravityforms.com/using-gform-validation-hook/ "Using the Gravity Forms “gform_validation” Hook") [**Dynamically Populating a Field** \\
Using dynamic population in Gravity Forms allows you to dynamically populate a field with a value (or values depending on the field type).](https://docs.gravityforms.com/using-dynamic-population/ "Dynamically Populating a Field") [**How To Install Gravity Forms** \\
Installing Gravity Forms is quite simple and is the same process as installing many other plugins. In this article, we will show you how to quickly install Gravity Forms using the plugin uploader inside your WordPress admin dashboard.](https://docs.gravityforms.com/how-to-install-gravity-forms/ "How To Install Gravity Forms") [**Gravity Forms Pricing: Adding Tax** \\
If you would like to implement tax you can use the Product Field configured as a Calculation field type. Then configure the formula for the calculation to calculate the appropriate tax.](https://docs.gravityforms.com/gravity-forms-pricing-adding-tax/ "Gravity Forms Pricing: Adding Tax") [**Dynamically Populating the Post Author** \\
Learn how to dynamically populate the post author in Gravity Forms.](https://docs.gravityforms.com/dynamically-populating-the-post-author/ "Dynamically Populating the Post Author") [**Dynamically Populating Drop Down, Radio Buttons or Multi-Select Fields** \\
Being able to dynamically populate the values in a select (aka drop down) field is fairly common requirement for product selection forms, product option forms, or any form that requires earlier submissions to drive choices in a latter collection field.](https://docs.gravityforms.com/dynamically-populating-drop-down-or-radio-buttons-fields/ "Dynamically Populating Drop Down, Radio Buttons or Multi-Select Fields") [**Making a Field Read-Only** \\
If you want to change a field to be read-only, you currently need to use JavaScript to do so. The following filter and function will help you accomplish this.](https://docs.gravityforms.com/making-a-field-read-only/ "Making a Field Read-Only") [**Set Tabindex** \\
Having an issue where pressing tab on your keyboard brings your user to another form on your page? That is because Gravity Forms assumes its tabindex values and you can have overlap.](https://docs.gravityforms.com/set-tabindex/ "Set Tabindex") [**Delete Entry Data after Submission** \\
This article explains how how to manage deletion using Personal Data Settings, third-party tools, or custom code.](https://docs.gravityforms.com/delete-entry-data-after-submission/ "Delete Entry Data after Submission") [Previous](https://docs.gravityforms.com/category/knowledge-base/how-to/page/3/) [1](https://docs.gravityforms.com/category/knowledge-base/how-to/) [2](https://docs.gravityforms.com/category/knowledge-base/how-to/page/2/) [3](https://docs.gravityforms.com/category/knowledge-base/how-to/page/3/) 4 [5](https://docs.gravityforms.com/category/knowledge-base/how-to/page/5/) [Next](https://docs.gravityforms.com/category/knowledge-base/how-to/page/5/)
...
[Algolia](https://docs.gravityforms.com/category/knowledge-base/how-to/page/4/# "Algolia")
