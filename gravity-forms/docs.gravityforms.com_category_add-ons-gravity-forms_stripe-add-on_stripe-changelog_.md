---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-changelog/"
title: "Stripe Changelog Archives - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Stripe Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/)    - [Stripe Getting Started](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-getting-started/)
    ...
    - [Stripe Changelog](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-changelog/)      - [Stripe 5.0 Release Notes](https://docs.gravityforms.com/stripe-5-0-release-notes/ "Stripe 5.0 Release Notes")
      - [Changes to Stripe Checkout with Stripe Add-On v3.0](https://docs.gravityforms.com/changes-to-checkout-with-stripe-v3/ "Changes to Stripe Checkout with Stripe Add-On v3.0")
      - [Upgrading to Stripe version 2.6](https://docs.gravityforms.com/stripe-documentation-2-6/ "Upgrading to Stripe version 2.6")
      - [Why did the Stripe Feed Subscription Name Change?](https://docs.gravityforms.com/why-did-the-stripe-feed-subscription-name-change/ "Why did the Stripe Feed Subscription Name Change?")
      - [Stripe Changelog](https://docs.gravityforms.com/stripe-change-log/ "Stripe Changelog")
...
This article includes feature notes and a change log for the release of the official Gravity Forms Stripe Add-On version 5.0.](https://docs.gravityforms.com/stripe-5-0-release-notes/ "Stripe 5.0 Release Notes") [**Changes to Stripe Checkout with Stripe Add-On v3.0** \\
Version 3 of the official Gravity Forms Stripe Add-On made a number of changes to bring our add-on into line with Stripe’s updates around Strong Customer Authentication (SCA) and their new API. This document describes the existing flow using Stripe Checkout and Stripe filters that have been affected.](https://docs.gravityforms.com/changes-to-checkout-with-stripe-v3/ "Changes to Stripe Checkout with Stripe Add-On v3.0") [**Upgrading to Stripe version 2.6** \\
Discover features and notes pertaining to upgrading to version 2.6 of the Stripe Add-On.](https://docs.gravityforms.com/stripe-documentation-2-6/ "Upgrading to Stripe version 2.6") [**Why did the Stripe Feed Subscription Name Change?** \\
With Gravity Forms Stripe Add-On version 3.7.2 and greater you may occasionally notice the value of the Subscription Name setting on your Stripe feed changes to include additional numbers and underscores.](https://docs.gravityforms.com/why-did-the-stripe-feed-subscription-name-change/ "Why did the Stripe Feed Subscription Name Change?") [**Stripe Changelog** \\
View the change log for the Stripe Add-On.](https://docs.gravityforms.com/stripe-change-log/ "Stripe Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-changelog/# "Algolia")
