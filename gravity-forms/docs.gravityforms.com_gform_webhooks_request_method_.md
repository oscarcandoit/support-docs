---
url: "https://docs.gravityforms.com/gform_webhooks_request_method/"
title: "gform_webhooks_request_method - Gravity Forms Documentation"
---
...
# gform\_webhooks\_request\_method

- [Description](https://docs.gravityforms.com/gform_webhooks_request_method/#h-description)
- [Usage](https://docs.gravityforms.com/gform_webhooks_request_method/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_webhooks_request_method/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_webhooks_request_method/#h-example)
- [Placement](https://docs.gravityforms.com/gform_webhooks_request_method/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_webhooks_request_method/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_webhooks_request_method'``,``'your_function_name'``, 10, 4 )` |

To target a specific form, append the form id to the hook name. (format: gform\_webhooks\_request\_method\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_webhooks_request_method_7'``,``'your_function_name'``, 10, 4 )` |

## Parameters

- **$request\_method** [string](https://docs.gravityforms.com/string)
HTTP request method.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_webhooks_request_method'``,``'set_method'``, 10, 4 );`<br>`function``set_method(``$request_method``,``$feed``,``$entry``,``$form``){`<br>```return``'GET'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_webhooks_request_method/# "Algolia")
