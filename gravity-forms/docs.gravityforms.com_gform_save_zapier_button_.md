---
url: "https://docs.gravityforms.com/gform_save_zapier_button/"
title: "gform_save_zapier_button - Gravity Forms Documentation"
---
...
# gform\_save\_zapier\_button

- [Description](https://docs.gravityforms.com/gform_save_zapier_button/#h-description)
- [Usage](https://docs.gravityforms.com/gform_save_zapier_button/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_save_zapier_button/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_save_zapier_button/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_save_zapier_button/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_save_zapier_button/#h-source-code)

## Description

The “gform\_save\_zapier\_button” filter allows the Zapier Feed save button to be modified.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_save_zapier_button'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$zapier\_button** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_save_zapier_button'``,``'change_save_button'``, 10, 1 );`<br>`function``change_save_button(``$zapier_button``){`<br>```return``'<input class="button-primary" type="submit" value="Save Your Feed" name="save"/>'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_save_zapier_button/# "Algolia")
