---
url: "https://docs.gravityforms.com/gform_webhooks_request_url/"
title: "gform_webhooks_request_url - Gravity Forms Documentation"
---
...
# gform\_webhooks\_request\_url

- [Description](https://docs.gravityforms.com/gform_webhooks_request_url/#h-description)
- [Usage](https://docs.gravityforms.com/gform_webhooks_request_url/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_webhooks_request_url/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_webhooks_request_url/#h-example)
- [Placement](https://docs.gravityforms.com/gform_webhooks_request_url/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_webhooks_request_url/#h-source-code)

## Description

The “gform\_webhooks\_request\_url” filter allows the webhook HTTP request url to be modified.
...
- **$request\_url** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_webhooks_request_url'``,``'set_url'``, 10, 4 );`<br>`function``set_url(``$request_url``,``$feed``,``$entry``,``$form``){`<br>```$request_url``=``'https://www.your.domain'``;`<br>``<br>```return``$request_url``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_webhooks_request_url/# "Algolia")
