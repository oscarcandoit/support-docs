---
url: "https://docs.gravityforms.com/gform_address_zip/"
title: "gform_address_zip - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_address_zip/#h-description)
- [Usage](https://docs.gravityforms.com/gform_address_zip/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_address_zip/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_address_zip/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_address_zip/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_address_zip/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_address_zip'``,``'change_address_zip'``, 10, 2 );`<br>`function``change_address_zip(``$label``,``$form_id``) {`<br>```return``"Address Zip"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_address_zip/# "Algolia")
