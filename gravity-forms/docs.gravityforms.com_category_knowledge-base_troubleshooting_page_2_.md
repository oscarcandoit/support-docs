---
url: "https://docs.gravityforms.com/category/knowledge-base/troubleshooting/page/2/"
title: "Troubleshooting Archives - Page 2 of 3 - Gravity Forms Documentation - Page 2 of 3"
---
...
Is the Feeds menu item missing from an add-on you’re trying to use? We’ll show you how to troubleshoot the issue.](https://docs.gravityforms.com/troubleshooting-a-missing-feeds-menu-item/ "Troubleshooting a Missing ‘Feeds’ Menu Item") [**Troubleshooting a Missing Settings Page** \\
Most add-ons are managed from their own settings pages. These settings pages are typically accessible by accessing the primary Gravity Forms Settings page, then clicking on the tab appropriate for your add-on.](https://docs.gravityforms.com/troubleshooting-missing-settings-page/ "Troubleshooting a Missing Settings Page") [**Troubleshooting an Empty or Incomplete Settings Page** \\
This article contains troubleshooting steps if you see a settings page that has missing or incomplete content and will help you resolve the problem.](https://docs.gravityforms.com/troubleshoot-empty-incomplete-settings-page/ "Troubleshooting an Empty or Incomplete Settings Page") [**Troubleshooting API Key Validation Issues** \\
In this article, we will help you troubleshoot issues with validating an API key for an add-on service.](https://docs.gravityforms.com/troubleshooting-api-key-validation-issues/ "Troubleshooting API Key Validation Issues") [**Troubleshooting Background (async) Processing Issues** \\
This article contains tips and links to help you debug issues with background (async) processing, as introduced in Gravity Forms 2.2.](https://docs.gravityforms.com/troubleshooting-background-issues/ "Troubleshooting Background (async) Processing Issues") [**Troubleshooting Form Data Not Being Sent to a Service** \\
Many of the add-ons that Gravity Forms offers require form data being sent to a 3rd party service, such as Dropbox. If you are having issues, here's how to troubleshoot it.](https://docs.gravityforms.com/troubleshoot-form-data-not-sent-to-service/ "Troubleshooting Form Data Not Being Sent to a Service") [**Troubleshooting Form Submission Performance** \\
The performance of form submissions can be an important factor in the user experience of your site, so it is essential that you understand how the process works.](https://docs.gravityforms.com/troubleshooting-form-submission-performance/ "Troubleshooting Form Submission Performance") [**Troubleshooting Issues with Calculation Results** \\
Learn how to troubleshoot issues with calculation results.](https://docs.gravityforms.com/troubleshooting-issues-with-calculation-results/ "Troubleshooting Issues with Calculation Results") [**Troubleshooting Issues with Gravity Forms Download and Signature Links** \\
Learn how to troubleshoot issues with Gravity Forms download and signature links.](https://docs.gravityforms.com/troubleshooting-issues-with-gravity-forms-download-links/ "Troubleshooting Issues with Gravity Forms Download and Signature Links") [**Troubleshooting license key validation errors** \\
This article describes the checks you can perform when your Gravity Forms license key will not validate successfully.](https://docs.gravityforms.com/troubleshooting-license-key-validation/ "Troubleshooting license key validation errors") [Previous](https://docs.gravityforms.com/category/knowledge-base/troubleshooting/) [1](https://docs.gravityforms.com/category/knowledge-base/troubleshooting/) 2 [3](https://docs.gravityforms.com/category/knowledge-base/troubleshooting/page/3/) [Next](https://docs.gravityforms.com/category/knowledge-base/troubleshooting/page/3/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/troubleshooting/page/2/# "Algolia")
