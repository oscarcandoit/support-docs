---
url: "https://docs.gravityforms.com/gform_field_type_title/"
title: "gform_field_type_title - Gravity Forms Documentation"
---
...
# gform\_field\_type\_title

- [Description](https://docs.gravityforms.com/gform_field_type_title/#h-description)
- [Usage](https://docs.gravityforms.com/gform_field_type_title/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_field_type_title/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_field_type_title/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_field_type_title/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_field_type_title/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `add_filter(``'gform_field_type_title'``,``'assign_title'``, 10, 2 );`<br>`function``assign_title(``$title``,``$field_type``) {`<br>```if``(``$field_type``==``'map'``) {`<br>```return``'Map'``;`<br>```}`<br>```else``{`<br>```return``$title``;`<br>```}`<br>`}` |
...
This filter is located in GFCommon::get\_field\_type\_title() in _common.php_
...
[Algolia](https://docs.gravityforms.com/gform_field_type_title/# "Algolia")
