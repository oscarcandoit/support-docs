---
url: "https://docs.gravityforms.com/gf_field_multiselect/"
title: "GF_Field_MultiSelect - Gravity Forms Documentation"
---
...
# GF\_Field\_MultiSelect

- [Introduction](https://docs.gravityforms.com/gf_field_multiselect/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_multiselect/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_multiselect/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_multiselect/#h-properties)
- [Source Code](https://docs.gravityforms.com/gf_field_multiselect/#h-source-code)

## Introduction

The GF\_Field\_MultiSelect class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Multi Select field is rendered when the form is displayed and how its value is handled during and after form submission.
...
An array containing the the individual properties for each item in the multi select.
  ...
  - **isSelected** [boolean](https://docs.gravityforms.com/boolean)
    ...
    |     |     |
    | --- | --- |
    | 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17 | `$choices``=``array``(`<br>```array``(`<br>```'text'``=>``'First Choice'``,`<br>```'value'``=>``'one'``,`<br>```'isSelected'``=> false`<br>```),`<br>```array``(`<br>```'text'``=>``'Second Choice'``,`<br>```'value'``=>``'two'``,`<br>```'isSelected'``=> true`<br>```),`<br>```array``(`<br>```'text'``=>``'Third Choice'``,`<br>```'value'``=>``'three'``,`<br>```'isSelected'``=> false`<br>```),`<br>```);` |
...
- **enableEnhancedUI** [boolean](https://docs.gravityforms.com/boolean)
...
The source code is located in _includes/fields/class-gf-field-multiselect.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_multiselect/# "Algolia")
