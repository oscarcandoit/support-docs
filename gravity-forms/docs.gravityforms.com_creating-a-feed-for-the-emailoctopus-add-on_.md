---
url: "https://docs.gravityforms.com/creating-a-feed-for-the-emailoctopus-add-on/"
title: "EmailOctopus Add-On Feed Creation - Gravity"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [EmailOctopus Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/emailoctopus-add-on/)    - [Setting Up The EmailOctopus Add-On](https://docs.gravityforms.com/setting-up-the-email-octopus-add-on/ "Setting Up The EmailOctopus Add-On")
    - [Creating a Feed for the EmailOctopus Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-emailoctopus-add-on/ "Creating a Feed for the EmailOctopus Add-On")
    - [EmailOctopus Changelog](https://docs.gravityforms.com/emailoctopus-change-log/ "EmailOctopus Changelog")
...
- [Summary](https://docs.gravityforms.com/creating-a-feed-for-the-emailoctopus-add-on/#h-summary)
- [Pre-requisites](https://docs.gravityforms.com/creating-a-feed-for-the-emailoctopus-add-on/#h-pre-requisites)
- [Steps to Create a Feed](https://docs.gravityforms.com/creating-a-feed-for-the-emailoctopus-add-on/#h-steps-to-create-a-feed)
- [Feed Settings Screen](https://docs.gravityforms.com/creating-a-feed-for-the-emailoctopus-add-on/#h-feed-settings-screen)

## Summary

Before the EmailOctopus Add-On can be used with Gravity Forms, you will first need to create [a feed](https://docs.gravityforms.com/what-is-a-feed/). Your feeds allow you to integrate a form with your EmailOctopus account and feed user information in real time to their service when a form is submitted. This allows you to automatically add subscribers to your list at form submission.

## Pre-requisites

1. You have [completed setup the EmailOctopus add-on](https://docs.gravityforms.com/setting-up-the-email-octopus-add-on), including registering the API key.
2. You should already have a form setup within GF that you wish to use as the source of feed submissions.
...
4. Click **Add New** to create a new feed. You will be presented with the EmailOctopus feed settings screen. See below for information on the fields presented there.
...
2. Select the **EmailOctopus List** you would like to add the subscriber to. The drop-down should offer the lists already setup within your EmailOctopus account.
3. **Map Fields**: Map each of the list fields to the desired form field that you wish to be the source for that information.
4. **Conditional Logic**: If unchecked, every successful form submission will be sent to EmailOctopus. If you wish to set specific conditions for sending form data to EmailOctopus, then check the “Enable Condition” box and fill out your required criteria.

[![Email Octopus feed settings page](https://docs.gravityforms.com/wp-content/uploads/2020/01/emailoctopus-feed-settings-1024x577.png)](https://docs.gravityforms.com/wp-content/uploads/2020/01/emailoctopus-feed-settings.png)
...
[Algolia](https://docs.gravityforms.com/creating-a-feed-for-the-emailoctopus-add-on/# "Algolia")
