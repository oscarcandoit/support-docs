---
url: "https://docs.gravityforms.com/consent-field-css-selectors/"
title: "Consent Field CSS Selectors - Gravity Forms Documentation"
---
...
- [Container](https://docs.gravityforms.com/consent-field-css-selectors/#h-container)
- [Checkbox Label](https://docs.gravityforms.com/consent-field-css-selectors/#h-checkbox-label)
- [Inputs](https://docs.gravityforms.com/consent-field-css-selectors/#h-inputs)
- [Description](https://docs.gravityforms.com/consent-field-css-selectors/#h-description)

## Container

- **example:** consent field container – applies to all forms

```
body .gform_body .gform_fields .ginput_container.ginput_container_consent {border: 1px solid red}
```

- **example:** consent field container – applies just to form ID #1
...
- **example:** consent field checkbox label – applies to all forms

```
body .gform_wrapper .gform_body .gform_fields .gfield .gfield_consent_label {border: 1px solid red}
```

- **example:** consent field checkbox label – applies just to form ID #1

```
body #gform_wrapper_1 .gform_body .gform_fields .gfield .gfield_consent_label {border: 1px solid red}
```


## Inputs

- **example:** consent field input (checkbox) – applies to all forms

```
body .gform_wrapper .gform_body .gform_fields .ginput_container_consent input[type=checkbox] {border: 1px solid red}
```

- **example:** consent field input (checkbox) – applies just to form ID #1

```
body #gform_wrapper_1 .gform_body .gform_fields .ginput_container_consent input[type=checkbox] {border: 1px solid red}
```


## Description

- **example:** consent field container (div) – applies to all forms

```
body .gform_wrapper .gform_body .gform_fields .gfield .gfield_consent_description {border: 1px solid red}
```

- **example:** consent field container (div) – applies just to form ID #1

```
body #gform_wrapper_1 .gform_body .gform_fields .gfield .gfield_consent_description {border: 1px solid red}
```
...
[Algolia](https://docs.gravityforms.com/consent-field-css-selectors/# "Algolia")
