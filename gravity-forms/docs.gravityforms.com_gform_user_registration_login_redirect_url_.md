---
url: "https://docs.gravityforms.com/gform_user_registration_login_redirect_url/"
title: "gform_user_registration_login_redirect_url - Gravity Forms"
---
...
- [Description](https://docs.gravityforms.com/gform_user_registration_login_redirect_url/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_login_redirect_url/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_user_registration_login_redirect_url/#h-examples)
- [Redirect all users to a custom URL](https://docs.gravityforms.com/gform_user_registration_login_redirect_url/#h-redirect-all-users-to-a-custom-url)
- [Redirect to a custom URL only for users with 'administrator' role](https://docs.gravityforms.com/gform_user_registration_login_redirect_url/#h-redirect-to-a-custom-url-only-for-users-with-administrator-role)
- [Placement](https://docs.gravityforms.com/gform_user_registration_login_redirect_url/#h-placement)
- [Since](https://docs.gravityforms.com/gform_user_registration_login_redirect_url/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_login_redirect_url/#h-source-code)
...
- **$login\_redirect** [string](https://docs.gravityforms.com/string)
The URL to which the user will be redirected.

- **$sign\_on** [object](https://docs.gravityforms.com/object)

The [WP\_User](https://developer.wordpress.org/reference/classes/wp_user/) on success.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_user_registration_login_redirect_url'``,``'your_function_name'``, 10, 2 );`<br>`function``your_function_name(``$login_redirect``,``$sign_on``) {`<br>```return``'https://localhost/wp.dev/my-account/'``;`<br>`}` |

### Redirect to a custom URL only for users with ‘administrator’ role

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11 | `add_filter(``'gform_user_registration_login_redirect_url'``,``'gf_redirect_user_role'``, 10, 2 );`<br>`function``gf_redirect_user_role(``$login_redirect``,``$sign_on``) {`<br>```GFCommon::log_debug(``__METHOD__``.``'(): Running...'``);`<br>```if``( in_array(``'administrator'``,``$sign_on``->roles ) ) {`<br>```// Redirect users with administrator role to a specific page.`<br>```$login_redirect``=``'https://example.com/'``;`<br>```GFCommon::log_debug(``__METHOD__``.``'(): Redirecting to '``.``$login_redirect``);`<br>```}`<br>```return``$login_redirect``;`<br>`}` |
...
This action hook is located in GF\_User\_Registration::handle\_login\_submission() in _gravityformsuserregistration/class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_login_redirect_url/# "Algolia")
