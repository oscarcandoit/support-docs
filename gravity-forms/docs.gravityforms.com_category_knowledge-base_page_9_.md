---
url: "https://docs.gravityforms.com/category/knowledge-base/page/9/"
title: "Knowledge Base Archives - Page 9 of 18 - Gravity Forms Documentation - Page 9 of 18"
---
...
This guide explains handling situations where form submissions fail due to invalid characters.](https://docs.gravityforms.com/handling-character-encoding-issues-in-form-submissions/ "Handling Character Encoding Issues in Form Submissions") [**Highrise (Deprecated) Changelog** \\
View the change log for the Highrise Add-On.](https://docs.gravityforms.com/highrise-change-log/ "Highrise (Deprecated) Changelog") [**HIPAA and Gravity Forms** \\
When looking into HIPAA requirements for a website, we often get asked "Is Gravity Forms HIPAA compliant?". The question is rarely that simple, as much of compliance is dependent upon other factors.](https://docs.gravityforms.com/hipaa-and-gravity-forms/ "HIPAA and Gravity Forms") [**Holding Notifications until after Payment** \\
This article explains how to send notifications after the payment has been completed when using payment add-ons. The Payment Completed notification event will send the notification when a payment has successfully been completed.](https://docs.gravityforms.com/holding-notifications-until-after-payment/ "Holding Notifications until after Payment") [**How to add Gravity Forms Blocks** \\
WordPress 5 introduced the block based page/post editor, a replacement for the venerable classic editing environment. Gravity Forms includes its own blocks for use in the new editor.](https://docs.gravityforms.com/how-to-add-gravity-forms-blocks/ "How to add Gravity Forms Blocks") [**How to Chain Forms Using Shortcodes** \\
This article explains how you can chain two forms together by placing the shortcode for another form inside the confirmation of the first form.](https://docs.gravityforms.com/how-to-chain-forms-using-shortcodes/ "How to Chain Forms Using Shortcodes") [**How to Change the Gravity Forms License on a Site** \\
This article reviews how to change the Gravity Forms license on your WordPress website](https://docs.gravityforms.com/change-gravity-forms-license/ "How to Change the Gravity Forms License on a Site") [**How To Change Your Language In Gravity Forms** \\
By default, Gravity Forms is available in US English. However, with users on every continent, island, and corner of the globe, we have built Gravity Forms to support many different languages.](https://docs.gravityforms.com/how-to-change-your-language-in-gravity-forms/ "How To Change Your Language In Gravity Forms") [**How to Delete a Field in a Form without Losing Existing Data** \\
Deleting a field will permanently remove its associated data from all existing entries. This guide will walk you through how to safely remove a field from use without losing previously collected information.](https://docs.gravityforms.com/how-to-delete-a-field-in-a-form-without-losing-existing-data/ "How to Delete a Field in a Form without Losing Existing Data") [**How to determine the Form ID** \\
This short guide details one way to determine your Gravity Forms Form ID.](https://docs.gravityforms.com/how-to-determine-the-form-id/ "How to determine the Form ID") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/8/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [7](https://docs.gravityforms.com/category/knowledge-base/page/7/) [8](https://docs.gravityforms.com/category/knowledge-base/page/8/) 9 [10](https://docs.gravityforms.com/category/knowledge-base/page/10/) [11](https://docs.gravityforms.com/category/knowledge-base/page/11/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/10/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/9/# "Algolia")
