---
url: "https://docs.gravityforms.com/gform_paypal_return_url/"
title: "gform_paypal_return_url - Gravity Forms Documentation"
---
...
# gform\_paypal\_return\_url

- [Description](https://docs.gravityforms.com/gform_paypal_return_url/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_return_url/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_return_url/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_return_url/#h-examples)
- [1\. Use site\_url()](https://docs.gravityforms.com/gform_paypal_return_url/#h-1-use-site_url)
- [2\. Hardcoded URL](https://docs.gravityforms.com/gform_paypal_return_url/#h-2-hardcoded-url)
- [Placement](https://docs.gravityforms.com/gform_paypal_return_url/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_paypal_return_url/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_return_url'``,``'your_function_name'``, 10, 4 ) ;` |

## Parameters

- **$url** [string](https://docs.gravityforms.com/string)
The return URL, uses the $\_SERVER\[‘SERVER\_NAME’\] parameter.
...
- **$query** [string](https://docs.gravityforms.com/string)

The gf\_paypal\_return parameter and value.
...
This example shows how you can replace the default return URL with the url returned by the WordPress site\_url function.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_paypal_return_url'``,``'update_url'``, 10, 4 );`<br>`function``update_url(``$url``,``$form_id``,``$entry_id``,``$query``) {`<br>```return``trailingslashit( site_url() ) .``'?'``.``$query``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_paypal_return_url'``,``'update_url'``, 10, 4 );`<br>`function``update_url(``$url``,``$form_id``,``$entry_id``,``$query``) {`<br>```return``'https://somedomain.com/?'``.``$query``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `apply_filters(``'gform_paypal_return_url'``,``$url``,``$form_id``,``$lead_id``,``$query``)` |

This filter is located in GFPayPal::return\_url() in _class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_return_url/# "Algolia")
