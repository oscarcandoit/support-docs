---
url: "https://docs.gravityforms.com/gform_notes_apply_button/"
title: "gform_notes_apply_button - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_notes_apply_button/#h-description)
- [Usage](https://docs.gravityforms.com/gform_notes_apply_button/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_notes_apply_button/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_notes_apply_button/#h-examples)
- [Customize the Apply button styling and text.](https://docs.gravityforms.com/gform_notes_apply_button/#h-customize-the-apply-button-nbsp-styling-and-text)
- [Placement](https://docs.gravityforms.com/gform_notes_apply_button/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_notes_apply_button/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_notes_apply_button'``,``'your_function_name'``);` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$apply\_button** | [string](https://docs.gravityforms.com/string/) | The HTML for the Apply button. Default contains an input button with the text “Apply” that triggers bulk actions. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_notes_apply_button'``,``'customize_notes_apply_button'``);`<br>`function``customize_notes_apply_button(``$apply_button``) {`<br>```$custom_button``=``'<input type="submit" class="button button-primary" value="'``. esc_attr__(``'Execute Bulk Action'``,``'gravityforms'``) .``'" onclick="jQuery(\'#action\').val(\'bulk\');" />'``;`<br>``<br>```return``$custom_button``;`<br>`}` |

![](https://docs.gravityforms.com/wp-content/uploads/2025/09/image-7-1024x241.png)
...
[Algolia](https://docs.gravityforms.com/gform_notes_apply_button/# "Algolia")
