---
url: "https://docs.gravityforms.com/gform_stripe_object/"
title: "gform_stripe_object - Gravity Forms Documentation"
---
...
# gform\_stripe\_object

- [Description](https://docs.gravityforms.com/gform_stripe_object/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_object/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_object/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_object/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_stripe_object/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_object/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_object/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_object'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_stripe_object'``,``'set_stripe_args'``, 10, 2 );`<br>`function``set_stripe_args(``$args``,``$form_id``){`<br>```$args``[``'ccFieldId'``] = 8;`<br>```return``$args``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_stripe_object/# "Algolia")
