---
url: "https://docs.gravityforms.com/gform_export_form/"
title: "gform_export_form - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_export_form/#h-description)
- [Usage](https://docs.gravityforms.com/gform_export_form/#h-usage)
- [Example](https://docs.gravityforms.com/gform_export_form/#h-example)
- [Placement](https://docs.gravityforms.com/gform_export_form/#h-placement)
- [Since](https://docs.gravityforms.com/gform_export_form/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_export_form/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_export_form'``,``'modify_form_for_export'``, 10, 1 );` |

To target a specific form, append the form id to the hook name. (format: gform\_export\_form\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_export_form_1'``,``'modify_form_for_export'``, 10, 1 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_export_form'``,``'modify_form_for_export'``);`<br>`function``modify_form_for_export(``$form``) {`<br>`$form``[``'exported'``] = true;`<br>`return``$form``;`<br>`}` |

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_export_form'``,``'modify_form_for_export'``);`<br>`function``modify_form_for_export(``$form``) {`<br>`$form``[``'title'``] =``'Export of '``.``$form``[``'title'``];`<br>`return``$form``;`<br>`}` |
...
This filter is located in GFExport::prepare\_forms\_for\_export() in _export.php_.
...
[Algolia](https://docs.gravityforms.com/gform_export_form/# "Algolia")
