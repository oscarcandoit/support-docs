---
url: "https://docs.gravityforms.com/gf_field_price/"
title: "GF_Field_Price - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_price/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_price/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_price/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_price/#h-properties)
- [Source Code](https://docs.gravityforms.com/gf_field_price/#h-source-code)

## Introduction

The GF\_Field\_Price class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Product field is rendered when it is a “User Defined Price” when the form is displayed and how its value is handled during and after form submission.
...
The source code is located in _includes/fields/class-gf-field-price.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_price/# "Algolia")
