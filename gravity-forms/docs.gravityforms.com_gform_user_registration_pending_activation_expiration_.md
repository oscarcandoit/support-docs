---
url: "https://docs.gravityforms.com/gform_user_registration_pending_activation_expiration/"
title: "Pending Activation Expiration - Gravity Guide"
---
...
- [Description](https://docs.gravityforms.com/gform_user_registration_pending_activation_expiration/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_pending_activation_expiration/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_pending_activation_expiration/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_user_registration_pending_activation_expiration/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_user_registration_pending_activation_expiration/#h-placement)
- [Since](https://docs.gravityforms.com/gform_user_registration_pending_activation_expiration/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_pending_activation_expiration/#h-source-code)
...
- **$expiration\_time** [int](https://docs.gravityforms.com/int)
...
|     |
| --- |
| `add_filter(``'gform_user_registration_pending_activation_expiration'``,``function``(``$expiration``) {`<br>```// Extend expiration time to 7 days.`<br>```return``( 7 * DAY_IN_SECONDS );`<br>`} );` |
...
This filter is located in _gravityformsuserregistration/class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_pending_activation_expiration/# "Algolia")
