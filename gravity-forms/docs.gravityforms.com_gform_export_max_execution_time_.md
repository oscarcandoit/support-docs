---
url: "https://docs.gravityforms.com/gform_export_max_execution_time/"
title: "gform_export_max_execution_time - Gravity Forms Documentation"
---
...
# gform\_export\_max\_execution\_time

- [Description](https://docs.gravityforms.com/gform_export_max_execution_time/#h-description)
- [Usage](https://docs.gravityforms.com/gform_export_max_execution_time/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_export_max_execution_time/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_export_max_execution_time/#h-example)
- [Placement](https://docs.gravityforms.com/gform_export_max_execution_time/#h-placement)
- [Since](https://docs.gravityforms.com/gform_export_max_execution_time/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_export_max_execution_time/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_export_max_execution_time'``, 'your_function_name, 10, 2 );` |

## Parameters

- **$max\_execution\_time** [int](https://docs.gravityforms.com/int)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_export_max_execution_time'``,``'change_export_time'``, 10, 2 );`<br>`function``change_export_time(``$max_execution_time``,``$form``){`<br>```//change the execution time to 60 seconds`<br>```return``60;`<br>`}` |
...
This filter is located in GFExport::start\_export() in _export.php_.
...
[Algolia](https://docs.gravityforms.com/gform_export_max_execution_time/# "Algolia")
