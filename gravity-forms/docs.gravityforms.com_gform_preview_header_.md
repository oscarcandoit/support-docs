---
url: "https://docs.gravityforms.com/gform_preview_header/"
title: "gform_preview_header - Gravity Forms Documentation"
---
...
# gform\_preview\_header

- [Description](https://docs.gravityforms.com/gform_preview_header/#h-description)
- [Usage](https://docs.gravityforms.com/gform_preview_header/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_preview_header/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_preview_header/#h-examples)
- [Since](https://docs.gravityforms.com/gform_preview_header/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_preview_header/#h-source-code)

## Description

The “gform\_preview\_header” action is triggered when the header of the form preview page loads, allowing further actions to be done.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_preview_header'``,``'my_function'``, 10, 1 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `function``my_function() {`<br>```//Do something here`<br>`}`<br>`add_action(``'gform_preview_header'``,``'my_function'``, 10, 1 );` |
...
[Algolia](https://docs.gravityforms.com/gform_preview_header/# "Algolia")
