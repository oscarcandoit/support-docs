---
url: "https://docs.gravityforms.com/gform_required_legend/"
title: "gform_required_legend - Gravity Forms Documentation"
---
...
# gform\_required\_legend

- [Description](https://docs.gravityforms.com/gform_required_legend/#h-description)
- [Usage](https://docs.gravityforms.com/gform_required_legend/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_required_legend/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_required_legend/#h-examples)
- [1\. Use a custom legend](https://docs.gravityforms.com/gform_required_legend/#h-1-use-a-custom-legend)
- [2\. Empty legend](https://docs.gravityforms.com/gform_required_legend/#h-2-empty-legend)
- [Placement](https://docs.gravityforms.com/gform_required_legend/#h-placement)
- [Since](https://docs.gravityforms.com/gform_required_legend/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_required_legend/#h-source-code)
...
- **$legend** [string](https://docs.gravityforms.com/string)
...
|     |
| --- |
| `add_filter(``'gform_required_legend'``,``function``(``$legend``,``$form``) {`<br>```return``'your custom legend here'``;`<br>`}, 10, 2 );` |

### 2\. Empty legend

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_required_legend'``,``'__return_empty_string'``);` |
...
This filter is located in GFFormDisplay::get\_form() in _form\_display.php_.
...
[Algolia](https://docs.gravityforms.com/gform_required_legend/# "Algolia")
