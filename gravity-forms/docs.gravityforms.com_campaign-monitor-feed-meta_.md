---
url: "https://docs.gravityforms.com/campaign-monitor-feed-meta/"
title: "Campaign Monitor Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Campaign Monitor Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/campaign-monitor-filters/)          - [Campaign Monitor Feed Meta](https://docs.gravityforms.com/campaign-monitor-feed-meta/ "Campaign Monitor Feed Meta")
          - [gform\_campaignmonitor\_field\_value](https://docs.gravityforms.com/gform_campaignmonitor_field_value/ "gform_campaignmonitor_field_value")
          - [gform\_campaignmonitor\_override\_blank\_custom\_fields](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/ "gform_campaignmonitor_override_blank_custom_fields")
          - [gform\_campaignmonitor\_override\_subscriber](https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/ "gform_campaignmonitor_override_subscriber")
...
- [Introduction](https://docs.gravityforms.com/campaign-monitor-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/campaign-monitor-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) meta for the Campaign Monitor Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `$feed``[``'meta'``] =``array``(`<br>```'feedName'``=>``'Your Feed Name'``,`<br>```'listFields_email'``=>``'2'``,`<br>```'listFields_fullname'``=>``'1'``,`<br>```'resubscribe'``=> false,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **client** [string](https://docs.gravityforms.com/string)

The Campaign Monitor client ID the contacts will be added to.

- **contactList** [string](https://docs.gravityforms.com/string)

The Campaign Monitor list ID the contacts will be added to.

- **listFields\_email** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s email.

- **listFields\_fullname** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s full name.

- **listFields\_ _{custom\_field\_name}_** [string](https://docs.gravityforms.com/string)

The ID of the field containing the value for the custom field.

There would be properties for any custom fields configured for your list, they all begin **listFields\_** and then end with the custom field name (no spaces), e.g. listFields\_ipaddress.

- **resubscribe** [boolean](https://docs.gravityforms.com/boolean)
...
[Algolia](https://docs.gravityforms.com/campaign-monitor-feed-meta/# "Algolia")
