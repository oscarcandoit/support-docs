---
url: "https://docs.gravityforms.com/category/knowledge-base/page/12/"
title: "Knowledge Base Archives - Page 12 of 18 - Gravity Forms Documentation - Page 12 of 18"
---
...
This article contains information regarding the Gravity Forms legacy license types of Personal, Business and Developer, which are no longer offered for sale but can still be renewed.](https://docs.gravityforms.com/legacy-license-faq/ "Legacy (Personal, Business, Developer) License FAQ") [**List of Gravity Forms license key validation errors** \\
The following list of shows the possible validation messages you may see if you have a problem attempting to register your Gravity Forms license key on a WordPress site.](https://docs.gravityforms.com/license-key-validation-errors/ "List of Gravity Forms license key validation errors") [**Logging and Debugging** \\
For quite a while, enabling logging within Gravity Forms has been a go-to method for debugging any issues within Gravity Forms. As of Gravity Forms version 2.2, logging functionality has been moved from a separate add-on to becoming a core feature of Gravity Forms.](https://docs.gravityforms.com/logging-and-debugging/ "Logging and Debugging") [**Making a Field Read-Only** \\
If you want to change a field to be read-only, you currently need to use JavaScript to do so. The following filter and function will help you accomplish this.](https://docs.gravityforms.com/making-a-field-read-only/ "Making a Field Read-Only") [**Multisite Licensing** \\
This article contains an overview of how Gravity Forms licensing works within a WordPress multisite installation.](https://docs.gravityforms.com/multisite-licensing/ "Multisite Licensing") [**My Download Is Not a Zip File?** \\
To install a Wordpress plugin you need a zip file, which is how we provide Gravity Forms and Gravity Forms add-ons upon download. But what if your download is not a zip file?](https://docs.gravityforms.com/my-download-is-not-a-zipfile/ "My Download Is Not a Zip File?") [**Non-Applicability of Data Processing Agreements** \\
This article describes why Gravity Forms does not provide data processing agreements to its customers.](https://docs.gravityforms.com/non-applicability-of-data-processing-agreements/ "Non-Applicability of Data Processing Agreements") [**Not Receiving Notifications** \\
This guide helps you identify common causes for not receiving notifications and provides steps to improve email reliability.](https://docs.gravityforms.com/not-receiving-notifications/ "Not Receiving Notifications") [**Obtaining Prior Versions of Gravity Forms** \\
We do not recommend downgrading to a prior version of Gravity Forms, and this short article discusses why, and what alternatives you might have.](https://docs.gravityforms.com/obtaining-prior-versions-of-gravity-forms/ "Obtaining Prior Versions of Gravity Forms") [**PayPal Checkout Beta 2.0 Features and Changes** \\
PayPal Checkout will be the future name of the Paypal Commerce Platform Add-On, and is available now as a beta for evaluation. The new version also introduces support for PayPal Subscriptions and refunds, as well as authorize and capture later feed option.](https://docs.gravityforms.com/paypal-checkout-2-0-beta-features-changes/ "PayPal Checkout Beta 2.0 Features and Changes") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/11/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [10](https://docs.gravityforms.com/category/knowledge-base/page/10/) [11](https://docs.gravityforms.com/category/knowledge-base/page/11/) 12 [13](https://docs.gravityforms.com/category/knowledge-base/page/13/) [14](https://docs.gravityforms.com/category/knowledge-base/page/14/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/13/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/12/# "Algolia")
