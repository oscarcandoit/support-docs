---
url: "https://docs.gravityforms.com/gform_zapier_sample_field_value/"
title: "gform_zapier_sample_field_value - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_zapier_sample_field_value/#h-description)
- [Usage](https://docs.gravityforms.com/gform_zapier_sample_field_value/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_zapier_sample_field_value/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_zapier_sample_field_value/#h-examples)
- [Basic usage](https://docs.gravityforms.com/gform_zapier_sample_field_value/#h-basic-usage)
- [Email Field Example](https://docs.gravityforms.com/gform_zapier_sample_field_value/#h-email-field-example)
- [Placement](https://docs.gravityforms.com/gform_zapier_sample_field_value/#h-placement)
- [Since](https://docs.gravityforms.com/gform_zapier_sample_field_value/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_zapier_sample_field_value/#h-source-code)

## Description

The gform\_zapier\_sample\_field\_value filter can be used to modify the sample field value before it is sent to Zapier.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_zapier_sample_field_value'``,``'your_function_name'``, 10, 3 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_zapier_sample_field_value'``,``'zapier_sample_field_value'``, 10, 3 );`<br>`function``zapier_sample_field_value(``$value``,``$form_id``,``$field_id``) {`<br>```return``'the new value'``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_zapier_sample_field_value'``,``function``(``$value``) {`<br>```if``(``$value``===``'test@domain.dev'``) {`<br>```$value``=``'name@example.com'``;`<br>```}`<br>```return``$value``;`<br>`} );` |
...
This filter is located in GFZapier::get\_body() in _zapier.php_.
...
[Algolia](https://docs.gravityforms.com/gform_zapier_sample_field_value/# "Algolia")
