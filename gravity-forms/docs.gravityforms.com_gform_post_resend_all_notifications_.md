---
url: "https://docs.gravityforms.com/gform_post_resend_all_notifications/"
title: "gform_post_resend_all_notifications - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_post_resend_all_notifications/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_resend_all_notifications/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_resend_all_notifications/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_resend_all_notifications/#h-examples)
- [Log Notification Resend Event.](https://docs.gravityforms.com/gform_post_resend_all_notifications/#h-log-notification-resend-event)
- [Placement](https://docs.gravityforms.com/gform_post_resend_all_notifications/#h-placement)
- [Since](https://docs.gravityforms.com/gform_post_resend_all_notifications/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_post_resend_all_notifications/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_post_resend_all_notifications'``,``'your_function_name'``, 10, 2 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$form** | [array](https://docs.gravityforms.com/array/) | The current form object, which includes form settings, fields, and other form-related data. |
| **$entry** | [array](https://docs.gravityforms.com/array/) | The current entry object, containing the submitted form data. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_action(``'gform_post_resend_all_notifications'``,``'log_notification_resend'``, 10, 2 );`<br>`function``log_notification_resend(``$form``,``$entry``) {`<br>```GFCommon::log_debug(``'gform_post_resend_all_notifications: Notifications resent for Form ID '``.``$form``[``'id'``] .``', Entry ID '``.``$entry``[``'id'``] );`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_post_resend_all_notifications/# "Algolia")
