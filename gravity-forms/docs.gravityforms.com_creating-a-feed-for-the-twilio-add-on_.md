---
url: "https://docs.gravityforms.com/creating-a-feed-for-the-twilio-add-on/"
title: "Creating a Feed for the Twilio Add-On - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Twilio Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/twilio-add-on/)    - [Setting Up the Twilio Add-On](https://docs.gravityforms.com/setting-up-the-twilio-add-on/ "Setting Up the Twilio Add-On")
    - [Obtaining Your Twilio API Key](https://docs.gravityforms.com/obtaining-and-activating-your-twilio-api-key/ "Obtaining Your Twilio API Key")
    - [Creating a Feed for the Twilio Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-twilio-add-on/ "Creating a Feed for the Twilio Add-On")
    - [Twilio Changelog](https://docs.gravityforms.com/twilio-change-log/ "Twilio Changelog")
...
- [Summary](https://docs.gravityforms.com/creating-a-feed-for-the-twilio-add-on/#h-summary)
- [Create a Feed](https://docs.gravityforms.com/creating-a-feed-for-the-twilio-add-on/#h-create-a-feed)
- [Feed Settings Reference](https://docs.gravityforms.com/creating-a-feed-for-the-twilio-add-on/#h-feed-settings-reference)

## Summary

Before the Twilio Add-On can be used with Gravity Forms, you will first need to create [a feed](https://docs.gravityforms.com/what-is-a-feed/). A feed simply allows form submission data to be sent to another source. In this instance, form submissions are being sent to the Twilio API.
...
2. Select the form that you want to use with Twilio.
3. Once within your desired form, hover over **Settings** and click on **Twilio**.
4. Click **Add New** to create a new feed. You will be presented with the Twilio feed settings screen.
...
[![Twilio Feed Settings Page](https://docs.gravityforms.com/wp-content/uploads/2025/06/image-16-1024x582.png)](https://docs.gravityforms.com/wp-content/uploads/2025/06/image-16.png)
...
| **Shorten URLs** | Enable this option to shorten URLs in your message using Bitly. Bitly support must be configured in the Twilio Add-On settings before this feature can be used.<br>This setting is only available when a Bitly Token was configured in the [Twilio Settings](https://docs.gravityforms.com/setting-up-the-twilio-add-on). |
...
[Algolia](https://docs.gravityforms.com/creating-a-feed-for-the-twilio-add-on/# "Algolia")
