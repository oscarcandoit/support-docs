---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/authorize-net-add-on/"
title: "Authorize.Net Add-On Archives - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Authorize.Net Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/authorize-net-add-on/)    - [Migrating from the Authorize.Net Add-On](https://docs.gravityforms.com/migrating-from-authorize-net-addon/ "Migrating from the Authorize.Net Add-On")
    - [Setting Up the Authorize.Net Add-On](https://docs.gravityforms.com/setting-up-the-authorize-net-add-on/ "Setting Up the Authorize.Net Add-On")
    - [Additional Authorize.Net Add-On Requirements](https://docs.gravityforms.com/authorize-net-add-on-requirements/ "Additional Authorize.Net Add-On Requirements")
    - [Creating a Feed for the Authorize.Net Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-authorize-net-add-on/ "Creating a Feed for the Authorize.Net Add-On")
    - [Recurring Payment Account Detail and Credit Card Changes](https://docs.gravityforms.com/subscription-account-detail-cc-changes/ "Recurring Payment Account Detail and Credit Card Changes")
    - [Canceling Recurring Subscriptions](https://docs.gravityforms.com/cancelling-recurring-subscriptions/ "Canceling Recurring Subscriptions")
    - [Authorize.Net Changelog](https://docs.gravityforms.com/authorize-net-change-log/ "Authorize.Net Changelog")
...
The Authorize.Net API used by this Add-On is no longer actively maintained or supported by Authorize.Net and we have therefore classified this Add-On as a Legacy Add-On and we will be deprecating it entirely in the future.

Authorize.Net have stated that breaking changes are expected that will impact the functionality of this Add-On and it will cease to function at some point. We recommend you evaluate the feasibility of migrating to another payment processing solution such as [Stripe](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/), [Square](https://docs.gravityforms.com/category/add-ons-gravity-forms/square-add-on/) or [PayPal](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/paypal-checkout-add-on/).

## Articles

[**Migrating from the Authorize.Net Add-On** \\
Step-by-step instructions for migrating from the legacy Authorize.net Add-On to a supported payment gateway like Stripe, PayPal Checkout, or Square.](https://docs.gravityforms.com/migrating-from-authorize-net-addon/ "Migrating from the Authorize.Net Add-On") [**Setting Up the Authorize.Net Add-On** \\
Step-by-step instructions on how to setup the Authorize.Net Add-On.](https://docs.gravityforms.com/setting-up-the-authorize-net-add-on/ "Setting Up the Authorize.Net Add-On") [**Additional Authorize.Net Add-On Requirements** \\
The Authorize.Net Add-On has a few additional requirements beyond those of a normal add-on. Learn about them here.](https://docs.gravityforms.com/authorize-net-add-on-requirements/ "Additional Authorize.Net Add-On Requirements") [**Creating a Feed for the Authorize.Net Add-On** \\
...
View the change log for the Authorize.Net Add-On.](https://docs.gravityforms.com/authorize-net-change-log/ "Authorize.Net Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/authorize-net-add-on/# "Algolia")
