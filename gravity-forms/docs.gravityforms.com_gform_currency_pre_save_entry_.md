---
url: "https://docs.gravityforms.com/gform_currency_pre_save_entry/"
title: "gform_currency_pre_save_entry - Gravity Forms Documentation"
---
...
# gform\_currency\_pre\_save\_entry

- [Description](https://docs.gravityforms.com/gform_currency_pre_save_entry/#h-description)
- [Usage](https://docs.gravityforms.com/gform_currency_pre_save_entry/#h-usage)
- [Example](https://docs.gravityforms.com/gform_currency_pre_save_entry/#h-example)
- [Placement](https://docs.gravityforms.com/gform_currency_pre_save_entry/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_currency_pre_save_entry/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_currency_pre_save_entry/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_currency_pre_save_entry'``,``'your_function_name'``, 10, 2 );` |

To target a specific form append the form id to the hook name. (format: gform\_currency\_pre\_save\_entry\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_currency_pre_save_entry_5'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$currency** [string](https://docs.gravityforms.com/string)
The three character ISO currency code to be stored in the entry. Default is value returned by GFCommon::get\_currency()
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_currency_pre_save_entry'``,``'override_currency_code'``, 10, 2 );`<br>`function``override_currency_code(``$currency``,``$form``) {`<br>`return``rgpost(``'input_7'``);`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_currency_pre_save_entry'``,``$form``[``'id'``], GFCommon::get_currency(),``$form``)` |

This filter is located in GFFormsModel::create\_lead and GFFormsModel::save\_lead in _forms\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_currency_pre_save_entry/# "Algolia")
