---
url: "https://docs.gravityforms.com/validation-errors/"
title: "Validation Errors CSS Selectors - Gravity Forms Documentation"
---
...
- [Validation Error Message](https://docs.gravityforms.com/validation-errors/#h-validation-error-message)
- [Validation – Error Container](https://docs.gravityforms.com/validation-errors/#h-validation-error-container)
- [Validation – Error Description Message](https://docs.gravityforms.com/validation-errors/#h-validation-error-description-message)
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .validation_error {``border``:``1px``solid``red``}` |

**example:** validation error message (div) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.validation_error {``border``:``1px``solid``red``}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield_error {``border``:``1px``solid``red``}` |

**example:** validation – error container (li) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_body .gform_fields .gfield_error {``border``:``1px``solid``red``}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield_error .validation_message {``border``:``1px``solid``red``}` |

**example:** validation – error description message (div) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_body .gform_fields .gfield_error .validation_message {``border``:``1px``solid``red``}` |
...
[Algolia](https://docs.gravityforms.com/validation-errors/# "Algolia")
