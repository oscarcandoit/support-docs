---
url: "https://docs.gravityforms.com/gform_breeze_card/"
title: "gform_breeze_card - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_breeze_card/#h-description)
- [Usage](https://docs.gravityforms.com/gform_breeze_card/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_breeze_card/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_breeze_card/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_breeze_card/#h-source-code)

## Description

The “gform\_breeze\_card” filter in the Gravity Breeze Add-On filters which card is created by the add-on.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_breeze_card'``,``'my_function'``, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `function``my_function(``$card``,``$feed``,``$entry``,``$form``) {`<br>```//Do something here`<br>```return``$card``;`<br>`}`<br>`add_filter(``'gform_breeze_card'``,``'my_function'``, 10, 4 );` |

## Source Code

This filter is located in _class-gf-breeze.php_.
...
[Algolia](https://docs.gravityforms.com/gform_breeze_card/# "Algolia")
