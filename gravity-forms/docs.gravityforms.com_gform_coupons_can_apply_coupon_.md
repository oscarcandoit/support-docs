---
url: "https://docs.gravityforms.com/gform_coupons_can_apply_coupon/"
title: "gform_coupons_can_apply_coupon - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Coupons Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/coupons-filters/)          - [Coupons Feed Meta](https://docs.gravityforms.com/coupons-feed-meta/ "Coupons Feed Meta")
          - [GFCoupons](https://docs.gravityforms.com/gfcoupons/ "GFCoupons")
          - [gform\_coupons\_can\_apply\_coupon](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/ "gform_coupons_can_apply_coupon")
          - [gform\_coupons\_discount\_amount](https://docs.gravityforms.com/gform_coupons_discount_amount/ "gform_coupons_discount_amount")
          - [gform\_coupons\_is\_valid\_code](https://docs.gravityforms.com/gform_coupons_is_valid_code/ "gform_coupons_is_valid_code")
          - [gform\_coupons\_post\_delete\_coupon](https://docs.gravityforms.com/gform_coupons_post_delete_coupon/ "gform_coupons_post_delete_coupon")
...
# gform\_coupons\_can\_apply\_coupon

- [Description](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/#h-description)
- [Usage](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/#h-examples)
- [Restrict a coupon to a single form](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/#h-restrict-a-coupon-to-a-single-form)
- [Limit a coupon to logged in users only](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/#h-limit-a-coupon-to-logged-in-users-only)
- [Placement](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/#h-placement)
- [Since](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `apply_filters(``'gform_coupons_can_apply_coupon'``,``$can_apply``,``$coupon_code``,``$existing_coupon_codes``,``$feed``,``$form``);` |

## Parameters

- **$can\_apply** [array](https://docs.gravityforms.com/array)
The coupon validation result.

- **$coupon\_code** [string](https://docs.gravityforms.com/string)

The coupon code being validated.

- **$existing\_coupon\_codes** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_coupons_can_apply_coupon'``,``function``(``$can_apply``,``$coupon_code``,``$existing_coupon_codes``,``$feed``,``$form``) {`<br>```if``(``$form``[``'id'``] == 1 &&``$coupon_code``!==``'FREE'``) {`<br>```$can_apply``[``'is_valid'``]       = false;`<br>```$can_apply``[``'invalid_reason'``] =``'the error message'``;`<br>```}`<br>``<br>```return``$can_apply``;`<br>`}, 10, 5 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_coupons_can_apply_coupon'``,``function``(``$can_apply``,``$coupon_code``,``$existing_coupon_codes``,``$feed``,``$form``) {`<br>```if``(  is_user_logged_in() === false &&``$coupon_code``===``'TEST'``) {`<br>```$can_apply``[``'is_valid'``]       = false;`<br>```$can_apply``[``'invalid_reason'``] =``'the error message'``;`<br>```}`<br>```return``$can_apply``;`<br>`}, 10, 5 );` |
...
This filter is located in apply\_coupon\_code() in _class-gf-coupons.php_.
...
[Algolia](https://docs.gravityforms.com/gform_coupons_can_apply_coupon/# "Algolia")
