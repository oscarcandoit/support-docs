---
url: "https://docs.gravityforms.com/gform_aweber_field_value/"
title: "gform_aweber_field_value - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [AWeber Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/aweber-filters/)          - [AWeber Feed Meta](https://docs.gravityforms.com/aweber-feed-meta/ "AWeber Feed Meta")
          - [gform\_aweber\_ad\_tracking](https://docs.gravityforms.com/gform_aweber_ad_tracking/ "gform_aweber_ad_tracking")
          - [gform\_aweber\_args\_pre\_subscribe](https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/ "gform_aweber_args_pre_subscribe")
          - [gform\_aweber\_field\_value](https://docs.gravityforms.com/gform_aweber_field_value/ "gform_aweber_field_value")
          - [gform\_aweber\_post\_subscriber\_created](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/ "gform_aweber_post_subscriber_created")
...
# gform\_aweber\_field\_value

- [Description](https://docs.gravityforms.com/gform_aweber_field_value/#h-description)
- [Usage](https://docs.gravityforms.com/gform_aweber_field_value/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_aweber_field_value/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_aweber_field_value/#h-examples)
- [1\. Change Signature Value](https://docs.gravityforms.com/gform_aweber_field_value/#h-1-change-signature-value)
- [Placement](https://docs.gravityforms.com/gform_aweber_field_value/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_aweber_field_value/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_aweber_field_value/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_aweber_field_value'``,``'your_function_name'``, 10, 4 );` |

To target a specific form append the form id to the hook name. (format: gform\_aweber\_field\_value\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_aweber_field_value_10'``,``'your_function_name'``, 10, 4 );` |

To target a specific field append both the form id and the field id to the hook name. (format: gform\_aweber\_field\_value\_FORMID\_FIELDID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_aweber_field_value_10_3'``,``'your_function_name'``, 10, 4 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$value** | [string](https://docs.gravityforms.com/string) | The value to be modified. |
| **$form\_id** | [integer](https://docs.gravityforms.com/integer) | The ID of the form being processed. |
| **$field\_id** | [string](https://docs.gravityforms.com/string) | The ID of the field being processed. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `add_filter(``'gform_aweber_field_value'``,``'change_signature_value'``, 10, 4 );`<br>`function``change_signature_value(``$value``,``$form_id``,``$field_id``,``$entry``) {`<br>```$form``= GFAPI::get_form(``$form_id``);`<br>```$field``= GFFormsModel::get_field(``$form``,``$field_id``);`<br>```if``(``is_object``(``$field``) &&``$field``->get_input_type() ==``'signature'``) {`<br>```$value``= RGFormsModel::get_upload_url_root() .``'signatures/'``.``$value``;`<br>```}`<br>```return``$value``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_aweber_field_value'``,``array``(``$form``[``'id'``],``$field_id``),``$field_value``,``$form``[``'id'``],``$field_id``,``$entry``);` |

This filter is located in GFAWeber::maybe\_override\_field\_value() in _class-gf-aweber.php_.
...
[Algolia](https://docs.gravityforms.com/gform_aweber_field_value/# "Algolia")
