---
url: "https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/"
title: "GetResponse Limit Custom Fields - Gravity Forms"
---
...
# gform\_getresponse\_limit\_pre\_get\_custom\_fields

- [Description](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/#h-description)
- [Usage](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/#h-example)
- [Placement](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/#h-placement)
- [Since](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/#h-source-code)

## Description

The gform\_getresponse\_limit\_pre\_get\_custom\_fields allows the maximum number of custom fields which are retrieved from GetResponse to be overridden.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_getresponse_limit_pre_get_custom_fields'``,``'your_function_name'``);` |

## Parameters

- **$limit** [int](https://docs.gravityforms.com/int)
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_getresponse_limit_pre_get_custom_fields'``,``function``(``$limit``) {`<br>`return``200;`<br>`} );` |
...
This filter is located in _GFGetResponse::get\_custom\_fields\_limit()_ in _gravityformsgetresponse/class-gf-getresponse.php_.
...
[Algolia](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/# "Algolia")
