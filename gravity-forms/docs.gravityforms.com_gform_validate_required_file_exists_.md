---
url: "https://docs.gravityforms.com/gform_validate_required_file_exists/"
title: "gform_validate_required_file_exists - Gravity Forms Documentation"
---
...
# gform\_validate\_required\_file\_exists

- [Description](https://docs.gravityforms.com/gform_validate_required_file_exists/#h-description)
- [Usage](https://docs.gravityforms.com/gform_validate_required_file_exists/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_validate_required_file_exists/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_validate_required_file_exists/#h-example)
- [Placement](https://docs.gravityforms.com/gform_validate_required_file_exists/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_validate_required_file_exists/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_validate_required_file_exists/#h-since)
...
- **$validate** [boolean](https://docs.gravityforms.com/boolean/)

Whether to validate the required file exists. Default is `true`.
- **$file** [array](https://docs.gravityforms.com/array/)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_validate_required_file_exists'``,``'require_file'``, 10, 3 );`<br>`function``require_file(``$validate``,``$file``,``$field``) {`<br>```return``$validate``;`<br>`}` |
...
The filter is located in **GF\_Field\_FileUpload::is\_value\_submission\_empty()** in _/includes/fields/class-gf-field-fileupload.php_
...
[Algolia](https://docs.gravityforms.com/gform_validate_required_file_exists/# "Algolia")
