---
url: "https://docs.gravityforms.com/rgblank/"
title: "rgblank() - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/rgblank/#h-description)
- [Usage](https://docs.gravityforms.com/rgblank/#h-usage)
- [Parameters](https://docs.gravityforms.com/rgblank/#h-parameters)
- [Returns](https://docs.gravityforms.com/rgblank/#h-returns)
- [Examples](https://docs.gravityforms.com/rgblank/#h-examples)
- [Source Code](https://docs.gravityforms.com/rgblank/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2 | `$text``=``'This is a string'``;`<br>`rgblank(``$text``);` |
...
[Algolia](https://docs.gravityforms.com/rgblank/# "Algolia")
