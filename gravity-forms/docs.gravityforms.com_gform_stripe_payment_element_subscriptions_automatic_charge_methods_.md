---
url: "https://docs.gravityforms.com/gform_stripe_payment_element_subscriptions_automatic_charge_methods/"
title: "gform_stripe_payment_element_subscriptions_automatic_charge_methods - Gravity Forms Documentation"
---
...
- [Usage](https://docs.gravityforms.com/gform_stripe_payment_element_subscriptions_automatic_charge_methods/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_payment_element_subscriptions_automatic_charge_methods/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_stripe_payment_element_subscriptions_automatic_charge_methods/#h-example)
- [Placement](https://docs.gravityforms.com/gform_stripe_payment_element_subscriptions_automatic_charge_methods/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_payment_element_subscriptions_automatic_charge_methods/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_payment_element_subscriptions_automatic_charge_methods/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_payment_element_subscriptions_automatic_charge_methods'``,``function``(``$methods``,``$feed``,``$form``)` |

## Parameters

- $form [Form Object](https://docs.gravityforms.com/form-object/)
- $unsupported\_payment\_methods [array](https://www.php.net/manual/en/language.types.array.php)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_stripe_payment_element_subscriptions_automatic_charge_methods'``,``function``(``$methods``,``$feed``,``$form``) {`<br>``<br>```$methods``=``array_merge``(``$methods``,``array``( ‘sofort’ ) )`<br>```unset(``$methods``[‘sepa_debit’] );`<br>```return``$methods``;`<br>`} );` |
...
|     |     |
| --- | --- |
| 1 | `return``apply_filters(``'gform_stripe_payment_element_subscriptions_automatic_charge_methods'``,``$methods``,``$feed``,``$form``);` |

This filter is located in GF\_Payment\_Element\_Payment::get\_subscriptions\_automatic\_charge\_methods() in _class-gf-payment-element-payment.php_
...
[Algolia](https://docs.gravityforms.com/gform_stripe_payment_element_subscriptions_automatic_charge_methods/# "Algolia")
