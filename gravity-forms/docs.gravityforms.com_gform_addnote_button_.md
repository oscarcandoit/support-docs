---
url: "https://docs.gravityforms.com/gform_addnote_button/"
title: "gform_addnote_button - Gravity Forms Documentation"
---
...
# gform\_addnote\_button

- [Description](https://docs.gravityforms.com/gform_addnote_button/#h-description)
- [Usage](https://docs.gravityforms.com/gform_addnote_button/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_addnote_button/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_addnote_button/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_addnote_button/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_addnote_button/#h-source-code)

## Description

The “gform\_addnote\_button” filter in Gravity Forms allows modification of the HTML of the “Add Note” button for Entry Notes on the Entry Detail page.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_addnote_button'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$note\_button** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_addnote_button'``,``'change_button'``, 10, 1 );`<br>`function``change_button(``$note_button``){`<br>```$note_button``=``'<input type="submit" name="add_note" value="'``. esc_attr__(``'Add A Note To Your Entry'``,``'gravityforms'``) .``'" class="button" style="width:auto;padding-bottom:2px;background-color:blue;color:white" onclick="jQuery(\'#action\').val(\'add_note\');"/>'``;`<br>```return``$note_button``;`<br>`}` |
...
This filter is located in GFEntryDetail::notes\_grid() in _entry\_detail.php_.
...
[Algolia](https://docs.gravityforms.com/gform_addnote_button/# "Algolia")
