---
url: "https://docs.gravityforms.com/api-outage/"
title: "Gravity API Outage Impacts - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/api-outage/#h-introduction)
- [What Will Be Affected](https://docs.gravityforms.com/api-outage/#h-what-will-be-affected)
- [What Won’t Be Affected](https://docs.gravityforms.com/api-outage/#h-what-won-t-be-affected)
- [After the Outage](https://docs.gravityforms.com/api-outage/#h-after-the-outage)

## Introduction

A temporary Gravity API outage due to maintenance, backups, or server issues can affect several license-oriented operations. This article describes what is and is not affected in such circumstances, in case an “outage” notice has been posted on site.

## **What Will Be Affected**

When the Gravity Forms API is inaccessible, it affects the following actions:

- **You won’t be able to activate the Gravity Forms plugin on new sites.**

- **Plugin updates** won’t be able to run.
- **Accessing your license** **keys** on [My Account](https://www.gravityforms.com/my-account/) will be temporarily unavailable.
- You won’t be able to **create new external service connections** using our plugins, nor **manage existing add-on service connections** during the outage. Connections you’ve already set up should keep working without any disruption.
- You will not be able to **create a new Technical Support ticket** as this requires license validation via the API. The [General Question](https://www.gravityforms.com/open-support-ticket/) form is still available for all users and will reach our support team also.

## **What Won’t Be Affected**

The good news is that not everything is impacted. Here’s what will still work:

- **Purchases, Renewals, and Account Creation**: You can still buy new licenses or renew existing ones. Charges and transactions will process normally. However, **license provisioning and Gravity Forms account creation will be delayed** until the API is back online. This means that you may not receive your verification email, your purchased license key, your email receipt, or your expiry date change (for a renewal) until the API server is back up and running and caught up with its queued requests.

- **External Service Connections**: Most **OAuth connections** managed through our add-ons to services like email marketing platforms, CRMs, payment gateways, etc, should be unaffected. In some rare cases, where the OAuth-generated access token that your service has provided to authenticate your connection happens to expire during the outage, you may have to wait for the API service to resume in order to re-establish the connection.
- You use use the [General Questions](https://www.gravityforms.com/open-support-ticket/general/) option to raise a ticket which will reach our support team.

## **After the Outage**

Once the API is back online, any pending tasks (like license provisioning) will automatically go through. If anything doesn’t update automatically, you might need to log into your account or contact our [support team](https://www.gravityforms.com/support/) to finish things up.

**We apologize for any inconvenience a planned or unplanned outage may cause**. We know this might be inconvenient. Rest assured that our teams work hard to minimize disruption as we improve things at our end.
...
[Algolia](https://docs.gravityforms.com/api-outage/# "Algolia")
