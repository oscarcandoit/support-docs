---
url: "https://docs.gravityforms.com/gform_stripe_entry_not_found_status_code/"
title: "gform_stripe_entry_not_found_status_code - Gravity Forms"
---
...
# gform\_stripe\_entry\_not\_found\_status\_code

- [Description](https://docs.gravityforms.com/gform_stripe_entry_not_found_status_code/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_entry_not_found_status_code/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_entry_not_found_status_code/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_entry_not_found_status_code/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_stripe_entry_not_found_status_code/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_entry_not_found_status_code/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_entry_not_found_status_code/#h-source-code)

## Description

The “gform\_stripe\_entry\_not\_found\_status\_code” filter in Gravity Forms Stripe Add-On allows the status code for the entry not found WP\_Error to be overridden.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_entry_not_found_status_code'``,``'your_function_name'``, 10, 3 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_stripe_entry_not_found_status_code'``,``'change_status_code'``, 10, 3 );`<br>`function``change_status_code(``$status_code``,``$action``,``$event``){`<br>```return``"205"``;`<br>`}` |
...
This filter is located in GFStripe::callback() in _gravityformsstripe/class-gf-stripe.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_entry_not_found_status_code/# "Algolia")
