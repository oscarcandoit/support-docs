---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/signature-add-on/"
title: "Signature Add-On Archives - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Signature Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/signature-add-on/)    - [Setting Up the Signature Add-On](https://docs.gravityforms.com/signature-add-on/ "Setting Up the Signature Add-On")
    - [Using the Signature Add-On](https://docs.gravityforms.com/using-the-signature-add-on/ "Using the Signature Add-On")
    - [gform\_signature\_show\_in\_all\_fields](https://docs.gravityforms.com/gform_signature_show_in_all_fields/ "gform_signature_show_in_all_fields")
    - [Signature Changelog](https://docs.gravityforms.com/signature-change-log/ "Signature Changelog")
...
Step-by-step instructions on how to setup the Signature Add-On.](https://docs.gravityforms.com/signature-add-on/ "Setting Up the Signature Add-On") [**Using the Signature Add-On** \\
Discover how to use and customize the Gravity Forms Signature Add-On.](https://docs.gravityforms.com/using-the-signature-add-on/ "Using the Signature Add-On") [**gform\_signature\_show\_in\_all\_fields** \\
The gform\_signature\_show\_in\_all\_fields filter allows the inclusion of the signature image in the {all\_fields} merge tag output to be toggled on/off.](https://docs.gravityforms.com/gform_signature_show_in_all_fields/ "gform_signature_show_in_all_fields") [**Signature Changelog** \\
View the change log for the Signature Add-On.](https://docs.gravityforms.com/signature-change-log/ "Signature Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/signature-add-on/# "Algolia")
