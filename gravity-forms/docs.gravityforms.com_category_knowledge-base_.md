---
url: "https://docs.gravityforms.com/category/knowledge-base/"
title: "Knowledge Base Archives - Gravity Forms Documentation"
---
...
Answers to the most common questions we receive about the Gravity Forms Starter license provided to GoDaddy hosted website customers.](https://docs.gravityforms.com/about-godaddy-starter-licenses/ "About GoDaddy Starter Licenses") [**About Processor Decline Errors When Attempting A Purchase** \\
This article explains what a processor decline is when you are trying to make a purchase on the Gravity Forms website, and how you may go about resolving it.](https://docs.gravityforms.com/processor-decline-errors/ "About Processor Decline Errors When Attempting A Purchase") [**Accepting Payments Without SSL** \\
Learn how to accept payments using Gravity Forms without your own dedicated SSL by using the PayPal Standard add-on.](https://docs.gravityforms.com/accepting-payments-without-ssl/ "Accepting Payments Without SSL") [**Accessibility Checklist for Gravity Forms** \\
This article takes you through settings and options for forms and fields to help educate you as to what (and what not) to use for better accessibility of your forms.](https://docs.gravityforms.com/accessibility-checklist-for-gravity-forms/ "Accessibility Checklist for Gravity Forms") [**Accessibility Guide for Content Providers** \\
With Gravity Forms you have a great tool to create accessible web forms. In this documentation we want to help you:\\
\\
Set up a form with accessibility in mind.](https://docs.gravityforms.com/accessibility-for-content-providers/ "Accessibility Guide for Content Providers") [**Accessibility Guide for Designers** \\
Design a beautiful form and and make it accessible for all users. On this page we list some of the most important topics where design, accessibility and good UX meet.](https://docs.gravityforms.com/accessibility-for-designers/ "Accessibility Guide for Designers") [**Accessibility Guide for Developers** \\
How to create a form that is usable and accessible for most people? How to develop so that your forms comply to the global Web Content Accessibility Guidelines (currently WCAG 2.1 AA)?.](https://docs.gravityforms.com/accessibility-for-developers/ "Accessibility Guide for Developers") [**Accessibility Warning Showing on Field** \\
This article provides information regarding accessibility warning messages you may receive for a particular field on your form.](https://docs.gravityforms.com/field-accessibility-warning/ "Accessibility Warning Showing on Field") [**Add-On Support for Background Feed Processing** \\
Background or async feed processing is a method that can be used to improve form submission performance.](https://docs.gravityforms.com/support-background-feed/ "Add-On Support for Background Feed Processing") [**Adding an inline Submit Button in Gravity Forms 2.5** \\
This tutorial provides a quick overview of how to add an inline submit button with the new columnar layout editor available in Gravity Forms 2.5.](https://docs.gravityforms.com/adding-an-inline-submit-button-in-gravity-forms-2-5/ "Adding an inline Submit Button in Gravity Forms 2.5") 1 [2](https://docs.gravityforms.com/category/knowledge-base/page/2/) [3](https://docs.gravityforms.com/category/knowledge-base/page/3/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/2/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/# "Algolia")
