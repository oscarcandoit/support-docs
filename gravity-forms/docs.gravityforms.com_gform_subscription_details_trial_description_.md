---
url: "https://docs.gravityforms.com/gform_subscription_details_trial_description/"
title: "gform_subscription_details_trial_description - Gravity Forms Documentation"
---
...
# gform\_subscription\_details\_trial\_description

- [Description](https://docs.gravityforms.com/gform_subscription_details_trial_description/#h-description)
- [Usage](https://docs.gravityforms.com/gform_subscription_details_trial_description/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_subscription_details_trial_description/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_subscription_details_trial_description/#h-example)
- [Customize the trial description.](https://docs.gravityforms.com/gform_subscription_details_trial_description/#h-customize-the-trial-description)
- [Placement](https://docs.gravityforms.com/gform_subscription_details_trial_description/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_subscription_details_trial_description/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_subscription_details_trial_description'``,``'your_function_name'``, 10, 3 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$trial\_description** | string | The trial description text. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_subscription_details_trial_description'``,``'customize_trial_description'``, 10, 3 );`<br>`function``customize_trial_description(``$trial_description``,``$form``,``$entry``) {`<br>```// Add custom text to the trial description`<br>```$trial_description``.=``' (Custom trial period)'``;`<br>``<br>```return``$trial_description``;`<br>`}` |

[![Image showing custom message for the trial period.](https://docs.gravityforms.com/wp-content/uploads/2025/08/image.png)](https://docs.gravityforms.com/wp-content/uploads/2025/08/image.png)
...
This filter is located in entry\_detail.php.
...
[Algolia](https://docs.gravityforms.com/gform_subscription_details_trial_description/# "Algolia")
