---
url: "https://docs.gravityforms.com/enabling-no-conflict-mode/"
title: "Enabling No Conflict Mode - Gravity Forms Documentation"
---
...
There is an easy fix to get around these issues, but it is still recommended you troubleshoot using our [theme and plugin conflict steps](https://docs.gravityforms.com/testing-theme-plugin-conflict/) to isolate the issue and report it to the proper developer.
...
We recommend finding the source of this issue as it could cause further problems later on. Please follow the [Theme and Plugin Conflict troubleshooting steps](https://docs.gravityforms.com/testing-theme-plugin-conflict/).
...
[Algolia](https://docs.gravityforms.com/enabling-no-conflict-mode/# "Algolia")
