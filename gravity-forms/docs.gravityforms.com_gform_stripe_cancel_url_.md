---
url: "https://docs.gravityforms.com/gform_stripe_cancel_url/"
title: "gform_stripe_cancel_url - Gravity Forms Documentation"
---
...
# gform\_stripe\_cancel\_url

- [Description](https://docs.gravityforms.com/gform_stripe_cancel_url/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_cancel_url/#h-usage)
- [Example](https://docs.gravityforms.com/gform_stripe_cancel_url/#h-example)
- [Placement](https://docs.gravityforms.com/gform_stripe_cancel_url/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_cancel_url/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_cancel_url/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_stripe_cancel_url'``,``function``(``$url``,``$form_id``) {`<br>```GFCommon::log_debug(``__METHOD__``.``'(): Original URL: '``.``$url``);`<br>```// Replace example.com with your site domain.`<br>```$url``=``str_replace``(``'localhost'``,``'example.com'``,``$url``);`<br>```GFCommon::log_debug(``__METHOD__``.``'(): New URL: '``.``$url``);`<br>```return``$url``;`<br>`}, 10, 2 );` |
...
[Algolia](https://docs.gravityforms.com/gform_stripe_cancel_url/# "Algolia")
