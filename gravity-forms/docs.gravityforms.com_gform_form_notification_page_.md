---
url: "https://docs.gravityforms.com/gform_form_notification_page/"
title: "gform_form_notification_page - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_form_notification_page/#h-description)
- [Usage](https://docs.gravityforms.com/gform_form_notification_page/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_form_notification_page/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_form_notification_page/#h-example)
- [Placement](https://docs.gravityforms.com/gform_form_notification_page/#h-placement)
- [Since](https://docs.gravityforms.com/gform_form_notification_page/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_form_notification_page/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_form_notification_page'``,``'your_function_name'``, 10, 2 );` |

To target a specific form, append the form id to the hook name. (format: gform\_form\_notification\_page\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_form_notification_page_1'``,``'your_function_name'``, 10, 2 );` |
...
- **$notification\_id** [int](https://docs.gravityforms.com/int)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_form_notification_page'``,``'use_master_form'``, 10, 2 );`<br>`function``use_master_form(``$form``,``$notification_id``){`<br>```if``(``$form``[``'id'``] ==``'45'``){`<br>```//use master form with notifications to be used for all forms.`<br>```$form``= GFFormsModel::get_form_meta(79);`<br>```}`<br>```return``$form``;` |
...
[Algolia](https://docs.gravityforms.com/gform_form_notification_page/# "Algolia")
