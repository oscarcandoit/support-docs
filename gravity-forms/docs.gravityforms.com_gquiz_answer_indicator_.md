---
url: "https://docs.gravityforms.com/gquiz_answer_indicator/"
title: "gquiz_answer_indicator - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Quiz Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/quiz-filters/)          - [gform\_quiz\_show\_choice\_values](https://docs.gravityforms.com/gform_quiz_show_choice_values/ "gform_quiz_show_choice_values")
          - [gquiz\_answer\_indicator](https://docs.gravityforms.com/gquiz_answer_indicator/ "gquiz_answer_indicator")
          - [gquiz\_correct\_indicator](https://docs.gravityforms.com/gquiz_correct_indicator/ "gquiz_correct_indicator")
          - [gquiz\_incorrect\_indicator](https://docs.gravityforms.com/gquiz_incorrect_indicator/ "gquiz_incorrect_indicator")
...
# gquiz\_answer\_indicator

- [Description](https://docs.gravityforms.com/gquiz_answer_indicator/#h-description)
- [Usage](https://docs.gravityforms.com/gquiz_answer_indicator/#h-usage)
- [Examples](https://docs.gravityforms.com/gquiz_answer_indicator/#h-examples)
- [Placement](https://docs.gravityforms.com/gquiz_answer_indicator/#h-placement)
- [Source Code](https://docs.gravityforms.com/gquiz_answer_indicator/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gquiz_answer_indicator'``,``'gquiz_answer_indicator'``, 10, 7 );` |

## Parameters

- **$indicator\_markup** [string](https://docs.gravityforms.com/string)
...
- **$lead** [Lead Object](https://docs.gravityforms.com/lead-object)

The Lead object.

- **$is\_response\_correct** [bool](https://docs.gravityforms.com/bool)

True or false if the response is correct; can be used to change indicators.

- **$is\_response\_wrong** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15 | `add_filter(``'gquiz_answer_indicator'``,``'gquiz_answer_indicator'``, 10, 7);`<br>`function``gquiz_answer_indicator(``$indicator_markup``,``$form``,``$field``,``$choice``,``$lead``,``$is_response_correct``,``$is_response_wrong``) {`<br>`if``(``$is_response_correct``) {`<br>`$indicator_markup``=``' (you got this one right!)'``;`<br>`}``elseif``(``$is_response_wrong``) {`<br>`if``(``$field``[``'inputType'``] ==``'checkbox'``&& rgar(``$choice``,``'gquizIsCorrect'``) ) {`<br>`$indicator_markup``=``' (you missed this one!)'``;`<br>`}``else``{`<br>`$indicator_markup``=``' (you got this one wrong!)'``;`<br>`}`<br>`}``elseif``( rgar(``$choice``,``'gquizIsCorrect'``) ) {`<br>`$indicator_markup``=``' (this was the correct answer!)'``;`<br>`}`<br>`return``$indicator_markup``;`<br>`}` |
...
This filter is located in GFQuiz::get\_quiz\_results() in _gravityformsquiz/class-gf-quiz.php_.
...
[Algolia](https://docs.gravityforms.com/gquiz_answer_indicator/# "Algolia")
