---
url: "https://docs.gravityforms.com/gform_form_settings_fields/"
title: "gform_form_settings_fields - Gravity Forms Documentation"
---
...
# gform\_form\_settings\_fields

- [Description](https://docs.gravityforms.com/gform_form_settings_fields/#h-description)
- [Usage](https://docs.gravityforms.com/gform_form_settings_fields/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_form_settings_fields/#h-examples)
- [Add a new field](https://docs.gravityforms.com/gform_form_settings_fields/#h-add-a-new-field)
- [Placement](https://docs.gravityforms.com/gform_form_settings_fields/#h-placement)
- [Since](https://docs.gravityforms.com/gform_form_settings_fields/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_form_settings_fields/#h-source-code)

## Description

The gform\_form\_settings\_fields filter is used to customize the available settings on the Form Settings page and save them to the database.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_form_settings_fields'``,``'your_function_name'``, 10, 2 );` |

You can also target a specific form by adding the form id after the hook name.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_form_settings_fields_6'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$fields** [array](https://docs.gravityforms.com/array/)

The Form Settings fields. See the [Settings API](https://docs.gravityforms.com/category/developers/php-api/add-on-framework/settings-api/) for details about how the fields are defined.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_form_settings_fields'``,``function``(``$fields``,``$form``) {`<br>```$fields``[``'form_options'``][``'fields'``][] =``array``(``'type'``=>``'hidden'``,``'name'``=>``'my_custom_hidden_field'``);`<br>``<br>```return``$fields``;`<br>`}, 10, 2 );` |
...
This filter is located in GFFormSettings::form\_settings\_fields() in _form\_settings.php_.
...
[Algolia](https://docs.gravityforms.com/gform_form_settings_fields/# "Algolia")
