---
url: "https://docs.gravityforms.com/gform_mailchimp_allow_resubscription/"
title: "gform_mailchimp_allow_resubscription - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_mailchimp_allow_resubscription/#h-description)
- [Usage](https://docs.gravityforms.com/gform_mailchimp_allow_resubscription/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_mailchimp_allow_resubscription/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_mailchimp_allow_resubscription/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_mailchimp_allow_resubscription/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_mailchimp_allow_resubscription/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `<?php`<br>`add_filter(``"gform_mailchimp_allow_resubscription"``,``"__return_false"``);`<br>`?>` |
...
This filter is located in _mailchimp.php_.
...
[Algolia](https://docs.gravityforms.com/gform_mailchimp_allow_resubscription/# "Algolia")
