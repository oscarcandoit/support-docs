---
url: "https://docs.gravityforms.com/gform_brevo_allow_resubscription/"
title: "gform_brevo_allow_resubscription - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Brevo Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/brevo-filters/)          - [gform\_brevo\_request\_args](https://docs.gravityforms.com/gform_brevo_request_args/ "gform_brevo_request_args")
          - [gform\_brevo\_allow\_resubscription](https://docs.gravityforms.com/gform_brevo_allow_resubscription/ "gform_brevo_allow_resubscription")
          - [Brevo Feed Meta](https://docs.gravityforms.com/brevo-feed-meta/ "Brevo Feed Meta")
...
- [Description](https://docs.gravityforms.com/gform_brevo_allow_resubscription/#h-description)
- [Usage](https://docs.gravityforms.com/gform_brevo_allow_resubscription/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_brevo_allow_resubscription/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_brevo_allow_resubscription/#h-examples)
- [Prevent resubscription for unsubscribed users.](https://docs.gravityforms.com/gform_brevo_allow_resubscription/#h-prevent-resubscription-for-unsubscribed-users)
- [Allow resubscription only on form with ID 8.](https://docs.gravityforms.com/gform_brevo_allow_resubscription/#h-allow-resubscription-only-on-form-with-id-8)
- [Placement](https://docs.gravityforms.com/gform_brevo_allow_resubscription/#h-placement)
- [Since](https://docs.gravityforms.com/gform_brevo_allow_resubscription/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_brevo_allow_resubscription/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_brevo_allow_resubscription'``,``'your_function_name'``, 10, 4 );` |

To limit the scope of your function to a specific form, append the form id to the end of the hook name. (format: gform\_brevo\_allow\_resubscription\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_brevo_allow_resubscription_123'``,``'your_function_name'``, 10, 4 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$allow\_resubscription** | bool | If the user should be resubscribed. |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_brevo_allow_resubscription'``,``'__return_false'``);` |

### Allow resubscription only on form with ID 8.

|     |     |
| --- | --- |
| 1<br>2 | `add_filter( 'gform_brevo_allow_resubscription', '__return_false', 10 );`<br>`add_filter( 'gform_brevo_allow_resubscription_8', '__return_true', 15 );` |
...
[Algolia](https://docs.gravityforms.com/gform_brevo_allow_resubscription/# "Algolia")
