---
url: "https://docs.gravityforms.com/gform_field_size_choices/"
title: "gform_field_size_choices - Gravity Forms Documentation"
---
...
# gform\_field\_size\_choices

- [Description](https://docs.gravityforms.com/gform_field_size_choices/#h-description)
- [Usage](https://docs.gravityforms.com/gform_field_size_choices/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_field_size_choices/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_field_size_choices/#h-examples)
- [1\. Add custom size](https://docs.gravityforms.com/gform_field_size_choices/#h-1-add-custom-size)
- [Placement](https://docs.gravityforms.com/gform_field_size_choices/#h-placement)
- [Since](https://docs.gravityforms.com/gform_field_size_choices/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_field_size_choices/#h-source-code)

## Description

The gform\_field\_size\_choices filter allows the choices for Field Size setting in the form editor to be customized.
...
This code can be placed in the [functions.php](http://codex.wordpress.org/Theme_Development#Functions_File) file of your active theme or a custom functions plugin.
...
This filter is located in GF\_Field::get\_size\_choices() in _includes/fields/class-gf-field.php_.
