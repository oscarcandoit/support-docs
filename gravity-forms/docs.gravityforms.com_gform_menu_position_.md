---
url: "https://docs.gravityforms.com/gform_menu_position/"
title: "gform_menu_position - Gravity Forms Documentation"
---
...
# gform\_menu\_position

- [Description](https://docs.gravityforms.com/gform_menu_position/#h-description)
- [Usage](https://docs.gravityforms.com/gform_menu_position/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_menu_position/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_menu_position/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_menu_position/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_menu_position'``,``'my_custom_function'``, 10, 1 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_menu_position'``,``'my_gform_menu_position'``);`<br>`function``my_gform_menu_position(``$position``) {`<br>`return``50;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_menu_position/# "Algolia")
