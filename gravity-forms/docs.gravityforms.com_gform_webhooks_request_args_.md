---
url: "https://docs.gravityforms.com/gform_webhooks_request_args/"
title: "gform_webhooks_request_args - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Webhooks Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/webhooks-filters/)          - [gform\_webhooks\_post\_request](https://docs.gravityforms.com/gform_webhooks_post_request/ "gform_webhooks_post_request")
          - [gform\_webhooks\_request\_args](https://docs.gravityforms.com/gform_webhooks_request_args/ "gform_webhooks_request_args")
          - [gform\_webhooks\_request\_data](https://docs.gravityforms.com/gform_webhooks_request_data/ "gform_webhooks_request_data")
          - [gform\_webhooks\_request\_headers](https://docs.gravityforms.com/gform_webhooks_request_headers/ "gform_webhooks_request_headers")
          - [gform\_webhooks\_request\_method](https://docs.gravityforms.com/gform_webhooks_request_method/ "gform_webhooks_request_method")
          - [gform\_webhooks\_request\_url](https://docs.gravityforms.com/gform_webhooks_request_url/ "gform_webhooks_request_url")
          - [Webhooks Feed Meta](https://docs.gravityforms.com/webhooks-feed-meta/ "Webhooks Feed Meta")
...
# gform\_webhooks\_request\_args

- [Description](https://docs.gravityforms.com/gform_webhooks_request_args/#h-description)
- [Usage](https://docs.gravityforms.com/gform_webhooks_request_args/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_webhooks_request_args/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_webhooks_request_args/#h-examples)
- [1\. Set the "From" Header](https://docs.gravityforms.com/gform_webhooks_request_args/#h-1-set-the-from-header)
- [2\. Set the WP REST API Cookie Authentication Arguments](https://docs.gravityforms.com/gform_webhooks_request_args/#h-2-set-the-wp-rest-api-cookie-authentication-arguments)
- [3\. Set the WP REST API Basic Authorization Header](https://docs.gravityforms.com/gform_webhooks_request_args/#h-3-set-the-wp-rest-api-basic-authorization-header)
- [Placement](https://docs.gravityforms.com/gform_webhooks_request_args/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_webhooks_request_args/#h-source-code)

## Description

The “gform\_webhooks\_request\_args” filter allows the webhook HTTP request arguments to be modified.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_webhooks_request_args'``'your_function_name'``, 10, 4 );` |

## Parameters

- **$request\_args** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_webhooks_request_args'``,``'set_args'``, 10, 4 );`<br>`function``set_args(``$request_args``,``$feed``,``$entry``,``$form``){`<br>```$request_args``[``'headers'``][``'From'``] =``'name@domain.local'``;`<br>```return``$request_args``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_webhooks_request_args'``,``function``(``$request_args``,``$feed``) {`<br>```$request_url``= rgars(``$feed``,``'meta/requestURL'``);`<br>```if``(``strpos``(``$request_url``,``'{rest_api_url}'``) === 0 ||``strpos``(``$request_url``, rest_url() ) === 0 ) {`<br>```$request_args``[``'cookies'``]               =``$_COOKIE``;`<br>```$request_args``[``'headers'``][``'X-WP-Nonce'``] = wp_create_nonce(``'wp_rest'``);`<br>```}`<br>```return``$request_args``;`<br>`}, 10, 2 );` |
...
Note: Cookie authentication is the only method the WordPress REST API supports natively. Using alternative methods such as the Basic Authorization header will require the use of additional plugins, see the [WordPress REST API documentation](https://developer.wordpress.org/rest-api/using-the-rest-api/authentication/#authentication-plugins) for some suggestions.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_webhooks_request_args'``,``function``(``$request_args``,``$feed``) {`<br>```$request_url``= rgars(``$feed``,``'meta/requestURL'``);`<br>```if``(``strpos``(``$request_url``,``'{rest_api_url}'``) === 0 ||``strpos``(``$request_url``, rest_url() ) === 0 ) {`<br>```$request_args``[``'headers'``][``'Authorization'``] =``'Basic '``.``base64_encode``( USERNAME_HERE .``':'``. PASSWORD_HERE );`<br>```}`<br>```return``$request_args``;`<br>`}, 10, 2 );` |
...
This filter is located in GF\_Webhooks::process\_feed() in _gravityformswebhooks/class-gf-webhooks.php_.
...
[Algolia](https://docs.gravityforms.com/gform_webhooks_request_args/# "Algolia")
