---
url: "https://docs.gravityforms.com/gform_advancedpostcreation_post_update_post/"
title: "gform_advancedpostcreation_post_update_post - Gravity Forms Documentation"
---
...
# gform\_advancedpostcreation\_post\_update\_post

- [Description](https://docs.gravityforms.com/gform_advancedpostcreation_post_update_post/#h-description)
- [Usage](https://docs.gravityforms.com/gform_advancedpostcreation_post_update_post/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_advancedpostcreation_post_update_post/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_advancedpostcreation_post_update_post/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_advancedpostcreation_post_update_post/#h-placement)
- [Since](https://docs.gravityforms.com/gform_advancedpostcreation_post_update_post/#h-since)
- [Source code](https://docs.gravityforms.com/gform_advancedpostcreation_post_update_post/#h-source-code)
...
- **$post** [Post Object](https://developer.wordpress.org/reference/classes/wp_post/)
...
|     |
| --- |
| `add_action(``'gform_advancedpostcreation_post_update_post'``,``'after_updating_post'``, 10, 3 );`<br>`function``after_updating_post(``$post``,``$feed``,``$entry``) {`<br>```// do something`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_advancedpostcreation_post_update_post/# "Algolia")
