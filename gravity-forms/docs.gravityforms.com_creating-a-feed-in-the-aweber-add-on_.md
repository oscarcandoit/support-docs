---
url: "https://docs.gravityforms.com/creating-a-feed-in-the-aweber-add-on/"
title: "Creating a Feed for the AWeber Add-On - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [AWeber Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/aweber-add-on/)    - [Deprecation of the AWeber SDK](https://docs.gravityforms.com/deprecation-of-the-aweber-sdk/ "Deprecation of the AWeber SDK")
    - [Setting Up the AWeber Add-On](https://docs.gravityforms.com/setting-up-aweber/ "Setting Up the AWeber Add-On")
    - [Creating a Feed for the AWeber Add-On](https://docs.gravityforms.com/creating-a-feed-in-the-aweber-add-on/ "Creating a Feed for the AWeber Add-On")
    - [AWeber Changelog](https://docs.gravityforms.com/aweber-change-log/ "AWeber Changelog")
...
- [Summary](https://docs.gravityforms.com/creating-a-feed-in-the-aweber-add-on/#h-summary)
- [Create a Feed](https://docs.gravityforms.com/creating-a-feed-in-the-aweber-add-on/#h-create-a-feed)
- [Feed Settings Reference](https://docs.gravityforms.com/creating-a-feed-in-the-aweber-add-on/#h-feed-settings-reference)

## Summary

To send information from your Gravity Forms form to the AWeber service, you will first need to create a [feed](https://docs.gravityforms.com/what-is-a-feed/). The feed will tell Gravity Forms what list you want to submit to, how you want the fields to be mapped, and under what conditions you wish for the entry to be sent to the service. This article describes the steps to create a basic feed to AWeber.

## Create a Feed

To create a feed to AWeber using the AWeber Add-On for Gravity Forms, do the following from your WordPress Admin Dashboard:

1. Click on **Forms** in the left side menu.
2. Select the form that you want to use with AWeber.
3. Once within your desired form, hover over **Form Settings** and click on AWeber.
4. Click **Add New** to create a new feed. You will be presented with the AWeber feed settings screen.

## Feed Settings Reference

![AWeber Add-On Feed Settings](https://docs.gravityforms.com/wp-content/uploads/2015/05/aweber-feed-settings-1.png)

This table describes the feed settings options you will be offered for an AWeber feed.

| Setting | Description | Image Key |
| --- | --- | --- |
| **Name** | To identify your feed when viewing the feed list page. **Required** | 1 |
| **List** | Select the AWeber contact list that you would like to add the subscriber to. **Required** | 2 |
| **Map Fields** | Map each of the contact list fields to the form field that will send that information. Email field is required. | 3 |
| **Tags** | Use merge fields or static values to populate the AWeber tags for each submission in the feed. Multiple tags must be separated using commas. | 4 |
| **Conditional Logic** | If unchecked, every successful form submission will be sent to AWeber. If you wish to set specific conditions for sending form data to AWeber, then check the “Enable Condition” box and fill out your required criteria. | 5 |
...
[Algolia](https://docs.gravityforms.com/creating-a-feed-in-the-aweber-add-on/# "Algolia")
