---
url: "https://docs.gravityforms.com/gform_gfuser_object_init/"
title: "gform_gfuser_object_init - Gravity Forms Documentation"
---
...
# gform\_gfuser\_object\_init

- [Description](https://docs.gravityforms.com/gform_gfuser_object_init/#h-description)
- [Usage](https://docs.gravityforms.com/gform_gfuser_object_init/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_gfuser_object_init/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_gfuser_object_init/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_gfuser_object_init/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `<script type=``"text/javascript"``>`<br>```jQuery(document).on(``'gform_gfuser_object_init'``,``function``(){`<br>```// code to fire once the GFUser object has been initialized goes here`<br>```});`<br>`</script>` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11 | `<script type=``"text/javascript"``>`<br>```jQuery(document).on(``'gform_gfuser_object_init'``,``function``(){`<br>```// add buddypress properties to GFUser object`<br>```GFUser.buddypress_meta = <?php``echo``(!``empty``(``$config``[``'meta'``][``'buddypress_meta'``])) ? GFCommon::json_encode(``$config``[``'meta'``][``'buddypress_meta'``]) :``"[new BuddyPressMetaOption()]"``; ?>;`<br>```GFUser.buddypress_options = <?php``echo``GFCommon::json_encode(self::get_buddypress_fields()); ?>;`<br>```CreateBuddyPressMetaOptions();`<br>```});`<br>`</script>` |

## Source Code

This filter is located in _userregistration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_gfuser_object_init/# "Algolia")
