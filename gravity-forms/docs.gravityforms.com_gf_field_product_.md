---
url: "https://docs.gravityforms.com/gf_field_product/"
title: "GF_Field_Product - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_product/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_product/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_product/#h-settings)
- [Source Code](https://docs.gravityforms.com/gf_field_product/#h-source-code)

## Introduction

The GF\_Field\_Product class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for handling the [Product field](https://docs.gravityforms.com/product/). Because Product fields are either a Single Product, Drop Down, Radio Button, User Defined Price, Hidden or Calculation, this class only adds some settings and sets the title for the field in the editor. The rendering of the Product field is handled by the class associated with its sub-type. The field “type” property will be set to **product**. Depending on the product field chosen, the field “inputType” property will be \*singleproduct\*\*, “select”, “radio”, “price”, “hiddenproduct”, or “calculation”.

For more details about rendering the Option field, check out the articles below:

Calculation – [GF\_Field\_Calculation](https://docs.gravityforms.com/gf_field_calculation) class

Drop Down – [GF\_Field\_Select](https://docs.gravityforms.com/gf_field_select) class

Hidden Product – [GF\_Field\_Hiddenproduct](https://docs.gravityforms.com/gf_field_hiddenproduct) class

Radio Buttons – [GF\_Field\_Radio](https://docs.gravityforms.com/gf_field_radio) class

Single Product – [GF\_Field\_Singleproduct](https://docs.gravityforms.com/gf_field_singleproduct) class

User Defined Price – [GF\_Field\_Price](https://docs.gravityforms.com/gf_field_price) class
...
The source code is located in _includes/fields/class-gf-field-product.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_product/# "Algolia")
