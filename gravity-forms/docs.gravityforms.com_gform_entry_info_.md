---
url: "https://docs.gravityforms.com/gform_entry_info/"
title: "gform_entry_info - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_entry_info/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_info/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_entry_info/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_entry_info/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_entry_info'``,``'my_entry_info'``, 10, 2 );` |
...
This very basic example will output “Hello” in the **Info** panel on the [Entry Detail](https://docs.gravityforms.com/entry-detail) view.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_entry_info'``,``'my_entry_info'``, 10, 2 );`<br>`function``my_entry_info(``$form_id``,``$entry``) {`<br>`echo``'Hello'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_info/# "Algolia")
