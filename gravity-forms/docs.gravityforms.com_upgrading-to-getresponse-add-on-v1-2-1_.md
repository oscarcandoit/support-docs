---
url: "https://docs.gravityforms.com/upgrading-to-getresponse-add-on-v1-2-1/"
title: "Upgrade to GetResponse Add-On v1.2.1 - Gravity"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [GetResponse Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/getresponse-add-on/)    - [Setting Up the GetResponse Add-On](https://docs.gravityforms.com/getresponse-add-on/ "Setting Up the GetResponse Add-On")
    - [Creating a Feed for the GetResponse Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-getresponse-add-on/ "Creating a Feed for the GetResponse Add-On")
    - [Upgrading to GetResponse Add-On version 1.2.1](https://docs.gravityforms.com/upgrading-to-getresponse-add-on-v1-2-1/ "Upgrading to GetResponse Add-On version 1.2.1")
    - [GetResponse Changelog](https://docs.gravityforms.com/getresponse-change-log/ "GetResponse Changelog")
...
- [Summary](https://docs.gravityforms.com/upgrading-to-getresponse-add-on-v1-2-1/#h-summary)
- [Areas To Consider](https://docs.gravityforms.com/upgrading-to-getresponse-add-on-v1-2-1/#h-areas-to-consider)
- [We Shouldn't Have to Say This But...](https://docs.gravityforms.com/upgrading-to-getresponse-add-on-v1-2-1/#h-we-shouldn-t-have-to-say-this-but)

## Summary

GetResponse Add-On version 1.2.1 includes updates to utilize the newest [GetResponse API version 3](http://(https//apidocs.getresponse.com/v3). This version of their API includes new field data validations that did not previously exist, and upgrading carries a risk if you have existing forms that were previously breaking these validations.

## Areas To Consider

1. Refer to [this section](https://docs.gravityforms.com/creating-a-feed-for-the-getresponse-add-on/#mapping-fields) of our “Setting up A Feed” article for specific information on the way fields are validated now. A field that breaks the validation will be ignored on submission, and that data will not be added to your contact.

2. The newer API has a different endpoint for the [GetResponse Enterprise plan](https://secure.getresponse.com/pricing/en). As such, there is a [new setting](https://docs.gravityforms.com/getresponse-add-on/#account-type-version-1-3-1-) to define that. This only needs adjustment if you are specifically using their Enterprise plan, as it defaults to “standard” (which covers all the other non-Enterprise plans).
...
[Algolia](https://docs.gravityforms.com/upgrading-to-getresponse-add-on-v1-2-1/# "Algolia")
