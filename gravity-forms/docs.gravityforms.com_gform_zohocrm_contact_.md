---
url: "https://docs.gravityforms.com/gform_zohocrm_contact/"
title: "gform_zohocrm_contact - Gravity Forms Documentation"
---
...
# gform\_zohocrm\_contact

- [Description](https://docs.gravityforms.com/gform_zohocrm_contact/#h-description)
- [Usage](https://docs.gravityforms.com/gform_zohocrm_contact/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_zohocrm_contact/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_zohocrm_contact/#h-examples)
- [Change Email Opt Out](https://docs.gravityforms.com/gform_zohocrm_contact/#h-change-email-opt-out)
- [Placement](https://docs.gravityforms.com/gform_zohocrm_contact/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_zohocrm_contact/#h-source-code)
...
To target feeds for a specific form, append the form id to the hook name. (format: gform\_zohocrm\_contact\_FORMID)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11 | `array``(`<br>```'Email Opt Out'``=> false,`<br>```'Description'``=>``'some text'``,`<br>```'Lead Source'``=>``'Advertisement'``,`<br>```'SMOWNERID'``=>``'The-Zoho-CRM-User-ID-Here'``,`<br>```'options'``=>``array``(`<br>```'duplicateCheck'``=>``'1'``,`<br>```'isApproval'``=> false,`<br>```'wfTrigger'``=> false`<br>```)`<br>`)` |
...
This example shows how to change the ‘Email Opt Out’ setting based on a field value in the [Entry Object](https://docs.gravityforms.com/entry-object).

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_zohocrm_contact_4'``,``'change_contact_argument'``, 10, 4 );`<br>`function``change_contact_argument(``$contact``,``$feed``,``$entry``,``$form``) {`<br>```if``( rgars(``$feed``,``'meta/feedName'``) ==``'Zoho CRM Feed 2'``&& rgar(``$entry``,``'5'``) ==``'No'``) {`<br>```$contact``[``'Email Opt Out'``] = true;`<br>```}`<br>```return``$contact``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_zohocrm_contact'``,``$form``[``'id'``],``$contact``,``$feed``,``$entry``,``$form``);` |

This filter is located in GFZohoCRM::create\_contact() in _class-gf-zohocrm.php_.
...
[Algolia](https://docs.gravityforms.com/gform_zohocrm_contact/# "Algolia")
