---
url: "https://docs.gravityforms.com/adding-mailchimp-subscriptions-to-groups/"
title: "Adding Mailchimp Subscriptions To Groups - Gravity Forms"
---
...
2. When [creating a feed for the Mailchimp Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-mailchimp-add-on/), select the audience that contains your group.
3. If groups exist within the audience, they will automatically appear with checkboxes next to each of them. Upon enabling a group, you will be able to select if all subscribers on the form will be added to the audience, or just ones that fall under a specific condition. For more information on using conditions, see our article on [configuring conditional logic](https://docs.gravityforms.com/enable-conditional-logic/).
4. Save your feed.

[![MailChimp Groups Settings](https://docs.gravityforms.com/wp-content/uploads/2021/06/CleanShot-2021-06-08-at-08.38.39.png)](https://docs.gravityforms.com/wp-content/uploads/2021/06/CleanShot-2021-06-08-at-08.38.39.png)
...
[Algolia](https://docs.gravityforms.com/adding-mailchimp-subscriptions-to-groups/# "Algolia")
