---
url: "https://docs.gravityforms.com/gform_square_card_details_style/"
title: "gform_square_card_details_style - Gravity Forms Documentation"
---
...
# gform\_square\_card\_details\_style

- [Description](https://docs.gravityforms.com/gform_square_card_details_style/#h-description)
- [Usage](https://docs.gravityforms.com/gform_square_card_details_style/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_square_card_details_style/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_square_card_details_style/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_square_card_details_style/#h-)
- [Since](https://docs.gravityforms.com/gform_square_card_details_style/#h--0)
- [Source Code](https://docs.gravityforms.com/gform_square_card_details_style/#h--1)
...
For more information about which styles may be applied, check out the [**style reference**](https://developer.squareup.com/reference/sdks/web/payments/objects/CardClassSelectors) in Square’s documentation.

## Usage

|     |     |
| --- | --- |
| 1 | `gform.addFilter(``'gform_square_card_details_style'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **styleObject** [**{Object}**](https://docs.gravityforms.com/array)

An object that contains css selectors, properties and their values, selectors, property names and values should match documentation [**here**](https://developer.squareup.com/reference/sdks/web/payments/objects/CardClassSelectors).
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `gform.addFilter(``'gform_square_card_details_style'``,``function``( styleObject, formId ) {`<br>```if``( formId === myFormId ) {`<br>```styleObject.input.backgroundColor =``'#000000'``;`<br>```styleObject.input.color =``'#FFFFFF'``;`<br>```}`<br>```return``styleObject;`<br>`});` |

## **Placement**

See the JavaScript/jQuery section in this article: [**Where Do I Put This Code?**](https://docs.gravityforms.com/where-do-i-put-this-code/)
...
This filter is located in CardRenderer.getCardConfigurationStyleObject() in _js/src/frontend/card-renderer.js_.
...
[Algolia](https://docs.gravityforms.com/gform_square_card_details_style/# "Algolia")
