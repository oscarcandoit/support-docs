---
url: "https://docs.gravityforms.com/gform_entry_detail_sidebar_after/"
title: "gform_entry_detail_sidebar_after - Gravity Forms Documentation"
---
...
# gform\_entry\_detail\_sidebar\_after

- [Description](https://docs.gravityforms.com/gform_entry_detail_sidebar_after/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_detail_sidebar_after/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entry_detail_sidebar_after/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_entry_detail_sidebar_after/#h-examples)
- [This example adds a new box with a header and text](https://docs.gravityforms.com/gform_entry_detail_sidebar_after/#h-this-example-adds-a-new-box-with-a-header-and-text)
- [Placement](https://docs.gravityforms.com/gform_entry_detail_sidebar_after/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_entry_detail_sidebar_after/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_entry_detail_sidebar_after'``,``'add_sidebar_text_after'``, 10, 2 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$form** | [Form Object](https://docs.gravityforms.com/form-object) | The form from which the entry value was submitted. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_entry_detail_sidebar_after'``,``'add_sidebar_text_after'``, 10, 2 );`<br>`function``add_sidebar_text_after(``$form``,``$entry``) {`<br>```echo``"<br/><div class='stuffbox'><h3><span class='hndle'>More Cool Stuff</span></h3><div class='inside'>text added after!<br/></div></div>"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_detail_sidebar_after/# "Algolia")
