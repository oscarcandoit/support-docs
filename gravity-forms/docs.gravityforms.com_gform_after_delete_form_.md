---
url: "https://docs.gravityforms.com/gform_after_delete_form/"
title: "gform_after_delete_form - Gravity Forms Documentation"
---
...
# gform\_after\_delete\_form

- [Description](https://docs.gravityforms.com/gform_after_delete_form/#h-description)
- [Usage](https://docs.gravityforms.com/gform_after_delete_form/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_after_delete_form/#h-examples)
- [Adds a log file entry when a form is deleted](https://docs.gravityforms.com/gform_after_delete_form/#h-adds-a-log-file-entry-when-a-form-is-deleted)
- [Placement](https://docs.gravityforms.com/gform_after_delete_form/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_after_delete_form/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_action(``'gform_after_delete_form'``,``'do_cleanup'``);`<br>`function``do_cleanup(``$form_id``) {`<br>```// Perform your cleanup actions here`<br>```// $form_id is the ID of the form that has been deleted`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_action(``'gform_after_delete_form'``,``'log_form_deleted'``);`<br>`function``log_form_deleted(``$form_id``) {`<br>```$log_file``= ABSPATH .``'/gf_deleted_forms.log'``;`<br>```$f``=``fopen``(``$log_file``,``'a'``);`<br>```$user``= wp_get_current_user();`<br>```fwrite(``$f``,``date``(``'c'``) .``" - Form deleted by {$user->user_login}. Form ID: {$form_id}.\n"``);`<br>```fclose(``$f``);`<br>`}` |
...
This action hook is located in GFFormsModel::delete\_form() in _form\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_after_delete_form/# "Algolia")
