---
url: "https://docs.gravityforms.com/php-8-5-compatibility/"
title: "Gravity Forms and PHP 8.5 Compatibility - Gravity Forms Documentation"
---
...
- [Compatibility](https://docs.gravityforms.com/php-8-5-compatibility/#h-compatibility)
- [Reporting Issues](https://docs.gravityforms.com/php-8-5-compatibility/#h-reporting-issues)
- [Known Issues](https://docs.gravityforms.com/php-8-5-compatibility/#h-known-issues)

## Compatibility

**PHP 8.5 is a [major update](https://www.php.net/releases/8.5/en.php) of the PHP language**, with new features including the **URI extension**, **Pipe operator**, and support for **modifying properties while cloning**.

WordPress currently has **[beta support](https://make.wordpress.org/core/2025/11/21/php-8-5-support-in-wordpress-6-9/)** for PHP 8.5.

Testing for Gravity Forms core and all official add-ons has **not yet begun**. We will update this article as testing progresses and results become available.

## Reporting Issues

If you believe you’ve discovered a PHP 8.5-related issue with a Gravity Forms product that isn’t listed below, please let us know by [contacting **Support**](https://www.gravityforms.com/open-support-ticket/technical/). Thank you for contributing to improved compatibility.
...
[Algolia](https://docs.gravityforms.com/php-8-5-compatibility/# "Algolia")
