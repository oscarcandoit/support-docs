---
url: "https://docs.gravityforms.com/set-tabindex/"
title: "Set Tabindex - Gravity Forms Documentation"
---
...
- [Summary](https://docs.gravityforms.com/set-tabindex/#h-summary)
- [Embed Code](https://docs.gravityforms.com/set-tabindex/#h-embed-code)
- [Widget](https://docs.gravityforms.com/set-tabindex/#h-widget)
- [Code](https://docs.gravityforms.com/set-tabindex/#h-code)

## Summary

Having an issue where pressing tab on your keyboard brings your user to another form on your page? That is because Gravity Forms assumes its tabindex values, and you can overlap them. You need to change the tabindex on your forms to work as expected.

**Note:** For accessibility reasons, you shouldn’t set the tabindex. For more information about accessibility, refer to this [article](https://docs.gravityforms.com/accessibility-for-developers/#h-guidelines-2).
...
|     |     |
| --- | --- |
| 1 | `[gravityform id="1" title="false" description="false" tabindex="10"]` |
...
We have a filter called [gform\_tabindex](https://docs.gravityforms.com/gform_tabindex) that allows you to set the tabindex of all forms or a single form using PHP.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_tabindex'``,``'change_tabindex'``, 10, 2 );`<br>`function``change_tabindex(``$tabindex``,``$form``) {`<br>`return``10;`<br>`}` |

This is similar to the embed code version, except it would set all forms to have a starting tabindex of ten.
...
[Algolia](https://docs.gravityforms.com/set-tabindex/# "Algolia")
