---
url: "https://docs.gravityforms.com/_supports_callbacks/"
title: "$_supports_callbacks - Gravity Forms Documentation"
---
...
# $\_supports\_callbacks

- [Description](https://docs.gravityforms.com/_supports_callbacks/#h-description)
- [Properties](https://docs.gravityforms.com/_supports_callbacks/#h-properties)
- [Usage](https://docs.gravityforms.com/_supports_callbacks/#h-usage)
- [Location](https://docs.gravityforms.com/_supports_callbacks/#h-location)
- [Used By](https://docs.gravityforms.com/_supports_callbacks/#h-used-by)

## Description

The _$\_supports\_callbacks_ property defines if your payment add-on supports callbacks. By enabling this property within your payment add-on, you can easily receive and process callbacks.
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `class``ExamplePaymentAddOn``extends``GFPaymentAddOn {`<br>```protected``$_supports_callbacks``= true;`<br>`}` |
...
GFPaymentAddOn::upgrade\_payment()
...
[Algolia](https://docs.gravityforms.com/_supports_callbacks/# "Algolia")
