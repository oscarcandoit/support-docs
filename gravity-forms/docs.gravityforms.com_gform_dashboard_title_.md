---
url: "https://docs.gravityforms.com/gform_dashboard_title/"
title: "gform_dashboard_title - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_dashboard_title/#h-description)
- [Usage](https://docs.gravityforms.com/gform_dashboard_title/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_dashboard_title/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_dashboard_title/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_dashboard_title/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_dashboard_title'``,``'set_dashboard_title'``);` |

## Examples

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_dashboard_title'``,``'set_dashboard_title'``);`<br>`function``set_dashboard_title() {`<br>`//change the title of the Forms Dashboard`<br>`return``"May The Forms Be With You"``;`<br>`}` |
...
This filter is located in GFForms::dashboard\_setup() in _gravityforms.php_
...
[Algolia](https://docs.gravityforms.com/gform_dashboard_title/# "Algolia")
