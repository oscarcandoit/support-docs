---
url: "https://docs.gravityforms.com/gform_system_status_menu/"
title: "gform_system_status_menu - Gravity Forms Documentation"
---
...
# gform\_system\_status\_menu

- [Description](https://docs.gravityforms.com/gform_system_status_menu/#h-description)
- [Usage](https://docs.gravityforms.com/gform_system_status_menu/#h-usage)
- [Since](https://docs.gravityforms.com/gform_system_status_menu/#h-since)
- [Placement](https://docs.gravityforms.com/gform_system_status_menu/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_system_status_menu/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_system_status_menu'``,``'your_function_name'``);` |

## Parameters

- **$subviews** [array](https://docs.gravityforms.com/array)
...
[Algolia](https://docs.gravityforms.com/gform_system_status_menu/# "Algolia")
