---
url: "https://docs.gravityforms.com/gform_dropbox_link_type/"
title: "gform_dropbox_link_type - Gravity Forms Documentation"
---
...
# gform\_dropbox\_link\_type

- [Description](https://docs.gravityforms.com/gform_dropbox_link_type/#h-description)
- [Usage](https://docs.gravityforms.com/gform_dropbox_link_type/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_dropbox_link_type/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_dropbox_link_type/#h-example)
- [Placement](https://docs.gravityforms.com/gform_dropbox_link_type/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_dropbox_link_type/#h-source-code)
...
To target a specific form append the form id to the hook name. (format: gform\_dropbox\_link\_type\_FORMID)

|     |
| --- |
| `add_filter(``'gform_dropbox_link_type_10'``,``'your_function_name'``, 10, 3 );` |

To target a specific field append both the form id and the field id to the hook name. (format: gform\_dropbox\_link\_type\_FORMID\_FIELDID)
...
- **$linkType** [string](https://docs.gravityforms.com/string)
The Dropbox link type. _Possible values: **preview** (a preview link to the document for sharing) or **direct** (an expiring link to download the contents of the file). Default: **preview**_.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_dropbox_link_type_10'``,``'change_link_type'``, 10, 3 );`<br>`function``change_link_type(``$linkType``,``$form``,``$field_id``) {`<br>```return``'direct'``;`<br>`}` |
...
This filter is located in GF\_Field\_Dropbox::get\_form\_inline\_script\_on\_page\_render() in _class-gf-field-dropbox.php_.
...
[Algolia](https://docs.gravityforms.com/gform_dropbox_link_type/# "Algolia")
