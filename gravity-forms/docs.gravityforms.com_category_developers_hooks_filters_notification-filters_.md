---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/"
title: "Notification Filters Archives - Gravity Forms Documentation"
---
...
[**gform\_disable\_resend\_notification** \\
The gform\_disable\_resend\_notification filter allows developers to prevent a notification email from being resent.](https://docs.gravityforms.com/gform_disable_resend_notification/ "gform_disable_resend_notification") [**gform\_notification\_email\_header** \\
The gform\_notification\_email\_header filter adds the ability to enable and customize the X-Gravity-Forms-Source email header for notification emails.](https://docs.gravityforms.com/gform_notification_email_header/ "gform_notification_email_header") [**gform\_email\_background\_color\_data** \\
...
Allows the background color for the field label in the html email to be changed.](https://docs.gravityforms.com/gform_email_background_color_label/ "gform_email_background_color_label") [**gform\_form\_notification\_page** \\
Filters the form to be used in the notification page.](https://docs.gravityforms.com/gform_form_notification_page/ "gform_form_notification_page") [**gform\_notification\_enable\_cc** \\
The "gform\_notification\_enable\_cc" filter allows the display of a carbon copy field when creating a notification.](https://docs.gravityforms.com/gform_notification_enable_cc/ "gform_notification_enable_cc") [**gform\_html\_message\_template\_pre\_send\_email** \\
The “gform\_html\_message\_template\_pre\_send\_email” filter allows the template for the HTML-formatted message to be overridden.](https://docs.gravityforms.com/gform_html_message_template_pre_send_email/ "gform_html_message_template_pre_send_email") [**gform\_enable\_shortcode\_notification\_message** \\
Allows the disabling of the notification message defined in the shortcode.](https://docs.gravityforms.com/gform_enable_shortcode_notification_message/ "gform_enable_shortcode_notification_message") [**gform\_routing\_field\_types** \\
Description.](https://docs.gravityforms.com/gform_routing_field_types/ "gform_routing_field_types") [**gform\_notification\_validation** \\
This filter was removed in Gravity Forms v2.5 and is no longer supported. From Gravity Forms 2.5, notification settings and their validation callbacks are now defined via the gform\_notification\_settings\_fields filter.](https://docs.gravityforms.com/gform_notification_validation/ "gform_notification_validation") 1 [2](https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/page/2/) [3](https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/page/3/) [Next](https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/page/2/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/# "Algolia")
