---
url: "https://docs.gravityforms.com/gform_get_field_value/"
title: "gform_get_field_value - Gravity Forms Documentation"
---
...
- [Developers](https://docs.gravityforms.com/category/developers/)  - [Theme Framework](https://docs.gravityforms.com/category/developers/theme-framework/)
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Field Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/field-framework-filters/)        - [gform\_get\_field\_value](https://docs.gravityforms.com/gform_get_field_value/ "gform_get_field_value")
...
- [Description](https://docs.gravityforms.com/gform_get_field_value/#h-description)
- [Usage](https://docs.gravityforms.com/gform_get_field_value/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_get_field_value/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_get_field_value/#h-example)
- [Placement](https://docs.gravityforms.com/gform_get_field_value/#h-placement)
- [Since](https://docs.gravityforms.com/gform_get_field_value/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_get_field_value/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_get_field_value'``,``'your_function_name'``, 10, 3 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_get_field_value'``,``'change_field_value'``, 10, 3 );`<br>`function``change_field_value(``$value``,``$entry``,``$field``){`<br>```if``(``$field``[``'id'``] == 1 ){`<br>```$value``=``'Testing'``;`<br>```}`<br>```return``$value``;`<br>`}` |
...
- GF\_Entry\_List\_Table::column\_default() in _entry\_list.php_
- GFFormsModel::get\_lead\_field\_value() in _forms\_model.php_
...
[Algolia](https://docs.gravityforms.com/gform_get_field_value/# "Algolia")
