---
url: "https://docs.gravityforms.com/gform_honeypot_labels_pre_render/"
title: "gform_honeypot_labels_pre_render - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_honeypot_labels_pre_render/#h-description)
- [Usage](https://docs.gravityforms.com/gform_honeypot_labels_pre_render/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_honeypot_labels_pre_render/#h-examples)
- [1\. Four new labels](https://docs.gravityforms.com/gform_honeypot_labels_pre_render/#h-1-four-new-labels)
- [Placement](https://docs.gravityforms.com/gform_honeypot_labels_pre_render/#h-placement)
- [Since](https://docs.gravityforms.com/gform_honeypot_labels_pre_render/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_honeypot_labels_pre_render/#h-source-code)

## Description

The gform\_honeypot\_labels\_pre\_render filter can be used to override the labels used when rendering the hidden honeypot field.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_honeypot_labels_pre_render'``,``'your_function_name'``);` |

## Parameters

- **$honeypot\_labels** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_honeypot_labels_pre_render'``,``function``(``$honeypot_labels``) {`<br>`return``array``(``'One'``,``'Two'``,``'Three'``,``'Four'``);`<br>`} );` |
...
This filter is located in GF\_Honeypot\_Handler::get\_honeypot\_labels() in includes/honeypot/class-gf-honeypot-handler.php
...
[Algolia](https://docs.gravityforms.com/gform_honeypot_labels_pre_render/# "Algolia")
