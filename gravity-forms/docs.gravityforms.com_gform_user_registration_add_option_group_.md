---
url: "https://docs.gravityforms.com/gform_user_registration_add_option_group/"
title: "gform_user_registration_add_option_group - Gravity Forms"
---
...
- [Description](https://docs.gravityforms.com/gform_user_registration_add_option_group/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_add_option_group/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_add_option_group/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_user_registration_add_option_group/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_add_option_group/#h-source-code)

**Removed:** This hook was removed in version 3.0 and replaced by [gform\_userregistration\_feed\_settings\_fields](https://docs.gravityforms.com/gform_userregistration_feed_settings_fields).
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_user_registration_add_option_group'``,``'your_function_name'``, 10, 3 );` |
...
- **$is\_validation\_error** [boolean](https://docs.gravityforms.com/boolean)
...
This example shows how to add the “Send User Email” option (available by default in the User Registration) using the [gform\_user\_registration\_add\_option\_group](https://docs.gravityforms.com/gform_user_registration_add_option_group) as if this option was no already available.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `add_action(``'gform_user_registration_add_option_group'``,``'add_custom_group'``, 10, 3 );`<br>`function``add_multisite_section(``$config``,``$form``,``$is_validation_error``) {`<br>```?>`<br>```<div``class``=``"margin_vertical_10"``>`<br>```<label``class``=``"left_header"``><?php _e(``"Send Email?"``,``"gravityformsuserregistration"``); ?> <?php gform_tooltip(``"user_registration_notification"``) ?></label>`<br>```<input type=``"checkbox"``id=``"gf_user_registration_notification"``name=``"gf_user_registration_notification"``value=``"1"``<?php``echo``(``$config``[``"meta"``][``"notification"``] == 1 || !isset(``$config``[``"meta"``][``"notification"``])) ?``"checked='checked'"``:``""``?> />`<br>```<label``for``=``"gf_user_registration_notification"``class``=``"checkbox-label"``><?php _e(``"Send this password to the new user by email."``,``"gravityformsuserregistration"``); ?></label>`<br>```</div> <!-- / send email? -->`<br>```<?php`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_add_option_group/# "Algolia")
