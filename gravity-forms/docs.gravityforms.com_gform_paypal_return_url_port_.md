---
url: "https://docs.gravityforms.com/gform_paypal_return_url_port/"
title: "gform_paypal_return_url_port - Gravity Forms Documentation"
---
...
# gform\_paypal\_return\_url\_port

- [Description](https://docs.gravityforms.com/gform_paypal_return_url_port/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_return_url_port/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_return_url_port/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_return_url_port/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_paypal_return_url_port/#h-placement)
- [Since](https://docs.gravityforms.com/gform_paypal_return_url_port/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_paypal_return_url_port/#h-source-code)

## Description

This filter allow the port to be changed for the return\_url that is sent to PayPal.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_return_url_port'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$server\_port** [string](https://docs.gravityforms.com/string)
The current port.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_paypal_return_url_port'``,``'change_port'``);`<br>`function``change_port(){`<br>```return``'81'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_paypal_return_url_port/# "Algolia")
