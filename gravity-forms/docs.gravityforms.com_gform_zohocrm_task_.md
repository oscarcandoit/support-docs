---
url: "https://docs.gravityforms.com/gform_zohocrm_task/"
title: "gform_zohocrm_task - Gravity Forms Documentation"
---
...
# gform\_zohocrm\_task

- [Description](https://docs.gravityforms.com/gform_zohocrm_task/#h-description)
- [Usage](https://docs.gravityforms.com/gform_zohocrm_task/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_zohocrm_task/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_zohocrm_task/#h-examples)
- [Append text to Subject](https://docs.gravityforms.com/gform_zohocrm_task/#h-append-text-to-subject)
- [Placement](https://docs.gravityforms.com/gform_zohocrm_task/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_zohocrm_task/#h-source-code)
...
To target feeds for a specific form append the form id to the hook name. (format: gform\_zohocrm\_task\_FORMID)
...
- **$task** [array](https://docs.gravityforms.com/array)
The task arguments are an associative array.


|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `array``(`<br>```'Due Date'``=>``'2015-10-15'``,`<br>```'Subject'``=>``'some text'``,`<br>```'Status'``=>``'Not Started'``,`<br>```'SMOWNERID'``=>``'The-Zoho-CRM-User-ID-Here'``,`<br>```'CONTACTID'``=>``'The-Zoho-CRM-Contact-ID-Here'``,`<br>```'SEID'``=>``'The-Zoho-CRM-Lead-Or-Contact-ID-Here'``,`<br>```'SEMODULE'``=>``'Leads'``/* or Contacts */`<br>`)` |
...
This example shows how you can append some text to the ‘Subject’ argument based on a field value in the [Entry Object](https://docs.gravityforms.com/entry-object).

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_zohocrm_task_4'``,``'change_task_argument'``, 10, 4 );`<br>`function``change_task_argument(``$task``,``$feed``,``$entry``,``$form``) {`<br>```if``( rgars(``$feed``,``'meta/feedName'``) ==``'Zoho CRM Feed 2'``&& rgar(``$entry``,``'5'``) ==``'No'``) {`<br>```$task``[``'Subject'``] .=``' - some more text'``;`<br>```}`<br>```return``$task``;`<br>`}` |
...
This filter is located in GFZohoCRM::create\_task() in _class-gf-zohocrm.php_.
...
[Algolia](https://docs.gravityforms.com/gform_zohocrm_task/# "Algolia")
