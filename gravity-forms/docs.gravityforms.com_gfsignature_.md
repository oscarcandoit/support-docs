---
url: "https://docs.gravityforms.com/gfsignature/"
title: "GFSignature - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gfsignature/#h-description)
- [gf\_signature()](https://docs.gravityforms.com/gfsignature/#h-gf_signature)
- [get\_signature\_url()](https://docs.gravityforms.com/gfsignature/#h-get_signature_url)
- [Usage](https://docs.gravityforms.com/gfsignature/#h-usage)
- [Parameters](https://docs.gravityforms.com/gfsignature/#h-parameters)
- [delete\_signature()](https://docs.gravityforms.com/gfsignature/#h-delete_signature)
- [Usage](https://docs.gravityforms.com/gfsignature/#h-usage)
- [Parameters](https://docs.gravityforms.com/gfsignature/#h-parameters)

## Description

GFSignature is the class which houses some of the functionality included by the Gravity Forms Signature Add-on; it extends the [GFAddon](https://docs.gravityforms.com/gfaddon) class which is part of the add-on framework. Below are a few functions which you may find useful when working on your own custom code.

## gf\_signature()

The gf\_signature() function is used to return an instance of the GFSignature class.
...
|     |     |
| --- | --- |
| 1 | `$signature_url``= gf_signature()->get_signature_url(``$filename``);` |

#### Parameters

- **$filename** [string](https://docs.gravityforms.com/string)
The filename for this signature. The filename can be found in the [Entry Object](https://docs.gravityforms.com/entry-object) as the value for the signature field.
...
|     |     |
| --- | --- |
| 1 | `$result``= gf_signature()->delete_signature(``$entry_id``,``$field_id``);` |
...
- **Returns** [bool](https://docs.gravityforms.com/bool)
...
[Algolia](https://docs.gravityforms.com/gfsignature/# "Algolia")
