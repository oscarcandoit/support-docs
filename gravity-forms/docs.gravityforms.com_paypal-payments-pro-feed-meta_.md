---
url: "https://docs.gravityforms.com/paypal-payments-pro-feed-meta/"
title: "PayPal Payments Pro Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [PayPal Payments Pro Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/paypal-payments-pro-filters/)          - [gform\_paypalpaymentspro\_api\_before\_send](https://docs.gravityforms.com/gform_paypalpaymentspro_api_before_send/ "gform_paypalpaymentspro_api_before_send")
          - [gform\_paypalpaymentspro\_args\_before\_payment](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_payment/ "gform_paypalpaymentspro_args_before_payment")
          - [gform\_paypalpaymentspro\_args\_before\_send](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_send/ "gform_paypalpaymentspro_args_before_send")
          - [gform\_paypalpaymentspro\_args\_before\_subscription](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_subscription/ "gform_paypalpaymentspro_args_before_subscription")
          - [gform\_paypalpaymentspro\_log\_api\_request](https://docs.gravityforms.com/gform_paypalpaymentspro_log_api_request/ "gform_paypalpaymentspro_log_api_request")
          - [gform\_paypalpaymentspro\_verifyhost](https://docs.gravityforms.com/gform_paypalpaymentspro_verifyhost/ "gform_paypalpaymentspro_verifyhost")
          - [gform\_paypalpaymentspro\_verifypeer](https://docs.gravityforms.com/gform_paypalpaymentspro_verifypeer/ "gform_paypalpaymentspro_verifypeer")
          - [PayPal Payments Pro Feed Meta](https://docs.gravityforms.com/paypal-payments-pro-feed-meta/ "PayPal Payments Pro Feed Meta")
...
- [Introduction](https://docs.gravityforms.com/paypal-payments-pro-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/paypal-payments-pro-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the PayPal Payments Pro Add-On is an associative array containing the properties which determine what type of transaction should occur and what values are sent to PayPal.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `$feed``[``'meta'``] =``array``(`<br>```'feedName'``=>``'PayPal Payments Pro Feed 1'``,`<br>```'transactionType'``=>``'product'``,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **transactionType** [string](https://docs.gravityforms.com/string)

The type of transaction which should occur when the feed is processed. _Possible values: product or subscription._

- **billingInformation\_lastName** [string](https://docs.gravityforms.com/string)

The ID of the field containing the customer’s last name.

- **billingInformation\_firstName** [string](https://docs.gravityforms.com/string)

The ID of the field containing the customer’s first name.

- **billingInformation\_email** [string](https://docs.gravityforms.com/string)

The ID of the field containing the customer’s email.

- **billingInformation\_address** [string](https://docs.gravityforms.com/string)

The ID of the field containing the first line of the customer’s address.

- **billingInformation\_address2** [string](https://docs.gravityforms.com/string)

The ID of the field containing the second line of the customer’s address.

- **billingInformation\_city** [string](https://docs.gravityforms.com/string)

The ID of the field containing the city of the customer’s address.

- **billingInformation\_state** [string](https://docs.gravityforms.com/string)

The ID of the field containing the state of the customer’s address.

- **billingInformation\_zip** [string](https://docs.gravityforms.com/string)

The ID of the field containing the zip of the customer’s address.

- **billingInformation\_country** [string](https://docs.gravityforms.com/string)

The ID of the field containing the country of the customer’s address.

- **apiSettingsEnabled** [boolean](https://docs.gravityforms.com/boolean)

Override the default API settings? Default is false.

- **overrideMode** [string](https://docs.gravityforms.com/string)

Which mode should this feed use when overriding the default API settings. _Possible values: production or test._

- **overrideUsername** [string](https://docs.gravityforms.com/string)

The PayPal Manager login username to use when overriding the default API settings.

- **overridePassword** [string](https://docs.gravityforms.com/string)

The PayPal Manager password to use when overriding the default API settings.

- **overrideVendor** [string](https://docs.gravityforms.com/string)

The PayPal Manager vendor to use when overriding the default API settings.

- **overridePartner** [string](https://docs.gravityforms.com/string)

The PayPal Manager partner to use when overriding the default API settings. _Default value: PayPal._
...
- **paymentAmount** [string](https://docs.gravityforms.com/string)
What to use for the payment amount. _Possible values: form\_total or a product field ID._
...
- **recurringAmount** [string](https://docs.gravityforms.com/string)
What to use for the recurring amount. _Possible values: form\_total or a product field ID._

- **payPeriod** [string](https://docs.gravityforms.com/string)

How often the recurring payment should occur. _Possible values: WEEK, BIWK, SMMO, FRWK, MONT, QTER, SMYR, or YEAR._

- **recurringTimes** [integer](https://docs.gravityforms.com/integer)
...
- **setupFee\_enabled** [boolean](https://docs.gravityforms.com/boolean)

Should a setup fee be charged? Default is false.

- **setupFee\_product** [string](https://docs.gravityforms.com/string)

The ID of the product field containing the amount the user should be charged for the setup fee.

- **change\_post\_status** [boolean](https://docs.gravityforms.com/boolean)
...
- **update\_post\_action** [string](https://docs.gravityforms.com/string)

Change the post status when a subscription is canceled? _Possible values: draft or delete._
...
[Algolia](https://docs.gravityforms.com/paypal-payments-pro-feed-meta/# "Algolia")
