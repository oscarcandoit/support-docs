---
url: "https://docs.gravityforms.com/gravity-forms-and-php-8-2-compatibility/"
title: "Gravity Forms and PHP 8.2 Compatibility - Gravity Forms Documentation"
---
...
# Gravity Forms and PHP 8.2 Compatibility

- [Compatibility](https://docs.gravityforms.com/gravity-forms-and-php-8-2-compatibility/#h-compatibility)
- [Reporting Issues](https://docs.gravityforms.com/gravity-forms-and-php-8-2-compatibility/#h-reporting-issues)
- [Known Issues](https://docs.gravityforms.com/gravity-forms-and-php-8-2-compatibility/#h-known-issues)

## Compatibility

PHP 8.2 is a [major new release](https://www.php.net/releases/8.2/en.php) of the PHP language with many changes.

~~WordPress is not currently compatible [with PHP 8.2](https://make.wordpress.org/core/handbook/references/php-compatibility-and-wordpress-versions/).~~

~~Like WordPress, Gravity Forms isn’t currently compatible but our product team will be working on compatiblity tests and fixes for any issues found.~~

## Reporting Issues

If you think you have discovered a PHP 8.2 related issue with a Gravity Forms product in your own testing, which isn’t listed below, please let us know by [contacting Support](http://gravityforms.com/support). Thank you for contributing!

## Known Issues

Note that all of the issues listed below are fixed in the latest versions of the respective plugins.

The following issues were reported and logged.

- `Creation of dynamic property Gravity_Forms\Gravity_Forms\Settings\Fields\Select::$tooltip is deprecated in /includes/settings/fields/class-base.php on line 167`
- `Creation of dynamic property GFMailChimp::$delayed_payment_integration is deprecated in /includes/addon/class-gf-feed-addon.php on line 1886`
- `Using ${var} in strings is deprecated, use {$var} instead in /includes/fields/class-gf-field-list.php on line 167`
- `Using ${var} in strings is deprecated, use {$var} instead in /includes/fields/class-gf-field-repeater.php on line 584`

Compatibility testing of the add-ons will only begin after WordPress 6.3 is released, and the above issues have been resolved.
...
[Algolia](https://docs.gravityforms.com/gravity-forms-and-php-8-2-compatibility/# "Algolia")
