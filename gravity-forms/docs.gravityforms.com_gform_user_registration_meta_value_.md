---
url: "https://docs.gravityforms.com/gform_user_registration_meta_value/"
title: "gform_user_registration_meta_value - Gravity Forms Documentation"
---
...
# gform\_user\_registration\_meta\_value

- [Description](https://docs.gravityforms.com/gform_user_registration_meta_value/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_meta_value/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_meta_value/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_user_registration_meta_value/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_user_registration_meta_value/#h-placement)
- [Since](https://docs.gravityforms.com/gform_user_registration_meta_value/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_meta_value/#h-source-code)
...
The [Feed meta](https://docs.gravityforms.com/user-registration-feed-meta/) or just the mappings from a generic\_map type setting.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_user_registration_meta_value'``,``function``(``$value``,``$meta_key``,``$meta``,``$form``,``$entry``,``$is_username``) {`<br>```if``(``$meta_key``==``'siteAddress'``) {`<br>```$value``=``'your new value'``;`<br>```}`<br>```return``$value``;`<br>`}, 10, 6 );` |
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_meta_value/# "Algolia")
