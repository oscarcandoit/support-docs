---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/file-upload-fields/"
title: "File Upload Fields Archives - Gravity Forms Documentation"
---
...
[**gform\_cleanup\_target\_dir** \\
The gform\_cleanup\_target\_dir filter is used to bypass functionality that relies on open\_dir(), enabling support for the multi-file upload field on servers that don’t support open\_dir(), such as WordPress VIP.](https://docs.gravityforms.com/gform_cleanup_target_dir/ "gform_cleanup_target_dir") [**gform\_field\_types\_delete\_files** \\
Allows additional files to be deleted when file deletion occurs by adding additional field types.](https://docs.gravityforms.com/gform_field_types_delete_files/ "gform_field_types_delete_files") [**gform\_file\_path\_pre\_delete\_file** \\
...
The “gform\_file\_upload\_markup” filter in Gravity Forms can be used to modify the HTML for the multi-file upload “preview”.](https://docs.gravityforms.com/gform_file_upload_markup/ "gform_file_upload_markup") [**gform\_file\_upload\_whitelisting\_disabled** \\
...
Allows for the filtering of the file path before output.](https://docs.gravityforms.com/gform_fileupload_entry_value_file_path/ "gform_fileupload_entry_value_file_path") [**gform\_multifile\_upload\_field** \\
This filter is used to filter the field object that will be associated with the uploaded file.](https://docs.gravityforms.com/gform_multifile_upload_field/ "gform_multifile_upload_field") [**gform\_permission\_granted\_pre\_download** \\
This filter can be used to perform custom logic to determine if the download URL will allow access to the file.](https://docs.gravityforms.com/gform_permission_granted_pre_download/ "gform_permission_granted_pre_download") [**gform\_plupload\_settings** \\
This filter allows the initialization settings (file size, file count, browse button, drag and drop, and more) for Plupload to be changed.](https://docs.gravityforms.com/gform_plupload_settings/ "gform_plupload_settings") 1 [2](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/file-upload-fields/page/2/) [Next](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/file-upload-fields/page/2/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/file-upload-fields/# "Algolia")
