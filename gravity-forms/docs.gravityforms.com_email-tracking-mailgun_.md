---
url: "https://docs.gravityforms.com/email-tracking-mailgun/"
title: "Email Tracking with Mailgun - Gravity Forms Documentation"
---
...
In addition to being able to send your notifications using Mailgun, the Mailgun Add-On also includes the ability to integrate with Mailgun’s email tracking. With email tracking, you’ll be able to see if the notification was opened or links were clicked, allowing for better management of your notifications. In this article, we’ll show you how to enable email tracking in the [Mailgun add-on](https://www.gravityforms.com/add-ons/mailgun/) for Gravity Forms.

[![Mailgun Form Notifications Email Tracking Settings](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-09-at-10.28.12.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-09-at-10.28.12.png)

1. Access the form notification that is configured to use Mailgun. If you don’t already have a notification that is using Mailgun, see our article on [sending form notifications with Mailgun](https://docs.gravityforms.com/send-form-notifications-mailgun/).
2. Scroll down in the settings until you see an option labeled **Email Tracking**.
3. To enable tracking of link clicks, check the checkbox labeled **Enable click tracking for this notification**.
4. To enable tracking of who has opened your form notifications, check the checkbox labeled **Enable open tracking for this notification**.
5. Once complete, save your notification settings.
...
[Algolia](https://docs.gravityforms.com/email-tracking-mailgun/# "Algolia")
