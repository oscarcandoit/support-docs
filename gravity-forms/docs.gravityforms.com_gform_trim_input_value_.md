---
url: "https://docs.gravityforms.com/gform_trim_input_value/"
title: "gform_trim_input_value - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_trim_input_value/#h-description)
- [Usage](https://docs.gravityforms.com/gform_trim_input_value/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_trim_input_value/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_trim_input_value/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_trim_input_value/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_trim_input_value/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_trim_input_value'``,``'disable_trim'``, 10, 3 );` |

## Parameters

- **$do\_trim** [boolean](https://docs.gravityforms.com/boolean)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_trim_input_value'``,``'disable_trim'``, 10, 3 );`<br>`function``disable_trim(``$do_trim``,``$form_id``,``$field``) {`<br>```if``(``$form_id``== 36 &&``$field``->id ==``'1'``) {`<br>```return``false;`<br>```}`<br>```return``$do_trim``;`<br>`}` |
...
This filter is located in the following methods in _forms\_model.php_

- GFFormsModel::maybe\_trim\_input()
- GFFormsModel::trim\_form\_meta\_values()
- GFFormsModel::trim\_conditional\_logic\_values\_from\_element()
...
[Algolia](https://docs.gravityforms.com/gform_trim_input_value/# "Algolia")
