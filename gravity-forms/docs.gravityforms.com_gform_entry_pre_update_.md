---
url: "https://docs.gravityforms.com/gform_entry_pre_update/"
title: "gform_entry_pre_update - Gravity Forms Documentation"
---
...
# gform\_entry\_pre\_update

- [Description](https://docs.gravityforms.com/gform_entry_pre_update/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_pre_update/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entry_pre_update/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_entry_pre_update/#h-example)
- [Placement](https://docs.gravityforms.com/gform_entry_pre_update/#h-placement)
- [Since](https://docs.gravityforms.com/gform_entry_pre_update/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_entry_pre_update/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_pre_update'``,``'your_function_name'``, 10, 2);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_entry_pre_update'``,``'change_entry'``, 10, 2);`<br>`function``change_entry(``$entry``,``$original_entry``) {`<br>```if``(rgar(``$entry``,``'1.3'``) ==``'Rocketgenius'``|| rgar(``$entry``,``'1.6'``) ==``'Rocketgenius'``) {`<br>```$entry``[``'2'``] =``'dana@rocketgenius.com'``;`<br>```}`<br>```return``$entry``;`<br>`}` |
...
This filter is located in GFAPI::update\_entry() in **includes/api.php** and

GF\_Forms\_Model\_Legacy::update\_entry() in **includes/legacy/forms\_model\_legacy.php**.
...
[Algolia](https://docs.gravityforms.com/gform_entry_pre_update/# "Algolia")
