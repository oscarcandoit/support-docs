---
url: "https://docs.gravityforms.com/gform_post_status_options/"
title: "gform_post_status_options - Gravity Forms Documentation"
---
...
# gform\_post\_status\_options

- [Description](https://docs.gravityforms.com/gform_post_status_options/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_status_options/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_status_options/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_status_options/#h-examples)
- [1\. Add a new status](https://docs.gravityforms.com/gform_post_status_options/#h-1-add-a-new-status)
- [2\. Remove a status](https://docs.gravityforms.com/gform_post_status_options/#h-2-remove-a-status)
- [Placement](https://docs.gravityforms.com/gform_post_status_options/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_post_status_options/#h-source-code)
...
- **$post\_status\_options** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_post_status_options'``,``'add_custom_post_status'``);`<br>`function``add_custom_post_status(``$post_status_options``) {`<br>```$post_status_options``[``'custom_status'``] =``'My Custom Status'``;`<br>```return``$post_status_options``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_post_status_options'``,``'add_custom_post_status'``);`<br>`function``add_custom_post_status(``$post_status_options``) {`<br>```unset(``$post_status_options``[``'draft'``] );`<br>```return``$post_status_options``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_post_status_options/# "Algolia")
