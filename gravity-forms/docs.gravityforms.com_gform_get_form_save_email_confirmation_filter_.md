---
url: "https://docs.gravityforms.com/gform_get_form_save_email_confirmation_filter/"
title: "gform_get_form_save_email_confirmation_filter -"
---
...
# gform\_get\_form\_save\_email\_confirmation\_filter

- [Description](https://docs.gravityforms.com/gform_get_form_save_email_confirmation_filter/#h-description)
- [Usage](https://docs.gravityforms.com/gform_get_form_save_email_confirmation_filter/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_get_form_save_email_confirmation_filter/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_get_form_save_email_confirmation_filter/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_get_form_save_email_confirmation_filter/#h-placement)
- [Since](https://docs.gravityforms.com/gform_get_form_save_email_confirmation_filter/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_get_form_save_email_confirmation_filter/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_get_form_save_email_confirmation_filter'``,``'your_function_name'``, 10, 2 );` |

To target a specific form, append the form ID to the hook name. To target form ID 13 only:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_get_form_save_email_confirmation_filter_13'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$save\_email\_confirmation** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_get_form_save_email_confirmation_filter'``,``'add_note_to_save_email_confirmation'``, 10, 2 );`<br>`function``add_note_to_save_email_confirmation(``$save_email_confirmation``,``$form``) {`<br>```GFCommon::log_debug(``__METHOD__``.``'(): Running...'``);`<br>```$save_email_confirmation``.=``"Please call us at 888-555-1212 if you need help."``;`<br>```return``$save_email_confirmation``;`<br>`}` |
...
This filter is located in the GFFormDisplay::handle\_save\_email\_confirmation() in _form\_display.php_
...
[Algolia](https://docs.gravityforms.com/gform_get_form_save_email_confirmation_filter/# "Algolia")
