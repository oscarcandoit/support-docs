---
url: "https://docs.gravityforms.com/zapier-feed-meta/"
title: "Zapier Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Zapier Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/zapier-filters/)          - [gform\_form\_settings\_page\_gravityformszapier](https://docs.gravityforms.com/gform_form_settings_page_gravityformszapier/ "gform_form_settings_page_gravityformszapier")
          - [gform\_save\_zapier\_button](https://docs.gravityforms.com/gform_save_zapier_button/ "gform_save_zapier_button")
          - [gform\_zap\_before\_save](https://docs.gravityforms.com/gform_zap_before_save/ "gform_zap_before_save")
          - [gform\_zapier\_actions](https://docs.gravityforms.com/gform_zapier_actions/ "gform_zapier_actions")
          - [gform\_zapier\_feed\_conditional\_logic](https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/ "gform_zapier_feed_conditional_logic")
          - [gform\_zapier\_field\_value](https://docs.gravityforms.com/gform_zapier_field_value/ "gform_zapier_field_value")
          - [gform\_zapier\_products](https://docs.gravityforms.com/gform_zapier_products/ "gform_zapier_products")
          - [gform\_zapier\_request\_body](https://docs.gravityforms.com/gform_zapier_request_body/ "gform_zapier_request_body")
          - [gform\_zapier\_sample\_field\_value](https://docs.gravityforms.com/gform_zapier_sample_field_value/ "gform_zapier_sample_field_value")
          - [gform\_zapier\_use\_stored\_body](https://docs.gravityforms.com/gform_zapier_use_stored_body/ "gform_zapier_use_stored_body")
          - [Zapier Feed Meta](https://docs.gravityforms.com/zapier-feed-meta/ "Zapier Feed Meta")
...
- [Introduction](https://docs.gravityforms.com/zapier-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/zapier-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the Zapier Add-On is an associative array containing the properties which determine how the add-on should process the form submission.
...
- **zapURL** [string](https://docs.gravityforms.com/string)

The Zapier hosted URL where the entry data will be sent when the feed is processed.

- **adminLabels** [string](https://docs.gravityforms.com/string)

Indicates if the field admin labels should be sent to Zapier instead of the main labels, if configured. _Possible values: 1 or 0._
...
- **legacy** [boolean](https://docs.gravityforms.com/boolean)

Indicates if the feed was migrated from the non-framework version of the add-on (pre 4.0).

- **legacy\_id** [int](https://docs.gravityforms.com/int)

The feed ID when it was stored in the legacy rg\_zapier table.
...
[Algolia](https://docs.gravityforms.com/zapier-feed-meta/# "Algolia")
