---
url: "https://docs.gravityforms.com/category/knowledge-base/page/10/"
title: "Knowledge Base Archives - Page 10 of 18 - Gravity Forms Documentation - Page 10 of 18"
---
...
Installing Gravity Forms is quite simple and is the same process as installing many other plugins. In this article, we will show you how to quickly install Gravity Forms using the plugin uploader inside your WordPress admin dashboard.](https://docs.gravityforms.com/how-to-install-gravity-forms/ "How To Install Gravity Forms") [**How To Load Forms In Hidden UIs** \\
This article guides you through loading forms in hidden UIs with dynamically loaded content.](https://docs.gravityforms.com/how-to-load-forms-in-hidden-uis/ "How To Load Forms In Hidden UIs") [**How To Manually Update For Older WordPress Editions** \\
Find out how to update Gravity Forms manually on an older WordPress version.](https://docs.gravityforms.com/manually-update-for-older-wordpress/ "How To Manually Update For Older WordPress Editions") [**How to Manually Update Gravity Forms** \\
In this article, we explain how to update Gravity Forms or an Add-On from your WordPress dashboard.](https://docs.gravityforms.com/how-to-manually-update/ "How to Manually Update Gravity Forms") [**How To Populate A Field With A Default Value** \\
This article explores how to pre-populate a default value in a field, allowing you to present the user with a pre-filled option, reducing manual input, and streamlining the form submission process](https://docs.gravityforms.com/populate-a-default-value/ "How To Populate A Field With A Default Value") [**How To Populate Image Choices With WooCommerce Products** \\
This article demonstrates how to use a custom snippet to retrieve WooCommerce products and populate a Gravity Forms image choice field.](https://docs.gravityforms.com/how-to-populate-image-choices-with-woocommerce-products/ "How To Populate Image Choices With WooCommerce Products") [**How To Remove Required Field And Indicates Required Fields legends** \\
This article explains how to prevent users from selecting a placeholder option in dropdown fields and to remove the “\* indicates required fields” message.](https://docs.gravityforms.com/how-to-remove-required-field-and-indicates-required-fields-legends/ "How To Remove Required Field And Indicates Required Fields legends") [**How To Report a Security Issue** \\
We take security issues very seriously and want to ensure that you always feel safe when using Gravity Forms. Here are a few steps you should take if you believe you have a security issue with Gravity Forms.](https://docs.gravityforms.com/how-to-report-a-security-issue/ "How To Report a Security Issue") [**How To Restrict Download URLs To The Entry Creator** \\
In this guide, we’ll walk through how to use filters to limit file access to the original submitter of a Gravity Forms entry.](https://docs.gravityforms.com/how-to-restrict-download-urls-to-the-entry-creator/ "How To Restrict Download URLs To The Entry Creator") [**How To Restrict Forms To Logged In Users** \\
Restrict form access to logged-in users only, ensuring submissions come from authenticated users.](https://docs.gravityforms.com/how-to-restrict-forms-to-logged-in-users/ "How To Restrict Forms To Logged In Users") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/9/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [8](https://docs.gravityforms.com/category/knowledge-base/page/8/) [9](https://docs.gravityforms.com/category/knowledge-base/page/9/) 10 [11](https://docs.gravityforms.com/category/knowledge-base/page/11/) [12](https://docs.gravityforms.com/category/knowledge-base/page/12/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/11/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/10/# "Algolia")
