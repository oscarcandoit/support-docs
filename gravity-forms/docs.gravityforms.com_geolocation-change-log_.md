---
url: "https://docs.gravityforms.com/geolocation-change-log/"
title: "Geolocation Changelog - Gravity Forms Documentation"
---
...
- Fixed an issue where the address field styles disappears in orbital theme when the geolocation suggestions setting is enabled.

### 1.5.0 \| 2025-05-13

- Added support for Google Places (New) API and enterprise API keys.
...
- Added the JS-based [gform\_geolocation\_autocomplete\_options\_pre\_init](https://docs.gravityforms.com/gform-geolocation-autocomplete-options-pre-init/) filter, so the autocomplete initialization options can be customized.
- Added the JS-based [gform\_geolocation\_autocomplete\_mappings\_pre\_populate](https://docs.gravityforms.com/gform-geolocation-autocomplete-mappings-pre-populate) filter, so the input values can be customized before the Address field is populated.
...
[Algolia](https://docs.gravityforms.com/geolocation-change-log/# "Algolia")
