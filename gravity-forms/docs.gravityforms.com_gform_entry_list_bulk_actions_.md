---
url: "https://docs.gravityforms.com/gform_entry_list_bulk_actions/"
title: "gform_entry_list_bulk_actions - Gravity Forms Documentation"
---
...
# gform\_entry\_list\_bulk\_actions

- [Description](https://docs.gravityforms.com/gform_entry_list_bulk_actions/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_list_bulk_actions/#h-usage)
- [Example(s)](https://docs.gravityforms.com/gform_entry_list_bulk_actions/#h-example-s)
- [Placement](https://docs.gravityforms.com/gform_entry_list_bulk_actions/#h-placement)
- [Since](https://docs.gravityforms.com/gform_entry_list_bulk_actions/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_entry_list_bulk_actions/#h-source-code)

## Description

The “gform\_entry\_list\_bulk\_actions” filter in Gravity Forms allows the drop down of available bulk actions on the entries list to be modified. This filter works well with the [gform\_entry\_list\_action](https://docs.gravityforms.com/gform_entry_list_action) action for handling the custom actions added.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_list_bulk_actions'``,``'your_function_name'``, 10, 2 );` |

To limit the scope of your function to a specific form, append the form id to the end of the hook name. (format:gform\_entry\_list\_bulk\_actions\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_list_bulk_actions_21'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_entry_list_bulk_actions'``,``'add_actions'``, 10, 2 );`<br>`function``add_actions(``$actions``,``$form_id``){`<br>`$actions``[``'my_custom_action'``] =``'My Custom Action'``;`<br>`return``$actions``;`<br>`}` |
...
This filter is located in the GF\_Entry\_List\_Table::get\_bulk\_actions() in gravityforms/entry\_list.php.
...
[Algolia](https://docs.gravityforms.com/gform_entry_list_bulk_actions/# "Algolia")
