---
url: "https://docs.gravityforms.com/gform_field_types_delete_files/"
title: "gform_field_types_delete_files - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_field_types_delete_files/#h-description)
- [Usage](https://docs.gravityforms.com/gform_field_types_delete_files/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_field_types_delete_files/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_field_types_delete_files/#h-placement)
- [Since](https://docs.gravityforms.com/gform_field_types_delete_files/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_field_types_delete_files/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_field_types_delete_files'``,``'your_function_name'``, 10, 2 );` |

To target a specific form, append the form id to the hook name. (format: gform\_field\_types\_delete\_files\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_field_types_delete_files_1'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$field\_types** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_field_types_delete_files'``,``'__return_empty_array'``);` |

The following example adds the **post\_custom\_field** to the field types to be removed.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_field_types_delete_files'``,``'delete_custom_field_upload'``);`<br>`function``delete_custom_field_upload(``$field_types``) {`<br>`$field_types``[] =``'post_custom_field'``;`<br>`return``$field_types``;`<br>`}` |
...
- GFFormsModel::get\_delete\_file\_field\_types() in _forms\_model.php_
- GFFormsModel::get\_delete\_file\_field\_types() in _forms\_model\_legacy.php_
...
[Algolia](https://docs.gravityforms.com/gform_field_types_delete_files/# "Algolia")
