---
url: "https://docs.gravityforms.com/gf_field_total/"
title: "GF_Field_Total - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_total/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_total/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_total/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_total/#h-properties)
- [Source Code](https://docs.gravityforms.com/gf_field_total/#h-source-code)

## Introduction

The GF\_Field\_Total class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Total field is rendered when the form is displayed and how its value is handled during and after form submission.
...
The source code is located in _includes/fields/class-gf-field-total.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_total/# "Algolia")
