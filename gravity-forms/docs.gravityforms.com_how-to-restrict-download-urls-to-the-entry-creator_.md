---
url: "https://docs.gravityforms.com/how-to-restrict-download-urls-to-the-entry-creator/"
title: "How To Restrict Download URLs To The Entry Creator - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/how-to-restrict-download-urls-to-the-entry-creator/#h-introduction)
- [Examples](https://docs.gravityforms.com/how-to-restrict-download-urls-to-the-entry-creator/#h-examples)
- [Placement](https://docs.gravityforms.com/how-to-restrict-download-urls-to-the-entry-creator/#h-placement)
- [Resources](https://docs.gravityforms.com/how-to-restrict-download-urls-to-the-entry-creator/#h-resources)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22<br>23<br>24<br>25<br>26<br>27<br>28<br>29<br>30<br>31<br>32<br>33<br>34<br>35<br>36<br>37<br>38<br>39<br>40<br>41<br>42<br>43<br>44<br>45<br>46<br>47<br>48<br>49<br>50<br>51<br>52<br>53<br>54<br>55<br>56 | `add_filter(``'gform_pre_replace_merge_tags'``,``function``(``$text``,``$form``,``$entry``) {`<br>```if``(``empty``(``$entry``[``'id'``] ) ||``empty``(``$entry``[``'created_by'``] ) ) {`<br>```return``$text``;`<br>```}`<br>```foreach``(``$form``[``'fields'``]``as``$field``) {`<br>```if``( !``$field``instanceof``GF_Field_FileUpload ) {`<br>```continue``;`<br>```}`<br>```$field``->set_context_property(``'entry_id'``,``$entry``[``'id'``] );`<br>```$field``->set_context_property(``'entry_created_by'``,``$entry``[``'created_by'``] );`<br>```}`<br>```return``$text``;`<br>`}, 10, 3 );`<br>`add_filter(``'gform_secure_file_download_url'``,``function``(``$download_url``,``$field``) {`<br>```if``( GFCommon::is_entry_detail() ) {`<br>```$entry``= GFEntryDetail::get_current_entry();`<br>```$entry_id``= rgar(``$entry``,``'id'``);`<br>```$created_by``= rgar(``$entry``,``'created_by'``);`<br>```}``else``{`<br>```$entry_id``=``$field``->get_context_property(``'entry_id'``);`<br>```$created_by``=``$field``->get_context_property(``'entry_created_by'``);`<br>```}`<br>```if``(``empty``(``$entry_id``) ||``empty``(``$created_by``) ) {`<br>```return``$download_url``;`<br>```}`<br>```return``add_query_arg(``array``(``'id-e'``=>``$entry_id``,``'id-c'``=>``$created_by``),``$download_url``);`<br>`}, 10, 2 );`<br>`add_filter(``'gform_require_login_pre_download'``,``function``(``$require_login``) {`<br>```$require_login``= true;`<br>```if``( ! is_user_logged_in() ) {`<br>```auth_redirect();`<br>```}`<br>```return``$require_login``;`<br>`} );`<br>`add_filter(``'gform_permission_granted_pre_download'``,``function``(``$permission_granted``,``$form_id``,``$field_id``) {`<br>```$entry_id``= rgget(``'id-e'``);`<br>```$created_by``= rgget(``'id-c'``);`<br>```if``(``empty``(``$entry_id``) ||``empty``(``$created_by``) ) {`<br>```return``false;`<br>```}`<br>```$entry``= GFAPI::get_entry(``$entry_id``);`<br>```if``( is_wp_error(``$entry``) || rgar(``$entry``,``'created_by'``) !==``$created_by``||``empty``(``$entry``[``$field_id``] ) ) {`<br>```return``false;`<br>```}`<br>```return``get_current_user_id() ==``$created_by``;`<br>`}, 10, 3 );` |
...
- [gform\_pre\_replace\_merge\_tags](https://docs.gravityforms.com/gform_pre_replace_merge_tags/)
- [gform\_secure\_file\_download\_url](https://docs.gravityforms.com/gform_secure_file_download_url/)
- [**gform\_require\_login\_pre\_download**](https://docs.gravityforms.com/gform_require_login_pre_download/)
- **[gform\_permission\_granted\_pre\_download](https://docs.gravityforms.com/gform_permission_granted_pre_download/)**
...
[Algolia](https://docs.gravityforms.com/how-to-restrict-download-urls-to-the-entry-creator/# "Algolia")
