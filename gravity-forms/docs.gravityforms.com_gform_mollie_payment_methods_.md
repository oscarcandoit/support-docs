---
url: "https://docs.gravityforms.com/gform_mollie_payment_methods/"
title: "gform_mollie_payment_methods - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_mollie_payment_methods/#h-description)
- [Usage](https://docs.gravityforms.com/gform_mollie_payment_methods/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_mollie_payment_methods/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_mollie_payment_methods/#h-examples)
- [Modify available payment methods.](https://docs.gravityforms.com/gform_mollie_payment_methods/#h-modify-available-payment-methods)
- [Placement](https://docs.gravityforms.com/gform_mollie_payment_methods/#h-placement)
- [Since](https://docs.gravityforms.com/gform_mollie_payment_methods/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_mollie_payment_methods/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mollie_payment_methods'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$methods** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `add_filter(``'gform_mollie_payment_methods'``,``'filter_mollie_payment_methods'``, 10, 1 );`<br>`function``filter_mollie_payment_methods(``$methods``) {`<br>```// Allow only the Bank payment method as defined by Mollie's API.`<br>```$filtered_methods``=``array_filter``(``$methods``,``function``(``$method``) {`<br>```return``$method``[``'id'``] ===``'bancontact'``;`<br>```});`<br>```return``$filtered_methods``;`<br>`}` |

For more information about available payment methods, refer to [this article](https://docs.mollie.com/docs/payment-methods).
...
This hook is located in GF\_Mollie::get\_methods() in _class-gf-mollie.php_.
...
[Algolia](https://docs.gravityforms.com/gform_mollie_payment_methods/# "Algolia")
