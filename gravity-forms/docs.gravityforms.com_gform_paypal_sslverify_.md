---
url: "https://docs.gravityforms.com/gform_paypal_sslverify/"
title: "gform_paypal_sslverify - Gravity Forms Documentation"
---
...
# gform\_paypal\_sslverify

- [Description](https://docs.gravityforms.com/gform_paypal_sslverify/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_sslverify/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_sslverify/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_paypal_sslverify/#h-example)
- [Turn off SSL verification.](https://docs.gravityforms.com/gform_paypal_sslverify/#h-turn-off-ssl-verification)
- [Placement](https://docs.gravityforms.com/gform_paypal_sslverify/#h-placement)
- [Since](https://docs.gravityforms.com/gform_paypal_sslverify/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_paypal_sslverify/#h-source-code)

## Description

The “gform\_paypal\_sslverify” filter in the PayPal Standard Add-On allows the sslverify setting to be modified before sending requests to PayPal.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_sslverify'``,``'your_function_name'``);` |

## Parameters

- **$sslverify** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_sslverify'``,``'__return_false'``);` |
...
This filter is located in GFPayPal::verify\_paypal\_ipn() in _class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_sslverify/# "Algolia")
