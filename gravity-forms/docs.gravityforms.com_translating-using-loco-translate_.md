---
url: "https://docs.gravityforms.com/translating-using-loco-translate/"
title: "Translating Gravity Forms using Loco Translate - Gravity Forms"
---
...
- [Getting Started](https://docs.gravityforms.com/translating-using-loco-translate/#h-getting-started)
- [Creating a New Translation](https://docs.gravityforms.com/translating-using-loco-translate/#h-creating-a-new-translation)
- [Updating an Existing Translation](https://docs.gravityforms.com/translating-using-loco-translate/#h-updating-an-existing-translation)
- [Translate those Strings](https://docs.gravityforms.com/translating-using-loco-translate/#h-translate-those-strings)
- [Share Your Translation](https://docs.gravityforms.com/translating-using-loco-translate/#h-share-your-translation)
- [Override bundled Translation](https://docs.gravityforms.com/translating-using-loco-translate/#h-override-bundled-translation)

In this article, we explain how you can use the [Loco Translate](https://wordpress.org/plugins/loco-translate/) WordPress plugin to create and update translations for Gravity Forms (or an add-on). Loco also has an [free online PO file editor](https://localise.biz/free/poeditor) but this article focuses on the WordPress plugin.

## Getting Started

1. [![install-loco-translate](https://docs.gravityforms.com/wp-content/uploads/2015/09/install-loco-translate-300x153.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/install-loco-translate.png) Loco Translate is available from the WordPress Plugin Directory and can be installed directly from the **Plugins > Add New** page of your WordPress Admin.

2. [![loco-translate-manage-translations](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-manage-translations-300x96.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-manage-translations.png) Once installed and activated you will find a new **Loco Translate** menu item has been added. Here you will find a list of all your installed themes and plugins, including their available translations.


## Creating a New Translation

1. [![loco-translate-new-language](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-new-language-300x41.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-new-language.png) To add a translation for a new language click the **New language** link in the _Translations (PO)_ column of the plugin you want to translate.

2. [![loco-translate-new-po-file](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-new-po-file-300x109.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-new-po-file.png) On the _New PO file_ tab select the language from the drop down of common languages, or enter the language ISO code.

3. [![loco-translate-select-directory](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-select-directory-300x39.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-select-directory.png) You may also be offered the ability to choose where the translation will be stored. To ensure your translation is not lost during updates we would recommend selecting the **global languages directory**.

4. [![loco-translate-start-translating](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-start-translating.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-start-translating.png) Click the **Start Translating** button.

5. See [Translate those Strings](https://docs.gravityforms.com/translating-using-loco-translate/#translate-those-strings)


## Updating an Existing Translation

1. [![loco-translate-update-existing](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-update-existing-300x38.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-update-existing.png) On the Loco Translate packages tab, in the _Translations (PO)_ column, click on the translation you want to update.

2. [![loco-translate-save-download-sync-toolbar](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-save-download-sync-toolbar.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-save-download-sync-toolbar.png) To pull in any new strings which need translating, and remove any translations for strings which no longer exist in Gravity Forms (or add-on) click the **Sync** button in the editor toolbar.

3. See [Translate those Strings](https://docs.gravityforms.com/translating-using-loco-translate/#translate-those-strings)


## Translate those Strings

1. [![loco-translate-editor](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-editor-300x231.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-editor.png) On the editor screen you’ll be presented with a list of all the strings available for translating. Untranslated strings are shown in bold blue.
...
2. [![loco-translate-unsaved-changes](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-unsaved-changes-300x56.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-unsaved-changes.png) The newly translated string will have a star icon to the left of the string indicating that the changes have yet to be saved.

3. [![loco-translate-save-download-toolbar](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-save-download-toolbar.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-save-download-toolbar.png) To compile the translation MO file for use by Gravity Forms (or add-on) click the **Save** button in the toolbar above the list of strings.


## Share Your Translation

1. [![loco-translate-download-po-mo-buttons](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-download-po-mo-buttons.png)](https://docs.gravityforms.com/wp-content/uploads/2015/09/loco-translate-download-po-mo-buttons.png) On the Loco Translate editor screen download the translation **PO** and **MO** files by using the buttons in the toolbar.

2. Open a [support ticket](https://www.gravityforms.com/support/) or use our [Contact Us form](https://www.gravityforms.com/contact-us/) and let us know you would like to contribute your translations. We’ll reply informing you how best to send them to us. Once we have your files we will get them included in the next plugin update and on the [Translations](https://www.gravityforms.com/downloads/translations/) page of the support site. We will also credit you in the change log and on the Translations page.
...
[Algolia](https://docs.gravityforms.com/translating-using-loco-translate/# "Algolia")
