---
url: "https://docs.gravityforms.com/gform_paypal_invoice/"
title: "gform_paypal_invoice - Gravity Forms Documentation"
---
...
# gform\_paypal\_invoice

- [Description](https://docs.gravityforms.com/gform_paypal_invoice/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_invoice/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_invoice/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_invoice/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_paypal_invoice/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_invoice'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$invoice\_id** [integer](https://docs.gravityforms.com/integer)
Empty string.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_paypal_invoice'``,``'change_invoice'``, 10, 3 );`<br>`function``change_invoice(``$invoice_id``,``$form``,``$entry``) {`<br>```return``rgar(``$entry``,``'id'``);`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_paypal_invoice/# "Algolia")
