---
url: "https://docs.gravityforms.com/gform_product/"
title: "gform_product - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_product/#h-description)
- [Usage](https://docs.gravityforms.com/gform_product/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_product/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_product/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_product/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_product/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_product'``,``'change_product'``, 10, 2 );`<br>`function``change_product(``$label``,``$form_id``) {`<br>```return``'Services'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_product/# "Algolia")
