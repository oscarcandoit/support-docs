---
url: "https://docs.gravityforms.com/gform_address_display_format/"
title: "gform_address_display_format - Gravity Forms Documentation"
---
...
# gform\_address\_display\_format

- [Description](https://docs.gravityforms.com/gform_address_display_format/#h-description)
- [Usage](https://docs.gravityforms.com/gform_address_display_format/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_address_display_format/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_address_display_format/#h-examples)
- [Since](https://docs.gravityforms.com/gform_address_display_format/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_address_display_format/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_address_display_format'``,``'change_address'``, 10, 2 );` |
...
_Possible values:_ default and zip\_before\_city.
...
This example demonstrates how to change the address format to _zip\_before\_city_.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_address_display_format'``,``'address_format'``, 10, 2 );`<br>`function``address_format(``$format``,``$field``) {`<br>`return``'zip_before_city'``;`<br>`}` |
...
This filter is located in the following methods in _includes/fields/class-gf-field-address.php_:

- GF\_Field\_Address::get\_field\_input()
- GF\_Field\_Address::get\_value\_entry\_detail()
...
[Algolia](https://docs.gravityforms.com/gform_address_display_format/# "Algolia")
