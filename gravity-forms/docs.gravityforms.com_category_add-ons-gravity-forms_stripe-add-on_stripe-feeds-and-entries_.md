---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-feeds-and-entries/"
title: "Stripe Feeds And Entries Archives - Gravity Forms Documentation"
---
...
# Stripe Feeds And Entries

## Articles

[**Stripe Feed Settings Reference** \\
The following guide explains the many settings that you can find when creating a feed for the official Gravity Forms Stripe Add-On.](https://docs.gravityforms.com/stripe-feed-settings-reference/ "Stripe Feed Settings Reference") [**Creating a Feed for the Stripe Add-On**\\
...
In this article, we will show you how to cancel recurring subscriptions that were placed using the Stripe Add-On from within the WordPress admin.](https://docs.gravityforms.com/cancelling-recurring-subscriptions-stripe/ "Canceling Recurring Subscriptions in Stripe") [**Stripe Marks Charge As Recurring When It Is Non-Recurring** \\
Charges made through the Stripe Add-On have shown up flagged as "recurring", when they are not part of a recurring subscription plan.](https://docs.gravityforms.com/stripe-marking-charges-as-recurring/ "Stripe Marks Charge As Recurring When It Is Non-Recurring")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-feeds-and-entries/# "Algolia")
