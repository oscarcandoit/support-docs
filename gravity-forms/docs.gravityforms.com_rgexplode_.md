---
url: "https://docs.gravityforms.com/rgexplode/"
title: "rgexplode() - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/rgexplode/#h-description)
- [Usage](https://docs.gravityforms.com/rgexplode/#h-usage)
- [Parameters](https://docs.gravityforms.com/rgexplode/#h-parameters)
- [Example](https://docs.gravityforms.com/rgexplode/#h-example)
- [Source Code](https://docs.gravityforms.com/rgexplode/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `rgexplode(``$sep``,``$string``,``$count``),` |

## Parameters

- **$sep** [string](https://docs.gravityforms.com/string)
The separator between items. Commonly, a comma is used.

- **$string** [string](https://docs.gravityforms.com/string)

The string of values to be placed within an array.

- **$count** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `// Gets the first 5 values and places them into an array.`<br>`$sep``=``','``;`<br>`$string``=``'item1,item2,item3,item4,item5,item6,item7,item8,item9'``;`<br>`$count``= 5;`<br>`$items``= rgexplode(``$sep``,``$string``,``$count``);` |
...
[Algolia](https://docs.gravityforms.com/rgexplode/# "Algolia")
