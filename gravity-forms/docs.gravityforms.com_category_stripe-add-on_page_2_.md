---
url: "https://docs.gravityforms.com/category/stripe-add-on/page/2/"
title: "Stripe Add-On Archives - Page 2 of 3 - Gravity Forms Documentation - Page 2 of 3"
---
...
This article includes feature notes and a change log for the release of the official Gravity Forms Stripe Add-On version 5.0.](https://docs.gravityforms.com/stripe-5-0-release-notes/ "Stripe 5.0 Release Notes") [**Using the Stripe Add-On** \\
Gravity Forms and Stripe allows you to quickly and easily implement credit card payments with WordPress!](https://docs.gravityforms.com/stripe-add-on/ "Using the Stripe Add-On") [**Creating a Feed for the Stripe Add-On**\\
This article contains step-by-step instructions on how to create a feed for the Stripe Add-On.](https://docs.gravityforms.com/setting-up-the-stripe-feeds/ "Creating a Feed for the Stripe Add-On") [**Managing Stripe Entries** \\
This article lists entry actions you can execute from your Entry Detail page when collecting payments with the official Gravity Forms Stripe Add-On.](https://docs.gravityforms.com/stripe-entry-detail-actions/ "Managing Stripe Entries") [**Canceling Recurring Subscriptions in Stripe** \\
...
This article gives a brief overview of the payment collection methods available in Gravity Forms Stripe Add-On version v2.6.](https://docs.gravityforms.com/stripe-payment-collection-methods/ "Overview of Stripe Payment Collection Methods") [**Verifying Your Stripe Integration** \\
Step-by-step instructions on how to test that your Stripe Add-On has been correctly integrated with Gravity Forms.](https://docs.gravityforms.com/verifying-your-stripe-integration/ "Verifying Your Stripe Integration") [**Changes to Stripe Checkout with Stripe Add-On v3.0** \\
...
Version 3 of the official Gravity Forms Stripe Add-On made a number of changes to bring our add-on into line with Stripe’s updates around Strong Customer Authentication (SCA) and their new API. This article gives you the basics regarding SCA.](https://docs.gravityforms.com/stripe-support-of-strong-customer-authentication/ "Stripe Support of Strong Customer Authentication") [**Common questions about Authenticating with Stripe** \\
Version 2.8 of our official Stripe add-on implements Stripe's recommended Stripe Connect authentication and account linking method.](https://docs.gravityforms.com/faq-authenticating-with-stripe/ "Common questions about Authenticating with Stripe") [Previous](https://docs.gravityforms.com/category/stripe-add-on/) [1](https://docs.gravityforms.com/category/stripe-add-on/) 2 [3](https://docs.gravityforms.com/category/stripe-add-on/page/3/) [Next](https://docs.gravityforms.com/category/stripe-add-on/page/3/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/stripe-add-on/page/2/# "Algolia")
