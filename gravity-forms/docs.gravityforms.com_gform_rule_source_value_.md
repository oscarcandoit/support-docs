---
url: "https://docs.gravityforms.com/gform_rule_source_value/"
title: "gform_rule_source_value - Gravity Forms Documentation"
---
...
# gform\_rule\_source\_value

- [Description](https://docs.gravityforms.com/gform_rule_source_value/#h-description)
- [Usage](https://docs.gravityforms.com/gform_rule_source_value/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_rule_source_value/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_rule_source_value/#h-example)
- [Placement](https://docs.gravityforms.com/gform_rule_source_value/#h-placement)
- [Since](https://docs.gravityforms.com/gform_rule_source_value/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_rule_source_value/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_rule_source_value'``,``function``(``$source_value``,``$rule``,``$form``,``$logic``,``$entry``) {`<br>```// Modify the rule`<br>```return``$source_value``;`<br>`}, 10, 5 );` |

## Parameters

- **$source\_value** [int](https://docs.gravityforms.com/int/) \| [string](https://docs.gravityforms.com/string/)

The value of the rule’s configured field ID, entry meta, or custom property.

- **$rule** [Rule Object](https://docs.gravityforms.com/conditional-logic-object/#rule)

The current rule object. See the Rule Properties section of the [Conditional Logic Object](https://docs.gravityforms.com/conditional-logic/#rule) article.

- **$form** [Form Object](https://docs.gravityforms.com/form-object/)

The current form meta.

- **$logic** [Conditional Logic Object](https://docs.gravityforms.com/conditional-logic-object/)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_rule_source_value'``,``function``(``$source_value``,``$rule``,``$form``,``$logic``,``$entry``) {`<br>```// Changing the field value when evaludating conditional logic with source field id 3, and form id 1.`<br>```if``(``$form``[``'id'``] ==``'1'``&&``$rule``[``'fieldId'``] ==``'3'``) {`<br>```$source_value``=``'my custom field value'``;`<br>```}`<br>```return``$source_value``;`<br>`}, 10, 5 );` |
...
This filter is located in GFFormsModel::evaluate\_conditional\_logic() in _forms\_model.php_
...
[Algolia](https://docs.gravityforms.com/gform_rule_source_value/# "Algolia")
