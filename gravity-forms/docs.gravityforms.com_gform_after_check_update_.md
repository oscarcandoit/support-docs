---
url: "https://docs.gravityforms.com/gform_after_check_update/"
title: "gform_after_check_update - Gravity Forms Documentation"
---
...
# gform\_after\_check\_update

- [Description](https://docs.gravityforms.com/gform_after_check_update/#h-description)
- [Usage](https://docs.gravityforms.com/gform_after_check_update/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_after_check_update/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_after_check_update/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_after_check_update'``,``'my_function'``, 10, 0 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `function``my_function() {`<br>`echo``'Update was checked'``;`<br>`}`<br>`add_action(``'gform_after_check_update'``,``'my_function'``, 10, 0 );` |

## Source Code

This action hook is located in _update.php_.
...
[Algolia](https://docs.gravityforms.com/gform_after_check_update/# "Algolia")
