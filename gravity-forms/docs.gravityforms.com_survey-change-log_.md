---
url: "https://docs.gravityforms.com/survey-change-log/"
title: "Survey Changelog - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Survey Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/survey-add-on/)    - [Setting Up the Survey Add-On](https://docs.gravityforms.com/survey-add-on/ "Setting Up the Survey Add-On")
    - [Using the Survey Add-On](https://docs.gravityforms.com/using-the-survey-add-on/ "Using the Survey Add-On")
    - [Viewing Survey Results](https://docs.gravityforms.com/viewing-survey-results/ "Viewing Survey Results")
    - [Survey Changelog](https://docs.gravityforms.com/survey-change-log/ "Survey Changelog")
...
- Fixed an issue where Survey icon is not displayed on Uninstall screen.
- Fixed a fatal error that occurs when the site is using plain permalinks.

### 4.2.1

- Fixed fatal error due to class name duplication.

### 4.2.0 \| 2025-06-10

- Updated the add-on to be released with minified and non-minified assets.
- Fixed a bug that causes the Rating choices to not be saved when navigating between pages or failing validation.
- Fixed a bug that can cause PHP errors in the dashboard.
- API: Fixed an issue where the Survey field does not use the correct styles in a conversational form.
- API: Fixed an issue where Theme Framework CSS API properties for Survey fields are output when not using the Orbital theme and no Survey field is present.
- API: Removed the deprecated form Theme Framework global CSS API properties used in `theme_layer_form_css_properties`.
...
- Fixed an issue with how the empty Likert field value was handled in the {all\_fields} output.
...
- Added GF\_Field\_Rating.
- Added GF\_Field\_Rank.
- Added GF\_Field\_Survey.
- Added GF\_Field\_Likert.
- Added DocBlocks.
...
- Updated front-end script dependency to include _jquery-touch-punch_ on mobile devices enabling touch support for the Rank field.
- Updated POT file.
...
- Added function gf\_survey to easily get a Survey instance.
...
[Algolia](https://docs.gravityforms.com/survey-change-log/# "Algolia")
