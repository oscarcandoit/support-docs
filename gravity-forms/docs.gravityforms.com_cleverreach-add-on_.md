---
url: "https://docs.gravityforms.com/cleverreach-add-on/"
title: "Setting Up the CleverReach Add-On - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [CleverReach Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/cleverreach-add-on/)    - [Setting Up the CleverReach Add-On](https://docs.gravityforms.com/cleverreach-add-on/ "Setting Up the CleverReach Add-On")
    - [Creating a Feed for the CleverReach Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-cleverreach-add-on/ "Creating a Feed for the CleverReach Add-On")
    - [CleverReach Changelog](https://docs.gravityforms.com/cleverreach-change-log/ "CleverReach Changelog")
...
- [Pre-Requisites](https://docs.gravityforms.com/cleverreach-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/cleverreach-add-on/#h-setup)
- [Add-On Framework Hooks](https://docs.gravityforms.com/cleverreach-add-on/#h-add-on-framework-hooks)
...
- A [CleverReach](https://www.cleverreach.com/en/) account
...
3. From this page, click the **CleverReach** tab.
4. Enter your **Customer ID**, **Username**, and **Password**. This is obtained from CleverReach.
...
Once you have entered your API key, you’re ready to begin [creating a feed for the CleverReach Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-cleverreach-add-on/).

## Add-On Framework Hooks

Because the CleverReach Add-On is built using the [Add-On Framework](https://docs.gravityforms.com/category/developers/php-api/add-on-framework) it also inherits any hooks available in the framework methods it uses such as:

- [gform\_short\_slug\_field\_value](https://docs.gravityforms.com/gform_short_slug_field_value) for changing a field value before it is passed to CleverReach.
...
[Algolia](https://docs.gravityforms.com/cleverreach-add-on/# "Algolia")
