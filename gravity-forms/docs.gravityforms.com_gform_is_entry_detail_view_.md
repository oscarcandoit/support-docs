---
url: "https://docs.gravityforms.com/gform_is_entry_detail_view/"
title: "gform_is_entry_detail_view - Gravity Forms Documentation"
---
...
# gform\_is\_entry\_detail\_view

- [Description](https://docs.gravityforms.com/gform_is_entry_detail_view/#h-description)
- [Usage](https://docs.gravityforms.com/gform_is_entry_detail_view/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_is_entry_detail_view/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_is_entry_detail_view/#h-example)
- [Placement](https://docs.gravityforms.com/gform_is_entry_detail_view/#h-placement)
- [Since](https://docs.gravityforms.com/gform_is_entry_detail_view/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_is_entry_detail_view/#h-source-code)

## Description

Allows the “entry\_detail” page to be marked as a regular page, not an admin or edit page, or a regular page to be marked as an Entry Detail page. This filter is useful if you are creating custom entry edit pages.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_is_entry_detail_view'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$is\_entry\_detail\_view** [bool](https://docs.gravityforms.com/bool)
Whether the current page is the Entry Detail (entry\_detail) page.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_is_entry_detail_view'``,``'set_entry_edit'``, 10, 1 );`<br>`function``set_entry_edit(``$is_entry_detail_view``){`<br>```return``false;`<br>`}` |
...
This filter is located in GFCommon::is\_entry\_detail\_view() in _common.php_.
...
[Algolia](https://docs.gravityforms.com/gform_is_entry_detail_view/# "Algolia")
