---
url: "https://docs.gravityforms.com/gform_user_registration_config_validation/"
title: "gform_user_registration_config_validation - Gravity Forms"
---
...
- [Description](https://docs.gravityforms.com/gform_user_registration_config_validation/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_config_validation/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_config_validation/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_user_registration_config_validation/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_config_validation/#h-source-code)

**Removed:** This filter was removed in version 3.0. New feed settings defined using [gform\_userregistration\_feed\_settings\_fields](https://docs.gravityforms.com/gform_userregistration_feed_settings_fields) can be validated by defining the validation\_callback property for the field.

## Description

Used to validate custom settings/meta specified using the [gform\_user\_registration\_add\_option\_section](https://docs.gravityforms.com/gform_user_registration_add_option_section) or [gform\_user\_registration\_add\_option\_group](https://docs.gravityforms.com/gform_user_registration_add_option_group) action hooks.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_user_registration_config_validation'``,``'your_function_name'``, 2 );` |

## Parameters

- **$is\_validation\_error** [array](https://docs.gravityforms.com/array)

Boolean value indicating whether there was a validation error with the User Registration configuration.
- **$config** [array](https://docs.gravityforms.com/array)

The User Registration configuration array.

## Examples

This example is a bit of modified code from the User Registration source code that demonstrates how to validate the custom option fields added using the [gform\_user\_registration\_add\_option\_section](https://docs.gravityforms.com/gform_user_registration_add_option_section) hook to support the multisite options.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13 | `add_filter(``'gform_user_registration_config_validation'``,``'validate_multisite_config'``);`<br>`public``static``function``validate_multisite_config(``$is_validation_error``) {`<br>```$multisite_options``=``$config``[``'meta'``][``'multisite_options'``];`<br>```if``(``empty``(``$multisite_options``[``'create_site'``]))`<br>```return``$is_validation_error``;`<br>```if``(``empty``(``$multisite_options``[``'site_address'``]) ||``empty``(``$multisite_options``[``'site_title'``]))`<br>```return``true;`<br>```return``$is_validation_error``;`<br>`}` |

## Source Code

This action hook is located in _userregistration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_config_validation/# "Algolia")
