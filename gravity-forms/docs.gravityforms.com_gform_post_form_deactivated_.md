---
url: "https://docs.gravityforms.com/gform_post_form_deactivated/"
title: "gform_post_form_deactivated - Gravity Forms Documentation"
---
...
# gform\_post\_form\_deactivated

- [Description](https://docs.gravityforms.com/gform_post_form_deactivated/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_form_deactivated/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_form_deactivated/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_form_deactivated/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_post_form_deactivated/#h-source-code)

## Description

The “gform\_post\_form\_deactivated” action in Gravity Forms is triggered after an active form is marked as inactive, allowing further actions to be performed.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_post_form_deactivated'``,``'my_function'``, 10, 1 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_action(``'gform_post_form_deactivated'``,``'my_post_form_deactivated_func'``, 10);`<br>`function``my_post_form_deactivated_func(``$form_id``) {`<br>```// perform action after a form has been deactivated`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_post_form_deactivated/# "Algolia")
