---
url: "https://docs.gravityforms.com/gform_entry_detail_sidebar_before/"
title: "gform_entry_detail_sidebar_before - Gravity Forms Documentation"
---
...
# gform\_entry\_detail\_sidebar\_before

- [Description](https://docs.gravityforms.com/gform_entry_detail_sidebar_before/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_detail_sidebar_before/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_entry_detail_sidebar_before/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_entry_detail_sidebar_before/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_entry_detail_sidebar_before/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_entry_detail_sidebar_before'``,``'add_sidebar_text_before'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_entry_detail_sidebar_before'``,``'add_sidebar_text_before'``, 10, 2 );`<br>`function``add_sidebar_text_before(``$form``,``$entry``) {`<br>`echo``"<div class='stuffbox'><h3><span class='hndle'>Extra Cool Stuff</span></h3><div class='inside'>text added before!<br/></div></div>"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_detail_sidebar_before/# "Algolia")
