---
url: "https://docs.gravityforms.com/gform_hubspot_custom_settings/"
title: "gform_hubspot_custom_settings - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_hubspot_custom_settings/#h-description)
- [Usage](https://docs.gravityforms.com/gform_hubspot_custom_settings/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_hubspot_custom_settings/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_hubspot_custom_settings/#h-example)
- [Placement](https://docs.gravityforms.com/gform_hubspot_custom_settings/#h-placement)
- [Since](https://docs.gravityforms.com/gform_hubspot_custom_settings/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_hubspot_custom_settings/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_hubspot_custom_settings'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$custom\_settings** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_hubspot_custom_settings'``,``'add_hubspot_property'``, 10, 2 );`<br>`function``add_hubspot_property(``$custom_settings``,``$form``){`<br>```$custom_settings``[``'gravity_forms_key_test'``] =``array``(``'allows_blank'``=> true,``'tooltip'``=> esc_html__(``'<h6>License Key</h6>Gravity Forms License Key'``,``'gravityformshubspot'``) );`<br>```return``$custom_settings``;`<br>`}` |
...
This filter is located in GF\_HubSpot::get\_enumeration\_properties() in _class-gf-hubspot.php_.
...
[Algolia](https://docs.gravityforms.com/gform_hubspot_custom_settings/# "Algolia")
