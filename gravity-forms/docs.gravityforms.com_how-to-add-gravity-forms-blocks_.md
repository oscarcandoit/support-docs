---
url: "https://docs.gravityforms.com/how-to-add-gravity-forms-blocks/"
title: "How to add Gravity Forms Blocks - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/how-to-add-gravity-forms-blocks/#h-introduction)
- [Insert using the Add Block button](https://docs.gravityforms.com/how-to-add-gravity-forms-blocks/#h-insert-using-the-add-block-button)
- [Insert using the quick select slash "/"](https://docs.gravityforms.com/how-to-add-gravity-forms-blocks/#h-insert-using-the-quick-select-slash)
- [Insert using the content area "recent blocks" shortcut.](https://docs.gravityforms.com/how-to-add-gravity-forms-blocks/#h-insert-using-the-content-area-recent-blocks-shortcut)
- [Insert using the Shortcode block](https://docs.gravityforms.com/how-to-add-gravity-forms-blocks/#h-insert-using-the-shortcode-block)
- [Tailoring Your Block](https://docs.gravityforms.com/how-to-add-gravity-forms-blocks/#h-tailoring-your-block)
...
Note that as of [WordPress 5.8](https://wordpress.org/news/2021/07/tatum/), the Gravity Forms Block will no longer work properly if you are on Gravity Forms 2.4.x or earlier. You will need to upgrade to the latest Gravity Forms release.

## Insert using the Add Block button

1. Open the page or post you wish to add a block to.
2. Click the **plus sign** button (+) to add a new block into the content area where your cursor focus is.

![](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-06-at-12.04.34.png)

3. In the search bar, type enough text to identify the block you want. Alternatively, look under the **Embeds** area.
...
_Example: inserting the Poll block using the Add Block button. Click to view animation._
...
_Example: inserting the Poll block using the shortcode short cut. Click to view animation._

[![Polls Block Typing /Poll](https://docs.gravityforms.com/wp-content/uploads/2019/06/Polls-Block-Typing-Slash-Poll2-300x101.gif)](https://docs.gravityforms.com/wp-content/uploads/2019/06/Polls-Block-Typing-Slash-Poll2.gif)
...
[![](https://docs.gravityforms.com/wp-content/uploads/2019/06/Block-insertion-point-contextual-controls-300x24.png)](https://docs.gravityforms.com/wp-content/uploads/2019/06/Block-insertion-point-contextual-controls.png)

## Insert using the Shortcode block

The WordPress 5 editor comes with a **Shortcode block** (under the Widgets category), which once added will accept a [standard Gravity Forms shortcode](https://docs.gravityforms.com/shortcodes/). Insert that block using any of the methods above, and then you can manually tailor your Gravity Forms shortcode as needed.

[![Add Block - Shortcode](https://docs.gravityforms.com/wp-content/uploads/2019/06/CleanShot-2021-07-06-at-12.25.22.png)](https://docs.gravityforms.com/wp-content/uploads/2019/06/CleanShot-2021-07-06-at-12.25.22.png)
...
- [Form block](https://docs.gravityforms.com/adding-a-form-using-blocks/) (included with Gravity Forms core).
- [Poll block](https://docs.gravityforms.com/polls-block/) (included with Poll add-on)
- [Gutenberg Gravity Forms block](https://docs.gravityforms.com/gravity-forms-gutenberg-block/) (included with the Gutenberg Block experimental add-on)
...
[Algolia](https://docs.gravityforms.com/how-to-add-gravity-forms-blocks/# "Algolia")
