---
url: "https://docs.gravityforms.com/gf_field_email/"
title: "GF_Field_Email - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_email/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_email/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_email/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_email/#h-properties)
- [Source Code](https://docs.gravityforms.com/gf_field_email/#h-source-code)

## Introduction

The GF\_Field\_Email class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Email field is rendered when the form is displayed and how its value is handled during and after form submission.
...
- **emailConfirmEnabled** [boolean](https://docs.gravityforms.com/boolean)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16 | `$inputs``=``array``(`<br>```array``(`<br>```'id'``=>``'1'``,`<br>```'label'``=>``'Email'``,`<br>```'customLabel'``=>``'Email Address'``,`<br>```'placeholder'``=>``'Enter your email address'``,`<br>```'defaultValue'``=>``''`<br>```),`<br>```array``(`<br>```'id'``=>``' 1.2'``,`<br>```'label'``=>``'Confirm Email'``,`<br>```'customLabel'``=>``'Confirm Email Address'``,`<br>```'placeholder'``=>``'Enter your email address again'``,`<br>```'defaultValue'``=>``''`<br>```)`<br>```);` |
...
The source code is located in _includes/fields/class-gf-field-email.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_email/# "Algolia")
