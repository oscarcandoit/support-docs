---
url: "https://docs.gravityforms.com/hidden/"
title: "Hidden - Gravity Forms Documentation"
---
...
- [Summary](https://docs.gravityforms.com/hidden/#h-summary)
- [Common Settings](https://docs.gravityforms.com/hidden/#h-common-settings)
- [Merge Tags](https://docs.gravityforms.com/hidden/#h-merge-tags)
- [Usage](https://docs.gravityforms.com/hidden/#h-usage)
- [Modifiers](https://docs.gravityforms.com/hidden/#h-modifiers)
...
**Note:** The Hidden field is always available in the form to store information. It doesn’t support [Conditional Logic,](https://docs.gravityforms.com/enable-conditional-logic/) and its Visibility settings cannot be changed. If you need to have a field hidden in the form but still available for Conditional Logic, you can use a [Single Line Text](https://docs.gravityforms.com/single-line-text/) field with its Visibility set to hidden. Refer to this [article](https://docs.gravityforms.com/common-field-settings/) for more information.

[![GForms Hidden Field Icon](https://docs.gravityforms.com/wp-content/uploads/2014/05/CleanShot-2021-05-10-at-15.55.19@2x.png)](https://docs.gravityforms.com/wp-content/uploads/2014/05/CleanShot-2021-05-10-at-15.55.19@2x.png)

Hidden field as displayed in the [Field Library](https://docs.gravityforms.com/form-editor/#h-the-field-library)

[![GForms Hidden Field](https://docs.gravityforms.com/wp-content/uploads/2014/05/CleanShot-2021-05-11-at-14.25.15@2x.png)](https://docs.gravityforms.com/wp-content/uploads/2014/05/CleanShot-2021-05-11-at-14.25.15@2x.png)

Hidden field as displayed in the [Form Editor](https://docs.gravityforms.com/form-editor/#h-the-layout-space).
...
[Algolia](https://docs.gravityforms.com/hidden/# "Algolia")
