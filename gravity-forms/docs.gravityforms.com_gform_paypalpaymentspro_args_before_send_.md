---
url: "https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_send/"
title: "gform_paypalpaymentspro_args_before_send - Gravity Forms"
---
...
# gform\_paypalpaymentspro\_args\_before\_send

- [Description](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_send/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_send/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_send/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_send/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_send/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypalpaymentspro_args_before_send'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$nvp** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22<br>23<br>24<br>25 | `Array`<br>`(`<br>```[ACCT] => 4111111111111111`<br>```[EXPDATE] => 1232`<br>```[CVV2] => 111`<br>```[STREET] =>`<br>```[BILLTOSTREET2] =>`<br>```[CITY] =>`<br>```[STATE] =>`<br>```[ZIP] =>`<br>```[BILLTOCOUNTRY] =>`<br>```[CURRENCY] => USD`<br>```[FIRSTNAME] => x`<br>```[LASTNAME] => d`<br>```[EMAIL] => dana@rocketgenius.com`<br>```[DESC] =>`<br>```[L_NAME0] => T-Shirt`<br>```[L_DESC0] =>`<br>```[L_AMT0] => 20`<br>```[L_NUMBER0] => 1`<br>```[L_QTY0] => 2`<br>```[AMT] => 40`<br>```[TENDER] => C`<br>```[TRXTYPE] => S`<br>`)` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_paypalpaymentspro_args_before_send'``,``'change_args'``, 10, 2 );`<br>`function``change_args(``$nvp``,``$form_id``){`<br>```$nvp``[``'LASTNAME'``] =``'Testing'``;`<br>```return``$nvp``;`<br>`}` |
...
This filter is located in GFPayPalPaymentsPro::post\_to\_payflow() in _class-gf-paypalpaymentspro.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypalpaymentspro_args_before_send/# "Algolia")
