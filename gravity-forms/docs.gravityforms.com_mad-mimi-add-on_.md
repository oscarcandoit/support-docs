---
url: "https://docs.gravityforms.com/mad-mimi-add-on/"
title: "Setting Up the Mad Mimi Add-On - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Mad Mimi Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/mad-mimi-add-on/)    - [Obtaining Your Mad Mimi API Key](https://docs.gravityforms.com/setting-up-the-mad-mimi-add-on/ "Obtaining Your Mad Mimi API Key")
    - [Setting Up the Mad Mimi Add-On](https://docs.gravityforms.com/mad-mimi-add-on/ "Setting Up the Mad Mimi Add-On")
    - [Creating a Feed for the Mad Mimi Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-mad-mimi-add-on/ "Creating a Feed for the Mad Mimi Add-On")
    - [Mad Mimi Changelog](https://docs.gravityforms.com/mad-mimi-change-log/ "Mad Mimi Changelog")
...
- [Pre-Requisites](https://docs.gravityforms.com/mad-mimi-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/mad-mimi-add-on/#h-setup)
- [Add-On Framework Hooks](https://docs.gravityforms.com/mad-mimi-add-on/#h-add-on-framework-hooks)

GoDaddy has announced the [closure of the Mad Mimi service](https://madmimi.com/). Once the service is discontinued at the end of August 2024, the Gravity Forms Mad Mimi Add-On will no longer be available for download.
...
3. From this page, click the **Mad Mimi** tab.
4. Enter your **Email Address** and **API Key**. Refer to the [Obtaining Your Mad Mimi API Key](https://docs.gravityforms.com/setting-up-the-mad-mimi-add-on/) article for instructions.
...
Once you have entered your API key, you’re ready to begin [creating a feed for the Mad Mimi Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-mad-mimi-add-on/).

## Add-On Framework Hooks

Because the Mad Mimi Add-On is built using the [Add-On Framework](https://docs.gravityforms.com/category/developers/php-api/add-on-framework) it also inherits any hooks available in the framework methods it uses such as:

- [gform\_short\_slug\_field\_value](https://docs.gravityforms.com/gform_short_slug_field_value) for changing a field value before it is passed to Mad Mimi.
...
[Algolia](https://docs.gravityforms.com/mad-mimi-add-on/# "Algolia")
