---
url: "https://docs.gravityforms.com/gform_consent_checked_indicator/"
title: "gform_consent_checked_indicator - Gravity Forms Documentation"
---
...
# gform\_consent\_checked\_indicator

- [Description](https://docs.gravityforms.com/gform_consent_checked_indicator/#h-description)
- [Usage](https://docs.gravityforms.com/gform_consent_checked_indicator/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_consent_checked_indicator/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_consent_checked_indicator/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_consent_checked_indicator/#h-placement)
- [Since](https://docs.gravityforms.com/gform_consent_checked_indicator/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_consent_checked_indicator/#h-source-code)

## Description

The “gform\_consent\_checked\_indicator” filter in Gravity Forms allows the Consent check mark image to be changed.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_consent_checked_indicator'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$checked\_indicator\_url** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_consent_checked_indicator'``,``'change_image'``, 10, 1 );`<br>`function``change_image(``$checked_indicator_url``){`<br>```return``GFCommon::get_base_url() .``'/images/star1.png'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_consent_checked_indicator/# "Algolia")
