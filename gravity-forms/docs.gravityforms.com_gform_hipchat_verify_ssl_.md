---
url: "https://docs.gravityforms.com/gform_hipchat_verify_ssl/"
title: "gform_hipchat_verify_ssl - Gravity Forms Documentation"
---
...
# gform\_hipchat\_verify\_ssl

- [Description](https://docs.gravityforms.com/gform_hipchat_verify_ssl/#h-description)
- [Usage](https://docs.gravityforms.com/gform_hipchat_verify_ssl/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_hipchat_verify_ssl/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_hipchat_verify_ssl/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_hipchat_verify_ssl/#h-source-code)

## Description

The “gform\_hipchat\_verify\_ssl” filter in the Gravity Forms HipChat Add-On allows the verification of HipChat SSL to be enabled or disabled.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_hipchat_verify_ssl'``,``'your_function_name'``, 10, 1 );` |

\## Parameters

– \*\*$verify\_ssl\*\* [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_hipchat_verify_ssl'``,``'set_ssl'``, 10, 1 );`<br>`function``set_ssl(``$verify_ssl``){`<br>```return``false;`<br>`}` |
...
This filter is located in GFHipChat::initialize\_api() in _gravityformshipchat/class-gf-hipchat.php_.
...
[Algolia](https://docs.gravityforms.com/gform_hipchat_verify_ssl/# "Algolia")
