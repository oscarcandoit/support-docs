---
url: "https://docs.gravityforms.com/category/developers/hooks/actions/payment-actions/page/2/"
title: "Payment Actions Archives - Page 2 of 2 - Gravity Forms Documentation - Page 2 of 2"
---
...
[**gform\_subscription\_canceled** \\
This action hook can be used to perform custom actions when a subscription has been canceled.](https://docs.gravityforms.com/gform_subscription_canceled/ "gform_subscription_canceled") [**gform\_trigger\_payment\_delayed\_feeds** \\
An action hook which is primarily used in GFFeedAddOn by GFPaymentAddOn based add-ons to trigger processing of feeds delayed until payment is completed.](https://docs.gravityforms.com/gform_trigger_payment_delayed_feeds/ "gform_trigger_payment_delayed_feeds") [Previous](https://docs.gravityforms.com/category/developers/hooks/actions/payment-actions/) [1](https://docs.gravityforms.com/category/developers/hooks/actions/payment-actions/) 2

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/actions/payment-actions/page/2/# "Algolia")
