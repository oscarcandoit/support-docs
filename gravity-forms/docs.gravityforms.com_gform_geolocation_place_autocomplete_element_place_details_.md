---
url: "https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/"
title: "gform_geolocation_place_autocomplete_element_place_details - Gravity Forms Documentation"
---
...
# gform\_geolocation\_place\_autocomplete\_element\_place\_details

- [Description](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/#h-description)
- [Usage](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/#h-examples)
- [Include the displayName as an additional return value from the place.fetchFields() call.](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/#h-include-the-nbsp-displayname-nbsp-as-an-additional-return-value-from-the-place-fetchfields-call)
- [Placement](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/#h-since)
...
| **address** | [element](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/#) | The Address field element. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `gform.addFilter(``'gform_geolocation_place_autocomplete_element_place_details'``,``function``(placeDetails, formId, fieldId, address) {`<br>```// Add 'displayName' if it's not already included`<br>```if``(!placeDetails.fields.includes('displayName``')) {`<br>```placeDetails.fields.push('``displayName');`<br>```}`<br>```return``placeDetails;`<br>`});` |
...
[Algolia](https://docs.gravityforms.com/gform_geolocation_place_autocomplete_element_place_details/# "Algolia")
