---
url: "https://docs.gravityforms.com/creating-forms-with-the-gfapi/"
title: "Creating Forms with the GFAPI - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#h-introduction)
- [Adding a single form](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-form)
- [Method Overview](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#h-method-overview)
- [Source Code](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-form-source-code)
- [Parameters](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-form-parameters)
- [Returns](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-form-returns)
- [Usage Example](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-form-usage-example)
- [Adding multiple forms](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-forms)
- [Method Overview](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#h-method-overview-0)
- [Source Code](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-forms-source-code)
- [Parameters](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-forms-parameters)
- [Returns](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-forms-returns)
- [Usage Example](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-forms-usage-example)

## Introduction

The **GFAPI::add\_form()** and **GFAPI::add\_forms()** methods are used to create forms.

## Adding a single form

The **GFAPI::add\_form()** method is used to add a single form.
...
| Class | **GFAPI** |
| Function | **add\_form** |
| Parameters | [see\_below](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-form-parameters) |
| Returns | [see\_below](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-form-returns) |
...
| --- | --- | --- |
| **$form\_meta** | [array](https://docs.gravityforms.com/array) | An associative array containing the form settings, fields, notifications, confirmations, and other properties (e.g. add-on settings). See [Form Object](https://docs.gravityforms.com/form-object/). |

### Returns

An [integer](https://docs.gravityforms.com/integer), the form ID, or a [WP\_Error](https://developer.wordpress.org/reference/classes/wp_error/) instance if an error occurs.
...
The **GFAPI::add\_forms()** method is used to add multiple forms.
...
| --- | --- |
| Class | **GFAPI** |
| Functions | **add\_forms** |
| Parameters | [see\_below](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-forms-parameters) |
| Returns | [see\_below](https://docs.gravityforms.com/creating-forms-with-the-gfapi/#add-forms-returns) |
...
| Param | Type | Description |
| --- | --- | --- |
| **$forms** | [array](https://docs.gravityforms.com/array) | An array of associative arrays containing the form settings, fields, notifications, confirmations, and other properties (e.g. add-on settings). See [Form Object](https://docs.gravityforms.com/form-object/). |

### Returns

An [array](https://docs.gravityforms.com/array) of [integers](https://docs.gravityforms.com/integer), the form IDs, or a [WP\_Error](https://developer.wordpress.org/reference/classes/wp_error/) instance if an error occurs.
...
[Algolia](https://docs.gravityforms.com/creating-forms-with-the-gfapi/# "Algolia")
