---
url: "https://docs.gravityforms.com/gform_aweber_post_subscriber_created/"
title: "gform_aweber_post_subscriber_created - Gravity Forms Documentation"
---
...
# gform\_aweber\_post\_subscriber\_created

- [Description](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/#h-description)
- [Usage](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/#h-examples)
- [1\. Store a property in the entry meta](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/#h-1-store-a-property-in-the-entry-meta)
- [Placement](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/#h-placement)
- [Since](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/#h-source-code)

## Description

The gform\_aweber\_post\_subscriber\_created hook can be used to perform custom actions after the subscriber has been successfully added to the AWeber list.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_aweber_post_subscriber_created'``,``'your_function_name'``, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_action(``'gform_aweber_post_subscriber_created'``,``function``(``$subscriber``,``$form``,``$entry``,``$feed``) {`<br>```gform_update_meta(``$entry``[``'id'``],``'aweber_subscriber_status'``, rgar(``$subscriber``,``'status'``) );`<br>`}, 10, 4 );` |
...
This filter is located in GFAWeber::export\_feed() in _class-gf-aweber.php_.
...
[Algolia](https://docs.gravityforms.com/gform_aweber_post_subscriber_created/# "Algolia")
