---
url: "https://docs.gravityforms.com/paypal-service-upgrade/"
title: "PayPal Service Upgrade - Gravity Forms Documentation"
---
...
- [PayPal Standard](https://docs.gravityforms.com/paypal-service-upgrade/#h-paypal-standard)
- [PayPal Payments Pro & PayPal Pro](https://docs.gravityforms.com/paypal-service-upgrade/#h-paypal-payments-pro-paypal-pro)
...
If your site has an SSL certificate you should also check if it needs upgrading to SHA-256. You can do this by using the [SHAChecker](https://shachecker.com/) tool.

See more from Paypal regarding security [here](https://developer.paypal.com/docs/classic/lifecycle/info-security-guidelines/#upgrade-to-sha-256-ssl-certificates/).
...
_Note: When using the PayPal Standard Add-On you don’t need an SSL certificate._
...
[Algolia](https://docs.gravityforms.com/paypal-service-upgrade/# "Algolia")
