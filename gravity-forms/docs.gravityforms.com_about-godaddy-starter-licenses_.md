---
url: "https://docs.gravityforms.com/about-godaddy-starter-licenses/"
title: "About GoDaddy Starter Licenses - Gravity Forms Documentation"
---
...
- [Knowledge Base](https://docs.gravityforms.com/category/knowledge-base/)  - [Accessibility](https://docs.gravityforms.com/category/knowledge-base/accessibility/)
  ...
  - [Licensing](https://docs.gravityforms.com/category/knowledge-base/licensing/)    - [About GoDaddy Starter Licenses](https://docs.gravityforms.com/about-godaddy-starter-licenses/ "About GoDaddy Starter Licenses")
    - [About Processor Decline Errors When Attempting A Purchase](https://docs.gravityforms.com/processor-decline-errors/ "About Processor Decline Errors When Attempting A Purchase")
    - [Authorized Gravity Forms Sellers](https://docs.gravityforms.com/authorized-gravity-forms-sellers/ "Authorized Gravity Forms Sellers")
    - [Common Questions about Gravity Forms Licensing](https://docs.gravityforms.com/licensing-faq/ "Common Questions about Gravity Forms Licensing")
    - [List of Gravity Forms license key validation errors](https://docs.gravityforms.com/license-key-validation-errors/ "List of Gravity Forms license key validation errors")
    - [Multisite Licensing](https://docs.gravityforms.com/multisite-licensing/ "Multisite Licensing")
    - [URLs Ignored for Gravity Forms License Site Limits](https://docs.gravityforms.com/urls-ignored-for-gravity-forms-license-site-limits/ "URLs Ignored for Gravity Forms License Site Limits")
    - [What is this Charge on my Credit Card?](https://docs.gravityforms.com/what-is-this-charge-on-my-credit-card/ "What is this Charge on my Credit Card?")
...
- [Introduction](https://docs.gravityforms.com/about-godaddy-starter-licenses/#h-introduction)
- [What does Gravity Forms provide with a GoDaddy starter license?](https://docs.gravityforms.com/about-godaddy-starter-licenses/#h-what-does-gravity-forms-provide-with-a-godaddy-starter-license)
- [Can I get any help from Gravity Forms for my GoDaddy starter license?](https://docs.gravityforms.com/about-godaddy-starter-licenses/#h-can-i-get-any-help-from-gravity-forms-for-my-godaddy-starter-license)
- [How can I see the license key for my GoDaddy Starter license?](https://docs.gravityforms.com/about-godaddy-starter-licenses/#h-how-can-i-see-the-license-key-for-my-godaddy-starter-license)
- [Do I have a Gravity Forms account to go with my GoDaddy license?](https://docs.gravityforms.com/about-godaddy-starter-licenses/#h-do-i-have-a-gravity-forms-account-to-go-with-my-godaddy-license)
- [How do I upgrade a GoDaddy starter license to a fully featured Gravity Forms license?](https://docs.gravityforms.com/about-godaddy-starter-licenses/#h-how-do-i-upgrade-a-godaddy-starter-license-to-a-fully-featured-gravity-forms-license)
- [I’ve switched my website hosting; can I transfer my GoDaddy starter license?](https://docs.gravityforms.com/about-godaddy-starter-licenses/#h-i-ve-switched-my-website-hosting-can-i-transfer-my-godaddy-starter-license)

### Introduction

Up until 2023, [GoDaddy managed WordPress accounts](https://www.godaddy.com/hosting/wordpress-hosting) would include a free one-year Gravity Forms Starter license. You can read more below if you wish to learn which features were provided with that starter license and what was not included. This offer is no longer running.

### What does Gravity Forms provide with a GoDaddy starter license?

A GoDaddy starter license provides:

– access to automatic updates and future releases of Gravity Forms (core plugin) for one year
...
– plugin updates after the year has elapsed

### Can I get any help from Gravity Forms for my GoDaddy starter license?

We will happily answer simple [Contact Us](https://www.gravityforms.com/contact-us/) questions and refer you to our [public help documentation](https://docs.gravityforms.com/) for questions regarding installation, updates, how to upgrade your license, etc.

For anything more complex, such as help with setup, conflicts, debugging forms, etc, you will need to purchase a paid Gravity Forms license, which allows you to open a Gravity Forms support ticket [here](https://www.gravityforms.com/open-support-ticket/technical/).
...
You can purchase [directly from us](https://www.gravityforms.com/pricing/). Note that you will need to [change the license key](https://docs.gravityforms.com/change-gravity-forms-license/) on your website after purchase, but none of your form data or settings will be lost.
...
[Algolia](https://docs.gravityforms.com/about-godaddy-starter-licenses/# "Algolia")
