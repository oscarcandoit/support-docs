---
url: "https://docs.gravityforms.com/send-form-notifications-mailgun/"
title: "Sending Form Notifications Using Mailgun - Gravity Forms"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Mailgun Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/mailgun-add-on/)    - [Obtaining Your Mailgun API Key](https://docs.gravityforms.com/mailgun-api-key/ "Obtaining Your Mailgun API Key")
    - [Setting Up the Mailgun Add-On](https://docs.gravityforms.com/setting-up-the-mailgun-add-on/ "Setting Up the Mailgun Add-On")
    - [Sending Form Notifications Using Mailgun](https://docs.gravityforms.com/send-form-notifications-mailgun/ "Sending Form Notifications Using Mailgun")
    - [Email Tracking with Mailgun](https://docs.gravityforms.com/email-tracking-mailgun/ "Email Tracking with Mailgun")
    - [Mailgun Changelog](https://docs.gravityforms.com/mailgun-change-log/ "Mailgun Changelog")
...
- [Pre-Requisites](https://docs.gravityforms.com/send-form-notifications-mailgun/#h-pre-requisites)
- [Configuring Notifications](https://docs.gravityforms.com/send-form-notifications-mailgun/#h-configuring-notifications)
...
[Setup the Mailgun add-on](https://docs.gravityforms.com/setting-up-the-mailgun-add-on/)
...
1. Access an existing form notification or create a new notification by going to your form settings and clicking on **Notifications**.
2. Within your notification, you should see a setting labeled **Email Service**. Within this setting, select the **Mailgun** option.
3. You can now continue setting up your notification like usual. For more information, see our article on [configuring notifications in Gravity Forms.](https://docs.gravityforms.com/configuring-notifications-in-gravity-forms/)

[![Mailgun Notification Settings](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-09-at-10.25.03.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-09-at-10.25.03.png)

Once you’re done with putting your settings in place, be sure to save them!

In addition to the standard functionality of sending notifications, the Mailgun Add-On also includes additional email tracking features. For more information on email tracking, see our article on [tracking notifications with Mailgun](https://docs.gravityforms.com/email-tracking-mailgun/).
...
[Algolia](https://docs.gravityforms.com/send-form-notifications-mailgun/# "Algolia")
