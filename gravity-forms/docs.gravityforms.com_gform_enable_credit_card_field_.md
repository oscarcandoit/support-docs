---
url: "https://docs.gravityforms.com/gform_enable_credit_card_field/"
title: "gform_enable_credit_card_field - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_enable_credit_card_field/#h-description)
- [Usage](https://docs.gravityforms.com/gform_enable_credit_card_field/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_enable_credit_card_field/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_enable_credit_card_field/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_enable_credit_card_field/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_enable_credit_card_field'``,``'__return_true'``, 11 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_enable_credit_card_field'``,``'enable_creditcard'``, 11 );`<br>`function``enable_creditcard(``$is_enabled``) {`<br>`return``true;`<br>`}` |

## Placement

This code should be placed in the [functions.php](http://codex.wordpress.org/Theme_Development#Functions_File) file of your active theme or a custom functionality plugin.
...
[Algolia](https://docs.gravityforms.com/gform_enable_credit_card_field/# "Algolia")
