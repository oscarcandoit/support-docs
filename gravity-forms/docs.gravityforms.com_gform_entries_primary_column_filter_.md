---
url: "https://docs.gravityforms.com/gform_entries_primary_column_filter/"
title: "Gform Entries Primary Column Filter: Guide"
---
...
# gform\_entries\_primary\_column\_filter

- [Description](https://docs.gravityforms.com/gform_entries_primary_column_filter/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entries_primary_column_filter/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entries_primary_column_filter/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_entries_primary_column_filter/#h-example)
- [Placement](https://docs.gravityforms.com/gform_entries_primary_column_filter/#h-placement)
- [Since](https://docs.gravityforms.com/gform_entries_primary_column_filter/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_entries_primary_column_filter/#h-source-code)
...
- **$column\_value** [string](https://docs.gravityforms.com/string/)
...
- **$field\_id** [integer](https://docs.gravityforms.com/integer/) \| [string](https://docs.gravityforms.com/string/)

The ID of the field or the name of an entry column (i.e. date\_created).
...
- **$edit\_url** [string](https://docs.gravityforms.com/string/)
...
|     |
| --- |
| `add_filter(``'gform_entries_primary_column_filter'``,``function``(``$column_value``,``$form_id``,``$field_id``,``$entry``,``$query_string``,``$edit_url``,``$field_value``) {`<br>```if``(``$form_id``== 56 ) {`<br>```$column_value``=``'<a href="'``.``$edit_url``.``'">Click to view entry</a>'``;`<br>```}`<br>```return``$column_value``;`<br>`}, 10, 7 );` |
...
This filter is located in GF\_Entry\_List\_Table::column\_default() in _entry\_list.php_.
...
[Algolia](https://docs.gravityforms.com/gform_entries_primary_column_filter/# "Algolia")
