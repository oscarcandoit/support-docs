---
url: "https://docs.gravityforms.com/gform_honeypot_input_name/"
title: "gform_honeypot_input_name - Gravity Forms Documentation"
---
...
# gform\_honeypot\_input\_name

- [Usage](https://docs.gravityforms.com/gform_honeypot_input_name/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_honeypot_input_name/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_honeypot_input_name/#h-examples)
- [Hash and cache name.](https://docs.gravityforms.com/gform_honeypot_input_name/#h-hash-and-cache-name)
- [Placement](https://docs.gravityforms.com/gform_honeypot_input_name/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_honeypot_input_name/#h-source-nbsp-code)
- [Since](https://docs.gravityforms.com/gform_honeypot_input_name/#h-since)
...
| --- | --- | --- |
| **$name** | [string](https://docs.gravityforms.com/string/) | The honeypot input name. |
| **$form** | [Form](https://docs.gravityforms.com/form-object/) | The form being rendered or validated. |

## Examples

### Hash and cache name.

This example takes the default name (e.g. input\_1), appends the form ID and Gravity Forms version number to it, and then uses the WordPress wp\_hash function to hash it using your site salts, creating an input name that is unique to both your form and site. It also caches the name for two days.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14 | `add_filter(``'gform_honeypot_input_name'``,``function``(``$name``,``$form``) {`<br>```$form_id``= absint( rgar(``$form``,``'id'``) );`<br>```$cache_key``=``'gform_honeypot_input_name_'``.``$form_id``;`<br>```$cached_name``= GFCache::get(``$cache_key``);`<br>```if``( !``empty``(``$cached_name``) ) {`<br>```return``$cached_name``;`<br>```}`<br>```$name``= wp_hash(``$name``.``'_'``.``$form_id``.``'_'``. GFForms::``$version``);`<br>```GFCache::set(``$cache_key``,``$name``, true, DAY_IN_SECONDS * 2 );`<br>```return``$name``;`<br>`}, 10, 2 );` |
...
This filter is located in `\Gravity_Forms\Gravity_Forms\Honeypot\GF_Honeypot_Handler::get_input_name()` in _includes/honeypot/class-gf-honeypot-handler.php_

## Since

The gform\_honeypot\_input\_name filter was added in Gravity Forms version 2.9.16.
...
[Algolia](https://docs.gravityforms.com/gform_honeypot_input_name/# "Algolia")
