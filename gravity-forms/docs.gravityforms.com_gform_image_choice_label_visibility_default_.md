---
url: "https://docs.gravityforms.com/gform_image_choice_label_visibility_default/"
title: "gform_image_choice_label_visibility_default - Gravity Forms Documentation"
---
...
# gform\_image\_choice\_label\_visibility\_default

- [Description](https://docs.gravityforms.com/gform_image_choice_label_visibility_default/#h-description)
- [Usage](https://docs.gravityforms.com/gform_image_choice_label_visibility_default/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_image_choice_label_visibility_default/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_image_choice_label_visibility_default/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_image_choice_label_visibility_default/#h-placement)
- [Since](https://docs.gravityforms.com/gform_image_choice_label_visibility_default/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_image_choice_label_visibility_default/#h-source-code)

## Description

Allows the default [Image Choice](https://docs.gravityforms.com/image-choice-field/) label visibility setting to be managed.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_image_choice_label_visibility_default'``,``'your_function_name'``, 10, 1 );` |

Applies to a specific form:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_image_choice_label_visibility_default_FORMID'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$label\_visibility\_default** [string](https://docs.gravityforms.com/string)

Default is show.

## Examples

Updates the choice label visibility, setting the default to hide the labels. It will also hide the inputs for any form where a new [Image Choice](https://docs.gravityforms.com/image-choice-field/) field is added.

|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_image_choice_label_visibility_default'``,``function``(``$label_visibility_default``) {`<br>```return``'hide'``;`<br>`}, 10, 1 );` |
...
[Algolia](https://docs.gravityforms.com/gform_image_choice_label_visibility_default/# "Algolia")
