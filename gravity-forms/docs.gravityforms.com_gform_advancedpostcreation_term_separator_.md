---
url: "https://docs.gravityforms.com/gform_advancedpostcreation_term_separator/"
title: "gform_advancedpostcreation_term_separator - Gravity Forms"
---
...
- [Description](https://docs.gravityforms.com/gform_advancedpostcreation_term_separator/#h-description)
- [Usage](https://docs.gravityforms.com/gform_advancedpostcreation_term_separator/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_advancedpostcreation_term_separator/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_advancedpostcreation_term_separator/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_advancedpostcreation_term_separator/#h-placement)
- [Since](https://docs.gravityforms.com/gform_advancedpostcreation_term_separator/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_advancedpostcreation_term_separator/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_advancedpostcreation_term_separator'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$separator** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_advancedpostcreation_term_separator'``,``'set_separator'``, 10, 1 );`<br>`function``set_separator(``$separator``){`<br>```return``'|'``;`<br>`}` |
...
This filter is located in GF\_Advanced\_Post\_Creation::get\_mapped\_taxonomies() in _gravityformsadvancedpostcreation/class-gf-advancedpostcreation.php_.
...
[Algolia](https://docs.gravityforms.com/gform_advancedpostcreation_term_separator/# "Algolia")
