---
url: "https://docs.gravityforms.com/gform_post_form_duplicated/"
title: "gform_post_form_duplicated - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_post_form_duplicated/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_form_duplicated/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_form_duplicated/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_form_duplicated/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_post_form_duplicated/#h-source-code)

**Note:** This hook replaces the deprecated “gform\_after\_duplicate\_form” hook.

## Description

The “gform\_post\_form\_duplicated” action in Gravity Forms is triggered after a form is duplicated, allowing further actions to be performed. The hook provides the ID of the form duplicated and the ID of the new form created.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_post_form_duplicated'``,``'my_function'``, 10, 2 );` |
...
- **$new\_id** [int](https://docs.gravityforms.com/int)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `function``my_function() {`<br>```//Do something here`<br>`}`<br>`add_action(``'gform_post_form_duplicated'``,``'my_function'``, 10, 2 );` |

## Source Code

This action hook is located in GFFormsModel::duplicate\_form() in _forms\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_post_form_duplicated/# "Algolia")
