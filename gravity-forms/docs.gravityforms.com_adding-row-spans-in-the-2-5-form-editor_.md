---
url: "https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/"
title: "Use Row Spans in Gravity Forms 2.5 Editor"
---
...
- [Introduction](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/#h-introduction)
- [Quickstart Guide](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/#h-quickstart-guide)
- [Setup the Fields](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/#h-setup-the-fields)
- [Add a CSS Class to the Spanning Field](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/#h-add-a-css-class-to-the-spanning-field)
- [Add a CSS Span Property to your Theme](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/#h-add-a-css-span-property-to-your-theme)
- [Want to learn more about CSS Grid?](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/#h-want-to-learn-more-about-css-grid)
...
![Form demonstrating three fields in three rows (name, phone and email) and a message field spanning all three rows in the column beside it.](https://docs.gravityforms.com/wp-content/uploads/2020/07/form-with-spanned-rows.png)

This technique is for Gravity Forms 2.5 and later only.

## Quickstart Guide

1. Add a [Name field](https://docs.gravityforms.com/name-fields/) and [Textarea field](https://docs.gravityforms.com/textarea-field/) side by side in the form.
2. Add an [Email field](https://docs.gravityforms.com/email-field/) and [Phone field](https://docs.gravityforms.com/phone/) side by side in the form.
3. Add a Custom CSS class to the Textarea field under Field Settings > Appearance > Custom CSS ie `gform-field-row--span-three`
4. Save the Form and [Add the form to your website](https://docs.gravityforms.com/category/user-guides/getting-started/add-form-to-site/).
5. Add the following CSS to your website:
...
![Add a Name Field and a TextArea field side by side in two columns](https://docs.gravityforms.com/wp-content/uploads/2020/08/span-rows-add-name-textarea.gif)

In our example, that means adding a [Name field](https://docs.gravityforms.com/name-fields/) and a [Textarea field](https://docs.gravityforms.com/textarea-field/) side-by-side in the editor
...
![Add an Email and Phone Field in two columns in the next row.](https://docs.gravityforms.com/wp-content/uploads/2020/08/span-rows-add-email-phone.gif)

In our example, this is adding an [Email field](https://docs.gravityforms.com/email-field/) and a [Phone field](https://docs.gravityforms.com/phone/) side-by-side in the row below the first two fields.
...
Taking advantage of the [Custom CSS Class settings](https://docs.gravityforms.com/common-field-settings/#custom-css-class), go into the Textarea field in the form and select it to then click the tab for **Appearance**. This will reveal the **Custom CSS Class** setting [1](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/#fn-24379-1). In this field, add a CSS Class name that you will remember. For example, `span-three-rows` or `row-span-three` or `gform-field-row--span-three`. It is up to you, just remember what you chose for later.

![Add Custom CSS Class to the Text Area field to Span Multiple Rows](https://docs.gravityforms.com/wp-content/uploads/2020/08/span-rows-add-custom-css.gif)
...
Now that we have named the element, we need to tell the Theme file how to treat it, in this case specifically using the span property. The easiest way will be to add this to the Customizer in Theme Options. There are [other ways to add CSS to your theme](https://docs.gravityforms.com/where-to-put-your-custom-css/). The following line is what you will add to your Theme’s CSS:

|     |     |
| --- | --- |
| 1<br>2<br>3 | `.gform-field-row--span-three {`<br>`grid-row``: span``3``;`<br>`}` |

Here’s how this works: the `.gform-field-row--span-three` identifies the class and makes the action specific to any objects with that class. The [grid-row](https://developer.mozilla.org/en-US/docs/Web/CSS/grid-row) is a CSS Grid property, and the `span 3` is telling the CSS to span 3 grid rows for any object with the class `gform-field-row--span-three`. Simple!

![Use the Theme Customizer to add CSS to the Additional CSS settings.](https://docs.gravityforms.com/wp-content/uploads/2020/08/span-rows-customize-theme-css.gif)
...
- [Official Documentation for CSS Grid](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Grid_Layout)
- [Comprehensive Guide to Grid by CSS Tricks](https://css-tricks.com/snippets/css/complete-guide-grid/)

* * *

1. An alternative to using Custom CSS Class Settings is to inspect your form after configuring and putting it into a page, and then seeing what the field id is for the Textarea field so you can specifically target just that field with your CSS. [↩](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/#fnref-24379-1)
...
[Algolia](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/# "Algolia")
