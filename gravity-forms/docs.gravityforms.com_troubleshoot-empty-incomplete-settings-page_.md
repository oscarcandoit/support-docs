---
url: "https://docs.gravityforms.com/troubleshoot-empty-incomplete-settings-page/"
title: "Troubleshooting an Empty or Incomplete Settings Page - Gravity Forms"
---
...
- [Check Enabled PHP Extensions](https://docs.gravityforms.com/troubleshoot-empty-incomplete-settings-page/#h-check-enabled-php-extensions)
- [Checking Your PHP Environment](https://docs.gravityforms.com/troubleshoot-empty-incomplete-settings-page/#h-checking-your-php-environment)
- [Fixing Your PHP Environment](https://docs.gravityforms.com/troubleshoot-empty-incomplete-settings-page/#h-fixing-your-php-environment)
- [Contacting Support](https://docs.gravityforms.com/troubleshoot-empty-incomplete-settings-page/#h-contacting-support)
...
The extensions that are typically required for many Gravity Forms add-ons are [mbstring](http://php.net/manual/en/book.mbstring.php) and [curl](http://php.net/manual/en/book.curl.php).

### Checking Your PHP Environment

Details about the PHP extensions available to your site can be found in the Server Environment section of the **Forms > System Status** page. For more details, see [Checking Your Environment Details](https://docs.gravityforms.com/checking-environment-details/).

See also [Gravity Forms System Requirements](https://docs.gravityforms.com/gravity-forms-system-requirements/).
...
Upon contacting support, be sure to provide any related output that you have from [logging](https://docs.gravityforms.com/logging-and-debugging/). Often times, this is the first thing you will be asked to do when troubleshooting this issue over a ticket, so sending it ahead of time saves time.
...
[Algolia](https://docs.gravityforms.com/troubleshoot-empty-incomplete-settings-page/# "Algolia")
