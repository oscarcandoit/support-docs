---
url: "https://docs.gravityforms.com/gform_entry_detail_content_before/"
title: "gform_entry_detail_content_before - Gravity Forms Documentation"
---
...
# gform\_entry\_detail\_content\_before

- [Description](https://docs.gravityforms.com/gform_entry_detail_content_before/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_detail_content_before/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_entry_detail_content_before/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_entry_detail_content_before/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_entry_detail_content_before/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_entry_detail_content_before'``,``'add_main_text_before'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_entry_detail_content_before'``,``'add_main_text_before'``, 10, 2 );`<br>`function``add_main_text_before(``$form``,``$entry``) {`<br>`echo``'<table class="widefat fixed entry-detail-view" cellspacing="0"><thead><tr><th>Main Content Before</th></tr></thead><tbody><tr><td>some stuff</td></tr></tbody></table>'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_detail_content_before/# "Algolia")
