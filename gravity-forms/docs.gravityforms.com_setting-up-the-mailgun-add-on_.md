---
url: "https://docs.gravityforms.com/setting-up-the-mailgun-add-on/"
title: "Setting Up the Mailgun Add-On - Gravity Forms Documentation"
---
...
- [Pre-Requisites](https://docs.gravityforms.com/setting-up-the-mailgun-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-up-the-mailgun-add-on/#h-setup)

## Pre-Requisites

- Add your domain to your Mailgun account and [validate it](https://help.mailgun.com/hc/en-us/articles/360026833053-Domain-Verification-Walkthrough).
...
3. From this page, click the **Mailgun** tab.
4. Select your **Region** and enter your **Private API Key**. This is obtained from Mailgun. If you are unsure of how to obtain your API key, take a look at our article on [obtaining your Mailgun API key](https://docs.gravityforms.com/mailgun-api-key/).
...
Once you have entered your API key, you’re ready to begin [sending form notifications using Mailgun](https://docs.gravityforms.com/send-form-notifications-mailgun/).
...
[Algolia](https://docs.gravityforms.com/setting-up-the-mailgun-add-on/# "Algolia")
