---
url: "https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/"
title: "gform_stripe_subscription_cancel_at_period_end - Gravity Forms"
---
...
# gform\_stripe\_subscription\_cancel\_at\_period\_end

- [Description](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/#h-examples)
- [1\. Apply to all subscriptions](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/#h-1-apply-to-all-subscriptions)
- [2\. Apply to a specific feed](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/#h-2-apply-to-a-specific-feed)
- [Placement](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/#h-source-code)

## Description

The gform\_stripe\_subscription\_cancel\_at\_period\_end filter can be used to delay the cancellation of the subscription until the end of the current period.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_subscription_cancel_at_period_end'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$at\_period\_end** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_subscription_cancel_at_period_end'``,``'__return_true'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_stripe_subscription_cancel_at_period_end'``,``'stripe_subscription_cancel_at_period_end'``, 10, 3 );`<br>`function``stripe_subscription_cancel_at_period_end(``$at_period_end``,``$entry``,``$feed``) {`<br>```$feed_name``= rgars(``$feed``,``'meta/feedName'``);`<br>```if``(``$feed_name``==``'your feed name here'``) {`<br>```return``true;`<br>```}`<br>```return``$at_period_end``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `$params``[``'at_period_end'``] = apply_filters(``'gform_stripe_subscription_cancel_at_period_end'``, false,``$entry``,``$feed``);` |

This hook is located in GFStripe::cancel() in _class-gf-stripe.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_subscription_cancel_at_period_end/# "Algolia")
