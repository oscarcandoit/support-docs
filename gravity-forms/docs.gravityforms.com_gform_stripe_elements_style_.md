---
url: "https://docs.gravityforms.com/gform_stripe_elements_style/"
title: "gform_stripe_elements_style - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_stripe_elements_style/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_elements_style/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_elements_style/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_elements_style/#h-examples)
- [Set a custom style for Stripe Field.](https://docs.gravityforms.com/gform_stripe_elements_style/#h-set-a-custom-style-for-stripe-field)
- [Placement](https://docs.gravityforms.com/gform_stripe_elements_style/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_elements_style/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_elements_style/#h-source-code)

## Description

This filter allows styles to be used with Stripe Elements to control the look of the Credit Card field.

For more information about which styles may be applied, check out the [Stripe Style object reference](https://docs.stripe.com/js/appendix/style) _(when using the Stripe Card field **without** the setting for “Use Stripe’s Payment Element” enabled)_ or [Stripe’s Elements Appearance API](https://stripe.com/docs/elements/appearance-api) _(when using Stripe Card field **with** the setting for “Use Stripe’s Payment Element” enabled)_. To simplify, [Style Reference for Stripe’s Card Element](https://docs.stripe.com/js/appendix/style) and [Style Reference for Stripe’s Payment Element](https://stripe.com/docs/elements/appearance-api).

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_elements_style'``,``'your_function_name'``, 10, 3);` |

## Parameters

| **Key** | **Type** | **Description** |
| --- | --- | --- |
| **$styles** | array | Array of the current styles applied. |
| **$form\_id** | int | The current form ID. |
| **$is\_payment\_element\_enabled** | bool | Whether or not the payment element is enabled. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22<br>23<br>24<br>25<br>26<br>27<br>28<br>29<br>30<br>31<br>32<br>33<br>34<br>35 | `add_filter(``'gform_stripe_elements_style'``,``function``(``$card_styles``,``$form_id``,``$is_payment_element_enabled``) {`<br>```if``(``$is_payment_element_enabled``) {`<br>```// reference https://docs.stripe.com/elements/appearance-api`<br>```$card_styles``[``'variables'``] =``array``(`<br>```'colorPrimary'``=>``'#e0643b'``,`<br>```'colorTextSecondary'``=>``'#465459'``,`<br>```'colorText'``=>``'#272829'``,`<br>```'fontSizeBase'``=>``'14px'``,`<br>```'tabSpacing'``=>``'1rem'`<br>```);`<br>``<br>```$card_styles``[``'rules'``] =``array``(`<br>```'.Tab:hover'``=>``array``(`<br>```'boxShadow'``=>``'var(--focusBoxShadow)'`<br>```)`<br>```);`<br>```}``else``{`<br>```// reference https://docs.stripe.com/js/appendix/style`<br>```$card_styles``[``'base'``] =``array``(`<br>```'color'``=>``'#465459'``,`<br>```'fontSize'``=>``'16px'``,`<br>```':focus'``=>``array``(`<br>```'color'``=>``'#272829'`<br>```)`<br>```);`<br>```}`<br>``<br>```return``$card_styles``;`<br>``<br>`}, 10, 3 );` |
...
[Algolia](https://docs.gravityforms.com/gform_stripe_elements_style/# "Algolia")
