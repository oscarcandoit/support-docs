---
url: "https://docs.gravityforms.com/gform_dropbox_file_name/"
title: "gform_dropbox_file_name - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_dropbox_file_name/#h-description)
- [Usage](https://docs.gravityforms.com/gform_dropbox_file_name/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_dropbox_file_name/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_dropbox_file_name/#h-examples)
- [1\. Use an entry value in the filename.](https://docs.gravityforms.com/gform_dropbox_file_name/#h-1-use-an-entry-value-in-the-filename)
- [Placement](https://docs.gravityforms.com/gform_dropbox_file_name/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_dropbox_file_name/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_dropbox_file_name'``,``'your_function_name'``, 10, 5 );` |

To target a specific form append the form id to the hook name. (format: gform\_dropbox\_file\_name\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_dropbox_file_name_10'``,``'your_function_name'``, 10, 5 );` |

## Parameters

- **$file\_name** [string](https://docs.gravityforms.com/string)
...
This example shows how you can use a value from the [Entry Object](https://docs.gravityforms.com/entry-object) when modifying the filename.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_dropbox_file_name_10'``,``'change_name'``, 10, 5 );`<br>`function``change_name(``$file_name``,``$form``,``$field_id``,``$entry``,``$feed``) {`<br>`return``rgar(``$entry``,``'id'``) .``'-'``.``$file_name``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_dropbox_file_name'``,``$form``[``'id'``],``$file``[``'name'``],``$form``,``$field_id``,``$entry``,``$feed``)` |
...
[Algolia](https://docs.gravityforms.com/gform_dropbox_file_name/# "Algolia")
