---
url: "https://docs.gravityforms.com/gform_ppcp_entry_not_found_status_code/"
title: "gform_ppcp_entry_not_found_status_code - Gravity Forms Documentation"
---
...
# gform\_ppcp\_entry\_not\_found\_status\_code

- [Description](https://docs.gravityforms.com/gform_ppcp_entry_not_found_status_code/#h-description)
- [Usage](https://docs.gravityforms.com/gform_ppcp_entry_not_found_status_code/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_ppcp_entry_not_found_status_code/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_ppcp_entry_not_found_status_code/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_ppcp_entry_not_found_status_code/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_ppcp_entry_not_found_status_code/#h-source-code)

## Description

The “gform\_ppcp\_entry\_not\_found\_status\_code” filter in the Gravity Forms PayPal Checkout Add-On allows the status code for the entry not found WP\_Error to be overridden.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_ppcp_entry_not_found_status_code'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$status\_code** [int](https://docs.gravityforms.com/int)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `array``(`<br>```'type'``=>``''``,`<br>```'amount'``=>``''``,`<br>```'transaction_type'``=>``''``,`<br>```'transaction_id'``=>``''``,`<br>```'subscription_id'``=>``''``,`<br>```'entry_id'``=>``''``,`<br>```'payment_status'``=>``''``,`<br>```'note'``=>``''``,`<br>`);` |

- **$event** [array](https://docs.gravityforms.com/array)

The PayPal event object for the webhook which was received. See the [PayPal API Reference](https://developer.paypal.com/docs/integration/direct/webhooks/event-names/) for details about the event properties.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_ppcp_entry_not_found_status_code'``,``'change_status_code'``, 10, 3 );`<br>`function``change_status_code(``$status_code``,``$action``,``$event``) {`<br>```return``'205'``;`<br>`}` |
...
This filter is located in GF\_PPCP::get\_entry\_not\_found\_wp\_error() in _gravityformsstripe/class-gf-ppcp.php_.
...
[Algolia](https://docs.gravityforms.com/gform_ppcp_entry_not_found_status_code/# "Algolia")
