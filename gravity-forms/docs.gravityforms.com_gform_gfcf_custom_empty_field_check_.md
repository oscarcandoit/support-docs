---
url: "https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/"
title: "gform_gfcf_custom_empty_field_check - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Conversational Forms Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/conversational-forms-filters/)          - [gform\_gfcf\_theme\_config](https://docs.gravityforms.com/gform_gfcf_theme_config/ "gform_gfcf_theme_config")
          - [gform\_gfcf\_custom\_empty\_field\_check](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/ "gform_gfcf_custom_empty_field_check")
...
# gform\_gfcf\_custom\_empty\_field\_check

- [Description](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/#h-description)
- [Usage](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/#h-examples)
- [Render the filter for the Pipe Add-On.](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/#h-render-the-filter-for-the-pipe-add-on)
- [Placement](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/#h-since)
...
|     |
| --- |
| `gform.addFilter(``'gform_gfcf_custom_empty_field_check'``,``function``() {`<br>```// Your logic here`<br>`});` |
...
### Render the filter for the [Pipe Add-On](https://docs.gravityforms.com/setting-pipe-add/).
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22<br>23<br>24<br>25 | `document.addEventListener(``'DOMContentLoaded'``,``function``() {`<br>```// Custom function to add to the gform_gfcf_custom_empty_field_check filter.`<br>```function``customBypassValidations(bypassFunctions) {`<br>```// The pipe field is a hidden input element and, by default, hidden elements`<br>```// aren't counted as filled fields when checking if the form is empty.`<br>```// Adding a filter for the pipe field will force Conversational Forms`<br>```// to check if the field is empty or not.`<br>```bypassFunctions.push([`<br>```// Check if the input is of type pipe_recorder`<br>```function``(input) {`<br>```return``input.closest('.gfield--input-type-pipe_recorder``');`<br>```},`<br>```// Set to false so internally it is not bypassed as a hidden input`<br>```function() {`<br>```return false;`<br>```}`<br>```]);`<br>```return bypassFunctions;`<br>```}`<br>```// Add filter to the gform object`<br>```if (typeof gform !== '``undefined``' && typeof gform.addFilter === '``function``') {`<br>```gform.addFilter('``gform_gfcf_custom_empty_field_check', customBypassValidations);`<br>```}`<br>`});` |
...
[Algolia](https://docs.gravityforms.com/gform_gfcf_custom_empty_field_check/# "Algolia")
