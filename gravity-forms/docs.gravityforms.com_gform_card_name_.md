---
url: "https://docs.gravityforms.com/gform_card_name/"
title: "gform_card_name - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_card_name/#h-description)
- [Usage](https://docs.gravityforms.com/gform_card_name/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_card_name/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_card_name/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_card_name/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_card_name/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_card_name'``,``'change_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_card_name'``,``'change_name'``, 10, 2 );`<br>`function``change_name(``$label``,``$form_id``) {`<br>```return``"Name on card"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_card_name/# "Algolia")
