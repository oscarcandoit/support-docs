---
url: "https://docs.gravityforms.com/gform_notification_note/"
title: "gform_notification_note - Gravity Forms Documentation"
---
...
# gform\_notification\_note

- [Description](https://docs.gravityforms.com/gform_notification_note/#h-description)
- [Parameters](https://docs.gravityforms.com/gform_notification_note/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_notification_note/#h-examples)
- [Customize the result note with custom text](https://docs.gravityforms.com/gform_notification_note/#h-customize-the-result-note-with-custom-text)
- [Disable all notes](https://docs.gravityforms.com/gform_notification_note/#h-disable-all-notes)
- [Disable notes for specific notification](https://docs.gravityforms.com/gform_notification_note/#h-disable-notes-for-specific-notification)
- [Placement](https://docs.gravityforms.com/gform_notification_note/#h-placement)
- [Since](https://docs.gravityforms.com/gform_notification_note/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_notification_note/#h-source-code)
...
- **$note\_args** [array](https://docs.gravityforms.com/array)
...
- **$result** [bool](https://docs.gravityforms.com/bool)

The result returned by `wp_mail()`.

- **$notification** [array](https://docs.gravityforms.com/array)

The notification properties. See [Notifications Object](https://docs.gravityforms.com/notifications-object) for possible properties.

- **$error\_info** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_notification_note'``,``'custom_sending_result_note'``, 10, 6 );`<br>`function``custom_sending_result_note(``$note_args``,``$entry_id``,``$result``,``$notification``,``$error_info``,``$email``) {`<br>`if``(``$result``=== true ){`<br>`$result_note``[``'text'``] = &quot;Amazing! WordPress sent the email to: &quot; .``$email``[``'to'``];`<br>`}`<br>`return``$result_note``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_notification_note'``,``'__return_empty_array'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_notification_note'``,``'gf_disable_notification_notes'``, 10, 6 );`<br>`function``gf_disable_notification_notes(``$note_args``,``$entry_id``,``$result``,``$notification``,``$error_info``,``$email``) {`<br>`if``( rgar(``$notification``,``'name'``) ===``'The notification name here'``) {`<br>`$note_args``=``array``();`<br>`}`<br>`return``$note_args``;`<br>`}` |
...
This filter is located in GFFormsModel::add\_notification\_note in _forms\_model.php_:
...
[Algolia](https://docs.gravityforms.com/gform_notification_note/# "Algolia")
