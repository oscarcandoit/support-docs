---
url: "https://docs.gravityforms.com/gfstripe/"
title: "GFStripe - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gfstripe/#h-description)
- [gf\_stripe()](https://docs.gravityforms.com/gfstripe/#h-gf-stripe)
- [get\_payment\_feed()](https://docs.gravityforms.com/gfstripe/#h-get-payment-feed)
- [cancel()](https://docs.gravityforms.com/gfstripe/#h-cancel)
- [get\_amount\_export()](https://docs.gravityforms.com/gfstripe/#h-get-amount-export)
- [get\_amount\_import()](https://docs.gravityforms.com/gfstripe/#h-get-amount-import)
- [insert\_feed()](https://docs.gravityforms.com/gfstripe/#h-insert-feed)
- [add\_note()](https://docs.gravityforms.com/gfstripe/#h-add-note)
- [log\_debug()](https://docs.gravityforms.com/gfstripe/#h-log-debug)
- [log\_error()](https://docs.gravityforms.com/gfstripe/#h-log-error)
- [include\_stripe\_api()](https://docs.gravityforms.com/gfstripe/#h-include-stripe-api)

## Description

GFStripe is the class which houses the main functionality of the Gravity Forms Stripe Add-on; it extends the [GFPaymentAddOn](https://docs.gravityforms.com/gfpaymentaddon) class which is part of the add-on framework. Below are a few functions which you may find useful when working on your own custom code.

## gf\_stripe()

The gf\_stripe() function is used to return an instance of the GFStripe class.
...
- **$entry** [Entry Object](https://docs.gravityforms.com/entry-object) \| [boolean](https://docs.gravityforms.com/boolean)
The Entry Object to be checked.

- **$form** [Form Object](https://docs.gravityforms.com/form-object) \| [boolean](https://docs.gravityforms.com/boolean)

The Form Object to be used when evaluating feed conditional logic. Defaults to false.

- **Returns** [Feed Object](https://docs.gravityforms.com/feed-object) \| [boolean](https://docs.gravityforms.com/boolean)
...
- **Returns** [boolean](https://docs.gravityforms.com/boolean)
...
- **$currency\_code** [string](https://docs.gravityforms.com/string)

The currency code.

- **Returns** [integer](https://docs.gravityforms.com/integer) \| [float](https://docs.gravityforms.com/float)
...
The insert\_feed() method can be used to add Stripe feeds.
...
- **$is\_active** [boolean](https://docs.gravityforms.com/boolean)

Is this feed active or inactive.

- **$meta** [Stripe Feed Meta](https://docs.gravityforms.com/stripe-feed-meta)
...
- **Returns** [integer](https://docs.gravityforms.com/integer)
...
The type of note to be added. _Example values: note, success, or error._


## log\_debug()

Writes a debug message to the log file for the Stripe Add-On. Requires [logging to be enabled](https://docs.gravityforms.com/logging-and-debugging/).
...
Writes an error message to the log file for the Stripe Add-On. Requires [logging to be enabled](https://docs.gravityforms.com/logging-and-debugging/).
...
[Algolia](https://docs.gravityforms.com/gfstripe/# "Algolia")
