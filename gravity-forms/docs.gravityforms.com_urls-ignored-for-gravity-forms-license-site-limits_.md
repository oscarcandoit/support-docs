---
url: "https://docs.gravityforms.com/urls-ignored-for-gravity-forms-license-site-limits/"
title: "Ignored URLs for Gravity Forms License Limits"
---
...
- [Introduction](https://docs.gravityforms.com/urls-ignored-for-gravity-forms-license-site-limits/#h-introduction)
- [Regex List](https://docs.gravityforms.com/urls-ignored-for-gravity-forms-license-site-limits/#h-regex-list)

## Introduction

Each type of Gravity Forms license has a limit to the number of websites that it can be installed on. You can see the list of those [limits by license type](https://docs.gravityforms.com/gravity-forms-license-types/) in the linked help guide.

Sites in use as “staging”, “development”, “sandbox” etc, generally those being used for development and test and that are not being used for real customer traffic, are _not counted against the site limit of your license_.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22<br>23<br>24<br>25<br>26<br>27<br>28<br>29<br>30<br>31<br>32<br>33<br>34<br>35<br>36<br>37<br>38<br>39<br>40<br>41<br>42<br>43<br>44<br>45<br>46<br>47<br>48<br>49<br>50<br>51<br>52<br>53<br>54<br>55<br>56 | `127.0.0.1`<br>`*.app.github.dev`<br>`*.cloudwaysapps.com`<br>`*.ddev.site`<br>`*.dev.*`<br>`*.dreamhosters.com`<br>`*.elementor.cloud`<br>`*.flywheelsites.com`<br>`*.flywheelstaging.com`<br>`*.kinsta.cloud`<br>`*.kinsta.com`<br>`*.lightningbasehosted.com`<br>`*.lndo.site`<br>`*.loc`<br>`*.local`<br>`*.localhost`<br>`*.localhost.*`<br>`*.mybluehost.com`<br>`*.myftpupload.com`<br>`*.myraidboxes.de (for raidboxes.io)`<br>`*.mysites.io`<br>`*.mystagingwebsite.com`<br>`*.nxcli.io`<br>`*.pantheonlocal.com`<br>`*.pantheonsite.io`<br>`*.savviihq.com`<br>`*.sg-host.com`<br>`*.stage.site`<br>`*.staging`<br>`*.staging.*`<br>`*.test`<br>`*.test.*`<br>`*.tribe`<br>`*.wpengine.com`<br>`*.wpenginepowered.com`<br>`*.wpsc.site (for WP Stagecoach )`<br>`*.wpstagecoach.com`<br>`.wpstage.net`<br>`beta.*`<br>`corpwebstg.*`<br>`dev.*`<br>`devsite.*`<br>`local.*`<br>`localhost*`<br>`pantheon-dev.*`<br>`pantheon-live.*`<br>`sandbox.*`<br>`stage.*`<br>`staging[number].*    i.e. staging10.mysite.com`<br>`test.*`<br>`upgrade.*`<br>`webdev.*`<br>`wpdev.*`<br>`www.staging[number].*  (for SiteGround)` |
...
[Algolia](https://docs.gravityforms.com/urls-ignored-for-gravity-forms-license-site-limits/# "Algolia")
