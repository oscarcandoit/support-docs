---
url: "https://docs.gravityforms.com/gf_field_quantity/"
title: "GF_Field_Quantity - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_quantity/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_quantity/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_quantity/#h-settings)
- [Source Code](https://docs.gravityforms.com/gf_field_quantity/#h-source-code)

## Introduction

The GF\_Field\_Quantity class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for handling the Quantity field. Because Quantity fields are either a Number, Drop Down or Hidden field, this class only adds some settings and sets the title for the field in the editor. The rendering of the Quantity field is handled by the class associated with its sub-type. The field “type” property will be set to “quantity” and the field “inputType” property will be “number”, “select”, or “hidden”.

For more details about rendering the Quantity field, check out the articles below for the specific type of Quantity field:

Number – [GF\_Field\_Number](https://docs.gravityforms.com/gf_field_number) class
...
The source code is located in _includes/fields/class-gf-field-quantity.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_quantity/# "Algolia")
