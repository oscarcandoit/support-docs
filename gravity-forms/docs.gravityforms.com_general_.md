---
url: "https://docs.gravityforms.com/general/"
title: "Common Questions About Gravity Forms"
---
...
- [What is Gravity Forms?](https://docs.gravityforms.com/general/#h-what-is-gravity-forms)
- [What are the requirements to run Gravity Forms?](https://docs.gravityforms.com/general/#h-what-are-the-requirements-to-run-gravity-forms)
- [Where can I get custom development?](https://docs.gravityforms.com/general/#h-where-can-i-get-custom-development)
- [Do you have a trial version?](https://docs.gravityforms.com/general/#h-do-you-have-a-trial-version)
- [How can I submit a feature request? When will you have feature X?](https://docs.gravityforms.com/general/#h-how-can-i-submit-a-feature-request-when-will-you-have-feature-x)
- [Where do I put custom CSS and PHP?](https://docs.gravityforms.com/general/#h-where-do-i-put-custom-css-and-php)
- [Does Gravity Forms work properly on Microsoft Internet Explorer?](https://docs.gravityforms.com/general/#h-does-gravity-forms-work-properly-on-microsoft-internet-explorer)
- [Will Gravity Forms work with my Theme?](https://docs.gravityforms.com/general/#h-will-gravity-forms-work-with-my-theme)

## What is Gravity Forms?

Gravity Forms is a plugin for WordPress. It allows you to quickly create data collection forms, polls and surveys for your WordPress website. [This article](https://docs.gravityforms.com/what-is-this-charge-on-my-credit-card/) explains more, or refer to our [home page](https://www.gravityforms.com/).

## What are the requirements to run Gravity Forms?

Refer to [this article](https://docs.gravityforms.com/gravity-form-system-requirements/).

Please note: If your site is hosted by the WordPress.com service you will need to be on their Creator plan, with a custom domain configured and the [Hello Dolly plugin](https://wordpress.org/plugins/hello-dolly/) installed, before they will allow you to install Gravity Forms.

## Where can I get custom development?

Check out [this article](https://docs.gravityforms.com/custom-development/).

## Do you have a trial version?

We do not have any trial version, but we do offer the following resources to help interested prospective purchasers:

– full [user documentation](https://docs.gravityforms.com/)

– a fully-functioning [online demo](https://www.gravityforms.com/gravity-forms-demo/)

– reviewable [Terms of Service](https://www.gravityforms.com/terms-and-conditions/)

– a talented team of Support Engineers via our [contact us form](https://www.gravityforms.com/contact-us/).

## How can I submit a feature request? When will you have feature X?

We have a selection of proposed features that are either open for comment or voting to all active Gravity Forms license holders. Go to Gravity Forms Support page, and then choose “View Our Roadmap” to navigate to the [Feature Roadmap page](https://www.gravityforms.com/gravity-forms-roadmap/).
...
Custom CSS rules for your forms belong at the end of your theme stylesheet. Action hooks and filters belong in your theme’s functions.php file. You can find more information in the documentation section here: [https://docs.gravityforms.com/page/Where-Do-I-Put-This-Code](https://docs.gravityforms.com/where-do-i-put-this-code/)

## Does Gravity Forms work properly on Microsoft Internet Explorer?

Browser support for viewing WordPress pages is [covered here](https://make.wordpress.org/core/handbook/best-practices/browser-support/). Internet Explorer will be no longer supported by Microsoft in 2021, and we will stop testing core and add-on updates on IE11 at that time.
...
[Algolia](https://docs.gravityforms.com/general/# "Algolia")
