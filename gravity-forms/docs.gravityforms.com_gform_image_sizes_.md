---
url: "https://docs.gravityforms.com/gform_image_sizes/"
title: "gform_image_sizes - Gravity Forms Documentation"
---
...
- [Developers](https://docs.gravityforms.com/category/developers/)  - [Theme Framework](https://docs.gravityforms.com/category/developers/theme-framework/)
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Field Filters](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/)        - [Image Choice Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/image-choice-fields/)          - [gform\_has\_image\_choices](https://docs.gravityforms.com/gform_has_image_choices/ "gform_has_image_choices")
          - [gform\_image\_sizes](https://docs.gravityforms.com/gform_image_sizes/ "gform_image_sizes")
...
- [Description](https://docs.gravityforms.com/gform_image_sizes/#h-description)
- [Usage](https://docs.gravityforms.com/gform_image_sizes/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_image_sizes/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_image_sizes/#h-examples)
- [Modify image sizes for all forms.](https://docs.gravityforms.com/gform_image_sizes/#h-modify-image-sizes-for-all-forms)
- [Placement](https://docs.gravityforms.com/gform_image_sizes/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_image_sizes/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_image_sizes/#h-since)

## Description

This gform\_image\_sizes filter allows you to customize the image sizes that are registered for the [Image Choice](https://docs.gravityforms.com/image-choice-field/) fields. You can modify the width, height, and crop settings for the small, medium, and large image choice sizes registered by default.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_image_sizes'``,``'your_function_name'``, 10, 1 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$image\_sizes** | array | An array of image sizes with their respective attributes. Each size contains width, height, and crop settings. |

**Default Sizes**

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17 | `array``(`<br>```'image-choice-sm'``=>``array``(`<br>```'width'``=> 300,`<br>```'height'``=> 300,`<br>```'crop'``=> true`<br>```),`<br>```'image-choice-md'``=>``array``(`<br>```'width'``=> 400,`<br>```'height'``=> 400,`<br>```'crop'``=> true`<br>```),`<br>```'image-choice-lg'``=>``array``(`<br>```'width'``=> 600,`<br>```'height'``=> 600,`<br>```'crop'``=> true`<br>```),`<br>`)` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11 | `add_filter(``'gform_image_sizes'``,``'customize_gf_image_sizes'``, 10, 1 );`<br>`function``customize_gf_image_sizes(``$image_sizes``) {`<br>```$image_sizes``[``'image-choice-sm'``][``'width'``] = 250;`<br>```$image_sizes``[``'image-choice-sm'``][``'height'``] = 250;`<br>```$image_sizes``[``'image-choice-md'``][``'width'``] = 500;`<br>```$image_sizes``[``'image-choice-md'``][``'height'``] = 500;`<br>```$image_sizes``[``'image-choice-lg'``][``'width'``] = 800;`<br>```$image_sizes``[``'image-choice-lg'``][``'height'``] = 800;`<br>``<br>```return``$image_sizes``;`<br>`}` |
...
This filter is located in GFForms::get\_image\_sizes() in gravityforms.php
...
[Algolia](https://docs.gravityforms.com/gform_image_sizes/# "Algolia")
