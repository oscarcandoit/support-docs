---
url: "https://docs.gravityforms.com/post-excerpt-2/"
title: "Post Excerpt CSS Selectors - Gravity Forms Documentation"
---
...
- [Container](https://docs.gravityforms.com/post-excerpt-2/#h-container)
- [Input](https://docs.gravityforms.com/post-excerpt-2/#h-input)
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield .ginput_container_post_excerpt {``border``:``1px``solid``red``;}` |

example: post excerpt container (div) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields .gfield .ginput_container_post_excerpt {``border``:``1px``solid``red``;}` |

example: post excerpt container (div) – applies just to specific container (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields #field_XX_X.gfield .ginput_container_post_excerpt {``border``:``1px``solid``red``;}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield .ginput_container_post_excerpt input {``border``:``1px``solid``red``;}` |

example: post excerpt input (input) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields .gfield .ginput_container_post_excerpt input {``border``:``1px``solid``red``;}` |

example: post excerpt input (input) – applies just to specific container (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields #field_XX_X.gfield .ginput_container_post_excerpt input {``border``:``1px``solid``red``;}` |
...
[Algolia](https://docs.gravityforms.com/post-excerpt-2/# "Algolia")
