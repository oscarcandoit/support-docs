---
url: "https://docs.gravityforms.com/gform_advancedpostcreation_file_fields_choices/"
title: "gform_advancedpostcreation_file_fields_choices - Gravity Forms"
---
...
# gform\_advancedpostcreation\_file\_fields\_choices

- [Description](https://docs.gravityforms.com/gform_advancedpostcreation_file_fields_choices/#h-description)
- [Usage](https://docs.gravityforms.com/gform_advancedpostcreation_file_fields_choices/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_advancedpostcreation_file_fields_choices/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_advancedpostcreation_file_fields_choices/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_advancedpostcreation_file_fields_choices/#h-placement)
- [Since](https://docs.gravityforms.com/gform_advancedpostcreation_file_fields_choices/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_advancedpostcreation_file_fields_choices/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_advancedpostcreation_file_fields_choices'``,``'your_function_name'``, 10, 3 );` |
...
- **$single\_file** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `add_filter(``'gform_advancedpostcreation_file_fields_choices'``,``'filter_choices'``, 10, 3 );`<br>`function``filter_choices(``$choices``,``$form``,``$single_file``){`<br>```$filtered_choices``=``array``();`<br>```foreach``(``$choices``as``$choice``)`<br>```{`<br>```if``(``$choice``[``'label'``] ==``'Not For Media'``){`<br>```continue``;`<br>```}`<br>```$filtered_choices``[] =``$choice``;`<br>```}`<br>```return``$filtered_choices``;`<br>`}` |
...
This filter is located in GF\_Advanced\_Post\_Creation::get\_file\_fields\_as\_choices() in _gravityformsadvancedpostcreation/class-gf-advancedpostcreation.php_.
...
[Algolia](https://docs.gravityforms.com/gform_advancedpostcreation_file_fields_choices/# "Algolia")
