---
url: "https://docs.gravityforms.com/gform_icontact_request_args/"
title: "gform_icontact_request_args - Gravity Forms Documentation"
---
...
# gform\_icontact\_request\_args

- [Description](https://docs.gravityforms.com/gform_icontact_request_args/#h-description)
- [Usage](https://docs.gravityforms.com/gform_icontact_request_args/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_icontact_request_args/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_icontact_request_args/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_icontact_request_args'``,``'my_function'``, 10, 4 );` |
...
- **$method** [string](https://docs.gravityforms.com/string)

The request method being used. Example: GET.

- **$return\_key** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `function``my_function(``$options``,``$action``,``$method``,``$return_key``) {`<br>`//Do something here`<br>`return``$options``;`<br>`}`<br>`add_filter(``'gform_icontact_request_args'``,``'my_function'``, 10, 4 );` |

## Source Code

This action hook is located in _class-icontact.php_.
...
[Algolia](https://docs.gravityforms.com/gform_icontact_request_args/# "Algolia")
