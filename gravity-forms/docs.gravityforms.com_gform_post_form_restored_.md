---
url: "https://docs.gravityforms.com/gform_post_form_restored/"
title: "gform_post_form_restored - Gravity Forms Documentation"
---
...
# gform\_post\_form\_restored

- [Description](https://docs.gravityforms.com/gform_post_form_restored/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_form_restored/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_form_restored/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_form_restored/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_post_form_restored/#h-source-code)

## Description

The “gform\_post\_form\_restored” action in Gravity Forms is triggered after a form is restored from the trash, allowing further actions to be performed.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_post_form_restored'``,``'my_function'``, 10 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_action(``'gform_post_form_restored'``,``'my_post_form_restored_func'``, 10);`<br>`function``my_post_form_restored_func(``$form_id``) {`<br>```// perform action after a form has been restored`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_post_form_restored/# "Algolia")
