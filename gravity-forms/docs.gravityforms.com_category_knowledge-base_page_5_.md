---
url: "https://docs.gravityforms.com/category/knowledge-base/page/5/"
title: "Knowledge Base Archives - Page 5 of 18 - Gravity Forms Documentation - Page 5 of 18"
---
...
You can embed the Gravity Forms shortcode anywhere within your WordPress site, independently from other plugins. But to talk effectively and get closer integration between Gravity Forms and a third party service, we recommend:.](https://docs.gravityforms.com/does-gravity-forms-support/ "Does Gravity Forms Support ….") [**Does Gravity Forms Support HHVM?** \\
While Gravity Forms is not tested on HHVM, in many cases it will operate properly out of the box or with a few modifications.](https://docs.gravityforms.com/does-gravity-forms-support-hhvm/ "Does Gravity Forms Support HHVM?") [**Duplicate Submissions And No Duplicates** \\
Duplicate submissions can happen when a browser reloads a form after it’s been submitted. No Duplicates setting helps prevent repeated entries by blocking identical submissions based on selected fields.](https://docs.gravityforms.com/duplicate-submissions/ "Duplicate Submissions And No Duplicates") [**Dynamically Populating a Field** \\
Using dynamic population in Gravity Forms allows you to dynamically populate a field with a value (or values depending on the field type).](https://docs.gravityforms.com/using-dynamic-population/ "Dynamically Populating a Field") [**Dynamically Populating Drop Down, Radio Buttons or Multi-Select Fields** \\
Being able to dynamically populate the values in a select (aka drop down) field is fairly common requirement for product selection forms, product option forms, or any form that requires earlier submissions to drive choices in a latter collection field.](https://docs.gravityforms.com/dynamically-populating-drop-down-or-radio-buttons-fields/ "Dynamically Populating Drop Down, Radio Buttons or Multi-Select Fields") [**Dynamically Populating the Post Author** \\
Learn how to dynamically populate the post author in Gravity Forms.](https://docs.gravityforms.com/dynamically-populating-the-post-author/ "Dynamically Populating the Post Author") [**Enabling No Conflict Mode** \\
If you are running into issues with your form builder, view this article to learn how to enable no conflict mode. This will temporarily resolve the issue.](https://docs.gravityforms.com/enabling-no-conflict-mode/ "Enabling No Conflict Mode") [**Enabling the Gravity Forms Toolbar Menu** \\
The Gravity Forms toolbar menu enables quick access to your most recent common actions. This article shows you how to enable it.](https://docs.gravityforms.com/enabling-gravity-forms-toolbar-item/ "Enabling the Gravity Forms Toolbar Menu") [**Enhancements to the Spam Honeypot** \\
This article covers the new enhancements made for the Gravity Forms anti-spam honeypot.](https://docs.gravityforms.com/spam-honeypot-enhancements/ "Enhancements to the Spam Honeypot") [**Error ‘Unexpected T\_STRING’ when installing Gravity Forms** \\
This article offers potential cause and remedy for a PHP related error that may be encountered during Gravity Forms installation.](https://docs.gravityforms.com/unexpected-t-string-php-error/ "Error ‘Unexpected T_STRING’ when installing Gravity Forms") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/4/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [3](https://docs.gravityforms.com/category/knowledge-base/page/3/) [4](https://docs.gravityforms.com/category/knowledge-base/page/4/) 5 [6](https://docs.gravityforms.com/category/knowledge-base/page/6/) [7](https://docs.gravityforms.com/category/knowledge-base/page/7/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/6/)
...
[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/5/# "Algolia")
