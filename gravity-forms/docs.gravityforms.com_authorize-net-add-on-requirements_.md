---
url: "https://docs.gravityforms.com/authorize-net-add-on-requirements/"
title: "Additional Authorize.Net Add-On Requirements - Gravity Forms"
---
...
- [Summary](https://docs.gravityforms.com/authorize-net-add-on-requirements/#h-summary)
- [SSL Requirement](https://docs.gravityforms.com/authorize-net-add-on-requirements/#h-ssl-requirement)
- [PHP cURL Extension](https://docs.gravityforms.com/authorize-net-add-on-requirements/#h-php-curl-extension)
- [Required Fields](https://docs.gravityforms.com/authorize-net-add-on-requirements/#h-required-fields)
- [Feed](https://docs.gravityforms.com/authorize-net-add-on-requirements/#h-feed)

**Important:** Authorize.net is a legacy add-on. It will not be receiving further updates. We recommend switching to an alternative payment add-on, such as [Stripe](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/), [PayPal Checkout](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/paypal-checkout-add-on/), [Square](https://docs.gravityforms.com/category/add-ons-gravity-forms/square-add-on/), or [Mollie](https://docs.gravityforms.com/category/add-ons-gravity-forms/mollie-add-on/).
...
If you need assistance configuring your WordPress site to work, check out the [WordPress.org plugin repository](https://wordpress.org/plugins/search/SSL/) for options.
...
For more information, take a look at our article on [creating a feed for the Authorize.Net Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-authorize-net-add-on/).
...
[Algolia](https://docs.gravityforms.com/authorize-net-add-on-requirements/# "Algolia")
