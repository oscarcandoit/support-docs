---
url: "https://docs.gravityforms.com/gform_disable_resend_notification/"
title: "gform_disable_resend_notification - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_disable_resend_notification/#h-description)
- [Usage](https://docs.gravityforms.com/gform_disable_resend_notification/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_disable_resend_notification/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_disable_resend_notification/#h-examples)
- [Prevent Resending a Specific Notification.](https://docs.gravityforms.com/gform_disable_resend_notification/#h-prevent-resending-a-specific-notification)
- [Block Resend Based on Form Submission Data.](https://docs.gravityforms.com/gform_disable_resend_notification/#h-block-resend-based-on-form-submission-data)
- [Placement](https://docs.gravityforms.com/gform_disable_resend_notification/#h-placement)
- [Since](https://docs.gravityforms.com/gform_disable_resend_notification/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_disable_resend_notification/#h-source-code)
...
To use the gform\_disable\_resend\_notification filter, add it to your code as follows:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_disable_resend_notification'``,``'your_function_name'``, 10, 4 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$abort\_email** | [bool](https://docs.gravityforms.com/bool/) | Determines whether the notification email should be prevented from being sent. Return true to block the email, or false to allow it. Default is false. |
| **$notification** | [array](https://docs.gravityforms.com/array/) | The current notification object. |
| **$form** | [array](https://docs.gravityforms.com/array/) | The current form object. |
| **$lead** | [array](https://docs.gravityforms.com/array/) | The current entry object. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_disable_resend_notification'``,``'prevent_specific_notification_resend'``, 10, 4 );`<br>`function``prevent_specific_notification_resend(``$abort_email``,``$notification``,``$form``,``$lead``) {`<br>```if``(``$notification``[``'id'``] ===``'68beda29a1b3c'``) {`<br>```return``true;``// Prevent this notification from being resent`<br>```}`<br>```return``$abort_email``;``// Retain default behavior for other notifications`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_disable_resend_notification'``,``'block_resend_based_on_field'``, 10, 4 );`<br>`function``block_resend_based_on_field(``$abort_email``,``$notification``,``$form``,``$lead``) {`<br>```if``( rgar(``$lead``,``'5'``) ===``'No'``) {`<br>```return``true;``// Prevent resending if field ID 5 has the value "No"`<br>```}`<br>```return``$abort_email``;``// Retain default behavior otherwise`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_disable_resend_notification/# "Algolia")
