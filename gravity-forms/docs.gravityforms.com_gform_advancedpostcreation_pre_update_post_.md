---
url: "https://docs.gravityforms.com/gform_advancedpostcreation_pre_update_post/"
title: "gform_advancedpostcreation_pre_update_post - Gravity Forms Documentation"
---
...
# gform\_advancedpostcreation\_pre\_update\_post

- [Description](https://docs.gravityforms.com/gform_advancedpostcreation_pre_update_post/#h-description)
- [Usage](https://docs.gravityforms.com/gform_advancedpostcreation_pre_update_post/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_advancedpostcreation_pre_update_post/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_advancedpostcreation_pre_update_post/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_advancedpostcreation_pre_update_post/#h-placement)
- [Since](https://docs.gravityforms.com/gform_advancedpostcreation_pre_update_post/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_advancedpostcreation_pre_update_post/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_advancedpostcreation_pre_update_post'``,``'your_function_name'``, 10, 3 );` |

To target a specific form, append the form id to the hook name. (format: gform\_advancedpostcreation\_pre\_update\_post\_FORMID):

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_advancedpostcreation_pre_update_post_1'``,``'your_function_name'``, 10, 3 );` |

Note that only files that were uploaded using the [Gravity Forms File Upload field](https://docs.gravityforms.com/file-upload/) will be updated.

## Parameters

- **$post** [array](https://docs.gravityforms.com/array/)

The post to be updated. Array returned is the WP [get\_post](https://developer.wordpress.org/reference/functions/get_post/) function.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_advancedpostcreation_pre_update_post'``,``'pre_update_your_post'``, 10, 3 );`<br>`function``pre_update_your_post (``$post``,``$feed``,``$entry``) {`<br>```// do something`<br>`}` |
...
This filter is located in GF\_Advanced\_Post\_Creation:update() in _class-post-update-handler.php_
...
[Algolia](https://docs.gravityforms.com/gform_advancedpostcreation_pre_update_post/# "Algolia")
