---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/getresponse-add-on/"
title: "GetResponse Add-On Archives - Gravity Forms Documentation"
---
...
Step-by-step instructions on how to setup the GetResponse Add-On.](https://docs.gravityforms.com/getresponse-add-on/ "Setting Up the GetResponse Add-On") [**Creating a Feed for the GetResponse Add-On**\\
This article contains step-by-step instructions on how to create a feed for the GetResponse Add-On.](https://docs.gravityforms.com/creating-a-feed-for-the-getresponse-add-on/ "Creating a Feed for the GetResponse Add-On") [**Upgrading to GetResponse Add-On version 1.2.1** \\
GetResponse Add-On version 1.2.1 includes updates to utilize the newest GetResponse API version 3. This version of their API includes new field data validations that did not previously exist, and upgrading carries a risk if you have existing forms that were previously breaking these validations.](https://docs.gravityforms.com/upgrading-to-getresponse-add-on-v1-2-1/ "Upgrading to GetResponse Add-On version 1.2.1") [**GetResponse Changelog** \\
View the change log for the GetResponse Add-On.](https://docs.gravityforms.com/getresponse-change-log/ "GetResponse Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/getresponse-add-on/# "Algolia")
