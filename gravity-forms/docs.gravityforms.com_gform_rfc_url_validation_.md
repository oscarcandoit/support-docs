---
url: "https://docs.gravityforms.com/gform_rfc_url_validation/"
title: "gform_rfc_url_validation - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_rfc_url_validation/#h-description)
- [Usage](https://docs.gravityforms.com/gform_rfc_url_validation/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_rfc_url_validation/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_rfc_url_validation/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_rfc_url_validation/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_rfc_url_validation/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_rfc_url_validation'``,``'__return_false'``, 10, 1 );` |

## Parameters

Defaults to true. Set to false using \_\_return\_false or a custom function to set to false, to disable RFC.
...
[Algolia](https://docs.gravityforms.com/gform_rfc_url_validation/# "Algolia")
