---
url: "https://docs.gravityforms.com/gform_name_last/"
title: "gform_name_last - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_name_last/#h-description)
- [Usage](https://docs.gravityforms.com/gform_name_last/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_name_last/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_name_last/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_name_last/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_name_last'``,``'change_last'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_name_last'``,``'change_last'``, 10, 2 );`<br>`function``change_last(``$label``,``$form_id``) {`<br>```return``"Last Name"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_name_last/# "Algolia")
