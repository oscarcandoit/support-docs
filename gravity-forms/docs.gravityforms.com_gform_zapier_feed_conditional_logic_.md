---
url: "https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/"
title: "gform_zapier_feed_conditional_logic - Gravity Forms Documentation"
---
...
# gform\_zapier\_feed\_conditional\_logic

- [Description](https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/#h-description)
- [Usage](https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/#h-placement)
- [Since](https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/#h-source-code)

## Description

The “gform\_zapier\_feed\_conditional\_logic” filter allows the feed conditional logic rule to be overridden during submission, allowing multiple rules to be defined.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_zapier_feed_conditional_logic'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$logic** [string](https://docs.gravityforms.com/string)

- **$form** [Form Object](https://docs.gravityforms.com/form-object)

The form object.

- **$zap** [object](https://docs.gravityforms.com/object)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `add_filter(``'gform_zapier_feed_conditional_logic'``,``'set_logic'``, 10, 3 );`<br>`function``set_logic(``$logic``,``$form``,``$zap``){`<br>```$logic``[``'rules'``][] =`<br>```array``(`<br>```'fieldId'``=> rgar(``$zap``,``'zapier_conditional_field_id'``),`<br>```'operator'``=>``'starts_with'``,`<br>```'value'``=>``'Test'``,`<br>```);`<br>```return``$logic``;`<br>`}` |
...
This filter is located in GFZapier::conditions\_met() in _gravityformszapier/zapier.php_.
...
[Algolia](https://docs.gravityforms.com/gform_zapier_feed_conditional_logic/# "Algolia")
