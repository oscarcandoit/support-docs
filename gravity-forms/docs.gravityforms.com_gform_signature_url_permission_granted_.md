---
url: "https://docs.gravityforms.com/gform_signature_url_permission_granted/"
title: "gform_signature_url_permission_granted - Gravity Forms Documentation"
---
...
# gform\_signature\_url\_permission\_granted

- [Description](https://docs.gravityforms.com/gform_signature_url_permission_granted/#h-description)
- [Usage](https://docs.gravityforms.com/gform_signature_url_permission_granted/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_signature_url_permission_granted/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_signature_url_permission_granted/#h-examples)
- [Require the user to have administrative capabilities](https://docs.gravityforms.com/gform_signature_url_permission_granted/#h-require-the-user-to-have-administrative-capabilities)
- [Placement](https://docs.gravityforms.com/gform_signature_url_permission_granted/#h-placement)
- [Since](https://docs.gravityforms.com/gform_signature_url_permission_granted/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_signature_url_permission_granted/#h-source-code)

## Description

The gform\_signature\_url\_permission\_granted filter can be used to perform custom logic to determine if the signature URL will allow access to the file.
...
This filter is located in GF\_Signature\_Image::is\_permission\_granted() in _includes/class-gf-signature-image.php_.
