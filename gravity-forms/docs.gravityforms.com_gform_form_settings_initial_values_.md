---
url: "https://docs.gravityforms.com/gform_form_settings_initial_values/"
title: "gform_form_settings_initial_values - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_form_settings_initial_values/#h-description)
- [Usage](https://docs.gravityforms.com/gform_form_settings_initial_values/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_form_settings_initial_values/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_form_settings_initial_values/#h-examples)
- [1\. Enable Honeypot](https://docs.gravityforms.com/gform_form_settings_initial_values/#h-1-enable-honeypot)
- [Placement](https://docs.gravityforms.com/gform_form_settings_initial_values/#h-placement)
- [Since](https://docs.gravityforms.com/gform_form_settings_initial_values/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_form_settings_initial_values/#h-source-code)
...
- **$initial\_values** [array](https://docs.gravityforms.com/array)
...
|     |
| --- |
| `add_filter(``'gform_form_settings_initial_values'``,``function``(``$initial_values``,``$form``) {`<br>```$initial_values``[``'enableHoneypot'``] = true;`<br>``<br>```return``$initial_values``;`<br>`}, 10, 2 );` |
...
This filter is located in GFFormSettings::get\_initial\_values() in _form\_settings.php_.
...
[Algolia](https://docs.gravityforms.com/gform_form_settings_initial_values/# "Algolia")
