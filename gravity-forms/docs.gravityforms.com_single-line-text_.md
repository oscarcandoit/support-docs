---
url: "https://docs.gravityforms.com/single-line-text/"
title: "Single Line Text - Gravity Forms Documentation"
---
...
- [Summary](https://docs.gravityforms.com/single-line-text/#h-summary)
- [Common Settings](https://docs.gravityforms.com/single-line-text/#h-common-settings)
- [Input Mask](https://docs.gravityforms.com/single-line-text/#h-input-mask)
- [Merge Tags](https://docs.gravityforms.com/single-line-text/#h-merge-tags)
- [Usage](https://docs.gravityforms.com/single-line-text/#h-usage)
- [Modifiers](https://docs.gravityforms.com/single-line-text/#h-modifiers)
...
[![GForms Single Line Text Field Icon](https://docs.gravityforms.com/wp-content/uploads/2014/05/CleanShot-2021-05-10-at-17.25.15@2x.png)](https://docs.gravityforms.com/wp-content/uploads/2014/05/CleanShot-2021-05-10-at-17.25.15@2x.png)

Single Line Text field as displayed in the [Field Library](https://docs.gravityforms.com/form-editor/#h-the-field-library)

[![Screenshot of Single Line Text Field in form editor](https://docs.gravityforms.com/wp-content/uploads/2014/05/CleanShot-2021-08-02-at-12.50.43.png)](https://docs.gravityforms.com/wp-content/uploads/2014/05/CleanShot-2021-08-02-at-12.50.43.png)

Single Line Text field as displayed in the [Form Editor](https://docs.gravityforms.com/form-editor/#h-the-layout-space).
...
Single Line Text and [Post Custom Field](https://docs.gravityforms.com/post-custom/) are the only fields that have the Input Mask setting. You can learn more about input masks in this [article](https://docs.gravityforms.com/input-mask/).
...
The following example would be the merge tag for a Single Line Text field labeled as “Text Field”, which has id 2 assigned.
...
[Algolia](https://docs.gravityforms.com/single-line-text/# "Algolia")
