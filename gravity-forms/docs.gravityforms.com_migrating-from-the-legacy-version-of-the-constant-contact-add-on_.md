---
url: "https://docs.gravityforms.com/migrating-from-the-legacy-version-of-the-constant-contact-add-on/"
title: "Migrate Legacy Version of Constant Contact Add-On - Gravity Forms"
---
...
If you’re using the legacy [third-party Constant Contact Add-On](https://wordpress.org/plugins/gravity-forms-constant-contact/) created by Katz Web Services, Inc., you will need to recreate your feed settings in the new official Add-On by Gravity Forms. The legacy add-on uses an old version of the Constant Contact API (v2) and will receive no further updates.
...
1. **Middle Name** is no longer available as a Map Field. Use a custom field if this information needs to be gathered.
2. **Address 2** is no longer available as a Map Field. Use a custom field if this information needs to be gathered.
3. **Address 3** is no longer available as a Map Field. Use a custom field if this information needs to be gathered.
4. The list of available **Custom Fields** for mapping pulls the custom fields which have been created in your Constant Contact account.
...
[Algolia](https://docs.gravityforms.com/migrating-from-the-legacy-version-of-the-constant-contact-add-on/# "Algolia")
