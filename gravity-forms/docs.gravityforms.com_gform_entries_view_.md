---
url: "https://docs.gravityforms.com/gform_entries_view/"
title: "gform_entries_view - Gravity Forms Documentation"
---
...
# gform\_entries\_view

- [Description](https://docs.gravityforms.com/gform_entries_view/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entries_view/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_entries_view/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_entries_view/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_entries_view'``,``'my_function'``, 10, 3 );` |
...
- **$form\_id** [string](https://docs.gravityforms.com/string)

The ID of the form that the entry belongs to.

- **$entry\_id** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `if``( rgget(``'view'``) ==``'my_view'``) {`<br>`add_action(``'gform_entries_view'``,``'my_function'``, 10, 3 );`<br>`function``my_function(``$view``,``$form_id``,``$entry_id``) {`<br>`//Display the view for this entry type`<br>`}`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entries_view/# "Algolia")
