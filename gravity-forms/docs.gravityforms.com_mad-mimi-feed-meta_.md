---
url: "https://docs.gravityforms.com/mad-mimi-feed-meta/"
title: "Mad Mimi Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Mad Mimi Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/mad-mimi-filters/)          - [gform\_madmimi\_field\_value](https://docs.gravityforms.com/gform_madmimi_field_value/ "gform_madmimi_field_value")
          - [Mad Mimi Feed Meta](https://docs.gravityforms.com/mad-mimi-feed-meta/ "Mad Mimi Feed Meta")
...
- [Introduction](https://docs.gravityforms.com/mad-mimi-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/mad-mimi-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the Mad Mimi Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `$feed``[``'meta'``] =``array``(`<br>```'feed_name'``=>``'Your Feed Name'``,`<br>```'fields_email'``=>``'2'``,`<br>```'fields_firstname'``=>``'1.3'``,`<br>```'fields_lastname'``=>``'1.6'``,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **feed\_name** [string](https://docs.gravityforms.com/string)
The feed name which appears on the add-ons feeds tab.

- **list** [string](https://docs.gravityforms.com/string)

The ID of the Mad Mimi list this feed will add contacts to.

- **fields\_email** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s email address. Required.

- **fields\_firstname** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s first name.

- **fields\_lastname** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s last name.

- **fields\_title** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s title.

- **fields\_company** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s company.

- **fields\_phone** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s phone number.

- **fields\_address** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s address.

- **fields\_city** [string](https://docs.gravityforms.com/string)

The ID of the field containing the customer’s city.

- **fields\_state** [string](https://docs.gravityforms.com/string)

The ID of the field containing the customer’s state.

- **fields\_zip** [string](https://docs.gravityforms.com/string)

The ID of the field containing the customer’s zip.

- **fields\_country** [string](https://docs.gravityforms.com/string)

The ID of the field containing the customer’s zip.

- **custom\_fields** [array](https://docs.gravityforms.com/array)

A multidimensional array containing the custom fields to be sent to Mad Mimi. See [Custom Field Properties](https://docs.gravityforms.com/mad-mimi-feed-meta/#custom-field-properties).
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `array``(`<br>```'key'``=>``'gf_custom'``,`<br>```'value'``=>``'3.1'``,`<br>```'custom_key'``=>``'address_one'``,`<br>`)` |
...
The custom field key. _Value: gf\_custom_
...
- **custom\_key** [string](https://docs.gravityforms.com/string) The custom field name.
...
[Algolia](https://docs.gravityforms.com/mad-mimi-feed-meta/# "Algolia")
