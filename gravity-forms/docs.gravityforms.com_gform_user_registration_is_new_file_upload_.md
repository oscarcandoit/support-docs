---
url: "https://docs.gravityforms.com/gform_user_registration_is_new_file_upload/"
title: "New File Upload in User Registration - Gravity"
---
...
# gform\_user\_registration\_is\_new\_file\_upload

- [Description](https://docs.gravityforms.com/gform_user_registration_is_new_file_upload/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_is_new_file_upload/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_user_registration_is_new_file_upload/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_user_registration_is_new_file_upload/#h-placement)
- [Since](https://docs.gravityforms.com/gform_user_registration_is_new_file_upload/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_is_new_file_upload/#h-source-code)

## Description

The “gform\_user\_registration\_is\_new\_file\_upload” filter in the Gravity Forms User Registration Add-On allows you to change whether or not new files have been uploaded when an Update User feed is processed.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_user_registration_is_new_file_upload'``,``'upload_custom_action'``, 10, 3 );` |

## Parameters

- **$is\_new\_file\_upload** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_user_registration_is_new_file_upload'``,``'upload_custom_action'``, 10, 3 );`<br>`function``upload_custom_action(``$is_new_file_upload``,``$form_id``,``$input_name``) {`<br>```// Do your custom stuff here.`<br>```return``$is_new_file_upload``;`<br>`}` |
...
This filter is located in GF\_User\_Registration::is\_new\_file\_upload() in _gravityformsuserregistration/class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_is_new_file_upload/# "Algolia")
