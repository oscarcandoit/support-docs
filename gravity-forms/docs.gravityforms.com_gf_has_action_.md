---
url: "https://docs.gravityforms.com/gf_has_action/"
title: "gf_has_action - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gf_has_action/#h-description)
- [Usage](https://docs.gravityforms.com/gf_has_action/#h-usage)
- [Parameters](https://docs.gravityforms.com/gf_has_action/#h-parameters)
- [Returns](https://docs.gravityforms.com/gf_has_action/#h-returns)
- [Examples](https://docs.gravityforms.com/gf_has_action/#h-examples)
- [Since](https://docs.gravityforms.com/gf_has_action/#h-since)
- [Source Code](https://docs.gravityforms.com/gf_has_action/#h-source-code)

## Description

The function **gf\_has\_action()** determines if a callback has been registered for the specified action.
...
| --- | --- | --- |
| **$action** | [array](https://docs.gravityforms.com/int) | Array containing the action tag as well as the possible modifiers. |
| **$function\_to\_check** | [bool](https://docs.gravityforms.com/int) \|callable | The optional callback to check for. |
...
[Algolia](https://docs.gravityforms.com/gf_has_action/# "Algolia")
