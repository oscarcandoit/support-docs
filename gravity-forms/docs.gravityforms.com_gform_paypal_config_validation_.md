---
url: "https://docs.gravityforms.com/gform_paypal_config_validation/"
title: "gform_paypal_config_validation - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_paypal_config_validation/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_config_validation/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_config_validation/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_config_validation/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_paypal_config_validation/#h-source-code)

## Description

Used to validate custom settings/meta specified using the [gform\_paypal\_action\_fields](https://docs.gravityforms.com/gform_paypal_action_fields) or [gform\_paypal\_add\_option\_group](https://docs.gravityforms.com/gform_paypal_add_option_group) action hooks.
...
This example shows how to validate fictional custom options added to integrate with a fictional third party application. This assumes that the custom fields were added to the PayPal configuration form using the [gform\_paypal\_action\_fields](https://docs.gravityforms.com/gform_paypal_action_fields) or [gform\_paypal\_add\_option\_group](https://docs.gravityforms.com/gform_paypal_add_option_group) hook.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13 | `add_filter(``'gform_paypal_config_validation'``,``'validate_custom_config'``, 10, 2 );`<br>`public``static``function``validate_custom_config(``$is_validation_error``,``$feed``) {`<br>```$custom_options``= rgars(``$feed``,``'meta/custom_options'``);`<br>```if``(``empty``(``$custom_options``[``'enable_thirdparty_options'``] ) )`<br>```return``$is_validation_error``;`<br>```if``(``empty``(``$custom_options``[``'thirdparty_apikey'``] ) ||``empty``(``$custom_options``[``'thirdparty_apipass'``] ) )`<br>```return``true;`<br>```return``$is_validation_error``;`<br>`}` |
...
This action hook is located in GFPayPal::save\_feed\_settings() _class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_config_validation/# "Algolia")
