---
url: "https://docs.gravityforms.com/square-feed-meta/"
title: "Square Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Square Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/square-filters/)          - [gform\_square\_authorization\_only](https://docs.gravityforms.com/gform_square_authorization_only/ "gform_square_authorization_only")
          - [gform\_square\_card\_details\_style](https://docs.gravityforms.com/gform_square_card_details_style/ "gform_square_card_details_style")
          - [gform\_square\_card\_style](https://docs.gravityforms.com/gform_square_card_style/ "gform_square_card_style")
          - [gform\_square\_data\_sync\_enabled](https://docs.gravityforms.com/gform_square_data_sync_enabled/ "gform_square_data_sync_enabled")
          - [gform\_square\_payment\_data](https://docs.gravityforms.com/gform_square_payment_data/ "gform_square_payment_data")
          - [gform\_square\_show\_custom\_app\_settings](https://docs.gravityforms.com/gform_square_show_custom_app_settings/ "gform_square_show_custom_app_settings")
          - [Square Feed Meta](https://docs.gravityforms.com/square-feed-meta/ "Square Feed Meta")
...
- [Introduction](https://docs.gravityforms.com/square-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/square-feed-meta/#h-usage)
- [Properties](https://docs.gravityforms.com/square-feed-meta/#h-properties)

## Introduction

The [Feed Meta Object](https://docs.gravityforms.com/feed-object) for the Square Add-On is an associative array with properties determining how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22<br>23<br>24<br>25<br>26<br>27<br>28<br>29<br>30<br>31<br>32<br>33<br>34<br>35 | `$feed``[``'meta'``] =``array``(`<br>```'feedName'``=>``'Square Feed Example'``,`<br>```'transactionType'``=>``'product'``,`<br>```'paymentAmount'``=>``''``,`<br>```'authorizeOnly'``=>``'0'``,`<br>```'billingCycle_length'``=>``''``,`<br>```'billingCycle_unit'``=>``''``,`<br>```'recurringTimes'``=>``''``,`<br>```'setupFee_enabled'``=> false,`<br>```'setupFee'``=>``''``,`<br>```'feed_condition_conditional_logic'``=> false,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(`<br>```'actionType'``=>``''``,`<br>```'logicType'``=>``''``,`<br>```'rules'``=>``array``(`<br>```array``(`<br>```'fieldId'``=>``''``,`<br>```'operator'``=>``''``,`<br>```'value'``=>``''``,`<br>```),`<br>```),`<br>```),`<br>```),`<br>```'subscription_name'``=>``''``,`<br>```'billingInformation_email'``=>``''``,`<br>```'billingInformation_first_name'``=>``''``,`<br>```'billingInformation_last_name'``=>``''``,`<br>```'billingInformation_address_line1'``=>``''``,`<br>```'billingInformation_address_line2'``=>``''``,`<br>```'billingInformation_address_city'``=>``''``,`<br>```'billingInformation_address_state'``=>``''``,`<br>```'billingInformation_address_zip'``=>``''``,`<br>```'billingInformation_address_country'``=>``''``,`<br>`);` |
...
| **billingCycle\_length** | string | Specifies the length of the billing cycle for subscriptions. |
| **billingCycle\_unit** | string | Specifies the unit of time for the billing cycle: ‘week’, ‘month’, or ‘year’. |
| **recurringTimes** | string | The number of billing cycles for a subscription (or leave empty for ongoing). |
| **setupFee\_enabled** | boolean | Enables a one-time setup fee for subscriptions. |
| **setupFee** | string | Specifies the setup fee amount. |
| **feed\_condition\_conditional\_logic** | boolean | Enables conditional logic to determine if the feed should run. |
| **feed\_condition\_conditional\_logic\_object** | array | Stores the conditional logic rules, including the field ID, operator, and value. |
| **subscription\_name** | string | A custom name for the subscription. |
| **billingInformation\_email** | string | The customer’s email address. |
| **billingInformation\_first\_name** | string | The customer’s first name. |
| **billingInformation\_last\_name** | string | The customer’s last name. |
| **billingInformation\_address\_line1** | string | The first line of the customer’s billing address. |
| **billingInformation\_address\_line2** | string | The second line of the customer’s billing address (optional). |
| **billingInformation\_address\_city** | string | The city of the customer’s billing address. |
| **billingInformation\_address\_state** | string | The state or region of the customer’s billing address. |
| **billingInformation\_address\_zip** | string | The ZIP/postal code of the customer’s billing address. |
| **billingInformation\_address\_country** | string | The country of the customer’s billing address. |
...
[Algolia](https://docs.gravityforms.com/square-feed-meta/# "Algolia")
