---
url: "https://docs.gravityforms.com/gf_field_consent/"
title: "GF_Field_Consent - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_consent/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_consent/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_consent/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_consent/#h-properties)
- [Hooks](https://docs.gravityforms.com/gf_field_consent/#h-hooks)
- [Source Code](https://docs.gravityforms.com/gf_field_consent/#h-source-code)

## Introduction

The GF\_Field\_Consent class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Consent field is rendered when the form is displayed and how its value is handled during and after form submission.

## Settings and Properties

Settings control what options are available to the admin user when configuring the field in the form editor. Gravity Forms includes many built-in settings such as Field Label, Field Description, Conditional Logic, etc. In addition to built-in settings, custom settings can also be developed. For more information on how to develop custom settings and how to associate settings to a field, visit the [GF\_Field page](https://docs.gravityforms.com/gf_field/#get_form_editor_field_settings).
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `//get the field`<br>`$field``= GFFormsModel::get_field(``$form``, 1 );`<br>`//get the description`<br>`$description``=``$field``->description;` |
...
- **checkbox\_label\_setting**

Controls whether the “Checkbox Label” setting appears.
...
- **checkboxLabel** [string](https://docs.gravityforms.com/string)
...
The following hooks are located in GF\_Field\_Consent:

- [gform\_consent\_checked\_indicator\_markup](https://docs.gravityforms.com/gform_consent_checked_indicator)
- [gform\_consent\_checked\_indicator](https://docs.gravityforms.com/gform_consent_checked_indicator/)

## Source Code

The source code is located in _includes/fields/class-gf-field-section.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_consent/# "Algolia")
