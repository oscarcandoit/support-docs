---
url: "https://docs.gravityforms.com/gform_userregistration_associate_entry_with_user/"
title: "gform_userregistration_associate_entry_with_user - Gravity Forms"
---
...
# gform\_userregistration\_associate\_entry\_with\_user

- [Description](https://docs.gravityforms.com/gform_userregistration_associate_entry_with_user/#h-description)
- [Usage](https://docs.gravityforms.com/gform_userregistration_associate_entry_with_user/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_userregistration_associate_entry_with_user/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_userregistration_associate_entry_with_user/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_userregistration_associate_entry_with_user/#h-placement)
- [Since](https://docs.gravityforms.com/gform_userregistration_associate_entry_with_user/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_userregistration_associate_entry_with_user/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_userregistration_associate_entry_with_user'``,``'your_function_name'``, 10, 5 );` |

## Parameters

- **$update\_entry\_creator** [bool](https://docs.gravityforms.com/bool)
If entry creator should be associated with user.

- **$user\_id** [int](https://docs.gravityforms.com/int)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_userregistration_associate_entry_with_user'``,``'associate_entry'``, 10, 5 );`<br>`function``associate_entry(``$update_entry_creator``,``$user_id``,``$feed``,``$entry``,``$form``){`<br>```return``true;`<br>`}` |
...
This filter is located in GF\_User\_Registration::create\_user() in _gravityformsuserregistration/class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_userregistration_associate_entry_with_user/# "Algolia")
