---
url: "https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/"
title: "gform_include_thousands_sep_pre_format_number - Gravity Forms"
---
...
# gform\_include\_thousands\_sep\_pre\_format\_number

- [Description](https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/#h-description)
- [Usage](https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/#h-examples)
- [1\. All fields and forms](https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/#h-1-all-fields-and-forms)
- [2\. Specific field](https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/#h-2-specific-field)
- [Placement](https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/#h-source-code)
...
- **$include\_separator** [boolean](https://docs.gravityforms.com/boolean)
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_include_thousands_sep_pre_format_number'``,``function``(``$include_separator``,``$field``) {`<br>```return``$field``->formId == 20 &&``$field``->id == 45 ? false :``$include_separator``;`<br>`}, 10, 2 );` |
...
This filter is located in the following methods in _includes/fields/class-gf-field-number.php_:

- GF\_Field\_Number::get\_field\_input()
- GF\_Field\_Number::get\_value\_entry\_list()
- GF\_Field\_Number::get\_value\_entry\_detail()
- GF\_Field\_Number::get\_value\_merge\_tag()
...
[Algolia](https://docs.gravityforms.com/gform_include_thousands_sep_pre_format_number/# "Algolia")
