---
url: "https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/"
title: "gform_moderation_field_types_to_analyze - Gravity Forms Documentation"
---
...
# gform\_moderation\_field\_types\_to\_analyze

- [Description](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/#h-description)
- [Usage](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/#h-examples)
- [Add additional field types for toxicity.](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/#h-add-additional-field-types-for-toxicity)
- [Placement](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_moderation_field_types_to_analyze'``,``'your_function_name'``, 10, 2 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$field\_types\_to\_analyze** | array | The types of fields to be analyzed for toxicity. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `array``(`<br>```'email'``,`<br>```'name'``,`<br>```'text'``,`<br>```'textarea'``,`<br>```'website'``,`<br>```'address'``,`<br>```'post_content'``,`<br>```'post_custom_field'``,`<br>```'post_excerpt'``,`<br>```'post_title'`<br>`)` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_moderation_field_types_to_analyze'``,``'add_custom_field_types_for_moderation'``, 10, 2 );`<br>`function``add_custom_field_types_for_moderation(``$field_types_to_analyze``,``$form``) {`<br>```$field_types_to_analyze``[] =``'phone'``;`<br>```$field_types_to_analyze``[] =``'number'``;`<br>```return``$field_types_to_analyze``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/# "Algolia")
