---
url: "https://docs.gravityforms.com/gf_do_action/"
title: "gf_do_action() - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gf_do_action/#h-description)
- [Usage](https://docs.gravityforms.com/gf_do_action/#h-usage)
- [Examples](https://docs.gravityforms.com/gf_do_action/#h-examples)
- [Since](https://docs.gravityforms.com/gf_do_action/#h-since)
- [Source Code](https://docs.gravityforms.com/gf_do_action/#h-source-code)

## Description

Gravity Forms pre-processing for do\_action.
...
```
gf_do_action( array( 'my_action_hook', $form_id ), $arg1, $arg2 );
```
...
Array containing the action hook as well as the modifier.

## Examples

|     |     |
| --- | --- |
| 1 | `gf_do_action(``array``(``'my_action_hook'``,``$form_id``),``$arg1``,``$arg2``);` |
...
[Algolia](https://docs.gravityforms.com/gf_do_action/# "Algolia")
