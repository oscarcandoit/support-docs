---
url: "https://docs.gravityforms.com/deprecation-of-the-gravity-forms-credit-card-field/"
title: "Gravity Forms Credit Card Field Deprecation"
---
...
- [Notice](https://docs.gravityforms.com/deprecation-of-the-gravity-forms-credit-card-field/#h-notice)
- [How to Change Your Payment Collection Method](https://docs.gravityforms.com/deprecation-of-the-gravity-forms-credit-card-field/#h-how-to-change-your-payment-collection-method)
- [More Help Needed?](https://docs.gravityforms.com/deprecation-of-the-gravity-forms-credit-card-field/#h-more-help-needed)

## Notice

❗The [Gravity Forms Credit Card Field](https://docs.gravityforms.com/stripe-payment-collection-methods/) has been **deprecated** for use with all our modern payment add-ons. Instead, use the gateway-specific payment collection fields.

It is no longer supported in the current versions of our Stripe, PayPal, and Square Add-Ons. Forms that are currently using this field may continue to work; however, it is not possible to add the field to new forms, and future announcements/changes may halt its operation. We do not recommend its use in any of your solutions, and encourage you to migrate all your forms to the gateway-specific payment collection fields, such as the [Stripe Field](https://docs.gravityforms.com/stripe-field/), [Square Field](https://docs.gravityforms.com/square-field/) and [PayPal Field](https://docs.gravityforms.com/paypal-field/).

The exception to this is the [Authorize.net Add-On](https://docs.gravityforms.com/authorize-net-change-log/), and some of the superceded [PayPal legacy](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/paypa-legacy-add-ons/) add-ons. These are older add-ons built on legacy APIs, and they only support the Gravity Forms credit card field. See the caveat below for additional risks.

## How to Change Your Payment Collection Method

The payment option is contained within [Stripe Add-On settings](https://docs.gravityforms.com/downloading-installing-the-stripe-add-on/#payment-collection-stripe-v2-6-) − refer to [this article for details](https://docs.gravityforms.com/stripe-payment-collection-methods/).
...
If you have any additional questions, please contact our [Support Team](https://www.gravityforms.com/support/) who will be happy to help.

List of relevant links:

[Download official Stripe Add-On](https://www.gravityforms.com/add-ons/stripe/)

[Stripe Add-On Change Log](https://docs.gravityforms.com/stripe-change-log/)

[About Stripe Payment Collection methods](https://docs.gravityforms.com/stripe-payment-collection-methods/)

[Support of SCA](https://docs.gravityforms.com/stripe-support-of-strong-customer-authentication/)

[About SCA](https://stripe.com/docs/strong-customer-authentication)

[Stripe Security and PCI Compliance Validation](https://stripe.com/docs/security#validating-pci-compliance)
...
[Algolia](https://docs.gravityforms.com/deprecation-of-the-gravity-forms-credit-card-field/# "Algolia")
