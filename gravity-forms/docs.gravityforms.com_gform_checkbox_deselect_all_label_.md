---
url: "https://docs.gravityforms.com/gform_checkbox_deselect_all_label/"
title: "gform_checkbox_deselect_all_label - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-description)
- [Usage](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-examples)
- [1\. All forms](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-1-all-forms)
- [2\. Specific form](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-2-specific-form)
- [3\. Specific checkbox field on a form](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-3-specific-checkbox-field-on-a-form)
- [Placement](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-placement)
- [Since](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/#h-source-code)

## Description

The “gform\_checkbox\_deselect\_all\_label” filter in Gravity Forms allows the “Deselect All” label for the [Checkboxes](https://docs.gravityforms.com/checkboxes) field to be modified.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_checkbox_deselect_all_label'``,``'your_function_name'``, 10, 2 );` |

To target a specific form, append the form id to the hook name. (format: gform\_checkbox\_deselect\_all\_label\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_checkbox_deselect_all_label_1'``,``'your_function_name'``, 10, 2 );` |

To target a specific field for a form, append the form id and field id to the hook name. (format: gform\_checkbox\_deselect\_all\_label\_FORMID\_FIELDID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_checkbox_deselect_all_label_1_22'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$select\_label** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_checkbox_deselect_all_label'``,``'change_deselect_label'``, 10, 2 );`<br>`function``change_deselect_label(``$select_label``,``$field``){`<br>```return``"My Custom Deselect All"``;`<br>`}` |

### 2\. Specific form

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_checkbox_deselect_all_label_114'``,``'change_deselect_label'``, 10, 2 );`<br>`function``change_deselect_label(``$select_label``,``$field``){`<br>```return``"My Custom Deselect All"``;`<br>`}` |

### 3\. Specific checkbox field on a form

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_checkbox_deselect_all_label_114_2'``,``'change_deselect_label'``, 10, 2 );`<br>`function``change_deselect_label(``$select_label``,``$field``){`<br>```return``"My Custom Deselect All"``;`<br>`}` |
...
This filter is located in GF\_Field\_Checkbox::get\_checkbox\_choices() in _gravityforms/fields/includes/class-gf-field-checkbox.php_.
...
[Algolia](https://docs.gravityforms.com/gform_checkbox_deselect_all_label/# "Algolia")
