---
url: "https://docs.gravityforms.com/gform_hubspot_output_tracking_script/"
title: "gform_hubspot_output_tracking_script - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_hubspot_output_tracking_script/#h-description)
- [Usage](https://docs.gravityforms.com/gform_hubspot_output_tracking_script/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_hubspot_output_tracking_script/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_hubspot_output_tracking_script/#h-example)
- [Placement](https://docs.gravityforms.com/gform_hubspot_output_tracking_script/#h-placement)
- [Since](https://docs.gravityforms.com/gform_hubspot_output_tracking_script/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_hubspot_output_tracking_script/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_hubspot_output_tracking_script'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$add\_tracking** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_hubspot_output_tracking_script'``,``'__return_false'``);` |
...
This filter is located in GF\_HubSpot::action\_wp\_footer in _class-gf-hubspot.php_.
...
[Algolia](https://docs.gravityforms.com/gform_hubspot_output_tracking_script/# "Algolia")
