---
url: "https://docs.gravityforms.com/gform_paypal_feed_settings_fields/"
title: "gform_paypal_feed_settings_fields - Gravity Forms Documentation"
---
...
# gform\_paypal\_feed\_settings\_fields

- [Description](https://docs.gravityforms.com/gform_paypal_feed_settings_fields/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_feed_settings_fields/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_feed_settings_fields/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_feed_settings_fields/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_paypal_feed_settings_fields/#h-placement)
- [Since](https://docs.gravityforms.com/gform_paypal_feed_settings_fields/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_paypal_feed_settings_fields/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_feed_settings_fields'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$default\_settings** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `add_filter(``'gform_paypal_feed_settings_fields'``,``'add_custom_setting'``, 10, 2 );`<br>`function``add_custom_setting(``$default_settings``,``$form``){`<br>```$default_settings``[0][``'fields'``][] =``array``(`<br>```'name'``=>``'Testing'``,`<br>```'label'``=>``'Testing Label'``,`<br>```'type'``=>``'text'``,`<br>```'class'``=>``'medium'``,`<br>```'required'``=> true,`<br>```'tooltip'``=>``'<h6>Testing. Test</h6>'`<br>```);`<br>```return``$default_settings``;`<br>`}` |
...
This filter is located in GFPayPal::feed\_settings\_fields() in _class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_feed_settings_fields/# "Algolia")
