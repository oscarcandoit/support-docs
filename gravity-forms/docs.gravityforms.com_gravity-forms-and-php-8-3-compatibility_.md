---
url: "https://docs.gravityforms.com/gravity-forms-and-php-8-3-compatibility/"
title: "Gravity Forms and PHP 8.3 Compatibility - Gravity Forms Documentation"
---
...
# Gravity Forms and PHP 8.3 Compatibility

- [Compatibility](https://docs.gravityforms.com/gravity-forms-and-php-8-3-compatibility/#h-compatibility)
- [Reporting Issues](https://docs.gravityforms.com/gravity-forms-and-php-8-3-compatibility/#h-reporting-issues)
- [Known Issues](https://docs.gravityforms.com/gravity-forms-and-php-8-3-compatibility/#h-known-issues)

## Compatibility

PHP 8.3 is a [major new release](https://www.php.net/releases/8.2/en.php) of the PHP language with many changes.

WordPress 6.8+ is currently compatible [with PHP 8.3](https://make.wordpress.org/core/handbook/references/php-compatibility-and-wordpress-versions/). WordPress 6.7.x has beta support for PHP 8.3. Earlier versions of WordPress are not compatible with PHP 8.3.

Gravity Forms is compatible with PHP 8.3.

## Reporting Issues

If you think you have discovered a PHP 8.3-related issue with a Gravity Forms product in your own testing, which isn’t listed below, please let us know by [contacting Support](http://gravityforms.com/support). Thank you for contributing!

## Known Issues

Note that all the issues listed below are fixed in the latest version of Gravity Forms.

The following issues were reported and logged:

- **PHP Deprecated: Function utf8\_encode() is deprecated in /Users/dewey/Sites/prime/wp-content/plugins/gravityforms/includes/form-editor/renderer/class-gf-form-editor-renderer.php on line 30** – fixed in 2.9.8
- **PHP Deprecated: Function utf8\_encode() is deprecated in /Users/dewey/Sites/prime/wp-content/plugins/gravityforms/includes/form-editor/renderer/export.php line 970** – fixed in 2.9.8
...
[Algolia](https://docs.gravityforms.com/gravity-forms-and-php-8-3-compatibility/# "Algolia")
