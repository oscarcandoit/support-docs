---
url: "https://docs.gravityforms.com/setting-up-the-brevo-add-on/"
title: "Setting Up The Brevo Add-On - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Brevo Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/brevo-add-on/)    - [Setting Up The Brevo Add-On](https://docs.gravityforms.com/setting-up-the-brevo-add-on/ "Setting Up The Brevo Add-On")
    - [Creating A Brevo Feed](https://docs.gravityforms.com/creating-a-brevo-feed/ "Creating A Brevo Feed")
    - [Brevo Add-On Changelog](https://docs.gravityforms.com/brevo-add-on-changelog/ "Brevo Add-On Changelog")
...
- [Introduction](https://docs.gravityforms.com/setting-up-the-brevo-add-on/#h-introduction)
- [Setup](https://docs.gravityforms.com/setting-up-the-brevo-add-on/#h-setup)
...
To connect your Brevo account, you will need to complete the following steps:

1. Create a [Brevo account](https://onboarding.brevo.com/account/register).
2. **Authenticate a domain as a Sender Identity in Brevo.**

Adding a “sender identity” to your Brevo account is required to prove ownership of the email address and domain used for outgoing messages. You must complete this step before configuring the Brevo Add-On. Refer to [this help guide](https://docs.gravitysmtp.com/authenticating-a-domain-in-brevo/) for instructions on how to complete this step.
3. **Obtain your Brevo API key**.

This will be required in settings to create the link between Brevo and your website. Refer to [this help guide](https://docs.gravitysmtp.com/getting-a-brevo-api-key/) for instructions on how to find that API key in your Brevo account.
4. Once you have your Brevo API Key, log into your WordPress admin dashboard.
5. On the left side navigation menu, hover over **Forms** and click on **Settings**.
6. From this page, click the **Brevo** tab.
7. Enter the Brevo **API Key** you obtained in step 3.
8. Click **Update Settings**. If you’ve entered your account information correctly, you will be notified by a green check mark beside the box. If you do not see a green check mark, please double check this information and try again.

[![Brevo Settings](https://docs.gravityforms.com/wp-content/uploads/2025/01/image-1.png)](https://docs.gravityforms.com/wp-content/uploads/2025/01/image-1.png)

Once you have entered your API key, you’re ready to [create your first feed](https://docs.gravityforms.com/?p=42347).
...
[Algolia](https://docs.gravityforms.com/setting-up-the-brevo-add-on/# "Algolia")
