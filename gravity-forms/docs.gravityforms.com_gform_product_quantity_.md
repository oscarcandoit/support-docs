---
url: "https://docs.gravityforms.com/gform_product_quantity/"
title: "gform_product_quantity - Gravity Forms Documentation"
---
...
# gform\_product\_quantity

- [Description](https://docs.gravityforms.com/gform_product_quantity/#h-description)
- [Usage](https://docs.gravityforms.com/gform_product_quantity/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_product_quantity/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_product_quantity/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_product_quantity/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_product_quantity/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_product_quantity'``,``'set_quantity_label'``, 10, 2 );` |

You can also target a specific form by adding the form id after the hook name.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_product_quantity_6'``,``'set_quantity_label'``, 10, 2 );` |

## Parameters

- **$sublabel** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_product_quantity_185'``,``'set_quantity_label'``, 10, 2 );`<br>`function``set_quantity_label(``$sublabel``,``$form_id``) {`<br>`return``'How many:'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_product_quantity/# "Algolia")
