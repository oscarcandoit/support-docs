---
url: "https://docs.gravityforms.com/enabling-gravity-forms-toolbar-item/"
title: "Enabling the Gravity Forms Toolbar Menu - Gravity Forms"
---
...
- [Enabling the toolbar menu item](https://docs.gravityforms.com/enabling-gravity-forms-toolbar-item/#h-enabling-the-toolbar-menu-item)
- [Accessing the toolbar menu item](https://docs.gravityforms.com/enabling-gravity-forms-toolbar-item/#h-accessing-the-toolbar-menu-item)
- [Capabilities](https://docs.gravityforms.com/enabling-gravity-forms-toolbar-item/#h-capabilities)
- [Help! I don't see the toolbar!](https://docs.gravityforms.com/enabling-gravity-forms-toolbar-item/#h-help-i-don-t-see-the-toolbar)
...
1. First, access your Gravity Forms settings page. This done by hovering over **Forms** on the left side admin menu, and clicking on **Settings**.

[![Toolbar Menu - Where is it?](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-06-at-10.00.23.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-06-at-10.00.23.png)

2. Once you have accessed the _Settings_ page, locate the option labeled **Toolbar Menu** and turn it on.

[![Toolbar Menu Setting](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-06-at-10.00.35.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-06-at-10.00.35.png)

3. After the _Toolbar Menu_ option is set, save your settings by scrolling down and clicking the **Save Settings** button.
...
| Menu Item | User Capability Required |
| --- | --- |
| **New Form** | gravityforms\_create\_form |
| **All Forms** | gravityforms\_edit\_forms |

These are the submenu items for the individual forms.

| Menu Item | User Capability Required |
| --- | --- |
| **Edit** | gravityforms\_edit\_forms |
| **Entries** | gravityforms\_view\_entries |
| **Settings** | gravityforms\_edit\_forms |
| **Preview** | Preview – gravityforms\_edit\_forms or gravityforms\_create\_form or gravityforms\_preview\_forms |

See the [Role Management](https://docs.gravityforms.com/role-management-guide/) article for more information about the plugin capabilities and how they can be managed.
...
1. Access your user profile within the WordPress admin dashboard. To do so, hover over **Users** on the left side admin menu, and click on **My Profile**.
2. Within this page, you should see an option labeled **Toolbar**. Ensure the checkbox is enabled. If not, enable it and save your changes.
...
[Algolia](https://docs.gravityforms.com/enabling-gravity-forms-toolbar-item/# "Algolia")
