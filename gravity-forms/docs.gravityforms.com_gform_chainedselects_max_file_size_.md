---
url: "https://docs.gravityforms.com/gform_chainedselects_max_file_size/"
title: "gform_chainedselects_max_file_size - Gravity Forms Documentation"
---
...
# gform\_chainedselects\_max\_file\_size

- [Description](https://docs.gravityforms.com/gform_chainedselects_max_file_size/#h-description)
- [Usage](https://docs.gravityforms.com/gform_chainedselects_max_file_size/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_chainedselects_max_file_size/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_chainedselects_max_file_size/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_chainedselects_max_file_size/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_chainedselects_max_file_size/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_chainedselects_max_file_size'``,``'your_function_name'``);` |

## Parameters

- **$size** [int](https://docs.gravityforms.com/int)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_chainedselects_max_file_size'``,``'set_size'``);`<br>`function``set_size(``$size``) {`<br>```return``2000000;``//2mb`<br>`}` |
...
This filter is located in GFChainedSelects::get\_max\_file\_size() in _gravityformschainedselects/class-gf-chainedselects.php_.
...
[Algolia](https://docs.gravityforms.com/gform_chainedselects_max_file_size/# "Algolia")
