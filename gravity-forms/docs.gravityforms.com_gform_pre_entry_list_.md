---
url: "https://docs.gravityforms.com/gform_pre_entry_list/"
title: "gform_pre_entry_list - Gravity Forms Documentation"
---
...
# gform\_pre\_entry\_list

- [Description](https://docs.gravityforms.com/gform_pre_entry_list/#h-description)
- [Usage](https://docs.gravityforms.com/gform_pre_entry_list/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_pre_entry_list/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_pre_entry_list/#h-example)
- [Source Code](https://docs.gravityforms.com/gform_pre_entry_list/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_pre_entry_list/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_pre_entry_list'``,``'your_function_name'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_pre_entry_list'``,``'echo_content'``);`<br>`function``echo_content(``$form_id``) {`<br>```echo``'some content here'``;`<br>`}` |

## Source Code

|     |     |
| --- | --- |
| 1 | `do_action(``'gform_pre_entry_list'``,``$form_id``);` |
...
[Algolia](https://docs.gravityforms.com/gform_pre_entry_list/# "Algolia")
