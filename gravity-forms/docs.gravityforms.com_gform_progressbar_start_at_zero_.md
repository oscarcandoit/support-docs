---
url: "https://docs.gravityforms.com/gform_progressbar_start_at_zero/"
title: "gform_progressbar_start_at_zero - Gravity Forms Documentation"
---
...
# gform\_progressbar\_start\_at\_zero

- [Description](https://docs.gravityforms.com/gform_progressbar_start_at_zero/#h-description)
- [Usage](https://docs.gravityforms.com/gform_progressbar_start_at_zero/#h-usage)
- [Placement](https://docs.gravityforms.com/gform_progressbar_start_at_zero/#h-placement)
- [Since](https://docs.gravityforms.com/gform_progressbar_start_at_zero/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_progressbar_start_at_zero/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_progressbar_start_at_zero'``,``'__return_true'``);` |
...
This filter is located in the following methods in _form\_display.php_:

- GFFormDisplay::get\_form()
- GFFormDisplay::get\_progress\_bar()
...
[Algolia](https://docs.gravityforms.com/gform_progressbar_start_at_zero/# "Algolia")
