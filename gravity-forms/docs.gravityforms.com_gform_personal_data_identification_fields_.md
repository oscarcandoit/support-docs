---
url: "https://docs.gravityforms.com/gform_personal_data_identification_fields/"
title: "gform_personal_data_identification_fields - Gravity Forms"
---
...
# gform\_personal\_data\_identification\_fields

- [Description](https://docs.gravityforms.com/gform_personal_data_identification_fields/#h-description)
- [Usage](https://docs.gravityforms.com/gform_personal_data_identification_fields/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_personal_data_identification_fields/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_personal_data_identification_fields/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_personal_data_identification_fields/#h-placement)
- [Since](https://docs.gravityforms.com/gform_personal_data_identification_fields/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_personal_data_identification_fields/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_personal_data_identification_fields'``,``'your_function_name'``, 10, 2 );` |

To target a specific form, append the form id to the hook name. (format: gform\_personal\_data\_identification\_fields\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_personal_data_identification_fields_1'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$identification\_field\_choices** [array](https://docs.gravityforms.com/array)
...
The example below adds the “created\_by” field as a choice for the identification field.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_personal_data_identification_fields'``,``'add_fields'``, 10, 2 );`<br>`function``add_fields(``$identification_field_choices``,``$form``){`<br>```$identification_field_choices``[``'created_by'``] =``'Created By'``;`<br>```return``$identification_field_choices``;`<br>`}` |
...
This filter is located in GF\_Personal\_Data::form\_settings() in _gravityforms/includes/class-personal-data.php_.
...
[Algolia](https://docs.gravityforms.com/gform_personal_data_identification_fields/# "Algolia")
