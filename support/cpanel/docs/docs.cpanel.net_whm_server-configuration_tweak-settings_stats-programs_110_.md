---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/110/"
title: "Tweak Settings — Stats Programs | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/110/#main-content)
...
4. Tweak Settings — Stats Programs
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/110/#installation-toggle)
...
#### [110](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/110/)

#### [112](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/112/)

#### [116](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/116/)

#### [118](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/118/)

#### [120](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/120/)

#### [124](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/)
...
Statistical analysis programs allow your users to view information about their site visitors. For more configuration options, use WHM’s [_Statistics Software Configuration_](https://docs.cpanel.net/whm/server-configuration/statistics-software-configuration/) interface ( _WHM » Home » Server Configuration » Statistics Software Configuration_).

The _Stats Programs_ section includes the following settings:

| Setting | Description | Values | Default |
| --- | --- | --- | --- |
| _Awstats reverse DNS resolution_ | This setting allows you to specify whether the [_AwStats_](https://docs.cpanel.net/cpanel/metrics/awstats/) statistical analysis program interprets visitors’ domain names as IP addresses. Disable this option to conserve server resources. | - _On_ — Enable.<br>- _Off_ — Disable. | _Off_ |
| _Enable Analog stats_ | This setting allows you to enable the [_Analog_](https://docs.cpanel.net/cpanel/metrics/analog-stats/) statistical analysis program. | - _On_ — Enable.<br>- _Off_ — Disable. | _On_ |
| _Enable Awstats stats_ | This setting allows you to enable the [_AwStats_](https://docs.cpanel.net/cpanel/metrics/awstats/) statistical analysis program. | - _On_ — Enable.<br>- _Off_ — Disable. | _On_ |
| _Enable Webalizer stats_ | This setting allows you to enable the [_Webalizer_](https://docs.cpanel.net/cpanel/metrics/webalizer/) statistical analysis program. | - _On_ — Enable.<br>- _Off_ — Disable. | _On_ |
