...
title: "File Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/files/file-manager/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/files/file-manager/#overview)

* * *

[Change Settings](https://docs.cpanel.net/cpanel/files/file-manager/#change-settings)

* * *

[Character encoding verification dialogs](https://docs.cpanel.net/cpanel/files/file-manager/#character-encoding-verification-dialogs)

* * *

[Working with files and folders](https://docs.cpanel.net/cpanel/files/file-manager/#working-with-files-and-folders)

* * *

[Create or copy files or folders](https://docs.cpanel.net/cpanel/files/file-manager/#create-or-copy-files-or-folders)

* * *

[Move files or folders](https://docs.cpanel.net/cpanel/files/file-manager/#move-files-or-folders)

* * *

[Update file or folder permissions](https://docs.cpanel.net/cpanel/files/file-manager/#update-file-or-folder-permissions)

* * *

[Delete or restore files and folders](https://docs.cpanel.net/cpanel/files/file-manager/#delete-or-restore-files-and-folders)

* * *

[Other item actions](https://docs.cpanel.net/cpanel/files/file-manager/#other-item-actions)

* * *

[Search for an item](https://docs.cpanel.net/cpanel/files/file-manager/#search-for-an-item)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/files/file-manager/#table-of-contents-toggle)
...
![](https://docs.cpanel.net/img/cpanel-icons/file_manager.svg)

_Valid for versions 126 through the latest version_

#### Version:

#### [110](https://docs.cpanel.net/cpanel/files/file-manager/110/)

#### [126](https://docs.cpanel.net/cpanel/files/file-manager/)

Last modified: _2025 September 26_
...
When you edit a file with the _Edit_ or _HTML Editor (Beta)_ actions, an interface appears to confirm the file’s character encoding. Use the menu to select the correct character encoding for the file. Then, click _Edit_ to continue.
...
| --- | --- | --- |
| _Upload_ | Files | Upload individual items, such as files or images.<br>Note:<br>You **cannot** upload a folder through this interface. Create a new folder and upload the desired files into it. |
| _Download_ | Files | Download files to save them locally. |
| _Rename_ | Files, Compressed Files, Folders | Rename the file or folder. |
| _Edit_ | Files | Open the selected file in an editor. <br>Warning:<br>You **cannot** edit a file in this interface if it contains more than one megabyte (1 MB) of data. To edit the file, you **must** download it and use a local editor. |
| _HTML Editor (Beta)_ | Files | Open the selected file in the experimental [HTML Editor](https://docs.cpanel.net/cpanel/files/html-editor/). |
...
| _Password Protect_ | Folders | Set a username and password to restrict access to a folder.<br>Note:<br>Your hosting provider must enable this feature. |
| _Leech Protection_ | Folders | Redirect users who have shared the password to a restricted area of your site. The system will redirect accounts that exceed a set number of logins in a two hour period to a selected URL, or receive an internal server error message.<br>Note:<br>Your hosting provider must enable this feature. |
| _Manage Indices_ | Folders | Customize the way users view a folder on the web.<br>Note:<br>Your hosting provider must enable this feature. |
