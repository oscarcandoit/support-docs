---
url: "https://docs.cpanel.net/cpanel/software/application-manager/102/"
title: "Application Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/software/application-manager/102/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/software/application-manager/102/#overview)

* * *

[Requirements](https://docs.cpanel.net/cpanel/software/application-manager/102/#requirements)

* * *

[Applications](https://docs.cpanel.net/cpanel/software/application-manager/102/#applications)

* * *

[Create an application](https://docs.cpanel.net/cpanel/software/application-manager/102/#create-an-application)

* * *

[Register an application](https://docs.cpanel.net/cpanel/software/application-manager/102/#register-an-application)

* * *

[Environment variables](https://docs.cpanel.net/cpanel/software/application-manager/102/#environment-variables)

* * *

[Add environment variables](https://docs.cpanel.net/cpanel/software/application-manager/102/#add-environment-variables)

* * *

[Edit an application](https://docs.cpanel.net/cpanel/software/application-manager/102/#edit-an-application)

* * *

[Unregister an application](https://docs.cpanel.net/cpanel/software/application-manager/102/#unregister-an-application)

* * *

[Log files](https://docs.cpanel.net/cpanel/software/application-manager/102/#log-files)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/software/application-manager/102/#table-of-contents-toggle)
...
| Package | Description |
| --- | --- |
| `ea-apache24-mod-passenger` | This [package](https://docs.cpanel.net/knowledge-base/web-services/using-passenger-applications) **only** works on systems that run [Ubuntu®](https://docs.cpanel.net/installation-guide/system-requirements-ubuntu/). |
| `ea-ruby24-mod_passenger` | This package **only** works on systems that run CentOS 7. |
| `ea-ruby27-mod_passenger` | This package **only** works on systems that run CentOS 7, [AlmaLinux OS](https://docs.cpanel.net/installation-guide/system-requirements-almalinux/), or [Rocky Linux™](https://docs.cpanel.net/installation-guide/system-requirements-rockylinux/). |
...
| `ea-nodejs16`<br>`ea-nodejs18`<br>`ea-nodejs20`<br>`ea-nodejs22` | These packages provide Node.js™ application support. <br>- `ea-nodejs16` — This is the only Node.js option for servers that run CentOS 7.<br>- `ea-nodejs18` — You cannot use this Node.js option on servers that run CentOS 7.<br>- `ea-nodejs20` — You cannot use this Node.js option on servers that run CentOS 7.<br>- `ea-nodejs22` — You cannot use this Node.js option on servers that run CentOS 7.<br> When you install a Node.js package, it will **uninstall** any other Node.js packages. You **must** update any existing applications to use the new version of Node.js. Any new applications will use the newest installed version of Node.js. |
