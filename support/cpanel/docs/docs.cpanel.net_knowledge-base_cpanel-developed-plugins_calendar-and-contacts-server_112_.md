---
url: "https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/"
title: "Calendar and Contacts Server | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/#overview)

* * *

[Install the Calendar and Contacts Server plugin](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/#install-the-calendar-and-contacts-server-plugin)

* * *

[Uninstall the Calendar and Contacts Server plugin](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/#uninstall-the-calendar-and-contacts-server-plugin)

* * *

[Connect the Calendar and Contacts Server plugin to other devices](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/#connect-the-calendar-and-contacts-server-plugin-to-other-devices)

* * *

[Z-Push - ActiveSync Support](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/#z-push-activesync-support)

* * *

[Requirements for Z-Push - ActiveSync Support](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/#requirements-for-z-push-activesync-support)

* * *

[Uninstall the Z-Push - ActiveSync Support plugin](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/#uninstall-the-z-push-activesync-support-plugin)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/112/#table-of-contents-toggle)
...
Last modified: _2023 October 10_
...
- This plugin does **not** support the Rocky Linux™ 9, AlmaLinux OS 9, or Ubuntu® [operating systems](https://docs.cpanel.net/knowledge-base/third-party/third-party-software-end-of-life-policy/#how-long-will-cpanel-support-my-chosen-operating-system).
