---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/120/"
title: "Tweak Settings | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/120/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/120/#installation-toggle)
...
- [Compression](https://docs.cpanel.net/whm/server-configuration/tweak-settings/compression/120)
- [cPAddons Site Software](https://docs.cpanel.net/whm/server-configuration/tweak-settings/cpaddons-site-software/120)
- [Development](https://docs.cpanel.net/whm/server-configuration/tweak-settings/development/120)
- [Display](https://docs.cpanel.net/whm/server-configuration/tweak-settings/display/120)
- [Domains](https://docs.cpanel.net/whm/server-configuration/tweak-settings/domains/120)
- [Logging](https://docs.cpanel.net/whm/server-configuration/tweak-settings/logging/120)
- [Mail](https://docs.cpanel.net/whm/server-configuration/tweak-settings/mail/120)
- [Notifications](https://docs.cpanel.net/whm/server-configuration/tweak-settings/notifications/120)
- [Packages](https://docs.cpanel.net/whm/server-configuration/tweak-settings/packages/120)
- [PHP](https://docs.cpanel.net/whm/server-configuration/tweak-settings/php/120)
- [Redirection](https://docs.cpanel.net/whm/server-configuration/tweak-settings/redirection/120)
- [Security](https://docs.cpanel.net/whm/server-configuration/tweak-settings/security/120)
- [Software](https://docs.cpanel.net/whm/server-configuration/tweak-settings/software/120)
- [SQL](https://docs.cpanel.net/whm/server-configuration/tweak-settings/sql/120)
- [Stats and Logs](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-and-logs/120)
- [Stats Programs](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/120)
- [Status](https://docs.cpanel.net/whm/server-configuration/tweak-settings/status/120)
- [Support](https://docs.cpanel.net/whm/server-configuration/tweak-settings/support/120)
- [System](https://docs.cpanel.net/whm/server-configuration/tweak-settings/system/120)
