---
url: "https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/"
title: "The checkallsslcerts Script | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/#main-content)
...
[Overview](https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/#overview)

* * *

[What the script does](https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/#what-the-script-does)

* * *

[Run the script](https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/#run-the-script)

* * *

[Options](https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/#options)

* * *

[The allow-retry options](https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/#the-allow-retry-options)

* * *

[Output](https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/#output)

* * *

[Disable a cPanel-signed hostname certificate](https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/#disable-a-cpanel-signed-hostname-certificate)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/scripts/the-checkallsslcerts-script/82/#table-of-contents-toggle)
...
_Valid for versions 82 through 110_
...
Last modified: _2023 February 16_
