---
url: "https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/"
title: "How to Configure MySQL SSL Connections | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#overview)

* * *

[Configure MySQL SSL connections](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#configure-mysql-ssl-connections)

* * *

[Create the directory to store the SSL keys](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#create-the-directory-to-store-the-ssl-keys)

* * *

[Create the SSL keys](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#create-the-ssl-keys)

* * *

[Edit the MySQL configuration](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#edit-the-mysql-configuration)

* * *

[Test the SSL configuration](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#test-the-ssl-configuration)

* * *

[Create a user and allow remote access](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#create-a-user-and-allow-remote-access)

* * *

[Test the remote MySQL connection](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#test-the-remote-mysql-connection)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/security/how-to-configure-mysql-ssl-connections/124/#table-of-contents-toggle)
...
_Valid for versions 124 through 130_
