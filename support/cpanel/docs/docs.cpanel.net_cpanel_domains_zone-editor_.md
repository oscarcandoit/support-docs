---
url: "https://docs.cpanel.net/cpanel/domains/zone-editor/"
title: "Zone Editor | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/domains/zone-editor/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/domains/zone-editor/#overview)

* * *

[Domains](https://docs.cpanel.net/cpanel/domains/zone-editor/#domains)

* * *

[Manage Zone](https://docs.cpanel.net/cpanel/domains/zone-editor/#manage-zone)

* * *

[Add a DNS zone record](https://docs.cpanel.net/cpanel/domains/zone-editor/#add-a-dns-zone-record)

* * *

[Edit a DNS zone record](https://docs.cpanel.net/cpanel/domains/zone-editor/#edit-a-dns-zone-record)

* * *

[Delete a DNS zone record](https://docs.cpanel.net/cpanel/domains/zone-editor/#delete-a-dns-zone-record)

* * *

[Reset zone files](https://docs.cpanel.net/cpanel/domains/zone-editor/#reset-zone-files)

* * *

[DNSSEC](https://docs.cpanel.net/cpanel/domains/zone-editor/#dnssec)

* * *

[DNSSEC Keys table](https://docs.cpanel.net/cpanel/domains/zone-editor/#dnssec-keys-table)

* * *

[Create Key](https://docs.cpanel.net/cpanel/domains/zone-editor/#create-key)

* * *

[Import a DNSSEC key](https://docs.cpanel.net/cpanel/domains/zone-editor/#import-a-dnssec-key)

* * *

[Export a DNSSEC key](https://docs.cpanel.net/cpanel/domains/zone-editor/#export-a-dnssec-key)

* * *

[Public DNSKEY](https://docs.cpanel.net/cpanel/domains/zone-editor/#public-dnskey)

* * *

[DS Records](https://docs.cpanel.net/cpanel/domains/zone-editor/#ds-records)

* * *

[Delete a DNSSEC key](https://docs.cpanel.net/cpanel/domains/zone-editor/#delete-a-dnssec-key)

* * *

[Domain registrar DS records](https://docs.cpanel.net/cpanel/domains/zone-editor/#domain-registrar-ds-records)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/domains/zone-editor/#table-of-contents-toggle)
...
| Action | Description |
| --- | --- |
| _A Record_ | Create a new [A record](https://docs.cpanel.net/cpanel/domains/zone-editor/#a). When you select this record type, a new window will appear. Enter a valid DNS zone name in the _Name_ text box and a valid IPv4 address in the _Address_ text box. Click _Add An A Record_ to save your changes. |
| _CNAME Record_ | Create a new [CNAME](https://docs.cpanel.net/cpanel/domains/zone-editor/#cname) record. When you select this record type, a new window will appear. Enter a valid DNS zone name in the _Name_ text box and a FQDN in the _CNAME_ text box. Click _Add A CNAME Record_ to save your changes. |
| _MX Record_ | Create a new [MX record](https://docs.cpanel.net/cpanel/domains/zone-editor/#mx). When you select this record type, a new window will appear. Enter the record’s priority value in the _Priority_ text box and a FQDN in the _Destination_ text box. Click _Add An MX Record_ to save your changes. |
| _DNSSEC_ | Manage the domain’s [Domain Name System Security Extensions (DNSSEC)](https://docs.cpanel.net/cpanel/domains/zone-editor/#dnssec) records. When you select this record type, the system directs you to the [_DNSSEC_](https://docs.cpanel.net/cpanel/domains/zone-editor/#dnssec) interface. |
| _Manage_ | Add or edit additional domain records. When you click _Manage_, the system directs you to the [_Manage Zone_](https://docs.cpanel.net/cpanel/domains/zone-editor/#manage-zone) interface. |
...
| _Type_ | The [record’s type](https://docs.cpanel.net/cpanel/domains/zone-editor/#dns-zone-record-types). |
| _Record_ | The record’s information. |
| _Actions_ | The option to [edit](https://docs.cpanel.net/cpanel/domains/zone-editor/#edit-a-dns-zone-record) or delete the record. |

You can also use this interface to:

- [Add](https://docs.cpanel.net/cpanel/domains/zone-editor/#add-a-dns-zone-record) or [edit](https://docs.cpanel.net/cpanel/domains/zone-editor/#edit-a-dns-zone-record) one or more DNS zone records.
- [Delete](https://docs.cpanel.net/cpanel/domains/zone-editor/#delete-a-dns-zone-record) a DNS zone record.
- [Reset the zone files](https://docs.cpanel.net/cpanel/domains/zone-editor/#reset-zone-files).
...
- _Email Routing (MX Records and Zone Editor)_
- _Simple Zone Editor (Custom A and CNAME records only)_
- _Advanced Zone Editor (All DNS records except MX)_
...
2. Click _Add Record_. You can also click the arrow icon (![The Add Record arrow icon](https://docs.cpanel.net/img/dns-zone-manager-arrowicon.png)) next to _Add Record_ and select the [desired record type](https://docs.cpanel.net/cpanel/domains/zone-editor/#dns-zone-record-types) from the menu.
...
If you change an existing record’s [_Type_ value](https://docs.cpanel.net/cpanel/domains/zone-editor/#dns-zone-record-types), the system preserves the current record’s data until you save your changes.
...
| Value | Description |
| --- | --- |
| _Name_ | A new or existing DNS zone name alias. |
| _Record_ | Enter a fully qualified domain name (FQDN). For example, the `example.com` domain. You cannot point an ALIAS record to an IP address. |

This record type is **only** available if your system administrator enabled access for it. For more information about ALIAS records, read our [The ALIAS DNS Record](https://docs.cpanel.net/knowledge-base/dns/the-alias-dns-record/) documentation.
...
Canonical Name Record — This record creates an alias for another domain name, which DNS resolves. This is useful, for example, if you point multiple CNAME records to a single [A record](https://docs.cpanel.net/cpanel/domains/zone-editor/#a) in order to simplify DNS maintenance. You can set the following values:
...
When you select this option, the system creates a [TXT record](https://docs.cpanel.net/cpanel/domains/zone-editor/#txt) with a default DMARC record. The system also displays a form that allows you to define the domain’s DMARC _Policy_ ( _None_, _Quarantine_, or _Reject_), as well as the following optional parameters:
...
| Action | Description |
| --- | --- |
| _View DS Records_ | Display the domain’s DS records. The [_DS Records_](https://docs.cpanel.net/cpanel/domains/zone-editor/#ds-records) interface will appear. |
| _Export_ | Export the domain’s DNSSEC key. The [_Export_](https://docs.cpanel.net/cpanel/domains/zone-editor/#export-a-dnssec-key) interface will appear. |

### Create Key

Important:

When you create a domain’s DNSSEC key you **must** also configure a DS record with [your domain registrar](https://docs.cpanel.net/cpanel/domains/zone-editor/#domain-registrar-ds-records).
...
You can use this information to add a DS record to [your domain’s registrar](https://docs.cpanel.net/cpanel/domains/zone-editor/#domain-registrar-ds-records). To do so, perform the following steps:
