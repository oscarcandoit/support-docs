---
url: "https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/"
title: "Notification Templates | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#overview)

* * *

[Available notification templates](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#available-notification-templates)

* * *

[Notification types](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#notification-types)

* * *

[Notification names](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#notification-names)

* * *

[Additional templates and resources](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#additional-templates-and-resources)

* * *

[Available variables](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#available-variables)

* * *

[Customize a template](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#customize-a-template)

* * *

[Example](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#example)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/#table-of-contents-toggle)
...
Last modified: _2024 September 23_
...
Additional WP Toolkit notification templates may be available based on 3rd party installations. For more information, read Plesk’s [WP Toolkit](https://docs.plesk.com/en-US/obsidian/administrator-guide/plesk-administration/wp-toolkit-in-plesk.73391/) documentation.
...
| `Mail/ReconfigureCalendars.*.tmpl` | The system sends a notification email to all users with [Calendar and Contacts Server (CCS)](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/calendar-and-contacts-server/) data. The email tells them to reconfigure their calendars and contacts applications for the [replacement of CCS by the `cpdavd` service](https://docs.cpanel.net/knowledge-base/webmail/cpdavd-service-replaces-ccs-plugin/). | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_Reconfigure CalDAV/CardDAV clients_ |
...
| `Market/SSLCertActionNeeded.*.tmpl` | An SSL certificate purchased through cPanel’s [_SSL/TLS Wizard_](https://docs.cpanel.net/cpanel/security/ssl-tls-wizard/) interface ( _cPanel » Home » Security » SSL/TLS Wizard_) needs validation. | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_Notices concerning goods and services purchased via the cPanel Market_ |
...
| `Market/WHMPluginInstall.*.tmpl` | The system fails to install a WHM plugin that a cPanel user ordered through the [cPanel Store](https://store.cpanel.net/). | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_Notices concerning goods and services purchased via the cPanel Market_ |
...
| `PHPFPM/AccountOverquota.*.tmpl` | An over quota account prevents PHP-FPM from starting on a server that runs in a Virtuozzo environment. | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_PHP-FPM Account is over quota_ |
...
| `Update/UpgradeRequired.*.tmpl` | cPanel & WHM will automatically upgrade a service. | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_Upgrade Required - Service Is Outdated_ |
