---
url: "https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/"
title: "Transfer Tool — Prepare The Source Server | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/#main-content)
...
[Overview](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/#overview) [Set up a source server for transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/#set-up-a-source-server-for-transfer) [Remote server information](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/#remote-server-information) [Authentication](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/#authentication) [Security](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/#security) [Advanced](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/#advanced) [The Account List interface](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/#the-account-list-interface) - [Select What to Transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/select-what-to-transfer/)
...
[**Table of Contents**](https://docs.cpanel.net/whm/transfers/transfer-tool/prepare-a-source-server/#installation-toggle)
