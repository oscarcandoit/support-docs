---
url: "https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/"
title: "MySQL/MariaDB Upgrade | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#main-content)
...
[Overview](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#overview)

* * *

[Before installation](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#before-installation)

* * *

[Installation limitations](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#installation-limitations)

* * *

[CloudLinux’s MySQL Governor](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#cloudlinuxs-mysql-governor)

* * *

[The phpinfo file](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#the-phpinfo-file)

* * *

[Amazon Relational Database Service](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#amazon-relational-database-service)

* * *

[Available versions](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#available-versions)

* * *

[Upgrade or reinstall MySQL or MariaDB](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#upgrade-or-reinstall-mysql-or-mariadb)

* * *

[The MySQL Upgrade Checker Utility](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#the-mysql-upgrade-checker-utility)

* * *

[MySQL upgrade log](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#mysql-upgrade-log)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade/102/#table-of-contents-toggle)
...
_Valid for versions 102 through 112_
