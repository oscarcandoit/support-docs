---
url: "https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/"
title: "Upgrade Database Version | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#main-content)
...
[Overview](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#overview)

* * *

[Before installation](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#before-installation)

* * *

[Installation limitations](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#installation-limitations)

* * *

[CloudLinux’s MySQL Governor](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#cloudlinuxs-mysql-governor)

* * *

[The phpinfo file](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#the-phpinfo-file)

* * *

[Amazon Relational Database Service](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#amazon-relational-database-service)

* * *

[Available versions](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#available-versions)

* * *

[Upgrade or reinstall MySQL or MariaDB](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#upgrade-or-reinstall-mysql-or-mariadb)

* * *

[The MySQL Upgrade Checker Utility](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#the-mysql-upgrade-checker-utility)

* * *

[MySQL upgrade log](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#mysql-upgrade-log)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/#table-of-contents-toggle)
...
- We do **not** support the use of MySQL’s [sha256\_password](https://dev.mysql.com/doc/refman/5.7/en/sha256-pluggable-authentication.html) plugin for MySQL 5.7, MySQL 8.0, MariaDB 10.2, or MariaDB 10.3.
...
- [Upgrade Database Version](https://docs.cpanel.net/whm/database-services/upgrade-database-version/)
