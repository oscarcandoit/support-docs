---
url: "https://docs.cpanel.net/whm/account-functions/modify-an-account/124/"
title: "Modify an Account | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#main-content)
...
[Overview](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#overview)

* * *

[Modify an account](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#modify-an-account)

* * *

[Basic information](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#basic-information)

* * *

[Linked Server Nodes](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#linked-server-nodes)

* * *

[Resource Limits](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#resource-limits)

* * *

[Account Enhancements](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#account-enhancements)

* * *

[Privileges](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#privileges)

* * *

[DNS Settings](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#dns-settings)

* * *

[Package Extensions](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#package-extensions)

* * *

[Package Conflict Resolution](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#package-conflict-resolution)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#table-of-contents-toggle)
...
- If you make changes to the _Resource Limits_, _Privileges_, _DNS Settings_, or _Package Extensions_ sections, the [_Package Conflict Resolution_](https://docs.cpanel.net/whm/account-functions/modify-an-account/124/#package-conflict-resolution) dialog box appears.
