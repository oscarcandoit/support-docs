---
url: "https://docs.cpanel.net/whm/cpanel/install-cpaddons-site-software/104/"
title: "Install cPAddons Site Software | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/cpanel/install-cpaddons-site-software/104/#main-content)
...
[Overview](https://docs.cpanel.net/whm/cpanel/install-cpaddons-site-software/104/#overview)

* * *

[cPanel-managed package managers](https://docs.cpanel.net/whm/cpanel/install-cpaddons-site-software/104/#cpanel-managed-package-managers)

* * *

[Install a cPAddon](https://docs.cpanel.net/whm/cpanel/install-cpaddons-site-software/104/#install-a-cpaddon)

* * *

[Add new vendors](https://docs.cpanel.net/whm/cpanel/install-cpaddons-site-software/104/#add-new-vendors)

* * *

[Delete a vendor](https://docs.cpanel.net/whm/cpanel/install-cpaddons-site-software/104/#delete-a-vendor)

* * *

[cPAddon data after deletion](https://docs.cpanel.net/whm/cpanel/install-cpaddons-site-software/104/#cpaddon-data-after-deletion)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/cpanel/install-cpaddons-site-software/104/#table-of-contents-toggle)
...
We have updated the cPAddons feature to use a package manager to install WordPress®. For more information, read our [Package Manager Basics](https://docs.cpanel.net/ea4/basics/package-manager-basics/) documentation. When you install WordPress through cPAddons with a package manager, you can update WordPress through its own administrative interface. WHM’s _Install cPAddons Site Software_ interface discovers, installs, and uninstalls packages with `yum`. The WebPros International, LLC package manager contains an unaltered WordPress installer package obtained from [wordpress.org](http://wordpress.org/).
...
Manually delete empty cPAddon databases in cPanel’s [_MySQL® Databases_](https://docs.cpanel.net/cpanel/databases/mysql-databases/) interface ( _cPanel_ » _Home_ » _Databases_ » _MySQL® Databases_).
