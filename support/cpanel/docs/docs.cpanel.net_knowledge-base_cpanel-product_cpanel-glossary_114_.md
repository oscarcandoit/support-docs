---
url: "https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/"
title: "cPanel Glossary | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#main-content)
...
[A](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#a)

* * *

[B](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#b)

* * *

[C](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#c)

* * *

[D](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#d)

* * *

[E](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#e)

* * *

[F](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#f)

* * *

[G](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#g)

* * *

[H](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#h)

* * *

[I](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#i)

* * *

[J](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#j)

* * *

[K](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#k)

* * *

[L](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#l)

* * *

[M](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#m)

* * *

[N](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#n)

* * *

[O](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#o)

* * *

[P](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#p)

* * *

[Q](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#q)

* * *

[R](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#r)

* * *

[S](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#s)

* * *

[T](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#t)

* * *

[U](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#u)

* * *

[V](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#v)

* * *

[W](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#w)

* * *

[X](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#x)

* * *

[Y](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#y)

* * *

[Z](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#z)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#table-of-contents-toggle)
...
See [Fully Qualified Domain Name](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#fqdn).
...
- To allow a [Reseller](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#reseller) to assign and unassign Account Enhancements, you must enable the _Use Root Account Enhancements_ privilege in WHM’s [_Edit Reseller Nameservers and Privileges_](https://docs.cpanel.net/whm/resellers/edit-reseller-nameservers-and-privileges) interface ( _WHM » Home » Resellers » Edit Reseller Nameservers and Privileges_).
...
Successful [Domain Control Validation](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#domain-control-validation) (DCV) of a domain applies to all of its subdomains as well. For example, if the `example.com` domain succeeds, the `store.example.com` subdomain would also succeed.
...
A set of programming standards and tools that third-party or internal developers can use to interact with a software application. WebPros International, LLC provides [APIs](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#api) that you can use to customize and integrate with [cPanel or Webmail](https://api.docs.cpanel.net/cpanel/introduction/), [WHM](https://api.docs.cpanel.net/whm/introduction/), and [Manage2](https://docs.cpanel.net/manage2/knowledge-base/guide-to-the-manage2-api).

##### atd

A [daemon](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#daemon) that performs scheduled tasks for the `at` command on Linux operating systems. cPanel & WHM uses the `at` daemon to [check system health after updates](https://docs.cpanel.net/whm/server-configuration/update-preferences).
...
A nameserver that returns responses to queries for one or more [DNS zones](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#dnszones). Name Server (NS) records point to the domain’s authoritative nameserver. These nameservers **don’t** cache DNS information for related domains.
...
A feature in WHM that provides free, [Domain-Validated SSL certificates](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#domain-validated-ssl) to users’ domains.
...
- Use [SPF](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#spf) on your mail server to reduce backscatter.
...
**See also:** [Greylisting](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#greylisting), [Whitelist](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#whitelist).
...
- BoxTrapper Blacklist — A list of incoming email addresses that the [BoxTrapper](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#boxtrapper) application automatically blocks. cPanel automatically sends a configurable warning message when it receives mail from a [blacklisted](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#blacklist) address.

- BoxTrapper Ignore List — A list of incoming email addresses that [BoxTrapper](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#boxtrapper) automatically ignores.
...
- BoxTrapper Whitelist — A list of incoming email addresses that [BoxTrapper](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#boxtrapper) automatically accepts.
...
A file that contains details about an [SSL certificate](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ssl-certificate), such as its issuer and that issuer’s certificates and chain of trust. Browsers include a built-in list of trusted certificate authorities, and compare their lists against CA bundles to determine whether to trust an authority.
...
A non-authoritative [linked node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#linked-node) that receives tasks from a [parent node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#parent-node).
...
The companion software to [WHM](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#whm). WebPros International, LLC designs cPanel to simplify website maintenance for website owners.
...
cPanel’s WebDAV [daemon](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#daemon), which provides access to cPanel’s [_Web Disk_](https://docs.cpanel.net/cpanel/files/web-disk) interface ( _cPanel » Home » Files » Web Disk_).
...
cPanel Service [Daemon](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#daemon), the software that runs cPanel & WHM on your server.
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#release-tiers). We have tested and verified versions on this tier, but they may not contain all of the proposed functionality of a release.
...
The process of moving some or all of a [distributed cPanel account](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#distributed-cpanel-account)’s functionality from a [child node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#child-node) back to the [parent node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#parent-node). For example, returning a cPanel account’s mail functionality from a [Mail Node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#server-profile) child node to the parent node.
...
- This attack is similar to a [brute force attack](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#brute-force).
...
A [brute force attack](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#brute-force) technique. Spammers attempt to find valid email addresses on a server through guesswork and various permutations of common addresses. WHM includes [cPHulk](https://docs.cpanel.net/whm/security-center/cphulk-brute-force-protection/), a protection system that lets you lock out brute force attackers after a specified number of failed attempts.
...
A [CA](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ca) uses Domain Control Validation (DCV) to verify that a certificate requester owns the domain before issuing the certificate. The CA can use one of the three following DCV methods to verify ownership:
...
A digital certificate for [SSL/TLS](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ssl) verification. The [certificate authority (CA)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ca) verifies that the applicant controls the DNS domain via email, phone, or other method.
...
DMARC (Domain-based Message Authentication, Reporting & Conformance) is a technical specification to help reduce the potential for email-based abuse. A DMARC policy uses DNS to confirm that an email message uses a valid [DKIM](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#dkim) and [SPF](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#spf) record, and that the `From:` header matches those records.
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#release-tiers).
...
A variant of [Digital Signature Algorithm](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#DSA) that uses [elliptic-curve cryptography (ECC)](https://en.wikipedia.org/wiki/Elliptic-curve_cryptography). ECDSA provides equivalent security to RSA keys using smaller key sizes. As a result, ECDSA keys generate smaller certificates. Smaller certificates can result in faster connections and website loading times.
...
**See also:** [HELO](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#helo)

An [Extended Simple Mail Transfer Protocol (ESMTP)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#esmtp) command that a mail server or client sends to identify itself when it connects with another mail server.
...
An extension of the original [Simple Mail Transfer Protocol (SMTP)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#smtp)’s protocols. ESMTP sends an [EHLO](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ehlo) request to a mail server or client to identify the server’s supported protocol. The server returns a list of its available ESMTP commands.

##### Extended Validation (EV) Certificate

A digital certificate for [SSL/TLS](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ssl) verification. The [certificate authority (CA)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ca) verifies that the applicant controls the DNS domain with a comprehensive identity validation process.
...
See [Bug](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#bug).
...
- **Only** use a forceful reboot if you **cannot** [reboot gracefully](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#graceful-reboot), because it can result in data loss.
...
A value that the system uses to identify a resource, similar to [UUID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#uuid). UUID is the more common identifier while Microsoft products are the main users of GUID.
...
- This is the opposite of a [forceful reboot](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#forceful-reboot).
- You can perform forceful and graceful reboots [in the WHM interface](https://docs.cpanel.net/whm/system-reboot/system-reboot/).

##### Greylisting

**See also:** [Blacklist](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#blacklist), [Whitelist](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#whitelist)
...
- Unix and Linux systems often use gzip with the [tar](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#tar) command to create a tarball file, which uses the `.tar.gz` file extension.
...
- The server hostname is distinct from your [domain name](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#domain-name).
...
A [CLI](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#cli) configuration that restricts users’ access rights. The system limits shell sessions to a filesystem that does not contain the home directories of other cPanel users on the system.
...
A node that a server administrator designates to either assign tasks to or receive tasks from another node. For example, a [parent node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#parent-node) may assign all mail tasks for a cPanel account to a [child node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#child-node).
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#release-tiers). WebPros International, LLC supports this version for a period of one year before designating the next LTS version.
...
A server that sends mail to and receives mail from other servers. Mail exchangers use [MX entries](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#mail-exchanger-mx-entry) to determine where to send mail.
...
A program that sends and receives email messages. [Exim](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#exim) is an MTA.
...
[Mailing list](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#mailinglist) software that sends email messages to a group of specified email addresses.
...
**See also:** [UID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#uid)

A Unix or Linux system account with the UID of `99`. This system account executes [CGI](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#cgi) and [PHP](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#php) scripts if [suEXEC](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#suexec) is disabled.
...
A standard for third-party authentication. cPanel & WHM’s [External Authentication](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#external-authentication) feature uses OpenID Connect to communicate with third-party authentication providers.
...
The background software that runs all of the other software applications on your system. The OS is a required part of any server or computer. cPanel & WHM supports specific versions of the [AlmaLinux OS](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#almalinux), [Rocky Linux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#rockylinux), [CloudLinux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#cloudlinux), and [Ubuntu](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ubuntu) operating systems.
...
A digital certificate used for [SSL/TLS](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ssl) verification. The [certificate authority (CA)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ca) verifies that the applicant controls the DNS domain through a vetting process. These certificates enable HTTPS on a user’s web browser address bar and state that the site is secure with a Secure Site Seal.

- These certificates are more secure than a [DV certificate](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#domain-validated-ssl).
- You can purchase and install certificates in cPanel’s [_SSL/TLS Wizard_](https://docs.cpanel.net/cpanel/security/ssl-tls-wizard) interface ( _cPanel » Home » Security » SSL/TLS Wizard_).
...
2. A collection of software that publishers bundle together for distribution and installation. WebPros International, LLC provides various third-party software, such as [FTP](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ftp) and [MySQL](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#mysql), as [packages](https://docs.cpanel.net/knowledge-base/rpm-versions) that the `rpm.versions` system manages.

##### Parent Node

An authoritative [linked node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#linked-node) that assigns tasks to one or more [child nodes](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#child-node).
...
- Perl applications are commonly `.pl`, `.pm`, and `.cgi` files and may require [Perl modules](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#perl-modules).
...
A computer scripting language that many web-based applications use. Some PHP applications require [PEAR packages](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#pear).
...
- Encryption schemes use a pair of keys (one [public key](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#public-key) and one private key) to create a secret code.
...
**See also:** [Private Key](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#private-key)
...
- [CloudLinux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#cloudlinux)
- [AlmaLinux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#almalinux)
- [Rocky Linux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#rockylinux)
...
**See also:** [Domain Forwarding](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#domain-forwarding)
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#release-tiers). Versions on this tier are feature-complete and well-tested.
...
**See also:** [Restoration](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#restoration)
...
1. Specific to Unix and Unix-based systems, the system account. The system administrator uses this account, and it carries full privileges to configure a computer system. See [UID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#uid).
...
A collection of [server roles](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#server-roles) that allow you to optimize a server to perform a specific task or function.
...
This protocol is the standard by which you transmit email messages across the internet. Use SMTP to send mail to a mail server’s [Mail Transfer Agent (MTA)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#mta).
...
An attack in which attackers appear as another user through the falsification of data, in order to conceal their identities. Enable [SPF](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#spf) to make it more difficult for spammers to spoof a domain.
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#release-tiers). Versions on this tier have received considerable public exposure, testing, and verification.
...
An Apache feature that allows users to run CGI and SSI applications on the system as themselves. By default, the system account (the `nobody` account with a [UID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#uid) of `99`) executes CGI and SSI.

## T

##### Tar

A program that collates files for transfer or distribution. The system usually compresses files that this program processes into [tarballs](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#tarball).
...
- `99` — `nobody`, the default executor of [CGI](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#cgi) scripts, if [suEXEC](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#suexec) is disabled. The system reserves UIDs `0` through `100` for system accounts like `admin` and `root`.
...
Encodes information within a [Uniform Resource Identifier (URI)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#uri). In URI encoding, you must convert characters that browsers reserve for URL formatting into percent-encoded characters (for example, encode the forward slash (`/`) as `%2F`).
...
A value that the system uses to identify a resource, similar to [GUID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#guid). UUID is the more common identifier while Microsoft products are the main users of GUID.
...
**See also:** [Dynamic DNS (DDNS) Domain](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#ddns).
...
A program, such as [Apache](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#apache), which receives requests from clients (browsers), retrieves the requested webpages, and serves them.
...
Companion software to [cPanel](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#cpanel), which we design for hosting providers, resellers, and system administrators.
...
**See also:** [Blacklist](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#blacklist), [Greylisting](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#greylisting).
...
An administrative space or portion of the [Domain Name System](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/#dns). This space directs internet traffic to the correct location. For example, `example.com` is a DNS zone whose servers direct its internet traffic.
