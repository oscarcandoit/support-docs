---
url: "https://docs.cpanel.net/whm/sql-services/configure-postgresql/"
title: "Configure PostgreSQL | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/sql-services/configure-postgresql/#main-content)
...
[Overview](https://docs.cpanel.net/whm/sql-services/configure-postgresql/#overview)

* * *

[Postgres Config Install](https://docs.cpanel.net/whm/sql-services/configure-postgresql/#postgres-config-install)

* * *

[Create Postgres Users](https://docs.cpanel.net/whm/sql-services/configure-postgresql/#create-postgres-users)

* * *

[Postgres Password](https://docs.cpanel.net/whm/sql-services/configure-postgresql/#postgres-password)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/sql-services/configure-postgresql/#table-of-contents-toggle)
...
#### [118](https://docs.cpanel.net/whm/sql-services/configure-postgresql/)
...
This interface allows you to complete the [PostgreSQL® installation process](https://docs.cpanel.net/knowledge-base/sql/install-or-update-postgresql-on-your-cpanel-server/), create PostgreSQL users, and update your PostgreSQL password.
