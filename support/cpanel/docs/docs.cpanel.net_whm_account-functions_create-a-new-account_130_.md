---
url: "https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/"
title: "Create a New Account | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#main-content)
...
[Overview](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#overview)

* * *

[Domain Information](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#domain-information)

* * *

[Package](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#package)

* * *

[Account Enhancements](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#account-enhancements)

* * *

[Manual Resource Options](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#manual-resource-options)

* * *

[Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#settings)

* * *

[Mail Routing Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#mail-routing-settings)

* * *

[Package Extensions](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#package-extensions)

* * *

[Reseller Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#reseller-settings)

* * *

[DNS Settings](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#dns-settings)

* * *

[Create the account](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#create-the-account)

* * *

[Visitor experience](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#visitor-experience)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#table-of-contents-toggle)
...
- _Domain_ — The domain name for the account (for example, `example.com`). You may choose one of the following two options:

  - _Use a domain that you own_ — Use a registered domain.
  - _Choose a domain later_ — cPanel & WHM will assign a [temporary domain name](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#temporary-domains) to the account.
...
- You can **only** assign a temporary domain name during account creation. You **cannot** change an existing cPanel account to use a temporary domain.
...
A temporary domain is an automatically-generated `cpanel.site` subdomain that acts as a cPanel user’s [primary domain](https://docs.cpanel.net/cpanel/the-cpanel-interface/the-cpanel-interface/#primary-domain). You can use a temporary domain to design and collaborate with others on a website without a [registered domain](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#registered-domain).

Accounts with temporary domains cannot use email services. cPanel & WHM does not support using temporary domains with [Search Engine Optimization](https://docs.cpanel.net/cpanel/domains/search-engine-optimization/). You **cannot** edit a temporary domain’s DNS information.

Additionally, search engines do not rank temporary domains, and they do not affect SEO.

To update the cPanel account to a registered domain, use WHM’s [_Modify an Account_](https://docs.cpanel.net/whm/account-functions/modify-an-account) interface ( _WHM » Home » Account Functions » Modify an Account_).
...
The _Manual Resource Options_ section appears when you select the _Select package options manually_ checkbox in the [_Package_](https://docs.cpanel.net/whm/account-functions/create-a-new-account/130/#package) section.
...
Accounts with temporary domains will **not** be able to route mail until you [replace the temporary domain with a registered domain](https://docs.cpanel.net/whm/account-functions/modify-an-account/#basic-information).
