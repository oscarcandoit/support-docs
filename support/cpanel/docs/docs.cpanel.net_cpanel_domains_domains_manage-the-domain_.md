...
[Skip to main content](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#overview) [Update the domain](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#update-the-domain) [Temporary domains](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#temporary-domains) [New document root](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#new-document-root) [Domain information](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#domain-information) [Remove the domain](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#remove-the-domain) [Email accounts when you remove a domain](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#email-accounts-when-you-remove-a-domain) [Additional Resources](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#additional-resources)

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/domains/domains/manage-the-domain/#installation-toggle)
...
This section allows you to change your domain from a temporary to a registered domain and update your document root.

### Temporary domains

If your account uses a [temporary domain](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#temporary-domain), select the _Replace with a registered domain_ option to update the account to use a registered domain.
...
Enter the new domain name in the _Replace with a registered domain_ text box and click _Update_.

Note:

You **cannot** change the _Main Domain_ from a temporary domain to a registered domain in cPanel. Contact your hosting provider to update your main domain.
