---
url: "https://docs.cpanel.net/knowledge-base/third-party/the-lets-encrypt-plugin/108/"
title: "The Let's Encrypt Plugin | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/third-party/the-lets-encrypt-plugin/108/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/third-party/the-lets-encrypt-plugin/108/#overview)

* * *

[Wildcard domains](https://docs.cpanel.net/knowledge-base/third-party/the-lets-encrypt-plugin/108/#wildcard-domains)

* * *

[Installation](https://docs.cpanel.net/knowledge-base/third-party/the-lets-encrypt-plugin/108/#installation)

* * *

[Recreate your registration](https://docs.cpanel.net/knowledge-base/third-party/the-lets-encrypt-plugin/108/#recreate-your-registration)

* * *

[Uninstall the plugin](https://docs.cpanel.net/knowledge-base/third-party/the-lets-encrypt-plugin/108/#uninstall-the-plugin)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/third-party/the-lets-encrypt-plugin/108/#table-of-contents-toggle)
...
This plugin allows the AutoSSL feature to issue certificates from the [Let’s Encrypt™](https://letsencrypt.org/) provider. You can use this plugin as an alternative to cPanel’s [default provider (powered by Sectigo)](https://docs.cpanel.net/knowledge-base/security/guide-to-ssl/#autossl-providers). Let’s Encrypt allows you to secure [wildcard domains](https://en.wikipedia.org/wiki/Wildcard_DNS_record), which the default provider cannot do. It also issues certificates faster than the default provider. However, unlike the default provider, Let’s Encrypt imposes significant [rate and domain limits](https://letsencrypt.org/docs/rate-limits). For more information, read our [Guide to SSL](https://docs.cpanel.net/knowledge-base/security/guide-to-ssl) documentation.

Important:

- This plugin does **not** generate hostname certificates for your system’s services. It only generates SSL certificates for your cPanel accounts. For more information, read our [Manage AutoSSL](https://docs.cpanel.net/whm/ssl-tls/manage-autossl) documentation.
- Let’s Encrypt provides all future SSL and Wildcard SSL certificates when you select Let’s Encrypt as your default provider. For more information on generating SSL certificates, read our [Generate an SSL Certificate and Signing Request](https://docs.cpanel.net/whm/ssl-tls/generate-an-ssl-certificate-and-signing-request/) documentation.
...
3. Log in to WHM and navigate to the [_Manage AutoSSL_](https://docs.cpanel.net/whm/ssl-tls/manage-autossl) interface ( _WHM_ » _Home_ » _SSL/TLS_ » _Manage AutoSSL_).

4. In the _Providers_ tab, select the _Let’s Encrypt™_ option. The interface will display the _Terms of Service_ section.

5. Review Let’s Encrypt’s terms of service. If you agree, select the _I agree to these terms of service_ option.
