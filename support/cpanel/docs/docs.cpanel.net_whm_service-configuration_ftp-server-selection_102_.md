---
url: "https://docs.cpanel.net/whm/service-configuration/ftp-server-selection/102/"
title: "FTP Server Selection | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/service-configuration/ftp-server-selection/102/#main-content)
...
[Overview](https://docs.cpanel.net/whm/service-configuration/ftp-server-selection/102/#overview)

* * *

[How to select an FTP daemon](https://docs.cpanel.net/whm/service-configuration/ftp-server-selection/102/#how-to-select-an-ftp-daemon)

* * *

[Pure-FTPd and ProFTPD](https://docs.cpanel.net/whm/service-configuration/ftp-server-selection/102/#pure-ftpd-and-proftpd)

* * *

[Troubleshoot unmanaged FTP services](https://docs.cpanel.net/whm/service-configuration/ftp-server-selection/102/#troubleshoot-unmanaged-ftp-services)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/service-configuration/ftp-server-selection/102/#table-of-contents-toggle)
