---
url: "https://docs.cpanel.net/whm/email/email-deliverability-in-whm/"
title: "Email Deliverability in WHM | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#main-content)
...
[Overview](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#overview)

* * *

[Manage the Domain](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#manage-the-domain)

* * *

[DKIM](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#dkim)

* * *

[Suggested DKIM record](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#suggested-dkim-record)

* * *

[The DSO PHP handler without ModRuid2 or MPM ITK](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#the-dso-php-handler-without-modruid2-or-mpm-itk)

* * *

[SPF](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#spf)

* * *

[Suggested SPF record](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#suggested-spf-record)

* * *

[Customize an SPF record](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#customize-an-spf-record)

* * *

[DMARC](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#dmarc)

* * *

[Suggested DMARC record](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#suggested-dmarc-record)

* * *

[Reverse DNS (PTR)](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#reverse-dns-ptr)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/email/email-deliverability-in-whm/#table-of-contents-toggle)
...
This section allows you to set the server’s [DMARC](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#domain-based-message-authentication-reporting-and-conformance-dmarc) record. A DMARC record sets a policy that tells servers how to handle mail based on the domain’s SPF and DKIM records.

Important:

DMARC **requires** valid SPF and DKIM records. The server’s hostname domain **must** have valid SPF and DKIM records for the DMARC record to be active.

### Suggested DMARC record

Use the _Suggested DMARC (TXT) Record_ section to copy or install the system’s recommended DMARC record for your server’s hostname. To add the DMARC record, perform **one** of the following actions:

- If your server is **not** an authoritative nameserver for the hostname’s domain, click _Copy_ to copy the _Name_ and _Value_ records that the system provides, then add the records to an authoritative nameserver.
- If your server **is** an authoritative nameserver for the hostname’s domain, click _Install the Suggested Record_ to install the DMARC record on your cPanel & WHM server.
