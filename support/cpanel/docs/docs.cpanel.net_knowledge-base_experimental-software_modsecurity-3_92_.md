---
url: "https://docs.cpanel.net/knowledge-base/experimental-software/modsecurity-3/92/"
title: "ModSecurity® 3 | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/experimental-software/modsecurity-3/92/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/experimental-software/modsecurity-3/92/#overview)

* * *

[Compatibility](https://docs.cpanel.net/knowledge-base/experimental-software/modsecurity-3/92/#compatibility)

* * *

[Install ModSecurity 3](https://docs.cpanel.net/knowledge-base/experimental-software/modsecurity-3/92/#install-modsecurity-3)

* * *

[Configuration files](https://docs.cpanel.net/knowledge-base/experimental-software/modsecurity-3/92/#configuration-files)

* * *

[ModSecurity Rules](https://docs.cpanel.net/knowledge-base/experimental-software/modsecurity-3/92/#modsecurity-rules)

* * *

[Differences between ModSecurity 2 and ModSecurity 3](https://docs.cpanel.net/knowledge-base/experimental-software/modsecurity-3/92/#differences-between-modsecurity-2-and-modsecurity-3)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/experimental-software/modsecurity-3/92/#table-of-contents-toggle)
...
_Valid for versions 92 through 110_
...
ModSecurity 3 is **only** compatible with CentOS 7 on systems that run NGINX.
