---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/116/"
title: "Tweak Settings | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/116/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/116/#installation-toggle)
...
- [Compression](https://docs.cpanel.net/whm/server-configuration/tweak-settings/compression/116)
- [cPAddons Site Software](https://docs.cpanel.net/whm/server-configuration/tweak-settings/cpaddons-site-software/116)
- [Development](https://docs.cpanel.net/whm/server-configuration/tweak-settings/development/116)
- [Display](https://docs.cpanel.net/whm/server-configuration/tweak-settings/display/116)
- [Domains](https://docs.cpanel.net/whm/server-configuration/tweak-settings/domains/116)
- [Logging](https://docs.cpanel.net/whm/server-configuration/tweak-settings/logging/116)
- [Mail](https://docs.cpanel.net/whm/server-configuration/tweak-settings/mail/116)
- [Notifications](https://docs.cpanel.net/whm/server-configuration/tweak-settings/notifications/116)
- [Packages](https://docs.cpanel.net/whm/server-configuration/tweak-settings/packages/116)
- [PHP](https://docs.cpanel.net/whm/server-configuration/tweak-settings/php/116)
- [Redirection](https://docs.cpanel.net/whm/server-configuration/tweak-settings/redirection/116)
- [Security](https://docs.cpanel.net/whm/server-configuration/tweak-settings/security/116)
- [Software](https://docs.cpanel.net/whm/server-configuration/tweak-settings/software/116)
- [SQL](https://docs.cpanel.net/whm/server-configuration/tweak-settings/sql/116)
- [Stats and Logs](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-and-logs/116)
- [Stats Programs](https://docs.cpanel.net/whm/server-configuration/tweak-settings/stats-programs/116)
- [Status](https://docs.cpanel.net/whm/server-configuration/tweak-settings/status/116)
- [Support](https://docs.cpanel.net/whm/server-configuration/tweak-settings/support/116)
- [System](https://docs.cpanel.net/whm/server-configuration/tweak-settings/system/116)
