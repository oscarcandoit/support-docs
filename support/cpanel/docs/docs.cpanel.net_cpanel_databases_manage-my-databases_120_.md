---
url: "https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/"
title: "Manage My Databases | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#overview)

* * *

[Create a database](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#create-a-database)

* * *

[Remote Database Host](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#remote-database-host)

* * *

[Modify Databases](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#modify-databases)

* * *

[Check a database](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#check-a-database)

* * *

[Repair a database](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#repair-a-database)

* * *

[Current Databases](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#current-databases)

* * *

[Rename a database](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#rename-a-database)

* * *

[Delete a database](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#delete-a-database)

* * *

[Add a user](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#add-a-user)

* * *

[Add a user to a database](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#add-a-user-to-a-database)

* * *

[Current Users](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#current-users)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#table-of-contents-toggle)
...
[MySQL 5.6 and earlier](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#mysql-5-6-and-earlier1764175694893125723)
...
[MySQL 5.7 and later](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#mysql-5-7-and-later1764175694893208903)
...
[MariaDB](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#mariadb1764175694893277063)
...
- This value corresponds to the user’s `DB_PASSWORD` value. However, cPanel & WHM does **not** reveal this value. If you forget the value, you must [change the user’s password](https://docs.cpanel.net/cpanel/databases/manage-my-databases/120/#current-users).
