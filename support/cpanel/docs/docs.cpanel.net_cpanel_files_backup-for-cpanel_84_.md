---
url: "https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/"
title: "Backup for cPanel | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#overview)

* * *

[Full Backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#full-backup)

* * *

[Generate a Full Backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#generate-a-full-backup)

* * *

[Account Backups](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#account-backups)

* * *

[Partial Backups](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#partial-backups)

* * *

[Download a Home Directory Backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#download-a-home-directory-backup)

* * *

[Download a MySQL Database Backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#download-a-mysql-database-backup)

* * *

[Download Email Forwarders](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#download-email-forwarders)

* * *

[Download Email Filters](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#download-email-filters)

* * *

[Restore a partial backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#restore-a-partial-backup)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#table-of-contents-toggle)
...
_Valid for versions 84 through 118_
...
In this section, click _Download a Full Account Backup_ to create, download, or store a full backup file. The [_Generate a Full Backup_](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#generate-a-full-backup) interface will appear.
...
1. Select a storage location from the _Backup Destination_ menu:
   - [_Home Directory_](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/84/#home-directory-backup-file-contents) — Select this setting to save the backup file on the server. You can access it with SSH or through the [_File Manager_](https://docs.cpanel.net/cpanel/files/file-manager/) interface ( _cPanel » Home » Files » File Manager_).
...
1. Click _Choose File_ under the appropriate heading. For example, to restore a MySQL® database, click _Choose File_ under the _Restore a MySQL Database Backup_ heading.
