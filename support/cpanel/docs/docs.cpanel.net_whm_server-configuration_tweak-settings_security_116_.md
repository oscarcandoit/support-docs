---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/security/116/"
title: "Tweak Settings — Security | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/security/116/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/security/116/#installation-toggle)
