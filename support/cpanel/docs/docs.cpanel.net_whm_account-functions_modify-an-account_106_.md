---
url: "https://docs.cpanel.net/whm/account-functions/modify-an-account/106/"
title: "Modify an Account | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#main-content)
...
[Overview](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#overview)

* * *

[Modify an account](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#modify-an-account)

* * *

[Basic information](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#basic-information)

* * *

[Linked Server Nodes](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#linked-server-nodes)

* * *

[Resource Limits](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#resource-limits)

* * *

[Account Enhancements](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#account-enhancements)

* * *

[Privileges](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#privileges)

* * *

[DNS Settings](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#dns-settings)

* * *

[Package Extensions](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#package-extensions)

* * *

[Package Conflict Resolution](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#package-conflict-resolution)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#table-of-contents-toggle)
...
_Valid for versions 106 through 122_
...
- If you make changes to the _Resource Limits_, _Privileges_, _DNS Settings_, or _Package Extensions_ sections, the [_Package Conflict Resolution_](https://docs.cpanel.net/whm/account-functions/modify-an-account/106/#package-conflict-resolution) dialog box appears.
...
Changing the primary domain will also update usernames for any email, FTP, or Web Disk accounts that use the primary domain, and will update your DNS records to map your primary domain’s IP addresses to the new domain name. The account’s files and home directories for FTP and Web Disk service accounts will **not** change.
