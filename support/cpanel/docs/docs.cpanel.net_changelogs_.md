...
title: "Change Logs | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/changelogs/#main-content)
...
#### [132 Change Log](https://docs.cpanel.net/changelogs/132-change-log/)

This document lists the cases and bugs worked on during the version 132 release cycle.

[Read more](https://docs.cpanel.net/changelogs/132-change-log/)

#### [130 Change Log](https://docs.cpanel.net/changelogs/130-change-log/)

This document lists the cases and bugs worked on during the version 130 release cycle.

[Read more](https://docs.cpanel.net/changelogs/130-change-log/)

#### [128 Change Log](https://docs.cpanel.net/changelogs/128-change-log/)

This document lists the cases and bugs worked on during the version 128 release cycle.

[Read more](https://docs.cpanel.net/changelogs/128-change-log/)
...
#### [Let's Encrypt™ Change Log](https://docs.cpanel.net/changelogs/lets-encrypt-change-log/)
...
#### [Search Engine Optimization Change Log](https://docs.cpanel.net/changelogs/search-engine-optimization-change-log/)

This document provides the list of changes to the Search Engine Optimization feature.

[Read more](https://docs.cpanel.net/changelogs/search-engine-optimization-change-log/)
...
#### [Social Media Management (Powered by Social Bee) Change Log](https://docs.cpanel.net/changelogs/social-media-management-powered-by-social-bee-change-log/)

This document provides the list of changes for the Social Media Management (Powered by SocialBee) plugin.

[Read more](https://docs.cpanel.net/changelogs/social-media-management-powered-by-social-bee-change-log/)
