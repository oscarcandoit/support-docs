---
url: "https://docs.cpanel.net/cpanel/email/create-an-email-account/"
title: "Create an Email Account | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/email/create-an-email-account/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/email/create-an-email-account/#overview) [Create a new email account](https://docs.cpanel.net/cpanel/email/create-an-email-account/#create-a-new-email-account) [Optional Settings](https://docs.cpanel.net/cpanel/email/create-an-email-account/#optional-settings) [Using this interface](https://docs.cpanel.net/cpanel/email/create-an-email-account/#using-this-interface) - [Manage Email Accounts](https://docs.cpanel.net/cpanel/email/manage-email-accounts/)
- [Set Up Mail Client](https://docs.cpanel.net/cpanel/email/set-up-mail-client/)

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/email/create-an-email-account/#installation-toggle)
