---
url: "https://docs.cpanel.net/cpanel/preferences/manage-team/110/"
title: "Manage Team | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#overview) [Team users](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#team-users) [Roles](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#roles) [Services](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#services) [Team user preferences](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#team-user-preferences) [List team table](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#list-team-table) [View audit log](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#view-audit-log) - [Audit Log](https://docs.cpanel.net/cpanel/preferences/manage-team-audit-log/)
...
[**Table of Contents**](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#installation-toggle)
...
| User | Description |
| --- | --- |
| Team user **without** [role](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#roles) | A team user without a role can:<br>- Log in to cPanel.<br>- Update their password.<br>- Change the default interface language.<br>- Update their contact information.<br>- Access [services](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#services) that the team owner assigns.<br> A team owner can create an **unlimited** number of team users without roles. |
| Team user **with** [role](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#roles) | A team user with roles can:<br>- Log in to cPanel.<br>- Update their password.<br>- Change the default interface language.<br>- Update their contact information.<br>- Access [services](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#services) that the team owner assigns.<br>- Perform the [role’s](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#roles) associated administrative functions.<br> A team owner can **only** assign roles to seven team users. |
...
| Item | Description |
| --- | --- |
| _Username_ | The team user’s login username. If the team user is suspended, the _Suspended_ ( ![Suspended warning](https://docs.cpanel.net/img/manage-team-warning-suspended.png) ) warning will appear next to the team user’s username. Click the _More_ (![More](https://docs.cpanel.net/img/columnmore.png)) icon to view more information about a team user account. This will display the [team user’s information](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#team-user-information). |
| [_Roles_](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#roles) | The team user’s assigned role(s) if applicable. |
| _Last Login Date_ | The last time the team user logged in to the account. |
| [_Services_](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#services-for-team-users) | The services available to the team user. |
| [_Actions_](https://docs.cpanel.net/cpanel/preferences/manage-team/110/#actions) | The actions available to manage the team user. |

#### Team user information

| Item | Description |
| --- | --- |
| _Suspension Information_ | If the team user is suspended, the interface will display the date of the suspension and the reason for the suspension. If the team owner does not provide a suspension reason, this field will be blank. |
