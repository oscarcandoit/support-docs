---
url: "https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/"
title: "MySQL® Database Wizard | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/#overview)

* * *

[Set up a database](https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/#set-up-a-database)

* * *

[Additional options](https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/#additional-options)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/#table-of-contents-toggle)
...
#### [106](https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/)
...
- In cPanel & WHM version 120 and later, we renamed this interface to [_Database Wizard_](https://docs.cpanel.net/cpanel/databases/database-wizard/).
- To create additional databases or users, you can also use the [_MySQL® Databases_](https://docs.cpanel.net/cpanel/databases/mysql-databases/) interface ( _cPanel » Home » Databases » MySQL® Databases_).
...
[MySQL 5.6 and earlier](https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/#mysql-5-6-and-earlier1764175694904444636)
...
[MySQL 5.7 and later](https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/#mysql-5-7-and-later1764175694904518916)
...
[MariaDB](https://docs.cpanel.net/cpanel/databases/mysql-database-wizard/#mariadb1764175694904575418)
...
5. Select the checkboxes that correspond to the privileges that you want to grant the user, or select _ALL PRIVILEGES._ For more information about user privileges, read the [MySQL documentation](http://dev.mysql.com/doc/).
...
- _Add another MySQL Databases User_ — Click to open the [_MySQL® Databases_](https://docs.cpanel.net/cpanel/databases/mysql-databases/) interface ( _cPanel » Home » Databases » MySQL® Databases_) to create additional user accounts and assign them to a database.
...
When you use the _MySQL Database Wizard_ interface to add a user and a database, the system automatically grants the user access to the database. You do **not** need to use the _Add User to Database_ feature in the [_MySQL® Databases_](https://docs.cpanel.net/cpanel/databases/mysql-databases/) interface ( _cPanel » Home » Databases » MySQL® Databases_).
