---
url: "https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/"
title: "Manage AutoSSL | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#main-content)
...
[Overview](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#overview)

* * *

[Provider information](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#provider-information)

* * *

[AutoSSL providers](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#autossl-providers)

* * *

[Providers](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#providers)

* * *

[Terms of Service](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#terms-of-service)

* * *

[Options](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#options)

* * *

[Notifications](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#notifications)

* * *

[Allow AutoSSL to replace invalid or expiring non-AutoSSL certificates](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#allow-autossl-to-replace-invalid-or-expiring-non-autossl-certificates)

* * *

[Logs](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#logs)

* * *

[Manage Users](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#manage-users)

* * *

[Run AutoSSL Check](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#run-autossl-check)

* * *

[Pending Queue](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#pending-queue)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/ssl-tls/manage-autossl/114/#table-of-contents-toggle)
...
In cPanel & WHM versions 112 and earlier, the system uses the _cPanel (powered by Sectigo)_ provider by default. When you upgrade from earlier versions, the upgrade will preserve your existing AutoSSL configuration.
