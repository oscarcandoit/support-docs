---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/security/120/"
title: "Tweak Settings — Security | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/security/120/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/security/120/#installation-toggle)
