---
url: "https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/"
title: "Exim Configuration Manager Basic Editor | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#main-content)
...
[Overview](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#overview)

* * *

[All](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#all)

* * *

[ACL Options](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#acl-options)

* * *

[Access Lists](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#access-lists)

* * *

[Domains and IPs](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#domains-and-ips)

* * *

[Filters](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#filters)

* * *

[Mail](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#mail)

* * *

[RBLs](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#rbls)

* * *

[Security](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#security)

* * *

[Apache SpamAssassin™ Options](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#apache-spamassassin-options)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#table-of-contents-toggle)
...
_Valid for versions 122 through the latest version_
...
This setting allows you to drop and rate-limit hosts with more than four failed recipients, in order to block dictionary attacks. A dictionary attack is when a malicious user uses words in a dictionary to guess email addresses or password attempts.
...
[Click to view...](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#click-to-view---1764175702374895669)
...
This setting allows you to prefix the _Subject_ header with information from the _X-Spam-Subject_ header and omit the _X-Spam-Subject_ header.
...
##### _EXPERIMENTAL: Enable ARC signing for outgoing mail_

Experimental:

This setting is [experimental](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#experimental). If you enable this setting, email deliverability to some large providers **may** improve, but WebPros International, LLC does **not** guarantee it.

This setting allows you to add  headers to messages sent from the server. ARC uses [Sender Policy Framework (SPF)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#spf) and [DomainKeys Identified Mail (DKIM)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#dkim) to sign mail that passes through the system.

To enable this setting, you **must** set the [_Allow DKIM verification for incoming messages_](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#_allow-dkim-verification-for-incoming-messages_) setting to _On_. And for this setting to work correctly, you **must** also enable DKIM/SPF in WHM’s [_Enable DKIM/SPF Globally_](https://docs.cpanel.net/whm/dns-functions/enable-dkim-spf-globally/) interface ( _WHM » Home » DNS Functions » Enable DKIM/SPF Globally_).

Note:

If you enable this setting, Gmail and other large mail providers may still mark your server’s messages as spam. For more information on how to prevent this, read our [How to Keep Your Email Out of the Spam Folder](https://docs.cpanel.net/knowledge-base/email/how-to-keep-your-email-out-of-the-spam-folder/) documentation.
...
- [Trusted mail users](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#trusted-mail-users) can bypass this setting.
...
##### _Disable pipelining_

This setting tells Exim not to use pipelining when it delivers to remote hosts. Pipelining cuts down on Exim’s synchronization time but can cause delivery problems on some servers.

This setting defaults to _Off_.

##### _Mailbox quota query timeout_

This setting defines how long Exim spends checking mailbox quotas. We recommend that you increase this interval if Exim times out while checking quotas for large mailboxes. Enter a number followed by `s` for seconds or `m` for minutes.

This setting defaults to _45s_.
