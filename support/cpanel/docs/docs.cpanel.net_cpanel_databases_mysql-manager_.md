---
url: "https://docs.cpanel.net/cpanel/databases/mysql-manager/"
title: "MySQL® Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/databases/mysql-manager/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/databases/mysql-manager/#overview)

* * *

[Enable the MySQL Manager interface](https://docs.cpanel.net/cpanel/databases/mysql-manager/#enable-the-mysql-manager-interface)

* * *

[The Databases tab](https://docs.cpanel.net/cpanel/databases/mysql-manager/#the-databases-tab)

* * *

[The Database Users tab](https://docs.cpanel.net/cpanel/databases/mysql-manager/#the-database-users-tab)

* * *

[The Configuration tab](https://docs.cpanel.net/cpanel/databases/mysql-manager/#the-configuration-tab)

* * *

[Disable the MySQL Manager interface](https://docs.cpanel.net/cpanel/databases/mysql-manager/#disable-the-mysql-manager-interface)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/databases/mysql-manager/#table-of-contents-toggle)
...
To disable this feature, your hosting provider **must** perform the following steps in WHM:
