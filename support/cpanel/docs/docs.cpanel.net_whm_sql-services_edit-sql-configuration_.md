---
url: "https://docs.cpanel.net/whm/sql-services/edit-sql-configuration/"
title: "Edit SQL Configuration | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/sql-services/edit-sql-configuration/#main-content)
...
[Overview](https://docs.cpanel.net/whm/sql-services/edit-sql-configuration/#overview)

* * *

[Database Optimization](https://docs.cpanel.net/whm/sql-services/edit-sql-configuration/#database-optimization)

* * *

[Configuration Settings for MySQL and MariaDB](https://docs.cpanel.net/whm/sql-services/edit-sql-configuration/#configuration-settings-for-mysql-and-mariadb)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/sql-services/edit-sql-configuration/#table-of-contents-toggle)
...
- In cPanel & WHM version 120 and later, we renamed this interface to [_Edit Database Configuration_](https://docs.cpanel.net/whm/database-services/edit-database-configuration) and its section in the WHM interface to [Database Services](https://docs.cpanel.net/whm/database-services).
...
- [Manage Database Users](https://docs.cpanel.net/whm/sql-services/manage-database-users/)
