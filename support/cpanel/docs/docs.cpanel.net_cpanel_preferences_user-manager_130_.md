---
url: "https://docs.cpanel.net/cpanel/preferences/user-manager/130/"
title: "User Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#overview)

* * *

[Link accounts](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#link-accounts)

* * *

[Add a Subaccount](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#add-a-subaccount)

* * *

[Services](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#services)

* * *

[Logging in](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#logging-in)

* * *

[Edit a Subaccount](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#edit-a-subaccount)

* * *

[Delete a Subaccount](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#delete-a-subaccount)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#table-of-contents-toggle)
...
7. Select the Subaccount’s services. For more information, read the [Services](https://docs.cpanel.net/cpanel/preferences/user-manager/130/#services) section below.
