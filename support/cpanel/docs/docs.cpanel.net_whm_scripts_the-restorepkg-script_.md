---
url: "https://docs.cpanel.net/whm/scripts/the-restorepkg-script/"
title: "The restorepkg Script | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/scripts/the-restorepkg-script/#main-content)
...
[Overview](https://docs.cpanel.net/whm/scripts/the-restorepkg-script/#overview)

* * *

[Run the script](https://docs.cpanel.net/whm/scripts/the-restorepkg-script/#run-the-script)

* * *

[Options](https://docs.cpanel.net/whm/scripts/the-restorepkg-script/#options)

* * *

[Files](https://docs.cpanel.net/whm/scripts/the-restorepkg-script/#files)

* * *

[Examples](https://docs.cpanel.net/whm/scripts/the-restorepkg-script/#examples)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/scripts/the-restorepkg-script/#table-of-contents-toggle)
...
| `--newuser` | Change the restored account’s username. To change the name of a database or database user after you restore the account, use WHM’s [_Manage Databases_](https://docs.cpanel.net/whm/database-services/manage-databases) interface ( _WHM » Home » Database Services » Manage Databases_) and WHM’s [_Manage Database Users_](https://docs.cpanel.net/whm/database-services/manage-database-users) interface ( _WHM » Home » Database Services » Manage Database Users_). <br>Warning:<br>- All of the account’s database users will keep their current username **except** for the user that matches the cPanel account.<br>- The new account name **cannot** already exist on the server.<br>- The username **must** contain 16 characters or fewer, and the first eight characters **must** be unique on the server.<br>- If you use this option with the `--skipaccount` option, the cPanel account may not restore correctly. | `--newuser=username` |
...
| `--update_dns_zone` | Whether to restore the zonefile data associated with an account. <br>- `1` — Restore the account’s zonefile data. <br>- `0` — Do not restore the account’s zonefile data. <br> This option is most useful when performing a [Live Transfer](https://docs.cpanel.net/whm/transfers/transfer-tool/#live-transfer). Disabling this option prevents updating the zonefiles for the main domain, subdomains (including servive and proxy domains), parked domains, and addon domains. | `--update_dns_zone = 1` |
