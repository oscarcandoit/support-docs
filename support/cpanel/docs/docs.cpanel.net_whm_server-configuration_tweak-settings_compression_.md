---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/compression/"
title: "Tweak Settings — Compression | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/compression/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/compression/#installation-toggle)
