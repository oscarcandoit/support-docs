...
[Skip to main content](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#overview)

* * *

[Full Backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#full-backup)

* * *

[Generate a Full Backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#generate-a-full-backup)

* * *

[Account Backups](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#account-backups)

* * *

[Partial Backups](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#partial-backups)

* * *

[Download a Home Directory Backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#download-a-home-directory-backup)

* * *

[Download a Database Backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#download-a-database-backup)

* * *

[Download Email Forwarders](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#download-email-forwarders)

* * *

[Download Email Filters](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#download-email-filters)

* * *

[Restore a partial backup](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#restore-a-partial-backup)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#table-of-contents-toggle)
...
In this section, click _Download a Full Account Backup_ to create, download, or store a full backup file. The [_Generate a Full Backup_](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#generate-a-full-backup) interface will appear.
...
1. Select a storage location from the _Backup Destination_ menu:
   - [_Home Directory_](https://docs.cpanel.net/cpanel/files/backup-for-cpanel/#download-a-home-directory-backup) — Select this setting to save the backup file on the server. You can access it with SSH or through the [_File Manager_](https://docs.cpanel.net/cpanel/files/file-manager/) interface ( _cPanel » Home » Files » File Manager_).
...
3. If you wish to include [integration links](https://api.docs.cpanel.net/guides/guide-to-integration-links/) in the backup, select _Include integration links (may include external account credentials)_.

4. If you selected _Remote FTP Server_, _Remote FTP Server (passive mode transfer)_, or _Secure Copy (SCP)_ from the _Backup Destination_ menu, enter the remote destination’s information in the available text boxes.

5. Click _Generate Backup_. The backup file will download to the storage location you selected.
...
Partial backup files store individual parts of your account and can be restored fully through cPanel. To download a specific item, select the backup type that contains that item. The system downloads the backup file as a [`.gz`](https://en.wikipedia.org/wiki/Gzip) file to your computer’s _Downloads_ folder.
...
To use a partial backup to restore a portion of your account, click _Restore_, then perform the following steps:

1. Select the appropriate restoration type in the _Select Restore Type_ section. For example, to restore the `/home` directory, click _Home Directory_.
2. Click _Choose File_.
3. Select the backup file from your computer.
4. Click _Upload_ to restore that portion of your account.
