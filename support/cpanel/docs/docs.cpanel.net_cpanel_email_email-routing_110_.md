---
url: "https://docs.cpanel.net/cpanel/email/email-routing/110/"
title: "Email Routing | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/email/email-routing/110/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/email/email-routing/110/#overview)

* * *

[Configure Email Routing](https://docs.cpanel.net/cpanel/email/email-routing/110/#configure-email-routing)

* * *

[Automatically configure email routing](https://docs.cpanel.net/cpanel/email/email-routing/110/#automatically-configure-email-routing)

* * *

[Manually configure email routing](https://docs.cpanel.net/cpanel/email/email-routing/110/#manually-configure-email-routing)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/email/email-routing/110/#table-of-contents-toggle)
...
_Valid for versions 110 through 128_
...
- [_Local Mail Exchanger_](https://docs.cpanel.net/cpanel/email/email-routing/110/#local-mail-exchanger) — The system selects this option if the lowest-numbered mail exchanger points to an [Internet Protocol (IP) address](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#internet-protocol-ip-address) on this server.
- [_Backup Mail Exchanger_](https://docs.cpanel.net/cpanel/email/email-routing/110/#backup-mail-exchanger) — The system selects this option if the lowest-numbered mail exchanger points to an IP address not on this server.
- [_Remote Mail Exchanger_](https://docs.cpanel.net/cpanel/email/email-routing/110/#remote-mail-exchanger) — The system selects this option if no mail exchangers point to an IP address on this server.
