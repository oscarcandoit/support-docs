---
url: "https://docs.cpanel.net/whm/packages/feature-manager/128/"
title: "Feature Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/packages/feature-manager/128/#main-content)
...
[Overview](https://docs.cpanel.net/whm/packages/feature-manager/128/#overview)

* * *

[Predefined feature lists](https://docs.cpanel.net/whm/packages/feature-manager/128/#predefined-feature-lists)

* * *

[default](https://docs.cpanel.net/whm/packages/feature-manager/128/#default)

* * *

[Mail only](https://docs.cpanel.net/whm/packages/feature-manager/128/#mail-only)

* * *

[disabled](https://docs.cpanel.net/whm/packages/feature-manager/128/#disabled)

* * *

[Create and edit a feature list](https://docs.cpanel.net/whm/packages/feature-manager/128/#create-and-edit-a-feature-list)

* * *

[Delete a feature list](https://docs.cpanel.net/whm/packages/feature-manager/128/#delete-a-feature-list)

* * *

[Selectable features](https://docs.cpanel.net/whm/packages/feature-manager/128/#selectable-features)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/packages/feature-manager/128/#table-of-contents-toggle)
...
_Valid for versions 128 through 130_
...
| _Advanced Zone Editor (All DNS records except MX)_ | Allows cPanel account users to create or modify AAAA, CAA, DMARC, SRV, and TXT records in cPanel’s [_Zone Editor_](https://docs.cpanel.net/cpanel/domains/zone-editor/) interface ( _cPanel » Home » Domains » Zone Editor_). This feature also controls whether a cPanel account user can view and edit the existing default A and CNAME records. <br>Note:<br>cPanel & WHM enables this feature by default. |
...
| _Application Manager_ | [_Application Manager_](https://docs.cpanel.net/cpanel/software/application-manager/) interface ( _cPanel » Home » Software » Application Manager_). <br>Note:<br>To enable this interface, you must also install **one** of the following Apache modules: <br>- `ea-apache24-mod-passenger` — Use this package if your system runs Ubuntu®, AlmaLinux OS 9, or Rocky Linux™ 9.<br>- `ea-ruby27-mod_passenger` — Use this package if your system runs AlmaLinux 8 or Rocky Linux 8.<br>If needed, you should also install the following modules: <br>- `ea-apache24-mod_env` — This module allows your application configuration to set environment variables for your application on RHEL-based systems.<br>- `ea-apache24-mod-env` — This module allows your application configuration to set environment variables for your application on Ubuntu-based systems.<br>- One of the following modules that support Node.js™ applications:<br>  - `ea-nodejs16`<br>  - `ea-nodejs18`<br>  - `ea-nodejs20`<br>  - `ea-nodejs22`<br>Additionally, for Python WSGI applications, you must install Python and the pip application. |
...
| _Calendars and Contacts_ | - [_Calendars and Contacts Configuration_](https://docs.cpanel.net/knowledge-base/webmail/how-to-set-up-calendars-and-contacts/) interface ( _cPanel » Home » Email » Calendars and Contacts Configuration_).<br>- [_Calendars and Contacts Management_](https://docs.cpanel.net/cpanel/email/calendars-and-contacts-management) interface ( _cPanel » Home » Email » Calendars and Contacts Management_).<br>- [_Calendars and Contacts Sharing_](https://docs.cpanel.net/cpanel/email/calendars-and-contacts-sharing) interface ( _cPanel » Home » Email » Calendars and Contacts Sharing_). |
...
| _Manage Team_ | [_Manage Team_](https://docs.cpanel.net/cpanel/preferences/manage-team/) interface ( _cPanel » Home » Preferences » Manage Team_). <br>Note:<br>This feature is **only** available for [Premier](https://cpanel.net/pricing/), [Autoscale](https://support.cpanel.net/hc/en-us/articles/1500011418781-Autoscale-License-Packages), and [development](https://cpanel.net/developer-license-app/) cPanel licenses. |
...
| _Simple Zone Editor (Custom A and CNAME records only)_ | Enables cPanel’s [_Zone Editor_](https://docs.cpanel.net/cpanel/domains/zone-editor/) interface ( _cPanel » Home » Domains » Zone Editor_) and allows cPanel account users to create A and CNAME records. <br>Note:<br>This feature **only** applies to A and CNAME records that the cPanel account user created. To allow cPanel account users to view the system’s default A and CNAME records, and to modify their domains’ DMARC records, enable the _Advanced Zone Editor (All DNS records except MX)_ feature. |
...
| _Site Quality Monitoring_ | [_Site Quality Monitoring_](https://docs.cpanel.net/cpanel/metrics/site-quality-monitoring) interface ( _cPanel » Home » Metrics » Site Quality Monitoring_). |
...
| _Social Media Management_ | [_Social Media Management_](https://docs.cpanel.net/cpanel/domains/social-media-management/) interface ( _cPanel » Home » Domains » Social Media Management_). |
...
| _WP Management_ | [_WP Toolkit_](https://docs.cpanel.net/knowledge-base/cpanel-developed-plugins/wp-toolkit/) interface ( _cPanel » Home » Domains » WP Toolkit_). |
