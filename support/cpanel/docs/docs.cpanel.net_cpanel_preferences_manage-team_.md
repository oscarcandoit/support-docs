---
url: "https://docs.cpanel.net/cpanel/preferences/manage-team/"
title: "Manage Team | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/preferences/manage-team/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/preferences/manage-team/#overview) [Team users](https://docs.cpanel.net/cpanel/preferences/manage-team/#team-users) [Roles](https://docs.cpanel.net/cpanel/preferences/manage-team/#roles) [Services](https://docs.cpanel.net/cpanel/preferences/manage-team/#services) [Team user preferences](https://docs.cpanel.net/cpanel/preferences/manage-team/#team-user-preferences) [List team table](https://docs.cpanel.net/cpanel/preferences/manage-team/#list-team-table) [View audit log](https://docs.cpanel.net/cpanel/preferences/manage-team/#view-audit-log) - [Audit Log](https://docs.cpanel.net/cpanel/preferences/manage-team-audit-log/)
...
[**Table of Contents**](https://docs.cpanel.net/cpanel/preferences/manage-team/#installation-toggle)
...
| User | Description |
| --- | --- |
| Team user **without** [role](https://docs.cpanel.net/cpanel/preferences/manage-team/#roles) | A team user without a role can:<br>- Log in to cPanel.<br>- Update their password.<br>- Change the default interface language.<br>- Update their contact information.<br>- Access [services](https://docs.cpanel.net/cpanel/preferences/manage-team/#services) that the team owner assigns.<br> A team owner can create an **unlimited** number of team users without roles. |
| Team user **with** [role](https://docs.cpanel.net/cpanel/preferences/manage-team/#roles) | A team user with roles can:<br>- Log in to cPanel.<br>- Update their password.<br>- Change the default interface language.<br>- Update their contact information.<br>- Access [services](https://docs.cpanel.net/cpanel/preferences/manage-team/#services) that the team owner assigns.<br>- Perform the [role’s](https://docs.cpanel.net/cpanel/preferences/manage-team/#roles) associated administrative functions.<br> A team owner can **only** assign roles to seven team users. |
...
- Users **cannot** use email services or edit DNS for [temporary domains](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/#temporary-domain) regardless of their role. Contact your [hosting provider](https://docs.cpanel.net/knowledge-base/cpanel-product/how-to-identify-your-hosting-provider/) to replace your temporary domain with a registered domain.
...
| [_Roles_](https://docs.cpanel.net/cpanel/preferences/manage-team/#roles) | The team user’s assigned role(s) if applicable. |
| _Last Login Date_ | The last time the team user logged in to the account. |
| [_Services_](https://docs.cpanel.net/cpanel/preferences/manage-team/#services) | The services available to the team user. |
| [_Actions_](https://docs.cpanel.net/cpanel/preferences/manage-team/#actions) | The actions available to manage the team user. |
