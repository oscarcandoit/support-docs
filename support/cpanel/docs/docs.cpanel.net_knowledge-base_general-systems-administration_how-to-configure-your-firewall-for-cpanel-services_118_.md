---
url: "https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/"
title: "How to Configure Your Firewall for cPanel & WHM Services | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#overview)

* * *

[Ports](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#ports)

* * *

[The License Callback Mechanism](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#the-license-callback-mechanism)

* * *

[IP addresses for specific features](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#ip-addresses-for-specific-features)

* * *

[Search Engine Optimization](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#search-engine-optimization)

* * *

[Site Quality Monitoring](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#site-quality-monitoring)

* * *

[Social Media Management](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#social-media-management)

* * *

[Example configurations](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#example-configurations)

* * *

[AlmaLinux, Rocky Linux, and CloudLinux firewall management](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#almalinux-rocky-linux-and-cloudlinux-firewall-management)

* * *

[Ubuntu firewall management](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#ubuntu-firewall-management)

* * *

[Adding rules with the CSF and APF utilities](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#adding-rules-with-the-csf-and-apf-utilities)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#table-of-contents-toggle)
...
| `2079` | CalDAV and CardDAV | ![](https://docs.cpanel.net/img/checkbox.png) |  | ![](https://docs.cpanel.net/img/checkbox.png) | ![](https://docs.cpanel.net/img/checkbox.png) |  | Important:<br>This port is insecure and could expose your server to security risks. We **strongly** recommend that you use port `2080` instead. |
...
The [Search Engine Optimization](https://docs.cpanel.net/cpanel/domains/search-engine-optimization/) feature uses the following IP addresses to scan your server’s websites:
...
The [Social Media Management](https://docs.cpanel.net/cpanel/domains/social-media-management/) feature uses the [SocialBee](https://socialbee.com/) platform. SocialBee uses [Amazon Web Services™ (AWS)](https://aws.amazon.com/) IP addresses to scan your server’s websites. The scans may come from any IP addresses that AWS manages.

Use the following commands to get a list of the AWS IP address ranges:

|     |     |
| --- | --- |
| ```<br>1<br>2<br>``` | ```go<br>curl -O https://ip-ranges.amazonaws.com/ip-ranges.json<br>json_pp < ip-ranges.json | grep ip_prefix<br>``` |
...
- [AlmaLinux OS](https://docs.cpanel.net/installation-guide/system-requirements-almalinux/), [CloudLinux™](https://docs.cpanel.net/installation-guide/system-requirements-cloudlinux/), and [Rocky Linux™](https://docs.cpanel.net/installation-guide/system-requirements-rockylinux/) servers have additional requirements. For more information, read the [AlmaLinux, Rocky Linux, and CloudLinux firewall management section](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#almalinux-rocky-linux-and-cloudlinux-firewall-management) below.
- We recommend the `nftables` utility for servers that run the [AlmaLinux, Rocky Linux, or CloudLinux operating systems](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#almalinux-rocky-linux-and-cloudlinux-firewall-management). We recommend the `iptables` utility on servers that run the [Ubuntu operating system](https://docs.cpanel.net/knowledge-base/general-systems-administration/how-to-configure-your-firewall-for-cpanel-services/118/#ubuntu-firewall-management).

### AlmaLinux, Rocky Linux, and CloudLinux firewall management

Important:

We **strongly** recommend that you use the `nftables` framework for the firewall of servers that run the Rocky Linux, CloudLinux, or AlmaLinux operating systems.
