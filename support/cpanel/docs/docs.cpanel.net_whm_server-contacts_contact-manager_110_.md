---
url: "https://docs.cpanel.net/whm/server-contacts/contact-manager/110/"
title: "Contact Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-contacts/contact-manager/110/#main-content)
...
[Overview](https://docs.cpanel.net/whm/server-contacts/contact-manager/110/#overview)

* * *

[Communication Type](https://docs.cpanel.net/whm/server-contacts/contact-manager/110/#communication-type)

* * *

[Test a communication type](https://docs.cpanel.net/whm/server-contacts/contact-manager/110/#test-a-communication-type)

* * *

[Notifications](https://docs.cpanel.net/whm/server-contacts/contact-manager/110/#notifications)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/server-contacts/contact-manager/110/#table-of-contents-toggle)
...
| _Hostname Change Notifications_ | The system launches a background task to update the hostname in individual Horde databases. | `DAV/ChangeHostname.*.tmpl` |
...
| _MyDNS Zone Import Failure_ | The system fails to import zone files into the MyDNS database. <br>Warning:<br>We removed the MyDNS nameserver in cPanel & WHM version 106 and later. For more information, read our [cPanel Deprecation Plan](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-deprecation-plan/). | `ImportMyDNSdb/Failure.*.tmpl` |
| _MyDNS Zone Import In Progress_ | An import of zone files into the MyDNS database is in progress. <br>Warning:<br>We removed the MyDNS nameserver in cPanel & WHM version 106 and later. For more information, read our [cPanel Deprecation Plan](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-deprecation-plan/). | `ImportMyDNSdb/InProgress.*.tmpl` |
| _MyDNS Zone Import Successful_ | The system successfully imports zone files into the MyDNS database. <br>Warning:<br>We removed the MyDNS nameserver in cPanel & WHM version 106 and later. For more information, read our [cPanel Deprecation Plan](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-deprecation-plan/). | `ImportMyDNSdb/Success.*.tmpl` |
