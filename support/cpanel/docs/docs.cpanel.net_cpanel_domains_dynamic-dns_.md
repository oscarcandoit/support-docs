---
url: "https://docs.cpanel.net/cpanel/domains/dynamic-dns/"
title: "Dynamic DNS | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/domains/dynamic-dns/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/domains/dynamic-dns/#overview)

* * *

[The Dynamic DNS Domains table](https://docs.cpanel.net/cpanel/domains/dynamic-dns/#the-dynamic-dns-domains-table)

* * *

[Create a new DDNS domain](https://docs.cpanel.net/cpanel/domains/dynamic-dns/#create-a-new-ddns-domain)

* * *

[Manage a DDNS domain](https://docs.cpanel.net/cpanel/domains/dynamic-dns/#manage-a-ddns-domain)

* * *

[View SSL Certificate](https://docs.cpanel.net/cpanel/domains/dynamic-dns/#view-ssl-certificate)

* * *

[Manage a DDNS domain’s SSL certificate](https://docs.cpanel.net/cpanel/domains/dynamic-dns/#manage-a-ddns-domains-ssl-certificate)

* * *

[Configure your router for DDNS](https://docs.cpanel.net/cpanel/domains/dynamic-dns/#configure-your-router-for-ddns)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/domains/dynamic-dns/#table-of-contents-toggle)
