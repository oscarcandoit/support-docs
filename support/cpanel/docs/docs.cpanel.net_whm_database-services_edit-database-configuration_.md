---
url: "https://docs.cpanel.net/whm/database-services/edit-database-configuration/"
title: "Edit Database Configuration | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/database-services/edit-database-configuration/#main-content)
...
[Overview](https://docs.cpanel.net/whm/database-services/edit-database-configuration/#overview)

* * *

[Database Optimization](https://docs.cpanel.net/whm/database-services/edit-database-configuration/#database-optimization)

* * *

[Configuration Settings for MySQL and MariaDB](https://docs.cpanel.net/whm/database-services/edit-database-configuration/#configuration-settings-for-mysql-and-mariadb)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/database-services/edit-database-configuration/#table-of-contents-toggle)
...
#### [120](https://docs.cpanel.net/whm/database-services/edit-database-configuration/)
...
- In cPanel & WHM version 118 and earlier, we titled this interface [_Edit SQL Configuration_](https://docs.cpanel.net/whm/sql-services/edit-sql-configuration) and its section in the WHM interface [SQL Services](https://docs.cpanel.net/whm/sql-services).
...
- Click the document icon (![document icon](https://docs.cpanel.net/img/file-settings-line.png)) to restore a setting to its default values.
- Click the arrow icon (![a curved arrow icon](https://docs.cpanel.net/img/arrow-go-back-line.png)) to revert a setting to its previous value.
...
1. Click the gauge icon (![gauge icon](https://docs.cpanel.net/img/guage1.png)). The _Optimization_ menu will appear.
