---
url: "https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/"
title: "Notification Templates | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#overview)

* * *

[Available notification templates](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#available-notification-templates)

* * *

[Notification types](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#notification-types)

* * *

[Notification names](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#notification-names)

* * *

[Additional templates and resources](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#additional-templates-and-resources)

* * *

[Available variables](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#available-variables)

* * *

[Customize a template](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#customize-a-template)

* * *

[Example](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#example)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/general-systems-administration/notification-templates/110/#table-of-contents-toggle)
...
| `Check/PopBeforeSMTPEnabled.*.tmpl` | The POP Before SMTP option is enabled, which poses a security risk. | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_POP before SMTP enabled_ |
...
| `DAV/ChangeHostname.*.tmpl` | The system launches a background task to update the hostname in individual Horde databases. | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_Hostname Change Notifications_ |
...
| `Deprecated/EA3RPMs.*.tmpl` | The system detected that legacy EasyApache 3 packages still exist on the server. <br>Note:<br>The system only sends this notification one time. | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_Legacy EA3 RPMs Installed List_ |
...
| `EasyApache/EA4_MigrationModSec.*.tmpl` | EasyApache 4 migrates the ModSecurity configuration, and it makes a change to the custom user configuration file in order to ensure maximum compatibility. | N/A |
...
| `Install/Horde.*.tmpl` | The system fails to properly convert a table in Horde. | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_Horde Maintenance Notification_ |
...
| `NSD/BadZones.*.tmpl` | The system detects corrupt DNS zones. <br>Warning:<br>We **removed** the NSD nameserver in cPanel & WHM version 106 and later. We strongly recommend that you migrate to PowerDNS. For more information, read our [cPanel Deprecation Plan](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-deprecation-plan).<br> <br> This notification template uses the `BadZones.body.html.tmpl` sub-template from the `NSD/includes` directory. | [_Contact Manager_](https://docs.cpanel.net/whm/server-contacts/contact-manager)<br>_NSD DNS Zones Corrupted_ |
