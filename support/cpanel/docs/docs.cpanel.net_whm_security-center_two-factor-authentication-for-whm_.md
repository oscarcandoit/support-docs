---
url: "https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/"
title: "Two-Factor Authentication for WHM | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#main-content)
...
[Overview](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#overview)

* * *

[Enable 2FA for logins and Webmail](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#enable-2fa-for-logins-and-webmail)

* * *

[Failed to set user configuration: The security code is invalid](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#failed-to-set-user-configuration-the-security-code-is-invalid)

* * *

[Enable 2FA for APIs](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#enable-2fa-for-apis)

* * *

[Settings](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#settings)

* * *

[Manage Users](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#manage-users)

* * *

[Remove 2FA on a user account](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#remove-2fa-on-a-user-account)

* * *

[Enable 2FA on a user account](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#enable-2fa-on-a-user-account)

* * *

[Manage My Account](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#manage-my-account)

* * *

[Configure 2FA](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#configure-2fa)

* * *

[Remove 2FA](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#remove-2fa)

* * *

[Reconfigure 2FA](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#reconfigure-2fa)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#table-of-contents-toggle)
...
## Enable 2FA for logins and Webmail
...
To reconfigure 2FA, click _Reconfigure_. Then, follow the steps above to [configure 2FA](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm/#configure-2fa).
