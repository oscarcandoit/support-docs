---
url: "https://docs.cpanel.net/whm/service-configuration/service-manager/"
title: "Service Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/service-configuration/service-manager/#main-content)
...
[Overview](https://docs.cpanel.net/whm/service-configuration/service-manager/#overview)

* * *

[TailWatch Drivers in the tailwatchd module](https://docs.cpanel.net/whm/service-configuration/service-manager/#tailwatch-drivers-in-the-tailwatchd-module)

* * *

[Service daemons](https://docs.cpanel.net/whm/service-configuration/service-manager/#service-daemons)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/service-configuration/service-manager/#table-of-contents-toggle)
...
| cPanel DAV Daemon (`cpdavd`) | This daemon enables a set of extensions that allow users to manage their websites, calendars, and contacts remotely. <br>Important:<br>If you plan to host other people’s websites or email on your web server, do **not** disable this daemon.<br> <br>Note:<br>The _Database_ and _DNS_ server profiles **disable** this daemon. |
...
| NGINX® Server (`nginx`) | This daemon runs the reverse proxy and caching server. <br>Note:<br>The interface does not display this daemon until you install NGINX. For more information, read WHM’s [_NGINX® Manager_](https://docs.cpanel.net/whm/software/nginx-manager/) interface ( _WHM » Software » NGINX® Manager_) documentation. |
...
| SSH Daemon (`sshd`) | This daemon allows users to connect to your server in a terminal session via SSH. <br>Note:<br>On Debian systems such as Ubuntu, the daemon name is `sshd`, and the service name is `ssh`. |
