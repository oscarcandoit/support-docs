---
url: "https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/"
title: "DNS Zone Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#main-content)
...
[Overview](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#overview)

* * *

[Domains](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#domains)

* * *

[Manage DNS Zone Records](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#manage-dns-zone-records)

* * *

[Add a DNS zone record](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#add-a-dns-zone-record)

* * *

[Edit a DNS zone record](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#edit-a-dns-zone-record)

* * *

[DNS zone record types](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#dns-zone-record-types)

* * *

[Delete a DNS zone record](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#delete-a-dns-zone-record)

* * *

[Reset DNS zone files](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#reset-dns-zone-files)

* * *

[View Raw DNS zone file](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#view-raw-dns-zone-file)

* * *

[View DNSSEC Keys](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#view-dnssec-keys)

* * *

[Create Key](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#create-key)

* * *

[Import Key](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#import-key)

* * *

[Export](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#export)

* * *

[Public DNSKEY](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#public-dnskey)

* * *

[View DS Records](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#view-ds-records)

* * *

[Domain registrar DS records](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#domain-registrar-ds-records)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#table-of-contents-toggle)
...
_Valid for versions 106 through 120_
...
- _A Record_ — Create a new [A record](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#a). When you select this record type, a new window will appear. Enter a valid DNS zone name in the _Name_ text box and a valid IPv4 address in the _Address_ text box. Click _Add An A Record_ to save your changes.
- _CNAME Record_ — Create a new [CNAME record](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#cname). When you select this record type, a new window will appear. Enter a valid DNS zone name in the _Name_ text box and a FQDN in the _CNAME_ text box. Click _Add A CNAME Record_ to save your changes.
- _MX Record_ — Create a new [MX record](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#mx). When you select this record type, a new window will appear. Enter the record’s priority value in the _Priority_ text box and a FQDN in the _Destination_ text box. Click _Add An MX Record_ to save your changes.
- _DNSSEC_ — Manage the domain’s [DNSSEC (Domain Name System Security Extensions)](https://docs.cpanel.net/knowledge-base/dns/dnssec) records. When you select this record type, the system directs you to the [_View DNSSEC Keys_](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#view-dnssec-keys) interface.
- _Manage_ — Add or edit additional domain records. When you select this setting, the system directs you to the [_Manage DNS Zone Records_](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#manage-dns-zone-records) interface.
...
- _Type_ — The [record’s type](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#dns-zone-record-types).
- _Record_ — The record’s information.
- _Actions_ — The option to [edit](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#edit-a-dns-zone-record) or delete the record.

You can also use this interface to:

- [Add](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#add-a-dns-zone-record) or [edit](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#edit-a-dns-zone-record) one or more DNS zone records.
- [Delete](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#delete-a-dns-zone-record) a DNS zone record.
- [View the raw DNS zone file](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#view-raw-dns-zone-file).
- [Reset the DNS zone](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#reset-dns-zone-files).
...
2. Click _Add Record_. You can also click the arrow icon (![The Add Record arrow icon](https://docs.cpanel.net/img/dns-zone-manager-arrowicon.png)) and select [the desired record type](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#dns-zone-record-types) from the list.
...
When you select this setting, the system creates a [TXT record](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#txt) with a default DMARC record. The system also displays a form that allows you to define the domain’s DMARC _Policy_ ( _None_, _Quarantine_, or _Reject_), as well as the following optional parameters:
...
For more information, read the [View DNSSEC Keys](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#view-dnssec-keys) section.
...
- _Txt-dname_ — A related hostname or domain name for which [TXT](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#TXT) records exist. This entry **must** end in a period (`.`).
...
3. To copy the file, click _Copy_, or click _Return to Editor_ to exit the [_Manage DNS Zone Records_](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#manage-dns-zone-records) interface.
...
- ![Expand Arrow](https://docs.cpanel.net/img/expandarrow.png)— This setting will display the following details about a DNSSEC key:
  ...
  - _Delete_ — Delete the DNSSEC key. If you click this setting, a confirmation window will appear.
    ...
    When you deactivate or delete a DNSSEC key, you **must** remove the Domain Server (DS) record at [your domain registrar](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#domain-registrar-ds-records).

  - _Public DNSKEY_ — Display the public DNSKEY record. The [_Public DNSKEY_](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#public-DNSKEY) interface will appear.
...
- _View DS Records_ — Display the domain’s DS records. The [DNSSEC Key Details](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#view-ds-records) interface will appear.
- _Export_ — Export the domain’s DNSSEC key. The [Export DNSSEC Key](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#export) interface will appear.
...
When you create a domain DNSSEC key, you **must** configure a DS record with [your domain registrar](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#domain-registrar-ds-records).
...
2. Click _Create_. The [_DNSSEC Key Details_](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#view-ds-records) interface will appear with the keys’ details.
...
3. Visit your registrar’s website and add the information that they request for your domain. For more information about some popular domain registrars, read the [Domain registrar DS records](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#domain-registrar-ds-records) section.

### Domain registrar DS records

Any time you create, modify, or remove a domain’s DNSSEC key, you **must** configure a [Delegation Signer (DS)](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/106/#ds) record with your domain registrar. The following are some of the most popular domain registrars. Visit their website to read their DNSSEC management documentation.
