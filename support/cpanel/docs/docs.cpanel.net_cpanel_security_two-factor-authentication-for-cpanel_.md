---
url: "https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/"
title: "Two-Factor Authentication for cPanel | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#overview)

* * *

[2FA smartphone apps](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#2fa-smartphone-apps)

* * *

[Set up 2FA](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#set-up-2fa)

* * *

[Reconfigure 2FA](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#reconfigure-2fa)

* * *

[2FA authentication status tracking](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#2fa-authentication-status-tracking)

* * *

[Disable 2FA](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#disable-2fa)

* * *

[Lost access to 2FA](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#lost-access-to-2fa)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#table-of-contents-toggle)
...
_Valid for versions 114 through the latest version_
...
Two-factor authentication (2FA) is a popular security measure. When you [set up 2FA](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#set-up-2fa), you must provide two identification factors to log in to cPanel: your password and a six-digit security code. You can get this security code from a smartphone with a [a smartphone authenticator app](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#2fa-smartphone-apps).
...
- This document **only** covers how to use 2FA for cPanel. For information about how to use 2FA with Webmail, read our [Webmail — Edit Your Settings](https://docs.cpanel.net/webmail/edit-your-settings-in-webmail/#two-factor-authentication) documentation.
...
To set up 2FA, you **must** first install a [smartphone app](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#2fa-smartphone-apps) to generate your security code. Then, perform the following steps:
...
To reconfigure 2FA, click _Reconfigure_. Then, [follow the steps](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#set-up-2fa) to set up 2FA again with a new configuration.

Warning:

This action will **overwrite** your account’s existing 2FA configuration. As a result, any existing 2FA app configurations will **not** provide valid security codes. Additionally, the system will [log you out](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#2fa-authentication-status-tracking) of any other cPanel browser windows.
...
- [Setting up](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#set-up-2fa) 2FA.
- [Reconfiguring](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel/#reconfigure-2fa) 2FA.
