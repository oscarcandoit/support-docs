---
url: "https://docs.cpanel.net/whm/database-services/manage-databases/"
title: "Manage Databases | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/database-services/manage-databases/#main-content)
...
[Overview](https://docs.cpanel.net/whm/database-services/manage-databases/#overview)

* * *

[Databases](https://docs.cpanel.net/whm/database-services/manage-databases/#databases)

* * *

[Rename a database](https://docs.cpanel.net/whm/database-services/manage-databases/#rename-a-database)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/database-services/manage-databases/#table-of-contents-toggle)
...
#### [120](https://docs.cpanel.net/whm/database-services/manage-databases/)
...
- It is potentially dangerous to rename a database. We **strongly** recommend that you create a backup of any database that you wish to rename.
