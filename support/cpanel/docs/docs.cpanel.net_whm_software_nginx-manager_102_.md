---
url: "https://docs.cpanel.net/whm/software/nginx-manager/102/"
title: "NGINX® Manager | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/software/nginx-manager/102/#main-content)
...
[Overview](https://docs.cpanel.net/whm/software/nginx-manager/102/#overview)

* * *

[Requirements](https://docs.cpanel.net/whm/software/nginx-manager/102/#requirements)

* * *

[Compatibility](https://docs.cpanel.net/whm/software/nginx-manager/102/#compatibility)

* * *

[Limitations](https://docs.cpanel.net/whm/software/nginx-manager/102/#limitations)

* * *

[Landing page](https://docs.cpanel.net/whm/software/nginx-manager/102/#landing-page)

* * *

[System Settings](https://docs.cpanel.net/whm/software/nginx-manager/102/#system-settings)

* * *

[User Settings](https://docs.cpanel.net/whm/software/nginx-manager/102/#user-settings)

* * *

[Uninstall](https://docs.cpanel.net/whm/software/nginx-manager/102/#uninstall)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/software/nginx-manager/102/#table-of-contents-toggle)
...
This section of the interface **only** appears if NGINX is **not** installed on your server. If NGINX is already installed, the interface displays the [_System Settings_](https://docs.cpanel.net/whm/software/nginx-manager/102/#system-settings) tab.
...
To uninstall NGINX, use the _Uninstall NGINX Reverse Proxy_ option in the [_System Settings_](https://docs.cpanel.net/whm/software/nginx-manager/102/#system-settings) tab.
...
- [NGINX® Manager](https://docs.cpanel.net/whm/software/nginx-manager/)
