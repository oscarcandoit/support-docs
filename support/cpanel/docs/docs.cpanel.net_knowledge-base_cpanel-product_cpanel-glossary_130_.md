---
url: "https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/"
title: "cPanel Glossary | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#main-content)
...
[dnsonly](https://docs.cpanel.net/tags/dnsonly/) [whmui](https://docs.cpanel.net/tags/whmui/) [cpanelui](https://docs.cpanel.net/tags/cpanelui/) [whmadvanced](https://docs.cpanel.net/tags/whmadvanced/)

#### Table of Contents

[A](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#a)

* * *

[B](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#b)

* * *

[C](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#c)

* * *

[D](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#d)

* * *

[E](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#e)

* * *

[F](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#f)

* * *

[G](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#g)

* * *

[H](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#h)

* * *

[I](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#i)

* * *

[J](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#j)

* * *

[K](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#k)

* * *

[L](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#l)

* * *

[M](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#m)

* * *

[N](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#n)

* * *

[O](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#o)

* * *

[P](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#p)

* * *

[Q](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#q)

* * *

[R](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#r)

* * *

[S](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#s)

* * *

[T](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#t)

* * *

[U](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#u)

* * *

[V](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#v)

* * *

[W](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#w)

* * *

[X](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#x)

* * *

[Y](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#y)

* * *

[Z](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#z)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#table-of-contents-toggle)
...
#### [110](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/110/)

#### [112](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/112/)

#### [114](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/114/)

#### [116](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/116/)

#### [120](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/120/)

#### [122](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/122/)

#### [124](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/124/)

#### [130](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/)

#### [132](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/)
...
See [Fully Qualified Domain Name](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#fqdn).
...
- To allow a [Reseller](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#reseller) to assign and unassign Account Enhancements, you must enable the _Use Root Account Enhancements_ privilege in WHM’s [_Edit Reseller Nameservers and Privileges_](https://docs.cpanel.net/whm/resellers/edit-reseller-nameservers-and-privileges) interface ( _WHM » Home » Resellers » Edit Reseller Nameservers and Privileges_).
...
An open-source, community-driven Linux operating system distribution from [The AlmaLinux OS Foundation](https://almalinux.org/). The AlmaLinux OS is one of cPanel & WHM’s supported operating systems.

More:

For more information, read our [AlmaLinux Installation Guide](https://docs.cpanel.net/installation-guide/system-requirements-almalinux/) documentation.
...
Successful [Domain Control Validation](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#domain-control-validation) (DCV) of a domain applies to all of its subdomains as well. For example, if the `example.com` domain succeeds, the `store.example.com` subdomain would also succeed.
...
- [Each `app_key` value](https://api.docs.cpanel.net/guides/guide-to-cpanel-interface-customization-and-branding/guide-to-cpanel-interface-customization-appkeys/) is unique to a single item.
- You can use these values when you develop [cPanel plugins](https://api.docs.cpanel.net/guides/guide-to-cpanel-plugins/).

##### Application Programming Interface (API)

A set of programming standards and tools that third-party or internal developers can use to interact with a software application. WebPros International, LLC provides [APIs](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#api) that you can use to customize and integrate with [cPanel or Webmail](https://api.docs.cpanel.net/cpanel/introduction/), [WHM](https://api.docs.cpanel.net/whm/introduction/), and [Manage2](https://docs.cpanel.net/manage2/knowledge-base/guide-to-the-manage2-api).

##### atd

A [daemon](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#daemon) that performs scheduled tasks for the `at` command on Linux operating systems. cPanel & WHM uses the `at` daemon to [check system health after updates](https://docs.cpanel.net/whm/server-configuration/update-preferences).

##### Authenticated Received Chain (ARC)

An email protocol that helps combat [phishing](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#phishing), [spoofing](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#spoof), and [spam](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#spam). ARC verifies email authentication in messages that your server forwards or redirects. Google and other large email providers may require ARC headers in these types of messages.

If you enable ARC in cPanel & WHM, your server adds ARC headers to forwarded emails and emails sent via mailing lists. For more information, read our [_Exim Configuration Manager Basic Editor_](https://docs.cpanel.net/whm/service-configuration/exim-configuration-manager-basic-editor/#_experimental-enable-arc-signing-for-outgoing-mail_) documentation.
...
- You can configure two-factor authentication (2FA) for [cPanel](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel), [WHM](https://docs.cpanel.net/whm/security-center/two-factor-authentication-for-whm), and [Webmail](https://docs.cpanel.net/webmail/the-webmail-interface) accounts.
...
A nameserver that returns responses to queries for one or more [DNS zones](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#dnszones). Name Server (NS) records point to the domain’s authoritative nameserver. These nameservers **don’t** cache DNS information for related domains.
...
A feature in WHM that provides free, [Domain-Validated SSL certificates](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#domain-validated-ssl) to users’ domains.
...
- Use [SPF](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#spf) on your mail server to reduce backscatter.
...
**See also:** [Greylisting](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#greylisting), [Whitelist](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#whitelist).
...
- BoxTrapper Blacklist — A list of incoming email addresses that the [BoxTrapper](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#boxtrapper) application automatically blocks. cPanel automatically sends a configurable warning message when it receives mail from a [blacklisted](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#blacklist) address.

- BoxTrapper Ignore List — A list of incoming email addresses that [BoxTrapper](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#boxtrapper) automatically ignores.
...
- BoxTrapper Whitelist — A list of incoming email addresses that [BoxTrapper](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#boxtrapper) automatically accepts.


##### Branding

Changes to the cPanel interface to match your company’s logo and brand. Branding changes also include updates to image assets or text labels. For more information, read our [Guide to cPanel Interface Customization and Branding](https://api.docs.cpanel.net/guides/guide-to-cpanel-interface-customization-and-branding/).
...
See [Feature](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#feature).

##### Build

A release of cPanel & WHM that uses a specific version number. WebPros International, LLC [releases cPanel & WHM builds in different stages](https://docs.cpanel.net/knowledge-base/cpanel-product/product-versions-and-the-release-process) through our [named release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#release-tiers).
...
- You can configure DNS record caches in WHM’s [_DNS Zone Manager_](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager) interface ( _WHM » Home » DNS Functions » DNS Zone Manager_).
...
A file that contains details about an [SSL certificate](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ssl-certificate), such as its issuer and that issuer’s certificates and chain of trust. Browsers include a built-in list of trusted certificate authorities, and compare their lists against CA bundles to determine whether to trust an authority.
...
A non-authoritative [linked node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#linked-node) that receives tasks from a [parent node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#parent-node).
...
For more information, read our [CloudLinux Installation Guide](https://docs.cpanel.net/installation-guide/system-requirements-cloudlinux/) documentation.
...
Email users manage their collections in Webmail’s [_Calendars and Contacts Management_](https://docs.cpanel.net/cpanel/email/calendars-and-contacts-management/) interface ( _Webmail » Calendars and Contacts Management_) and share them in Webmail’s [_Calendars and Contacts Sharing_](https://docs.cpanel.net/cpanel/email/calendars-and-contacts-sharing/) interface ( _Webmail » Calendars and Contacts Sharing_).
...
For more information, read our [How to Access the Command Line](https://docs.cpanel.net/knowledge-base/general-server-administration/how-to-access-the-command-line) documentation.
...
A Content Delivery Network (CDN) is a [world-wide network of servers](https://en.wikipedia.org/wiki/Content_delivery_network) that delivers data quickly to a world-wide network of users. This network architecture helps prevent unbalanced server loads and provides high availability.

##### cPanel

The companion software to [WHM](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#whm). WebPros International, LLC designs cPanel to simplify website maintenance for website owners.

More:

- For more information, read our [documentation for cPanel’s interfaces](https://docs.cpanel.net/cpanel).
- Developers can [create plugins for cPanel](https://api.docs.cpanel.net/guides/guide-to-cpanel-plugins/).

##### cPanel Market

A system that administrators can use to sell products from various vendors (for example, the cPanel Store) through the cPanel & WHM interface. For example, cPanel’s [_SSL/TLS Wizard_](https://docs.cpanel.net/cpanel/security/ssl-tls-wizard) interface ( _cPanel » Home » Security » SSL/TLS Wizard_) uses the cPanel Market to sell [SSL certificates](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ssl-certificate).
...
Our online store, through which customers can [purchase various services and products](https://docs.cpanel.net/knowledge-base/cpanel-product/how-to-purchase-a-cpanel-license) such as licenses, support, and [SSL certificates](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ssl-certificate).

##### cPanelID

Your login credentials for cPanel’s Store, ticket system, and [Manage2](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#manage2). You can use your [cPanelID](https://docs.cpanel.net/knowledge-base/accounts/cpanelid/) as an [External Authentication](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#external-authentication) method.
...
cPanel’s WebDAV, calendars, and contacts [daemon](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#daemon). `cpdavd` provides access to cPanel’s [_Web Disk_](https://docs.cpanel.net/cpanel/files/web-disk) interface ( _cPanel » Home » Files » Web Disk_), [_Calendars and Contacts Management_](https://docs.cpanel.net/cpanel/email/calendars-and-contacts-management/) interface ( _cPanel » Home » Email » Calendars and Contacts Management_), and [_Calendars and Contacts Sharing_](https://docs.cpanel.net/cpanel/email/calendars-and-contacts-sharing/) interface ( _cPanel » Home » Email » Calendars and Contacts Sharing_).
...
cPanel Service [Daemon](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#daemon), the software that runs cPanel & WHM on your server.
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#release-tiers). We have tested and verified versions on this tier, but they may not contain all of the proposed functionality of a release.
...
The process of moving some or all of a [distributed cPanel account](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#distributed-cpanel-account)’s functionality from a [child node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#child-node) back to the [parent node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#parent-node). For example, returning a cPanel account’s mail functionality from a [Mail Node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#server-profile) child node to the parent node.
...
A term that WebPros International, LLC uses to describe a feature that we [no longer support or will remove](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-deprecation-plan) in an upcoming release.

##### Dictionary Attack

A method in which a malicious user tries to guess a password with words from a dictionary.

- This attack is similar to a [brute force attack](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#brute-force).
...
A [brute force attack](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#brute-force) technique. Spammers attempt to find valid email addresses on a server through guesswork and various permutations of common addresses. WHM includes [cPHulk](https://docs.cpanel.net/whm/security-center/cphulk-brute-force-protection/), a protection system that lets you lock out brute force attackers after a specified number of failed attempts.
...
A [CA](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ca) uses Domain Control Validation (DCV) to verify that a certificate requester owns the domain before issuing the certificate. The CA can use one of the three following DCV methods to verify ownership:
...
A digital certificate for [SSL/TLS](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ssl) verification. The [certificate authority (CA)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ca) verifies that the applicant controls the DNS domain via email, phone, or other method.
...
- To set a default DMARC policy when you create a new account, select the _Enable DMARC on this account._ checkbox in WHM’s [_Create a New Account_](https://docs.cpanel.net/whm/account-functions/create-a-new-account) interface ( _WHM » Home » Account Functions » Create a New Account_).
- To apply a default DMARC policy to all domains on the server, use WHM’s [_Email DNS Record Manager_](https://docs.cpanel.net/whm/dns-functions/email-dns-record-manager) interface ( _WHM » Home » DNS Functions » Email DNS Record Manager_).
- To create a custom DMARC record or modify an existing DMARC record for a domain, use WHM’s [_DNS Zone Manager_](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager/) interface ( _WHM » Home » DNS Functions » DNS Zone Manager_) or cPanel’s [_Zone Editor_](https://docs.cpanel.net/cpanel/domains/zone-editor) interface ( _cPanel » Home » Domain» Zone Editor_).

More:

For more information, read [dmarc.org’s documentation](https://dmarc.org/) and our [How to Keep your Email Out of the Spam Folder](https://docs.cpanel.net/knowledge-base/email/how-to-keep-your-email-out-of-the-spam-folder) documentation.
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#release-tiers).
...
A variant of [Digital Signature Algorithm](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#DSA) that uses [elliptic-curve cryptography (ECC)](https://en.wikipedia.org/wiki/Elliptic-curve_cryptography). ECDSA provides equivalent security to RSA keys using smaller key sizes. As a result, ECDSA keys generate smaller certificates. Smaller certificates can result in faster connections and website loading times.
...
**See also:** [HELO](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#helo)

An [Extended Simple Mail Transfer Protocol (ESMTP)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#esmtp) command that a mail server or client sends to identify itself when it connects with another mail server.
...
An extension of the original [Simple Mail Transfer Protocol (SMTP)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#smtp)’s protocols. ESMTP sends an [EHLO](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ehlo) request to a mail server or client to identify the server’s supported protocol. The server returns a list of its available ESMTP commands.

##### Extended Validation (EV) Certificate

A digital certificate for [SSL/TLS](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ssl) verification. The [certificate authority (CA)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ca) verifies that the applicant controls the DNS domain with a comprehensive identity validation process.
...
See [Bug](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#bug).
...
- **Only** use a forceful reboot if you **cannot** [reboot gracefully](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#graceful-reboot), because it can result in data loss.
...
A value that the system uses to identify a resource, similar to [UUID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#uuid). UUID is the more common identifier while Microsoft products are the main users of GUID.
...
- This is the opposite of a [forceful reboot](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#forceful-reboot).
- You can perform forceful and graceful reboots [in the WHM interface](https://docs.cpanel.net/whm/system-reboot/system-reboot/).

##### Greylisting

**See also:** [Blacklist](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#blacklist), [Whitelist](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#whitelist)
...
- Unix and Linux systems often use gzip with the [tar](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#tar) command to create a tarball file, which uses the `.tar.gz` file extension.
...
- The server hostname is distinct from your [domain name](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#domain-name).
...
- [**IPv6**](https://docs.cpanel.net/knowledge-base/ipv6/guide-to-ipv6) is a newer version that uses 128-bit IP addresses. This version has vast availability of addresses, but requires an IPv6-enabled network and server.
...
A [CLI](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#cli) configuration that restricts users’ access rights. The system limits shell sessions to a filesystem that does not contain the home directories of other cPanel users on the system.
...
For more information, read our [Tomcat via Containers](https://docs.cpanel.net/ea4/containers/tomcat-via-containers/) documentation.
...
A node that a server administrator designates to either assign tasks to or receive tasks from another node. For example, a [parent node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#parent-node) may assign all mail tasks for a cPanel account to a [child node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#child-node).
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#release-tiers). WebPros International, LLC supports this version for a period of one year before designating the next LTS version.
...
A server that sends mail to and receives mail from other servers. Mail exchangers use [MX entries](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#mail-exchanger-mx-entry) to determine where to send mail.
...
A program that sends and receives email messages. [Exim](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#exim) is an MTA.
...
[Mailing list](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#mailinglist) software that sends email messages to a group of specified email addresses.
...
A WebPros International, LLC website that lets you perform license-related tasks. Hosting providers log in to [Manage2](https://docs.cpanel.net/manage2) to add, update, or remove cPanel product licenses, or to manage and pay invoices from WebPros International, LLC.
...
- You can upgrade the server’s MariaDB version in WHM’s [_Upgrade Database Version_](https://docs.cpanel.net/whm/database-services/upgrade-database-version/) interface ( _WHM » Home » Database Services » Upgrade Database Version_).
...
The remapping of one IP address space to another by modifying the network address information of packets’ IP headers while in transit across a router. This method allows for the use of a single IP address on an entire private network. For more information about NAT, read our [1:1 NAT](https://docs.cpanel.net/knowledge-base/general-systems-administration/1-1-nat) documentation.
...
**See also:** [UID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#uid)

A Unix or Linux system account with the UID of `99`. This system account executes [CGI](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#cgi) and [PHP](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#php) scripts if [suEXEC](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#suexec) is disabled.

## O

##### Onboarding Assistant

The _Onboarding Assistant_ appears for new or migrated cPanel user accounts to welcome the user and offer a starting point to begin using the [cPanel interface](https://docs.cpanel.net/cpanel/the-cpanel-interface/the-cpanel-interface). The interface’s options will change depending on your hosting provider and account settings.
...
A standard for third-party authentication. cPanel & WHM’s [External Authentication](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#external-authentication) feature uses OpenID Connect to communicate with third-party authentication providers.
...
The background software that runs all of the other software applications on your system. The OS is a required part of any server or computer. cPanel & WHM supports specific versions of the [AlmaLinux OS](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#almalinux), [Rocky Linux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#rockylinux), [CloudLinux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#cloudlinux), and [Ubuntu](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ubuntu) operating systems.
...
A digital certificate used for [SSL/TLS](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ssl) verification. The [certificate authority (CA)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ca) verifies that the applicant controls the DNS domain through a vetting process. These certificates enable HTTPS on a user’s web browser address bar and state that the site is secure with a Secure Site Seal.

- These certificates are more secure than a [DV certificate](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#domain-validated-ssl).
- You can purchase and install certificates in cPanel’s [_SSL/TLS Wizard_](https://docs.cpanel.net/cpanel/security/ssl-tls-wizard) interface ( _cPanel » Home » Security » SSL/TLS Wizard_).
...
2. A collection of software that publishers bundle together for distribution and installation. WebPros International, LLC provides various third-party software, such as [FTP](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ftp) and [MySQL](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#mysql), as [packages](https://docs.cpanel.net/knowledge-base/rpm-versions) that the `rpm.versions` system manages.

##### Parent Node

An authoritative [linked node](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#linked-node) that assigns tasks to one or more [child nodes](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#child-node).
...
- Perl applications are commonly `.pl`, `.pm`, and `.cgi` files and may require [Perl modules](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#perl-modules).
...
A computer scripting language that many web-based applications use. Some PHP applications require [PEAR packages](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#pear).
...
A graphical application that allows server administrators to manipulate and manage MySQL databases over the internet. Server administrators can access this feature in WHM’s [_Database Services_](https://docs.cpanel.net/whm/database-services) section.
...
- For more information about cPanel plugins, read our [Guide to cPanel Plugins](https://api.docs.cpanel.net/guides/guide-to-cpanel-plugins/) documentation.
...
- Encryption schemes use a pair of keys (one [public key](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#public-key) and one private key) to create a secret code.
...
In the context of [Site Quality Monitoring](https://docs.cpanel.net/cpanel/metrics/site-quality-monitoring), a project is **one** website’s root domain, its subdirectories, and its subdomains.
...
**See also:** [Private Key](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#private-key)
...
- [CloudLinux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#cloudlinux)
- [AlmaLinux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#almalinux)
- [Rocky Linux](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#rockylinux)
...
**See also:** [Domain Forwarding](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#domain-forwarding)
...
A registered domain is a domain whose name you register with a domain registrar. A domain registrar manages internet domain names. To learn more about your registrar, read our [How to Identify Your Registrar](https://docs.cpanel.net/knowledge-base/dns/how-to-identify-your-registrar/) documentation.
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#release-tiers). Versions on this tier are feature-complete and well-tested.
...
**See also:** [Restoration](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#restoration)
...
An open-source, community-driven Linux operating system distribution from [Rocky Enterprise Software Foundation](https://www.resf.org/). [Rocky Linux](https://rockylinux.org/) is one of cPanel & WHM’s supported operating systems.

More:

For more information, read our [Rocky Linux Installation Guide](https://docs.cpanel.net/installation-guide/system-requirements-rockylinux/) documentation.
...
1. Specific to Unix and Unix-based systems, the system account. The system administrator uses this account, and it carries full privileges to configure a computer system. See [UID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#uid).
...
For more information about how to create web applications using Ruby in cPanel & WHM, read our [How to Create Ruby Web Applications](https://docs.cpanel.net/knowledge-base/web-services/how-to-create-ruby-web-applications) documentation.
...
On servers that run the AlmaLinux OS operating system, you may see a `named` warning about the absence of SPF resource records on DNS. This warning is not relevant on these servers because [RFC 7208 deprecated SPF records](https://tools.ietf.org/html/rfc7208). AlmaLinux OS servers use TXT records instead of SPF records.
...
A collection of [server roles](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#server-roles) that allow you to optimize a server to perform a specific task or function.
...
This protocol is the standard by which you transmit email messages across the internet. Use SMTP to send mail to a mail server’s [Mail Transfer Agent (MTA)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#mta).
...
An attack in which attackers appear as another user through the falsification of data, in order to conceal their identities. Enable [SPF](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#spf) to make it more difficult for spammers to spoof a domain.

##### Sprite

A type of file that can incorporate several different images. The cPanel interface uses sprites to decrease load time. When you [add an icon](https://api.docs.cpanel.net/guides/guide-to-cpanel-interface-customization-and-branding/guide-to-cpanel-interface-customization-appkeys/), cPanel adds it to the appropriate sprite file.
...
One of cPanel & WHM’s [release tiers](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#release-tiers). Versions on this tier have received considerable public exposure, testing, and verification.
...
An Apache feature that allows users to run CGI and SSI applications on the system as themselves. By default, the system account (the `nobody` account with a [UID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#uid) of `99`) executes CGI and SSI.

## T

##### Tar

A program that collates files for transfer or distribution. The system usually compresses files that this program processes into [tarballs](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#tarball).
...
The cPanel account that manages all team user accounts in the [_Manage Team_](https://docs.cpanel.net/cpanel/preferences/manage-team) interface ( _cPanel » Home » Manage Team_).

##### Team User

A virtual account that exists under the team owner’s account in the [_Manage Team_](https://docs.cpanel.net/cpanel/preferences/manage-team) interface ( _cPanel » Home » Manage Team_).

##### Telnet

A network protocol that allows a user to log in to a remote machine user account remotely. Telnet is similar to [SSH](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ssl), but is **less** secure. **Don’t** use Telnet to connect to your website except for testing purposes. Telnet sends login information as plain text, which others can easily intercept.
...
A temporary domain is an automatically-generated `cpanel.site` subdomain that acts as a cPanel user’s primary domain. You can use a temporary domain to design and collaborate with others on a website without a registered domain.

Accounts with temporary domains cannot use email services or [Search Engine Optimization](https://docs.cpanel.net/cpanel/domains/search-engine-optimization/). You cannot edit a temporary domain’s DNS information.

Additionally, search engines do not rank temporary domains, and they do not affect SEO.
To update the cPanel account’s primary domain to a registered domain, use WHM’s [_Modify an Account_](https://docs.cpanel.net/whm/account-functions/modify-an-account/) interface ( _WHM » Home » Account Functions » Modify an Account)_, or contact your [hosting provider](https://docs.cpanel.net/knowledge-base/cpanel-product/how-to-identify-your-hosting-provider/) to do so.

Note:

- You can only create temporary domains with new cPanel accounts.
- You cannot modify an existing account to use a temporary domain.
...
- cPanel & WHM currently ships with one default cPanel theme and one default WHM theme, as well as Webmail and login themes. To customize the default cPanel theme, use the [_Customization_](https://docs.cpanel.net/whm/cpanel/customization/) interface ( _WHM » Home » cPanel » Customization_).
- Use WHM’s [_Theme Manager_](https://docs.cpanel.net/whm/themes/theme-manager) interface ( _WHM » Home » Themes » Theme Manager_) to install, preview, clone, download, and delete custom themes for the [_cPanel_](https://docs.cpanel.net/cpanel/the-cpanel-interface/the-cpanel-interface/), [_Login_](https://docs.cpanel.net/knowledge-base/accounts/how-to-log-in-to-your-server-or-account/#log-in), and [_Webmail_](https://docs.cpanel.net/webmail/the-webmail-interface/) interfaces.
...
A value that specifies how long clients will cache DNS zone data. You can view this information in WHM’s [_DNS Zone Manager_](https://docs.cpanel.net/whm/dns-functions/dns-zone-manager) interface ( _WHM » Home » DNS Functions » DNS Zone Manager_).
...
- Users can configure 2FA in cPanel’s [_Two-Factor Authentication_](https://docs.cpanel.net/cpanel/security/two-factor-authentication-for-cpanel) interface ( _cPanel » Home » Security » Two-Factor Authentication_) and in the [_Webmail_](https://docs.cpanel.net/webmail/the-webmail-interface) interface.
...
An open-source Linux operating system distribution based on [Debian](https://www.debian.org/). [Ubuntu](https://www.ubuntu.com/) is one of cPanel & WHM’s supported operating systems.

More:

For more information, read our [Ubuntu Installation Guide](https://docs.cpanel.net/installation-guide/system-requirements-ubuntu/) documentation.
...
- `99` — `nobody`, the default executor of [CGI](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#cgi) scripts, if [suEXEC](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#suexec) is disabled. The system reserves UIDs `0` through `100` for system accounts like `admin` and `root`.


##### User Analytics ID

The User Analytics ID is assigned to each cPanel account user for use with [interface analytics](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-analytics/#interface-analytics).
...
Encodes information within a [Uniform Resource Identifier (URI)](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#uri). In URI encoding, you must convert characters that browsers reserve for URL formatting into percent-encoded characters (for example, encode the forward slash (`/`) as `%2F`).
...
A value that the system uses to identify a resource, similar to [GUID](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#guid). UUID is the more common identifier while Microsoft products are the main users of GUID.
...
**See also:** [Dynamic DNS (DDNS) Domain](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#ddns).
...
A program, such as [Apache](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#apache), which receives requests from clients (browsers), retrieves the requested webpages, and serves them.
...
For more information, visit the [Webalizer website](https://webalizer.net/).

##### WebHost Manager (WHM)

Companion software to [cPanel](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#cpanel), which we design for hosting providers, resellers, and system administrators.
...
**See also:** [Blacklist](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#blacklist), [Greylisting](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#greylisting).
...
A SocialBee [workspace](https://help.socialbee.com/article/145-workspaces#what) is a group that manages one or more social media profiles. You can create workspaces to manage profiles together.
...
An administrative space or portion of the [Domain Name System](https://docs.cpanel.net/knowledge-base/cpanel-product/cpanel-glossary/130/#dns). This space directs internet traffic to the correct location. For example, `example.com` is a DNS zone whose servers direct its internet traffic.
