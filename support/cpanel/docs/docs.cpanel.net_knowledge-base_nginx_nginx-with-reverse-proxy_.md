---
url: "https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/"
title: "NGINX® with Reverse Proxy | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#main-content)
...
[Overview](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#overview) [Stop or restart NGINX](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#stop-or-restart-nginx) [Configure a user](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#configure-a-user) [Configure an application](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#configure-an-application) [NGINX-specific packages](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#nginx-specific-packages) [Compression](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#compression) [HTTP2](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#http2) [NGINX JavaScript Module (NJS)](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#nginx-javascript-module-njs) - [The Default Configuration of NGINX with Reverse Proxy](https://docs.cpanel.net/knowledge-base/nginx/the-default-configuration-of-nginx-with-reverse-proxy/)
...
[**Table of Contents**](https://docs.cpanel.net/knowledge-base/nginx/nginx-with-reverse-proxy/#installation-toggle)
