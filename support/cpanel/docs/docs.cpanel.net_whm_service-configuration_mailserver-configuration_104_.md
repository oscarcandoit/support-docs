---
url: "https://docs.cpanel.net/whm/service-configuration/mailserver-configuration/104/"
title: "Mailserver Configuration | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/service-configuration/mailserver-configuration/104/#main-content)
...
[Overview](https://docs.cpanel.net/whm/service-configuration/mailserver-configuration/104/#overview)

* * *

[Mailserver Configuration settings](https://docs.cpanel.net/whm/service-configuration/mailserver-configuration/104/#mailserver-configuration-settings)

* * *

[Add Dovecot settings](https://docs.cpanel.net/whm/service-configuration/mailserver-configuration/104/#add-dovecot-settings)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/service-configuration/mailserver-configuration/104/#table-of-contents-toggle)
...
_Valid for versions 104 through 130_
...
|     |     |
| --- | --- |
| ```<br>1<br>2<br>3<br>4<br>``` | ```go<br>local_name "" {<br>ssl_cert = <<br>ssl_key = <<br>}<br>``` |
...
5. In the `ssl_cert` field, enter the full path of the new domain’s SSL certificate file. For example:
...
6. In the `ssl_key` field, add the full path of the new domain’s SSL certificate’s private key file. For example:
...
- [Mailserver Configuration](https://docs.cpanel.net/whm/service-configuration/mailserver-configuration/)
