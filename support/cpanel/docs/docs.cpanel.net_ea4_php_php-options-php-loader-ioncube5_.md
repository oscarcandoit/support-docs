---
url: "https://docs.cpanel.net/ea4/php/php-options-php-loader-ioncube5/"
title: "PHP Options: PHP Loader: ionCube 5 | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/ea4/php/php-options-php-loader-ioncube5/#main-content)
...
4. PHP Options: PHP Loader: ionCube 5


[whmadvanced](https://docs.cpanel.net/tags/whmadvanced/) [ea4](https://docs.cpanel.net/tags/ea4/) [phpoptions](https://docs.cpanel.net/tags/phpoptions/)

#### Table of Contents

[Overview](https://docs.cpanel.net/ea4/php/php-options-php-loader-ioncube5/#overview)

* * *

[Installation](https://docs.cpanel.net/ea4/php/php-options-php-loader-ioncube5/#installation)

* * *

[In the interface](https://docs.cpanel.net/ea4/php/php-options-php-loader-ioncube5/#in-the-interface)

* * *

[On the command line](https://docs.cpanel.net/ea4/php/php-options-php-loader-ioncube5/#on-the-command-line)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/ea4/php/php-options-php-loader-ioncube5/#table-of-contents-toggle)
...
To install or uninstall ionCube 5, use WHM’s [_EasyApache 4_](https://docs.cpanel.net/whm/software/easyapache-4-interface) interface ( _WHM » Home » Software » EasyApache 4_).
