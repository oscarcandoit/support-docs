---
url: "https://docs.cpanel.net/whm/server-configuration/tweak-settings/sql/"
title: "Tweak Settings — SQL | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/server-configuration/tweak-settings/sql/#main-content)
...
[**Table of Contents**](https://docs.cpanel.net/whm/server-configuration/tweak-settings/sql/#installation-toggle)
