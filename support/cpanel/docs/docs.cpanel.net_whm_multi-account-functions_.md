---
url: "https://docs.cpanel.net/whm/multi-account-functions/"
title: "Multi Account Functions | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/multi-account-functions/#main-content)
...
[Read more](https://docs.cpanel.net/whm/multi-account-functions/change-multiple-sites-ip-addresses/)
...
[Read more](https://docs.cpanel.net/whm/multi-account-functions/modify-upgrade-multiple-accounts/)
