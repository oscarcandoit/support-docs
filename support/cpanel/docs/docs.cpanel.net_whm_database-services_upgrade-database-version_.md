---
url: "https://docs.cpanel.net/whm/database-services/upgrade-database-version/"
title: "Upgrade Database Version | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#main-content)
...
[Overview](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#overview)

* * *

[Before installation](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#before-installation)

* * *

[Installation limitations](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#installation-limitations)

* * *

[CloudLinux’s MySQL Governor](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#cloudlinuxs-mysql-governor)

* * *

[The phpinfo file](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#the-phpinfo-file)

* * *

[Amazon Relational Database Service](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#amazon-relational-database-service)

* * *

[Available versions](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#available-versions)

* * *

[Upgrade or reinstall MySQL or MariaDB](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#upgrade-or-reinstall-mysql-or-mariadb)

* * *

[The MySQL Upgrade Checker Utility](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#the-mysql-upgrade-checker-utility)

* * *

[MySQL upgrade log](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#mysql-upgrade-log)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/database-services/upgrade-database-version/#table-of-contents-toggle)
...
#### [120](https://docs.cpanel.net/whm/database-services/upgrade-database-version/120/)

#### [124](https://docs.cpanel.net/whm/database-services/upgrade-database-version/124/)

#### [126](https://docs.cpanel.net/whm/database-services/upgrade-database-version/)
...
This interface allows the `root` user or resellers with `root`-level privileges to manage MySQL® or MariaDB® version upgrades (for example, when you upgrade from MySQL 5.7 to 8.4). After you select your server’s MySQL or MariaDB version, WHM automatically keeps your database engine up-to-date. This means, for example, that whenever the vendor releases a new patch for your server’s version of MySQL or MariaDB, WHM automatically applies the patch to your installation.

Note:

In cPanel & WHM version 118 and earlier, we titled this interface [_MySQL/MariaDB Upgrade_](https://docs.cpanel.net/whm/sql-services/mysql-or-mariadb-upgrade) and its section in the WHM interface [SQL Services](https://docs.cpanel.net/whm/sql-services/).
...
- We do **not** support the use of MySQL’s [sha256\_password](https://dev.mysql.com/doc/refman/5.7/en/sha256-pluggable-authentication.html) plugin for MySQL 5.7, MySQL 8.0, MySQL 8.4, MariaDB 10.2, or MariaDB 10.3.
...
- System administrators can choose either MySQL or MariaDB during the cPanel & WHM installation process. For more information, read our [Installation Guide](https://docs.cpanel.net/installation-guide).
