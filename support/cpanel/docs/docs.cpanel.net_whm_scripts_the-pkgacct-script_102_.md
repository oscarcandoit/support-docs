---
url: "https://docs.cpanel.net/whm/scripts/the-pkgacct-script/102/"
title: "The pkgacct Script | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/whm/scripts/the-pkgacct-script/102/#main-content)
...
[Overview](https://docs.cpanel.net/whm/scripts/the-pkgacct-script/102/#overview)

* * *

[Server requirements](https://docs.cpanel.net/whm/scripts/the-pkgacct-script/102/#server-requirements)

* * *

[Run the script](https://docs.cpanel.net/whm/scripts/the-pkgacct-script/102/#run-the-script)

* * *

[Options](https://docs.cpanel.net/whm/scripts/the-pkgacct-script/102/#options)

* * *

[Use a custom pkgacct script](https://docs.cpanel.net/whm/scripts/the-pkgacct-script/102/#use-a-custom-pkgacct-script)

* * *

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/whm/scripts/the-pkgacct-script/102/#table-of-contents-toggle)
...
_Valid for versions 102 through 122_
...
Last modified: _2025 July 7_

* * *

## Overview

You can use the `/usr/local/cpanel/scripts/pkgacct` script to [create a `cpmove` archive](https://docs.cpanel.net/whm/scripts/the-pkgacct-script/102/#use-a-custom-pkgacct-script) for an account. After you create the archive, you can then restore the account on any cPanel & WHM servers. By default, this script compresses the `cpmove` archive.
...
- [The pkgacct Script](https://docs.cpanel.net/whm/scripts/the-pkgacct-script/)
