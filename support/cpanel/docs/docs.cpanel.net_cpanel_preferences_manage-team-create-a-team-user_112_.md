---
url: "https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/112/"
title: "Manage Team — Create a Team User | cPanel & WHM Documentation"
---

[Skip to main content](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/112/#main-content)
...
[Overview](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/112/#overview) [Create a Team User](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/112/#create-a-team-user) [MySQL® and team users](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/112/#mysql-and-team-users) - [Edit a Team User](https://docs.cpanel.net/cpanel/preferences/manage-team-edit-a-team-user/)

Was this helpful?

[**Table of Contents**](https://docs.cpanel.net/cpanel/preferences/manage-team-create-a-team-user/112/#installation-toggle)
...
7. In the _Security Settings_ section, you can enter expiration information for the new team user. The expiration setting [suspends](https://docs.cpanel.net/cpanel/preferences/manage-team/#suspend-a-team-user) the account on the specified date in the future.
