...
## [Creating a project](https://vercel.com/docs/projects/managing-projects\#creating-a-project)
...
![ Creating a new project from the Vercel dashboard.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fadd-new-project-light.png&w=1920&q=75)![ Creating a new project from the Vercel dashboard.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fadd-new-project-dark.png&w=1920&q=75) Creating a new project from the Vercel dashboard.

1. You can either [import from an existing Git repository](https://vercel.com/docs/git) or use one of our [templates](https://vercel.com/templates). For more information, see our [Getting Started with Vercel](https://vercel.com/docs/getting-started-with-vercel/projects-deployments).
2. If you choose to import from a Git repository, you'll be prompted to select the repository you want to deploy.
3. Configure your project settings, such as the name, [framework](https://vercel.com/docs/frameworks), [environment variables](https://vercel.com/docs/environment-variables), and [build and output settings](https://vercel.com/docs/deployments/configure-a-build#configuring-a-build).
4. If you're importing from a monorepo, select the Edit button to select the project from the repository you want to deploy. For more information, see [Monorepos](https://vercel.com/docs/monorepos#add-a-monorepo-through-the-vercel-dashboard).
...
## [Pausing a project](https://vercel.com/docs/projects/managing-projects\#pausing-a-project)

You can choose to temporarily pause a project to ensure that you do not incur usage from [metered resources](https://vercel.com/docs/limits#additional-resources) on your production deployment.

### [Pausing a project when you reach your spend amount](https://vercel.com/docs/projects/managing-projects\#pausing-a-project-when-you-reach-your-spend-amount)
...
To learn more, see the [Spend Management documentation](https://vercel.com/docs/spend-management#pausing-projects).

### [Pause a project using the REST API](https://vercel.com/docs/projects/managing-projects\#pause-a-project-using-the-rest-api)

To pause a project manually or with a webhook you can use the [REST API](https://vercel.com/docs/rest-api/reference/endpoints/projects/pause-a-project):
...
2. Create a webhook that calls the pause project [endpoint](https://vercel.com/docs/rest-api/reference/endpoints/projects/pause-a-project):
   - You'll need to pass a path parameter of the [Project ID](https://vercel.com/docs/projects/overview#project-id) and query string of [Team ID](https://vercel.com/docs/accounts#find-your-team-id):
...
You can also manually make a POST request to the [pause project\\
endpoint](https://vercel.com/docs/rest-api/reference/endpoints/projects/pause-a-project) without
using webhook.

### [Resuming a project](https://vercel.com/docs/projects/managing-projects\#resuming-a-project)

Resuming a project can either be done through the [REST API](https://vercel.com/docs/rest-api/reference/endpoints/projects/unpause-a-project) or your project settings:
...
## [Deleting a project](https://vercel.com/docs/projects/managing-projects\#deleting-a-project)
...
1. On the Vercel [dashboard](https://vercel.com/dashboard), ensure you have selected the correct team from the [scope selector](https://vercel.com/docs/dashboard-features#scope-selector) and select the project you want to delete.
2. Select the Settings tab.
3. At the bottom of the General page, you’ll see the Delete Project section. Click the Delete button.![The Delete Project section.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fdelete-project-light.png&w=1920&q=75)![The Delete Project section.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fdelete-project-dark.png&w=1920&q=75)The Delete Project section.
