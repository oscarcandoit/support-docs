...
Alertsare availablein [Beta](https://vercel.com/docs/release-phases#beta)on[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans with [Observability Plus](https://vercel.com/docs/observability/observability-plus)
...
## [Alert types](https://vercel.com/docs/alerts\#alert-types)

| Alert Type | Triggered when | Webhook Event | Slack Event |
| --- | --- | --- | --- |
| Error Anomaly | Fires when your 5-minute error rate (5xx) is more than 4 standard deviations above your 24-hour average and exceeds the minimum threshold. | [observability.error-anomaly](https://vercel.com/docs/webhooks/webhooks-api#observability.error-anomaly) | observability\_anomaly\_error |
| Usage Anomaly | Fires when your 5-minute usage is more than 4 standard deviations above your 24-hour average and exceeds the minimum threshold. | [observability.usage-anomaly](https://vercel.com/docs/webhooks/webhooks-api#observability.usage-anomaly) | observability\_anomaly |
...
3. Then, pick how you'd like to be notified: [Email](https://vercel.com/docs/alerts#vercel-notifications), [Slack](https://vercel.com/docs/alerts#slack-integration), or [Webhook](https://vercel.com/docs/alerts#webhook).

### [Vercel Notifications](https://vercel.com/docs/alerts\#vercel-notifications)

You can subscribe to alerts about anomalies through the standard [Vercel notifications](https://vercel.com/docs/notifications), which will notify you through either email or the Vercel dashboard.
...
### [Slack integration](https://vercel.com/docs/alerts\#slack-integration)
...
### [Webhook](https://vercel.com/docs/alerts\#webhook)
...
4. Fill out the webhook details:
   - Pick which [observability events](https://vercel.com/docs/alerts#alert-types) to listen to
   - Choose which projects to monitor
   - Add your endpoint URL

You can also set this up through [account webhooks](https://vercel.com/docs/webhooks#account-webhooks), just pick the events you want under Observability Events.

#### [Webhooks payload](https://vercel.com/docs/alerts\#webhooks-payload)

To learn more about the webhook payload, see the [Webhooks API Reference](https://vercel.com/docs/webhooks/webhooks-api) for each event type:

- [Usage anomaly](https://vercel.com/docs/webhooks/webhooks-api#observability.usage-anomaly)
- [Error anomaly](https://vercel.com/docs/webhooks/webhooks-api#observability.error-anomaly)

## [Investigate alerts with AI](https://vercel.com/docs/alerts\#investigate-alerts-with-ai)

When you get an error alert, [Agent Investigation](https://vercel.com/docs/agent/investigation) can run automatically to help you debug faster. Instead of manually digging through logs and metrics, AI analyzes what's happening and displays highlights of the anomaly directly in your dashboard.
...
Learn more in the [Agent Investigation docs](https://vercel.com/docs/agent/investigation).
