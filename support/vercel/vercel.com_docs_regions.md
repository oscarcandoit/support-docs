...
## [Global infrastructure](https://vercel.com/docs/regions\#global-infrastructure)
...
### [Caching strategy](https://vercel.com/docs/regions\#caching-strategy)
...
## [Region list](https://vercel.com/docs/regions\#region-list)
...
### [Points of Presence (PoPs)](https://vercel.com/docs/regions\#points-of-presence-pops)
...
## [Local development regions](https://vercel.com/docs/regions\#local-development-regions)
...
## [Compute defaults](https://vercel.com/docs/regions\#compute-defaults)

- Vercel Functions default to running in the `iad1` (Washington, D.C., USA) region. Learn more about [changing function regions](https://vercel.com/docs/functions/regions)

Functions should be executed in the same region as your database, or as close to it as possible, [for the lowest latency](https://vercel.com/kb/guide/choosing-deployment-regions).
...
- For Enterprise customers, Vercel functions can automatically failover to a different region if the region they are running in becomes unavailable. Learn more about [Vercel Function failover](https://vercel.com/docs/functions/configuring-functions/region#automatic-failover).
