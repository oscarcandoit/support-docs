...
- [Private npm packages](https://vercel.com/docs/builds/build-features#private-npm-packages)
- [Ignored files and folders](https://vercel.com/docs/builds/build-features#ignored-files-and-folders)
- [Special paths](https://vercel.com/docs/builds/build-features#special-paths)
- [Git submodules](https://vercel.com/docs/builds/build-features#git-submodules)
...
To install private `npm` modules, define `NPM_TOKEN` as an [Environment Variable](https://vercel.com/docs/environment-variables) in your project. Alternatively, define `NPM_RC` as an [Environment Variable](https://vercel.com/docs/environment-variables) in the contents of the project's npmrc config file that resides at the root of the project folder and is named `~/.npmrc`. This file defines the config settings of `npm` at the level of the project.

To learn more, check out the [guide here](https://vercel.com/kb/guide/using-private-dependencies-with-vercel) if you need help configuring private dependencies.
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fbuild-step%2Flogs-and-sources-light.png&w=3840&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fbuild-step%2Flogs-and-sources-dark.png&w=3840&q=75)

Build Logs and Source Protection is enabled by default.

### [Source View](https://vercel.com/docs/builds/build-features\#source-view)

By appending `/_src` to a Deployment URL or [Custom Domain](https://vercel.com/docs/domains/add-a-domain) in your web browser, you will be redirected to the Deployment inspector and be able to browse the sources and [build](https://vercel.com/docs/deployments/configure-a-build) outputs.

### [Logs View](https://vercel.com/docs/builds/build-features\#logs-view)

By appending `/_logs` to a Deployment URL or [Custom Domain](https://vercel.com/docs/domains/add-a-domain) in your web browser, you can see a real-time stream of logs from your deployment build processes by clicking on the Build Logs accordion.

### [Security considerations](https://vercel.com/docs/builds/build-features\#security-considerations)
...
You can configure these paths to make them publicly accessible under the Security tab on the Project Settings page. You can learn more about making paths publicly accessible in the [Build Logs and Source Protection](https://vercel.com/docs/projects/overview#logs-and-source-protection) section.

## [Git submodules](https://vercel.com/docs/builds/build-features\#git-submodules)

On Vercel, you can deploy [Git submodules](https://git-scm.com/book/en/v2/Git-Tools-Submodules) with a [Git provider](https://vercel.com/docs/git) as long as the submodule is publicly accessible through the HTTP protocol. Git submodules that are private or requested over SSH will fail during the Build step. However, you can reference private repositories formatted as npm packages in your `package.json` file dependencies. Private repository modules require a special link syntax that varies according to the Git provider. For more information on this syntax, see " [How do I use private dependencies with Vercel?](https://vercel.com/kb/guide/using-private-dependencies-with-vercel)".
