...
## [Benefits of using an `iframe`](https://vercel.com/docs/security/pci-dss\#benefits-of-using-an-iframe)
...
## [Integrate an `iframe` for payment processing](https://vercel.com/docs/security/pci-dss\#integrate-an-iframe-for-payment-processing)
