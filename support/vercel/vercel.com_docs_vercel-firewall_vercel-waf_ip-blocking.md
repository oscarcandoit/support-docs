...
## [Access roles](https://vercel.com/docs/vercel-firewall/vercel-waf/ip-blocking\#access-roles)
...
## [Project level IP Blocking](https://vercel.com/docs/vercel-firewall/vercel-waf/ip-blocking\#project-level-ip-blocking)

Project level IP Blockingis availableon [all plans](https://vercel.com/docs/plans)
...
## [Account-level IP Blocking](https://vercel.com/docs/vercel-firewall/vercel-waf/ip-blocking\#account-level-ip-blocking)

Account-level IP Blockingis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
### [How to add an IP block rule](https://vercel.com/docs/vercel-firewall/vercel-waf/ip-blocking\#how-to-add-an-ip-block-rule)
...
## [More resources](https://vercel.com/docs/vercel-firewall/vercel-waf/ip-blocking\#more-resources)

- [Geolocation region block](https://vercel.com/kb/guide/suspicious-traffic-in-specific-countries)
