...
## [Get started with Flask on Vercel](https://vercel.com/docs/frameworks/backend/flask\#get-started-with-flask-on-vercel)

You can quickly deploy a Flask application to Vercel by creating a Flask app or using an existing one:

[![](https://api-frameworks.vercel.sh/framework-logos/flask.svg)Deploy Flask to Vercel](https://vercel.com/templates/python/flask-python-boilerplate)

[Deploy](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fvercel%2Ftree%2Fmain%2Fexamples%2Fflask&template=flask) [Live Example](https://vercel-plus-flask.vercel.app/)

### [Get started with Vercel CLI](https://vercel.com/docs/frameworks/backend/flask\#get-started-with-vercel-cli)

Get started by initializing a new Flask project using [Vercel CLI init command](https://vercel.com/docs/cli/init):
...
## [Exporting the Flask application](https://vercel.com/docs/frameworks/backend/flask\#exporting-the-flask-application)
...
### [Build command](https://vercel.com/docs/frameworks/backend/flask\#build-command)
...
### [Local development](https://vercel.com/docs/frameworks/backend/flask\#local-development)
...
### [Deploying the application](https://vercel.com/docs/frameworks/backend/flask\#deploying-the-application)
...
## [Serving static assets](https://vercel.com/docs/frameworks/backend/flask\#serving-static-assets)
...
Flask's `app.static_folder` should not be used for static files on Vercel. Use
the `public/**` directory instead.

## [Vercel Functions](https://vercel.com/docs/frameworks/backend/flask\#vercel-functions)

When you deploy a Flask app to Vercel, the application becomes a single [Vercel Function](https://vercel.com/docs/functions) and uses [Fluid compute](https://vercel.com/docs/fluid-compute) by default. This means your Flask app will automatically scale up and down based on traffic.

## [Limitations](https://vercel.com/docs/frameworks/backend/flask\#limitations)

All [Vercel Functions limitations](https://vercel.com/docs/functions/limitations) apply to Flask applications, including:
...
## [More resources](https://vercel.com/docs/frameworks/backend/flask\#more-resources)
