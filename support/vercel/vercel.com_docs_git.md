...
For Azure DevOps repositories, use the [Vercel Deployment\\
...
You cannot deploy to a Hobby team from a private repository in a GitHub organization, GitLab group, or Bitbucket workspace. Consider making the repository public or upgrading to [Pro](https://vercel.com/docs/plans/pro).
