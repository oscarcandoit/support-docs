...
To prevent sensitive data from being sent to Vercel, you can pass in the `beforeSend` function that modifies the event before it is sent. To learn more about the `beforeSend` function and how it can be used with other frameworks, see the [@vercel/analytics](https://vercel.com/docs/analytics/package) package documentation.

## [Ignoring events or routes](https://vercel.com/docs/analytics/redacting-sensitive-data\#ignoring-events-or-routes)
...
## [Removing query parameters](https://vercel.com/docs/analytics/redacting-sensitive-data\#removing-query-parameters)
...
## [Allowing users to opt-out of tracking](https://vercel.com/docs/analytics/redacting-sensitive-data\#allowing-users-to-opt-out-of-tracking)
