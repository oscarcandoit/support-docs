---
url: "https://vercel.com/docs/edge-config"
...
Ruby, Go, and Python](https://vercel.com/docs/functions/runtimes) upon request. See [our Edge\\
Config limits docs](https://vercel.com/docs/edge-config/edge-config-limits) to learn more.

## [Use cases](https://vercel.com/docs/edge-config\#use-cases)
...
**Feature flags and A/B testing**: Experiment with A/B testing by
storing feature flags in your Edge Config. Fetching such data from Edge Config
rather than a database can cut page loads by hundreds of milliseconds. [Deploy\\
the template](https://vercel.com/templates/next.js/feature-flag-apple-store)
...
action](https://vercel.com/docs/security/vercel-waf/rule-configuration#actions) based on
specific conditions. For more details, check the [emergency\\
redirect](https://vercel.com/docs/security/vercel-waf/examples#emergency-redirect) example.
...
## [Getting started](https://vercel.com/docs/edge-config\#getting-started)

You can create and manage your Edge Config from either [Vercel REST API](https://vercel.com/docs/edge-config/vercel-api) or [Dashboard](https://vercel.com/docs/edge-config/edge-config-dashboard). You can scope your Edge Configs to your Hobby team or [team](https://vercel.com/docs/accounts/create-a-team), and connect them to as many projects as you want.

To get started, see [our quickstart](https://vercel.com/docs/edge-config/get-started).
...
[![LaunchDarkly Integration example](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F5at5W00aNo6noTLTx7q8AM%2F158dc4f49131706f60864f37861c675f%2FCleanShot_2023-06-20_at_12.43.11.png&w=3840&q=75)\\
\\
LaunchDarkly Integration example\\
\\
Learn how to set up the LaunchDarkly integration to read flags from Edge Config](https://vercel.com/templates/next.js/feature-flag-launchdarkly) [![Dynamic Model Usage with AI SDK](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F0YgPDxAUUI9MD8EhGCbI5%2Fec6e59b3d4615792ec32f398397b72df%2FUntitled_design__3_.png&w=3840&q=75)\\
\\
Dynamic Model Usage with AI SDK\\
\\
A chatbot that allows you to dynamically set the LLM using Vercel AI SDK with Feature Flags and Edge Config](https://vercel.com/templates/next.js/ai-sdk-feature-flags-edge-config) [![Maintenance Page](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F4MY7E65qHkruy3TluLsB0S%2Fdd589bb3288c370326295a088d001512%2Fmaintenance-page.png&w=3840&q=75)\\
\\
Maintenance Page\\
\\
This template shows how to quickly trigger a maintenance page using Edge Config](https://vercel.com/templates/next.js/maintenance-page)

[View All Templates](https://vercel.com/templates/edge-config)

## [Using Edge Config in your workflow](https://vercel.com/docs/edge-config\#using-edge-config-in-your-workflow)
...
## [Why use Edge Config instead of alternatives?](https://vercel.com/docs/edge-config\#why-use-edge-config-instead-of-alternatives)
...
## [Limits](https://vercel.com/docs/edge-config\#limits)

To learn about Edge Config limits and pricing, see [our Edge Config limits docs](https://vercel.com/docs/edge-config/edge-config-limits).

## [More resources](https://vercel.com/docs/edge-config\#more-resources)

- [Quickstart](https://vercel.com/docs/edge-config/get-started)
- [Read with the SDK](https://vercel.com/docs/edge-config/edge-config-sdk)
- [Use the Dashboard](https://vercel.com/docs/edge-config/edge-config-dashboard)
- [Manage with the API](https://vercel.com/docs/edge-config/vercel-api)
