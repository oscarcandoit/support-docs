...
## [Alpha](https://vercel.com/docs/release-phases\#alpha)
...
## [Beta](https://vercel.com/docs/release-phases\#beta)
...
Products in a Beta state, are **not** covered under the [Service\\
Level Agreement](https://vercel.com/legal/sla) (SLA) for Enterprise plans.
Vercel **does not** recommend using Beta products in a full
production environment.

### [Private Beta](https://vercel.com/docs/release-phases\#private-beta)
...
The product is under active development with limited customer access - may
include an NDA.

### [Limited Beta](https://vercel.com/docs/release-phases\#limited-beta)
...
The product is under active development, and has been publicly announced.
Limited customer access - may include an NDA.

### [Public Beta](https://vercel.com/docs/release-phases\#public-beta)
...
See the [Public Beta Agreement](https://vercel.com/docs/release-phases/public-beta-agreement) for detailed information.

## [General Availability](https://vercel.com/docs/release-phases\#general-availability)
...
## [Deprecated and Sunset](https://vercel.com/docs/release-phases\#deprecated-and-sunset)
