...
## [Local Development Environment](https://vercel.com/docs/deployments/environments\#local-development-environment)

This environment is where you develop new features and fix bugs on your local machine. When building with [frameworks](https://vercel.com/docs/frameworks), use the [Vercel CLI](https://vercel.com/docs/cli) to pull the environment variables for your project.
...
## [Preview Environment (Pre-production)](https://vercel.com/docs/deployments/environments\#preview-environment-pre-production)
...
- Create a pull request (PR) on [GitHub, GitLab, or Bitbucket](https://vercel.com/docs/git)
...
Learn more about [generated URLs](https://vercel.com/docs/deployments/generated-urls).

## [Production Environment](https://vercel.com/docs/deployments/environments\#production-environment)
...
### [Creating a custom environment](https://vercel.com/docs/deployments/environments\#creating-a-custom-environment)
...
### [Using custom environments via the CLI](https://vercel.com/docs/deployments/environments\#using-custom-environments-via-the-cli)
...
### [Pricing and limits](https://vercel.com/docs/deployments/environments\#pricing-and-limits)
...
## [More resources](https://vercel.com/docs/deployments/environments\#more-resources)
