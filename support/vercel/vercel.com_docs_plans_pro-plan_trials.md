...
The Pro trial offers an opportunity to explore [Pro features](https://vercel.com/docs/plans/pro-plan) for free during the trial period. There are some [limitations](https://vercel.com/docs/plans/pro-plan/trials#trial-limitations).

## [Starting a trial](https://vercel.com/docs/plans/pro-plan/trials\#starting-a-trial)
...
## [Trial Limitations](https://vercel.com/docs/plans/pro-plan/trials\#trial-limitations)

The trial plan includes a $20 credit and follows the same [general limits](https://vercel.com/docs/limits#general-limits) as a regular plan but with specified usage restrictions. See how these compare to the [non-trial usage limits](https://vercel.com/docs/limits#included-usage):
...
| Projects | 200 |
| [Active CPU](https://vercel.com/docs/functions/usage-and-pricing) | 8 CPU-hrs |
| [Provisioned Memory](https://vercel.com/docs/functions/usage-and-pricing) | 720 GB-hrs |
| [Function Invocations](https://vercel.com/docs/functions/usage-and-pricing) | 1,000,000/month |
| Build Execution | Max. 200 Hrs |
| [Image transformations](https://vercel.com/docs/image-optimization/limits-and-pricing#image-transformations) | Max. 5K/month |
| [Image cache reads](https://vercel.com/docs/image-optimization/limits-and-pricing#image-cache-reads) | Max. 300K/month |
| [Image cache writes](https://vercel.com/docs/image-optimization/limits-and-pricing#image-cache-writes) | Max. 100K/month |
| [Monitoring](https://vercel.com/docs/observability/monitoring) | Max. 125,000 metrics |
...
Once your usage of [Active CPU](https://vercel.com/docs/functions/usage-and-pricing), [Provisioned Memory](https://vercel.com/docs/functions/usage-and-pricing), or [Function Invocations](https://vercel.com/docs/functions/usage-and-pricing) exceeds or reaches 100% of the Pro trial usage, your trial will be paused.

## [Post-Trial Decision](https://vercel.com/docs/plans/pro-plan/trials\#post-trial-decision)
...
- [Upgrade to a paid Pro plan](https://vercel.com/docs/plans/pro-plan/trials#upgrade-to-a-paid-pro-plan)
- [Revert to a Hobby plan](https://vercel.com/docs/plans/pro-plan/trials#revert-to-a-hobby-plan)
...
To add a payment method, navigate to the Billings page through Settings > Billing. From this point, you will get billed according to the [number of users in your team](https://vercel.com/docs/plans/pro/billing#what-is-a-billing-cycle).

#### [When will I get billed?](https://vercel.com/docs/plans/pro-plan/trials\#when-will-i-get-billed)
...
Charges apply only if you have a payment method. If a trial finishes and you
...
### [Downgraded to Hobby](https://vercel.com/docs/plans/pro-plan/trials\#downgraded-to-hobby)

If your Pro trial account gets downgraded to a Hobby team, you can revert this by upgrading to Pro. If you've transferred out the projects that were exceeding the included Hobby usage and want to unpause your Hobby team, [contact support](https://vercel.com/help).
...
#### [What if I resume using Vercel months after my trial ends?](https://vercel.com/docs/plans/pro-plan/trials\#what-if-i-resume-using-vercel-months-after-my-trial-ends)
...
- [Revert to a Hobby plan](https://vercel.com/docs/plans/pro-plan/trials#revert-to-a-hobby-plan)
- [Downgraded to Hobby](https://vercel.com/docs/plans/pro-plan/trials#downgraded-to-hobby)
- [What if I resume using Vercel ...](https://vercel.com/docs/plans/pro-plan/trials#what-if-i-resume-using-vercel-months-after-my-trial-ends)
