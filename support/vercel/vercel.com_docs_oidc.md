...
Secure backend access with OIDC federation is available on [all plans](https://vercel.com/docs/plans)
...
### [Benefits](https://vercel.com/docs/oidc\#benefits)
...
## [Getting started](https://vercel.com/docs/oidc\#getting-started)
...
- [Connect to Amazon Web Services (AWS)](https://vercel.com/docs/oidc/aws)
- [Connect to Google Cloud Platform (GCP)](https://vercel.com/docs/oidc/gcp)
- [Connect to Microsoft Azure](https://vercel.com/docs/oidc/azure)
- [Connect to your own API](https://vercel.com/docs/oidc/api)

## [Issuer mode](https://vercel.com/docs/oidc\#issuer-mode)
...
## [How OIDC token federation works](https://vercel.com/docs/oidc\#how-oidc-token-federation-works)

### [In Builds](https://vercel.com/docs/oidc\#in-builds)
...
### [In Vercel Functions](https://vercel.com/docs/oidc\#in-vercel-functions)
...
### [In Local Development](https://vercel.com/docs/oidc\#in-local-development)
...
to `development` to the `.env.local` file of your project folder. See the [CLI docs](https://vercel.com/docs/cli/env) for more information.

## [Related](https://vercel.com/docs/oidc\#related)

[**Helper libraries** \\
\\
Review libraries to help you connect to your backend with OIDC.](https://vercel.com/docs/oidc/reference#helper-libraries)

[**OIDC token anatomy** \\
\\
Understand the structure of an OIDC token.](https://vercel.com/docs/oidc/reference#oidc-token-anatomy)
