...
This guide demonstrates how to integrate [Vercel AI Gateway](https://vercel.com/docs/ai-gateway)
with Pydantic AI to access various AI models and providers.

## [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai\#getting-started)

1. ### [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai\#create-a-new-project)
...
2. ### [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai\#install-dependencies)
...
3. ### [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai\#configure-environment-variables)
...
deployment](https://vercel.com/docs/ai-gateway#using-the-ai-gateway-with-a-vercel-oidc-token),
you can also use the `VERCEL_OIDC_TOKEN` environment variable which will be
automatically provided.

4. ### [Create your Pydantic AI application](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai\#create-your-pydantic-ai-application)
...
5. ### [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai\#running-the-application)
...
- [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai#getting-started)
- [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai#create-a-new-project)
- [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai#install-dependencies)
- [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai#configure-environment-variables)
- [Create your Pydantic AI application](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai#create-your-pydantic-ai-application)
- [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/pydantic-ai#running-the-application)
