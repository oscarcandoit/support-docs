---
url: "https://vercel.com/docs/edge-config/get-started"
...
This guide will help you will create an Edge Config called `hello_world_store` at the project-level, through the Vercel [dashboard](https://vercel.com/dashboard). A token and environment variable `EDGE_CONFIG`, that stores the connection string, will be automatically created for you. You'll update the store with a key-value data pair and read the value of `"greeting"` from a local Next.js project.

## [Prerequisites](https://vercel.com/docs/edge-config/get-started\#prerequisites)
...
1. ### [Create an Edge Config store](https://vercel.com/docs/edge-config/get-started\#create-an-edge-config-store)



Navigate to the [Project](https://vercel.com/docs/projects/overview) you'd like to add an Edge Config store to. Click on the Storage tab, then click the Create Database button. Select Edge Config and click Continue.
...
2. ### [Review what was created](https://vercel.com/docs/edge-config/get-started\#review-what-was-created)
...
3. ### [Add a key-value pair](https://vercel.com/docs/edge-config/get-started\#add-a-key-value-pair)
...
You can see more information about what can be stored in an Edge Config in the [limits](https://vercel.com/docs/edge-config/edge-config-limits) documentation.

4. ### [Connect your Vercel project](https://vercel.com/docs/edge-config/get-started\#connect-your-vercel-project)
...
On your local machine, connect your Vercel Project. If you haven't already, install the Edge Config SDK, as mentioned in [prerequisites](https://vercel.com/docs/edge-config/get-started#prerequisites).

5. ### [Pull the latest environment variables](https://vercel.com/docs/edge-config/get-started\#pull-the-latest-environment-variables)
...
6. ### [Create a Middleware](https://vercel.com/docs/edge-config/get-started\#create-a-middleware)



Create a [Middleware](https://vercel.com/docs/routing-middleware) for your project by creating a new file called `middleware.js` at the root of the project and if using Next.js, add the following code:
...
7. ### [Run your application locally](https://vercel.com/docs/edge-config/get-started\#run-your-application-locally)
...
Your project is now ready to read more key-value data pairs from the `hello_world_store` Edge Config using the [SDK](https://vercel.com/docs/edge-config/edge-config-sdk) or [Vercel REST API](https://vercel.com/docs/edge-config/vercel-api).
...
## [Next steps](https://vercel.com/docs/edge-config/get-started\#next-steps)

Now that you've created an Edge Config store and read from it, you can explore the following:

- [Creating the Edge Config at the account level](https://vercel.com/docs/edge-config/edge-config-dashboard#at-the-account-level)
- [Creating a read access token](https://vercel.com/docs/edge-config/using-edge-config#creating-a-read-access-token)
- [Setting up a connection string](https://vercel.com/docs/edge-config/using-edge-config#using-a-connection-string)
- [Learn about the `@vercel/edge-config` package](https://github.com/vercel/storage/tree/main/packages/edge-config#readme)
- [Explore the SDK](https://vercel.com/docs/edge-config/edge-config-sdk)
...
- [Prerequisites](https://vercel.com/docs/edge-config/get-started#prerequisites)
- [Create an Edge Config store](https://vercel.com/docs/edge-config/get-started#create-an-edge-config-store)
- [Review what was created](https://vercel.com/docs/edge-config/get-started#review-what-was-created)
- [Add a key-value pair](https://vercel.com/docs/edge-config/get-started#add-a-key-value-pair)
- [Connect your Vercel project](https://vercel.com/docs/edge-config/get-started#connect-your-vercel-project)
- [Pull the latest environment variables](https://vercel.com/docs/edge-config/get-started#pull-the-latest-environment-variables)
- [Create a Middleware](https://vercel.com/docs/edge-config/get-started#create-a-middleware)
- [Run your application locally](https://vercel.com/docs/edge-config/get-started#run-your-application-locally)
- [Next steps](https://vercel.com/docs/edge-config/get-started#next-steps)
