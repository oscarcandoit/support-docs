...
## [Bandwidth](https://vercel.com/docs/pricing/legacy\#bandwidth)

Bandwidth is the amount of data your deployments have sent or received.
This chart includes traffic for both [preview](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) and
[production](https://vercel.com/docs/deployments/environments#production-environment) deployments.

You are not billed for bandwidth usage on [blocked or\\
paused](https://vercel.com/kb/guide/why-is-my-account-deployment-blocked#pausing-process)
deployments.
...
Data used by [ISR](https://vercel.com/docs/incremental-static-regeneration) and the responses from the [CDN](https://vercel.com/docs/cdn) and [Vercel functions](https://vercel.com/docs/functions) count as outgoing bandwidth
- Incoming: Incoming bandwidth measures the amount of data that your deployments have received from your users

An example of incoming bandwidth would be page views requested by the browser. All requests sent to the [CDN](https://vercel.com/docs/cdn) and [Vercel functions](https://vercel.com/docs/functions) are collected as incoming bandwidth.

Incoming bandwidth is usually much smaller than outgoing bandwidth for website projects.

## [Requests](https://vercel.com/docs/pricing/legacy\#requests)

Requests are the number of requests made to your deployments. This chart includes traffic for both [preview](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) and [production](https://vercel.com/docs/deployments/environments#production-environment) deployments.

Requests can be filtered by:

- Ratio: The ratio of requests that are cached and uncached by the [CDN](https://vercel.com/docs/cdn)
- Projects: The projects that the requests are made to

## [Vercel Function Invocations](https://vercel.com/docs/pricing/legacy\#vercel-function-invocations)

Vercel Function Invocations are the number of times your [Vercel functions](https://vercel.com/docs/functions) have receive a request, excluding cache hits.
...
## [Vercel Function Execution](https://vercel.com/docs/pricing/legacy\#vercel-function-execution)

Vercel Function Execution is the amount of time your [Vercel functions](https://vercel.com/docs/functions) have spent computing resources.
