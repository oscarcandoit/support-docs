---
url: "https://vercel.com/docs/pricing/regional-pricing/gru1"
...
The table below shows Managed Infrastructure products with pricing specific to the São Paulo, Brazil (gru1) region. This pricing is available only to [Pro plan](https://vercel.com/docs/plans/pro) users. Your team will be charged based on the usage of your projects for each resource in this region.
...
| Resource | On-demand (Billing Cycle) |
| --- | --- |
| [Fast Data Transfer](https://vercel.com/docs/pricing/regional-pricing) | Included 1TB, then $0.22 per 1 GB |
| [Fast Origin Transfer](https://vercel.com/docs/pricing/regional-pricing) | $0.41 per 1 GB |
| [Edge Requests](https://vercel.com/docs/pricing/regional-pricing) | Included 10,000,000, then $3.20 per 1,000,000 Requests |
| [ISR Reads](https://vercel.com/docs/data-cache) | $0.64 per 1,000,000 Read Units |
| [ISR Writes](https://vercel.com/docs/data-cache) | $6.40 per 1,000,000 Write Units |
| [Edge Request Additional CPU Duration](https://vercel.com/docs/pricing/regional-pricing) | $0.48 per 1 Hour |
| [Image Optimization Transformations](https://vercel.com/docs/image-optimization) | $0.0812 per 1K |
| [Image Optimization Cache Reads](https://vercel.com/docs/image-optimization) | $0.64 per 1M |
| [Image Optimization Cache Writes](https://vercel.com/docs/image-optimization) | $6.40 per 1M |
| [WAF Rate Limiting](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting) | $0.80 per 1,000,000 Allowed Requests |
| [OWASP CRS per request number](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets) | $1.28 per 1,000,000 Inspected Requests |
| [OWASP CRS per request size](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets) | $0.32 per 1 GB of inspected request payload |
| [Blob Storage Size](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $0.041 per GB |
| [Blob Simple Operations](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $0.560 per 1M |
| [Blob Advanced Operations](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $7.000 per 1M |
| [Blob Data Transfer](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $0.073 per GB |
| [Private Data Transfer](https://vercel.com/docs/connectivity/static-ips) | $0.310 per 1 GB |
| [Workflow Storage](https://vercel.com/docs/workflow#pricing) | $0.80 per 1 GB per month |
| [Workflow Steps](https://vercel.com/docs/workflow#pricing) | $40.00 per 1,000,000 Steps |
