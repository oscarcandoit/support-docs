...
For information about when SSL certificate renewals happen, see [When is the SSL Certificate on my Vercel Domain renewed?](https://vercel.com/kb/guide/renewal-of-ssl-certificates-with-a-vercel-domain)
...
## [Troubleshooting](https://vercel.com/docs/domains/working-with-ssl\#troubleshooting)

To learn more about common SSL issues, see the [troubleshooting](https://vercel.com/docs/domains/troubleshooting#common-ssl-certificate-issues) doc.

## [Related](https://vercel.com/docs/domains/working-with-ssl\#related)
