---
url: "https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config"
...
## [Prerequisites](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config\#prerequisites)
...
1. ### [Set up the Statsig integration](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config\#set-up-the-statsig-integration)



Visit [the Statsig page in the Integration Marketplace](https://vercel.com/integrations/statsig) and select the Add Integration button. Then:
...
4. Statsig will provide you with a [Connection String](https://vercel.com/docs/edge-config/using-edge-config#using-a-connection-string) and Edge Config Item Key. Save both, as you'll need them later in the setup
2. ### [Add your Environment Variables](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config\#add-your-environment-variables)



Navigate to [your Vercel dashboard](https://vercel.com/dashboard), and select the project you want to use the Statsig integration with.
...
See [our Environment Variables documentation](https://vercel.com/docs/environment-variables#creating-environment-variables) to learn more.

3. ### [Use the Statsig integration in your code](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config\#use-the-statsig-integration-in-your-code)
...
The following example sets up a Statsig experiment with Edge Config in an [Middleware](https://vercel.com/docs/routing-middleware) file, using the `EDGE_CONFIG_ITEM_KEY` environment variable.
...
## [Next steps](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config\#next-steps)
...
- [Prerequisites](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config#prerequisites)
- [Set up the Statsig integration](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config#set-up-the-statsig-integration)
- [Add your Environment Variables](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config#add-your-environment-variables)
- [Use the Statsig integration in your code](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config#use-the-statsig-integration-in-your-code)
- [Next steps](https://vercel.com/docs/edge-config/edge-config-integrations/statsig-edge-config#next-steps)
