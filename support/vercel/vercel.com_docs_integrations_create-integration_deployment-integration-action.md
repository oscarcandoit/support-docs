---
url: "https://vercel.com/docs/integrations/create-integration/deployment-integration-action"
...
With deployment integration actions, integration providers can enable [integration resource](https://vercel.com/docs/integrations/create-integration/native-integration#resources) tasks to be performed such as branching a database, setting environment variables, and running readiness checks. It then allows integration users to configure and trigger these actions automatically during a deployment.

For example, you can use deployment integration actions with the checks API to [create integrations](https://vercel.com/docs/checks#build-your-checks-integration) that provide testing functionality to deployments.

## [How deployment actions work](https://vercel.com/docs/integrations/create-integration/deployment-integration-action\#how-deployment-actions-work)

1. Action declaration:
   - An integration [product](https://vercel.com/docs/integrations/create-integration/native-integration#resources) declares deployment actions with an ID, name, and metadata.
...
## [Creating deployment actions](https://vercel.com/docs/integrations/create-integration/deployment-integration-action\#creating-deployment-actions)
...
1. ### [Declare deployment actions](https://vercel.com/docs/integrations/create-integration/deployment-integration-action\#declare-deployment-actions)
...
Next, handle webhook events and perform API actions in your [integration server](https://vercel.com/docs/integrations/marketplace-product#deploy-the-integration-server). Review the [example marketplace integration server](https://github.com/vercel/example-marketplace-integration) code repository.

2. ### [Handle the deployment start](https://vercel.com/docs/integrations/create-integration/deployment-integration-action\#handle-the-deployment-start)
...
3. ### [Use the Get Deployment API](https://vercel.com/docs/integrations/create-integration/deployment-integration-action\#use-the-get-deployment-api)
...
You can create your `access_token` from [Vercel's account settings](https://vercel.com/docs/rest-api#creating-an-access-token).
...
4. ### [Complete a deployment action](https://vercel.com/docs/integrations/create-integration/deployment-integration-action\#complete-a-deployment-action)



Once an action is processed, update its status using the [Update Deployment Integration Action](https://vercel.com/docs/rest-api/reference/endpoints/deployments/update-deployment-integration-action) REST API endpoint.
...
5. ### [Handle deployment cancellation](https://vercel.com/docs/integrations/create-integration/deployment-integration-action\#handle-deployment-cancellation)
...
- [How deployment actions work](https://vercel.com/docs/integrations/create-integration/deployment-integration-action#how-deployment-actions-work)
- [Creating deployment actions](https://vercel.com/docs/integrations/create-integration/deployment-integration-action#creating-deployment-actions)
- [Declare deployment actions](https://vercel.com/docs/integrations/create-integration/deployment-integration-action#declare-deployment-actions)
- [Handle the deployment start](https://vercel.com/docs/integrations/create-integration/deployment-integration-action#handle-the-deployment-start)
- [Use the Get Deployment API](https://vercel.com/docs/integrations/create-integration/deployment-integration-action#use-the-get-deployment-api)
- [Complete a deployment action](https://vercel.com/docs/integrations/create-integration/deployment-integration-action#complete-a-deployment-action)
- [Handle deployment cancellation](https://vercel.com/docs/integrations/create-integration/deployment-integration-action#handle-deployment-cancellation)
