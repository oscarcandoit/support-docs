...
limit](https://vercel.com/docs/functions/runtimes#request-body-size) on Vercel Functions. If you
need to upload larger files, use [client\\
uploads](https://vercel.com/docs/storage/vercel-blob/client-upload).

## [Prerequisites](https://vercel.com/docs/vercel-blob/server-upload\#prerequisites)
...
1. ### [Create a Blob store](https://vercel.com/docs/vercel-blob/server-upload\#create-a-blob-store)
...
2. ### [Prepare your local project](https://vercel.com/docs/vercel-blob/server-upload\#prepare-your-local-project)
...
## [Upload a file using Server Actions](https://vercel.com/docs/vercel-blob/server-upload\#upload-a-file-using-server-actions)
...
## [Upload a file using a server upload page and route](https://vercel.com/docs/vercel-blob/server-upload\#upload-a-file-using-a-server-upload-page-and-route)
...
1. ### [Create a server upload page](https://vercel.com/docs/vercel-blob/server-upload\#create-a-server-upload-page)
...
2. ### [Create a server upload route](https://vercel.com/docs/vercel-blob/server-upload\#create-a-server-upload-route)
...
### [Testing your page](https://vercel.com/docs/vercel-blob/server-upload\#testing-your-page)

1. ### [Run your application locally](https://vercel.com/docs/vercel-blob/server-upload\#run-your-application-locally)
...
2. ### [Review the Blob object metadata](https://vercel.com/docs/vercel-blob/server-upload\#review-the-blob-object-metadata)
...
## [Next steps](https://vercel.com/docs/vercel-blob/server-upload\#next-steps)
...
- [Prerequisites](https://vercel.com/docs/vercel-blob/server-upload#prerequisites)
- [Create a Blob store](https://vercel.com/docs/vercel-blob/server-upload#create-a-blob-store)
- [Prepare your local project](https://vercel.com/docs/vercel-blob/server-upload#prepare-your-local-project)
- [Upload a file using Server Actions](https://vercel.com/docs/vercel-blob/server-upload#upload-a-file-using-server-actions)
- [Upload a file using a server upload page and route](https://vercel.com/docs/vercel-blob/server-upload#upload-a-file-using-a-server-upload-page-and-route)
- [Create a server upload page](https://vercel.com/docs/vercel-blob/server-upload#create-a-server-upload-page)
- [Create a server upload route](https://vercel.com/docs/vercel-blob/server-upload#create-a-server-upload-route)
- [Testing your page](https://vercel.com/docs/vercel-blob/server-upload#testing-your-page)
- [Run your application locally](https://vercel.com/docs/vercel-blob/server-upload#run-your-application-locally)
- [Review the Blob object metadata](https://vercel.com/docs/vercel-blob/server-upload#review-the-blob-object-metadata)
- [Next steps](https://vercel.com/docs/vercel-blob/server-upload#next-steps)
