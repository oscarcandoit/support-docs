...
## [Pricing](https://vercel.com/docs/speed-insights/limits-and-pricing\#pricing)

Speed Insights is available on the Hobby, Pro, and Enterprise plans.

On the Hobby plan, Speed Insights is free and can be enabled on one project with a [set allotment](https://vercel.com/docs/speed-insights/limits-and-pricing#limitations) of data points.
...
## [Limitations](https://vercel.com/docs/speed-insights/limits-and-pricing\#limitations)
...
You can reduce the number of data points collected by adjusting the [Sample Rate](https://vercel.com/docs/speed-insights/limits-and-pricing#sample-rate) at the project level by using the `@vercel/speed-insights`. To learn more, see [Sample Rate](https://vercel.com/docs/speed-insights/package#samplerate).

## [Sample rate](https://vercel.com/docs/speed-insights/limits-and-pricing\#sample-rate)
...
To reduce cost, you can change the sample rate at a project level by using the `@vercel/speed-insights` package as explained in [Sample rate](https://vercel.com/docs/speed-insights/package#samplerate). To learn more about how to configure the `sampleRate` option, see the [Sending a sample of events to Speed Insights](https://vercel.com/kb/guide/sending-sample-to-speed-insights) recipe.

## [Prorating](https://vercel.com/docs/speed-insights/limits-and-pricing\#prorating)
...
## [Usage](https://vercel.com/docs/speed-insights/limits-and-pricing\#usage)
...
| --- | --- | --- | --- |
| [Data points](https://vercel.com/docs/pricing/observability#managing-speed-insights-data-points) | The number of data points reported from browsers | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/pricing/observability#optimizing-speed-insights-data-points) |
