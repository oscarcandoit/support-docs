...
Once you've [set up Code Review](https://vercel.com/docs/agent/pr-review#how-to-set-up-code-review), you can customize settings and monitor performance from the [Agent tab](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fvercel-agent&title=Open+Vercel+Agent) in your dashboard. This is your central hub for managing which repositories get reviewed, tracking costs, and analyzing how reviews are performing.

## [Choose which repositories to review](https://vercel.com/docs/agent/pr-review/usage\#choose-which-repositories-to-review)
...
## [Allow reviews on draft PRs](https://vercel.com/docs/agent/pr-review/usage\#allow-reviews-on-draft-prs)
...
## [Track spending and costs](https://vercel.com/docs/agent/pr-review/usage\#track-spending-and-costs)
...
For detailed information about tracking costs, viewing your credit balance, and understanding cost breakdowns, see the [cost tracking section in the pricing docs](https://vercel.com/docs/agent/pricing#track-costs-and-spending).

## [Track the suggestions](https://vercel.com/docs/agent/pr-review/usage\#track-the-suggestions)
...
## [Review agent efficiency](https://vercel.com/docs/agent/pr-review/usage\#review-agent-efficiency)
...
## [Export review metrics](https://vercel.com/docs/agent/pr-review/usage\#export-review-metrics)
...
## [Disable Vercel Agent](https://vercel.com/docs/agent/pr-review/usage\#disable-vercel-agent)
