...
Notificationsare availableon [all plans](https://vercel.com/docs/plans)
...
## [Receiving notifications](https://vercel.com/docs/notifications\#receiving-notifications)
...
By default, you will receive both web and email notifications for all [types of alerts](https://vercel.com/docs/notifications#types-of-notifications). You can [manage these notifications](https://vercel.com/docs/notifications#managing-notifications) from the Settings tab, but any changes you make will only affect _your_ notifications.

## [Basic capabilities](https://vercel.com/docs/notifications\#basic-capabilities)
...
## [Managing notifications](https://vercel.com/docs/notifications\#managing-notifications)

You can manage your own notifications by using the following steps:

1. Select your team from the [scope selector](https://vercel.com/docs/dashboard-features#scope-selector).
...
### [Notifications for Comments](https://vercel.com/docs/notifications\#notifications-for-comments)
...
### [On-demand usage notifications](https://vercel.com/docs/notifications\#on-demand-usage-notifications)

Customizing on-demand usage notificationsis availableon [Pro plans](https://vercel.com/docs/plans/pro)
...
If you choose to disable notifications, you won't receive alerts for any
...
## [Types of notifications](https://vercel.com/docs/notifications\#types-of-notifications)
...
### [Critical notifications](https://vercel.com/docs/notifications\#critical-notifications)
...
### [Notification details](https://vercel.com/docs/notifications\#notification-details)
