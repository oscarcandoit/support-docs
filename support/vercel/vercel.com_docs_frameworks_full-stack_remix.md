...
Remix is a fullstack, [server-rendered](https://vercel.com/docs/frameworks/full-stack/remix#server-side-rendering-ssr) React framework. Its built-in features for nested pages, error boundaries, transitions between loading states, and more, enable developers to create modern web apps.
...
in conjunction with the [Vercel Preset](https://vercel.com/docs/frameworks/full-stack/remix#vercel-vite-preset), when deploying
to Vercel.

## [Getting started](https://vercel.com/docs/frameworks/full-stack/remix\#getting-started)
...
[![](https://7nyt0uhk7sse4zvn.public.blob.vercel-storage.com/docs-assets/static/topics/icons/remix-light.svg)Deploy our Remix template, or view a live example.](https://vercel.com/templates/remix/remix-boilerplate)

[Deploy](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fvercel%2Ftree%2Fmain%2Fexamples%2Fremix&template=remix) [Live Example](https://remix-run-template.vercel.app/)
...
[View All Templates](https://vercel.com/templates/remix)





[![Ecommerce Template with Crystallize and Remix](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F1Pifbeel3gAM5CeLg8Ay0B%2F3e728c6bf7cb01b7518e31e25cd7bb1b%2FScreenshot_2023-05-10_at_20.16.14_-_Veljko_Simakovic.png&w=3840&q=75)\\
\\
Ecommerce Template with Crystallize and Remix\\
\\
A fully-featured eCommerce boilerplate built using Remix and Crystallize with performance in mind.](https://vercel.com/templates/remix/ecommerce-crystalize-remix) [![Remix Boilerplate](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F64fEidzvsP1HHsvVXGFUcd%2F7d3b9b272f190700a0b500477f411e76%2F1200x627_-_Glowing.png&w=3840&q=75)\\
\\
Remix Boilerplate\\
\\
A new Remix app — the result of running \`npx create-remix\`.](https://vercel.com/templates/remix/remix-boilerplate) [![Product Roadmap Voting App ](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F7sIUbaHxfoahejo46dA3Pf%2Fc7746ad6ac15673fdb4b40ada2f46268%2FVercel_RowyRoadmap_Template.png&w=3840&q=75)\\
\\
Product Roadmap Voting App \\
\\
Public roadmap app for your product powered by Rowy and Firebase](https://vercel.com/templates/remix/roadmap-voting-app-rowy)
...
Vercel deployments can [integrate with your git provider](https://vercel.com/docs/git) to [generate preview URLs](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) for each pull request you make to your Remix project.

## [`@vercel/remix`](https://vercel.com/docs/frameworks/full-stack/remix\#@vercel/remix)
...
To best experience Vercel features such as [streaming](https://vercel.com/docs/frameworks/full-stack/remix#response-streaming), [Vercel Functions](https://vercel.com/docs/frameworks/full-stack/remix#vercel-functions), and more, we recommend importing utilities from `@vercel/remix` rather than from standard Remix packages such as `@remix-run/node`.
...
## [Vercel Vite Preset](https://vercel.com/docs/frameworks/full-stack/remix\#vercel-vite-preset)
...
## [Server-Side Rendering (SSR)](https://vercel.com/docs/frameworks/full-stack/remix\#server-side-rendering-ssr)
...
### [Vercel Functions](https://vercel.com/docs/frameworks/full-stack/remix\#vercel-functions)
...
## [Response streaming](https://vercel.com/docs/frameworks/full-stack/remix\#response-streaming)

[Streaming HTTP responses](https://vercel.com/docs/functions/streaming-functions)
...
[Learn more about Streaming](https://vercel.com/docs/functions/streaming-functions)

## [`Cache-Control` headers](https://vercel.com/docs/frameworks/full-stack/remix\#cache-control-headers)

Vercel's [CDN](https://vercel.com/docs/cdn) caches your content at the edge in order to serve data to your users as fast as possible. [Static caching](https://vercel.com/docs/edge-cache#static-files-caching) works with zero configuration.
...
See [our docs on cache limits](https://vercel.com/docs/edge-cache#limits) to learn the max size and lifetime of caches stored on Vercel.
...
[Learn more about caching](https://vercel.com/docs/edge-cache#how-to-cache-responses)

## [Analytics](https://vercel.com/docs/frameworks/full-stack/remix\#analytics)
...
## [Using a custom `app/entry.server` file](https://vercel.com/docs/frameworks/full-stack/remix\#using-a-custom-app/entry.server-file)
...
## [Using a custom `server` file](https://vercel.com/docs/frameworks/full-stack/remix\#using-a-custom-server-file)
...
If your project requires a custom [`server`](https://remix.run/docs/en/main/file-conventions/remix-config#md-server) file, you will need to [install `@vercel/remix`](https://vercel.com/docs/frameworks/full-stack/remix#@vercel/remix) and import `createRequestHandler` from `@vercel/remix/server`. The following example demonstrates a basic `server.js` file:
...
## [More benefits](https://vercel.com/docs/frameworks/full-stack/remix\#more-benefits)
...
## [More resources](https://vercel.com/docs/frameworks/full-stack/remix\#more-resources)

Learn more about deploying Remix projects on Vercel with the following resources:

- [Explore Remix in a monorepo](https://vercel.com/templates/remix/turborepo-kitchensink)
- [Deploy our Product Roadmap template](https://vercel.com/templates/remix/roadmap-voting-app-rowy)
