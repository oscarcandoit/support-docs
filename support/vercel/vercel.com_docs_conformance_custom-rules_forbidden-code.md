---
url: "https://vercel.com/docs/conformance/custom-rules/forbidden-code"
...
use the [`forbidden-properties`](https://vercel.com/docs/conformance/custom-rules/forbidden-properties) rule type.
...
Multi-line strings and patterns are currently unsupported by this custom rule
type.
...
| Property | Type | Description |
| --- | --- | --- |
| `paths` | `string[]` (optional) | An optional array of exact paths or glob expressions\*.<br>_\*Note that paths containing square brackets need to be escaped, i.e. `[folder-name]\page.tsx` would become `\[folder-name\]\page.tsx`._ |
