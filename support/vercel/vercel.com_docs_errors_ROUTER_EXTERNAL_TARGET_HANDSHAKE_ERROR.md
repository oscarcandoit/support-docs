...
## [Troubleshoot](https://vercel.com/docs/errors/ROUTER_EXTERNAL_TARGET_HANDSHAKE_ERROR\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/ROUTER\_EXTERNAL\_TARGET\_HANDSHAKE\_ERROR to understand what's happening.
