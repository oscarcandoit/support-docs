...
## [API key](https://vercel.com/docs/ai-gateway/authentication\#api-key)
...
### [Creating an API Key](https://vercel.com/docs/ai-gateway/authentication\#creating-an-api-key)

1. ### [Navigate to the AI Gateway tab](https://vercel.com/docs/ai-gateway/authentication\#navigate-to-the-ai-gateway-tab)



From the [Vercel dashboard](https://vercel.com/dashboard), click the AI Gateway tab to access the AI Gateway settings.

2. ### [Access API key management](https://vercel.com/docs/ai-gateway/authentication\#access-api-key-management)



Click API keys on the left sidebar to view and manage your API keys.

3. ### [Create a new API key](https://vercel.com/docs/ai-gateway/authentication\#create-a-new-api-key)



Click Create key and proceed with Create key from the dialog to generate a new API key.

4. ### [Save your API key](https://vercel.com/docs/ai-gateway/authentication\#save-your-api-key)
...
### [Using the API key](https://vercel.com/docs/ai-gateway/authentication\#using-the-api-key)
...
## [OIDC token](https://vercel.com/docs/ai-gateway/authentication\#oidc-token)

The [Vercel OIDC token](https://vercel.com/docs/oidc) is a way to authenticate your requests to the AI Gateway without needing to manage an API key. Vercel automatically generates the OIDC token that it associates with your Vercel project.
...
### [Setting up OIDC authentication](https://vercel.com/docs/ai-gateway/authentication\#setting-up-oidc-authentication)

1. ### [Link to a Vercel project](https://vercel.com/docs/ai-gateway/authentication\#link-to-a-vercel-project)
...
2. ### [Pull environment variables](https://vercel.com/docs/ai-gateway/authentication\#pull-environment-variables)
...
3. ### [Use OIDC authentication in your code](https://vercel.com/docs/ai-gateway/authentication\#use-oidc-authentication-in-your-code)
...
- [API key](https://vercel.com/docs/ai-gateway/authentication#api-key)
- [Creating an API Key](https://vercel.com/docs/ai-gateway/authentication#creating-an-api-key)
- [Navigate to the AI Gateway tab](https://vercel.com/docs/ai-gateway/authentication#navigate-to-the-ai-gateway-tab)
- [Access API key management](https://vercel.com/docs/ai-gateway/authentication#access-api-key-management)
- [Create a new API key](https://vercel.com/docs/ai-gateway/authentication#create-a-new-api-key)
- [Save your API key](https://vercel.com/docs/ai-gateway/authentication#save-your-api-key)
- [Using the API key](https://vercel.com/docs/ai-gateway/authentication#using-the-api-key)
- [OIDC token](https://vercel.com/docs/ai-gateway/authentication#oidc-token)
- [Setting up OIDC authentication](https://vercel.com/docs/ai-gateway/authentication#setting-up-oidc-authentication)
- [Link to a Vercel project](https://vercel.com/docs/ai-gateway/authentication#link-to-a-vercel-project)
- [Pull environment variables](https://vercel.com/docs/ai-gateway/authentication#pull-environment-variables)
- [Use OIDC authentication in your code](https://vercel.com/docs/ai-gateway/authentication#use-oidc-authentication-in-your-code)
