...
## [No data visible in Speed Insights dashboard](https://vercel.com/docs/speed-insights/troubleshooting\#no-data-visible-in-speed-insights-dashboard)
...
## [Requests are not getting called](https://vercel.com/docs/speed-insights/troubleshooting\#requests-are-not-getting-called)
...
## [Speed Insights is not working with proxy](https://vercel.com/docs/speed-insights/troubleshooting\#speed-insights-is-not-working-with-proxy)
