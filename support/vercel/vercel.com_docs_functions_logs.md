...
Vercel Functions allow you to debug and monitor your functions using runtime logs. Users on the Pro and Enterprise plans can use Vercel's support for [Log Drains](https://vercel.com/docs/drains) to collect and analyze your logs using third-party providers. Functions have full support for the [`console`](https://developer.mozilla.org/docs/Web/API/Console) API, including `time`, `debug`, `timeEnd`, and more.

## [Runtime Logs](https://vercel.com/docs/functions/logs\#runtime-logs)

You can view [runtime logs](https://vercel.com/docs/runtime-logs#what-are-runtime-logs) for all Vercel Functions in real-time from [the Logs tab](https://vercel.com/docs/runtime-logs#view-runtime-logs) of your project's dashboard. You can use the various filters and options to find specific log information. These logs are held for an [amount of time based on your plan](https://vercel.com/docs/runtime-logs#limits).

When your function is [streaming](https://vercel.com/docs/functions/streaming-functions), you'll get the following:

- You can [view the logs](https://vercel.com/docs/runtime-logs#view-runtime-logs) in real-time from the Logs tab of your project's dashboard.
...
For more information, see [Runtime Logs](https://vercel.com/docs/runtime-logs).

These changes in the frequency and format of logs will affect Log Drains. If
you are using Log Drains we recommend ensuring that your ingestion can handle
both the new format and frequency.

### [Number of logs per request](https://vercel.com/docs/functions/logs\#number-of-logs-per-request)
...
- A [stale](https://vercel.com/docs/edge-cache#cache-invalidation) page having to be regenerated. For stale pages, both HTML (for direct browser navigation) and JSON (for Single Page App (SPA) transitions) are rendered simultaneously to maintain consistency
...
### [Next.js logs](https://vercel.com/docs/functions/logs\#next.js-logs)
