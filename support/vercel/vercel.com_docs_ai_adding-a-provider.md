...
## [Adding a native integration provider](https://vercel.com/docs/ai/adding-a-provider\#adding-a-native-integration-provider)
...
For more information on managing native integration providers, review [Manage native integrations](https://vercel.com/docs/integrations/install-an-integration/product-integration#manage-native-integrations).

## [Adding a connectable account provider](https://vercel.com/docs/ai/adding-a-provider\#adding-a-connectable-account-provider)
...
## [Featured AI integrations](https://vercel.com/docs/ai/adding-a-provider\#featured-ai-integrations)
