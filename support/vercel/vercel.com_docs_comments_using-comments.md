...
## [Add comments](https://vercel.com/docs/comments/using-comments\#add-comments)
...
### [Mention users](https://vercel.com/docs/comments/using-comments\#mention-users)
...
![A comment using the @ symbol to mention someone.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fpreview-deployments%2Fcomments%2Fcomment-light.png&w=828&q=75)![A comment using the @ symbol to mention someone.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fpreview-deployments%2Fcomments%2Fcomment-dark.png&w=828&q=75)A comment using the @ symbol to mention someone.

### [Add emojis to a comment](https://vercel.com/docs/comments/using-comments\#add-emojis-to-a-comment)
...
The latter two options are only available to users with the [browser extension](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#accessing-the-toolbar-using-the-chrome-extension) installed.

### [Use Markdown in a comment](https://vercel.com/docs/comments/using-comments\#use-markdown-in-a-comment)
...
### [Supported markdown formatting options](https://vercel.com/docs/comments/using-comments\#supported-markdown-formatting-options)
...
| Embedded links | N/A | N/A | `[A link](https://example.com)` | [A link](https://vercel.com/docs/comments/using-comments#supported-markdown-formatting-options) |
| Quotes | `>` | `>` | `> Quote` | │ Quote |

## [Comment threads](https://vercel.com/docs/comments/using-comments\#comment-threads)
...
### [Thread filtering](https://vercel.com/docs/comments/using-comments\#thread-filtering)
...
### [Copy comment links](https://vercel.com/docs/comments/using-comments\#copy-comment-links)
