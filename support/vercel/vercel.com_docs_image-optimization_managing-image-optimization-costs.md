...
## [Measuring usage](https://vercel.com/docs/image-optimization/managing-image-optimization-costs\#measuring-usage)

This document describes usage for the default pricing option. For Pro and
...
images-based](https://vercel.com/docs/image-optimization/legacy-pricing) pricing plan.
...
## [Reducing usage](https://vercel.com/docs/image-optimization/managing-image-optimization-costs\#reducing-usage)
