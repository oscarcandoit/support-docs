...
## [Use cases](https://vercel.com/docs/ai/groq\#use-cases)
...
### [Available models](https://vercel.com/docs/ai/groq\#available-models)
...
## [Getting started](https://vercel.com/docs/ai/groq\#getting-started)

The Vercel Groq integration can be accessed through the AI tab on your [Vercel dashboard](https://vercel.com/dashboard).

### [Prerequisites](https://vercel.com/docs/ai/groq\#prerequisites)
...
### [Add the provider to your project](https://vercel.com/docs/ai/groq\#add-the-provider-to-your-project)

#### [Using the dashboard](https://vercel.com/docs/ai/groq\#using-the-dashboard)

01. Navigate to the AI tab in your [Vercel dashboard](https://vercel.com/dashboard)
02. Select Groq from the list of providers, and press Add
...
10. Connect your project using the code below:
    ...
    3import { groq } from '@ai-sdk/groq';

    4import { streamText } from 'ai';
    ...
    13  // Call the language model

    14  const result = streamText({

    15    model: groq('llama-3.1-8b-instant'),
...
#### [Using the CLI](https://vercel.com/docs/ai/groq\#using-the-cli)
...
## [More resources](https://vercel.com/docs/ai/groq\#more-resources)
