---
url: "https://vercel.com/docs/plans/pro"
...
The legacy Pro plan is available for existing customers and offers fixed resource limits with traditional billing. It includes team collaboration features, email support, and increased limits compared to Hobby. You are encouraged to choose the [new Pro plan](https://vercel.com/docs/plans/pro-plan) for better flexibility and enhanced features.

This legacy Pro plan is still supported, but all teams will move to the [new\\
pricing model](https://vercel.com/docs/plans/pro-plan) later this year. [Follow this\\
guide](https://vercel.com/docs/plans/pro-plan/switching) to switch early. New Pro teams will be
on this pricing model automatically.

## [Team seats](https://vercel.com/docs/plans/pro\#team-seats)
...
### [Pro plan roles](https://vercel.com/docs/plans/pro\#pro-plan-roles)

The Pro plan includes access to the following [team level](https://vercel.com/docs/rbac/access-roles#team-level-roles) [RBAC](https://vercel.com/docs/rbac/access-roles) roles:
...
## [Pro plan pricing](https://vercel.com/docs/plans/pro\#pro-plan-pricing)
...
See the [Pricing](https://vercel.com/docs/pricing) page for more information.

## [Downgrading to Hobby](https://vercel.com/docs/plans/pro\#downgrading-to-hobby)
