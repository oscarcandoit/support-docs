...
## [Why opt for incremental migration?](https://vercel.com/docs/incremental-migration\#why-opt-for-incremental-migration)
...
### [Disadvantages of one-time migrations](https://vercel.com/docs/incremental-migration\#disadvantages-of-one-time-migrations)
...
### [When to use incremental migration?](https://vercel.com/docs/incremental-migration\#when-to-use-incremental-migration)
...
### [Vertical migration](https://vercel.com/docs/incremental-migration\#vertical-migration)
...
### [Horizontal migration](https://vercel.com/docs/incremental-migration\#horizontal-migration)
...
### [Hybrid migration](https://vercel.com/docs/incremental-migration\#hybrid-migration)
...
## [Implementation approaches](https://vercel.com/docs/incremental-migration\#implementation-approaches)
...
## [Point your domain to Vercel](https://vercel.com/docs/incremental-migration\#point-your-domain-to-vercel)
...
### [1\. Deploy your application](https://vercel.com/docs/incremental-migration\#1.-deploy-your-application)

Use the [framework](https://vercel.com/docs/frameworks) of your choice to deploy your application to Vercel

### [2\. Re-route the traffic](https://vercel.com/docs/incremental-migration\#2.-re-route-the-traffic)

Send all traffic to the legacy server using one of the following 3 methods:

#### [Framework-specific rewrites](https://vercel.com/docs/incremental-migration\#framework-specific-rewrites)
...
#### [Vercel configuration rewrites](https://vercel.com/docs/incremental-migration\#vercel-configuration-rewrites)
...
#### [Edge Config](https://vercel.com/docs/incremental-migration\#edge-config)

Use [Edge Config](https://vercel.com/docs/edge-config) with [Routing Middleware](https://vercel.com/docs/routing-middleware) to rewrite requests at the edge with the following benefits:
...
### [3\. Deploy to production](https://vercel.com/docs/incremental-migration\#3.-deploy-to-production)
...
### [4\. Deploy your first iteration](https://vercel.com/docs/incremental-migration\#4.-deploy-your-first-iteration)
...
## [Keep your domain on the legacy server](https://vercel.com/docs/incremental-migration\#keep-your-domain-on-the-legacy-server)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fincremental-migration%2Fapproach-2-light.png&w=3840&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fincremental-migration%2Fapproach-2-dark.png&w=3840&q=75)

Keep your domain on the legacy server approach

### [1\. Deploy your first feature](https://vercel.com/docs/incremental-migration\#1.-deploy-your-first-feature)
...
### [2\. Add a rewrite or reverse proxy](https://vercel.com/docs/incremental-migration\#2.-add-a-rewrite-or-reverse-proxy)
...
## [Troubleshooting](https://vercel.com/docs/incremental-migration\#troubleshooting)

### [Maximum number of routes](https://vercel.com/docs/incremental-migration\#maximum-number-of-routes)
...
### [Handling emergencies](https://vercel.com/docs/incremental-migration\#handling-emergencies)
...
## [Session management](https://vercel.com/docs/incremental-migration\#session-management)
...
Learn more about creating a session store and managing session data in our [quickstart guide](https://vercel.com/docs/storage/vercel-kv/quickstart).

## [User group strategies](https://vercel.com/docs/incremental-migration\#user-group-strategies)
...
## [Using functions](https://vercel.com/docs/incremental-migration\#using-functions)
...
## [SEO considerations](https://vercel.com/docs/incremental-migration\#seo-considerations)
