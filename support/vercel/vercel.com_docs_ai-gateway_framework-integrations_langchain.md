...
## [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/langchain\#getting-started)

1. ### [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/langchain\#create-a-new-project)
...
2. ### [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/langchain\#install-dependencies)
...
3. ### [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/langchain\#configure-environment-variables)
...
4. ### [Create your LangChain application](https://vercel.com/docs/ai-gateway/framework-integrations/langchain\#create-your-langchain-application)
...
5. ### [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/langchain\#running-the-application)
...
- [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/langchain#getting-started)
- [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/langchain#create-a-new-project)
- [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/langchain#install-dependencies)
- [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/langchain#configure-environment-variables)
- [Create your LangChain application](https://vercel.com/docs/ai-gateway/framework-integrations/langchain#create-your-langchain-application)
- [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/langchain#running-the-application)
