---
url: "https://vercel.com/docs/vercel-firewall/ddos-mitigation"
...
Vercel does not charge customers for traffic that gets blocked with DDoS
mitigation.
...
- You can also use Middleware to [block requests](https://github.com/vercel/examples/tree/main/edge-middleware/geolocation-country-block) based on specific criteria or to implement [rate limiting](https://vercel.com/kb/guide/rate-limiting-edge-middleware-vercel-kv).
...
Bypass System-level Mitigationsare availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
You are responsible for all usage fees incurred when using this feature,
