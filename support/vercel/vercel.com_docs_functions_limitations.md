...
| Feature | Node.js |
| --- | --- |
| [Maximum memory](https://vercel.com/docs/functions/limitations#memory-size-limits) | Hobby: 2 GB, Pro and Ent: 4 GB |
| [Maximum duration](https://vercel.com/docs/functions/limitations#max-duration) | Hobby: 300s (default) - [configurable up to 300s](https://vercel.com/docs/functions/configuring-functions/duration), Pro: 300s (default) - [configurable](https://vercel.com/docs/functions/configuring-functions/duration) up to 800s, Ent: 300s (default) - [configurable](https://vercel.com/docs/functions/configuring-functions/duration) up to 800s. If [fluid compute](https://vercel.com/docs/fluid-compute) is enabled, these values are increased across plans. See [max durations](https://vercel.com/docs/functions/limitations#max-duration) for more information. |
| [Size](https://vercel.com/docs/functions/runtimes#bundle-size-limits) (after gzip compression) | 250 MB |
| [Concurrency](https://vercel.com/docs/functions/concurrency-scaling#automatic-concurrency-scaling) | Auto-scales up to 30,000 (Hobby and Pro) or 100,000+ (Enterprise) concurrency |
| [Cost](https://vercel.com/docs/functions/runtimes) | Pay for active CPU time and provisioned memory time |
| [Regions](https://vercel.com/docs/functions/runtimes#location) | Executes region-first, [can customize location](https://vercel.com/docs/functions/regions#select-a-default-serverless-region).<br> Enterprise teams can set [multiple regions](https://vercel.com/docs/functions/regions#set-multiple-serverless-regions) |
| [API Coverage](https://vercel.com/docs/functions/limitations#api-support) | Full Node.js coverage |
| [File descriptors](https://vercel.com/docs/functions/limitations#file-descriptors) | 1,024 shared across concurrent executions (including runtime usage) |

## [Functions name](https://vercel.com/docs/functions/limitations\#functions-name)
...
## [Bundle size limits](https://vercel.com/docs/functions/limitations\#bundle-size-limits)
...
For Vercel Functions, the maximum uncompressed size is 250 MB including layers which are automatically used depending on [runtimes](https://vercel.com/docs/functions/runtimes). These limits are [enforced by AWS](https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-limits.html).
...
While Vercel Functions have a default duration, this duration can be extended using the [maxDuration config](https://vercel.com/docs/functions/configuring-functions/duration). If a Vercel Function doesn't respond within the duration, a 504 error code ( [`FUNCTION_INVOCATION_TIMEOUT`](https://vercel.com/docs/errors/FUNCTION_INVOCATION_TIMEOUT)) is returned.

With [fluid compute](https://vercel.com/docs/fluid-compute) enabled, Vercel Functions have the following defaults and maximum limits (applies to the Node.js and Python runtimes):

### [Node.js and python runtimes](https://vercel.com/docs/functions/limitations\#node.js-and-python-runtimes)
...
### [Edge runtime](https://vercel.com/docs/functions/limitations\#edge-runtime)

Vercel Functions using the [Edge runtime](https://vercel.com/docs/functions/runtimes/edge) must begin sending a response within 25 seconds to maintain streaming capabilities beyond this period, and can continue [streaming](https://vercel.com/docs/functions/streaming-functions) data for up to 300 seconds.

## [Memory size limits](https://vercel.com/docs/functions/limitations\#memory-size-limits)
...
Users on Pro and Enterprise plans can [configure the default memory size](https://vercel.com/docs/functions/configuring-functions/memory#setting-your-default-function-memory-/-cpu-size) for all functions in the dashboard.
...
## [Request body size](https://vercel.com/docs/functions/limitations\#request-body-size)
...
## [API support](https://vercel.com/docs/functions/limitations\#api-support)

|  | Node.js runtime (and more) |
| --- | --- |
| Geolocation data | [Yes](https://vercel.com/docs/headers/request-headers#x-vercel-ip-country) |
| Access request headers | Yes |
| Cache responses | [Yes](https://vercel.com/docs/edge-cache#using-vercel-functions) |

## [Cost and usage](https://vercel.com/docs/functions/limitations\#cost-and-usage)

The Hobby plan offers functions for free, within [limits](https://vercel.com/docs/limits). The Pro plan extends these limits, and charges usage based on active CPU time and provisioned memory time for Vercel Functions.
...
It is important to make sure you've set a reasonable [maximum duration](https://vercel.com/docs/functions/configuring-functions/duration) for your function. See "Managing usage and pricing for [Vercel Functions](https://vercel.com/docs/pricing/serverless-functions)" for more information.

## [Environment variables](https://vercel.com/docs/functions/limitations\#environment-variables)

If you have [fluid compute](https://vercel.com/docs/fluid-compute) enabled, the following environment variables are not accessible and you cannot log them:
