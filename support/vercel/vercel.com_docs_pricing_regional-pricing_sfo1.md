---
url: "https://vercel.com/docs/pricing/regional-pricing/sfo1"
...
The table below shows Managed Infrastructure products with pricing specific to the San Francisco, USA (sfo1) region. This pricing is available only to [Pro plan](https://vercel.com/docs/plans/pro) users. Your team will be charged based on the usage of your projects for each resource in this region.
...
| Resource | On-demand (Billing Cycle) |
| --- | --- |
| [Fast Data Transfer](https://vercel.com/docs/pricing/regional-pricing) | Included 1TB, then $0.15 per 1 GB |
| [Fast Origin Transfer](https://vercel.com/docs/pricing/regional-pricing) | $0.06 per 1 GB |
| [Edge Requests](https://vercel.com/docs/pricing/regional-pricing) | Included 10,000,000, then $2.40 per 1,000,000 Requests |
| [ISR Reads](https://vercel.com/docs/data-cache) | $0.48 per 1,000,000 Read Units |
| [ISR Writes](https://vercel.com/docs/data-cache) | $4.80 per 1,000,000 Write Units |
| [Edge Request Additional CPU Duration](https://vercel.com/docs/pricing/regional-pricing) | $0.36 per 1 Hour |
| [Image Optimization Transformations](https://vercel.com/docs/image-optimization) | $0.0658 per 1K |
| [Image Optimization Cache Reads](https://vercel.com/docs/image-optimization) | $0.48 per 1M |
| [Image Optimization Cache Writes](https://vercel.com/docs/image-optimization) | $4.80 per 1M |
| [WAF Rate Limiting](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting) | $0.60 per 1,000,000 Allowed Requests |
| [OWASP CRS per request number](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets) | $0.96 per 1,000,000 Inspected Requests |
| [OWASP CRS per request size](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets) | $0.24 per 1 GB of inspected request payload |
| [Blob Storage Size](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $0.026 per GB |
| [Blob Simple Operations](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $0.440 per 1M |
| [Blob Advanced Operations](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $5.500 per 1M |
| [Blob Data Transfer](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $0.050 per GB |
| [Private Data Transfer](https://vercel.com/docs/connectivity/static-ips) | $0.160 per 1 GB |
| [Workflow Storage](https://vercel.com/docs/workflow#pricing) | $0.60 per 1 GB per month |
| [Workflow Steps](https://vercel.com/docs/workflow#pricing) | $30.00 per 1,000,000 Steps |
