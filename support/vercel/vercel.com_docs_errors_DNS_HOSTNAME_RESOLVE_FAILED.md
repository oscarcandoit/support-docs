...
## [Troubleshoot](https://vercel.com/docs/errors/DNS_HOSTNAME_RESOLVE_FAILED\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/DNS\_HOSTNAME\_RESOLVE\_FAILED to understand what's happening.
