...
- [Vercel Edge Config](https://vercel.com/docs/edge-config): Global, low-latency data store
...
## [Choosing a storage product](https://vercel.com/docs/storage\#choosing-a-storage-product)
...
| --- | --- | --- | --- | --- | --- |
| [Blob](https://vercel.com/docs/storage/vercel-blob) | Fast | Milliseconds | Large, content-addressable files ("blobs") | [Learn more](https://vercel.com/docs/storage/vercel-blob/usage-and-pricing) | Hobby, Pro |
| [Edge Config](https://vercel.com/docs/edge-config) | Ultra-fast | Seconds | Runtime configuration (e.g., feature flags) | [Learn more](https://vercel.com/docs/edge-config/edge-config-limits) | Hobby, Pro, Enterprise |

Read our section on [best practices](https://vercel.com/docs/storage#best-practices) to get the most out of our storage products.

## [Vercel Blob](https://vercel.com/docs/storage\#vercel-blob)

Vercel Blobis availableon [all plans](https://vercel.com/docs/plans)
...
### [Explore Vercel Blob](https://vercel.com/docs/storage\#explore-vercel-blob)

- [Overview](https://vercel.com/docs/storage/vercel-blob)
- [Quickstart](https://vercel.com/docs/storage/vercel-blob/server-upload)
...
### [Explore Edge Config](https://vercel.com/docs/storage\#explore-edge-config)

- [Overview](https://vercel.com/docs/edge-config)
- [Quickstart](https://vercel.com/docs/edge-config/get-started)
- [Limits & Pricing](https://vercel.com/docs/edge-config/edge-config-limits)

## [Best practices](https://vercel.com/docs/storage\#best-practices)

When choosing a storage option, we recommend considering these best practices:

### [Locate your data close to your functions](https://vercel.com/docs/storage\#locate-your-data-close-to-your-functions)

To ensure low-latency responses, it's crucial to have compute close to your databases. Always deploy your databases in [regions](https://vercel.com/docs/regions) closest to your Functions to avoid long network roundtrips.

- [Vercel functions](https://vercel.com/docs/functions): Defaults to `iad1`, but can be deployed to any region
  ...
  - If using Vercel Postgres, ensure your database is in the same region as your Function
  - If using Vercel KV and replicated regions, place your stores in the same regions as your Functions
- [Middleware](https://vercel.com/docs/routing-middleware): Global only; always executed in the region nearest the user
  - Since Middleware are part of request processing, it is best suited for extremely fast and globally replicated data like [Edge Config](https://vercel.com/docs/edge-config)

### [Optimize for high cache hit rates](https://vercel.com/docs/storage\#optimize-for-high-cache-hit-rates)

Vercel's CDN provides caching in every region globally. To ensure the fastest response times, ensure data fetched from your data store is properly [cached](https://vercel.com/docs/edge-cache) at the edge.
...
You can manually configure cache-control headers when using [Vercel Functions](https://vercel.com/docs/edge-cache#using-vercel-functions) to cache the response data in every CDN region. Middleware runs before the CDN cache layer and cannot use cache-control headers.

## [Transferring your store](https://vercel.com/docs/storage\#transferring-your-store)
