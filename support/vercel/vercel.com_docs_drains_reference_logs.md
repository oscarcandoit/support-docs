...
- [Custom endpoint](https://vercel.com/docs/drains/using-drains#custom-endpoint): Send logs to any HTTP endpoint you configure
- [Native integration](https://vercel.com/docs/drains/using-drains#native-integrations): Use integrations from the Vercel Marketplace like [Dash0](https://vercel.com/marketplace/dash0)
...
## [Logs Schema](https://vercel.com/docs/drains/reference/logs\#logs-schema)
...
## [Format](https://vercel.com/docs/drains/reference/logs\#format)

Vercel supports the following formats for Log Drains. You can configure the format when [configuring the Drain destination](https://vercel.com/docs/drains/using-drains#configure-destination):

### [JSON](https://vercel.com/docs/drains/reference/logs\#json)
...
### [NDJSON](https://vercel.com/docs/drains/reference/logs\#ndjson)
...
## [Log Sources](https://vercel.com/docs/drains/reference/logs\#log-sources)
...
| `lambda` | Output from Vercel Functions like [API Routes](https://vercel.com/docs/functions) |
...
| `external` | External [rewrites](https://vercel.com/docs/project-configuration#rewrites) to a different domain. Includes [cached external rewrites](https://vercel.com/docs/rewrites#caching-external-rewrites) |
| `firewall` | Outputs log data from requests denied by [Vercel Firewall](https://vercel.com/docs/vercel-firewall) rules |
| `redirect` | Requests that are redirected by [redirect rules](https://vercel.com/docs/project-configuration#redirects) |

## [Log Environments](https://vercel.com/docs/drains/reference/logs\#log-environments)
...
## [Sampling Rate](https://vercel.com/docs/drains/reference/logs\#sampling-rate)
...
## [More resources](https://vercel.com/docs/drains/reference/logs\#more-resources)
