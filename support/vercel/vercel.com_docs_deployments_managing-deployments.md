...
## [Filter deployment](https://vercel.com/docs/deployments/managing-deployments\#filter-deployment)
...
3. Use the dropdowns to search by Branch, Date Range, All Environments, or Status![The Deployments tab with the status filter dropdown open.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Ffiltering-deployments%2Ffilter-status-light.png&w=1200&q=75)![The Deployments tab with the status filter dropdown open.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Ffiltering-deployments%2Ffilter-status-dark.png&w=1200&q=75)The Deployments tab with the status filter dropdown open.

## [Delete a deployment](https://vercel.com/docs/deployments/managing-deployments\#delete-a-deployment)

DashboardcURLSDK

If you no longer need a specific deployment of your app, you can delete it from your project with the following steps:

1. From your [dashboard](https://vercel.com/dashboard), select the project where the specific deployment is located.
...
You can also set a [deployment retention policy](https://vercel.com/docs/deployments/managing-deployments#set-the-deployment-retention-policy) to automatically delete deployments after a certain period.

### [Set the deployment retention policy](https://vercel.com/docs/deployments/managing-deployments\#set-the-deployment-retention-policy)

You can set the retention policy for your deployments to automatically delete them after a certain period. To learn more, see [Deployment Retention](https://vercel.com/docs/security/deployment-retention).

## [Deployment protection](https://vercel.com/docs/deployments/managing-deployments\#deployment-protection)

Vercel provides a way to protect your deployments from being accessed by unauthorized users. You can use [Vercel Authentication](https://vercel.com/docs/security/deployment-protection/methods-to-protect-deployments/vercel-authentication) to restrict access to your deployments to only Vercel users with [suitable access rights](https://vercel.com/docs/security/deployment-protection/methods-to-protect-deployments/vercel-authentication#who-can-access-protected-deployments). You can also configure which [environments](https://vercel.com/docs/security/deployment-protection#understanding-deployment-protection-by-environment) are protected.

In addition, Enterprise teams can use [Trusted IPs](https://vercel.com/docs/security/deployment-protection/methods-to-protect-deployments/trusted-ips) and [Password Protection](https://vercel.com/docs/security/deployment-protection/methods-to-protect-deployments/password-protection) to further secure their deployments. Password protection is also available as a paid add-on for Pro teams.

To learn more, see [Deployment Protection](https://vercel.com/docs/security/deployment-protection).

## [Redeploy a project](https://vercel.com/docs/deployments/managing-deployments\#redeploy-a-project)
...
![Option to confirm redeploy to production.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fredeploy-model-light.png&w=1080&q=75)![Option to confirm redeploy to production.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fredeploy-model-dark.png&w=1080&q=75)Option to confirm redeploy to production.

### [When to Redeploy](https://vercel.com/docs/deployments/managing-deployments\#when-to-redeploy)
...
- Changing the [Environment Variables](https://vercel.com/docs/environment-variables)
- [Outage Resiliency](https://vercel.com/docs/regions#outage-resiliency)
