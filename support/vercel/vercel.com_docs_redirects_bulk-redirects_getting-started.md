...
## [Get started with bulk redirects](https://vercel.com/docs/redirects/bulk-redirects/getting-started\#get-started-with-bulk-redirects)
...
1. ### [Create your redirect file](https://vercel.com/docs/redirects/bulk-redirects/getting-started\#create-your-redirect-file)
...
2. ### [Configure bulkRedirectsPath](https://vercel.com/docs/redirects/bulk-redirects/getting-started\#configure-bulkredirectspath)
...
3. ### [Deploy](https://vercel.com/docs/redirects/bulk-redirects/getting-started\#deploy)
...
## [Available fields](https://vercel.com/docs/redirects/bulk-redirects/getting-started\#available-fields)
...
For complete configuration details and advanced options, see the [`bulkRedirectsPath` configuration reference](https://vercel.com/docs/projects/project-configuration#bulkredirectspath).
...
- [Get started with bulk redirects](https://vercel.com/docs/redirects/bulk-redirects/getting-started#get-started-with-bulk-redirects)
- [Create your redirect file](https://vercel.com/docs/redirects/bulk-redirects/getting-started#create-your-redirect-file)
- [Configure bulkRedirectsPath](https://vercel.com/docs/redirects/bulk-redirects/getting-started#configure-bulkredirectspath)
- [Deploy](https://vercel.com/docs/redirects/bulk-redirects/getting-started#deploy)
- [Available fields](https://vercel.com/docs/redirects/bulk-redirects/getting-started#available-fields)
