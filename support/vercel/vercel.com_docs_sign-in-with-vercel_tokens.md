...
- [ID Token](https://vercel.com/docs/sign-in-with-vercel/tokens#id-token)
- [Access Token](https://vercel.com/docs/sign-in-with-vercel/tokens#access-token)
- [Refresh Token](https://vercel.com/docs/sign-in-with-vercel/tokens#refresh-token)
...
### [JWT claims in ID Tokens](https://vercel.com/docs/sign-in-with-vercel/tokens\#jwt-claims-in-id-tokens)
...
### [Scope dependent claims](https://vercel.com/docs/sign-in-with-vercel/tokens\#scope-dependent-claims)
...
## [Securing your tokens](https://vercel.com/docs/sign-in-with-vercel/tokens\#securing-your-tokens)
