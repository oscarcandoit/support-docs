...
## [Disconnect your Git repository](https://vercel.com/docs/project-configuration/git-settings\#disconnect-your-git-repository)
...
## [Git Large File Storage (LFS)](https://vercel.com/docs/project-configuration/git-settings\#git-large-file-storage-lfs)

If you have [LFS objects](https://git-lfs.com/) in your repository, you can enable or disable support for them from the [project settings](https://vercel.com/docs/projects/project-dashboard#settings).
...
## [Deploy Hooks](https://vercel.com/docs/project-configuration/git-settings\#deploy-hooks)
...
By default, Vercel creates a new [deployment](https://vercel.com/docs/deployments) and build (unless the Build Step is [skipped](https://vercel.com/docs/deployments/configure-a-build#skip-build-step)) for every commit pushed to your connected Git repository.
...
3. In the Ignored Build Step section, select the behavior you would like. This behavior provides a command that outputs a code, which tells Vercel whether to issue a new build or not. The command is executed within the [Root Directory](https://vercel.com/docs/deployments/configure-a-build#root-directory) and can access all [System Environment Variables](https://vercel.com/docs/environment-variables/system-environment-variables):
   ...
   - Run my Bash script: [Run a Bash script](https://vercel.com/kb/guide/how-do-i-use-the-ignored-build-step-field-on-vercel) from a location that you specify
   - Run my Node script: [Run a Node script](https://vercel.com/kb/guide/how-do-i-use-the-ignored-build-step-field-on-vercel) from a location that you specify
...
the ignore build step will still count towards your [deployment quotas](https://vercel.com/docs/limits#deployments-per-day-hobby) and [concurrent build slots](https://vercel.com/docs/deployments/concurrent-builds).

You may be able to optimize your deployment queue by [skipping builds](https://vercel.com/docs/monorepos#skipping-unaffected-projects) for projects within a monorepo that are unaffected by a change.

To learn about more advanced usage see the ["How do I use the Ignored Build Step field on Vercel?"](https://vercel.com/kb/guide/how-do-i-use-the-ignored-build-step-field-on-vercel) guide.

### [Ignore Build Step on redeploy](https://vercel.com/docs/project-configuration/git-settings\#ignore-build-step-on-redeploy)

If you have set an ignore build step command or [script](https://vercel.com/kb/guide/how-do-i-use-the-ignored-build-step-field-on-vercel), you can also skip the build step when redeploying your app:
...
## [Verified Commits](https://vercel.com/docs/project-configuration/git-settings\#verified-commits)
