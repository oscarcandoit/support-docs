...
![Astro](https://api-frameworks.vercel.sh/framework-logos/astro.svg)![Astro](https://api-frameworks.vercel.sh/framework-logos/astro.svg)
...
![Dojo](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fapi-frameworks.vercel.sh%2Fframework-logos%2Fdojo.png&w=48&q=75)
...
![FastHTML](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fapi-frameworks.vercel.sh%2Fframework-logos%2Ffasthtml.png&w=48&q=75)
...
![Parcel](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fapi-frameworks.vercel.sh%2Fframework-logos%2Fparcel.png&w=48&q=75)
...
[Deploy](https://vercel.com/new/clone?repository-url=https://github.com/vercel/vercel/tree/main/examples/saber) [View Demo](https://vercel.com/docs/frameworks/frontend)
...
![Scully](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fapi-frameworks.vercel.sh%2Fframework-logos%2Fscullyio-logo.png&w=48&q=75)
...
[Deploy](https://vercel.com/new/clone?repository-url=https://github.com/vercel/vercel/tree/main/examples/storybook) [View Demo](https://vercel.com/docs/frameworks/frontend)
...
![VuePress](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fapi-frameworks.vercel.sh%2Fframework-logos%2Fvuepress.png&w=48&q=75)
...
![Zola](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fapi-frameworks.vercel.sh%2Fframework-logos%2Fzola.png&w=48&q=75)
...
## [Frameworks infrastructure support matrix](https://vercel.com/docs/frameworks/frontend\#frameworks-infrastructure-support-matrix)
...
SupportedNot SupportedNot Applicable

| Feature | Next.js | SvelteKit | Nuxt | Astro | Remix | Vite | Gatsby | CRA |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [Static Assets](https://vercel.com/docs/edge-network/overview)<br>Support for static assets being served and cached directly from the edge |  |  |  |  |  |  |  |  |
| [Edge Routing Rules](https://vercel.com/docs/edge-network/overview#edge-routing-rules)<br>Lets you configure incoming requests, set headers, and cache responses |  |  |  |  |  |  |  |  |
| [Routing Middleware](https://vercel.com/docs/functions/edge-middleware)<br>Execute code before a request is processed |  |  |  |  |  |  |  |  |
| [Server-Side Rendering](https://vercel.com/docs/functions)<br>Render pages dynamically on the server |  |  |  |  |  |  |  |  |
| [Streaming SSR](https://vercel.com/docs/functions/streaming)<br>Stream responses and render parts of the UI as they become ready |  |  |  |  |  |  |  |  |
| [Incremental Static Regeneration](https://vercel.com/docs/incremental-static-regeneration)<br>Create or update content on your site without redeploying |  |  |  |  |  |  |  |  |
| [Image Optimization](https://vercel.com/docs/image-optimization)<br>Optimize and cache images at the edge |  |  |  |  |  |  |  |  |
| [Data Cache](https://vercel.com/docs/infrastructure/data-cache)<br>A granular cache for storing responses from fetches |  |  |  |  |  |  |  |  |
| [Native OG Image Generation](https://vercel.com/docs/functions/og-image-generation)<br>Generate dynamic open graph images using Vercel Functions |  |  |  |  |  |  |  |  |
| [Multi-runtime support (different routes)](https://vercel.com/docs/functions/runtimes)<br>Customize runtime environments per route |  |  |  |  |  |  |  |  |
| [Multi-runtime support (entire app)](https://vercel.com/docs/functions/runtimes)<br>Lets your whole application utilize different runtime environments |  |  |  |  |  |  |  |  |
| [Output File Tracing](https://vercel.com/guides/how-can-i-use-files-in-serverless-functions)<br>Analyzes build artifacts to identify and include only necessary files for the runtime |  |  |  |  |  |  |  |  |
| [Skew Protection](https://vercel.com/docs/deployments/skew-protection)<br>Ensure that only the latest deployment version serves your traffic by not serving older versions of code |  |  |  |  |  |  |  |  |
| [Routing Middleware](https://vercel.com/docs/functions/edge-middleware)<br>Framework-native integrated middleware convention |  |  |  |  |  |  |  |  |
