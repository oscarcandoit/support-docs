---
url: "https://vercel.com/docs/vercel-blob/examples"
...
## [Range requests](https://vercel.com/docs/vercel-blob/examples\#range-requests)
...
## [Upload progress](https://vercel.com/docs/vercel-blob/examples\#upload-progress)
...
## [Aborting requests](https://vercel.com/docs/vercel-blob/examples\#aborting-requests)
...
## [Deleting all blobs](https://vercel.com/docs/vercel-blob/examples\#deleting-all-blobs)
...
Either execute this code in a [Vercel Cron Job](https://vercel.com/docs/cron-jobs), as a serverless function or on your local machine.
...
## [Backups](https://vercel.com/docs/vercel-blob/examples\#backups)

While there's no native backup system for Vercel Blob, here are two ways to backup your blobs:

1. Continuous backup: When using [Client Uploads](https://vercel.com/docs/storage/vercel-blob/using-blob-sdk#client-uploads) you can leverage the `onUploadCompleted` callback from the `handleUpload` server-side function to save every Blob upload to another storage.
2. Periodic backup: Using [Cron Jobs](https://vercel.com/docs/cron-jobs) and the [Vercel Blob SDK](https://vercel.com/docs/storage/vercel-blob/using-blob-sdk) you can periodically list all blobs and save them.
