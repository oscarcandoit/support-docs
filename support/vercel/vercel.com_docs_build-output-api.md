...
## [Overview](https://vercel.com/docs/build-output-api\#overview)
...
## [Known limitations](https://vercel.com/docs/build-output-api\#known-limitations)
...
ideally the same as the platform [Build Image](https://vercel.com/docs/deployments/build-image).

## [More resources](https://vercel.com/docs/build-output-api\#more-resources)

- [Configuration](https://vercel.com/docs/build-output-api/v3/configuration)
- [Vercel Primitives](https://vercel.com/docs/build-output-api/v3/primitives)
- [Features](https://vercel.com/docs/build-output-api/v3/features)

* * *

[Previous\\
\\
AI / Workflow](https://vercel.com/docs/workflow)
