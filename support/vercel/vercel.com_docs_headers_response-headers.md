...
## [`cache-control`](https://vercel.com/docs/headers/response-headers\#cache-control)

Used to specify directives for caching mechanisms in both the [Network layer cache](https://vercel.com/docs/edge-cache) and the browser cache. See the [Cache Control Headers](https://vercel.com/docs/headers#cache-control-header) section for more detail.
...
## [`content-length`](https://vercel.com/docs/headers/response-headers\#content-length)

An integer that indicates the number of bytes in the response.

## [`content-type`](https://vercel.com/docs/headers/response-headers\#content-type)
...
## [`date`](https://vercel.com/docs/headers/response-headers\#date)

A timestamp indicating when the response was generated.

## [`server: Vercel`](https://vercel.com/docs/headers/response-headers\#server:-vercel)

Shows where the request came from. This header can be overridden by other proxies (e.g., Cloudflare).

## [`strict-transport-security`](https://vercel.com/docs/headers/response-headers\#strict-transport-security)
...
## [`x-robots-tag`](https://vercel.com/docs/headers/response-headers\#x-robots-tag)
...
## [`x-vercel-cache`](https://vercel.com/docs/headers/response-headers\#x-vercel-cache)

The `x-vercel-cache` header is primarily used to indicate the cache status of static assets and responses from Vercel's CDN. For dynamic routes and fetch requests that utilize the [Vercel Data Cache](https://vercel.com/docs/infrastructure/data-cache), this header will often show `MISS` even if the data is being served from the Data Cache. Use [custom headers](https://vercel.com/docs/headers/cache-control-headers#custom-response-headers) or [runtime logs](https://vercel.com/docs/runtime-logs) to determine if a fetch response was served from the Data Cache.

The following values are possible when the content being served [is static](https://vercel.com/docs/edge-cache#static-files-caching) or uses [a Cache-Control header](https://vercel.com/docs/headers#cache-control-header):

### [`MISS`](https://vercel.com/docs/headers/response-headers\#miss)
...
### [`HIT`](https://vercel.com/docs/headers/response-headers\#hit)
...
### [`STALE`](https://vercel.com/docs/headers/response-headers\#stale)
...
See [purging the cache](https://vercel.com/docs/edge-cache/purge) for more information.
...
### [`PRERENDER`](https://vercel.com/docs/headers/response-headers\#prerender)
...
### [`REVALIDATED`](https://vercel.com/docs/headers/response-headers\#revalidated)
...
## [`x-vercel-id`](https://vercel.com/docs/headers/response-headers\#x-vercel-id)

This header contains a list of [Vercel regions](https://vercel.com/docs/regions) your request hit, as well as the region the function was executed in (for both Edge and Serverless).
