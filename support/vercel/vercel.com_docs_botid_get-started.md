---
url: "https://vercel.com/docs/botid/get-started"
...
1. ### [Install the package](https://vercel.com/docs/botid/get-started\#install-the-package)
...
2. ### [Configure redirects](https://vercel.com/docs/botid/get-started\#configure-redirects)
...
3. ### [Add client-side protection](https://vercel.com/docs/botid/get-started\#add-client-side-protection)
...
4. ### [Perform BotID checks on the server](https://vercel.com/docs/botid/get-started\#perform-botid-checks-on-the-server)
...
behavior](https://vercel.com/docs/botid/local-development-behavior).
...
5. ### [Enable BotID deep analysis in Vercel (Recommended)](https://vercel.com/docs/botid/get-started\#enable-botid-deep-analysis-in-vercel-recommended)
...
BotID Deep Analysisare availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
