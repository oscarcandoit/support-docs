...
## [Troubleshoot](https://vercel.com/docs/errors/DNS_HOSTNAME_RESOLVED_PRIVATE\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/DNS\_HOSTNAME\_RESOLVED\_PRIVATE to understand what's happening.
