---
url: "https://vercel.com/docs/plans/enterprise/buy-with-miu"
...
Buy with MIU is available on [Enterprise plans](https://vercel.com/docs/plans/enterprise)

For projects under the Enterprise plan, you can now use your existing [MIUs](https://vercel.com/docs/pricing/understanding-my-invoice#managed-infrastructure-units-miu) to pay for [AI Gateway](https://vercel.com/docs/ai-gateway) and [Vercel Agent](https://vercel.com/docs/agent) without any additional contracts or procurements.

### [Enabling Buy with MIUs](https://vercel.com/docs/plans/enterprise/buy-with-miu\#enabling-buy-with-mius)
...
If your MIU credits include a discounted rate, the discount will not be
