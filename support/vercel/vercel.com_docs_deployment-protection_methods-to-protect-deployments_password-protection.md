...
Password Protectionis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)or with the [Advanced Deployment Protection](https://vercel.com/docs/security/deployment-protection#advanced-deployment-protection) add-on for [Pro plans](https://vercel.com/docs/plans/pro)

Those with the[owner](https://vercel.com/docs/rbac/access-roles#owner-role), [member](https://vercel.com/docs/rbac/access-roles#member-role) and [admin](https://vercel.com/docs/rbac/access-roles#admin-role)rolescan manage Password Protection

With [Password Protection](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection#managing-password-protection) enabled, visitors to your deployment must enter the pre-defined password to gain access.
...
## [Password Protection security considerations](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection\#password-protection-security-considerations)
...
## [Managing Password Protection](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection\#managing-password-protection)

You can manage Password Protection through the dashboard, API, or Terraform:

1. ### [Go to Project Deployment Protection Settings](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection\#go-to-project-deployment-protection-settings)
...
2. ### [Manage Password Protection](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection\#manage-password-protection)
...
### [Manage using the API](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection\#manage-using-the-api)
...
### [Manage using Terraform](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection\#manage-using-terraform)
...
- [Password Protection security considerations](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection#password-protection-security-considerations)
- [Managing Password Protection](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection#managing-password-protection)
- [Go to Project Deployment Protection Settings](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection#go-to-project-deployment-protection-settings)
- [Manage Password Protection](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection#manage-password-protection)
- [Manage using the API](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection#manage-using-the-api)
- [Manage using Terraform](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection#manage-using-terraform)
