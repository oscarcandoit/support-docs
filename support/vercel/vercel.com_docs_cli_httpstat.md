...
The command runs the `httpstat` tool with the same arguments you provide, but adds an [`x-vercel-protection-bypass`](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/protection-bypass-automation#using-protection-bypass-for-automation) header with a valid token. This makes it simple to measure response times, analyze performance bottlenecks, or debug latency issues on protected deployments.

This command is available in Vercel CLI v48.9.0 and later. If you're using an older version, see [Updating Vercel CLI](https://vercel.com/docs/cli#updating-vercel-cli).

## [Usage](https://vercel.com/docs/cli/httpstat\#usage)
...
Using the `vercel httpstat` command to visualize HTTP
timing statistics for a deployment.

## [Examples](https://vercel.com/docs/cli/httpstat\#examples)

### [Basic timing analysis](https://vercel.com/docs/cli/httpstat\#basic-timing-analysis)
...
Getting timing statistics for the `/api/hello`
endpoint on your production deployment.

### [POST request timing](https://vercel.com/docs/cli/httpstat\#post-request-timing)
...
### [Specific deployment timing](https://vercel.com/docs/cli/httpstat\#specific-deployment-timing)
...
### [Multiple requests](https://vercel.com/docs/cli/httpstat\#multiple-requests)
...
## [How it works](https://vercel.com/docs/cli/httpstat\#how-it-works)

When you run `vercel httpstat`:

1. The CLI finds your linked project (or you can specify one with [`--scope`](https://vercel.com/docs/cli/global-options#scope))
...
## [Unique options](https://vercel.com/docs/cli/httpstat\#unique-options)

These are options that only apply to the `vercel httpstat` command.

### [Deployment](https://vercel.com/docs/cli/httpstat\#deployment)
...
Using the `--deployment` option to target a specific
deployment.

### [Protection Bypass](https://vercel.com/docs/cli/httpstat\#protection-bypass)
...
Using the `--protection-bypass` option with a manual
secret.

You can also use the [`VERCEL_AUTOMATION_BYPASS_SECRET`](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/protection-bypass-automation#using-protection-bypass-for-automation) environment variable:
...
## [Understanding the output](https://vercel.com/docs/cli/httpstat\#understanding-the-output)
...
## [Troubleshooting](https://vercel.com/docs/cli/httpstat\#troubleshooting)

### [httpstat command not found](https://vercel.com/docs/cli/httpstat\#httpstat-command-not-found)
...
### [No deployment found for the project](https://vercel.com/docs/cli/httpstat\#no-deployment-found-for-the-project)
...
### [Failed to get deployment protection bypass token](https://vercel.com/docs/cli/httpstat\#failed-to-get-deployment-protection-bypass-token)
...
5. Use it with the `--protection-bypass` flag or [`VERCEL_AUTOMATION_BYPASS_SECRET`](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/protection-bypass-automation#using-protection-bypass-for-automation) environment variable

### [No deployment found for ID](https://vercel.com/docs/cli/httpstat\#no-deployment-found-for-id)
...
## [Global Options](https://vercel.com/docs/cli/httpstat\#global-options)

The following [global options](https://vercel.com/docs/cli/global-options) can be passed when using the `vercel httpstat` command:
...
## [Related](https://vercel.com/docs/cli/httpstat\#related)
