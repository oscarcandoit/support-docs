---
url: "https://vercel.com/docs/integrations/cms/contentful"
...
- Getting your [Space ID](https://vercel.com/docs/integrations/cms/contentful#retrieve-your-contentful-space-id) and [Content Management API Token](https://vercel.com/docs/integrations/cms/contentful#create-a-content-management-api-token)
- [Importing your content model](https://vercel.com/docs/integrations/cms/contentful#import-the-content-model)
- [Adding your Contentful environment variables](https://vercel.com/docs/integrations/cms/contentful#add-environment-variables) to your Vercel project
...
[![Next.js Blog with Draft Mode](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F5nCnKpHjzhYfrEZZFcmGxU%2F9a057ee2eba16efb26ddb59ca16d4bac%2FCleanShot_2021-07-07_at_19.43.15_2x.png&w=3840&q=75)\\
\\
Next.js Blog with Draft Mode\\
\\
Static blog with Preview Mode, built with Next.js and Contentful.](https://vercel.com/templates/next.js/nextjs-blog-draft-mode)
...
1. ### [Clone the repository](https://vercel.com/docs/integrations/cms/contentful\#clone-the-repository)
...
2. ### [Create a Contentful Account](https://vercel.com/docs/integrations/cms/contentful\#create-a-contentful-account)
...
3. ### [Retrieve your Contentful Space ID](https://vercel.com/docs/integrations/cms/contentful\#retrieve-your-contentful-space-id)
...
4. ### [Create a Content Management API token](https://vercel.com/docs/integrations/cms/contentful\#create-a-content-management-api-token)
...
Avoid sharing this token because it allows both read and write access to your
...
5. ### [Import the Content Model](https://vercel.com/docs/integrations/cms/contentful\#import-the-content-model)
...
1. ### [Publish Contentful entries](https://vercel.com/docs/integrations/cms/contentful\#publish-contentful-entries)



You'll notice the new author and post entries for the example we've provided. Publish each entry to make this fully live.

2. ### [Retrieve your Contentful Secrets](https://vercel.com/docs/integrations/cms/contentful\#retrieve-your-contentful-secrets)
...
3. ### [Start your application](https://vercel.com/docs/integrations/cms/contentful\#start-your-application)
...
1. ### [Publish your code to Git](https://vercel.com/docs/integrations/cms/contentful\#publish-your-code-to-git)
...
2. ### [Import your project into Vercel](https://vercel.com/docs/integrations/cms/contentful\#import-your-project-into-vercel)
...
3. ### [Add Environment Variables](https://vercel.com/docs/integrations/cms/contentful\#add-environment-variables)
