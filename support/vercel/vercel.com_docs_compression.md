...
## [Compression algorithms](https://vercel.com/docs/compression\#compression-algorithms)
...
## [Compression negotiation](https://vercel.com/docs/compression\#compression-negotiation)
...
### [Clients that don't use `Accept-Encoding`](https://vercel.com/docs/compression\#clients-that-don't-use-accept-encoding)
...
### [Automatically compressed MIME types](https://vercel.com/docs/compression\#automatically-compressed-mime-types)
...
#### [Application types](https://vercel.com/docs/compression\#application-types)
...
#### [Font types](https://vercel.com/docs/compression\#font-types)

- `otf`
- `ttf`

#### [Image types](https://vercel.com/docs/compression\#image-types)

- `svg+xml`
- `bmp`
- `x-icon`

#### [Text types](https://vercel.com/docs/compression\#text-types)
...
### [Why doesn't Vercel compress all MIME types?](https://vercel.com/docs/compression\#why-doesn't-vercel-compress-all-mime-types)
