...
WAF Rate Limitingis availableon [all plans](https://vercel.com/docs/plans)
...
## [Get started](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting\#get-started)
...
7. For the Then action, you can leave the Default (429) action or choose between Log, Deny and Challenge
      ...
      The Log action will not perform any blocks. You can use it to first
...
6. Go to the Firewall overview page, select your Custom Rule from the traffic grouping drop-down and select the paramater(s) related to the condition(s) of your Custom Rule to observe the traffic and check whether it's working as expected:![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fwaf-overview-custom-rule-light.png&w=3840&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fwaf-overview-custom-rule-dark.png&w=3840&q=75)

## [Limits](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting\#limits)
...
## [Pricing](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting\#pricing)
