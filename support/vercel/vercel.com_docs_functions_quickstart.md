...
In this guide, you'll learn how to get started with Vercel Functions using your favorite [frontend framework](https://vercel.com/docs/frameworks) (or no framework).

## [Prerequisites](https://vercel.com/docs/functions/quickstart\#prerequisites)
...
## [Create a Vercel Function](https://vercel.com/docs/functions/quickstart\#create-a-vercel-function)
...
[Open inOpen in v0](https://v0.app/chat?q=%20%20Create%20a%20minimal%20example%20app%20for%20this%20code:%20export%20async%20function%20GET(request:%20Request)%20{%20%20const%20response%20=%20await%20fetch(%27https://api.vercel.app/products%27);%20%20const%20products%20=%20await%20response.json();%20%20return%20Response.json(products);}%20In%20your%20response:%20%201.%20Keep%20the%20example%20simple%20and%20focused%20on%20demonstrating%20the%20core%20functionality%20of%20the%20code%20%202.%20DO%20NOT%20include%20unnecessary%20features%20or%20complexity,%20aim%20to%20only%20showcase%20the%20essential%20parts%20%203.%20Show%20the%20code%20in%20a%20way%20that%20is%20easy%20to%20understand%20and%20implement%20%204.%20Provide%20clear%20and%20concise%20explanations%20for%20each%20part%20of%20the%20code)

While using `fetch` is the recommended way to create a Vercel Function, you can still use HTTP methods like `GET` and `POST`.

## [Next steps](https://vercel.com/docs/functions/quickstart\#next-steps)

Now that you have set up a Vercel Function, you can explore the following topics to learn more:

- [Explore the functions API reference](https://vercel.com/docs/functions/functions-api-reference): Learn more about creating a Vercel Function.
- [Learn about streaming functions](https://vercel.com/docs/functions/streaming-functions): Learn how to fetch streamable data with Vercel Functions.
- [Choosing a Runtime](https://vercel.com/docs/functions/runtimes): Learn more about the differences between the Node.js and Edge runtimes.
- [Configuring Functions](https://vercel.com/docs/functions/configuring-functions): Learn about the different options for configuring a Vercel Function.
