...
## [Base URL](https://vercel.com/docs/ai-gateway/usage\#base-url)
...
## [Supported endpoints](https://vercel.com/docs/ai-gateway/usage\#supported-endpoints)

The AI Gateway supports the following Usage & Billing endpoints:

- [`GET /credits`](https://vercel.com/docs/ai-gateway/usage#credits) \- Check your credit balance and usage information
- [`GET /generation`](https://vercel.com/docs/ai-gateway/usage#generation-lookup) \- Retrieve detailed information about a specific generation

## [Credits](https://vercel.com/docs/ai-gateway/usage\#credits)
...
## [Generation lookup](https://vercel.com/docs/ai-gateway/usage\#generation-lookup)
