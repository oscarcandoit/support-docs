...
## [Projects and repositories](https://vercel.com/docs/dashboard-features/overview\#projects-and-repositories)

Your dashboard view shows a list of all projects and repositories that belong to the [selected team](https://vercel.com/docs/dashboard-features#scope-selector).
...
- Visit the production deployment for the project with the [toolbar](https://vercel.com/docs/vercel-toolbar)
- View Logs
- Manage Domains
- Transfer the project
- Go to Project Settings
- Access pages for the repository or [Conformance](https://vercel.com/docs/conformance)

### [Project Dashboard](https://vercel.com/docs/dashboard-features/overview\#project-dashboard)
...
## [Search](https://vercel.com/docs/dashboard-features/overview\#search)

Use the searchbar to search for the name of any deployed project.

## [Create](https://vercel.com/docs/dashboard-features/overview\#create)
