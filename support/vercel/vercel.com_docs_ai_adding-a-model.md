...
Last updatedMarch 19, 2025

If you have integrations installed, scroll to the bottom to access the models explorer.

## [Exploring models](https://vercel.com/docs/ai/adding-a-model\#exploring-models)
...
### [Using the model playground](https://vercel.com/docs/ai/adding-a-model\#using-the-model-playground)
...
### [Adding a model to your project](https://vercel.com/docs/ai/adding-a-model\#adding-a-model-to-your-project)
...
## [Featured AI integrations](https://vercel.com/docs/ai/adding-a-model\#featured-ai-integrations)
