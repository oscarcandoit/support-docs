...
## [Using BotID](https://vercel.com/docs/botid\#using-botid)

- [Getting Started](https://vercel.com/docs/botid/get-started) \- Setup guide with complete code examples
- [Verified Bots](https://vercel.com/docs/botid/verified-bots) \- Information about verified bots and their handling
- [Bypass BotID](https://vercel.com/docs/botid#bypass-botid) \- Configure bypass rules for BotID detection

View our BotID Next.js starter template

[Get Started](https://github.com/vercel-labs/botid-nextjs-starter)

BotID includes a [Deep Analysis mode](https://vercel.com/docs/botid#how-botid-deep-analysis-works), powered by [Kasada](https://www.kasada.io/). Kasada is a leading bot protection provider trusted by Fortune 500 companies and global enterprises. It delivers advanced bot detection and anti-fraud capabilities.
...
## [Key features](https://vercel.com/docs/botid\#key-features)
...
- Deep Analysis (Kasada-powered): For the highest level of protection, enable Deep Analyis in your [Vercel Dashboard](https://vercel.com/dashboard). This leverages Kasada's advanced detection technology to block even the most sophisticated bots.

## [BotID modes](https://vercel.com/docs/botid\#botid-modes)
...
### [How BotID deep analysis works](https://vercel.com/docs/botid\#how-botid-deep-analysis-works)
...
## [Pricing](https://vercel.com/docs/botid\#pricing)
...
Calling the `checkBotId()` function in your code triggers BotID Deep Analysis
charges. Passive page views or requests that don't invoke the `checkBotId()`
function are not charged.

## [Bypass BotID](https://vercel.com/docs/botid\#bypass-botid)
...
### [Checking BotID traffic](https://vercel.com/docs/botid\#checking-botid-traffic)

You can view BotID checks by selecting BotID on the firewall traffic dropdown filter of the [Firewall tab](https://vercel.com/docs/vercel-firewall/firewall-observability#traffic) of a project.

Metrics are also available in [Observability Plus](https://vercel.com/docs/observability/observability-plus).

## [More resources](https://vercel.com/docs/botid\#more-resources)

- [Advanced configuration](https://vercel.com/docs/botid/advanced-configuration) \- Fine-grained control over detection levels and backend domains
- [Form submissions](https://vercel.com/docs/botid/form-submissions) \- Handling form submissions with BotID protection
- [Local Development Behavior](https://vercel.com/docs/botid/local-development-behavior) \- Testing BotID in development environments
