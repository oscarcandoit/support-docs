---
url: "https://vercel.com/docs/edge-config/using-edge-config"
...
[Edge Config](https://vercel.com/docs/edge-config) is a global data store that offers ultra-low latency read speeds from anywhere in the world thanks to [Vercel's CDN](https://vercel.com/docs/cdn).

We recommend using [the Edge Config client SDK](https://vercel.com/docs/edge-config/edge-config-sdk) to read data from your Edge Configs. To write data to your Edge Configs, use [Vercel REST API](https://vercel.com/docs/rest-api) as outlined in [our docs on managing Edge Configs with the API](https://vercel.com/docs/edge-config/vercel-api).

This page outlines all the ways you can interact with your Edge Configs, and our recommended best approaches.

## [Reading data from Edge Configs](https://vercel.com/docs/edge-config/using-edge-config\#reading-data-from-edge-configs)

There are multiple ways to read data from your Edge Configs, but we recommend using [our Edge Config client SDK](https://vercel.com/docs/edge-config/edge-config-sdk) in your projects.

If you prefer making direct API requests to your Edge Config, we recommend sending them to your [Edge Config endpoint](https://vercel.com/docs/edge-config/using-edge-config#understanding-edge-config-endpoints). You can request data through Vercel REST API, but we recommend against ever doing so. Requests to Vercel REST API do not benefit from the optimizations Vercel applies to Edge Config reads. Requests to an Edge Config endpoint do.
...
### [Understanding Edge Config endpoints](https://vercel.com/docs/edge-config/using-edge-config\#understanding-edge-config-endpoints)
...
- `edge-config.vercel.com`: [Edge Config endpoint](https://vercel.com/docs/edge-config/using-edge-config#querying-edge-config-endpoints) intended for reading Edge Config at high volume

#### [`api.vercel.com`](https://vercel.com/docs/edge-config/using-edge-config\#api.vercel.com)

- This endpoint is part of the [Vercel REST API](https://vercel.com/docs/rest-api)
- It is intended to [manage Edge Configs](https://vercel.com/docs/edge-config/vercel-api)
...
#### [`edge-config.vercel.com`](https://vercel.com/docs/edge-config/using-edge-config\#edge-config.vercel.com)
...
- This is the endpoint [`@vercel/edge-config`](https://vercel.com/docs/edge-config/edge-config-sdk) reads from
- This endpoint uses the Edge Config's own [Read Access tokens](https://vercel.com/docs/edge-config/using-edge-config#creating-a-read-access-token)

#### [Querying Edge Config endpoints](https://vercel.com/docs/edge-config/using-edge-config\#querying-edge-config-endpoints)
...
You can authenticate with a [Read Access token](https://vercel.com/docs/edge-config/using-edge-config#creating-a-read-access-token), which you can add to the `Authorization` header of your request, setting `Bearer <token>` as the value.

### [Finding your Edge Config ID](https://vercel.com/docs/edge-config/using-edge-config\#finding-your-edge-config-id)
...
![Your Edge Config ID in the Vercel Dashboard.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fstorage%2Fedge-config%2Fconfig-id-light.png&w=3840&q=75)![Your Edge Config ID in the Vercel Dashboard.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fstorage%2Fedge-config%2Fconfig-id-dark.png&w=3840&q=75)Your Edge Config ID in the Vercel Dashboard.

- Send a `GET` request to the `/edge-config` endpoint of Vercel REST API, as outlined in [our API reference](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-configs). The response will be a list of Edge Configs associated with your account (or team, if you add the `teamId` query parameter)

```
https://api.vercel.com/v1/edge-config?teamId=<teamId>
```

### [Creating a read access token](https://vercel.com/docs/edge-config/using-edge-config\#creating-a-read-access-token)
...
- In the Storage tab of your project dashboard. See [our Edge Config dashboard docs](https://vercel.com/docs/edge-config/edge-config-dashboard#managing-read-access-tokens) to learn how
- Through a `POST` request to Vercel REST API

#### [Using Vercel API](https://vercel.com/docs/edge-config/using-edge-config\#using-vercel-api)
...
Then you can send a `POST` request to the [`/edge-config/<edgeConfigId>/token`](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/create-an-edge-config) path, as shown below, inserting [your Edge Config's ID](https://vercel.com/docs/edge-config/using-edge-config#finding-your-edge-config-id) where appropriate:
...
Append the `teamId` query parameter to if the config is
...
### [Using a connection string](https://vercel.com/docs/edge-config/using-edge-config\#using-a-connection-string)
...
![Copy your Edge Config connection string from the dashboard.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fedge-config%2Fcopy-edge-config-connection-string-light.png&w=2048&q=75)![Copy your Edge Config connection string from the dashboard.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fedge-config%2Fcopy-edge-config-connection-string-dark.png&w=2048&q=75)Copy your Edge Config connection string from the dashboard.

A token is not created when you create an Edge Config at the account level,
...
The variable can be called anything, but [our Edge Config client SDK](https://vercel.com/docs/edge-config/edge-config-sdk) will search for `process.env.EDGE_CONFIG` by default. See our [environment variables](https://vercel.com/docs/environment-variables#creating-environment-variables) docs to learn how to create one.

## [Writing data to Edge Configs](https://vercel.com/docs/edge-config/using-edge-config\#writing-data-to-edge-configs)

Edge Config is optimized for many reads and few writes. To write data to your Edge Configs, see [our docs on doing so with Vercel REST API](https://vercel.com/docs/edge-config/vercel-api).

## [Edge Config backups](https://vercel.com/docs/edge-config/using-edge-config\#edge-config-backups)
...
Backups are taken when you make any changes either through the dashboard or API. They do not contribute to your storage size. The length of time each backup is held for depends on your plan, see [Limits and Pricing](https://vercel.com/docs/edge-config/edge-config-limits) for more information.
