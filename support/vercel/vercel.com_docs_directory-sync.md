...
Directory Syncis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)

Those with the[owner](https://vercel.com/docs/rbac/access-roles#owner-role)rolecan access this feature

Directory Sync helps teams manage their organization membership from a third-party identity provider like Google Directory or Okta. Directory Sync is only available for Enterprise Teams and can only be configured by [Team Owners](https://vercel.com/docs/rbac/access-roles#owner-role).

When Directory Sync is configured, changes to your Directory Provider will automatically be synced with your [team members](https://vercel.com/docs/rbac/managing-team-members). The previously existing permissions/roles will be overwritten by Directory Sync, including current user performing the sync.
...
out.](https://vercel.com/docs/directory-sync#preventing-account-lockout)
...
You can configure a mapping between your Directory Provider's groups and a Vercel Team role. For example, your Engineers group on Okta can be configured with the [member](https://vercel.com/docs/rbac/access-roles#member-role) role on Vercel, and your Admin group can use the [owner](https://vercel.com/docs/rbac/access-roles#owner-role) role.

## [Configuring Directory Sync](https://vercel.com/docs/directory-sync\#configuring-directory-sync)
...
4. Once you have completed the configuration walkthrough, configure how Directory Groups should map to Vercel Team roles:![Setting the Okta Admins group as Vercel owners and the Engineers group as Vercel Members.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fteams%2Fdsync-roles.png&w=1080&q=75)![Setting the Okta Admins group as Vercel owners and the Engineers group as Vercel Members.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fteams%2Fdsync-roles-dark.png&w=1080&q=75)Setting the Okta Admins group as Vercel owners and the Engineers group as Vercel Members.
5. Finally, an overview of all synced members is shown. Click Confirm and Sync to complete the syncing:![An overview of Team owners and Members that will be added.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fteams%2Fdsync-confirmation.png&w=1080&q=75)![An overview of Team owners and Members that will be added.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fteams%2Fdsync-confirmation-dark.png&w=1080&q=75)An overview of Team owners and Members that will be added.
...
### [Supported providers](https://vercel.com/docs/directory-sync\#supported-providers)

See [SAML Single Sign-On](https://vercel.com/docs/saml#saml-providers) for a list of all the SAML providers that Vercel supports.

## [Preventing account lockout](https://vercel.com/docs/directory-sync\#preventing-account-lockout)
...
| Group name | Role |
| --- | --- |
| `vercel-role-owner` | [Owner](https://vercel.com/docs/rbac/access-roles#owner-role) |
| `vercel-role-member` | [Member](https://vercel.com/docs/rbac/access-roles#member-role) |
| `vercel-role-developer` | [Developer](https://vercel.com/docs/rbac/access-roles#developer-role) |
| `vercel-role-billing` | [Billing](https://vercel.com/docs/rbac/access-roles#billing-role) |
| `vercel-role-viewer` | [Viewer Pro](https://vercel.com/docs/rbac/access-roles#pro-viewer-role) or [Viewer Enterprise](https://vercel.com/docs/rbac/access-roles#enterprise-viewer-role) |
| `vercel-role-contributor` | [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role) |
