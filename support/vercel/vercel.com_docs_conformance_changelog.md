---
url: "https://vercel.com/docs/conformance/changelog"
...
Conformanceis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)

## [Upgrade instructions](https://vercel.com/docs/conformance/changelog\#upgrade-instructions)
...
## [Releases](https://vercel.com/docs/conformance/changelog\#releases)

### [`1.12.3`](https://vercel.com/docs/conformance/changelog\#1.12.3)

- Support for Turborepo v2 configuration

### [`1.12.2`](https://vercel.com/docs/conformance/changelog\#1.12.2)
...
### [`1.10.2`](https://vercel.com/docs/conformance/changelog\#1.10.2)
...
### [`1.10.1`](https://vercel.com/docs/conformance/changelog\#1.10.1)

This patch update has the following changes:

- Fix updating allowlist files when entries conflict or already exist

### [`1.10.0`](https://vercel.com/docs/conformance/changelog\#1.10.0)

This minor update has the following changes:

- Replace [`NEXTJS_MISSING_MODULARIZE_IMPORTS`](https://vercel.com/docs/conformance/rules/NEXTJS_MISSING_MODULARIZE_IMPORTS) Next.js rule with [`NEXTJS_MISSING_OPTIMIZE_PACKAGE_IMPORTS`](https://vercel.com/docs/conformance/rules/NEXTJS_MISSING_OPTIMIZE_PACKAGE_IMPORTS)
- Fix showing error messages for rules
- Update allowlist entry details for [`REQUIRE_CARET_DEPENDENCIES`](https://vercel.com/docs/conformance/rules/REQUIRE_CARET_DEPENDENCIES)

### [`1.9.0`](https://vercel.com/docs/conformance/changelog\#1.9.0)
...
### [`1.8.1`](https://vercel.com/docs/conformance/changelog\#1.8.1)
...
### [`1.8.0`](https://vercel.com/docs/conformance/changelog\#1.8.0)

This minor update has the following changes:

- Support non-numeric Node version numbers like `lts` in [`REQUIRE_NODE_VERSION_FILE`](https://vercel.com/docs/conformance/rules/REQUIRE_NODE_VERSION_FILE).
- Add version range support for [`forbidden-packages`](https://vercel.com/docs/conformance/custom-rules/forbidden-packages) custom rules.
- Updates dependencies for performance and security.

New rules:

- [`REQUIRE_DOCS_ON_EXPORTED_FUNCTIONS`](https://vercel.com/docs/conformance/rules/REQUIRE_DOCS_ON_EXPORTED_FUNCTIONS).
Requires that all exported functions have JSDoc comments.

### [`1.7.0`](https://vercel.com/docs/conformance/changelog\#1.7.0)
...
- [`NEXTJS_REQUIRE_EXPLICIT_DYNAMIC`](https://vercel.com/docs/conformance/rules/NEXTJS_REQUIRE_EXPLICIT_DYNAMIC):
Improved error messaging.
- [`NEXTJS_SAFE_NEXT_PUBLIC_ENV_USAGE`](https://vercel.com/docs/conformance/rules/NEXTJS_SAFE_NEXT_PUBLIC_ENV_USAGE):
Improved error messaging.

### [`1.6.0`](https://vercel.com/docs/conformance/changelog\#1.6.0)
...
- [`NO_UNNECESSARY_PROP_SPREADING`](https://vercel.com/docs/conformance/rules/NO_UNNECESSARY_PROP_SPREADING):
Disallows the usage of object spreading in JSX components.

The following rules had fixes and improvements:

- [`REQUIRE_CARET_DEPENDENCIES`](https://vercel.com/docs/conformance/rules/REQUIRE_CARET_DEPENDENCIES):
Additional cases are now covered by this rule.
- [`NO_INSTANCEOF_ERROR`](https://vercel.com/docs/conformance/rules/NO_INSTANCEOF_ERROR):
Multiple issues in the same file are no longer reported as a single issue.
- [`NO_INLINE_SVG`](https://vercel.com/docs/conformance/rules/NO_INLINE_SVG):
Multiple issues in the same file are no longer reported as a single issue.
- [`REQUIRE_ONE_VERSION_POLICY`](https://vercel.com/docs/conformance/rules/REQUIRE_ONE_VERSION_POLICY):
Multiple issues in the same file are now differentiated by the package name
and the location of the entry in `package.json`.

### [`1.5.0`](https://vercel.com/docs/conformance/changelog\#1.5.0)
...
### [`1.4.0`](https://vercel.com/docs/conformance/changelog\#1.4.0)
...
- [`NO_POSTINSTALL_SCRIPT`](https://vercel.com/docs/conformance/rules/NO_POSTINSTALL_SCRIPT):
...
- [`PACKAGE_MANAGEMENT_REQUIRED_README`](https://vercel.com/docs/conformance/rules/PACKAGE_MANAGEMENT_REQUIRED_README):
Lowercase `readme.md` files are now considered valid.
- [`REQUIRE_NODE_VERSION_FILE`](https://vercel.com/docs/conformance/rules/REQUIRE_NODE_VERSION_FILE):
...
- The [`forbidden-imports`](https://vercel.com/docs/conformance/custom-rules/forbidden-imports)
custom rule type now supports `paths` being defined in [rule configuration](https://vercel.com/docs/conformance/custom-rules/forbidden-imports#configuring-this-rule-type).

### [`1.3.0`](https://vercel.com/docs/conformance/changelog\#1.3.0)
...
### [`1.2.1`](https://vercel.com/docs/conformance/changelog\#1.2.1)

This patch updates some Conformance dependencies for performance and security,
and improves handling of edge case for both [`NEXTJS_NO_ASYNC_LAYOUT`](https://vercel.com/docs/conformance/rules/NEXTJS_NO_ASYNC_LAYOUT)
and [`NEXTJS_NO_ASYNC_PAGE`](https://vercel.com/docs/conformance/rules/NEXTJS_NO_ASYNC_PAGE).

### [`1.2.0`](https://vercel.com/docs/conformance/changelog\#1.2.0)
...
### [`1.1.0`](https://vercel.com/docs/conformance/changelog\#1.1.0)
...
- [`NEXTJS_NO_ASYNC_PAGE`](https://vercel.com/docs/conformance/rules/NEXTJS_NO_ASYNC_PAGE):
...
- [`NEXTJS_NO_ASYNC_LAYOUT`](https://vercel.com/docs/conformance/rules/NEXTJS_NO_ASYNC_LAYOUT):
...
- [`NEXTJS_USE_NATIVE_FETCH`](https://vercel.com/docs/conformance/rules/NEXTJS_USE_NATIVE_FETCH):
Requires using native `fetch` which Next.js polyfills, removing the need for
third-party fetch libraries.
- [`NEXTJS_USE_NEXT_FONT`](https://vercel.com/docs/conformance/rules/NEXTJS_USE_NEXT_FONT):
Requires using `next/font` (when possible), which optimizes fonts for
improved privacy and performance.
- [`NEXTJS_USE_NEXT_IMAGE`](https://vercel.com/docs/conformance/rules/NEXTJS_USE_NEXT_IMAGE):
Requires that `next/image` is used for all images for improved performance.
- [`NEXTJS_USE_NEXT_SCRIPT`](https://vercel.com/docs/conformance/rules/NEXTJS_USE_NEXT_SCRIPT):
Requires that `next/script` is used for all scripts for improved performance.

### [`1.0.0`](https://vercel.com/docs/conformance/changelog\#1.0.0)
