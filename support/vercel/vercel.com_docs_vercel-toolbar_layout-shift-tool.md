...
Layout Shift Toolis availableon [all plans](https://vercel.com/docs/plans)
...
Layout shifts play a part in [Core Web Vitals](https://vercel.com/docs/speed-insights/metrics#core-web-vitals-explained) and contribute to [Speed Insights](https://vercel.com/docs/speed-insights/metrics#core-web-vitals-explained) scores. With the layout shift tool, you can see which elements are contributing to a layout shift and by how much.

## [Accessing the layout shift tool](https://vercel.com/docs/vercel-toolbar/layout-shift-tool\#accessing-the-layout-shift-tool)
...
## [Inspecting layout shifts](https://vercel.com/docs/vercel-toolbar/layout-shift-tool\#inspecting-layout-shifts)
...
When you replay layout shifts, the Vercel Toolbar will become your stop button. Press this to stop replaying layout shifts. Alternatively, press the `Ctrlesc` key.
...
## [Disabling the layout shift tool](https://vercel.com/docs/vercel-toolbar/layout-shift-tool\#disabling-the-layout-shift-tool)
...
## [More resources](https://vercel.com/docs/vercel-toolbar/layout-shift-tool\#more-resources)

- [Preview deployments overview](https://vercel.com/docs/deployments/environments#preview-environment-pre-production)
...
[Next\\
\\
Compute / Fluid Compute](https://vercel.com/docs/fluid-compute)
