...
## [Using headers](https://vercel.com/docs/headers\#using-headers)
...
## [Cache-Control header](https://vercel.com/docs/headers\#cache-control-header)

To learn about the cache-control headers sent to each Vercel deployment and how to use them to control the caching behavior of your application, see [Cache-Control headers](https://vercel.com/docs/headers/cache-control-headers).

## [More resources](https://vercel.com/docs/headers\#more-resources)
