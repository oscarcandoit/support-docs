---
url: "https://vercel.com/docs/rest-api/reference/welcome"
title: "Using the REST API - Vercel API Docs"
---

[Skip to main content](https://vercel.com/docs/rest-api/reference/welcome#content-area)
...
- [API Basics](https://vercel.com/docs/rest-api/reference/welcome#api-basics)
- [Server Specs](https://vercel.com/docs/rest-api/reference/welcome#server-specs)
- [HTTP and TLS](https://vercel.com/docs/rest-api/reference/welcome#http-and-tls)
- [Content Type](https://vercel.com/docs/rest-api/reference/welcome#content-type)
- [Authentication](https://vercel.com/docs/rest-api/reference/welcome#authentication)
- [Creating an Access Token](https://vercel.com/docs/rest-api/reference/welcome#creating-an-access-token)
- [Expiration](https://vercel.com/docs/rest-api/reference/welcome#expiration)
- [Accessing Resources Owned by a Team](https://vercel.com/docs/rest-api/reference/welcome#accessing-resources-owned-by-a-team)
- [Failed Authentication](https://vercel.com/docs/rest-api/reference/welcome#failed-authentication)
- [Types](https://vercel.com/docs/rest-api/reference/welcome#types)
- [Pagination](https://vercel.com/docs/rest-api/reference/welcome#pagination)
- [Rate Limits](https://vercel.com/docs/rest-api/reference/welcome#rate-limits)
- [Versioning](https://vercel.com/docs/rest-api/reference/welcome#versioning)
...
- Use the language of your choice by calling the endpoints directly and [providing your token](https://vercel.com/docs/rest-api/reference/welcome#authentication)

## [​](https://vercel.com/docs/rest-api/reference/welcome\#api-basics)  API Basics
...
### [​](https://vercel.com/docs/rest-api/reference/welcome\#server-specs)  Server Specs

#### [​](https://vercel.com/docs/rest-api/reference/welcome\#http-and-tls)  HTTP and TLS
...
### [​](https://vercel.com/docs/rest-api/reference/welcome\#content-type)  Content Type
...
### [​](https://vercel.com/docs/rest-api/reference/welcome\#authentication)  Authentication
...
#### [​](https://vercel.com/docs/rest-api/reference/welcome\#creating-an-access-token)  Creating an Access Token
...
#### [​](https://vercel.com/docs/rest-api/reference/welcome\#expiration)  Expiration
...
#### [​](https://vercel.com/docs/rest-api/reference/welcome\#accessing-resources-owned-by-a-team)  Accessing Resources Owned by a Team
...
#### [​](https://vercel.com/docs/rest-api/reference/welcome\#failed-authentication)  Failed Authentication

If authentication is unsuccessful for a request, the [error status code](https://vercel.com/docs/rest-api/reference/welcome#errors) **403** is returned.

## [​](https://vercel.com/docs/rest-api/reference/welcome\#types)  Types
...
## [​](https://vercel.com/docs/rest-api/reference/welcome\#pagination)  Pagination
...
## [​](https://vercel.com/docs/rest-api/reference/welcome\#rate-limits)  Rate Limits
...
## [​](https://vercel.com/docs/rest-api/reference/welcome\#versioning)  Versioning
