...
1. ### [Find a domain](https://vercel.com/docs/getting-started-with-vercel/buy-domain\#find-a-domain)
...
![Domains marketplace](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fgetting-started-with-vercel%2Fbuy-domains-light.png&w=2048&q=75)![Domains marketplace](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fgetting-started-with-vercel%2Fbuy-domains-dark.png&w=2048&q=75)Domains marketplace
...
2. ### [Select your domain(s)](https://vercel.com/docs/getting-started-with-vercel/buy-domain\#select-your-domains)
...
3. ### [Purchase your domain(s)](https://vercel.com/docs/getting-started-with-vercel/buy-domain\#purchase-your-domains)
...
4. ### [Enter payment details and registrant information](https://vercel.com/docs/getting-started-with-vercel/buy-domain\#enter-payment-details-and-registrant-information)




   - You'll need to enter your billing and credit card details to purchase the domain on the checkout page. These details are saved for [auto renewal](https://vercel.com/docs/domains/renew-a-domain).
...
5. ### [Configure your domain](https://vercel.com/docs/getting-started-with-vercel/buy-domain\#configure-your-domain)
...
You can also configure your domain from the [project's domains dashboard page](https://vercel.com/d?to=%2F%5Bteam%5D%2F%5Bproject%5D%2Fsettings%2Fdomains&title=Go+to+your+project%27s+domain) by following the [Add and configure domain](https://vercel.com/docs/domains/working-with-domains/add-a-domain) instructions.

## [Next steps](https://vercel.com/docs/getting-started-with-vercel/buy-domain\#next-steps)

Next, learn how to take advantage of Vercel's collaboration features as part of your developer workflow:

[Use Vercel in your developer workflow](https://vercel.com/docs/getting-started-with-vercel/collaborate)
...
- [Find a domain](https://vercel.com/docs/getting-started-with-vercel/buy-domain#find-a-domain)
- [Select your domain(s)](https://vercel.com/docs/getting-started-with-vercel/buy-domain#select-your-domains)
- [Purchase your domain(s)](https://vercel.com/docs/getting-started-with-vercel/buy-domain#purchase-your-domains)
- [Enter payment details and registrant information](https://vercel.com/docs/getting-started-with-vercel/buy-domain#enter-payment-details-and-registrant-information)
- [Configure your domain](https://vercel.com/docs/getting-started-with-vercel/buy-domain#configure-your-domain)
- [Next steps](https://vercel.com/docs/getting-started-with-vercel/buy-domain#next-steps)
