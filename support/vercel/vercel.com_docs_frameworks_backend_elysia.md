...
- [Fluid compute](https://vercel.com/docs/fluid-compute): Active CPU billing, automatic cold start prevention, optimized concurrency, background processing, and more
- [Preview deployments](https://vercel.com/docs/deployments/environments#preview-environment-pre-production): Test your changes on a copy of your production infrastructure
- [Instant Rollback](https://vercel.com/docs/instant-rollback): Recover from unintended changes or bugs in milliseconds
- [Vercel Firewall](https://vercel.com/docs/vercel-firewall): Protect your applications from a wide range of threats with a multi-layered security system
...
## [Get started with Elysia on Vercel](https://vercel.com/docs/frameworks/backend/elysia\#get-started-with-elysia-on-vercel)

Get started by initializing a new Elysia project using [Vercel CLI init command](https://vercel.com/docs/cli/init):
...
To deploy, [connect your Git repository](https://vercel.com/new) or [use Vercel CLI](https://vercel.com/docs/cli):
...
## [Entrypoint detection](https://vercel.com/docs/frameworks/backend/elysia\#entrypoint-detection)
...
### [Using a default export](https://vercel.com/docs/frameworks/backend/elysia\#using-a-default-export)
...
### [Using a port listener](https://vercel.com/docs/frameworks/backend/elysia\#using-a-port-listener)

Running your application using `app.listen` is currently not supported. For now, prefer `export default app`.

## [Local development](https://vercel.com/docs/frameworks/backend/elysia\#local-development)
...
## [Using Node.js](https://vercel.com/docs/frameworks/backend/elysia\#using-node.js)
...
## [Using the Bun runtime](https://vercel.com/docs/frameworks/backend/elysia\#using-the-bun-runtime)
...
For more information, [visit the Bun runtime on Vercel documentation](https://vercel.com/docs/functions/runtimes/bun).

## [Middleware](https://vercel.com/docs/frameworks/backend/elysia\#middleware)

### [Elysia Plugins and Lifecycle Hooks](https://vercel.com/docs/frameworks/backend/elysia\#elysia-plugins-and-lifecycle-hooks)
...
### [Vercel Routing Middleware](https://vercel.com/docs/frameworks/backend/elysia\#vercel-routing-middleware)

In Vercel, [Routing Middleware](https://vercel.com/docs/routing-middleware) executes before a request is processed by your application. Use it for rewrites, redirects, headers, or personalization, and combine it with Elysia's own lifecycle hooks as needed.

## [Vercel Functions](https://vercel.com/docs/frameworks/backend/elysia\#vercel-functions)

When you deploy an Elysia app to Vercel, your server endpoints automatically run as [Vercel Functions](https://vercel.com/docs/functions) and use [Fluid compute](https://vercel.com/docs/fluid-compute) by default.

## [More resources](https://vercel.com/docs/frameworks/backend/elysia\#more-resources)
