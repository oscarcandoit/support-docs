...
1. ### [Connect to your Git provider](https://vercel.com/docs/getting-started-with-vercel/import\#connect-to-your-git-provider)
...
Follow the prompts to sign in to either your [GitHub](https://vercel.com/docs/git/vercel-for-github), [GitLab](https://vercel.com/docs/git/vercel-for-gitlab), or [BitBucket](https://vercel.com/docs/git/vercel-for-bitbucket) account.

2. ### [Import your repository](https://vercel.com/docs/getting-started-with-vercel/import\#import-your-repository)



Find the repository in the list that you would like to import and select Import.

3. ### [Optionally, configure any settings](https://vercel.com/docs/getting-started-with-vercel/import\#optionally-configure-any-settings)



Vercel will automatically detect the framework and any necessary build settings. However, you can also configure the Project settings at this point including the [build and output settings](https://vercel.com/docs/deployments/configure-a-build#build-and-development-settings) and [Environment Variables](https://vercel.com/docs/environment-variables). These can also be set later.
   ...
   - You can also configure additional properties by adding a [vercel.json](https://vercel.com/docs/project-configuration) to your project. You can either do this now, before you deploy, or add it later and redeploy your project.
4. ### [Deploy your project](https://vercel.com/docs/getting-started-with-vercel/import\#deploy-your-project)



Press the Deploy button. Vercel will create the Project and deploy it based on the chosen configurations.

5. ### [Enjoy the confetti!](https://vercel.com/docs/getting-started-with-vercel/import\#enjoy-the-confetti!)
...
![Accessing auto-generated domain](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fgetting-started-with-vercel%2Fprod-view-light.png&w=3840&q=75)![Accessing auto-generated domain](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fgetting-started-with-vercel%2Fprod-view-dark.png&w=3840&q=75)Accessing auto-generated domain

## [Next Steps](https://vercel.com/docs/getting-started-with-vercel/import\#next-steps)
...
- [Connect to your Git provider](https://vercel.com/docs/getting-started-with-vercel/import#connect-to-your-git-provider)
- [Import your repository](https://vercel.com/docs/getting-started-with-vercel/import#import-your-repository)
- [Optionally, configure any settings](https://vercel.com/docs/getting-started-with-vercel/import#optionally-configure-any-settings)
- [Deploy your project](https://vercel.com/docs/getting-started-with-vercel/import#deploy-your-project)
- [Enjoy the confetti!](https://vercel.com/docs/getting-started-with-vercel/import#enjoy-the-confetti!)
- [Next Steps](https://vercel.com/docs/getting-started-with-vercel/import#next-steps)
