...
## [Prerequisites](https://vercel.com/docs/cron-jobs/quickstart\#prerequisites)

- [A Vercel account](https://vercel.com/signup)
- [A project](https://vercel.com/docs/projects/overview#creating-a-project) with a [Vercel Function](https://vercel.com/docs/functions)

1. ### [Create a function](https://vercel.com/docs/cron-jobs/quickstart\#create-a-function)
...
2. ### [Create or update your `vercel.json` file](https://vercel.com/docs/cron-jobs/quickstart\#create-or-update-your-vercel.json-file)



Create or go to your [`vercel.json`](https://vercel.com/docs/project-configuration#functions) file and add the following code:
...
3. ### [Deploy your project.](https://vercel.com/docs/cron-jobs/quickstart\#deploy-your-project.)



When you deploy your project, Vercel's build process creates the cron job. Vercel invokes cron jobs only for [production](https://vercel.com/docs/deployments/environments#production-environment) deployments and not for [preview](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) deployments
...
## [Next steps](https://vercel.com/docs/cron-jobs/quickstart\#next-steps)

Now that you have created a cron job, you can learn more about how to manage and configure them:

- [Learn about managing cron jobs](https://vercel.com/docs/cron-jobs/manage-cron-jobs)
- [Explore usage and pricing](https://vercel.com/docs/cron-jobs/usage-and-pricing)
...
- [Prerequisites](https://vercel.com/docs/cron-jobs/quickstart#prerequisites)
- [Create a function](https://vercel.com/docs/cron-jobs/quickstart#create-a-function)
- [Create or update your vercel.json file](https://vercel.com/docs/cron-jobs/quickstart#create-or-update-your-vercel.json-file)
- [Deploy your project.](https://vercel.com/docs/cron-jobs/quickstart#deploy-your-project.)
- [Next steps](https://vercel.com/docs/cron-jobs/quickstart#next-steps)
