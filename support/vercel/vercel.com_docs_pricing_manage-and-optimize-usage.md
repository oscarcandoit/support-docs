---
url: "https://vercel.com/docs/pricing/manage-and-optimize-usage"
...
## [What pricing plan am I on?](https://vercel.com/docs/pricing/manage-and-optimize-usage\#what-pricing-plan-am-i-on)
...
## [Viewing usage](https://vercel.com/docs/pricing/manage-and-optimize-usage\#viewing-usage)
...
6. Use the [Top Paths](https://vercel.com/docs/manage-cdn-usage#top-paths) chart to understand the metrics causing the high usage

## [Usage alerts, notification, and spend management](https://vercel.com/docs/pricing/manage-and-optimize-usage\#usage-alerts-notification-and-spend-management)
...
- Usage Notifications: Usage notifications are set up automatically. Pro teams can also [configure the threshold](https://vercel.com/docs/notifications#on-demand-usage-notifications) for usage alerts to notify you when you're approaching your usage limits
...
## [Networking](https://vercel.com/docs/pricing/manage-and-optimize-usage\#networking)
...
| --- | --- | --- | --- |
| [Top Paths](https://vercel.com/docs/manage-cdn-usage#top-paths) | The paths that consume the most resources on your team | N/A | N/A |
| [Fast Data Transfer](https://vercel.com/docs/manage-cdn-usage#fast-data-transfer) | The data transfer between Vercel's CDN and your sites' end users. | [Yes](https://vercel.com/docs/pricing/regional-pricing) | [Learn More](https://vercel.com/docs/manage-cdn-usage#optimizing-fast-data-transfer) |
| [Fast Origin Transfer](https://vercel.com/docs/manage-cdn-usage#fast-origin-transfer) | The data transfer between Vercel's CDN to Vercel Compute | [Yes](https://vercel.com/docs/pricing/regional-pricing) | [Learn More](https://vercel.com/docs/manage-cdn-usage#optimizing-fast-origin-transfer) |
| [Edge Requests](https://vercel.com/docs/manage-cdn-usage#edge-requests) | The number of cached and uncached requests that your deployments have received | [Yes](https://vercel.com/docs/pricing/regional-pricing) | [Learn More](https://vercel.com/docs/manage-cdn-usage#optimizing-edge-requests) |

Manage and Optimize pricing

## [Serverless Functions](https://vercel.com/docs/pricing/manage-and-optimize-usage\#serverless-functions)
...
| Metric | Description | Priced | Optimize |
| --- | --- | --- | --- |
| [Function Invocations](https://vercel.com/docs/pricing/serverless-functions#managing-function-invocations) | The number of times your Functions have been invoked | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/pricing/serverless-functions#optimizing-function-invocations) |
| [Function Duration](https://vercel.com/docs/pricing/serverless-functions#managing-function-duration) | The time your Serverless Functions have spent responding to requests | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/pricing/serverless-functions#optimizing-function-duration) |
| [Throttles](https://vercel.com/docs/pricing/serverless-functions#throttles) | Instances where requests to Functions are not served due to concurrency limits | No | N/A |

Manage and Optimize pricing

## [Builds](https://vercel.com/docs/pricing/manage-and-optimize-usage\#builds)

The table below shows the metrics for the [Builds](https://vercel.com/docs/builds/managing-builds) section of the Usage dashboard.

To view information on managing each resource, select the resource link in the Metric column. To jump straight to guidance on optimization, select the corresponding resource link in the Optimize column.

| Metric | Description | Priced | Optimize |
| --- | --- | --- | --- |
| [Build Time](https://vercel.com/docs/builds/managing-builds#managing-build-time) | The amount of time your Deployments have spent being queued or building | No | [Learn More](https://vercel.com/docs/builds/managing-builds#managing-build-time) |
| [Number of Builds](https://vercel.com/docs/builds/managing-builds#number-of-builds) | How many times a build was issued for one of your Deployments | No | N/A |

Manage and Optimize pricing

## [Artifacts](https://vercel.com/docs/pricing/manage-and-optimize-usage\#artifacts)

The table below shows the metrics for the [Remote Cache Artifacts](https://vercel.com/docs/monorepos/remote-caching#artifacts) section of the Usage dashboard.
...
| [Total Size of Remote Cache Artifacts](https://vercel.com/docs/monorepos/remote-caching#managing-total-size-of-remote-cache-artifacts) | The size of uploaded and downloaded artifacts using the Remote Cache API | No | [Learn More](https://vercel.com/docs/monorepos/remote-caching#optimizing-total-size-of-remote-cache-artifacts) |
...
## [Edge Config](https://vercel.com/docs/pricing/manage-and-optimize-usage\#edge-config)
...
| Metric | Description | Priced | Optimize |
| --- | --- | --- | --- |
| [Reads](https://vercel.com/docs/pricing/edge-config#reviewing-edge-config-reads) | The number of times your Edge Config has been read | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/pricing/edge-config#optimizing-edge-config-reads) |
| [Writes](https://vercel.com/docs/pricing/edge-config#managing-edge-config-writes) | The number of times your Edge Config has been updated | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/pricing/edge-config#optimizing-edge-config-writes) |

Manage and Optimize pricing

## [Data Cache](https://vercel.com/docs/pricing/manage-and-optimize-usage\#data-cache)

The table below shows the metrics for the [Data Cache](https://vercel.com/docs/data-cache) section of the Usage dashboard.

To view information on managing each resource, select the resource link in the Metric column. To jump straight to guidance on optimization, select the corresponding resource link in the Optimize column.

| Metric | Description | Priced | Optimize |
| --- | --- | --- | --- |
| [Overview](https://vercel.com/docs/data-cache) | The usage from fetch requests to origins | No | [Learn More](https://vercel.com/docs/data-cache) |
| [Reads](https://vercel.com/docs/data-cache) | The total amount of Read Units used to access the Data Cache | No | [Learn More](https://vercel.com/docs/data-cache) |
| [Writes](https://vercel.com/docs/data-cache) | The total amount of Write Units used to store new data in the Data Cache | No | [Learn More](https://vercel.com/docs/data-cache) |

Manage and Optimize pricing

## [Incremental Static Regeneration (ISR)](https://vercel.com/docs/pricing/manage-and-optimize-usage\#incremental-static-regeneration-isr)

The table below shows the metrics for the [Incremental Static Regeneration](https://vercel.com/docs/pricing/incremental-static-regeneration) section of the Usage dashboard.
...
## [Observability](https://vercel.com/docs/pricing/manage-and-optimize-usage\#observability)

The table below shows the metrics for the [Web Analytics](https://vercel.com/docs/pricing/observability#managing-web-analytics-events), [Speed Insights](https://vercel.com/docs/pricing/observability#managing-speed-insights-data-points), and [Monitoring](https://vercel.com/docs/manage-and-optimize-observability#optimizing-monitoring-events) sections of the Usage dashboard.

To view information on managing each resource, select the resource link in the Metric column. To jump straight to guidance on optimization, select the corresponding resource link in the Optimize column.

| Metric | Description | Priced | Optimize |
| --- | --- | --- | --- |
| [Web Analytics Events](https://vercel.com/docs/pricing/observability#managing-web-analytics-events) | The number of page views and custom events tracked across all your projects | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/manage-and-optimize-observability#optimizing-web-analytics-events) |
| [Speed Insights Data points](https://vercel.com/docs/pricing/observability#managing-speed-insights-data-points) | The number of data points reported from browsers for Speed Insights | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/speed-insights/limits-and-pricing#optimizing-speed-insights-data-points) |
| [Observability Plus Events](https://vercel.com/docs/pricing/observability#managing-observability-events) | The number of events collected, based on requests made to your site | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/manage-and-optimize-observability#optimizing-observability-events) |
| [Monitoring Events](https://vercel.com/docs/manage-and-optimize-observability#optimizing-monitoring-events) | The number of requests made to your website | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/manage-and-optimize-observability#optimizing-monitoring-events) |

Manage and Optimize pricing

## [Image Optimization](https://vercel.com/docs/pricing/manage-and-optimize-usage\#image-optimization)

The table below shows the metrics for the [Image Optimization](https://vercel.com/docs/image-optimization/managing-image-optimization-costs) section of the Usage dashboard.

To view information on managing each resource, select the resource link in the Metric column. To jump straight to guidance on optimization, select the corresponding resource link in the Optimize column.

| Metric | Description | Priced | Optimize |
| --- | --- | --- | --- |
| [Source images](https://vercel.com/docs/image-optimization/managing-image-optimization-costs#source-image-optimizations) | The number of images that have been optimized using the Image Optimization feature | [Yes](https://vercel.com/docs/pricing#managed-infrastructure-billable-resources) | [Learn More](https://vercel.com/docs/image-optimization/managing-image-optimization-costs#how-to-optimize-your-costs) |

Manage and Optimize pricing

## [Viewing Options](https://vercel.com/docs/pricing/manage-and-optimize-usage\#viewing-options)

### [Count](https://vercel.com/docs/pricing/manage-and-optimize-usage\#count)
...
### [Project](https://vercel.com/docs/pricing/manage-and-optimize-usage\#project)
...
### [Region](https://vercel.com/docs/pricing/manage-and-optimize-usage\#region)
...
### [Ratio](https://vercel.com/docs/pricing/manage-and-optimize-usage\#ratio)
...
### [Average](https://vercel.com/docs/pricing/manage-and-optimize-usage\#average)

This shows the average usage of a certain metric over a 24 hour period.

## [More resources](https://vercel.com/docs/pricing/manage-and-optimize-usage\#more-resources)
