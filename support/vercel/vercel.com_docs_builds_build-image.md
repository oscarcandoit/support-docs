...
When you initiate a deployment, Vercel will [build your project](https://vercel.com/docs/builds) within a container using the build image.
Vercel supports [multiple runtimes](https://vercel.com/docs/functions/runtimes).

| Runtime | [Build image](https://vercel.com/docs/builds/build-image) |
| --- | --- |
| [Node.js](https://vercel.com/docs/functions/runtimes/node-js) | `24.x``22.x``20.x` |
| [Edge](https://vercel.com/docs/functions/runtimes/edge-runtime) |  |
| [Python](https://vercel.com/docs/functions/runtimes/python) | `3.12` |
| [Ruby](https://vercel.com/docs/functions/runtimes/ruby) | `3.3.x` |
| [Go RuntimeGo](https://vercel.com/docs/functions/runtimes/go) |  |
...
## [Pre-installed packages](https://vercel.com/docs/builds/build-image\#pre-installed-packages)
...
## [Running the build image locally](https://vercel.com/docs/builds/build-image\#running-the-build-image-locally)
...
## [Installing additional packages](https://vercel.com/docs/builds/build-image\#installing-additional-packages)

You can install additional packages into the build container by configuring the [Install Command](https://vercel.com/docs/deployments/configure-a-build#install-command) within the dashboard or the `"installCommand"` in your `vercel.json` to use any of the following commands.
