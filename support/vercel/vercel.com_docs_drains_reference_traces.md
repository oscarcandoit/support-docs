...
- [Custom endpoint](https://vercel.com/docs/drains/using-drains#custom-endpoint): Send traces to any HTTP endpoint you configure
- [Native integration](https://vercel.com/docs/drains/using-drains#native-integrations): Use integrations from the Vercel Marketplace like [Braintrust](https://vercel.com/marketplace/braintrust)
...
## [Traces Schema](https://vercel.com/docs/drains/reference/traces\#traces-schema)
...
## [Format](https://vercel.com/docs/drains/reference/traces\#format)

Vercel supports the following formats for Trace Drains. You can configure the format when [configuring the Drain destination](https://vercel.com/docs/drains/using-drains#configure-destination):

### [JSON](https://vercel.com/docs/drains/reference/traces\#json)
...
### [Protobuf](https://vercel.com/docs/drains/reference/traces\#protobuf)
...
## [Sampling Rate](https://vercel.com/docs/drains/reference/traces\#sampling-rate)
...
## [Limitations](https://vercel.com/docs/drains/reference/traces\#limitations)

Custom spans from functions using the [Edge runtime](https://vercel.com/docs/functions/runtimes/edge) are not forwarded via the Trace Drain.

## [More resources](https://vercel.com/docs/drains/reference/traces\#more-resources)
