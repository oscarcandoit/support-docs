...
Vercel Agent Code Reviewis availablein [Beta](https://vercel.com/docs/release-phases#beta)on[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans

AI Code Review is part of [Vercel Agent](https://vercel.com/docs/agent), a suite of AI-powered development tools. When you open a pull request, it automatically analyzes your changes using multi-step reasoning to catch security vulnerabilities, logic errors, and performance issues.

It generates patches and runs them in [secure sandboxes](https://vercel.com/docs/vercel-sandbox) with your real builds, tests, and linters to validate fixes before suggesting them. Only validated suggestions that pass these checks appear in your PR, allowing you to apply specific code changes with one click.

## [How to set up Code Review](https://vercel.com/docs/agent/pr-review\#how-to-set-up-code-review)

To enable code reviews for your [repositories](https://vercel.com/docs/git#supported-git-providers), navigate to the
[Agent tab](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fvercel-agent&title=Open+Vercel+Agent) of the dashboard.
...
## [How it works](https://vercel.com/docs/agent/pr-review\#how-it-works)
...
Code Review then generates patches, runs them in [secure sandboxes](https://vercel.com/docs/vercel-sandbox), and executes your real builds, tests, and linters. Only validated suggestions that pass these checks appear in your PR.

## [Managing reviews](https://vercel.com/docs/agent/pr-review\#managing-reviews)

Check out [Managing Reviews](https://vercel.com/docs/agent/pr-review/usage) for details on how to customize which repositories get reviewed and monitor your review metrics and spending.

## [Pricing](https://vercel.com/docs/agent/pr-review\#pricing)
...
## [Privacy](https://vercel.com/docs/agent/pr-review\#privacy)
