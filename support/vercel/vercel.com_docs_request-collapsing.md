...
## [How request collapsing works](https://vercel.com/docs/request-collapsing\#how-request-collapsing-works)

When a request for an uncached path arrives, Vercel invokes the origin [function](https://vercel.com/docs/functions) and stores the response in the [cache](https://vercel.com/docs/edge-cache). In most cases, any following requests are served from this cached response.
...
Vercel also applies request collapsing when serving [STALE](https://vercel.com/docs/headers/response-headers#stale) responses (with [stale-while-revalidate](https://vercel.com/docs/headers/cache-control-headers#stale-while-revalidate) semantics), ensuring that concurrent background revalidation of multiple requests is collapsed into a single invocation.

### [Example](https://vercel.com/docs/request-collapsing\#example)
...
## [Supported features](https://vercel.com/docs/request-collapsing\#supported-features)
