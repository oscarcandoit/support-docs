...
![](https://7nyt0uhk7sse4zvn.public.blob.vercel-storage.com/docs-assets/static/topics/icons/nitro.svg)
...
## [Get started with Nitro on Vercel](https://vercel.com/docs/frameworks/backend/nitro\#get-started-with-nitro-on-vercel)

To get started with Nitro on Vercel, use the following Nitro template to deploy to Vercel with zero configuration:

[![](https://7nyt0uhk7sse4zvn.public.blob.vercel-storage.com/docs-assets/static/topics/icons/nitro.svg)Deploy Nitro to Vercel](https://vercel.com/templates/backend/nitro-starter)

[Deploy](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fvercel%2Ftree%2Fmain%2Fexamples%2Fnitro&template=nitro) [Live Example](https://nitro-template.vercel.app/)

Vercel deployments can [integrate with your git provider](https://vercel.com/docs/git) to [generate preview URLs](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) for each pull request you make to your Nitro project.

### [Get started with Vercel CLI](https://vercel.com/docs/frameworks/backend/nitro\#get-started-with-vercel-cli)

Get started by initializing a new Nitro project using [Vercel CLI init command](https://vercel.com/docs/cli/init):
...
## [Using Vercel's features with Nitro](https://vercel.com/docs/frameworks/backend/nitro\#using-vercel's-features-with-nitro)

When you deploy a Nitro app to Vercel, you can use Vercel specific features such as [Incremental Static Regeneration (ISR)](https://vercel.com/docs/frameworks/backend/nitro#incremental-static-regeneration-isr), [preview deployments](https://vercel.com/docs/deployments/environments#preview-environment-pre-production), [Fluid compute](https://vercel.com/docs/fluid-compute), [Observability](https://vercel.com/docs/frameworks/backend/nitro#observability), and [Vercel firewall](https://vercel.com/docs/vercel-firewall) with zero or minimum configuration.

## [Incremental Static Regeneration (ISR)](https://vercel.com/docs/frameworks/backend/nitro\#incremental-static-regeneration-isr)
...
### [On-demand revalidation](https://vercel.com/docs/frameworks/backend/nitro\#on-demand-revalidation)
...
1. ### [Create an Environment Variable](https://vercel.com/docs/frameworks/backend/nitro\#create-an-environment-variable)
...
2. ### [Update your configuration](https://vercel.com/docs/frameworks/backend/nitro\#update-your-configuration)
...
3. ### [Trigger revalidation](https://vercel.com/docs/frameworks/backend/nitro\#trigger-revalidation)
...
### [Fine-grained ISR configuration](https://vercel.com/docs/frameworks/backend/nitro\#fine-grained-isr-configuration)
...
## [Observability](https://vercel.com/docs/frameworks/backend/nitro\#observability)
...
Framework integrations can use the `ssrRoutes` configuration to declare SSR
routes. For more information, see
[#3475](https://github.com/unjs/nitro/pull/3475).

## [Vercel Functions](https://vercel.com/docs/frameworks/backend/nitro\#vercel-functions)

When you deploy a Nitro app to Vercel, your server routes automatically become [Vercel Functions](https://vercel.com/docs/functions) and use [Fluid compute](https://vercel.com/docs/fluid-compute) by default.

## [More resources](https://vercel.com/docs/frameworks/backend/nitro\#more-resources)
...
- [Incremental Static Regeneration (ISR)](https://vercel.com/docs/frameworks/backend/nitro#incremental-static-regeneration-isr)
- [On-demand revalidation](https://vercel.com/docs/frameworks/backend/nitro#on-demand-revalidation)
- [Create an Environment Variable](https://vercel.com/docs/frameworks/backend/nitro#create-an-environment-variable)
- [Update your configuration](https://vercel.com/docs/frameworks/backend/nitro#update-your-configuration)
- [Trigger revalidation](https://vercel.com/docs/frameworks/backend/nitro#trigger-revalidation)
- [Fine-grained ISR configuration](https://vercel.com/docs/frameworks/backend/nitro#fine-grained-isr-configuration)
- [Observability](https://vercel.com/docs/frameworks/backend/nitro#observability)
- [Vercel Functions](https://vercel.com/docs/frameworks/backend/nitro#vercel-functions)
- [More resources](https://vercel.com/docs/frameworks/backend/nitro#more-resources)
