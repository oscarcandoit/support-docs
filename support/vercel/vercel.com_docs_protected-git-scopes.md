...
Protected Git Scopesare availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
## [Managing Protected Git Scopes](https://vercel.com/docs/protected-git-scopes\#managing-protected-git-scopes)

You can [add](https://vercel.com/docs/protected-git-scopes#adding-a-protected-git-scope) up to five Protected Git Scopes to your Vercel Team. Multiple teams can specify the same scope, allowing both teams access.

In order to add a Protected Git Scope to your Vercel Team, you must be an [Owner](https://vercel.com/docs/rbac/access-roles#owner-role) of the Vercel Team, and have the required permission in the Git namespace.

For Github you must be an `admin`, for Gitlab you must be an `owner`, and for Bitbucket you must be a `owner`.

## [Adding a Protected Git Scope](https://vercel.com/docs/protected-git-scopes\#adding-a-protected-git-scope)

1. ### [Go to your Team Security Settings](https://vercel.com/docs/protected-git-scopes\#go-to-your-team-security-settings)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fprotected-git-scopes-light.png&w=1200&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fprotected-git-scopes-dark.png&w=1200&q=75)
2. ### [Add a Protected Git Scope](https://vercel.com/docs/protected-git-scopes\#add-a-protected-git-scope)
...
2. In the modal, select the Git provider you wish to add:![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fprotected-git-scopes-modal-1-light.png&w=828&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fprotected-git-scopes-modal-1-dark.png&w=828&q=75)
3. In the modal, select the Git namespace you wish to add:![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fprotected-git-scopes-modal-2-light.png&w=828&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fprotected-git-scopes-modal-2-dark.png&w=828&q=75)
4. Click Save

## [Removing a Protected Git Scope](https://vercel.com/docs/protected-git-scopes\#removing-a-protected-git-scope)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fprotected-git-scopes-light.png&w=1200&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fprotected-git-scopes-dark.png&w=1200&q=75)
2. ### [Remove a Protected Git Scope](https://vercel.com/docs/protected-git-scopes\#remove-a-protected-git-scope)
...
- [Managing Protected Git Scopes](https://vercel.com/docs/protected-git-scopes#managing-protected-git-scopes)
- [Adding a Protected Git Scope](https://vercel.com/docs/protected-git-scopes#adding-a-protected-git-scope)
- [Go to your Team Security Settings](https://vercel.com/docs/protected-git-scopes#go-to-your-team-security-settings)
- [Add a Protected Git Scope](https://vercel.com/docs/protected-git-scopes#add-a-protected-git-scope)
- [Removing a Protected Git Scope](https://vercel.com/docs/protected-git-scopes#removing-a-protected-git-scope)
- [Go to your Team Security Settings](https://vercel.com/docs/protected-git-scopes#go-to-your-team-security-settings)
- [Remove a Protected Git Scope](https://vercel.com/docs/protected-git-scopes#remove-a-protected-git-scope)
