...
## [Troubleshoot](https://vercel.com/docs/errors/DNS_HOSTNAME_NOT_FOUND\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/DNS\_HOSTNAME\_NOT\_FOUND to understand what's happening.
...
4. Review application logs: Inspect the [application logs](https://vercel.com/docs/deployments/logs) for any warnings or errors related to DNS or the attempted connections
