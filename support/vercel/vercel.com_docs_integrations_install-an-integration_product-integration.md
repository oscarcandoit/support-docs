---
url: "https://vercel.com/docs/integrations/install-an-integration/product-integration"
...
Native Integrations are available on [all plans](https://vercel.com/docs/plans)

All plans, including Enterprise, can install the integrations through a self-service workflow.

## [Add a product](https://vercel.com/docs/integrations/install-an-integration/product-integration\#add-a-product)

1. From the [Vercel dashboard](https://vercel.com/dashboard), select the Integrations tab and then the Browse Marketplace button. You can also go directly to the [Integrations Marketplace](https://vercel.com/integrations).
...
## [Manage native integrations](https://vercel.com/docs/integrations/install-an-integration/product-integration\#manage-native-integrations)
...
- [Uninstall the integration](https://vercel.com/docs/integrations/install-an-integration/product-integration#uninstall-an-integration)

### [Manage products](https://vercel.com/docs/integrations/install-an-integration/product-integration\#manage-products)
...
#### [Projects](https://vercel.com/docs/integrations/install-an-integration/product-integration\#projects)
...
#### [Settings](https://vercel.com/docs/integrations/install-an-integration/product-integration\#settings)
...
#### [Getting Started](https://vercel.com/docs/integrations/install-an-integration/product-integration\#getting-started)
...
#### [Usage](https://vercel.com/docs/integrations/install-an-integration/product-integration\#usage)
...
#### [Resources](https://vercel.com/docs/integrations/install-an-integration/product-integration\#resources)
...
### [Add more products](https://vercel.com/docs/integrations/install-an-integration/product-integration\#add-more-products)
...
### [Uninstall an integration](https://vercel.com/docs/integrations/install-an-integration/product-integration\#uninstall-an-integration)
...
## [Use deployment integration actions](https://vercel.com/docs/integrations/install-an-integration/product-integration\#use-deployment-integration-actions)

If available in the integration you want to install, [deployment integration actions](https://vercel.com/docs/integrations/create-integration/deployment-integration-action) enable automatic task execution during deployment, such as branching a database or setting environment variables.
...
## [Best practices](https://vercel.com/docs/integrations/install-an-integration/product-integration\#best-practices)
...
- Monitor Usage: Take advantage of per-product usage tracking to optimize costs and performance by using the Usage and Invoices tabs of the [product's settings page](https://vercel.com/docs/integrations/install-an-integration/product-integration#manage-products).
