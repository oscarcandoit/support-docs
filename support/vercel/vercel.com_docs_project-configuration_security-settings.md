...
From here you can enable or disable [Attack Challenge Mode](https://vercel.com/docs/attack-challenge-mode), [Logs and Source Protection](https://vercel.com/docs/project-configuration/security-settings#build-logs-and-source-protection), [Customer Success Code Visibility](https://vercel.com/docs/project-configuration/security-settings#customer-success-code-visibility) and [Git Fork Protection](https://vercel.com/docs/project-configuration/security-settings#git-fork-protection).

## [Build logs and source protection](https://vercel.com/docs/project-configuration/security-settings\#build-logs-and-source-protection)
...
## [Customer Success Code Visibility](https://vercel.com/docs/project-configuration/security-settings\#customer-success-code-visibility)

Customer Success Code Visibilityis availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
## [Git fork protection](https://vercel.com/docs/project-configuration/security-settings\#git-fork-protection)
...
## [Secure Backend Access with OIDC Federation](https://vercel.com/docs/project-configuration/security-settings\#secure-backend-access-with-oidc-federation)
...
To learn more, see [Secure Backend Access with OIDC Federation](https://vercel.com/docs/oidc).

## [Deployment Retention Policy](https://vercel.com/docs/project-configuration/security-settings\#deployment-retention-policy)

Deployment Retention Policy allows you to set a limit on how long older deployments are kept for your project. To learn more, see [Deployment Retention Policy](https://vercel.com/docs/security/deployment-retention).
