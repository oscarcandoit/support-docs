---
url: "https://vercel.com/docs/private-registry"
...
This guide covers Vercel's private registry packages. For information on using your own private npm packages with Vercel, see our guide on [using private dependencies with Vercel](https://vercel.com/kb/guide/using-private-dependencies-with-vercel).

Access to `@vercel-private` packages is linked to access to products. If you
have trouble accessing a package, please check that you have access to the
corresponding Vercel product.

## [Setting up your local environment](https://vercel.com/docs/private-registry\#setting-up-your-local-environment)

1. ### [Set up your workspace](https://vercel.com/docs/private-registry\#set-up-your-workspace)
...
packages with the `@vercel-private` scope from the private registry. If you're using modern Yarn (v2 or newer) see the [Using modern versions of Yarn](https://vercel.com/docs/private-registry#setting-registry-server-using-modern-versions-of-yarn) section below.
...
2. ### [Setting registry server using modern versions of Yarn](https://vercel.com/docs/private-registry\#setting-registry-server-using-modern-versions-of-yarn)
...
3. ### [Log in to the private registry](https://vercel.com/docs/private-registry\#log-in-to-the-private-registry)
...
The minimum required version of npm to log into the registry is 8.14.0. For
...
4. #### [Setting token using modern versions of Yarn](https://vercel.com/docs/private-registry\#setting-token-using-modern-versions-of-yarn)
...
5. ### [Verify your setup](https://vercel.com/docs/private-registry\#verify-your-setup)
...
The Yarn command only works with Yarn version 2 or newer, use the npm command
if using Yarn v1.
...
6. ### [Optionally set up a pre-install message for missing credentials](https://vercel.com/docs/private-registry\#optionally-set-up-a-pre-install-message-for-missing-credentials)
...
## [Setting up Vercel](https://vercel.com/docs/private-registry\#setting-up-vercel)
...
value to the token you created above. We recommend using a [Sensitive Environmental Variable](https://vercel.com/docs/environment-variables/sensitive-environment-variables) for storing this token
...
If you already have an `NPM_RC` environment variable, you can append the above
to that existing value.

Vercel should now be able to install packages from the private registry when
building your Project.

## [Setting up your CI provider](https://vercel.com/docs/private-registry\#setting-up-your-ci-provider)
...
3. Finally, create a [workflow](https://docs.github.com/en/actions/using-workflows) for the product you're setting up. The example workflow below is for [Conformance](https://vercel.com/docs/conformance)
...
- [Setting up your local environment](https://vercel.com/docs/private-registry#setting-up-your-local-environment)
- [Set up your workspace](https://vercel.com/docs/private-registry#set-up-your-workspace)
- [Setting registry server using modern versions of Yarn](https://vercel.com/docs/private-registry#setting-registry-server-using-modern-versions-of-yarn)
- [Log in to the private registry](https://vercel.com/docs/private-registry#log-in-to-the-private-registry)
- [Setting token using modern versions of Yarn](https://vercel.com/docs/private-registry#setting-token-using-modern-versions-of-yarn)
- [Verify your setup](https://vercel.com/docs/private-registry#verify-your-setup)
- [Optionally set up a pre-install message for missing credentials](https://vercel.com/docs/private-registry#optionally-set-up-a-pre-install-message-for-missing-credentials)
- [Setting up Vercel](https://vercel.com/docs/private-registry#setting-up-vercel)
- [Setting up your CI provider](https://vercel.com/docs/private-registry#setting-up-your-ci-provider)
