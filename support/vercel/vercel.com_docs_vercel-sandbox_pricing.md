...
## [Resource limits](https://vercel.com/docs/vercel-sandbox/pricing\#resource-limits)
...
- You can run Node.js or Python runtimes. Review the [system specifications](https://vercel.com/docs/vercel-sandbox#system-specifications).
- Sandboxes can have up to 4 open ports.

## [Pricing](https://vercel.com/docs/vercel-sandbox/pricing\#pricing)
...
### [Included allotment](https://vercel.com/docs/vercel-sandbox/pricing\#included-allotment)
...
### [Maximum runtime duration](https://vercel.com/docs/vercel-sandbox/pricing\#maximum-runtime-duration)
...
### [Concurrent sandboxes limit](https://vercel.com/docs/vercel-sandbox/pricing\#concurrent-sandboxes-limit)

At any time, based on your plan, you can run up to a maximum number of sandboxes at the same time. You can [upgrade](https://vercel.com/docs/plans/hobby#upgrading-to-pro) if you're on Hobby. For Pro and Enterprise, this limit will only apply during the [Beta](https://vercel.com/docs/release-phases#beta) period.
...
Please [get in touch with our sales team](https://vercel.com/contact/sales) if you need more concurrent sandboxes.

### [Sandboxes creation rate limit](https://vercel.com/docs/vercel-sandbox/pricing\#sandboxes-creation-rate-limit)

The number of vCPUs you can allocate to active sandboxes depends on your plan. If you need more, you can [upgrade](https://vercel.com/docs/plans/hobby#upgrading-to-pro).
...
Please [get in touch with our sales team](https://vercel.com/contact/sales) if you need a higher rate of sandboxes vCPUs allocations.
