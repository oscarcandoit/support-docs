...
want to [deploy](https://vercel.com/docs/cli/deploy) your directory to. You can choose to either [link](https://vercel.com/docs/cli/link) an existing Vercel Project or to create a new one.
...
both the organization and `id` of your Vercel Project. If you want [unlink](https://vercel.com/docs/cli/link) your directory, you can remove the `.vercel` directory.
...
When you create a new Vercel Project, Vercel CLI will [link](https://vercel.com/docs/cli/link) the Vercel Project and automatically detect the framework you are using and offer
