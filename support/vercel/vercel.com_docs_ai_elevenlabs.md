...
## [Use cases](https://vercel.com/docs/ai/elevenlabs\#use-cases)
...
### [Available models](https://vercel.com/docs/ai/elevenlabs\#available-models)
...
## [Getting started](https://vercel.com/docs/ai/elevenlabs\#getting-started)

The Vercel ElevenLabs integration can be accessed through the AI tab on your [Vercel dashboard](https://vercel.com/dashboard).

### [Prerequisites](https://vercel.com/docs/ai/elevenlabs\#prerequisites)
...
### [Add the provider to your project](https://vercel.com/docs/ai/elevenlabs\#add-the-provider-to-your-project)

#### [Using the dashboard](https://vercel.com/docs/ai/elevenlabs\#using-the-dashboard)

01. Navigate to the AI tab in your [Vercel dashboard](https://vercel.com/dashboard)
02. Select ElevenLabs from the list of providers, and press Add
...
10. Connect your project using the code below:
    ...
    2import { ElevenLabsClient, play } from '@elevenlabs/elevenlabs-js';
    ...
    5  apiKey: 'YOUR_API_KEY', // Defaults to process.env.ELEVENLABS_API_KEY
    ...
    8const audio = await elevenlabs.textToSpeech.convert('JBFqnCBsd6RMkjVDRZzb', {
...
## [More resources](https://vercel.com/docs/ai/elevenlabs\#more-resources)
