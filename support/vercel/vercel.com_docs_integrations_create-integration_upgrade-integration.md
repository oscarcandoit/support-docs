---
url: "https://vercel.com/docs/integrations/create-integration/upgrade-integration"
...
## [Upgrading your Integration](https://vercel.com/docs/integrations/create-integration/upgrade-integration\#upgrading-your-integration)

If your Integration is using outdated features on the Vercel Platform, [follow these guidelines](https://vercel.com/docs/integrations/create-integration/upgrade-integration#upgrading-your-integration) to upgrade your Integration and use the latest features.

Once ready, make sure to [submit your Integration](https://vercel.com/docs/integrations/create-integration/submit-integration) for review after you upgraded it.

## [Use generic Webhooks](https://vercel.com/docs/integrations/create-integration/upgrade-integration\#use-generic-webhooks)
...
## [Use External Flow](https://vercel.com/docs/integrations/create-integration/upgrade-integration\#use-external-flow)

If your Integration is using the OAuth2 installation flow, you should use the [External installation flow](https://vercel.com/docs/integrations/create-integration/submit-integration#external-installation-flow) instead. By using the External flow, users will be able to choose which Vercel scope (Personal Account or Team) to install your Integration to.

Show More

## [Use your own UI](https://vercel.com/docs/integrations/create-integration/upgrade-integration\#use-your-own-ui)
...
## [Legacy Integrations](https://vercel.com/docs/integrations/create-integration/upgrade-integration\#legacy-integrations)
...
## [`currentProjectId` in Deploy Button](https://vercel.com/docs/integrations/create-integration/upgrade-integration\#currentprojectid-in-deploy-button)

If your Integration is not using `currentProjectId` to determine the target project for the Deploy Button flow, please use it. [Here’s the documentation](https://vercel.com/docs/deploy-button).

## [Single installation per scope](https://vercel.com/docs/integrations/create-integration/upgrade-integration\#single-installation-per-scope)
...
- [Marketplace flow](https://vercel.com/docs/integrations/create-integration/marketplace-product)
- [External flow](https://vercel.com/docs/integrations/create-integration/submit-integration#external-installation-flow)
- [Deploy Button flow](https://vercel.com/docs/deploy-button)

## [Latest API for Environment Variables](https://vercel.com/docs/integrations/create-integration/upgrade-integration\#latest-api-for-environment-variables)

If your Integration is setting Environment Variables, please make sure to use `type=encrypted` with the latest version (v7) of the API when [creating Environment Variables for a Project](https://vercel.com/docs/rest-api/reference/endpoints/projects/create-one-or-more-environment-variables).

Creating project secrets is not required anymore and will be deprecated in the
near future.
...
- [Upgrading your Integration](https://vercel.com/docs/integrations/create-integration/upgrade-integration#upgrading-your-integration)
- [Use generic Webhooks](https://vercel.com/docs/integrations/create-integration/upgrade-integration#use-generic-webhooks)
- [Using Webhooks APIs but not a Delete Hook](https://vercel.com/docs/integrations/create-integration/upgrade-integration#using-webhooks-apis-but-not-a-delete-hook)
- [Using a Delete Hook but not Webhooks APIs](https://vercel.com/docs/integrations/create-integration/upgrade-integration#using-a-delete-hook-but-not-webhooks-apis)
- [Using both Webhook APIs and a Delete Hook](https://vercel.com/docs/integrations/create-integration/upgrade-integration#using-both-webhook-apis-and-a-delete-hook)
- [Use External Flow](https://vercel.com/docs/integrations/create-integration/upgrade-integration#use-external-flow)
- [Use your own UI](https://vercel.com/docs/integrations/create-integration/upgrade-integration#use-your-own-ui)
- [Remove UI Hooks code](https://vercel.com/docs/integrations/create-integration/upgrade-integration#remove-ui-hooks-code)
- [Build your own UI](https://vercel.com/docs/integrations/create-integration/upgrade-integration#build-your-own-ui)
- [Legacy Integrations](https://vercel.com/docs/integrations/create-integration/upgrade-integration#legacy-integrations)
- [currentProjectId in Deploy Button](https://vercel.com/docs/integrations/create-integration/upgrade-integration#currentprojectid-in-deploy-button)
- [Single installation per scope](https://vercel.com/docs/integrations/create-integration/upgrade-integration#single-installation-per-scope)
- [Latest API for Environment Variables](https://vercel.com/docs/integrations/create-integration/upgrade-integration#latest-api-for-environment-variables)
