...
## [Use cases](https://vercel.com/docs/ai/xai\#use-cases)
...
### [Available models](https://vercel.com/docs/ai/xai\#available-models)
...
## [Getting started](https://vercel.com/docs/ai/xai\#getting-started)

The Vercel xAI integration can be accessed through the AI tab on your [Vercel dashboard](https://vercel.com/dashboard).

### [Prerequisites](https://vercel.com/docs/ai/xai\#prerequisites)
...
### [Add the provider to your project](https://vercel.com/docs/ai/xai\#add-the-provider-to-your-project)

#### [Using the dashboard](https://vercel.com/docs/ai/xai\#using-the-dashboard)

01. Navigate to the AI tab in your [Vercel dashboard](https://vercel.com/dashboard)
02. Select xAI from the list of providers, and press Add
...
#### [Using the CLI](https://vercel.com/docs/ai/xai\#using-the-cli)
...
## [More resources](https://vercel.com/docs/ai/xai\#more-resources)
