...
## [Configure your AWS account](https://vercel.com/docs/oidc/aws\#configure-your-aws-account)

1. ### [Create an OIDC identity provider](https://vercel.com/docs/oidc/aws\#create-an-oidc-identity-provider)
...
3. ### [Define the role ARN as environment variable](https://vercel.com/docs/oidc/aws\#define-the-role-arn-as-environment-variable)



Once you have created the role, copy the [role's ARN](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html#identifiers-arns) and [declare it as an environment variable](https://vercel.com/docs/environment-variables#creating-environment-variables) in your Vercel project with key name `AWS_ROLE_ARN`.
...
## [Examples](https://vercel.com/docs/oidc/aws\#examples)
...
### [List objects in an AWS S3 bucket](https://vercel.com/docs/oidc/aws\#list-objects-in-an-aws-s3-bucket)
...
### [Query an AWS RDS instance](https://vercel.com/docs/oidc/aws\#query-an-aws-rds-instance)
...
- [Configure your AWS account](https://vercel.com/docs/oidc/aws#configure-your-aws-account)
- [Create an OIDC identity provider](https://vercel.com/docs/oidc/aws#create-an-oidc-identity-provider)
- [Create an IAM role](https://vercel.com/docs/oidc/aws#create-an-iam-role)
- [Define the role ARN as environment variable](https://vercel.com/docs/oidc/aws#define-the-role-arn-as-environment-variable)
- [Examples](https://vercel.com/docs/oidc/aws#examples)
- [List objects in an AWS S3 bucket](https://vercel.com/docs/oidc/aws#list-objects-in-an-aws-s3-bucket)
- [Query an AWS RDS instance](https://vercel.com/docs/oidc/aws#query-an-aws-rds-instance)
