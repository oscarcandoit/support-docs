...
A session trace is initiated through the Vercel toolbar, either through a [Page Trace](https://vercel.com/docs/tracing/session-tracing#run-a-page-trace) or a [Session Trace](https://vercel.com/docs/tracing/session-tracing#run-a-session-trace). It is active for the person who initiated the trace on their browser indefinitely, until it is stopped or cookies are cleared.

## [Prerequisites](https://vercel.com/docs/tracing/session-tracing\#prerequisites)
...
- [The toolbar enabled](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost) in your preview or production environment.

## [Run a session trace](https://vercel.com/docs/tracing/session-tracing\#run-a-session-trace)
...
3. From the toolbar, you can then using the Tracing icon to select any of the following options:
   ...
   - View Page Trace: View the trace for the current page. Selecting this option will open the trace for the current page in a new tab. This is the same as [running a page trace](https://vercel.com/docs/tracing/session-tracing#run-a-page-trace).
...
## [View previous session traces](https://vercel.com/docs/tracing/session-tracing\#view-previous-session-traces)
...
You can filter traces using [all the same filters available](https://vercel.com/docs/runtime-logs#log-filters) in the Logs tab of the dashboard. To view traces for requests to your browser, press the user icon next to the Traces icon.
...
## [Usage and pricing](https://vercel.com/docs/tracing/session-tracing\#usage-and-pricing)
...
## [Limitations](https://vercel.com/docs/tracing/session-tracing\#limitations)

Custom spans from functions using the [Edge runtime](https://vercel.com/docs/functions/runtimes/edge) are not supported.

## [More resources](https://vercel.com/docs/tracing/session-tracing\#more-resources)

- [Learn about the Vercel toolbar](https://vercel.com/docs/vercel-toolbar)
- [Explore Observability on Vercel](https://vercel.com/docs/observability)
