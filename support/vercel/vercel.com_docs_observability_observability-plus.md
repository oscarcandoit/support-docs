...
## [Using Observability Plus](https://vercel.com/docs/observability/observability-plus\#using-observability-plus)

### [Enabling Observability Plus](https://vercel.com/docs/observability/observability-plus\#enabling-observability-plus)
...
1. From your [dashboard](https://vercel.com/dashboard), navigate to [the Observability tab](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fobservability&title=Try+Observability).
...
You'll be charged and upgraded immediately. You will immediately have access to the Observability Plus features and can view [events](https://vercel.com/docs/observability#tracked-events) based on data that was collected before you enabled it.

### [Disabling Observability Plus](https://vercel.com/docs/observability/observability-plus\#disabling-observability-plus)

1. From your [dashboard](https://vercel.com/dashboard), navigate to [the Observability tab](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fobservability).
...
## [Pricing](https://vercel.com/docs/observability/observability-plus\#pricing)
...
| --- | --- | --- |
| Observability Plus <br>**(Add-on for Pro and Enterprise)** | Pro: $10/month <br> Enterprise: none | $1.20 per 1 million [events](https://vercel.com/docs/observability#tracked-events) |

## [Limitations](https://vercel.com/docs/observability/observability-plus\#limitations)

| Feature | Observability | Observability Plus |
| --- | --- | --- |
| Data Retention | Hobby: 12 hours <br> Pro: 1 day <br> Enterprise: 3 days | 30 days |
| Monitoring access | Not Included | Included for existing Monitoring users. <br>See [Existing monitoring users](https://vercel.com/docs/observability#existing-monitoring-users) for more information |
...
## [Prorating](https://vercel.com/docs/observability/observability-plus\#prorating)
