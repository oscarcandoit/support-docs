...
Web Analytics integrationis availablein [Beta](https://vercel.com/docs/release-phases#beta)on [all plans](https://vercel.com/docs/plans)
...
## [Client-side tracking](https://vercel.com/docs/feature-flags/integrate-with-web-analytics\#client-side-tracking)
...
1. ### [Emit feature flags and connect them to Vercel Web Analytics](https://vercel.com/docs/feature-flags/integrate-with-web-analytics\#emit-feature-flags-and-connect-them-to-vercel-web-analytics)



To share your feature flags with Web Analytics you have to emit your feature flag values to the DOM as described in [Supporting Feature Flags](https://vercel.com/docs/feature-flags/flags-explorer/reference#values).

This will automatically annotate all page views and client-side events with your feature flags.

2. ### [Tracking feature flags in client-side events](https://vercel.com/docs/feature-flags/integrate-with-web-analytics\#tracking-feature-flags-in-client-side-events)
...
## [Server-side tracking](https://vercel.com/docs/feature-flags/integrate-with-web-analytics\#server-side-tracking)
...
Pattern](https://vercel.com/docs/feature-flags/feature-flags-pattern) you don't need to call
...
- [Client-side tracking](https://vercel.com/docs/feature-flags/integrate-with-web-analytics#client-side-tracking)
- [Emit feature flags and connect them to Vercel Web Analytics](https://vercel.com/docs/feature-flags/integrate-with-web-analytics#emit-feature-flags-and-connect-them-to-vercel-web-analytics)
- [Tracking feature flags in client-side events](https://vercel.com/docs/feature-flags/integrate-with-web-analytics#tracking-feature-flags-in-client-side-events)
- [Server-side tracking](https://vercel.com/docs/feature-flags/integrate-with-web-analytics#server-side-tracking)
