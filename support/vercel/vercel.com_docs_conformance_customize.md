---
url: "https://vercel.com/docs/conformance/customize"
...
Both `conformance.config.jsonc` and `conformance.config.json` are supported,
...
field is an object literal where the keys are the name of the [rule](https://vercel.com/docs/conformance/rules) and the
values are booleans or another object literal containing a [rule-specific\\
configuration](https://vercel.com/docs/conformance/customize#configuring-a-conformance-rule).
