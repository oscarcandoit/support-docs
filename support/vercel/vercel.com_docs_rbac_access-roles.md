...
- [Team level roles](https://vercel.com/docs/rbac/access-roles#team-level-roles): Users who have access to all projects within a team
  - [Owner](https://vercel.com/docs/rbac/access-roles#owner-role)
  - [Member](https://vercel.com/docs/rbac/access-roles#member-role)
  - [Developer](https://vercel.com/docs/rbac/access-roles#developer-role)
  - [Security](https://vercel.com/docs/rbac/access-roles#security-role)
  - [Billing](https://vercel.com/docs/rbac/access-roles#billing-role)
  - [Pro Viewer](https://vercel.com/docs/rbac/access-roles#pro-viewer-role)
  - [Enterprise Viewer](https://vercel.com/docs/rbac/access-roles#enterprise-viewer-role)
  - [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role)
- [Project level roles](https://vercel.com/docs/rbac/access-roles#project-level-roles): Users who have restricted access at the project level. Only contributors can have configurable project roles
  - [Project Administrator](https://vercel.com/docs/rbac/access-roles#project-administrators)
  - [Project Developer](https://vercel.com/docs/rbac/access-roles#project-developer)
  - [Project Viewer](https://vercel.com/docs/rbac/access-roles#project-viewer)

## [Team level roles](https://vercel.com/docs/rbac/access-roles\#team-level-roles)

Team level rolesare availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
| Role | Description |
| --- | --- |
| [Owner](https://vercel.com/docs/rbac/access-roles#owner-role) | Have the highest level of control. They can manage, modify, and oversee the team's settings, all projects, team members and roles. |
| [Member](https://vercel.com/docs/rbac/access-roles#member-role) | Have full control over projects and most team settings, but cannot invite or manage users by default. |
| [Developer](https://vercel.com/docs/rbac/access-roles#developer-role) | Can deploy to projects and manage environment settings but lacks the comprehensive team oversight that an owner or member possesses. |
| [Security](https://vercel.com/docs/rbac/access-roles#security-role) | Can manage security features, IP blocking, firewall. Cannot create deployments by default. |
| [Billing](https://vercel.com/docs/rbac/access-roles#billing-role) | Primarily responsible for the team's financial management and oversight. The billing role also gets read-only access to every project. |
| [Pro Viewer](https://vercel.com/docs/rbac/access-roles#pro-viewer-role) | Has limited read-only access to projects and deployments, ideal for stakeholder collaboration |
| [Enterprise Viewer](https://vercel.com/docs/rbac/access-roles#enterprise-viewer-role) | Has read-only access to the team's resources and projects. |
| [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role) | A unique role that can be configured to have any of the project level roles or none. If a contributor has no assigned project role, they won't be able to access that specific project. Only contributors can have configurable project roles. |
...
### [Owner role](https://vercel.com/docs/rbac/access-roles\#owner-role)

The owner roleis availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans

| About | Details |
| --- | --- |
| Description | The owner role is the highest level of authority within a team, possessing comprehensive access and control over all team and [project settings](https://vercel.com/docs/projects/overview#project-settings). |
| Key Responsibilities | \- Oversee and manage all team resources and projects <br> \- Modify team settings, including [billing](https://vercel.com/docs/rbac/access-roles#billing-role) and [member](https://vercel.com/docs/rbac/access-roles#member-role) roles <br> \- Grant or revoke access to team projects and determine project-specific roles for members <br> \- Access and modify all projects, including their settings and deployments |
| Access and Permissions | Owners have unrestricted access to all team functionalities, can modify all settings, and change other members' roles. <br> Team owners inherently act as [project administrators](https://vercel.com/docs/rbac/access-roles#project-administrators) for every project within the team, ensuring that they can manage individual projects' settings and deployments. |
...
### [Member role](https://vercel.com/docs/rbac/access-roles\#member-role)

The member roleis availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans

Members play a pivotal role in team operations and project management.

Key responsibilities

- Create [deployments](https://vercel.com/docs/deployments) and manage projects
- Set up [integrations](https://vercel.com/docs/integrations) and manage project-specific [domains](https://vercel.com/docs/domains)
- Handle [deploy hooks](https://vercel.com/docs/deploy-hooks) and adjust [Vercel Function](https://vercel.com/docs/functions) settings
- Administer security settings for their assigned projects

Access and permissions

Certain team-level settings remain exclusive to owners. Members cannot edit critical team settings like billing information or [invite new users to the team](https://vercel.com/docs/rbac/managing-team-members), this keeps a clear boundary between the responsibilities of members and owners.

| About | Details |
| --- | --- |
| Description | Members play a pivotal role in team operations and project management. |
| Key Responsibilities | \- Create [deployments](https://vercel.com/docs/deployments) and manage projects <br> \- Set up [integrations](https://vercel.com/docs/integrations) and manage project-specific [domains](https://vercel.com/docs/domains)<br> \- Handle [deploy hooks](https://vercel.com/docs/deploy-hooks) and adjust [Serverless Function](https://vercel.com/docs/functions/serverless-functions) settings <br> \- Administer security settings for their assigned projects |
| Access and Permissions | Certain team-level settings remain exclusive to owners. Members cannot edit critical team settings like billing information or [invite new users to the team](https://vercel.com/docs/rbac/managing-team-members), keeping a clear boundary between the responsibilities of members and owners. |

To assign the member role to a team member, refer to our [Adding team members and assigning roles](https://vercel.com/docs/rbac/managing-team-members#adding-team-members-and-assigning-roles) documentation.

See the [Team Level Roles Reference](https://vercel.com/docs/rbac/access-roles/team-level-roles) for a complete list of roles and their permissions.

### [Developer role](https://vercel.com/docs/rbac/access-roles\#developer-role)

The developer roleis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
| Key Responsibilities | \- Create [deployments](https://vercel.com/docs/deployments) and manage projects <br> \- Control [environment variables](https://vercel.com/docs/environment-variables), particularly for preview and development environments <br> \- Manage project [domains](https://vercel.com/docs/domains)<br> \- Create a [production build](https://vercel.com/docs/deployments/environments#production) by committing to the `main` branch of a project. Developers can also create preview branches and [preview deployments](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) by committing to any branch other than `main` |
| Access and Permissions | While developers have significant access to project functionalities, they are restricted from altering production environment variables and team-specific settings. They cannot invite new team members. <br> Only contributors can be assigned [project level roles](https://vercel.com/docs/rbac/access-roles#project-level-roles); developers cannot. <br> Developers can deploy to production by merging to the production branch in Git-based workflows. |
...
- Create [deployments](https://vercel.com/docs/deployments) and manage projects
- Control [environment variables](https://vercel.com/docs/environment-variables), particularly for preview and development environments
- Manage project [domains](https://vercel.com/docs/domains)
- Create a [production build](https://vercel.com/docs/deployments/environments#production-environment) by committing to the `main` branch of a project. Note that developers can create preview branches and [preview deployments](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) by committing to any branch other than `main`

Access and permissions

While Developers have significant access to project functionalities, they are restricted from altering production environment variables and team-specific settings. They are also unable to invite new team members. Note that the capability to become a project administrator is reserved for the contributor role. Those with the developer role cannot be assigned [project level roles](https://vercel.com/docs/rbac/access-roles#project-level-roles).

Developers can deploy to production through merging to the production branch for Git projects.

Additional information

To assign the developer role to a team member, refer to our [Adding team members and assigning roles](https://vercel.com/docs/rbac/managing-team-members#adding-team-members-and-assigning-roles) documentation.

See the [Team Level Roles Reference](https://vercel.com/docs/rbac/access-roles/team-level-roles) for a complete list of roles and their permissions.

### [Contributor role](https://vercel.com/docs/rbac/access-roles\#contributor-role)

The contributor roleis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
- Initiate [deployments](https://vercel.com/docs/deployments) \- _Depending on their assigned [project role](https://vercel.com/docs/rbac/access-roles#project-level-roles)_
- Manage [domains](https://vercel.com/docs/domains) and set up [integrations](https://vercel.com/docs/integrations) for projects if they have the [project administrator](https://vercel.com/docs/rbac/access-roles#project-administrators) role assigned
- Adjust [Vercel functions](https://vercel.com/docs/functions) and oversee [deploy hooks](https://vercel.com/docs/deploy-hooks)

Access and permissions

Contributors can be assigned to specific projects and have the same permissions as [project administrators](https://vercel.com/docs/rbac/access-roles#project-administrators), [project developers](https://vercel.com/docs/rbac/access-roles#project-developer), or [project viewers](https://vercel.com/docs/rbac/access-roles#project-viewer). They can also be assigned no project role, which means they won't be able to access that specific project.

| About | Details |
| --- | --- |
| Description | Contributors offer flexibility in access control at the project level. To limit team members' access at the project level, they must first be assigned the contributor role. Only after being assigned the contributor role can they receive project-level roles. <br> \- Contributors have no access to projects unless explicitly assigned. <br> \- Contributors may have project-specific role assignments, with the potential for comprehensive control over assigned projects only. |
| Key Responsibilities | \- Typically assigned to specific projects based on expertise and needs <br> \- Initiate [deployments](https://vercel.com/docs/deployments) — _Depending on their assigned [project role](https://vercel.com/docs/rbac/access-roles#project-level-roles)_<br> \- Manage [domains](https://vercel.com/docs/domains) and set up [integrations](https://vercel.com/docs/integrations) for projects if they have the [project administrator](https://vercel.com/docs/rbac/access-roles#project-administrators) role assigned <br> \- Adjust [Serverless Functions](https://vercel.com/docs/functions/serverless-functions) and oversee [deploy hooks](https://vercel.com/docs/deploy-hooks) |
| Access and Permissions | Contributors can be assigned to specific projects and have the same permissions as [project administrators](https://vercel.com/docs/rbac/access-roles#project-administrators), [project developers](https://vercel.com/docs/rbac/access-roles#project-developer), or [project viewers](https://vercel.com/docs/rbac/access-roles#project-viewer). <br> They can also be assigned no project role, which means they won't be able to access that specific project. <br> See the [Project level roles](https://vercel.com/docs/rbac/access-roles#project-level-roles) section for more information on project roles. |

To assign the contributor role to a team member, refer to our [Adding team members and assigning roles](https://vercel.com/docs/rbac/managing-team-members#adding-team-members-and-assigning-roles) documentation.

See the [Team Level Roles Reference](https://vercel.com/docs/rbac/access-roles/team-level-roles) for a complete list of roles and their permissions.

### [Security role](https://vercel.com/docs/rbac/access-roles\#security-role)

The security roleis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)

| About | Details |
| --- | --- |
| Description | Inspect and manage Vercel security features. |
| Key Responsibilities | \- Manage Firewall <br> \- Rate Limiting <br> \- Deployment Protection |
| Access and Permissions | The security role is designed to provide focused access to security features and settings. <br> This role also has read-only access to all projects within the team. |

This role does not offer deployment permissions by default.

See the [Team Level Roles Reference](https://vercel.com/docs/rbac/access-roles/team-level-roles) for a complete list of roles and their permissions.

### [Billing role](https://vercel.com/docs/rbac/access-roles\#billing-role)

The billing roleis availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
| Key Responsibilities | \- Oversee and manage the team's billing information <br> \- Review and manage team and project costs <br> \- Handle the team's payment methods |
| Access and Permissions | The billing role is designed to provide financial oversight and management, with access to the team's billing information and payment methods. <br> This role also has read-only access to all projects within the team. |

The billing role can be assigned at no extra cost. For [Pro teams](https://vercel.com/docs/plans/pro), it's limited to one member while for [Enterprise teams](https://vercel.com/docs/plans/enterprise), it can be assigned to multiple members.

To assign the billing role to a team member, refer to our [Adding team members and assigning roles](https://vercel.com/docs/rbac/managing-team-members#adding-team-members-and-assigning-roles) documentation.

Compatible permission group:`UsageViewer`.

See the [Team Level Roles Reference](https://vercel.com/docs/rbac/access-roles/team-level-roles) for a complete list of roles and their permissions.

### [Pro Viewer role](https://vercel.com/docs/rbac/access-roles\#pro-viewer-role)

The Pro Viewer roleis availableon [Pro plans](https://vercel.com/docs/plans/pro)
...
- Monitor and inspect all team [projects](https://vercel.com/docs/projects/overview) and deployments
- Collaborate on [preview deployments](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) with commenting and feedback capabilities
...
To assign the Pro Viewer role to a team member, refer to the [adding team members and assigning roles](https://vercel.com/docs/rbac/managing-team-members#adding-team-members-and-assigning-roles) documentation.

See the [Team Level Roles Reference](https://vercel.com/docs/rbac/access-roles/team-level-roles) for a complete list of roles and their permissions.

### [Enterprise Viewer role](https://vercel.com/docs/rbac/access-roles\#enterprise-viewer-role)

The viewer roleis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)

| About | Details |
| --- | --- |
| Description | An observational role, viewers are informed on team activities without direct intervention. |
| Key Responsibilities | \- Monitor and inspect all team [projects](https://vercel.com/docs/projects/overview)<br> \- Review shared team resources <br> \- Observe team settings and configurations |
| Access and Permissions | Viewers have broad viewing privileges but are restricted from making changes. |

The Enterprise Viewer roleis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
To assign the Enterprise Viewer role to a team member, refer to the [adding team members and assigning roles](https://vercel.com/docs/rbac/managing-team-members#adding-team-members-and-assigning-roles) documentation.
...
Project level rolesare availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
| Role | Description |
| --- | --- |
| [Project Administrator](https://vercel.com/docs/rbac/access-roles#project-administrators) | Team owners and members inherently act as project administrators for every project. Project administrators can create production deployments, manage all [project settings](https://vercel.com/docs/projects/overview#project-settings), and manage production [environment variables](https://vercel.com/docs/environment-variables). |
| [Project Developer](https://vercel.com/docs/rbac/access-roles#project-developer) | Can deploy to the project and manage its environment settings. Team developers inherently act as project developers. |
| [Project Viewer](https://vercel.com/docs/rbac/access-roles#project-viewer) | Has read-only access to a specific project. Both team billing and viewer members automatically act as project viewers for every project. |

See the [Project Level Roles Reference](https://vercel.com/docs/rbac/access-roles/project-level-roles) for a complete list of roles and their permissions.

### [Project administrators](https://vercel.com/docs/rbac/access-roles\#project-administrators)

The project administrator roleis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)

| About | Details |
| --- | --- |
| Description | Project administrators hold significant authority at the project level, operating as the project-level counterparts to team [members](https://vercel.com/docs/rbac/access-roles#owner-role) and [owners](https://vercel.com/docs/rbac/access-roles#owner-role). |
| Key Responsibilities | \- Govern [project settings](https://vercel.com/docs/projects/overview#project-settings)<br> \- Deploy to all [environments](https://vercel.com/docs/deployments/environments)<br> \- Manage all [environment variables](https://vercel.com/docs/environment-variables) and oversee [domains](https://vercel.com/docs/domains) |
| Access and Permissions | Their authority doesn't extend across all [projects](https://vercel.com/docs/projects/overview) within the team. Project administrators are restricted to the projects they're assigned to. |

To assign the project administrator role to a team member, refer to our [Assigning project roles](https://vercel.com/docs/rbac/managing-team-members#assigning-project-roles) documentation.

See the [Project Level Roles Reference](https://vercel.com/docs/rbac/access-roles/project-level-roles) for a complete list of roles and their permissions.

### [Project developer](https://vercel.com/docs/rbac/access-roles\#project-developer)

The project developer roleis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)

| About | Details |
| --- | --- |
| Description | Project developers play a key role in working on projects, mirroring the functions of [team developers](https://vercel.com/docs/rbac/access-roles#developer-role), but with a narrowed project focus. |
| Key Responsibilities | \- Initiate [deployments](https://vercel.com/docs/deployments)<br> \- Manage [environment variables](https://vercel.com/docs/environment-variables) for development and [preview environments](https://vercel.com/docs/deployments/environments#preview-environment-pre-production)<br> \- Handle project [domains](https://vercel.com/docs/domains) |
...
To assign the project developer role to a team member, refer to our [Assigning project roles](https://vercel.com/docs/rbac/managing-team-members#assigning-project-roles) documentation.

See the [Project Level Roles Reference](https://vercel.com/docs/rbac/access-roles/project-level-roles) for a complete list of roles and their permissions.

### [Project viewer](https://vercel.com/docs/rbac/access-roles\#project-viewer)

The project viewer roleis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
| Key Responsibilities | \- View and inspect all [deployments](https://vercel.com/docs/deployments)<br> \- Review [project settings](https://vercel.com/docs/projects/overview#project-settings)<br> \- Examine [environment variables](https://vercel.com/docs/environment-variables) across all environments and view project [domains](https://vercel.com/docs/domains) |
| Access and Permissions | They have a broad view but can't actively make changes. |

To assign the project viewer role to a team member, refer to our [Assigning project roles](https://vercel.com/docs/rbac/managing-team-members#assigning-project-roles) documentation.

See the [Project Level Roles Reference](https://vercel.com/docs/rbac/access-roles/project-level-roles) for a complete list of roles and their permissions.

## [Permission groups](https://vercel.com/docs/rbac/access-roles\#permission-groups)
...
See [project level roles](https://vercel.com/docs/rbac/access-roles/project-level-roles) and [team level roles](https://vercel.com/docs/rbac/access-roles/team-level-roles) for a complete list of roles, their permissions, and how they can be combined.
