---
url: "https://vercel.com/docs/oidc/api"
...
## [Validate the tokens](https://vercel.com/docs/oidc/api\#validate-the-tokens)
...
### [Use the `jose.jwtVerify` function](https://vercel.com/docs/oidc/api\#use-the-jose.jwtverify-function)
...
### [Use the `getVercelOidcToken` function](https://vercel.com/docs/oidc/api\#use-the-getverceloidctoken-function)
