...
Vercel Content Management System (CMS) Integrations allow you to connect your projects with CMS platforms, including [Contentful](https://vercel.com/docs/integrations/contentful), [Sanity](https://vercel.com/integrations/sanity), [Sitecore XM Cloud](https://vercel.com/docs/integrations/sitecore) and [more](https://vercel.com/docs/integrations/cms#featured-cms-integrations). These integrations provide a direct path to incorporating CMS into your applications, enabling you to build, deploy, and leverage CMS-powered features with minimal hassle.

You can use the following methods to integrate your CMS with Vercel:

- [Environment variable import](https://vercel.com/docs/integrations/cms#environment-variable-import): Quickly setup your Vercel project with environment variables from your CMS
- [Edit Mode through the Vercel Toolbar](https://vercel.com/docs/integrations/cms#edit-mode-with-the-vercel-toolbar): Visualize content from your CMS within a Vercel deployments and edit directly in your CMS
  - [Content Link](https://vercel.com/docs/edit-mode#content-link): Lets you visualize content models from your CMS within a Vercel deployments and edit directly in your CMS
- [Deploy changes from CMS](https://vercel.com/docs/integrations/cms#deploy-changes-from-cms): Connect and deploy content from your CMS to your Vercel site

## [Environment variable import](https://vercel.com/docs/integrations/cms\#environment-variable-import)
...
1. ### [Install the Vercel CLI](https://vercel.com/docs/integrations/cms\#install-the-vercel-cli)
...
2. ### [Install your CMS integration](https://vercel.com/docs/integrations/cms\#install-your-cms-integration)



Navigate to the CMS integration you want to install into your project, and follow the steps to install the integration.

3. ### [Pull in environment variables](https://vercel.com/docs/integrations/cms\#pull-in-environment-variables)
...
## [Edit mode with the Vercel Toolbar](https://vercel.com/docs/integrations/cms\#edit-mode-with-the-vercel-toolbar)

To access Edit Mode:

1. Ensure you're logged into the [Vercel Toolbar](https://vercel.com/docs/vercel-toolbar) with your Vercel account.
2. Navigate to a page with editable content. The Edit Mode option will only appear in the [Vercel Toolbar](https://vercel.com/docs/vercel-toolbar) menu when there are elements on the page matched to fields in the CMS.
3. Select the Edit Mode option in the toolbar menu. This will highlight the editable fields as [Content Links](https://vercel.com/docs/edit-mode#content-link), which turn blue as you hover near them.
...
See the [Edit Mode documentation](https://vercel.com/docs/edit-mode) for information on setup and configuration.

## [Draft mode through the Vercel Toolbar](https://vercel.com/docs/integrations/cms\#draft-mode-through-the-vercel-toolbar)
...
## [Deploy changes from CMS](https://vercel.com/docs/integrations/cms\#deploy-changes-from-cms)
...
## [Featured CMS integrations](https://vercel.com/docs/integrations/cms\#featured-cms-integrations)
...
- [Environment variable import](https://vercel.com/docs/integrations/cms#environment-variable-import)
- [Install the Vercel CLI](https://vercel.com/docs/integrations/cms#install-the-vercel-cli)
- [Install your CMS integration](https://vercel.com/docs/integrations/cms#install-your-cms-integration)
- [Pull in environment variables](https://vercel.com/docs/integrations/cms#pull-in-environment-variables)
- [Edit mode with the Vercel Toolbar](https://vercel.com/docs/integrations/cms#edit-mode-with-the-vercel-toolbar)
- [Draft mode through the Vercel Toolbar](https://vercel.com/docs/integrations/cms#draft-mode-through-the-vercel-toolbar)
- [Deploy changes from CMS](https://vercel.com/docs/integrations/cms#deploy-changes-from-cms)
- [Featured CMS integrations](https://vercel.com/docs/integrations/cms#featured-cms-integrations)
