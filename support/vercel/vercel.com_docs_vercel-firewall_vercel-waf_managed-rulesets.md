...
- [Bot protection managed ruleset](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets#configure-bot-protection-managed-ruleset)
- [AI Bots managed ruleset](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets#configure-ai-bots-managed-ruleset)

## [Access roles](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets\#access-roles)
...
## [Configure OWASP core ruleset](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets\#configure-owasp-core-ruleset)

OWASP core rulesetis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise). [Review pricing information here](https://vercel.com/docs/security/vercel-waf/usage-and-pricing#managed-ruleset-pricing).
...
## [Configure bot protection managed ruleset](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets\#configure-bot-protection-managed-ruleset)

Bot protection managed rulesetis availableon [all plans](https://vercel.com/docs/plans)

To enable and configure [bot protection](https://vercel.com/docs/bot-management#bot-protection-managed-ruleset) for your project, follow these steps:

1. From your [project's dashboard](https://vercel.com/docs/projects/project-dashboard), select the [Firewall](https://vercel.com/d?to=%2F%5Bteam%5D%2F%5Bproject%5D%2Ffirewall&title=Firewall+tab) tab.
2. Select the Rules tab.
...
## [Configure AI Bots managed ruleset](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets\#configure-ai-bots-managed-ruleset)

AI bots managed rulesetis availableon [all plans](https://vercel.com/docs/plans)
...
## [Bypassing rulesets](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets\#bypassing-rulesets)

Sometimes, you may need to allow specific requests that a managed ruleset is blocking. For example, [Bot Protection](https://vercel.com/docs/bot-management#bot-protection-managed-ruleset) could be blocking a custom user agent that you are using.
In this case, use the [bypass](https://vercel.com/docs/vercel-firewall/firewall-concepts#bypass) [action](https://vercel.com/docs/vercel-firewall/vercel-waf/rule-configuration#actions) in a [WAF Custom Rule](https://vercel.com/docs/vercel-firewall/vercel-waf/custom-rules) to target the traffic you want to allow.
...
### [Bypassing custom rules](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets\#bypassing-custom-rules)
...
### [Rules execution order](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets\#rules-execution-order)
