...
- The size of your deployment bundle for Vercel functions exceeds the limit. For Vercel functions, the [maximum uncompressed size is 250 MB](https://vercel.com/docs/functions/runtimes#bundle-size-limits)
...
## [Troubleshoot](https://vercel.com/docs/errors/INTERNAL_UNARCHIVE_FAILED\#troubleshoot)
...
- Check bundle size: Looking into your `includeFiles` and `excludeFiles` configuration to specify items affecting the function size. See [bundle size limits](https://vercel.com/docs/functions/runtimes#bundle-size-limits)
