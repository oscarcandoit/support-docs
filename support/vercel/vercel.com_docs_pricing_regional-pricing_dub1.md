---
url: "https://vercel.com/docs/pricing/regional-pricing/dub1"
...
The table below shows Managed Infrastructure products with pricing specific to the Dublin, Ireland (dub1) region. This pricing is available only to [Pro plan](https://vercel.com/docs/plans/pro) users. Your team will be charged based on the usage of your projects for each resource in this region.
...
| [Image Optimization Transformations](https://vercel.com/docs/image-optimization) | $0.0567 per 1K |
