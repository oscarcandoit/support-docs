---
url: "https://vercel.com/docs/plans/enterprise"
...
Vercel offers an Enterprise plan for organizations and enterprises that need high [performance](https://vercel.com/docs/plans/enterprise#performance-and-reliability), advanced [security](https://vercel.com/docs/plans/enterprise#security-and-compliance), and dedicated [support](https://vercel.com/docs/plans/enterprise#administration-and-support).
...
## [Performance and reliability](https://vercel.com/docs/plans/enterprise\#performance-and-reliability)
...
- Greater multi-region limits for [Vercel Functions](https://vercel.com/docs/functions/configuring-functions/region#project-configuration)
- Vercel functions memory [configurable](https://vercel.com/docs/functions/runtimes#size-limits) to 3009 MB
- Configurable [Vercel Function](https://vercel.com/docs/functions) up to a [maximum duration](https://vercel.com/docs/functions/runtimes#max-duration) of 900-seconds
- Unlimited [domains](https://vercel.com/docs/domains) per project
- [Custom SSL Certificates](https://vercel.com/docs/domains/custom-SSL-certificate)
- Automatic concurrency scaling up to 100,000 for [Vercel Functions](https://vercel.com/docs/functions/concurrency-scaling#automatic-concurrency-scaling)
- [Isolated\\
build infrastructure](https://vercel.com/docs/security#do-enterprise-accounts-run-on-a-different-infrastructure),
with the ability to have [larger memory and storage](https://vercel.com/docs/deployments/troubleshoot-a-build#build-container-resources)
- [Trusted Proxy](https://vercel.com/docs/headers/request-headers#x-forwarded-for)

## [Security and compliance](https://vercel.com/docs/plans/enterprise\#security-and-compliance)

Data and infrastructure security is paramount in the Enterprise plan with advanced features including:

- [SSO/SAML Login](https://vercel.com/docs/saml)
- [Compliance measures](https://vercel.com/docs/security)
- Access management for your deployments such as [Password Protection](https://vercel.com/docs/security/deployment-protection/methods-to-protect-deployments/password-protection),
[Private Production Deployments](https://vercel.com/docs/security/deployment-protection#configuring-deployment-protection),
and [Trusted IPs](https://vercel.com/docs/security/deployment-protection/methods-to-protect-deployments/trusted-ips)
- [Secure Compute](https://vercel.com/docs/secure-compute) (Paid add-on for Enterprise)
- [Directory Sync](https://vercel.com/docs/security/directory-sync)
- [SIEM Integration](https://vercel.com/docs/observability/audit-log#custom-siem-log-streaming) (Paid add-on for Enterprise)
- [Vercel Firewall](https://vercel.com/docs/vercel-firewall), including [dedicated DDoS support](https://vercel.com/docs/vercel-firewall/ddos-mitigation#dedicated-ddos-support-for-enterprise-teams), [WAF account-level IP Blocking](https://vercel.com/docs/security/vercel-waf/ip-blocking#account-level-ip-blocking) and [WAF Managed Rulesets](https://vercel.com/docs/security/vercel-waf/managed-rulesets)

## [Conformance and Code Owners](https://vercel.com/docs/plans/enterprise\#conformance-and-code-owners)

[Conformance](https://vercel.com/docs/conformance) is a suite of tools designed for static code analysis. Conformance ensures high standards in performance, security, and code health, which are integral for enterprise projects. Code Owners enables you to define users or teams that are responsible for directories and files in your codebase.

- [Allowlists](https://vercel.com/docs/conformance/allowlist)
- [Curated rules](https://vercel.com/docs/conformance/rules)
- [Custom rules](https://vercel.com/docs/conformance/custom-rules)
- [Code Owners](https://vercel.com/docs/code-owners) for GitHub

## [Observability and Reporting](https://vercel.com/docs/plans/enterprise\#observability-and-reporting)
...
- 3 days of [Runtime Logs](https://vercel.com/docs/runtime-logs) and increased row data
- Increased retention with [Vercel Monitoring](https://vercel.com/docs/observability/monitoring)
- [Tracing](https://vercel.com/docs/tracing) support
- Configurable [drains](https://vercel.com/docs/drains/using-drains)
...
## [Administration and Support](https://vercel.com/docs/plans/enterprise\#administration-and-support)

The Enterprise plan allows for streamlined team collaboration and offers robust support with:

- [Role-Based Access Control (RBAC)](https://vercel.com/docs/rbac/access-roles)
- [Access Groups](https://vercel.com/docs/rbac/access-groups)
