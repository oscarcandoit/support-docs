...
Vercel Agentis availablein [Beta](https://vercel.com/docs/release-phases#beta)on[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
## [Features](https://vercel.com/docs/agent\#features)

### [Code Review](https://vercel.com/docs/agent\#code-review)
...
Learn more in the [Code Review docs](https://vercel.com/docs/agent/pr-review).
...
## [Getting started](https://vercel.com/docs/agent\#getting-started)
...
- Code Review: You'll need to configure which repositories to review and whether to review draft PRs. See [Code Review setup](https://vercel.com/docs/agent/pr-review#how-to-set-up-code-review) for details.
- Agent Investigation: This requires [Observability Plus](https://vercel.com/docs/observability/observability-plus) and in order to run investigations automatically, you'll need to enable Vercel Agent Investigations. See [Investigation setup](https://vercel.com/docs/agent/investigation#how-to-enable-agent-investigation) to get started.
...
You can [purchase credits and enable auto-reload](https://vercel.com/docs/agent/pricing#adding-credits) in the Agent tab of your dashboard. For complete pricing details, credit management, and cost tracking information, see [Vercel Agent Pricing](https://vercel.com/docs/agent/pricing).

## [Privacy](https://vercel.com/docs/agent\#privacy)
...
[Previous\\
\\
Access / Two-factor (2FA)](https://vercel.com/docs/two-factor-authentication)
