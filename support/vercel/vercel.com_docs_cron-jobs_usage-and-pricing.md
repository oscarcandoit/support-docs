...
Cron jobs invoke [Vercel Functions](https://vercel.com/docs/functions). This means the same [usage](https://vercel.com/docs/limits) and [pricing](https://vercel.com/pricing) limits will apply.
...
### [Hobby scheduling limits](https://vercel.com/docs/cron-jobs/usage-and-pricing\#hobby-scheduling-limits)
...
For more specific cron job executions, upgrade to our [Pro](https://vercel.com/docs/plans/pro) plan.

## [Pricing](https://vercel.com/docs/cron-jobs/usage-and-pricing\#pricing)

Cron jobs are included in all plans.

You use a function to invoke a cron job, and therefore [usage](https://vercel.com/docs/limits) and [pricing](https://vercel.com/pricing) limits for these functions apply to all cron job executions:

- [Functions limits and pricing](https://vercel.com/docs/functions/usage-and-pricing)
