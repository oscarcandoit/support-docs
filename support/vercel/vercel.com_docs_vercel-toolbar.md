...
Vercel Toolbaris availableon [all plans](https://vercel.com/docs/plans)

The Vercel Toolbar is a tool that assists in the iteration and development process. Through the toolbar, you can:

- Leave feedback on deployments with [Comments](https://vercel.com/docs/comments)
- Navigate [through dashboard pages](https://vercel.com/docs/vercel-toolbar#using-the-toolbar-menu), and [share deployments](https://vercel.com/docs/vercel-toolbar#sharing-deployments)
- Read and set [Feature Flags](https://vercel.com/docs/feature-flags)
- Use [Draft Mode](https://vercel.com/docs/draft-mode) for previewing unpublished content
- Edit content in real-time using [Edit Mode](https://vercel.com/docs/edit-mode)
- Inspect for [Layout Shifts](https://vercel.com/docs/vercel-toolbar/layout-shift-tool) and [Interaction Timing](https://vercel.com/docs/vercel-toolbar/interaction-timing-tool)
- Check for accessibility issues with the [Accessibility Audit Tool](https://vercel.com/docs/vercel-toolbar/accessibility-audit-tool)

## [Activating the Toolbar](https://vercel.com/docs/vercel-toolbar\#activating-the-toolbar)
...
## [Enabling or Disabling the toolbar](https://vercel.com/docs/vercel-toolbar\#enabling-or-disabling-the-toolbar)

The Vercel Toolbar is enabled by default for all preview deployments. You can disable the toolbar at the [team](https://vercel.com/docs/vercel-toolbar/managing-toolbar#enable-or-disable-the-toolbar-team-wide), [project](https://vercel.com/docs/vercel-toolbar/managing-toolbar#enable-or-disable-the-toolbar-project-wide), or [session](https://vercel.com/docs/vercel-toolbar/managing-toolbar#disable-toolbar-for-session) level.

You can also manage its visibility for [automation](https://vercel.com/docs/vercel-toolbar/managing-toolbar#disable-toolbar-for-automation) with HTTP headers and through [environment variables](https://vercel.com/docs/vercel-toolbar/managing-toolbar#enable-or-disable-the-toolbar-for-a-specific-branch). To learn more, see [Managing the toolbar](https://vercel.com/docs/vercel-toolbar/managing-toolbar).

To enable the toolbar for your local or production environments, see [Adding the toolbar to your environment](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost).

## [Using the Toolbar Menu](https://vercel.com/docs/vercel-toolbar\#using-the-toolbar-menu)
...
| [Layout shifts](https://vercel.com/docs/vercel-toolbar/layout-shift-tool) | Open the Layout Shift Tool to identify elements causing layout shifts. |
| [Interaction timing](https://vercel.com/docs/vercel-toolbar/interaction-timing-tool) | Inspect in detail each interaction's latency and view your current session's INP. |
| [Accessibility audit tool](https://vercel.com/docs/vercel-toolbar/accessibility-audit-tool) | Automatically check the Web Content Accessibility Guidelines 2.0 level A and AA rules. |
...
| [Comments](https://vercel.com/docs/comments) | Access the Comments panel to leave or view feedback. |
| [View inbox](https://vercel.com/docs/comments/using-comments#comment-threads) | View all open comments. |
...
| [Hide Toolbar](https://vercel.com/docs/vercel-toolbar#enabling-or-disabling-the-toolbar) | Hide the toolbar. |
| [Disable for session](https://vercel.com/docs/vercel-toolbar#enabling-or-disabling-the-toolbar) | Disable the toolbar for the current session. |
| [Set preferences](https://vercel.com/docs/vercel-toolbar#toolbar-menu-preferences) | Set personal preferences for the toolbar. |
| Logout | Logout of the toolbar. |

## [Setting Custom Keyboard Shortcuts](https://vercel.com/docs/vercel-toolbar\#setting-custom-keyboard-shortcuts)
...
## [Sharing deployments](https://vercel.com/docs/vercel-toolbar\#sharing-deployments)

You can use the Share button in deployments with the Vercel Toolbar enabled, as well as in all preview deployments, to share your deployment's [generated URL](https://vercel.com/docs/deployments/generated-urls). When you use the Share button from the toolbar, the URL will contain any relevant query parameters.
...
3. From the Share dialog, ensure you're allowing the right permissions and click Copy Link to copy the deployment URL to your clipboard. To learn more, see [Sharing Deployments](https://vercel.com/docs/deployments/sharing-deployments).

If you're on an [Enterprise](https://vercel.com/docs/plans/enterprise) team, you will be able to see who shared deployment URLs in your [audit logs](https://vercel.com/docs/observability/audit-log).

## [Reposition toolbar](https://vercel.com/docs/vercel-toolbar\#reposition-toolbar)
...
## [Toolbar Menu preferences](https://vercel.com/docs/vercel-toolbar\#toolbar-menu-preferences)
...
| Setting | Description |
| --- | --- |
| [Notifications](https://vercel.com/docs/comments/managing-comments#notifications) | Set when you will receive notifications for comments in the deployment you're viewing |
| Theme | Select your color theme |
| Layout Shift Detection | Enable or disable the [Layout Shift Tool](https://vercel.com/docs/vercel-toolbar/layout-shift-tool) |
| [Keyboard Shortcuts](https://vercel.com/docs/vercel-toolbar#setting-custom-keyboard-shortcuts) | Set custom keyboard shortcuts for tools and change the default keyboard shortcuts |
| Accessibility Audit | Enable or disable the [Accessibility Audit Tool](https://vercel.com/docs/vercel-toolbar/accessibility-audit-tool) |
| Measure Interaction Timing | Enable or disable the [Interaction Timing Tool](https://vercel.com/docs/vercel-toolbar/interaction-timing-tool) |
| [Browser Extension](https://vercel.com/docs/vercel-toolbar/browser-extension) | Add Vercel's extension to your browser to take screenshots, enable the toolbar in production, and access Always Activate and Start Hidden preferences. |
...
| Start Hidden | Sets the toolbar to start hidden. Read more about [hiding and showing the toolbar](https://vercel.com/docs/vercel-toolbar/managing-toolbar#disable-toolbar-for-session). |

## [More resources](https://vercel.com/docs/vercel-toolbar\#more-resources)
