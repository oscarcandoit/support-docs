...
must be called with an OAuth2, or it will produce a`400` error.

### [Create a new check](https://vercel.com/docs/checks/checks-api\#using-the-checks-api/endpoints/create-a-new-check)
...
| Action | Endpoint |
| --- | --- |
| Read/Write | POST<br>[/v1/deployments/{deploymentId}/checks](https://vercel.com/docs/rest-api#endpoints/checks/creates-a-new-check) |

### [Update a check](https://vercel.com/docs/checks/checks-api\#using-the-checks-api/endpoints/update-a-check)
...
| Action | Endpoint |
| --- | --- |
| Read/Write | PATCH<br>[/v1/deployments/{deploymentId}/checks/{checkId}](https://vercel.com/docs/rest-api#endpoints/checks/update-a-check) |

### [Get all checks](https://vercel.com/docs/checks/checks-api\#using-the-checks-api/endpoints/get-all-checks)
...
| Action | Endpoint |
| --- | --- |
| Read | GET<br>[/v1/deployments/{deploymentId}/checks](https://vercel.com/docs/rest-api#endpoints/checks/retrieve-a-list-of-all-checks) |

### [Get one check](https://vercel.com/docs/checks/checks-api\#using-the-checks-api/endpoints/get-one-check)
...
| Action | Endpoint |
| --- | --- |
| Read | GET<br>[/v1/deployments/{deploymentId}/checks/{checkId}](https://vercel.com/docs/rest-api#endpoints/checks/get-a-single-check) |

### [Rerequest a failed check](https://vercel.com/docs/checks/checks-api\#using-the-checks-api/endpoints/rerequest-a-failed-check)

Allows integration to return a new outcome or rewrite an existing check result. This endpoint is used for check reruns.

| Action | Endpoint |
| --- | --- |
| Read/Write | POST<br>[/v1/deployments/{deploymentId}/checks/{checkId}/rerequest](https://vercel.com/docs/rest-api#endpoints/checks/rerequest-a-check) |
