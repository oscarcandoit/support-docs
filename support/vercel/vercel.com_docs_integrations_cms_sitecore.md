---
url: "https://vercel.com/docs/integrations/cms/sitecore"
...
## [Setting up an XM Cloud project, environment, and website](https://vercel.com/docs/integrations/cms/sitecore\#setting-up-an-xm-cloud-project-environment-and-website)

01. ### [Access XM Cloud Deploy app](https://vercel.com/docs/integrations/cms/sitecore\#access-xm-cloud-deploy-app)



    Log in to your XM Cloud Deploy app account.

02. ### [Initiate project creation](https://vercel.com/docs/integrations/cms/sitecore\#initiate-project-creation)
...
03. ### [Select project foundation](https://vercel.com/docs/integrations/cms/sitecore\#select-project-foundation)
...
04. ### [Select starter template](https://vercel.com/docs/integrations/cms/sitecore\#select-starter-template)
...
05. ### [Name your project](https://vercel.com/docs/integrations/cms/sitecore\#name-your-project)
...
06. ### [Select source control provider](https://vercel.com/docs/integrations/cms/sitecore\#select-source-control-provider)
...
07. ### [Set up source control connection](https://vercel.com/docs/integrations/cms/sitecore\#set-up-source-control-connection)
...
08. ### [Specify repository name](https://vercel.com/docs/integrations/cms/sitecore\#specify-repository-name)
...
09. ### [Configure environment details](https://vercel.com/docs/integrations/cms/sitecore\#configure-environment-details)
...
10. ### [Finalize setup](https://vercel.com/docs/integrations/cms/sitecore\#finalize-setup)
...
11. ### [Create a new website](https://vercel.com/docs/integrations/cms/sitecore\#create-a-new-website)
...
12. ### [Publish the site](https://vercel.com/docs/integrations/cms/sitecore\#publish-the-site)
...
## [Creating a Next.js JSS application](https://vercel.com/docs/integrations/cms/sitecore\#creating-a-next.js-jss-application)
...
[![Sitecore XM Cloud Next.js Starter](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2FJAWlcS27EakxvDFRjmLwD%2F412631142afd83d7b3a926cb7c3e44bd%2FCleanShot_2023-08-25_at_20.09.25_2x.png&w=3840&q=75)\\
\\
Sitecore XM Cloud Next.js Starter\\
\\
Simple Next.js blog site that connects to a Sitecore XM Cloud site using the Sitecore JavaScript Rendering SDK (JSS).](https://vercel.com/templates/next.js/sitecore-starter)
...
1. ### [Clone the repository](https://vercel.com/docs/integrations/cms/sitecore\#clone-the-repository)
...
2. ### [Retrieve your API key, GraphQL endpoint, and JSS app name](https://vercel.com/docs/integrations/cms/sitecore\#retrieve-your-api-key-graphql-endpoint-and-jss-app-name)
...
3. ### [Configure your Next.js JSS application](https://vercel.com/docs/integrations/cms/sitecore\#configure-your-next.js-jss-application)
...
4. ### [Start your application](https://vercel.com/docs/integrations/cms/sitecore\#start-your-application)
...
## [How it works](https://vercel.com/docs/integrations/cms/sitecore\#how-it-works)
...
Vercel Deployment Protection is enabled for new projects by
[default](https://vercel.com/changelog/deployment-protection-is-now-enabled-by-default-for-new-projects)
...
[documentation](https://vercel.com/docs/security/deployment-protection) and Sitecore XM Cloud
...
## [Deploying to Vercel](https://vercel.com/docs/integrations/cms/sitecore\#deploying-to-vercel)

1. ### [Push to Git](https://vercel.com/docs/integrations/cms/sitecore\#push-to-git)
...
2. ### [Import to Vercel](https://vercel.com/docs/integrations/cms/sitecore\#import-to-vercel)
...
3. ### [Configure environment variables](https://vercel.com/docs/integrations/cms/sitecore\#configure-environment-variables)
...
- [Setting up an XM Cloud project, environment, and website](https://vercel.com/docs/integrations/cms/sitecore#setting-up-an-xm-cloud-project-environment-and-website)
- [Access XM Cloud Deploy app](https://vercel.com/docs/integrations/cms/sitecore#access-xm-cloud-deploy-app)
- [Initiate project creation](https://vercel.com/docs/integrations/cms/sitecore#initiate-project-creation)
- [Select project foundation](https://vercel.com/docs/integrations/cms/sitecore#select-project-foundation)
- [Select starter template](https://vercel.com/docs/integrations/cms/sitecore#select-starter-template)
- [Name your project](https://vercel.com/docs/integrations/cms/sitecore#name-your-project)
- [Select source control provider](https://vercel.com/docs/integrations/cms/sitecore#select-source-control-provider)
- [Set up source control connection](https://vercel.com/docs/integrations/cms/sitecore#set-up-source-control-connection)
- [Specify repository name](https://vercel.com/docs/integrations/cms/sitecore#specify-repository-name)
- [Configure environment details](https://vercel.com/docs/integrations/cms/sitecore#configure-environment-details)
- [Finalize setup](https://vercel.com/docs/integrations/cms/sitecore#finalize-setup)
- [Create a new website](https://vercel.com/docs/integrations/cms/sitecore#create-a-new-website)
- [Publish the site](https://vercel.com/docs/integrations/cms/sitecore#publish-the-site)
- [Creating a Next.js JSS application](https://vercel.com/docs/integrations/cms/sitecore#creating-a-next.js-jss-application)
- [Clone the repository](https://vercel.com/docs/integrations/cms/sitecore#clone-the-repository)
- [Retrieve your API key, GraphQL endpoint, and JSS app name](https://vercel.com/docs/integrations/cms/sitecore#retrieve-your-api-key-graphql-endpoint-and-jss-app-name)
- [Configure your Next.js JSS application](https://vercel.com/docs/integrations/cms/sitecore#configure-your-next.js-jss-application)
- [Start your application](https://vercel.com/docs/integrations/cms/sitecore#start-your-application)
- [How it works](https://vercel.com/docs/integrations/cms/sitecore#how-it-works)
- [Deploying to Vercel](https://vercel.com/docs/integrations/cms/sitecore#deploying-to-vercel)
- [Push to Git](https://vercel.com/docs/integrations/cms/sitecore#push-to-git)
- [Import to Vercel](https://vercel.com/docs/integrations/cms/sitecore#import-to-vercel)
- [Configure environment variables](https://vercel.com/docs/integrations/cms/sitecore#configure-environment-variables)
