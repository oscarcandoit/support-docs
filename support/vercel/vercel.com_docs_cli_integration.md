...
resources](https://vercel.com/docs/cli/integration-resource#vercel-integration-resource-remove)
from this integration before using this command.

## [Global Options](https://vercel.com/docs/cli/integration\#global-options)

The following [global options](https://vercel.com/docs/cli/global-options) can be passed when using the `vercel integration` command:
