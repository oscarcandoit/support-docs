...
## [Supported package managers](https://vercel.com/docs/package-managers\#supported-package-managers)
...
| Vlt <br>Beta | `vlt-lock.json` | [`vlt install`](https://docs.vlt.sh/) | 0.x |
...
`pnpm-lock.yaml` version 9.0 can be generated by pnpm 9 or 10. Newer projects
will prefer 10, while older prefer 9. Check [build\\
logs](https://vercel.com/docs/deployments/logs) to see which version is used for your project.
...
## [Manually specifying a package manager](https://vercel.com/docs/package-managers\#manually-specifying-a-package-manager)

You can manually specify a package manager to use on a per-project, or per-deployment basis.

### [Project override](https://vercel.com/docs/package-managers\#project-override)
...
### [Deployment override](https://vercel.com/docs/package-managers\#deployment-override)

To specify a package manager for a deployment, use the [`installCommand`](https://vercel.com/docs/project-configuration#installcommand) property in your projects `vercel.json`.
