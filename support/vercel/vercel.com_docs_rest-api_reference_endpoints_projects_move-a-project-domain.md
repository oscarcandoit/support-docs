---
url: "https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain"
title: "Move a project domain - Vercel API Docs"
---

[Skip to main content](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#content-area)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#authorization-authorization)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#parameter-id-or-name)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#parameter-domain)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#parameter-team-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#parameter-slug)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#body-project-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#body-git-branch)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#body-redirect)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#body-redirect-status-code)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-name)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-apex-name)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-project-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-verified)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-redirect)

redirect

string \| null

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-redirect-status-code)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-git-branch)

gitBranch

string \| null

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-custom-environment-id)

customEnvironmentId

string \| null

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-updated-at)

updatedAt

number

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-created-at)

createdAt

number

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-verification)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-verification-type)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-verification-domain)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-verification-value)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain#response-verification-reason)
...
[Add a domain to a project](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project) [Verify project domain](https://vercel.com/docs/rest-api/reference/endpoints/projects/verify-project-domain)
