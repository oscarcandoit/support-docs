...
Environment variables are key-value pairs configured outside your source code so that each value can change depending on the [Environment](https://vercel.com/docs/deployments/environments).
...
## [Declare an Environment Variable](https://vercel.com/docs/environment-variables/managing-environment-variables\#declare-an-environment-variable)
...
![The 'Add New' section of the Environment Variables page in the Project Settings.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fenvironment-variables%2Fenv-var-section-light.png&w=1920&q=75)![The 'Add New' section of the Environment Variables page in the Project Settings.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fenvironment-variables%2Fenv-var-section-dark.png&w=1920&q=75)The 'Add New' section of the Environment Variables page in the Project Settings.
...
6. Configure which [deployment environment(s)](https://vercel.com/docs/deployments/environments) this variable should apply to.

7. Click Save.

8. To ensure that the new Environment Variable is applied to your deployment, you must [redeploy](https://vercel.com/docs/deployments/managing-deployments#redeploy-a-project) your project.


## [Viewing, editing, or deleting an Environment Variable](https://vercel.com/docs/environment-variables/managing-environment-variables\#viewing-editing-or-deleting-an-environment-variable)

To find and view all environment variables.

1. From your [dashboard](https://vercel.com/dashboard), select your project. You can also view all team-wide environment variables through the Team Settings.
2. Select the Settings tab.
3. Go to the Environment Variables section of your Project Settings.
4. Below the _Add New_ form is a list of all the environment variables for the Project.
5. You can search for an existing Environment Variable by name using the search input and/or filter by [Environment](https://vercel.com/docs/deployments/environments).
6. To edit or delete the Environment Variable, click the three dots to the right of the Environment Variable name.![An example of an Environment Variable with the search and filter inputs above.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fenvironment-variables%2Fvariable-example-light.png&w=1920&q=75)![An example of an Environment Variable with the search and filter inputs above.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fenvironment-variables%2Fvariable-example-dark.png&w=1920&q=75)An example of an Environment Variable with the search and filter inputs above.
