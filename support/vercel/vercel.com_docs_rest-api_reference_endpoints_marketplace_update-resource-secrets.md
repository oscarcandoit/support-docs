---
url: "https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets"
title: "Update Resource Secrets - Vercel API Docs"
---

[Skip to main content](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#content-area)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#authorization-authorization)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#parameter-integration-configuration-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#parameter-resource-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#body-secrets)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#body-secrets-name)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#body-secrets-value)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#body-secrets-prefix)

prefix

string

[​](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#body-secrets-environment-overrides)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets#body-partial)
...
[Update Resource Secrets (Deprecated)](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/update-resource-secrets-deprecated) [Create one or multiple experimentation items](https://vercel.com/docs/rest-api/reference/endpoints/marketplace/create-one-or-multiple-experimentation-items)
