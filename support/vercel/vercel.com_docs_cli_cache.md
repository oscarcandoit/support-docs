...
Learn more about [purging Vercel cache](https://vercel.com/docs/edge-cache/purge).

## [Usage](https://vercel.com/docs/cli/cache\#usage)
...
## [Extended Usage](https://vercel.com/docs/cli/cache\#extended-usage)
...
## [Unique Options](https://vercel.com/docs/cli/cache\#unique-options)

These are options that only apply to the `vercel cache` command.

### [tag](https://vercel.com/docs/cli/cache\#tag)
...
### [srcimg](https://vercel.com/docs/cli/cache\#srcimg)
...
### [revalidation-deadline-seconds](https://vercel.com/docs/cli/cache\#revalidation-deadline-seconds)
...
### [Yes](https://vercel.com/docs/cli/cache\#yes)
...
## [Global Options](https://vercel.com/docs/cli/cache\#global-options)

The following [global options](https://vercel.com/docs/cli/global-options) can be passed when using the `vercel cache` command:
