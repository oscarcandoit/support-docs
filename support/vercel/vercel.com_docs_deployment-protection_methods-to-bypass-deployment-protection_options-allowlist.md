...
OPTIONS Allowlistis availableon [all plans](https://vercel.com/docs/plans)
...
## [Enabling OPTIONS Allowlist](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist\#enabling-options-allowlist)

1. ### [Go to Project Deployment Protection Settings](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist\#go-to-project-deployment-protection-settings)
...
2. ### [Enable OPTIONS Allowlist](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist\#enable-options-allowlist)
...
3. ### [Specify a path](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist\#specify-a-path)
...
4. ### [Add more paths](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist\#add-more-paths)
...
5. ### [Save changes](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist\#save-changes)
...
## [Disabling OPTIONS Allowlist](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist\#disabling-options-allowlist)
...
1. Select the project that you wish to enable Password Protection for
2. Go to the Settings tab, and then to Deployment Protection
2. ### [Disable OPTIONS Allowlist](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist\#disable-options-allowlist)
...
3. ### [Save changes](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist\#save-changes)
...
- [Enabling OPTIONS Allowlist](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#enabling-options-allowlist)
- [Go to Project Deployment Protection Settings](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#go-to-project-deployment-protection-settings)
- [Enable OPTIONS Allowlist](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#enable-options-allowlist)
- [Specify a path](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#specify-a-path)
- [Add more paths](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#add-more-paths)
- [Save changes](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#save-changes)
- [Disabling OPTIONS Allowlist](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#disabling-options-allowlist)
- [Go to Project Deployment Protection Settings](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#go-to-project-deployment-protection-settings)
- [Disable OPTIONS Allowlist](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#disable-options-allowlist)
- [Save changes](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/options-allowlist#save-changes)
