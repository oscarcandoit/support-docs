...
## [`sandbox --help`](https://vercel.com/docs/vercel-sandbox/cli-reference\#sandbox---help)
...
- [`list`](https://vercel.com/docs/vercel-sandbox/cli-reference#sandbox-list): List all sandboxes for the specified account and project. \[alias: `ls`\]
- [`create`](https://vercel.com/docs/vercel-sandbox/cli-reference#sandbox-create): Create a sandbox in the specified account and project.
- [`copy`](https://vercel.com/docs/vercel-sandbox/cli-reference#sandbox-copy): Copy files between your local filesystem and a remote sandbox \[alias: `cp`\]
- [`exec`](https://vercel.com/docs/vercel-sandbox/cli-reference#sandbox-exec): Execute a command in an existing sandbox
- [`stop`](https://vercel.com/docs/vercel-sandbox/cli-reference#sandbox-stop): Stop one or more running sandboxes \[aliases: `rm`, `remove`\]
- [`run`](https://vercel.com/docs/vercel-sandbox/cli-reference#sandbox-run): Create and run a command in a sandbox
- [`login`](https://vercel.com/docs/vercel-sandbox/cli-reference#sandbox-login): Log in to the Sandbox CLI
- [`logout`](https://vercel.com/docs/vercel-sandbox/cli-reference#sandbox-logout): Log out of the Sandbox CLI

For more help, try running `sandbox <subcommand> --help`

## [`sandbox list`](https://vercel.com/docs/vercel-sandbox/cli-reference\#sandbox-list)
...
### [Example](https://vercel.com/docs/vercel-sandbox/cli-reference\#example)
...
### [Options](https://vercel.com/docs/vercel-sandbox/cli-reference\#options)
...
### [Flags](https://vercel.com/docs/vercel-sandbox/cli-reference\#flags)
...
## [`sandbox run`](https://vercel.com/docs/vercel-sandbox/cli-reference\#sandbox-run)
...
### [Arguments](https://vercel.com/docs/vercel-sandbox/cli-reference\#arguments)
...
## [`sandbox create`](https://vercel.com/docs/vercel-sandbox/cli-reference\#sandbox-create)
...
## [`sandbox exec`](https://vercel.com/docs/vercel-sandbox/cli-reference\#sandbox-exec)
...
## [`sandbox stop`](https://vercel.com/docs/vercel-sandbox/cli-reference\#sandbox-stop)
...
## [`sandbox copy`](https://vercel.com/docs/vercel-sandbox/cli-reference\#sandbox-copy)
...
## [`sandbox login`](https://vercel.com/docs/vercel-sandbox/cli-reference\#sandbox-login)
...
## [`sandbox logout`](https://vercel.com/docs/vercel-sandbox/cli-reference\#sandbox-logout)
