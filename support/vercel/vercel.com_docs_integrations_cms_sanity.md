...
## [Getting started](https://vercel.com/docs/integrations/cms/sanity\#getting-started)

To get started with the Sanity on Vercel deploy the template below:

[![Stablo – Minimal Blog Template](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F6p72KDrdJ8SjyvOBrgRbnr%2F0760db43f2cb08504a2f67601e74d986%2FCleanShot_2022-07-15_at_16.54.17.png&w=3840&q=75)\\
\\
Stablo – Minimal Blog Template\\
\\
A minimal blog website template built with Next.js, TailwindCSS & Sanity CMS](https://vercel.com/templates/next.js/stablo-blog) [![Visual Editing with Sanity](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2Fyr4zLyqLVfavv4ULFDL6n%2F0152dd740a5abaa8f82a970f8c660166%2Fvisualtemplatedemothumb_-_Tarun_Gangwani.png&w=3840&q=75)\\
\\
Visual Editing with Sanity\\
\\
Sanity + Vercel Visual Editing demo, bringing intuitive content management to modern, composable content architectures.](https://vercel.com/templates/next.js/sanity-visual-editing-demo) [![Blog with Native Content Editing](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F78G5CgqIsN6SUizcrcSHC%2F2d67c52e3b4bac1a13e34ac15b38bba0%2Fnextjs-sanity-blog-preview_-_Tarun_Gangwani.png&w=3840&q=75)\\
\\
Blog with Native Content Editing\\
\\
A Sanity-powered blog with native content editing and instant previews.](https://vercel.com/templates/next.js/blog-nextjs-sanity)

Or, follow the steps below to install the integration:

1. ### [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/sanity\#install-the-vercel-cli)



To pull in environment variables from Sanity to your Vercel project, you need to install the [Vercel CLI](https://vercel.com/docs/cli). Run the following command in your terminal:
...
2. ### [Install your CMS integration](https://vercel.com/docs/integrations/cms/sanity\#install-your-cms-integration)



Navigate to the [Sanity integration](https://vercel.com/integrations/sanity) and follow the steps to install the integration.

3. ### [Pull in environment variables](https://vercel.com/docs/integrations/cms/sanity\#pull-in-environment-variables)
...
### [Content Link](https://vercel.com/docs/integrations/cms/sanity\#content-link)

Content Linkis availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
- [Getting started](https://vercel.com/docs/integrations/cms/sanity#getting-started)
- [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/sanity#install-the-vercel-cli)
- [Install your CMS integration](https://vercel.com/docs/integrations/cms/sanity#install-your-cms-integration)
- [Pull in environment variables](https://vercel.com/docs/integrations/cms/sanity#pull-in-environment-variables)
- [Content Link](https://vercel.com/docs/integrations/cms/sanity#content-link)
