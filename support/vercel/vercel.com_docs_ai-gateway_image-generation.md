...
If using the [AI SDK](https://vercel.com/docs/ai-sdk), you can use the `generateImage` function
for image-specific models, or use `generateText`
and `streamText` with models that support multi-modal outputs. Read more in the
AI SDK [Image Generation documentation](https://ai-sdk.dev/docs/ai-sdk-core/image-generation#image-generation).

## [Nano Banana Pro (Gemini 3 Pro Image)](https://vercel.com/docs/ai-gateway/image-generation\#nano-banana-pro-gemini-3-pro-image)

Google's Nano Banana Pro (Gemini 3 Pro Image) model offers state-of-the-art image generation and editing capabilities.
This model supports [specifying response modalities](https://ai-sdk.dev/providers/ai-sdk-providers/google-generative-ai#image-outputs)
to enable image outputs alongside text responses. Find details on this model in the [Model Library](https://vercel.com/ai-gateway/models/gemini-3-pro-image).

## [Basic image generation](https://vercel.com/docs/ai-gateway/image-generation\#basic-image-generation)

Generate images from text prompts using the `generateText` or `streamText` functions.
...
async function main() {
  const result = await generateText({
    ...
    prompt: 'Render a cat looking out at the river in Arashiyama on a rainy afternoon.',
  });
...
## [Use images as input](https://vercel.com/docs/ai-gateway/image-generation\#use-images-as-input)
...
For OpenAI-compatible API usage with image generation, see the [OpenAI-Compatible API Image Generation section](https://vercel.com/docs/ai-gateway/openai-compat#image-generation).

## [OpenAI-compatible API response format](https://vercel.com/docs/ai-gateway/image-generation\#openai-compatible-api-response-format)
...
### [Response structure](https://vercel.com/docs/ai-gateway/image-generation\#response-structure)
...
### [Key format details](https://vercel.com/docs/ai-gateway/image-generation\#key-format-details)
...
### [Streaming responses](https://vercel.com/docs/ai-gateway/image-generation\#streaming-responses)
...
## [Handling generated images](https://vercel.com/docs/ai-gateway/image-generation\#handling-generated-images)
...
## [Streaming image generation](https://vercel.com/docs/ai-gateway/image-generation\#streaming-image-generation)
