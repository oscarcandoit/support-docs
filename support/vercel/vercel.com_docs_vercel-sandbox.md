...
Vercel Sandboxis availablein [Beta](https://vercel.com/docs/release-phases#beta)on [all plans](https://vercel.com/docs/plans)
...
## [Using Vercel Sandbox](https://vercel.com/docs/vercel-sandbox\#using-vercel-sandbox)

- Get started with using Vercel Sandbox with the [getting started guide](https://vercel.com/docs/vercel-sandbox#getting-started) and [examples](https://vercel.com/docs/vercel-sandbox/examples)
- Learn about [authentication methods](https://vercel.com/docs/vercel-sandbox#authentication) and the [SDK reference](https://vercel.com/docs/vercel-sandbox/reference/globals)
- Use the [CLI reference](https://vercel.com/docs/vercel-sandbox/cli-reference) to manage sandboxes from the command line
- [Understand how to monitor your sandboxes](https://vercel.com/docs/vercel-sandbox#observability)
...
## [Getting started](https://vercel.com/docs/vercel-sandbox\#getting-started)

### [Pre-requisites](https://vercel.com/docs/vercel-sandbox\#pre-requisites)

- [The Vercel CLI](https://vercel.com/docs/cli)

### [Create a sandbox](https://vercel.com/docs/vercel-sandbox\#create-a-sandbox)
...
1. ### [Set up your environment](https://vercel.com/docs/vercel-sandbox\#set-up-your-environment)
...
2. ### [Set up authentication](https://vercel.com/docs/vercel-sandbox\#set-up-authentication)
...
3. ### [Create the set up file](https://vercel.com/docs/vercel-sandbox\#create-the-set-up-file)
...
4. ### [Start the sandbox](https://vercel.com/docs/vercel-sandbox\#start-the-sandbox)
...
5. ### [Access the sandbox](https://vercel.com/docs/vercel-sandbox\#access-the-sandbox)
...
6. ### [Stop the sandbox](https://vercel.com/docs/vercel-sandbox\#stop-the-sandbox)
...
To stop a sandbox, you can:
   ...
   - Navigate to the [Observability tab](https://vercel.com/docs/vercel-sandbox#observability) of your project
...
## [Authentication](https://vercel.com/docs/vercel-sandbox\#authentication)

### [Vercel OIDC token](https://vercel.com/docs/vercel-sandbox\#vercel-oidc-token)
...
### [Using access tokens](https://vercel.com/docs/vercel-sandbox\#using-access-tokens)
...
### [Available packages](https://vercel.com/docs/vercel-sandbox\#available-packages)
...
### [Sudo config](https://vercel.com/docs/vercel-sandbox\#sudo-config)
...
## [Observability](https://vercel.com/docs/vercel-sandbox\#observability)
...
- [Pre-requisites](https://vercel.com/docs/vercel-sandbox#pre-requisites)
- [Create a sandbox](https://vercel.com/docs/vercel-sandbox#create-a-sandbox)
- [Set up your environment](https://vercel.com/docs/vercel-sandbox#set-up-your-environment)
- [Set up authentication](https://vercel.com/docs/vercel-sandbox#set-up-authentication)
- [Create the set up file](https://vercel.com/docs/vercel-sandbox#create-the-set-up-file)
- [Start the sandbox](https://vercel.com/docs/vercel-sandbox#start-the-sandbox)
- [Access the sandbox](https://vercel.com/docs/vercel-sandbox#access-the-sandbox)
- [Stop the sandbox](https://vercel.com/docs/vercel-sandbox#stop-the-sandbox)
- [Set up your environment](https://vercel.com/docs/vercel-sandbox#set-up-your-environment)
- [Set up authentication](https://vercel.com/docs/vercel-sandbox#set-up-authentication)
- [Create the set up file](https://vercel.com/docs/vercel-sandbox#create-the-set-up-file)
- [Start the sandbox](https://vercel.com/docs/vercel-sandbox#start-the-sandbox)
