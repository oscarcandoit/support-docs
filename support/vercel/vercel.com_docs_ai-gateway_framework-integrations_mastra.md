...
using a modern JavaScript stack powered by the [Vercel AI SDK](https://vercel.com/docs/ai-sdk).
Integrating with AI Gateway provides unified model management and routing capabilities.

## [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/mastra\#getting-started)

1. ### [Create a new Mastra project](https://vercel.com/docs/ai-gateway/framework-integrations/mastra\#create-a-new-mastra-project)
...
2. ### [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/mastra\#install-dependencies)
...
3. ### [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/mastra\#configure-environment-variables)



Create or update your `.env` file with
your [Vercel AI Gateway API key](https://vercel.com/docs/ai-gateway#using-the-ai-gateway-with-an-api-key):
...
4. ### [Configure your agent to use AI Gateway](https://vercel.com/docs/ai-gateway/framework-integrations/mastra\#configure-your-agent-to-use-ai-gateway)
...
5. ### [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/mastra\#running-the-application)
...
- [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/mastra#getting-started)
- [Create a new Mastra project](https://vercel.com/docs/ai-gateway/framework-integrations/mastra#create-a-new-mastra-project)
- [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/mastra#install-dependencies)
- [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/mastra#configure-environment-variables)
- [Configure your agent to use AI Gateway](https://vercel.com/docs/ai-gateway/framework-integrations/mastra#configure-your-agent-to-use-ai-gateway)
- [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/mastra#running-the-application)
