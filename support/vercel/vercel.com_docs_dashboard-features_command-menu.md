...
![Opening the Command Menu using your cursor.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Funiversal-search%2Fdashboard-cmdk-light.png&w=1080&q=75)![Opening the Command Menu using your cursor.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Funiversal-search%2Fdashboard-cmdk-dark.png&w=1080&q=75)Opening the Command Menu using your cursor.
...
## [Recently Used Items](https://vercel.com/docs/dashboard-features/command-menu\#recently-used-items)
...
## [Context-Based Items](https://vercel.com/docs/dashboard-features/command-menu\#context-based-items)
...
If you're currently looking at the dashboard for a [Pro](https://vercel.com/docs/plans/pro) or [Enterprise](https://vercel.com/docs/plans/enterprise) Team, for example, you will be offered to copy a link for inviting new [Team Members](https://vercel.com/docs/rbac/managing-team-members) if you're an [Owner](https://vercel.com/docs/rbac/access-roles#owner-role) of that Team.

Whereas, if you're on a [Hobby plan](https://vercel.com/docs/plans/hobby) instead, you will not be offered that option because Hobby plans don't support collaborating.

## [Additional Keyboard Shortcuts](https://vercel.com/docs/dashboard-features/command-menu\#additional-keyboard-shortcuts)
...
## [Searching documentation](https://vercel.com/docs/dashboard-features/command-menu\#searching-documentation)
...
![Searching from the Vercel documentation.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Funiversal-search%2Funiversal-search-v1-light.png&w=1920&q=75)![Searching from the Vercel documentation.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Funiversal-search%2Funiversal-search-v1-dark.png&w=1920&q=75)Searching from the Vercel documentation.

### [Searching from the Vercel documentation](https://vercel.com/docs/dashboard-features/command-menu\#searching-from-the-vercel-documentation)
...
### [Searching from the Vercel dashboard](https://vercel.com/docs/dashboard-features/command-menu\#searching-from-the-vercel-dashboard)
...
## [What about regular menus?](https://vercel.com/docs/dashboard-features/command-menu\#what-about-regular-menus)
