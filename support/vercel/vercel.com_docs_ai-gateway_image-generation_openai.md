...
For AI SDK usage with image generation capabilities, see the [AI SDK\\
documentation](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk).

## [Multimodal LLMs](https://vercel.com/docs/ai-gateway/image-generation/openai\#multimodal-llms)
...
### [Generate response format](https://vercel.com/docs/ai-gateway/image-generation/openai\#generate-response-format)
...
### [Streaming response format](https://vercel.com/docs/ai-gateway/image-generation/openai\#streaming-response-format)
...
## [Dedicated image models](https://vercel.com/docs/ai-gateway/image-generation/openai\#dedicated-image-models)

Dedicated image generation models use the OpenAI Images API (`/v1/images/generations`) for specialized image creation.

### [Google Vertex Imagen](https://vercel.com/docs/ai-gateway/image-generation/openai\#google-vertex-imagen)
...
TypeScript (Basic)TypeScript (With Options)Python
...
### [Black Forest Labs](https://vercel.com/docs/ai-gateway/image-generation/openai\#black-forest-labs)
...
## [Python](https://vercel.com/docs/ai-gateway/image-generation/openai\#python)
...
## [REST API](https://vercel.com/docs/ai-gateway/image-generation/openai\#rest-api)
