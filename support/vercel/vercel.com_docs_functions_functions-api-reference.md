...
## [Function signature](https://vercel.com/docs/functions/functions-api-reference\#function-signature)
...
1. In your `vercel.json` file, add `"supportsCancellation": true` to the [specific paths](https://vercel.com/docs/project-configuration#key-definition) you want to opt-in to cancellation for your functions. For example, to enable everything, use `**/*` as the glob or `app/**/*` for app router:
...
## [Route segment config](https://vercel.com/docs/functions/functions-api-reference\#route-segment-config)
...
## [`SIGTERM` signal](https://vercel.com/docs/functions/functions-api-reference\#sigterm-signal)
...
## [The `@vercel/functions` package](https://vercel.com/docs/functions/functions-api-reference\#the-@vercel/functions-package)

The `@vercel/functions` package provides a set of helper methods and utilities for working with Vercel Functions.

### [Helper methods](https://vercel.com/docs/functions/functions-api-reference\#helper-methods)
...
- [`getCache()`](https://vercel.com/docs/functions/functions-api-reference/vercel-functions-package#getcache): Obtain a [`RuntimeCache`](https://vercel.com/docs/functions/functions-api-reference/vercel-functions-package#getcache) object to interact with the [Vercel Data Cache](https://vercel.com/docs/data-cache).
...
## [The `@vercel/oidc` package](https://vercel.com/docs/functions/functions-api-reference\#the-@vercel/oidc-package)
...
### [OIDC Helper methods](https://vercel.com/docs/functions/functions-api-reference\#oidc-helper-methods)
...
## [The `@vercel/oidc-aws-credentials-provider` package](https://vercel.com/docs/functions/functions-api-reference\#the-@vercel/oidc-aws-credentials-provider-package)
...
### [AWS Helper methods](https://vercel.com/docs/functions/functions-api-reference\#aws-helper-methods)
...
## [More resources](https://vercel.com/docs/functions/functions-api-reference\#more-resources)

- [Streaming Data: Learn about streaming on Vercel](https://vercel.com/docs/functions/streaming)
...
- [Function signature](https://vercel.com/docs/functions/functions-api-reference#function-signature)
- [fetch Web Standard](https://vercel.com/docs/functions/functions-api-reference#fetch-web-standard)
- [Cancel requests](https://vercel.com/docs/functions/functions-api-reference#cancel-requests)
- [config object](https://vercel.com/docs/functions/functions-api-reference#config-object)
- [config properties](https://vercel.com/docs/functions/functions-api-reference#config-properties)
- [Route segment config](https://vercel.com/docs/functions/functions-api-reference#route-segment-config)
- [SIGTERM signal](https://vercel.com/docs/functions/functions-api-reference#sigterm-signal)
- [The @vercel/functions package](https://vercel.com/docs/functions/functions-api-reference#the-@vercel/functions-package)
- [Helper methods](https://vercel.com/docs/functions/functions-api-reference#helper-methods)
