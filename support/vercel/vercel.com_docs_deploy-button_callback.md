---
url: "https://vercel.com/docs/deploy-button/callback"
...
## [Redirect URL](https://vercel.com/docs/deploy-button/callback\#redirect-url)
...
Provide a custom name and logo for the redirect UI by using the [Developer ID](https://vercel.com/docs/deploy-button/callback#developer-id) parameter.

### [Callback Parameters](https://vercel.com/docs/deploy-button/callback\#callback-parameters)
...
| `production-deploy-hook-url` ( [conditional](https://vercel.com/docs/deploy-button/callback#deploy-hook)) | The URL of a Deploy Hook. Requires [the `production-deploy-hook` parameter](https://vercel.com/docs/deploy-button/callback#deploy-hook). |

## [Developer ID](https://vercel.com/docs/deploy-button/callback\#developer-id)

| Parameter | Type | Value |
| --- | --- | --- |
| `developer-id` | `string` | The Client ID of an Integration. |

The Developer ID parameter allows you to define a [Vercel Integration](https://vercel.com/docs/integrations) Client ID which will then attach your logo and name to the UI when using the [Redirect URL](https://vercel.com/docs/deploy-button/callback#redirect-url) parameter.
...
This parameter requires the [Redirect URL](https://vercel.com/docs/deploy-button/callback#redirect-url) parameter to be set and also that the Integration website field matches the Redirect URL value.
...
## [External ID](https://vercel.com/docs/deploy-button/callback\#external-id)
...
The query parameter will be relayed to the [Redirect URL](https://vercel.com/docs/integrations/create-integration) of
each required [Integration](https://vercel.com/docs/integrations/deploy-button/integrations) when the user adds them in the Project creation flow.
...
## [Deploy Hook](https://vercel.com/docs/deploy-button/callback\#deploy-hook)
...
When redirected back to your application upon a successful deployment for the user, you will get the `production-deploy-hook-url` callback parameter in addition to [the default callback parameters](https://vercel.com/docs/deploy-button/callback#callback-parameters).

This parameter requires the [Redirect URL](https://vercel.com/docs/deploy-button/callback#redirect-url) parameter to also be set.
