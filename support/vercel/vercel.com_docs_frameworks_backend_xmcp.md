...
## [Get started with xmcp on Vercel](https://vercel.com/docs/frameworks/backend/xmcp\#get-started-with-xmcp-on-vercel)
...
### [Get started with Vercel CLI](https://vercel.com/docs/frameworks/backend/xmcp\#get-started-with-vercel-cli)

Get started by initializing a new Xmcp project using [Vercel CLI init command](https://vercel.com/docs/cli/init):
...
## [Local development](https://vercel.com/docs/frameworks/backend/xmcp\#local-development)
...
## [Middleware](https://vercel.com/docs/frameworks/backend/xmcp\#middleware)

### [xmcp Middleware](https://vercel.com/docs/frameworks/backend/xmcp\#xmcp-middleware)
...
### [Vercel Routing Middleware](https://vercel.com/docs/frameworks/backend/xmcp\#vercel-routing-middleware)

In Vercel, [Routing Middleware](https://vercel.com/docs/routing-middleware) executes before a request is processed by your application. Use it for rewrites, redirects, headers, or personalization, and combine it with xmcp's own middleware as needed.

## [Vercel Functions](https://vercel.com/docs/frameworks/backend/xmcp\#vercel-functions)

When you deploy an xmcp app to Vercel, your server endpoints automatically run as [Vercel Functions](https://vercel.com/docs/functions) and use [Fluid compute](https://vercel.com/docs/fluid-compute) by default.

## [More resources](https://vercel.com/docs/frameworks/backend/xmcp\#more-resources)
