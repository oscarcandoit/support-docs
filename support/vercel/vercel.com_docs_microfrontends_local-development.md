...
## [The need for a microfrontends proxy](https://vercel.com/docs/microfrontends/local-development\#the-need-for-a-microfrontends-proxy)
...
## [Setting up microfrontends proxy](https://vercel.com/docs/microfrontends/local-development\#setting-up-microfrontends-proxy)

### [Prerequisites](https://vercel.com/docs/microfrontends/local-development\#prerequisites)

- Set up your [microfrontends on Vercel](https://vercel.com/docs/microfrontends/quickstart)
...
1. ### [Application setup](https://vercel.com/docs/microfrontends/local-development\#application-setup)
...
2. ### [Starting local proxy](https://vercel.com/docs/microfrontends/local-development\#starting-local-proxy)
...
3. ### [Setting up your monorepo](https://vercel.com/docs/microfrontends/local-development\#setting-up-your-monorepo)



1. ### [Option 1: Adding Turborepo to a monorepo](https://vercel.com/docs/microfrontends/local-development\#option-1:-adding-turborepo-to-a-monorepo)
...
2. ### [Option 2: Using without Turborepo](https://vercel.com/docs/microfrontends/local-development\#option-2:-using-without-turborepo)
      ...
      Review [Understanding the proxy command](https://vercel.com/docs/microfrontends/local-development#understanding-the-proxy-command) for more details.
4. ### [Accessing the microfrontends proxy](https://vercel.com/docs/microfrontends/local-development\#accessing-the-microfrontends-proxy)
...
### [Accessing the configuration file](https://vercel.com/docs/microfrontends/local-development\#accessing-the-configuration-file)
...
### [Running the local development proxy](https://vercel.com/docs/microfrontends/local-development\#running-the-local-development-proxy)
...
1. ### [Start your local microfrontend application](https://vercel.com/docs/microfrontends/local-development\#start-your-local-microfrontend-application)



Start your microfrontend application with the proper port configuration. Follow the [Application setup](https://vercel.com/docs/microfrontends/local-development#application-setup) instructions to configure your development script with the `microfrontends port` command.

2. ### [Run the microfrontends proxy](https://vercel.com/docs/microfrontends/local-development\#run-the-microfrontends-proxy)
...
3. ### [Access your application](https://vercel.com/docs/microfrontends/local-development\#access-your-application)
...
## [Understanding the proxy command](https://vercel.com/docs/microfrontends/local-development\#understanding-the-proxy-command)
...
## [Falling back to protected deployments](https://vercel.com/docs/microfrontends/local-development\#falling-back-to-protected-deployments)

To fall back to a Vercel deployment protected with [Deployment Protection](https://vercel.com/docs/deployment-protection), set an environment variable with the value of the [Protection Bypass for Automation](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/protection-bypass-automation).
...
### [Set the protection bypass environment variable](https://vercel.com/docs/microfrontends/local-development\#set-the-protection-bypass-environment-variable)

1. ### [Enable the Protection Bypass for Automation for your project](https://vercel.com/docs/microfrontends/local-development\#enable-the-protection-bypass-for-automation-for-your-project)
...
4. If not enabled, create a new [Protection Bypass for Automation](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/protection-bypass-automation)
5. Copy the value of the secret
2. ### [Set the environment variable in the default app project](https://vercel.com/docs/microfrontends/local-development\#set-the-environment-variable-in-the-default-app-project)
...
6. Click on Save
3. ### [Import the secret using vc env pull](https://vercel.com/docs/microfrontends/local-development\#import-the-secret-using-vc-env-pull)
...
4. ### [Update your README.md](https://vercel.com/docs/microfrontends/local-development\#update-your-readme.md)



Include [the previous step](https://vercel.com/docs/microfrontends/local-development#import-the-secret-using-vc-env-pull) in your repository setup instructions, so that other users will also have the secret available.
...
- [Setting up microfrontends proxy](https://vercel.com/docs/microfrontends/local-development#setting-up-microfrontends-proxy)
- [Prerequisites](https://vercel.com/docs/microfrontends/local-development#prerequisites)
- [Application setup](https://vercel.com/docs/microfrontends/local-development#application-setup)
- [Starting local proxy](https://vercel.com/docs/microfrontends/local-development#starting-local-proxy)
- [Setting up your monorepo](https://vercel.com/docs/microfrontends/local-development#setting-up-your-monorepo)
- [Option 1: Adding Turborepo to a monorepo](https://vercel.com/docs/microfrontends/local-development#option-1:-adding-turborepo-to-a-monorepo)
- [Option 2: Using without Turborepo](https://vercel.com/docs/microfrontends/local-development#option-2:-using-without-turborepo)
- [Accessing the microfrontends proxy](https://vercel.com/docs/microfrontends/local-development#accessing-the-microfrontends-proxy)
- [Debug routing](https://vercel.com/docs/microfrontends/local-development#debug-routing)
- [Polyrepo setup](https://vercel.com/docs/microfrontends/local-development#polyrepo-setup)
- [Accessing the configuration file](https://vercel.com/docs/microfrontends/local-development#accessing-the-configuration-file)
- [Running the local development proxy](https://vercel.com/docs/microfrontends/local-development#running-the-local-development-proxy)
- [Start your local microfrontend application](https://vercel.com/docs/microfrontends/local-development#start-your-local-microfrontend-application)
- [Run the microfrontends proxy](https://vercel.com/docs/microfrontends/local-development#run-the-microfrontends-proxy)
- [Access your application](https://vercel.com/docs/microfrontends/local-development#access-your-application)
- [Understanding the proxy command](https://vercel.com/docs/microfrontends/local-development#understanding-the-proxy-command)
- [Falling back to protected deployments](https://vercel.com/docs/microfrontends/local-development#falling-back-to-protected-deployments)
- [Set the protection bypass environment variable](https://vercel.com/docs/microfrontends/local-development#set-the-protection-bypass-environment-variable)
- [Enable the Protection Bypass for Automation for your project](https://vercel.com/docs/microfrontends/local-development#enable-the-protection-bypass-for-automation-for-your-project)
- [Set the environment variable in the default app project](https://vercel.com/docs/microfrontends/local-development#set-the-environment-variable-in-the-default-app-project)
- [Import the secret using vc env pull](https://vercel.com/docs/microfrontends/local-development#import-the-secret-using-vc-env-pull)
- [Update your README.md](https://vercel.com/docs/microfrontends/local-development#update-your-readme.md)
