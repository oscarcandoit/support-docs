...
You can [buy a domain through Vercel](https://vercel.com/docs/domains/working-with-domains#buying-a-domain-through-vercel) by going to the [Vercel.com domains page](https://vercel.com/domains) and using our fast search to [find one or more domains](https://vercel.com/docs/getting-started-with-vercel/buy-domain) that fit your brand and needs. The price of available domains is the same as the registrar's pricing and Vercel does not keep a log of your search history for marketing purposes.

## [Buying a domain name](https://vercel.com/docs/domains/working-with-domains\#buying-a-domain-name)
...
More often than not, you will want to assign a domain to a project that reflects its nature better. You can buy a domain name either [through Vercel](https://vercel.com/docs/domains/working-with-domains#buying-a-domain-through-vercel) or [through a third-party](https://vercel.com/docs/domains/working-with-domains#buying-a-domain-through-a-third-party). Depending on which option you choose, will dictate how and when you'll need to make configurations:

### [Buying a domain through Vercel](https://vercel.com/docs/domains/working-with-domains\#buying-a-domain-through-vercel)
...
- If you enter the same email address you use for your Vercel user account
(or an email your [team owner](https://vercel.com/docs/rbac/access-roles#owner-role) uses),
the information will be confirmed automatically.

- If you enter another email address, please follow the instructions you
receive in an email to confirm your registrant information.

- If you don't confirm your registrant information, your domain could be suspended (clientHold).
...
### [Buying a domain through a third-party](https://vercel.com/docs/domains/working-with-domains\#buying-a-domain-through-a-third-party)
...
## [Domain ownership and Project assignment](https://vercel.com/docs/domains/working-with-domains\#domain-ownership-and-project-assignment)
...
## [Subdomains, wildcard domains, and apex domains](https://vercel.com/docs/domains/working-with-domains\#subdomains-wildcard-domains-and-apex-domains)

### [Apex Domain](https://vercel.com/docs/domains/working-with-domains\#apex-domain)
...
### [Subdomain](https://vercel.com/docs/domains/working-with-domains\#subdomain)
...
### [Wildcard domain](https://vercel.com/docs/domains/working-with-domains\#wildcard-domain)
...
## [Using email with domains](https://vercel.com/docs/domains/working-with-domains\#using-email-with-domains)
...
Because many domain providers do not offer a mail service, several third-party services specifically offer this type of functionality and are enabled by adding MX records. Examples of this type of service include [ImproxMX](https://improvmx.com/) and [Forward Email](https://forwardemail.net/en), however there are many more options available. For each provider, different DNS records are required to be added. For information on how to set up email, see [How do I send and receive emails with my Vercel purchased domain?](https://vercel.com/kb/guide/using-email-with-your-vercel-domain)

## [Troubleshooting](https://vercel.com/docs/domains/working-with-domains\#troubleshooting)
...
## [More resources](https://vercel.com/docs/domains/working-with-domains\#more-resources)

- [Domains overview: Learn the concepts behind how domains work](https://vercel.com/docs/domains)
- [Learn how DNS works in order to properly configure your domain](https://vercel.com/docs/domains/working-with-dns)
- [Learn about nameservers and the benefits Vercel nameservers provide](https://vercel.com/docs/domains/working-with-nameservers)
- [Learn how Vercel uses SSL certificates to keep your site secure](https://vercel.com/docs/domains/working-with-ssl)
- [Learn how to troubleshoot your domain on Vercel](https://vercel.com/docs/domains/troubleshooting)
