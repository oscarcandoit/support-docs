...
## [Real Experience Score (RES)](https://vercel.com/docs/speed-insights/metrics\#real-experience-score-res)

### [Real user monitoring](https://vercel.com/docs/speed-insights/metrics\#real-user-monitoring)
...
Speed Insights now uses Lighthouse 10 scoring criteria instead of Lighthouse 6
criteria as explained in [Updated Scoring\\
Criteria](https://vercel.com/docs/speed-insights/migrating-from-legacy#updated-scoring-criteria)

| Metric | Description | Target Value |
| --- | --- | --- |
| [Largest Contentful Paint (LCP)](https://vercel.com/docs/speed-insights/metrics#largest-contentful-paint-lcp) | Measures the time from page start to when the largest content element is fully visible. | 2.5 seconds or less |
| [Cumulative Layout Shift (CLS)](https://vercel.com/docs/speed-insights/metrics#cumulative-layout-shift-cls) | Quantifies the fraction of layout shift experienced by the user over the lifespan of the page. | 0.1 or less |
| [Interaction to Next Paint (INP)](https://vercel.com/docs/speed-insights/metrics#interaction-to-next-paint-inp) | Measures the time from user interaction to when the browser renders the next frame. | 200 millisecond or less |
| [First Contentful Paint (FCP)](https://vercel.com/docs/speed-insights/metrics#first-contentful-paint-fcp) | Measures the time from page start to the rendering of the first piece of DOM content. | 1.8 seconds or less |
| [First Input Delay (FID)](https://vercel.com/docs/speed-insights/metrics#first-input-delay-fid) | Measures the time from a user's first interaction to the time the browser is able to respond. | 100 milliseconds or less |
| [Total Blocking Time (TBT)](https://vercel.com/docs/speed-insights/metrics#total-blocking-time-tbt) | Measures the total amount of time between FCP and TTI where the main thread was blocked long enough to prevent input responsiveness. | Under 800 milliseconds |
| [Time to First Byte (TTFB)](https://vercel.com/docs/speed-insights/metrics#time-to-first-byte-ttfb) | Measures the time from the request of a resource to when the first byte of a response begins to arrive. | Under 800 milliseconds |

### [Largest Contentful Paint (LCP)](https://vercel.com/docs/speed-insights/metrics\#largest-contentful-paint-lcp)
...
### [Cumulative Layout Shift (CLS)](https://vercel.com/docs/speed-insights/metrics\#cumulative-layout-shift-cls)
...
### [Interaction to Next Paint (INP)](https://vercel.com/docs/speed-insights/metrics\#interaction-to-next-paint-inp)
...
### [First Contentful Paint (FCP)](https://vercel.com/docs/speed-insights/metrics\#first-contentful-paint-fcp)
...
## [Other metrics](https://vercel.com/docs/speed-insights/metrics\#other-metrics)

### [Time to First Byte (TTFB)](https://vercel.com/docs/speed-insights/metrics\#time-to-first-byte-ttfb)
...
### [First Input Delay (FID)](https://vercel.com/docs/speed-insights/metrics\#first-input-delay-fid)
...
### [Total Blocking Time (TBT)](https://vercel.com/docs/speed-insights/metrics\#total-blocking-time-tbt)
...
For more in-depth information related to performance metrics, visit the
PageSpeed Insights [documentation](https://developers.google.com/speed/docs/insights/v5/about).

## [How the scores are determined](https://vercel.com/docs/speed-insights/metrics\#how-the-scores-are-determined)

Vercel calculates performance scores using real-world data obtained from the [HTTP Archive](https://httparchive.org/). This process involves assigning each collected metric (e.g., [First Contentful Paint (FCP)](https://vercel.com/docs/speed-insights/metrics#first-contentful-paint-fcp)) a score ranging from 0 to 100. The score is determined based on where the raw metric value falls within a log-normal distribution derived from actual website performance data.
...
Gauge showing computed score and metrics91FCPFirst Contentful paint. Good <= 1.8s, Improvable <= 3sLCPLarge Contentful Paint. Good <= 2.5s, Improvable <= 4sINPInteraction to Next Paint. Good <= 200ms, Improvable <= 500msCLSCumulative Layout Shift. Good <= 0.1, Improvable <= 0.25

## [Understanding data points](https://vercel.com/docs/speed-insights/metrics\#understanding-data-points)
...
- On page load: Time to First Byte ( [TTFB](https://vercel.com/docs/speed-insights/metrics#time-to-first-byte-ttfb)) and First Contentful Paint ( [FCP](https://vercel.com/docs/speed-insights/metrics#first-contentful-paint-fcp))
- On interaction: First Input Delay ( [FID](https://vercel.com/docs/speed-insights/metrics#first-input-delay-fid)) and Largest Contentful Paint ( [LCP](https://vercel.com/docs/speed-insights/metrics#largest-contentful-paint-lcp))
- On leave: Interaction to Next Paint ( [INP](https://vercel.com/docs/speed-insights/metrics#interaction-to-next-paint-inp)), Cumulative Layout Shift ( [CLS](https://vercel.com/docs/speed-insights/metrics#cumulative-layout-shift-cls)), and, if not already sent, Largest Contentful Paint ( [LCP](https://vercel.com/docs/speed-insights/metrics#largest-contentful-paint-lcp)).
...
These data points provide insights into various performance aspects of your website, such as the time it takes to display the first content ( [FCP](https://vercel.com/docs/speed-insights/metrics#first-contentful-paint-fcp)) and the delay between user input and response ( [FID](https://vercel.com/docs/speed-insights/metrics#first-input-delay-fid)). By analyzing these data points, you can gain valuable information to optimize and enhance the performance of your website.

### [How the percentages are calculated?](https://vercel.com/docs/speed-insights/metrics\#how-the-percentages-are-calculated)
...
For instance, a P75 score of 1 second for [First Contentful Paint (FCP)](https://vercel.com/docs/speed-insights/metrics#first-contentful-paint-fcp) means that 75% of your users experience an FCP faster than 1 second. Similarly, a P99 score of 8 seconds means 99% of your users experience an FCP faster than 8 seconds.

## [Interpreting performance scores](https://vercel.com/docs/speed-insights/metrics\#interpreting-performance-scores)

Performance metrics, including the [Real Experience Score](https://vercel.com/docs/speed-insights/metrics#real-user-monitoring), the [Virtual Experience Score](https://vercel.com/docs/speed-insights/metrics#predictive-performance-metrics-with-virtual-experience-score), and the individual [Core Web Vitals](https://vercel.com/docs/speed-insights/metrics#core-web-vitals-explained) (along with [Other Web Vitals](https://vercel.com/docs/speed-insights/metrics#other-metrics)) are color-coded as follows:
...
### [Implications of scores for the end-user experience](https://vercel.com/docs/speed-insights/metrics\#implications-of-scores-for-the-end-user-experience)
...
## [Predictive performance metrics with Virtual Experience Score](https://vercel.com/docs/speed-insights/metrics\#predictive-performance-metrics-with-virtual-experience-score)

The Real Experience Score ( [RES](https://vercel.com/docs/speed-insights/metrics#real-user-monitoring)) displayed in the Speed Insights tab is derived from actual data points collected from your visitors' devices. As such, it can only offer insight into your app's performance post-deployment. While it's critical to gather these real-world data points, they only reflect user experiences after the fact, limiting their predictive power.
...
- In place of the First Input Delay ( [FID](https://vercel.com/docs/speed-insights/metrics#first-input-delay-fid)) Core Web Vital, the Virtual Experience Score utilizes Total Blocking Time ( [TBT](https://vercel.com/docs/speed-insights/metrics#total-blocking-time-tbt))
...
## [Breaking down data in Speed Insights](https://vercel.com/docs/speed-insights/metrics\#breaking-down-data-in-speed-insights)

Speed Insights offers a variety of views to help you analyze your application's performance data. This allows you to identify areas that need improvement and make informed decisions about how to optimize your site. To learn more, see [Using Speed Insights](https://vercel.com/docs/speed-insights/using-speed-insights).
