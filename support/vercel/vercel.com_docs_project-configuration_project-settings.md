...
From the Vercel [dashboard](https://vercel.com/dashboard), there are two areas where you can configure settings:
...
- Project Settings: These are specific settings, accessed through the [project dashboard](https://vercel.com/docs/projects/project-dashboard), that are only scoped to the selected project. You can make changes about all areas relating to your project, including domains, functions, drains, integrations, Git, caching, environment variables, deployment protection, and security.
...
## [Configuring your project with a vercel.json file](https://vercel.com/docs/project-configuration/project-settings\#configuring-your-project-with-a-vercel.json-file)
...
To learn more, see [Configuring projects with vercel.json](https://vercel.com/docs/project-configuration).

## [General settings](https://vercel.com/docs/project-configuration/project-settings\#general-settings)
...
To learn more, see [General Settings](https://vercel.com/docs/project-configuration/general-settings)

## [Build and deployment settings](https://vercel.com/docs/project-configuration/project-settings\#build-and-deployment-settings)
...
## [Custom domains](https://vercel.com/docs/project-configuration/project-settings\#custom-domains)

You can [add custom domains](https://vercel.com/docs/domains/add-a-domain) for each project.

To learn more, [see the Domains documentation](https://vercel.com/docs/domains)

## [Environment Variables](https://vercel.com/docs/project-configuration/project-settings\#environment-variables)

You can configure Environment Variables for each environment directly from your project's settings. This includes [linking Shared Environment Variables](https://vercel.com/docs/environment-variables/shared-environment-variables#project-level-linking) and [creating Sensitive Environment Variables](https://vercel.com/docs/environment-variables/sensitive-environment-variables)

To learn more, [see the Environment Variables documentation](https://vercel.com/docs/environment-variables).

## [Git](https://vercel.com/docs/project-configuration/project-settings\#git)

In your project settings, you can manage the Git connection, enable Git LFS, and manage your build step settings.

To learn more about the settings, see [Git Settings](https://vercel.com/docs/project-configuration/git-settings). To learn more about working with your Git integration, see [Git Integrations](https://vercel.com/docs/git).

## [Integrations](https://vercel.com/docs/project-configuration/project-settings\#integrations)

To manage third-party integrations for your project, you can use the Integrations settings.

To learn more, see [Integrations](https://vercel.com/docs/integrations).

## [Deployment Protection](https://vercel.com/docs/project-configuration/project-settings\#deployment-protection)

Protect your project deployments with [Vercel Authentication](https://vercel.com/docs/security/deployment-protection/methods-to-protect-deployments/vercel-authentication) and [Password Protection](https://vercel.com/docs/security/deployment-protection/methods-to-protect-deployments/password-protection), and more.

To learn more, see [Deployment Protection](https://vercel.com/docs/security/deployment-protection).

## [Functions](https://vercel.com/docs/project-configuration/project-settings\#functions)
...
To learn more, see [Configuring Functions](https://vercel.com/docs/functions/configuring-functions).

## [Cron Jobs](https://vercel.com/docs/project-configuration/project-settings\#cron-jobs)
...
To learn more, see [Cron Jobs](https://vercel.com/docs/cron-jobs).

## [Project members](https://vercel.com/docs/project-configuration/project-settings\#project-members)
...
To learn more, see [project-level roles](https://vercel.com/docs/rbac/access-roles/project-level-roles).

## [Webhooks](https://vercel.com/docs/project-configuration/project-settings\#webhooks)
...
To learn more, see the [Webhooks documentation](https://vercel.com/docs/webhooks).

## [Drains](https://vercel.com/docs/project-configuration/project-settings\#drains)
...
To learn more, see the [Drains documentation](https://vercel.com/docs/drains/using-drains).

## [Security settings](https://vercel.com/docs/project-configuration/project-settings\#security-settings)

From your project's security settings you can enable or disable [Attack Challenge Mode](https://vercel.com/docs/attack-challenge-mode), [Logs and Source Protection](https://vercel.com/docs/projects/overview#logs-and-source-protection), [Customer Success Code Visibility](https://vercel.com/docs/projects/overview#customer-success-code-visibility) [Git Fork Protection](https://vercel.com/docs/projects/overview#git-fork-protection), and set a [retention policy for your deployments](https://vercel.com/docs/security/deployment-retention).

To learn more, see [Security Settings](https://vercel.com/docs/project-configuration/security-settings).

## [Advanced](https://vercel.com/docs/project-configuration/project-settings\#advanced)

Vercel provides some additional features in order to configure your project in a more advanced way. This includes:

- Displaying [directory listing](https://vercel.com/docs/directory-listing)
- Enabling [Skew protection](https://vercel.com/docs/skew-protection)
