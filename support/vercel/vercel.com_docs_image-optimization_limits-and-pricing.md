...
## [Pricing](https://vercel.com/docs/image-optimization/limits-and-pricing\#pricing)

This is the default pricing option. For Pro and Enterprise teams created
...
images-based](https://vercel.com/docs/image-optimization/legacy-pricing) pricing plan. Upgrading
or downgrading your plan will automatically opt-in your team.

Image optimization pricing is dependent on your plan and on specific parameters outlined in the table below. For detailed pricing information for each region, review [Regional Pricing](https://vercel.com/docs/pricing/regional-pricing#specific-region-pricing).

| Image Usage | Hobby Included | On-demand Rates |
| --- | --- | --- |
| [Image transformations](https://vercel.com/docs/image-optimization/limits-and-pricing#image-transformations) | 5K/month | [$0.05 - $0.0812 per 1K](https://vercel.com/docs/pricing/regional-pricing#specific-region-pricing) |
| [Image cache reads](https://vercel.com/docs/image-optimization/limits-and-pricing#image-cache-reads) | 300K/month | [$0.40 - $0.64 per 1M](https://vercel.com/docs/pricing/regional-pricing#specific-region-pricing) |
| [Image cache writes](https://vercel.com/docs/image-optimization/limits-and-pricing#image-cache-writes) | 100K/month | [$4.00 - $6.40 per 1M](https://vercel.com/docs/pricing/regional-pricing#specific-region-pricing) |
...
## [Image transformations](https://vercel.com/docs/image-optimization/limits-and-pricing\#image-transformations)

Image transformations are billed for every cache MISS and STALE. The cache key is based on several inputs and differs for [local images cache key](https://vercel.com/docs/image-optimization#local-images-cache-key) vs the [remote images cache key](https://vercel.com/docs/image-optimization#remote-images-cache-key).

## [Image cache reads](https://vercel.com/docs/image-optimization/limits-and-pricing\#image-cache-reads)
...
## [Image cache writes](https://vercel.com/docs/image-optimization/limits-and-pricing\#image-cache-writes)
...
You are billed for the number of [Image Transformations](https://vercel.com/docs/image-optimization/limits-and-pricing#image-transformations), [Image Cache Reads](https://vercel.com/docs/image-optimization/limits-and-pricing#image-cache-reads), and [Image Cache Writes](https://vercel.com/docs/image-optimization/limits-and-pricing#image-cache-writes) during the billing period.

Additionally, charges apply for [Fast Data Transfer](https://vercel.com/docs/manage-cdn-usage#fast-data-transfer) and [Edge Requests](https://vercel.com/docs/manage-cdn-usage#edge-requests) when transformed images are delivered from Vercel's [CDN](https://vercel.com/docs/cdn) to clients.

### [Hobby](https://vercel.com/docs/image-optimization/limits-and-pricing\#hobby)
...
Vercel will send you emails as you are nearing your [usage](https://vercel.com/docs/image-optimization/limits-and-pricing#pricing) limits, but you will also be advised of any alerts within the [dashboard](https://vercel.com/dashboard).

Once you exceed the limits:

- New images will fail to optimize and instead return a runtime error response with [402 status code](https://vercel.com/docs/errors/platform-error-codes#402:-deployment_disabled). This will trigger the [`onError`](https://nextjs.org/docs/app/api-reference/components/image#onerror) callback and show the [`alt`](https://nextjs.org/docs/app/api-reference/components/image#alt) text instead of the image
...
### [Pro and Enterprise](https://vercel.com/docs/image-optimization/limits-and-pricing\#pro-and-enterprise)
...
## [Limits](https://vercel.com/docs/image-optimization/limits-and-pricing\#limits)

For all the images that are [optimized by Vercel](https://vercel.com/docs/image-optimization/managing-image-optimization-costs#measuring-usage), the following limits apply:

- The maximum size for an transformed image is 10 MB, as set out in the [Cacheable Responses limits](https://vercel.com/docs/edge-cache#how-to-cache-responses)
