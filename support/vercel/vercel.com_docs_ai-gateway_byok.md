...
Using your own credentials with an external AI provider allows AI Gateway to authenticate requests on your behalf with [no added markup](https://vercel.com/docs/ai-gateway/pricing#using-a-custom-api-key).
...
## [Getting started](https://vercel.com/docs/ai-gateway/byok\#getting-started)

1. ### [Retrieve credentials from your AI provider](https://vercel.com/docs/ai-gateway/byok\#retrieve-credentials-from-your-ai-provider)
...
2. ### [Add the credentials to your Vercel team](https://vercel.com/docs/ai-gateway/byok\#add-the-credentials-to-your-vercel-team)
...
3. ### [Use the credentials in your AI Gateway requests](https://vercel.com/docs/ai-gateway/byok\#use-the-credentials-in-your-ai-gateway-requests)
...
## [Testing your credentials](https://vercel.com/docs/ai-gateway/byok\#testing-your-credentials)
...
- [Getting started](https://vercel.com/docs/ai-gateway/byok#getting-started)
- [Retrieve credentials from your AI provider](https://vercel.com/docs/ai-gateway/byok#retrieve-credentials-from-your-ai-provider)
- [Add the credentials to your Vercel team](https://vercel.com/docs/ai-gateway/byok#add-the-credentials-to-your-vercel-team)
- [Use the credentials in your AI Gateway requests](https://vercel.com/docs/ai-gateway/byok#use-the-credentials-in-your-ai-gateway-requests)
- [Testing your credentials](https://vercel.com/docs/ai-gateway/byok#testing-your-credentials)
