---
url: "https://vercel.com/docs/rest-api/reference/endpoints/edge-config/delete-an-edge-config"
title: "Delete an Edge Config - Vercel API Docs"
---

[Skip to main content](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/delete-an-edge-config#content-area)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/delete-an-edge-config#authorization-authorization)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/delete-an-edge-config#parameter-edge-config-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/delete-an-edge-config#parameter-team-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/delete-an-edge-config#parameter-slug)
...
[Update an Edge Config](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-an-edge-config) [Get Edge Config items](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items)
