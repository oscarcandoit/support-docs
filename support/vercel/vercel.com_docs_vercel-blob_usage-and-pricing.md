---
url: "https://vercel.com/docs/vercel-blob/usage-and-pricing"
...
## [Usage](https://vercel.com/docs/vercel-blob/usage-and-pricing\#usage)
...
## [Pricing](https://vercel.com/docs/vercel-blob/usage-and-pricing\#pricing)
...
| Resource | Hobby Included | On-demand Rates |
| --- | --- | --- |
| [Blob Storage Size](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | 1GB/month | $0.023 per GB |
| [Blob Simple Operations](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | First 10,000 | $0.400 per 1M |
| [Blob Advanced Operations](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | First 2,000 | $5.000 per 1M |
| [Blob Data Transfer](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | First 10 GB | $0.050 per GB |

Managed Infrastructure pricing

[Edge Requests](https://vercel.com/docs/pricing/networking#edge-requests) and [Fast Origin\\
Transfer](https://vercel.com/docs/pricing/networking#fast-origin-transfer) for blobs are billed
at standard [CDN rates](https://vercel.com/docs/cdn#pricing). The included resource usage for
the Hobby plan is shared across all Vercel services in your project.

## [Usage details](https://vercel.com/docs/vercel-blob/usage-and-pricing\#usage-details)
...
## [Hobby](https://vercel.com/docs/vercel-blob/usage-and-pricing\#hobby)

Vercel Blob is free for Hobby users within the [usage limits](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing).
...
## [Pro](https://vercel.com/docs/vercel-blob/usage-and-pricing\#pro)
...
## [Enterprise](https://vercel.com/docs/vercel-blob/usage-and-pricing\#enterprise)
...
## [Pricing Example](https://vercel.com/docs/vercel-blob/usage-and-pricing\#pricing-example)
...
## [Limits](https://vercel.com/docs/vercel-blob/usage-and-pricing\#limits)

Vercel Blob has certain [limits](https://vercel.com/docs/limits) that you should be aware of when designing your application.

### [Operation rate limits](https://vercel.com/docs/vercel-blob/usage-and-pricing\#operation-rate-limits)
...
### [Size limits](https://vercel.com/docs/vercel-blob/usage-and-pricing\#size-limits)
...
## [Observability](https://vercel.com/docs/vercel-blob/usage-and-pricing\#observability)
