...
## [Multimodal LLMs](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk\#multimodal-llms)
...
### [Nano Banana (`google/gemini-2.5-flash-image`)](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk\#nano-banana-google/gemini-2.5-flash-image)
...
To save generated images to disk, see [Save generated images](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk#save-generated-images).

generateTextstreamText
...
### [Nano Banana Pro (`google/gemini-3-pro-image`)](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk\#nano-banana-pro-google/gemini-3-pro-image)
...
### [OpenAI models with image generation tool](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk\#openai-models-with-image-generation-tool)
...
OpenAI images are returned as base64-encoded strings. To save them to disk, you'll need to decode the base64 string first. For multimodal models that return images in `result.files`, see [Save generated images](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk#save-generated-images).

### [Save generated images](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk\#save-generated-images)
...
## [Dedicated image models](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk\#dedicated-image-models)

These models are specialized for image generation and use the `experimental_generateImage` function.

### [Google Vertex Imagen](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk\#google-vertex-imagen)
...
To save generated images to disk, see [Save generated images from dedicated models](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk#save-generated-images-from-dedicated-models).
...
### [Black Forest Labs](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk\#black-forest-labs)
...
### [Save generated images from dedicated models](https://vercel.com/docs/ai-gateway/image-generation/ai-sdk\#save-generated-images-from-dedicated-models)
