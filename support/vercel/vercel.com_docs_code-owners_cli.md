---
url: "https://vercel.com/docs/code-owners/cli"
...
## [Using the CLI](https://vercel.com/docs/code-owners/cli\#using-the-cli)

The Code Owners CLI is separate to the [Vercel CLI](https://vercel.com/docs/cli). However you
must ensure that the Vercel CLI is
[installed](https://vercel.com/docs/cli#installing-vercel-cli) and that you are [logged\\
in](https://vercel.com/docs/cli/login) to use the Code Owners CLI.

## [Sub-commands](https://vercel.com/docs/code-owners/cli\#sub-commands)

The following sub-commands are available for this CLI.

### [`init`](https://vercel.com/docs/code-owners/cli\#init)

The `init` command sets up code owners files in the repository. See
[Getting Started](https://vercel.com/docs/code-owners/getting-started#initalizing-code-owners) for more information on
using this command.

### [`validate`](https://vercel.com/docs/code-owners/cli\#validate)
