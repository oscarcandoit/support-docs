...
When you enable Speed Insights, data will be tracked on all deployed
environments, including
[preview](https://vercel.com/docs/deployments/environments#preview-environment-pre-production)
and [production](https://vercel.com/docs/deployments/environments#production-environment)
deployments.

## [Dashboard view](https://vercel.com/docs/speed-insights\#dashboard-view)
...
Once you [enable Speed Insights](https://vercel.com/docs/speed-insights/quickstart), you can access the dashboard by selecting your project in the Vercel [dashboard](https://vercel.com/dashboard), and clicking the Speed Insights tab.
...
## [More resources](https://vercel.com/docs/speed-insights\#more-resources)
