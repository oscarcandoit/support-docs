---
url: "https://vercel.com/docs/code-owners/getting-started"
...
Code Ownersare availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)

To [set up Code Owners](https://vercel.com/docs/code-owners/getting-started#setting-up-code-owners-in-your-repository) in your repository, you'll need to do the following:

- Set up [Vercel's private npm registry](https://vercel.com/docs/private-registry) to install the necessary packages
- [Install and initialize](https://vercel.com/docs/code-owners/getting-started#setting-up-code-owners-in-your-repository) Code Owners in your repository
- [Add your repository](https://vercel.com/docs/code-owners/getting-started#adding-your-repository-to-the-vercel-dashboard) to your Vercel dashboard

If you've already set up Conformance, you may have already completed some of these steps.

## [Prerequisites](https://vercel.com/docs/code-owners/getting-started\#prerequisites)

### [Get access to Code Owners](https://vercel.com/docs/code-owners/getting-started\#get-access-to-code-owners)
...
### [Setting up Vercel's private npm registry](https://vercel.com/docs/code-owners/getting-started\#setting-up-vercel's-private-npm-registry)
...
- [Set up your local environment](https://vercel.com/docs/private-registry#setting-up-your-local-environment) – This should be completed by the team owner, but each member of your team will need to log in
- [Set up Vercel](https://vercel.com/docs/private-registry#setting-up-vercel) – This should be completed by the team owner
- [Set up Code Owners for use with CI](https://vercel.com/docs/private-registry#setting-up-your-ci-provider) – This should be completed by the team owner

## [Setting up Code Owners in your repository](https://vercel.com/docs/code-owners/getting-started\#setting-up-code-owners-in-your-repository)

A GitHub App enables Code Owners functionality by adding reviewers and
enforcing review checks for merging PRs.

1. ### [Set up the Vercel CLI](https://vercel.com/docs/code-owners/getting-started\#set-up-the-vercel-cli)



The Code Owners CLI is separate to the [Vercel CLI](https://vercel.com/docs/cli), however it uses
the Vercel CLI for authentication.

Before continuing, please ensure that the Vercel CLI is [installed](https://vercel.com/docs/cli#installing-vercel-cli)
and that you are [logged in](https://vercel.com/docs/cli/login).

2. ### [Initalizing Code Owners](https://vercel.com/docs/code-owners/getting-started\#initalizing-code-owners)
...
`yarn dlx` only works with Yarn version 2 or newer, for Yarn v1 use the npx
command.
...
3. ### [Install the GitHub App into a repository](https://vercel.com/docs/code-owners/getting-started\#install-the-github-app-into-a-repository)
...
4. ### [Define Code Owners files](https://vercel.com/docs/code-owners/getting-started\#define-code-owners-files)
...
5. ### [Test Code Owners on a new pull request](https://vercel.com/docs/code-owners/getting-started\#test-code-owners-on-a-new-pull-request)
...
6. ### [Add the Code Owners check as required](https://vercel.com/docs/code-owners/getting-started\#add-the-code-owners-check-as-required)
...
## [Adding your repository to the Vercel dashboard](https://vercel.com/docs/code-owners/getting-started\#adding-your-repository-to-the-vercel-dashboard)
...
1. ### [Import your repository](https://vercel.com/docs/code-owners/getting-started\#import-your-repository)



1. Ensure your team is selected in the [scope selector](https://vercel.com/docs/dashboard-features#scope-selector).
...
2. ### [Configure your repository](https://vercel.com/docs/code-owners/getting-started\#configure-your-repository)
...
## [More resources](https://vercel.com/docs/code-owners/getting-started\#more-resources)

- [Code Owners CLI](https://vercel.com/docs/code-owners/cli)
- [Conformance](https://vercel.com/docs/conformance)
...
- [Setting up Vercel's private npm registry](https://vercel.com/docs/code-owners/getting-started#setting-up-vercel's-private-npm-registry)
- [Setting up Code Owners in your repository](https://vercel.com/docs/code-owners/getting-started#setting-up-code-owners-in-your-repository)
- [Set up the Vercel CLI](https://vercel.com/docs/code-owners/getting-started#set-up-the-vercel-cli)
- [Initalizing Code Owners](https://vercel.com/docs/code-owners/getting-started#initalizing-code-owners)
- [Install the GitHub App into a repository](https://vercel.com/docs/code-owners/getting-started#install-the-github-app-into-a-repository)
- [Define Code Owners files](https://vercel.com/docs/code-owners/getting-started#define-code-owners-files)
- [Test Code Owners on a new pull request](https://vercel.com/docs/code-owners/getting-started#test-code-owners-on-a-new-pull-request)
- [Add the Code Owners check as required](https://vercel.com/docs/code-owners/getting-started#add-the-code-owners-check-as-required)
- [Adding your repository to the Vercel dashboard](https://vercel.com/docs/code-owners/getting-started#adding-your-repository-to-the-vercel-dashboard)
- [Import your repository](https://vercel.com/docs/code-owners/getting-started#import-your-repository)
- [Configure your repository](https://vercel.com/docs/code-owners/getting-started#configure-your-repository)
- [More resources](https://vercel.com/docs/code-owners/getting-started#more-resources)
