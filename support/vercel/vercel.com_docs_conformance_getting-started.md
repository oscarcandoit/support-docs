---
url: "https://vercel.com/docs/conformance/getting-started"
...
To [set up Conformance](https://vercel.com/docs/conformance/getting-started#setting-up-conformance-in-your-repository) in your repository, you must:

- Set up [Vercel's private npm registry](https://vercel.com/docs/private-registry) to install the necessary packages
- [Install and initialize](https://vercel.com/docs/conformance/getting-started#setting-up-conformance-in-your-repository) Conformance in your repository

If you've already set up Code Owners, you may have already completed some of these steps.

## [Prerequisites](https://vercel.com/docs/conformance/getting-started\#prerequisites)

### [Get access to Conformance](https://vercel.com/docs/conformance/getting-started\#get-access-to-conformance)
...
### [Setting up Vercel's private npm registry](https://vercel.com/docs/conformance/getting-started\#setting-up-vercel's-private-npm-registry)
...
- [Optionally, set up Conformance for use with CI](https://vercel.com/docs/private-registry#setting-up-your-ci-provider) – This should be completed by the team owner

## [Setting up Conformance in your repository](https://vercel.com/docs/conformance/getting-started\#setting-up-conformance-in-your-repository)

This section guides you through setting up Conformance for your repository.

1. ### [Set up the Vercel CLI](https://vercel.com/docs/conformance/getting-started\#set-up-the-vercel-cli)



The Conformance CLI is separate to the [Vercel CLI](https://vercel.com/docs/cli), however it
...
2. ### [Initialize Conformance](https://vercel.com/docs/conformance/getting-started\#initialize-conformance)
...
3. ### [Review the generated changes](https://vercel.com/docs/conformance/getting-started\#review-the-generated-changes)
...
The Conformance `init` command creates the following changes:
   ...
   - It adds any existing Conformance errors to allowlists, letting you start using Conformance without immediate fixes and allowing you to gradually resolve these allowlist entries over time. Learn more about Conformance Allowlists in the [documentation](https://vercel.com/docs/conformance/allowlist).

Once you've reviewed these, open a pull request with the changes and merge it.

4. ### [Add owners for allowlist files](https://vercel.com/docs/conformance/getting-started\#add-owners-for-allowlist-files)



\\*\\* This step assumes you have [set up Code Owners](https://vercel.com/docs/code-owners/getting-started).\*\*
...
Learn more about [wildcard syntax](https://vercel.com/docs/code-owners/code-approvers#globstar-pattern)
and [`:required` syntax](https://vercel.com/docs/code-owners/code-approvers#required) from Code Owners.

5. ### [Add Conformance to your CI system](https://vercel.com/docs/conformance/getting-started\#add-conformance-to-your-ci-system)



You can integrate Conformance in your CI to avoid merging errors into your code. To learn more, see [Setting up your CI provider](https://vercel.com/docs/private-registry#setting-up-your-ci-provider).


## [More resources](https://vercel.com/docs/conformance/getting-started\#more-resources)
...
- [Setting up Vercel's private npm registry](https://vercel.com/docs/conformance/getting-started#setting-up-vercel's-private-npm-registry)
- [Setting up Conformance in your repository](https://vercel.com/docs/conformance/getting-started#setting-up-conformance-in-your-repository)
- [Set up the Vercel CLI](https://vercel.com/docs/conformance/getting-started#set-up-the-vercel-cli)
- [Initialize Conformance](https://vercel.com/docs/conformance/getting-started#initialize-conformance)
- [Review the generated changes](https://vercel.com/docs/conformance/getting-started#review-the-generated-changes)
- [Add owners for allowlist files](https://vercel.com/docs/conformance/getting-started#add-owners-for-allowlist-files)
- [Add Conformance to your CI system](https://vercel.com/docs/conformance/getting-started#add-conformance-to-your-ci-system)
- [More resources](https://vercel.com/docs/conformance/getting-started#more-resources)
