...
Access Groupsare availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
4. Select the projects and [project roles](https://vercel.com/docs/rbac/access-roles/project-level-roles) to assign
...
2. By [editing each Access Group](https://vercel.com/docs/rbac/access-groups#add-and-remove-members-from-an-access-group) using the Edit Access Group button and editing the Members list
...
Contributors and Developers can increase their level of permissions in a
