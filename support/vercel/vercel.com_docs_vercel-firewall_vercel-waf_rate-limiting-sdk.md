---
url: "https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk"
...
## [Using `@vercel/firewall`](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk\#using-@vercel/firewall)

1. ### [Create a `@vercel/firewall` rule](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk\#create-a-@vercel/firewall-rule)
...
2. ### [Configure rate limiting in code](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk\#configure-rate-limiting-in-code)
...
3. ### [Test in a preview deployment](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk\#test-in-a-preview-deployment)
...
## [Target a user's organization](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk\#target-a-user's-organization)
...
### [Update the custom rule filters](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk\#update-the-custom-rule-filters)
...
### [Use the `rateLimitKey` in code](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk\#use-the-ratelimitkey-in-code)
...
- [Using @vercel/firewall](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk#using-@vercel/firewall)
- [Create a @vercel/firewall rule](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk#create-a-@vercel/firewall-rule)
- [Configure rate limiting in code](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk#configure-rate-limiting-in-code)
- [Test in a preview deployment](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk#test-in-a-preview-deployment)
- [Target a user's organization](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk#target-a-user's-organization)
- [Update the custom rule filters](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk#update-the-custom-rule-filters)
- [Use the rateLimitKey in code](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting-sdk#use-the-ratelimitkey-in-code)
