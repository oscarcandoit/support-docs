...
## [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex\#getting-started)

1. ### [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex\#create-a-new-project)
...
2. ### [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex\#install-dependencies)
...
3. ### [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex\#configure-environment-variables)
...
4. ### [Create your LlamaIndex application](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex\#create-your-llamaindex-application)
...
5. ### [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex\#running-the-application)
...
- [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex#getting-started)
- [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex#create-a-new-project)
- [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex#install-dependencies)
- [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex#configure-environment-variables)
- [Create your LlamaIndex application](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex#create-your-llamaindex-application)
- [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/llamaindex#running-the-application)
