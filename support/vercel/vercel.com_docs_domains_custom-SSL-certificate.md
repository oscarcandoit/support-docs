...
Uploading Custom SSL Certificatesare availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
Custom SSL certificates can be uploaded through the [Domains tab on your team's dashboard](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fdomains&title=Go+to+team%27s+domains+page), or by using the [Vercel REST API](https://vercel.com/docs/rest-api/reference/endpoints/certs/upload-a-cert#upload-a-cert).
