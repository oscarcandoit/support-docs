...
## [Pricing](https://vercel.com/docs/image-optimization/legacy-pricing\#pricing)

This legacy pricing option is only available to Pro and Enterprise teams
...
plan](https://vercel.com/docs/image-optimization/limits-and-pricing) or stay on this legacy
source images-based pricing plan. Upgrading or downgrading your plan will
automatically opt-in your team.

Image Optimization pricing is dependent on your plan and how many unique [source images](https://vercel.com/docs/image-optimization/legacy-pricing#source-images) you have across your projects during your billing period.

| Resource | Hobby Included | Pro Included | Pro Additional |
| --- | --- | --- | --- |
| [Image Optimization Source Images](https://vercel.com/docs/image-optimization/legacy-pricing#source-images) | First 1,000 | First 5,000 | $5.00 per 1,000 Images |

## [Usage](https://vercel.com/docs/image-optimization/legacy-pricing\#usage)
...
### [Source Images](https://vercel.com/docs/image-optimization/legacy-pricing\#source-images)
...
## [Billing](https://vercel.com/docs/image-optimization/legacy-pricing\#billing)

You are billed for the number of unique [source images](https://vercel.com/docs/image-optimization/legacy-pricing#source-images) requested during the billing period.

Additionally, charges apply for [Fast Data Transfer](https://vercel.com/docs/manage-cdn-usage#fast-data-transfer) when optimized images are delivered from Vercel's [CDN](https://vercel.com/docs/cdn) to clients.

### [Hobby](https://vercel.com/docs/image-optimization/legacy-pricing\#hobby)

Image Optimization is free for Hobby users within the [usage limits](https://vercel.com/docs/limits/fair-use-guidelines#typical-monthly-usage-guidelines). As stated in the [Fair Usage Policy](https://vercel.com/docs/limits/fair-use-guidelines#commercial-usage), Hobby teams are restricted to non-commercial personal use only.

Vercel will send you emails as you are nearing your [usage](https://vercel.com/docs/image-optimization/legacy-pricing#pricing) limits, but you will also be advised of any alerts within the [dashboard](https://vercel.com/dashboard).

Once you exceed the limits:

- New [source images](https://vercel.com/docs/image-optimization/legacy-pricing#source-images) will fail to optimize and instead return a runtime error response with [402 status code](https://vercel.com/docs/errors/platform-error-codes#402:-deployment_disabled). This will trigger the [`onError`](https://nextjs.org/docs/app/api-reference/components/image#onerror) callback and show the [`alt`](https://nextjs.org/docs/app/api-reference/components/image#alt) text instead of the image
- Previously optimized images have already been cached and will continue to work as expected, without error

You will not be charged for exceeding the usage limits, but this usually means your application is ready to upgrade to a [Pro plan](https://vercel.com/docs/plans/pro).
...
### [Pro and Enterprise](https://vercel.com/docs/image-optimization/legacy-pricing\#pro-and-enterprise)

For Teams on Pro trials, the [trial will end](https://vercel.com/docs/plans/pro-plan/trials#post-trial-decision) if your Team uses over 2500 source images. For more information, see the [trial limits](https://vercel.com/docs/plans/pro-plan/trials#trial-limitations).

Vercel will send you emails as you are nearing your [usage](https://vercel.com/docs/image-optimization/legacy-pricing#pricing) limits, but you will also be advised of any alerts within the [dashboard](https://vercel.com/dashboard). Once your team exceeds the 5000 source images limit, you will continue to be charged $5 per 1000 source images for on-demand usage.
...
## [Limits](https://vercel.com/docs/image-optimization/legacy-pricing\#limits)

For all the images that are optimized by Vercel, the following limits apply:

- The maximum size for an optimized image is 10 MB, as set out in the [Cacheable Responses limits](https://vercel.com/docs/edge-cache#how-to-cache-responses)
- Each [source image](https://vercel.com/docs/image-optimization/legacy-pricing#source-images) has a maximum width and height of 8192 pixels
- A [source image](https://vercel.com/docs/image-optimization/legacy-pricing#source-images) must be one of the following formats to be optimized: `image/jpeg`, `image/png`, `image/webp`, `image/avif`. Other formats will be served as-is
