...
React Router is a multi-strategy router for React. When used [as a framework](https://reactrouter.com/home#react-router-as-a-framework), React Router enables fullstack, [server-rendered](https://vercel.com/docs/frameworks/frontend/react-router#server-side-rendering-ssr) React applications. Its built-in features for nested pages, error boundaries, transitions between loading states, and more, enable developers to create modern web apps.
...
Preset](https://vercel.com/docs/frameworks/frontend/react-router#vercel-react-router-preset) when deploying to Vercel.

## [`@vercel/react-router`](https://vercel.com/docs/frameworks/frontend/react-router\#@vercel/react-router)
...
- `@vercel/react-router/vite` import
  - Contains the [Vercel Preset](https://vercel.com/docs/frameworks/frontend/react-router#vercel-react-router-preset) to enhance React Router functionality on Vercel
- `@vercel/react-router/entry.server` import
  - For situations where you need to [define a custom `entry.server` file](https://vercel.com/docs/frameworks/frontend/react-router#using-a-custom-app/entry.server-file).
...
## [Vercel React Router Preset](https://vercel.com/docs/frameworks/frontend/react-router\#vercel-react-router-preset)
...
## [Server-Side Rendering (SSR)](https://vercel.com/docs/frameworks/frontend/react-router\#server-side-rendering-ssr)
...
## [Response streaming](https://vercel.com/docs/frameworks/frontend/react-router\#response-streaming)

[Streaming HTTP responses](https://vercel.com/docs/functions/streaming-functions)

with React Router on Vercel is supported with Vercel Functions. See the
[Streaming with Suspense](https://reactrouter.com/how-to/suspense) page in the
React Router docs for general instructions.
...
## [`Cache-Control` headers](https://vercel.com/docs/frameworks/frontend/react-router\#cache-control-headers)
...
## [Analytics](https://vercel.com/docs/frameworks/frontend/react-router\#analytics)

[Vercel's Analytics](https://vercel.com/docs/analytics) features enable you to visualize and monitor your application's performance over time. The Analytics tab in your project's dashboard offers detailed insights into your website's visitors, with metrics like top pages, top referrers, and user demographics.
...
## [Using a custom server entrypoint](https://vercel.com/docs/frameworks/frontend/react-router\#using-a-custom-server-entrypoint)
...
## [Using a custom `app/entry.server` file](https://vercel.com/docs/frameworks/frontend/react-router\#using-a-custom-app/entry.server-file)
...
## [More benefits](https://vercel.com/docs/frameworks/frontend/react-router\#more-benefits)
...
## [More resources](https://vercel.com/docs/frameworks/frontend/react-router\#more-resources)
