...
![Visitors tab data.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fanalytics%2Fvisitor-chart-light.png&w=3840&q=75)![Visitors tab data.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fanalytics%2Fvisitor-chart-dark.png&w=3840&q=75)Visitors tab data.
...
- Privacy: Web Analytics only stores anonymized data and [does not use cookies](https://vercel.com/docs/analytics#how-visitors-are-determined), providing data for you while respecting your visitors' privacy and web experience.
...
To set up Web Analytics for your project, see the [Quickstart](https://vercel.com/docs/analytics/quickstart).
...
## [Visitors](https://vercel.com/docs/analytics\#visitors)
...
You can use the [panels](https://vercel.com/docs/analytics#panels) section to view a breakdown of specific information, organized by the total number of visitors.

### [How visitors are determined](https://vercel.com/docs/analytics\#how-visitors-are-determined)
...
## [Page views](https://vercel.com/docs/analytics\#page-views)
...
You can use the [panels](https://vercel.com/docs/analytics#panels) section to view a breakdown of specific information, organized by the total number of page views.

## [Bounce rate](https://vercel.com/docs/analytics\#bounce-rate)
...
### [How bounce rate is calculated](https://vercel.com/docs/analytics\#how-bounce-rate-is-calculated)
...
## [Panels](https://vercel.com/docs/analytics\#panels)

Panels provide a way to view detailed analytics for Visitors and Page Views, such as top pages and referrers. They'll also show additional information such as the country, OS, and device or browser of your visitors, and configured options such as [custom events](https://vercel.com/docs/analytics/custom-events) and [feature flag](https://vercel.com/docs/feature-flags) usage.
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fobservability%2Fpanels-light-mode.png&w=3840&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fobservability%2Fpanels-dark-mode.png&w=3840&q=75)

Panels showing a breakdown of page view data.

You can export the up to 250 entries from the panel as a CSV file. See [Exporting data as CSV](https://vercel.com/docs/analytics/using-web-analytics#exporting-data-as-csv) for more information.

## [Bots](https://vercel.com/docs/analytics\#bots)
