...
The `vercel curl` command works like `curl`, but automatically handles deployment protection bypass tokens for you. When your project has [Deployment Protection](https://vercel.com/docs/security/deployment-protection) enabled, this command lets you test protected deployments without manually managing bypass secrets.

The command runs the system `curl` command with the same arguments you provide, but adds an [`x-vercel-protection-bypass`](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/protection-bypass-automation#using-protection-bypass-for-automation) header with a valid token. This makes it simple to test API endpoints, check responses, or debug issues on protected deployments.

This command is available in Vercel CLI v48.8.0 and later. If you're using an older version, see [Updating Vercel CLI](https://vercel.com/docs/cli#updating-vercel-cli).

## [Usage](https://vercel.com/docs/cli/curl\#usage)
...
Using the `vercel curl` command to make an HTTP request
to a deployment.

## [Examples](https://vercel.com/docs/cli/curl\#examples)

### [Basic request](https://vercel.com/docs/cli/curl\#basic-request)
...
Making a GET request to the `/api/hello` endpoint on
your production deployment.

### [POST request with data](https://vercel.com/docs/cli/curl\#post-request-with-data)
...
### [Request specific deployment](https://vercel.com/docs/cli/curl\#request-specific-deployment)
...
### [Verbose output](https://vercel.com/docs/cli/curl\#verbose-output)
...
Using curl's `-v` flag for verbose output, which shows
headers and connection details.

## [How it works](https://vercel.com/docs/cli/curl\#how-it-works)
...
## [Unique options](https://vercel.com/docs/cli/curl\#unique-options)

These are options that only apply to the `vercel curl` command.

### [Deployment](https://vercel.com/docs/cli/curl\#deployment)
...
### [Protection Bypass](https://vercel.com/docs/cli/curl\#protection-bypass)
...
## [Troubleshooting](https://vercel.com/docs/cli/curl\#troubleshooting)

### [curl command not found](https://vercel.com/docs/cli/curl\#curl-command-not-found)
...
### [No deployment found for the project](https://vercel.com/docs/cli/curl\#no-deployment-found-for-the-project)
...
### [Failed to get deployment protection bypass token](https://vercel.com/docs/cli/curl\#failed-to-get-deployment-protection-bypass-token)
...
### [No deployment found for ID](https://vercel.com/docs/cli/curl\#no-deployment-found-for-id)
...
## [Global Options](https://vercel.com/docs/cli/curl\#global-options)

The following [global options](https://vercel.com/docs/cli/global-options) can be passed when using the `vercel curl` command:
...
## [Related](https://vercel.com/docs/cli/curl\#related)
