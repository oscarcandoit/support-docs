...
You only pay for what you use on the AI Gateway by purchasing [AI Gateway Credits through the Vercel dashboard](https://vercel.com/docs/ai-gateway/pricing#view-your-ai-gateway-credits-balance). There are no markups to use the AI Gateway, so you're only charged for what your AI providers would bill you if you were using the provider directly.

Charges are automatically deducted from your AI Gateway Credits balance and you can [top up the balance](https://vercel.com/docs/ai-gateway/pricing#top-up-your-ai-gateway-credits) at any time.

## [Free and paid tiers](https://vercel.com/docs/ai-gateway/pricing\#free-and-paid-tiers)
...
### [Free tier](https://vercel.com/docs/ai-gateway/pricing\#free-tier)
...
### [Moving to paid tier](https://vercel.com/docs/ai-gateway/pricing\#moving-to-paid-tier)
...
## [AI Gateway Rates](https://vercel.com/docs/ai-gateway/pricing\#ai-gateway-rates)
...
## [Using a custom API key](https://vercel.com/docs/ai-gateway/pricing\#using-a-custom-api-key)

The AI Gateway also supports [using a custom API key](https://vercel.com/docs/ai-gateway/byok) for any provider listed in our catalog.
If you use a custom API key, there is no markup or fee from AI Gateway.

## [View your AI Gateway Credits balance](https://vercel.com/docs/ai-gateway/pricing\#view-your-ai-gateway-credits-balance)
...
## [Top up your AI Gateway Credits](https://vercel.com/docs/ai-gateway/pricing\#top-up-your-ai-gateway-credits)
