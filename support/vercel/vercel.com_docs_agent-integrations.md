...
With [AI agents](https://vercel.com/docs/agent-integrations#ai-agents) and [AI agent services](https://vercel.com/docs/agent-integrations#ai-agent-services) on the Vercel Marketplace, you can add AI-powered workflows to your projects through [native integrations](https://vercel.com/docs/integrations#native-integrations) and get a unified dashboard with billing, observability, and installation flows.

You have access to two types of AI building blocks:

- [Agents](https://vercel.com/docs/agent-integrations#ai-agents): Pre-built systems that handle specialized workflows on your behalf
- [Services](https://vercel.com/docs/agent-integrations#ai-agent-services): Infrastructure you use to build and run your own agents

## [Getting started](https://vercel.com/docs/agent-integrations\#getting-started)
...
### [Providers](https://vercel.com/docs/agent-integrations\#providers)

If you're building agents or AI infrastructure, check out [Integrate with Vercel](https://vercel.com/docs/integrations/create-integration) to learn how to create a native integration. When you're ready to proceed, submit a [request to join](https://vercel.com/marketplace-providers#become-a-provider) the Vercel Marketplace.

## [AI agents](https://vercel.com/docs/agent-integrations\#ai-agents)
...
## [AI agent services](https://vercel.com/docs/agent-integrations\#ai-agent-services)
...
## [More resources](https://vercel.com/docs/agent-integrations\#more-resources)

- [AI agents and services on the Vercel Marketplace](https://vercel.com/marketplace/category/agents)
- [Learn how to add and manage a native integration](https://vercel.com/docs/integrations/install-an-integration/product-integration)
- [Learn how to create a native integration](https://vercel.com/docs/integrations/create-integration/marketplace-product)
