...
## [Troubleshoot](https://vercel.com/docs/errors/ROUTER_TOO_MANY_HAS_SELECTIONS\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/ROUTER\_TOO\_MANY\_HAS\_SELECTIONS to understand what's happening.
...
4. Review application logs: Inspect the [application logs](https://vercel.com/docs/deployments/logs) for any warnings or errors related to routing or selections

[**Not what you were looking for?** \\
\\
Return to the Errors documentation section](https://vercel.com/docs/errors)
