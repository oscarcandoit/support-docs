---
url: "https://vercel.com/docs/plans/pro/billing"
...
## [Payments](https://vercel.com/docs/plans/pro/billing\#payments)

### [What is the price of the Pro plan?](https://vercel.com/docs/plans/pro/billing\#what-is-the-price-of-the-pro-plan)

See the [pricing page](https://vercel.com/docs/pricing).

### [When are payments taken?](https://vercel.com/docs/plans/pro/billing\#when-are-payments-taken)

At the beginning of each [billing cycle](https://vercel.com/docs/plans/pro/billing#what-is-a-billing-cycle). Each invoice charges for the upcoming billing cycle. It includes any additional usage that occurred during the previous billing cycle.

### [What payment methods are available?](https://vercel.com/docs/plans/pro/billing\#what-payment-methods-are-available)

Credit/Debit card only.

### [What card types can I pay with?](https://vercel.com/docs/plans/pro/billing\#what-card-types-can-i-pay-with)
...
### [What currency can I pay in?](https://vercel.com/docs/plans/pro/billing\#what-currency-can-i-pay-in)

You can pay in any currency so long as the credit card provider allows charging in USD _after_ conversion.

### [What happens when I cannot pay?](https://vercel.com/docs/plans/pro/billing\#what-happens-when-i-cannot-pay)
...
### [Can I delay my payment?](https://vercel.com/docs/plans/pro/billing\#can-i-delay-my-payment)

No, you cannot delay your payment.

### [Can I pay annually?](https://vercel.com/docs/plans/pro/billing\#can-i-pay-annually)
...
### [Can I change my payment method?](https://vercel.com/docs/plans/pro/billing\#can-i-change-my-payment-method)
...
## [Invoices](https://vercel.com/docs/plans/pro/billing\#invoices)

### [Can I pay by invoice?](https://vercel.com/docs/plans/pro/billing\#can-i-pay-by-invoice)
...
### [Why am I overdue?](https://vercel.com/docs/plans/pro/billing\#why-am-i-overdue)
...
See [What happens when I cannot pay](https://vercel.com/docs/plans/pro/billing#what-happens-when-i-cannot-pay) for more information.

### [Can I change an existing invoice detail?](https://vercel.com/docs/plans/pro/billing\#can-i-change-an-existing-invoice-detail)
...
### [Does Vercel possess and display their VAT ID on invoices?](https://vercel.com/docs/plans/pro/billing\#does-vercel-possess-and-display-their-vat-id-on-invoices)
...
### [Can invoices be sent to my email?](https://vercel.com/docs/plans/pro/billing\#can-invoices-be-sent-to-my-email)
...
### [Can I repay an invoice if I've used the wrong payment method?](https://vercel.com/docs/plans/pro/billing\#can-i-repay-an-invoice-if-i've-used-the-wrong-payment-method)
...
## [Billing](https://vercel.com/docs/plans/pro/billing\#billing)

### [How are add-ons billed?](https://vercel.com/docs/plans/pro/billing\#how-are-add-ons-billed)

Pro add-ons are billed in the subsequent billing cycle as a line item on your invoice.

### [What happens if I purchase an add-on by mistake?](https://vercel.com/docs/plans/pro/billing\#what-happens-if-i-purchase-an-add-on-by-mistake)

[Open a support ticket](https://vercel.com/help#issues) for your request and our team will assist you.

### [What do I do if I think my bill is wrong?](https://vercel.com/docs/plans/pro/billing\#what-do-i-do-if-i-think-my-bill-is-wrong)
...
### [Do I get billed for DDoS?](https://vercel.com/docs/plans/pro/billing\#do-i-get-billed-for-ddos)
...
### [What is a billing cycle?](https://vercel.com/docs/plans/pro/billing\#what-is-a-billing-cycle)
...
- [Does Vercel possess and display their VAT ID on invoices?](https://vercel.com/docs/plans/pro/billing#does-vercel-possess-and-display-their-vat-id-on-invoices)
- [Can invoices be sent to my email?](https://vercel.com/docs/plans/pro/billing#can-invoices-be-sent-to-my-email)
- [Can I repay an invoice if I've...](https://vercel.com/docs/plans/pro/billing#can-i-repay-an-invoice-if-i've-used-the-wrong-payment-method)
- [Billing](https://vercel.com/docs/plans/pro/billing#billing)
- [How are add-ons billed?](https://vercel.com/docs/plans/pro/billing#how-are-add-ons-billed)
- [What happens if I purchase an add-on by mistake?](https://vercel.com/docs/plans/pro/billing#what-happens-if-i-purchase-an-add-on-by-mistake)
- [What do I do if I think my bil...](https://vercel.com/docs/plans/pro/billing#what-do-i-do-if-i-think-my-bill-is-wrong)
- [Do I get billed for DDoS?](https://vercel.com/docs/plans/pro/billing#do-i-get-billed-for-ddos)
- [What is a billing cycle?](https://vercel.com/docs/plans/pro/billing#what-is-a-billing-cycle)
