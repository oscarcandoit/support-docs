---
url: "https://vercel.com/docs/redis"
...
Vercel lets you connect external Redis databases through the [Marketplace](https://vercel.com/marketplace), allowing you to integrate high-performance caching and real-time data storage into your Vercel projects without managing Redis servers.

- Explore [Marketplace storage redis integrations](https://vercel.com/marketplace?category=storage&search=redis).
- Learn how to [add a Marketplace native integration](https://vercel.com/docs/integrations/install-an-integration/product-integration).

## [Connecting to the Marketplace](https://vercel.com/docs/redis\#connecting-to-the-marketplace)

Vercel enables you to use Redis by integrating with external database providers. By using the Marketplace, you can:

- Select a [Redis provider](https://vercel.com/marketplace?category=storage&search=redis)
- Provision and configure a Redis database with minimal setup.
- Have credentials and [environment variables](https://vercel.com/docs/environment-variables) injected into your Vercel project.
