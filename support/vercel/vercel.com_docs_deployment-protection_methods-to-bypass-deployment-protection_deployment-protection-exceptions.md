...
Deployment Protection Exceptionsare availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)or with the [Advanced Deployment Protection](https://vercel.com/docs/security/deployment-protection#advanced-deployment-protection) add-on for [Pro plans](https://vercel.com/docs/plans/pro)
...
## [Adding a Deployment Protection Exception](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions\#adding-a-deployment-protection-exception)

1. ### [Go to Project Deployment Protection Settings](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions\#go-to-project-deployment-protection-settings)
...
2. ### [Select Add Domain](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions\#select-add-domain)



From the Deployment Protection Exceptions section, select Add Domain:
![Add Deployment Protection Exception.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fsecurity%2Fdeployment-exception-no-domain-light.png&w=3840&q=75)![Add Deployment Protection Exception.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fsecurity%2Fdeployment-exception-no-domain-dark.png&w=3840&q=75)Add Deployment Protection Exception.
3. ### [Specify domain](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions\#specify-domain)
...
4. ### [Confirm domain](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions\#confirm-domain)
...
## [Removing a Deployment Protection Exception](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions\#removing-a-deployment-protection-exception)
...
1. Select the project that you wish to enable Password Protection for
2. Go to the Settings tab, and then to Deployment Protection
2. ### [Select the Domain to Remove](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions\#select-the-domain-to-remove)
...
3. ### [Confirm the Domain to Remove](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions\#confirm-the-domain-to-remove)
...
## [Managing Deployment Protection Exceptions](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions\#managing-deployment-protection-exceptions)
...
- [Adding a Deployment Protection Exception](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#adding-a-deployment-protection-exception)
- [Go to Project Deployment Protection Settings](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#go-to-project-deployment-protection-settings)
- [Select Add Domain](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#select-add-domain)
- [Specify domain](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#specify-domain)
- [Confirm domain](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#confirm-domain)
- [Removing a Deployment Protection Exception](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#removing-a-deployment-protection-exception)
- [Go to Project Deployment Protection Settings](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#go-to-project-deployment-protection-settings)
- [Select the Domain to Remove](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#select-the-domain-to-remove)
- [Confirm the Domain to Remove](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#confirm-the-domain-to-remove)
- [Managing Deployment Protection Exceptions](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/deployment-protection-exceptions#managing-deployment-protection-exceptions)
