...
The Vercel platform caches all static content at [the edge](https://vercel.com/docs/edge-cache) by default. This means your users will always get static files like HTML, CSS, and JavaScript served from servers that are closest to them. See the [regions](https://vercel.com/docs/regions) page for a full list of our regions.

In a globally distributed application, the physical distance between your function and its data source can impact latency and response times. Therefore, Vercel allows you to specify the region in which your functions execute, ideally close to your data source (such as your [database](https://vercel.com/kb/guide/using-databases-with-vercel)).
...
## [Setting your default region](https://vercel.com/docs/functions/configuring-functions/region\#setting-your-default-region)
...
### [Dashboard](https://vercel.com/docs/functions/configuring-functions/region\#dashboard)
...
### [Project configuration](https://vercel.com/docs/functions/configuring-functions/region\#project-configuration)
...
### [Vercel CLI](https://vercel.com/docs/functions/configuring-functions/region\#vercel-cli)
...
## [Available regions](https://vercel.com/docs/functions/configuring-functions/region\#available-regions)
...
## [Automatic failover](https://vercel.com/docs/functions/configuring-functions/region\#automatic-failover)
...
### [Node.js runtime failover](https://vercel.com/docs/functions/configuring-functions/region\#node.js-runtime-failover)

Setting failover regionsare availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)
...
![Failover regions for your Vercel functions shown in the deployment summary.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Ffunctions%2Ffunction-failover-region-light.png&w=3840&q=75)![Failover regions for your Vercel functions shown in the deployment summary.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Ffunctions%2Ffunction-failover-region-dark.png&w=3840&q=75)Failover regions for your Vercel functions shown in the deployment summary.
