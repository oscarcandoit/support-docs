...
## [Automatic instrumentation](https://vercel.com/docs/tracing\#automatic-instrumentation)

Vercel automatically instruments your application without needing any additional code changes. When you have set up [Trace Drains](https://vercel.com/docs/drains/reference/traces) or enabled [Session Tracing](https://vercel.com/docs/tracing/session-tracing) for your Vercel Functions, you'll be able to visualize traces for:
...
For additional tracing, such as framework spans, you can install the [@vercel/otel](https://vercel.com/docs/tracing/instrumentation) package to use the OpenTelemetry SDK. In addition, you can [add custom spans](https://vercel.com/docs/tracing/instrumentation#adding-custom-spans) to your traces to capture spans and gain more visibility into your application.
...
For detailed instructions on starting traces, managing active sessions, and viewing previous traces, see the [Session Tracing](https://vercel.com/docs/tracing/session-tracing) documentation.

## [Using OpenTelemetry](https://vercel.com/docs/tracing\#using-opentelemetry)
...
See the [Instrumentation](https://vercel.com/docs/tracing/instrumentation) guide to set up OpenTelemetry for your project.

## [Viewing traces in the dashboard](https://vercel.com/docs/tracing\#viewing-traces-in-the-dashboard)
...
3. Use the tracing icon  in the filter bar to filter to traces. You can filter traces using [all the same filters available](https://vercel.com/docs/runtime-logs#log-filters) in the Logs tab of the dashboard. To view traces for requests to your browser, press the user icon next to the Traces icon.
...
![View traces in the logs tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fobservability%2Ftrace-panel-2-light.png%3Flightbox&w=3840&q=75)![View traces in the logs tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fobservability%2Ftrace-panel-2-dark.png%3Flightbox&w=3840&q=75)View traces in the logs tab.Zoom Image
...
![View traces in the logs tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fobservability%2Ftrace-panel-2-light.png%3Flightbox&w=3840&q=75)![View traces in the logs tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fobservability%2Ftrace-panel-2-dark.png%3Flightbox&w=3840&q=75)View traces in the logs tab.


### [Anatomy of a trace](https://vercel.com/docs/tracing\#anatomy-of-a-trace)
...
| Framework spans | Blue | Appear when you [instrument your application](https://vercel.com/docs/tracing/instrumentation) with OpenTelemetry. Next.js 13.4+ automatically contributes spans for routes and rendering tasks. |
| Custom spans | Blue | [Custom instrumentation](https://vercel.com/docs/tracing#adding-custom-spans) you can add to your application using OpenTelemetry. |
...
## [Exporting traces to a third party](https://vercel.com/docs/tracing\#exporting-traces-to-a-third-party)

You can export traces to a third party observability provider using [Vercel Drains](https://vercel.com/docs/drains). This can be done either by sending traces to a custom HTTP endpoint, or by using a [native integration from the Vercel Marketplace](https://vercel.com/marketplace/category/observability).

See the [Vercel Drains](https://vercel.com/docs/drains) page to learn how to set up a Drain to export traces to a third party observability provider.

### [Using custom OpenTelemetry setup with Sentry](https://vercel.com/docs/tracing\#using-custom-opentelemetry-setup-with-sentry)
...
## [More resources](https://vercel.com/docs/tracing\#more-resources)

- [Using Vercel Drains](https://vercel.com/docs/drains)
- [Trace Drains](https://vercel.com/docs/drains/reference/traces)
- [Learn about the Vercel toolbar](https://vercel.com/docs/vercel-toolbar)
- [Session Tracing](https://vercel.com/docs/tracing/session-tracing)
