...
## [Get started with Hono on Vercel](https://vercel.com/docs/frameworks/backend/hono\#get-started-with-hono-on-vercel)

Start with Hono on Vercel by using the following Hono template to deploy to Vercel with zero configuration:

[![](https://api-frameworks.vercel.sh/framework-logos/hono.svg)Deploy Hono to Vercel](https://vercel.com/templates/backend/hono-starter)

[Deploy](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fvercel%2Ftree%2Fmain%2Fexamples%2Fhono&template=hono) [Live Example](https://hono.vercel.dev/)

Vercel deployments can [integrate with your git provider](https://vercel.com/docs/git) to [generate preview URLs](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) for each pull request you make to your Hono project.

### [Get started with Vercel CLI](https://vercel.com/docs/frameworks/backend/hono\#get-started-with-vercel-cli)

Get started by initializing a new Hono project using [Vercel CLI init command](https://vercel.com/docs/cli/init):
...
## [Exporting the Hono application](https://vercel.com/docs/frameworks/backend/hono\#exporting-the-hono-application)
...
### [Local development](https://vercel.com/docs/frameworks/backend/hono\#local-development)
...
## [Middleware](https://vercel.com/docs/frameworks/backend/hono\#middleware)

Hono has the concept of "Middleware" as a part of the framework. This is different from [Vercel Routing Middleware](https://vercel.com/docs/routing-middleware), though they can be used together.

### [Hono Middleware](https://vercel.com/docs/frameworks/backend/hono\#hono-middleware)
...
### [Vercel Routing Middleware](https://vercel.com/docs/frameworks/backend/hono\#vercel-routing-middleware)

In Vercel, [Routing Middleware](https://vercel.com/docs/routing-middleware) executes code before a request is processed by the application. This gives you a way to handle rewrites, redirects, headers, and more, before returning a response. See [the Routing Middleware documentation](https://vercel.com/docs/routing-middleware) for examples.

## [Serving static assets](https://vercel.com/docs/frameworks/backend/hono\#serving-static-assets)
...
## [Vercel Functions](https://vercel.com/docs/frameworks/backend/hono\#vercel-functions)

When you deploy a Hono app to Vercel, your server routes automatically become [Vercel Functions](https://vercel.com/docs/functions) and use [Fluid compute](https://vercel.com/docs/fluid-compute) by default.

### [Streaming](https://vercel.com/docs/frameworks/backend/hono\#streaming)

Vercel Functions support streaming which can be used with [Hono's `stream()` function](https://hono.dev/docs/helpers/streaming).

## [More resources](https://vercel.com/docs/frameworks/backend/hono\#more-resources)
