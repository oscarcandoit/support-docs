...
### [Disabling helpers for Node.js](https://vercel.com/docs/functions/runtimes/node-js/advanced-node-configuration\#disabling-helpers-for-node.js)

To disable [helpers](https://vercel.com/docs/functions/runtimes/node-js#node.js-helpers):
...
For more information, see [Environment Variables](https://vercel.com/docs/environment-variables).

### [Private npm modules for Node.js](https://vercel.com/docs/functions/runtimes/node-js/advanced-node-configuration\#private-npm-modules-for-node.js)

To install private npm modules:

1. From the dashboard, select your project and go to the Settings tab.
2. Select Environment Variables from the left side in settings.
3. Add a new environment variable with the Key: `NPM_TOKEN` and enter your [npm token](https://docs.npmjs.com/about-access-tokens) as the value. Alternatively, define `NPM_RC` as an [Environment Variable](https://vercel.com/docs/environment-variables) with the contents of `~/.npmrc`.
4. Pull your env vars into your local project with the [following command](https://vercel.com/docs/cli/env):
...
### [Custom build step for Node.js](https://vercel.com/docs/functions/runtimes/node-js/advanced-node-configuration\#custom-build-step-for-node.js)
...
### [SIGINT behavior](https://vercel.com/docs/functions/runtimes/node-js/advanced-node-configuration\#sigint-behavior)
