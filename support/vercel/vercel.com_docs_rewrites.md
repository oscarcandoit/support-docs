...
Enterprise teams can configure custom SSL. [Contact sales](https://vercel.com/contact/sales) to
learn more.

## [Setting up rewrites](https://vercel.com/docs/rewrites\#setting-up-rewrites)
...
## [Same-application rewrites](https://vercel.com/docs/rewrites\#same-application-rewrites)
...
### [Caching external rewrites](https://vercel.com/docs/rewrites\#caching-external-rewrites)

The CDN can cache external rewrites for better performance. There are three approaches to enable caching:

1. Directly from your API (preferred): When you control the backend API, the API itself can return [`CDN-Cache-Control`](https://vercel.com/docs/headers/cache-control-headers#cdn-cache-control-header) or [`Vercel-CDN-Cache-Control`](https://vercel.com/docs/headers/cache-control-headers#cdn-cache-control-header) headers in its response:
...
For more information on caching headers and detailed options, see the [Cache-Control headers documentation](https://vercel.com/docs/headers/cache-control-headers).

### [Draining external rewrites](https://vercel.com/docs/rewrites\#draining-external-rewrites)
...
### [Observing external rewrites](https://vercel.com/docs/rewrites\#observing-external-rewrites)
...
## [Framework considerations](https://vercel.com/docs/rewrites\#framework-considerations)
...
## [Testing rewrites](https://vercel.com/docs/rewrites\#testing-rewrites)
...
## [Wildcard path forwarding](https://vercel.com/docs/rewrites\#wildcard-path-forwarding)
...
## [Using regular expressions](https://vercel.com/docs/rewrites\#using-regular-expressions)
...
## [When to use each type](https://vercel.com/docs/rewrites\#when-to-use-each-type)
