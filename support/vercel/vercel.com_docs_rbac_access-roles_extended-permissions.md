---
url: "https://vercel.com/docs/rbac/access-roles/extended-permissions"
...
## [Project roles for specific access](https://vercel.com/docs/rbac/access-roles/extended-permissions\#project-roles-for-specific-access)
...
| --- | --- | --- |
| [Admin](https://vercel.com/docs/rbac/access-roles#project-administrators) | [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role), [Developer](https://vercel.com/docs/rbac/access-roles#developer-role) | Full control over a specific project including production deployments and settings |
| [Project Developer](https://vercel.com/docs/rbac/access-roles#project-developer) | [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role) | Can deploy to assigned project and manage dev/preview environment variables |
| [Project Viewer](https://vercel.com/docs/rbac/access-roles#project-viewer) | [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role) | Read-only access to assigned project |

## [Extended permissions for granular access](https://vercel.com/docs/rbac/access-roles/extended-permissions\#extended-permissions-for-granular-access)
...
| --- | --- | --- | --- |
| Create Project | Allows the user to create a new project. | [Developer](https://vercel.com/docs/rbac/access-roles#developer-role) | [Owner](https://vercel.com/docs/rbac/access-roles#owner-role), [Member](https://vercel.com/docs/rbac/access-roles#member-role) |
| Full Production Deployment | Deploy to production from CLI, rollback and promote any deployment. | [Developer](https://vercel.com/docs/rbac/access-roles#developer-role), [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role) | [Owner](https://vercel.com/docs/rbac/access-roles#owner-role), [Member](https://vercel.com/docs/rbac/access-roles#member-role) |
| Usage Viewer | Read-only usage team-wide including prices and invoices. | [Developer](https://vercel.com/docs/rbac/access-roles#developer-role), [Security](https://vercel.com/docs/rbac/access-roles#security-role), [Member](https://vercel.com/docs/rbac/access-roles#member-role), [Viewer](https://vercel.com/docs/rbac/access-roles#viewer-role) | [Owner](https://vercel.com/docs/rbac/access-roles#owner-role), [Billing](https://vercel.com/docs/rbac/access-roles#billing-role) |
| Integration Manager | Install and use Vercel integrations, marketplace integrations, and storage. | [Developer](https://vercel.com/docs/rbac/access-roles#developer-role), [Security](https://vercel.com/docs/rbac/access-roles#security-role), [Billing](https://vercel.com/docs/rbac/access-roles#billing-role), [Viewer](https://vercel.com/docs/rbac/access-roles#viewer-role), [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role) | [Owner](https://vercel.com/docs/rbac/access-roles#owner-role), [Member](https://vercel.com/docs/rbac/access-roles#member-role) |
| Environment Manager | Create and manage project environments. | [Developer](https://vercel.com/docs/rbac/access-roles#developer-role), [Member](https://vercel.com/docs/rbac/access-roles#member-role) | [Owner](https://vercel.com/docs/rbac/access-roles#owner-role), [Member](https://vercel.com/docs/rbac/access-roles#member-role) |
| Environment Variable Manager | Create and manage environment variables. | [Developer](https://vercel.com/docs/rbac/access-roles#developer-role) | [Owner](https://vercel.com/docs/rbac/access-roles#owner-role), [Member](https://vercel.com/docs/rbac/access-roles#member-role) |

Extended permissions work when the user has at least one compatible team role.

### [How roles fit together](https://vercel.com/docs/rbac/access-roles/extended-permissions\#how-roles-fit-together)
...
| --- | --- | --- |
| [Owner](https://vercel.com/docs/rbac/access-roles#owner-role) | Complete control over all team and project settings | All extended permissions (already includes all permissions by default) |
| [Member](https://vercel.com/docs/rbac/access-roles#member-role) | Can manage projects but not team settings | \- [Environment Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#environment-manager)<br> \- [Usage Viewer](https://vercel.com/docs/rbac/access-roles/extended-permissions#usage-viewer) |
| [Developer](https://vercel.com/docs/rbac/access-roles#developer-role) | Can deploy and manage projects with limitations on production settings | \- [Create Project](https://vercel.com/docs/rbac/access-roles/extended-permissions#create-project)<br> \- [Full Production Deployment](https://vercel.com/docs/rbac/access-roles/extended-permissions#full-production-deployment)<br> \- [Usage Viewer](https://vercel.com/docs/rbac/access-roles/extended-permissions#usage-viewer)<br> \- [Integration Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#integration-manager)<br> \- [Environment Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#environment-manager)<br> \- [Environment Variable Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#environment-variable-manager) |
| [Billing](https://vercel.com/docs/rbac/access-roles#billing-role) | Manages financial aspects only | \- [Integration Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#integration-manager) |
| [Security](https://vercel.com/docs/rbac/access-roles#security-role) | Manages security features team-wide | \- [Usage Viewer](https://vercel.com/docs/rbac/access-roles/extended-permissions#usage-viewer)<br> \- [Integration Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#integration-manager) |
| [Viewer](https://vercel.com/docs/rbac/access-roles#viewer-role) | Read-only access to all projects | \- [Usage Viewer](https://vercel.com/docs/rbac/access-roles/extended-permissions#usage-viewer)<br> \- [Integration Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#integration-manager) |
| [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role) | Configurable role that can be assigned project-level roles | \- [Full Production Deployment](https://vercel.com/docs/rbac/access-roles/extended-permissions#full-production-deployment)<br> \- [Integration Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#integration-manager)<br> See project-level table for compatible project roles and permissions |

## [How combinations work](https://vercel.com/docs/rbac/access-roles/extended-permissions\#how-combinations-work)
...
| --- | --- | --- | --- |
| DevOps engineer | [Developer](https://vercel.com/docs/rbac/access-roles#developer-role) \+ [Environment Variable Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#environment-variable-manager) \+ [Full Production Deployment](https://vercel.com/docs/rbac/access-roles/extended-permissions#full-production-deployment) | \- Deploy to both preview and production environments <br> \- Manage preview and production environment variables <br> \- Full deployment capabilities incl. CLI and rollbacks | Manages deployments and config without billing or team access |
| Technical team lead | [Member](https://vercel.com/docs/rbac/access-roles#member-role) \+ [Security](https://vercel.com/docs/rbac/access-roles#security-role) | \- Create/manage projects and team members <br> \- Configure deployment protection, rate limits <br> \- Manage log drains and monitoring | Leads projects and enforces security without [Owner](https://vercel.com/docs/rbac/access-roles#owner-role) access |
| External contractor | [Contributor](https://vercel.com/docs/rbac/access-roles#contributor-role) \+ [Project Developer](https://vercel.com/docs/rbac/access-roles#project-developer) (for specific projects only) | \- Can deploy to assigned projects only <br> \- No access to team settings or other projects | Limited project access for external collaborators |
| Finance manager | [Billing](https://vercel.com/docs/rbac/access-roles#billing-role) \+ [Usage Viewer](https://vercel.com/docs/rbac/access-roles/extended-permissions#usage-viewer) | \- Manage billing and payment methods <br> \- View usage metrics across projects <br> \- Read-only project access | Monitors costs and handles billing with no dev access |
| Product owner | [Viewer](https://vercel.com/docs/rbac/access-roles#viewer-role) \+ [Create Project](https://vercel.com/docs/rbac/access-roles/extended-permissions#create-project) \+ [Environment Manager](https://vercel.com/docs/rbac/access-roles/extended-permissions#environment-manager) | \- Read-only access to all projects <br> \- Create new projects <br> \- Manage environments, but not deployments or settings | Oversees product workflows, supports setup but not execution |

## [Role compatibility and constraints](https://vercel.com/docs/rbac/access-roles/extended-permissions\#role-compatibility-and-constraints)

Not all roles and permissions can be meaningfully combined. For example:

- The [Owner](https://vercel.com/docs/rbac/access-roles#owner-role) role already includes all permissions, so adding additional roles doesn't grant more access
- Some extended permissions are only compatible with specific roles (e.g. [Full Production Deployment](https://vercel.com/docs/rbac/access-roles/extended-permissions#full-production-deployment) works with [Developer](https://vercel.com/docs/rbac/access-roles#developer-role), [Member](https://vercel.com/docs/rbac/access-roles#member-role), and [Owner](https://vercel.com/docs/rbac/access-roles#owner-role) roles)
- Project roles are primarily assigned to [Contributors](https://vercel.com/docs/rbac/access-roles#contributor-role) or via Access Groups
