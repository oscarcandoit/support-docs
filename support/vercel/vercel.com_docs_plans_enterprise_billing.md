---
url: "https://vercel.com/docs/plans/enterprise/billing"
...
## [Payments](https://vercel.com/docs/plans/enterprise/billing\#payments)

### [When are payments taken?](https://vercel.com/docs/plans/enterprise/billing\#when-are-payments-taken)

- Pay by credit card: When the invoice is finalized in Stripe
- Pay by ACH/Wire: Due by due date on the invoice

### [What payment methods are available?](https://vercel.com/docs/plans/enterprise/billing\#what-payment-methods-are-available)

- Credit card
- ACH/Wire

### [What currency can I pay in?](https://vercel.com/docs/plans/enterprise/billing\#what-currency-can-i-pay-in)

You can pay in any currency so long as the credit card provider allows charging in USD _after_ conversion.

### [Can I delay my payment?](https://vercel.com/docs/plans/enterprise/billing\#can-i-delay-my-payment)

Contact your Customer Success Manager (CSM) or Account Executive (AE) if you feel payment might be delayed.

### [Can I pay annually?](https://vercel.com/docs/plans/enterprise/billing\#can-i-pay-annually)

Yes.

### [What card types can I pay with?](https://vercel.com/docs/plans/enterprise/billing\#what-card-types-can-i-pay-with)
...
#### [If paying by ACH, do I need to cover the payment fee cost on top of the payment?](https://vercel.com/docs/plans/enterprise/billing\#if-paying-by-ach-do-i-need-to-cover-the-payment-fee-cost-on-top-of-the-payment)
...
### [Can I change my payment method?](https://vercel.com/docs/plans/enterprise/billing\#can-i-change-my-payment-method)
...
## [Invoices](https://vercel.com/docs/plans/enterprise/billing\#invoices)

### [Can I pay by invoice?](https://vercel.com/docs/plans/enterprise/billing\#can-i-pay-by-invoice)
...
### [Why am I overdue?](https://vercel.com/docs/plans/enterprise/billing\#why-am-i-overdue)
...
### [Can I change an existing invoice detail?](https://vercel.com/docs/plans/enterprise/billing\#can-i-change-an-existing-invoice-detail)
...
## [Billing](https://vercel.com/docs/plans/enterprise/billing\#billing)

### [Is there a Billing role available?](https://vercel.com/docs/plans/enterprise/billing\#is-there-a-billing-role-available)

Yes. Learn more about [Roles and Permissions](https://vercel.com/docs/accounts/team-members-and-roles).

### [How do I update my billing information?](https://vercel.com/docs/plans/enterprise/billing\#how-do-i-update-my-billing-information)

1. ### [Go to the **Settings** page](https://vercel.com/docs/plans/enterprise/billing\#go-to-the-settings-page)



   - Navigate to the [Dashboard](https://vercel.com/dashboard)
...
2. ### [Go to the Billing section to update the appropriate fields](https://vercel.com/docs/plans/enterprise/billing\#go-to-the-billing-section-to-update-the-appropriate-fields)



Select Billing from the sidebar. Scroll down to find the following editable fields. You can update these if you are a [team owner](https://vercel.com/docs/rbac/access-roles#owner-role) or have the [billing role](https://vercel.com/docs/rbac/access-roles#billing-role):
...
### [What do I do if I think my bill is wrong?](https://vercel.com/docs/plans/enterprise/billing\#what-do-i-do-if-i-think-my-bill-is-wrong)
...
### [Do I get billed for DDoS?](https://vercel.com/docs/plans/enterprise/billing\#do-i-get-billed-for-ddos)
...
### [What is a billing cycle?](https://vercel.com/docs/plans/enterprise/billing\#what-is-a-billing-cycle)
...
- [Can I pay annually?](https://vercel.com/docs/plans/enterprise/billing#can-i-pay-annually)
- [What card types can I pay with?](https://vercel.com/docs/plans/enterprise/billing#what-card-types-can-i-pay-with)
- [If paying by ACH, do I need to...](https://vercel.com/docs/plans/enterprise/billing#if-paying-by-ach-do-i-need-to-cover-the-payment-fee-cost-on-top-of-the-payment)
- [Can I change my payment method?](https://vercel.com/docs/plans/enterprise/billing#can-i-change-my-payment-method)
- [Invoices](https://vercel.com/docs/plans/enterprise/billing#invoices)
- [Can I pay by invoice?](https://vercel.com/docs/plans/enterprise/billing#can-i-pay-by-invoice)
- [Why am I overdue?](https://vercel.com/docs/plans/enterprise/billing#why-am-i-overdue)
...
- [Is there a Billing role available?](https://vercel.com/docs/plans/enterprise/billing#is-there-a-billing-role-available)
- [How do I update my billing information?](https://vercel.com/docs/plans/enterprise/billing#how-do-i-update-my-billing-information)
- [Go to the Settings page](https://vercel.com/docs/plans/enterprise/billing#go-to-the-settings-page)
- [Go to the Billing section to update the appropriate fields](https://vercel.com/docs/plans/enterprise/billing#go-to-the-billing-section-to-update-the-appropriate-fields)
- [What do I do if I think my bil...](https://vercel.com/docs/plans/enterprise/billing#what-do-i-do-if-i-think-my-bill-is-wrong)
- [Do I get billed for DDoS?](https://vercel.com/docs/plans/enterprise/billing#do-i-get-billed-for-ddos)
- [What is a billing cycle?](https://vercel.com/docs/plans/enterprise/billing#what-is-a-billing-cycle)
