...
page](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transfer-a-domain-to-vercel)
...
You can do this using either the Vercel Domains dashboard, or the [Vercel CLI](https://vercel.com/docs/cli).

## [Generating a Certificate](https://vercel.com/docs/domains/pre-generating-ssl-certs\#generating-a-certificate)
...
## [Setting your DNS records and finalizing](https://vercel.com/docs/domains/pre-generating-ssl-certs\#setting-your-dns-records-and-finalizing)
...
## [Verifying the Certificate](https://vercel.com/docs/domains/pre-generating-ssl-certs\#verifying-the-certificate)
...
## [Finishing connecting your domain to Vercel](https://vercel.com/docs/domains/pre-generating-ssl-certs\#finishing-connecting-your-domain-to-vercel)
...
See [this detailed guide](https://vercel.com/kb/guide/a-record-and-caa-with-vercel) on using domains with A records for more information.

For more details on performing a migration, see [this guide](https://vercel.com/docs/domains/managing-dns-records#migrating-dns-records-from-an-external-registrar).
