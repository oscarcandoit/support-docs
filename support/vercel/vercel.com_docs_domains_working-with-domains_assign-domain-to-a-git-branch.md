...
Every commit pushed to the [Production Branch](https://vercel.com/docs/git#production-branch) of your [connected Git repository](https://vercel.com/docs/git) will be assigned the domains configured in your project.

To automatically assign a domain to a different branch:

1. From the [dashboard](https://vercel.com/dashboard), pick the project to which you would like to assign your domain and select the Settings tab.
...
![Assign domain to branch modal.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Fassign-domain-to-git-branch-light.png&w=1200&q=75)![Assign domain to branch modal.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Fassign-domain-to-git-branch-dark.png&w=1200&q=75)Assign domain to branch modal.

Pro and Enterprise teams can also set branch tracking for their [custom environments](https://vercel.com/docs/deployments/environments#custom-environments).

If you prefer to do this using the Vercel REST API instead, you can use the
["Update a project\\
domain"](https://vercel.com/docs/rest-api/reference/endpoints/projects/update-a-project-domain)
PATCH endpoint.
