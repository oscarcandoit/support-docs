...
title: "Add a domain to a project - Vercel API Docs"
---

[Skip to main content](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#content-area)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#authorization-authorization)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#parameter-id-or-name)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#parameter-team-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#parameter-slug)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#body-name)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#body-git-branch)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#body-custom-environment-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#body-redirect)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#body-redirect-status-code)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-name)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-apex-name)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-project-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-verified)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-redirect)

redirect

string \| null

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-redirect-status-code)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-git-branch)

gitBranch

string \| null

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-custom-environment-id)

customEnvironmentId

string \| null

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-updated-at)

updatedAt

number

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-created-at)

createdAt

number

[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-verification)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-verification-type)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-verification-domain)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-verification-value)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/projects/add-a-domain-to-a-project#response-verification-reason)
...
[Update a project domain](https://vercel.com/docs/rest-api/reference/endpoints/projects/update-a-project-domain) [Move a project domain](https://vercel.com/docs/rest-api/reference/endpoints/projects/move-a-project-domain)
