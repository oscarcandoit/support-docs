...
Use this checklist to ensure all necessary steps have been taken for a great integration experience to get listed on the [Integration Marketplace](https://vercel.com/integrations).
Make sure you read the [after integration creation guide](https://vercel.com/docs/integrations/create-integration#after-integration-creation) before you start.

## [Marketplace listing](https://vercel.com/docs/integrations/create-integration/approval-checklist\#marketplace-listing)
...
- Is the first image high-quality and suitable to be used in a [Open Graph (OG)](https://vercel.com/docs/og-image-generation) image (that gets automatically generated)?
...
## [Overview and instructions](https://vercel.com/docs/integrations/create-integration/approval-checklist\#overview-and-instructions)
...
- Do the instructions clearly mention all [environment variables](https://vercel.com/docs/integrations/create-integration/submit-integration#additional-information) that get set and ideally, what they are used for?
Use the [comment property](https://vercel.com/docs/rest-api/endpoints#projects/create-one-or-more-environment-variables/body-parameters) when creating environment variables.

- Does additional documentation exist? If so, is the documentation URL set?


## [Installation flow](https://vercel.com/docs/integrations/create-integration/approval-checklist\#installation-flow)
...
### [Deploy button flow](https://vercel.com/docs/integrations/create-integration/approval-checklist\#deploy-button-flow)
...
- Does the integration crash if it's already present on the [selected scope](https://vercel.com/docs/integrations/create-integration/submit-integration#deploy-button-installation-flow)?
The integration shouldn't treat the passed `configurationId` as a new installation since it was previously installed.


## [Integration is installed successfully](https://vercel.com/docs/integrations/create-integration/approval-checklist\#integration-is-installed-successfully)
