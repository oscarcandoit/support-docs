...
database](https://vercel.com/kb/guide/vector-databases) service that handles the storage and search
...
## [Use cases](https://vercel.com/docs/ai/pinecone\#use-cases)
...
## [Getting started](https://vercel.com/docs/ai/pinecone\#getting-started)

The Vercel Pinecone integration can be accessed through the AI tab on your [Vercel dashboard](https://vercel.com/dashboard).

### [Prerequisites](https://vercel.com/docs/ai/pinecone\#prerequisites)
...
### [Add the provider to your project](https://vercel.com/docs/ai/pinecone\#add-the-provider-to-your-project)

#### [Using the dashboard](https://vercel.com/docs/ai/pinecone\#using-the-dashboard)

01. Navigate to the AI tab in your [Vercel dashboard](https://vercel.com/dashboard)
02. Select Pinecone from the list of providers, and press Add
...
10. Connect your project using the code below:
    ...
    4const pc = new Pinecone();

    5
    ```


## [Deploy a template](https://vercel.com/docs/ai/pinecone\#deploy-a-template)

You can deploy a template to Vercel that includes a pre-trained model and a sample application that uses the model:

[![Pinecone - Vercel AI SDK Starter](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F1G4xSqx0bCgVVv3aY3rrX4%2Ffa27791c39ddf058995561d794a68710%2FCleanShot_2023-07-21_at_11.55.49.png&w=3840&q=75)\\
\\
...
## [More resources](https://vercel.com/docs/ai/pinecone\#more-resources)
