---
title: "API Scripts and client libraries"
source: "https://docs.virustotal.com/docs/api-scripts-and-client-libraries"
scraped_at: "2026-02-08T06:19:25.082Z"
---

VirusTotal&#x27;s API lets you upload and scan files or URLs, access finished scan reports and make automatic comments without the need of using the website interface. In other words, it allows you to build simple scripts to access the information generated by VirusTotal. You may learn more about it in our [Developer Hub](/reference/overview).

VirusTotal Community members have written a number of scripts in different programming languages to interact with our [API](/reference/overview). Those scripts are listed here. **VirusTotal itself is not responsible for these scripts, which are contributions by the Community. Use them at your own risk and make sure you follow our [Terms of Service](https://docs.virustotal.com/docs/terms-of-service).**
...
# API V3 official client libraries[](#api-v3official-client-libraries)

---

[*](https://github.com/VirusTotal/vt-go) [![python_icon.svg](https://storage.googleapis.com/vtdocresources/guides/tools/python_icon.svg)](https://github.com/VirusTotal/vt-py)
...
### Maltego Transforms[](#maltego-transforms-1)
