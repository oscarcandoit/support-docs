...
# Address your comments[](#address-your-comments)

If you are answering another VirusTotal Community member&#x27;s file or URL comment, don&#x27;t forget to address your answer to them by using the @user_nickname syntax:

@EmilianoMartinez

# Tag your comments[](#tag-your-comments)
...
# Users can then search through comments for specific tags using the VirusTotal Intelligence *comment* modifier.[](#users-can-then-search-through-comments-for-specific-tags-using-the-virustotal-intelligence-comment-modifier)
...
# Flag files and URLs as malicious or harmless[](#flag-files-and-urls-as-malicious-or-harmless)
