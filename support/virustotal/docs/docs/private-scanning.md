---
title: "Private Scanning"
source: "https://docs.virustotal.com/docs/private-scanning"
scraped_at: "2026-02-08T06:19:22.628Z"
---
...
Private Scanning does not replace VirusTotal&#x27;s standard upload experience, you must use the [Private Scanning form](https://www.virustotal.com/gui/private-scanning/.) to keep uploads private. When using Private Scanning:[](#important-observationsprivate-scanning-does-not-replace-virustotals-standard-upload-experience-you-must-use-the-private-scanning-form-to-keep-uploads-private-when-using-private-scanning)
...
As with most of our functionality you have two options to use it, through our [API](/reference/private-files-api) or via the web interface. We have also developed a [command-line script](https://storage.googleapis.com/vtcdn/api-scripts/privscan.py) to get you started with automation.

# Accessing the Private Scanning web interface[](#accessing-the-private-scanning-web-interface)
...
![Private Scanning Link](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_link_20230929.png)
...
![Private Scanning Menu](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_menu_20240110.png)
...
# Analyzing using the Private Scanning module[](#analyzing-using-the-private-scanning-module)
...
*
![Private Scanning Link from homepage](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_links2_20240110.png)

## Analyzing a file[](#analyzing-a-file)

**ℹ️
### Compressed files (ZIP, 7z, RAR, tar.bz2, etc)**[](#compressed-files-zip-7z-rar-tarbz2-etc)
...
![Private Scanning Options](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_options_20250205.png)
...
![Private Scanning Known File](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_knownfile_20240109.png)
...
![Private Scanning Report](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_report_20240109.png)
...
## Analyzing a URL[](#analyzing-a-url)
...
![Private Scanning URL options](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_url_options_20240109.png)
...
![Private Scanning URL analysis](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_url_analysis_20240109.png)

# Private Scanning file reports[](#private-scanning-file-reports)
...
![Private Scanning Detection](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_detection_20240109.png)
...
![Private Scanning Behavior](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_behavior_20230929.png)
...
![Private Scanning](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_activity_20230929.png)
...
![Private Scanning](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_community_20230929.png)

# Locating similar files and expanding context[](#locating-similar-files-and-expanding-context)
...
![Private Scanning Similar](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_similar_20240109.png)
...
![Private Scanning](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_distributionvectors_20230929.png)
...
![Private Scanning Actors](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_actors_20230929.png)

# Deleting files and analysis reports[](#deleting-files-and-analysis-reports)
...
# Private Scanning URL reports[](#private-scanning-url-reports)
...
![Private Scanning URL details](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_url_details_20240109.png)

The **behavior tab** displays useful information such as page statistics, cookies, HTTP transactions, a screenshot, etc.

![Private Scanning URL behavior](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_url_behavior_20240109.png)

# Private Analysis Workflow[](#private-analysis-workflow)
...
# Final technical highlights[](#final-technical-highlights)

![Private Scanning Final Highlights](https://storage.googleapis.com/vtdocresources/guides/private-scanning/privatescanning_highlights_20230929.png)
**❓
### Looking for a benefit analysis?**
You may want to share the [Private Scanning brief](https://assets.virustotal.com/vt-brief-private-scanning.pdf) with your stakeholders or leadership in order to justify its value.[](#looking-for-a-benefit-analysisyou-may-want-to-share-the-private-scanning-brief-with-your-stakeholders-or-leadership-in-order-to-justify-its-value)
