---
title: "VirusTotal Intelligence Introduction"
source: "https://docs.virustotal.com/docs/virustotal-intelligence-introduction"
scraped_at: "2026-02-08T06:19:18.456Z"
---

# How to perform file searches[](#how-to-perform-file-searches)
...
[Identifying files according to antivirus detections](/docs/list-file-engines)

[Search modifiers](/docs/search-modifiers-full-list)

[Content search (VTGrep)](/docs/vtgrep)

[File similarity search](/docs/file-similarity-search)

[URL search modifiers](/docs/url-search-modifiers)

[Domain search modifiers](/docs/domain-search-modifiers)

[IP address search modifiers](/docs/ip-address-search-modifiers)

[Results reports](/docs/results-reports)

We also provided a script for [Batch file downloads](/docs/batch-file-downloads) and some [Example use cases](#example-use-cases).
...
## AND Boolean operator[](#and-boolean-operator)
...
## NOT Boolean operator[](#not-boolean-operator)
...
## Parentheses for grouping parts[](#parentheses-for-grouping-parts)
...
## Studying malicious PDFs[](#studying-malicious-pdfs)
...
## Retrieving exploit samples[](#retrieving-exploit-samples)
...
## Identifying potential false positives[](#identifying-potential-false-positives)
