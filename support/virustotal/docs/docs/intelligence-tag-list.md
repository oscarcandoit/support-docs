---
title: "Full list of VirusTotal Intelligence tag modifier"
source: "https://docs.virustotal.com/docs/intelligence-tag-list"
scraped_at: "2026-02-08T06:19:21.114Z"
---

One of the search modifiers available in [VirusTotal Intelligence](/docs/file-search-modifiers) is "tag". This modifier will search for files tagged with the literal provided. VirusTotal adds tags to all files processed based on hundreds of factors depending on the type of file, information extracted, behaviour, etc.

You can find the description and examples of the most common tags at the [File search modifiers article](/docs/file-search-modifiers).
