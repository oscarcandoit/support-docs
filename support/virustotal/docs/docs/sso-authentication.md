...
source: "https://docs.virustotal.com/docs/sso-authentication"
scraped_at: "2026-02-08T06:19:18.479Z"
---
...
# Create a new VT account using SSO[](#create-a-new-vt-account-using-sso)
...
# Login to an existing account using SSO[](#login-to-an-existing-account-using-sso)
...
# Group SSO settings[](#group-sso-settings)
...
We have articles with examples of how to [configure SAML with Okta](/docs/saml-okta), [configure SAML with Ping](/docs/saml-ping) or [configure SAML with EntraID](/docs/saml-entraid)
