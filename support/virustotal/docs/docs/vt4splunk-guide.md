---
title: "VT4Splunk, official VirusTotal app for Splunk"
source: "https://docs.virustotal.com/docs/vt4splunk-guide"
scraped_at: "2026-02-08T06:19:25.211Z"
---
...
- `VirusTotal API Key`:
Your API key can be found at [https://www.virustotal.com/gui/my-apikey](https://www.virustotal.com/gui/my-apikey) (sign in required). As a premium user you can also generate service accounts in your group profile.
...
### Ignoring specific IoCs[](#ignoring-specific-iocs)
...
### Empty dashboards[](#empty-dashboards)
...
### Upgrade from all versions[](#upgrade-from-all-versions)
...
### Upgrade from 1.4.* versions[](#upgrade-from-14-versions)
...
### Upgrade from 1.2.0 version[](#upgrade-from-120-version)
...
- 
Email [[email&#160;protected]](contact@virustotal.com)
