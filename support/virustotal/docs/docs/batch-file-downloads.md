---
title: "Batch file downloads"
source: "https://docs.virustotal.com/docs/batch-file-downloads"
scraped_at: "2026-02-08T06:19:24.839Z"
---
...
After installing the library, you can use the [search_and_download_topn_files.py](https://github.com/VirusTotal/vt-py/blob/master/examples/search_and_download_topn_files.py) script:
...
`python3 search\_and\_download\_topn\_files.py -n 500 &#x27;type:"peexe"&#x27; --apikey $VT\_API\_KEY`**Updated about 2 months ago