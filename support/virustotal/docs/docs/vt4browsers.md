---
title: "VT4Browsers + Google TI"
source: "https://docs.virustotal.com/docs/vt4browsers"
scraped_at: "2026-02-08T06:19:25.046Z"
---
...
**📘
### Note for Google Threat Intelligence users[](#note-for-google-threat-intelligence-users)
...
# Uploading and scanning files automatically with VirusTotal[](#uploading-and-scanning-files-automatically-with-virustotal)
...
# IoC contextualization with VT AUGMENT[](#ioc-contextualization-with-vt-augment)
...
![VT4Browsers API key](https://storage.googleapis.com/vtdocresources/guides/tools/vt4browsersvtapikey_20230921.png)

The VT Augment functionality allows you to highlight or enrich IoCs (hashes, domains, IPs, URLs) in pages of your choice and works best with [premium API keys](/reference/public-vs-premium-api), as these are not rate limited. You can [request a premium API key via our commercial inquiry contact form](https://www.virustotal.com/gui/contact-us/premium-services).
...
### Understanding Detection Colors[](#understanding-detection-colors)
...
# Security analyst shortcuts via right-click[](#security-analyst-shortcuts-via-right-click)
