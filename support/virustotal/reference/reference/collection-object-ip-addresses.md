---
title: "🔀 ip_addresses"
source: "https://docs.virustotal.com/reference/collection-object-ip-addresses"
scraped_at: "2026-02-08T06:35:42.753Z"
---

The *ip_addresses* relationship return the list of ***all IP addresses in the Collection***.

This relationship can be retrieved using the [relationships API](/reference/get-collections-relationship) endpoint. The response contains a list of [IP address](/reference/ip-object) objects.

/collections/{id}/ip_addressesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "self": "https://virustotal.com/api/v3/collections/testdata_collection/ip_addresses?limit=1",
 "next": "https://virustotal.com/api/v3/collections/testdata_collection/ip_addresses?cursor=eyJsaW1pdCI6IDEsICJvZmZzZXQiOiAxfQ%3D%3D&limit=1"
 },
 "meta": {
 "count": 2,
