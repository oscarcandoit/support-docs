---
title: "🔀🔒 urls"
source: "https://docs.virustotal.com/reference/ip-object-urls"
scraped_at: "2026-02-08T06:35:50.352Z"
---

The *urls* relationship returns a list of the IP&#x27;s URLs. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/ip-relationships). The response contains a list of [URL](/reference/url-object) objects.

/ip_addresses/{ip_address}/urlsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
