---
title: "🔀 bundled_files"
source: "https://docs.virustotal.com/reference/file-object-bundled-files"
scraped_at: "2026-02-08T06:35:46.393Z"
---

The *bundled_files* relationship returns the list of ***all files bundled inside a given file***.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [Files](/reference/files) objects. It also includes the following context attributes:

- `bundle_date`: <*string*> date the file was added to the bundle in `%Y-%m-%d %H:%M:%S` [format](http://strftime.org/).

- `bundle_id`: <*string*> file ID.

- `filename`: <*string*> filename the file has inside the bundle.

- `guid`: <*string*> GUID of the container where this image was found.

- `size`: <*integer*> file size in bytes. Is 0 when the file is a directory.

- `type_description`: <*string*> type of file (i.e. "directory", "file", "Portable Executable"...).

/files/{file_hash}/bundled_filesExample
```
`{
 "data": [
 "attributes": <MDXishSnakeCase0>,
 "context_attributes": {
 "bundle_date": "<string:%Y-%m-%d %H:%M:%S>",
 "bundle_id": "<string>",
 "filename": "<string>",
 "guid": "<string>",
 "size": <int>,
...
`{
 ...
 "context_attributes": {
 "bundle_date": "2003-11-27 21:09:16",
 "filename": "blablabla.exe",
 "guid": "67456696-1865-66c5-699d-6360c67d5672",
 "size": 445440,
 ...
 {
 "context_attributes": {
 "bundle_date": "2017-07-23 12:23:08",
 "filename": "blabla v0.2.2/README.txt",
 "size": 1555,
 "type_description": "unknown"
 },
 "error": {
 "code": "NotFoundError",
 "message": "file with id \"2e1591a35cdcf3c59d3c351f8652405aa2b55c4a5c345b5e51db5655f5a33072\" not found"
 },
 "id": "2e1591a35cdcf3c59d3c351f8652405aa2b55c4a5c345b5e51db5655f5a33072",
 "type": "file"
 }
 ],
 "links": {
 "next": "https://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/bundled_files?cursor=STEwCi4%3D&limit=2",
 "self": "https://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/bundled_files?limit=2"
 },
 "meta": {
 "count": 8,
 "cursor": "STEwCi4="
