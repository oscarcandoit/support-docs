...
source: "https://docs.virustotal.com/reference/service-accounts-object"
scraped_at: "2026-02-08T06:35:52.695Z"
---
...
In addition to the previously described attributes, Service Account objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section.
...
| --- | --- | --- | --- |
| api_quota_group | Group from which the Service Account consumes API quota. | Group Admin | A single [Group](/reference/group-object) object. |
| comments | Comments posted by the Service Account. | Everyone. | A list of [Comments](/reference/comments). |
| groups | Groups the Service Account belongs to. | Group Admin. | A list of [Groups](/reference/group-object). |
| intelligence_quota_group | Group from which the Service Account consumes intelligence quota. | Group Admin | A single [Group](/reference/group-object) object. |
