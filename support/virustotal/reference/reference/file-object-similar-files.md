---
title: "🔀🔒 similar_files"
source: "https://docs.virustotal.com/reference/file-object-similar-files"
scraped_at: "2026-02-08T06:35:46.942Z"
---

The *similar_files* relationship returns a list of **similar files to a given one**. The association is made by using VirusTotal&#x27;s in-house vhash. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [File](/reference/files) objects.

/files/{file_hash}/similar_filesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "resource_details": [
 {
 "chi2": 4753.37744140625,
 "entropy": 4.968014717102051,
 "filetype": "application/xml",
 "lang": "NEUTRAL",
 "sha256": "abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c",
 "type": "RT_MANIFEST"
 }
 ],
 "resource_langs": {
 ...
 "links": {
 "next": "https://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/similar_files?cursor=STewei4%3D&limit=1",
 "self": "https://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/similar_files?limit=1"
 },
 "meta": {
 "count": 100,
 "cursor": "STewei4="
