...
source: "https://docs.virustotal.com/reference/hunting-ruleset-notification-files"
scraped_at: "2026-02-08T06:35:49.757Z"
---

The *hunting_notification_files* relationship returns ***all files associated to notifications triggered by a given ruleset***. This relationship is only visible for the account&#x27;s owner.

This relationship can be retrieved by using the [relationships API endpoint](/reference/get-hunting-ruleset-full-relationships) and returns a list of [File](/reference/files) objects.

/hunting_rulesets/{id}/hunting_notification_filesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
