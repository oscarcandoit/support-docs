---
title: "🔀🔒 submissions"
source: "https://docs.virustotal.com/reference/url-object-submissions"
scraped_at: "2026-02-08T06:35:52.179Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [Submission](/reference/submission-object) objects.

/urls/{url_id}/submissionsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
