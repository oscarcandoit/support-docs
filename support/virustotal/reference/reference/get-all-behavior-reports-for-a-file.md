---
title: "Get all behavior reports for a file"
source: "https://docs.virustotal.com/reference/get-all-behavior-reports-for-a-file"
scraped_at: "2026-02-08T06:35:35.694Z"
---

This endpoint returns behavioural information from each sandbox about the file.

This API call returns all fields contained in the [File behaviour](/reference/file-behaviour-summary) object.

Note some of the entries have

- `has_html_report` if true you may fech the HTML [File behaviour](/reference/get-file-behaviours-html).

- `has_pcap` if true you may fech the PCAP [File behaviour](/reference/get-file-behaviours-pcap).
