---
title: "🔀 references"
source: "https://docs.virustotal.com/reference/collection-object-references"
scraped_at: "2026-02-08T06:35:42.724Z"
---

The *references* relationship return the list of ***all references in the Collection***.

This relationship can be retrieved using the [relationships API](/reference/get-collections-relationship) endpoint. The response contains a list of [Reference](/reference/references) objects.

/collections/{id}/referencesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
