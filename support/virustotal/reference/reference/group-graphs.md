---
title: "🔀🧑‍💻 graphs"
source: "https://docs.virustotal.com/reference/group-graphs"
scraped_at: "2026-02-08T06:35:49.838Z"
---
...
It can be fetched using the [relationships API endpoint](/reference/groups-relationships) and it returns a list of [Graph](/reference/graph-object) objects.

/groups/{id}/graphsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
