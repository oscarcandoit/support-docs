---
title: "🔀 graphs"
source: "https://docs.virustotal.com/reference/domain-object-graphs"
scraped_at: "2026-02-08T06:35:44.316Z"
---

The *graphs* relationship returns a list of **graphs containing the given domain**.

This relationship can be retrieved using the [relationships API endpoint](/reference/domains-relationships). The response contains a list of [Graph](/reference/graph-object) objects.
