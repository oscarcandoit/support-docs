---
title: "YARA Rulesets"
source: "https://docs.virustotal.com/reference/yara-rulesets"
scraped_at: "2026-02-08T06:35:52.710Z"
---
...
In addition to the previously described attributes, YARA rulesets objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section.
...
| --- | --- | --- | --- |
| yara_rules | Returns all YARA rules contained in this ruleset. | Everyone. | A list of [YARA Rules](/reference/yara-rule) |