---
title: "signature_info"
source: "https://docs.virustotal.com/reference/file-object-signature-info"
scraped_at: "2026-02-08T06:35:45.860Z"
---
...
`x509`: <*list of dictionaries*> list of certificates found in the file. Every item in the list is an [SSL Certificate](/reference/ssl-certificate) object, but returning just the following fields from the object:
...
Signature informationExample (PE)Example (Mach-O)
```
`{
 "data": {
 ...
