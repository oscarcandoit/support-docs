---
title: "🔀 graphs"
source: "https://docs.virustotal.com/reference/file-object-graphs"
scraped_at: "2026-02-08T06:35:46.505Z"
---

The *graphs* relationship returns a list of **graphs containing the given file**.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [Graph](/reference/graph-object) objects.

/files/{file_hash}/graphsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
