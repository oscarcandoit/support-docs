---
title: "🔀 item"
source: "https://docs.virustotal.com/reference/analysis-object-item"
scraped_at: "2026-02-08T06:35:42.048Z"
---

The *item* relationship returns the ***entity being analysed***.

This relationship can be retrieved by using the [relationships API endpoint](/reference/analyses-get-objects). The response can contain one of the following object types:

- [File](/reference/files)

- [URL](/reference/url-object)
