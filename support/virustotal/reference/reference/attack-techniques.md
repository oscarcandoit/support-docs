...
source: "https://docs.virustotal.com/reference/attack-techniques"
scraped_at: "2026-02-08T06:35:42.692Z"
---
...
`revoked`: <*boolean*> indicates if the technique has been revoked. If a technique has been revoked you can retrieve the new technique using the [revoking_technique](/reference/attack-technique-object-revoking-technique) relationship.
`stix_id`: <*string*> technique&#x27;s STIX ID.

Attack technique objectExample
`{
 "data": {
 "attributes": {
 "info": <dictionary>,
...
In addition to the previously described attributes, attack technique objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section.

The following table shows a summary of available relationships.

| Relationship | Return object type |
| --- | --- |
| attack_tactics | List of [Attack Tactics](/reference/attack-tactics) |
| parent_technique | A single [Attack Technique](/reference/attack-techniques) |
| revoking_technique | A single [Attack Technique](/reference/attack-techniques) |
| subtechniques | List of [Attack Techniques](/reference/attack-techniques) |
