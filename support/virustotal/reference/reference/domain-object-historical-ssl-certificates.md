...
source: "https://docs.virustotal.com/reference/domain-object-historical-ssl-certificates"
scraped_at: "2026-02-08T06:35:44.342Z"
---

The *historical_ssl_certificates* relationship returns a list of **SSL certificates that have been associated with the domain at some moment in time**.

This relationship can be retrieved using the [relationships API endpoint](/reference/domains-relationships). The response a list of [SSL Certificate](/reference/ssl-certificate) objects. It also includes two context_attributes:
