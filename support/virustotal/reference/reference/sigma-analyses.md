---
title: "Sigma Analyses"
source: "https://docs.virustotal.com/reference/sigma-analyses"
scraped_at: "2026-02-08T06:35:51.448Z"
---
...
In addition to the previously described attributes, Sigma Analysis objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section.
...
| --- | --- | --- | --- |
| rules | Sigma rules that matched an analysis | Everyone | A list of [Sigma Rules](/reference/sigma-rule-object). |
