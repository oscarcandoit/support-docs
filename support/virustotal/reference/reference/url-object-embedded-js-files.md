---
title: "🔀🔒 embedded_js_files"
source: "https://docs.virustotal.com/reference/url-object-embedded-js-files"
scraped_at: "2026-02-08T06:35:52.166Z"
---
...
The relationship can be retrieved by using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [File](/reference/files) objects. The relationship contains the same context attributes as described in [🔀🔒 urls_for_embedded_js](/reference/urls-urls_for_embedded_js)

/urls/{url_id}/embedded_js_filesExample
```
`{
 "data": [
 {
