---
title: "🔀 immediate_parent"
source: "https://docs.virustotal.com/reference/domain-object-immediate-parent"
scraped_at: "2026-02-08T06:35:44.329Z"
---

The *immediate_parent* relationship returns the domain&#x27;s object immediate parent. For subdomains of the form `subdomain.domain.com`, the *immediate_parent* relationship will be the same as the [*parent*](/reference/domain-object-parent) relationship. For subdomains of the form `subdomain.subdomain.domain.com`, the *immediate_parent* returns `subdomain.domain.com` and the [*parent*](/reference/domain-object-parent) returns `domain.com`.

This relationship can be retrieved using the [relationships API endpoint](/reference/domains-relationships). The response contains a [Domain](/reference/domains-object) object.

/domains/{domain}/immediate_parentExample
```
`{
 "data": {
 <MDXishSnakeCase0>
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/domains/bar.foo.fooapis.com/immediate_parent"
 },
 "meta": {
 "count": 1
 }
