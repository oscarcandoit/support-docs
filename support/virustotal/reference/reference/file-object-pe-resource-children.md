---
title: "🔀  pe_resource_children"
source: "https://docs.virustotal.com/reference/file-object-pe-resource-children"
scraped_at: "2026-02-08T06:35:47.027Z"
---

The *pe_resource_children* relationship returns a list of ***PE files contained by the file as a resource***. PE resource children are files contained into another file as a resource.
...
/files/{file_hash}/pe_resource_childrenExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
