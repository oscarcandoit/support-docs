---
title: "🔀 files"
source: "https://docs.virustotal.com/reference/collection-object-files"
scraped_at: "2026-02-08T06:35:42.801Z"
---

The *files* relationship returns the list of ***all files in the Collection***.

This relationship can be retrieved using the [relationships API](/reference/get-collections-relationship) endpoint. The response contains a list of [File](/reference/files) objects.

/collections/{id}/filesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
