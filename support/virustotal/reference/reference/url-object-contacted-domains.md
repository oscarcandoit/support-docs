...
source: "https://docs.virustotal.com/reference/url-object-contacted-domains"
scraped_at: "2026-02-08T06:35:51.525Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [Domain](/reference/domains-object) objects.

/urls/{url_id}/contacted_domains Example
```
`{
 "data": [
 <MDXishSnakeCase0>,
