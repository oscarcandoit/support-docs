...
source: "https://docs.virustotal.com/reference/ip-object-related-references"
scraped_at: "2026-02-08T06:35:49.824Z"
---

The *related_references* relationship returns a list of ***references related to the IP address***.

This relationship can be retrieved using the [relationships API endpoint](/reference/ip-relationships). The response contains a list of [References](/reference/references) objects.

/ip_addresses/{id}/related_referencesExample
```
`{
 "meta": {
 "count": <int>
