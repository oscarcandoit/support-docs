---
title: "Relationships"
source: "https://docs.virustotal.com/reference/relationships"
scraped_at: "2026-02-08T06:35:33.085Z"
---
...
`https://www.virustotal.com/api/v3/{collection name}/{object id}/relationships/{relationship}`
One-to-many relationships are simply collections that contains objects that are somehow related to a primary object, so they usually have their own URL that you can use to iterate over the related objects by sending `GET` requests to the URL as described in the [Collections](/reference/collections) section. Actually, there are two types of URLs:
...
## Relationships with objects not present in VirusTotal&#x27;s database[](#relationships-with-objects-not-present-in-virustotals-database)
