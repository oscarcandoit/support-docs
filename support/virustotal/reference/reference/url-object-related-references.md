...
source: "https://docs.virustotal.com/reference/url-object-related-references"
scraped_at: "2026-02-08T06:35:52.155Z"
---

The *related_references* relationship returns a list of ***references related to the URL***.

This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [References](/reference/references) objects.

/urls/{url_id}/related_referencesExample
```
`{
 "meta": {
 "count": <int>
