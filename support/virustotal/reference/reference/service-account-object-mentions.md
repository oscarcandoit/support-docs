---
title: "🔀 mentions"
source: "https://docs.virustotal.com/reference/service-account-object-mentions"
scraped_at: "2026-02-08T06:35:52.642Z"
---

The *mentions* relationship returns a list of ***all comments mentioning a given Service Account***.

This relationship can be retrieved by using the [relationships API endpoint](/reference/users-relationships) and returns a list of [Comment](/reference/comments) objects.

/users/{user_id}/mentionsExample
```
`{
 "data": [
 <MDXishSnakeCase0>
