---
title: "Hunting Notifications"
source: "https://docs.virustotal.com/reference/hunting-notification-object"
scraped_at: "2026-02-08T06:35:49.832Z"
---
...
> 
> 
> This object is no longer used by the web interface. Use [IoC-Stream Notifications](/reference/ioc-stream-notifications) instead.
> 
> 

A Hunting Notification object represents a notification generated when one of the YARA rules in a [Hunting Ruleset](/reference/hunting-ruleset-object) matches a file sent to VirusTotal. This object is only visible for the Hunting Ruleset&#x27;s owner and any user the ruleset was shared with.
...
Hunting Notification objectExample
```
`{
 "data": {
 "attributes": {
