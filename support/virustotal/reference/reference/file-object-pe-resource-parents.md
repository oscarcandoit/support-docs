---
title: "🔀 pe_resource_parents"
source: "https://docs.virustotal.com/reference/file-object-pe-resource-parents"
scraped_at: "2026-02-08T06:35:47.075Z"
---

The *pe_resource_parents* relationship returns a list of ***PE files containing a given file as resource***.
...
/files/{file_hash}/pe_resource_parentsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/pe_resource_parents?limit=10"
 },
 "meta": {
 "count": 1
 }
