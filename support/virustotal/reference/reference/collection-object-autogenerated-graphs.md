---
title: "🔀 autogenerated_graphs"
source: "https://docs.virustotal.com/reference/collection-object-autogenerated-graphs"
scraped_at: "2026-02-08T06:35:42.781Z"
---
...
The relationship can be retrieved using the [relationships API](/reference/get-collections-relationship) endpoint. The response contains a list of [Graph](/reference/graph-object) objects.

/collections/{id}/autogenerated_graphsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
