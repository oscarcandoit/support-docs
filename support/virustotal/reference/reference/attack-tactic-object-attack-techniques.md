...
source: "https://docs.virustotal.com/reference/attack-tactic-object-attack-techniques"
scraped_at: "2026-02-08T06:35:42.646Z"
---

The *attack_techniques* relationship returns the list of ***attack techniques belonging to the tactic***.

The relationship can be retrieved using the relationships API endpoint. The response contains a list of [Attack Technique](/reference/attack-techniques) objects.
