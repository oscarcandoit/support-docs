---
title: "🔀 file"
source: "https://docs.virustotal.com/reference/file-behaviour-object-file"
scraped_at: "2026-02-08T06:35:49.125Z"
---

The *file* relationship returns the ***file for a given behaviour report***.

This relationship can be retrieved by using the [relationships API endpoint](/reference/get-file-behaviours-relationship). The response contains a [file](/reference/files) object.

/file_behaviours/{id}/fileExample
```
`{
 "data": <FILE>,
 "links": {
