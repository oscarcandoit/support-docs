...
source: "https://docs.virustotal.com/reference/domain-object-communicating-files"
scraped_at: "2026-02-08T06:35:44.306Z"
---

The *communicating_files* relationship lists all **files presenting any sort of traffic to the given domain** at some point of its execution.
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/domains/foo.com/communicating_files?limit=10"
 },
 "meta": {
 "count": 1
 }
