---
title: "🔀🔒 embedded_urls"
source: "https://docs.virustotal.com/reference/file-object-embedded-urls"
scraped_at: "2026-02-08T06:35:46.430Z"
---

The *embedded_urls* relationship returns the list of ***all URLs embedded in a given file***. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [URL](/reference/url-object) objects.

/files/{file_hash}/embedded_urlsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
