---
title: "🔀🔒 analyses"
source: "https://docs.virustotal.com/reference/file-object-analyses"
scraped_at: "2026-02-08T06:35:45.868Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [Analysis](/reference/analyses-object) objects.

/files/{file_hash}/analysesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
