---
title: "🔀🔒 related_threat_actors"
source: "https://docs.virustotal.com/reference/url-object-related-threat-actors"
scraped_at: "2026-02-08T06:35:52.186Z"
---

The *related_threat_actors* relationship returns a list of ***threat actors related to the URL***.

This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [Threat Actors](/reference/threat-actors-object) objects.

/urls/{url_id}/related_threat_actorsExample
```
`{
 "meta": {
 "count": <int>
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/urls/9a99a24b65c8336298d5dcd773303675c0fa79fd53f6ec19da03588ddb57836a/related_threat_actors?limit=10"
 }
}`
```