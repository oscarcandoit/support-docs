---
title: "Retrohunt Jobs"
source: "https://docs.virustotal.com/reference/retrohunt-job-object"
scraped_at: "2026-02-08T06:35:51.572Z"
---
...
In addition to the previously described attributes, Retrohunt Jobs objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section.
...
| --- | --- | --- | --- |
| matching_files | Returns all files matched during the job&#x27;s execution. | Owner. | A list of [Files](/reference/files). |
| owner | Returns the job&#x27;s owner. | Owner. | A single [User](/reference/user-object) object. |
