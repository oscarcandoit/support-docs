---
title: "🔀🔒 overlay_parents"
source: "https://docs.virustotal.com/reference/file-object-overlay-parents"
scraped_at: "2026-02-08T06:35:47.083Z"
---

The *overlay_parents* relationship returns a list of ***files containing a given file as an overlay***. This relationship is only available for Premium API users.
...
/files/{file_hash}/overlay_parentsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
