---
title: "🔀🔒 overlay_children"
source: "https://docs.virustotal.com/reference/file-object-overlay-children"
scraped_at: "2026-02-08T06:35:47.109Z"
---

The *overlay_children* relationship returns a list of ***files contained by the file as an overlay.*** This relationship is only available for Premium API users. Overlay children are files that are contained as overlay in another sample.
...
/files/{file_hash}/overlay_childrenExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/overlay_children?limit=10"
 },
 "meta": {
 "count": 1
 }
