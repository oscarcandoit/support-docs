---
title: "🔀 execution_parents"
source: "https://docs.virustotal.com/reference/file-object-execution-parents"
scraped_at: "2026-02-08T06:35:46.409Z"
---

The *execution_parents* relationship returns the list of ***all files that executed a given file***. This relationship is extracted from sandbox analyses.
...
/files/{file_hash}/execution_parentsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
