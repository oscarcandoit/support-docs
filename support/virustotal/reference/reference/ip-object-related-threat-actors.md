...
source: "https://docs.virustotal.com/reference/ip-object-related-threat-actors"
scraped_at: "2026-02-08T06:35:50.345Z"
---

The *related_threat_actors* relationship returns a list of ***threat actors related to the IP address***.

This relationship can be retrieved using the [relationships API endpoint](/reference/ip-relationships). The response contains a list of [Threat Actors](/reference/threat-actors-object) objects.

/ip_addresses/{id}/related_threat_actorsExample
```
`{
 "meta": {
 "count": <int>
