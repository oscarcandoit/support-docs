...
source: "https://docs.virustotal.com/reference/domain-object-related-comments"
scraped_at: "2026-02-08T06:35:44.271Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [Comments](/reference/comments) objects. If the comment belongs to an object different than the domain itself, an additional context_attribute is added:
