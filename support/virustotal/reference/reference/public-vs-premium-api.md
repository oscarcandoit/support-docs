...
The Public API, on the other hand, is a set of endpoints available for everyone to use at no cost. The only thing you need in order to use the Public API is to sign up to VirusTotal Community and obtain your API key as described in [Getting started](/reference/getting-started).

**❗️
### Public API constraints and restrictions[](#public-api-constraints-and-restrictions)
...
**📘
### Premium API highlights[](#premium-api-highlights)
