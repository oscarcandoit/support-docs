---
title: "🔀🔒 analyses"
source: "https://docs.virustotal.com/reference/url-object-analyses"
scraped_at: "2026-02-08T06:35:51.538Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [Analyses](/reference/analyses-object) objects.

/urls/{url_id}/analysesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
