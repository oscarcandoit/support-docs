---
title: "🔀 memory_pattern_ips"
source: "https://docs.virustotal.com/reference/file-object-memory-pattern-ips"
scraped_at: "2026-02-08T06:35:46.983Z"
---

The *memory_pattern_ips* relationship returns the list of ***all IPs includded in the memory pattern of a given file***. This relationship is only available for Premium API users.
...
/files/{file_hash}/memory_pattern_ipsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
