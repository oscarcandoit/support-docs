---
title: "🔀 contacted_urls"
source: "https://docs.virustotal.com/reference/file-object-contacted-urls"
scraped_at: "2026-02-08T06:35:46.499Z"
---

The *contacted_urls* relationship returns the list of ***all URL addresses which were detected as contacted by the given file***.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [URLs](/reference/url-object) objects.

/files/{file_hash}/contacted_urlsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
