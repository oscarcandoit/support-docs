---
title: "🔀 siblings"
source: "https://docs.virustotal.com/reference/domain-object-siblings"
scraped_at: "2026-02-08T06:35:44.725Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/domains-relationships) and the response contains a list of [Domains](/reference/domains-object) objects.

/domains/{domain}/siblingsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
