...
source: "https://docs.virustotal.com/reference/ip-object-referrer-files"
scraped_at: "2026-02-08T06:35:50.406Z"
---

The *referrer_files* relationship returns a list of **files containing the given IP address on its strings**.
...
/ip_addresses/{ip_address}/referrer_filesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
