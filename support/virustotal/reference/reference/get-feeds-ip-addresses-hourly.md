---
title: "Get an hourly IP address feed batch"
source: "https://docs.virustotal.com/reference/get-feeds-ip-addresses-hourly"
scraped_at: "2026-02-08T06:35:41.490Z"
---
...
This endpoint returns a single package containing all minutely packages returned in [`/feeds/ip_addresses/{time}`](/reference/get-feeds-ip-addresses) endpoint for a given hour. The returned file is a .tar.bz2 file which contains the 60 minutely feeds for that hour.
