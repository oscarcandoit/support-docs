---
title: "🔀🔒 embedded_ips"
source: "https://docs.virustotal.com/reference/file-object-embedded-ips"
scraped_at: "2026-02-08T06:35:46.458Z"
---

The *embedded_ips* relationship returns the list of ***all IP addresses embedded in a given file***. This relationship is only available for Premium API users.
...
/files/{file_hash}/embedded_ipsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
