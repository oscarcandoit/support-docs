---
title: "Graphs"
source: "https://docs.virustotal.com/reference/graph-object"
scraped_at: "2026-02-08T06:35:48.296Z"
---
...
In addition to the previously described attributes, Graph objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section.
...
| --- | --- | --- | --- |
| comments | Comments for the graph. | Viewers. | A list of [Comments](/reference/comments). |
| editors | Graph&#x27;s editors. | Viewers. | A list of [Users](/reference/user-object) and [Groups](/reference/group-object). |
| group | Group owning the graph. | Viewers. | A single [Group](/reference/group-object) object. |
| items | Items related to the graph. They can be: files, urls, domains or IP addresses. | Viewers. | A list of [Files](/reference/files), [IP addresses](/reference/ip-object), [URLs](/reference/url-object) and [Domains](/reference/domains-object). |
| owner | Graph&#x27;s owner. | Viewers. | A single [User](/reference/user-object) object. |
| viewers | Graph&#x27;s viewers. | Viewers. | A list of [Users](/reference/user-object) and [Groups](/reference/group-object). |
