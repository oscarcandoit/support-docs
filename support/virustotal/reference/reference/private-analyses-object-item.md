---
title: "🔀 item"
source: "https://docs.virustotal.com/reference/private-analyses-object-item"
scraped_at: "2026-02-08T06:35:50.321Z"
---

The *item* relationship returns the ***entity being analysed***.

This relationship can be retrieved by using the [relationships API endpoint](/reference/get-private-analyses-relationship). The response contains a [private file](/reference/private-files) object.

/analyses/{analysis_id}/itemExample
```
`{
 "data": {
 <OBJECT>
