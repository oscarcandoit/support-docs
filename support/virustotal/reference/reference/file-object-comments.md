---
title: "🔀 comments"
source: "https://docs.virustotal.com/reference/file-object-comments"
scraped_at: "2026-02-08T06:35:46.473Z"
---

The *comments* relationship lists all comments posted by the VirusTotal community for a given file.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [Comment](/reference/comments) objects.

/files/{file_hash}/commentsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
