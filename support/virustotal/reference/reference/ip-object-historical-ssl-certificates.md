---
title: "🔀 historical_ssl_certificates"
source: "https://docs.virustotal.com/reference/ip-object-historical-ssl-certificates"
scraped_at: "2026-02-08T06:35:49.807Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/ip-relationships). The response a list of [SSL Certificate](/reference/ssl-certificate) objects. It also includes two context_attributes:
...
/ip_addresses/{ip_address}/historical_ssl_certificatesExample
```
`{
 "data": [
 {
...
`{
 ...
 "links": {
 "next": "https://www.virustotal.com/api/v3/ip_addresses/1.2.3.4/historical_ssl_certificates?cursor=fpgBChfKBGRhdGfSCQjUyceflsbpAhJ_ahFzfnZpcnVzdG90YWxjbG91ZHJqCxIKUGFzc2l2ZVNTTCJaZ29vZ2xlLmNvbSM0NDMjYWQzZGY4MmQ0MmVlMTUxNDI1ZTViZmQ3fmFjNDf4ZGEfY2MxfmI0MTI5YmQ5ZDg4MTJhMDA2MDZlYzNlZjBhNyMyMDIwLTA1LTIyDBgAIAE%3D&limit=1",
 "self": "https://www.virustotal.com/api/v3/ip_addresses/1.2.3.4/historical_ssl_certificates?limit=1"
 },
 "meta": {
 "count": 71,
