---
title: "🔀 owner"
source: "https://docs.virustotal.com/reference/graph-owner"
scraped_at: "2026-02-08T06:35:49.352Z"
---

The *owner* relationship returns ***the user owning a given graph***.

This relationship can be retrieved by using the [relationships API endpoint](/reference/graphs-relationships) and returns an [User](/reference/user-object) object.
