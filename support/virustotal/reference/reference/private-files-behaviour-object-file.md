---
title: "🔀 file"
source: "https://docs.virustotal.com/reference/private-files-behaviour-object-file"
scraped_at: "2026-02-08T06:35:50.296Z"
---

The *file* relationship returns the ***file for a given behaviour report***.

This relationship can be retrieved using the [relationships API endpoint](/reference/get-private-file-behaviours-relationship). The response contains a [private file](/reference/private-files) object.

/private/file_behaviours/{id}/fileExample
```
`{
