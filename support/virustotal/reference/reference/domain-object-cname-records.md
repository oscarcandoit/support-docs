---
title: "🔀🔒 cname_records"
source: "https://docs.virustotal.com/reference/domain-object-cname-records"
scraped_at: "2026-02-08T06:35:44.163Z"
---

The *cname_records* relationship returns a list of all domain&#x27;s CNAME records. This relationship is only available for premium API users.
...
This relationship can be retrieved using the [relationships API endpoint](/reference/domains-relationships). The response contains a list of [Domains](/reference/domains-object) objects.

/domains/{domain}/cname_recordsExample
```
`{
 "data": [
 {
