---
title: "IP addresses"
source: "https://docs.virustotal.com/reference/ip-object"
scraped_at: "2026-02-08T06:35:49.863Z"
---
...
In addition to the previously described attributes, IP address objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section. The available relationships are described in the following table:

| Relationship | Description | Accessibility | Return object type |
| --- | --- | --- | --- |
| comments | Comments for the IP address. | Everyone. | List of [Comments](/reference/comments). |
| communicating_files | Files that communicate with the IP address. | Everyone. | List of [Files](/reference/files). |
| downloaded_files | Files downloaded from the IP address. | VT Enterprise users only. | List of [Files](/reference/files). |
| graphs | Graphs including the IP address. | Everyone. | List of [Graphs](/reference/graph-object). |
| historical_ssl_certificates | SSL certificates associated with the IP. | Everyone. | List of [SSL Certificate](/reference/ssl-certificate). |
| historical_whois | WHOIS information for the IP address. | Everyone. | List of [Whois](/reference/whois). |
| related_comments | Community posted comments in the IP&#x27;s related objects. | Everyone. | List of [Comments](/reference/comments). |
| related_references | References related to the IP address. | VT Enterprise users only. | List of [References](/reference/references). |
| related_threat_actors | Threat actors related to the IP address. | VT Enterprise users only. | List of [Threat Actors](/reference/threat-actors-object). |
| referrer_files | Files containing the IP address. | Everyone. | List of [Files](/reference/files). |
| resolutions | IP address&#x27; resolutions | Everyone. | List of [Resolutions](/reference/resolution-object). |
| urls | URLs related to the IP address. | VT Enterprise users only. | List of [URLs](/reference/url-object). |
