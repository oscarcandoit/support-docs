---
title: "🔀🧑‍💻 hunting_notification_files"
source: "https://docs.virustotal.com/reference/user-object-hunting-notification-files"
scraped_at: "2026-02-08T06:35:52.682Z"
---

The *hunting_notification_files* relationship returns a list of ***all files flagged by a hunting notification for a given user.*** This relationship is only visible for the account&#x27;s owner.

This relationship can be retrieved by using the [relationships API endpoint](/reference/users-relationships) and returns a list of [File](/reference/files) objects. In addition, it includes the following context attributes taken from the corresponding [Hunting Notification](/reference/hunting-notification-object) and [Hunting Ruleset](/reference/hunting-ruleset-object) objects:
...
/users/{id}/hunting_notification_filesExample
```
`{
 "data": [
 {
