---
title: "dmg_info"
source: "https://docs.virustotal.com/reference/file-object-dmg-info"
scraped_at: "2026-02-08T06:35:44.792Z"
---

`dmg_info` reports data about [Apple .dmg file] ([https://en.wikipedia.org/wiki/Apple_Disk_Image](https://en.wikipedia.org/wiki/Apple_Disk_Image)) structure. much data comes from internal metadata files that may appear in some files but other don&#x27;t.
...
`unreadable_files`: <*integer*> number of unreadable files.
`timeout`: <*boolean*> whether the block&#x27;s processing took too long or not.
`volume_data`: <*dictionary*> ISO volume data. Check [isoimage_info](/reference/isoimage_info) output to know its structure.
