...
source: "https://docs.virustotal.com/reference/domain-object-related-threat-actors"
scraped_at: "2026-02-08T06:35:44.294Z"
---

The *related_threat_actors* relationship returns a list of ***threat actors related to the domain***.

This relationship can be retrieved using the [relationships API endpoint](/reference/domains-relationships). The response contains a list of [Threat Actors](/reference/threat-actors-object) objects.

/domains/{id}/related_threat_actorsExample
```
`{
 "meta": {
 "count": <int>
