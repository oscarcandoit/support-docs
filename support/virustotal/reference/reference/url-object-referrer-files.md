---
title: "🔀🔒 referrer_files"
source: "https://docs.virustotal.com/reference/url-object-referrer-files"
scraped_at: "2026-02-08T06:35:52.131Z"
---

The *referrer_files* relationships returns a list of all **files containing a given URL**. This relationship is only available for Premium API users.
...
/urls/{url_id}/referrer_filesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
