...
source: "https://docs.virustotal.com/reference/private-file-object-execution-parents"
scraped_at: "2026-02-08T06:35:50.288Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/private-files-relationships). The response contains a list of [private files](/reference/private-files) objects.

/private/files/{sha256}/execution_parentsExample
```
`{
 "data": [
 {
