---
title: "🔀 collections"
source: "https://docs.virustotal.com/reference/user-object-collections"
scraped_at: "2026-02-08T06:35:52.160Z"
---

The *collections* relationship returns a list of ***collections for a given user.***

This relationship can be retrieved by using the [relationships API endpoint](/reference/users-relationships) and returns a list containing [collection](/reference/collections-object) objects.
...
/users/{user_id}/collectionsExample
```
`{
 "data": [
 <MDXishSnakeCase0>
