---
title: "🔀 items"
source: "https://docs.virustotal.com/reference/graph-items"
scraped_at: "2026-02-08T06:35:49.233Z"
---

The *items* relationship returns all ***objects contained in a given graph***.

It can be fetched using the [relationships API endpoint](/reference/graphs-relationships) and it returns a list of [File](/reference/files), [URL](/reference/url-object), [IP address](/reference/ip-object) and [Domain](/reference/domains-object) objects.

/graphs/{id}/itemsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
