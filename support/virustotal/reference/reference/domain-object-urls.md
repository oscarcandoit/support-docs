---
title: "🔀🔒 urls"
source: "https://docs.virustotal.com/reference/domain-object-urls"
scraped_at: "2026-02-08T06:35:44.714Z"
---

The *urls* relationship returns a list of the domain&#x27;s URLs. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/domains-relationships). The response contains a list of [URL](/reference/url-object) objects.
