---
title: "🔀 collections"
source: "https://docs.virustotal.com/reference/ip-object-collections"
scraped_at: "2026-02-08T06:35:49.731Z"
---

The *collections* relationship lists all VirusTotal&#x27;s collections where this IP address is contained.

This relationship can be retrieved using the [relationships API endpoint](/reference/ip-relationships). The response contains a list of [Collections](/reference/collections) objects.

/ip_addresses/{ip_address}/collectionsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
