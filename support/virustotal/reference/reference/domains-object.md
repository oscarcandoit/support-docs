---
title: "Domains"
source: "https://docs.virustotal.com/reference/domains-object"
scraped_at: "2026-02-08T06:35:44.185Z"
---
...
In addition to the previously described attributes, Domain objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section. The available relationships are shown in the following table:

| Relationship | Description | Accessibility | Return object type |
| --- | --- | --- | --- |
| caa_records | Records CAA for the domain. | VT Enterprise users only. | List of [Domains](/reference/domains-object). |
| cname_records | Records CNAME for the domain. | VT Enterprise users only. | List of [Domains](/reference/domains-object). |
| comments | Community posted comments about the domain. | Everyone. | List of [Comments](/reference/comments). |
| communicating_files | Files that communicate with the domain. | Everyone. | List of [Files](/reference/files). |
| downloaded_files | Files downloaded from that domain. | VT Enterprise users only. | List of [Files](/reference/files). |
| graphs | Graphs including the domain. | Everyone. | List of [Graphs](/reference/graph-object). |
| historical_ssl_certificates | SSL certificates associated with the domain. | Everyone. | List of [SSL Certificate](/reference/ssl-certificate). |
| historical_whois | WHOIS information for the domain. | Everyone. | List of [Whois](/reference/whois). |
| immediate_parent | Domain&#x27;s immediate parent. | Everyone. | A single [Domain](/reference/domains-object). |
| mx_records | Records MX for the domain. | VT Enterprise users only. | List of [Domains](/reference/domains-object). |
| ns_records | Records NS for the domain. | VT Enterprise users only. | List of [Domains](/reference/domains-object). |
| parent | Domain&#x27;s top parent. | Everyone. | A single [Domain](/reference/domains-object). |
| referrer_files | Files containing the domain. | Everyone. | A list of [Files](/reference/files). |
| related_comments | Community posted comments in the domain&#x27;s related objects. | Everyone. | A list of [Comments](/reference/comments). |
| related_references | References related to the domain. | VT Enterprise users only. | A list of [References](/reference/references). |
| related_threat_actors | Threat actors related to the domain. | VT Enterprise users only. | A list of [Threat Actors](/reference/threat-actors-object). |
| resolutions | DNS resolutions for the domain. | Everyone. | A list of [Resolutions](/reference/resolution-object). |
| soa_records | Records SOA for the domain. | VT Enterprise users only. | List of [Domains](/reference/domains-object). |
| siblings | Domain&#x27;s sibling domains. | Everyone. | A list of [Domains](/reference/domains-object). |
| subdomains | Domain&#x27;s subdomains. | Everyone. | A list of [Domains](/reference/domains-object). |
| urls | URLs having this domain. | VT Enterprise users only. | A list of [URLs](/reference/url-object). |
| user_votes | Current user&#x27;s votes. | Everyone. | A list of [Votes](/reference/vote-object) |
