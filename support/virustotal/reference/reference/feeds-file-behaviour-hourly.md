---
title: "Get an hourly file behaviour feed batch"
source: "https://docs.virustotal.com/reference/feeds-file-behaviour-hourly"
scraped_at: "2026-02-08T06:35:40.864Z"
---
...
This endpoint returns a single package containing all minutely packages returned in [/feeds/file_behaviours/{time}](/reference/feeds-file-behaviour) endpoint for a given hour. The returned file is a `.tar.bz2` file which contains the 60 minutely feeds for that hour.
