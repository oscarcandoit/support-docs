---
title: "🔀🔒 itw_ips"
source: "https://docs.virustotal.com/reference/file-object-itw-ips"
scraped_at: "2026-02-08T06:35:46.424Z"
---

The *itw_ips* relationship returns a list of ***in the wild IP addresses from which the file has been downloaded.***. We have seen this file being downloaded from these IP addresses. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [IP address](/reference/ip-object) objects.

/files/{file_hash}/itw_ipsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "next": "http://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/itw_ips?cursor=eyJsaW1pdCI6IDEsICJvZmZzZXQiOiAxfQ%3D%3D%0A&limit=1",
 "self": "http://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/itw_ips?limit=1"
 },
 "meta": {
 "count": 26,
