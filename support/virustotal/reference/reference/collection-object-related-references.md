---
title: "🔀🔒 related_references"
source: "https://docs.virustotal.com/reference/collection-object-related-references"
scraped_at: "2026-02-08T06:35:42.658Z"
---

The *related_references* relationship returns a list of ***references related to the collection***.

This relationship can be retrieved using the [relationships API endpoint](/reference/get-collections-relationship). The response contains a list of [References](/reference/references) objects.

/collections/{id}/related_referencesExample
```
`{
 "meta": {
 "count": <int>
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/collections/malpedia_win_emotet/related_references?limit=2",
 "next": "https://www.virustotal.com/api/v3/collections/malpedia_win_emotet/related_references?cursor=eyJsaW1pdCI6IDIsICJvZmZzZXQiOiAyfQ%3D%3D&limit=2"
 }
}`
```