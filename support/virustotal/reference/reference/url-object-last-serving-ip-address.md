---
title: "🔀 last_serving_ip_address"
source: "https://docs.virustotal.com/reference/url-object-last-serving-ip-address"
scraped_at: "2026-02-08T06:35:52.138Z"
---

The *last_serving_ip_address* returns the URL&#x27;s last IP resolution.

This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains an [IP address](/reference/ip-object) object.

/urls/{url_id}/last_serving_ip_address Example
```
`{
 "data": {
 <MDXishSnakeCase0>
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/urls/afed5cd29ae397eb3c7ec5a7bef3952ef1ae7f6a62a9e4bbe9497e705f4eac5e/last_serving_ip_address"
 },
 "meta": {
 "count": 1
 }
