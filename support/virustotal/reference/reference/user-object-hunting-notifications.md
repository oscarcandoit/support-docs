---
title: "🔀🧑‍💻 hunting_notifications"
source: "https://docs.virustotal.com/reference/user-object-hunting-notifications"
scraped_at: "2026-02-08T06:35:52.648Z"
---
...
This relationship can be retrieved by using the [relationships API endpoint](/reference/users-relationships) and returns a list of [Hunting Notification](/reference/hunting-notification-object) objects.

/users/{id}/hunting_notificationsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
