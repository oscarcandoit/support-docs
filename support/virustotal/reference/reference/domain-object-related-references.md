...
source: "https://docs.virustotal.com/reference/domain-object-related-references"
scraped_at: "2026-02-08T06:35:44.215Z"
---

The *related_references* relationship returns a list of ***references related to the domain***.

This relationship can be retrieved using the [relationships API endpoint](/reference/domains-relationships). The response contains a list of [References](/reference/references) objects.
