...
source: "https://docs.virustotal.com/reference/private-analyses"
scraped_at: "2026-02-08T06:35:50.390Z"
---
...
Private analysis objectExample
`{
 "meta": {
 "file_info": {
 "size": <int>,
...
In addition to the previously described attributes, private analyses objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section.

The following table shows a summary of available relationships.

| Relationship | Return object type |
| --- | --- |
| item | A single [private file](/reference/private-files) |
| submitter | A single [user](/reference/user-object) |