---
title: "🔀🔒 carbonblack_children"
source: "https://docs.virustotal.com/reference/file-object-carbonblack-children"
scraped_at: "2026-02-08T06:35:46.534Z"
---

The *carbonblack_children* relationship returns the list of ***all files derived from a given file according to Carbon Black***. This relationship is only available for Premium API users.
...
/files/{file_hash}/carbonblack_childrenExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
