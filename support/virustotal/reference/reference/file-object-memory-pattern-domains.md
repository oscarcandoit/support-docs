---
title: "🔀 memory_pattern_domains"
source: "https://docs.virustotal.com/reference/file-object-memory-pattern-domains"
scraped_at: "2026-02-08T06:35:47.067Z"
---

The *memory_pattern_domains* relationship returns the list of ***all domains includded in the memory pattern of a given file***. This relationship is only available for Premium API users.
...
/files/{file_hash}/memory_pattern_domainsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
