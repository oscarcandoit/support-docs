---
title: "🔀 collections"
source: "https://docs.virustotal.com/reference/file-object-collections"
scraped_at: "2026-02-08T06:35:46.465Z"
---

The *collections* relationship lists all VirusTotal&#x27;s collections where this file is contained.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [Collections](/reference/collections) objects.

/files/{file}/collectionsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
