...
source: "https://docs.virustotal.com/reference/domain-object-downloaded-files"
scraped_at: "2026-02-08T06:35:44.237Z"
---

The *downloaded_files* relationship returns a list of **files that were available from an URL under the given domain or subdomain** at some moment. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/domains-relationships). The response contains a list of [File](/reference/files) objects.
...
`{
 ...
 "links": {
 "next": "https://www.virustotal.com/api/v3/domains/www.blablabla.net/downloaded_files?cursor=STgwCg4%3D&limit=1",
 "self": "https://www.virustotal.com/api/v3/domains/www.blablabla.net/downloaded_files?limit=1"
 },
 "meta": {
 "count": 50,
 "cursor": "STgwCg="
