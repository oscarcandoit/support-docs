---
title: "🔀 domains"
source: "https://docs.virustotal.com/reference/collection-object-domains"
scraped_at: "2026-02-08T06:35:42.737Z"
---

The *domains* relationship return the list of ***all domains in the Collection***.

This relationship can be retrieved using the [relationships API](/reference/get-collections-relationship) endpoint. The response contains a list of [Domain](/reference/domains-object) objects.

/collections/{id}/domainsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
