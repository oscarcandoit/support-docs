...
source: "https://docs.virustotal.com/reference/file-behaviour-object-attack-techniques"
scraped_at: "2026-02-08T06:35:49.202Z"
---

The *attack_techniques* relationship returns the ***attack techniques observed in the behaviour report***.

This relationship can be retrieved by using the [relationships API endpoint](/reference/get-file-behaviours-relationship). The response contains a list of [attack technique](/reference/attack-techniques) objects.
...
/file_behaviours/{id}/attack_techniquesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
