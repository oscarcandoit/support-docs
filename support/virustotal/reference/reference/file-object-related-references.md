...
source: "https://docs.virustotal.com/reference/file-object-related-references"
scraped_at: "2026-02-08T06:35:46.954Z"
---

The *related_references* relationship returns a list of ***references related to the file***.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [References](/reference/references) objects.

/files/{file_hash}/related_referencesExample
```
`{
 "meta": {
 "count": <int>
