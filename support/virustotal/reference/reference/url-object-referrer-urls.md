---
title: "🔀🔒 referrer_urls"
source: "https://docs.virustotal.com/reference/url-object-referrer-urls"
scraped_at: "2026-02-08T06:35:52.077Z"
---

The *referrer_urls* relationship returns a list of all URLs **referring to a given URL**. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [URL](/reference/url-object) objects. The relationship contains the following context attributes:

- `url`: <*string*> the URL is added as context attribute in case it&#x27;s missing in the VirusTotal dataset.

/urls/{url_id}/referrer_urlsExample
```
`{
 "data": [
 {
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/urls/cf4b367e4ebf0b2e041c6f06ef4aa19fecfe3ec8d5abc0617343d1ae6c6ae6f5/referrer_urls?limit=10"
 },
 "meta": {
 "count": 1
 }
