---
title: "🔀 parent_technique"
source: "https://docs.virustotal.com/reference/attack-technique-object-parent-technique"
scraped_at: "2026-02-08T06:35:42.667Z"
---

The *parent_technique* relationship returns the ***technique&#x27;s parent technique***.

This relationship can be retrieved using the [relationships API](/reference/get-attack-techniques-relationship) endpoint. The response contains a [Attack Technique](/reference/attack-techniques) object (or none if the technique is not a sub-technique).

/attack_techniques/{id}/parent_techniqueExample
```
`{
