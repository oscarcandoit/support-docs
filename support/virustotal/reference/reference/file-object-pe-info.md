---
title: "pe_info"
source: "https://docs.virustotal.com/reference/file-object-pe-info"
scraped_at: "2026-02-08T06:35:45.919Z"
---
...
- `datatype`: <*integer*> always set to 1 (`IMAGE_DEBUG_MISC_EXENAME).
...
Microsoft Windows Portable Executable filesExample
```
`{
 "data": {
 ...
