...
source: "https://docs.virustotal.com/reference/file-object-related-threat-actors"
scraped_at: "2026-02-08T06:35:46.961Z"
---

The *related_threat_actors* relationship returns a list of ***threat actors related to the file***.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [Threat Actors](/reference/threat-actors-object) objects.

/files/{file_hash}/related_threat_actorsExample
```
`{
 "meta": {
 "count": <int>
