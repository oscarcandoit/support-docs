---
title: "🔒 Private Files"
source: "https://docs.virustotal.com/reference/private-files"
scraped_at: "2026-02-08T06:35:50.399Z"
---
...
Private files are similar to [Files](/reference/files), but they are only visible to the user who uploads the file.

A private file object ID is its SHA256 hash.

## Object attributes[](#object-attributes)

Most [File&#x27;s](/reference/files) attributes are present in private files, except for `last_analysis_stats` and `last_analysis_results` since private files are not run by antivirus.

Private file objectExample
`{
 "data": {
 "attributes": {
 "androguard": <dict>,
...
In addition to the previously described attributes, private file objects contain relationships with other objects in our dataset that can be retrieved as explained in the [Relationships](/reference/relationships) section.

The following table shows a summary of available relationships.

| Relationship | Return object type |
| --- | --- |
| behaviours | List of [Private File Behaviours](/reference/private-file-behaviours) |
| dropped_files | List of [Private Files](/reference/private-files) |
| execution_parents | List of [Private Files](/reference/private-files) |