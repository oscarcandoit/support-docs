---
title: "🔀🔒 soa_records"
source: "https://docs.virustotal.com/reference/domain-object-soa-records"
scraped_at: "2026-02-08T06:35:44.749Z"
---

The *soa_records* relationship returns a list of all domain&#x27;s CNAME records. This relationship is only available for premium API users.
...
/domains/{domain}/soa_recordsExample
```
`{
 "data": [
 {
