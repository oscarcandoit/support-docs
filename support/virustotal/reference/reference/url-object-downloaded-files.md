...
source: "https://docs.virustotal.com/reference/url-object-downloaded-files"
scraped_at: "2026-02-08T06:35:51.622Z"
---

The *downloaded_files* relationships returns a list of all **files downloaded from the URL at some moment in time**. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [File](/reference/files) objects.

/urls/{url_id}/downloaded_files Example
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/urls/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/downloaded_files?limit=10"
 },
 "meta": {
 "count": 1
 }
