---
title: "🔀🔒 screenshots"
source: "https://docs.virustotal.com/reference/file-object-screenshots"
scraped_at: "2026-02-08T06:35:47.047Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [Screenshot](/reference/screenshots) objects.
...
/files/{file_hash}/screenshotsExample
```
`{
 "data": [
 {
