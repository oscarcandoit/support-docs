...
source: "https://docs.virustotal.com/reference/ip-object-downloaded-files"
scraped_at: "2026-02-08T06:35:49.879Z"
---

The *downloaded_files* relationship returns a list of **files that were available from an URL under the given IP address** at some moment. This relationship is only available for Premium API users.
...
/ip_addresses/{ip_address}/downloaded_filesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
