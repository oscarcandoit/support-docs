---
title: "🔀 contacted_domains"
source: "https://docs.virustotal.com/reference/file-object-contacted-domains"
scraped_at: "2026-02-08T06:35:46.451Z"
---

The *contacted_domains* relationship returns the list of ***all domains which were detected as contacted by the given file.***

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [Domains](/reference/domains-object) objects.

/files/{file_hash}/contacted_domainsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
