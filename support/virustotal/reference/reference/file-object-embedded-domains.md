...
source: "https://docs.virustotal.com/reference/file-object-embedded-domains"
scraped_at: "2026-02-08T06:35:46.520Z"
---

The *embedded_domains* relationship returns the list of ***all domain names embedded in a given file***. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [Domain](/reference/domains-object) objects.

/files/{file_hash}/embedded_domainsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "next": "https://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/embedded_domains?cursor=STewei4%3D&limit=1",
 "self": "https://www.virustotal.com/api/v3/files/abfa4d04ecfb8cd9e22e2301bfe902c30caea6071ce6a9742eb1f1ce1494696c/embedded_domains?limit=1"
 },
 "meta": {
 "count": 99,
 "cursor": "STewei4="
