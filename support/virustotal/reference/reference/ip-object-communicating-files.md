---
title: "🔀 communicating_files"
source: "https://docs.virustotal.com/reference/ip-object-communicating-files"
scraped_at: "2026-02-08T06:35:49.784Z"
---

The *communicating_files* relationship lists all **files presenting any sort of traffic to the given IP address** at some point of its execution.

This relationship can be retrieved using the [relationships API endpoint](/reference/ip-relationships). The response contains a list of [File](/reference/files) objects.

/ip_addresses/{ip_address}/communicating_filesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/ip_addresses/1.2.3.4/communicating_files?limit=10"
 },
 "meta": {
 "count": 1
 }
