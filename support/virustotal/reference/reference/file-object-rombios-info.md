---
title: "rombios_info"
source: "https://docs.virustotal.com/reference/file-object-rombios-info"
scraped_at: "2026-02-08T06:35:45.949Z"
---
...
`format`: <*string*> bundle format (i.e. "ROMFLASH_HEADER").
...
Firmware imagesExampleExample (apple)
```
`{
 "data": {
 ...
