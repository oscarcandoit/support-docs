---
title: "🔀🔒 redirects_to"
source: "https://docs.virustotal.com/reference/url-object-redirects-to"
scraped_at: "2026-02-08T06:35:52.004Z"
---

The *redirects_to* relationship returns a list of **all URLs a given URL redirects to**. This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [URL](/reference/url-object) objects.

/urls/{url_id}/redirects_toExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/urls/cf4b367e4ebf0b2e041c6f06ef4aa19fecfe3ec8d5abc0617343d1ae6c6ae6f5/redirects_to?limit=10"
 },
 "meta": {
 "count": 1
 }
