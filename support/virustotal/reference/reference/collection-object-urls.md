---
title: "🔀 urls"
source: "https://docs.virustotal.com/reference/collection-object-urls"
scraped_at: "2026-02-08T06:35:42.788Z"
---

The *urls* relationship return the list of ***all URLs in the Collection***.

This relationship can be retrieved using the [relationships API](/reference/get-collections-relationship) endpoint. The response contains a list of [URL](/reference/url-object) objects.

/collections/{id}/urlsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
