---
title: "🔀🔒 contacted_ips"
source: "https://docs.virustotal.com/reference/url-object-contacted-ips"
scraped_at: "2026-02-08T06:35:51.517Z"
---

The *contacted_ips* relationship returns a list of all ***distinct IP addresses from which the URL loads some kind of resource.*** This relationship is only available for Premium API users.

This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [IP address](/reference/ip-object) objects.

/urls/{url_id}/contacted_ips Example
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/urls/afed5cd29ae397eb3c7ec5a7bef3952ef1ae7f6a62a9e4bbe9497e705f4eac5e/contacted_ips?limit=10"
 },
 "meta": {
 "count": 1
 }
