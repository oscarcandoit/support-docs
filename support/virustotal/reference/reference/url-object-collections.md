---
title: "🔀 collections"
source: "https://docs.virustotal.com/reference/url-object-collections"
scraped_at: "2026-02-08T06:35:51.460Z"
---

The *collections* relationship lists all VirusTotal&#x27;s collections where this URL is contained.

This relationship can be retrieved using the [relationships API endpoint](/reference/urls-relationships). The response contains a list of [Collections](/reference/collections) objects.

/urls/{url}/collections Example
```
`{
 "data": [
 <MDXishSnakeCase0>,
