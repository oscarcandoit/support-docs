---
title: "🔀🔒 threat_actors"
source: "https://docs.virustotal.com/reference/attack-technique-object-threat-actors"
scraped_at: "2026-02-08T06:35:43.780Z"
---

The *threat_actors* relationship returns the list of ***all threat actors where this technique appears***.

This relationship can be retrieved using the [relationships API](/reference/get-attack-techniques-relationship) endpoint. The response contains a list of [Threat Actor](/reference/threat-actors-object) objects.

/attack_techniques/{id}/threat_actorsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
