---
title: "🔀 dropped_files"
source: "https://docs.virustotal.com/reference/file-object-dropped-files"
scraped_at: "2026-02-08T06:35:46.581Z"
---

The *dropped_files* relationship returns the list of ***all the files dropped by the given file***. Dropped files are interesting files written to disk during sandbox execution.
...
/files/{file_hash}/dropped_filesExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
