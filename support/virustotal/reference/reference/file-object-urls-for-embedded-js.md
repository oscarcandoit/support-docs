---
title: "🔀🔒 urls_for_embedded_js"
source: "https://docs.virustotal.com/reference/file-object-urls-for-embedded-js"
scraped_at: "2026-02-08T06:35:47.889Z"
---
...
This relationship can be retrieved using the [relationships API endpoint](/reference/files-relationships). The response contains a list of [URL](/reference/url-object) objects. The relationship contains the following context attributes:
...
/files/{id}/urls_for_embedded_jsExample
```
`{
 "data": [
 {
