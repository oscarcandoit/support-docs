---
title: "🔀 graphs"
source: "https://docs.virustotal.com/reference/user-object-graphs"
scraped_at: "2026-02-08T06:35:52.173Z"
---

The *graphs* relationships returns a list of ***all graphs the user is owner/editor/viewer of.***

This relationship can be retrieved by using the [relationships API endpoint](/reference/users-relationships) and returns a list of [Graph](/reference/graph-object) objects.

/users/{user_id}/graphsExample
```
`{
 "data": [
 <MDXishSnakeCase0>,
...
`{
 ...
 "links": {
 "self": "https://www.virustotal.com/api/v3/users/spellman/graphs?limit=10"
 },
 "meta": {
 "count": 1
 }
