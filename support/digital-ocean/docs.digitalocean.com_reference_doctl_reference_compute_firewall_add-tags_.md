---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-tags/"
title: "doctl compute firewall add-tags | DigitalOcean Documentation"
---
...
```shell
doctl compute firewall add-tags <firewall-id> [flags]
```

## Description

Add tags to a cloud firewall. This adds all assets using that tag to the firewall.

## Example

The following example adds two tags to a cloud firewall with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl compute firewall add-tags f81d4fae-7dec-11d0-a765-00a0c91e6bf6 --tag-names "frontend,backend"
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-tags/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-tags/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-tags/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-tags/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-tags/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-tags/#global-flags)
