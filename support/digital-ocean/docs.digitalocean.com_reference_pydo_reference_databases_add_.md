---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/add/"
title: "pydo.databases.add() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_add) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/add/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/add/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/add/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/add/#more-information)
