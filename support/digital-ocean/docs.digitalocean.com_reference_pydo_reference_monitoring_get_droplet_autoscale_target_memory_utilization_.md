---
url: "https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_droplet_autoscale_target_memory_utilization/"
title: "pydo.monitoring.get_droplet_autoscale_target_memory_utilization() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [monitoring](https://docs.digitalocean.com/reference/pydo/reference/monitoring/)
- get\_droplet\_autoscale\_target\_memory\_utilization()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/monitoring_get_droplet_autoscale_target_memory_utilization) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_droplet_autoscale_target_memory_utilization/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_droplet_autoscale_target_memory_utilization/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_droplet_autoscale_target_memory_utilization/#more-information)
