---
url: "https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/"
title: "JupyterLab - AMD MI300x | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/)
...
from [the JupyterLab - AMD MI300x catalog page](https://marketplace.digitalocean.com/apps/jupyterlab-amd-mi300x)

Leverage the power of Digital OceanGPU droplets powered by AMD to deploy a JupyterLab IDE with Jupyter AI in minutes! Whether you’re using Jupyter Lab for data science or machine learning tasks, use this marketplace app to set up a powerful experimentation environment without the hassle of manual installation.

## Software Included

| Package | Version | License |
| --- | --- | --- |
| [JupyterLab](https://jupyter.org/install) | 4.4.2 | BSD 3-Clause License |
| [jupyter-ai](https://github.com/jupyterlab/jupyter-ai) | 2.31.4 | BSD 3-Clause License |
| [Anaconda](https://anaconda.com/) | 2024.10-1 | [Non Commercial Use Only](https://legal.anaconda.com/policies/en/?name=terms-of-service) |

## Creating an App using the Control Panel

Click the **Deploy to DigitalOcean** button to create a Droplet based on this 1-Click App. If you aren’t logged in, this link will prompt you to log in with your DigitalOcean account.

[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=digitaloceanai-jupyterlabamdmi3)

## Creating an App using the API

In addition to creating a Droplet from the JupyterLab - AMD MI300x 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB JupyterLab - AMD MI300x Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"digitaloceanai-jupyterlabamdmi3"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying JupyterLab - AMD MI300x
...
## Manually Running the JupyterLab

```
- JupyterLab is installed under the jupyter environment. You can manage the jupyter-notebook.service provided.
...
- The droplet already starts up an instance of the JupyterLab on boot. If you need multiple instances, you’ll have to run them up manually by providing port number to have different instances listening on different ports.


  - To manually start JupyterLab, run:
...
The output is stored in `output.png`. If connected to JupyterLab, you should be able to view the file in the notebook itself.
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#creating-an-app-using-the-api)
- [Getting Started After Deploying JupyterLab - AMD MI300x](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#getting-started-after-deploying-jupyterlab---amd-mi300x)
  - [JupyterLab](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#jupyterlab)
  - [Jupyter AI](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#jupyter-ai)
- [Before You Deploy](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#before-you-deploy)
- [Quickly Get Started With Your Jupyter Droplet](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#quickly-get-started-with-your-jupyter-droplet)
- [Access your Anaconda Distribution](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#access-your-anaconda-distribution)
- [Manually Running the JupyterLab](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#manually-running-the-jupyterlab)
- [Using Jupyter AI](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#using-jupyter-ai)
- [Example 1: Running Stable Diffusion](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#example-1-running-stable-diffusion)
- [Example 2: Running DistilBERT Sequence Classification](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#example-2-running-distilbert-sequence-classification)
- [Troubleshooting](https://docs.digitalocean.com/products/marketplace/catalog/jupyterlab-amd-mi300x/#troubleshooting)
