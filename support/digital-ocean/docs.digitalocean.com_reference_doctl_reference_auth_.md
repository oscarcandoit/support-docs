---
url: "https://docs.digitalocean.com/reference/doctl/reference/auth/"
title: "doctl auth | DigitalOcean Documentation"
---
...
The `doctl auth` commands allow you to authenticate doctl for use with your DigitalOcean account using tokens that you generate in the control panel at [https://cloud.digitalocean.com/account/api/tokens](https://cloud.digitalocean.com/account/api/tokens).
...
- [Description](https://docs.digitalocean.com/reference/doctl/reference/auth/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/auth/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/#global-flags)
