---
url: "https://docs.digitalocean.com/reference/doctl/reference/account/get/"
title: "doctl account get | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl account](https://docs.digitalocean.com/reference/doctl/reference/account/)
      - [get](https://docs.digitalocean.com/reference/doctl/reference/account/get/)
      - [ratelimit](https://docs.digitalocean.com/reference/doctl/reference/account/ratelimit/)
...
Retrieve the following details from your account profile:
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Email`, `Team`, `DropletLimit`, `EmailVerified`, `UUID`, `Status`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/account/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/account/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/account/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/account/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/account/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/account/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/account/get/#global-flags)
