---
url: "https://docs.digitalocean.com/reference/pydo/reference/volumes/delete_by_name/"
title: "pydo.volumes.delete_by_name() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/volumes_delete_byName) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/volumes/delete_by_name/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/volumes/delete_by_name/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/volumes/delete_by_name/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/volumes/delete_by_name/#more-information)
