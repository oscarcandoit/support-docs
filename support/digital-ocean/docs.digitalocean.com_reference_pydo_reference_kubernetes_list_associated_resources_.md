---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_associated_resources/"
title: "pydo.kubernetes.list_associated_resources() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_list_associatedResources) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_associated_resources/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_associated_resources/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_associated_resources/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_associated_resources/#more-information)
