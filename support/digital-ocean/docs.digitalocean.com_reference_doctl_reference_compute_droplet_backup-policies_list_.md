---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list/"
title: "doctl compute droplet backup-policies list | DigitalOcean Documentation"
---
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [droplet](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/)
        ...
        - [backup-policies](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/)
          - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/get/)
          - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list/)
          - [list-supported](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list-supported/)
...
```shell
doctl compute droplet backup-policies list [flags]
```
...
List droplet backup policies for all existing Droplets.

## Example

The following example list backup policies for all existing Droplets:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list/#global-flags)
