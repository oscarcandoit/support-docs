---
url: "https://docs.digitalocean.com/support/why-does-mysql-shut-down-when-importing-data-with-the-source-command/"
title: "Why does MySQL shut down when importing data with the source command? | DigitalOcean Documentation"
---
...
Instead, we recommend you use the MySQL `import` command to import large amounts of data. For more detailed steps, see [How to Import MySQL Databases into DigitalOcean Managed Databases](https://docs.digitalocean.com/products/databases/mysql/how-to/import-databases/).
...
[Why does MySQL shut down when importing data with the source command?](https://docs.digitalocean.com/support/why-does-mysql-shut-down-when-importing-data-with-the-source-command/)
