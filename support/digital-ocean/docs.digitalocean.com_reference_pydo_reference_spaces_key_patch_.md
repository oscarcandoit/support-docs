---
url: "https://docs.digitalocean.com/reference/pydo/reference/spaces_key/patch/"
title: "pydo.spaces_key.patch() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/spacesKey_patch) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/patch/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/patch/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/patch/#more-information)
