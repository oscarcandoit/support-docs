---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/ssh/"
title: "doctl compute ssh | DigitalOcean Documentation"
---
...
| `--ssh-agent-forwarding` | Enable SSH agent forwarding<br>Default: `false` |
| `--ssh-command` | Command to execute on Droplet |
| `--ssh-key-path` | Path to SSH private key |
| `--ssh-port` | The remote port sshd is running on<br>Default: `22` |
| `--ssh-private-ip` | SSH to Droplet’s private IP address<br>Default: `false` |
| `--ssh-retry-max` | Max number of retries for a successful SSH connection to a Droplet (default is 0)<br>Default: `0` |
| `--ssh-user` | SSH user for connection<br>Default: `root` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh/#global-flags)
