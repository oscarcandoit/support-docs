---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/"
title: "pydo.kubernetes | DigitalOcean Documentation"
---
...
- [PyDo](https://docs.digitalocean.com/reference/pydo/)
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- kubernetes
...
allows you to quickly deploy scalable and secure Kubernetes clusters.
...
pydo.kubernetes.add\_node\_pool()

Add a Node Pool to a Kubernetes Cluster

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.kubernetes.add\_registries()

Add Container Registries to Kubernetes Clusters

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.kubernetes.add\_registry()

Add Container Registry to Kubernetes Clusters

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.kubernetes.create\_cluster()

Create a New Kubernetes Cluster

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.kubernetes.delete\_cluster()

Delete a Kubernetes Cluster

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.kubernetes.delete\_node\_pool()
