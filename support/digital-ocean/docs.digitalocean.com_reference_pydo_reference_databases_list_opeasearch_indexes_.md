---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_opeasearch_indexes/"
title: "pydo.databases.list_opeasearch_indexes() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- list\_opeasearch\_indexes()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.list\_opeasearch\_indexes()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_opeasearch_indexes) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_opeasearch_indexes/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_opeasearch_indexes/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_opeasearch_indexes/#more-information)
