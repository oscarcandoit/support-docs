---
url: "https://docs.digitalocean.com/products/marketplace/catalog/sglang/"
title: "SGLang | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/sglang/)
...
from [the SGLang catalog page](https://marketplace.digitalocean.com/apps/sglang)
...
| --- | --- | --- |
| ROCm (host system) | 6.4.0 | [LICENSE](https://rocm.docs.amd.com/en/latest/about/license.html) |
...
| SGLang (in Docker image) | 0.4.9 | [LICENSE](https://github.com/sgl-project/sglang/blob/main/LICENSE) |

## Creating an App using the Control Panel

Click the **Deploy to DigitalOcean** button to create a Droplet based on this 1-Click App. If you aren’t logged in, this link will prompt you to log in with your DigitalOcean account.

[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=digitaloceanai-sglang)

## Creating an App using the API

In addition to creating a Droplet from the SGLang 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB SGLang Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"digitaloceanai-sglang"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying SGLang
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/sglang/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/sglang/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/sglang/#creating-an-app-using-the-api)
- [Getting Started After Deploying SGLang](https://docs.digitalocean.com/products/marketplace/catalog/sglang/#getting-started-after-deploying-sglang)
- [Accessing SGLang + ROCm resources and libraries](https://docs.digitalocean.com/products/marketplace/catalog/sglang/#accessing-sglang--rocm-resources-and-libraries)
- [SSHing into your AMD 1-Click](https://docs.digitalocean.com/products/marketplace/catalog/sglang/#sshing-into-your-amd-1-click)
- [Exploring via Jupyter](https://docs.digitalocean.com/products/marketplace/catalog/sglang/#exploring-via-jupyter)
- [Exploring via Docker](https://docs.digitalocean.com/products/marketplace/catalog/sglang/#exploring-via-docker)
