---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/create/"
title: "doctl apps create | DigitalOcean Documentation"
---
...
| `--update-sources` | Boolean that specifies whether, on update, the app should also update its source code<br>Default: `false` |
| `--upsert` | A boolean value that creates or updates an app’s configuration with the attached app spec. This does not pull changes from the app’s container registry or source repository. Instead, App Platform uses the image from the app’s most recent deployment. To additionally pull the latest changes from the app’s source, set the `--update-sources` flag.<br>Default: `false` |
| `--wait` | Boolean that specifies whether to wait for an app to complete before returning control to the terminal<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/create/#global-flags)
