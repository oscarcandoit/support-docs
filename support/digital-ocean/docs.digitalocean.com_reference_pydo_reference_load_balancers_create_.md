---
url: "https://docs.digitalocean.com/reference/pydo/reference/load_balancers/create/"
title: "pydo.load_balancers.create() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/loadBalancers_create) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/create/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/create/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/create/#more-information)
