---
url: "https://docs.digitalocean.com/reference/doctl/reference/auth/init/"
title: "doctl auth init | DigitalOcean Documentation"
---
...
| `--token-validation-server` | The server used to validate a token<br>Default: `https://cloud.digitalocean.com` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/auth/init/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/auth/init/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/auth/init/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/init/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/auth/init/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/init/#global-flags)
