---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/update/"
title: "doctl compute load-balancer update | DigitalOcean Documentation"
---
...
| `--redirect-http-to-https` | Flag to redirect HTTP requests to the load balancer on port 80 to HTTPS on port 443<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/update/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/update/#global-flags)
