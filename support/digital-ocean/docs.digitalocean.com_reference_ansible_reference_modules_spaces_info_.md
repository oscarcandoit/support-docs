---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/spaces_info/"
title: "spaces_info | DigitalOcean Documentation"
---
...
List all of the Spaces in your account. View the documentation at [https://www.digitalocean.com/products/spaces](https://www.digitalocean.com/products/spaces).
...
| --- | --- | --- |
| `aws_access_key_id`<br>str |  | The AWS\_ACCESS\_KEY\_ID to use for authentication. The `AWS_ACCESS_KEY_ID` environment variable will be used. |
| `aws_secret_access_key`<br>str |  | The AWS\_SECRET\_ACCESS\_KEY to use for authentication. The `AWS_SECRET_ACCESS_KEY` environment variable will be used. |
...
| `name`<br>str |  | The short name of the Space to list. If not provided all the Spaces in `region` will be returned. For example, given `name=my-do-space` and `region=nyc3`, the managed Space will be [https://my-do-space.nyc3.digitaloceanspace.com](https://my-do-space.nyc3.digitaloceanspace.com/). |
| `region`<br>str |  | The region in which to list Spaces. The `SPACES_REGION` environment variable will be used. |
...
| --- | --- | --- |
| `error`<br>dict | failure | DigitalOcean Spaces boto response metadata.<br>Sample:<br>```json<br>{<br>  "HTTPHeaders": "Header metadata key/values",<br>  "HTTPStatusCode": 400,<br>  "HostId": "Host ID data as a hash",<br>  "RequestId": "1234567890ABCDEF",<br>  "RetryAttempts'": 0<br>}<br>``` |
| `msg`<br>str | always | Spaces result information.<br>Sample:<br>```json<br>[<br>  "Current Spaces in nyc3",<br>  "Existing Space named my-do-space in nyc3",<br>  "No Spaces in sfo3",<br>  "No Space named my-do-space in nyc3",<br>  "Failed to list Spaces in nyc3"<br>]<br>``` |
| `spaces`<br>list | always | Current spaces.<br>Sample:<br>```json<br>{<br>  "endpoint_url": "https://nyc3.digitaloceanspaces.com",<br>  "name": "my-do-space",<br>  "region": "nyc3",<br>  "space_url": "https://my-do-space.nyc3.digitaloceanspaces.com"<br>}<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/spaces_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/spaces_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/spaces_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/spaces_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/spaces_info/#return-values)
