---
url: "https://docs.digitalocean.com/reference/doctl/reference/1-click/list/"
title: "doctl 1-click list | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    - [doctl 1-click](https://docs.digitalocean.com/reference/doctl/reference/1-click/)
      - [list](https://docs.digitalocean.com/reference/doctl/reference/1-click/list/)
...
| `--type` | The 1-Click type. Valid types are one of the following: kubernetes, droplet |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/1-click/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/1-click/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/1-click/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/1-click/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/1-click/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/1-click/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/1-click/list/#global-flags)
