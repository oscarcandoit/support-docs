---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/list/"
title: "doctl compute droplet list | DigitalOcean Documentation"
---
...
Retrieves a list of Droplets on your account, including the following information about each:
...
The following example retrieves a list of all Droplets in the `nyc1` region:
...
| `--gpus` | List GPU Droplets only. By default, only non-GPU Droplets are returned.<br>Default: `false` |
| `--help`, `-h` | Help for this command |
| `--no-header` | Return raw data with no headers<br>Default: `false` |
| `--region` | Retrieves a list of Droplets in a specified region |
| `--tag-name` | Retrieves a list of Droplets with the specified tag name |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/list/#global-flags)
