---
url: "https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/"
title: "logout | DigitalOcean Documentation"
---
...
The team to logout of.

## Flags

### –all, -a (boolean, optional)

Log out of all teams.
...
- [Arguments](https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/#arguments)
  - [\[argument\] (string, required)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/#argument-string-required)
- [Flags](https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/#flags)
  - [–all, -a (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/#all--a-boolean-optional)
- [Global Flags](https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/#global-flags)
  - [–log-level, -l (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/#log-level--l-string-optional)
  - [–json, -j (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/#json--j-boolean-optional)
  - [–api-key (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/#api-key-string-optional)
  - [–help, -h (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/logout/#help--h-boolean-optional)
