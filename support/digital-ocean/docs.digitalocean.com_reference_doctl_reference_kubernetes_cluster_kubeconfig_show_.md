---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/show/"
title: "doctl kubernetes cluster kubeconfig show | DigitalOcean Documentation"
---
    ...
    - [doctl kubernetes](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/)
      ...
      - [cluster](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/)
        ...
        - [kubeconfig](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/)
          - [remove](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/remove/)
          - [save](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/save/)
          - [show](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/show/)
...
```shell
doctl kubernetes cluster kubeconfig show <cluster-id|cluster-name> [flags]
```
...
The following example shows the kubeconfig YAML for a cluster named `example-cluster`:

```shell
doctl kubernetes cluster kubeconfig show example-cluster
```
...
| Option | Description |
| --- | --- |
| `--expiry-seconds` | The length of time the cluster credentials are valid for, in seconds. By default, the credentials expire after seven days.<br>Default: `0` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/show/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/show/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/show/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/show/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/show/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/show/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/show/#global-flags)
