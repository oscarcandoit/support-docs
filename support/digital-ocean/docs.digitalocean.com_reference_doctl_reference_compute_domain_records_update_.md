---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/update/"
title: "doctl compute domain records update | DigitalOcean Documentation"
---
...
| `--record-id` | The record’s ID<br>Default: `0` |
...
| `--record-ttl` | The record’s Time To Live (TTL) value, in seconds<br>Default: `0` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/update/#global-flags)
