---
url: "https://docs.digitalocean.com/platform/organizations/how-to/create/"
title: "How to Create New Organizations | DigitalOcean Documentation"
---
...
Validated on 10 Sep 2025 • Last edited on 30 Sep 2025

To create a new organization, from the [DigitalOcean Control Panel](https://cloud.digitalocean.com/), click the profile icon in the top right to open the drop-down menu.

In the menu that opens, click **Create an Organization** to go to the **Setting up your organization** page.

Note
You can access the **Create an Organization** option only if you own at least one team.

The first step is to add an initial team. Adding a team is permanent and the settings of that team are imported as the organization’s default settings. The payment method and billing settings of the team become the default payment and billing settings of the organization.

In the **Select and review an initial team to add to the organization** dropdown, select your initial team. Only teams that you own are visible in the dropdown menu.

![Setting up your org](https://docs.digitalocean.com/screenshots/organizations/setting-up-your-org.4e1203d964ef3095958d28abdc71ab3c8ddf927ffb24ef61ac00e0bc512febc2.png)

The organization name is pre-populated with the name of your company in the **Organization name** field.

Click **Finalize and Create Organization**. After your organization is set up, you can view it in the [**Organization** dashboard](https://cloud.digitalocean.com/organizations/). On this page, you can view the organization name, ID, and membership as well as the organization’s teams and billing. You can also view and create API tokens for the organization, and add more teams and members. Organization owners can see each team member’s role, status, and sign-in method.

![Org dashboard](https://docs.digitalocean.com/screenshots/organizations/org-dashboard.41988f0e804a8c6bffbd94f735269758e7bccf28480066c08351acd66ccf9e9b.png)

You can also create an organization in the [**My Account** page](https://cloud.digitalocean.com/account/profile), or [the team settings page](https://cloud.digitalocean.com/account/team) by clicking **Create an Organization**.

In this article...

[How to Create New Organizations](https://docs.digitalocean.com/platform/organizations/how-to/create/)
