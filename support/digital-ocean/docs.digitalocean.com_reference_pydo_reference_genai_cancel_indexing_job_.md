---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/cancel_indexing_job/"
title: "pydo.genai.cancel_indexing_job() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `uuid` | string | True | A unique identifier for an indexing job. |  |
| `body` | JSON or IO\[bytes\] | False |  |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_cancel_indexing_job) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/cancel_indexing_job/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/cancel_indexing_job/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/cancel_indexing_job/#more-information)
