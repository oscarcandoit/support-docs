---
url: "https://docs.digitalocean.com/products/app-platform/how-to/manage-workers/"
title: "How to Manage Workers in App Platform | DigitalOcean Documentation"
---
...
Background workers can consist of any application code you like. As far as App Platform is concerned, they are the same as [services](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/), except they are not routable, meaning they are not accessible via an external URL.

## Add a Worker to an App Using Automation

You can add a worker to an app using the CLI’s app update command or the API’s app update endpoint. To add a worker, update the [app’s spec](https://docs.digitalocean.com/products/app-platform/reference/app-spec/) with the worker’s specifications and submit the spec using the following command or endpoint.

How to Add a Worker to an App Using the DigitalOcean CLI
...
How to Add a Worker to an App Using the DigitalOcean API
...
1. In the [**Apps** section of the DigitalOcean Control Panel](https://cloud.digitalocean.com/apps), select your app, then click the **Create** drop-down and choose **Create Resources From Source Code** to add a Worker.
...
![Create web service](https://docs.digitalocean.com/screenshots/app-platform/create-worker.0ae78c00c20b2b0c5b88d14ca75ab1700f8c3ccaab0065cd1dbc362576cdb4bc.png)
...
In the [**Apps** section of the DigitalOcean Control Panel](https://cloud.digitalocean.com/apps), select your app and click the **Settings** tab. Click the Worker you'd like to edit.
...
In the [**Apps** section of the DigitalOcean Control Panel](https://cloud.digitalocean.com/apps), select your app and click the **Settings** tab. Click the Worker you'd like to destroy.
...
- [Add a Worker to an App Using Automation](https://docs.digitalocean.com/products/app-platform/how-to/manage-workers/#add-a-worker-to-an-app-using-automation)
- [Add a Worker Using the Control Panel](https://docs.digitalocean.com/products/app-platform/how-to/manage-workers/#add-a-worker-using-the-control-panel)
- [Environment](https://docs.digitalocean.com/products/app-platform/how-to/manage-workers/#environment)
- [Edit Workers](https://docs.digitalocean.com/products/app-platform/how-to/manage-workers/#edit-workers)
- [Destroy Workers](https://docs.digitalocean.com/products/app-platform/how-to/manage-workers/#destroy-workers)
