---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/change-backup-policy/"
title: "doctl compute droplet-action change-backup-policy | DigitalOcean Documentation"
---
...
# doctl compute droplet-action change-backup-policy
...
```shell
doctl compute droplet-action change-backup-policy <droplet-id> [flags]
```

## Description

Changes backup policy for a Droplet with enabled backups.

## Example

The following example changes backup policy on a Droplet with the ID `386734086`:

```shell
doctl compute droplet-action change-backup-policy 386734086 --backup-policy-plan weekly --backup-policy-weekday SUN --backup-policy-hour 4
```
...
| Option | Description |
| --- | --- |
| `--backup-policy-hour` | Backup policy hour.<br>Default: `0` |
| `--backup-policy-plan` | Backup policy frequency plan. (required) |
| `--backup-policy-weekday` | Backup policy weekday. |
...
| `--wait` | Wait for action to complete<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/change-backup-policy/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/change-backup-policy/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/change-backup-policy/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/change-backup-policy/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/change-backup-policy/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/change-backup-policy/#global-flags)
