---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_clusters/"
title: "pydo.kubernetes.list_clusters() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_list_clusters) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_clusters/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_clusters/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_clusters/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_clusters/#more-information)
