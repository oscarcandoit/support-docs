---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/list/"
title: "doctl compute droplet 1-click list | DigitalOcean Documentation"
---
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [droplet](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/)
        - [1-click](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/)
          - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/list/)
...
# doctl compute droplet 1-click list
...
```shell
doctl compute droplet 1-click list [flags]
```
...
Retrieves a list of Droplet 1-Click application slugs.
...
The following example retrieves a list of 1-clicks for Droplets:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/1-click/list/#global-flags)
