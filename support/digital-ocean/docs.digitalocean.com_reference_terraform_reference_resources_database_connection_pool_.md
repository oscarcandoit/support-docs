---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/database_connection_pool/"
title: "digitalocean_database_connection_pool | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/database_connection_pool/#example-usage)
  - [Create a new PostgreSQL database connection pool](https://docs.digitalocean.com/reference/terraform/reference/resources/database_connection_pool/#create-a-new-postgresql-database-connection-pool)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_connection_pool/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_connection_pool/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/database_connection_pool/#import)
