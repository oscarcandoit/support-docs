---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/fork/"
title: "doctl databases fork | DigitalOcean Documentation"
---
...
| `--wait` | A boolean that specifies whether to wait for a database to complete before returning control to the terminal<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/fork/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/fork/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/fork/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/fork/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/fork/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/fork/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/fork/#global-flags)
