---
url: "https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/"
title: "vLLM 0.8.5 | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/)
...
from [the vLLM 0.8.5 catalog page](https://marketplace.digitalocean.com/apps/vllm-0-8-5)
...
| ROCm (in Docker image) | 6.3.1 | [LICENSE](https://rocm.docs.amd.com/en/latest/about/license.html) |
| JupyterLab (in Docker image) | 4.4.2 | [LICENSE](https://jupyter.org/governance/projectlicense.html) |
| vLLM (in Docker image) | 0.8.5 | [LICENSE](https://github.com/vllm-project/vllm/blob/main/LICENSE) |

## Creating an App using the Control Panel

Click the **Deploy to DigitalOcean** button to create a Droplet based on this 1-Click App. If you aren’t logged in, this link will prompt you to log in with your DigitalOcean account.

[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=amd-vllm085)

## Creating an App using the API

In addition to creating a Droplet from the vLLM 0.8.5 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB vLLM 0.8.5 Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"amd-vllm085"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying vLLM 0.8.5
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/#creating-an-app-using-the-api)
- [Getting Started After Deploying vLLM 0.8.5](https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/#getting-started-after-deploying-vllm-085)
- [Accessing vLLM + ROCm resources and libraries](https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/#accessing-vllm--rocm-resources-and-libraries)
- [SSHing into your AMD 1-Click](https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/#sshing-into-your-amd-1-click)
- [Exploring via Jupyter](https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/#exploring-via-jupyter)
- [Exploring via Docker](https://docs.digitalocean.com/products/marketplace/catalog/vllm-0-8-5/#exploring-via-docker)
