---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list/"
title: "doctl genai knowledge-base list | DigitalOcean Documentation"
---
...
```shell
doctl genai knowledge-base list [flags]
```
...
List all knowledge bases for agents where each knowledge base contains the following information:
...
The following command lists all knowledge base for agents
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list/#global-flags)
