---
url: "https://docs.digitalocean.com/products/databases/opensearch/details/pricing/"
title: "OpenSearch Pricing | DigitalOcean Documentation"
---
...
Managed OpenSearch clusters begin at $19 per month for a single node cluster with 2 GiB of RAM.

Additional storage you add to the cluster costs $0.21 per GiB per month, in increments of 10 GB.
...
All managed databases are deployed onto Droplets with either [shared or dedicated CPU](https://docs.digitalocean.com/products/droplets/concepts/choosing-a-plan/#shared-vs-dedicated). For a list of the Droplet plans we offer for OpenSearch, see the [Managed Databases pricing page](https://www.digitalocean.com/pricing/managed-databases#opensearch).

In this article...

- [Plans for Cluster Nodes](https://docs.digitalocean.com/products/databases/opensearch/details/pricing/#plans-for-cluster-nodes)
