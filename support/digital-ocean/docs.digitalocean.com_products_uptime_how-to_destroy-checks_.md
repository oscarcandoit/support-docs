---
url: "https://docs.digitalocean.com/products/uptime/how-to/destroy-checks/"
title: "How to Destroy Checks | DigitalOcean Documentation"
---
...
Uptime checks can be deleted from [the main Uptime page](https://cloud.digitalocean.com/monitors/uptime/checks), where all your checks are listed.
...
1. Click the drop-down menu for the check you’d like to destroy, then select **Delete**.
2. This opens a confirmation pop-up. Press the **Delete** button to confirm the action.

In this article...

[How to Destroy Checks](https://docs.digitalocean.com/products/uptime/how-to/destroy-checks/)
