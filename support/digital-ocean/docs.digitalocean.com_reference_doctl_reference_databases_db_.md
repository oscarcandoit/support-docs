---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/db/"
title: "doctl databases db | DigitalOcean Documentation"
---
...
The subcommands under `doctl databases db` are for managing specific databases that are served by a database cluster.
...
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/db/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/db/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/db/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/db/#global-flags)
