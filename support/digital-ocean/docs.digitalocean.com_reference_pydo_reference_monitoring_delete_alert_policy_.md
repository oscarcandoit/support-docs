---
url: "https://docs.digitalocean.com/reference/pydo/reference/monitoring/delete_alert_policy/"
title: "pydo.monitoring.delete_alert_policy() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/monitoring_delete_alertPolicy) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/monitoring/delete_alert_policy/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/monitoring/delete_alert_policy/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/monitoring/delete_alert_policy/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/monitoring/delete_alert_policy/#more-information)
