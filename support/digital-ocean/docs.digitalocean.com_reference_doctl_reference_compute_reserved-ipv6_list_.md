---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/list/"
title: "doctl compute reserved-ipv6 list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [reserved-ipv6](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/)
        - [assign](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/assign/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/list/)
        - [unassign](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/unassign/)
...
```shell
doctl compute reserved-ipv6 list [flags]
```
...
Retrieves a list of all the reserved IPv6 addresses on your account.

## Example

The following example lists all reserved IPv6 addresses in the `nyc1` region:

```shell
doctl compute reserved-ipv6 list --region nyc1
```
...
| `--region` | Retrieves a list of reserved IPv6 addresses in the specified region |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/list/#global-flags)
