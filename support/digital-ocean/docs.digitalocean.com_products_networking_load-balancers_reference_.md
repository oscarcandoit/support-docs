---
url: "https://docs.digitalocean.com/products/networking/load-balancers/reference/"
title: "Load Balancer Reference | DigitalOcean Documentation"
---
...
You can use the API to [create, delete, and manage load balancers](https://docs.digitalocean.com/reference/api/digitalocean/#tag/Load-Balancers).
...
[`doctl`](https://github.com/digitalocean/doctl) supports managing load balancers from the command line. See the [`doctl` documentation](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/) or use `doctl compute load-balancer --help` for more information.

In this article...

- [The DigitalOcean API](https://docs.digitalocean.com/products/networking/load-balancers/reference/#the-digitalocean-api)
- [The DigitalOcean Command Line Client, doctl](https://docs.digitalocean.com/products/networking/load-balancers/reference/#the-digitalocean-command-line-client-doctl)
