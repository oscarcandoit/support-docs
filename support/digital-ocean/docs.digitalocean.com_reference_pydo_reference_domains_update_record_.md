---
url: "https://docs.digitalocean.com/reference/pydo/reference/domains/update_record/"
title: "pydo.domains.update_record() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [domains](https://docs.digitalocean.com/reference/pydo/reference/domains/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/domains/create/)
      - [create\_record()](https://docs.digitalocean.com/reference/pydo/reference/domains/create_record/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/domains/delete/)
      - [delete\_record()](https://docs.digitalocean.com/reference/pydo/reference/domains/delete_record/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/domains/get/)
      - [get\_record()](https://docs.digitalocean.com/reference/pydo/reference/domains/get_record/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/domains/list/)
      - [list\_records()](https://docs.digitalocean.com/reference/pydo/reference/domains/list_records/)
      - [patch\_record()](https://docs.digitalocean.com/reference/pydo/reference/domains/patch_record/)
      - [update\_record()](https://docs.digitalocean.com/reference/pydo/reference/domains/update_record/)
...
See the [attribute table](https://docs.digitalocean.com/reference/pydo/reference/domains/update_record/#tag/Domain-Records) for details regarding record
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/domains_update_record) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/domains/update_record/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/domains/update_record/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/domains/update_record/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/domains/update_record/#more-information)
