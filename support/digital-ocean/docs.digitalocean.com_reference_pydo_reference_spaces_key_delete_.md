---
url: "https://docs.digitalocean.com/reference/pydo/reference/spaces_key/delete/"
title: "pydo.spaces_key.delete() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `access_key` | string | True | The access key’s ID. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/spacesKey_delete) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/delete/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/delete/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/delete/#more-information)
