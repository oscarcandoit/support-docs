---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/delete/"
title: "pydo.databases.delete() | DigitalOcean Documentation"
---
...
| `database_name` | string | True | The name of the database. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_delete) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/delete/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/delete/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/delete/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/delete/#more-information)
