---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/ssh_keys/"
title: "digitalocean_ssh_keys | DigitalOcean Documentation"
---
...
Note: You can use the [`digitalocean_ssh_key`](https://docs.digitalocean.com/reference/terraform/reference/data-sources/ssh_keys/droplet) data source to obtain metadata
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/ssh_keys/#example-usage)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/ssh_keys/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/ssh_keys/#attributes-reference)
