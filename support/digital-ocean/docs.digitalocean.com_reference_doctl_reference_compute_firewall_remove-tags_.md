---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-tags/"
title: "doctl compute firewall remove-tags | DigitalOcean Documentation"
---
...
# doctl compute firewall remove-tags
...
```shell
doctl compute firewall remove-tags <firewall-id> [flags]
```

## Description

Removes tags from a cloud firewall. This removes all assets using that tag from the firewall.

## Example

The following example removes two tags from a cloud firewall with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl compute firewall remove-tags f81d4fae-7dec-11d0-a765-00a0c91e6bf6 --tag-names "frontend,backend"
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-tags/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-tags/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-tags/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-tags/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-tags/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-tags/#global-flags)
