---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/create/"
title: "doctl compute certificate create | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [certificate](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/list/)
...
| Option | Description |
| --- | --- |
| `--certificate-chain-path` | The path on your local machine to a full PEM-formatted trust chain between the certificate authority’s certificate and your domain’s SSL certificate. |
...
| `--leaf-certificate-path` | The path on your local machine to a PEM-formatted public SSL certificate. |
| `--name` | A user-specified name for the certificate. (required) |
| `--private-key-path` | The path on your local machine to a PEM-formatted private-key corresponding to the SSL certificate. |
| `--type` | The type of certificate, `custom` or `lets_encrypt`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/create/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/create/#global-flags)
