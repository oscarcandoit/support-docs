---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/regions/"
title: "doctl kubernetes options regions | DigitalOcean Documentation"
---
...
```shell
doctl kubernetes options regions [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/regions/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/regions/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/regions/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/regions/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/regions/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/regions/#global-flags)
