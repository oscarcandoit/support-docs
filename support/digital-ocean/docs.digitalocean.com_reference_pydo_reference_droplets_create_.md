---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/create/"
title: "pydo.droplets.create() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_create) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/create/#description)
  - [Create Multiple Droplets](https://docs.digitalocean.com/reference/pydo/reference/droplets/create/#create-multiple-droplets)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/create/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/create/#more-information)
