---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/domain/get/"
title: "doctl compute domain get | DigitalOcean Documentation"
---
...
```shell
doctl compute domain get <domain> [flags]
```
...
The following command retrieves information about the domain example.com:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/get/#global-flags)
