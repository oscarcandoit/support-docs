---
url: "https://docs.digitalocean.com/reference/pydo/reference/apps/restart/"
title: "pydo.apps.restart() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/apps_restart) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/apps/restart/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/apps/restart/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/apps/restart/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/apps/restart/#more-information)
