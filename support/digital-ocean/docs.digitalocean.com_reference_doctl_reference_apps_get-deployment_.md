---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/get-deployment/"
title: "doctl apps get-deployment | DigitalOcean Documentation"
---
...
The following example gets information about a deployment with the ID `418b7972-fc67-41ea-ab4b-6f9477c4f7d8` for an app with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`. Additionally, the command returns the deployment’s ID, status, and cause:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/get-deployment/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/get-deployment/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/get-deployment/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/get-deployment/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/get-deployment/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/get-deployment/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/get-deployment/#global-flags)
