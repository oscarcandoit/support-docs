---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/delete_kafka_topic/"
title: "pydo.databases.delete_kafka_topic() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- delete\_kafka\_topic()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.delete\_kafka\_topic()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_delete_kafka_topic) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_kafka_topic/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_kafka_topic/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_kafka_topic/#more-information)
