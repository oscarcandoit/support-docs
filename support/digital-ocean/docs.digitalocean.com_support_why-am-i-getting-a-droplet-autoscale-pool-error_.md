---
url: "https://docs.digitalocean.com/support/why-am-i-getting-a-droplet-autoscale-pool-error/"
title: "Why am I getting a Droplet autoscale pool error? | DigitalOcean Documentation"
---
...
Validated on 13 Dec 2024 • Last edited on 18 Dec 2024

If your [autoscale pool](https://docs.digitalocean.com/products/droplets/how-to/use-autoscale-pools/) isn’t scaling, or you’re receiving an **Autoscale Pool Error** with a message like “Invalid resource: failure creating Droplet”, it may be caused by one of the following issues:
...
If the VPC is out of IP addresses, you can [create a new VPC network](https://docs.digitalocean.com/products/networking/vpc/how-to/create/) with a larger IP range, then update the autoscale pool’s Droplet configuration to use the new network.
...
- You’ve reached the Droplet limit for your team. You can view your team’s Droplet limit and request an increase on the team’s [**Settings** page](https://cloud.digitalocean.com/account/team) under **Droplet Limit**.

- The selected datacenter has no more capacity. Check our [regional availability](https://docs.digitalocean.com/platform/regional-availability/) page and [status page](https://status.digitalocean.com/) for more information about datacenter availability.
...
[Why am I getting a Droplet autoscale pool error?](https://docs.digitalocean.com/support/why-am-i-getting-a-droplet-autoscale-pool-error/)
