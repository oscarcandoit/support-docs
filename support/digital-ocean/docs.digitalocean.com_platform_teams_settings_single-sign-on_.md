---
url: "https://docs.digitalocean.com/platform/teams/settings/single-sign-on/"
title: "Single Sign-On for DigitalOcean Teams | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/teams.d6932e5b476fcbbdf1fecec304776ef06c1a04d23174de1c0e6b349d96add59f.svg)Teams](https://docs.digitalocean.com/platform/teams/)
  ...
  - [Settings](https://docs.digitalocean.com/platform/teams/settings/)
    - [Contact Emails](https://docs.digitalocean.com/platform/teams/settings/contact-emails/)
    - [Secure Sign-In](https://docs.digitalocean.com/platform/teams/settings/secure-sign-in/)
    - [Single Sign-On](https://docs.digitalocean.com/platform/teams/settings/single-sign-on/)
...
_Single sign-on_ (SSO) is an authentication service that lets users access multiple applications by signing in once with a single set of credentials. An _identity provider_ (IdP) is an authentication service that manages user identities for applications.

When a logged-out user tries to access an SSO-enabled app, the app redirects the user to the IdP to authenticate. Using a secure protocol, like [SAML](https://en.wikipedia.org/wiki/Security_Assertion_Markup_Language) or [OpenID Connect (OIDC)](https://en.wikipedia.org/wiki/OpenID#OpenID_Connect_(OIDC)), the app sends the user’s credentials to the IdP which then verifies the user’s identity.
...
When you have SSO enabled on a team, you can view SSO activity on the [SSO activity page](https://cloud.digitalocean.com/account/team/sso/activity).

In this article...

[Single Sign-On for DigitalOcean Teams](https://docs.digitalocean.com/platform/teams/settings/single-sign-on/)
