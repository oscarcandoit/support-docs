---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/delete/"
title: "doctl compute reserved-ipv6 delete | DigitalOcean Documentation"
---
...
Permanently deletes a reserved IPv6 address. This is irreversible.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes the reserved IPv6 address without confirmation<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/delete/#global-flags)
