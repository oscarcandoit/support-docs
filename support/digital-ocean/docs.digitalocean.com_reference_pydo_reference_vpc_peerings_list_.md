---
url: "https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/list/"
title: "pydo.vpc_peerings.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [vpc\_peerings](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/list/)
      - [patch()](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/patch/)
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/vpcPeerings_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/list/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/list/#more-information)
