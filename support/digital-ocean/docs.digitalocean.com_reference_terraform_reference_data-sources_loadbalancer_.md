---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/loadbalancer/"
title: "digitalocean_loadbalancer | DigitalOcean Documentation"
---
...
See the [Load Balancer Resource](https://docs.digitalocean.com/reference/terraform/reference/resources/loadbalancer/) for details on the
returned attributes - they are identical.

In this article...

- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/loadbalancer/#example-usage)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/loadbalancer/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/loadbalancer/#attributes-reference)
