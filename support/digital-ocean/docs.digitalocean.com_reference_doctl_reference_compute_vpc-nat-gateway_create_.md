---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/create/"
title: "doctl compute vpc-nat-gateway create | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [vpc-nat-gateway](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/list/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/update/)
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Name`, `Type`, `State`, `Region`, `VPCs`, `Egresses`, `Timeouts`. |
| `--help`, `-h` | Help for this command |
| `--icmp-timeout` | ICMP connection timeout (seconds)<br>Default: `30` |
| `--name` | Name of the VPC NAT Gateway (required) |
| `--no-header` | Return raw data with no headers<br>Default: `false` |
| `--project-id` | Indicates which project to associate the VPC NAT Gateway with. If not specified, the VPC NAT Gateway will be placed in your default project. |
| `--region` | Gateway region (required) |
| `--size` | Gateway size<br>Default: `1` |
| `--tcp-timeout` | TCP connection timeout (seconds)<br>Default: `300` |
| `--type` | Gateway type<br>Default: `PUBLIC` |
| `--udp-timeout` | UDP connection timeout (seconds)<br>Default: `30` |
| `--vpcs` | Ingress VPCs |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/create/#aliases)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/create/#global-flags)
