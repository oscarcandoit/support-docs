---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/logs/"
title: "doctl apps logs | DigitalOcean Documentation"
---
...
To retrieve job invocation logs, pass the job invocation ID with the –job-invocation flag.
...
| `--follow`, `-f` | Returns logs as they are emitted by the app.<br>Default: `false` |
| `--help`, `-h` | Help for this command |
| `--job-invocation` | Retrieves logs for a specific job invocation ID. |
| `--no-prefix` | Removes the prefix from logs. Useful for JSON structured logs<br>Default: `false` |
| `--tail` | Specifies the number of lines to show from the end of the log.<br>Default: `-1` |
| `--type` | Retrieves logs for a specific log type. Defaults to run logs.<br>Default: `run` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/logs/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/logs/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/logs/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/logs/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/logs/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/logs/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/logs/#global-flags)
