---
url: "https://docs.digitalocean.com/reference/pydo/reference/uptime/get_check_state/"
title: "pydo.uptime.get_check_state() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [uptime](https://docs.digitalocean.com/reference/pydo/reference/uptime/)
      - [create\_alert()](https://docs.digitalocean.com/reference/pydo/reference/uptime/create_alert/)
      - [create\_check()](https://docs.digitalocean.com/reference/pydo/reference/uptime/create_check/)
      - [delete\_alert()](https://docs.digitalocean.com/reference/pydo/reference/uptime/delete_alert/)
      - [delete\_check()](https://docs.digitalocean.com/reference/pydo/reference/uptime/delete_check/)
      - [get\_alert()](https://docs.digitalocean.com/reference/pydo/reference/uptime/get_alert/)
      - [get\_check()](https://docs.digitalocean.com/reference/pydo/reference/uptime/get_check/)
      - [get\_check\_state()](https://docs.digitalocean.com/reference/pydo/reference/uptime/get_check_state/)
      - [list\_alerts()](https://docs.digitalocean.com/reference/pydo/reference/uptime/list_alerts/)
      - [list\_checks()](https://docs.digitalocean.com/reference/pydo/reference/uptime/list_checks/)
      - [update\_alert()](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_alert/)
      - [update\_check()](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_check/)
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/uptime_get_checkState) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/uptime/get_check_state/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/uptime/get_check_state/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/uptime/get_check_state/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/uptime/get_check_state/#more-information)
