---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/post/"
title: "pydo.reserved_ips_actions.post() | DigitalOcean Documentation"
---
...
# pydo.reserved\_ips\_actions.post()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPsActions_post) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/post/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/post/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/post/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/post/#more-information)
