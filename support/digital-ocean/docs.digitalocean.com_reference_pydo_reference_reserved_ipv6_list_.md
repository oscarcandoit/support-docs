---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/list/"
title: "pydo.reserved_ipv6.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPv6_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/list/#more-information)
