---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/domains/"
title: "digitalocean_domains | DigitalOcean Documentation"
---
...
Note: You can use the [`digitalocean_domain`](https://docs.digitalocean.com/reference/terraform/reference/data-sources/domains/domain) data source to obtain metadata
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/domains/#example-usage)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/domains/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/domains/#attributes-reference)
