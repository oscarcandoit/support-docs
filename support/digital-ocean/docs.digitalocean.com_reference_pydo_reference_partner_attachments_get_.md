---
url: "https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get/"
title: "pydo.partner_attachments.get() | DigitalOcean Documentation"
---
...
partner_attachment_response = client.partner_attachments.get("5a4981aa-9653-4bd1-bef5-d6bff52042e4")
```

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/partnerAttachments_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get/#more-information)
