---
url: "https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/list/"
title: "doctl nfs snapshot list | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl nfs](https://docs.digitalocean.com/reference/doctl/reference/nfs/)
      - [create](https://docs.digitalocean.com/reference/doctl/reference/nfs/create/)
      - [delete](https://docs.digitalocean.com/reference/doctl/reference/nfs/delete/)
      - [get](https://docs.digitalocean.com/reference/doctl/reference/nfs/get/)
      - [list](https://docs.digitalocean.com/reference/doctl/reference/nfs/list/)
      - [resize](https://docs.digitalocean.com/reference/doctl/reference/nfs/resize/)
      - [snapshot](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/list/)
...
List all NFS snapshots in the given region.

## Flags

| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Name`, `Size`, `Region`, `Status`, `CreatedAt`, `ShareID`. |
| `--help`, `-h` | Help for this command |
| `--no-header` | Return raw data with no headers<br>Default: `false` |
| `--region`, `-r` | the region where the NFS shares reside (required) |
| `--share-id` | the NFS share ID to which snapshots belong |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/list/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/list/#global-flags)
