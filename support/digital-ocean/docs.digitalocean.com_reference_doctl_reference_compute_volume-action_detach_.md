---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach/"
title: "doctl compute volume-action detach | DigitalOcean Documentation"
---
...
| `--wait` | Instructs the terminal to wait for the volume to detach before returning control to the user<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach/#global-flags)
