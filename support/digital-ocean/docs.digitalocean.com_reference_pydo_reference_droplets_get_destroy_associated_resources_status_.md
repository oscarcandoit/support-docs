---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/get_destroy_associated_resources_status/"
title: "pydo.droplets.get_destroy_associated_resources_status() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [droplets](https://docs.digitalocean.com/reference/pydo/reference/droplets/)
- get\_destroy\_associated\_resources\_status()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.droplets.get\_destroy\_associated\_resources\_status()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_get_DestroyAssociatedResourcesStatus) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_destroy_associated_resources_status/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_destroy_associated_resources_status/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_destroy_associated_resources_status/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_destroy_associated_resources_status/#more-information)
