---
url: "https://docs.digitalocean.com/reference/pydo/reference/spaces_key/get/"
title: "pydo.spaces_key.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/spacesKey_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/get/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/get/#more-information)
