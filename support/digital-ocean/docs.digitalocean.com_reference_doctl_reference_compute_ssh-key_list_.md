---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/list/"
title: "doctl compute ssh-key list | DigitalOcean Documentation"
---
...
Use this command to list the id, fingerprint, public\_key, and name of all SSH keys on your account.
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/list/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/list/#global-flags)
