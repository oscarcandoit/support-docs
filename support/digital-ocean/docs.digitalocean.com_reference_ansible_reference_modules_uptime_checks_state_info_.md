---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_state_info/"
title: "uptime_checks_state_info | DigitalOcean Documentation"
---
...
Get the state of an Uptime check. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/uptime\_get\_checkState](https://docs.digitalocean.com/reference/api/api-reference/#operation/uptime_get_checkState).
...
| --- | --- | --- |
| `check_id`<br>str |  | The Uptime check UUID. |
...
| `name`<br>str |  | The Uptime check name. Will fail if there is more than one check with this `name`. |
| `state`<br>str | Choices:<br>- `present` (default) | Only `present` is supported which will return the state of the Uptime check. |
...
| `msg`<br>str | always | Uptime checks result information.<br>Sample:<br>```json<br>[<br>  "Current Uptime check 4de7ac8b-495b-4884-9a69-1050c6793cd6 state",<br>  "No Uptime check 4de7ac8b-495b-4884-9a69-1050c6793cd6 state",<br>  "No Uptime check named my-check",<br>  "Current Uptime check named my-check state",<br>  "Multiple Uptime checks named my-check"<br>]<br>``` |
| `state`<br>dict | always | Uptime check state.<br>Sample:<br>```json<br>{<br>  "state": {<br>    "previous_outage": {<br>      "duration_seconds": 120,<br>      "ended_at": "2022-03-17T18:06:55Z",<br>      "region": "us_east",<br>      "started_at": "2022-03-17T18:04:55Z"<br>    },<br>    "regions": {<br>      "eu_west": {<br>        "status": "UP",<br>        "status_changed_at": "2022-03-17T22:28:51Z",<br>        "thirty_day_uptime_percentag\"": 97.99<br>      },<br>      "us_east": {<br>        "status": "UP",<br>        "status_changed_at": "2022-03-17T22:28:51Z",<br>        "thirty_day_uptime_percentage": 97.99<br>      }<br>    }<br>  }<br>}<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_state_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_state_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_state_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_state_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_state_info/#return-values)
