---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/neighbors/"
title: "doctl compute droplet neighbors | DigitalOcean Documentation"
---
...
# doctl compute droplet neighbors
...
Lists your Droplets that are on the same physical hardware, including the following details:
...
The following example retrieves a list of Droplets that are on the same physical hardware as the Droplet with the ID `386734086` and uses the `--format` flag to return only each Droplet’s ID, name and public IPv4 address:

```shell
doctl compute droplet neighbors 386734086 --format ID,Name,PublicIPv4
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/neighbors/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/neighbors/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/neighbors/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/neighbors/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/neighbors/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/neighbors/#global-flags)
