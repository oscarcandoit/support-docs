---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/create/"
title: "doctl genai agent apikeys create | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/create/#global-flags)
