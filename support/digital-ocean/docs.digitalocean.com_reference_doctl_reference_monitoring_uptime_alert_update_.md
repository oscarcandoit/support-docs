---
url: "https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/update/"
title: "doctl monitoring uptime alert update | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl monitoring](https://docs.digitalocean.com/reference/doctl/reference/monitoring/)
      ...
      - [uptime](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/)
        - [alert](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/)
          - [create](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/create/)
          - [delete](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/delete/)
          - [get](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/get/)
          - [list](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/list/)
          - [update](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/update/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/list/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/update/)
...
# doctl monitoring uptime alert update
...
The following example updates an alert policy with the ID `418b7972-fc67-41ea-ab4b-6f9477c4f7d8` that is a policy of an uptime check with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl monitoring uptime alert update f81d4fae-7dec-11d0-a765-00a0c91e6bf6 418b7972-fc67-41ea-ab4b-6f9477c4f7d8 --name "Example Alert" --type latency --threshold 100 --comparison greater_than --period 2m --emails "admin@example.com"
```
...
| `--slack-channels` | Slack channels to send uptime alerts to, for example, `production-alerts`. Must be used with the `--slack-urls` flag. |
| `--slack-urls` | A Slack webhook URL to send alerts to, for example, `https://hooks.slack.com/services/T1234567/AAAAAAAA/ZZZZZZ`. |
| `--threshold` | The threshold at which to trigger the alert. The specific threshold is dependent on the alert type.<br>Default: `0` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/update/#global-flags)
