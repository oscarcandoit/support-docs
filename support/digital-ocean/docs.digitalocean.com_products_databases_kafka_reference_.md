---
url: "https://docs.digitalocean.com/products/databases/kafka/reference/"
title: "Kafka Reference | DigitalOcean Documentation"
---
...
Validated on 4 Jul 2021 • Last edited on 17 Apr 2025
...
You can use the API to [manage clusters, Topics, and users](https://docs.digitalocean.com/reference/api/digitalocean/#tag/Databases).
...
- [The DigitalOcean API](https://docs.digitalocean.com/products/databases/kafka/reference/#the-digitalocean-api)
- [Official Kafka Documentation](https://docs.digitalocean.com/products/databases/kafka/reference/#official-kafka-documentation)
