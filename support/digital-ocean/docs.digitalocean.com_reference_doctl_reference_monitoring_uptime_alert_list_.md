---
url: "https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/list/"
title: "doctl monitoring uptime alert list | DigitalOcean Documentation"
---
...
# doctl monitoring uptime alert list
...
```shell
doctl monitoring uptime alert list <uptime-check-id> [flags]
```
...
Retrieves a list of the alert policies for an uptime check.

## Example

The following example lists the alert policies for an uptime check with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl monitoring uptime alert list f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/alert/list/#global-flags)
