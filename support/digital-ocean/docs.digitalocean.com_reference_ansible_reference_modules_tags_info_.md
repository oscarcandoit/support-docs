---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/tags_info/"
title: "tags_info | DigitalOcean Documentation"
---
...
List all of the tags on your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/tags\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/tags_list).
...
| `msg`<br>str | always | Tag result information.<br>Sample:<br>```json<br>[<br>  "Current tags",<br>  "No tags"<br>]<br>``` |
| `tags`<br>list | always | Tags. |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/tags_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/tags_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/tags_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/tags_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/tags_info/#return-values)
