---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_keys_info/"
title: "ssh_keys_info | DigitalOcean Documentation"
---
...
List all of the keys in your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/sshKeys\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/sshKeys_list).
...
| `msg`<br>str | always | SSH keys result information.<br>Sample:<br>```json<br>[<br>  "Current SSH keys",<br>  "No SSH keys"<br>]<br>``` |
| `ssh_keys`<br>list | always | SSH keys.<br>Sample:<br>```json<br>[<br>  {<br>    "fingerprint": "3b:16:e4:bf:8b:00:8b:b8:59:8c:a9:d3:f0:19:fa:45",<br>    "id": 289794,<br>    "name": "Other Public Key",<br>    "public_key": "ssh-rsa ANOTHEREXAMPLEaC1yc2EAAAADAQABAAAAQ...owLh64b72pxekALga2oi4GvT+TlWNhzPH4V anotherexample"<br>  }<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_keys_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_keys_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_keys_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_keys_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_keys_info/#return-values)
