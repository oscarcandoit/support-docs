---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/events/list/"
title: "doctl databases events list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl databases](https://docs.digitalocean.com/reference/doctl/reference/databases/)
      ...
      - [events](https://docs.digitalocean.com/reference/doctl/reference/databases/events/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/databases/events/list/)
...
The following example retrieves a list of databases events in a database cluster with the ID `ca9f591d-f38h-5555-a0ef-1c02d1d1e35`:

```shell
doctl databases events list ca9f591d-f38h-5555-a0ef-1c02d1d1e35
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `ServiceName`, `EventType`, `CreateTime`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/events/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/events/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/events/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/events/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/events/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/events/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/events/list/#global-flags)
