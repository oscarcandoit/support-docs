---
url: "https://docs.digitalocean.com/products/databases/opensearch/how-to/forward-logs/"
title: "How to Forward Logs to OpenSearch Clusters | DigitalOcean Documentation"
---
...
You can forward logs to your Managed OpenSearch cluster to view them in the OpenSearch Dashboard in the [control panel](https://cloud.digitalocean.com/databases). The DigitalOcean API natively supports [forwarding logs from other Managed Database clusters](https://docs.digitalocean.com/products/databases/opensearch/how-to/forward-logs/#forward-logs-from-managed-database-clusters).
...
- [Forward Logs from Managed Database Clusters](https://docs.digitalocean.com/products/databases/opensearch/how-to/forward-logs/#forward-logs-from-managed-database-clusters)
