---
url: "https://docs.digitalocean.com/reference/doctl/reference/balance/get/"
title: "doctl balance get | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl balance](https://docs.digitalocean.com/reference/doctl/reference/balance/)
      - [get](https://docs.digitalocean.com/reference/doctl/reference/balance/get/)
...
This command retrieves the following details about your account balance:
...
The following example uses the `--format` flag to display only your month-to-date balance:
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `MonthToDateBalance`, `AccountBalance`, `MonthToDateUsage`, `GeneratedAt`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/balance/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/balance/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/balance/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/balance/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/balance/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/balance/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/balance/get/#global-flags)
