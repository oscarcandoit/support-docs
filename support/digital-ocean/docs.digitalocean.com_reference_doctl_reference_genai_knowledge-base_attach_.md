---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/attach/"
title: "doctl genai knowledge-base attach | DigitalOcean Documentation"
---
...
# doctl genai knowledge-base attach
...
```shell
doctl genai knowledge-base attach <agent-uuid> <knowledge-base-uuid> [flags]
```
...
Attach a knowledge base to an agent using knowledge base uuid and agent uuid. It returns the information of corresponding agent.

## Example

The following example attaches the Knowledge Base having uuid - f81d4fae-7dec-11d0-a765-00a0c91e6bf6 to a specific agent having uuid - \`f81d4fae-0000-11d0-a765-000000000000
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/attach/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/attach/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/attach/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/attach/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/attach/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/attach/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/attach/#global-flags)
