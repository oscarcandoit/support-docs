---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket_policy/"
title: "digitalocean_spaces_bucket_policy | DigitalOcean Documentation"
---
...
- [Provider Reference](https://docs.digitalocean.com/reference/terraform/reference/)
- [Resources](https://docs.digitalocean.com/reference/terraform/reference/resources/)
- digitalocean\_spaces\_bucket\_policy
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket_policy/#example-usage)
  - [Limiting access to specific IP addresses](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket_policy/#limiting-access-to-specific-ip-addresses)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket_policy/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket_policy/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket_policy/#import)
