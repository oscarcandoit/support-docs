---
url: "https://docs.digitalocean.com/products/marketplace/catalog/shiny-kubernetes/"
title: "Shiny Kubernetes | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/shiny-kubernetes/)
...
from [the Shiny Kubernetes catalog page](https://marketplace.digitalocean.com/apps/shiny-kubernetes)
...
| Shiny | [1.5.17.973](https://github.com/rstudio/shiny-server/blob/master/NEWS) | [GPL-3](http://www.gnu.org/licenses/agpl-3.0-standalone.html) |
| Rocker Shinyverse | [4.1.0](https://hub.docker.com/r/rocker/shiny-verse) | [GPL-2](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html) |

## Creating an App using the Control Panel

Click the **Deploy to DigitalOcean** button to install a Kubernetes 1-Click Application. If you aren’t logged in, this link will prompt you to log in with your DigitalOcean account.

[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/kubernetes/clusters/new?addonslug=shiny&nodePools=s-1vcpu-2gb%3A3)
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/shiny-kubernetes/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/shiny-kubernetes/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/shiny-kubernetes/#creating-an-app-using-the-api)
- [Getting Started After Deploying Shiny Kubernetes](https://docs.digitalocean.com/products/marketplace/catalog/shiny-kubernetes/#getting-started-after-deploying-shiny-kubernetes)
