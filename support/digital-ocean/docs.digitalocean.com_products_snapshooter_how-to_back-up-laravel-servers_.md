---
url: "https://docs.digitalocean.com/products/snapshooter/how-to/back-up-laravel-servers/"
title: "How to Back Up Laravel Servers with SnapShooter | DigitalOcean Documentation"
---
...
On the jobs creation page, click **Laravel**. A new section about the job appears at the bottom of the screen. Enter a name for the job, then click **Continue**.

On the **Choose Server** page, select the Laravel server. If you didn’t add it earlier, you can also connect it from this page.
...
On the **Configure Backup** page, in the **Set Config Variables** section, enter the Laravel root directory path. Optionally, in the **Scripts** section, you can add any [pre- or post-backup scripts](https://docs.digitalocean.com/products/snapshooter/how-to/add-pre-and-post-backup-scripts/).
...
- [Connect a Server and Storage Provider](https://docs.digitalocean.com/products/snapshooter/how-to/back-up-laravel-servers/#connect-a-server-and-storage-provider)
- [Create the Backup Job](https://docs.digitalocean.com/products/snapshooter/how-to/back-up-laravel-servers/#create-the-backup-job)
