---
url: "https://docs.digitalocean.com/reference/pydo/reference/monitoring/"
title: "pydo.monitoring | DigitalOcean Documentation"
---
...
The Monitoring API can help you gain insight into how your apps are performing
and consuming resources.

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.create\_alert\_policy()

Create Alert Policy

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.create\_destination()

Create Logging Destination

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.create\_sink()

Create Sink

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.delete\_alert\_policy()

Delete an Alert Policy

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.delete\_destination()

Delete Logging Destination

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.delete\_sink()

Delete Sink

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_alert\_policy()

Retrieve an Existing Alert Policy

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_app\_cpupercentage\_metrics()

Get App CPU Percentage Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_app\_memory\_percentage\_metrics()

Get App Memory Percentage Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_app\_restart\_count\_metrics.yml()

Get App Restart Count Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_destination()

Get Logging Destination

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_autoscale\_current\_cpu\_utilization.yml()

Get Droplet Autoscale Pool Current Average CPU utilization

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_autoscale\_current\_instances()

Get Droplet Autoscale Pool Current Size

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_autoscale\_current\_memory\_utilization()

Get Droplet Autoscale Pool Current Average Memory utilization

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_autoscale\_target\_cpu\_utilization()

Get Droplet Autoscale Pool Target Average CPU utilization

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_autoscale\_target\_instances()

Get Droplet Autoscale Pool Target Size

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_autoscale\_target\_memory\_utilization()

Get Droplet Autoscale Pool Target Average Memory utilization

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_bandwidth\_metrics()

Get Droplet Bandwidth Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_cpu\_metrics()

Get Droplet CPU Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_filesystem\_free\_metrics()

Get Droplet Filesystem Free Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_filesystem\_size\_metrics()

Get Droplet Filesystem Size Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_load1\_metrics()

Get Droplet Load1 Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_load15\_metrics()

Get Droplet Load15 Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_load5\_metrics()

Get Droplet Load5 Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_memory\_available\_metrics()

Get Droplet Available Memory Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_memory\_cached\_metrics()

Get Droplet Cached Memory Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_memory\_free\_metrics()

Get Droplet Free Memory Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_droplet\_memory\_total\_metrics()

Get Droplet Total Memory Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_connections()

Get Load Balancer Droplets Active Connections Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_downtime()

Get Load Balancer Droplets Downtime Status Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_health\_checks()

Get Load Balancer Droplets Health Check Status Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_http\_response\_time\_50p()

Get Load Balancer Droplets 50th Percentile HTTP Response Time Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_http\_response\_time\_95p()

Get Load Balancer Droplets 95th Percentile HTTP Response Time Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_http\_response\_time\_99p()

Get Load Balancer Droplets 99th Percentile HTTP Response Time Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_http\_response\_time\_avg()

Get Load Balancer Droplets Average HTTP Response Time Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_http\_responses()

Get Load Balancer Droplets HTTP Rate Of Response Code Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_http\_session\_duration\_50p()

Get Load Balancer Droplets 50th Percentile HTTP Session Duration Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_http\_session\_duration\_95p()

Get Load Balancer Droplets 95th Percentile HTTP Session Duration Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_http\_session\_duration\_avg()

Get Load Balancer Droplets Average HTTP Session Duration Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_droplets\_queue\_size()

Get Load Balancer Droplets Queue Size Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_connections\_current()

Get Load Balancer Frontend Total Current Active Connections Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_connections\_limit()

Get Load Balancer Frontend Max Connections Limit Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_cpu\_utilization()

Get Load Balancer Frontend Average Percentage CPU Utilization Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_firewall\_dropped\_bytes()

Get Load Balancer Frontend Firewall Dropped Bytes Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_firewall\_dropped\_packets()

Get Load Balancer Frontend Firewall Dropped Packets Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_http\_requests\_per\_second()

Get Load Balancer Frontend HTTP Requests Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_http\_responses()

Get Load Balancer Frontend HTTP Rate Of Response Code Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_network\_throughput\_http()

Get Load Balancer Frontend HTTP Throughput Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_network\_throughput\_tcp()
...
pydo.monitoring.get\_lb\_frontend\_nlb\_tcp\_network\_throughput()

Get Network Load Balancer Frontend TCP Throughput Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_nlb\_udp\_network\_throughput()

Get Network Load Balancer Frontend UDP Throughput Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_tls\_connections\_current()

Get Load Balancer Frontend Current TLS Connections Rate Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_tls\_connections\_exceeding\_rate\_limit()

Get Load Balancer Frontend Closed TLS Connections For Exceeded Rate Limit Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_lb\_frontend\_tls\_connections\_limit()

Get Load Balancer Frontend Max TLS Connections Limit Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.get\_sink()

Get Sink

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.list\_alert\_policy()

List Alert Policies

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.list\_destinations()

List Logging Destinations

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.monitoring.list\_sinks()
...
pydo.monitoring.update\_destination()

Update Logging Destination

In this article...

[pydo.monitoring](https://docs.digitalocean.com/reference/pydo/reference/monitoring/)
