---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/install/"
title: "doctl serverless install | DigitalOcean Documentation"
---
...
```shell
doctl serverless install [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/install/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/install/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/install/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/install/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/install/#global-flags)
