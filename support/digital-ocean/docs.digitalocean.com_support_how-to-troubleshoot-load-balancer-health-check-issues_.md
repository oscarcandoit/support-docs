---
url: "https://docs.digitalocean.com/support/how-to-troubleshoot-load-balancer-health-check-issues/"
title: "How to Troubleshoot Load Balancer Health Check Issues | DigitalOcean Documentation"
---
...
Validated on 25 Jul 2024 • Last edited on 30 Jul 2024
...
- If using [Cloud Firewalls](https://docs.digitalocean.com/products/networking/firewalls/how-to/configure-rules/), make sure that the load balancer is added as a source in the appropriate firewall rules.
- Ensure your server software is listening on the private network interface. All load balancer traffic goes through the specified [private VPC network](https://docs.digitalocean.com/products/networking/vpc/).
- If using the [PROXY protocol](https://docs.digitalocean.com/products/networking/load-balancers/how-to/manage/#proxy-protocol), make sure your health check endpoint (the URL specified in the **Path** setting of the health check) also accepts PROXY protocol.
...
[How to Troubleshoot Load Balancer Health Check Issues](https://docs.digitalocean.com/support/how-to-troubleshoot-load-balancer-health-check-issues/)
