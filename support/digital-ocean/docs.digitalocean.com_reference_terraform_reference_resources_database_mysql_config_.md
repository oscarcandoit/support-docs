---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/database_mysql_config/"
title: "digitalocean_database_mysql_config | DigitalOcean Documentation"
---
...
- `slow_query_log` \- (Optional) When enabled, captures slow queries. When disabled, also truncates the mysql.slow\_log table. Default is false.
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/database_mysql_config/#example-usage)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_mysql_config/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_mysql_config/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/database_mysql_config/#import)
