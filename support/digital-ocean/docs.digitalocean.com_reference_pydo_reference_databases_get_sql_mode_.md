---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_sql_mode/"
title: "pydo.databases.get_sql_mode() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_sql_mode) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_sql_mode/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_sql_mode/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/get_sql_mode/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_sql_mode/#more-information)
