---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/"
title: "doctl apps dev config | DigitalOcean Documentation"
---
...
\[BETA\] Displays commands for working with App Platform local development configuration settings.
...
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/#global-flags)
