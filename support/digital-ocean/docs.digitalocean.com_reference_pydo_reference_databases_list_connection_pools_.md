---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_connection_pools/"
title: "pydo.databases.list_connection_pools() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- list\_connection\_pools()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.list\_connection\_pools()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_connectionPools) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_connection_pools/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_connection_pools/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/list_connection_pools/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_connection_pools/#more-information)
