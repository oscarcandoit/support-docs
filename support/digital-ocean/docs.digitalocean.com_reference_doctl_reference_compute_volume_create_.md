---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/volume/create/"
title: "doctl compute volume create | DigitalOcean Documentation"
---
...
| `--size` | Volume size (required)<br>Default: `4TiB` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/create/#global-flags)
