---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_topic/"
title: "pydo.databases.get_kafka_topic() | DigitalOcean Documentation"
---
...
# pydo.databases.get\_kafka\_topic()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_kafka_topic) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_topic/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_topic/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_topic/#more-information)
