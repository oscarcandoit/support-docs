---
url: "https://docs.digitalocean.com/support/my-php-app-is-timing-out-and-throwing-5xx-errors/"
title: "My PHP app is timing out and throwing 5xx errors | DigitalOcean Documentation"
---
...
Running out of time to execute a request is the most common cause of timeouts and `5xx` errors in [PHP apps on App Platform](https://docs.digitalocean.com/products/app-platform/reference/buildpacks/php/). By default, App Platform allows your app `30` seconds to execute a request before timing out. You can increase this time by editing your app’s `.user.ini` file and setting the `max_execution_time` value to a higher number. `user.ini` files allow you to configure and override PHP settings on a per directory basis.

To increase your app’s maximum execution time, add a [`.user.ini` file](https://www.php.net/manual/en/configuration.file.per-user.php) to the root of your app with the following contents:
...
[My PHP app is timing out and throwing 5xx errors](https://docs.digitalocean.com/support/my-php-app-is-timing-out-and-throwing-5xx-errors/)
