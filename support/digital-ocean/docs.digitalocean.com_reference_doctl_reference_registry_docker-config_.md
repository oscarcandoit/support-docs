---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/docker-config/"
title: "doctl registry docker-config | DigitalOcean Documentation"
---
...
```shell
doctl registry docker-config [flags]
```
...
Outputs a JSON-formatted Docker configuration that you can use to configure a Docker client to authenticate with your private container registry. This configuration is useful for configuring third-party tools that need access to your registry. For configuring your local Docker client use `doctl registry login` instead, as it preserves the configuration of any other registries you have authenticated to.
...
```shell
doctl registry docker-config example-registry --expiry-seconds=86400
```
...
| Option | Description |
| --- | --- |
| `--expiry-seconds` | The length of time the registry credentials are valid for, in seconds. By default, the credentials do not expire.<br>Default: `0` |
| `--help`, `-h` | Help for this command |
| `--read-write` | Generates credentials that can push to your registry<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/docker-config/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registry/docker-config/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/docker-config/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registry/docker-config/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/docker-config/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/docker-config/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/docker-config/#global-flags)
