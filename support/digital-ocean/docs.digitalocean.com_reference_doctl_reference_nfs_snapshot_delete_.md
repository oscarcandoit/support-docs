---
url: "https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/delete/"
title: "doctl nfs snapshot delete | DigitalOcean Documentation"
---
...
Delete an NFS share with the given ID and region.
...
| `--id` | the ID of the NFS snapshot (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/delete/#global-flags)
