---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/user/get/"
title: "doctl databases user get | DigitalOcean Documentation"
---
...
The following example retrieves the details for the user with the username `example-user` for a database cluster with the ID `ca9f591d-f38h-5555-a0ef-1c02d1d1e35` and uses the `--format` flag to return only the user’s name and role:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/user/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/user/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/user/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/user/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/user/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/user/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/user/get/#global-flags)
