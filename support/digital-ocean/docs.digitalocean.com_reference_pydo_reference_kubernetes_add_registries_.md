---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/add_registries/"
title: "pydo.kubernetes.add_registries() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_add_registries) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/add_registries/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/add_registries/#more-information)
