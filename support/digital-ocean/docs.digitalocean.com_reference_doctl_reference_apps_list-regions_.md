---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/list-regions/"
title: "doctl apps list-regions | DigitalOcean Documentation"
---
...
The following example lists all regions supported by App Platform, including details about their current availability:

```shell
doctl apps list-regions --format DataCenters,Disabled,Reason
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Slug`, `Label`, `Continent`, `DataCenters`, `Disabled`, `Reason`, `Default`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/list-regions/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/list-regions/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/list-regions/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list-regions/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/list-regions/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list-regions/#global-flags)
