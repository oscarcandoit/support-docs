---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/create_replica/"
title: "pydo.databases.create_replica() | DigitalOcean Documentation"
---
...
# pydo.databases.create\_replica()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_create_replica) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/create_replica/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/create_replica/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/create_replica/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/create_replica/#more-information)
