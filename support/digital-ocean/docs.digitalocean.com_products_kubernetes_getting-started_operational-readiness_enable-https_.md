---
url: "https://docs.digitalocean.com/products/kubernetes/getting-started/operational-readiness/enable-https/"
title: "DOKS Operational Readiness, Part 2: Enable HTTPS | DigitalOcean Documentation"
---
...
- Install an NGINX Ingress Controller and configure the backend services, as described in the [Install NGINX Ingress Controller](https://docs.digitalocean.com/products/kubernetes/getting-started/operational-readiness/install-nginx-ingress-controller/) tutorial.
...
- [Prerequisites](https://docs.digitalocean.com/products/kubernetes/getting-started/operational-readiness/enable-https/#prerequisites)
- [Step 1: Install Cert-Manager](https://docs.digitalocean.com/products/kubernetes/getting-started/operational-readiness/enable-https/#step-1-install-cert-manager)
- [STEP 2: Configure Production-Ready TLS Certificates for nginx](https://docs.digitalocean.com/products/kubernetes/getting-started/operational-readiness/enable-https/#step-2-configure-production-ready-tls-certificates-for-nginx)
- [STEP 3: Enable Proxy Protocol](https://docs.digitalocean.com/products/kubernetes/getting-started/operational-readiness/enable-https/#step-3-enable-proxy-protocol)
- [Summary](https://docs.digitalocean.com/products/kubernetes/getting-started/operational-readiness/enable-https/#summary)
- [What’s Next](https://docs.digitalocean.com/products/kubernetes/getting-started/operational-readiness/enable-https/#whats-next)
