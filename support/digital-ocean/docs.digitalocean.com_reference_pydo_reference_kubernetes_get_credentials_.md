---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_credentials/"
title: "pydo.kubernetes.get_credentials() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_get_credentials) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_credentials/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_credentials/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_credentials/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_credentials/#more-information)
