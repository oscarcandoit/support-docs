---
url: "https://docs.digitalocean.com/reference/doctl/reference/nfs/list/"
title: "doctl nfs list | DigitalOcean Documentation"
---
...
List all NFS shares in the given region.

## Flags

| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Name`, `Size`, `Region`, `Status`, `CreatedAt`, `VpcIDs`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/nfs/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/nfs/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/nfs/list/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/nfs/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/list/#global-flags)
