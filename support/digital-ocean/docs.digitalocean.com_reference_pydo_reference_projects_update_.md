---
url: "https://docs.digitalocean.com/reference/pydo/reference/projects/update/"
title: "pydo.projects.update() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/projects_update) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/projects/update/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/projects/update/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/projects/update/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/projects/update/#more-information)
