---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/balance_info/"
title: "balance_info | DigitalOcean Documentation"
---
...
Retrieve the balances on a customer’s account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/balance\_get](https://docs.digitalocean.com/reference/api/api-reference/#operation/balance_get).
...
| --- | --- | --- |
| `balance`<br>dict | always | Balance information.<br>Sample:<br>```json<br>{<br>  "account_balance": 12.23,<br>  "generated_at": "2019-07-09T15:01:12Z",<br>  "month_to_date_balance": 23.44,<br>  "month_to_date_usage": 11.21<br>}<br>``` |
...
| `msg`<br>str | always | Balance result information.<br>Sample:<br>```json<br>[<br>  "Current balance information",<br>  "Current balance information not found"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/balance_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/balance_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/balance_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/balance_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/balance_info/#return-values)
