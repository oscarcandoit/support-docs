---
url: "https://docs.digitalocean.com/reference/pydo/reference/firewalls/list/"
title: "pydo.firewalls.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/firewalls_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/firewalls/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/firewalls/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/firewalls/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/firewalls/list/#more-information)
