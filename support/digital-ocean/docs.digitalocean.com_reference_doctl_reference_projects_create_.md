---
url: "https://docs.digitalocean.com/reference/doctl/reference/projects/create/"
title: "doctl projects create | DigitalOcean Documentation"
---
...
| `--environment` | The environment in which your project resides. Possible `enum` values: `Development`, `Staging`, `Production`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/projects/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/projects/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/projects/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/projects/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/projects/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/projects/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/projects/create/#global-flags)
