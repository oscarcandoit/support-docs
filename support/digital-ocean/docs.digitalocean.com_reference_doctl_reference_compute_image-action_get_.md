---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/get/"
title: "doctl compute image-action get | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [image-action](https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/get/)
        - [transfer](https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/transfer/)
...
# doctl compute image-action get
...
```shell
doctl compute image-action get <image-id> [flags]
```

## Description

Retrieves the status of an image action, including the following details:
...
The following example retrieves the details for an image-action with ID 191669331 take on an image with the ID 386734086:

```shell
doctl compute image-action get 386734086 --action-id 191669331
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/get/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image-action/get/#global-flags)
