---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/"
title: "pydo.genai | DigitalOcean Documentation"
---
...
pydo.genai.attach\_agent\_function()

Add Function Route to an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.attach\_agent()

Add Agent Route to an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.attach\_knowledge\_base()

Attach Knowledge Base to an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.attach\_knowledge\_bases()

Attach Knowledge Bases to an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.cancel\_indexing\_job()

Cancel Indexing Job for a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_agent\_api\_key()

Create an Agent API Key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_agent()

Create an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_anthropic\_api\_key()
...
pydo.genai.create\_evaluation\_dataset\_file\_upload\_presigned\_urls()

Create Presigned URLs for Evaluation Dataset File Upload

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_evaluation\_dataset()

Create Evaluation Dataset

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_evaluation\_test\_case()

Create Evaluation Test Case.

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_indexing\_job()

Start Indexing Job for a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_knowledge\_base\_data\_source()

Add Data Source to a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_knowledge\_base()

Create a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_model\_api\_key()

Create a Model API Key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_oauth2\_dropbox\_tokens()

Get Oauth2 Dropbox Tokens

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_openai\_api\_key()

Create OpenAI API Key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_scheduled\_indexing()

Create scheduled indexing for knowledge base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.create\_workspace()

Create a Workspace

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.delete\_agent\_api\_key()

Delete API Key for an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.delete\_agent()

Delete an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.delete\_anthropic\_api\_key()

Delete Anthropic API Key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.delete\_knowledge\_base\_data\_source()

Delete a Data Source from a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.delete\_knowledge\_base()

Delete a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.delete\_model\_api\_key()

Delete API Key for a Model

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.delete\_openai\_api\_key()

Delete OpenAI API Key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.delete\_scheduled\_indexing()

Delete Scheduled Indexing

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.delete\_workspace()

Delete a Workspace

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.detach\_agent\_function()

Delete Function Route for an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.detach\_agent()

Delete Agent Route for an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.detach\_knowledge\_base()

Detach Knowledge Base from an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_agent\_children()

View Agent Routes

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_agent\_usage()

Get Agent Usage

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_agent()

Retrieve an Existing Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_anthropic\_api\_key()

Get Anthropic API Key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_evaluation\_run\_prompt\_results()

Retrieve Results of an Evaluation Run Prompt

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_evaluation\_run\_results()

Retrieve Results of an Evaluation Run

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_evaluation\_run()

Retrieve Information About an Existing Evaluation Run

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_evaluation\_test\_case()

Retrieve Information About an Existing Evaluation Test Case

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_indexing\_job\_details\_signed\_url()

Get Signed URL for Indexing Job Details

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_indexing\_job()

Retrieve Status of Indexing Job for a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_knowledge\_base()

Retrieve Information About an Existing Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_oauth2\_url()

Get Oauth2 URL

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_openai\_api\_key()

Get OpenAI API Key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_scheduled\_indexing()

Get Scheduled Indexing for Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.get\_workspace()

Retrieve an Existing Workspace

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_agent\_api\_keys()

List Agent API Keys

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_agent\_versions()

List Agent Versions

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_agents\_by\_anthropic\_key()

List agents by Anthropic key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_agents\_by\_openai\_key()

List agents by OpenAI key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_agents\_by\_workspace()

List agents by Workspace

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_agents()

List Agents

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_anthropic\_api\_keys()

List Anthropic API Keys

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_datacenter\_regions()

List Datacenter Regions

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_evaluation\_metrics()

List Evaluation Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_evaluation\_runs\_by\_test\_case()

List Evaluation Runs by Test Case

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_evaluation\_test\_cases\_by\_workspace()

List Evaluation Test Cases by Workspace

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_evaluation\_test\_cases()

List Evaluation Test Cases

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_indexing\_job\_data\_sources()

List Data Sources for Indexing Job for a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_indexing\_jobs\_by\_knowledge\_base()

List Indexing Jobs for a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_indexing\_jobs()

List Indexing Jobs for a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_knowledge\_base\_data\_sources()

List Data Sources for a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_knowledge\_bases()

List Knowledge Bases

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_model\_api\_keys()

List Model API Keys

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_models()

List Available Models

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_openai\_api\_keys()

List OpenAI API Keys

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.list\_workspaces()

List Workspaces

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.regenerate\_agent\_api\_key()

Regenerate API Key for an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.regenerate\_model\_api\_key()

Regenerate API Key for a Model

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.rollback\_to\_agent\_version()

Rollback to Agent Version

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.run\_evaluation\_test\_case()

Run an Evaluation Test Case

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_agent\_api\_key()

Update API Key for an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_agent\_deployment\_visibility()

Update Agent Status

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_agent\_function()

Update Function Route for an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_agent()

Update an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_agents\_workspace()

Move Agents to a Workspace

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_anthropic\_api\_key()

Update Anthropic API Key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_attached\_agent()

Update Agent Route for an Agent

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_evaluation\_test\_case()

Update an Evaluation Test Case.

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_knowledge\_base()

Update a Knowledge Base

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_model\_api\_key()

Update API Key for a Model

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_openai\_api\_key()

Update OpenAI API Key

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.genai.update\_workspace()

Update a Workspace

In this article...

[pydo.genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
