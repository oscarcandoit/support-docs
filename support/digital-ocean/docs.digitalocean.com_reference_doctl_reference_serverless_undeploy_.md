---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/undeploy/"
title: "doctl serverless undeploy | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--all` | remove all packages and functions<br>Default: `false` |
| `--apihost` |  |
| `--auth` |  |
| `--force`, `-f` | Delete namespace resources without confirmation prompt<br>Default: `false` |
| `--help`, `-h` | Help for this command |
| `--packages`, `-p` | interpret simple name arguments as packages<br>Default: `false` |
| `--triggers` | interpret all arguments as triggers<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/undeploy/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/undeploy/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/undeploy/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/undeploy/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/undeploy/#global-flags)
