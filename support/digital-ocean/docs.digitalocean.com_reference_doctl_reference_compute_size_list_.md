---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/size/list/"
title: "doctl compute size list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [size](https://docs.digitalocean.com/reference/doctl/reference/compute/size/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/size/list/)
...
The following example retrieves a list of Droplet sizes and uses the –format flag to return only the slug for each size and its monthly price:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/size/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/size/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/size/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/size/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/size/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/size/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/size/list/#global-flags)
