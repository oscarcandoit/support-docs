---
url: "https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list_remote_routes/"
title: "pydo.partner_attachments.list_remote_routes() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [partner\_attachments](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/)
- list\_remote\_routes()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.partner\_attachments.list\_remote\_routes()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/partnerAttachments_list_remote_routes) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list_remote_routes/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list_remote_routes/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list_remote_routes/#more-information)
