---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/attachment/update/"
title: "doctl network attachment update | DigitalOcean Documentation"
---
...
# doctl network attachment update
...
```shell
doctl network attachment update <partner-attachment-id> [flags]
```
...
Use this command to update the name and and configuration of a Partner Attachment
...
| `--name` | The Partner Attachment name (required) |
| `--type` | Specify connect type (e.g., partner)<br>Default: `partner` |
| `--vpc-ids` | The Partner Attachment vpc ids (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/update/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/update/#global-flags)
