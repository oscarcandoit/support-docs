---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_agent_versions/"
title: "pydo.genai.list_agent_versions() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `uuid` | string | True | Agent uuid |  |
| `page` | integer | False | Page number. |  |
| `per_page` | integer | False | Items per page. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_agent_versions) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agent_versions/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agent_versions/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agent_versions/#more-information)
