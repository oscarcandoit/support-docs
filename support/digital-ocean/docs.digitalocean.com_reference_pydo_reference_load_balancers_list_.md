---
url: "https://docs.digitalocean.com/reference/pydo/reference/load_balancers/list/"
title: "pydo.load_balancers.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/loadBalancers_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/list/#more-information)
