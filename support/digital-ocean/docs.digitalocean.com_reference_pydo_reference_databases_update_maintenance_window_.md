---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_maintenance_window/"
title: "pydo.databases.update_maintenance_window() | DigitalOcean Documentation"
---
...
# pydo.databases.update\_maintenance\_window()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_maintenanceWindow) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_maintenance_window/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_maintenance_window/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/update_maintenance_window/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_maintenance_window/#more-information)
