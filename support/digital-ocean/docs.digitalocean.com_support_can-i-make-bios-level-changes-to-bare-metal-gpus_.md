---
url: "https://docs.digitalocean.com/support/can-i-make-bios-level-changes-to-bare-metal-gpus/"
title: "Can I make BIOS-level changes to bare metal GPUs? | DigitalOcean Documentation"
---
...
You can request BIOS-level changes to bare metal GPUs by [opening a support ticket](https://docs.digitalocean.com/products/bare-metal-gpus/support/contact/).

Some BIOS changes may require us to reprovision your bare metal GPU.
...
[Can I make BIOS-level changes to bare metal GPUs?](https://docs.digitalocean.com/support/can-i-make-bios-level-changes-to-bare-metal-gpus/)
