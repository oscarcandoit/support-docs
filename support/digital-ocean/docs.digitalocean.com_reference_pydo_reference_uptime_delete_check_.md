---
url: "https://docs.digitalocean.com/reference/pydo/reference/uptime/delete_check/"
title: "pydo.uptime.delete_check() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/uptime_delete_check) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/uptime/delete_check/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/uptime/delete_check/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/uptime/delete_check/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/uptime/delete_check/#more-information)
