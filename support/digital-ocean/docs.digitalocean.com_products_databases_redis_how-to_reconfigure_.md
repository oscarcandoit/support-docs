---
url: "https://docs.digitalocean.com/products/databases/redis/how-to/reconfigure/"
title: "How to Reconfigure Caching Database Clusters | DigitalOcean Documentation"
---
...
To ensure database stability, you can only edit the parameters listed in our [API reference](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_patch_config). To change other Caching parameters, [contact support](https://cloudsupport.digitalocean.com/).
...
- [Update a Database’s Configuration Using the CLI](https://docs.digitalocean.com/products/databases/redis/how-to/reconfigure/#update-a-databases-configuration-using-the-cli)
- [Update a Database’s Configuration Using the API](https://docs.digitalocean.com/products/databases/redis/how-to/reconfigure/#update-a-databases-configuration-using-the-api)
