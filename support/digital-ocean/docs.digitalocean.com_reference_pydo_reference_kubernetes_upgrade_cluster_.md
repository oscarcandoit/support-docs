---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/upgrade_cluster/"
title: "pydo.kubernetes.upgrade_cluster() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_upgrade_cluster) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/upgrade_cluster/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/upgrade_cluster/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/upgrade_cluster/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/upgrade_cluster/#more-information)
