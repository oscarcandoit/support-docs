---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/database_replica/"
title: "digitalocean_database_replica | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/database_replica/#example-usage)
  - [Create a new PostgreSQL database replica](https://docs.digitalocean.com/reference/terraform/reference/resources/database_replica/#create-a-new-postgresql-database-replica)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_replica/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_replica/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/database_replica/#import)
