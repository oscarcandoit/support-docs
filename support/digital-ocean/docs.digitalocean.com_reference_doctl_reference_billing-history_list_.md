---
url: "https://docs.digitalocean.com/reference/doctl/reference/billing-history/list/"
title: "doctl billing-history list | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl billing-history](https://docs.digitalocean.com/reference/doctl/reference/billing-history/)
      - [list](https://docs.digitalocean.com/reference/doctl/reference/billing-history/list/)
...
The following example uses the `--format` flag to display only the date and description of each event in your billing history:
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Date`, `Type`, `Description`, `Amount`, `InvoiceID`, `InvoiceUUID`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/billing-history/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/billing-history/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/billing-history/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/billing-history/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/billing-history/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/billing-history/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/billing-history/list/#global-flags)
