---
url: "https://docs.digitalocean.com/reference/pydo/reference/functions/delete_namespace/"
title: "pydo.functions.delete_namespace() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [functions](https://docs.digitalocean.com/reference/pydo/reference/functions/)
      - [create\_namespace()](https://docs.digitalocean.com/reference/pydo/reference/functions/create_namespace/)
      - [create\_trigger()](https://docs.digitalocean.com/reference/pydo/reference/functions/create_trigger/)
      - [delete\_namespace()](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_namespace/)
      - [delete\_trigger()](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_trigger/)
      - [get\_namespace()](https://docs.digitalocean.com/reference/pydo/reference/functions/get_namespace/)
      - [get\_trigger()](https://docs.digitalocean.com/reference/pydo/reference/functions/get_trigger/)
      - [list\_namespaces()](https://docs.digitalocean.com/reference/pydo/reference/functions/list_namespaces/)
      - [list\_triggers()](https://docs.digitalocean.com/reference/pydo/reference/functions/list_triggers/)
      - [update\_trigger()](https://docs.digitalocean.com/reference/pydo/reference/functions/update_trigger/)
...
# pydo.functions.delete\_namespace()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/functions_delete_namespace) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_namespace/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_namespace/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_namespace/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_namespace/#more-information)
