---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-rules/"
title: "doctl compute firewall add-rules | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-rules/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-rules/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-rules/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-rules/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-rules/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-rules/#global-flags)
