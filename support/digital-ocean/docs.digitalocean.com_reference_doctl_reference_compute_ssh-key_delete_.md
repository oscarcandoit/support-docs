---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/delete/"
title: "doctl compute ssh-key delete | DigitalOcean Documentation"
---
...
Use this command to permanently delete an SSH key from your account.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete the key without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/delete/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/delete/#global-flags)
