---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/validate_name/"
title: "pydo.registries.validate_name() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_validate_name) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/validate_name/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/validate_name/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/validate_name/#more-information)
