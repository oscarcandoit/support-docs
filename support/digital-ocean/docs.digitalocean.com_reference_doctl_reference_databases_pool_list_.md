---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/pool/list/"
title: "doctl databases pool list | DigitalOcean Documentation"
---
...
```shell
doctl databases pool list <database-cluster-id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/list/#global-flags)
