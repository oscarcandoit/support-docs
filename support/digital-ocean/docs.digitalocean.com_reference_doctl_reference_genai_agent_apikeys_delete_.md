---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/delete/"
title: "doctl genai agent apikeys delete | DigitalOcean Documentation"
---
...
The following example deletes an apikey with ID `12345678-1234-1234-1234-123456789012for an agent with the ID`12345678-1234-1234-1234-123456789013\`:
...
| `--force`, `-f` | Deletes the API Key without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/delete/#global-flags)
