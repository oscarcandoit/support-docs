---
url: "https://docs.digitalocean.com/reference/pydo/reference/load_balancers/get/"
title: "pydo.load_balancers.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/loadBalancers_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/get/#more-information)
