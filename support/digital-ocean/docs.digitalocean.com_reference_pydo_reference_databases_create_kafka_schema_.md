---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/create_kafka_schema/"
title: "pydo.databases.create_kafka_schema() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- create\_kafka\_schema()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.create\_kafka\_schema()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_create_kafka_schema) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/create_kafka_schema/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/create_kafka_schema/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/create_kafka_schema/#more-information)
