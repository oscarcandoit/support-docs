---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/delete/"
title: "doctl network byoip-prefix delete | DigitalOcean Documentation"
---
...
# doctl network byoip-prefix delete
...
```shell
doctl network byoip-prefix delete <prefix-uuid> [flags]
```
...
Permanently deletes a BYOIP Prefix. This is irreversible and it needs all IPs of the prefix to be unassigned

## Example

The following example deletes the byoip prefix `5ae545c4-0ac4-42bb-9de5-8eca3d17f1c0`:

```shell
doctl network byoip-prefix delete 5ae545c4-0ac4-42bb-9de5-8eca3d17f1c0
```
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes the BYOIP Prefix without confirmation<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/delete/#global-flags)
