---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/action/wait/"
title: "doctl compute action wait | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      - [action](https://docs.digitalocean.com/reference/doctl/reference/compute/action/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/action/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/action/list/)
        - [wait](https://docs.digitalocean.com/reference/doctl/reference/compute/action/wait/)
...
| `--poll-timeout` | Re-poll time in seconds<br>Default: `5` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/action/wait/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/action/wait/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/action/wait/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/action/wait/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/action/wait/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/action/wait/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/action/wait/#global-flags)
