---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_nat_gateway/"
title: "digitalocean_vpc_nat_gateway | DigitalOcean Documentation"
---
...
See the [VPC NAT Gateway Resource](https://docs.digitalocean.com/reference/terraform/reference/data-sources/resources/vpc_nat_gateway.md) for details on the
returned attributes - they are identical.

In this article...

- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_nat_gateway/#example-usage)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_nat_gateway/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_nat_gateway/#attributes-reference)
