---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/post_by_tag/"
title: "pydo.droplet_actions.post_by_tag() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [droplet\_actions](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/list/)
      - [post()](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/post/)
      - [post\_by\_tag()](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/post_by_tag/)
...
# pydo.droplet\_actions.post\_by\_tag()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/dropletActions_post_byTag) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/post_by_tag/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/post_by_tag/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/post_by_tag/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/post_by_tag/#more-information)
