---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_kubeconfig/"
title: "pydo.kubernetes.get_kubeconfig() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_get_kubeconfig) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_kubeconfig/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_kubeconfig/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_kubeconfig/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_kubeconfig/#more-information)
