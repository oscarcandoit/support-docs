---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/list-instances/"
title: "doctl apps list-instances | DigitalOcean Documentation"
---
...
```shell
doctl apps list-instances <app id> [flags]
```
...
The following examples retrieves the currently running, ephemeral compute instances for the app with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl apps list-instances f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/list-instances/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/list-instances/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/list-instances/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/list-instances/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list-instances/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/list-instances/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list-instances/#global-flags)
