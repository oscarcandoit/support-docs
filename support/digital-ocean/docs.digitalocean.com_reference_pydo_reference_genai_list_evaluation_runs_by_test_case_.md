---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_runs_by_test_case/"
title: "pydo.genai.list_evaluation_runs_by_test_case() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- list\_evaluation\_runs\_by\_test\_case()
...
| --- | --- | --- | --- | --- |
| `evaluation_test_case_uuid` | string | True | Evaluation run UUID. |  |
| `evaluation_test_case_version` | integer | False | Version of the test case. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_evaluation_runs_by_test_case) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_runs_by_test_case/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_runs_by_test_case/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_runs_by_test_case/#more-information)
