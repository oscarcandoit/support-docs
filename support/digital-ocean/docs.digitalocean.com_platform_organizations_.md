---
url: "https://docs.digitalocean.com/platform/organizations/"
title: "DigitalOcean Organizations | DigitalOcean Documentation"
---
...
# DigitalOcean Organizations

Validated on 10 Sep 2025 • Last edited on 30 Sep 2025

Organizations are groupings of related [teams](https://docs.digitalocean.com/platform/teams/). Organizations enable consolidated billing, payment, and invoicing, and provide detailed spend breakdowns by team. Organization owners can manage members, settings, and billing across teams in the organization while team owners can manage their team’s resources and view spending.

Organizations are available at no cost.

![](https://docs.digitalocean.com/images/icons/organizations.svg)

Organization Roles

Each organization member comes with predefined roles which cover common use cases for levels of access.

![](https://docs.digitalocean.com/images/icons/organizations.svg)

Organization How-Tos

Step-by-step instructions on how to perform specific tasks with DigitalOcean Organizations.

![](https://docs.digitalocean.com/images/icons/organizations.svg)

Organization Limits

Limits and known issues for DigitalOcean Organizations.
...
[DigitalOcean Organizations](https://docs.digitalocean.com/platform/organizations/)
