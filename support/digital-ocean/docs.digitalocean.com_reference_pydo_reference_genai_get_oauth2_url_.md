---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/get_oauth2_url/"
title: "pydo.genai.get_oauth2_url() | DigitalOcean Documentation"
---
...
To generate an Oauth2-URL for use with your localhost, send a GET request to `/v2/gen-ai/oauth2/url`. Pass ‘http://localhost:3000 as redirect\_url

## Parameters

| Name | Type | Required | Description | Default Value |
| --- | --- | --- | --- | --- |
| `type` | string | False | Type “google” / “dropbox”. |  |
| `redirect_url` | string | False | The redirect url. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_get_oauth2_url) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/get_oauth2_url/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/get_oauth2_url/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/get_oauth2_url/#more-information)
