---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/list-job-invocations/"
title: "doctl apps list-job-invocations | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/list-job-invocations/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/list-job-invocations/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/list-job-invocations/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/list-job-invocations/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list-job-invocations/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/list-job-invocations/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list-job-invocations/#global-flags)
