---
url: "https://docs.digitalocean.com/products/snapshooter/how-to/back-up-postgresql-servers/"
title: "How to Back Up PostgreSQL Servers with SnapShooter | DigitalOcean Documentation"
---
...
On the jobs creation page, click **PostgreSQL Databases (All Databases)**. A new section about the job appears at the bottom of the screen. Enter a name for the job, then click **Continue**.

On the **Choose Server** page, under **Own Compute**, click **Use My Servers**. In the **Choose Server** section, select the server you want to back up. If you didn’t add it earlier, you can also connect it from this page.
...
On the **Configure Backup** page, in the **Set Config Variables** section, enter the PostgreSQL username, password, host, and port. Optionally, in the **Scripts** section, you can add any [pre- or post-backup scripts](https://docs.digitalocean.com/products/snapshooter/how-to/add-pre-and-post-backup-scripts/).
...
- [Connect a Server and Storage Provider](https://docs.digitalocean.com/products/snapshooter/how-to/back-up-postgresql-servers/#connect-a-server-and-storage-provider)
- [Create the Backup Job](https://docs.digitalocean.com/products/snapshooter/how-to/back-up-postgresql-servers/#create-the-backup-job)
