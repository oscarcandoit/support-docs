---
url: "https://docs.digitalocean.com/products/uptime/how-to/edit-alerts/"
title: "How to Edit Alerts | DigitalOcean Documentation"
---
...
To edit an Uptime alert, go to the **Active Uptime Alerts** table at the bottom of your Uptime check’s status page.

![screenshot of an alerts list, showing the 'More' menu extended and the 'Edit' option highlighted](https://docs.digitalocean.com/screenshots/uptime/alert-edit.4ceae25197c8bdd81180250ac0c926ed110ce54ba85e25d96a90f2b341811b39.png)

1. Click the drop-down arrow for the alert you want to edit, then select **Edit**.
2. Make changes to the alert. Refer to [How to Create Alerts](https://docs.digitalocean.com/products/uptime/how-to/create-alerts/) for detailed information on the options available.
3. Click the **Submit** button to save your changes.

In this article...

[How to Edit Alerts](https://docs.digitalocean.com/products/uptime/how-to/edit-alerts/)
