---
url: "https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list_resources/"
title: "pydo.byoip_prefixes.list_resources() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [byoip\_prefixes](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list/)
      - [list\_resources()](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list_resources/)
      - [patch()](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/patch/)
...
# pydo.byoip\_prefixes.list\_resources()
...
| --- | --- | --- | --- | --- |
| `byoip_prefix_uuid` | string | True | The unique identifier for the BYOIP Prefix. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/byoipPrefixes_list_resources) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list_resources/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list_resources/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list_resources/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list_resources/#more-information)
