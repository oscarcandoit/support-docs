---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/spec/get/"
title: "doctl apps spec get | DigitalOcean Documentation"
---
...
```shell
doctl apps spec get <app id> [flags]
```

## Description

Use this command to retrieve the latest spec of an app.
...
| Option | Description |
| --- | --- |
| `--deployment` | optional: a deployment ID |
| `--format` | the format to output the spec in; either “yaml” or “json”<br>Default: `yaml` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/get/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/get/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/get/#global-flags)
