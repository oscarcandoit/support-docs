---
url: "https://docs.digitalocean.com/products/databases/mongodb/details/features/"
title: "MongoDB Features | DigitalOcean Documentation"
---
...
- **High availability with automated failover**. In the event of a failure, managed databases with a standby node automatically switch data handling to the standby node to prevent unplanned downtime. [Learn more about high availability for managed databases](https://docs.digitalocean.com/products/databases/#high-availability).
...
[MongoDB Features](https://docs.digitalocean.com/products/databases/mongodb/details/features/)
