...
title: "pydo.databases.install_update() | DigitalOcean Documentation"
---
...
# pydo.databases.install\_update()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_install_update) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/install_update/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/install_update/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/install_update/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/install_update/#more-information)
