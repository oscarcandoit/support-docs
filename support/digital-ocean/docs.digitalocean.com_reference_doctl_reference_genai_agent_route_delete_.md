---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/delete/"
title: "doctl genai agent route delete | DigitalOcean Documentation"
---
    ...
    - [doctl genai](https://docs.digitalocean.com/reference/doctl/reference/genai/)
      - [agent](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/)
        ...
        - [route](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/)
          - [add](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/add/)
          - [delete](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/delete/)
          - [update](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/update/)
...
# doctl genai agent route delete
...
```shell
doctl genai agent route delete [flags]
```
...
```shell
doctl genai agent route delete --parent-agent-id "12345678-1234-1234-1234-123456789012" --child-agent-id "12345678-1234-1234-1234-123456789013"
```
...
| `--force`, `-f` | Force route deletion without confirmation<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/delete/#global-flags)
