---
url: "https://docs.digitalocean.com/support/i-did-not-get-an-email-of-my-droplets-root-password/"
title: "I did not get an email of my Droplet's root password | DigitalOcean Documentation"
---
...
During Droplet creation, you have the option to select a root password. After creation, we do not send this password to the registered email address.

You can reset a Droplet’s root password by following our [How to Reset Droplet Root Passwords](https://docs.digitalocean.com/support/how-do-i-reset-my-droplets-root-password/) tutorial.
...
[I did not get an email of my Droplet's root password](https://docs.digitalocean.com/support/i-did-not-get-an-email-of-my-droplets-root-password/)
