---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list-versions/"
title: "doctl genai agent list-versions | DigitalOcean Documentation"
---
...
# doctl genai agent list-versions
...
```shell
doctl genai agent list-versions [flags]
```
...
The following example retrieves a list of all versions for an Agent with ID `12345678-1234-1234-1234-123456789012` :

```shell
doctl genai agent list-versions 12345678-1234-1234-1234-123456789012
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `AgentUuid`, `CanRollback`, `CreatedAt`, `CreatedByEmail`, `CurrentlyApplied`, `ID`, `ModelName`, `Name`, `VersionHash`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list-versions/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list-versions/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list-versions/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list-versions/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list-versions/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list-versions/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list-versions/#global-flags)
