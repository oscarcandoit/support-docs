---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/image/get/"
title: "doctl compute image get | DigitalOcean Documentation"
---
...
```shell
doctl compute image get <image-id|image-slug> [flags]
```

## Description

Returns the following information about the specified image:
...
The following example retrieves information about an image with the ID `386734086`:

```shell
doctl compute image get 386734086
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/image/get/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/image/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/image/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/image/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/get/#global-flags)
