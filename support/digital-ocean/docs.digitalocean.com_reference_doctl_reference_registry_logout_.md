---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/logout/"
title: "doctl registry logout | DigitalOcean Documentation"
---
...
```shell
doctl registry logout [flags]
```

## Description

This command logs Docker out of the private container registry, revoking access to it.

## Flags

| Option | Description |
| --- | --- |
| `--authorization-server-endpoint` | The endpoint of the OAuth authorization server used to revoke credentials on logout.<br>Default: `https://cloud.digitalocean.com/v1/oauth/revoke` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/logout/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/logout/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/logout/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/logout/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/logout/#global-flags)
