---
url: "https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/php/"
title: "Sample App for PHP | DigitalOcean Documentation"
---
...
The PHP buildpack applies to this sample app. See the [PHP buildpack overview](https://docs.digitalocean.com/products/app-platform/reference/buildpacks/php/) for more information about its configuration options and limitations.

> This content is automatically generated from [https://github.com/digitalocean/sample-php/blob/main/README.md](https://github.com/digitalocean/sample-php/blob/main/README.md).
...
1. Edit `index.php` and change the default message, “Set a message by adding ?message= to the URL”
...
- [Usage](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/php/#usage)
