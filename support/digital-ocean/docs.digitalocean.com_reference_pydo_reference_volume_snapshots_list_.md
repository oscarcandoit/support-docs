---
url: "https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/list/"
title: "pydo.volume_snapshots.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/volumeSnapshots_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/list/#more-information)
