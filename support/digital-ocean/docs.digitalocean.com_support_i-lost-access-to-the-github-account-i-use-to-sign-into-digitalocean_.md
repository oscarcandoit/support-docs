---
url: "https://docs.digitalocean.com/support/i-lost-access-to-the-github-account-i-use-to-sign-into-digitalocean/"
title: "I lost access to the GitHub account I use to sign into DigitalOcean | DigitalOcean Documentation"
---
...
If you have lost access to your GitHub account, first try to restore access by following [GitHub’s account recovery process](https://docs.github.com/en/free-pro-team@latest/github/authenticating-to-github/updating-your-github-access-credentials) or [GitHub’s 2FA credential recovery process](https://docs.github.com/en/free-pro-team@latest/github/authenticating-to-github/recovering-your-account-if-you-lose-your-2fa-credentials).

If you can’t regain access to your GitHub account, [open a support ticket](https://www.digitalocean.com/company/contact/support) using the email associated with your DigitalOcean account and let us know you need to reset your authentication method. We need additional information to verify that you are the account owner, so be prepared with a photo of your government-issued ID (for example, a passport, driver’s license, or military ID). The name on ID in the photo must match the name for the account information that we have on file.
...
[I lost access to the GitHub account I use to sign into DigitalOcean](https://docs.digitalocean.com/support/i-lost-access-to-the-github-account-i-use-to-sign-into-digitalocean/)
