---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/create/"
title: "doctl network byoip-prefix create | DigitalOcean Documentation"
---
...
```shell
doctl network byoip-prefix create [flags]
```
...
Creates a new BYOIP Prefix.
BYOIP Prefixes can be held in the region they were created in on your account.

## Example

The following example creates a byoip prefix in the `nyc1` region:

```shell
doctl network byoip-prefix create --region nyc1 --prefix "10.1.1.1/24" --signature "signature"
```
...
| `--prefix` | The prefix to create |
| `--region` | The region where to create the byoip prefix |
| `--signature` | The signature for the prefix |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/create/#global-flags)
