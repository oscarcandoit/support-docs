---
url: "https://docs.digitalocean.com/platform/teams/settings/secure-sign-in/"
title: "Secure Sign-In for DigitalOcean Teams | DigitalOcean Documentation"
---
...
# Secure Sign-In for DigitalOcean Teams

Validated on 14 Aug 2024 • Last edited on 18 Mar 2025

For additional security, owners can [require secure sign-in](https://docs.digitalocean.com/platform/teams/how-to/require-secure-sign-in/) via [Google or GitHub](https://docs.digitalocean.com/platform/accounts/settings/#sign-in-method) or [DigitalOcean two-factor authentication (2FA)](https://docs.digitalocean.com/platform/accounts/2fa/). Owners can see the sign-in method for each person on their team.
...
[Secure Sign-In for DigitalOcean Teams](https://docs.digitalocean.com/platform/teams/settings/secure-sign-in/)
