---
url: "https://docs.digitalocean.com/reference/pydo/reference/nfs/create_action/"
title: "pydo.nfs.create_action() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [nfs](https://docs.digitalocean.com/reference/pydo/reference/nfs/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/nfs/create/)
      - [create\_action()](https://docs.digitalocean.com/reference/pydo/reference/nfs/create_action/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/nfs/delete/)
      - [delete\_snapshot()](https://docs.digitalocean.com/reference/pydo/reference/nfs/delete_snapshot/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/nfs/get/)
      - [get\_snapshot()](https://docs.digitalocean.com/reference/pydo/reference/nfs/get_snapshot/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/nfs/list/)
      - [list\_snapshot()](https://docs.digitalocean.com/reference/pydo/reference/nfs/list_snapshot/)
...
| Action | Details |
| --- | --- |
| `resize` | Resizes an NFS share. Set the size\_gib attribute to a desired value in GiB |
| `snapshot` | Takes a snapshot of an NFS share |
| `attach` | Attaches an NFS share to a VPC. Set the vpc\_id attribute to the desired VPC ID |
| `detach` | Detaches an NFS share from a VPC. Set the vpc\_id attribute to the desired VPC ID |

## Parameters

| Name | Type | Required | Description | Default Value |
| --- | --- | --- | --- | --- |
| `nfs_id` | string | True | The unique ID of the NFS share |  |
| `body` | JSON or IO\[bytes\] | True | The `type` attribute set in the request body will specify the action that |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/nfs_create_action) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/nfs/create_action/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/nfs/create_action/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/nfs/create_action/#more-information)
