---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_run_prompt_results/"
title: "pydo.genai.get_evaluation_run_prompt_results() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- get\_evaluation\_run\_prompt\_results()
...
| --- | --- | --- | --- | --- |
| `evaluation_run_uuid` | string | True | Evaluation run UUID. |  |
| `prompt_id` | integer | True | Prompt ID to get results for. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_get_evaluation_run_prompt_results) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_run_prompt_results/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_run_prompt_results/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_run_prompt_results/#more-information)
