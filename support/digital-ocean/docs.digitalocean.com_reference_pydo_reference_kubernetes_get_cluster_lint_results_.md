---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_lint_results/"
title: "pydo.kubernetes.get_cluster_lint_results() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_get_clusterLintResults) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_lint_results/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_lint_results/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_lint_results/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_lint_results/#more-information)
