---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/delete/"
title: "doctl compute reserved-ip delete | DigitalOcean Documentation"
---
...
Permanently deletes a reserved IP address. This is irreversible.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes the reserved IP address without confirmation<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/delete/#global-flags)
