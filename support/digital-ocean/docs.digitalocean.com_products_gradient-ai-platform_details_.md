---
url: "https://docs.digitalocean.com/products/gradient-ai-platform/details/"
title: "DigitalOcean Gradient™ AI Platform Details | DigitalOcean Documentation"
---
...
# DigitalOcean Gradient™ AI Platform Details
...
We offer a variety of features and components within Gradient AI Platform to enhance your experience when creating an agent, like agent routing, models, the model and agent playground, and more.

![](https://docs.digitalocean.com/images/icons/gradient-ai-platform.svg)

DigitalOcean Gradient™ AI Platform Pricing

Gradient AI Platform charges based on the models you use, their usage, and additional features such as knowledge bases, guardrails, and evaluations.

![](https://docs.digitalocean.com/images/icons/gradient-ai-platform.svg)

DigitalOcean Gradient™ AI Platform Availability

Regional datacenter availability for Gradient AI Platform.

![](https://docs.digitalocean.com/images/icons/gradient-ai-platform.svg)

DigitalOcean Gradient™ AI Platform Limits

Limits and known issues for Gradient AI Platform.
...
A list of the foundation and embedding models available for Gradient AI Platform.

![](https://docs.digitalocean.com/images/icons/gradient-ai-platform.svg)

DigitalOcean Gradient™ AI Data Privacy

Information about the data we collect when using DigitalOcean Gradient™ AI Platform.

In this article...

- [More Details](https://docs.digitalocean.com/products/gradient-ai-platform/details/#more-details)
