---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/delete_logsink/"
title: "pydo.databases.delete_logsink() | DigitalOcean Documentation"
---
...
# pydo.databases.delete\_logsink()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_delete_logsink) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_logsink/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_logsink/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_logsink/#more-information)
