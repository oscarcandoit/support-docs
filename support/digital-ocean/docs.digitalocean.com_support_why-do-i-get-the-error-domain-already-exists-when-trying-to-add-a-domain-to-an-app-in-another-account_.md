---
url: "https://docs.digitalocean.com/support/why-do-i-get-the-error-domain-already-exists-when-trying-to-add-a-domain-to-an-app-in-another-account/"
title: "Why do I get the error \"Domain Already Exists\" when trying to add a domain to an app in another account? | DigitalOcean Documentation"
---
...
Validated on 24 Sep 2025 • Last edited on 7 Oct 2025

You cannot add the same domain name to multiple App Platform apps, even if they belong to separate DigitalOcean accounts. Similarly, you must have the app and its desired domain name in the same account for them to work.
...
[Why do I get the error "Domain Already Exists" when trying to add a domain to an app in another account?](https://docs.digitalocean.com/support/why-do-i-get-the-error-domain-already-exists-when-trying-to-add-a-domain-to-an-app-in-another-account/)
