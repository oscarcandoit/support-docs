---
url: "https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/"
title: "PyTorch (ROCm7) | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/)
...
from [the PyTorch (ROCm7) catalog page](https://marketplace.digitalocean.com/apps/pytorch-rocm7)
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=amd-pytorchrocm7)

## Creating an App using the API

In addition to creating a Droplet from the PyTorch (ROCm7) 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB PyTorch (ROCm7) Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"amd-pytorchrocm7"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying PyTorch (ROCm7)
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#creating-an-app-using-the-api)
- [Getting Started After Deploying PyTorch (ROCm7)](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#getting-started-after-deploying-pytorch-rocm7)
- [Accessing ROCm + PyTorch](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#accessing-rocm--pytorch)
  - [Approach A: SSH](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#approach-a-ssh)
  - [Approach B: JupyterLab](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#approach-b-jupyterlab)
  - [Jupyter AI](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#jupyter-ai)
- [Before You Deploy](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#before-you-deploy)
- [Quickly Get Started With Your Jupyter Droplet](https://docs.digitalocean.com/products/marketplace/catalog/pytorch-rocm7/#quickly-get-started-with-your-jupyter-droplet)
