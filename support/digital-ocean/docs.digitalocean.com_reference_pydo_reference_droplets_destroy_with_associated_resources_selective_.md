---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_selective/"
title: "pydo.droplets.destroy_with_associated_resources_selective() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [droplets](https://docs.digitalocean.com/reference/pydo/reference/droplets/)
- destroy\_with\_associated\_resources\_selective()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.droplets.destroy\_with\_associated\_resources\_selective()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_destroy_withAssociatedResourcesSelective) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_selective/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_selective/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_selective/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_selective/#more-information)
