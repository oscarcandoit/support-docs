---
url: "https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/list/"
title: "pydo.ssh_keys.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [ssh\_keys](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/list/)
      - [update()](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/update/)
...
To list all of the keys in your account, send a GET request to `/v2/account/keys`. The response will be a JSON object with a key set to `ssh_keys`. The value of this will be an array of ssh\_key objects, each of which contains the standard ssh\_key attributes.
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/sshKeys_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/list/#more-information)
