---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/delete/"
title: "doctl compute certificate delete | DigitalOcean Documentation"
---
...
```shell
doctl compute certificate delete <id> [flags]
```
...
The following example deletes the certificate with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl compute certificate delete f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete the certificate without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/delete/#global-flags)
