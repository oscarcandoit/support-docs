---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_autoscale/"
title: "pydo.databases.update_autoscale() | DigitalOcean Documentation"
---
...
# pydo.databases.update\_autoscale()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_autoscale) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_autoscale/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_autoscale/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/update_autoscale/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_autoscale/#more-information)
