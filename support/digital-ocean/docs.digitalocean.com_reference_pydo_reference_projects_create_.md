---
url: "https://docs.digitalocean.com/reference/pydo/reference/projects/create/"
title: "pydo.projects.create() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/projects_create) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/projects/create/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/projects/create/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/projects/create/#more-information)
