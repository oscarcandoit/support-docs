---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/update/"
title: "doctl compute vpc-nat-gateway update | DigitalOcean Documentation"
---
...
# doctl compute vpc-nat-gateway update
...
```shell
doctl compute vpc-nat-gateway update <gateway-id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/update/#aliases)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/vpc-nat-gateway/update/#global-flags)
