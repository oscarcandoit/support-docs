---
url: "https://docs.digitalocean.com/support/how-do-i-manually-back-up-my-droplet/"
title: "How do I manually back up my Droplet? | DigitalOcean Documentation"
---
...
Validated on 5 Jun 2024 • Last edited on 1 Oct 2025
...
A [DigitalOcean Snapshot](https://docs.digitalocean.com/products/snapshots/) is an on-demand full disk image of a Droplet. When you [snapshot a Droplet](https://docs.digitalocean.com/products/snapshots/getting-started/quickstart/), the image is saved to your account and remains there until you delete it. You can use snapshots to restore an existing Droplet or create a new Droplet from that point in time.

## Convert Automatic DigitalOcean Backups into Snapshots

When you [enable backups](https://docs.digitalocean.com/products/backups/how-to/enable/) on a Droplet, we automatically create a full disk image of the Droplet either weekly or daily, depending on your choice. Like snapshots, backup images are saved to your account, and you can use backups to restore an existing Droplet or create new Droplets from that point in time.

Unlike snapshots, backup images remain in your team temporarily. We retain weekly backups for four weeks, daily backups for seven days, and usage-based backups for a custom amount of time. To keep a backup indefinitely, [convert the backup into a snapshot](https://docs.digitalocean.com/products/backups/how-to/convert-to-snapshot/).

## Use Third-Party Tools for Partial Backups

To back up part of a Droplet, such as its configuration or data, we recommend [SnapShooter](https://docs.digitalocean.com/products/snapshooter/). You can also use third-party tools like [rsync](https://www.digitalocean.com/community/tutorials/how-to-use-rsync-to-sync-local-and-remote-directories-on-a-vps) or [SFTP](https://www.digitalocean.com/community/tutorials/how-to-use-filezilla-to-transfer-and-manage-files-securely-on-your-vps).
...
- [Use DigitalOcean Snapshots for Full System Backups](https://docs.digitalocean.com/support/how-do-i-manually-back-up-my-droplet/#use-digitalocean-snapshots-for-full-system-backups)
- [Convert Automatic DigitalOcean Backups into Snapshots](https://docs.digitalocean.com/support/how-do-i-manually-back-up-my-droplet/#convert-automatic-digitalocean-backups-into-snapshots)
- [Use Third-Party Tools for Partial Backups](https://docs.digitalocean.com/support/how-do-i-manually-back-up-my-droplet/#use-third-party-tools-for-partial-backups)
