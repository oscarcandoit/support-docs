---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-tag/"
title: "doctl registries repository delete-tag | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl registries](https://docs.digitalocean.com/reference/doctl/reference/registries/)
      ...
      - [repository](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/)
        - [delete-manifest](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-manifest/)
        - [delete-tag](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-tag/)
        - [list-manifests](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-manifests/)
        - [list-tags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-tags/)
        - [list-v2](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-v2/)
...
# doctl registries repository delete-tag
...
```shell
doctl registries repository delete-tag <registry-name> <repository> <tag>... [flags]
```
...
```shell
doctl registries repository delete-tag example-registry example-repository web
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-tag/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-tag/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-tag/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-tag/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-tag/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-tag/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-tag/#global-flags)
