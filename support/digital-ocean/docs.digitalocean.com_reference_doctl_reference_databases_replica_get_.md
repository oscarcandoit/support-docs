---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/replica/get/"
title: "doctl databases replica get | DigitalOcean Documentation"
---
...
```shell
doctl databases replica get <database-cluster-id> <replica-name> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/get/#global-flags)
