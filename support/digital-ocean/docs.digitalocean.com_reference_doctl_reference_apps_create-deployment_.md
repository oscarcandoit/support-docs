---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/create-deployment/"
title: "doctl apps create-deployment | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--force-rebuild` | Force a re-build even if a previous build is eligible for reuse.<br>Default: `false` |
...
| `--wait` | Boolean that specifies whether to wait for the deployment to complete before allowing further terminal input. This can be helpful for scripting.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/create-deployment/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/create-deployment/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/create-deployment/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/create-deployment/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/create-deployment/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/create-deployment/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/create-deployment/#global-flags)
