---
url: "https://docs.digitalocean.com/support/why-is-my-droplet-receiving-authoritative-answer-flag-errors/"
title: "Why is my Droplet receiving Authoritative Answer flag errors? | DigitalOcean Documentation"
---
...
Validated on 19 Aug 2021 • Last edited on 1 Aug 2024
...
This means that if your Droplet makes a DNS query for a hostname and the response from the hostname’s DNS name server doesn’t include the AA flag, our recursive server drops the response and your Droplet cannot resolve the hostname. This can cause connection issues to hostnames whose DNS records are hosted by providers that have not implemented the AA flag.
...
You can check to see if a domain is not using the AA flag in its response by using the [DNS Viz tool](https://dnsviz.net/). If you enter a hostname into the search field and receive an error similar to this, the hostname’s DNS provider has not implemented the AA flag in its responses:
...
Hostnames are usually owned by whoever registered the domain name you are trying to query. If you do not have a direct relationship with a domain owner, you can use [ICANN’s website to lookup the contact information](https://lookup.icann.org/) for the domain.
...
- [Check the Hostname](https://docs.digitalocean.com/support/why-is-my-droplet-receiving-authoritative-answer-flag-errors/#check-the-hostname)
- [Solutions](https://docs.digitalocean.com/support/why-is-my-droplet-receiving-authoritative-answer-flag-errors/#solutions)
  - [I own the hostname](https://docs.digitalocean.com/support/why-is-my-droplet-receiving-authoritative-answer-flag-errors/#i-own-the-hostname)
  - [I don’t own the hostname](https://docs.digitalocean.com/support/why-is-my-droplet-receiving-authoritative-answer-flag-errors/#i-dont-own-the-hostname)
- [Conclusion](https://docs.digitalocean.com/support/why-is-my-droplet-receiving-authoritative-answer-flag-errors/#conclusion)
