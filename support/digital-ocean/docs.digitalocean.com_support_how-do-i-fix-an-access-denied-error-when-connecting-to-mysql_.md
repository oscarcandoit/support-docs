---
url: "https://docs.digitalocean.com/support/how-do-i-fix-an-access-denied-error-when-connecting-to-mysql/"
title: "How do I fix an \"Access Denied\" error when connecting to MySQL? | DigitalOcean Documentation"
---
...
- Ensure the user has the correct privileges on the database you want to connect to.
  - To change user privileges, see [Privileges Provided by MySQL](https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html).
...
[How do I fix an "Access Denied" error when connecting to MySQL?](https://docs.digitalocean.com/support/how-do-i-fix-an-access-denied-error-when-connecting-to-mysql/)
