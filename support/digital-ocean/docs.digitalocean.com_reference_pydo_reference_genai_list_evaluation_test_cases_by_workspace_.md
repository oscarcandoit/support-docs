---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_test_cases_by_workspace/"
title: "pydo.genai.list_evaluation_test_cases_by_workspace() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- list\_evaluation\_test\_cases\_by\_workspace()
...
| --- | --- | --- | --- | --- |
| `workspace_uuid` | string | True | Workspace UUID. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_evaluation_test_cases_by_workspace) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_test_cases_by_workspace/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_test_cases_by_workspace/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_test_cases_by_workspace/#more-information)
