---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_test_case/"
title: "pydo.genai.get_evaluation_test_case() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `test_case_uuid` | string | True | The test case uuid to retrieve. |  |
| `evaluation_test_case_version` | integer | False | Version of the test case. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_get_evaluation_test_case) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_test_case/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_test_case/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_test_case/#more-information)
