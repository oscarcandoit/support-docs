---
url: "https://docs.digitalocean.com/reference/pydo/reference/projects/list/"
title: "pydo.projects.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/projects_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/projects/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/projects/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/projects/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/projects/list/#more-information)
