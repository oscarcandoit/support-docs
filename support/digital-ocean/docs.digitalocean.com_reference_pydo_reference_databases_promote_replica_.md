---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/promote_replica/"
title: "pydo.databases.promote_replica() | DigitalOcean Documentation"
---
...
# pydo.databases.promote\_replica()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_promote_replica) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/promote_replica/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/promote_replica/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/promote_replica/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/promote_replica/#more-information)
