---
url: "https://docs.digitalocean.com/reference/pydo/reference/functions/delete_trigger/"
title: "pydo.functions.delete_trigger() | DigitalOcean Documentation"
---
...
# pydo.functions.delete\_trigger()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/functions_delete_trigger) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_trigger/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_trigger/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_trigger/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/functions/delete_trigger/#more-information)
