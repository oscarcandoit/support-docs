---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/image/update/"
title: "doctl compute image update | DigitalOcean Documentation"
---
...
```shell
doctl compute image update <image-id> [flags]
```

## Description

Updates an image’s metadata, including its name, description, and distribution.

## Example

The following example updates the name of an image with the ID `386734086` to `New Image Name`:

```shell
doctl compute image update 386734086 --name "Example Image Name"
```
...
| `--image-name` | The name of the image to update (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/image/update/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/image/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/image/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/image/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/update/#global-flags)
