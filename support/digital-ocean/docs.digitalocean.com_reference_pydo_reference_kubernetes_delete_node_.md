---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node/"
title: "pydo.kubernetes.delete_node() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [kubernetes](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/)
      - [add\_node\_pool()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/add_node_pool/)
      - [add\_registries()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/add_registries/)
      - [add\_registry()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/add_registry/)
      - [create\_cluster()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/create_cluster/)
      - [delete\_cluster()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_cluster/)
      - [delete\_node()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node/)
      - [delete\_node\_pool()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node_pool/)
      - [destroy\_associated\_resources\_dangerous()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_dangerous/)
      - [destroy\_associated\_resources\_selective()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_selective/)
      - [get\_available\_upgrades()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_available_upgrades/)
      - [get\_cluster()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster/)
      - [get\_cluster\_lint\_results()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_lint_results/)
      - [get\_cluster\_user()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_user/)
      - [get\_credentials()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_credentials/)
      - [get\_kubeconfig()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_kubeconfig/)
      - [get\_node\_pool()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_node_pool/)
      - [get\_status\_messages()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_status_messages/)
      - [list\_associated\_resources()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_associated_resources/)
      - [list\_clusters()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_clusters/)
      - [list\_node\_pools()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_node_pools/)
      - [list\_options()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_options/)
      - [recycle\_node\_pool()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/recycle_node_pool/)
      - [remove\_registries()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/remove_registries/)
      - [remove\_registry()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/remove_registry/)
      - [run\_cluster\_lint()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/run_cluster_lint/)
      - [update\_cluster()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/update_cluster/)
      - [update\_node\_pool()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/update_node_pool/)
      - [upgrade\_cluster()](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/upgrade_cluster/)
...
| `node_id` | string | True | A unique ID that can be used to reference a node in a Kubernetes node pool. |  |
| `skip_drain` | integer | False | Specifies whether or not to drain workloads from a node before it is deleted. Setting it to `1` causes node draining to be skipped. Omitting the query parameter or setting its value to `0` carries out draining prior to deletion. | 0 |
| `replace` | integer | False | Specifies whether or not to replace a node after it has been deleted. Setting it to `1` causes the node to be replaced by a new one after deletion. Omitting the query parameter or setting its value to `0` deletes without replacement. | 0 |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_delete_node) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node/#more-information)
