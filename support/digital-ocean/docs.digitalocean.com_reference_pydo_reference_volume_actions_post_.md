---
url: "https://docs.digitalocean.com/reference/pydo/reference/volume_actions/post/"
title: "pydo.volume_actions.post() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [volume\_actions](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/list/)
      - [post()](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/post/)
      - [post\_by\_id()](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/post_by_id/)
...
| volume\_name | The name of the block storage volume |
| droplet\_id | Set to the Droplet’s ID |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/volumeActions_post) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/post/#description)
- [Attach a Block Storage Volume to a Droplet](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/post/#attach-a-block-storage-volume-to-a-droplet)
- [Remove a Block Storage Volume from a Droplet](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/post/#remove-a-block-storage-volume-from-a-droplet)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/post/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/post/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/post/#more-information)
