---
url: "https://docs.digitalocean.com/reference/pydo/reference/cdn/purge_cache/"
title: "pydo.cdn.purge_cache() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/cdn_purge_cache) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/cdn/purge_cache/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/cdn/purge_cache/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/cdn/purge_cache/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/cdn/purge_cache/#more-information)
