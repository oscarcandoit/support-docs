---
url: "https://docs.digitalocean.com/products/kubernetes/how-to/add-node-pools/"
title: "How to Add Node Pools to a Cluster | DigitalOcean Documentation"
---
...
You can also add a [GPU node pool](https://docs.digitalocean.com/products/kubernetes/details/supported-gpus/) to an existing cluster on versions 1.30.4-do.0, 1.29.8-do.0, 1.28.13-do.0, and later.
...
In this article...\
\
- [Add a Node Pool to a Cluster Using Automation](https://docs.digitalocean.com/products/kubernetes/how-to/add-node-pools/#add-a-node-pool-to-a-cluster-using-automation)\
  - [Add a GPU Worker Node to a Cluster](https://docs.digitalocean.com/products/kubernetes/how-to/add-node-pools/#add-a-gpu-worker-node-to-a-cluster)\
- [Add a Node Pool to a Cluster Using the Control Panel](https://docs.digitalocean.com/products/kubernetes/how-to/add-node-pools/#add-a-node-pool-to-a-cluster-using-the-control-panel)\
\
##### Company\
\
