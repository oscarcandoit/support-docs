---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/image/create/"
title: "doctl compute image create | DigitalOcean Documentation"
---
...
| `--image-distribution` | A custom image distribution slug to apply to the image<br>Default: `Unknown` |
| `--image-url` | The URL to retrieve the image from (required) |
| `--region` | The `slug` of the region you want to store the image in. For a list of region slugs, use the `doctl compute region list` command. (required) |
| `--tag-names` | A list of tag names to apply to the image |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/image/create/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/image/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/image/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/image/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/create/#global-flags)
