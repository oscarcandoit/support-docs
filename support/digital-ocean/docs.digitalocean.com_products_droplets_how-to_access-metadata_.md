---
url: "https://docs.digitalocean.com/products/droplets/how-to/access-metadata/"
title: "How to Access Information about a Droplet using the Metadata API | DigitalOcean Documentation"
---
...
[Metadata](https://docs.digitalocean.com/reference/api/metadata/) is a DigitalOcean service that allows a Droplet to access data about itself.
...
Full documentation of the metadata service and its endpoints are available in the [Droplet metadata API reference](https://docs.digitalocean.com/reference/api/metadata/).

In this article...

- [Access Droplet Metadata](https://docs.digitalocean.com/products/droplets/how-to/access-metadata/#access-droplet-metadata)
