---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/list/"
title: "doctl kubernetes cluster node-pool list | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/list/#global-flags)
