---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/update/"
title: "doctl genai agent apikeys update | DigitalOcean Documentation"
---
    ...
    - [doctl genai](https://docs.digitalocean.com/reference/doctl/reference/genai/)
      - [agent](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/)
        - [apikeys](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/)
          - [create](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/create/)
          - [delete](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/delete/)
          - [list](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/list/)
          - [regenerate](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/regenerate/)
          - [update](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/update/)
...
```shell
doctl genai agent apikeys update <apikey-id> [flags]
```
...
The following example updates the name of an api-key with the ID `12345678-1234-1234-1234-123456789012for an agent with the ID`12345678-1234-1234-1234-123456789013`to`new-name\`:
...
| Option | Description |
| --- | --- |
| `--agent-id` | The ID of the agent for which to update the API Key |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/update/#global-flags)
