---
url: "https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/list/"
title: "pydo.vpcnatgateways.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [vpcnatgateways](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/list/)
      - [update()](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/update/)
...
| `state` | string | False | The current state of the VPC NAT gateway. |  |
| `region` | string | False | The region where the VPC NAT gateway is located. |  |
| `type` | string | False | The type of the VPC NAT gateway. |  |
| `name` | string | False | The name of the VPC NAT gateway. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/vpcnatgateways_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/list/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/list/#more-information)
