---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/list/"
title: "doctl databases indexes list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl databases](https://docs.digitalocean.com/reference/doctl/reference/databases/)
      ...
      - [indexes](https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/delete/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/list/)
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Index Name`, `Status`, `Health`, `Size`, `Docs`, `Create At`, `Number of Shards`, `Number of Replica`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/list/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/indexes/list/#global-flags)
