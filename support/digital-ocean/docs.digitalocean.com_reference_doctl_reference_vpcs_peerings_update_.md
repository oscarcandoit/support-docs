---
url: "https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/update/"
title: "doctl vpcs peerings update | DigitalOcean Documentation"
---
...
```shell
doctl vpcs peerings update <peering-id> [flags]
```
...
| `--name` | The VPC Peering’s name (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/update/#global-flags)
