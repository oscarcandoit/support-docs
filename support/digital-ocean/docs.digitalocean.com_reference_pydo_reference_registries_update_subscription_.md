---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/update_subscription/"
title: "pydo.registries.update_subscription() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_update_subscription) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/update_subscription/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/update_subscription/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/update_subscription/#more-information)
