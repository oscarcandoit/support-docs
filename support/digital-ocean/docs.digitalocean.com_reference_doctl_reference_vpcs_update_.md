---
url: "https://docs.digitalocean.com/reference/doctl/reference/vpcs/update/"
title: "doctl vpcs update | DigitalOcean Documentation"
---
...
```shell
doctl vpcs update <vpc-id> [flags]
```
...
Updates a VPC network’s configuration. You can update its name, description, and default state.

## Example

The following example updates the name of a VPC network with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6` to `new-name`:

```shell
doctl vpcs update f81d4fae-7dec-11d0-a765-00a0c91e6bf6 --name new-name --default=true
```
...
| Option | Description |
| --- | --- |
| `--default` | A boolean value indicating whether or not the VPC network is the default one for the region<br>Default: `false` |
| `--description` | The VPC network’s description |
| `--help`, `-h` | Help for this command |
| `--name` | The VPC network’s name |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/vpcs/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/vpcs/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/vpcs/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/vpcs/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/vpcs/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/update/#global-flags)
