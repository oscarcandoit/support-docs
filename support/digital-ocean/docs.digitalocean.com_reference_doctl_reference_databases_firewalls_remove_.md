---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/remove/"
title: "doctl databases firewalls remove | DigitalOcean Documentation"
---
...
The following example removes a firewall rule with the UUID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6` from a database cluster with the ID `ca9f591d-f38h-5555-a0ef-1c02d1d1e35`:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/remove/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/remove/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/remove/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/remove/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/remove/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/remove/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/remove/#global-flags)
