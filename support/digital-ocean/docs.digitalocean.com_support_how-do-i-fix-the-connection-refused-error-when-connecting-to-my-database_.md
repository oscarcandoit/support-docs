---
url: "https://docs.digitalocean.com/support/how-do-i-fix-the-connection-refused-error-when-connecting-to-my-database/"
title: "How do I fix the \"Connection Refused\" error when connecting to my database? | DigitalOcean Documentation"
---
...
- Check that the port is correct in the connection string.
- Check that you have added the machine or resource you are connecting from to the database’s list of trusted sources. To check your database’s trusted sources, see the following guides for [PostgreSQL](https://docs.digitalocean.com/products/databases/postgresql/how-to/secure/#firewalls), [MySQL](https://docs.digitalocean.com/products/databases/mysql/how-to/secure/#firewalls), [Redis](https://docs.digitalocean.com/products/databases/redis/how-to/secure/#firewalls), [MongoDB](https://docs.digitalocean.com/products/databases/mongodb/how-to/secure/#firewalls), [Kafka](https://docs.digitalocean.com/products/databases/kafka/how-to/secure/#firewalls), and [OpenSearch](https://docs.digitalocean.com/products/databases/opensearch/how-to/secure/#firewalls).
...
- If you’re using the database’s private IP address, connect from a Droplet that meets the following criteria:
  ...
  - The Droplet resides in the same VPC network as the target Droplet. To check VPC networks, see the following guides for [PostgreSQL](https://docs.digitalocean.com/products/databases/postgresql/how-to/secure/#firewalls), [MySQL](https://docs.digitalocean.com/products/databases/mysql/how-to/secure/#firewalls), [Redis](https://docs.digitalocean.com/products/databases/redis/how-to/secure/#firewalls), [MongoDB](https://docs.digitalocean.com/products/databases/mongodb/how-to/secure/#firewalls), [Kafka](https://docs.digitalocean.com/products/databases/kafka/how-to/secure/#firewalls), and [OpenSearch](https://docs.digitalocean.com/products/databases/opensearch/how-to/secure/#firewalls).
...
- [Connection Refused (Hostname)](https://docs.digitalocean.com/support/how-do-i-fix-the-connection-refused-error-when-connecting-to-my-database/#connection-refused-hostname)
- [Connection Refused (IP Address)](https://docs.digitalocean.com/support/how-do-i-fix-the-connection-refused-error-when-connecting-to-my-database/#connection-refused-ip-address)
