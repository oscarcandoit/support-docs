---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-v2/"
title: "doctl registries repository list-v2 | DigitalOcean Documentation"
---
...
# doctl registries repository list-v2
...
```shell
doctl registries repository list-v2 <registry-name> [flags]
```
...
```shell
doctl registries repository list-v2 example-registry --format Name,UpdatedAt
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-v2/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-v2/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-v2/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-v2/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-v2/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-v2/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-v2/#global-flags)
