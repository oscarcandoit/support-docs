---
url: "https://docs.digitalocean.com/support/can-i-resize-a-doks-node/"
title: "Can I resize a DOKS node? | DigitalOcean Documentation"
---
...
Validated on 2 Feb 2021 • Last edited on 6 Sep 2023
...
To increase the amount of resources your nodes have, you need to [create a new node pool](https://docs.digitalocean.com/products/kubernetes/getting-started/quickstart/#edit-nodes-and-node-pools-for-an-existing-cluster) of the desired size. After you have created the new node pool and it displays a ‘Ready’ status, delete the older smaller node pool. This causes the workloads on the old node pool to get rescheduled on the new larger nodes.

This does not incur downtime as long as your applications are deployed in a highly available manner with multiple [replicas](https://docs.digitalocean.com/products/kubernetes/concepts/best-practices/#use-replicas-instead-of-bare-pods) and [appropriately sized nodes](https://docs.digitalocean.com/products/kubernetes/concepts/best-practices/#size-nodes-pools-for-high-availability).
...
[Can I resize a DOKS node?](https://docs.digitalocean.com/support/can-i-resize-a-doks-node/)
