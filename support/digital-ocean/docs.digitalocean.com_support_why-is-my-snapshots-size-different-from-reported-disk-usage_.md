---
url: "https://docs.digitalocean.com/support/why-is-my-snapshots-size-different-from-reported-disk-usage/"
title: "Why is my snapshot's size different from reported disk usage? | DigitalOcean Documentation"
---
...
You can trim or discard unused blocks to make volume snapshots smaller and therefore less expensive. [Configuring periodic `fstrim`](https://www.digitalocean.com/community/tutorials/how-to-configure-periodic-trim-for-ssd-storage-on-linux-servers). You can also mount volumes with the discard option, which helps ensure that the block storage system knows which blocks are used and which are not.
...
[Why is my snapshot's size different from reported disk usage?](https://docs.digitalocean.com/support/why-is-my-snapshots-size-different-from-reported-disk-usage/)
