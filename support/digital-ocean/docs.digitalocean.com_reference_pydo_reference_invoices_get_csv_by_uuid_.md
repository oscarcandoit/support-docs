---
url: "https://docs.digitalocean.com/reference/pydo/reference/invoices/get_csv_by_uuid/"
title: "pydo.invoices.get_csv_by_uuid() | DigitalOcean Documentation"
---
...
# pydo.invoices.get\_csv\_by\_uuid()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/invoices_get_csvByUUID) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_csv_by_uuid/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_csv_by_uuid/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_csv_by_uuid/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_csv_by_uuid/#more-information)
