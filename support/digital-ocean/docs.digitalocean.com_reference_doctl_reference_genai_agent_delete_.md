---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/delete/"
title: "doctl genai agent delete | DigitalOcean Documentation"
---
...
```shell
doctl genai agent delete <agent-id> [flags]
```
...
The following example deletes an agent with the ID `12345678-1234-1234-1234-123456789012`:

```shell
doctl genai agent delete 12345678-1234-1234-1234-123456789012
```
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes the Agent without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/delete/#global-flags)
