---
url: "https://docs.digitalocean.com/products/snapshooter/how-to/back-up-mysql-servers/"
title: "How to Back Up MySQL Servers with SnapShooter | DigitalOcean Documentation"
---
...
On the jobs creation page, click **MySQL All Databases**. A new section about the job appears at the bottom of the screen. Enter a name for the job, then click **Continue**.
...
On the **Configure Backup** page, in the **Set Config Variables** section, enter the MySQL username, password, host, and port. Optionally, in the **Scripts** section, you can add any [pre- or post-backup scripts](https://docs.digitalocean.com/products/snapshooter/how-to/add-pre-and-post-backup-scripts/).
...
- [Connect a Server and Storage Provider](https://docs.digitalocean.com/products/snapshooter/how-to/back-up-mysql-servers/#connect-a-server-and-storage-provider)
- [Create the Backup Job](https://docs.digitalocean.com/products/snapshooter/how-to/back-up-mysql-servers/#create-the-backup-job)
