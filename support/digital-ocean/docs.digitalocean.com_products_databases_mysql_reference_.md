---
url: "https://docs.digitalocean.com/products/databases/mysql/reference/"
title: "MySQL Reference | DigitalOcean Documentation"
---
...
- The [MySQL documentation](https://dev.mysql.com/doc/refman/8.0/en/)

- The [`mysql` command-line client documentation](https://dev.mysql.com/doc/refman/8.0/en/mysql.html)

- The [`mysqlsh` command-line client documentation](https://dev.mysql.com/doc/mysql-shell/8.0/en/mysql-shell-commands.html)


In this article...

- [The DigitalOcean API](https://docs.digitalocean.com/products/databases/mysql/reference/#the-digitalocean-api)
- [The DigitalOcean Command Line Client, doctl](https://docs.digitalocean.com/products/databases/mysql/reference/#the-digitalocean-command-line-client-doctl)
- [Official MySQL Documentation](https://docs.digitalocean.com/products/databases/mysql/reference/#official-mysql-documentation)
