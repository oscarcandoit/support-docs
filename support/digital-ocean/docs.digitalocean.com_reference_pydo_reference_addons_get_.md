---
url: "https://docs.digitalocean.com/reference/pydo/reference/addons/get/"
title: "pydo.addons.get() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `resource_uuid` | string | True | The UUID of the add-on resource to retrieve. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/addons_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/addons/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/addons/get/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/addons/get/#more-information)
