---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/migrate/"
title: "doctl databases migrate | DigitalOcean Documentation"
---
...
| `--private-network-uuid` | The UUID of a VPC network to create the database cluster in. The command uses the region’s default VPC network if not specified. |
| `--region` | The region to which the database cluster should be migrated, such as `sfo2` or `nyc3`. (required) |
| `--wait` | A boolean value that specifies whether to wait for the database migration to complete before returning control to the terminal.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/migrate/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/migrate/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/migrate/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/migrate/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/migrate/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/migrate/#global-flags)
