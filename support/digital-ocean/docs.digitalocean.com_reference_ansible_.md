---
url: "https://docs.digitalocean.com/reference/ansible/"
title: "Ansible | DigitalOcean Documentation"
---
...
DigitalOcean maintains an Ansible collection, [`digitalocean.cloud`](https://github.com/digitalocean/ansible-collection/), that you can use to manage DigitalOcean infrastructure.
...
A complete reference for digitalocean.cloud, the DigitalOcean Ansible Collection
...
A Community tutorial series covering the installation and use of Ansible.

digitalocean.com/community![](https://docs.digitalocean.com/images/icons/community.svg)

How to Use Ansible: A Reference Guide

This cheat sheet-style guide provides a quick reference to commands and practices commonly used when working with Ansible.

digitalocean.com/community

In this article...

- [Getting Started](https://docs.digitalocean.com/reference/ansible/#getting-started)
- [Resources](https://docs.digitalocean.com/reference/ansible/#resources)
