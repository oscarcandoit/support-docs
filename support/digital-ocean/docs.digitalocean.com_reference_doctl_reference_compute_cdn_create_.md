---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/create/"
title: "doctl compute cdn create | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [cdn](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/delete/)
        - [flush](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/flush/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/list/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/update/)
...
The following example creates a CDN for the custom domain `cdn.example.com` using a DigitalOcean Spaces origin endpoint and SSL certificate ID for the custom domain:

```shell
doctl compute cdn create https://tester-two.blr1.digitaloceanspaces.com --domain cdn.example.com --certificate-id f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
| `--ttl` | The “Time To Live” (TTL) value for cached content, in seconds<br>Default: `3600` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/create/#global-flags)
