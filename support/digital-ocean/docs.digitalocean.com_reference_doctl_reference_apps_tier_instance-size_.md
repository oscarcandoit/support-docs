---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/"
title: "doctl apps tier instance-size | DigitalOcean Documentation"
---
...
The subcommands of `doctl app tier instance-size` retrieve information about app instance sizes.
...
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/#global-flags)
