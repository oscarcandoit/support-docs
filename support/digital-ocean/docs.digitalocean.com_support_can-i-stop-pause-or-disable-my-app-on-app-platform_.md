---
url: "https://docs.digitalocean.com/support/can-i-stop-pause-or-disable-my-app-on-app-platform/"
title: "Can I stop, pause, or disable my app on App Platform? | DigitalOcean Documentation"
---
...
To download the app spec, in the [DigitalOcean Control Panel](https://cloud.digitalocean.com/apps), click the **Settings** tab for the app you want to delete. In the **App Spec** section, click the **Edit** link and click **Download**. Then, [create an app](https://docs.digitalocean.com/products/app-platform/how-to/create-apps/#create-resource-from-source-code-using-the-control-panel) using the DigitalOcean Control Panel and [update the app spec](https://docs.digitalocean.com/products/app-platform/how-to/update-app-spec/) to redeploy that app with the same settings as the deleted one.
...
[Can I stop, pause, or disable my app on App Platform?](https://docs.digitalocean.com/support/can-i-stop-pause-or-disable-my-app-on-app-platform/)
