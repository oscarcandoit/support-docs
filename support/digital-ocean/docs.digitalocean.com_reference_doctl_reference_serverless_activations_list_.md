---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/list/"
title: "doctl serverless activations list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl serverless](https://docs.digitalocean.com/reference/doctl/reference/serverless/)
      - [activations](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/list/)
        - [logs](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/logs/)
        - [result](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/result/)
...
| Option | Description |
| --- | --- |
| `--count` | Return only the total number of activations.<br>Default: `false` |
...
| `--full`, `-f` | Include the full activation description.<br>Default: `false` |
| `--help`, `-h` | Help for this command |
| `--limit`, `-l` | Limit the number of activations returned to the specified amount. Default: 30, Maximum: 200<br>Default: `30` |
| `--no-header` | Return raw data with no headers<br>Default: `false` |
| `--since` | Retrieve activations invoked after the specified date-time, in UNIX timestamp format measured in milliseconds.<br>Default: `0` |
| `--skip`, `-s` | Exclude a specified number of activations from the returned list, starting with the most recent.<br>Default: `0` |
| `--upto` | Retrieve activations invoked before the specified date-time; in UNIX timestamp format measured in milliseconds.<br>Default: `0` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/list/#global-flags)
