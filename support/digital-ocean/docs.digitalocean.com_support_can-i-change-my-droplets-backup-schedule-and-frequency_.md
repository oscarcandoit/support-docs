---
url: "https://docs.digitalocean.com/support/can-i-change-my-droplets-backup-schedule-and-frequency/"
title: "Can I change my Droplet's backup schedule and frequency? | DigitalOcean Documentation"
---
...
Validated on 11 Jun 2024 • Last edited on 12 Jun 2024

When you enable backups for a Droplet, you can choose between daily and weekly backups.

You can also customize the backup window, which is a 4-hour window of time during which the Droplet automatically initiates a new backup. For weekly backups, this also lets you choose a day of the week for your backups.

As an alternative, you can also [use SnapShooter to automate taking snapshots of Droplets](https://docs.digitalocean.com/products/snapshooter/how-to/back-up-droplets/). SnapShooter offers a customizable backup frequency and retention policy.
...
[Can I change my Droplet's backup schedule and frequency?](https://docs.digitalocean.com/support/can-i-change-my-droplets-backup-schedule-and-frequency/)
