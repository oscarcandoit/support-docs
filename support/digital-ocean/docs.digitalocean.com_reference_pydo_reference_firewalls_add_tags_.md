---
url: "https://docs.digitalocean.com/reference/pydo/reference/firewalls/add_tags/"
title: "pydo.firewalls.add_tags() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/firewalls_add_tags) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/firewalls/add_tags/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/firewalls/add_tags/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/firewalls/add_tags/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/firewalls/add_tags/#more-information)
