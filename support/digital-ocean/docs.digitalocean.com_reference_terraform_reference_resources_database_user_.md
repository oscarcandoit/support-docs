---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/database_user/"
title: "digitalocean_database_user | DigitalOcean Documentation"
---
...
- `topic` \- (Required) A regex for matching the topic(s) that this ACL should apply to. The regex can assume one of 3 patterns: “ _”, “_”, or “”. “ _” is a special value indicating a wildcard that matches on all topics. “_” defines a regex that matches all topics with the prefix. “” performs an exact match on a topic name and only applies to that topic.
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/database_user/#example-usage)
  - [Create a new PostgreSQL database user](https://docs.digitalocean.com/reference/terraform/reference/resources/database_user/#create-a-new-postgresql-database-user)
  - [Create a new user for a PostgreSQL database replica](https://docs.digitalocean.com/reference/terraform/reference/resources/database_user/#create-a-new-user-for-a-postgresql-database-replica)
  - [Create a new user for a Kafka database cluster](https://docs.digitalocean.com/reference/terraform/reference/resources/database_user/#create-a-new-user-for-a-kafka-database-cluster)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_user/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_user/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/database_user/#import)
