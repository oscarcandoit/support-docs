---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-droplets/"
title: "doctl compute load-balancer add-droplets | DigitalOcean Documentation"
---
...
Use this command to add Droplets to a load balancer.

## Flags

| Option | Description |
| --- | --- |
| `--droplet-ids` | A comma-separated list of IDs of Droplet to add to the load balancer, example value: `12,33` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-droplets/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-droplets/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-droplets/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-droplets/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-droplets/#global-flags)
