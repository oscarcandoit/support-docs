---
url: "https://docs.digitalocean.com/products/databases/kafka/how-to/set-up-alerts/"
title: "How to Set Up Kafka Cluster Monitoring Alerts | DigitalOcean Documentation"
---
...
You can set alert policies based on your [cluster performance metrics](https://docs.digitalocean.com/products/databases/kafka/how-to/monitor-clusters/). Alert policies notify you when a performance metric rises above or falls below a threshold you set, and again when a metric returns to within the threshold. You can receive notifications via email or Slack.
...
- [Create an Alert Policy](https://docs.digitalocean.com/products/databases/kafka/how-to/set-up-alerts/#create-an-alert-policy)
- [Manage Alert Policies and Triggered Alerts](https://docs.digitalocean.com/products/databases/kafka/how-to/set-up-alerts/#manage-alert-policies-and-triggered-alerts)
