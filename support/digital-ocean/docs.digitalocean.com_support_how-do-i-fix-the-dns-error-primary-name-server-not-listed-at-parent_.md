---
url: "https://docs.digitalocean.com/support/how-do-i-fix-the-dns-error-primary-name-server-not-listed-at-parent/"
title: "How do I fix the DNS error \"Primary Name Server Not Listed at Parent\"? | DigitalOcean Documentation"
---
...
Validated on 13 Feb 2025 • Last edited on 19 Mar 2025

When checking DNS propagation, the error “Primary Name Server Not Listed at Parent” means your primary name server is not in the list of name servers you provided to the registrar.

To fix this error, [update your registrar](https://docs.digitalocean.com/products/networking/dns/getting-started/dns-registrars/) to use DigitalOcean’s name servers.

If you have configured vanity/branded name servers pointing at DigitalOcean’s name server IP addresses, read [Why aren’t my vanity DNS name servers resolving?](https://docs.digitalocean.com/support/why-arent-my-vanity-dns-name-servers-resolving/).
...
[How do I fix the DNS error "Primary Name Server Not Listed at Parent"?](https://docs.digitalocean.com/support/how-do-i-fix-the-dns-error-primary-name-server-not-listed-at-parent/)
