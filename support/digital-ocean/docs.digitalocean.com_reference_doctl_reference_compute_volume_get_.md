---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/volume/get/"
title: "doctl compute volume get | DigitalOcean Documentation"
---
...
```shell
doctl compute volume get <volume-id> [flags]
```
...
Retrieves information about a block storage volume.

## Example

The following example retrieves information about a volume with the UUID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl compute volume get f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/get/#global-flags)
