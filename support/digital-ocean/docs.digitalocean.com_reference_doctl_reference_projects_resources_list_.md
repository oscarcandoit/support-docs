---
url: "https://docs.digitalocean.com/reference/doctl/reference/projects/resources/list/"
title: "doctl projects resources list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl projects](https://docs.digitalocean.com/reference/doctl/reference/projects/)
      ...
      - [resources](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/)
        - [assign](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/assign/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/list/)
...
```shell
doctl projects resources list <project-id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/list/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/list/#global-flags)
