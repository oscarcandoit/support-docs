---
url: "https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/patch/"
title: "pydo.byoip_prefixes.patch() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `byoip_prefix_uuid` | string | True | A unique identifier for a BYOIP prefix. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/byoipPrefixes_patch) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/patch/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/patch/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/patch/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/patch/#more-information)
