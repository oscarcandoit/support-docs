---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/droplet_autoscale/"
...
See the [Droplet Autoscale Resource](https://docs.digitalocean.com/reference/terraform/reference/data-sources/resources/droplet_autoscale.md) for details on the
returned attributes - they are identical.

In this article...

- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/droplet_autoscale/#example-usage)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/droplet_autoscale/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/droplet_autoscale/#attributes-reference)
