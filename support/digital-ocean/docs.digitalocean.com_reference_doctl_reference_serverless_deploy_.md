---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/deploy/"
title: "doctl serverless deploy | DigitalOcean Documentation"
---
...
| `--incremental` | Deploy only changes since last deploy<br>Default: `false` |
| `--insecure` | Ignore SSL Certificates<br>Default: `false` |
| `--no-triggers` | Default: `false` |
| `--remote-build` | Run builds remotely<br>Default: `false` |
| `--verbose-build` | Display build details<br>Default: `false` |
| `--verbose-zip` | Display start/end of zipping phase for each function<br>Default: `false` |
| `--yarn` | Use yarn instead of npm for node builds<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/deploy/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/deploy/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/deploy/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/deploy/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/deploy/#global-flags)
