---
url: "https://docs.digitalocean.com/products/app-platform/how-to/manage-services/"
title: "How to Manage Services in App Platform | DigitalOcean Documentation"
---
...
The [usual app creation process](https://docs.digitalocean.com/products/app-platform/getting-started/quickstart/#create-an-app) will create a service by default; you only need to follow this process if you’re creating another resource for your app that needs an internet-accessible endpoint. If your resource only needs to be internally accessible, create a [internal service](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#create-an-internal-service) instead. If you don’t need this resource to be internet-accessible, create a [worker](https://docs.digitalocean.com/products/app-platform/how-to/manage-workers/) instead.

## Add a Service to an App Using Automation

You can add a service to an app using the CLI’s app update command or the API’s app update endpoint. To add a service, update the [app’s spec](https://docs.digitalocean.com/products/app-platform/reference/app-spec/) with the service’s specifications and submit the spec using the following command or endpoint.
...
1. In the [**Apps** section of the DigitalOcean Control Panel](https://cloud.digitalocean.com/apps), select your app, then click the **Create** drop-down and choose **Create Resources From Source Code** to add a Web Service.
...
- **Build Strateg:** Add a custom build command to run before the app is deployed. This is useful for compiling assets, installing dependencies, or running tests before deployment.
...
Full HTTP request path preservation for services is not available in the control panel. Instead, set the `preserve_path_prefix` annotation in the [App Spec](https://docs.digitalocean.com/products/app-platform/reference/app-spec/) to `true`.
...
To create an internal service using the [app spec](https://docs.digitalocean.com/products/app-platform/reference/app-spec/), remove any existing `http_port` fields from the target service object and then add the `internal_ports` field to the service:
...
- [Add a Service to an App Using Automation](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#add-a-service-to-an-app-using-automation)
- [Add a Service to an App Using the Control Panel](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#add-a-service-to-an-app-using-the-control-panel)
- [Environment](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#environment)
- [Edit a Service](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#edit-a-service)
- [Destroy a Service](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#destroy-a-service)
- [Create an Internal Service](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#create-an-internal-service)
  - [Create an Internal Service Using the Control Panel](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#create-an-internal-service-using-the-control-panel)
  - [Create an Internal Service Using the App Spec](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#create-an-internal-service-using-the-app-spec)
- [Add a Function](https://docs.digitalocean.com/products/app-platform/how-to/manage-services/#add-a-function)
