---
url: "https://docs.digitalocean.com/support/why-dont-i-see-google-pay-as-a-payment-option/"
title: "Why don't I see Google Pay as a payment option? | DigitalOcean Documentation"
---
...
Validated on 4 Oct 2022 • Last edited on 8 May 2024

If you expect to see Google Pay as a [payment method option](https://docs.digitalocean.com/platform/billing/manage-payment-methods/) but don’t, try the following steps:

- Make sure you’re [logged into Google Pay](https://pay.google.com/).

- Visit the [Stripe documentation on the payment request button](https://stripe.com/docs/stripe-js/elements/payment-request-button) and make sure you see the Google Pay button at the top of the page. If you see an error, follow the instructions in the error message.

- If you use 1Password, try [adjusting your 1Password autofill settings](https://1password.community/discussion/comment/596688/#Comment_596688) to work with Chrome.
...
[Why don't I see Google Pay as a payment option?](https://docs.digitalocean.com/support/why-dont-i-see-google-pay-as-a-payment-option/)
