---
url: "https://docs.digitalocean.com/reference/pydo/reference/apps/create_rollback/"
title: "pydo.apps.create_rollback() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/apps_create_rollback) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/apps/create_rollback/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/apps/create_rollback/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/apps/create_rollback/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/apps/create_rollback/#more-information)
