---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_kafka_schemas/"
title: "pydo.databases.list_kafka_schemas() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- list\_kafka\_schemas()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.list\_kafka\_schemas()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_kafka_schemas) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_kafka_schemas/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_kafka_schemas/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_kafka_schemas/#more-information)
