---
url: "https://docs.digitalocean.com/reference/pydo/reference/nfs/get/"
title: "pydo.nfs.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/nfs_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/nfs/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/nfs/get/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/nfs/get/#more-information)
