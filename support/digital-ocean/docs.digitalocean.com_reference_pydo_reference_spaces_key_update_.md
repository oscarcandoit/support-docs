...
title: "pydo.spaces_key.update() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/spacesKey_update) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/update/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/update/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/spaces_key/update/#more-information)
