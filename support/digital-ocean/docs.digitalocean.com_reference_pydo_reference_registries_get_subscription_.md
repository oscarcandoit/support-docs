---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/get_subscription/"
title: "pydo.registries.get_subscription() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_get_subscription) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/get_subscription/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/get_subscription/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/get_subscription/#more-information)
