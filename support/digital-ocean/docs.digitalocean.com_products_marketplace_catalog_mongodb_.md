---
url: "https://docs.digitalocean.com/products/marketplace/catalog/mongodb/"
title: "MongoDB | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/mongodb/)
...
from [the MongoDB catalog page](https://marketplace.digitalocean.com/apps/mongodb)
...
| --- | --- | --- |
| MongoDB | [7.0.0](https://www.mongodb.com/) | [GNU AGPL v3](https://github.com/mongodb/mongo/blob/master/GNU-AGPL-3.0.txt) |

## Creating an App using the Control Panel

Click the **Deploy to DigitalOcean** button to create a Droplet based on this 1-Click App. If you aren’t logged in, this link will prompt you to log in with your DigitalOcean account.

[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=mongodb-18-04)
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/mongodb/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/mongodb/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/mongodb/#creating-an-app-using-the-api)
- [Getting Started After Deploying MongoDB](https://docs.digitalocean.com/products/marketplace/catalog/mongodb/#getting-started-after-deploying-mongodb)
