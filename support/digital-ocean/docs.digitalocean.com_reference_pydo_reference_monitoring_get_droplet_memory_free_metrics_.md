---
url: "https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_droplet_memory_free_metrics/"
title: "pydo.monitoring.get_droplet_memory_free_metrics() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [monitoring](https://docs.digitalocean.com/reference/pydo/reference/monitoring/)
- get\_droplet\_memory\_free\_metrics()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/monitoring_get_dropletMemoryFreeMetrics) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_droplet_memory_free_metrics/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_droplet_memory_free_metrics/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_droplet_memory_free_metrics/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_droplet_memory_free_metrics/#more-information)
