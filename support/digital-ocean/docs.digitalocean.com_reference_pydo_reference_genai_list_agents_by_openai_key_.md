---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_openai_key/"
title: "pydo.genai.list_agents_by_openai_key() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `uuid` | string | True | Unique ID of OpenAI key |  |
| `page` | integer | False | Page number. |  |
| `per_page` | integer | False | Items per page. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_agents_by_openai_key) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_openai_key/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_openai_key/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_openai_key/#more-information)
