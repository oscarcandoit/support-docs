---
url: "https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/get/"
title: "doctl spaces keys get | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl spaces](https://docs.digitalocean.com/reference/doctl/reference/spaces/)
      - [keys](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/list/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/update/)
...
Get the key for a Space by Access Key ID.

## Example

The following command gets a Spaces Key by Access Key ID and uses the `--format` flag to return only the Name and Grants of each key.

```shell
doctl spaces keys get DOACCESSKEY --format Name,Grants
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Name`, `AccessKey`, `SecretKey`, `Grants`, `CreatedAt`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/get/#global-flags)
