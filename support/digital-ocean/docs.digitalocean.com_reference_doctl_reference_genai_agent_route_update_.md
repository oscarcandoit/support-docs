---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/update/"
title: "doctl genai agent route update | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/update/#global-flags)
