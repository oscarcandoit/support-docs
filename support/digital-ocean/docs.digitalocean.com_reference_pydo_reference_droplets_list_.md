---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/list/"
title: "pydo.droplets.list() | DigitalOcean Documentation"
---
...
| `tag_name` | string | False | Used to filter Droplets by a specific tag. Can not be combined with `name` or `type`.<br>Requires `tag:read` scope. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/list/#description)
  - [Filtering Results by Tag](https://docs.digitalocean.com/reference/pydo/reference/droplets/list/#filtering-results-by-tag)
  - [GPU Droplets](https://docs.digitalocean.com/reference/pydo/reference/droplets/list/#gpu-droplets)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplets/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/list/#more-information)
