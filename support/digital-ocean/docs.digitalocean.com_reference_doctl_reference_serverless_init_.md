---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/init/"
title: "doctl serverless init | DigitalOcean Documentation"
---
...
| `--language`, `-l` | Language for the initial sample code<br>Default: `javascript` |
| `--overwrite` | Clears and reuses an existing directory<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/init/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/init/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/init/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/init/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/init/#global-flags)
