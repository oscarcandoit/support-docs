---
url: "https://docs.digitalocean.com/support/why-am-i-receiving-a-forbidden-error-when-making-changes-to-my-app-platform-app/"
title: "Why am I receiving a forbidden error when making changes to my App Platform app? | DigitalOcean Documentation"
---
...
Often, this is because your team balance is [past due](https://docs.digitalocean.com/platform/billing/late-payments/), which may happen if your default payment method fails and there are no other valid payment methods on file.

If your balance is past due, we temporarily restrict actions on your team until the balance is paid. To resolve a past due balance, add a [valid payment method](https://docs.digitalocean.com/platform/billing/manage-payment-methods/), then [pay your bill](https://docs.digitalocean.com/platform/billing/pay-bills/).

If your team balance is not past due and you’re still receiving a forbidden error, [contact support](https://cloudsupport.digitalocean.com/s/).
...
[Why am I receiving a forbidden error when making changes to my App Platform app?](https://docs.digitalocean.com/support/why-am-i-receiving-a-forbidden-error-when-making-changes-to-my-app-platform-app/)
