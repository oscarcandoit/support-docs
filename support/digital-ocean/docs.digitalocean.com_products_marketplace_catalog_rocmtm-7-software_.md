---
url: "https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/"
title: "ROCm™ 7 Software | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/)
...
from [the ROCm™ 7 Software catalog page](https://marketplace.digitalocean.com/apps/rocm-7-software)
...
| --- | --- | --- |
| ROCm (host system) | 7 | [LICENSE](https://rocm.docs.amd.com/en/latest/about/license.html) |
| ROCm (in Docker image) | 7 | [LICENSE](https://rocm.docs.amd.com/en/latest/about/license.html) |
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=amd-rocm7software)

## Creating an App using the API

In addition to creating a Droplet from the ROCm™ 7 Software 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB ROCm™ 7 Software Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"amd-rocm7software"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying ROCm™ 7 Software
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/#creating-an-app-using-the-api)
- [Getting Started After Deploying ROCm™ 7 Software](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/#getting-started-after-deploying-rocm-7-software)
- [Accessing ROCm resources and libraries](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/#accessing-rocm-resources-and-libraries)
- [SSHing into your AMD 1-Click](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/#sshing-into-your-amd-1-click)
- [Exploring via Jupyter](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/#exploring-via-jupyter)
- [Exploring via Docker](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-software/#exploring-via-docker)
