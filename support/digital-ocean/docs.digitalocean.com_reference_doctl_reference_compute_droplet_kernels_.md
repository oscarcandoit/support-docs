---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/kernels/"
title: "doctl compute droplet kernels | DigitalOcean Documentation"
---
...
```shell
doctl compute droplet kernels <droplet-id> [flags]
```
...
Retrieves a list of all kernels available to a Droplet. This command is only available for Droplets with externally managed kernels. All Droplets created after March 2017 have internally managed kernels by default.

## Example

The following example retrieves a list of available kernels for a Droplet with the ID `386734086`:

```shell
doctl compute droplet kernels 386734086
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Name`, `Version`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/kernels/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/kernels/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/kernels/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/kernels/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/kernels/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/kernels/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/kernels/#global-flags)
