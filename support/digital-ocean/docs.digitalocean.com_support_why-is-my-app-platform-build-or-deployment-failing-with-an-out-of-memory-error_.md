---
url: "https://docs.digitalocean.com/support/why-is-my-app-platform-build-or-deployment-failing-with-an-out-of-memory-error/"
title: "Why is my App Platform build or deployment failing with an out of memory error? | DigitalOcean Documentation"
---
...
- As an alternative, you can [build your app as a Docker image](https://docs.digitalocean.com/products/app-platform/reference/dockerfile/) and then [upload it to DigitalOcean Container Registry](https://docs.digitalocean.com/products/container-registry/). Because this method uses a local build, App Platform skips the build process and deploys directly from the image.


## Deployment Failing with Out of Memory Error

The amount of memory available to your app’s deployment depends on the [App Platform plan](https://docs.digitalocean.com/products/app-platform/details/pricing/).

If your deployment is running out of memory, you can [scale the app](https://docs.digitalocean.com/products/app-platform/how-to/scale-app/) to a larger plan.
...
- [Build Failing with Out of Memory Error](https://docs.digitalocean.com/support/why-is-my-app-platform-build-or-deployment-failing-with-an-out-of-memory-error/#build-failing-with-out-of-memory-error)
- [Deployment Failing with Out of Memory Error](https://docs.digitalocean.com/support/why-is-my-app-platform-build-or-deployment-failing-with-an-out-of-memory-error/#deployment-failing-with-out-of-memory-error)
