---
url: "https://docs.digitalocean.com/support/why-does-my-app-fail-to-build-while-trying-to-connect-to-a-digitalocean-managed-database/"
title: "Why does my app fail to build while trying to connect to a DigitalOcean Managed Database? | DigitalOcean Documentation"
---
...
Validated on 29 Jan 2024 • Last edited on 17 Jun 2025
...
As a workaround, you can temporarily [disable trusted sources](https://docs.digitalocean.com/products/app-platform/how-to/manage-databases/#disable-trusted-sources) for your app. However, we recommend not connecting your database to your app at build time. This keeps the build process self-contained and independent of external services that might otherwise cause the build to fail.
...
[Why does my app fail to build while trying to connect to a DigitalOcean Managed Database?](https://docs.digitalocean.com/support/why-does-my-app-fail-to-build-while-trying-to-connect-to-a-digitalocean-managed-database/)
