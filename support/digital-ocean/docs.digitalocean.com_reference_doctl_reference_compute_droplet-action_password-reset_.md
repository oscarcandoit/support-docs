---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/password-reset/"
title: "doctl compute droplet-action password-reset | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/password-reset/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/password-reset/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/password-reset/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/password-reset/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/password-reset/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/password-reset/#global-flags)
