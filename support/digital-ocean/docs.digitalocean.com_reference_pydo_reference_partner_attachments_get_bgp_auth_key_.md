---
url: "https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_bgp_auth_key/"
title: "pydo.partner_attachments.get_bgp_auth_key() | DigitalOcean Documentation"
---
...
# pydo.partner\_attachments.get\_bgp\_auth\_key()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/partnerAttachments_get_bgp_auth_key) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_bgp_auth_key/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_bgp_auth_key/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_bgp_auth_key/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_bgp_auth_key/#more-information)
