---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/snapshots/"
title: "doctl compute droplet snapshots | DigitalOcean Documentation"
---
...
```shell
doctl compute droplet snapshots <droplet-id> [flags]
```
...
Retrieves a list of snapshots created from this Droplet.

## Example

The following example retrieves a list of snapshots for a Droplet with the ID `386734086`:

```shell
doctl compute droplet snapshots 386734086
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/snapshots/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/snapshots/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/snapshots/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/snapshots/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/snapshots/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/snapshots/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/snapshots/#global-flags)
