---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/database_kafka_schema_registry/"
title: "digitalocean_database_kafka_schema_registry | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/database_kafka_schema_registry/#example-usage)
  - [Create a new Kafka Schema Registry](https://docs.digitalocean.com/reference/terraform/reference/resources/database_kafka_schema_registry/#create-a-new-kafka-schema-registry)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_kafka_schema_registry/#argument-reference)
