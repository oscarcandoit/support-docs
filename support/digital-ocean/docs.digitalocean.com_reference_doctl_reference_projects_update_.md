---
url: "https://docs.digitalocean.com/reference/doctl/reference/projects/update/"
title: "doctl projects update | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl projects](https://docs.digitalocean.com/reference/doctl/reference/projects/)
      - [create](https://docs.digitalocean.com/reference/doctl/reference/projects/create/)
      - [delete](https://docs.digitalocean.com/reference/doctl/reference/projects/delete/)
      - [get](https://docs.digitalocean.com/reference/doctl/reference/projects/get/)
      - [list](https://docs.digitalocean.com/reference/doctl/reference/projects/list/)
      - [resources](https://docs.digitalocean.com/reference/doctl/reference/projects/resources/)
      - [update](https://docs.digitalocean.com/reference/doctl/reference/projects/update/)
...
```shell
doctl projects update <project-id> [flags]
```
...
Updates information about an existing project. Use `default` as the  to update your default project.

## Example

The following example updates the project with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6` to have the name `API Project` and the purpose “Backend development”:

```shell
doctl projects update f81d4fae-7dec-11d0-a765-00a0c91e6bf6 --name "API Project" --purpose "Backend development"
```
...
| `--environment` | The environment in which your project resides. Possible `enum` values: `Development`, `Staging`, or `Production` |
...
| `--is_default` | Sets the specified project as your default project<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/projects/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/projects/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/projects/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/projects/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/projects/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/projects/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/projects/update/#global-flags)
