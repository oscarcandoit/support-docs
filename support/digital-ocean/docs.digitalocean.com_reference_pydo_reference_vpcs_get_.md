---
url: "https://docs.digitalocean.com/reference/pydo/reference/vpcs/get/"
title: "pydo.vpcs.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/vpcs_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/vpcs/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/vpcs/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/vpcs/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/vpcs/get/#more-information)
