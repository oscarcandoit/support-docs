---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/"
title: "doctl compute domain records | DigitalOcean Documentation"
---
...
Use the subcommands of `doctl compute domain records` to manage the DNS records for your domains.
...
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/#global-flags)
