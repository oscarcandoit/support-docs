---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_run/"
title: "pydo.genai.get_evaluation_run() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_get_evaluation_run) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_run/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_run/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/get_evaluation_run/#more-information)
