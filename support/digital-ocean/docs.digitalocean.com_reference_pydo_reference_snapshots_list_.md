---
url: "https://docs.digitalocean.com/reference/pydo/reference/snapshots/list/"
title: "pydo.snapshots.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [snapshots](https://docs.digitalocean.com/reference/pydo/reference/snapshots/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/snapshots/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/snapshots/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/snapshots/list/)
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/snapshots_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/snapshots/list/#description)
  - [Filtering Results by Resource Type](https://docs.digitalocean.com/reference/pydo/reference/snapshots/list/#filtering-results-by-resource-type)
    - [List Droplet Snapshots](https://docs.digitalocean.com/reference/pydo/reference/snapshots/list/#list-droplet-snapshots)
    - [List Volume Snapshots](https://docs.digitalocean.com/reference/pydo/reference/snapshots/list/#list-volume-snapshots)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/snapshots/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/snapshots/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/snapshots/list/#more-information)
