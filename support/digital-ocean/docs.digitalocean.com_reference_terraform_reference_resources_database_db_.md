---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/database_db/"
title: "digitalocean_database_db | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/database_db/#example-usage)
  - [Create a new PostgreSQL database](https://docs.digitalocean.com/reference/terraform/reference/resources/database_db/#create-a-new-postgresql-database)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_db/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_db/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/database_db/#import)
