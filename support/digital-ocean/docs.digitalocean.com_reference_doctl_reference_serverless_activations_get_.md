---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/get/"
title: "doctl serverless activations get | DigitalOcean Documentation"
---
...
| `--last`, `-l` | Retrieve the most recent activation (default). Does not return activations for web-invoked functions.<br>Default: `false` |
| `--logs`, `-g` | Retrieve only the logs, stripped of time stamps and stream identifier.<br>Default: `false` |
| `--quiet`, `-q` | Suppress the last activation information header.<br>Default: `false` |
| `--result`, `-r` | Retrieve only the resulting output of a function.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/get/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/get/#global-flags)
