---
url: "https://docs.digitalocean.com/reference/doctl/reference/auth/switch/"
title: "doctl auth switch | DigitalOcean Documentation"
---
...
The following example switches to the context `your-team`:

```shell
doctl auth switch --context your-team
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/auth/switch/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/auth/switch/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/auth/switch/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/switch/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/auth/switch/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/switch/#global-flags)
