---
url: "https://docs.digitalocean.com/products/databases/redis/how-to/add-standby-nodes/"
title: "How to Add Standby Nodes to Caching Database Clusters | DigitalOcean Documentation"
---
...
You can add standby nodes during cluster creation in the [cluster configuration section](https://docs.digitalocean.com/products/databases/redis/how-to/create/#choose-a-cluster-configuration) of the create page.
...
- [Use Standby Nodes for Reads](https://docs.digitalocean.com/products/databases/redis/how-to/add-standby-nodes/#use-standby-nodes-for-reads)
