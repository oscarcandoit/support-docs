---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/create_evaluation_test_case/"
title: "pydo.genai.create_evaluation_test_case() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- create\_evaluation\_test\_case()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_create_evaluation_test_case) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/create_evaluation_test_case/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/create_evaluation_test_case/#more-information)
