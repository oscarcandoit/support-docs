---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/list_backup_policies/"
title: "pydo.droplets.list_backup_policies() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_list_backup_policies) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_backup_policies/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_backup_policies/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_backup_policies/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_backup_policies/#more-information)
