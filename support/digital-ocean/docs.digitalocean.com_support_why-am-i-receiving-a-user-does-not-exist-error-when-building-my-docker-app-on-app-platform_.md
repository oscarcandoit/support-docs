---
url: "https://docs.digitalocean.com/support/why-am-i-receiving-a-user-does-not-exist-error-when-building-my-docker-app-on-app-platform/"
title: "Why am I receiving a \"user does not exist\" error when building my Docker app on App Platform? | DigitalOcean Documentation"
---
...
If your Docker App on App Platform fails to build with the following error in the [deployment logs](https://docs.digitalocean.com/products/app-platform/how-to/manage-deployments/), then the `USER` instruction may be in the wrong place in your Dockerfile:
...
[Why am I receiving a "user does not exist" error when building my Docker app on App Platform?](https://docs.digitalocean.com/support/why-am-i-receiving-a-user-does-not-exist-error-when-building-my-docker-app-on-app-platform/)
