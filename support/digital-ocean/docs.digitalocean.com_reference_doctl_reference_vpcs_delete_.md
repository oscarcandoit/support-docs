---
url: "https://docs.digitalocean.com/reference/doctl/reference/vpcs/delete/"
title: "doctl vpcs delete | DigitalOcean Documentation"
---
...
Permanently deletes the specified VPC. This is irreversible.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete the VPC without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/vpcs/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/vpcs/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/vpcs/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/vpcs/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/vpcs/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/delete/#global-flags)
