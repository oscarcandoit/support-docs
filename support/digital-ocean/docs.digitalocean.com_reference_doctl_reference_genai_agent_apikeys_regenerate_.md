---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/regenerate/"
title: "doctl genai agent apikeys regenerate | DigitalOcean Documentation"
---
...
# doctl genai agent apikeys regenerate
...
```shell
doctl genai agent apikeys regenerate <apikey-id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/regenerate/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/regenerate/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/regenerate/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/regenerate/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/regenerate/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/regenerate/#global-flags)
