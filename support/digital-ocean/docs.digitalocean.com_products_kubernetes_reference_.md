---
url: "https://docs.digitalocean.com/products/kubernetes/reference/"
title: "Kubernetes Reference | DigitalOcean Documentation"
---
...
You can use the API to [create, delete, and manage Kubernetes clusters](https://docs.digitalocean.com/reference/api/digitalocean/#tag/Kubernetes).
...
[`doctl`](https://github.com/digitalocean/doctl) supports managing Kubernetes clusters from the command line. See the [`doctl` documentation](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/) or use `doctl kubernetes --help` for more information.

## Official Kubernetes Documentation

- The [official Kubernetes documentation](https://kubernetes.io/docs/home/)

- [A conceptual overview of cloud controller managers (CCMs)](https://kubernetes.io/docs/concepts/architecture/cloud-controller/)


In this article...

- [The DigitalOcean API](https://docs.digitalocean.com/products/kubernetes/reference/#the-digitalocean-api)
- [The DigitalOcean Command Line Client, doctl](https://docs.digitalocean.com/products/kubernetes/reference/#the-digitalocean-command-line-client-doctl)
- [Official Kubernetes Documentation](https://docs.digitalocean.com/products/kubernetes/reference/#official-kubernetes-documentation)
