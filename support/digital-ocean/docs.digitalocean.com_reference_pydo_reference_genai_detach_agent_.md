---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/detach_agent/"
title: "pydo.genai.detach_agent() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `parent_agent_uuid` | string | True | Pagent agent id |  |
| `child_agent_uuid` | string | True | Routed agent id |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_detach_agent) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/detach_agent/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/detach_agent/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/detach_agent/#more-information)
