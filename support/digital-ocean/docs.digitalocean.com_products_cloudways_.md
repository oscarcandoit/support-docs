---
url: "https://docs.digitalocean.com/products/cloudways/"
title: "Cloudways | DigitalOcean Documentation"
---
...
Validated on 13 Jan 2023 • Last edited on 17 Apr 2025

Cloudways is a managed cloud hosting platform where teams can build, deploy, and scale web applications.

![](https://docs.digitalocean.com/images/icons/cloudways.svg)

Cloudways Managed Hosting for DigitalOcean

DigitalOcean and Cloudways together gives you a scalable managed hosting experience with active support.

cloudways.com![](https://docs.digitalocean.com/images/icons/cloudways.svg)

Getting Started with Cloudways

Learn how to launch a new server, add web application, migrate an existing website, collaborate with team members, and more.

cloudways.com

You can deploy a DigitalOcean server in minutes with a pre-installed stack including nginx, Apache, Memcached, and application level caching like Varnish and Redis to achieve optimal performance.

Cloudways provides 24/7 chat and ticket support as well as a [large knowledge base of frequently asked questions](https://support.cloudways.com/en/).

In this article...

[Cloudways](https://docs.digitalocean.com/products/cloudways/)
