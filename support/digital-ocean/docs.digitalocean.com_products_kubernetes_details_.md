---
url: "https://docs.digitalocean.com/products/kubernetes/details/"
title: "Kubernetes Details | DigitalOcean Documentation"
---
...
The cost of a DigitalOcean Kubernetes cluster is based on the cluster’s node pool configuration and usage.

![](https://docs.digitalocean.com/images/icons/kubernetes.svg)

Kubernetes Availability

Regional datacenter availability for Kubernetes.

![](https://docs.digitalocean.com/images/icons/kubernetes.svg)

Kubernetes Limits

Limits and known issues for DigitalOcean Kubernetes.
...
GPU worker nodes are built on GPU Droplets, which are powered by AMD and NVIDIA GPUs.

![](https://docs.digitalocean.com/images/icons/kubernetes.svg)

DigitalOcean Kubernetes Security Information

Information DigitalOcean Kubernetes security, like access control, security tooling, and authentication.

![](https://docs.digitalocean.com/images/icons/kubernetes.svg)

DigitalOcean Kubernetes Supported Releases

Release process and support policy for your Kubernetes clusters.

![](https://docs.digitalocean.com/images/icons/kubernetes.svg)

DigitalOcean Volumes Block Storage Features

An overview of volume feature support in DOKS.

![](https://docs.digitalocean.com/images/icons/digitalocean.svg)

DigitalOcean Kubernetes SLA

The service-level agreement for DigitalOcean Kubernetes.

digitalocean.com

In this article...

- [Additional Details](https://docs.digitalocean.com/products/kubernetes/details/#additional-details)
