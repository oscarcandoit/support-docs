---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/delete/"
title: "doctl compute firewall delete | DigitalOcean Documentation"
---
...
Permanently deletes a cloud firewall. This is irreversible, but does not delete any Droplets assigned to the cloud firewall.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes the firewall without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/delete/#global-flags)
