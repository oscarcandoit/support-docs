---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/rollback_to_agent_version/"
title: "pydo.genai.rollback_to_agent_version() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `uuid` | string | True | Agent unique identifier |  |
| `body` | JSON or IO\[bytes\] | False |  |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_rollback_to_agent_version) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/rollback_to_agent_version/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/rollback_to_agent_version/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/rollback_to_agent_version/#more-information)
