---
url: "https://docs.digitalocean.com/support/why-dont-i-see-apple-pay-as-a-payment-option/"
title: "Why don't I see Apple Pay as a payment option? | DigitalOcean Documentation"
---
...
If you expect to see Apple Pay as a [payment method option](https://docs.digitalocean.com/platform/billing/manage-payment-methods/) but don’t, try the following steps:

- Make sure you’re using Safari as your web browser.

- Make sure you have [Apple Pay set up and are logged into it](https://support.apple.com/en-us/HT204506).

- Visit the [Stripe documentation on the payment request button](https://stripe.com/docs/stripe-js/elements/payment-request-button) and make sure you see the Apple Pay button at the top of the page. If you see an error, follow the instructions in the error message.
...
[Why don't I see Apple Pay as a payment option?](https://docs.digitalocean.com/support/why-dont-i-see-apple-pay-as-a-payment-option/)
