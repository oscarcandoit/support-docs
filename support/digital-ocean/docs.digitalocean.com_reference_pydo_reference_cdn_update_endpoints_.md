---
url: "https://docs.digitalocean.com/reference/pydo/reference/cdn/update_endpoints/"
title: "pydo.cdn.update_endpoints() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [cdn](https://docs.digitalocean.com/reference/pydo/reference/cdn/)
      - [create\_endpoint()](https://docs.digitalocean.com/reference/pydo/reference/cdn/create_endpoint/)
      - [delete\_endpoint()](https://docs.digitalocean.com/reference/pydo/reference/cdn/delete_endpoint/)
      - [get\_endpoint()](https://docs.digitalocean.com/reference/pydo/reference/cdn/get_endpoint/)
      - [list\_endpoints()](https://docs.digitalocean.com/reference/pydo/reference/cdn/list_endpoints/)
      - [purge\_cache()](https://docs.digitalocean.com/reference/pydo/reference/cdn/purge_cache/)
      - [update\_endpoints()](https://docs.digitalocean.com/reference/pydo/reference/cdn/update_endpoints/)
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/cdn_update_endpoints) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/cdn/update_endpoints/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/cdn/update_endpoints/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/cdn/update_endpoints/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/cdn/update_endpoints/#more-information)
