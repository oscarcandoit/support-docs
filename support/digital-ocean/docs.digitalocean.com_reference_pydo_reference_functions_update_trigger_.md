---
url: "https://docs.digitalocean.com/reference/pydo/reference/functions/update_trigger/"
title: "pydo.functions.update_trigger() | DigitalOcean Documentation"
---
...
# pydo.functions.update\_trigger()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/functions_update_trigger) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/functions/update_trigger/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/functions/update_trigger/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/functions/update_trigger/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/functions/update_trigger/#more-information)
