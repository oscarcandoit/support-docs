---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/get_docker_credentials/"
title: "pydo.registries.get_docker_credentials() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [registries](https://docs.digitalocean.com/reference/pydo/reference/registries/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/registries/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/registries/delete/)
      - [delete\_repository()](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository/)
      - [delete\_repository\_manifest()](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_manifest/)
      - [delete\_repository\_tag()](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_tag/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/registries/get/)
      - [get\_docker\_credentials()](https://docs.digitalocean.com/reference/pydo/reference/registries/get_docker_credentials/)
      - [get\_garbage\_collection()](https://docs.digitalocean.com/reference/pydo/reference/registries/get_garbage_collection/)
      - [get\_options()](https://docs.digitalocean.com/reference/pydo/reference/registries/get_options/)
      - [get\_subscription()](https://docs.digitalocean.com/reference/pydo/reference/registries/get_subscription/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/registries/list/)
      - [list\_garbage\_collections()](https://docs.digitalocean.com/reference/pydo/reference/registries/list_garbage_collections/)
      - [list\_repositories\_v2()](https://docs.digitalocean.com/reference/pydo/reference/registries/list_repositories_v2/)
      - [list\_repository\_manifests()](https://docs.digitalocean.com/reference/pydo/reference/registries/list_repository_manifests/)
      - [list\_repository\_tags()](https://docs.digitalocean.com/reference/pydo/reference/registries/list_repository_tags/)
      - [run\_garbage\_collection()](https://docs.digitalocean.com/reference/pydo/reference/registries/run_garbage_collection/)
      - [update\_garbage\_collection()](https://docs.digitalocean.com/reference/pydo/reference/registries/update_garbage_collection/)
      - [update\_subscription()](https://docs.digitalocean.com/reference/pydo/reference/registries/update_subscription/)
      - [validate\_name()](https://docs.digitalocean.com/reference/pydo/reference/registries/validate_name/)
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [registries](https://docs.digitalocean.com/reference/pydo/reference/registries/)
- get\_docker\_credentials()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.registries.get\_docker\_credentials()
...
client or in a CI system, read\_write may be provided as query parameter. For
...
with an expiry set, expiry\_seconds may be provided as a query parameter. For
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_get_dockerCredentials) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/get_docker_credentials/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/registries/get_docker_credentials/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/get_docker_credentials/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/get_docker_credentials/#more-information)
