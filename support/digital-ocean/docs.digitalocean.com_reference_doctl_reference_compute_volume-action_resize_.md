---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/resize/"
title: "doctl compute volume-action resize | DigitalOcean Documentation"
---
...
| `--size` | The volume’s new size, in GiB (required)<br>Default: `0` |
| `--wait` | Instructs the terminal to wait for the volume to complete resizing before returning control to the user<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/resize/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/resize/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/resize/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/resize/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/resize/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/resize/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/resize/#global-flags)
