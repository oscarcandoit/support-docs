---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/get/"
title: "doctl genai agent get | DigitalOcean Documentation"
---
...
Retrieves information about an agent, including:
\- The Agent ID
\- The Agent name
\- The Agent’s region
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/get/#global-flags)
