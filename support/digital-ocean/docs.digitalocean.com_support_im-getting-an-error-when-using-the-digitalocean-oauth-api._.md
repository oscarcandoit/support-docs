---
url: "https://docs.digitalocean.com/support/im-getting-an-error-when-using-the-digitalocean-oauth-api./"
title: "I'm getting an error when using the DigitalOcean OAuth API. | DigitalOcean Documentation"
---
...
Here are solutions for common issues and errors when making [OAuth API authorization requests](https://docs.digitalocean.com/reference/api/oauth/#authorization).

### Access Denied

If the user denies authorization, OAuth redirects them to your callback URL with an `error_description` parameter:
...
Fix this by replacing the value of the `redirect_uri` parameter in your authorization code link with your application’s registered callback URL.
...
Correct this by using a [valid scope](https://docs.digitalocean.com/reference/api/scopes/) in your authorization link.

## Common Access Token Request Errors

Here are solutions for common issues and errors when making [OAuth API access token requests](https://docs.digitalocean.com/reference/api/oauth/#token).

### Redirect URI Mismatch or Invalid Grant

If your access token request contains a `redirect_uri` that does not match your registered callback URL, or if your authorization grant (`code`) is invalid (already used, expired, revoked), you receive the following error:
...
Fix this by ensuring your `redirect_uri` value matches your registered callback URL. If the problem persists, request a new `code` by starting the authorization process over. Authorization codes are valid for 10 minutes after creation.
...
Correct this by ensuring your request contains client credentials that match the client ID and client secret listed in your application’s registration page (located in the [DigitalOcean Control Panel](https://cloud.digitalocean.com/settings/applications)).

### Verify Scope of Access Token Grant

It is possible for the user to change the scope of the authorization request by modifying the value of the `scope` parameter in the authorization link. To prevent application errors due to insufficient scope, we recommend that you verify that the scope of the access token grant matches the scope that was originally requested.

In this article...

- [Common Authorization Request Errors](https://docs.digitalocean.com/support/im-getting-an-error-when-using-the-digitalocean-oauth-api./#common-authorization-request-errors)
  - [Access Denied](https://docs.digitalocean.com/support/im-getting-an-error-when-using-the-digitalocean-oauth-api./#access-denied)
  - [Invalid Redirect URI](https://docs.digitalocean.com/support/im-getting-an-error-when-using-the-digitalocean-oauth-api./#invalid-redirect-uri)
  - [Invalid Scope](https://docs.digitalocean.com/support/im-getting-an-error-when-using-the-digitalocean-oauth-api./#invalid-scope)
- [Common Access Token Request Errors](https://docs.digitalocean.com/support/im-getting-an-error-when-using-the-digitalocean-oauth-api./#common-access-token-request-errors)
  - [Redirect URI Mismatch or Invalid Grant](https://docs.digitalocean.com/support/im-getting-an-error-when-using-the-digitalocean-oauth-api./#redirect-uri-mismatch-or-invalid-grant)
  - [Incorrect Client Credentials](https://docs.digitalocean.com/support/im-getting-an-error-when-using-the-digitalocean-oauth-api./#incorrect-client-credentials)
  - [Verify Scope of Access Token Grant](https://docs.digitalocean.com/support/im-getting-an-error-when-using-the-digitalocean-oauth-api./#verify-scope-of-access-token-grant)
