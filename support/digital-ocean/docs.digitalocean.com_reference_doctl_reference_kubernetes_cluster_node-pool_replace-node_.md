---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/replace-node/"
title: "doctl kubernetes cluster node-pool replace-node | DigitalOcean Documentation"
---
...
The following example replaces a node named `example-node` in a node pool named `example-pool`:

```shell
doctl kubernetes cluster node-pool replace-node example-cluster example-pool example-node
```
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Replaces node without confirmation prompt<br>Default: `false` |
| `--help`, `-h` | Help for this command |
| `--skip-drain` | Skips draining the node before replacement<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/replace-node/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/replace-node/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/replace-node/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/replace-node/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/replace-node/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/replace-node/#global-flags)
