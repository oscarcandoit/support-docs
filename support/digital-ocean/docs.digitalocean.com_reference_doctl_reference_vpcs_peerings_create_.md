---
url: "https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/create/"
title: "doctl vpcs peerings create | DigitalOcean Documentation"
---
...
| `--wait` | Boolean that specifies whether to wait for a VPC Peering creation to complete before returning control to the terminal<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/create/#global-flags)
