---
url: "https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_droplets/"
title: "pydo.load_balancers.add_droplets() | DigitalOcean Documentation"
---
...
# pydo.load\_balancers.add\_droplets()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/loadBalancers_add_droplets) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_droplets/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_droplets/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_droplets/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_droplets/#more-information)
