---
url: "https://docs.digitalocean.com/reference/doctl/reference/auth/token/"
title: "doctl auth token | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl auth](https://docs.digitalocean.com/reference/doctl/reference/auth/)
      - [init](https://docs.digitalocean.com/reference/doctl/reference/auth/init/)
      - [list](https://docs.digitalocean.com/reference/doctl/reference/auth/list/)
      - [remove](https://docs.digitalocean.com/reference/doctl/reference/auth/remove/)
      - [switch](https://docs.digitalocean.com/reference/doctl/reference/auth/switch/)
      - [token](https://docs.digitalocean.com/reference/doctl/reference/auth/token/)
...
Display the current authentication context’s token that you created with `doctl auth init`.
...
The following example displays the token of the current context:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/auth/token/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/auth/token/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/auth/token/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/auth/token/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/token/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/auth/token/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/token/#global-flags)
