---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_schema_version/"
title: "pydo.databases.get_kafka_schema_version() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- get\_kafka\_schema\_version()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.get\_kafka\_schema\_version()
...
| `version` | string | True | The version of the Kafka schema subject. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_kafka_schema_version) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_schema_version/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_schema_version/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_schema_version/#more-information)
