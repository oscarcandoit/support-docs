---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/"
title: "doctl compute droplet-action | DigitalOcean Documentation"
---
...
Use the subcommands of `doctl compute droplet-action` to perform actions on Droplets.
...
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/#global-flags)
