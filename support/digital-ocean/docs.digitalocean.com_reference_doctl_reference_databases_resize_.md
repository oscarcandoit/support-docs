---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/resize/"
title: "doctl databases resize | DigitalOcean Documentation"
---
...
Resizes the specified database cluster.
...
| `--num-nodes` | The number of nodes in the database cluster. Valid values are 1-3. In addition to the primary node, up to two standby nodes may be added for high availability. (required)<br>Default: `0` |
| `--size` | The size of the nodes in the database cluster, for example `db-s-1vcpu-1gb` indicates a 1 CPU, 1GB node. For a list of available size slugs, visit: [https://docs.digitalocean.com/reference/api/api-reference/#tag/Databases](https://docs.digitalocean.com/reference/api/api-reference/#tag/Databases) (required) |
...
| `--wait` | Boolean that specifies whether to wait for the resize to complete before returning control to the terminal<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/resize/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/resize/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/resize/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/resize/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/resize/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/resize/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/resize/#global-flags)
