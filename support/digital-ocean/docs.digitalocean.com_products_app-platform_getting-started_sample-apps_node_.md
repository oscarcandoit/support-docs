---
url: "https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/node/"
title: "Sample App for Node.js | DigitalOcean Documentation"
---
...
> This content is automatically generated from [https://github.com/digitalocean/sample-nodejs/blob/main/README.md](https://github.com/digitalocean/sample-nodejs/blob/main/README.md).
...
- Both the npm and Yarn package managers are supported. However, you must commit either `package-lock.json` for npm projects or `yarn.lock` for Yarn projects to the repo alongside the app’s source code.

In this article...

- [Limits](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/node/#limits)
