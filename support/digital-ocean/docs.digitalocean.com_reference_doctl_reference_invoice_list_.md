---
url: "https://docs.digitalocean.com/reference/doctl/reference/invoice/list/"
title: "doctl invoice list | DigitalOcean Documentation"
---
...
Lists all of the invoices on your account including the UUID, amount in USD, and time period for each.

## Example

The following example lists all of the invoices on your account and uses the `--format` flag to only return the product name and the amount charged for it:

```shell
doctl invoice list --format Product,Amount
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/invoice/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/invoice/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/invoice/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/invoice/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/invoice/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/invoice/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/invoice/list/#global-flags)
