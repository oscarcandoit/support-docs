---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/region/list/"
title: "doctl compute region list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [region](https://docs.digitalocean.com/reference/doctl/reference/compute/region/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/region/list/)
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Slug`, `Name`, `Available`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/region/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/region/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/region/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/region/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/region/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/region/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/region/list/#global-flags)
