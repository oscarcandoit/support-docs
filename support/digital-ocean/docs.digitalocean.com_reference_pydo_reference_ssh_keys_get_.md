---
url: "https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/get/"
title: "pydo.ssh_keys.get() | DigitalOcean Documentation"
---
...
The response will be a JSON object with the key `ssh_key` and value an ssh\_key object which contains the standard ssh\_key attributes.
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/sshKeys_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/get/#more-information)
