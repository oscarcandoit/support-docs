---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/get-job-invocation/"
title: "doctl apps get-job-invocation | DigitalOcean Documentation"
---
...
```shell
doctl apps get-job-invocation <app id> <job invocation id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/get-job-invocation/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/get-job-invocation/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/get-job-invocation/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/get-job-invocation/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/get-job-invocation/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/get-job-invocation/#global-flags)
