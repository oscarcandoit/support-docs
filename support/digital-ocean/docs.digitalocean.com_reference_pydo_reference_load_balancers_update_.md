---
url: "https://docs.digitalocean.com/reference/pydo/reference/load_balancers/update/"
title: "pydo.load_balancers.update() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/loadBalancers_update) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/update/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/update/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/update/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/update/#more-information)
