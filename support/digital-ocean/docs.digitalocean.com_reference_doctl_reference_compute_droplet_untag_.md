---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/untag/"
title: "doctl compute droplet untag | DigitalOcean Documentation"
---
...
```shell
doctl compute droplet untag <droplet-id|droplet-name> [flags]
```

## Description

Removes a tag from a Droplet. Specify the tag with the `--tag-name` flag.

## Example

The following example removes the tag `frontend` from a Droplet with the ID `386734086`:

```shell
doctl compute droplet untag 386734086 --tag-name frontend
```
...
| `--tag-name` | The tag name to remove from Droplet |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/untag/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/untag/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/untag/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/untag/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/untag/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/untag/#global-flags)
