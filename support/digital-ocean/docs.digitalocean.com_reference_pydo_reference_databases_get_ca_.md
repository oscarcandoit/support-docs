---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_ca/"
title: "pydo.databases.get_ca() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_ca) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_ca/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_ca/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/get_ca/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_ca/#more-information)
