---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/list/"
title: "doctl apps tier instance-size list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl apps](https://docs.digitalocean.com/reference/doctl/reference/apps/)
      ...
      - [tier](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/)
        - [instance-size](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/)
          - [get](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/get/)
          - [list](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/list/)
...
```shell
doctl apps tier instance-size list [flags]
```
...
Use this command to list all the available app instance sizes.
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/list/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/tier/instance-size/list/#global-flags)
