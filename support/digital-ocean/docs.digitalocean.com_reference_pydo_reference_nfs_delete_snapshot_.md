---
url: "https://docs.digitalocean.com/reference/pydo/reference/nfs/delete_snapshot/"
title: "pydo.nfs.delete_snapshot() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `nfs_snapshot_id` | string | True | The unique ID of the NFS snapshot |  |
| `region` | string | True | The DigitalOcean region slug (e.g., nyc2, atl1) where the NFS share resides. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/nfs_delete_snapshot) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/nfs/delete_snapshot/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/nfs/delete_snapshot/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/nfs/delete_snapshot/#more-information)
