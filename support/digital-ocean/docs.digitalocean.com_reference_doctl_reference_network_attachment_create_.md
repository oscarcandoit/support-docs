---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/attachment/create/"
title: "doctl network attachment create | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl network](https://docs.digitalocean.com/reference/doctl/reference/network/)
      - [attachment](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get/)
        - [get-bgp-auth-key](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-bgp-auth-key/)
        - [get-service-key](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-service-key/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/list/)
        - [list-routes](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/list-routes/)
        - [regenerate-service-key](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/regenerate-service-key/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/update/)
      - [byoip-prefix](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/)
...
```shell
doctl network attachment create [flags]
```
...
Use this command to create a new Partner Attachment on your account.

## Flags

| Option | Description |
| --- | --- |
| `--bgp-auth-key` | BGP Auth Key |
| `--bgp-local-asn` | BGP Local ASN<br>Default: `0` |
| `--bgp-local-router-ip` | BGP Local Router IP |
| `--bgp-peer-asn` | BGP Peer ASN<br>Default: `0` |
| `--bgp-peer-router-ip` | BGP Peer Router IP |
| `--connection-bandwidth-in-mbps` | Connection Bandwidth in Mbps (required)<br>Default: `0` |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Name`, `State`, `ConnectionBandwidthInMbps`, `Region`, `NaaSProvider`, `VPCIDs`, `CreatedAt`, `BGPLocalASN`, `BGPLocalRouterIP`, `BGPPeerASN`, `BGPPeerRouterIP`, `RedundancyZone`, `ParentUUID`, `Children`. |
| `--help`, `-h` | Help for this command |
| `--naas-provider` | NaaS Provider (required) |
| `--name` | Name of the Partner Attachment (required) |
| `--no-header` | Return raw data with no headers<br>Default: `false` |
| `--parent-uuid` | HA Parent UUID (optional) |
| `--redundancy-zone` | Redundancy Zone (optional) |
| `--region` | Region (required) |
| `--type` | Specify connect type (e.g., partner)<br>Default: `partner` |
| `--vpc-ids` | VPC network IDs (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/create/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/create/#global-flags)
