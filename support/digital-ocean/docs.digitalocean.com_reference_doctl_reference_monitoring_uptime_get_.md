---
url: "https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/get/"
title: "doctl monitoring uptime get | DigitalOcean Documentation"
---
...
```shell
doctl monitoring uptime get <uptime-check-id> [flags]
```
...
```shell
doctl monitoring uptime get f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/get/#global-flags)
