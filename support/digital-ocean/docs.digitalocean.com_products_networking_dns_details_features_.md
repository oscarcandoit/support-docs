---
url: "https://docs.digitalocean.com/products/networking/dns/details/features/"
title: "DNS Features | DigitalOcean Documentation"
---
...
Our name servers are `ns1.digitalocean.com`, `ns2.digitalocean.com`, and `ns3.digitalocean.com`.

## Fully Managed SSL Certificates

Managing domains on DigitalOcean also enables our Let’s Encrypt integration for fully managed SSL certificates, which work with [custom Spaces CDN endpoints](https://docs.digitalocean.com/products/spaces/how-to/customize-cdn-endpoint/) and [SSL termination on DigitalOcean Load Balancers](https://docs.digitalocean.com/products/networking/load-balancers/how-to/ssl-termination/#use-lets-encrypt).

In this article...

- [Supported Records](https://docs.digitalocean.com/products/networking/dns/details/features/#supported-records)
- [Fully Managed SSL Certificates](https://docs.digitalocean.com/products/networking/dns/details/features/#fully-managed-ssl-certificates)
