---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/spaces_buckets/"
title: "digitalocean_spaces_buckets | DigitalOcean Documentation"
---
...
Note: You can use the [`digitalocean_spaces_bucket`](https://docs.digitalocean.com/reference/terraform/reference/data-sources/spaces_buckets/spaces_bucket) data source to
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/spaces_buckets/#example-usage)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/spaces_buckets/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/spaces_buckets/#attributes-reference)
