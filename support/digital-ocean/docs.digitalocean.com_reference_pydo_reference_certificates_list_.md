---
url: "https://docs.digitalocean.com/reference/pydo/reference/certificates/list/"
title: "pydo.certificates.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/certificates_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/certificates/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/certificates/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/certificates/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/certificates/list/#more-information)
