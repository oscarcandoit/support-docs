---
url: "https://docs.digitalocean.com/reference/pydo/reference/domains/list_records/"
title: "pydo.domains.list_records() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/domains_list_records) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/domains/list_records/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/domains/list_records/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/domains/list_records/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/domains/list_records/#more-information)
