---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/delete_agent/"
title: "pydo.genai.delete_agent() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `uuid` | string | True | Unique agent id |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_delete_agent) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/delete_agent/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/delete_agent/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/delete_agent/#more-information)
