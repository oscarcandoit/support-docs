---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_logsink/"
title: "pydo.databases.update_logsink() | DigitalOcean Documentation"
---
...
# pydo.databases.update\_logsink()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_logsink) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_logsink/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_logsink/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_logsink/#more-information)
