---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/list/"
title: "doctl genai openai-key list | DigitalOcean Documentation"
---
...
```shell
doctl genai openai-key list [flags]
```
...
The following example lists information about all OpenAI API Keys
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/list/#global-flags)
