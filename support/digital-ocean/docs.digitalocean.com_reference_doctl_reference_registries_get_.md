---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/get/"
title: "doctl registries get | DigitalOcean Documentation"
---
...
```shell
doctl registries get <registry-name> [flags]
```
...
Retrieves information about a registry in your account, including:
...
The following example retrieves information about a registry named `example-registry`:

```shell
doctl registries get example-registry
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/get/#global-flags)
