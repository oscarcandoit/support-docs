---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/tag/"
title: "doctl compute droplet tag | DigitalOcean Documentation"
---
...
Applies a tag to a Droplet. Specify the tag with the `--tag-name` flag.
...
| `--tag-name` | the tag name apply to the Droplet. You can use a new or existing tag. (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/tag/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/tag/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/tag/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/tag/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/tag/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/tag/#global-flags)
