---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete/"
title: "doctl compute droplet-autoscale delete | DigitalOcean Documentation"
---
...
# doctl compute droplet-autoscale delete
...
```shell
doctl compute droplet-autoscale delete <autoscale-pool-id> [flags]
```
...
| Option | Description |
| --- | --- |
| `--force` | Force delete without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete/#aliases)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete/#global-flags)
