---
url: "https://docs.digitalocean.com/support/how-do-i-fix-the-pg_dump-aborting-because-of-server-version-mismatch-error/"
title: "How do I fix the pg_dump \"aborting because of server version mismatch\" error? | DigitalOcean Documentation"
---
...
If you want to match your `pg_dump` to the current server version, you can install a specific `pg_dump` version. For more information about PostgreSQL versions, see the [official PostgreSQL release notes](https://www.postgresql.org/docs/release/).
...
Tip
We recommend you to refer to the [official documentation](https://www.postgresql.org/docs/current/app-pgdump.html) for more detailed instructions and version compatibility guidelines about the resources specific to your PostgreSQL version and the backup tools.
...
- [Upgrade `pg_dump` version](https://docs.digitalocean.com/support/how-do-i-fix-the-pg_dump-aborting-because-of-server-version-mismatch-error/#upgrade-pg_dump-version)
- [Use a third-party backup tool](https://docs.digitalocean.com/support/how-do-i-fix-the-pg_dump-aborting-because-of-server-version-mismatch-error/#use-a-third-party-backup-tool)
