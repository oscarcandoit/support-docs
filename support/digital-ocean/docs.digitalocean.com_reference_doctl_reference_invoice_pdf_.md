---
url: "https://docs.digitalocean.com/reference/doctl/reference/invoice/pdf/"
title: "doctl invoice pdf | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl invoice](https://docs.digitalocean.com/reference/doctl/reference/invoice/)
      - [csv](https://docs.digitalocean.com/reference/doctl/reference/invoice/csv/)
      - [get](https://docs.digitalocean.com/reference/doctl/reference/invoice/get/)
      - [list](https://docs.digitalocean.com/reference/doctl/reference/invoice/list/)
      - [pdf](https://docs.digitalocean.com/reference/doctl/reference/invoice/pdf/)
      - [summary](https://docs.digitalocean.com/reference/doctl/reference/invoice/summary/)
...
```shell
doctl invoice pdf <invoice-uuid> <output-file.pdf> [flags]
```
...
This command downloads a PDF summary of a specific invoice to the provided location.

Use the `doctl invoice list` command to find the UUID of the invoice to retrieve.

## Example

The following example downloads a PDF summary of an invoice with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6` to the file `invoice.pdf`:

```shell
doctl invoice pdf f81d4fae-7dec-11d0-a765-00a0c91e6bf6 invoice.pdf
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/invoice/pdf/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/invoice/pdf/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/invoice/pdf/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/invoice/pdf/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/invoice/pdf/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/invoice/pdf/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/invoice/pdf/#global-flags)
