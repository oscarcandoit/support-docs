---
url: "https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/flask/"
title: "Sample App for Flask | DigitalOcean Documentation"
---
...
# Sample App for Flask

Generated on 25 Nov 2025

App Platform is a Platform-as-a-Service (PaaS) offering that allows developers to publish code directly to DigitalOcean servers without worrying about the underlying infrastructure.

The Python buildpack applies to this sample app. See the [Python buildpack overview](https://docs.digitalocean.com/products/app-platform/reference/buildpacks/python/) for more information about its configuration options and limitations.

> This content is automatically generated from [https://github.com/digitalocean/sample-flask/blob/main/README.md](https://github.com/digitalocean/sample-flask/blob/main/README.md).
...
The default version for Python is currently 3.9.4. To use a different Python version, create a `runtime.txt` file at the top level of your repository and include a line with the version of Python you want to use using the format `python-<MAJOR.MINOR.PATCH>`. For example, to use Python 3.8.8, your `runtime.txt` would look like this:
...
- When deploying a Flask repository that uses Gunicorn, App Platform will only detect a partial run command. You will need to add your app’s entrypoint to it like so: `gunicorn --worker-tmp-dir /dev/shm project.wsgi`, where `project` is the name of your project.

In this article...

- [Usage](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/flask/#usage)
- [Limits](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/flask/#limits)
