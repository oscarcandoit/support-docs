---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/update/"
title: "doctl compute ssh-key update | DigitalOcean Documentation"
---
...
```shell
doctl compute ssh-key update <key-id|key-fingerprint> [flags]
```
...
Use this command to update the name of an SSH key.
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/update/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/update/#global-flags)
