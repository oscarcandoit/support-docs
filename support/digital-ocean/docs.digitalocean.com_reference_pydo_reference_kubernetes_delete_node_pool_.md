---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node_pool/"
title: "pydo.kubernetes.delete_node_pool() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_delete_nodePool) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node_pool/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node_pool/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node_pool/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_node_pool/#more-information)
