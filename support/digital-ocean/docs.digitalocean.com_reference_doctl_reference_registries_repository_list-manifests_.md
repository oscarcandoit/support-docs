---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-manifests/"
title: "doctl registries repository list-manifests | DigitalOcean Documentation"
---
...
# doctl registries repository list-manifests
...
```shell
doctl registries repository list-manifests <registry-name> <repository> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-manifests/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-manifests/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-manifests/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-manifests/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-manifests/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-manifests/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-manifests/#global-flags)
