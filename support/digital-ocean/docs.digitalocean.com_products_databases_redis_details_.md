---
url: "https://docs.digitalocean.com/products/databases/redis/details/"
title: "Caching Details | DigitalOcean Documentation"
---
...
Pricing information for Caching database clusters.

![](https://docs.digitalocean.com/images/icons/redis.svg)

Caching Availability

Regional datacenter availability for Caching.

![](https://docs.digitalocean.com/images/icons/redis.svg)

Caching Limits

Limits and known issues for Caching database clusters.
...
Caching database clusters reserve some memory for overhead to handle cluster operations, like backups and replication. Optimize Caching memory usage with cluster-level settings, like eviction policies, and application-level settings, like minimizing writes.

![](https://docs.digitalocean.com/images/icons/digitalocean.svg)

Managed Databases SLA

The service-level agreement for DigitalOcean Managed Databases.

digitalocean.com

In this article...

- [Additional Details](https://docs.digitalocean.com/products/databases/redis/details/#additional-details)
