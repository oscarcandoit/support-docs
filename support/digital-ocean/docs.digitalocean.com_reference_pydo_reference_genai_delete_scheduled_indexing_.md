---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/delete_scheduled_indexing/"
title: "pydo.genai.delete_scheduled_indexing() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `uuid` | string | True | UUID of the scheduled indexing |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_delete_scheduled_indexing) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/delete_scheduled_indexing/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/delete_scheduled_indexing/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/delete_scheduled_indexing/#more-information)
