---
url: "https://docs.digitalocean.com/support/how-do-i-disable-ipv6/"
title: "How do I disable IPv6? | DigitalOcean Documentation"
---
...
Validated on 28 Aug 2023 • Last edited on 17 Jun 2025

You cannot disable a Droplet’s IPv6 interface using the [DigitalOcean Control Panel](https://cloud.digitalocean.com/) after the Droplet has been activated. However, you can disable it by making changes to its network interface configuration.

Alternatively, you can also block all IPv6 traffic to the Droplet using a [cloud firewall rule](https://docs.digitalocean.com/products/networking/firewalls/how-to/create/).

## Prerequisites

Altering network configurations can cause you to lose access to your Droplet or other problems. We recommend [taking a snapshot of the Droplet](https://docs.digitalocean.com/products/snapshots/how-to/snapshot-droplets/) before making any changes to its network configuration. You can use the snapshot to [rebuild the Droplet](https://docs.digitalocean.com/products/snapshots/how-to/create-and-restore-droplets/) to the state it was in at the time when you took the snapshot.
...
- [Prerequisites](https://docs.digitalocean.com/support/how-do-i-disable-ipv6/#prerequisites)
- [Update Network Interface](https://docs.digitalocean.com/support/how-do-i-disable-ipv6/#update-network-interface)
