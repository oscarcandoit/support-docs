---
url: "https://docs.digitalocean.com/support/i-dont-recognize-a-charge-on-my-invoice/"
title: "I don't recognize a charge on my invoice | DigitalOcean Documentation"
---
...
Validated on 4 Oct 2022 • Last edited on 25 Nov 2024

If you don’t recognize a charge on your invoice, you can download the CSV version of your invoice for more detailed billing information.

Our standard PDF invoices ( [available in the control panel](https://docs.digitalocean.com/platform/billing/invoices/)) provide a general summary of service charges, including the total hours active for the month and associated costs. The CSV copy of your invoice provides additional information, such as:

- Individual line item charges for all instances created on the account.
- Individual line item charges for services that include multiple feature charges, such as Kubernetes nodes and load balancers.

To download your CSV invoice from the [Billing page](https://cloud.digitalocean.com/billing), click **CSV** in the **Month-to-date Summary** section.

![Month-to-date Summary section](https://docs.digitalocean.com/screenshots/billing/month-to-date-summary.4b8494f586d5521a13111c58dc1442651468c671874d83bb8f26f3f7991251e4.png)

## Unexpected Charges

If your invoice includes charges you did not expect, they may be from the following:

- **A free trial ended.** To stop these charges, destroy the services or resources before the free trial period ends.

- **Droplets that are powered down but not destroyed.** Droplets incur charges for as long as they remain on the platform, even if they are powered down. To stop these charges, [destroy the Droplets](https://docs.digitalocean.com/products/droplets/how-to/destroy/).

- **Bandwidth overage charges.** Droplets, App Platform apps, Spaces, and managed databases can incur [bandwidth overage charges](https://docs.digitalocean.com/platform/billing/bandwidth/). To avoid bandwidth overage charges, you can increase the size of your Droplet or reconfigure your resources to [use VPC networks](https://docs.digitalocean.com/products/networking/vpc/how-to/add-resources/).

- **[Unassigned reserved IP addresses](https://docs.digitalocean.com/products/networking/reserved-ips/details/pricing/).** Reserved IP addresses are free when assigned to a resource, such as a Droplet. However, they incur charges when not assigned. To avoid incurring charges for unassigned reserved IP addresses, you must assign them to a resource or destroy them.

- **Kubernetes autoscaling charges.** Kubernetes autoscaling automatically adds and removes resources to your app based on its workload. To avoid incurring charges for autoscaling, you must [disable autoscaling](https://docs.digitalocean.com/products/kubernetes/how-to/autoscale/#disabling-autoscaling) or destroy the resources.


If you have additional questions about unexpected charges, [contact support](https://cloud.digitalocean.com/support).
...
- [Unexpected Charges](https://docs.digitalocean.com/support/i-dont-recognize-a-charge-on-my-invoice/#unexpected-charges)
