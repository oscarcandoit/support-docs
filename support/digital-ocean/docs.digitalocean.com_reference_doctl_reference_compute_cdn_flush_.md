---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/flush/"
title: "doctl compute cdn flush | DigitalOcean Documentation"
---
...
Examples:
doctl compute cdn flush  –files /path/to/assets/\*
doctl compute cdn flush  –files “/path/to/file.one, /path/to/file.two”
doctl compute cdn flush  –files /path/to/file.one –files /path/to/file.two
doctl compute cdn flush  –files \*
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/flush/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/flush/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/flush/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/flush/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/flush/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/flush/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/flush/#global-flags)
