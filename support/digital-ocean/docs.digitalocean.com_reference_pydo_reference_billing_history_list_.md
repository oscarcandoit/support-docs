---
url: "https://docs.digitalocean.com/reference/pydo/reference/billing_history/list/"
title: "pydo.billing_history.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [billing\_history](https://docs.digitalocean.com/reference/pydo/reference/billing_history/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/billing_history/list/)
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/billingHistory_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/billing_history/list/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/billing_history/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/billing_history/list/#more-information)
