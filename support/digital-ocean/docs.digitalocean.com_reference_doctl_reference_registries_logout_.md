---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/logout/"
title: "doctl registries logout | DigitalOcean Documentation"
---
...
```shell
doctl registries logout <registry-name> [flags]
```
...
The following example logs Docker out of a registry named `example-registry`:

```shell
doctl registries logout example-registry
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/logout/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/logout/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/logout/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/logout/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/logout/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/logout/#global-flags)
