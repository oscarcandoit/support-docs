---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list-datasources/"
title: "doctl genai knowledge-base list-datasources | DigitalOcean Documentation"
---
...
# doctl genai knowledge-base list-datasources
...
```shell
doctl genai knowledge-base list-datasources <knowledge-base-uuid> [flags]
```
...
List all datasource for a valid knowledge base uuid.

## Example

The following example retrieves information about all Data Sources with the Knowledge Base ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6` :
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list-datasources/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list-datasources/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list-datasources/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list-datasources/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list-datasources/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list-datasources/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list-datasources/#global-flags)
