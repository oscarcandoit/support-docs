---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_test_cases/"
title: "pydo.genai.list_evaluation_test_cases() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_evaluation_test_cases) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_test_cases/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_evaluation_test_cases/#more-information)
