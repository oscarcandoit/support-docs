---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/create/"
title: "doctl compute reserved-ip create | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--droplet-id` | The ID of the Droplet to assign the reserved IP to. Cannot be used with the `--region` flag.<br>Default: `0` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/create/#global-flags)
