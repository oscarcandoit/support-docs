---
url: "https://docs.digitalocean.com/support/can-i-disable-unsafe-sysctl-on-digitalocean-kubernetes/"
title: "Can I disable unsafe sysctl on DigitalOcean Kubernetes? | DigitalOcean Documentation"
---
...
- Launch a privileged Init Container to set the value inside the container’s net namespace. Works with both namespaced and non-namespaced `sysctl`s.
- Run a DaemonSet on every node with privileged containers and modify non-namespaced `sysctl`s.
...
[Can I disable unsafe sysctl on DigitalOcean Kubernetes?](https://docs.digitalocean.com/support/can-i-disable-unsafe-sysctl-on-digitalocean-kubernetes/)
