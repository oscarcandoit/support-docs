---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/get/"
title: "doctl registry get | DigitalOcean Documentation"
---
...
Retrieves details about a private container registry, including its name and the endpoint used to access it.

## Example

The following example retrieves details about a registry named `example-registry`:

```shell
doctl registry get example-registry
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Name`, `Endpoint`, `Region`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registry/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registry/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/get/#global-flags)
