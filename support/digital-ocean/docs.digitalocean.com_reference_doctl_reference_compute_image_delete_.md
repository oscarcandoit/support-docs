---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/image/delete/"
title: "doctl compute image delete | DigitalOcean Documentation"
---
...
Permanently deletes an image from your account. This is irreversible.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Force image delete<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/image/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/image/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/image/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/image/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/image/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/delete/#global-flags)
