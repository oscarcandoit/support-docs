---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_firewall_rules/"
title: "pydo.databases.list_firewall_rules() | DigitalOcean Documentation"
---
...
# pydo.databases.list\_firewall\_rules()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_firewall_rules) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_firewall_rules/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_firewall_rules/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/list_firewall_rules/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_firewall_rules/#more-information)
