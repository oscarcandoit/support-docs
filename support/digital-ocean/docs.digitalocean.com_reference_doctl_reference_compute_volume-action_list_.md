---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/list/"
title: "doctl compute volume-action list | DigitalOcean Documentation"
---
...
The following example retrieves a list of actions taken on a volume with the UUID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`. The command also uses the `--format` flag to return only the resource ID and status for each action listed:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/list/#global-flags)
