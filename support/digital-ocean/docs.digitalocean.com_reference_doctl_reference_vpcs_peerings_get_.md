---
url: "https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/get/"
title: "doctl vpcs peerings get | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl vpcs](https://docs.digitalocean.com/reference/doctl/reference/vpcs/)
      - [create](https://docs.digitalocean.com/reference/doctl/reference/vpcs/create/)
      - [delete](https://docs.digitalocean.com/reference/doctl/reference/vpcs/delete/)
      - [get](https://docs.digitalocean.com/reference/doctl/reference/vpcs/get/)
      - [list](https://docs.digitalocean.com/reference/doctl/reference/vpcs/list/)
      - [peerings](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/list/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/update/)
      - [update](https://docs.digitalocean.com/reference/doctl/reference/vpcs/update/)
...
```shell
doctl vpcs peerings get <peering-id> [flags]
```
...
Retrieves information about a VPC Peering, including:
...
The following example retrieves information about a VPC Peering with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl vpcs peerings get f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Name`, `VPCIDs`, `Status`, `Created`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/get/#global-flags)
