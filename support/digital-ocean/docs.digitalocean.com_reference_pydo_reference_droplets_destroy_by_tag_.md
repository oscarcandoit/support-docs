---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_by_tag/"
title: "pydo.droplets.destroy_by_tag() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `tag_name` | string | True | Specifies Droplets to be deleted by tag. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_destroy_byTag) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_by_tag/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_by_tag/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_by_tag/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_by_tag/#more-information)
