---
url: "https://docs.digitalocean.com/products/databases/valkey/details/pricing/"
title: "Valkey Pricing | DigitalOcean Documentation"
---
...
All managed databases are deployed onto Droplets with either [shared or dedicated CPU](https://docs.digitalocean.com/products/droplets/concepts/choosing-a-plan/#shared-vs-dedicated). For a list of the Droplet plans we offer for Valkey, see the [Managed Databases pricing page](https://www.digitalocean.com/pricing/managed-databases).

In this article...

- [Plans for Cluster Nodes](https://docs.digitalocean.com/products/databases/valkey/details/pricing/#plans-for-cluster-nodes)
