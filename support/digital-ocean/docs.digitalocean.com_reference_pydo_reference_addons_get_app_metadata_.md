---
url: "https://docs.digitalocean.com/reference/pydo/reference/addons/get_app_metadata/"
title: "pydo.addons.get_app_metadata() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [addons](https://docs.digitalocean.com/reference/pydo/reference/addons/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/addons/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/addons/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/addons/get/)
      - [get\_app()](https://docs.digitalocean.com/reference/pydo/reference/addons/get_app/)
      - [get\_app\_metadata()](https://docs.digitalocean.com/reference/pydo/reference/addons/get_app_metadata/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/addons/list/)
      - [patch()](https://docs.digitalocean.com/reference/pydo/reference/addons/patch/)
      - [patch\_plan()](https://docs.digitalocean.com/reference/pydo/reference/addons/patch_plan/)
...
# pydo.addons.get\_app\_metadata()
...
| --- | --- | --- | --- | --- |
| `app_slug` | string | True | The slug identifier for the application whose metadata is being requested. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/addons_get_app_metadata) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/addons/get_app_metadata/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/addons/get_app_metadata/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/addons/get_app_metadata/#more-information)
