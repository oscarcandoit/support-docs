---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/list/"
title: "doctl genai agent apikeys list | DigitalOcean Documentation"
---
...
# doctl genai agent apikeys list
...
```shell
doctl genai agent apikeys list [flags]
```
...
The following example lists the apikeys for an agent with ID 12345678-1234-1234-1234-123456789013:
...
| Option | Description |
| --- | --- |
| `--agent-id` | The ID of the agent for which to list API Keys |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/apikeys/list/#global-flags)
