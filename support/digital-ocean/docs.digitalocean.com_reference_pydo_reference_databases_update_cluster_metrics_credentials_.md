---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_cluster_metrics_credentials/"
title: "pydo.databases.update_cluster_metrics_credentials() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- update\_cluster\_metrics\_credentials()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.update\_cluster\_metrics\_credentials()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_cluster_metrics_credentials) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_cluster_metrics_credentials/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_cluster_metrics_credentials/#more-information)
