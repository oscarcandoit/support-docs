---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/container_registry_docker_credentials/"
title: "digitalocean_container_registry_docker_credentials | DigitalOcean Documentation"
---
...
- [Provider Reference](https://docs.digitalocean.com/reference/terraform/reference/)
- [Resources](https://docs.digitalocean.com/reference/terraform/reference/resources/)
- digitalocean\_container\_registry\_docker\_credentials
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/container_registry_docker_credentials/#example-usage)
  - [Basic Example](https://docs.digitalocean.com/reference/terraform/reference/resources/container_registry_docker_credentials/#basic-example)
  - [Docker Provider Example](https://docs.digitalocean.com/reference/terraform/reference/resources/container_registry_docker_credentials/#docker-provider-example)
  - [Kubernetes Example](https://docs.digitalocean.com/reference/terraform/reference/resources/container_registry_docker_credentials/#kubernetes-example)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/container_registry_docker_credentials/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/container_registry_docker_credentials/#attributes-reference)
