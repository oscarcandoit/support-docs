---
url: "https://docs.digitalocean.com/platform/teams/settings/contact-emails/"
title: "Team Contact Emails | DigitalOcean Documentation"
---
...
Validated on 14 Mar 2025 • Last edited on 18 Mar 2025

The team contact email is where we send operational alerts and maintenance notices. By default, the team contact email is the email address of the person who created the team.

Everyone on a team can view the team contact email, but only owners can change it on [the team settings page](https://cloud.digitalocean.com/account/team).
...
[Team Contact Emails](https://docs.digitalocean.com/platform/teams/settings/contact-emails/)
