---
url: "https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list/"
title: "pydo.autoscalepools.list() | DigitalOcean Documentation"
---
...
| `name` | string | False | The name of the autoscale pool |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/autoscalepools_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list/#more-information)
