---
url: "https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/"
title: "DeepSeek R1 Distill Qwen 7B - Single GPU | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/)
...
from [the DeepSeek R1 Distill Qwen 7B - Single GPU catalog page](https://marketplace.digitalocean.com/apps/deepseek-r1-distill-qwen-7b-1x)
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=digitaloceanai-deepseekr1distil)

## Creating an App using the API

In addition to creating a Droplet from the DeepSeek R1 Distill Qwen 7B - Single GPU 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB DeepSeek R1 Distill Qwen 7B - Single GPU Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"digitaloceanai-deepseekr1distil"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying DeepSeek R1 Distill Qwen 7B - Single GPU
...
For more information please refer to [Ollama API docs](https://github.com/ollama/ollama/blob/main/docs/api.md)
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/#creating-an-app-using-the-api)
- [Getting Started After Deploying DeepSeek R1 Distill Qwen 7B - Single GPU](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/#getting-started-after-deploying-deepseek-r1-distill-qwen-7b---single-gpu)
- [Quickly Get Started With Your 1-Click Models](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/#quickly-get-started-with-your-1-click-models)
- [Troubleshooting](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/#troubleshooting)
  - [**Service Management**](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/#service-management)
  - [**Configuring HTTPS with TLS using Certbot and Caddy**](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/#configuring-https-with-tls-using-certbot-and-caddy)
  - [**Security Measures with Fail2Ban**](https://docs.digitalocean.com/products/marketplace/catalog/deepseek-r1-distill-qwen-7b-single-gpu/#security-measures-with-fail2ban)
