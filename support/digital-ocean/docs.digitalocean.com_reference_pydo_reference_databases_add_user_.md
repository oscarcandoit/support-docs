---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/add_user/"
title: "pydo.databases.add_user() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_add_user) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/add_user/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/add_user/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/add_user/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/add_user/#more-information)
