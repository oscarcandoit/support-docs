---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_cluster/"
title: "pydo.databases.destroy_cluster() | DigitalOcean Documentation"
---
...
# pydo.databases.destroy\_cluster()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_destroy_cluster) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_cluster/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_cluster/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_cluster/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_cluster/#more-information)
