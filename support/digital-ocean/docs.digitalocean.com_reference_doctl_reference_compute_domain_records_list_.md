---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/list/"
title: "doctl compute domain records list | DigitalOcean Documentation"
---
...
```shell
doctl compute domain records list <domain> [flags]
```
...
The following command lists the DNS records for the domain example.com. The command also uses the `--format` flag to only return each record’s ID, type, and TTL:

```shell
doctl compute domain records list example.com --format ID,Type,TTL
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/list/#global-flags)
