---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/monitoring_alert_policies_info/"
title: "monitoring_alert_policies_info | DigitalOcean Documentation"
---
...
Returns all alert policies that are configured for the given account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/monitoring\_list\_alertPolicy](https://docs.digitalocean.com/reference/api/api-reference/#operation/monitoring_list_alertPolicy).
...
| `msg`<br>str | always | Monitoring alert policies result information.<br>Sample:<br>```json<br>[<br>  "Current alert polices"<br>]<br>``` |
| `policies`<br>list | always | Monitoring alert policies.<br>Sample:<br>```json<br>[<br>  {<br>    "alerts": {<br>      "email": [<br>        "bob@example.com"<br>      ],<br>      "slack": [<br>        {<br>          "channel": "Production Alerts",<br>          "url": "https://hooks.slack.com/services/T1234567/AAAAAAAA/ZZZZZZ\""<br>        }<br>      ]<br>    },<br>    "compare": "GreaterThan",<br>    "description": "CPU Alert",<br>    "enabled": true,<br>    "entities": [<br>      192018292<br>    ],<br>    "tags": [<br>      "production_droplets"<br>    ],<br>    "type": "v1/insights/droplet/cpu",<br>    "uuid": "78b3da62-27e5-49ba-ac70-5db0b5935c64",<br>    "value": 80,<br>    "window": "5m"<br>  }<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/monitoring_alert_policies_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/monitoring_alert_policies_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/monitoring_alert_policies_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/monitoring_alert_policies_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/monitoring_alert_policies_info/#return-values)
