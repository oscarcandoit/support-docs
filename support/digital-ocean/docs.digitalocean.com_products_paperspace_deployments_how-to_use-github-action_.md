---
url: "https://docs.digitalocean.com/products/paperspace/deployments/how-to/use-github-action/"
title: "How to Deploy Using GitHub Actions with Gradient Deployments | DigitalOcean Documentation"
---
...
You can use the Paperspace Deploy GitHub Action and the following example to deploy an app on Paperspace or create a whole CI/CD workflow to build, push, and deploy a container image.

![](https://docs.digitalocean.com/images/icons/default.svg)

Paperspace Deploy Action Repo

github.com![](https://docs.digitalocean.com/images/icons/default.svg)

Paperspace Deploy Action Example

github.com![](https://docs.digitalocean.com/images/icons/default.svg)

GitHub Marketplace Paperspace Deploy Action

github.com

In this article...

[How to Deploy Using GitHub Actions with Gradient Deployments](https://docs.digitalocean.com/products/paperspace/deployments/how-to/use-github-action/)
