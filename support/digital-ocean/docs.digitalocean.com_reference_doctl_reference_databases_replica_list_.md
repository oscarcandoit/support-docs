---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/replica/list/"
title: "doctl databases replica list | DigitalOcean Documentation"
---
...
```shell
doctl databases replica list <database-cluster-id> [flags]
```
...
```shell
doctl databases replica list ca9f591d-f38h-5555-a0ef-1c02d1d1e35 --format ID,URI
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/replica/list/#global-flags)
