---
url: "https://docs.digitalocean.com/products/marketplace/catalog/aapanel/"
title: "aaPanel | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/)
...
from [the aaPanel catalog page](https://marketplace.digitalocean.com/apps/aapanel)
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=aapanel)
...
curl -X POST -H 'Content-Type: application/json' \
        ...
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"aapanel"}' \
...
- [What is aaPanel](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#what-is-aapanel)
  - [Free and Easy-to-use Web Hosting Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#free-and-easy-to-use-web-hosting-control-panel)
  - [Simple and smart visualization](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#simple-and-smart-visualization)
  - [Become a master of server management easily](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#become-a-master-of-server-management-easily)
  - [Visible safety](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#visible-safety)
- [Functions](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#functions)
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#creating-an-app-using-the-api)
- [Getting Started After Deploying aaPanel](https://docs.digitalocean.com/products/marketplace/catalog/aapanel/#getting-started-after-deploying-aapanel)
