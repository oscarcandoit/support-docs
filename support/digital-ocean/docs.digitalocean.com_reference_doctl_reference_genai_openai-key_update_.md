---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/update/"
title: "doctl genai openai-key update | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl genai](https://docs.digitalocean.com/reference/doctl/reference/genai/)
      ...
      - [openai-key](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get/)
        - [get-agents](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get-agents/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/list/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/update/)
...
```shell
doctl genai openai-key update <openai-api-key-uuid> [flags]
```
...
The following example updates an OpenAI API Key with ID - f81d4fae-0000-11d0-a765-000000000000
...
| Option | Description |
| --- | --- |
| `--api-key` | The API key for the OpenAI API Key. |
...
| `--name` | The name of the OpenAI API Key. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/update/#global-flags)
