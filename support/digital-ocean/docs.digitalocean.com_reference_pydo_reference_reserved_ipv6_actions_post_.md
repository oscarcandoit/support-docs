---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6_actions/post/"
title: "pydo.reserved_ipv6_actions.post() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [reserved\_ipv6\_actions](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6_actions/)
      - [post()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6_actions/post/)
...
# pydo.reserved\_ipv6\_actions.post()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPv6Actions_post) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6_actions/post/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6_actions/post/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6_actions/post/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6_actions/post/#more-information)
