---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/resource/"
title: "doctl network byoip-prefix resource | DigitalOcean Documentation"
---
...
# doctl network byoip-prefix resource
...
```shell
doctl network byoip-prefix resource [flags]
```
...
Retrieves a list of all the Resources in your prefix.

## Example

The following example lists all resources in a byoip prefix:

```shell
doctl network byoip-prefix resource s 5ae545c4-0ac4-42bb-9de5-8eca3d17f1c0
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `IP`, `Region`, `Resource`, `AssignedAt`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/resource/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/resource/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/resource/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/resource/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/resource/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/resource/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/resource/#global-flags)
