---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/"
title: "digitalocean_database_cluster | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#example-usage)
  - [Create a new PostgreSQL database cluster](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#create-a-new-postgresql-database-cluster)
  - [Create a new MySQL database cluster](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#create-a-new-mysql-database-cluster)
  - [Create a new Valkey database cluster](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#create-a-new-valkey-database-cluster)
  - [Create a new Kafka database cluster](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#create-a-new-kafka-database-cluster)
  - [Create a new MongoDB database cluster](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#create-a-new-mongodb-database-cluster)
  - [Create a new OpenSearch database cluster](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#create-a-new-opensearch-database-cluster)
- [Create a new database cluster based on a backup of an existing cluster.](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#create-a-new-database-cluster-based-on-a-backup-of-an-existing-cluster)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/database_cluster/#import)
