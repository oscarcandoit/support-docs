---
url: "https://docs.digitalocean.com/reference/pydo/reference/domains/get_record/"
title: "pydo.domains.get_record() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/domains_get_record) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/domains/get_record/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/domains/get_record/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/domains/get_record/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/domains/get_record/#more-information)
