---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/update/"
title: "doctl network byoip-prefix update | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl network](https://docs.digitalocean.com/reference/doctl/reference/network/)
      ...
      - [byoip-prefix](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/list/)
        - [resource](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/resource/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/update/)
...
# doctl network byoip-prefix update
...
```shell
doctl network byoip-prefix update <prefix-uuid> [flags]
```
...
Updates the advertisement status of a BYOIP Prefix

## Example

The following example updates the byoip prefix `5ae545c4-0ac4-42bb-9de5-8eca3d17f1c0` to enable advertisement:

```shell
doctl network byoip-prefix update 5ae545c4-0ac4-42bb-9de5-8eca3d17f1c0 --advertise=true
```
...
| Option | Description |
| --- | --- |
| `--advertise` | Enable or disable advertisement of the BYOIP Prefix<br>Default: `false` |
| `--format` | Columns for output in a comma-separated list. Possible values: `Prefix`, `Region`, `Status`, `UUID`, `Advertised`, `FailureReason`, `Validations`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/update/#global-flags)
