---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/replace/"
title: "doctl databases firewalls replace | DigitalOcean Documentation"
---
...
The following example replaces the firewall rules for a database cluster, with the ID `ca9f591d-f38h-5555-a0ef-1c02d1d1e35`, with rules that allow a specific Droplet, a specific IP address, and any resources with the `example-tag` to access the database:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/replace/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/replace/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/replace/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/replace/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/replace/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/replace/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/replace/#global-flags)
