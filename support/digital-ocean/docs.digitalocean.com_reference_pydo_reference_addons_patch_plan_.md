---
url: "https://docs.digitalocean.com/reference/pydo/reference/addons/patch_plan/"
title: "pydo.addons.patch_plan() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `resource_uuid` | string | True | The UUID of the add-on resource to update. |  |
| `body` | JSON or IO\[bytes\] | True |  |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/addons_patch_plan) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/addons/patch_plan/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/addons/patch_plan/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/addons/patch_plan/#more-information)
