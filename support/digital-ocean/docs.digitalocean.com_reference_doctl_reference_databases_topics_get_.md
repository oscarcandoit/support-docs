---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/topics/get/"
title: "doctl databases topics get | DigitalOcean Documentation"
---
...
```shell
doctl databases topics get <database-uuid> <topic-name> [flags]
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `key`, `value`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/get/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/get/#global-flags)
