---
url: "https://docs.digitalocean.com/reference/pydo/reference/projects/list_resources_default/"
title: "pydo.projects.list_resources_default() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [projects](https://docs.digitalocean.com/reference/pydo/reference/projects/)
- list\_resources\_default()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.projects.list\_resources\_default()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/projects_list_resources_default) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/projects/list_resources_default/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/projects/list_resources_default/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/projects/list_resources_default/#more-information)
