---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-private-networking/"
title: "doctl compute droplet-action enable-private-networking | DigitalOcean Documentation"
---
...
Once you have manually enabled private networking for a Droplet, the Droplet requires additional internal network configuration for it to become accessible through the VPC network. For more information, see: [https://docs.digitalocean.com/products/networking/vpc/how-to/enable](https://docs.digitalocean.com/products/networking/vpc/how-to/enable)
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-private-networking/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-private-networking/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-private-networking/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-private-networking/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-private-networking/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-private-networking/#global-flags)
