---
url: "https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/"
title: "ROCm™ 7.1 Software | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/)
...
from [the ROCm™ 7.1 Software catalog page](https://marketplace.digitalocean.com/apps/rocm-7-1-software)

Run a ready-to-use Docker image with JupyterLab IDE on top of your ROCm-enabled system! All software is preinstalled under containers, so you can jump straight into your workflow—get started with either SSH or Jupyter.

## Software Included

| Package | Version | License |
| --- | --- | --- |
| ROCm (host system) | 7.1 | [MIT License](https://rocm.docs.amd.com/en/latest/about/license.html) |
| ROCm (in Docker image) | 7.1 | [MIT License](https://rocm.docs.amd.com/en/latest/about/license.html) |
| JupyterLab (in Docker image) | 4.5.0 | [BSD-3-Clause license](https://jupyter.org/governance/projectlicense/) |

## Creating an App using the Control Panel

Click the **Deploy to DigitalOcean** button to create a Droplet based on this 1-Click App. If you aren’t logged in, this link will prompt you to log in with your DigitalOcean account.

[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?onboarding_origin=marketplace&appId=207153643&image=amd-rocm71software&activation_redirect=%2Fdroplets%2Fnew%3FappId%3D207153643%26image%3Damd-rocm71software)

## Creating an App using the API

In addition to creating a Droplet from the ROCm™ 7.1 Software 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB ROCm™ 7.1 Software Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"amd-rocm71software"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying ROCm™ 7.1 Software

## Accessing ROCm resources and libraries

There are two ways to utilise ROCm resources and libraries: directly from JupyterLab, or via a Docker container.
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/#creating-an-app-using-the-api)
- [Getting Started After Deploying ROCm™ 7.1 Software](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/#getting-started-after-deploying-rocm-71-software)
- [Accessing ROCm resources and libraries](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/#accessing-rocm-resources-and-libraries)
- [SSHing into your AMD 1-Click](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/#sshing-into-your-amd-1-click)
- [Exploring via Jupyter](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/#exploring-via-jupyter)
- [Exploring via Docker](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-7-1-software/#exploring-via-docker)
