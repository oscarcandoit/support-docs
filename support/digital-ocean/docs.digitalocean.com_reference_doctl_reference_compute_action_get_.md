---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/action/get/"
title: "doctl compute action get | DigitalOcean Documentation"
---
...
```shell
doctl compute action get <action-id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/action/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/action/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/action/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/action/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/action/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/action/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/action/get/#global-flags)
