---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/create_oauth2_dropbox_tokens/"
title: "pydo.genai.create_oauth2_dropbox_tokens() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- create\_oauth2\_dropbox\_tokens()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_create_oauth2_dropbox_tokens) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/create_oauth2_dropbox_tokens/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/create_oauth2_dropbox_tokens/#more-information)
