---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/update/"
title: "doctl apps update | DigitalOcean Documentation"
---
...
| `--update-sources` | Boolean that specifies whether the app should also update its source code<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/update/#global-flags)
