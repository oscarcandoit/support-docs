---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/delete/"
title: "doctl registry delete | DigitalOcean Documentation"
---
...
Permanently deletes a private container registry and all of its contents. This is irreversible.

## Example

The following example deletes a registry named `example-registry`:

```shell
doctl registry delete example-registry
```
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Force deletes the registry without confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registry/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registry/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/delete/#global-flags)
