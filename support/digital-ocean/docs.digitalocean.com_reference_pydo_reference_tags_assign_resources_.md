---
url: "https://docs.digitalocean.com/reference/pydo/reference/tags/assign_resources/"
title: "pydo.tags.assign_resources() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/tags_assign_resources) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/tags/assign_resources/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/tags/assign_resources/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/tags/assign_resources/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/tags/assign_resources/#more-information)
