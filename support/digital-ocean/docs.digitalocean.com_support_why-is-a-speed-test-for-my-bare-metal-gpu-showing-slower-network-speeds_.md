---
url: "https://docs.digitalocean.com/support/why-is-a-speed-test-for-my-bare-metal-gpu-showing-slower-network-speeds/"
title: "Why is a speed test for my bare metal GPU showing slower network speeds? | DigitalOcean Documentation"
---
...
- Conducting end-to-end tests using a tool like [`iperf`](https://iperf.fr/).
...
If you’re running into network issues, [contact support](https://docs.digitalocean.com/products/bare-metal-gpus/support/contact/). For the fastest help, follow these steps:
...
[Why is a speed test for my bare metal GPU showing slower network speeds?](https://docs.digitalocean.com/support/why-is-a-speed-test-for-my-bare-metal-gpu-showing-slower-network-speeds/)
