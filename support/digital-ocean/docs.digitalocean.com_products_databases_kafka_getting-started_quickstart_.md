---
url: "https://docs.digitalocean.com/products/databases/kafka/getting-started/quickstart/"
title: "Kafka Quickstart | DigitalOcean Documentation"
---
...
Validated on 8 Dec 2022 • Last edited on 27 Sep 2023
...
2. Select Kafka as the database engine.
...
4. Select the node size.
5. Click **Save**.

## Add Additional Users or Databases

1. Select your database cluster from the [**Databases** page](https://cloud.digitalocean.com/databases).
2. Click the **Topics & Users** tab.
...
- [Create Kafka Clusters](https://docs.digitalocean.com/products/databases/kafka/getting-started/quickstart/#create-kafka-clusters)
- [Change Size or Number of Cluster Nodes](https://docs.digitalocean.com/products/databases/kafka/getting-started/quickstart/#change-size-or-number-of-cluster-nodes)
- [Add Additional Users or Databases](https://docs.digitalocean.com/products/databases/kafka/getting-started/quickstart/#add-additional-users-or-databases)
- [Delete Clusters](https://docs.digitalocean.com/products/databases/kafka/getting-started/quickstart/#delete-clusters)
