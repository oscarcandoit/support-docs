---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/start/"
title: "doctl registry garbage-collection start | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl registry](https://docs.digitalocean.com/reference/doctl/reference/registry/)
      ...
      - [garbage-collection](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/)
        - [cancel](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/cancel/)
        - [get-active](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/get-active/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/list/)
        - [start](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/start/)
...
The following example starts a garbage collection on a registry named `example-registry`:

```shell
doctl registry garbage-collection start example-registry
```
...
| Option | Description |
| --- | --- |
| `--exclude-unreferenced-blobs` | Exclude unreferenced blobs from garbage collection.<br>Default: `false` |
| `--force`, `-f` | Run garbage collection without confirmation prompt<br>Default: `false` |
...
| `--include-untagged-manifests` | Include untagged manifests in garbage collection.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/start/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/start/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/start/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/start/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/start/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/start/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/start/#global-flags)
