---
url: "https://docs.digitalocean.com/reference/pydo/reference/nfs/get_snapshot/"
title: "pydo.nfs.get_snapshot() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/nfs_get_snapshot) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/nfs/get_snapshot/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/nfs/get_snapshot/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/nfs/get_snapshot/#more-information)
