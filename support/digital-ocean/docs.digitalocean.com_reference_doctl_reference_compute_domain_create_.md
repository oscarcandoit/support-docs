---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/domain/create/"
title: "doctl compute domain create | DigitalOcean Documentation"
---
...
Adds a domain to your account that you can assign to Droplets, load balancers, and other resources.
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Domain`, `TTL`. |
| `--help`, `-h` | Help for this command |
| `--ip-address` | Creates an A record for a IPv4 address |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/create/#global-flags)
