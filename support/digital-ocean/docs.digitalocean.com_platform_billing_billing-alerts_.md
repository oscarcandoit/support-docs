---
url: "https://docs.digitalocean.com/platform/billing/billing-alerts/"
title: "Billing Alerts | DigitalOcean Documentation"
---
...
Validated on 12 Mar 2024 • Last edited on 17 Jan 2025

Billing alerts send you an email if your monthly spending exceeds an amount you specify.

By default, billing alerts are disabled. You can opt into receiving billing alerts on [the **Billing** page](https://cloud.digitalocean.com/account/billing/settings) of your team.

In the **Billing alerts** section, click **Enable Alert** to open the **Set billing alert** window. Enter the threshold amount in the **Amount** box (which is set to $20 by default), then click **Confirm**.

When your monthly spending exceeds the amount specified, you receive an email at the email address associated with your account. You can change your email address on the [**Account Profile** page](https://cloud.digitalocean.com/account/profile).

To opt back out of billing alerts, in the **Billing alerts** section, click **Edit**, then click **Remove Alert**. In the window that opens, click **Remove** to confirm the removal.

Billing alerts are triggered on the basis of actual usage, so projections of Droplet transfer in excess of the transfer pool do not trigger a billing alert until they are applied to the invoice.
