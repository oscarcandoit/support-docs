---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/images_info/"
title: "images_info | DigitalOcean Documentation"
---
...
List all of the images available on your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/images\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/images_list).
...
| `type`<br>str | Choices:<br>- `application`<br>- `distribution` | Filters results based on image type. |
...
| `images`<br>list | always | Images.<br>Sample:<br>```json<br>[<br>  {<br>    "created_at": "2014-11-04T22:23:02Z",<br>    "description": "",<br>    "distribution": "Ubuntu",<br>    "error_message": "",<br>    "id": 7555620,<br>    "min_disk_size": 20,<br>    "name": "Nifty New Snapshot",<br>    "public": false,<br>    "regions": [],<br>    "size_gigabytes": 2.34,<br>    "slug": null,<br>    "status": "available",<br>    "tags": [],<br>    "type": "snapshot"<br>  }<br>]<br>``` |
| `msg`<br>str | always | Images result information.<br>Sample:<br>```json<br>[<br>  "Current Droplets",<br>  "No Droplets"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/images_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/images_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/images_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/images_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/images_info/#return-values)
