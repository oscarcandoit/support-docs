---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/vpcs_info/"
title: "vpcs_info | DigitalOcean Documentation"
---
...
List all of the VPCs on your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/vpcs\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/vpcs_list).
...
| `msg`<br>str | always | VPCs kresult information.<br>Sample:<br>```json<br>[<br>  "Current volumes",<br>  "No volumes"<br>]<br>``` |
| `vpcs`<br>list | always | VPCs.<br>Sample:<br>```json<br>[<br>  {<br>    "created_at": "2021-11-05T21:48:35Z",<br>    "default": true,<br>    "description": "",<br>    "id": "30f86d25-414e-434f-852d-993ed8d6815e",<br>    "ip_range": "10.108.0.0/20",<br>    "name": "default-nyc3",<br>    "region": "nyc3",<br>    "urn": "do:vpc:30f86d25-414e-434f-852d-993ed8d6815e"<br>  }<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/vpcs_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/vpcs_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/vpcs_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/vpcs_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/vpcs_info/#return-values)
