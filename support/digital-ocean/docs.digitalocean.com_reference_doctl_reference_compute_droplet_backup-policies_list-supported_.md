---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list-supported/"
title: "doctl compute droplet backup-policies list-supported | DigitalOcean Documentation"
---
...
```shell
doctl compute droplet backup-policies list-supported [flags]
```

## Description

List of all supported droplet backup policies.

## Example

The following example list all supported backup policies for Droplets:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list-supported/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list-supported/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list-supported/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list-supported/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list-supported/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backup-policies/list-supported/#global-flags)
