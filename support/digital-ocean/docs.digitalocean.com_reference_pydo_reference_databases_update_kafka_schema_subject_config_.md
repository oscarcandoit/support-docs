---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_kafka_schema_subject_config/"
title: "pydo.databases.update_kafka_schema_subject_config() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- update\_kafka\_schema\_subject\_config()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.update\_kafka\_schema\_subject\_config()
...
| `subject_name` | string | True | The name of the Kafka schema subject. |  |
| `body` | JSON or IO\[bytes\] | False |  |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_kafka_schema_subject_config) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_kafka_schema_subject_config/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_kafka_schema_subject_config/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_kafka_schema_subject_config/#more-information)
