---
url: "https://docs.digitalocean.com/products/snapshooter/details/alpha-beta-tests/"
title: "SnapShooter Alpha and Beta Tests for Backup Jobs | DigitalOcean Documentation"
---
...
- [Details](https://docs.digitalocean.com/products/snapshooter/details/)
- SnapShooter Alpha and Beta Tests for Backup Jobs
...
We regularly add new backup jobs to SnapShooter. We take requests and can create custom jobs for specific customers. If we think a custom job may have a wide reach, we can make it available to all customers.

Once we’ve written a new backup job and tested it in our staging environment, we invite customers to join in testing.

## Alpha and Beta Testing

All new jobs go through an alpha testing stage. This means we have tested it in our local environment, but in customers’ own environments, it may perform differently. After a job is working in all test users’ environments in alpha, it goes through broader beta testing before we release it fully.

We do not provide any guarantees for jobs in the alpha or beta stage, but we can set some general expectations:

| Alpha | Beta |
| --- | --- |
| Backups may not work | Backups should work |
| Restoring may not work | Restoring should work, but auto-restoring may not |
| Not recommended for production | More reliable, but still not recommended for production |

If you run a backup job in alpha or beta, contact support for information about receiving SnapShooter credits for helping us improve our backup jobs.

In this article...

- [Alpha and Beta Testing](https://docs.digitalocean.com/products/snapshooter/details/alpha-beta-tests/#alpha-and-beta-testing)
