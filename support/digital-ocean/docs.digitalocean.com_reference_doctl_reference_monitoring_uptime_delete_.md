---
url: "https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/delete/"
title: "doctl monitoring uptime delete | DigitalOcean Documentation"
---
...
# doctl monitoring uptime delete
...
```shell
doctl monitoring uptime delete <uptime-check-id> [flags]
```
...
Deletes an uptime check on your account.

## Example

The following example deletes an uptime check with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl monitoring uptime delete f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/delete/#global-flags)
