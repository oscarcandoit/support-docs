---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/domain/list/"
title: "doctl compute domain list | DigitalOcean Documentation"
---
...
```shell
doctl compute domain list [flags]
```
...
Retrieves a list of domains on your account.

## Example

The following command lists all domains on your account:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/list/#global-flags)
