---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/regions/"
title: "digitalocean_regions | DigitalOcean Documentation"
---
...
Note: You can use the [`digitalocean_region`](https://docs.digitalocean.com/reference/terraform/reference/data-sources/regions/region) data source
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/regions/#example-usage)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/regions/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/regions/#attributes-reference)
