---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/get_backup_policy/"
title: "pydo.droplets.get_backup_policy() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_get_backup_policy) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_backup_policy/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_backup_policy/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_backup_policy/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_backup_policy/#more-information)
