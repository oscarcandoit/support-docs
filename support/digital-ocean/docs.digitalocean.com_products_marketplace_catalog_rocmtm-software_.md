---
url: "https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/"
title: "ROCm™ Software | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/)
...
from [the ROCm™ Software catalog page](https://marketplace.digitalocean.com/apps/rocm-jupyter)
...
| ROCm (in Docker image) | 6.4.0 | [LICENSE](https://rocm.docs.amd.com/en/latest/about/license.html) |
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=digitaloceanai-rocmjupyter)

## Creating an App using the API

In addition to creating a Droplet from the ROCm™ Software 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB ROCm™ Software Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"digitaloceanai-rocmjupyter"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying ROCm™ Software
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/#creating-an-app-using-the-api)
- [Getting Started After Deploying ROCm™ Software](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/#getting-started-after-deploying-rocm-software)
- [Accessing ROCm resources and libraries](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/#accessing-rocm-resources-and-libraries)
- [SSHing into your AMD 1-Click](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/#sshing-into-your-amd-1-click)
- [Exploring via Jupyter](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/#exploring-via-jupyter)
- [Exploring via Docker](https://docs.digitalocean.com/products/marketplace/catalog/rocmtm-software/#exploring-via-docker)
