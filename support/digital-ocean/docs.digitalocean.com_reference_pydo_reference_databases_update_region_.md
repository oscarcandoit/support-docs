---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_region/"
title: "pydo.databases.update_region() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_region) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_region/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_region/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/update_region/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_region/#more-information)
