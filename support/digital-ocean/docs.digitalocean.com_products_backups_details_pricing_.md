---
url: "https://docs.digitalocean.com/products/backups/details/pricing/"
title: "Backups Pricing | DigitalOcean Documentation"
---
...
Validated on 17 Sep 2024 • Last edited on 1 Oct 2025
...
Backup costs depend on the type of chosen plan. Basic plans add a flat percentage of the Droplet’s cost to the monthly bill, while usage-based plans in public preview add a flat rate per GiB of backups stored.

For the basic plans, weekly backups for a Droplet adds 20.0% of the Droplet's cost per month. Enabling daily backups for a Droplet adds 30.0% of the Droplet's cost per month.

For the usage-based plans, weekly backups add $0.04 per GiB, daily backups add $0.03 per GiB, intra-daily backups (every 12 hours) add $0.02 per GiB, and intra-daily backups (every 6 hours) add $0.015 per GiB.

In more detail, each successful backup is charged at a percentage of the Droplet’s total cost that month. This means that you may be charged less than the full monthly cost in rare cases, such as when you destroy a Droplet that is less than a month old.
