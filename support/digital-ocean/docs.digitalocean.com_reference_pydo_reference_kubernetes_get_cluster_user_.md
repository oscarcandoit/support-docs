---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_user/"
title: "pydo.kubernetes.get_cluster_user() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_get_clusterUser) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_user/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_user/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_user/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster_user/#more-information)
