---
url: "https://docs.digitalocean.com/reference/pydo/reference/image_actions/post/"
title: "pydo.image_actions.post() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [image\_actions](https://docs.digitalocean.com/reference/pydo/reference/image_actions/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/image_actions/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/image_actions/list/)
      - [post()](https://docs.digitalocean.com/reference/pydo/reference/image_actions/post/)
...
| --- | --- | --- | --- | --- |
| `image_id` | integer | True | A unique number that can be used to identify and reference a specific image. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/imageActions_post) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/image_actions/post/#description)
- [Convert an Image to a Snapshot](https://docs.digitalocean.com/reference/pydo/reference/image_actions/post/#convert-an-image-to-a-snapshot)
- [Transfer an Image](https://docs.digitalocean.com/reference/pydo/reference/image_actions/post/#transfer-an-image)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/image_actions/post/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/image_actions/post/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/image_actions/post/#more-information)
