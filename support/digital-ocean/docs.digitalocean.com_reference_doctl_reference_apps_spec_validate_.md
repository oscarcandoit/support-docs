---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/spec/validate/"
title: "doctl apps spec validate | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl apps](https://docs.digitalocean.com/reference/doctl/reference/apps/)
      ...
      - [spec](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/get/)
        - [validate](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/validate/)
...
```shell
doctl apps spec validate <spec file> [flags]
```

## Description

Use this command to check whether a given app spec (YAML or JSON) is valid.
...
| `--schema-only` | Only validate the spec schema and not the correctness of the spec.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/validate/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/validate/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/validate/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/validate/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/spec/validate/#global-flags)
