---
url: "https://docs.digitalocean.com/reference/doctl/reference/monitoring/alert/list/"
title: "doctl monitoring alert list | DigitalOcean Documentation"
---
...
```shell
doctl monitoring alert list [flags]
```
...
Retrieves a list of all the alert policies in your account.

## Example

The following example lists all alert policies in your account:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/monitoring/alert/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/monitoring/alert/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/monitoring/alert/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/monitoring/alert/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/alert/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/monitoring/alert/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/alert/list/#global-flags)
