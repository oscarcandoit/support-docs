---
url: "https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_service_key/"
title: "pydo.partner_attachments.get_service_key() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [partner\_attachments](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/create/)
      - [create\_service\_key()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/create_service_key/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get/)
      - [get\_bgp\_auth\_key()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_bgp_auth_key/)
      - [get\_service\_key()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_service_key/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list/)
      - [list\_remote\_routes()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list_remote_routes/)
      - [patch()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/patch/)
      - [update\_remote\_routes()](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/update_remote_routes/)
...
# pydo.partner\_attachments.get\_service\_key()
...
response = client.partner_attachments.get_service_key("5a4981aa-9653-4bd1-bef5-d6bff52042e4")
```

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/partnerAttachments_get_service_key) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_service_key/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_service_key/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_service_key/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/get_service_key/#more-information)
