---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/detach_agent_function/"
title: "pydo.genai.detach_agent_function() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `agent_uuid` | string | True | The id of the agent the function route belongs to. |  |
| `function_uuid` | string | True | The function route to be destroyed. This does not destroy the function itself. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_detach_agent_function) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/detach_agent_function/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/detach_agent_function/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/detach_agent_function/#more-information)
