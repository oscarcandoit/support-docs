---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-tags/"
title: "doctl registries repository list-tags | DigitalOcean Documentation"
---
...
# doctl registries repository list-tags
...
```shell
doctl registries repository list-tags <registry-name> <repository> [flags]
```
...
```shell
doctl registries repository list-tags example-registry example-repository --format Tag,ManifestDigest
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-tags/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-tags/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-tags/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-tags/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-tags/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-tags/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/list-tags/#global-flags)
