---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/list_kernels/"
title: "pydo.droplets.list_kernels() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_list_kernels) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_kernels/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_kernels/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_kernels/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_kernels/#more-information)
