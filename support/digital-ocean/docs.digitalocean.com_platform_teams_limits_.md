---
url: "https://docs.digitalocean.com/platform/teams/limits/"
title: "Team Limits | DigitalOcean Documentation"
---
...
Validated on 14 Aug 2024 • Last edited on 29 Oct 2025

- The [DigitalOcean Control Panel](https://cloud.digitalocean.com/) is the only way to manage teams. The DigitalOcean API and CLI client, `doctl`, do not support teams.

- You must have a [valid payment method](https://docs.digitalocean.com/platform/billing/manage-payment-methods/) associated with your default team to invite team members, create resources, and create additional teams.

- Removing someone from a team revokes their access to the team in the control panel and API. However, it does not revoke their access to Droplets via SSH keys or other credentials, because DigitalOcean does not manage the contents of Droplets after creation. You must revoke credentials from multi-user Droplets independently.

- Google and GitHub sign-ins are accepted for [secure sign-in](https://docs.digitalocean.com/platform/teams/how-to/require-secure-sign-in/), but we do not detect or enforce 2FA for these sign-in methods.

- You can view your team’s Droplet limit on the team’s [**Settings** page](https://cloud.digitalocean.com/account/team) under **Droplet Limit**. To request an increase, click **Request Increase**. In the following window, fill out an explanation and requested limit, then click **Submit Increase Request**.


In this article...

[Team Limits](https://docs.digitalocean.com/platform/teams/limits/)
