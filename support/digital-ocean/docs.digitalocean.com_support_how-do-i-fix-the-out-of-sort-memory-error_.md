---
url: "https://docs.digitalocean.com/support/how-do-i-fix-the-out-of-sort-memory-error/"
title: "How do I fix the \"Out of sort memory\" error? | DigitalOcean Documentation"
---
...
Warning
Changing `sort_buffer_size` can reduce query performance, increase overall memory consumption, and even crash your cluster. This process is highly specific to your workload and we do not recommend changing the default value. Please read [its potential use cases and disclaimers](https://docs.digitalocean.com/products/databases/mysql/concepts/sort-buffer-size/#use-cases) before changing it.

To fix this error, increase `sort_buffer_size` to a value higher than its default of 256KB. Having `sort_buffer_size` over 5MB may significantly slow down memory allocation. To learn how to safely adjust `sort_buffer_size`, see [our guide](https://docs.digitalocean.com/products/databases/mysql/concepts/sort-buffer-size/).
...
[How do I fix the "Out of sort memory" error?](https://docs.digitalocean.com/support/how-do-i-fix-the-out-of-sort-memory-error/)
