---
url: "https://docs.digitalocean.com/products/paperspace/notebooks/details/limits/"
title: "Notebooks Limits | DigitalOcean Documentation"
---
...
- Storage in Paperspace is scoped to the team level. The amount of free storage accessible to a team is dictated by the [Paperspace subscription tier](https://docs.digitalocean.com/products/paperspace/notebooks/details/pricing/#paperspace-gradient-subscription). To view storage usage, visit the **Storage** tab in the workspace settings.

In this article...

[Notebooks Limits](https://docs.digitalocean.com/products/paperspace/notebooks/details/limits/)
