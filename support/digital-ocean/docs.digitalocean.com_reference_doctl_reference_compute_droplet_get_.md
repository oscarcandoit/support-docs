---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/get/"
title: "doctl compute droplet get | DigitalOcean Documentation"
---
...
The following example retrieves information about a Droplet with the ID `386734086`. The command also uses the `--format` flag to only return the Droplet’s name, ID, and public IPv4 address:
...
| `--template` | Go template format. Sample values: `{{.ID}}`, `{{.Name}}`, `{{.Memory}}`, `{{.Region.Name}}`, `{{.Image}}`, `{{.Tags}}` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/get/#global-flags)
