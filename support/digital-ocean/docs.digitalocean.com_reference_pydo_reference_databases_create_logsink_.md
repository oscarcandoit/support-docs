---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/create_logsink/"
title: "pydo.databases.create_logsink() | DigitalOcean Documentation"
---
...
# pydo.databases.create\_logsink()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_create_logsink) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/create_logsink/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/create_logsink/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/create_logsink/#more-information)
