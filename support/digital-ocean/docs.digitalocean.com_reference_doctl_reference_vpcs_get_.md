---
url: "https://docs.digitalocean.com/reference/doctl/reference/vpcs/get/"
title: "doctl vpcs get | DigitalOcean Documentation"
---
...
Retrieve information about a VPC network, including:
...
The following example retrieves information about a VPC network with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl vpcs get f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/vpcs/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/vpcs/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/vpcs/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/vpcs/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/vpcs/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/get/#global-flags)
