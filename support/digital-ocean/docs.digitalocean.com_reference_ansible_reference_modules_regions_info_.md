---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/regions_info/"
title: "regions_info | DigitalOcean Documentation"
---
...
List all of the regions that are available. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/regions\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/regions_list).
...
| `msg`<br>str | always | Regions result information.<br>Sample:<br>```json<br>[<br>  "Current regions",<br>  "No regions"<br>]<br>``` |
| `regions`<br>list | always | Regions.<br>Sample:<br>```json<br>[<br>  {<br>    "available": true,<br>    "features": [<br>      "backups",<br>      "ipv6",<br>      "metadata",<br>      "install_agent",<br>      "storage",<br>      "image_transfer"<br>    ],<br>    "name": "New York 1",<br>    "sizes": [<br>      "s-1vcpu-512mb-10gb",<br>      "s-1vcpu-1gb",<br>      "s-1vcpu-1gb-amd",<br>      "s-1vcpu-1gb-intel",<br>      "s-1vcpu-2gb",<br>      "..."<br>    ],<br>    "slug": "nyc1"<br>  },<br>  "..."<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/regions_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/regions_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/regions_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/regions_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/regions_info/#return-values)
