---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_sql_mode/"
title: "pydo.databases.update_sql_mode() | DigitalOcean Documentation"
---
...
# pydo.databases.update\_sql\_mode()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_sql_mode) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_sql_mode/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_sql_mode/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/update_sql_mode/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_sql_mode/#more-information)
