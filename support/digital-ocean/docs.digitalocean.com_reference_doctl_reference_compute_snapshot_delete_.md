---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/delete/"
title: "doctl compute snapshot delete | DigitalOcean Documentation"
---
...
Deletes the specified snapshot or volume. This is irreversible.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete the snapshot without confirmation<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/delete/#global-flags)
