---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/reset_auth/"
title: "pydo.databases.reset_auth() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_reset_auth) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/reset_auth/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/reset_auth/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/reset_auth/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/reset_auth/#more-information)
