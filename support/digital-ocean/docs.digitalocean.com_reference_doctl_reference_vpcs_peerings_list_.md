---
url: "https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/list/"
title: "doctl vpcs peerings list | DigitalOcean Documentation"
---
...
```shell
doctl vpcs peerings list [flags]
```
...
Retrieves a list of the VPC Peerings on your account, including the following information for each:
...
The following example lists the VPC Peerings on your account :

```shell
doctl vpcs peerings list --format Name,VPCIDs
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/list/#global-flags)
