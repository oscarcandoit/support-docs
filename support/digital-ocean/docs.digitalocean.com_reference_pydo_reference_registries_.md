---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/"
title: "pydo.registries | DigitalOcean Documentation"
---
...
if your container registry uses the Professional subscription plan.

The storage is shared among
...
pydo.registries.delete\_repository()

\[Public Preview\] Delete Container Registry Repository

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.registries.delete()
...
pydo.registries.list\_garbage\_collections()
...
pydo.registries.list\_repository\_manifests()

\[Public Preview\] List All Container Registry Repository Manifests

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.registries.list\_repository\_tags()
...
pydo.registries.run\_garbage\_collection()
...
pydo.registries.update\_subscription()

\[Public Preview\] Update Subscription Tier

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.registries.validate\_name()

\[Public Preview\] Validate a Container Registry Name

In this article...

[pydo.registries](https://docs.digitalocean.com/reference/pydo/reference/registries/)
