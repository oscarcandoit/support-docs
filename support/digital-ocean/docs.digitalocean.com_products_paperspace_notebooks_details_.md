---
url: "https://docs.digitalocean.com/products/paperspace/notebooks/details/"
title: "Notebooks Details | DigitalOcean Documentation"
---
...
Notebooks provide a fully-managed IDE for exploring data and building machine learning models

![](https://docs.digitalocean.com/images/icons/notebooks.svg)

Paperspace Pricing

Pricing for Paperspace products and Gradient subscriptions.

![](https://docs.digitalocean.com/images/icons/notebooks.svg)

Notebooks Availability

Regional datacenter availability for notebooks.

![](https://docs.digitalocean.com/images/icons/notebooks.svg)

Notebooks Limits

Limits and known issues for Notebooks.

![](https://docs.digitalocean.com/images/icons/notebooks.svg)

Storage Architecture

Interact with data through intuitive storage primitives.

![](https://docs.digitalocean.com/images/icons/notebooks.svg)

Storage Types

Types of storage in Notebooks such as persistent storage and versioned data.

In this article...

[Notebooks Details](https://docs.digitalocean.com/products/paperspace/notebooks/details/)
