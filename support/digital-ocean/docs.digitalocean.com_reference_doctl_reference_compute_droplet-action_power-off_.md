---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-off/"
title: "doctl compute droplet-action power-off | DigitalOcean Documentation"
---
...
The following example powers off a Droplet with the ID `386734086`:

```shell
doctl compute droplet-action power-off 386734086
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-off/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-off/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-off/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-off/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-off/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-off/#global-flags)
