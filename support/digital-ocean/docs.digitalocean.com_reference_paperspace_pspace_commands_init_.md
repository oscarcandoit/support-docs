---
url: "https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/"
title: "init | DigitalOcean Documentation"
---
...
Creates a new Paperspace app. This command creates a new directory with a
...
- [Arguments](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#arguments)
  - [\[argument\] (string, required)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#argument-string-required)
- [Flags](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#flags)
  - [–template, -t (string, required)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#template--t-string-required)
  - [mode, -m (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#mode--m-string-optional)
  - [name, -n (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#name--n-string-optional)
  - [clean, -c (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#clean--c-boolean-optional)
- [Global Flags](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#global-flags)
  - [–log-level, -l (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#log-level--l-string-optional)
  - [–json, -j (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#json--j-boolean-optional)
  - [–api-key (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#api-key-string-optional)
  - [–help, -h (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/init/#help--h-boolean-optional)
