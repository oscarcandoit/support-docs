---
url: "https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/get_by_id/"
title: "pydo.volume_snapshots.get_by_id() | DigitalOcean Documentation"
---
...
# pydo.volume\_snapshots.get\_by\_id()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/volumeSnapshots_get_byId) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/get_by_id/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/get_by_id/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/get_by_id/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/get_by_id/#more-information)
