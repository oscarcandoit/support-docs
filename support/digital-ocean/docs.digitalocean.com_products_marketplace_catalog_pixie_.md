---
url: "https://docs.digitalocean.com/products/marketplace/catalog/pixie/"
title: "Pixie | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/pixie/)
...
Generated on 17 May 2022
from [the Pixie catalog page](https://marketplace.digitalocean.com/apps/pixie)
...
| --- | --- | --- |
| [pixie-operator](https://github.com/pixie-io/pixie) | 0.0.25 | [Apache 2.0](https://github.com/pixie-io/pixie/blob/main/LICENSE) |
| [nats](https://github.com/nats-io/nats.go) | 2.4.0 | [Apache 2.0](https://github.com/nats-io/nats.go/blob/main/LICENSE) |

## Creating an App using the Control Panel

Click the **Deploy to DigitalOcean** button to install a Kubernetes 1-Click Application. If you aren’t logged in, this link will prompt you to log in with your DigitalOcean account.

[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/kubernetes/clusters/new?addonslug=pixie&nodePools=s-1vcpu-2gb%3A3)
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/pixie/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/pixie/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/pixie/#creating-an-app-using-the-api)
- [Getting Started After Deploying Pixie](https://docs.digitalocean.com/products/marketplace/catalog/pixie/#getting-started-after-deploying-pixie)
- [Prerequisites](https://docs.digitalocean.com/products/marketplace/catalog/pixie/#prerequisites)
- [Deploying](https://docs.digitalocean.com/products/marketplace/catalog/pixie/#deploying)
