---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/create/"
title: "doctl genai agent create | DigitalOcean Documentation"
---
...
| `--agent-id` | The ID of the agent to create |
...
| `--instruction` | Agent instruction. Instructions help your agent to perform its job effectively. (required) |
| `--knowledge-base-id` | Ids of the knowledge base(s) to attach to the agent |
| `--model-id` | Model ID. Identifier for the foundation model. (required) |
| `--name` | Agent name (required) |
| `--no-header` | Return raw data with no headers<br>Default: `false` |
| `--openai-key-id` | OpenAI API key ID to use with OpenAI models |
| `--project-id` | UUID of the project to assign the Agent to (required) |
| `--region` | specifies the region to create an Agent in, such as tor1. Use the “doctl compute region list” command for a list of valid regions. (required) |
| `--tags` | Applies a tag to the agent. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/create/#global-flags)
