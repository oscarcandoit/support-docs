---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/snapshot/"
...
Delete snapshots. View the delete API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/snapshots\_delete](https://docs.digitalocean.com/reference/api/api-reference/#operation/snapshots_delete).
...
| `snapshot_id`<br>str |  | Either the ID of an existing snapshot. This will be an integer for a Droplet snapshot or a string for a volume snapshot. |
| `snapshot_name`<br>str |  | The name of an existing snapshot. The module will fail if there is more than one by the same name, use `snapshot`id). |
...
| `msg`<br>str | always | DigitalOcean volume information.<br>Sample:<br>```json<br>[<br>  "Deleted snapshot 125349720",<br>  "Deleted snapshot test-snapshot-1",<br>  "Snapshot 125349720 would be deleted",<br>  "Snapshot test-snapshot-1 would be deleted",<br>  "Snapshot 125349720 not found",<br>  "Snapshot test-snapshot-1 not found"<br>]<br>``` |
| `snapshot`<br>dict | always | Snapshot information.<br>Sample:<br>```json<br>{<br>  "created_at": "2020-07-28T16:47:44Z",<br>  "id": "6372321",<br>  "min_disk_size": 25,<br>  "name": "web-01-1595954862243",<br>  "regions": [],<br>  "resource_id": "200776916",<br>  "resource_type": "droplet",<br>  "size_gigabytes": 2.34,<br>  "tags": []<br>}<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshot/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshot/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshot/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshot/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshot/#return-values)
