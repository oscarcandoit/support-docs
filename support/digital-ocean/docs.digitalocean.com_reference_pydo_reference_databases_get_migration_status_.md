---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_migration_status/"
title: "pydo.databases.get_migration_status() | DigitalOcean Documentation"
---
...
# pydo.databases.get\_migration\_status()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_migrationStatus) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_migration_status/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_migration_status/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/get_migration_status/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_migration_status/#more-information)
