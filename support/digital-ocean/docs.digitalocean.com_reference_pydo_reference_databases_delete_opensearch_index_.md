---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/delete_opensearch_index/"
title: "pydo.databases.delete_opensearch_index() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- delete\_opensearch\_index()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.delete\_opensearch\_index()
...
| `index_name` | string | True | The name of the OpenSearch index. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_delete_opensearch_index) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_opensearch_index/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_opensearch_index/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_opensearch_index/#more-information)
