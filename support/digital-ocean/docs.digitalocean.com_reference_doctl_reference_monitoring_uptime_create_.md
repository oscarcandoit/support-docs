---
url: "https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/create/"
title: "doctl monitoring uptime create | DigitalOcean Documentation"
---
...
The following example creates an uptime check that monitors the URL, `example.com` from the eastern and western regions of the Unites States:

```shell
doctl monitoring uptime create --target https://example.com --type https --regions us_east,us_west --enabled true
```
...
| Option | Description |
| --- | --- |
| `--enabled` | Whether or not the uptime check is enabled. Defaults to true<br>Default: `true` |
...
| `--regions` | A comma-separated list of regions to monitor the target from. Possible values: `us_east`, `us_west`, `eu_west`, `se_asia`. Defaults to `us_east`<br>Default: `[us_east]` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/create/#global-flags)
