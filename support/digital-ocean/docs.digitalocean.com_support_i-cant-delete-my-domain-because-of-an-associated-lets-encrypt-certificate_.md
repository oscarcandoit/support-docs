---
url: "https://docs.digitalocean.com/support/i-cant-delete-my-domain-because-of-an-associated-lets-encrypt-certificate/"
title: "I can't delete my domain because of an associated Let's Encrypt certificate | DigitalOcean Documentation"
---
...
Validated on 28 Jun 2024 • Last edited on 18 Mar 2025

![DNS domain is currently in use by a Let's Encrypt certificate, deleting this domain would prevent the Let's Encrypt certificate renewal.](https://docs.digitalocean.com/screenshots/dns/dns-le-error.1c1e83a53d63c6c739e98f96788f6f2c46eef8665c420e044f2add72817a1644.png)

Attempting to delete a domain that has a Let’s Encrypt certificate results in the following error:

> DNS domain is currently in use by a Let’s Encrypt certificate, deleting this domain would prevent the Let’s Encrypt certificate renewal.

You cannot delete a domain while a Let’s Encrypt SSL certificate is still associated with that domain.

To resolve this error, [delete the SSL certificate](https://docs.digitalocean.com/platform/teams/how-to/manage-certificates/) associated with the domain you want to delete, the [delete the domain](https://docs.digitalocean.com/products/networking/dns/how-to/delete-domains/).
