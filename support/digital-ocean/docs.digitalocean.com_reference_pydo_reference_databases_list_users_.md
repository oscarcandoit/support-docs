---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_users/"
title: "pydo.databases.list_users() | DigitalOcean Documentation"
---
...
For MySQL clusters, additional options will be contained in the mysql\_settings object.

For MongoDB clusters, additional information will be contained in the mongo\_user\_settings object
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_users) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_users/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_users/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/list_users/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_users/#more-information)
