---
url: "https://docs.digitalocean.com/reference/pydo/reference/images/list/"
title: "pydo.images.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [images](https://docs.digitalocean.com/reference/pydo/reference/images/)
      - [create\_custom()](https://docs.digitalocean.com/reference/pydo/reference/images/create_custom/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/images/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/images/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/images/list/)
      - [update()](https://docs.digitalocean.com/reference/pydo/reference/images/update/)
...
To retrieve only _**distribution**_ images, include the `type` query parameter set to distribution, `/v2/images?type=distribution`.

To retrieve only _**application**_ images, include the `type` query parameter set to application, `/v2/images?type=application`.
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/images_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/images/list/#description)
- [Filtering Results](https://docs.digitalocean.com/reference/pydo/reference/images/list/#filtering-results)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/images/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/images/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/images/list/#more-information)
