---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/list/"
title: "pydo.reserved_ips.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [reserved\_ips](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/list/)
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPs_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/list/#more-information)
