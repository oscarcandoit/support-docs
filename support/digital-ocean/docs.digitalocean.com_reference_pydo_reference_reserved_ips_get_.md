---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/get/"
title: "pydo.reserved_ips.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPs_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/get/#more-information)
