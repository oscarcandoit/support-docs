---
url: "https://docs.digitalocean.com/reference/pydo/reference/volume_actions/list/"
title: "pydo.volume_actions.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/volumeActions_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/volume_actions/list/#more-information)
