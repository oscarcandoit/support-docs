---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/restart/"
title: "doctl apps restart | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--components` | The components to restart. If not provided, all components are restarted. |
...
| `--wait` | Boolean that specifies whether to wait for the restart to complete before allowing further terminal input. This can be helpful for scripting.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/restart/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/restart/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/restart/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/restart/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/restart/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/restart/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/restart/#global-flags)
