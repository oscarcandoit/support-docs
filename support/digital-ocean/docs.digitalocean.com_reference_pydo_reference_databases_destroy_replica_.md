---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_replica/"
title: "pydo.databases.destroy_replica() | DigitalOcean Documentation"
---
...
# pydo.databases.destroy\_replica()
...
| `replica_name` | string | True | The name of the database replica. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_destroy_replica) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_replica/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_replica/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_replica/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/destroy_replica/#more-information)
