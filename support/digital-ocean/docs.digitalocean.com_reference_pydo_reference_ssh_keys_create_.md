---
url: "https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/create/"
title: "pydo.ssh_keys.create() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/sshKeys_create) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/create/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/create/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/create/#more-information)
