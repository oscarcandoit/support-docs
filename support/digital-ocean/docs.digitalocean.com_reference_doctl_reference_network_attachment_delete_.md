---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/attachment/delete/"
title: "doctl network attachment delete | DigitalOcean Documentation"
---
...
# doctl network attachment delete
...
```shell
doctl network attachment delete <partner-attachment-id> [flags]
```
...
Deletes information about a Partner Attachment. This is irreversible

## Flags

| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete the Partner Attachment without any confirmation prompt<br>Default: `false` |
...
| `--wait` | Boolean that specifies whether to wait for a Partner Attachment deletion to complete before returning control to the terminal<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/delete/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/delete/#global-flags)
