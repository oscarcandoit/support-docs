---
url: "https://docs.digitalocean.com/reference/doctl/reference/nfs/resize/"
title: "doctl nfs resize | DigitalOcean Documentation"
---
...
```shell
doctl nfs resize [flags]
```

## Description

Resize an NFS share with the given ID and region.
...
| `--id` | the ID of the NFS share (required) |
| `--region`, `-r` | the region where the NFS share resides (required) |
| `--size`, `-s` | the size of the NFS share in GiB (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/nfs/resize/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/nfs/resize/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/nfs/resize/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/resize/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/nfs/resize/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/resize/#global-flags)
