---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/update_evaluation_test_case/"
title: "pydo.genai.update_evaluation_test_case() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- update\_evaluation\_test\_case()
...
| --- | --- | --- | --- | --- |
| `test_case_uuid` | string | True | Test-case UUID to update |  |
| `body` | JSON or IO\[bytes\] | False |  |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_update_evaluation_test_case) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/update_evaluation_test_case/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/update_evaluation_test_case/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/update_evaluation_test_case/#more-information)
