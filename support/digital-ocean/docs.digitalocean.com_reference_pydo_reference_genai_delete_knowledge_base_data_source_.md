---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/delete_knowledge_base_data_source/"
title: "pydo.genai.delete_knowledge_base_data_source() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- delete\_knowledge\_base\_data\_source()
...
| --- | --- | --- | --- | --- |
| `knowledge_base_uuid` | string | True | Knowledge base id |  |
| `data_source_uuid` | string | True | Data source id |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_delete_knowledge_base_data_source) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/delete_knowledge_base_data_source/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/delete_knowledge_base_data_source/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/delete_knowledge_base_data_source/#more-information)
