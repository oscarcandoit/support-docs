---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete-datasource/"
title: "doctl genai knowledge-base delete-datasource | DigitalOcean Documentation"
---
...
# doctl genai knowledge-base delete-datasource
...
```shell
doctl genai knowledge-base delete-datasource <knowledge-base-uuid> <data-source-id> [flags]
```
...
Delete a datasource for knowledge base using its id.

## Example

The following example deletes data source having uuid like 00000000-0000-0000-0000-000000000000 from a Knowledge Base having uuid `f81d4fae-7dec-11d0-a765-00a0c91e6bf6  Using the following command` :
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes the datasource for knowledge base without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete-datasource/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete-datasource/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete-datasource/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete-datasource/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete-datasource/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete-datasource/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete-datasource/#global-flags)
