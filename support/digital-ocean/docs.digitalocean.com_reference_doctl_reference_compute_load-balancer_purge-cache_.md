---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/purge-cache/"
title: "doctl compute load-balancer purge-cache | DigitalOcean Documentation"
---
...
# doctl compute load-balancer purge-cache
...
```shell
doctl compute load-balancer purge-cache <load-balancer-id> [flags]
```

## Description

Use this command to purge the CDN cache for specified global load balancer.

## Flags

| Option | Description |
| --- | --- |
| `--force`, `-f` | Purge the global load balancer CDN cache without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/purge-cache/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/purge-cache/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/purge-cache/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/purge-cache/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/purge-cache/#global-flags)
