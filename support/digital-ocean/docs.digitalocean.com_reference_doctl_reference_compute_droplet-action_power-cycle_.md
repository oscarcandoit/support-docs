---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-cycle/"
title: "doctl compute droplet-action power-cycle | DigitalOcean Documentation"
---
...
# doctl compute droplet-action power-cycle
...
```shell
doctl compute droplet-action power-cycle <droplet-id> [flags]
```

## Description

Powercycles a Droplet. A powercycle action is similar to pushing the reset button on a physical machine.

## Example

The following example powercycles a Droplet with the ID `386734086`:

```shell
doctl compute droplet-action power-cycle 386734086
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-cycle/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-cycle/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-cycle/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-cycle/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-cycle/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-cycle/#global-flags)
