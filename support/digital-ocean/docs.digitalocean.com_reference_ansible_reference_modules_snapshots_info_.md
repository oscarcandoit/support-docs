---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/snapshots_info/"
title: "snapshots_info | DigitalOcean Documentation"
---
...
Retrieve a list of all of the snapshots in your account. View the API documentation at ( [https://docs.digitalocean.com/reference/api/api-reference/#operation/snapshots\_list)](https://docs.digitalocean.com/reference/api/api-reference/#operation/snapshots_list)).
...
| `resource_type`<br>str | Choices:<br>- `droplet`<br>- `volume` | Used to filter snapshots by a resource type. |
...
| `msg`<br>str | always | Snapshots result information.<br>Sample:<br>```json<br>[<br>  "Current snapshots",<br>  "No snapshots"<br>]<br>``` |
| `snapshots`<br>list | always | Snapshots.<br>Sample:<br>```json<br>[<br>  {<br>    "created_at": "2020-07-28T16:47:44Z",<br>    "id": "6372321",<br>    "min_disk_size": 25,<br>    "name": "web-01-1595954862243",<br>    "regions": [],<br>    "resource_id": "200776916",<br>    "resource_type": "droplet",<br>    "size_gigabytes": 2.34,<br>    "tags": []<br>  }<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshots_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshots_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshots_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshots_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/snapshots_info/#return-values)
