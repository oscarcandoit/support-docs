---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/tag/"
...
Create or delete tags. A tag is a label that can be applied to a resource (currently Droplets, Images, Volumes,
Volume Snapshots, and Database clusters) in order to better organize or facilitate the
lookups and actions on it.
View the create API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#tag/Tags](https://docs.digitalocean.com/reference/api/api-reference/#tag/Tags).
...
| `msg`<br>str | always | Droplet result information.<br>Sample:<br>```json<br>[<br>  "Created tag extra-awesome",<br>  "Deleted tag extra-awesome",<br>  "Tag extra-awesome would be created",<br>  "Tag extra-awesome exists",<br>  "Tag extra-awesome does not exist",<br>  "Tag extra-awesome deleted"<br>]<br>``` |
| `tag`<br>dict | always | Tag information.<br>Sample:<br>```json<br>{<br>  "name": "extra-awesome",<br>  "resources": {<br>    "count": 0,<br>    "databases": {<br>      "count": 0<br>    },<br>    "droplets": {<br>      "count": 0<br>    },<br>    "images": {<br>      "count": 0<br>    },<br>    "volume_snapshots": {<br>      "count": 0<br>    },<br>    "volumes": {<br>      "count": 0<br>    }<br>  }<br>}<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/tag/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/tag/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/tag/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/tag/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/tag/#return-values)
