---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/volume/delete/"
title: "doctl compute volume delete | DigitalOcean Documentation"
---
...
Deletes a block storage volume by ID, destroying all of its data and removing it from your account. This is irreversible.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete the volume without prompting for confirmation<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/delete/#global-flags)
