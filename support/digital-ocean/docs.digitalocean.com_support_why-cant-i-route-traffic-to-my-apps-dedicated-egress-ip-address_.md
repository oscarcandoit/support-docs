---
url: "https://docs.digitalocean.com/support/why-cant-i-route-traffic-to-my-apps-dedicated-egress-ip-address/"
title: "Why can't I route traffic to my app's dedicated egress IP address? | DigitalOcean Documentation"
---
...
App Platform provides several free [public ingress IP addresses](https://docs.digitalocean.com/products/app-platform/how-to/add-ip-address/#use-public-static-ingress-ips). To route ingress traffic to your app, create a DNS record (like an A record) that directs traffic from your domain to one of these public ingress IP addresses.

In contrast, App Platform’s [dedicated egress IP address](https://docs.digitalocean.com/products/app-platform/how-to/add-ip-address/) are an optional, paid feature. When you add a dedicated egress IP address to your app, all of your app’s outbound requests originate from that IP address. You can use this to restrict external resources to receive only outgoing traffic from your app.
...
[Why can't I route traffic to my app's dedicated egress IP address?](https://docs.digitalocean.com/support/why-cant-i-route-traffic-to-my-apps-dedicated-egress-ip-address/)
