---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_available_upgrades/"
title: "pydo.kubernetes.get_available_upgrades() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_get_availableUpgrades) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_available_upgrades/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_available_upgrades/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_available_upgrades/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_available_upgrades/#more-information)
