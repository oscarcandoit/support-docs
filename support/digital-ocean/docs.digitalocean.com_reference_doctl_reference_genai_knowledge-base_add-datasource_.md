---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/add-datasource/"
title: "doctl genai knowledge-base add-datasource | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl genai](https://docs.digitalocean.com/reference/doctl/reference/genai/)
      ...
      - [knowledge-base](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/)
        - [add-datasource](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/add-datasource/)
        - [attach](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/attach/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete/)
        - [delete-datasource](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete-datasource/)
        - [detach](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/detach/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list/)
        - [list-datasources](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/list-datasources/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/update/)
...
# doctl genai knowledge-base add-datasource
...
```shell
doctl genai knowledge-base add-datasource <knowledge-base-uuid> [flags]
```
...
Add a datasource for knowledge base by its uuid. Add only one Spaces or Webcrawler as a datasource. For more info about datasources, see the [datasources reference](https://docs.digitalocean.com/reference/api/digitalocean/#tag/GenAI-Platform-(Public-Preview)/operation/genai_create_knowledge_base_data_source)

## Flags

| Option | Description |
| --- | --- |
| `--base-url` | The base URL of the web crawler data source. |
| `--bucket-name` | The bucket name of data source from Spaces |
| `--crawling-option` | The crawling option of the web crawler data source. |
| `--embed-media` | The embed media option of the web crawler data source.<br>Default: `false` |
| `--format` | Columns for output in a comma-separated list. Possible values: `CreatedAt`, `FileUploadDataSource`, `LastIndexingJob`, `SpacesDataSource`, `UpdatedAt`, `UUID`, `WebCrawlerDataSource`. |
| `--help`, `-h` | Help for this command |
| `--item-path` | Item path of data source from Spaces. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/add-datasource/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/add-datasource/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/add-datasource/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/add-datasource/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/add-datasource/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/add-datasource/#global-flags)
