---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/connection/"
title: "doctl databases connection | DigitalOcean Documentation"
---
...
| `--private` | Returns connection details that use the database’s VPC network connection.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/connection/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/connection/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/connection/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/connection/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/connection/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/connection/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/connection/#global-flags)
