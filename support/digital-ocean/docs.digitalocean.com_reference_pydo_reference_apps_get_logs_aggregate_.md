---
url: "https://docs.digitalocean.com/reference/pydo/reference/apps/get_logs_aggregate/"
title: "pydo.apps.get_logs_aggregate() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [apps](https://docs.digitalocean.com/reference/pydo/reference/apps/)
- get\_logs\_aggregate()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.apps.get\_logs\_aggregate()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/apps_get_logs_aggregate) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/apps/get_logs_aggregate/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/apps/get_logs_aggregate/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/apps/get_logs_aggregate/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/apps/get_logs_aggregate/#more-information)
