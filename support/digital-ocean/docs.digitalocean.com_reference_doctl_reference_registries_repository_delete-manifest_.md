---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-manifest/"
title: "doctl registries repository delete-manifest | DigitalOcean Documentation"
---
...
# doctl registries repository delete-manifest
...
```shell
doctl registries repository delete-manifest <registry-name> <repository> <manifest-digest>... [flags]
```
...
```shell
doctl registries repository delete-manifest example-registry example-repository sha256:a67c20e45178d90cbe686575719bd81f279b06842dc77521690e292c1eea685
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-manifest/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-manifest/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-manifest/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-manifest/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-manifest/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-manifest/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/repository/delete-manifest/#global-flags)
