---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_node_pools/"
title: "pydo.kubernetes.list_node_pools() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_list_nodePools) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_node_pools/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_node_pools/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_node_pools/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_node_pools/#more-information)
