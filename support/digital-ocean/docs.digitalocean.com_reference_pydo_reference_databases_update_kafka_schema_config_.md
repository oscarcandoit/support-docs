---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_kafka_schema_config/"
title: "pydo.databases.update_kafka_schema_config() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- update\_kafka\_schema\_config()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.update\_kafka\_schema\_config()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_kafka_schema_config) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_kafka_schema_config/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_kafka_schema_config/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_kafka_schema_config/#more-information)
