---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository/"
title: "pydo.registries.delete_repository() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_delete_repository) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository/#more-information)
