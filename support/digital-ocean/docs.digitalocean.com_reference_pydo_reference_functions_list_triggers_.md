---
url: "https://docs.digitalocean.com/reference/pydo/reference/functions/list_triggers/"
title: "pydo.functions.list_triggers() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/functions_list_triggers) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/functions/list_triggers/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/functions/list_triggers/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/functions/list_triggers/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/functions/list_triggers/#more-information)
