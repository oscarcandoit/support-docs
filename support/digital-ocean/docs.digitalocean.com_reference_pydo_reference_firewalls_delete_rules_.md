---
url: "https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_rules/"
title: "pydo.firewalls.delete_rules() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/firewalls_delete_rules) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_rules/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_rules/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_rules/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_rules/#more-information)
