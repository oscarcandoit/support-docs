---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/get_garbage_collection/"
title: "pydo.registries.get_garbage_collection() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_get_garbageCollection) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/get_garbage_collection/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/registries/get_garbage_collection/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/get_garbage_collection/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/get_garbage_collection/#more-information)
