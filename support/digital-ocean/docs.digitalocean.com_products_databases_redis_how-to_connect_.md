---
url: "https://docs.digitalocean.com/products/databases/redis/how-to/connect/"
title: "How to Connect to Caching Database Clusters | DigitalOcean Documentation"
---
...
## View Caching Cluster Connection Details
...
- **Hostname and Port**:
The hostname is specified with the `-h` flag, and tells your client computer how to reach the cluster. Port is specified with the `-p` flag. If you do not specify a port, the client attempts to use the default Caching port, `6379`.
...
- **Encryption**:
Caching managed databases on DigitalOcean require you to connect using SSL/TLS. To do this with `redli`, specify the encryption with the `--tls` flag.
...
- To add your local computer [to the database’s trusted sources](https://docs.digitalocean.com/products/databases/redis/how-to/secure/#firewalls).
...
- To reference the [database cluster’s connection details](https://docs.digitalocean.com/products/databases/redis/how-to/connect/#connection-details), which tells your client how to connect to the cluster.
...
If you’re having trouble connecting to the database, you can [troubleshoot the connection using our Support page](https://docs.digitalocean.com/support/redis/), or you can reference [Redli’s connection documentation](https://cloud.ibm.com/docs/databases-for-redis?topic=databases-for-redis-connecting-cli-client).

In this article...

- [Retrieve Database Connection Details Using the CLI](https://docs.digitalocean.com/products/databases/redis/how-to/connect/#retrieve-database-connection-details-using-the-cli)
- [Retrieve Database Connection Details Using the API](https://docs.digitalocean.com/products/databases/redis/how-to/connect/#retrieve-database-connection-details-using-the-api)
- [View Caching Cluster Connection Details](https://docs.digitalocean.com/products/databases/redis/how-to/connect/#connection-details)
- [Anatomy of the Flags Format](https://docs.digitalocean.com/products/databases/redis/how-to/connect/#anatomy-of-the-flags-format)
- [Connect to the Database](https://docs.digitalocean.com/products/databases/redis/how-to/connect/#connect-to-the-database)
