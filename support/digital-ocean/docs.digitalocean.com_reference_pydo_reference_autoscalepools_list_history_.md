---
url: "https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list_history/"
title: "pydo.autoscalepools.list_history() | DigitalOcean Documentation"
---
...
# pydo.autoscalepools.list\_history()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/autoscalepools_list_history) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list_history/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list_history/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list_history/#more-information)
