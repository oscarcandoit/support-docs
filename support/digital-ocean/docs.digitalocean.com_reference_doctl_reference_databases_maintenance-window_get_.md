---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/maintenance-window/get/"
title: "doctl databases maintenance-window get | DigitalOcean Documentation"
---
...
```shell
doctl databases maintenance-window get <database-cluster-id> [flags]
```
...
```shell
doctl databases maintenance-window get ca9f591d-f38h-5555-a0ef-1c02d1d1e35
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/maintenance-window/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/maintenance-window/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/maintenance-window/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/maintenance-window/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/maintenance-window/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/maintenance-window/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/maintenance-window/get/#global-flags)
