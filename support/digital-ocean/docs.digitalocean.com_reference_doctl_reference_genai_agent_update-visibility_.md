---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/update-visibility/"
title: "doctl genai agent update-visibility | DigitalOcean Documentation"
---
...
# doctl genai agent update-visibility
...
```shell
doctl genai agent update-visibility <agent-id> [flags]
```

## Aliases

```shell
uv, update-visibility, update-vis
```
...
The following example updates the visibility of an agent with the ID `12345678-1234-1234-1234-123456789012` to `VISIBILITY_PUBLIC`:

```shell
doctl genai agent update-visibility 12345678-1234-1234-1234-123456789012 --visibility 'VISIBILITY_PUBLIC'
```
...
| `--visibility` | Agent deployment visibility. Possible Options: `VISIBILITY_PLAYGROUND`, `VISIBILITY_PUBLIC`, `VISIBILITY_PRIVATE`. Default: `VISIBILITY_UNKNOWN` (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/update-visibility/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/update-visibility/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/update-visibility/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/update-visibility/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/update-visibility/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/update-visibility/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/update-visibility/#global-flags)
