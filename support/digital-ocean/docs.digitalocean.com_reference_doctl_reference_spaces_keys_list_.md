---
url: "https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/list/"
title: "doctl spaces keys list | DigitalOcean Documentation"
---
...
The following command lists all Spaces Keys and uses the `--format` flag to return only the Name and Grants of each key.

```shell
doctl spaces keys list --format Name,Grants
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/list/#global-flags)
