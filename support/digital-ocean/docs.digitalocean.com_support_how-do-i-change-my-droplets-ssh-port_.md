---
url: "https://docs.digitalocean.com/support/how-do-i-change-my-droplets-ssh-port/"
title: "How do I change my Droplet's SSH port? | DigitalOcean Documentation"
---
...
Validated on 1 Nov 2022 • Last edited on 17 Apr 2025
...
For example, if your Droplet has the IP address `192.88.99.255` and the Droplet’s new SSH port is 20202, you would format the command as `ssh root@192.88.99.255 -p 20202`
.

A successful login to the Droplet confirms that SSH port has been successfully reassigned. If your login was unsuccessful, you can log in to the Droplet from the [Droplet Console](https://docs.digitalocean.com/products/droplets/how-to/connect-with-console/) and troubleshoot the configuration file.
...
[How do I change my Droplet's SSH port?](https://docs.digitalocean.com/support/how-do-i-change-my-droplets-ssh-port/)
