---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete/"
title: "doctl genai knowledge-base delete | DigitalOcean Documentation"
---
...
# doctl genai knowledge-base delete
...
```shell
doctl genai knowledge-base delete <knowledge-base-uuid> [flags]
```
...
Deletes the knowledge bases by its valid uuid.

## Example

The following command deletes the knowledge base by its uuid f81d4fae-7dec-11d0-a765-00a0c91e6bf6
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes the knowledge base without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/delete/#global-flags)
