...
title: "How to View Security History | DigitalOcean Documentation"
---
...
Validated on 24 Feb 2025 • Last edited on 18 Mar 2025

Your team’s security history shows a record of actions that have been taken in your team, like creating or deleting resources and API tokens.

You can view a team’s security history in the control panel. In the left menu, click **Settings**, then click the **Security** tab to go to the [team security page](https://cloud.digitalocean.com/account/security).

In the **Security History** section, each entry includes the action, the user who performed the action, the originating IP address, and how long ago the action happened. Hover over the value in the **Time** column, like **1 month ago**, to see the specific date and time of the event.

If you need data older than what is available in your security history, open a support ticket. For account activity, like logging in or joining a team, view [your account’s **Activity** tab](https://cloud.digitalocean.com/account/activity).

In this article...

[How to View Security History](https://docs.digitalocean.com/platform/teams/how-to/view-security-history/)
