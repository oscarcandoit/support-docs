---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-service-key/"
title: "doctl network attachment get-service-key | DigitalOcean Documentation"
---
...
# doctl network attachment get-service-key
...
```shell
doctl network attachment get-service-key <partner-attachment-id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-service-key/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-service-key/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-service-key/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-service-key/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-service-key/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-service-key/#global-flags)
