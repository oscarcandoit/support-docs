---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/list/"
title: "doctl compute snapshot list | DigitalOcean Documentation"
---
...
```shell
doctl compute snapshot list [glob] [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/list/#global-flags)
