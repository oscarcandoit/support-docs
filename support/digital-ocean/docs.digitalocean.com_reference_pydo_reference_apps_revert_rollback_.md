---
url: "https://docs.digitalocean.com/reference/pydo/reference/apps/revert_rollback/"
title: "pydo.apps.revert_rollback() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/apps_revert_rollback) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/apps/revert_rollback/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/apps/revert_rollback/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/apps/revert_rollback/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/apps/revert_rollback/#more-information)
