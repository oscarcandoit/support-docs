---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/propose/"
title: "doctl apps propose | DigitalOcean Documentation"
---
...
The following example proposes an app spec from the file directory `src/your-app.yaml` for a new app:

```shell
doctl apps propose --spec src/your-app.yaml
```
...
| `--spec` | Path to an app spec in JSON or YAML format. For more information about app specs, see the [app spec reference](https://www.digitalocean.com/docs/app-platform/concepts/app-spec) (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/propose/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/propose/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/propose/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/propose/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/propose/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/propose/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/propose/#global-flags)
