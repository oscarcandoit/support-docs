---
url: "https://docs.digitalocean.com/reference/pydo/reference/addons/delete/"
title: "pydo.addons.delete() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `resource_uuid` | string | True | A unique identifier for the add-on resource. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/addons_delete) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/addons/delete/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/addons/delete/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/addons/delete/#more-information)
