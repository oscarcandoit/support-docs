---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/get/"
title: "doctl compute certificate get | DigitalOcean Documentation"
---
...
This command retrieves the following details about a certificate:
...
The following example retrieves the ID, name, and domains associated with a certificate:

```shell
doctl compute certificate get f81d4fae-7dec-11d0-a765-00a0c91e6bf6 --format ID,Name,DNSNames
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/certificate/get/#global-flags)
