---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/certificate/"
title: "digitalocean_certificate | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/certificate/#example-usage)
  - [Custom Certificate](https://docs.digitalocean.com/reference/terraform/reference/resources/certificate/#custom-certificate)
  - [Let’s Encrypt Certificate](https://docs.digitalocean.com/reference/terraform/reference/resources/certificate/#lets-encrypt-certificate)
  - [Use with Other Resources](https://docs.digitalocean.com/reference/terraform/reference/resources/certificate/#use-with-other-resources)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/certificate/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/certificate/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/certificate/#import)
