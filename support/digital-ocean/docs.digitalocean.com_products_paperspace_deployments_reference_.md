---
url: "https://docs.digitalocean.com/products/paperspace/deployments/reference/"
title: "Deployments Reference | DigitalOcean Documentation"
---
...
Configure autoscaling to handle scale up and down events for your deployment.

![](https://docs.digitalocean.com/images/icons/deployments.svg)

Public and Protected Endpoints in Gradient Deployments

Gradient deployments have two levels of endpoint security with different levels of access to the service.
...
- [APIs & CLIs](https://docs.digitalocean.com/products/paperspace/deployments/reference/#apis--clis)
- [Additional References](https://docs.digitalocean.com/products/paperspace/deployments/reference/#additional-references)
