---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/domain/delete/"
title: "doctl compute domain delete | DigitalOcean Documentation"
---
...
Permanently deletes a domain from your account. You cannot undo this command once done.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes the domain without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/delete/#global-flags)
