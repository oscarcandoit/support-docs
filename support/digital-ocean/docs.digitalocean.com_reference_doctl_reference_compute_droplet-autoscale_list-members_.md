---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-members/"
title: "doctl compute droplet-autoscale list-members | DigitalOcean Documentation"
---
...
# doctl compute droplet-autoscale list-members
...
```shell
doctl compute droplet-autoscale list-members <autoscale-pool-id> [flags]
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Status`, `Health Status`, `Unhealthy Reason`, `CPU Util`, `Mem Util`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-members/#usage)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-members/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-members/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-members/#global-flags)
