---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/get/"
title: "pydo.reserved_ipv6.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPv6_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/get/#more-information)
