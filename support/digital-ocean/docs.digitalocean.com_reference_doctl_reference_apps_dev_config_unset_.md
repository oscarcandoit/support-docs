---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/unset/"
title: "doctl apps dev config unset | DigitalOcean Documentation"
---
...
```shell
doctl apps dev config unset KEY... [flags]
```
...
Nested component KEYs can also be unset, for example: components.my-component.build\_command
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/unset/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/unset/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/unset/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/unset/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/dev/config/unset/#global-flags)
