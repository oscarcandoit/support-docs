---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/delete/"
title: "pydo.reserved_ipv6.delete() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [reserved\_ipv6](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/list/)
...
| --- | --- | --- | --- | --- |
| `reserved_ipv6` | string | True | A reserved IPv6 address. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPv6_delete) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/delete/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/delete/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/delete/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/delete/#more-information)
