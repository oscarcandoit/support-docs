---
url: "https://docs.digitalocean.com/reference/pydo/reference/uptime/update_check/"
title: "pydo.uptime.update_check() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/uptime_update_check) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_check/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_check/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_check/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_check/#more-information)
