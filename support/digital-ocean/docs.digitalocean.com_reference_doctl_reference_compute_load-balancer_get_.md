---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/get/"
title: "doctl compute load-balancer get | DigitalOcean Documentation"
---
...
```shell
doctl compute load-balancer get <load-balancer-id> [flags]
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `IP`, `IPv6`, `Name`, `Status`, `Created`, `Region`, `Size`, `SizeUnit`, `VPCUUID`, `Tag`, `DropletIDs`, `RedirectHttpToHttps`, `StickySessions`, `HealthCheck`, `ForwardingRules`, `Firewall`, `DisableLetsEncryptDNSRecords`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/get/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/get/#global-flags)
