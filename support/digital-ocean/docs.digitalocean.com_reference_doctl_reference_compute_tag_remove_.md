---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/tag/remove/"
title: "doctl compute tag remove | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [tag](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/)
        - [apply](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/apply/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/list/)
        - [remove](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/remove/)
...
```shell
doctl compute tag remove <tag-name> --resource=<urn> [--resource=<urn> ...] [flags]
```

## Description

Removes a tag from one or more resources. Resources must be specified as Uniform Resource Names (URNs) and has the following syntax: `do:<resource_type>:<identifier>`.

## Example

The following example removes the tag named `web` from two Droplets:

```shell
doctl compute tag remove web --resource=do:droplet:386734086,do:droplet:191669331
```
...
| `--resource` | The resource to untag in URN format (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/remove/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/remove/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/remove/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/remove/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/remove/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/remove/#global-flags)
