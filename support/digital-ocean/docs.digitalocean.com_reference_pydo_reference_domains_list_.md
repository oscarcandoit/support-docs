---
url: "https://docs.digitalocean.com/reference/pydo/reference/domains/list/"
title: "pydo.domains.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/domains_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/domains/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/domains/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/domains/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/domains/list/#more-information)
