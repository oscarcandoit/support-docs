---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/create/"
title: "pydo.reserved_ipv6.create() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPv6_create) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/create/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/create/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ipv6/create/#more-information)
