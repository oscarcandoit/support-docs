---
url: "https://docs.digitalocean.com/reference/pydo/reference/uptime/create_alert/"
title: "pydo.uptime.create_alert() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/uptime_create_alert) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/uptime/create_alert/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/uptime/create_alert/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/uptime/create_alert/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/uptime/create_alert/#more-information)
