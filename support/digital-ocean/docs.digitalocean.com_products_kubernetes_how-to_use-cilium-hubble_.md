---
url: "https://docs.digitalocean.com/products/kubernetes/how-to/use-cilium-hubble/"
title: "How to Use Cilium Hubble for Network Visibility and Security of Kubernetes Clusters | DigitalOcean Documentation"
---
...
3. [Authenticate and connect to your DOKS cluster](https://docs.digitalocean.com/products/kubernetes/how-to/connect-to-cluster/) using `kubeconfig`.
...
If you don’t want to [run the deployments](https://docs.digitalocean.com/products/kubernetes/how-to/use-cilium-hubble/#resources-used-by-hubble) for Hubble Relay and Hubble UI, you can scale them down to zero replicas. For example, run `kubectl scale deploy hubble-ui --replicas=0` to disable the Hubble UI.

In this article...

- [Resources Used by Hubble](https://docs.digitalocean.com/products/kubernetes/how-to/use-cilium-hubble/#resources-used-by-hubble)
- [Prerequisites](https://docs.digitalocean.com/products/kubernetes/how-to/use-cilium-hubble/#prerequisites)
- [Use the Hubble CLI](https://docs.digitalocean.com/products/kubernetes/how-to/use-cilium-hubble/#use-the-hubble-cli)
- [Use the Hubble UI](https://docs.digitalocean.com/products/kubernetes/how-to/use-cilium-hubble/#use-the-hubble-ui)
- [Disable Hubble Relay and UI](https://docs.digitalocean.com/products/kubernetes/how-to/use-cilium-hubble/#disable-hubble-relay-and-ui)
