---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_autoscale/"
title: "pydo.databases.get_autoscale() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_autoscale) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_autoscale/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_autoscale/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/get_autoscale/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_autoscale/#more-information)
