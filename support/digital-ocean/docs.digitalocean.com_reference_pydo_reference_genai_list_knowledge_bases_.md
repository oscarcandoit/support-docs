---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_knowledge_bases/"
title: "pydo.genai.list_knowledge_bases() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_knowledge_bases) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_knowledge_bases/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_knowledge_bases/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_knowledge_bases/#more-information)
