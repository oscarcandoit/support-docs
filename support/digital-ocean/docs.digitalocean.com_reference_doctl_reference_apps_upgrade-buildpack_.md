---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/upgrade-buildpack/"
title: "doctl apps upgrade-buildpack | DigitalOcean Documentation"
---
...
```shell
doctl apps upgrade-buildpack <app id> [flags]
```
...
| `--major-version` | The major version to upgrade to. If empty, the buildpack upgrades to the latest available version.<br>Default: `0` |
| `--no-header` | Return raw data with no headers<br>Default: `false` |
| `--trigger-deployment` | Specifies whether to trigger a new deployment to apply the upgrade.<br>Default: `true` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/upgrade-buildpack/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/upgrade-buildpack/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/upgrade-buildpack/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/upgrade-buildpack/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/upgrade-buildpack/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/upgrade-buildpack/#global-flags)
