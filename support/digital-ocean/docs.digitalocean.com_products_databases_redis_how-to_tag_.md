---
url: "https://docs.digitalocean.com/products/databases/redis/how-to/tag/"
title: "How to Tag Caching Database Clusters | DigitalOcean Documentation"
---
...
# How to Tag Caching Database Clusters
...
Tags are custom labels you can apply to database clusters and other DigitalOcean resources. You can filter tagged databases clusters or [create monitoring alert policies](https://docs.digitalocean.com/products/databases/redis/how-to/set-up-alerts/) for multiple databases clusters with the same tag.
...
- [Limits](https://docs.digitalocean.com/products/databases/redis/how-to/tag/#limits)
- [Known Issues](https://docs.digitalocean.com/products/databases/redis/how-to/tag/#known-issues)
- [Tag Database Clusters During Creation](https://docs.digitalocean.com/products/databases/redis/how-to/tag/#tag-database-clusters-during-creation)
- [Tag Existing Database Clusters](https://docs.digitalocean.com/products/databases/redis/how-to/tag/#tag-existing-database-clusters)
- [Filter by Tag](https://docs.digitalocean.com/products/databases/redis/how-to/tag/#filter)
