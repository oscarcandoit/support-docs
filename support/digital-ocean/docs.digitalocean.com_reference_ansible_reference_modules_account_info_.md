---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/account_info/"
title: "account_info | DigitalOcean Documentation"
---
...
Show information about the current user account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/account\_get](https://docs.digitalocean.com/reference/api/api-reference/#operation/account_get).
...
| --- | --- | --- |
| `account`<br>dict | always | Account information.<br>Sample:<br>```json<br>{<br>  "droplet_limit": 25,<br>  "email": "sammy@digitalocean.com",<br>  "email_verified\"": "true,",<br>  "floating_ip_limit": 5,<br>  "status": "active",<br>  "status_message": " ",<br>  "team": {<br>    "name": "My Team",<br>    "uuid": "5df3e3004a17e242b7c20ca6c9fc25b701a47ece"<br>  },<br>  "uuid": "b6fr89dbf6d9156cace5f3c78dc9851d957381ef"<br>}<br>``` |
...
| `msg`<br>str | always | Account information result.<br>Sample:<br>```json<br>[<br>  "Current account information",<br>  "Current account information not found"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/account_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/account_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/account_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/account_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/account_info/#return-values)
