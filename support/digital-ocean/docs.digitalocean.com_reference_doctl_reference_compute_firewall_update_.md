---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/update/"
title: "doctl compute firewall update | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [firewall](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/)
        - [add-droplets](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-droplets/)
        - [add-rules](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-rules/)
        - [add-tags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/add-tags/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list/)
        - [list-by-droplet](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list-by-droplet/)
        - [remove-droplets](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-droplets/)
        - [remove-rules](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-rules/)
        - [remove-tags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/remove-tags/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/update/)
...
Updates the configuration of an existing cloud firewall. The request should contain a full representation of the firewall, including existing attributes. Any attributes that are not provided are reset to their default values.
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/update/#global-flags)
