---
url: "https://docs.digitalocean.com/reference/pydo/reference/uptime/update_alert/"
title: "pydo.uptime.update_alert() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/uptime_update_alert) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_alert/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_alert/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_alert/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/uptime/update_alert/#more-information)
