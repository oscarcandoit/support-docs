---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/images/"
title: "digitalocean_images | DigitalOcean Documentation"
---
...
Note: You can use the [`digitalocean_image`](https://docs.digitalocean.com/reference/terraform/reference/data-sources/images/image) data source to obtain metadata
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/images/#example-usage)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/images/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/images/#attributes-reference)
