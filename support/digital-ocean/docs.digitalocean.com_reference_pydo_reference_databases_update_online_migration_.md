---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_online_migration/"
title: "pydo.databases.update_online_migration() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- update\_online\_migration()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.update\_online\_migration()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_onlineMigration) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_online_migration/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_online_migration/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/update_online_migration/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_online_migration/#more-information)
