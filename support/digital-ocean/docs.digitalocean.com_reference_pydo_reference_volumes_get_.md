---
url: "https://docs.digitalocean.com/reference/pydo/reference/volumes/get/"
title: "pydo.volumes.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/volumes_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/volumes/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/volumes/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/volumes/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/volumes/get/#more-information)
