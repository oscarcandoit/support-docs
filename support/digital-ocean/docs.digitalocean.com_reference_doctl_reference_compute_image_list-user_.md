---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-user/"
title: "doctl compute image list-user | DigitalOcean Documentation"
---
...
The following example lists all user-created images on your account and uses the `--format` flag to return only the ID, name, distribution, and slug for each image:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-user/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-user/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-user/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-user/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-user/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-user/#global-flags)
