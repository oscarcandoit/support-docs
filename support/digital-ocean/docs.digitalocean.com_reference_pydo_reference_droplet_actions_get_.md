---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/get/"
title: "pydo.droplet_actions.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/dropletActions_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplet_actions/get/#more-information)
