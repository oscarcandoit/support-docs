---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/list/"
title: "doctl registries list | DigitalOcean Documentation"
---
...
Lists information about all registries in your account, including:
...
The following example lists all registries in your account:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/list/#global-flags)
