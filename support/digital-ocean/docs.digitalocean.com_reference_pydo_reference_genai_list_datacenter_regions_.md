---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_datacenter_regions/"
title: "pydo.genai.list_datacenter_regions() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `serves_inference` | boolean | False | Include datacenters that serve inference. |  |
| `serves_batch` | boolean | False | Include datacenters that are capable of running batch jobs. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_datacenter_regions) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_datacenter_regions/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_datacenter_regions/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_datacenter_regions/#more-information)
