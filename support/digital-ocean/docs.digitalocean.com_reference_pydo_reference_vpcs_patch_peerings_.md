---
url: "https://docs.digitalocean.com/reference/pydo/reference/vpcs/patch_peerings/"
title: "pydo.vpcs.patch_peerings() | DigitalOcean Documentation"
---
...
| `vpc_peering_id` | string | True | A unique identifier for a VPC peering. |  |
| `body` | JSON or IO\[bytes\] | True |  |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/vpcs_patch_peerings) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/vpcs/patch_peerings/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/vpcs/patch_peerings/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/vpcs/patch_peerings/#more-information)
