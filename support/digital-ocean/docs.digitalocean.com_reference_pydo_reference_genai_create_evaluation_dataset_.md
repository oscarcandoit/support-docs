---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/create_evaluation_dataset/"
title: "pydo.genai.create_evaluation_dataset() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_create_evaluation_dataset) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/create_evaluation_dataset/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/create_evaluation_dataset/#more-information)
