---
url: "https://docs.digitalocean.com/support/why-cant-i-create-a-droplet-from-a-snapshot/"
title: "Why can't I create a Droplet from a snapshot? | DigitalOcean Documentation"
---
...
Validated on 4 Oct 2022 • Last edited on 29 Sep 2023

You cannot create Droplets in certain datacenters due to limited capacity. If your snapshot is in a limited capacity datacenter, you can’t create a Droplet from that snapshot.

If you have a snapshot in a datacenter where Droplet creation is not available, [transfer the snapshot to another datacenter](https://docs.digitalocean.com/products/snapshots/how-to/change-regions/). You can then create a new Droplet from that snapshot in the new datacenter.

You can see where Droplets are available on the [Droplet availability page](https://docs.digitalocean.com/products/droplets/details/availability/).
...
[Why can't I create a Droplet from a snapshot?](https://docs.digitalocean.com/support/why-cant-i-create-a-droplet-from-a-snapshot/)
