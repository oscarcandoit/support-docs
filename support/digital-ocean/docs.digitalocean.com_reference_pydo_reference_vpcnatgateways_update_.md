---
url: "https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/update/"
title: "pydo.vpcnatgateways.update() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `id` | string | True | The unique identifier of the VPC NAT gateway. |  |
| `body` | JSON or IO\[bytes\] | False |  |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/vpcnatgateways_update) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/update/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/update/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/update/#more-information)
