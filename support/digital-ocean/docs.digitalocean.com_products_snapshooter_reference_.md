---
url: "https://docs.digitalocean.com/products/snapshooter/reference/"
title: "SnapShooter Reference | DigitalOcean Documentation"
---
...
## Additional Tools for SnapShooter

### The SnapShooter API

![](https://docs.digitalocean.com/images/icons/snapshooter.svg)

SnapShooter API Documentation

The SnapShooter API lets you programmatically take and manage backups on the SnapShooter platform.

snapshooter.com

In this article...

- [Additional Tools for SnapShooter](https://docs.digitalocean.com/products/snapshooter/reference/#additional-tools-for-snapshooter)
  - [The SnapShooter API](https://docs.digitalocean.com/products/snapshooter/reference/#the-snapshooter-api)
