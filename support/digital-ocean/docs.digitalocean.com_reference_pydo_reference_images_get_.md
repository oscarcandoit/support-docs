---
url: "https://docs.digitalocean.com/reference/pydo/reference/images/get/"
title: "pydo.images.get() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `image_id` | JSON | True | A unique number (id) or string (slug) used to identify and reference a<br>specific image.<br>**Public** images can be identified by image `id` or `slug`.<br>**Private** images _must_ be identified by image `id`. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/images_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/images/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/images/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/images/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/images/get/#more-information)
