---
url: "https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/get/"
title: "pydo.vpcnatgateways.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/vpcnatgateways_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/get/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/vpcnatgateways/get/#more-information)
