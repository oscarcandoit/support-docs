---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list/"
title: "doctl compute droplet-autoscale list | DigitalOcean Documentation"
---
...
```shell
doctl compute droplet-autoscale list [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list/#aliases)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list/#global-flags)
