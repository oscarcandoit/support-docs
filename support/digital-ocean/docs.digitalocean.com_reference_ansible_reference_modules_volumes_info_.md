---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/volumes_info/"
title: "volumes_info | DigitalOcean Documentation"
---
...
List all of the block storage volumes available on your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/volumes\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/volumes_list).
...
| `msg`<br>str | always | Volumes result information.<br>Sample:<br>```json<br>[<br>  "Current volumes",<br>  "No volumes"<br>]<br>``` |
| `volumes`<br>list | always | Volumes.<br>Sample:<br>```json<br>[<br>  {<br>    "created_at": "2022-11-28T02:07:45Z",<br>    "description": "Block store for examples",<br>    "droplet_ids": [],<br>    "filesystem_label": "example",<br>    "filesystem_type": "ext4",<br>    "id": "72b1d6de-6ec1-11ed-8a0d-0a58ac1466a8",<br>    "name": "example",<br>    "region": {<br>      "available": true,<br>      "features": [<br>        "backups",<br>        "ipv6",<br>        "metadata",<br>        "install_agent",<br>        "storage",<br>        "image_transfer"<br>      ],<br>      "name": "New York 3",<br>      "sizes": [<br>        "s-1vcpu-1gb",<br>        "s-1vcpu-1gb-amd",<br>        "s-1vcpu-1gb-intel",<br>        "..."<br>      ],<br>      "slug": "nyc3"<br>    },<br>    "size_gigabytes": 1,<br>    "tags": []<br>  }<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/volumes_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/volumes_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/volumes_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/volumes_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/volumes_info/#return-values)
