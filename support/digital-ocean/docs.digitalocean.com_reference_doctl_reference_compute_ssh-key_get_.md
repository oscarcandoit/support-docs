---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/get/"
title: "doctl compute ssh-key get | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [ssh-key](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/get/)
        - [import](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/import/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/list/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/update/)
...
```shell
doctl compute ssh-key get <key-id|key-fingerprint> [flags]
```
...
Use this command to get the id, fingerprint, public\_key, and name of a specific SSH key on your account.

## Flags

| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Name`, `FingerPrint`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/get/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/ssh-key/get/#global-flags)
