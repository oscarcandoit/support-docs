---
url: "https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/gatsby/"
title: "Sample App for Gatsby | DigitalOcean Documentation"
---
...
- [Getting Started](https://docs.digitalocean.com/products/app-platform/getting-started/)
  ...
  - [Sample Apps](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/)
    - [Asp .Net Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/aspnet/)
    - [Docker Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/docker/)
    - [Express.js Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/express.js/)
    - [Flask Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/flask/)
    - [Gatsby Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/gatsby/)
    - [Gin Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/gin/)
    - [Go Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/go/)
    - [Hugo Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/hugo/)
    - [Laravel Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/laravel/)
    - [Next.js Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/next.js/)
    - [Node.js Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/node/)
    - [Nuxt.js Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/nuxt.js/)
    - [PHP Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/php/)
    - [Python Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/python/)
    - [React Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/react/)
    - [Ruby Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/ruby/)
    - [Spring Boot Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/spring-boot/)
    - [Static Assets Sample App](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/static-assets/)
...
# Sample App for Gatsby

Generated on 25 Nov 2025

App Platform is a Platform-as-a-Service (PaaS) offering that allows developers to publish code directly to DigitalOcean servers without worrying about the underlying infrastructure.

The NodeJS buildpack applies to this sample app. See the [NodeJS buildpack overview](https://docs.digitalocean.com/products/app-platform/reference/buildpacks/nodejs/) for more information about its configuration options and limitations.

> This content is automatically generated from [https://github.com/digitalocean/sample-gatsby/blob/main/README.md](https://github.com/digitalocean/sample-gatsby/blob/main/README.md).
...
[![Deploy to DigitalOcean](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/apps/new?repo=https://github.com/digitalocean/sample-gatsby/tree/main)

Note that, for the purposes of this tutorial, this button deploys the app directly from DigitalOcean’s GitHub repository, which disables automatic redeployment since you cannot change our template. If you want automatic redeployment or you want to change the sample app’s code to your own, we instead recommend you fork [our repository](https://github.com/digitalocean/sample-gatsby/tree/main).

To fork our repository, click the **Fork** button in the top-right of [its page on GitHub](https://github.com/digitalocean/sample-gatsby/tree/main), then follow the on-screen instructions. To learn more about forking repos, see the [GitHub documentation](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo).

After forking the repo, you can view the same README in your own GitHub org; for example, in `https://github.com/<your-org>/sample-gatsby`. To deploy the new repo, visit the [control panel](https://cloud.digitalocean.com/apps) and click the **Create App** button. This takes you to the app creation page. Under **Service Provider**, select **GitHub**. Then, under **Repository**, select your newly-forked repo. Ensure that your branch is set to **main** and **Autodeploy** is checked on. Finally, click **Next**.
...
3. Visit the [control panel](https://cloud.digitalocean.com/apps) and navigate to your sample app.
...
- [Limits](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/gatsby/#limits)
