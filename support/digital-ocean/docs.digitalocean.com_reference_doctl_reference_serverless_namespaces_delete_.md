---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/delete/"
title: "doctl serverless namespaces delete | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl serverless](https://docs.digitalocean.com/reference/doctl/reference/serverless/)
      ...
      - [namespaces](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/delete/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list/)
        - [list-regions](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list-regions/)
...
# doctl serverless namespaces delete
...
```shell
doctl serverless namespaces delete <namespaceIdOrLabel> [flags]
```
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Just do it, omitting confirmatory prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/delete/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/delete/#global-flags)
