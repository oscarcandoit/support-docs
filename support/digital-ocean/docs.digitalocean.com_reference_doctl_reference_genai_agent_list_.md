---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list/"
title: "doctl genai agent list | DigitalOcean Documentation"
---
...
Retrieves a list of all the agents on your account, including the following information for each:
\- The Agent ID
\- The Agent name
\- The Agent’s region
...
The following example retrieves a list of all Agent in the `tor1` region:
...
| `--region` | Retrieves a list of Agents in a specified region |
| `--tag` | Retrieves a list of Agents with a specified tag |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/list/#global-flags)
