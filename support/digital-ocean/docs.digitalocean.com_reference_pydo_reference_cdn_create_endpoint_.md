---
url: "https://docs.digitalocean.com/reference/pydo/reference/cdn/create_endpoint/"
title: "pydo.cdn.create_endpoint() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/cdn_create_endpoint) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/cdn/create_endpoint/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/cdn/create_endpoint/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/cdn/create_endpoint/#more-information)
