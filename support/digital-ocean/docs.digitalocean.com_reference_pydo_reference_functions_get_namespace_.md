---
url: "https://docs.digitalocean.com/reference/pydo/reference/functions/get_namespace/"
title: "pydo.functions.get_namespace() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/functions_get_namespace) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/functions/get_namespace/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/functions/get_namespace/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/functions/get_namespace/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/functions/get_namespace/#more-information)
