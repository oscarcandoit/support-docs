---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/backups/"
title: "doctl databases backups | DigitalOcean Documentation"
---
...
```shell
doctl databases backups <database-cluster-id> [flags]
```
...
Retrieves a list of backups created for the specified database cluster.

The list contains the size in GB, and the date and time the backup was created.

## Example

The following example retrieves a list of backups for a database cluster with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Size`, `Created`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/backups/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/backups/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/backups/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/backups/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/backups/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/backups/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/backups/#global-flags)
