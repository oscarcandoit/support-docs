---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_dangerous/"
title: "pydo.droplets.destroy_with_associated_resources_dangerous() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [droplets](https://docs.digitalocean.com/reference/pydo/reference/droplets/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/droplets/create/)
      - [destroy()](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy/)
      - [destroy\_by\_tag()](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_by_tag/)
      - [destroy\_retry\_with\_associated\_resources()](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_retry_with_associated_resources/)
      - [destroy\_with\_associated\_resources\_dangerous()](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_dangerous/)
      - [destroy\_with\_associated\_resources\_selective()](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_selective/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/droplets/get/)
      - [get\_backup\_policy()](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_backup_policy/)
      - [get\_destroy\_associated\_resources\_status()](https://docs.digitalocean.com/reference/pydo/reference/droplets/get_destroy_associated_resources_status/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list/)
      - [list\_associated\_resources()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_associated_resources/)
      - [list\_backup\_policies()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_backup_policies/)
      - [list\_backups()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_backups/)
      - [list\_firewalls()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_firewalls/)
      - [list\_kernels()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_kernels/)
      - [list\_neighbors()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_neighbors/)
      - [list\_neighbors\_ids()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_neighbors_ids/)
      - [list\_snapshots()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_snapshots/)
      - [list\_supported\_backup\_policies()](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_supported_backup_policies/)
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [droplets](https://docs.digitalocean.com/reference/pydo/reference/droplets/)
- destroy\_with\_associated\_resources\_dangerous()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.droplets.destroy\_with\_associated\_resources\_dangerous()
...
| `X-Dangerous` | boolean | True | Acknowledge this action will destroy the Droplet and all associated resources and _can not_ be reversed. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_destroy_withAssociatedResourcesDangerous) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_dangerous/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_dangerous/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_dangerous/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/destroy_with_associated_resources_dangerous/#more-information)
