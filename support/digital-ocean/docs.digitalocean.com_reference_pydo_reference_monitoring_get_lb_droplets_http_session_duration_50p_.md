---
url: "https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_lb_droplets_http_session_duration_50p/"
title: "pydo.monitoring.get_lb_droplets_http_session_duration_50p() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [monitoring](https://docs.digitalocean.com/reference/pydo/reference/monitoring/)
- get\_lb\_droplets\_http\_session\_duration\_50p()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/monitoring_get_lb_droplets_http_session_duration_50p) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_lb_droplets_http_session_duration_50p/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_lb_droplets_http_session_duration_50p/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_lb_droplets_http_session_duration_50p/#more-information)
