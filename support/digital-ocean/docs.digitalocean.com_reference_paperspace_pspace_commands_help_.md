---
url: "https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/"
title: "help | DigitalOcean Documentation"
---
...
The command to show help for. One of `autoscaling-group`, `config`, `console`, `deployment`, `docs`, `init`, `login`, `logout`, `machine`, `machine-event`, `private-network`, `project`, `public-ip`, `secret`, `signup`, `snapshot`, `shared-drive`, `startup-script`, `template`, `up`, `upgrade`, `version`, `completion`, or `help`.
...
- [Arguments](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#arguments)
  - [\[argument\] (string, required)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#argument-string-required)
- [Global Flags](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#global-flags)
  - [–log-level, -l (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#log-level--l-string-optional)
  - [–json, -j (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#json--j-boolean-optional)
  - [–api-key (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#api-key-string-optional)
  - [–help, -h (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#help--h-boolean-optional)
- [pspace help commands](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#pspace-help-commands)
  - [Flags](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#flags)
    - [–all, -a (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#all--a-boolean-optional)
  - [Global Flags](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#global-flags-1)
    - [–log-level, -l (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#log-level--l-string-optional-1)
    - [–json, -j (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#json--j-boolean-optional-1)
    - [–api-key (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#api-key-string-optional-1)
    - [–help, -h (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/help/#help--h-boolean-optional-1)
