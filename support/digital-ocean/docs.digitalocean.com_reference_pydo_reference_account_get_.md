---
url: "https://docs.digitalocean.com/reference/pydo/reference/account/get/"
title: "pydo.account.get() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    - [account](https://docs.digitalocean.com/reference/pydo/reference/account/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/account/get/)
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/account_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/account/get/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/account/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/account/get/#more-information)
