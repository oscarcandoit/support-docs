---
url: "https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/update/"
title: "pydo.ssh_keys.update() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/sshKeys_update) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/update/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/update/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/update/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/ssh_keys/update/#more-information)
