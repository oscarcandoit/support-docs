---
url: "https://docs.digitalocean.com/support/why-didnt-i-receive-a-password-reset-email-or-verification-code/"
title: "Why didn't I receive a password reset email or verification code? | DigitalOcean Documentation"
---
...
Validated on 15 Mar 2024 • Last edited on 29 Mar 2024

Email generally arrives quickly. If you haven’t received the email you requested within a few minutes:

- Make sure you’re checking the right email address.
- Check your spam folder for the email. If you find it there, we recommend adding `*.digitalocean.com` to your email [allowlist](https://www.whatcounts.com/resources/checklists/how-to-safelist-emails/).
- If your email client needs to be refreshed, make sure you’ve actively checked for new mail.

If you were expecting an SMS message with a verification code, make sure you aren’t blocking communications from us and that you have entered the correct phone number in [your profile’s **Security** page](https://cloud.digitalocean.com/account/security).

If you still haven’t received the password reset email or verification code you expected, [open a support ticket](https://www.digitalocean.com/company/contact/support) with your device details in the description. To get your device details, visit [whatsmybrowser.org](https://www.whatsmybrowser.org/) and click **Copy**, then paste the URL in the ticket description.
...
[Why didn't I receive a password reset email or verification code?](https://docs.digitalocean.com/support/why-didnt-i-receive-a-password-reset-email-or-verification-code/)
