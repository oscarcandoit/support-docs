---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/get_options/"
title: "pydo.registries.get_options() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_get_options) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/get_options/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/get_options/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/get_options/#more-information)
