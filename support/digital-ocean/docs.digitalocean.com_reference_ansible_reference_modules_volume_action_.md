---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/volume_action/"
title: "volume_action | DigitalOcean Documentation"
---
...
On older Droplets, additional configuration is required. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#tag/Block-Storage-Actions](https://docs.digitalocean.com/reference/api/api-reference/#tag/Block-Storage-Actions).
...
| `droplet_name`<br>str / **required** |  | The name of the Droplet to attach or detach to the volume to. |
...
| `region`<br>str / **required** |  | Set to the slug representing the region where the volume and Droplet is located. |
...
| `volume_name`<br>str / **required** |  | The name of the block storage volume to attach or detach. |
...
| --- | --- | --- |
| `action`<br>dict | always | DigitalOcean volume action information.<br>Sample:<br>```json<br>{<br>  "completed_at": "2020-11-12T17:51:14Z",<br>  "id": 72531856,<br>  "region": {<br>    "available": true,<br>    "features": [<br>      "private_networking",<br>      "backups",<br>      "ipv6",<br>      "metadata"<br>    ],<br>    "name": "New York 1",<br>    "sizes": [<br>      "s-1vcpu-1gb",<br>      "s-1vcpu-2gb",<br>      "s-1vcpu-3gb",<br>      "s-2vcpu-2gb",<br>      "s-3vcpu-1gb",<br>      "s-2vcpu-4gb",<br>      "s-4vcpu-8gb",<br>      "s-6vcpu-16gb",<br>      "s-8vcpu-32gb",<br>      "s-12vcpu-48gb",<br>      "s-16vcpu-64gb",<br>      "s-20vcpu-96gb",<br>      "s-24vcpu-128gb",<br>      "s-32vcpu-192gb"<br>    ],<br>    "slug": "nyc1"<br>  },<br>  "region_slug": "nyc1",<br>  "resource_type": "volume",<br>  "started_at": "2020-11-12T17:51:03Z",<br>  "status": "completed",<br>  "type": "attach_volume"<br>}<br>``` |
...
| `msg`<br>str | always | DigitalOcean volume action information.<br>Sample:<br>```json<br>[<br>  "No volume named test-vol in nyc3",<br>  "Multiple volumes named test-vol in nyc3",<br>  "No Droplet named test-droplet in nyc3",<br>  "Multiple Droplets named test-droplet in nyc3",<br>  "Volume test-vol in nyc3 attached to test-droplet",<br>  "Attached volume test-vol in nyc3 to test-droplet",<br>  "Volume test-vol in nyc3 not attached to test-droplet",<br>  "Detached volume test-vol in nyc3 from test-droplet",<br>  "Volume test-vol in nyc3 would be attahed to test-droplet",<br>  "Volume test-vol in nyc3 would be detached from test-droplet"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/volume_action/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/volume_action/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/volume_action/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/volume_action/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/volume_action/#return-values)
