---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/set/"
title: "doctl databases sql-mode set | DigitalOcean Documentation"
---
...
This command configures the SQL modes for the specified MySQL database cluster. The SQL modes should be provided as a space separated list.
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/set/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/set/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/set/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/set/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/set/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/set/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/set/#global-flags)
