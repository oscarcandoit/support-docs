---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/list/"
title: "pydo.registries.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/list/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/list/#more-information)
