---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_options/"
title: "pydo.kubernetes.list_options() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_list_options) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_options/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_options/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/list_options/#more-information)
