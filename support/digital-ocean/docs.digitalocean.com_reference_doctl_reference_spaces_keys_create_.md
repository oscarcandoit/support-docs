---
url: "https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/create/"
title: "doctl spaces keys create | DigitalOcean Documentation"
---
...
```shell
doctl spaces keys create <name> [flags]
```

## Description

Create a key for a Space with the provided name.

## Flags

| Option | Description |
| --- | --- |
| `--grants`, `-g` | A comma-separated list of grants to add to the key. The permission should be either ‘read’, ‘readwrite’, or ‘fullaccess’.<br>Format: `"bucket=your-bucket;permission=your-permission"` (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/create/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/create/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/create/#global-flags)
