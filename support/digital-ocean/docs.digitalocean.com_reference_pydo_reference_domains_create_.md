---
url: "https://docs.digitalocean.com/reference/pydo/reference/domains/create/"
title: "pydo.domains.create() | DigitalOcean Documentation"
---
...
“ip\_address” attribute, and an A record will be automatically created pointing
to the apex domain.
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/domains_create) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/domains/create/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/domains/create/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/domains/create/#more-information)
