---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/options/available-regions/"
title: "doctl registries options available-regions | DigitalOcean Documentation"
---
...
```shell
doctl registries options available-regions [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/options/available-regions/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/options/available-regions/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/options/available-regions/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/options/available-regions/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/options/available-regions/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/options/available-regions/#global-flags)
