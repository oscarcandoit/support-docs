---
url: "https://docs.digitalocean.com/reference/doctl/reference/vpcs/create/"
title: "doctl vpcs create | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/vpcs/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/vpcs/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/vpcs/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/vpcs/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/vpcs/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/create/#global-flags)
