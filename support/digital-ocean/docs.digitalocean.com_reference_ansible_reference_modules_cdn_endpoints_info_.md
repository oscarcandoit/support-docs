---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/cdn_endpoints_info/"
title: "cdn_endpoints_info | DigitalOcean Documentation"
---
...
List all of the CDN endpoints available on your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/cdn\_list\_endpoints](https://docs.digitalocean.com/reference/api/api-reference/#operation/cdn_list_endpoints).
...
| --- | --- | --- |
| `endpoints`<br>list | always | CDN endpoints.<br>Sample:<br>```json<br>[<br>  {<br>    "certificate_id": "892071a0-bb95-49bc-8021-3afd67a210bf",<br>    "created_at": "2018-07-19T15:04:16Z",<br>    "custom_domain": "static.example.com",<br>    "endpoint": "static-images.nyc3.cdn.digitaloceanspaces.com",<br>    "id": "19f06b6a-3ace-4315-b086-499a0e521b76",<br>    "origin": "static-images.nyc3.digitaloceanspaces.com",<br>    "ttl": 3600<br>  }<br>]<br>``` |
...
| `msg`<br>str | always | CDN endpoints result information.<br>Sample:<br>```json<br>[<br>  "Current CDN endpoints",<br>  "No CDN endpoints"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/cdn_endpoints_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/cdn_endpoints_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/cdn_endpoints_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/cdn_endpoints_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/cdn_endpoints_info/#return-values)
