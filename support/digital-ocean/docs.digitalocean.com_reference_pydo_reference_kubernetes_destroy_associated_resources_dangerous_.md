---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_dangerous/"
title: "pydo.kubernetes.destroy_associated_resources_dangerous() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [kubernetes](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/)
- destroy\_associated\_resources\_dangerous()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_destroy_associatedResourcesDangerous) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_dangerous/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_dangerous/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_dangerous/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_dangerous/#more-information)
