---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/list/"
title: "pydo.reserved_ips_actions.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [reserved\_ips\_actions](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/list/)
      - [post()](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/post/)
...
# pydo.reserved\_ips\_actions.list()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPsActions_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips_actions/list/#more-information)
