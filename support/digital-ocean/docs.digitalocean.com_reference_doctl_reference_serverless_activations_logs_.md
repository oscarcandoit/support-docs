---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/logs/"
title: "doctl serverless activations logs | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--follow` | Continuously return log information.<br>Default: `false` |
| `--function`, `-f` | Retrieve the logs for a specific function. |
| `--help`, `-h` | Help for this command |
| `--last`, `-l` | Retrieve logs for the most recent activation (default).<br>Default: `false` |
| `--limit`, `-n` | Limit the number of logs returned to the specified amount, up to 200.<br>Default: `1` |
| `--package`, `-p` | Retrieve the logs for a specific package. |
| `--strip`, `-r` | Retrieves only the first line of output in the log, stripped of time stamps.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/logs/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/logs/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/logs/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/logs/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/logs/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/logs/#global-flags)
