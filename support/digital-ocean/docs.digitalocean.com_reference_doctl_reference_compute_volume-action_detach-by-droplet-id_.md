---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach-by-droplet-id/"
title: "doctl compute volume-action detach-by-droplet-id | DigitalOcean Documentation"
---
...
# doctl compute volume-action detach-by-droplet-id
...
```shell
doctl compute volume-action detach-by-droplet-id <volume-id> <droplet-id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach-by-droplet-id/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach-by-droplet-id/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach-by-droplet-id/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach-by-droplet-id/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach-by-droplet-id/#global-flags)
