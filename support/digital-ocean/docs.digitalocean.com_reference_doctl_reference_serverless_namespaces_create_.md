---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/create/"
title: "doctl serverless namespaces create | DigitalOcean Documentation"
---
...
| `--label`, `-l` | the label for the namespace (required) |
| `--no-connect`, `-n` | don’t immediately connect to the created namespace<br>Default: `false` |
| `--region`, `-r` | the region for the namespace (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/create/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/create/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/create/#global-flags)
