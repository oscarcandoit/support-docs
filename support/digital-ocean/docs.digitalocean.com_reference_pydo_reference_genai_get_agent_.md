---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/get_agent/"
title: "pydo.genai.get_agent() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_get_agent) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/get_agent/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/get_agent/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/get_agent/#more-information)
