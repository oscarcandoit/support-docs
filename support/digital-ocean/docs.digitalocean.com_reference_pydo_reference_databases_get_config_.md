---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_config/"
title: "pydo.databases.get_config() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_config) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_config/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_config/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/get_config/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_config/#more-information)
