---
url: "https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/"
title: "Megatron (ROCm 7) | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/)
...
from [the Megatron (ROCm 7) catalog page](https://marketplace.digitalocean.com/apps/megatron-rocm-7)
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=amd-megatronrocm7)

## Creating an App using the API

In addition to creating a Droplet from the Megatron (ROCm 7) 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB Megatron (ROCm 7) Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"amd-megatronrocm7"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying Megatron (ROCm 7)
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/#creating-an-app-using-the-api)
- [Getting Started After Deploying Megatron (ROCm 7)](https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/#getting-started-after-deploying-megatron-rocm-7)
- [Accessing Megatron + ROCm resources and libraries](https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/#accessing-megatron--rocm-resources-and-libraries)
- [SSHing into your AMD 1-Click](https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/#sshing-into-your-amd-1-click)
- [Exploring via Jupyter](https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/#exploring-via-jupyter)
- [Exploring via Docker](https://docs.digitalocean.com/products/marketplace/catalog/megatron-rocm-7/#exploring-via-docker)
