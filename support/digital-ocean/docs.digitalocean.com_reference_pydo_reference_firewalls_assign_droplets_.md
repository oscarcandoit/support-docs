---
url: "https://docs.digitalocean.com/reference/pydo/reference/firewalls/assign_droplets/"
title: "pydo.firewalls.assign_droplets() | DigitalOcean Documentation"
---
...
# pydo.firewalls.assign\_droplets()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/firewalls_assign_droplets) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/firewalls/assign_droplets/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/firewalls/assign_droplets/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/firewalls/assign_droplets/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/firewalls/assign_droplets/#more-information)
