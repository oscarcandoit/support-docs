---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/sizes_info/"
title: "sizes_info | DigitalOcean Documentation"
---
...
List all of available Droplet sizes. View the API documentation at ( [https://docs.digitalocean.com/reference/api/api-reference/#operation/sizes\_list)](https://docs.digitalocean.com/reference/api/api-reference/#operation/sizes_list)).
...
| `msg`<br>str | always | Droplet sizes result information.<br>Sample:<br>```json<br>[<br>  "Current Droplet sizes",<br>  "No Droplet sizes"<br>]<br>``` |
| `sizes`<br>list | always | Droplet sizes information.<br>Sample:<br>```json<br>[<br>  {<br>    "available": true,<br>    "description": "Basic",<br>    "disk": 10,<br>    "memory": 512,<br>    "price_hourly": 0.00595,<br>    "price_monthly": 4,<br>    "regions": [<br>      "ams3",<br>      "fra1",<br>      "nyc1",<br>      "sfo3",<br>      "sgp1",<br>      "syd1"<br>    ],<br>    "slug": "s-1vcpu-512mb-10gb",<br>    "transfer": 0.5,<br>    "vcpus": 1<br>  },<br>  "..."<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/sizes_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/sizes_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/sizes_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/sizes_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/sizes_info/#return-values)
