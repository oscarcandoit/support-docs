---
url: "https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list/"
title: "pydo.partner_attachments.list() | DigitalOcean Documentation"
---
...
# pydo.partner\_attachments.list()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/partnerAttachments_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/list/#more-information)
