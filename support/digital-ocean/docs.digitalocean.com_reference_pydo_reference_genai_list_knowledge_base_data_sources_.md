---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_knowledge_base_data_sources/"
title: "pydo.genai.list_knowledge_base_data_sources() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- list\_knowledge\_base\_data\_sources()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_knowledge_base_data_sources) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_knowledge_base_data_sources/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_knowledge_base_data_sources/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_knowledge_base_data_sources/#more-information)
