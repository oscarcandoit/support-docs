---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-forwarding-rules/"
title: "doctl compute load-balancer add-forwarding-rules | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-forwarding-rules/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-forwarding-rules/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-forwarding-rules/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-forwarding-rules/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/add-forwarding-rules/#global-flags)
