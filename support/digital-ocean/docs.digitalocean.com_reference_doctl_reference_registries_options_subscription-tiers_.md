---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/options/subscription-tiers/"
title: "doctl registries options subscription-tiers | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl registries](https://docs.digitalocean.com/reference/doctl/reference/registries/)
      ...
      - [options](https://docs.digitalocean.com/reference/doctl/reference/registries/options/)
        - [available-regions](https://docs.digitalocean.com/reference/doctl/reference/registries/options/available-regions/)
        - [subscription-tiers](https://docs.digitalocean.com/reference/doctl/reference/registries/options/subscription-tiers/)
...
```shell
doctl registries options subscription-tiers [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/options/subscription-tiers/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/options/subscription-tiers/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/options/subscription-tiers/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/options/subscription-tiers/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/options/subscription-tiers/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/options/subscription-tiers/#global-flags)
