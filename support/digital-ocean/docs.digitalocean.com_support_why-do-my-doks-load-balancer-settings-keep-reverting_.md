---
url: "https://docs.digitalocean.com/support/why-do-my-doks-load-balancer-settings-keep-reverting/"
title: "Why do my DOKS load balancer settings keep reverting? | DigitalOcean Documentation"
---
...
We provide the DigitalOcean CCM service annotations on our [public GitHub repository](https://github.com/digitalocean/digitalocean-cloud-controller-manager/blob/master/docs/controllers/services/annotations.md). You can find additional documentation on the service annotations [here](https://docs.digitalocean.com/products/kubernetes/how-to/configure-load-balancers/).
...
[Why do my DOKS load balancer settings keep reverting?](https://docs.digitalocean.com/support/why-do-my-doks-load-balancer-settings-keep-reverting/)
