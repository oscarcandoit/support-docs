---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/tag/list/"
title: "doctl compute tag list | DigitalOcean Documentation"
---
...
Retrieves a list of all the tags in your account and how many resources are using each tag.
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/list/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/list/#global-flags)
