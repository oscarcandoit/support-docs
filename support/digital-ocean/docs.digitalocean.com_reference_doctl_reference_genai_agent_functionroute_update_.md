---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/update/"
title: "doctl genai agent functionroute update | DigitalOcean Documentation"
---
    ...
    - [doctl genai](https://docs.digitalocean.com/reference/doctl/reference/genai/)
      - [agent](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/)
        ...
        - [functionroute](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/)
          - [create](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/create/)
          - [delete](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/delete/)
          - [update](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/update/)
...
# doctl genai agent functionroute update
...
```shell
doctl genai agent functionroute update [flags]
```
...
| `--description` | Updated description of the function route |
| `--faas-name` | Name of the function route in the DigitalOcean functions platform |
| `--faas-namespace` | Namespace of the function route in the DigitalOcean functions platform |
...
| `--function-id` | Function route ID to update (required) |
| `--help`, `-h` | Help for this command |
| `--input-schema` | Input schema of the function route |
| `--name` | Name of the function. |
| `--no-header` | Return raw data with no headers<br>Default: `false` |
| `--output-schema` | Output schema of the function route |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/update/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/update/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/update/#global-flags)
