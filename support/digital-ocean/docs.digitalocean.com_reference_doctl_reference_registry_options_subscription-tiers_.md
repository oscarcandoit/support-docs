---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/options/subscription-tiers/"
title: "doctl registry options subscription-tiers | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl registry](https://docs.digitalocean.com/reference/doctl/reference/registry/)
      ...
      - [options](https://docs.digitalocean.com/reference/doctl/reference/registry/options/)
        - [available-regions](https://docs.digitalocean.com/reference/doctl/reference/registry/options/available-regions/)
        - [subscription-tiers](https://docs.digitalocean.com/reference/doctl/reference/registry/options/subscription-tiers/)
...
```shell
doctl registry options subscription-tiers [flags]
```
...
Lists available container registry subscription tiers
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/options/subscription-tiers/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registry/options/subscription-tiers/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/options/subscription-tiers/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/options/subscription-tiers/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/options/subscription-tiers/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/options/subscription-tiers/#global-flags)
