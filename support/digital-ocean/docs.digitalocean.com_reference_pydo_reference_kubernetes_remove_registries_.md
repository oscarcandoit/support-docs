---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/remove_registries/"
title: "pydo.kubernetes.remove_registries() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_remove_registries) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/remove_registries/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/remove_registries/#more-information)
