---
url: "https://docs.digitalocean.com/reference/pydo/reference/load_balancers/delete_cache/"
title: "pydo.load_balancers.delete_cache() | DigitalOcean Documentation"
---
...
# pydo.load\_balancers.delete\_cache()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/loadBalancers_delete_cache) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/delete_cache/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/delete_cache/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/delete_cache/#more-information)
