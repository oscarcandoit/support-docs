---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_manifest/"
title: "pydo.registries.delete_repository_manifest() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [registries](https://docs.digitalocean.com/reference/pydo/reference/registries/)
- delete\_repository\_manifest()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.registries.delete\_repository\_manifest()
...
| `manifest_digest` | string | True | The manifest digest of a container registry repository tag. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_delete_repositoryManifest) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_manifest/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_manifest/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_manifest/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_manifest/#more-information)
