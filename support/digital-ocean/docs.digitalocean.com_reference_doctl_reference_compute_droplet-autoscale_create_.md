---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/create/"
title: "doctl compute droplet-autoscale create | DigitalOcean Documentation"
---
...
```shell
doctl compute droplet-autoscale create [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/create/#usage)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/create/#global-flags)
