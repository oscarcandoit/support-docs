---
url: "https://docs.digitalocean.com/support/does-digitalocean-support-dnssec/"
title: "Does DigitalOcean support DNSSEC? | DigitalOcean Documentation"
---
...
Validated on 5 Jun 2023 • Last edited on 29 Mar 2024

We do not support DNSSEC. This means we do not provide an option to configure DS records in our [DNS service](https://docs.digitalocean.com/products/networking/dns/). However, if you have already added your domain to our platform, then you need to disable DNSSEC at your domain registrar in order for the domain to receive DNS requests.

If you require DNSSEC functionality on your domain, we recommend switching to a different DNS provider for DNS management. With this approach, you can continue to manage your Droplets and other services through the [DigitalOcean Control Panel](https://cloud.digitalocean.com/apps) while entrusting your domain management elsewhere. We recommend [Cloudflare](https://developers.cloudflare.com/dns/) as they support DNSSEC.
...
[Does DigitalOcean support DNSSEC?](https://docs.digitalocean.com/support/does-digitalocean-support-dnssec/)
