---
url: "https://docs.digitalocean.com/products/marketplace/catalog/restyaboard-centos/"
title: "Restyaboard (CentOS) | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/restyaboard-centos/)
...
Generated on 14 Mar 2022
from [the Restyaboard (CentOS) catalog page](https://marketplace.digitalocean.com/apps/restyaboard-centos)
...
| PHP | [7.4](https://www.php.net/releases/) | [GPL](https://www.php.net/license/index.php) |
| Postgres | [13](https://packages.ubuntu.com/bionic/postgresql) | [Postgres SQL](https://opensource.org/licenses/postgresql) |
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=restya-restyaboardcento-8-3)

## Creating an App using the API

In addition to creating a Droplet from the Restyaboard (CentOS) 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB Restyaboard (CentOS) Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/restyaboard-centos/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/restyaboard-centos/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/restyaboard-centos/#creating-an-app-using-the-api)
- [Getting Started After Deploying Restyaboard (CentOS)](https://docs.digitalocean.com/products/marketplace/catalog/restyaboard-centos/#getting-started-after-deploying-restyaboard-centos)
