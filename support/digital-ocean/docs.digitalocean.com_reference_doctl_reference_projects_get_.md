---
url: "https://docs.digitalocean.com/reference/doctl/reference/projects/get/"
title: "doctl projects get | DigitalOcean Documentation"
---
...
```shell
doctl projects get <project-id> [flags]
```
...
Retrieves the following details for an existing project (use `default` as the  to retrieve details about your default project):
...
The following example retrieves details for a project with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl projects get f81d4fae-7dec-11d0-a765-00a0c91e6bf6
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/projects/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/projects/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/projects/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/projects/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/projects/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/projects/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/projects/get/#global-flags)
