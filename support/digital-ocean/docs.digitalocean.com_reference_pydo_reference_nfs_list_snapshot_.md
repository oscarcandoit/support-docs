---
url: "https://docs.digitalocean.com/reference/pydo/reference/nfs/list_snapshot/"
title: "pydo.nfs.list_snapshot() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `region` | string | True | The DigitalOcean region slug (e.g., nyc2, atl1) where the NFS share resides. |  |
| `share_id` | string | False | The unique ID of an NFS share. If provided, only snapshots of this specific share will be returned. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/nfs_list_snapshot) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/nfs/list_snapshot/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/nfs/list_snapshot/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/nfs/list_snapshot/#more-information)
