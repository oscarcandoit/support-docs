---
url: "https://docs.digitalocean.com/support/can-i-preserve-my-droplets-ipv4-address-when-i-transfer-the-droplet/"
title: "Can I preserve my Droplet's IPv4 address when I transfer the Droplet? | DigitalOcean Documentation"
---
...
Validated on 17 Oct 2022 • Last edited on 3 Nov 2022

Unfortunately, you cannot preserve a Droplet’s IP address when transferring the Droplet between regions, nor can you reassign a non-reserved IP address to another Droplet. See [our article about how we manage IPv4 addresses](https://docs.digitalocean.com/support/are-my-droplets-ip-addresses-static/) for more information.

If you need an IP address that you can reassign to different Droplets as needed, [use a Reserved IP address](https://docs.digitalocean.com/products/networking/reserved-ips/how-to/create/). Reserved IP addresses allow you to retain an IPv4 address and assign it to resources as needed.
...
[Can I preserve my Droplet's IPv4 address when I transfer the Droplet?](https://docs.digitalocean.com/support/can-i-preserve-my-droplets-ipv4-address-when-i-transfer-the-droplet/)
