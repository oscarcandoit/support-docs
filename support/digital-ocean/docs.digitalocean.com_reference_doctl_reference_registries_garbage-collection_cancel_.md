---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/cancel/"
title: "doctl registries garbage-collection cancel | DigitalOcean Documentation"
---
...
# doctl registries garbage-collection cancel
...
```shell
doctl registries garbage-collection cancel <registry-name> <gc-uuid> [flags]
```
...
The following example cancels the garbage collection with the uuid `gc-uuid` for a registry named `example-registry`:

```shell
doctl registries garbage-collection cancel example-registry gc-uuid
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/cancel/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/cancel/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/cancel/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/cancel/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/cancel/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/cancel/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/cancel/#global-flags)
