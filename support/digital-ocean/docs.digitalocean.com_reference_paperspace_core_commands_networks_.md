---
url: "https://docs.digitalocean.com/reference/paperspace/core/commands/networks/"
title: "networks | DigitalOcean Documentation"
---
...
```bash
curl -X GET 'https://api.paperspace.io/networks/getNetworks' \
...
| --- | --- | --- | --- |
| `id` | string | optional | network id to match on |
...
| `network` | string | optional | network to match on |
| `netmask` | string | optional | netmask to match on |
...
- [list](https://docs.digitalocean.com/reference/paperspace/core/commands/networks/#list)
  - [Examples](https://docs.digitalocean.com/reference/paperspace/core/commands/networks/#examples)
  - [Parameters](https://docs.digitalocean.com/reference/paperspace/core/commands/networks/#parameters)
  - [Response](https://docs.digitalocean.com/reference/paperspace/core/commands/networks/#response)
