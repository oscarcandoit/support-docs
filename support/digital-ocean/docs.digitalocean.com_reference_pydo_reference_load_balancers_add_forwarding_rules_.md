---
url: "https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_forwarding_rules/"
title: "pydo.load_balancers.add_forwarding_rules() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [load\_balancers](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/)
- add\_forwarding\_rules()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.load\_balancers.add\_forwarding\_rules()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/loadBalancers_add_forwardingRules) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_forwarding_rules/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_forwarding_rules/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_forwarding_rules/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_forwarding_rules/#more-information)
