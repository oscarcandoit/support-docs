---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/project_resources_info/"
title: "project_resources_info | DigitalOcean Documentation"
---
...
Retrieve a list of all of the project resources in your account. View the API documentation at ( [https://docs.digitalocean.com/reference/api/api-reference/#operation/projects\_list\_resources)](https://docs.digitalocean.com/reference/api/api-reference/#operation/projects_list_resources)).
...
| `project_id`<br>str |  | A unique identifier for a project. If unspecified, return project resources from the default project. |
...
| `msg`<br>str | always | Projects resources result information.<br>Sample:<br>```json<br>[<br>  "Current project resources",<br>  "No project resources"<br>]<br>``` |
| `project_resources`<br>list | always | Project resources.<br>Sample:<br>```json<br>[<br>  {<br>    "assigned_at": "2018-09-28T19:26:37Z",<br>    "links": {<br>      "self": "https://api.digitalocean.com/v2/droplets/13457723"<br>    },<br>    "status": "ok",<br>    "urn": "do:droplet:13457723"<br>  },<br>  {<br>    "assigned_at": "2019-03-31T16:24:14Z",<br>    "links": {<br>      "self": "https://api.digitalocean.com/v2/domains/example.com"<br>    },<br>    "urn": "do:domain:example.com"<br>  }<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/project_resources_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/project_resources_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/project_resources_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/project_resources_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/project_resources_info/#return-values)
