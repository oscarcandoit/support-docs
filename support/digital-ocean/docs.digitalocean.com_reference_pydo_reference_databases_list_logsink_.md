---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_logsink/"
title: "pydo.databases.list_logsink() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_logsink) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_logsink/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_logsink/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_logsink/#more-information)
