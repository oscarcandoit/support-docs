---
url: "https://docs.digitalocean.com/products/marketplace/catalog/vllm/"
title: "vLLM | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/vllm/)
...
from [the vLLM catalog page](https://marketplace.digitalocean.com/apps/rocm-vllm-jupyter)
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=digitaloceanai-rocmvllmjupyter)

## Creating an App using the API

In addition to creating a Droplet from the vLLM 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB vLLM Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.
...
## Getting Started After Deploying vLLM
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/vllm/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/vllm/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/vllm/#creating-an-app-using-the-api)
- [Getting Started After Deploying vLLM](https://docs.digitalocean.com/products/marketplace/catalog/vllm/#getting-started-after-deploying-vllm)
- [Accessing vLLM + ROCm resources and libraries](https://docs.digitalocean.com/products/marketplace/catalog/vllm/#accessing-vllm--rocm-resources-and-libraries)
- [SSHing into your AMD 1-Click](https://docs.digitalocean.com/products/marketplace/catalog/vllm/#sshing-into-your-amd-1-click)
- [Exploring via Jupyter](https://docs.digitalocean.com/products/marketplace/catalog/vllm/#exploring-via-jupyter)
- [Exploring via Docker](https://docs.digitalocean.com/products/marketplace/catalog/vllm/#exploring-via-docker)
