---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/detach/"
title: "doctl genai knowledge-base detach | DigitalOcean Documentation"
---
...
# doctl genai knowledge-base detach
...
```shell
doctl genai knowledge-base detach <agent-uuid> <knowledge-base-uuid> [flags]
```
...
Detaches a knowledge base from an agent using knowledge base uuid and agent uuid.

## Example

The following example detaches the Knowledge Base having uuid f81d4fae-7dec-11d0-a765-00a0c91e6bf6 from specific agent with uuid as `f81d4fae-0000-11d0-a765-000000000000`
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Detaches the knowledge base without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/detach/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/detach/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/detach/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/detach/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/detach/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/detach/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/knowledge-base/detach/#global-flags)
