---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/start/"
title: "doctl registries garbage-collection start | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl registries](https://docs.digitalocean.com/reference/doctl/reference/registries/)
      ...
      - [garbage-collection](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/)
        - [cancel](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/cancel/)
        - [get-active](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/get-active/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/list/)
        - [start](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/start/)
...
# doctl registries garbage-collection start
...
```shell
doctl registries garbage-collection start <registry-name> [flags]
```
...
```shell
doctl registries garbage-collection start example-registry
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/start/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/start/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/start/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/start/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/start/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/start/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/start/#global-flags)
