---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_cluster/"
title: "pydo.kubernetes.delete_cluster() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_delete_cluster) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_cluster/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_cluster/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_cluster/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/delete_cluster/#more-information)
