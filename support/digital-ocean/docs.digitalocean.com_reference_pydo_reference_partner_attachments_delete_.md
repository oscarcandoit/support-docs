---
url: "https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/delete/"
title: "pydo.partner_attachments.delete() | DigitalOcean Documentation"
---
...
# pydo.partner\_attachments.delete()
...
response = client.partner_attachments.delete("5a4981aa-9653-4bd1-bef5-d6bff52042e4")
```

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/partnerAttachments_delete) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/delete/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/delete/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/delete/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/delete/#more-information)
