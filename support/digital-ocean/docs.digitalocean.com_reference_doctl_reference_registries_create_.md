---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/create/"
title: "doctl registries create | DigitalOcean Documentation"
---
...
| `--region` | A `slug` indicating which datacenter region the registry reside in. For a list of supported region slugs, use the `doctl registries options available-regions` command |
| `--subscription-tier` | Subscription tier for the new registry. For a list of possible values, use the `doctl registries options subscription-tiers` command. (required)<br>Default: `basic` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/create/#global-flags)
