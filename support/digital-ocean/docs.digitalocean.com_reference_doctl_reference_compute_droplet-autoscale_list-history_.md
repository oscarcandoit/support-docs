---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-history/"
title: "doctl compute droplet-autoscale list-history | DigitalOcean Documentation"
---
...
# doctl compute droplet-autoscale list-history
...
```shell
doctl compute droplet-autoscale list-history <autoscale-pool-id> [flags]
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Current Instance`, `Target Instance`, `Status`, `Reason`, `Error Reason`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-history/#usage)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-history/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-history/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-history/#global-flags)
