---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster/"
title: "pydo.kubernetes.get_cluster() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_get_cluster) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/get_cluster/#more-information)
