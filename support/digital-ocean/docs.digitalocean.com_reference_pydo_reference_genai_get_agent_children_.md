---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/get_agent_children/"
title: "pydo.genai.get_agent_children() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_get_agent_children) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/get_agent_children/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/get_agent_children/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/get_agent_children/#more-information)
