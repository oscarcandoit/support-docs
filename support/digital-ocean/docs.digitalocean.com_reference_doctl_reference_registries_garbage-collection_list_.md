---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/list/"
title: "doctl registries garbage-collection list | DigitalOcean Documentation"
---
...
# doctl registries garbage-collection list
...
```shell
doctl registries garbage-collection list <registry-name> [flags]
```
...
The following example retrieves a list of past garbage collections for a registry named `example-registry`:

```shell
doctl registries garbage-collection list example-registry
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/list/#global-flags)
