---
url: "https://docs.digitalocean.com/products/databases/redis/how-to/set-up-alerts/"
title: "How to Set Up Caching Cluster Monitoring Alerts | DigitalOcean Documentation"
---
...
# How to Set Up Caching Cluster Monitoring Alerts

Validated on 27 Nov 2019 • Last edited on 16 Apr 2025
...
You can set alert policies based on your [cluster performance metrics](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/). Alert policies notify you when a performance metric rises above or falls below a threshold you set, and again when a metric returns to within the threshold. You can receive notifications via email or Slack.
...
![The Insights tab of a database cluster](https://docs.digitalocean.com/screenshots/databases/redis-insights-tab.c7ed20a188155485ea164c155c5611eef1032fa7eb3f1dece77644de46313983.png)
...
- [Create an Alert Policy](https://docs.digitalocean.com/products/databases/redis/how-to/set-up-alerts/#create-an-alert-policy)
- [Manage Alert Policies and Triggered Alerts](https://docs.digitalocean.com/products/databases/redis/how-to/set-up-alerts/#manage-alert-policies-and-triggered-alerts)
