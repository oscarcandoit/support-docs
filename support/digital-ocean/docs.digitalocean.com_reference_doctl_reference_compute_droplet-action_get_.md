---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/get/"
title: "doctl compute droplet-action get | DigitalOcean Documentation"
---
...
# doctl compute droplet-action get
...
```shell
doctl compute droplet-action get <droplet-id> [flags]
```
...
Retrieves information about an action performed on a Droplet, including its status, type, and completion time.

## Example

The following example retrieves information about an action, with the ID `1978716488`, performed on a Droplet with the ID `386734086`:

```shell
doctl compute droplet-action get 1978716488 --action-id 386734086
```
...
| Option | Description |
| --- | --- |
| `--action-id` | Action ID (required)<br>Default: `0` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/get/#global-flags)
