---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-bgp-auth-key/"
title: "doctl network attachment get-bgp-auth-key | DigitalOcean Documentation"
---
...
# doctl network attachment get-bgp-auth-key
...
```shell
doctl network attachment get-bgp-auth-key <partner-attachment-id> [flags]
```
...
Retrieves information about a BGP Auth key of Partner Attachment

## Flags

| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Value`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-bgp-auth-key/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-bgp-auth-key/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-bgp-auth-key/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-bgp-auth-key/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-bgp-auth-key/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/get-bgp-auth-key/#global-flags)
