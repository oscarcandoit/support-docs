---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_schema/"
title: "pydo.databases.get_kafka_schema() | DigitalOcean Documentation"
---
...
# pydo.databases.get\_kafka\_schema()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_kafka_schema) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_schema/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_schema/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_kafka_schema/#more-information)
