---
url: "https://docs.digitalocean.com/products/droplets/how-to/gpu/enable-jumbo-frames/"
title: "How to Enable Jumbo Frames on DigitalOcean Gradient™ AI GPU Droplets | DigitalOcean Documentation"
---
...
Validated on 26 Sep 2024 • Last edited on 15 Aug 2025

DigitalOcean Droplets are Linux-based virtual machines (VMs) that run on top of virtualized hardware. Each Droplet you create is a new server you can use, either standalone or as part of a larger, cloud-based infrastructure.

The VPC private interface, `eth1`, on GPU Droplets supports [jumbo frames](https://en.wikipedia.org/wiki/Jumbo_frame).
...
You can automatically configure jumbo frames when you create a GPU Droplet by using [user data](https://docs.digitalocean.com/products/droplets/how-to/provide-user-data/). The following `cloud-config` file runs the above command automatically on creation:
...
[How to Enable Jumbo Frames on DigitalOcean Gradient™ AI GPU Droplets](https://docs.digitalocean.com/products/droplets/how-to/gpu/enable-jumbo-frames/)
