---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/projects_info/"
title: "projects_info | DigitalOcean Documentation"
---
...
Retrieve a list of all of the projects in your account. View the API documentation at ( [https://docs.digitalocean.com/reference/api/api-reference/#operation/projects\_list)](https://docs.digitalocean.com/reference/api/api-reference/#operation/projects_list)).
...
| `msg`<br>str | always | Projects result information.<br>Sample:<br>```json<br>[<br>  "Current projects",<br>  "No projects"<br>]<br>``` |
| `projects`<br>list | always | Projects.<br>Sample:<br>```json<br>[<br>  {<br>    "created_at": "2018-09-27T20:10:35Z",<br>    "description": "My website API",<br>    "environment": "Production",<br>    "id": "4e1bfbc3-dc3e-41f2-a18f-1b4d7ba71679",<br>    "is_default": false,<br>    "name": "my-web-api",<br>    "owner_id": 258992,<br>    "owner_uuid": "99525febec065ca37b2ffe4f852fd2b2581895e7",<br>    "purpose": "Service or API",<br>    "updated_at": "2018-09-27T20:10:35Z"<br>  }<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/projects_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/projects_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/projects_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/projects_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/projects_info/#return-values)
