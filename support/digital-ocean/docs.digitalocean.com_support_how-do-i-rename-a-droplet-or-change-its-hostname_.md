---
url: "https://docs.digitalocean.com/support/how-do-i-rename-a-droplet-or-change-its-hostname/"
title: "How do I rename a Droplet or change its hostname? | DigitalOcean Documentation"
---
...
Validated on 4 Oct 2022 • Last edited on 27 Sep 2023
...
To rename the Droplet in the [DigitalOcean Control Panel](https://cloud.digitalocean.com/), log in and then click the Droplet you want to rename. In the Droplet detail window, click the name of the Droplet. Enter the new name in the entry field, then click the check mark to save it.

Alternatively, to rename the Droplet from the command line, use [`doctl compute droplet-action rename`](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rename/).
...
- [Rename the Droplet](https://docs.digitalocean.com/support/how-do-i-rename-a-droplet-or-change-its-hostname/#rename-the-droplet)
- [Change the Droplet’s Hostname](https://docs.digitalocean.com/support/how-do-i-rename-a-droplet-or-change-its-hostname/#change-the-droplets-hostname)
