---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/volume/list/"
title: "doctl compute volume list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [volume](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/list/)
        - [snapshot](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/snapshot/)
...
```shell
doctl compute volume list [flags]
```
...
Lists all of the block storage volumes on your account.

## Example

The following example retrieves a list of volumes on your account in the `nyc1` region. The command also uses the `--format` flag to return only the name and size of each volume:

```shell
doctl compute volume list --region nyc1 --format Name,Size
```
...
| `--region` | Filter’s volumes by the specified region |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume/list/#global-flags)
