---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/get-active/"
title: "doctl registries garbage-collection get-active | DigitalOcean Documentation"
---
...
# doctl registries garbage-collection get-active
...
```shell
doctl registries garbage-collection get-active <registry-name> [flags]
```
...
The following example retrieves the currently-active garbage collection for a registry named `example-registry`:

```shell
doctl registries garbage-collection get-active example-registry
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/get-active/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/get-active/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/get-active/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/get-active/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/get-active/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/get-active/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/garbage-collection/get-active/#global-flags)
