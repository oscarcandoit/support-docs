---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/create/"
title: "doctl compute domain records create | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [domain](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/list/)
        - [records](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/)
          - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/create/)
          - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/delete/)
          - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/list/)
          - [update](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/update/)
...
| `--record-flags` | The flag value of a CAA record. A valid is an unsigned integer between 0-255.<br>Default: `0` |
| `--record-name` | The host name, alias, or service being defined by the record |
| `--record-port` | The port value for an SRV record<br>Default: `0` |
| `--record-priority` | The priority for an MX or SRV record<br>Default: `0` |
| `--record-tag` | The parameter tag for CAA records. Valid values are `issue`, `issuewild`, or `iodef` |
| `--record-ttl` | The record’s Time To Live (TTL) value, in seconds<br>Default: `1800` |
| `--record-type` | The type of DNS record. Valid values are: `A`, `AAAA`, `CAA`, `CNAME`, `MX`, `NS`, `SOA`, `SRV`, and `TXT`. |
| `--record-weight` | The weight value for an SRV record<br>Default: `0` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/domain/records/create/#global-flags)
