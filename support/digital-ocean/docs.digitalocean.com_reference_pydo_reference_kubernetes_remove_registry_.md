---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/remove_registry/"
title: "pydo.kubernetes.remove_registry() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_remove_registry) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/remove_registry/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/remove_registry/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/remove_registry/#more-information)
