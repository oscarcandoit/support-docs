---
url: "https://docs.digitalocean.com/reference/pydo/reference/load_balancers/remove_forwarding_rules/"
title: "pydo.load_balancers.remove_forwarding_rules() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [load\_balancers](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/)
      - [add\_droplets()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_droplets/)
      - [add\_forwarding\_rules()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/add_forwarding_rules/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/delete/)
      - [delete\_cache()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/delete_cache/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/list/)
      - [remove\_droplets()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/remove_droplets/)
      - [remove\_forwarding\_rules()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/remove_forwarding_rules/)
      - [update()](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/update/)
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [load\_balancers](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/)
- remove\_forwarding\_rules()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.load\_balancers.remove\_forwarding\_rules()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/loadBalancers_remove_forwardingRules) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/remove_forwarding_rules/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/remove_forwarding_rules/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/remove_forwarding_rules/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/load_balancers/remove_forwarding_rules/#more-information)
