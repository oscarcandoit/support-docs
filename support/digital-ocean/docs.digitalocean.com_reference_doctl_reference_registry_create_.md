---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/create/"
title: "doctl registry create | DigitalOcean Documentation"
---
...
| `--subscription-tier` | Subscription tier for the new registry. For a list of possible values, use the `doctl registry options subscription-tiers` command. (required)<br>Default: `basic` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/create/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registry/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/create/#global-flags)
