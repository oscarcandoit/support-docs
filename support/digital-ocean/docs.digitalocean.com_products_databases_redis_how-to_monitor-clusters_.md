---
url: "https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/"
title: "How to Monitor Caching Database Cluster Performance | DigitalOcean Documentation"
---
...
# How to Monitor Caching Database Cluster Performance
...
For more information on database metrics, see our [how-to on monitoring database performance](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/).

## View Caching Metrics

To view Caching performance metrics, click the name of the database to go to its **Overview** page, then click the **Insights** tab.

![The Insights tab of a managed databases cluster](https://docs.digitalocean.com/screenshots/databases/redis-insights-tab.c7ed20a188155485ea164c155c5611eef1032fa7eb3f1dece77644de46313983.png)
...
- [View Caching Metrics](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#view-caching-metrics)
- [Cluster Metrics Details](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#cluster-metrics-details)
  - [CPU Usage](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#cpu-usage)
  - [Load Average](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#load-average)
  - [Memory Usage](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#memory-usage)
  - [Disk Usage](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#disk-usage)
- [Access the Metrics Endpoint](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#access-the-metrics-endpoint)
  - [Get Hostname and Credentials](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#get-hostname-and-credentials)
  - [Access with cURL](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#access-with-curl)
  - [Access with Prometheus](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#access-with-prometheus)
  - [Additional Resources](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/#additional-resources)
