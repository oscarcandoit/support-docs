---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/list_neighbors_ids/"
title: "pydo.droplets.list_neighbors_ids() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_list_neighborsIds) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_neighbors_ids/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_neighbors_ids/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_neighbors_ids/#more-information)
