---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_info/"
title: "uptime_checks_info | DigitalOcean Documentation"
---
...
List all of the Uptime checks on your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/uptime\_list\_checks](https://docs.digitalocean.com/reference/api/api-reference/#operation/uptime_list_checks).
...
| `state`<br>str | Choices:<br>- `present` (default) | Only `present` is supported which will return the Uptime checks. |
...
| --- | --- | --- |
| `checks`<br>list | always | Uptime checks.<br>Sample:<br>```json<br>[<br>  {<br>    "enabled": true,<br>    "id": "5a4981aa-9653-4bd1-bef5-d6bff52042e4",<br>    "name": "Landing page check",<br>    "regions": [<br>      "us_east",<br>      "eu_west"<br>    ],<br>    "target": "https://www.landingpage.com",<br>    "type": "https"<br>  }<br>]<br>``` |
...
| `msg`<br>str | always | Uptime checks result information.<br>Sample:<br>```json<br>[<br>  "Current Uptime checks",<br>  "No Uptime checks"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/uptime_checks_info/#return-values)
