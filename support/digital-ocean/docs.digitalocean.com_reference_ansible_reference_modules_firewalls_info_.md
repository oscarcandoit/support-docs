---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/firewalls_info/"
title: "firewalls_info | DigitalOcean Documentation"
---
...
List all firewall on your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/firewalls\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/firewalls_list).
...
| `firewalls`<br>list | always | Firewalls.<br>Sample:<br>```json<br>[<br>  {<br>    "id": "fb6045f1-cf1d-4ca3-bfac-18832663025b",<br>    "inbound_rules": [<br>      {<br>        "ports": "80",<br>        "protocol": "tcp",<br>        "sources": {<br>          "load_balancer_uids": [<br>            "4de7ac8b-495b-4884-9a69-1050c6793cd6"<br>          ]<br>        }<br>      },<br>      {<br>        "ports": "22",<br>        "protocol": "tcp",<br>        "sources": {<br>          "addresses": [<br>            "18.0.0.0/8"<br>          ],<br>          "tags": [<br>            "gateway"<br>          ]<br>        }<br>      }<br>    ],<br>    "name": "firewall",<br>    "status": "succeeded"<br>  }<br>]<br>``` |
| `msg`<br>str | always | Firewalls result information.<br>Sample:<br>```json<br>[<br>  "Current Droplets",<br>  "No Droplets"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/firewalls_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/firewalls_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/firewalls_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/firewalls_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/firewalls_info/#return-values)
