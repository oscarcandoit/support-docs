---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/create_scheduled_indexing/"
title: "pydo.genai.create_scheduled_indexing() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_create_scheduled_indexing) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/create_scheduled_indexing/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/create_scheduled_indexing/#more-information)
