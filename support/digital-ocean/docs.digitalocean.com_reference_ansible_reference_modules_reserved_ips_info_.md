---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/reserved_ips_info/"
title: "reserved_ips_info | DigitalOcean Documentation"
---
...
List all reserved IPs on your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/reservedIPs\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/reservedIPs_list).
...
| `msg`<br>str | always | Reserved IPs result information.<br>Sample:<br>```json<br>[<br>  "Current Droplets",<br>  "No Droplets"<br>]<br>``` |
| `reserved_ips`<br>list | always | Reserved IPs.<br>Sample:<br>```json<br>[<br>  {<br>    "droplet": null,<br>    "ip": "45.55.96.47",<br>    "locked": false,<br>    "project_id": "746c6152-2fa2-11ed-92d3-27aaa54e4988",<br>    "region": {<br>      "available": true,<br>      "features": [<br>        "private_networking",<br>        "backups",<br>        "ipv6",<br>        "metadata",<br>        "install_agent",<br>        "storage",<br>        "image_transfer"<br>      ],<br>      "name": "New York 3",<br>      "sizes": [<br>        "s-1vcpu-1gb",<br>        "..."<br>      ],<br>      "slug": "nyc3"<br>    }<br>  }<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/reserved_ips_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/reserved_ips_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/reserved_ips_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/reserved_ips_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/reserved_ips_info/#return-values)
