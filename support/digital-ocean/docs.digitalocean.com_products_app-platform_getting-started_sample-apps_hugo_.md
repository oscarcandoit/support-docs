---
url: "https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/hugo/"
title: "Sample App for Hugo | DigitalOcean Documentation"
---
...
The Hugo buildpack applies to this sample app. See the [Hugo buildpack overview](https://docs.digitalocean.com/products/app-platform/reference/buildpacks/hugo/) for more information about its configuration options and limitations.

> This content is automatically generated from [https://github.com/digitalocean/sample-hugo/blob/main/README.md](https://github.com/digitalocean/sample-hugo/blob/main/README.md).
...
- The default Hugo version is `0.78.0` (non-extended). To change the default Hugo version, set an environment variable named `HUGO_VERSION` to the desired version in the same format.

- To use Hugo Extended, set an environment variable named `HUGO_EXTENDED` to `1`.


In this article...

- [Usage](https://docs.digitalocean.com/products/app-platform/getting-started/sample-apps/hugo/#usage)
