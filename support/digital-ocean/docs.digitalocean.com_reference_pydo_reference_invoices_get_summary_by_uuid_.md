---
url: "https://docs.digitalocean.com/reference/pydo/reference/invoices/get_summary_by_uuid/"
title: "pydo.invoices.get_summary_by_uuid() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [invoices](https://docs.digitalocean.com/reference/pydo/reference/invoices/)
      - [get\_by\_uuid()](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_by_uuid/)
      - [get\_csv\_by\_uuid()](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_csv_by_uuid/)
      - [get\_pdf\_by\_uuid()](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_pdf_by_uuid/)
      - [get\_summary\_by\_uuid()](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_summary_by_uuid/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/invoices/list/)
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [invoices](https://docs.digitalocean.com/reference/pydo/reference/invoices/)
- get\_summary\_by\_uuid()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.invoices.get\_summary\_by\_uuid()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/invoices_get_summaryByUUID) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_summary_by_uuid/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_summary_by_uuid/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_summary_by_uuid/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/invoices/get_summary_by_uuid/#more-information)
