---
url: "https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/delete/"
title: "doctl spaces keys delete | DigitalOcean Documentation"
---
...
```shell
doctl spaces keys delete <access key> [flags]
```
...
```shell
doctl spaces keys delete DOACCESSKEY
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/delete/#global-flags)
