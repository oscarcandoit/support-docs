---
url: "https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/get/"
title: "pydo.byoip_prefixes.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/byoipPrefixes_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/get/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/get/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/get/#more-information)
