---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/create_evaluation_dataset_file_upload_presigned_urls/"
title: "pydo.genai.create_evaluation_dataset_file_upload_presigned_urls() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- create\_evaluation\_dataset\_file\_upload\_presigned\_urls()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_create_evaluation_dataset_file_upload_presigned_urls) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/create_evaluation_dataset_file_upload_presigned_urls/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/create_evaluation_dataset_file_upload_presigned_urls/#more-information)
