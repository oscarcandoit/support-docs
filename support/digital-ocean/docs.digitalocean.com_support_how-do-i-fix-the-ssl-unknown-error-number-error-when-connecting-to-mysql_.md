...
title: "How do I fix the SSL \"unknown error number\" error when connecting to MySQL? | DigitalOcean Documentation"
---
...
[How do I fix the SSL "unknown error number" error when connecting to MySQL?](https://docs.digitalocean.com/support/how-do-i-fix-the-ssl-unknown-error-number-error-when-connecting-to-mysql/)
