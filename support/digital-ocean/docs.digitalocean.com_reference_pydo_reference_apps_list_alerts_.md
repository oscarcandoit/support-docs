---
url: "https://docs.digitalocean.com/reference/pydo/reference/apps/list_alerts/"
title: "pydo.apps.list_alerts() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/apps_list_alerts) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/apps/list_alerts/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/apps/list_alerts/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/apps/list_alerts/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/apps/list_alerts/#more-information)
