---
url: "https://docs.digitalocean.com/platform/billing/reference/"
title: "Billing API and CLI Reference | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/billing.357b31651da85802e1aa1c9f0b19cda7b26d5c971352f7176d1a130b21e088b7.svg)Billing](https://docs.digitalocean.com/platform/billing/)
  ...
  - [API & CLI Reference](https://docs.digitalocean.com/platform/billing/reference/)
    - [API Reference](https://docs.digitalocean.com/reference/api/digitalocean/#tag/Billing)
    - [CLI Reference (Balance)](https://docs.digitalocean.com/reference/doctl/reference/balance/)
    - [CLI Reference (Billing History)](https://docs.digitalocean.com/reference/doctl/reference/billing-history/)
    - [CLI Reference (Invoice)](https://docs.digitalocean.com/reference/doctl/reference/invoice/)
...
- [The DigitalOcean API](https://docs.digitalocean.com/platform/billing/reference/#the-digitalocean-api)
- [The DigitalOcean Command Line Client, doctl](https://docs.digitalocean.com/platform/billing/reference/#the-digitalocean-command-line-client-doctl)
