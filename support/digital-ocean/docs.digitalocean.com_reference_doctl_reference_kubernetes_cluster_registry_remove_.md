---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/remove/"
title: "doctl kubernetes cluster registry remove | DigitalOcean Documentation"
---
    ...
    - [doctl kubernetes](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/)
      ...
      - [cluster](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/)
        ...
        - [registry](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/)
          - [add](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/add/)
          - [remove](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/remove/)
...
# doctl kubernetes cluster registry remove
...
```shell
doctl kubernetes cluster registry remove <cluster-id|cluster-name> <cluster-id|cluster-name> [flags]
```
...
The following example removes container registry support from a cluster named `example-cluster`:

```shell
doctl kubernetes cluster registry remove example-cluster
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/remove/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/remove/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/remove/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/remove/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/remove/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/remove/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/registry/remove/#global-flags)
