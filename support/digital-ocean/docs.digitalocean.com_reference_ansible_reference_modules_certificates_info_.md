---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/certificates_info/"
title: "certificates_info | DigitalOcean Documentation"
---
...
List all of the certificates available on your account. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/certificates\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/certificates_list).
...
| --- | --- | --- |
| `certificates`<br>dict | always | Certificates.<br>Sample:<br>```json<br>[<br>  {<br>    "created_at": "2017-02-08T16:02:37Z",<br>    "dns_names": [],<br>    "id": "892071a0-bb95-49bc-8021-3afd67a210bf",<br>    "name": "web-cert-01",<br>    "not_after": "2017-02-22T00:23:00Z",<br>    "sha1_fingerprint": "dfcc9f57d86bf58e321c2c6c31c7a971be244ac7",<br>    "state": "verified",<br>    "type": "custom"<br>  }<br>]<br>``` |
...
| `msg`<br>str | always | Certificates result information.<br>Sample:<br>```json<br>[<br>  "Current certificates",<br>  "No certificates"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/certificates_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/certificates_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/certificates_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/certificates_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/certificates_info/#return-values)
