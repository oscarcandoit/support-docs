---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_indexing_jobs/"
title: "pydo.genai.list_indexing_jobs() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_indexing_jobs) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_indexing_jobs/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_indexing_jobs/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_indexing_jobs/#more-information)
