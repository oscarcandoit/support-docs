---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/create/"
title: "doctl kubernetes cluster node-pool create | DigitalOcean Documentation"
---
    ...
    - [doctl kubernetes](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/)
      ...
      - [cluster](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/)
        ...
        - [node-pool](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/)
          - [create](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/create/)
          - [delete](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete/)
          - [delete-node](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete-node/)
          - [get](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/get/)
          - [list](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/list/)
          - [replace-node](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/replace-node/)
          - [update](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/update/)
...
| Option | Description |
| --- | --- |
| `--auto-scale` | Enables auto-scaling on the node pool<br>Default: `false` |
| `--count` | The number of nodes in the node pool (required)<br>Default: `0` |
| `--help`, `-h` | Help for this command |
| `--label` | A label in key=value notation to apply to the node pool. Repeat this flag to specify additional labels. An existing label is removed from the node pool if it is not specified by any flag. |
| `--max-nodes` | The maximum number of nodes in the node pool when autoscaling is enabled<br>Default: `0` |
| `--min-nodes` | The minimum number of nodes in the node pool when autoscaling (auto\_scale) is enabled. If auto\_scale is set to false, the default value will be 0. Scale-to-zero is not supported.<br>Default: `0` |
| `--name` | The name of the node pool (required) |
| `--size` | The `size` of the nodes in the node pool. Use the `doctl kubernetes options sizes` command for a list of possible values. (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/create/#global-flags)
