---
url: "https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/create/"
title: "doctl nfs snapshot create | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/create/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/create/#global-flags)
