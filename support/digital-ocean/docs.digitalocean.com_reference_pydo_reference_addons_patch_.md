---
url: "https://docs.digitalocean.com/reference/pydo/reference/addons/patch/"
title: "pydo.addons.patch() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `resource_uuid` | string | True | The UUID of the add-on resource to rename. |  |
| `body` | JSON or IO\[bytes\] | True |  |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/addons_patch) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/addons/patch/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/addons/patch/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/addons/patch/#more-information)
