---
url: "https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/delete/"
title: "doctl vpcs peerings delete | DigitalOcean Documentation"
---
...
Permanently deletes the specified VPC Peering. This is irreversible.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete the VPC Peering without any confirmation prompt<br>Default: `false` |
| `--help`, `-h` | Help for this command |
| `--wait` | Boolean that specifies whether to wait for a VPC Peering deletion to complete before returning control to the terminal<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/vpcs/peerings/delete/#global-flags)
