---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/list/"
title: "doctl kubernetes 1-click list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl kubernetes](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/)
      - [1-click](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/)
        - [install](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/install/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/list/)
...
```shell
doctl kubernetes 1-click list [flags]
```
...
Retrieves a list of Kubernetes 1-Click applications you can install on a Kubernetes cluster.

## Example

The following example lists all available 1-click apps for Kubernetes:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/1-click/list/#global-flags)
