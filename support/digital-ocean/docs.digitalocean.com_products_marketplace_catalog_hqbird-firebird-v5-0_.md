---
url: "https://docs.digitalocean.com/products/marketplace/catalog/hqbird-firebird-v5-0/"
title: "HQbird Firebird v5.0 | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/hqbird-firebird-v5-0/)
...
from [the HQbird Firebird v5.0 catalog page](https://marketplace.digitalocean.com/apps/hqbird-firebird-v5-0)

HQbird Firebird 5.0.4.1722-11.3.1017 installed on Ubuntu 24
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=ibsurgeon-hqbirdfirebirdv5)

## Creating an App using the API

In addition to creating a Droplet from the HQbird Firebird v5.0 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB HQbird Firebird v5.0 Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"ibsurgeon-hqbirdfirebirdv5"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying HQbird Firebird v5.0
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/hqbird-firebird-v5-0/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/hqbird-firebird-v5-0/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/hqbird-firebird-v5-0/#creating-an-app-using-the-api)
- [Getting Started After Deploying HQbird Firebird v5.0](https://docs.digitalocean.com/products/marketplace/catalog/hqbird-firebird-v5-0/#getting-started-after-deploying-hqbird-firebird-v50)
- [**Getting Started with HQbird Cloud Firebird**](https://docs.digitalocean.com/products/marketplace/catalog/hqbird-firebird-v5-0/#getting-started-with-hqbird-cloud-firebird)
