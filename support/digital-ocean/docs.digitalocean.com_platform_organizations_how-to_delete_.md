---
url: "https://docs.digitalocean.com/platform/organizations/how-to/delete/"
title: "How to Delete Organizations | DigitalOcean Documentation"
---
...
Validated on 15 May 2024 • Last edited on 30 Sep 2025

Deleting an organization permanently removes it from the control panel.

## Prerequisites

To delete an organization that you own, you must first delete all [teams](https://docs.digitalocean.com/platform/teams/) in the organization and have no outstanding balance.

Once the [teams are deleted](https://docs.digitalocean.com/platform/teams/how-to/delete/), owners can delete an organization to remove it from the control panel.

## Delete an Organization

To delete an organization, in [the **Organization** tab](https://cloud.digitalocean.com/organizations/teams) of the organizations dashboard, go to the **Delete Organization** section.

![Delete org](https://docs.digitalocean.com/screenshots/organizations/delete-org.88e2110e02e5a3c02dd9f4f7f9d43b26934d2d999801f02dc707e2e94a5accea.png)

In the **Confirm Organization Deletion** window, confirm the deletion by clicking **Yes, Permanently Delete \[Organization Name\]**.

When you confirm the deletion, owners receive an email confirmation that the organization has been deleted and the organization no longer appears in the control panel. The payment method associated with the organization is charged for the organization’s final balance, and billers and owners of the organization receive the receipt for the final charge.

Once a organization is deleted, you can reuse the name for a new organization.

In this article...

- [Prerequisites](https://docs.digitalocean.com/platform/organizations/how-to/delete/#prerequisites)
- [Delete an Organization](https://docs.digitalocean.com/platform/organizations/how-to/delete/#delete-an-organization)
