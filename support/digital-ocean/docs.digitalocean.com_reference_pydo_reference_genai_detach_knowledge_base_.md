---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/detach_knowledge_base/"
title: "pydo.genai.detach_knowledge_base() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_detach_knowledge_base) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/detach_knowledge_base/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/detach_knowledge_base/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/detach_knowledge_base/#more-information)
