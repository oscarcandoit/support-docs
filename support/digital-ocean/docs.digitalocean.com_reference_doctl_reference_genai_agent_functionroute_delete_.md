---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/delete/"
title: "doctl genai agent functionroute delete | DigitalOcean Documentation"
---
...
```shell
doctl genai agent functionroute delete [flags]
```
...
```shell
doctl genai agent functionroute delete --agent-id "0f0e928f-4649-11f0-bf8f-4e013e2ddde4" --function-id "e40dc785-5e69-11f0-bf8f-4e013e2ddde4"
```
...
| `--function-id` | Function route ID to delete (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/delete/#global-flags)
