---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/functions/invoke/"
title: "doctl serverless functions invoke | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--full`, `-f` | Waits for the function to complete and then outputs the function’s response along with its complete activation record. The record contains log information, duration time, and other information about the function’s execution.<br>Default: `false` |
| `--help`, `-h` | Help for this command |
| `--no-wait`, `-n` | Asynchronously invokes the function and does not wait for the result to be returned. An activation ID is returned in the response, instead.<br>Default: `false` |
...
| `--web` | Invokes the function as a web function and displays the result in your browser<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/functions/invoke/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/functions/invoke/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/serverless/functions/invoke/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/functions/invoke/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/functions/invoke/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/functions/invoke/#global-flags)
