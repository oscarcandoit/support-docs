---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rename/"
title: "doctl compute droplet-action rename | DigitalOcean Documentation"
---
...
# doctl compute droplet-action rename
...
```shell
doctl compute droplet-action rename <droplet-id> [flags]
```

## Description

Renames a Droplet. When using a Fully Qualified Domain Name (FQDN) this also updates the Droplet’s pointer (PTR) record.

## Example

The following example renames a Droplet with the ID `386734086` to `example.com` an FQDN:

```shell
doctl compute droplet-action rename 386734086 --droplet-name example.com
```
...
| Option | Description |
| --- | --- |
| `--droplet-name` | The new name for the Droplet (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rename/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rename/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rename/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rename/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rename/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rename/#global-flags)
