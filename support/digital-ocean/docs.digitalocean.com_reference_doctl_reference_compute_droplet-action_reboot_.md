---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/reboot/"
title: "doctl compute droplet-action reboot | DigitalOcean Documentation"
---
...
```shell
doctl compute droplet-action reboot <droplet-id> [flags]
```

## Description

Reboots a Droplet. A reboot action is an attempt to reboot the Droplet in a graceful way, similar to using the reboot command from the Droplet’s console.

## Example

The following example reboots a Droplet with the ID `386734086`:

```shell
doctl compute droplet-action reboot 386734086
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/reboot/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/reboot/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/reboot/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/reboot/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/reboot/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/reboot/#global-flags)
