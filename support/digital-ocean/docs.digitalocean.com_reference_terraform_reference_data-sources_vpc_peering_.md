---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_peering/"
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_peering/#example-usage)
  - [VPC Peering By Id](https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_peering/#vpc-peering-by-id)
  - [VPC Peering By Name](https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_peering/#vpc-peering-by-name)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_peering/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/vpc_peering/#attributes-reference)
