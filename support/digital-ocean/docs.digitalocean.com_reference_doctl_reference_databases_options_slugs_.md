---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/options/slugs/"
title: "doctl databases options slugs | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--engine` | The database engine. Possible values: `mysql`, `pg`, `redis`, `valkey`, `kafka`, `opensearch`, `mongodb` (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/options/slugs/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/options/slugs/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/options/slugs/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/options/slugs/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/options/slugs/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/options/slugs/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/options/slugs/#global-flags)
