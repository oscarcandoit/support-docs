---
url: "https://docs.digitalocean.com/support/how-do-i-fix-the-pg_dumpall-permission-denied-for-table-pg_authid-error/"
title: "How do I fix the pg_dumpall \"permission denied for table pg_authid\" error? | DigitalOcean Documentation"
---
...
To learn about the `pg_dumpall` command flags, see our [guide on exporting a PostgreSQL database](https://docs.digitalocean.com/products/databases/postgresql/how-to/import-databases/#export-an-existing-database).
...
[How do I fix the pg\_dumpall "permission denied for table pg\_authid" error?](https://docs.digitalocean.com/support/how-do-i-fix-the-pg_dumpall-permission-denied-for-table-pg_authid-error/)
