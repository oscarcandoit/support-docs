---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list/"
title: "doctl compute firewall list | DigitalOcean Documentation"
---
...
Retrieves a list of cloud firewalls on your account.

## Example

The following example lists all cloud firewalls on your account and uses the `--format` flag to return only the ID, name and inbound rules for each firewall:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list/#global-flags)
