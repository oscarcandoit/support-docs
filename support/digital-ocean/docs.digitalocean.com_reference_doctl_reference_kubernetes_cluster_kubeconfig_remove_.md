---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/remove/"
title: "doctl kubernetes cluster kubeconfig remove | DigitalOcean Documentation"
---
...
The following example removes the credentials for a cluster named `example-cluster` from your local kubeconfig:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/remove/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/remove/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/remove/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/remove/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/remove/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/remove/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/kubeconfig/remove/#global-flags)
