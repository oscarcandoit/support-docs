---
url: "https://docs.digitalocean.com/products/databases/mongodb/concepts/best-practices/"
...
To establish secure, centralized connections between resources in different VPCs or platforms, you can use a proxy server, for example [HAProxy](https://www.haproxy.org/).
...
To add standby nodes, see [How to Add Standby Nodes](https://docs.digitalocean.com/products/databases/mongodb/how-to/add-standby-nodes/).

In this article...

- [Use VPCs](https://docs.digitalocean.com/products/databases/mongodb/concepts/best-practices/#use-vpcs)
- [Add Standby Nodes](https://docs.digitalocean.com/products/databases/mongodb/concepts/best-practices/#add-standby-nodes)
