---
url: "https://docs.digitalocean.com/products/uptime/how-to/edit-checks/"
title: "How to Edit Checks | DigitalOcean Documentation"
---
...
Uptime checks can be edited from [the main Uptime page](https://cloud.digitalocean.com/monitors/uptime/checks), where all your checks are listed.

![screenshot of the Uptime check listing, with the 'more' menu extended, showing the 'Edit' option highlighted](https://docs.digitalocean.com/screenshots/uptime/check-edit.9189fd779dafa043a39f24ed8b72de22dc414434c18f71214a9b5111933261ce.png)

1. Click the drop-down menu for the check you’d like to update, then select **Edit**. This takes you to the edit page, which has the same options as the create page. See [How to Create Checks](https://docs.digitalocean.com/products/uptime/how-to/create-checks/) for detailed information on the options available.

2. Press the **Submit** button to save your changes.


In this article...

[How to Edit Checks](https://docs.digitalocean.com/products/uptime/how-to/edit-checks/)
