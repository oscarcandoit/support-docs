---
url: "https://docs.digitalocean.com/reference/pydo/reference/volumes/list/"
title: "pydo.volumes.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [volumes](https://docs.digitalocean.com/reference/pydo/reference/volumes/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/volumes/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/volumes/delete/)
      - [delete\_by\_name()](https://docs.digitalocean.com/reference/pydo/reference/volumes/delete_by_name/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/volumes/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/volumes/list/)
...
| --- | --- | --- | --- | --- |
| `name` | string | False | The block storage volume’s name. |  |
| `region` | string | False | The slug identifier for the region where the resource is available. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/volumes_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/volumes/list/#description)
- [Filtering Results](https://docs.digitalocean.com/reference/pydo/reference/volumes/list/#filtering-results)
  - [By Region](https://docs.digitalocean.com/reference/pydo/reference/volumes/list/#by-region)
  - [By Name](https://docs.digitalocean.com/reference/pydo/reference/volumes/list/#by-name)
  - [By Name and Region](https://docs.digitalocean.com/reference/pydo/reference/volumes/list/#by-name-and-region)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/volumes/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/volumes/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/volumes/list/#more-information)
