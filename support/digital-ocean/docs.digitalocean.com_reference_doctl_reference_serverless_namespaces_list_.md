---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list/"
title: "doctl serverless namespaces list | DigitalOcean Documentation"
---
...
```shell
doctl serverless namespaces list [flags]
```
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Label`, `Region`, `ID`, `Host`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list/#global-flags)
