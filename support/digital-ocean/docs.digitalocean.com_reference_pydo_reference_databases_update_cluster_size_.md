---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_cluster_size/"
title: "pydo.databases.update_cluster_size() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- update\_cluster\_size()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.update\_cluster\_size()
...
To resize a database cluster, send a PUT request to `/v2/databases/$DATABASE_ID/resize`. The body of the request must specify both the size and num\_nodes attributes.
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_clusterSize) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_cluster_size/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_cluster_size/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/update_cluster_size/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_cluster_size/#more-information)
