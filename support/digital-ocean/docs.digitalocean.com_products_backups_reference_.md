---
url: "https://docs.digitalocean.com/products/backups/reference/"
title: "Backups Reference | DigitalOcean Documentation"
---
...
You can use the API to [enable or disable backups on Droplets](https://docs.digitalocean.com/reference/api/digitalocean/#operation/dropletActions_post), then [list, update, and delete backup images](https://docs.digitalocean.com/reference/api/digitalocean/#tag/Images). You can also [transfer and convert specified backup images](https://docs.digitalocean.com/reference/api/digitalocean/#tag/Image-Actions).
...
[`doctl`](https://github.com/digitalocean/doctl) supports managing backups from the command line. See the [`doctl` documentation](https://docs.digitalocean.com/reference/doctl/reference/compute/) or use `doctl compute droplet-action enable-backups --help` for more information.
...
[Backups Reference](https://docs.digitalocean.com/products/backups/reference/)
