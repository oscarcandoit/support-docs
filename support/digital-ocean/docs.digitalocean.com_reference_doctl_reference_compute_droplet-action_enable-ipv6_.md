---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-ipv6/"
title: "doctl compute droplet-action enable-ipv6 | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [droplet-action](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/)
        - [change-backup-policy](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/change-backup-policy/)
        - [change-kernel](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/change-kernel/)
        - [disable-backups](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/disable-backups/)
        - [enable-backups](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-backups/)
        - [enable-ipv6](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-ipv6/)
        - [enable-private-networking](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-private-networking/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/get/)
        - [password-reset](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/password-reset/)
        - [power-cycle](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-cycle/)
        - [power-off](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-off/)
        - [power-on](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-on/)
        - [reboot](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/reboot/)
        - [rebuild](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rebuild/)
        - [rename](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/rename/)
        - [resize](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/resize/)
        - [restore](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/restore/)
        - [shutdown](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/shutdown/)
        - [snapshot](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/snapshot/)
...
# doctl compute droplet-action enable-ipv6
...
```shell
doctl compute droplet-action enable-ipv6 <droplet-id> [flags]
```

## Description

Enables IPv6 networking on a Droplet. When executed, we automatically assign an IPv6 address to the Droplet.

The Droplet may require additional network configuration to properly use the new IPv6 address. For more information, see: [https://docs.digitalocean.com/products/networking/ipv6/how-to/enable](https://docs.digitalocean.com/products/networking/ipv6/how-to/enable)

## Example

The following example enables IPv6 on a Droplet with the ID `386734086`:

```shell
doctl compute droplet-action enable-ipv6 386734086
```
...
| `--wait` | Instruct the terminal to wait for the action to complete before returning access to the user<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-ipv6/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-ipv6/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-ipv6/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-ipv6/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-ipv6/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/enable-ipv6/#global-flags)
