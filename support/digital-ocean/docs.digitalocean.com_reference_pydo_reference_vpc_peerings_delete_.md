---
url: "https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/delete/"
title: "pydo.vpc_peerings.delete() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/vpcPeerings_delete) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/delete/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/delete/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/vpc_peerings/delete/#more-information)
