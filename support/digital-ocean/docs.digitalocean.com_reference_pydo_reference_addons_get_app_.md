---
url: "https://docs.digitalocean.com/reference/pydo/reference/addons/get_app/"
title: "pydo.addons.get_app() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/addons_get_app) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/addons/get_app/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/addons/get_app/#more-information)
