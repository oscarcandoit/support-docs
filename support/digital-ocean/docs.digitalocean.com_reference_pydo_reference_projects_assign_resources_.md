---
url: "https://docs.digitalocean.com/reference/pydo/reference/projects/assign_resources/"
title: "pydo.projects.assign_resources() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [projects](https://docs.digitalocean.com/reference/pydo/reference/projects/)
      - [assign\_resources()](https://docs.digitalocean.com/reference/pydo/reference/projects/assign_resources/)
      - [assign\_resources\_default()](https://docs.digitalocean.com/reference/pydo/reference/projects/assign_resources_default/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/projects/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/projects/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/projects/get/)
      - [get\_default()](https://docs.digitalocean.com/reference/pydo/reference/projects/get_default/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/projects/list/)
      - [list\_resources()](https://docs.digitalocean.com/reference/pydo/reference/projects/list_resources/)
      - [list\_resources\_default()](https://docs.digitalocean.com/reference/pydo/reference/projects/list_resources_default/)
      - [patch()](https://docs.digitalocean.com/reference/pydo/reference/projects/patch/)
      - [patch\_default()](https://docs.digitalocean.com/reference/pydo/reference/projects/patch_default/)
      - [update()](https://docs.digitalocean.com/reference/pydo/reference/projects/update/)
      - [update\_default()](https://docs.digitalocean.com/reference/pydo/reference/projects/update_default/)
...
# pydo.projects.assign\_resources()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/projects_assign_resources) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/projects/assign_resources/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/projects/assign_resources/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/projects/assign_resources/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/projects/assign_resources/#more-information)
