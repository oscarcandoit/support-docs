---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_indexing_jobs_by_knowledge_base/"
title: "pydo.genai.list_indexing_jobs_by_knowledge_base() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- list\_indexing\_jobs\_by\_knowledge\_base()
...
| --- | --- | --- | --- | --- |
| `knowledge_base_uuid` | string | True | Knowledge base uuid in string |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_indexing_jobs_by_knowledge_base) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_indexing_jobs_by_knowledge_base/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_indexing_jobs_by_knowledge_base/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_indexing_jobs_by_knowledge_base/#more-information)
