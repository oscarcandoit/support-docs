---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list-regions/"
title: "doctl serverless namespaces list-regions | DigitalOcean Documentation"
---
...
```shell
doctl serverless namespaces list-regions [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list-regions/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list-regions/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list-regions/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list-regions/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/namespaces/list-regions/#global-flags)
