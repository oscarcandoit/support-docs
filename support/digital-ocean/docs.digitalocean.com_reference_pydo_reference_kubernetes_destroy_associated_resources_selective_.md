---
url: "https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_selective/"
title: "pydo.kubernetes.destroy_associated_resources_selective() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [kubernetes](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/)
- destroy\_associated\_resources\_selective()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/kubernetes_destroy_associatedResourcesSelective) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_selective/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_selective/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_selective/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/kubernetes/destroy_associated_resources_selective/#more-information)
