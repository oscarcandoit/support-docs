---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backups/"
title: "doctl compute droplet backups | DigitalOcean Documentation"
---
...
```shell
doctl compute droplet backups <droplet-id> [flags]
```
...
Lists backup images for a Droplet, including each image’s slug and ID.

## Example

The following example retrieves a list of backups for a Droplet with the ID `386734086`:

```shell
doctl compute droplet backups 386734086
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backups/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backups/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backups/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backups/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backups/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backups/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/backups/#global-flags)
