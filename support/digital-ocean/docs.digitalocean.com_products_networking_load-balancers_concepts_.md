---
url: "https://docs.digitalocean.com/products/networking/load-balancers/concepts/"
title: "Load Balancers Concepts | DigitalOcean Documentation"
---
...
The statuses reflect how many nodes in a load balancer pass their latest health check.

![](https://docs.digitalocean.com/images/icons/load-balancers.svg)

Best Practices for Performance on DigitalOcean Load Balancers

Get the best performance from your load balancers based on your use case and application architecture, like using HTTP/2, and enabling Droplet monitoring.

In this article...

[Load Balancers Concepts](https://docs.digitalocean.com/products/networking/load-balancers/concepts/)
