---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list-by-droplet/"
title: "doctl compute firewall list-by-droplet | DigitalOcean Documentation"
---
...
```shell
doctl compute firewall list-by-droplet <droplet_id> [flags]
```

## Description

Lists the cloud firewalls assigned to a Droplet.

## Example

The following example lists all cloud firewalls assigned to the Droplet with the ID `386734086`:

```shell
doctl compute firewall list-by-droplet 386734086
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list-by-droplet/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list-by-droplet/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list-by-droplet/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list-by-droplet/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list-by-droplet/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/firewall/list-by-droplet/#global-flags)
