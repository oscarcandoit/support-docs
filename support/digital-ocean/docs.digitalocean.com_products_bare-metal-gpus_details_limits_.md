---
url: "https://docs.digitalocean.com/products/bare-metal-gpus/details/limits/"
title: "DigitalOcean Gradient™ AI Bare Metal GPUs Limits | DigitalOcean Documentation"
---
...
# DigitalOcean Gradient™ AI Bare Metal GPUs Limits

Validated on 13 Nov 2024 • Last edited on 14 Nov 2025
...
- Bare metal GPUs are not available for on-demand provisioning through the control panel, API, or CLI. To purchase and provision bare metal GPUs, [contact our sales team](https://www.digitalocean.com/products/bare-metal-gpu?referrer=pdocs&utm_campaign=digitalocean-gradient-ai-bare-metal-gpus-limits#sales-form), who can finalize pricing and deployment with you.

- We do not offer direct IPMI access to bare metal GPUs.

- By default, there are no firewalls or gateways in front of bare metal GPUs. We recommend using [UFW](https://www.digitalocean.com/community/tutorials/how-to-set-up-a-firewall-with-ufw-on-ubuntu) to protect bare metal GPUs on the public interface.


In this article...

[DigitalOcean Gradient™ AI Bare Metal GPUs Limits](https://docs.digitalocean.com/products/bare-metal-gpus/details/limits/)
