---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-forwarding-rules/"
title: "doctl compute load-balancer remove-forwarding-rules | DigitalOcean Documentation"
---
...
# doctl compute load-balancer remove-forwarding-rules
...
Use this command to remove forwarding rules from a load balancer, specified with the `--forwarding-rules` flag. Valid rules include:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-forwarding-rules/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-forwarding-rules/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-forwarding-rules/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-forwarding-rules/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-forwarding-rules/#global-flags)
