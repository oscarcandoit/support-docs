---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/list_garbage_collections/"
title: "pydo.registries.list_garbage_collections() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_list_garbageCollections) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/list_garbage_collections/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/registries/list_garbage_collections/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/list_garbage_collections/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/list_garbage_collections/#more-information)
