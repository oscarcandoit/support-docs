---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_clusters/"
title: "pydo.databases.list_clusters() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `tag_name` | string | False | Limits the results to database clusters with a specific tag.<br>Requires `tag:read` scope. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_clusters) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_clusters/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_clusters/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/list_clusters/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_clusters/#more-information)
