---
url: "https://docs.digitalocean.com/reference/pydo/reference/cdn/list_endpoints/"
title: "pydo.cdn.list_endpoints() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/cdn_list_endpoints) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/cdn/list_endpoints/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/cdn/list_endpoints/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/cdn/list_endpoints/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/cdn/list_endpoints/#more-information)
