---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/get-ca/"
title: "doctl databases get-ca | DigitalOcean Documentation"
---
...
```shell
doctl databases get-ca <database-cluster-id> [flags]
```
...
Retrieves a database certificate

## Flags

| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Certificate`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/get-ca/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/get-ca/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/get-ca/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/get-ca/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/get-ca/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/get-ca/#global-flags)
