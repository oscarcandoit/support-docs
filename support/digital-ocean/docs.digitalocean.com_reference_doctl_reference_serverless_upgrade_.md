---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/upgrade/"
title: "doctl serverless upgrade | DigitalOcean Documentation"
---
...
```shell
doctl serverless upgrade [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/upgrade/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/upgrade/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/upgrade/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/upgrade/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/upgrade/#global-flags)
