---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/list/"
title: "doctl compute reserved-ip list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [reserved-ip](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/list/)
...
```shell
doctl compute reserved-ip list [flags]
```
...
Retrieves a list of all the reserved IP addresses on your account.

## Example

The following example lists all reserved IP addresses in the `nyc1` region:

```shell
doctl compute reserved-ip list --region nyc1
```
...
| `--region` | Retrieves a list of reserved IP addresses in the specified region |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip/list/#global-flags)
