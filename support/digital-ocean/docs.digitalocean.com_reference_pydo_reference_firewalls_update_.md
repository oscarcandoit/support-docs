---
url: "https://docs.digitalocean.com/reference/pydo/reference/firewalls/update/"
title: "pydo.firewalls.update() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/firewalls_update) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/firewalls/update/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/firewalls/update/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/firewalls/update/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/firewalls/update/#more-information)
