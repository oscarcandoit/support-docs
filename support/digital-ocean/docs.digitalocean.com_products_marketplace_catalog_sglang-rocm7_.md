---
url: "https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/"
title: "SGLang (ROCm7) | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/)
...
from [the SGLang (ROCm7) catalog page](https://marketplace.digitalocean.com/apps/sglang-rocm7)
...
| --- | --- | --- |
| ROCm (host version) | 7.0.0 | [LICENSE](https://rocm.docs.amd.com/en/latest/about/license.html) |
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=amd-sglangrocm7)

## Creating an App using the API

In addition to creating a Droplet from the SGLang (ROCm7) 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB SGLang (ROCm7) Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"amd-sglangrocm7"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying SGLang (ROCm7)
...
- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/#creating-an-app-using-the-api)
- [Getting Started After Deploying SGLang (ROCm7)](https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/#getting-started-after-deploying-sglang-rocm7)
- [Accessing SGLang + ROCm resources and libraries](https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/#accessing-sglang--rocm-resources-and-libraries)
- [SSHing into your AMD 1-Click](https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/#sshing-into-your-amd-1-click)
- [Exploring via Jupyter](https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/#exploring-via-jupyter)
- [Exploring via Docker](https://docs.digitalocean.com/products/marketplace/catalog/sglang-rocm7/#exploring-via-docker)
