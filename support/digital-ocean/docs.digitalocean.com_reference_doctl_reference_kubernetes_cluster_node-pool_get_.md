---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/get/"
title: "doctl kubernetes cluster node-pool get | DigitalOcean Documentation"
---
...
The following example retrieves information about a node pool named `example-pool` in a cluster named `example-cluster`:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/get/#global-flags)
