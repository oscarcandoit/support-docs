---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/create_cluster/"
title: "pydo.databases.create_cluster() | DigitalOcean Documentation"
---
...
# pydo.databases.create\_cluster()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_create_cluster) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/create_cluster/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/create_cluster/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/create_cluster/#more-information)
