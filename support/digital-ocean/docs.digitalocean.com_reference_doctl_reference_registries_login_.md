---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/login/"
title: "doctl registries login | DigitalOcean Documentation"
---
...
```shell
doctl registries login <registry-name> [flags]
```
...
The following example logs Docker into a registry named `example-registry` and provides Docker with read-only credentials:

```shell
doctl registries login example-registry --read-only=true
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/login/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/login/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/login/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/login/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/login/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/login/#global-flags)
