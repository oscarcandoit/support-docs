---
url: "https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/get/"
title: "doctl nfs snapshot get | DigitalOcean Documentation"
---
...
```shell
doctl nfs snapshot get [flags]
```

## Description

Get an NFS snapshot with the given ID and region.
...
| `--region`, `-r` | the region where the NFS snapshot resides (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/get/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/get/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/snapshot/get/#global-flags)
