---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/one_clicks_info/"
title: "one_clicks_info | DigitalOcean Documentation"
---
...
List all available 1-Click applications. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/oneClicks\_list](https://docs.digitalocean.com/reference/api/api-reference/#operation/oneClicks_list).
...
| `type`<br>str | Choices:<br>- `droplet`<br>- `kubernetes` | Limit by type of 1-Click application. |
...
| `msg`<br>str | always | 1-Click applications result information.<br>Sample:<br>```json<br>[<br>  "Current 1-Click applications",<br>  "Current Droplet 1-Click applications",<br>  "Current Kubernetes 1-Click applications",<br>  "Current 1-Click applications not found"<br>]<br>``` |
| `one_clicks`<br>list | always | DigitalOcean account information.<br>Sample:<br>```json<br>[<br>  {<br>    "slug": "cpanel-cpanelwhm-7-9",<br>    "type": "droplet"<br>  },<br>  {<br>    "slug": "npool",<br>    "type": "droplet"<br>  },<br>  {<br>    "slug": "optimajet-workflowserver-18-04",<br>    "type": "droplet"<br>  },<br>  "...",<br>  {<br>    "slug": "netdata",<br>    "type": "kubernetes"<br>  },<br>  {<br>    "slug": "okteto",<br>    "type": "kubernetes"<br>  },<br>  {<br>    "slug": "fyipe",<br>    "type": "kubernetes"<br>  }<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/one_clicks_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/one_clicks_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/one_clicks_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/one_clicks_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/one_clicks_info/#return-values)
