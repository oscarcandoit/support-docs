---
url: "https://docs.digitalocean.com/products/app-platform/how-to/destroy-app/"
title: "How to Destroy Apps in App Platform | DigitalOcean Documentation"
---
...
Deleting an app permanently and irreversibly destroys the app and its components. If you need to re-deploy the app, you can download the app specification file before deleting the app and [use the saved spec to build the app again](https://docs.digitalocean.com/support/can-i-stop-pause-or-disable-my-app-on-app-platform/).

## Destroy an App Using Automation

The destroy app CLI command and API endpoint require the app’s ID. You can retrieve a list of your apps and their IDs using the `doctl apps list` command or the [`/v2/apps` endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/apps_list) endpoint.
...
- [Destroy an App Using Automation](https://docs.digitalocean.com/products/app-platform/how-to/destroy-app/#destroy-an-app-using-automation)
- [Destroy an App Using the Control Panel](https://docs.digitalocean.com/products/app-platform/how-to/destroy-app/#destroy-an-app-using-the-control-panel)
