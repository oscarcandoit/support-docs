---
url: "https://docs.digitalocean.com/support/why-did-all-of-my-backend-droplets-become-unhealthy-when-i-enabled-proxy-protocol-on-my-load-balancer/"
title: "Why did all of my backend Droplets become unhealthy when I enabled PROXY protocol on my load balancer? | DigitalOcean Documentation"
---
...
- [Apache’s remoteIPProxyProtocol directive](https://httpd.apache.org/docs/2.4/mod/mod_remoteip.html#remoteipproxyprotocol)
...
[Why did all of my backend Droplets become unhealthy when I enabled PROXY protocol on my load balancer?](https://docs.digitalocean.com/support/why-did-all-of-my-backend-droplets-become-unhealthy-when-i-enabled-proxy-protocol-on-my-load-balancer/)
