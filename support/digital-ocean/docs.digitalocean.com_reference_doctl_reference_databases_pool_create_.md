---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/pool/create/"
title: "doctl databases pool create | DigitalOcean Documentation"
---
...
| `--mode` | The pool mode for the connection pool, such as `session`, `transaction`, and `statement`<br>Default: `transaction` |
| `--size` | pool size (required)<br>Default: `0` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/pool/create/#global-flags)
