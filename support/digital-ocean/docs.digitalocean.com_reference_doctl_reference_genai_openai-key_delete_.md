---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/delete/"
title: "doctl genai openai-key delete | DigitalOcean Documentation"
---
...
```shell
doctl genai openai-key delete <openai-api-key-uuid> [flags]
```
...
The following example deletes an OpenAI API Key with ID - f81d4fae-0000-11d0-a765-000000000000
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Forces deletion without confirmation.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/delete/#global-flags)
