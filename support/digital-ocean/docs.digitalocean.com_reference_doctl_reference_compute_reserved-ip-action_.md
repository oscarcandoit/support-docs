---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip-action/"
title: "doctl compute reserved-ip-action | DigitalOcean Documentation"
---
...
# doctl compute reserved-ip-action
...
```shell
fipa, floating-ip-action, floating-ip-actions, reserved-ip-actions
```

## Description

Reserved IP actions are commands that are used to manage DigitalOcean reserved IP addresses.
...
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip-action/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip-action/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip-action/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip-action/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ip-action/#global-flags)
