---
url: "https://docs.digitalocean.com/products/uptime/how-to/destroy-alerts/"
title: "How to Destroy Alerts | DigitalOcean Documentation"
---
...
To delete an Uptime alert, go to the **Active Uptime Alerts** table at the bottom of your Uptime check’s status page.

![screenshot of an alerts list, showing the 'More' menu extended and the 'Delete' option highlighted](https://docs.digitalocean.com/screenshots/uptime/alert-delete.2b2639c263f9f8ca44e1d57803e230bd9a69fc000a6526d51782c51f7c80f913.png)

1. Click the drop-down arrow for the alert you want to delete, then select **Delete:**
2. This opens a confirmation pop-up. Click **Delete** to confirm the action.

In this article...

[How to Destroy Alerts](https://docs.digitalocean.com/products/uptime/how-to/destroy-alerts/)
