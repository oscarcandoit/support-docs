---
url: "https://docs.digitalocean.com/reference/pydo/reference/actions/list/"
title: "pydo.actions.list() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [actions](https://docs.digitalocean.com/reference/pydo/reference/actions/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/actions/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/actions/list/)
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/actions_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/actions/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/actions/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/actions/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/actions/list/#more-information)
