---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/list-models/"
title: "doctl genai list-models | DigitalOcean Documentation"
---
...
The `doctl genai list-models` command lists all available GenAI models.
...
\- is\_foundational: True if it is a foundational model provided by DigitalOcean
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Id`, `Name`, `Agreement`, `CreatedAt`, `UpdatedAt`, `isFoundational`, `ParentId`, `UploadComplete`, `URL`, `Version`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/list-models/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/list-models/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/list-models/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/list-models/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/list-models/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/list-models/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/list-models/#global-flags)
