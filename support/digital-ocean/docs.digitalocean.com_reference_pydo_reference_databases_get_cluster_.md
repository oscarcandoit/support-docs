---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_cluster/"
title: "pydo.databases.get_cluster() | DigitalOcean Documentation"
---
...
The embedded maintenance\_window object will contain information about any scheduled maintenance for the database cluster.
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_cluster) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_cluster/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_cluster/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/get_cluster/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_cluster/#more-information)
