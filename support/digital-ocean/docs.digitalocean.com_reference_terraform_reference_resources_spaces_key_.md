---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_key/"
title: "digitalocean_spaces_key | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_key/#example-usage)
  - [Create a New Key](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_key/#create-a-new-key)
  - [Create a New Key with Grants](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_key/#create-a-new-key-with-grants)
  - [Create a New Key with full access](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_key/#create-a-new-key-with-full-access)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_key/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_key/#attributes-reference)
