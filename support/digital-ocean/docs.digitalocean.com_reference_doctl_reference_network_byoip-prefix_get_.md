---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/get/"
title: "doctl network byoip-prefix get | DigitalOcean Documentation"
---
...
# doctl network byoip-prefix get
...
```shell
doctl network byoip-prefix get <prefix-uuid> [flags]
```
...
Retrieves detailed information about a BYOIP Prefix

## Example

The following example retrieves information about the byoip prefix `5ae545c4-0ac4-42bb-9de5-8eca3d17f1c0`:

```shell
doctl network byoip-prefix get 5ae545c4-0ac4-42bb-9de5-8eca3d17f1c0
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/get/#global-flags)
