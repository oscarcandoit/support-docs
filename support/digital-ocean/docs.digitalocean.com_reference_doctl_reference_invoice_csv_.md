---
url: "https://docs.digitalocean.com/reference/doctl/reference/invoice/csv/"
title: "doctl invoice csv | DigitalOcean Documentation"
---
...
```shell
doctl invoice csv <invoice-uuid> <output-file.csv> [flags]
```
...
Downloads a CSV-formatted file of a specific invoice to your local machine.

Use the `doctl invoice list` command to find the UUID of the invoice to retrieve.

## Example

The following example downloads a CSV summary of an invoice with the ID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6` to the file `invoice.csv`:

```shell
doctl invoice csv f81d4fae-7dec-11d0-a765-00a0c91e6bf6 invoice.csv
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/invoice/csv/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/invoice/csv/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/invoice/csv/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/invoice/csv/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/invoice/csv/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/invoice/csv/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/invoice/csv/#global-flags)
