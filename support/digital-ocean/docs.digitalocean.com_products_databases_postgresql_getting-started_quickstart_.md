---
url: "https://docs.digitalocean.com/products/databases/postgresql/getting-started/quickstart/"
title: "PostgreSQL Quickstart | DigitalOcean Documentation"
---
...
- [Create PostgreSQL Database Clusters](https://docs.digitalocean.com/products/databases/postgresql/getting-started/quickstart/#create-postgresql-database-clusters)
- [Change Size or Number of Cluster Nodes](https://docs.digitalocean.com/products/databases/postgresql/getting-started/quickstart/#change-size-or-number-of-cluster-nodes)
- [Relocate Database Clusters](https://docs.digitalocean.com/products/databases/postgresql/getting-started/quickstart/#relocate-database-clusters)
- [Add Additional Users or Databases](https://docs.digitalocean.com/products/databases/postgresql/getting-started/quickstart/#add-additional-users-or-databases)
- [Create Connection Pools](https://docs.digitalocean.com/products/databases/postgresql/getting-started/quickstart/#create-connection-pools)
- [Delete Database Clusters](https://docs.digitalocean.com/products/databases/postgresql/getting-started/quickstart/#delete-database-clusters)
