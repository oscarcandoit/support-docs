---
url: "https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/create/"
title: "pydo.reserved_ips.create() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/reservedIPs_create) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/create/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/create/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/reserved_ips/create/#more-information)
