---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get-agents/"
title: "doctl genai openai-key get-agents | DigitalOcean Documentation"
---
...
# doctl genai openai-key get-agents
...
```shell
doctl genai openai-key get-agents <openai-api-key-uuid> [flags]
```
...
The following example retrieves information about an OpenAI API Key with ID - f81d4fae-0000-11d0-a765-000000000000
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get-agents/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get-agents/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get-agents/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get-agents/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get-agents/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get-agents/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/openai-key/get-agents/#global-flags)
