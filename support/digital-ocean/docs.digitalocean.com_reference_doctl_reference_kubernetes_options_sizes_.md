---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/sizes/"
title: "doctl kubernetes options sizes | DigitalOcean Documentation"
---
...
```shell
doctl kubernetes options sizes [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/sizes/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/sizes/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/sizes/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/sizes/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/sizes/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/sizes/#global-flags)
