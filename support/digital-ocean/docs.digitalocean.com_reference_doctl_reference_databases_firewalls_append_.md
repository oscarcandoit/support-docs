---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/append/"
title: "doctl databases firewalls append | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl databases](https://docs.digitalocean.com/reference/doctl/reference/databases/)
      ...
      - [firewalls](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/)
        - [append](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/append/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/list/)
        - [remove](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/remove/)
        - [replace](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/replace/)
...
This command requires the `--rule` flag specifying the resource or resources allowed to access the database cluster. The rule passed to the `--rule` flag must be in a : format where:
\- `type` is the type of resource that the firewall rule allows to access the database cluster. Possible values are: `droplet`, `k8s",`ip\_addr`,`tag`,`app`-`value\` is either the ID of a specific resource, the name of a tag applied to a group of resources, or the IP address that the firewall rule allows to access the database cluster.
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/append/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/append/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/append/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/append/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/append/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/append/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/firewalls/append/#global-flags)
