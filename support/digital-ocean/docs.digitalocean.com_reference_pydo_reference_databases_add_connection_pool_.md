---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/add_connection_pool/"
title: "pydo.databases.add_connection_pool() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- add\_connection\_pool()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.add\_connection\_pool()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_add_connectionPool) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/add_connection_pool/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/add_connection_pool/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/add_connection_pool/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/add_connection_pool/#more-information)
