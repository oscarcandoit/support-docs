---
url: "https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_app_restart_count_metrics.yml/"
title: "pydo.monitoring.get_app_restart_count_metrics.yml() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [monitoring](https://docs.digitalocean.com/reference/pydo/reference/monitoring/)
- get\_app\_restart\_count\_metrics.yml()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/monitoring_get_appRestartCountMetrics.yml) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_app_restart_count_metrics.yml/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_app_restart_count_metrics.yml/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/monitoring/get_app_restart_count_metrics.yml/#more-information)
