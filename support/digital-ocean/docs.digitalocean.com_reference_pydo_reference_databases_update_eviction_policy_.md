---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/update_eviction_policy/"
title: "pydo.databases.update_eviction_policy() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- update\_eviction\_policy()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.update\_eviction\_policy()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_update_evictionPolicy) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/update_eviction_policy/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/update_eviction_policy/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/update_eviction_policy/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/update_eviction_policy/#more-information)
