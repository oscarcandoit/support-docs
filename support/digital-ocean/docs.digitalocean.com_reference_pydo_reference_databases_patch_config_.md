---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/patch_config/"
title: "pydo.databases.patch_config() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_patch_config) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/patch_config/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/patch_config/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/patch_config/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/patch_config/#more-information)
