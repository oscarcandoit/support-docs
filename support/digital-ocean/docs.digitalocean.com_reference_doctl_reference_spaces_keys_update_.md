---
url: "https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/update/"
title: "doctl spaces keys update | DigitalOcean Documentation"
---
...
```shell
doctl spaces keys update DOACCESSKEY --name new-key --grants 'bucket=my-bucket;permission=readwrite,bucket=my-other-bucket;permission=read'
```
...
| Option | Description |
| --- | --- |
| `--grants`, `-g` | A comma-separated list of grants to set to the key. The permission should be either ‘read’, ‘readwrite’, or ‘fullaccess’.<br>Format: `"bucket=your-bucket;permission=your-permission"` (required) |
| `--help`, `-h` | Help for this command |
| `--name`, `-n` | The new name for the key. (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/update/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/update/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/update/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/spaces/keys/update/#global-flags)
