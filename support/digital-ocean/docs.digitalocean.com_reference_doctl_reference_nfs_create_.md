---
url: "https://docs.digitalocean.com/reference/doctl/reference/nfs/create/"
title: "doctl nfs create | DigitalOcean Documentation"
---
...
```shell
doctl nfs create [flags]
```

## Description

Create an NFS share with the provided config.
...
| `--name`, `-n` | the name of the NFS share (required) |
| `--region`, `-r` | the region where the NFS share resides (required) |
| `--size`, `-s` | the size of the NFS share in GiB (required) |
| `--vpc-ids` | the list of VPC IDs that should be able to access the share (required) |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/nfs/create/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/nfs/create/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/nfs/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/nfs/create/#global-flags)
