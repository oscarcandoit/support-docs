---
url: "https://docs.digitalocean.com/support/how-do-i-fix-an-image-or-digest-not-found-error-with-multiple-registries/"
title: "How do I fix an \"Image or digest not found\" error with multiple registries? | DigitalOcean Documentation"
---
...
To fix this error, [update the app spec](https://docs.digitalocean.com/products/app-platform/how-to/update-app-spec/) with the following `registry:` field, specifying your desired registry:
...
For a full example of the app spec, see [Reference for App Specification](https://docs.digitalocean.com/products/app-platform/reference/app-spec/).
...
[How do I fix an "Image or digest not found" error with multiple registries?](https://docs.digitalocean.com/support/how-do-i-fix-an-image-or-digest-not-found-error-with-multiple-registries/)
