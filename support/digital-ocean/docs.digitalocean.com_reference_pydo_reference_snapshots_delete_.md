---
url: "https://docs.digitalocean.com/reference/pydo/reference/snapshots/delete/"
title: "pydo.snapshots.delete() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/snapshots_delete) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/snapshots/delete/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/snapshots/delete/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/snapshots/delete/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/snapshots/delete/#more-information)
