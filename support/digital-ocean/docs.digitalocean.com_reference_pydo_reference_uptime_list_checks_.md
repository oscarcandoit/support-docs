---
url: "https://docs.digitalocean.com/reference/pydo/reference/uptime/list_checks/"
title: "pydo.uptime.list_checks() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/uptime_list_checks) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/uptime/list_checks/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/uptime/list_checks/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/uptime/list_checks/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/uptime/list_checks/#more-information)
