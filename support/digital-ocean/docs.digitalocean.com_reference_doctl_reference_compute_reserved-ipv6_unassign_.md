---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/unassign/"
title: "doctl compute reserved-ipv6 unassign | DigitalOcean Documentation"
---
...
# doctl compute reserved-ipv6 unassign
...
```shell
doctl compute reserved-ipv6 unassign <reserved-ipv6> [flags]
```

## Description

Unassigns a reserved IPv6 address from a Droplet.

## Example

The following example unassigns the reserved IPv6 address `5a11:a:b0a7` from a resource:

```shell
doctl compute reserved-ipv6 unassign 5a11:a:b0a7
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/unassign/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/unassign/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/unassign/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/unassign/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/unassign/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/unassign/#global-flags)
