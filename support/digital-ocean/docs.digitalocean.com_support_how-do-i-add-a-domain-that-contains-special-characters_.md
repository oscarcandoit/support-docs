---
url: "https://docs.digitalocean.com/support/how-do-i-add-a-domain-that-contains-special-characters/"
title: "How do I add a domain that contains special characters? | DigitalOcean Documentation"
---
...
You can convert your domain to Punycode using a tool like [PunyCoder](https://www.punycoder.com/). On Linux, you can install `idn` (with `apt install idn`) and use it on the command line (for example, `echo "екампле.цом" | idn`).
