---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/database_firewall/"
title: "digitalocean_database_firewall | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/database_firewall/#example-usage)
  - [Create a new database firewall allowing multiple IP addresses](https://docs.digitalocean.com/reference/terraform/reference/resources/database_firewall/#create-a-new-database-firewall-allowing-multiple-ip-addresses)
  - [Create a new database firewall allowing a Droplet](https://docs.digitalocean.com/reference/terraform/reference/resources/database_firewall/#create-a-new-database-firewall-allowing-a-droplet)
  - [Create a new database firewall for a database replica](https://docs.digitalocean.com/reference/terraform/reference/resources/database_firewall/#create-a-new-database-firewall-for-a-database-replica)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_firewall/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/database_firewall/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/database_firewall/#import)
