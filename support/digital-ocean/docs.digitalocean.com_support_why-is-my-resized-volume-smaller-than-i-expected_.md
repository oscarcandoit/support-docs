---
url: "https://docs.digitalocean.com/support/why-is-my-resized-volume-smaller-than-i-expected/"
title: "Why is my resized volume smaller than I expected? | DigitalOcean Documentation"
---
...
You can modify the reserved filesystem blocks and other filesystem parameters with [`tune2fs`](https://manpages.ubuntu.com/manpages/xenial/man8/tune2fs.8.html) for ext4 filesystems and [`xfs_io`](https://manpages.ubuntu.com/manpages/xenial/man8/xfs_io.8.html) for XFS filesystems.

- Different tools report size in different units, like [gigabytes (1 GB = 1000 bytes) or gibibytes (1 GiB = 1024 bytes)](https://en.wikipedia.org/wiki/Byte#Multiple-byte_units). For example, `df -h` reports size in powers of 1024, like GiB, and `df -H` reports sizes in powers of 1000, like GB. 500 GiB is approximately 536 GB.
...
[Why is my resized volume smaller than I expected?](https://docs.digitalocean.com/support/why-is-my-resized-volume-smaller-than-i-expected/)
