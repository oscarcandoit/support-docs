---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/delete/"
title: "doctl compute cdn delete | DigitalOcean Documentation"
---
...
```shell
doctl compute cdn delete <cdn-id> [flags]
```
...
Deletes the CDN specified by the ID.

You can retrieve a list of CDN IDs by calling `doctl compute cdn list`

## Example

The following example deletes a CDN with the ID `418b7972-fc67-41ea-ab4b-6f9477c4f7d8`:

```shell
doctl compute cdn delete 418b7972-fc67-41ea-ab4b-6f9477c4f7d8
```
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete the specified CDN without prompting for confirmation<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/cdn/delete/#global-flags)
