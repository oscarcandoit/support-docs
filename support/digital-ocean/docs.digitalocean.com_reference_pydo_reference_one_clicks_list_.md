---
url: "https://docs.digitalocean.com/reference/pydo/reference/one_clicks/list/"
title: "pydo.one_clicks.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/oneClicks_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/list/#more-information)
