---
url: "https://docs.digitalocean.com/support/how-do-i-fix-the-mysqldump-couldnt-execute-flush-tables-access-denied-error/"
title: "How do I fix the mysqldump \"Couldn't execute FLUSH TABLES Access denied\" error? | DigitalOcean Documentation"
---
...
An [update to the `mysqldump` package](https://github.com/mysql/mysql-server/commit/022e73ba6976b984658a1c2652178cd4b81aec28) fixed a bug with inconsistent backups with `--single-transaction`. Because the fix was rolled out in a minor version, automated backups pulled in the update and broke backups for some users.
...
Log in to the MySQL console, then run the following command to list the users and their relevant permissions:
...
GRANT RELOAD, PROCESS ON . TO 'backups'@'%'; FLUSH PRIVILEGES;
```
...
However, if you are using Amazon Relational Database Service (RDS), you need to use one of these alternative solutions because RDS doesn’t allow super permissions. [Learn more about fixing this error on RDS](https://repost.aws/knowledge-center/mysqldump-error-rds-mysql-mariadb).
...
- [Update Backup User Permissions](https://docs.digitalocean.com/support/how-do-i-fix-the-mysqldump-couldnt-execute-flush-tables-access-denied-error/#update-backup-user-permissions)
- [Alternative Solutions](https://docs.digitalocean.com/support/how-do-i-fix-the-mysqldump-couldnt-execute-flush-tables-access-denied-error/#alternative-solutions)
