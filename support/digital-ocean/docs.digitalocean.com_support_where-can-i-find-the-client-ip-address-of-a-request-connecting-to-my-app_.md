---
url: "https://docs.digitalocean.com/support/where-can-i-find-the-client-ip-address-of-a-request-connecting-to-my-app/"
title: "Where can I find the client IP address of a request connecting to my app? | DigitalOcean Documentation"
---
...
App Platform adds a `do-connecting-ip` [HTTP header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers) that contains the client’s IP address for requests directed to your app. While the `x-forwarded-for` header is often used for this purpose, App Platform uses this header for the IP address of the DigitalOcean ingress server that forwarded the request to your app.
...
[Where can I find the client IP address of a request connecting to my app?](https://docs.digitalocean.com/support/where-can-i-find-the-client-ip-address-of-a-request-connecting-to-my-app/)
