---
url: "https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/create_service_key/"
title: "pydo.partner_attachments.create_service_key() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [partner\_attachments](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/)
- create\_service\_key()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.partner\_attachments.create\_service\_key()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/partnerAttachments_create_service_key) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/create_service_key/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/create_service_key/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/create_service_key/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/partner_attachments/create_service_key/#more-information)
