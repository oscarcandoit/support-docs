---
url: "https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/"
title: "How to Choose Eviction Policies on Caching Database Clusters | DigitalOcean Documentation"
---
...
- [General Eviction Policies](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#general-eviction-policies)
  - [`noeviction`](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#noeviction)
  - [`allkeys-lru`](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#allkeys-lru)
  - [`allkeys-lfu`](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#allkeys-lfu)
  - [`allkeys-random`](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#allkeys-random)
- [Eviction Policies Dependent on Expiration](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#eviction-policies-dependent-on-expiration)
  - [`volatile-lru`](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#volatile-lru)
  - [`volatile-lfu`](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#volatile-lfu)
  - [`volatile-random`](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#volatile-random)
  - [`volatile-ttl`](https://docs.digitalocean.com/products/databases/redis/how-to/choose-eviction-policies/#volatile-ttl)
