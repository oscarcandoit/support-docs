---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_backups/"
title: "pydo.databases.list_backups() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_backups) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_backups/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_backups/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/list_backups/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_backups/#more-information)
