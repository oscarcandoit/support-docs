---
url: "https://docs.digitalocean.com/reference/pydo/reference/snapshots/get/"
title: "pydo.snapshots.get() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/snapshots_get) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/snapshots/get/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/snapshots/get/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/snapshots/get/#more-information)
