---
url: "https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/result/"
title: "doctl serverless activations result | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--function`, `-f` | Retrieve the results for a specific function. |
| `--help`, `-h` | Help for this command |
| `--last`, `-l` | Retrieve the most recent activation result (default).<br>Default: `false` |
| `--limit`, `-n` | Limit the number of results return to the specified number. (default 30, max 200)<br>Default: `1` |
| `--quiet`, `-q` | Suppress last activation information header.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/result/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/result/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/result/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/result/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/result/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/serverless/activations/result/#global-flags)
