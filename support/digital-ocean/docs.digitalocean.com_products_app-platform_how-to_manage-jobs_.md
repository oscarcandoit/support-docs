---
url: "https://docs.digitalocean.com/products/app-platform/how-to/manage-jobs/"
title: "How to Manage Jobs in App Platform | DigitalOcean Documentation"
---
...
Like [workers](https://docs.digitalocean.com/products/app-platform/how-to/manage-workers/), jobs are not “routable,” meaning they run in the background and cannot accept HTTP/S requests.

## Add a Job to an App Using Automation

You can add a job to an app using the CLI’s app update command or the API’s app update endpoint. To add a job, update the [app’s spec](https://docs.digitalocean.com/products/app-platform/reference/app-spec/) with the job’s specifications and submit the spec using the following command or endpoint.
...
To schedule a job, [update the app spec](https://docs.digitalocean.com/products/app-platform/how-to/update-app-spec/) with the following template, setting `kind` to `SCHEDULED` and configuring `schedule` with a cron expression (minimum of every 15 minutes) and time zone like this:
...
- [Add a Job to an App Using Automation](https://docs.digitalocean.com/products/app-platform/how-to/manage-jobs/#add-a-job-to-an-app-using-automation)
- [Add a Job to an App Using the Control Panel](https://docs.digitalocean.com/products/app-platform/how-to/manage-jobs/#add-a-job-to-an-app-using-the-control-panel)
- [Environment](https://docs.digitalocean.com/products/app-platform/how-to/manage-jobs/#environment)
- [Schedule Jobs](https://docs.digitalocean.com/products/app-platform/how-to/manage-jobs/#schedule-jobs)
  - [Using the Control Panel](https://docs.digitalocean.com/products/app-platform/how-to/manage-jobs/#using-the-control-panel)
  - [Using the App Spec](https://docs.digitalocean.com/products/app-platform/how-to/manage-jobs/#using-the-app-spec)
- [Edit Jobs](https://docs.digitalocean.com/products/app-platform/how-to/manage-jobs/#edit-jobs)
- [Destroy Jobs](https://docs.digitalocean.com/products/app-platform/how-to/manage-jobs/#destroy-jobs)
