---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete/"
title: "doctl kubernetes cluster node-pool delete | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes node pool without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/node-pool/delete/#global-flags)
