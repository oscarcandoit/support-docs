---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/certificate/"
...
Manage CDN endpoints: create, update, delete, purge cache. View the API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/cdn\_create\_endpoint](https://docs.digitalocean.com/reference/api/api-reference/#operation/cdn_create_endpoint).
...
| --- | --- | --- |
| `certificate_chain`<br>str |  | The full PEM-formatted trust chain between the certificate authority’s certificate and your domain’s SSL certificate. |
...
| `dns_names`<br>list / elements=str |  | An array of fully qualified domain names (FQDNs) for which the certificate was issued. A certificate covering all subdomains can be issued using a wildcard (e.g. `*.example.com`). |
| `leaf_certificate`<br>str |  | The contents of a PEM-formatted public SSL certificate. |
...
| `name`<br>str / **required** |  | A unique human-readable name referring to a certificate. To create a certificate from Let’s Encrypt, provide `dns_names`. To create a custom certificate, provide `private_key`, `leaf_certificate`, and optionally `certificate_chain`. View API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#operation/certificates\_create](https://docs.digitalocean.com/reference/api/api-reference/#operation/certificates_create). |
| `private_key`<br>str |  | The contents of a PEM-formatted private-key corresponding to the SSL certificate. |
...
| --- | --- | --- |
| `certificate`<br>dict | always | Certificate.<br>Sample:<br>```json<br>{<br>  "created_at": "2017-02-08T16:02:37Z",<br>  "dns_names": [],<br>  "id": "892071a0-bb95-49bc-8021-3afd67a210bf",<br>  "name": "web-cert-01",<br>  "not_after": "2017-02-22T00:23:00Z",<br>  "sha1_fingerprint": "dfcc9f57d86bf58e321c2c6c31c7a971be244ac7",<br>  "state": "verified",<br>  "type": "custom"<br>}<br>``` |
...
| `msg`<br>str | always | Certificate result information.<br>Sample:<br>```json<br>[<br>  "Certificate web-cert-01 not found",<br>  "Certificate web-cert-01 ID not found",<br>  "Certificate web-cert-01 created",<br>  "Certificate web-cert-01 created but not found yet",<br>  "Certificate web-cert-01 not created",<br>  "Certificate web-cert-01 deleted",<br>  "Certificate web-cert-01 exists"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/certificate/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/certificate/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/certificate/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/certificate/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/certificate/#return-values)
