---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/get/"
title: "doctl compute snapshot get | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [snapshot](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/list/)
...
```shell
doctl compute snapshot get <snapshot-id>... [flags]
```
...
Retrieves information about a Droplet or block storage volume snapshot, including:
...
The following example retrieves information about a Droplet snapshot with ID `386734086`:

```shell
doctl compute snapshot get 386734086
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/get/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/get/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/snapshot/get/#global-flags)
