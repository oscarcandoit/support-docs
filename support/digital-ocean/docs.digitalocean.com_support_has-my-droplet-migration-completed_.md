---
url: "https://docs.digitalocean.com/support/has-my-droplet-migration-completed/"
title: "Has my Droplet migration completed? | DigitalOcean Documentation"
---
...
Validated on 12 May 2020 • Last edited on 23 Jan 2025

You can monitor the status of a [Droplet migration](https://docs.digitalocean.com/products/droplets/details/live-migration/) within the [DigitalOcean Control Panel](https://cloud.digitalocean.com/).

To see the status of a migration, select the Droplet within the control panel. A banner appears at the top of the page showing if the migration is still in progress. If the migration is no longer in progress, the banner does not appear.

You can also check if a migration has completed by viewing the Droplet’s history. To view a Droplet’s history from the control panel, click the Droplet being migrated from your list of Droplets, then click **History** in the side menu. This shows when the migration began and how long it took to complete.
...
[Has my Droplet migration completed?](https://docs.digitalocean.com/support/has-my-droplet-migration-completed/)
