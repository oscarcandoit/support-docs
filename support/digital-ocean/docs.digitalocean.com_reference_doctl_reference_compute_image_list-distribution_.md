---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-distribution/"
title: "doctl compute image list-distribution | DigitalOcean Documentation"
---
...
```shell
doctl compute image list-distribution [flags]
```

## Description

Lists the distribution images available from DigitalOcean. This command returns the following information about each image:
...
The following example lists all public distribution images available from DigitalOcean and uses the `--format` flag to return only the ID, distribution, and slug for each image:
...
| `--public` | Lists public images<br>Default: `true` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-distribution/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-distribution/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-distribution/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-distribution/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-distribution/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-distribution/#global-flags)
