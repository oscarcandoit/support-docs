---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/domain_records_info/"
title: "domain_records_info | DigitalOcean Documentation"
---
...
Retrieve a listing of all of the domain records for a domain. View the API documentation at ( [https://docs.digitalocean.com/reference/api/api-reference/#operation/domains\_list\_records)](https://docs.digitalocean.com/reference/api/api-reference/#operation/domains_list_records)).
...
| `domain_name`<br>str / **required** |  | The name of the domain itself. |
...
| `name`<br>str |  | Retrieve a specific fully qualified record name. |
...
| `type`<br>str | Choices:<br>- `A`<br>- `AAAA`<br>- `CNAME`<br>- `MX`<br>- `TXT`<br>- `SRV`<br>- `NS`<br>- `CAA` | Retrieve a specific type of record. |
...
| --- | --- | --- |
| `domain_records`<br>list | always | Domain records.<br>Sample:<br>```json<br>[<br>  {<br>    "data": "ns1.digitalocean.com",<br>    "flags": null,<br>    "id": 324538538,<br>    "name": "@",<br>    "port": null,<br>    "priority": null,<br>    "tag": null,<br>    "ttl": 1800,<br>    "type": "NS",<br>    "weight": null<br>  }<br>]<br>``` |
...
| `msg`<br>str | always | Domain records result information.<br>Sample:<br>```json<br>[<br>  "Current domains",<br>  "No domains"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/domain_records_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/domain_records_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/domain_records_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/domain_records_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/domain_records_info/#return-values)
