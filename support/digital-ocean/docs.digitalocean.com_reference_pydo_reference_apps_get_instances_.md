---
url: "https://docs.digitalocean.com/reference/pydo/reference/apps/get_instances/"
title: "pydo.apps.get_instances() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/apps_get_instances) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/apps/get_instances/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/apps/get_instances/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/apps/get_instances/#more-information)
