---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/create_indexing_job/"
title: "pydo.genai.create_indexing_job() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_create_indexing_job) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/create_indexing_job/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/create_indexing_job/#more-information)
