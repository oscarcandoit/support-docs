---
url: "https://docs.digitalocean.com/reference/pydo/reference/functions/list_namespaces/"
title: "pydo.functions.list_namespaces() | DigitalOcean Documentation"
---
...
# pydo.functions.list\_namespaces()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/functions_list_namespaces) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/functions/list_namespaces/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/functions/list_namespaces/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/functions/list_namespaces/#more-information)
