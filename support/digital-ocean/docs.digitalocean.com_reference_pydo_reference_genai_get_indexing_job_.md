---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/get_indexing_job/"
title: "pydo.genai.get_indexing_job() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `uuid` | string | True | Indexing job id |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_get_indexing_job) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/get_indexing_job/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/get_indexing_job/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/get_indexing_job/#more-information)
