---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/topics/partitions/"
title: "doctl databases topics partitions | DigitalOcean Documentation"
---
...
# doctl databases topics partitions
...
```shell
doctl databases topics partitions <database-id> <topic-name> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/partitions/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/partitions/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/partitions/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/partitions/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/partitions/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/topics/partitions/#global-flags)
