---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_kafka_topics/"
title: "pydo.databases.list_kafka_topics() | DigitalOcean Documentation"
---
...
# pydo.databases.list\_kafka\_topics()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_kafka_topics) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_kafka_topics/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_kafka_topics/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_kafka_topics/#more-information)
