---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/tag/get/"
title: "doctl compute tag get | DigitalOcean Documentation"
---
...
```shell
doctl compute tag get <tag-name> [flags]
```

## Description

Retrieves the number of resources using the tag.

## Example

The following example retrieves information about the tag named `web`:
...
| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: `Name`, `DropletCount`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/get/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/get/#global-flags)
