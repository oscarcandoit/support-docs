---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete-dangerous/"
title: "doctl compute droplet-autoscale delete-dangerous | DigitalOcean Documentation"
---
...
# doctl compute droplet-autoscale delete-dangerous
...
```shell
doctl compute droplet-autoscale delete-dangerous <autoscale-pool-id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete-dangerous/#usage)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete-dangerous/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete-dangerous/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete-dangerous/#global-flags)
