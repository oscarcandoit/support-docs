---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/list_events_logs/"
title: "pydo.databases.list_events_logs() | DigitalOcean Documentation"
---
...
# pydo.databases.list\_events\_logs()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_list_events_logs) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/list_events_logs/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/list_events_logs/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/list_events_logs/#more-information)
