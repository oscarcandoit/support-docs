---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/"
title: "doctl network | DigitalOcean Documentation"
---
...
The commands under `doctl network` are for managing network products
...
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/#global-flags)
