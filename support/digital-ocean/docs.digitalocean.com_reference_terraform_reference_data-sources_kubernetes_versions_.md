---
url: "https://docs.digitalocean.com/reference/terraform/reference/data-sources/kubernetes_versions/"
title: "digitalocean_kubernetes_versions | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/data-sources/kubernetes_versions/#example-usage)
  - [Output a list of all available versions](https://docs.digitalocean.com/reference/terraform/reference/data-sources/kubernetes_versions/#output-a-list-of-all-available-versions)
  - [Create a Kubernetes cluster using the most recent version available](https://docs.digitalocean.com/reference/terraform/reference/data-sources/kubernetes_versions/#create-a-kubernetes-cluster-using-the-most-recent-version-available)
  - [Pin a Kubernetes cluster to a specific minor version](https://docs.digitalocean.com/reference/terraform/reference/data-sources/kubernetes_versions/#pin-a-kubernetes-cluster-to-a-specific-minor-version)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/kubernetes_versions/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/data-sources/kubernetes_versions/#attributes-reference)
