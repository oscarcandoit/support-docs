---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/add/"
title: "doctl genai agent route add | DigitalOcean Documentation"
---
...
```shell
doctl genai agent route add [flags]
```
...
```shell
doctl genai agent route add --parent-agent-id "12345678-1234-1234-1234-123456789012" --child-agent-id "12345678-1234-1234-1234-123456789013"
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/add/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/add/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/add/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/add/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/add/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/add/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/route/add/#global-flags)
