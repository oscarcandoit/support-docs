---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/user/list/"
title: "doctl databases user list | DigitalOcean Documentation"
---
...
```shell
doctl databases user list <database-cluster-id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/user/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/user/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/user/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/user/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/user/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/user/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/user/list/#global-flags)
