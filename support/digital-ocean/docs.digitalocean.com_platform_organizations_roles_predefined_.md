---
url: "https://docs.digitalocean.com/platform/organizations/roles/predefined/"
title: "Organizations Predefined Roles | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/organizations.ae95392d02268a2e13ef28b6aabf1b35b6a0a5a9ef64517fedf080075500cefd.svg)Organizations](https://docs.digitalocean.com/platform/organizations/)
  - [Roles](https://docs.digitalocean.com/platform/organizations/roles/)
    - [Organizations Roles](https://docs.digitalocean.com/platform/organizations/roles/predefined/)
...
| --- | --- | --- | --- | --- | --- |
| **Organization Owner** | User who owns the organization. Must be a team owner. | 🟢<br>Full access | 🟢<br>Full access | 🟡<br>Limited, read-only access to billing for teams they are not part of. | 🔴<br>No access unless they are a member of that team. |
| **Organization Admin** | User who can create new teams and add existing teams. | 🟡<br>Limited, read only access. | 🔴<br>No access | 🔴<br>No access | 🟢<br>Full access for teams they belong to. |
| **Organization Biller** | User who can manage organization billing – view and manage payment methods, access and download invoices, and monitor organization-wide spending. | 🔴<br>No access | 🔴<br>No access | 🟢<br>Full access | 🔴<br>No access |
| **Team Owner** | User who owns the team. | 🔴<br>No access unless they have a role in the organization. | 🟡<br>Limited to managing roles for their team. | 🔴<br>No access unless they have a role in the organization for their team. | 🟢<br>Full access for their team. |
| **Team Member** | User who belongs to a team. | 🔴<br>No access | 🔴<br>No access | 🔴<br>No access | 🟢<br>Full access for team resources assigned to their role in their team. |
| **Team Billing Viewer** | User who can view team billing information. | 🔴<br>No access | 🔴<br>No access | 🟢<br>Full access for their team. | 🔴<br>No access |

In this article...

[Organizations Predefined Roles](https://docs.digitalocean.com/platform/organizations/roles/predefined/)
