---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/"
title: "doctl databases sql-mode | DigitalOcean Documentation"
---
...
The subcommands of `doctl databases sql-mode` are used to view and configure a MySQL database cluster’s global SQL modes. Global SQL modes affect the SQL syntax MySQL supports and the data validation checks it performs.
...
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/sql-mode/#global-flags)
