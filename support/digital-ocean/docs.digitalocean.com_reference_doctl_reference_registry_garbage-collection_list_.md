---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/list/"
title: "doctl registry garbage-collection list | DigitalOcean Documentation"
---
...
```shell
doctl registry garbage-collection list [flags]
```
...
Retrieves a list of past garbage collections for a registry. Information about each garbage collection includes:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/list/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/list/#global-flags)
