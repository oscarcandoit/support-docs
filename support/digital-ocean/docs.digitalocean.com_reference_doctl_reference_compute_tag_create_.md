---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/tag/create/"
title: "doctl compute tag create | DigitalOcean Documentation"
---
...
```shell
doctl compute tag create <tag-name> [flags]
```

## Description

Creates a new tag that you can apply to resources.

## Example

The following example creates a tag name `web`:
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/create/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/create/#global-flags)
