---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/user/"
title: "doctl databases user | DigitalOcean Documentation"
---
...
The commands under `doctl databases user` allow you to view details for, and create, database users.
...
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/user/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/user/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/user/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/user/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/user/#global-flags)
