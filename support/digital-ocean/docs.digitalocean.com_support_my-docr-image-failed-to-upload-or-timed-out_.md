---
url: "https://docs.digitalocean.com/support/my-docr-image-failed-to-upload-or-timed-out/"
title: "My DOCR image failed to upload or timed out | DigitalOcean Documentation"
---
...
DOCR image upload failures can be difficult to diagnose. We recommend uploading the image again to see if it resolves the issue.

If uploading the image again does not resolve the issue, you can troubleshoot further by checking the build and runtime logs.

From the [control panel](https://cloud.digitalocean.com/apps), navigate to your app’s **Overview** page. Click the **Activity** tab, then click the **deployment** link for the latest deployment. This opens the deployment’s build and runtime logs.

Select the logs for the component that failed and review them for any errors that may help diagnose the problem.

In this article...

[My DOCR image failed to upload or timed out](https://docs.digitalocean.com/support/my-docr-image-failed-to-upload-or-timed-out/)
