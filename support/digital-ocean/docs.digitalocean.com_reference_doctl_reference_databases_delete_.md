---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/delete/"
title: "doctl databases delete | DigitalOcean Documentation"
---
...
Deletes the database cluster with the specified ID.
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete the database cluster without a confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/delete/#global-flags)
