---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/get_indexing_job_details_signed_url/"
title: "pydo.genai.get_indexing_job_details_signed_url() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- get\_indexing\_job\_details\_signed\_url()
...
| --- | --- | --- | --- | --- |
| `indexing_job_uuid` | string | True | The uuid of the indexing job |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_get_indexing_job_details_signed_url) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/get_indexing_job_details_signed_url/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/get_indexing_job_details_signed_url/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/get_indexing_job_details_signed_url/#more-information)
