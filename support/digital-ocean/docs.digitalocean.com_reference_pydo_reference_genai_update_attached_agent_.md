---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/update_attached_agent/"
title: "pydo.genai.update_attached_agent() | DigitalOcean Documentation"
---
...
| --- | --- | --- | --- | --- |
| `parent_agent_uuid` | string | True | A unique identifier for the parent agent. |  |
| `child_agent_uuid` | string | True | Routed agent id |  |
| `body` | JSON or IO\[bytes\] | False |  |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_update_attached_agent) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/update_attached_agent/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/update_attached_agent/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/update_attached_agent/#more-information)
