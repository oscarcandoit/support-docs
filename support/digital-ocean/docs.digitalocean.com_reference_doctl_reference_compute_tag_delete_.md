---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/tag/delete/"
title: "doctl compute tag delete | DigitalOcean Documentation"
---
...
```shell
doctl compute tag delete <tag-name>... [flags]
```
...
The following example deletes the tag named `web`:

```shell
doctl compute tag delete web
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/tag/delete/#global-flags)
