---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/actions/"
title: "doctl compute droplet actions | DigitalOcean Documentation"
---
...
```shell
doctl compute droplet actions <droplet-id> [flags]
```
...
Retrieves a list of previous actions taken on the Droplet, such as reboots, resizes, and snapshots actions.

## Example

The following example retrieves a list of actions taken on a Droplet with the ID `386734086`. Additionally, the command uses the `--format` flag to return only the ID, status, and type of action:

```shell
doctl compute droplet actions 386734086 --format ID,Status,Type
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/actions/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/actions/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/actions/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/actions/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/actions/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/actions/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet/actions/#global-flags)
