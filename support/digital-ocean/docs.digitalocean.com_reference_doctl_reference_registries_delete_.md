---
url: "https://docs.digitalocean.com/reference/doctl/reference/registries/delete/"
title: "doctl registries delete | DigitalOcean Documentation"
---
...
```shell
doctl registries delete <registry-name> [flags]
```
...
Permanently deletes a registry from your account.
...
```shell
doctl registries delete example-registry. Note that you can delete only one registry at a time.
```
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete registry without confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registries/delete/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registries/delete/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registries/delete/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registries/delete/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/delete/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registries/delete/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registries/delete/#global-flags)
