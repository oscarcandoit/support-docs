---
url: "https://docs.digitalocean.com/reference/doctl/reference/auth/remove/"
title: "doctl auth remove | DigitalOcean Documentation"
---
...
```shell
doctl auth remove --context <name> [flags]
```

## Description

This command allows you to remove authentication contexts you’ve already created.
...
The following example removes the context `your-team`:

```shell
doctl auth remove --context your-team
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/auth/remove/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/auth/remove/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/auth/remove/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/remove/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/auth/remove/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/auth/remove/#global-flags)
