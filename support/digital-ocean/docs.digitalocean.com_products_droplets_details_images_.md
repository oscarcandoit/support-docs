---
url: "https://docs.digitalocean.com/products/droplets/details/images/"
title: "Linux Images for Droplets | DigitalOcean Documentation"
---
...
Validated on 5 Jun 2025 • Last edited on 6 Jun 2025
...
| Image | API/CLI Slug | Image ID |
| --- | --- | --- |
| AlmaLinux 10 | `almalinux-10-x64` | 197014428 |
| AlmaLinux 8 | `almalinux-8-x64` | 200011382 |
| AlmaLinux 9 | `almalinux-9-x64` | 200011362 |
| CentOS Stream 10 x64 | `centos-stream-10-x64` | 199888277 |
| CentOS Stream 9 x64 | `centos-stream-9-x64` | 197131532 |
| Debian 12 Image | `debian-12-x64` | 199996745 |
| Debian 13 Image | `debian-13-x64` | 199888143 |
| Fedora 42 x64 | `fedora-42-x64` | 199561349 |
| AMD AI/ML Ready | `gpu-amd-base` | 203838208 |
| NVIDIA AI/ML Ready | `gpu-h100x1-base` | 203838782 |
| NVIDIA AI/ML Ready with NVLink | `gpu-h100x8-base` | 203839248 |
| Rocky Linux 10 x64 | `rockylinux-10-x64` | 197216326 |
| Rocky Linux 8 x64 | `rockylinux-8-x64` | 143033891 |
| Rocky Linux 9 x64 | `rockylinux-9-x64` | 135509519 |
| Ubuntu 22.04 (LTS) x64 | `ubuntu-22-04-x64` | 159651797 |
| Ubuntu 24.04 (LTS) x64 | `ubuntu-24-04-x64` | 195932981 |
| Ubuntu 25.04 x64 | `ubuntu-25-04-x64` | 194271330 |
| Ubuntu 25.10 x64 | `ubuntu-25-10-x64` | 204596533 |

In the [DigitalOcean Marketplace](https://marketplace.digitalocean.com/), we and third-party vendors offer a large variety of Droplet 1-Click Apps. Droplet 1-Click Apps are pre-built Droplet images that come with preconfigured software, features, and settings. You can view a similar table of available images for Droplet 1-Click Apps here:

![](https://docs.digitalocean.com/images/icons/marketplace.svg)

DigitalOcean Marketplace Droplet 1-Click Apps

Droplet 1-Click Apps are pre-built Droplet images that come with preconfigured software, features, and settings.
