---
url: "https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list/"
title: "pydo.byoip_prefixes.list() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/byoipPrefixes_list) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/byoip_prefixes/list/#more-information)
