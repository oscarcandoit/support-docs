---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/attachment/regenerate-service-key/"
title: "doctl network attachment regenerate-service-key | DigitalOcean Documentation"
---
...
# doctl network attachment regenerate-service-key
...
```shell
doctl network attachment regenerate-service-key <partner-attachment-id> [flags]
```
...
Regenerates information about a Service key of Partner Attachment

## Flags

| Option | Description |
| --- | --- |
| `--format` | Columns for output in a comma-separated list. Possible values: \`\`. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/regenerate-service-key/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/regenerate-service-key/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/regenerate-service-key/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/regenerate-service-key/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/regenerate-service-key/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/attachment/regenerate-service-key/#global-flags)
