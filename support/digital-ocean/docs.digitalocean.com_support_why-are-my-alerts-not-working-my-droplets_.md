---
url: "https://docs.digitalocean.com/support/why-are-my-alerts-not-working-my-droplets/"
title: "Why are my alerts not working my Droplets? | DigitalOcean Documentation"
---
...
Validated on 23 Aug 2023 • Last edited on 14 Jul 2025

You must [install the DigitalOcean metrics agent](https://docs.digitalocean.com/products/monitoring/how-to/install-metrics-agent/#install), a lightweight open-source program that gathers metrics, on every Droplet that you want to receive alerts for. DigitalOcean alerts rely on information provided by the [DigitalOcean metrics agent](https://docs.digitalocean.com/products/monitoring/#agent-overview).
...
[Why are my alerts not working my Droplets?](https://docs.digitalocean.com/support/why-are-my-alerts-not-working-my-droplets/)
