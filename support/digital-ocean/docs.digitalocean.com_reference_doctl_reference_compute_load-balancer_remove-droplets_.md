---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-droplets/"
title: "doctl compute load-balancer remove-droplets | DigitalOcean Documentation"
---
...
```shell
doctl compute load-balancer remove-droplets <load-balancer-id> [flags]
```

## Description

Use this command to remove Droplets from a load balancer. This command does not destroy any Droplets.

## Flags

| Option | Description |
| --- | --- |
| `--droplet-ids` | A comma-separated list of IDs of Droplets to remove from the load balancer, example value: `12,33` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-droplets/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-droplets/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-droplets/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-droplets/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/load-balancer/remove-droplets/#global-flags)
