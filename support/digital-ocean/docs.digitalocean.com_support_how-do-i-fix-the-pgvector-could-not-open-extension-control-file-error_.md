---
url: "https://docs.digitalocean.com/support/how-do-i-fix-the-pgvector-could-not-open-extension-control-file-error/"
title: "How do I fix the pgvector \"could not open extension control file\" error? | DigitalOcean Documentation"
---
...
For more details, see the [`pgvector` documentation](https://github.com/pgvector/pgvector).
...
[How do I fix the pgvector "could not open extension control file" error?](https://docs.digitalocean.com/support/how-do-i-fix-the-pgvector-could-not-open-extension-control-file-error/)
