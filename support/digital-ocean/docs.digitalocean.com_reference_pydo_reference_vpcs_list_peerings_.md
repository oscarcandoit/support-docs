---
url: "https://docs.digitalocean.com/reference/pydo/reference/vpcs/list_peerings/"
title: "pydo.vpcs.list_peerings() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/vpcs_list_peerings) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/vpcs/list_peerings/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/vpcs/list_peerings/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/vpcs/list_peerings/#more-information)
