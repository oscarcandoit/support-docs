---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/restore/"
title: "doctl compute droplet-action restore | DigitalOcean Documentation"
---
...
| `--image-id` | The ID of the image to restore the Droplet from (required)<br>Default: `0` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/restore/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/restore/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/restore/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/restore/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/restore/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/restore/#global-flags)
