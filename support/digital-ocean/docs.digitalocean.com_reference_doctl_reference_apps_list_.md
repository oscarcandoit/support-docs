---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/list/"
title: "doctl apps list | DigitalOcean Documentation"
---
...
| `--with-projects` | Boolean that specifies whether project ids should be fetched along with listed apps<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/apps/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list/#global-flags)
