---
url: "https://docs.digitalocean.com/reference/pydo/reference/cdn/get_endpoint/"
title: "pydo.cdn.get_endpoint() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/cdn_get_endpoint) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/cdn/get_endpoint/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/cdn/get_endpoint/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/cdn/get_endpoint/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/cdn/get_endpoint/#more-information)
