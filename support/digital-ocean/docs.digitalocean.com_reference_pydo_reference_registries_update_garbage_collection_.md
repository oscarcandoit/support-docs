---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/update_garbage_collection/"
title: "pydo.registries.update_garbage_collection() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [registries](https://docs.digitalocean.com/reference/pydo/reference/registries/)
- update\_garbage\_collection()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.registries.update\_garbage\_collection()
...
| `garbage_collection_uuid` | string | True | The UUID of a garbage collection run. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_update_garbageCollection) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/update_garbage_collection/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/registries/update_garbage_collection/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/update_garbage_collection/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/update_garbage_collection/#more-information)
