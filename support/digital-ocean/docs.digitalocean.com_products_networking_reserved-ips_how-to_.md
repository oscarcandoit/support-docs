---
url: "https://docs.digitalocean.com/products/networking/reserved-ips/how-to/"
title: "Reserved IP How-Tos | DigitalOcean Documentation"
---
...
Manually configure Droplets to enable reserved IPv4 and IPv6 addresses.
...
Provision a BYOIP prefix to assign your own IP addresses to Droplets.

![](https://docs.digitalocean.com/images/icons/reserved-ips.svg)

How to Deprovision a BYOIP Prefix

Deprovision a BYOIP prefix to remove it from your account.

![](https://docs.digitalocean.com/images/icons/reserved-ips.svg)

How to Pause or Resume BYOIP Prefix Advertisement

Pause or resume BYOIP prefix advertisement to control its accessibility from the internet.

![](https://docs.digitalocean.com/images/icons/reserved-ips.svg)

How to Assign BYOIP IPs

Assign an IP address from your BYOIP prefix to a Droplet.

![](https://docs.digitalocean.com/images/icons/reserved-ips.svg)

How to Reassign or Unassign BYOIP IPs

Reassign or Unassign a BYOIP IP address from a Droplet.

In this article...

[Reserved IP How-Tos](https://docs.digitalocean.com/products/networking/reserved-ips/how-to/)
