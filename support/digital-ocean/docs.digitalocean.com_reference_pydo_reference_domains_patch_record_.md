---
url: "https://docs.digitalocean.com/reference/pydo/reference/domains/patch_record/"
title: "pydo.domains.patch_record() | DigitalOcean Documentation"
---
...
See the [attribute table](https://docs.digitalocean.com/reference/pydo/reference/domains/patch_record/#tag/Domain-Records) for details regarding record
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/domains_patch_record) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/domains/patch_record/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/domains/patch_record/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/domains/patch_record/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/domains/patch_record/#more-information)
