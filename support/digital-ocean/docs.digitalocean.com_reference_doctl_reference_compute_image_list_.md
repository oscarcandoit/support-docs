---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/image/list/"
title: "doctl compute image list | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [image](https://docs.digitalocean.com/reference/doctl/reference/compute/image/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/image/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/image/delete/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/image/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list/)
        - [list-application](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-application/)
        - [list-distribution](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-distribution/)
        - [list-user](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list-user/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/compute/image/update/)
...
```shell
doctl compute image list [flags]
```
...
Lists all private images on your account. To list public images, use the `--public` flag. This command returns the following information about each image:
...
The following example lists all private images on your account and uses the `--format` flag to return only the ID, distribution, slug and created for each image:

```shell
doctl compute image list --format ID,Distribution,Slug,Created
```
...
| `--public` | Lists public images<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/image/list/#global-flags)
