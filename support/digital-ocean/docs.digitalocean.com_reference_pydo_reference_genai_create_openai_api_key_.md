---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/create_openai_api_key/"
title: "pydo.genai.create_openai_api_key() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_create_openai_api_key) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/create_openai_api_key/#description)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/create_openai_api_key/#more-information)
