---
url: "https://docs.digitalocean.com/reference/pydo/reference/projects/patch/"
title: "pydo.projects.patch() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/projects_patch) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/projects/patch/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/projects/patch/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/projects/patch/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/projects/patch/#more-information)
