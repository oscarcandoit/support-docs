---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/domains_info/"
title: "domains_info | DigitalOcean Documentation"
---
...
Retrieve a list of all of the domains in your account. View the API documentation at ( [https://docs.digitalocean.com/reference/api/api-reference/#operation/domains\_list)](https://docs.digitalocean.com/reference/api/api-reference/#operation/domains_list)).
...
| --- | --- | --- |
| `domains`<br>list | always | Domains.<br>Sample:<br>```json<br>[<br>  {<br>    "name": "example.com",<br>    "ttl": 1800,<br>    "zone_file": "$ORIGIN example.com.\n$TTL 1800\nexample.com. IN SOA ns1.digitalocean.com. hostmaster.example.com 1657981824 10800 3600 604800 1800\ntest.example.com. 300 IN A 1.2.3.4\nexample.com. 1800 IN NS ns1.digitalocean.com.\nexample.com. 1800 IN NS ns2.digitalocean.com.\nexample.com. 1800 IN NS ns3.digitalocean.com."<br>  }<br>]<br>``` |
...
| `msg`<br>str | always | Domain result information.<br>Sample:<br>```json<br>[<br>  "Current domains",<br>  "No domains"<br>]<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/domains_info/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/domains_info/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/domains_info/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/domains_info/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/domains_info/#return-values)
