---
url: "https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/"
title: "How to Monitor Caching Database Performance | DigitalOcean Documentation"
---
...
For more information on cluster metrics, see our [how-to on monitoring cluster performance](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-clusters/).
...
- [View Caching Metrics](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#view-caching-metrics)
- [Caching Metrics Details](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#caching-metrics-details)
  - [Connection Status](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#connection-status)
  - [Connected Clients](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#connected-clients)
  - [Throughput](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#throughput)
  - [Key Evictions](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#key-evictions)
  - [Memory Fragmentation](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#memory-fragmentation)
  - [Cache Hit Ratio](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#cache-hit-ratio)
  - [Replication Status](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#replication-status)
- [Access the Metrics Endpoint](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#access-the-metrics-endpoint)
  - [Get Hostname and Credentials](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#get-hostname-and-credentials)
  - [Access with cURL](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#access-with-curl)
  - [Access with Prometheus](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#access-with-prometheus)
  - [Additional Resources](https://docs.digitalocean.com/products/databases/redis/how-to/monitor-databases/#additional-resources)
