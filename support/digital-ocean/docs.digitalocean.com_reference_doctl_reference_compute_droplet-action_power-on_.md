---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-on/"
title: "doctl compute droplet-action power-on | DigitalOcean Documentation"
---
...
# doctl compute droplet-action power-on
...
```shell
doctl compute droplet-action power-on <droplet-id> [flags]
```

## Description

Powers on a Droplet. This is similar to pressing the power button on a physical machine.

## Example

The following example powers on a Droplet with the ID `386734086`:

```shell
doctl compute droplet-action power-on 386734086
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-on/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-on/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-on/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-on/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-on/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-action/power-on/#global-flags)
