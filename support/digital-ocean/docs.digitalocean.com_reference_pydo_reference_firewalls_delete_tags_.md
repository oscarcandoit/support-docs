---
url: "https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_tags/"
title: "pydo.firewalls.delete_tags() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/firewalls_delete_tags) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_tags/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_tags/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_tags/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/firewalls/delete_tags/#more-information)
