---
url: "https://docs.digitalocean.com/reference/pydo/reference/vpcs/patch/"
title: "pydo.vpcs.patch() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/vpcs_patch) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/vpcs/patch/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/vpcs/patch/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/vpcs/patch/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/vpcs/patch/#more-information)
