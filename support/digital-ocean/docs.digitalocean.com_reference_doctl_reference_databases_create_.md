---
url: "https://docs.digitalocean.com/reference/doctl/reference/databases/create/"
title: "doctl databases create | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--engine` | The database’s engine. Possible values are: `pg`, `mysql`, `redis`, `valkey`, `mongodb`, `kafka` and `opensearch`.<br>Default: `pg` |
| `--help`, `-h` | Help for this command |
| `--num-nodes` | The number of nodes in the database cluster. Valid values are 1-3. In addition to the primary node, up to two standby nodes may be added for high availability.<br>Default: `1` |
...
| `--region` | The data center region where the database cluster resides, such as `nyc1` or `sfo2`.<br>Default: `nyc1` |
...
| `--size` | The size of the nodes in the database cluster, for example `db-s-1vcpu-1gb` indicates a 1 CPU, 1GB node. For a list of available size slugs, visit: [https://docs.digitalocean.com/reference/api/api-reference/#tag/Databases](https://docs.digitalocean.com/reference/api/api-reference/#tag/Databases)<br>Default: `db-s-1vcpu-1gb` |
| `--storage-size-mib` | The amount of disk space allocated to the cluster. Applicable for PostgreSQL and MySQL clusters. Each plan size has a default value but can be increased in increments up to a maximum amount. For ranges, visit: [https://www.digitalocean.com/pricing/managed-databases](https://www.digitalocean.com/pricing/managed-databases)<br>Default: `0` |
...
| `--wait` | A boolean value that specifies whether to wait for the database cluster to be provisioned before returning control to the terminal.<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/databases/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/databases/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/create/#global-flags)
