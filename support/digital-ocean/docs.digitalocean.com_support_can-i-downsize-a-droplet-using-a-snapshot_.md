---
url: "https://docs.digitalocean.com/support/can-i-downsize-a-droplet-using-a-snapshot/"
title: "Can I downsize a Droplet using a snapshot? | DigitalOcean Documentation"
---
...
A workaround to this is to create a smaller Droplet and then transfer your data over the new Droplet using `rsync` or a similar tool. Review our [Community data migration guide](https://www.digitalocean.com/community/tutorial_series/how-to-migrate-to-a-new-linux-server) for more details on how to do this.
...
[Can I downsize a Droplet using a snapshot?](https://docs.digitalocean.com/support/can-i-downsize-a-droplet-using-a-snapshot/)
