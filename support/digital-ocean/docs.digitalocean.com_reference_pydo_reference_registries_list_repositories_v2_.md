---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/list_repositories_v2/"
title: "pydo.registries.list_repositories_v2() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [registries](https://docs.digitalocean.com/reference/pydo/reference/registries/)
- list\_repositories\_v2()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.registries.list\_repositories\_v2()
...
| `page` | integer | False | Which ‘page’ of paginated results to return. Ignored when ‘page\_token’ is provided. | 1 |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_list_repositoriesV2) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/list_repositories_v2/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/registries/list_repositories_v2/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/list_repositories_v2/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/list_repositories_v2/#more-information)
