---
url: "https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/update/"
title: "pydo.autoscalepools.update() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/autoscalepools_update) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/update/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/update/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/update/#more-information)
