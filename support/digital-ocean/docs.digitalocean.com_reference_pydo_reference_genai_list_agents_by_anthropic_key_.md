---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_anthropic_key/"
title: "pydo.genai.list_agents_by_anthropic_key() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [genai](https://docs.digitalocean.com/reference/pydo/reference/genai/)
- list\_agents\_by\_anthropic\_key()
...
| --- | --- | --- | --- | --- |
| `uuid` | string | True | Unique ID of Anthropic key |  |
| `page` | integer | False | Page number. |  |
| `per_page` | integer | False | Items per page. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_agents_by_anthropic_key) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_anthropic_key/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_anthropic_key/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_anthropic_key/#more-information)
