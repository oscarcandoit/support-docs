---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-tag/"
title: "doctl registry repository delete-tag | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/doctl.8752eb00eab1370da259c7536b272e156687733b207709b145ac9725f986eda0.svg)doctl CLI](https://docs.digitalocean.com/reference/doctl/)
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl registry](https://docs.digitalocean.com/reference/doctl/reference/registry/)
      - [create](https://docs.digitalocean.com/reference/doctl/reference/registry/create/)
      - [delete](https://docs.digitalocean.com/reference/doctl/reference/registry/delete/)
      - [docker-config](https://docs.digitalocean.com/reference/doctl/reference/registry/docker-config/)
      - [garbage-collection](https://docs.digitalocean.com/reference/doctl/reference/registry/garbage-collection/)
      - [get](https://docs.digitalocean.com/reference/doctl/reference/registry/get/)
      - [kubernetes-manifest](https://docs.digitalocean.com/reference/doctl/reference/registry/kubernetes-manifest/)
      - [login](https://docs.digitalocean.com/reference/doctl/reference/registry/login/)
      - [logout](https://docs.digitalocean.com/reference/doctl/reference/registry/logout/)
      - [options](https://docs.digitalocean.com/reference/doctl/reference/registry/options/)
      - [repository](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/)
        - [delete-manifest](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-manifest/)
        - [delete-tag](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-tag/)
        - [list-manifests](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/list-manifests/)
        - [list-tags](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/list-tags/)
        - [list-v2](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/list-v2/)
...
```shell
doctl registry repository delete-tag <repository> <tag>... [flags]
```
...
Permanently deletes one or more repository tags.

## Example

The following example deletes a tag named `web` from a repository named `example-repository` in a registry named `example-registry`:

```shell
doctl registry repository delete-tag example-repository web
```
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Delete tag without confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-tag/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-tag/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-tag/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-tag/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-tag/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-tag/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-tag/#global-flags)
