---
url: "https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/"
title: "up | DigitalOcean Documentation"
---
...
- [Flags](https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/#flags)
  - [–config, -c (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/#config--c-string-optional)
  - [–project-id, -p (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/#project-id--p-string-optional)
  - [–cwd (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/#cwd-string-optional)
- [Global Flags](https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/#global-flags)
  - [–log-level, -l (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/#log-level--l-string-optional)
  - [–json, -j (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/#json--j-boolean-optional)
  - [–api-key (string, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/#api-key-string-optional)
  - [–help, -h (boolean, optional)](https://docs.digitalocean.com/reference/paperspace/pspace/commands/up/#help--h-boolean-optional)
