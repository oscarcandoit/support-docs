---
url: "https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket/"
title: "digitalocean_spaces_bucket | DigitalOcean Documentation"
---
...
- [Example Usage](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket/#example-usage)
  - [Create a New Bucket](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket/#create-a-new-bucket)
  - [Create a New Bucket With CORS Rules](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket/#create-a-new-bucket-with-cors-rules)
- [Argument Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket/#argument-reference)
- [Attributes Reference](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket/#attributes-reference)
- [Import](https://docs.digitalocean.com/reference/terraform/reference/resources/spaces_bucket/#import)
