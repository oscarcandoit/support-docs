---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/"
title: "pydo.droplets | DigitalOcean Documentation"
---
...
By sending requests to the Droplet endpoint, you can
...
pydo.droplets.destroy\_by\_tag()
...
pydo.droplets.get\_backup\_policy()
...
pydo.droplets.list\_associated\_resources()

List Associated Resources for a Droplet

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.droplets.list\_backup\_policies()

List Backup Policies for All Existing Droplets

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.droplets.list\_backups()

List Backups for a Droplet

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.droplets.list\_firewalls()

List all Firewalls Applied to a Droplet

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.droplets.list\_kernels()

List All Available Kernels for a Droplet

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.droplets.list\_neighbors\_ids()

List All Droplet Neighbors

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.droplets.list\_neighbors()

List Neighbors for a Droplet

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.droplets.list\_snapshots()

List Snapshots for a Droplet

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.droplets.list\_supported\_backup\_policies()
...
[pydo.droplets](https://docs.digitalocean.com/reference/pydo/reference/droplets/)
