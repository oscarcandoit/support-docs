---
url: "https://docs.digitalocean.com/reference/pydo/reference/uptime/create_check/"
title: "pydo.uptime.create_check() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/uptime_create_check) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/uptime/create_check/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/uptime/create_check/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/uptime/create_check/#more-information)
