---
url: "https://docs.digitalocean.com/reference/pydo/reference/apps/"
title: "pydo.apps | DigitalOcean Documentation"
---
...
pydo.apps.assign\_alert\_destinations()

Update destinations for alerts

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.cancel\_deployment()

Cancel a Deployment

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.commit\_rollback()

Commit App Rollback

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.create\_deployment()

Create an App Deployment

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.create\_rollback()
...
pydo.apps.get\_deployment()

Retrieve an App Deployment

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.get\_exec\_active\_deployment()
...
pydo.apps.get\_health()

Retrieve App Health

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.get\_instance\_size()

Retrieve an Instance Size

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.get\_instances()

Retrieve App Instances

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.get\_job\_invocation\_logs()

Retrieve Job Invocation Logs

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.get\_job\_invocation()
...
pydo.apps.get\_metrics\_bandwidth\_daily()
...
pydo.apps.list\_instance\_sizes()

List Instance Sizes

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.list\_job\_invocations()

List Job Invocations

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.list\_metrics\_bandwidth\_daily()

Retrieve Multiple Apps’ Daily Bandwidth Metrics

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.list\_regions()
...
pydo.apps.validate\_app\_spec()

Propose an App Spec

![](https://docs.digitalocean.com/images/icons/python.svg)

pydo.apps.validate\_rollback()

Validate App Rollback

In this article...

[pydo.apps](https://docs.digitalocean.com/reference/pydo/reference/apps/)
