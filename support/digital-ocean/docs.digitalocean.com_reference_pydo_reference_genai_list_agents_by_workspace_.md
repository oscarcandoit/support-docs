---
url: "https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_workspace/"
title: "pydo.genai.list_agents_by_workspace() | DigitalOcean Documentation"
---
...
| `only_deployed` | boolean | False | Only list agents that are deployed. |  |
| `page` | integer | False | Page number. |  |
| `per_page` | integer | False | Items per page. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/genai_list_agents_by_workspace) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_workspace/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_workspace/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/genai/list_agents_by_workspace/#more-information)
