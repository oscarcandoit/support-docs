---
url: "https://docs.digitalocean.com/support/how-do-i-fix-the-invalid-password-error-when-connecting-to-redis/"
title: "How do I fix the \"Invalid Password\" error when connecting to Redis? | DigitalOcean Documentation"
---
...
If you are getting this error, verify that you are using the correct password. To better review changes, we recommend the flags format to modify the connection string. For more on the flags format, see [How to Connect to Redis](https://docs.digitalocean.com/products/databases/redis/how-to/connect/), and [MongoDB](https://docs.digitalocean.com/products/databases/mongodb/how-to/connect/).
...
[How do I fix the "Invalid Password" error when connecting to Redis?](https://docs.digitalocean.com/support/how-do-i-fix-the-invalid-password-error-when-connecting-to-redis/)
