---
url: "https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-manifest/"
title: "doctl registry repository delete-manifest | DigitalOcean Documentation"
---
...
| Option | Description |
| --- | --- |
| `--force`, `-f` | Deletes manifest without confirmation prompt<br>Default: `false` |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-manifest/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-manifest/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-manifest/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-manifest/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-manifest/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-manifest/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/registry/repository/delete-manifest/#global-flags)
