---
url: "https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/"
title: "JAX 0.4.35 | DigitalOcean Documentation"
---
...
- [Catalog](https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/)
...
from [the JAX 0.4.35 catalog page](https://marketplace.digitalocean.com/apps/jax-0-4-35)
...
| ROCm (in Docker image) | 6.4.2 | [LICENSE](https://rocm.docs.amd.com/en/latest/about/license.html) |
| JupyterLab (in Docker image) | 4.4.2 | [LICENSE](https://jupyter.org/governance/projectlicense.html) |
| JAX | 0.4.35 | [LICENSE](https://github.com/jax-ml/jax/blob/main/LICENSE) |

## Creating an App using the Control Panel

Click the **Deploy to DigitalOcean** button to create a Droplet based on this 1-Click App. If you aren’t logged in, this link will prompt you to log in with your DigitalOcean account.

[![Deploy to DO](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/droplets/new?image=amd-jax0435)

## Creating an App using the API

In addition to creating a Droplet from the JAX 0.4.35 1-Click App using the control panel, you can also use the [DigitalOcean API](https://docs.digitalocean.com/reference/api). As an example, to create a 4GB JAX 0.4.35 Droplet in the SFO2 region, you can use the following `curl` command. You need to either save your [API access token](https://docs.digitalocean.com/reference/api/create-personal-access-token/) to an environment variable or substitute it in the command below.

```shell
curl -X POST -H 'Content-Type: application/json' \
         -H 'Authorization: Bearer '$TOKEN'' -d \
        '{"name":"choose_a_name","region":"sfo2","size":"s-2vcpu-4gb","image":"amd-jax0435"}' \
        "https://api.digitalocean.com/v2/droplets"
```

## Getting Started After Deploying JAX 0.4.35

## Accessing JAX + ROCm resources and libraries

There are two ways to utilise JAX + ROCm resources and libraries: directly from JupyterLab, or via a Docker container.
...
Done! You can now freely implement any project that requires JAX + ROCm libraries.

In this article...

- [Software Included](https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/#software-included)
- [Creating an App using the Control Panel](https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/#creating-an-app-using-the-control-panel)
- [Creating an App using the API](https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/#creating-an-app-using-the-api)
- [Getting Started After Deploying JAX 0.4.35](https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/#getting-started-after-deploying-jax-0435)
- [Accessing JAX + ROCm resources and libraries](https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/#accessing-jax--rocm-resources-and-libraries)
- [SSHing into your AMD 1-Click](https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/#sshing-into-your-amd-1-click)
- [Exploring via Jupyter](https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/#exploring-via-jupyter)
- [Exploring via Docker](https://docs.digitalocean.com/products/marketplace/catalog/jax-0-4-35/#exploring-via-docker)
