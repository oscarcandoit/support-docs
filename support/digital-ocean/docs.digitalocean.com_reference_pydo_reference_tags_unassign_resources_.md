---
url: "https://docs.digitalocean.com/reference/pydo/reference/tags/unassign_resources/"
title: "pydo.tags.unassign_resources() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [tags](https://docs.digitalocean.com/reference/pydo/reference/tags/)
      - [assign\_resources()](https://docs.digitalocean.com/reference/pydo/reference/tags/assign_resources/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/tags/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/tags/delete/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/tags/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/tags/list/)
      - [unassign\_resources()](https://docs.digitalocean.com/reference/pydo/reference/tags/unassign_resources/)
...
| --- | --- | --- | --- | --- |
| `tag_id` | string | True | The name of the tag. Tags may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per tag. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/tags_unassign_resources) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/tags/unassign_resources/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/tags/unassign_resources/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/tags/unassign_resources/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/tags/unassign_resources/#more-information)
