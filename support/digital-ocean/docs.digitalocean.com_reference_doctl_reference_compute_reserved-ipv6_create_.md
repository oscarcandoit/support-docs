---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/create/"
title: "doctl compute reserved-ipv6 create | DigitalOcean Documentation"
---
...
Creates a new reserved IPv6 address.
Reserved IPv6 addresses can be held in the region they were created in on your account.
...
| `--region` | The region where to create the reserved IPv6 address. |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/reserved-ipv6/create/#global-flags)
