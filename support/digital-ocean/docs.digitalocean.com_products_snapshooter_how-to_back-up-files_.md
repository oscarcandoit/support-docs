---
url: "https://docs.digitalocean.com/products/snapshooter/how-to/back-up-files/"
title: "How to Back Up Files with SnapShooter | DigitalOcean Documentation"
---
...
Optionally, on the **Configure Backup** page, in the **Scripts** section, you can add any [pre- or post-backup scripts](https://docs.digitalocean.com/products/snapshooter/how-to/add-pre-and-post-backup-scripts/).
...
- [Connect a Server and Storage Provider](https://docs.digitalocean.com/products/snapshooter/how-to/back-up-files/#connect-a-server-and-storage-provider)
- [Create the Backup Job](https://docs.digitalocean.com/products/snapshooter/how-to/back-up-files/#create-the-backup-job)
