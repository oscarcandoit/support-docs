...
title: "doctl databases | DigitalOcean Documentation"
---
...
The commands under `doctl databases` are for managing your MySQL, Redis, Valkey, PostgreSQL, MongoDB, Kafka and Opensearch database services.
...
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/databases/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/databases/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/databases/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/databases/#global-flags)
