---
url: "https://docs.digitalocean.com/reference/pydo/reference/one_clicks/install_kubernetes/"
title: "pydo.one_clicks.install_kubernetes() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [one\_clicks](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/)
      - [install\_kubernetes()](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/install_kubernetes/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/list/)
...
# pydo.one\_clicks.install\_kubernetes()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/oneClicks_install_kubernetes) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/install_kubernetes/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/install_kubernetes/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/one_clicks/install_kubernetes/#more-information)
