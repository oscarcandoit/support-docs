---
url: "https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_key/"
...
Create or delete SSH keys. View the create API documentation at [https://docs.digitalocean.com/reference/api/api-reference/#tag/SSH-Keys](https://docs.digitalocean.com/reference/api/api-reference/#tag/SSH-Keys).
...
| `name`<br>str / **required** |  | A human-readable display name for this key, used to easily identify the SSH keys when they are displayed. |
| `public_key`<br>str / **required** |  | The entire public key string that was uploaded. Embedded into the root user’s authorized\_keys file if you include this key during Droplet creation. |
...
| `msg`<br>str | always | Droplet result information.<br>Sample:<br>```json<br>[<br>  "Created SSH key My SSH Public Key (3b:16:bf:e4:8b:00:8b:b8:59:8c:a9:d3:f0:19:45:fa)",<br>  "Deleted SSH key My SSH Public Key (3b:16:bf:e4:8b:00:8b:b8:59:8c:a9:d3:f0:19:45:fa)",<br>  "SSH key My SSH Public Key would be created",<br>  "SSH key My SSH Public Key (3b:16:bf:e4:8b:00:8b:b8:59:8c:a9:d3:f0:19:45:fa) exists",<br>  "SSH key My SSH Public Key does not exist",<br>  "SSH key My SSH Public Key (3b:16:bf:e4:8b:00:8b:b8:59:8c:a9:d3:f0:19:45:fa) would be deleted"<br>]<br>``` |
| `ssh_key`<br>dict | always | SSH key information.<br>Sample:<br>```json<br>{<br>  "fingerprint": "3b:16:bf:e4:8b:00:8b:b8:59:8c:a9:d3:f0:19:45:fa",<br>  "id": 512189,<br>  "name": "My SSH Public Key",<br>  "public_key": "ssh-rsa AEXAMPLEaC1yc2EAAAADAQABAAAAQQDDHr/jh2Jy4yALcK4JyWbVkPRaWmhck3IgCoeOO3z1e2dBowLh64QAM+Qb72pxekALga2oi4GvT+TlWNhzPH4V example"<br>}<br>``` |

In this article...

- [Synopsis](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_key/#synopsis)
- [Requirements](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_key/#requirements)
- [Parameters](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_key/#parameters)
- [Examples](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_key/#examples)
- [Return Values](https://docs.digitalocean.com/reference/ansible/reference/modules/ssh_key/#return-values)
