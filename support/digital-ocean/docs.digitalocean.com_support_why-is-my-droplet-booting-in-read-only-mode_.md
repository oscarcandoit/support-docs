---
url: "https://docs.digitalocean.com/support/why-is-my-droplet-booting-in-read-only-mode/"
title: "Why is my Droplet booting in Read Only mode? | DigitalOcean Documentation"
---
...
There are many possible causes for this problem, including file system corruption. If you suspect file system corruption, you can run a [File System Check (FSCK) and attempt to recover the files](https://www.digitalocean.com/community/tutorials/how-to-recover-from-file-system-corruption-using-fsck-and-a-recovery-iso).
...
[Why is my Droplet booting in Read Only mode?](https://docs.digitalocean.com/support/why-is-my-droplet-booting-in-read-only-mode/)
