---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/get/"
title: "doctl compute volume-action get | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [volume-action](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/)
        - [attach](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/attach/)
        - [detach](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach/)
        - [detach-by-droplet-id](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/detach-by-droplet-id/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/list/)
        - [resize](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/resize/)
...
# doctl compute volume-action get
...
```shell
doctl compute volume-action get <volume-id> [flags]
```

## Description

Retrieves the status of a volume action, including the following details:
...
The following example retrieves the status of an action taken on a volume with the UUID `f81d4fae-7dec-11d0-a765-00a0c91e6bf6`:

```shell
doctl compute volume-action get f81d4fae-7dec-11d0-a765-00a0c91e6bf6 --action-id 191669331
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/get/#usage)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/get/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/get/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/get/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/get/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/volume-action/get/#global-flags)
