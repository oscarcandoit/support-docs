---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/delete_user/"
title: "pydo.databases.delete_user() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_delete_user) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_user/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_user/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_user/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_user/#more-information)
