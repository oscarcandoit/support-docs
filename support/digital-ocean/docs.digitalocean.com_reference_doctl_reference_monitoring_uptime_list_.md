---
url: "https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/list/"
title: "doctl monitoring uptime list | DigitalOcean Documentation"
---
...
```shell
doctl monitoring uptime list [flags]
```
...
Retrieves a list of all of the uptime checks on your account.

## Example

The following example retrieves a list of all of the uptime checks on your account and uses the `--format` flag to return only the ID, name, and target of each check:

```shell
doctl monitoring uptime list --format ID,Name,Target
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/list/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/list/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/list/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/list/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/list/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/list/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/monitoring/uptime/list/#global-flags)
