---
url: "https://docs.digitalocean.com/reference/doctl/reference/apps/list-deployments/"
title: "doctl apps list-deployments | DigitalOcean Documentation"
---
...
```shell
doctl apps list-deployments <app id> [flags]
```
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/apps/list-deployments/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/apps/list-deployments/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/apps/list-deployments/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list-deployments/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/apps/list-deployments/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/apps/list-deployments/#global-flags)
