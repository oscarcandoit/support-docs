...
title: "Why is my app not resolving .gov domains? | DigitalOcean Documentation"
---
...
We recommend using a custom DNS resolver only to query the `.gov` sites that have resolution issues. Setting the custom resolver as the default resolver for your app can cause connection issues to [DigitalOcean Managed Databases](https://docs.digitalocean.com/products/databases/) connected to the app.
...
[Why is my app not resolving .gov domains?](https://docs.digitalocean.com/support/why-is-my-app-not-resolving-.gov-domains/)
