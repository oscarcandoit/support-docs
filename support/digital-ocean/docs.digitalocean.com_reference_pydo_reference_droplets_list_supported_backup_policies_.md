---
url: "https://docs.digitalocean.com/reference/pydo/reference/droplets/list_supported_backup_policies/"
title: "pydo.droplets.list_supported_backup_policies() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [droplets](https://docs.digitalocean.com/reference/pydo/reference/droplets/)
- list\_supported\_backup\_policies()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/droplets_list_supported_backup_policies) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_supported_backup_policies/#description)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_supported_backup_policies/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/droplets/list_supported_backup_policies/#more-information)
