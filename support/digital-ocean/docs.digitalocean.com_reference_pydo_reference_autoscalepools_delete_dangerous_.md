---
url: "https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/delete_dangerous/"
title: "pydo.autoscalepools.delete_dangerous() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [autoscalepools](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/create/)
      - [delete()](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/delete/)
      - [delete\_dangerous()](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/delete_dangerous/)
      - [get()](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/get/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list/)
      - [list\_history()](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list_history/)
      - [list\_members()](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/list_members/)
      - [update()](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/update/)
...
# pydo.autoscalepools.delete\_dangerous()
...
| --- | --- | --- | --- | --- |
| `autoscale_pool_id` | string | True | A unique identifier for an autoscale pool. |  |
| `X-Dangerous` | boolean | True | Acknowledge this action will destroy the autoscale pool and its associated resources and _can not_ be reversed. |  |

## More Information

See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/autoscalepools_delete_dangerous) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/delete_dangerous/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/delete_dangerous/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/autoscalepools/delete_dangerous/#more-information)
