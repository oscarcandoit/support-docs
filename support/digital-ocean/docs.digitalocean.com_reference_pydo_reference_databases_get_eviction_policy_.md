---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/get_eviction_policy/"
title: "pydo.databases.get_eviction_policy() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- get\_eviction\_policy()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.get\_eviction\_policy()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_get_evictionPolicy) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/get_eviction_policy/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/get_eviction_policy/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/databases/get_eviction_policy/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/get_eviction_policy/#more-information)
