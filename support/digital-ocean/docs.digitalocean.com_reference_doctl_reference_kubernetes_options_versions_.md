---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/versions/"
title: "doctl kubernetes options versions | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl kubernetes](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/)
      ...
      - [options](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/)
        - [regions](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/regions/)
        - [sizes](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/sizes/)
        - [versions](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/versions/)
...
```shell
doctl kubernetes options versions [flags]
```
...
Lists Kubernetes versions that you can use with DigitalOcean clusters
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/versions/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/versions/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/versions/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/versions/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/versions/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/options/versions/#global-flags)
