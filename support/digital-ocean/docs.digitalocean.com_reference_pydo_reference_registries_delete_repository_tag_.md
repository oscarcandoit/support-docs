---
url: "https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_tag/"
title: "pydo.registries.delete_repository_tag() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [registries](https://docs.digitalocean.com/reference/pydo/reference/registries/)
- delete\_repository\_tag()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.registries.delete\_repository\_tag()
...
| `repository_tag` | string | True | The name of a container registry repository tag. |  |
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/registries_delete_repositoryTag) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_tag/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_tag/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_tag/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/registries/delete_repository_tag/#more-information)
