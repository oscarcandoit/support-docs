---
url: "https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/delete_by_id/"
title: "pydo.volume_snapshots.delete_by_id() | DigitalOcean Documentation"
---
...
- [![](https://docs.digitalocean.com/images/icons/python.ccad6ea84a17bb64de581eba7a7efe96ff4b80b41bdf53a90a4819ba20e0dcaa.svg)PyDo](https://docs.digitalocean.com/reference/pydo/)
  - [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
    ...
    - [volume\_snapshots](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/)
      - [create()](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/create/)
      - [delete\_by\_id()](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/delete_by_id/)
      - [get\_by\_id()](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/get_by_id/)
      - [list()](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/list/)
...
# pydo.volume\_snapshots.delete\_by\_id()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/volumeSnapshots_delete_byId) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/delete_by_id/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/delete_by_id/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/delete_by_id/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/volume_snapshots/delete_by_id/#more-information)
