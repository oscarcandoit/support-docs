---
url: "https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/update/"
title: "doctl compute droplet-autoscale update | DigitalOcean Documentation"
---
  ...
  - [Command Reference](https://docs.digitalocean.com/reference/doctl/reference/)
    ...
    - [doctl compute](https://docs.digitalocean.com/reference/doctl/reference/compute/)
      ...
      - [droplet-autoscale](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/)
        - [create](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/create/)
        - [delete](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete/)
        - [delete-dangerous](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/delete-dangerous/)
        - [get](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/get/)
        - [list](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list/)
        - [list-history](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-history/)
        - [list-members](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/list-members/)
        - [update](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/update/)
...
# doctl compute droplet-autoscale update
...
```shell
doctl compute droplet-autoscale update <autoscale-pool-id> [flags]
```
...
| Option | Description |
| --- | --- |
| `--cooldown-minutes` | Cooldown duration<br>Default: `0` |
| `--cpu-target` | CPU target threshold |
| `--droplet-agent` | Enable droplet agent<br>Default: `true` |
| `--enable-ipv6` | Enable droplet IPv6<br>Default: `true` |
| `--format` | Columns for output in a comma-separated list. Possible values: `ID`, `Name`, `Region`, `Status`, `Min Instance`, `Max Instance`, `Target Instance`, `Avg CPU Util`, `Avg Mem Util`, `Target CPU Util`, `Target Mem Util`. |
| `--help`, `-h` | Help for this command |
| `--image` | Droplet image |
| `--max-instances` | Max number of members<br>Default: `0` |
| `--mem-target` | Memory target threshold |
| `--min-instances` | Min number of members<br>Default: `0` |
| `--name` | Name of the Droplet autoscale pool (required) |
| `--no-header` | Return raw data with no headers<br>Default: `false` |
| `--project-id` | Droplet project ID |
| `--region` | Droplet region |
| `--size` | Droplet size |
| `--ssh-keys` | Droplet SSH keys |
| `--tag` | Droplet tags |
| `--target-instances` | Target number of members<br>Default: `0` |
| `--user-data` | Droplet user data |
| `--vpc-uuid` | Droplet VPC UUID |
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/update/#usage)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/update/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/update/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/compute/droplet-autoscale/update/#global-flags)
