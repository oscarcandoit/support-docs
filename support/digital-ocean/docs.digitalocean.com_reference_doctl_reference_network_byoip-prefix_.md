---
url: "https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/"
title: "doctl network byoip-prefix | DigitalOcean Documentation"
---
...
The sub-commands of `doctl network byoip-prefix` manage Bring-Your-Own-IP (BYOIP) refixes. BYOIP Prefixes can be created and the IP addresses under that prefix can be used to assign to resources. BYOIP Prefixes are bound to the regions they are created in.
...
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/#description)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/network/byoip-prefix/#global-flags)
