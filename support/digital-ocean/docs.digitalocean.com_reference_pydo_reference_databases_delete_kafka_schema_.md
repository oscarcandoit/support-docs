---
url: "https://docs.digitalocean.com/reference/pydo/reference/databases/delete_kafka_schema/"
title: "pydo.databases.delete_kafka_schema() | DigitalOcean Documentation"
---
...
- [Library Reference](https://docs.digitalocean.com/reference/pydo/reference/)
- [databases](https://docs.digitalocean.com/reference/pydo/reference/databases/)
- delete\_kafka\_schema()

[Give Feedback](https://ideas.digitalocean.com/documentation)

# pydo.databases.delete\_kafka\_schema()
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/databases_delete_kafka_schema) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_kafka_schema/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_kafka_schema/#parameters)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/databases/delete_kafka_schema/#more-information)
