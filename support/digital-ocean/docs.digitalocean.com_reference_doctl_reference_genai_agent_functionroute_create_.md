---
url: "https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/create/"
title: "doctl genai agent functionroute create | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/create/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/create/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/create/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/create/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/create/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/create/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/genai/agent/functionroute/create/#global-flags)
