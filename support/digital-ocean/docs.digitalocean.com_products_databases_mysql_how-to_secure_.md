---
url: "https://docs.digitalocean.com/products/databases/mysql/how-to/secure/"
title: "How to Secure MySQL Managed Database Clusters | DigitalOcean Documentation"
---
...
- [Restrict Incoming Connections](https://docs.digitalocean.com/products/databases/mysql/how-to/secure/#firewalls)
- [Add a Trusted Source Using the CLI](https://docs.digitalocean.com/products/databases/mysql/how-to/secure/#add-a-trusted-source-using-the-cli)
- [Add a Trusted Source Using the API](https://docs.digitalocean.com/products/databases/mysql/how-to/secure/#add-a-trusted-source-using-the-api)
- [Add a Trusted Source using the Control Panel](https://docs.digitalocean.com/products/databases/mysql/how-to/secure/#add-a-trusted-source-using-the-control-panel)
- [Use Encrypted Connections](https://docs.digitalocean.com/products/databases/mysql/how-to/secure/#use-encrypted-connections)
