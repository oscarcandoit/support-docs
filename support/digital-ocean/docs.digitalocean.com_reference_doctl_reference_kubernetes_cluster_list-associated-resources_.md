---
url: "https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/list-associated-resources/"
title: "doctl kubernetes cluster list-associated-resources | DigitalOcean Documentation"
---
...
- [Usage](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/list-associated-resources/#usage)
- [Aliases](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/list-associated-resources/#aliases)
- [Description](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/list-associated-resources/#description)
- [Example](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/list-associated-resources/#example)
- [Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/list-associated-resources/#flags)
- [Related Commands](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/list-associated-resources/#related-commands)
- [Global Flags](https://docs.digitalocean.com/reference/doctl/reference/kubernetes/cluster/list-associated-resources/#global-flags)
