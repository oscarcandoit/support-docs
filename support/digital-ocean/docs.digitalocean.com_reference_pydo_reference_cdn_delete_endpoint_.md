---
url: "https://docs.digitalocean.com/reference/pydo/reference/cdn/delete_endpoint/"
title: "pydo.cdn.delete_endpoint() | DigitalOcean Documentation"
---
...
See [the API spec for this endpoint](https://docs.digitalocean.com/reference/api/digitalocean/#operation/cdn_delete_endpoint) to view additional detail on responses, headers, parameters, and more.

In this article...

- [Description](https://docs.digitalocean.com/reference/pydo/reference/cdn/delete_endpoint/#description)
- [Parameters](https://docs.digitalocean.com/reference/pydo/reference/cdn/delete_endpoint/#parameters)
- [Request Sample](https://docs.digitalocean.com/reference/pydo/reference/cdn/delete_endpoint/#request-sample)
- [More Information](https://docs.digitalocean.com/reference/pydo/reference/cdn/delete_endpoint/#more-information)
