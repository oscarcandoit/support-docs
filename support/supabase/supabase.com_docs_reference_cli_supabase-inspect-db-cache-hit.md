---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-cache-hit"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-cache-hit\#additional-links)
