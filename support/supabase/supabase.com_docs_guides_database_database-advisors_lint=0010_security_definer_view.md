---
url: "https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view"
...
## Using the Advisors [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view\#using-the-advisors)
...
## Available checks [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view\#available-checks)
...
### Rationale [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view\#rationale)
...
### Understanding SECURITY DEFINER and SECURITY INVOKER [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view\#understanding-security-definer-and-security-invoker)
...
### The Risk of SECURITY DEFINER Views in Public Schema [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view\#the-risk-of-security-definer-views-in-public-schema)
...
### How to Resolve [\#](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view\#how-to-resolve)
...
create view public.order_items    asselect    id,    ...from    app.order_items;
```
...
create view public.order_items    with (security_invoker=on)    asselect    id,    ...from    app.order_items;
```
...
[Using the Advisors](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view#using-the-advisors) [Available checks](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view#available-checks) [Rationale](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view#rationale) [Understanding SECURITY DEFINER and SECURITY INVOKER](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view#understanding-security-definer-and-security-invoker) [The Risk of SECURITY DEFINER Views in Public Schema](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view#the-risk-of-security-definer-views-in-public-schema) [How to Resolve](https://supabase.com/docs/guides/database/database-advisors?lint=0010_security_definer_view#how-to-resolve)
