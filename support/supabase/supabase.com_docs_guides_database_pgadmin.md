...
title: "Connecting with pgAdmin | Supabase Docs"
---
...
## What is pgAdmin? [\#](https://supabase.com/docs/guides/database/pgadmin\#what-is-pgadmin)
...
## Connecting pgAdmin with your Postgres database [\#](https://supabase.com/docs/guides/database/pgadmin\#connecting-pgadmin-with-your-postgres-database)
...
![Register a new postgres server.](https://supabase.com/docs/_next/image?url=%2Fdocs%2Fimg%2Fguides%2Fdatabase%2Fconnecting-to-postgres%2Fpgadmin%2Fregister-server-pgAdmin--light.png&w=3840&q=75)
...
## Why connect to pgAdmin [\#](https://supabase.com/docs/guides/database/pgadmin\#why-connect-to-pgadmin)
