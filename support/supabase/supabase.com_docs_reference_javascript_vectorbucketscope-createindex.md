---
url: "https://supabase.com/docs/reference/javascript/vectorbucketscope-createindex"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/vectorbucketscope-createindex\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/vectorbucketscope-createindex\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/vectorbucketscope-createindex\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/vectorbucketscope-createindex\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/vectorbucketscope-createindex\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/vectorbucketscope-createindex\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/vectorbucketscope-createindex\#response-types-for-complex-queries)
