---
url: "https://supabase.com/docs/reference/javascript/vectorindex-putvectors"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/vectorindex-putvectors\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/vectorindex-putvectors\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/vectorindex-putvectors\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/vectorindex-putvectors\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/vectorindex-putvectors\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/vectorindex-putvectors\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/vectorindex-putvectors\#response-types-for-complex-queries)
