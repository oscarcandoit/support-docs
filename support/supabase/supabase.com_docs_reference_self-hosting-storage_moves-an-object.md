...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-storage/moves-an-object\#client-libraries)

- [JavaScript](https://github.com/supabase/storage-js)
- [Dart](https://github.com/supabase/storage-dart)

### Additional links [\#](https://supabase.com/docs/reference/self-hosting-storage/moves-an-object\#additional-links)
