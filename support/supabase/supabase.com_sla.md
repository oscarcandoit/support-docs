...
[![Supabase Logo](https://supabase.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsupabase-logo-wordmark--light.daaeffd3.png&w=256&q=75&dpl=dpl_DQizXvCYRwfpSotqirvmvadxyEJY)![Supabase Logo](https://supabase.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsupabase-logo-wordmark--dark.b36ebb5f.png&w=256&q=75&dpl=dpl_DQizXvCYRwfpSotqirvmvadxyEJY)](https://supabase.com/)
...
[93.5K](https://github.com/supabase/supabase) [Sign in](https://supabase.com/dashboard) [Start your project](https://supabase.com/dashboard)
...
## 1\. Definitions [\#](https://supabase.com/sla\#1-definitions)
...
## 2\. Uptime Commitment [\#](https://supabase.com/sla\#2-uptime-commitment)
...
## 3\. SLA Definition & Exclusions [\#](https://supabase.com/sla\#3-sla-definition--exclusions)
...
### Product-Specific [\#](https://supabase.com/sla\#product-specific)

### Postgres [\#](https://supabase.com/sla\#postgres)
...
### Auth [\#](https://supabase.com/sla\#auth)
...
### Data APIs (PostgREST) [\#](https://supabase.com/sla\#data-apis-postgrest)
...
### Storage [\#](https://supabase.com/sla\#storage)
...
### Pooler (PgBouncer & Supavisor) [\#](https://supabase.com/sla\#pooler-pgbouncer--supavisor)
...
### Management API [\#](https://supabase.com/sla\#management-api)
...
### Branching [\#](https://supabase.com/sla\#branching)
...
### Realtime [\#](https://supabase.com/sla\#realtime)
...
### Functions [\#](https://supabase.com/sla\#functions)
...
### Studio [\#](https://supabase.com/sla\#studio)
...
### Logging [\#](https://supabase.com/sla\#logging)
...
## 4\. Service Credits [\#](https://supabase.com/sla\#4-service-credits)
...
## 5\. Credit Requests and Payment [\#](https://supabase.com/sla\#5-credit-requests-and-payment)

To request a Service Credit, Customer must send an email to Supabase at [support@supabase.io](mailto:support@supabase.io) within thirty (30) days of the end of the month in which the Uptime Commitment was not met. The request must include:
...
### High [\#](https://supabase.com/sla\#high)
...
### Normal [\#](https://supabase.com/sla\#normal)
...
### Low [\#](https://supabase.com/sla\#low)

**Minor Issue / Feature Request**

An Information request about Supabase or feature request.

### Severity and Target Initial Response Times [\#](https://supabase.com/sla\#severity-and-target-initial-response-times)
...
- SOC2 Type 2Certified
- HIPAACompliant

[![Supabase Logo](https://supabase.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsupabase-logo-wordmark--light.daaeffd3.png&w=384&q=75&dpl=dpl_DQizXvCYRwfpSotqirvmvadxyEJY)![Supabase Logo](https://supabase.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsupabase-logo-wordmark--dark.b36ebb5f.png&w=384&q=75&dpl=dpl_DQizXvCYRwfpSotqirvmvadxyEJY)](https://supabase.com/)
...
- [Vibe Coders](https://supabase.com/solutions/vibe-coders)
- [Hackathon Contestants](https://supabase.com/solutions/hackathon)
- [Startups](https://supabase.com/solutions/startups)
- [Agencies](https://supabase.com/solutions/agencies)
- [Enterprise](https://supabase.com/solutions/enterprise)
- [Innovation Teams](https://supabase.com/solutions/innovation-teams)
