...
title: "Login with Twitter | Supabase Docs"
---
...
[Auth](https://supabase.com/docs/guides/auth/social-login/auth-twitter)
...
7. [Twitter](https://supabase.com/docs/guides/auth/social-login/auth-twitter)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/auth/social-login/auth-twitter.mdx)
