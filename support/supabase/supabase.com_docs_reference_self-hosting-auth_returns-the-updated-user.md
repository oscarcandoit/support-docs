---
url: "https://supabase.com/docs/reference/self-hosting-auth/returns-the-updated-user"
...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-auth/returns-the-updated-user\#client-libraries)

- [JavaScript](https://github.com/supabase/gotrue-js)
- [Dart](https://github.com/supabase/gotrue-dart)

### Additional links [\#](https://supabase.com/docs/reference/self-hosting-auth/returns-the-updated-user\#additional-links)
