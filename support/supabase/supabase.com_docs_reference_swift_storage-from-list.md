---
url: "https://supabase.com/docs/reference/swift/storage-from-list"
...
### Install using Swift Package Manager [\#](https://supabase.com/docs/reference/swift/storage-from-list\#install-using-swift-package-manager)
...
### Handling deep links [\#](https://supabase.com/docs/reference/swift/storage-from-list\#handling-deep-links)

#### UIKit app lifecycle [\#](https://supabase.com/docs/reference/swift/storage-from-list\#uikit-app-lifecycle)
...
#### SwiftUI app lifecycle [\#](https://supabase.com/docs/reference/swift/storage-from-list\#swiftui-app-lifecycle)
