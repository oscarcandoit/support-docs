---
url: "https://supabase.com/docs/reference/kotlin/auth-mfa-challengeandverify"
...
Auth
  ...
  - Auth MFA
    ...
    [Auth MFA](https://supabase.com/docs/reference/kotlin/auth-mfa-api) - [Enroll a factor](https://supabase.com/docs/reference/kotlin/auth-mfa-enroll)
...
### Add one or more modules to your project [\#](https://supabase.com/docs/reference/kotlin/auth-mfa-challengeandverify\#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required) [\#](https://supabase.com/docs/reference/kotlin/auth-mfa-challengeandverify\#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization [\#](https://supabase.com/docs/reference/kotlin/auth-mfa-challengeandverify\#serialization)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/auth-mfa-challengeandverify\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/auth-mfa-challengeandverify\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/auth-mfa-challengeandverify\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/auth-mfa-challengeandverify\#pkce-authentication-flow)
