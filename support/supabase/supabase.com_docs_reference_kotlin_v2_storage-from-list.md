---
url: "https://supabase.com/docs/reference/kotlin/v2/storage-from-list"
...
### Add one or more modules to your project [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-list\#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required) [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-list\#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-list\#serialization)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-list\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-list\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-list\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v2/storage-from-list\#pkce-authentication-flow)
