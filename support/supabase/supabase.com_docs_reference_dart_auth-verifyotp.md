---
url: "https://supabase.com/docs/reference/dart/auth-verifyotp"
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/auth-verifyotp\#presence)
