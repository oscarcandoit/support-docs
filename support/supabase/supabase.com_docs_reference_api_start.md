---
url: "https://supabase.com/docs/reference/api/start"
...
## Authentication [\#](https://supabase.com/docs/reference/api/start\#authentication)
...
## Rate limits [\#](https://supabase.com/docs/reference/api/start\#rate-limits)
...
### Standard rate limit [\#](https://supabase.com/docs/reference/api/start\#standard-rate-limit)
...
### Rate limit scope [\#](https://supabase.com/docs/reference/api/start\#rate-limit-scope)
...
### Rate limit response headers [\#](https://supabase.com/docs/reference/api/start\#rate-limit-response-headers)
...
### How rate limits are tracked [\#](https://supabase.com/docs/reference/api/start\#how-rate-limits-are-tracked)
...
### Endpoint exceptions [\#](https://supabase.com/docs/reference/api/start\#endpoint-exceptions)
...
### Best practices [\#](https://supabase.com/docs/reference/api/start\#best-practices)
