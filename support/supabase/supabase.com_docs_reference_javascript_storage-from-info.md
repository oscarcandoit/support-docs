---
url: "https://supabase.com/docs/reference/javascript/storage-from-info"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/storage-from-info\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/storage-from-info\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/storage-from-info\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/storage-from-info\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/storage-from-info\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/storage-from-info\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/storage-from-info\#response-types-for-complex-queries)
