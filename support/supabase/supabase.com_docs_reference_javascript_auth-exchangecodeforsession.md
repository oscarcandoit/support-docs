...
### Install as package [\#](https://supabase.com/docs/reference/javascript/auth-exchangecodeforsession\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/auth-exchangecodeforsession\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/auth-exchangecodeforsession\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/auth-exchangecodeforsession\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/auth-exchangecodeforsession\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/auth-exchangecodeforsession\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/auth-exchangecodeforsession\#response-types-for-complex-queries)
