...
title: "Migrate from Firebase Firestore to Supabase | Supabase Docs"
---
...
## Migrate to Supabase [\#](https://supabase.com/docs/guides/platform/migrating-to-supabase/firestore-data\#migrate-to-supabase)
