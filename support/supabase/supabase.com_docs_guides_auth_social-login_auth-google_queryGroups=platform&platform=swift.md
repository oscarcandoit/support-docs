---
url: "https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift"
...
[Auth](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift)
...
- [By writing application code](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#application-code) for the web, native applications or Chrome extensions
- [By using Google's pre-built solutions](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#google-pre-built) such as [personalized sign-in buttons](https://developers.google.com/identity/gsi/web/guides/personalized-button), [One Tap](https://developers.google.com/identity/gsi/web/guides/features) or [automatic sign-in](https://developers.google.com/identity/gsi/web/guides/automatic-sign-in-sign-out)

## Prerequisites [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#prerequisites)
...
### Setup required scopes [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#setup-required-scopes)
...
### Setup consent screen branding [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#setup-consent-screen-branding)
...
## Project setup [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#project-setup)
...
import GoogleSignInclass GoogleSignInViewController: UIViewController {  ...  func googleSignIn() async throws {    let result = try await GIDSignIn.sharedInstance.signIn(withPresenting: self)    guard let idToken = result.user.idToken?.tokenString else {      print("No idToken found.")      return    }    let accessToken = result.user.accessToken.tokenString    try await supabase.auth.signInWithIdToken(      credentials: OpenIDConnectCredentials(        provider: .google,        idToken: idToken,        accessToken: accessToken      )    )  }  ...}
```

### Configuration [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#ios-configuration)
...
### Local development [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#local-development)
...
### Using the management API [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#using-the-management-api)
...
## Signing users in [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#signing-users-in)

WebExpo React NativeFlutter (iOS and Android)Flutter (web, macOS, Windows, Linux)Android (Kotlin)Chrome Extensions

### Application code [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#application-code)
...
### Saving Google tokens [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#saving-google-tokens)
...
### Google pre-built [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#google-pre-built)
...
### One-tap with Next.js [\#](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift\#one-tap-with-nextjs)
...
[Prerequisites](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#prerequisites) [Setup required scopes](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#setup-required-scopes) [Setup consent screen branding](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#setup-consent-screen-branding) [Project setup](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#project-setup) [Configuration](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#ios-configuration) [Local development](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#local-development) [Using the management API](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#using-the-management-api) [Signing users in](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#signing-users-in) [Application code](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#application-code) [Saving Google tokens](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#saving-google-tokens) [Google pre-built](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#google-pre-built) [One-tap with Next.js](https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=platform&platform=swift#one-tap-with-nextjs)
