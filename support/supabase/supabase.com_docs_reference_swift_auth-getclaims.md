...
### Install using Swift Package Manager [\#](https://supabase.com/docs/reference/swift/auth-getclaims\#install-using-swift-package-manager)
...
### Handling deep links [\#](https://supabase.com/docs/reference/swift/auth-getclaims\#handling-deep-links)

#### UIKit app lifecycle [\#](https://supabase.com/docs/reference/swift/auth-getclaims\#uikit-app-lifecycle)
...
#### SwiftUI app lifecycle [\#](https://supabase.com/docs/reference/swift/auth-getclaims\#swiftui-app-lifecycle)
