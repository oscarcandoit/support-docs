---
url: "https://supabase.com/docs/reference/self-hosting-storage/search-for-objects-under-a-prefix"
...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-storage/search-for-objects-under-a-prefix\#client-libraries)

- [JavaScript](https://github.com/supabase/storage-js)
- [Dart](https://github.com/supabase/storage-dart)

### Additional links [\#](https://supabase.com/docs/reference/self-hosting-storage/search-for-objects-under-a-prefix\#additional-links)
