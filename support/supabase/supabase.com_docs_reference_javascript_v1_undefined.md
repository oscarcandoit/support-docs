---
url: "https://supabase.com/docs/reference/javascript/v1/undefined"
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#upgrade-the-client-library)
...
### Auth methods [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#auth-methods)
...
#### Sign in with email and password [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#sign-in-with-email-and-password)
...
#### Sign in with magic link [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#sign-in-with-magic-link)
...
#### Sign in with a third-party provider [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#sign-in-with-a-third-party-provider)
...
#### Sign in with phone [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#sign-in-with-phone)
...
#### Sign in with phone using OTP [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#sign-in-with-phone-using-otp)
...
#### Reset password for email [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#reset-password-for-email)
...
#### Get the user's current session [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#get-the-users-current-session)
...
#### Get the logged-in user [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#get-the-logged-in-user)
...
#### Update user data for a logged-in user [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#update-user-data-for-a-logged-in-user)
...
#### Use a custom `access_token` JWT with Supabase [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#use-a-custom-accesstoken-jwt-with-supabase)
...
### Cookie methods [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#cookie-methods)
...
### Data methods [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#data-methods)
...
#### Insert and return data [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#insert-and-return-data)
...
#### Update and return data [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#update-and-return-data)
...
#### Upsert and return data [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#upsert-and-return-data)
...
#### Delete and return data [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#delete-and-return-data)
...
### Realtime methods [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#realtime-methods)

#### Subscribe [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#subscribe)
...
#### Unsubscribe [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#unsubscribe)
...
### Applying Filters [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#applying-filters)
...
### Chaining [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#chaining)
...
### Conditional Chaining [\#](https://supabase.com/docs/reference/javascript/v1/undefined\#conditional-chaining)
