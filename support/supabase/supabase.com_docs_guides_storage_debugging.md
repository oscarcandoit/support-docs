---
url: "https://supabase.com/docs/guides/storage/debugging"
title: "Not found"
---
...
[**Reports** \\
\\
Built-in observability for your Supabase project](https://supabase.com/docs/guides/telemetry/reports) [**Postgresai** \\
\\
Integration](https://supabase.com/docs/partners/integrations/postgresai) [**Error Codes** \\
\\
Learn about the Storage error codes and how to resolve them](https://supabase.com/docs/guides/storage/debugging/error-codes) [**How to Interpret and Explore the Postgres Logs**](https://github.com/orgs/supabase/discussions/26224) [**All about Supabase Egress**](https://github.com/orgs/supabase/discussions/26605) [**Edge Function shutdown reasons explained**](https://github.com/orgs/supabase/discussions/40097)
