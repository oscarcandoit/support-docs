---
url: "https://supabase.com/docs/reference/swift/auth-onauthstatechange"
...
### Install using Swift Package Manager [\#](https://supabase.com/docs/reference/swift/auth-onauthstatechange\#install-using-swift-package-manager)
...
### Handling deep links [\#](https://supabase.com/docs/reference/swift/auth-onauthstatechange\#handling-deep-links)

#### UIKit app lifecycle [\#](https://supabase.com/docs/reference/swift/auth-onauthstatechange\#uikit-app-lifecycle)
...
#### SwiftUI app lifecycle [\#](https://supabase.com/docs/reference/swift/auth-onauthstatechange\#swiftui-app-lifecycle)
