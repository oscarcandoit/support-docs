---
url: "https://supabase.com/docs/guides/storage/schema"
title: "Not found"
---
...
[**The Storage Schema** \\
\\
Learn about the storage schema](https://supabase.com/docs/guides/storage/schema/design) [**Local development with schema migrations** \\
\\
Develop locally with the Supabase CLI and schema migrations.](https://supabase.com/docs/guides/local-development/overview) [**Backup and Restore using the CLI** \\
\\
Learn how to backup and restore projects using the Supabase CLI](https://supabase.com/docs/guides/platform/migrating-within-supabase/backup-restore) [**Troubleshooting prisma errors** \\
\\
Prisma error troubleshooting](https://supabase.com/docs/guides/database/prisma/prisma-troubleshooting) [**Storage Helper Functions** \\
\\
Learn the storage schema](https://supabase.com/docs/guides/storage/schema/helper-functions) [**Permissions** \\
\\
Permissions requirements for the Supabase Cloud hosting environment](https://supabase.com/docs/guides/platform/permissions)
