---
url: "https://supabase.com/docs/reference/javascript/vectorbucketapi-getbucket"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/vectorbucketapi-getbucket\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/vectorbucketapi-getbucket\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/vectorbucketapi-getbucket\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/vectorbucketapi-getbucket\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/vectorbucketapi-getbucket\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/vectorbucketapi-getbucket\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/vectorbucketapi-getbucket\#response-types-for-complex-queries)
