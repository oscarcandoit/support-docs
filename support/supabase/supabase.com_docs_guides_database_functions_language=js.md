...
## Quick demo [\#](https://supabase.com/docs/guides/database/functions?language=js\#quick-demo)
...
## Getting started [\#](https://supabase.com/docs/guides/database/functions?language=js\#getting-started)
...
## Simple functions [\#](https://supabase.com/docs/guides/database/functions?language=js\#simple-functions)
...
Reference: [`rpc()`](https://supabase.com/docs/reference/javascript/rpc)

## Returning data sets [\#](https://supabase.com/docs/guides/database/functions?language=js\#returning-data-sets)
...
## Passing parameters [\#](https://supabase.com/docs/guides/database/functions?language=js\#passing-parameters)
...
## Suggestions [\#](https://supabase.com/docs/guides/database/functions?language=js\#suggestions)

### Database Functions vs Edge Functions [\#](https://supabase.com/docs/guides/database/functions?language=js\#database-functions-vs-edge-functions)
...
### Security `definer` vs `invoker` [\#](https://supabase.com/docs/guides/database/functions?language=js\#security-definer-vs-invoker)
...
### Function privileges [\#](https://supabase.com/docs/guides/database/functions?language=js\#function-privileges)
...
### Debugging functions [\#](https://supabase.com/docs/guides/database/functions?language=js\#debugging-functions)
...
#### General logging [\#](https://supabase.com/docs/guides/database/functions?language=js\#general-logging)
...
#### Error handling [\#](https://supabase.com/docs/guides/database/functions?language=js\#error-handling)
...
create or replace function error_if_null(some_val text)returns textlanguage plpgsqlas $$begin  -- error if some_val is null  if some_val is null then    raise exception 'some_val should not be NULL';  end if;  -- return some_val if it is not null  return some_val;end;$$;select error_if_null(null);
```
...
-- throw error when condition is falseassert <some condition>, 'message';
```
...
create function error_example()returns voidlanguage plpgsqlas $$begin  -- fails: cannot read from nonexistent table  select * from table_that_does_not_exist;  exception      when others then          raise exception 'An error occurred in function <function name>: %', sqlerrm;end;$$;
```

#### Advanced logging [\#](https://supabase.com/docs/guides/database/functions?language=js\#advanced-logging)
...
## Resources [\#](https://supabase.com/docs/guides/database/functions?language=js\#resources)
...
## Deep dive [\#](https://supabase.com/docs/guides/database/functions?language=js\#deep-dive)

### Create Database Functions [\#](https://supabase.com/docs/guides/database/functions?language=js\#create-database-functions)
...
### Call Database Functions using JavaScript [\#](https://supabase.com/docs/guides/database/functions?language=js\#call-database-functions-using-javascript)
...
### Using Database Functions to call an external API [\#](https://supabase.com/docs/guides/database/functions?language=js\#using-database-functions-to-call-an-external-api)
...
[Quick demo](https://supabase.com/docs/guides/database/functions?language=js#quick-demo) [Getting started](https://supabase.com/docs/guides/database/functions?language=js#getting-started) [Simple functions](https://supabase.com/docs/guides/database/functions?language=js#simple-functions) [Returning data sets](https://supabase.com/docs/guides/database/functions?language=js#returning-data-sets) [Passing parameters](https://supabase.com/docs/guides/database/functions?language=js#passing-parameters) [Suggestions](https://supabase.com/docs/guides/database/functions?language=js#suggestions) [Database Functions vs Edge Functions](https://supabase.com/docs/guides/database/functions?language=js#database-functions-vs-edge-functions) [Security definer vs invoker](https://supabase.com/docs/guides/database/functions?language=js#security-definer-vs-invoker) [Function privileges](https://supabase.com/docs/guides/database/functions?language=js#function-privileges) [Debugging functions](https://supabase.com/docs/guides/database/functions?language=js#debugging-functions) [Resources](https://supabase.com/docs/guides/database/functions?language=js#resources) [Deep dive](https://supabase.com/docs/guides/database/functions?language=js#deep-dive) [Create Database Functions](https://supabase.com/docs/guides/database/functions?language=js#create-database-functions) [Call Database Functions using JavaScript](https://supabase.com/docs/guides/database/functions?language=js#call-database-functions-using-javascript) [Using Database Functions to call an external API](https://supabase.com/docs/guides/database/functions?language=js#using-database-functions-to-call-an-external-api)
