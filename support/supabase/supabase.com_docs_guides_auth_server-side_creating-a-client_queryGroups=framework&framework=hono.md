---
url: "https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=hono"
...
[Auth](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=hono)
...
## Install [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=hono\#install)
...
## Set environment variables [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=hono\#set-environment-variables)
...
SUPABASE_URL=supabase_project_urlSUPABASE_PUBLISHABLE_KEY=supabase_publishable_key
```

## Create a client [\#](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=hono\#create-a-client)
...
[Install](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=hono#install) [Set environment variables](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=hono#set-environment-variables) [Create a client](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=hono#create-a-client) [Next steps](https://supabase.com/docs/guides/auth/server-side/creating-a-client?queryGroups=framework&framework=hono#next-steps)
