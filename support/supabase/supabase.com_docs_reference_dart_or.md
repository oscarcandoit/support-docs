...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/or\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/or\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/or\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/or\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/or\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/or\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/or\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/or\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/or\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/or\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/or\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/or\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/or\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/or\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/or\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/or\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/or\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/or\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/or\#presence)
