---
url: "https://supabase.com/docs/reference/python/storage-from-upload"
...
### Install with PyPi [\#](https://supabase.com/docs/reference/python/storage-from-upload\#install-with-pypi)
