---
url: "https://supabase.com/docs/reference/dart/upgrade-guide"
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/upgrade-guide\#presence)
