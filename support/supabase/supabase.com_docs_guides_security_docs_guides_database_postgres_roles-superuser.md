---
url: "https://supabase.com/docs/guides/security/docs/guides/database/postgres/roles-superuser"
title: "Not found"
---
...
\\
Supabase provides a secure yet flexible set of products. Here is how to adjust various security settings across the various products.](https://supabase.com/docs/guides/security/product-security) [**Roles, superuser access and unsupported operations**](https://supabase.com/docs/guides/database/postgres/roles-superuser) [**Securing your data**](https://supabase.com/docs/guides/database/secure-data) [**Features** \\
\\
Supabase features](https://supabase.com/docs/guides/getting-started/features) [**Storage Access Control** \\
\\
Learn how to restrict Supabase file uploads.](https://supabase.com/docs/guides/storage/security/access-control) [**Postgres Roles** \\
\\
Managing access to your Postgres database and configuring permissions.](https://supabase.com/docs/guides/database/postgres/roles)
