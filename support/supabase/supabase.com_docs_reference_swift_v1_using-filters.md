---
url: "https://supabase.com/docs/reference/swift/v1/using-filters"
...
Database
  ...
  - Using filters
    ...
    [Using filters](https://supabase.com/docs/reference/swift/v1/using-filters) - [Match an associated value](https://supabase.com/docs/reference/swift/v1/match)
- [Don't match the filter](https://supabase.com/docs/reference/swift/v1/not)
- [Match at least one filter](https://supabase.com/docs/reference/swift/v1/or)
- [Match the filter](https://supabase.com/docs/reference/swift/v1/filter)
