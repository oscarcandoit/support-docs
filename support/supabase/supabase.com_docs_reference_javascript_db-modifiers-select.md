---
url: "https://supabase.com/docs/reference/javascript/db-modifiers-select"
...
Database
  ...
  - Using modifiers
    ...
    [Using modifiers](https://supabase.com/docs/reference/javascript/using-modifiers) - [Return data after inserting](https://supabase.com/docs/reference/javascript/db-modifiers-select)
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/db-modifiers-select\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/db-modifiers-select\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/db-modifiers-select\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/db-modifiers-select\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/db-modifiers-select\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/db-modifiers-select\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/db-modifiers-select\#response-types-for-complex-queries)
