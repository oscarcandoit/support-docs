---
url: "https://supabase.com/docs/guides/database/row-level-security"
title: "Not found"
---
...
\\
Secure your data with Row Level Security policies for OAuth clients](https://supabase.com/docs/guides/auth/oauth-server/token-security) [**Row Level Security** \\
\\
Secure your data using Postgres Row Level Security.](https://supabase.com/docs/guides/database/postgres/row-level-security) [**Advanced pgTAP Testing** \\
\\
Learn how to leverage dbdev and test helpers for advanced database testing.](https://supabase.com/docs/guides/local-development/testing/pgtap-extended) [**Column Level Security** \\
\\
Secure your data using Postgres Column Level Security.](https://supabase.com/docs/guides/database/postgres/column-level-security) [**RAG with Permissions** \\
\\
Fine-grain access control with Retrieval Augmented Generation.](https://supabase.com/docs/guides/ai/rag-with-permissions) [**Build a User Management App with Swift and SwiftUI** \\
\\
Learn how to use Supabase in your SwiftUI App.](https://supabase.com/docs/guides/getting-started/tutorials/with-swift)
