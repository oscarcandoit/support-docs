---
url: "https://supabase.com/docs/reference/kotlin/rangeadjacent"
...
Database
  ...
  - Using filters
    ...
    [Using filters](https://supabase.com/docs/reference/kotlin/using-filters) - [Column is equal to a value](https://supabase.com/docs/reference/kotlin/eq)
- [Column is not equal to a value](https://supabase.com/docs/reference/kotlin/neq)
- [Column is greater than a value](https://supabase.com/docs/reference/kotlin/gt)
- [Column is greater than or equal to a value](https://supabase.com/docs/reference/kotlin/gte)
- [Column is less than a value](https://supabase.com/docs/reference/kotlin/lt)
- [Column is less than or equal to a value](https://supabase.com/docs/reference/kotlin/lte)
- [Column matches a pattern](https://supabase.com/docs/reference/kotlin/like)
- [Column matches a case-insensitive pattern](https://supabase.com/docs/reference/kotlin/ilike)
- [Column is a value](https://supabase.com/docs/reference/kotlin/is)
- [Column is in an array](https://supabase.com/docs/reference/kotlin/in)
- [Column contains every element in a value](https://supabase.com/docs/reference/kotlin/contains)
- [Greater than a range](https://supabase.com/docs/reference/kotlin/rangegt)
- [Greater than or equal to a range](https://supabase.com/docs/reference/kotlin/rangegte)
- [Less than a range](https://supabase.com/docs/reference/kotlin/rangelt)
- [Less than or equal to a range](https://supabase.com/docs/reference/kotlin/rangelte)
- [Mutually exclusive to a range](https://supabase.com/docs/reference/kotlin/rangeadjacent)
- [With a common element](https://supabase.com/docs/reference/kotlin/overlaps)
- [Match a string](https://supabase.com/docs/reference/kotlin/textsearch)
- [Don't match the filter](https://supabase.com/docs/reference/kotlin/not)
- [Match at least one filter](https://supabase.com/docs/reference/kotlin/or)
- [Match the filter](https://supabase.com/docs/reference/kotlin/filter)
...
### Add one or more modules to your project [\#](https://supabase.com/docs/reference/kotlin/rangeadjacent\#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required) [\#](https://supabase.com/docs/reference/kotlin/rangeadjacent\#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization [\#](https://supabase.com/docs/reference/kotlin/rangeadjacent\#serialization)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/rangeadjacent\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/rangeadjacent\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/rangeadjacent\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/rangeadjacent\#pkce-authentication-flow)
