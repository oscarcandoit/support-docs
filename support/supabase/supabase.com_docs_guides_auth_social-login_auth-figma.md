...
title: "Login with Figma | Supabase Docs"
---
...
[Auth](https://supabase.com/docs/guides/auth/social-login/auth-figma)
...
![Create Figma app](https://supabase.com/docs/img/guides/auth-figma/figma_app_credentials.png)
...
![Add redirect URL](https://supabase.com/docs/img/guides/auth-figma/figma_app_redirect_uri.png)
...
![Select OAuth scopes](https://supabase.com/docs/img/guides/auth-figma/figma_app_scopes.png)
