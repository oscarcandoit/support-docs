---
url: "https://supabase.com/docs/guides/database/replication/etl-replication-setup"
title: "Not found"
---
...
[**Replication Setup** \\
\\
Configure publications and destinations for replication.](https://supabase.com/docs/guides/database/replication/replication-setup) [**Manual Replication Setup** \\
\\
Set up replication with Airbyte, Estuary, Fivetran, and other tools.](https://supabase.com/docs/guides/database/replication/manual-replication-setup) [**Realtime Data Sync to Analytics Buckets** \\
\\
Replicate your PostgreSQL data to analytics buckets in real-time.](https://supabase.com/docs/guides/storage/analytics/replication) [**Query with PostgreSQL** \\
\\
Query analytics bucket data directly from PostgreSQL using SQL.](https://supabase.com/docs/guides/storage/analytics/query-with-postgres) [**Database Replication** \\
\\
An introduction to database replication and change data capture.](https://supabase.com/docs/guides/database/replication) [**Clickhouse-clickpipes** \\
\\
Integration](https://supabase.com/docs/partners/integrations/clickhouse-clickpipes)
