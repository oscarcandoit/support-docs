...
### Add one or more modules to your project [\#](https://supabase.com/docs/reference/kotlin/introduction\#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required) [\#](https://supabase.com/docs/reference/kotlin/introduction\#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization [\#](https://supabase.com/docs/reference/kotlin/introduction\#serialization)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/introduction\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/introduction\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/introduction\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/introduction\#pkce-authentication-flow)
