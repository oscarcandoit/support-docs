---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-seq-scans"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-seq-scans\#additional-links)
