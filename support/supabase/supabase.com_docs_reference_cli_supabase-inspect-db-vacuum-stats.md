---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-vacuum-stats"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-vacuum-stats\#additional-links)
