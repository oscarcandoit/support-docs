---
url: "https://supabase.com/docs/reference/dart/v1/auth-signup"
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/v1/auth-signup\#install-from-pubdev)
