...
title: "Supabase Docs | Troubleshooting | High Disk I/O"
---
...
To check your Disk IO Budget on the Supabase Platform, head over to [Database Health in the Observability section](https://supabase.com/dashboard/project/_/observability/database).
