---
url: "https://supabase.com/docs/reference/self-hosting-analytics/fetch-source"
...
However, it's important to note that certain [differences](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source#differences) may arise due to the platform's infrastructure.
...
## Backends Supported [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#backends-supported)
...
## Postgres Backend Setup [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#postgres-backend-setup)
...
### Configuration and Requirements [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#configuration-and-requirements)
...
## BigQuery Backend Setup [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#bigquery-backend-setup)
...
#### Setting up BigQuery Service Account [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#setting-up-bigquery-service-account)
...
#### Download the Service Account Keys [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#download-the-service-account-keys)
...
#### Docker Image Configuration [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#docker-image-configuration)
...
#### BigQuery Datset Storage Location [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#bigquery-datset-storage-location)
...
## Vector Usage [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#vector-usage)
...
## Differences from Platform [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#differences-from-platform)
...
## Production Recommendations [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#production-recommendations)

To self-host in a production setting, we recommend performing the following for a better experience.

### Ensure that Logflare is behind a firewall and restrict all network access to it besides safe requests. [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#ensure-that-logflare-is-behind-a-firewall-and-restrict-all-network-access-to-it-besides-safe-requests)
...
### Use a different Postgres Database to store Logflare data. [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#use-a-different-postgres-database-to-store-logflare-data)
...
### Use Big Query as the Logflare Backend [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#use-big-query-as-the-logflare-backend)
...
### Rotate Encryption Keys Regularly [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#rotate-encryption-keys-regularly)
...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#client-libraries)
...
### Integrations [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#integrations)
...
### Additional links [\#](https://supabase.com/docs/reference/self-hosting-analytics/fetch-source\#additional-links)
