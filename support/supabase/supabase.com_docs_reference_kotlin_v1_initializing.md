---
url: "https://supabase.com/docs/reference/kotlin/v1/initializing"
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v1/initializing\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v1/initializing\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v1/initializing\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v1/initializing\#pkce-authentication-flow)
