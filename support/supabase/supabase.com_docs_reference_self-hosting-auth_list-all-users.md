---
url: "https://supabase.com/docs/reference/self-hosting-auth/list-all-users"
...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-auth/list-all-users\#client-libraries)

- [JavaScript](https://github.com/supabase/gotrue-js)
- [Dart](https://github.com/supabase/gotrue-dart)

### Additional links [\#](https://supabase.com/docs/reference/self-hosting-auth/list-all-users\#additional-links)
