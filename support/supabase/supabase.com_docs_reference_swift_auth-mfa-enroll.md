---
url: "https://supabase.com/docs/reference/swift/auth-mfa-enroll"
...
Auth
  ...
  - Auth MFA
    ...
    [Auth MFA](https://supabase.com/docs/reference/swift/auth-mfa-api) - [Enroll a factor](https://supabase.com/docs/reference/swift/auth-mfa-enroll)
...
### Install using Swift Package Manager [\#](https://supabase.com/docs/reference/swift/auth-mfa-enroll\#install-using-swift-package-manager)
...
### Handling deep links [\#](https://supabase.com/docs/reference/swift/auth-mfa-enroll\#handling-deep-links)

#### UIKit app lifecycle [\#](https://supabase.com/docs/reference/swift/auth-mfa-enroll\#uikit-app-lifecycle)
...
#### SwiftUI app lifecycle [\#](https://supabase.com/docs/reference/swift/auth-mfa-enroll\#swiftui-app-lifecycle)
