---
url: "https://supabase.com/docs/reference/kotlin/v1/auth-signup"
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v1/auth-signup\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v1/auth-signup\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v1/auth-signup\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v1/auth-signup\#pkce-authentication-flow)
