---
url: "https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify"
...
Auth
  ...
  - Auth MFA
    ...
    [Auth MFA](https://supabase.com/docs/reference/dart/auth-mfa-api) - [Enroll a factor](https://supabase.com/docs/reference/dart/auth-mfa-enroll)
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify\#presence)
