...
### Install as package [\#](https://supabase.com/docs/reference/javascript/not\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/not\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/not\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/not\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/not\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/not\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/not\#response-types-for-complex-queries)
