---
url: "https://supabase.com/docs/reference/python/storage-from-getpublicurl"
...
Storage
  ...
  - File Buckets
    ...
    [File Buckets](https://supabase.com/docs/reference/python/file-buckets) - [List all buckets](https://supabase.com/docs/reference/python/storage-listbuckets)
...
### Install with PyPi [\#](https://supabase.com/docs/reference/python/storage-from-getpublicurl\#install-with-pypi)
