---
url: "https://supabase.com/docs/reference/self-hosting-storage/start"
...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-storage/start\#client-libraries)

- [JavaScript](https://github.com/supabase/storage-js)
- [Dart](https://github.com/supabase/storage-dart)

### Additional links [\#](https://supabase.com/docs/reference/self-hosting-storage/start\#additional-links)
