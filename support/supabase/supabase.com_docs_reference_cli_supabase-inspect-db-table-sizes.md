---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-table-sizes"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-table-sizes\#additional-links)
