---
url: "https://supabase.com/docs/reference/kotlin/v2/rangeadjacent"
...
Database
  ...
  - Using filters
    ...
    [Using filters](https://supabase.com/docs/reference/kotlin/v2/using-filters) - [Column is equal to a value](https://supabase.com/docs/reference/kotlin/v2/eq)
- [Column is not equal to a value](https://supabase.com/docs/reference/kotlin/v2/neq)
- [Column is greater than a value](https://supabase.com/docs/reference/kotlin/v2/gt)
- [Column is greater than or equal to a value](https://supabase.com/docs/reference/kotlin/v2/gte)
- [Column is less than a value](https://supabase.com/docs/reference/kotlin/v2/lt)
- [Column is less than or equal to a value](https://supabase.com/docs/reference/kotlin/v2/lte)
- [Column matches a pattern](https://supabase.com/docs/reference/kotlin/v2/like)
- [Column matches a case-insensitive pattern](https://supabase.com/docs/reference/kotlin/v2/ilike)
- [Column is a value](https://supabase.com/docs/reference/kotlin/v2/is)
- [Column is in an array](https://supabase.com/docs/reference/kotlin/v2/in)
- [Column contains every element in a value](https://supabase.com/docs/reference/kotlin/v2/contains)
- [Greater than a range](https://supabase.com/docs/reference/kotlin/v2/rangegt)
- [Greater than or equal to a range](https://supabase.com/docs/reference/kotlin/v2/rangegte)
- [Less than a range](https://supabase.com/docs/reference/kotlin/v2/rangelt)
- [Less than or equal to a range](https://supabase.com/docs/reference/kotlin/v2/rangelte)
- [Mutually exclusive to a range](https://supabase.com/docs/reference/kotlin/v2/rangeadjacent)
- [With a common element](https://supabase.com/docs/reference/kotlin/v2/overlaps)
- [Match a string](https://supabase.com/docs/reference/kotlin/v2/textsearch)
- [Don't match the filter](https://supabase.com/docs/reference/kotlin/v2/not)
- [Match at least one filter](https://supabase.com/docs/reference/kotlin/v2/or)
- [Match the filter](https://supabase.com/docs/reference/kotlin/v2/filter)
...
### Add one or more modules to your project [\#](https://supabase.com/docs/reference/kotlin/v2/rangeadjacent\#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required) [\#](https://supabase.com/docs/reference/kotlin/v2/rangeadjacent\#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization [\#](https://supabase.com/docs/reference/kotlin/v2/rangeadjacent\#serialization)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/v2/rangeadjacent\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/v2/rangeadjacent\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/v2/rangeadjacent\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/v2/rangeadjacent\#pkce-authentication-flow)
