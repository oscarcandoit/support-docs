---
url: "https://supabase.com/docs/reference/csharp/v0/select"
...
### Install from NuGet [\#](https://supabase.com/docs/reference/csharp/v0/select\#install-from-nuget)
...
## 0.16.2 - 2024-04-02 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0162---2024-04-02)
...
## 0.16.1 - 2024-03-15 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0161---2024-03-15)
...
## 0.16.0 - 2024-03-12 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0160---2024-03-12)
...
## 0.15.0 - 2024-01-08 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0150---2024-01-08)
...
## 0.14.0 - 2023-12-15 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0140---2023-12-15)
...
## 0.13.7 - 2023-11-13 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0137---2023-11-13)
...
## 0.13.6 - 2023-10-12 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0136---2023-10-12)
...
## 0.13.5 - 2023-10-09 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0135---2023-10-09)
...
## 0.13.4 - 2023-10-08 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0134---2023-10-08)
...
## 0.13.3 - 2023-09-15 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0133---2023-09-15)
...
## 0.13.2 - 2023-09-15 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0132---2023-09-15)
...
## 0.13.1 - 2023-08-26 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0131---2023-08-26)
...
## 0.13.0 - 2023-08-26 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0130---2023-08-26)
...
## 0.12.2 - 2023-07-28 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0122---2023-07-28)
...
## 0.12.1 - 2023-06-29 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0121---2023-06-29)
...
## 0.12.0 - 2023-06-25 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0120---2023-06-25)
...
## 0.11.1 - 2023-06-10 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0111---2023-06-10)
...
## 0.11.0 - 2023-05-24 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0110---2023-05-24)
...
## 0.10.0 - 2023-05-14 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0100---2023-05-14)
...
## 0.9.1 - 2023-04-28 [\#](https://supabase.com/docs/reference/csharp/v0/select\#091---2023-04-28)
...
## 0.9.0 - 2023-04-12 [\#](https://supabase.com/docs/reference/csharp/v0/select\#090---2023-04-12)
...
## 0.8.8 - 2023-03-29 [\#](https://supabase.com/docs/reference/csharp/v0/select\#088---2023-03-29)

- Update dependency: gotrue-csharp@3.0.6
  - Supports adding `SignInOptions` (i.e. `RedirectTo`) on `OAuth Provider` SignIn requests.

## 0.8.7 - 2023-03-23 [\#](https://supabase.com/docs/reference/csharp/v0/select\#087---2023-03-23)
...
## 0.8.6 - 2023-03-23 [\#](https://supabase.com/docs/reference/csharp/v0/select\#086---2023-03-23)
...
## 0.8.5 - 2023-03-10 [\#](https://supabase.com/docs/reference/csharp/v0/select\#085---2023-03-10)
...
## 0.8.4 - 2023-03-03 [\#](https://supabase.com/docs/reference/csharp/v0/select\#084---2023-03-03)
...
## 0.8.3 - 2023-02-26 [\#](https://supabase.com/docs/reference/csharp/v0/select\#083---2023-02-26)
...
## 0.8.2 - 2023-02-26 [\#](https://supabase.com/docs/reference/csharp/v0/select\#082---2023-02-26)

- Update dependency: supabase-storage-csharp@1.2.4
  - `UploadOrUpdate` now appropriately throws request exceptions

## 0.8.1 - 2023-02-06 [\#](https://supabase.com/docs/reference/csharp/v0/select\#081---2023-02-06)
...
## 0.8.0 - 2023-01-31 [\#](https://supabase.com/docs/reference/csharp/v0/select\#080---2023-01-31)
...
## 0.7.2 - 2023-01-27 [\#](https://supabase.com/docs/reference/csharp/v0/select\#072---2023-01-27)
...
## 0.7.1 - 2023-01-17 [\#](https://supabase.com/docs/reference/csharp/v0/select\#071---2023-01-17)
...
## 0.7.0 - 2023-01-16 [\#](https://supabase.com/docs/reference/csharp/v0/select\#070---2023-01-16)
...
## 0.6.2 - 2022-11-22 [\#](https://supabase.com/docs/reference/csharp/v0/select\#062---2022-11-22)
...
## 0.6.1 - 2022-11-12 [\#](https://supabase.com/docs/reference/csharp/v0/select\#061---2022-11-12)

- \[Hotfix\] `GetHeaders` was not passing properly to `SupabaseTable` and `Gotrue.Api`

## 0.6.0 - 2022-11-12 [\#](https://supabase.com/docs/reference/csharp/v0/select\#060---2022-11-12)
...
## 0.5.3 - 2022-10-11 [\#](https://supabase.com/docs/reference/csharp/v0/select\#053---2022-10-11)
...
## 0.5.2 - 2022-9-13 [\#](https://supabase.com/docs/reference/csharp/v0/select\#052---2022-9-13)
...
## 0.5.1 - 2022-8-1 [\#](https://supabase.com/docs/reference/csharp/v0/select\#051---2022-8-1)

- Update dependency: postgrest-csharp@2.0.11
- Update dependency: supabase-storage-csharp@1.1.1

## 0.5.0 - 2022-7-17 [\#](https://supabase.com/docs/reference/csharp/v0/select\#050---2022-7-17)
...
## 0.4.4 - 2022-5-24 [\#](https://supabase.com/docs/reference/csharp/v0/select\#044---2022-5-24)

- Update dependency: gotrue-csharp@2.4.5
- Update dependency: postgrest-csharp@2.0.8

## 0.4.3 - 2022-5-13 [\#](https://supabase.com/docs/reference/csharp/v0/select\#043---2022-5-13)

- Update dependency: gotrue-csharp@2.4.4

## 0.4.2 - 2022-4-30 [\#](https://supabase.com/docs/reference/csharp/v0/select\#042---2022-4-30)

- Update dependency: gotrue-csharp@2.4.3

## 0.4.1 - 2022-4-23 [\#](https://supabase.com/docs/reference/csharp/v0/select\#041---2022-4-23)

- Update dependency: gotrue-csharp@2.4.2

## 0.4.0 - 2022-4-12 [\#](https://supabase.com/docs/reference/csharp/v0/select\#040---2022-4-12)
...
## 0.3.5 - 2022-4-11 [\#](https://supabase.com/docs/reference/csharp/v0/select\#035---2022-4-11)

- Update dependency: postgres-csharp@2.0.7

## 0.3.4 - 2022-03-28 [\#](https://supabase.com/docs/reference/csharp/v0/select\#034---2022-03-28)

- Update dependency: gotrue-csharp@2.4.0

## 0.3.3 - 2022-02-27 [\#](https://supabase.com/docs/reference/csharp/v0/select\#033---2022-02-27)

- Update dependency: gotrue-csharp@2.3.6
- Update dependency: supabase-storage-csharp@1.0.2

## 0.3.2 - 2022-02-18 [\#](https://supabase.com/docs/reference/csharp/v0/select\#032---2022-02-18)
...
## 0.3.1 - 2022-01-20 [\#](https://supabase.com/docs/reference/csharp/v0/select\#031---2022-01-20)
...
## 0.3.0 - 2021-12-30 [\#](https://supabase.com/docs/reference/csharp/v0/select\#030---2021-12-30)
...
## 0.2.12 - 2021-12-29 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0212---2021-12-29)
...
## 0.2.11 - 2021-12-24 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0211---2021-12-24)
...
## 0.2.10 - 2021-12-23 [\#](https://supabase.com/docs/reference/csharp/v0/select\#0210---2021-12-23)
...
## 0.2.9 - 2021-12-9 [\#](https://supabase.com/docs/reference/csharp/v0/select\#029---2021-12-9)

- Separate Storage client from Supabase repo and into `storage-csharp`, `supabase-csharp` now references new repo.

## 0.2.8 - 2021-12-4 [\#](https://supabase.com/docs/reference/csharp/v0/select\#028---2021-12-4)

- Update gotrue-csharp to 2.2.4
  - Adds support for `ListUsers` (paginate, sort, filter), `GetUserById`, `CreateUser`, and `UpdateById`

## 0.2.7 - 2021-12-2 [\#](https://supabase.com/docs/reference/csharp/v0/select\#027---2021-12-2)

- Update gotrue-csharp to 2.2.3
  - Adds support for sending password resets to users.

## 0.2.6 - 2021-11-29 [\#](https://supabase.com/docs/reference/csharp/v0/select\#026---2021-11-29)
