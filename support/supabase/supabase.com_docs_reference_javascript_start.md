---
url: "https://supabase.com/docs/reference/javascript/start"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/start\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/start\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/start\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/start\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/start\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/start\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/start\#response-types-for-complex-queries)
