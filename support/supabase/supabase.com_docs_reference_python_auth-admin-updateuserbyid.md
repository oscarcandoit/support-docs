---
url: "https://supabase.com/docs/reference/python/auth-admin-updateuserbyid"
...
### Install with PyPi [\#](https://supabase.com/docs/reference/python/auth-admin-updateuserbyid\#install-with-pypi)
