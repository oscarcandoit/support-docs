---
url: "https://supabase.com/docs/reference/javascript/storagevectors-createbucket"
...
Storage
  ...
  - Vector Buckets
    ...
    [Vector Buckets](https://supabase.com/docs/reference/javascript/vector-buckets) - [Access a vector bucket](https://supabase.com/docs/reference/javascript/storagevectors-from)
- [Create a vector bucket](https://supabase.com/docs/reference/javascript/storagevectors-createbucket)
- [Delete a vector bucket](https://supabase.com/docs/reference/javascript/storagevectors-deletebucket)
- [Retrieve a vector bucket](https://supabase.com/docs/reference/javascript/storagevectors-getbucket)
- [List all vector buckets](https://supabase.com/docs/reference/javascript/storagevectors-listbuckets)
- [Create a vector index](https://supabase.com/docs/reference/javascript/vectorbucket-createindex)
- [Delete a vector index](https://supabase.com/docs/reference/javascript/vectorbucket-deleteindex)
- [Retrieve a vector index](https://supabase.com/docs/reference/javascript/vectorbucket-getindex)
- [List all vector indexes](https://supabase.com/docs/reference/javascript/vectorbucket-listindexes)
- [Access a vector index](https://supabase.com/docs/reference/javascript/vectorbucket-index)
- [Delete vectors from index](https://supabase.com/docs/reference/javascript/vectorindex-deletevectors)
- [Retrieve vectors from index](https://supabase.com/docs/reference/javascript/vectorindex-getvectors)
- [List vectors in index](https://supabase.com/docs/reference/javascript/vectorindex-listvectors)
- [Add vectors to index](https://supabase.com/docs/reference/javascript/vectorindex-putvectors)
- [Search vectors in index](https://supabase.com/docs/reference/javascript/vectorindex-queryvectors)
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/storagevectors-createbucket\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/storagevectors-createbucket\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/storagevectors-createbucket\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/storagevectors-createbucket\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/storagevectors-createbucket\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/storagevectors-createbucket\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/storagevectors-createbucket\#response-types-for-complex-queries)
