...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/select\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/select\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/select\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/select\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/select\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/select\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/select\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/select\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/select\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/select\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/select\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/select\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/select\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/select\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/select\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/select\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/select\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/select\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/select\#presence)
