---
url: "https://supabase.com/docs/reference/swift/storage-from-upload"
...
Storage
  ...
  - File Buckets
    ...
    [File Buckets](https://supabase.com/docs/reference/swift/file-buckets) - [List all buckets](https://supabase.com/docs/reference/swift/storage-listbuckets)
...
- [Create signed upload URL](https://supabase.com/docs/reference/swift/storage-from-createsigneduploadurl)
- [Upload to a signed URL](https://supabase.com/docs/reference/swift/storage-from-uploadtosignedurl)
...
### Install using Swift Package Manager [\#](https://supabase.com/docs/reference/swift/storage-from-upload\#install-using-swift-package-manager)
...
### Handling deep links [\#](https://supabase.com/docs/reference/swift/storage-from-upload\#handling-deep-links)

#### UIKit app lifecycle [\#](https://supabase.com/docs/reference/swift/storage-from-upload\#uikit-app-lifecycle)
...
#### SwiftUI app lifecycle [\#](https://supabase.com/docs/reference/swift/storage-from-upload\#swiftui-app-lifecycle)
