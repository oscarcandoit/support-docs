...
[Auth](https://supabase.com/docs/guides/auth/social-login/auth-spotify)
...
7. [Spotify](https://supabase.com/docs/guides/auth/social-login/auth-spotify)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/auth/social-login/auth-spotify.mdx)
