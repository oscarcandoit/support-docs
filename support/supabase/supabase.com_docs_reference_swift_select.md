---
url: "https://supabase.com/docs/reference/swift/select"
...
### Install using Swift Package Manager [\#](https://supabase.com/docs/reference/swift/select\#install-using-swift-package-manager)
...
### Handling deep links [\#](https://supabase.com/docs/reference/swift/select\#handling-deep-links)

#### UIKit app lifecycle [\#](https://supabase.com/docs/reference/swift/select\#uikit-app-lifecycle)
...
#### SwiftUI app lifecycle [\#](https://supabase.com/docs/reference/swift/select\#swiftui-app-lifecycle)
