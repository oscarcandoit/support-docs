...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-storage/generate-presigned-urls-to-retrieve-objects\#client-libraries)

- [JavaScript](https://github.com/supabase/storage-js)
- [Dart](https://github.com/supabase/storage-dart)

### Additional links [\#](https://supabase.com/docs/reference/self-hosting-storage/generate-presigned-urls-to-retrieve-objects\#additional-links)
