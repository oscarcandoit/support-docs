---
url: "https://supabase.com/docs/reference/javascript/auth-admin-generatelink"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/auth-admin-generatelink\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/auth-admin-generatelink\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/auth-admin-generatelink\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/auth-admin-generatelink\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/auth-admin-generatelink\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/auth-admin-generatelink\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/auth-admin-generatelink\#response-types-for-complex-queries)
