---
url: "https://supabase.com/docs/reference/api/v1-list-all-branches"
...
## Authentication [\#](https://supabase.com/docs/reference/api/v1-list-all-branches\#authentication)
...
## Rate limits [\#](https://supabase.com/docs/reference/api/v1-list-all-branches\#rate-limits)
...
{  "fileSizeLimit": 42,  "features": {    "imageTransformation": {      "enabled": true    },    "s3Protocol": {      "enabled": true    },    "icebergCatalog": {      "enabled": true    }  },  "capabilities": {    "list_v2": true,    "iceberg_catalog": true  },  "external": {    "upstreamTarget": "main"  },  "migrationVersion": "lorem",  "databasePoolMode": "lorem"}
```
