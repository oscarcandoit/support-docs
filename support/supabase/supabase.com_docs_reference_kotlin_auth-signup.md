---
url: "https://supabase.com/docs/reference/kotlin/auth-signup"
...
### Add one or more modules to your project [\#](https://supabase.com/docs/reference/kotlin/auth-signup\#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required) [\#](https://supabase.com/docs/reference/kotlin/auth-signup\#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization [\#](https://supabase.com/docs/reference/kotlin/auth-signup\#serialization)
...
### Create Supabase Client [\#](https://supabase.com/docs/reference/kotlin/auth-signup\#create-supabase-client)
...
### OAuth and OTP link verification [\#](https://supabase.com/docs/reference/kotlin/auth-signup\#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication [\#](https://supabase.com/docs/reference/kotlin/auth-signup\#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow [\#](https://supabase.com/docs/reference/kotlin/auth-signup\#pkce-authentication-flow)
