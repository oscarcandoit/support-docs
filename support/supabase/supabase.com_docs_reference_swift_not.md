---
url: "https://supabase.com/docs/reference/swift/not"
...
Database
  ...
  - Using filters
    ...
    [Using filters](https://supabase.com/docs/reference/swift/using-filters) - [Column is equal to a value](https://supabase.com/docs/reference/swift/eq)
- [Column is not equal to a value](https://supabase.com/docs/reference/swift/neq)
- [Column is greater than a value](https://supabase.com/docs/reference/swift/gt)
- [Column is greater than or equal to a value](https://supabase.com/docs/reference/swift/gte)
- [Column is less than a value](https://supabase.com/docs/reference/swift/lt)
- [Column is less than or equal to a value](https://supabase.com/docs/reference/swift/lte)
- [Column matches a pattern](https://supabase.com/docs/reference/swift/like)
- [Column matches a case-insensitive pattern](https://supabase.com/docs/reference/swift/ilike)
- [Column is a value](https://supabase.com/docs/reference/swift/is)
- [Column is in an array](https://supabase.com/docs/reference/swift/in)
- [Column contains every element in a value](https://supabase.com/docs/reference/swift/contains)
- [With a common element](https://supabase.com/docs/reference/swift/overlaps)
...
### Install using Swift Package Manager [\#](https://supabase.com/docs/reference/swift/not\#install-using-swift-package-manager)
...
### Handling deep links [\#](https://supabase.com/docs/reference/swift/not\#handling-deep-links)

#### UIKit app lifecycle [\#](https://supabase.com/docs/reference/swift/not\#uikit-app-lifecycle)
...
#### SwiftUI app lifecycle [\#](https://supabase.com/docs/reference/swift/not\#swiftui-app-lifecycle)
