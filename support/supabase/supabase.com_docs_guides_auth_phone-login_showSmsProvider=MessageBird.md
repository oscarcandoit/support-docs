...
[Auth](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird)
...
## Enabling phone login [\#](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird\#enabling-phone-login)
...
## Signing in with phone OTP [\#](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird\#signing-in-with-phone-otp)
...
## Verifying a phone OTP [\#](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird\#verifying-a-phone-otp)
...
## Updating a phone number [\#](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird\#updating-a-phone-number)
...
The user receives an SMS with a 6-digit pin that you must [verify](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird#verifying-a-phone-otp) within 60 seconds.
...
[Enabling phone login](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird#enabling-phone-login) [Signing in with phone OTP](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird#signing-in-with-phone-otp) [Verifying a phone OTP](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird#verifying-a-phone-otp) [Updating a phone number](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird#updating-a-phone-number)
...
### MessageBird [\#](https://supabase.com/docs/guides/auth/phone-login?showSmsProvider=MessageBird\#messagebird)
...
![Verify your own phone number](https://supabase.com/docs/img/guides/auth-messagebird/1.png)

![Get your API Keys](https://supabase.com/docs/img/guides/auth-messagebird/2.png)
...
![Set the default originator](https://supabase.com/docs/img/guides/auth-messagebird/3.png)
