---
url: "https://supabase.com/docs/reference/python/auth-getclaims"
...
### Install with PyPi [\#](https://supabase.com/docs/reference/python/auth-getclaims\#install-with-pypi)
