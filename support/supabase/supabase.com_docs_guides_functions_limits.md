...
## Platform limits [\#](https://supabase.com/docs/guides/functions/limits\#platform-limits)
...
- Static files cannot be deployed using the API flag. You need to build them with [Docker on the CLI](https://supabase.com/docs/guides/functions/quickstart#step-6-deploy-to-production).
...
[Runtime limits](https://supabase.com/docs/guides/functions/limits#runtime-limits) [Platform limits](https://supabase.com/docs/guides/functions/limits#platform-limits) [Other limits & restrictions](https://supabase.com/docs/guides/functions/limits#other-limits--restrictions)
