---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-table-record-counts"
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-table-record-counts\#additional-links)
