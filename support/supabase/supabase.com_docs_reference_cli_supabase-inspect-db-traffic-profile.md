---
url: "https://supabase.com/docs/reference/cli/supabase-inspect-db-traffic-profile"
...
Generate Types
  ...
  - [Generate a JWT signing key](https://supabase.com/docs/reference/cli/supabase-gen-signing-key)
...
Inspect
  ...
  - Inspect database statistics
    ...
    [Inspect database statistics](https://supabase.com/docs/reference/cli/supabase-inspect-db) - [Show estimated database bloat](https://supabase.com/docs/reference/cli/supabase-inspect-db-bloat)
...
- [Show statistics related to database usage](https://supabase.com/docs/reference/cli/supabase-inspect-db-db-stats)
- [Show sizes of individual indexes](https://supabase.com/docs/reference/cli/supabase-inspect-db-index-stats)
...
- [Show sizes of individual tables](https://supabase.com/docs/reference/cli/supabase-inspect-db-table-stats)
- [Show read / write activity ratio for tables](https://supabase.com/docs/reference/cli/supabase-inspect-db-traffic-profile)
...
Branches
  ...
  - [Pause a preview branch](https://supabase.com/docs/reference/cli/supabase-branches-pause)
  - [Unpause a preview branch](https://supabase.com/docs/reference/cli/supabase-branches-unpause)
...
Postgres Config
  ...
  - [Manage Postgres configurations](https://supabase.com/docs/reference/cli/supabase-postgres-config)
...
### Additional links [\#](https://supabase.com/docs/reference/cli/supabase-inspect-db-traffic-profile\#additional-links)
