...
title: "Vector Bucket Limits | Supabase Docs"
---
...
5. [Limits](https://supabase.com/docs/guides/storage/vector/limits)
...
## Storage limits [\#](https://supabase.com/docs/guides/storage/vector/limits\#storage-limits)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/storage/vector/limits.mdx)
