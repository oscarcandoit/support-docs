---
url: "https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql"
...
## Enable the extension [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#enable-the-extension)
...
-- Enable the "pgaudit" extensioncreate extension pgaudit;-- Disable the "pgaudit" extensiondrop extension if exists pgaudit;
```

## Configure the extension [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#configure-the-extension)

PGAudit can be configured with different levels of precision.

**PGAudit logging precision:**

- **[Session](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#session-logging):** Logs activity within a connection, such as a [psql](https://supabase.com/docs/guides/database/connecting-to-postgres#connecting-with-psql) connection.
- **[User](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#user-logging):** Logs activity by a particular database user (for example, `anon` or `postgres`).
- **[Global](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#global-logging):** Logs activity across the entire database.
- **[Object](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#object-logging):** Logs events related to specific database objects (for example, the auth.users table).
...
### Session mode categories [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#session-mode-categories)
...
### Session logging [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#session-logging)
...
### User logging [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#user-logging)
...
### Global logging [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#global-logging)
...
### Object logging [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#object-logging)
...
## Interpreting Audit Logs [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#interpreting-audit-logs)
...
## Finding and filtering audit logs [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#finding-and-filtering-audit-logs)
...
## Practical examples [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#practical-examples)

### Monitoring API events [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#monitoring-api-events)
...
### Monitoring the `auth.users` table [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#monitoring-the-authusers-table)
...
## Best practices [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#best-practices)

### Disabling excess logging [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#disabling-excess-logging)
...
## FAQ [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#faq)

#### Using PGAudit to debug database functions [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#using-pgaudit-to-debug-database-functions)
...
#### Downloading database logs [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#downloading-database-logs)

In the [Logs Dashboard](https://supabase.com/dashboard/project/_/logs/postgres-logs) you can download logs as CSVs.

#### Logging observed table rows [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#logging-observed-table-rows)
...
#### Logging function parameters [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#logging-function-parameters)
...
#### Does PGAudit support system wide configurations? [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#does-pgaudit-support-system-wide-configurations)
...
## Resources [\#](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql\#resources)
...
[Enable the extension](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#enable-the-extension) [Configure the extension](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#configure-the-extension) [Session mode categories](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#session-mode-categories) [Session logging](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#session-logging) [User logging](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#user-logging) [Global logging](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#global-logging) [Object logging](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#object-logging) [Interpreting Audit Logs](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#interpreting-audit-logs) [Finding and filtering audit logs](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#finding-and-filtering-audit-logs) [Practical examples](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#practical-examples) [Monitoring API events](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#monitoring-api-events) [Monitoring the auth.users table](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#monitoring-the-authusers-table) [Best practices](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#best-practices) [Disabling excess logging](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#disabling-excess-logging) [FAQ](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#faq) [Resources](https://supabase.com/docs/guides/database/extensions/pgaudit?queryGroups=database-method&database-method=sql#resources)
