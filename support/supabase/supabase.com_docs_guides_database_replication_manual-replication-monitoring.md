...
title: "Manual Replication Monitoring | Supabase Docs"
---
...
7. [Monitoring](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring)
...
1. Dashboard - Under the [Reports](https://supabase.com/docs/guides/platform/reports) of the dashboard, you can view the replication lag of your project
2. Database -
...
3. [Metrics](https://supabase.com/docs/guides/telemetry/metrics) \- Using the prometheus endpoint for your project
...
### Primary [\#](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring\#primary)

#### Replication status and lag [\#](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring\#replication-status-and-lag)
...
#### Replication slot status [\#](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring\#replication-slot-status)
...
#### WAL size [\#](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring\#wal-size)
...
#### Check the LSN [\#](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring\#check-the-lsn)
...
### Subscriber [\#](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring\#subscriber)

#### Subscription status [\#](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring\#subscription-status)
...
[Edit this page on GitHub](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/database/replication/manual-replication-monitoring.mdx)
...
[Primary](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring#primary) [Subscriber](https://supabase.com/docs/guides/database/replication/manual-replication-monitoring#subscriber)
