---
url: "https://supabase.com/docs/reference/self-hosting-analytics/list-sources"
...
However, it's important to note that certain [differences](https://supabase.com/docs/reference/self-hosting-analytics/list-sources#differences) may arise due to the platform's infrastructure.
...
## Backends Supported [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#backends-supported)
...
## Postgres Backend Setup [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#postgres-backend-setup)
...
### Configuration and Requirements [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#configuration-and-requirements)
...
## BigQuery Backend Setup [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#bigquery-backend-setup)
...
#### Setting up BigQuery Service Account [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#setting-up-bigquery-service-account)
...
#### Download the Service Account Keys [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#download-the-service-account-keys)
...
#### Docker Image Configuration [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#docker-image-configuration)
...
#### BigQuery Datset Storage Location [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#bigquery-datset-storage-location)
...
## Vector Usage [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#vector-usage)
...
## Differences from Platform [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#differences-from-platform)
...
## Production Recommendations [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#production-recommendations)

To self-host in a production setting, we recommend performing the following for a better experience.

### Ensure that Logflare is behind a firewall and restrict all network access to it besides safe requests. [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#ensure-that-logflare-is-behind-a-firewall-and-restrict-all-network-access-to-it-besides-safe-requests)
...
### Use a different Postgres Database to store Logflare data. [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#use-a-different-postgres-database-to-store-logflare-data)
...
### Use Big Query as the Logflare Backend [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#use-big-query-as-the-logflare-backend)
...
### Rotate Encryption Keys Regularly [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#rotate-encryption-keys-regularly)
...
### Client libraries [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#client-libraries)
...
### Integrations [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#integrations)
...
### Additional links [\#](https://supabase.com/docs/reference/self-hosting-analytics/list-sources\#additional-links)
