---
url: "https://supabase.com/docs/reference/python/storage-getbucket"
...
### Install with PyPi [\#](https://supabase.com/docs/reference/python/storage-getbucket\#install-with-pypi)
