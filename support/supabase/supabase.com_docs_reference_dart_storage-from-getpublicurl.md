...
Storage
  ...
  - File Buckets
    ...
    [File Buckets](https://supabase.com/docs/reference/dart/file-buckets) - [List all buckets](https://supabase.com/docs/reference/dart/storage-listbuckets)
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/storage-from-getpublicurl\#presence)
