---
url: "https://supabase.com/docs/reference/dart/explain"
...
Database
  ...
  - Using modifiers
    ...
    [Using modifiers](https://supabase.com/docs/reference/dart/using-modifiers) - [Return data after inserting](https://supabase.com/docs/reference/dart/db-modifiers-select)
...
### Install from pub.dev [\#](https://supabase.com/docs/reference/dart/explain\#install-from-pubdev)
...
## Upgrade the client library [\#](https://supabase.com/docs/reference/dart/explain\#upgrade-the-client-library)
...
### Auth updates [\#](https://supabase.com/docs/reference/dart/explain\#auth-updates)

#### Renaming Provider to OAuthProvider [\#](https://supabase.com/docs/reference/dart/explain\#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated [\#](https://supabase.com/docs/reference/dart/explain\#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh [\#](https://supabase.com/docs/reference/dart/explain\#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in [\#](https://supabase.com/docs/reference/dart/explain\#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type [\#](https://supabase.com/docs/reference/dart/explain\#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed [\#](https://supabase.com/docs/reference/dart/explain\#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed [\#](https://supabase.com/docs/reference/dart/explain\#supabaseauth-class-removed)
...
### Data methods [\#](https://supabase.com/docs/reference/dart/explain\#data-methods)

#### Insert and return data [\#](https://supabase.com/docs/reference/dart/explain\#insert-and-return-data)
...
#### Renaming is and in filter [\#](https://supabase.com/docs/reference/dart/explain\#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods [\#](https://supabase.com/docs/reference/dart/explain\#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes [\#](https://supabase.com/docs/reference/dart/explain\#postgrest-error-codes)
...
### Realtime methods [\#](https://supabase.com/docs/reference/dart/explain\#realtime-methods)
...
#### Postgres Changes [\#](https://supabase.com/docs/reference/dart/explain\#postgres-changes)
...
#### Broadcast [\#](https://supabase.com/docs/reference/dart/explain\#broadcast)
...
#### Presence [\#](https://supabase.com/docs/reference/dart/explain\#presence)
