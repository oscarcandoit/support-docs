---
url: "https://supabase.com/docs/reference/javascript/auth-admin-mfa-deletefactor"
...
### Install as package [\#](https://supabase.com/docs/reference/javascript/auth-admin-mfa-deletefactor\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/auth-admin-mfa-deletefactor\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/auth-admin-mfa-deletefactor\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/auth-admin-mfa-deletefactor\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/auth-admin-mfa-deletefactor\#using-typescript-type-definitions)
...
## Helper types for Tables and Joins [\#](https://supabase.com/docs/reference/javascript/auth-admin-mfa-deletefactor\#helper-types-for-tables-and-joins)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/auth-admin-mfa-deletefactor\#response-types-for-complex-queries)
