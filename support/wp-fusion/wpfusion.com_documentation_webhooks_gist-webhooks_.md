---
url: "https://wpfusion.com/documentation/webhooks/gist-webhooks/"
title: "Gist Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/gist-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/gist-webhooks/\#overview) Overview

You can use webhooks in Gist (with a _Plus_ plan) to send data back to your WordPress site using WP Fusion. Using these webhooks, you can create new users on your WordPress site, or update existing users’ meta data and tags.
...
#### [\#](https://wpfusion.com/documentation/webhooks/gist-webhooks/\#getting-started) Getting started
...
[![](https://wpfusion.com/wp-content/uploads/2019/01/Gist-webhooks-setup.jpeg)](https://wpfusion.com/wp-content/uploads/2019/01/Gist-webhooks-setup.jpeg)
...
#### [\#](https://wpfusion.com/documentation/webhooks/gist-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/gist-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/gist-webhooks/\#create-a-new-user) Create a new user
...
#### [\#](https://wpfusion.com/documentation/webhooks/gist-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/gist-webhooks/#overview)
- [Getting started](https://wpfusion.com/documentation/webhooks/gist-webhooks/#getting-started)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/gist-webhooks/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/gist-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/gist-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/gist-webhooks/#user-passwords)
