---
url: "https://wpfusion.com/documentation/webhooks/moosend-webhooks/"
title: "MooSend Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/moosend-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/moosend-webhooks/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/webhooks/moosend-webhooks/\#setup) Setup
...
[![](https://wpfusion.com/wp-content/uploads/2022/02/moosend-webhook-action-1024x506.jpeg)](https://wpfusion.com/wp-content/uploads/2022/02/moosend-webhook-action.jpeg)

Enter the webhook URL:

[![](https://wpfusion.com/wp-content/uploads/2022/02/moosend-webhook-url-1024x302.jpeg)](https://wpfusion.com/wp-content/uploads/2022/02/moosend-webhook-url.jpeg)

You have three options for the webhook, **update**, **update\_tags** and **add**(explained below). For each you will need to supply your access key, which can be obtained from the main panel in your WP Fusion settings.

For the structure of the webhook URL see the examples below:

#### [\#](https://wpfusion.com/documentation/webhooks/moosend-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/moosend-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/moosend-webhooks/\#create-a-new-user) Create a new user
...
**Note:** By default, user accounts will be created with their email address as the username and a randomly generated password. However, if you have created a custom username field and password field in MooSend, and enabled these fields in WP Fusion for sync with `user_login` and `user_pass` on your website, the new users will be given the usernames and passwords stored in their MooSend contact record.

#### [\#](https://wpfusion.com/documentation/webhooks/moosend-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/moosend-webhooks/#overview)
- [Setup](https://wpfusion.com/documentation/webhooks/moosend-webhooks/#setup)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/moosend-webhooks/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/moosend-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/moosend-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/moosend-webhooks/#user-passwords)
