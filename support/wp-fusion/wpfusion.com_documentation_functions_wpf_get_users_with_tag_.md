---
url: "https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/"
title: "wpf_get_users_with_tag() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/\#overview) Overview

This function returns an array of user IDs that have a specified tag. You can use either a tag ID or a label.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/\#parameters) Parameters

```php
wpf_get_users_with_tag( $tag )
```

- `$tag` _(string) (Required)_: The tag to search.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/\#return) Return

_(array)_`$user_ids` the user IDs with the tag.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/\#get-all-users-with-the-member-tag) Get all users with the Member tag

```php
$user_ids = wpf_get_users_with_tag( 'Member' );
```

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/\#get-all-users-with-tag-id-123) Get all users with tag ID 123
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/#return)
- [Get all users with the Member tag](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/#get-all-users-with-the-member-tag)
- [Get all users with tag ID 123](https://wpfusion.com/documentation/functions/wpf_get_users_with_tag/#get-all-users-with-tag-id-123)
