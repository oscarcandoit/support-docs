---
url: "https://wpfusion.com/documentation/functions/pull_user_meta/"
title: "pull_user_meta() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/pull_user_meta/#content)
...
### [\#](https://wpfusion.com/documentation/functions/pull_user_meta/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/functions/pull_user_meta/\#parameters) Parameters

```php
pull_user_meta( $user_id = false )
```

- `$user_id` _(Optional)_: the WordPress user ID to load the metadata for.

#### [\#](https://wpfusion.com/documentation/functions/pull_user_meta/\#returns) Returns

- `$user_meta`: array of key / value pairs of WordPress meta.

### [\#](https://wpfusion.com/documentation/functions/pull_user_meta/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/functions/pull_user_meta/\#load-a-number-and-increment-it) Load a number and increment it
...
- [Overview](https://wpfusion.com/documentation/functions/pull_user_meta/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/pull_user_meta/#parameters)
- [Returns](https://wpfusion.com/documentation/functions/pull_user_meta/#returns)
- [Examples](https://wpfusion.com/documentation/functions/pull_user_meta/#examples)
- [Load a number and increment it](https://wpfusion.com/documentation/functions/pull_user_meta/#load-a-number-and-increment-it)
