---
url: "https://wpfusion.com/documentation/functions/wpf_user_can_access/"
title: "wpf_user_can_access() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_user_can_access/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_user_can_access/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/functions/wpf_user_can_access/\#basic-usage) Basic Usage
...
#### [\#](https://wpfusion.com/documentation/functions/wpf_user_can_access/\#parameters) Parameters

```php
wpf_user_can_access( $post_id = false, $user_id = false )
```

- `$post_id` _(int) (Optional)_: The post ID to check.
- `$user_id` _(int) (Optional)_: The user ID to check.

#### [\#](https://wpfusion.com/documentation/functions/wpf_user_can_access/\#return) Return

_(bool)_ Whether the user can access the post.

#### [\#](https://wpfusion.com/documentation/functions/wpf_user_can_access/\#with-a-user-id) With a user ID
...
#### [\#](https://wpfusion.com/documentation/functions/wpf_user_can_access/\#within-a-loop) Within a loop
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_user_can_access/#overview)
- [Basic Usage](https://wpfusion.com/documentation/functions/wpf_user_can_access/#basic-usage)
- [Parameters](https://wpfusion.com/documentation/functions/wpf_user_can_access/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_user_can_access/#return)
- [With a user ID](https://wpfusion.com/documentation/functions/wpf_user_can_access/#with-a-user-id)
- [Within a loop](https://wpfusion.com/documentation/functions/wpf_user_can_access/#within-a-loop)
