---
url: "https://wpfusion.com/documentation/functions/push_user_meta/"
title: "push_user_meta() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/push_user_meta/#content)
...
### [\#](https://wpfusion.com/documentation/functions/push_user_meta/\#overview) Overview

This function allows you to sync WordPress user metadata to fields in your CRM.

#### [\#](https://wpfusion.com/documentation/functions/push_user_meta/\#sending-specific-data) Sending specific data
...
#### [\#](https://wpfusion.com/documentation/functions/push_user_meta/\#parameters) Parameters

```php
push_user_meta( $user_id, $user_meta = false )
```

- `$user_id` _(int) (Required)_: The user ID to push meta data to.
- `$user_meta` _(int) (Optional)_: The user meta to push.

#### [\#](https://wpfusion.com/documentation/functions/push_user_meta/\#return) Return

_(bool)_ The success status.

#### [\#](https://wpfusion.com/documentation/functions/push_user_meta/\#sending-all-user-data) Sending all user data
...
- [Overview](https://wpfusion.com/documentation/functions/push_user_meta/#overview)
- [Sending specific data](https://wpfusion.com/documentation/functions/push_user_meta/#sending-specific-data)
- [Parameters](https://wpfusion.com/documentation/functions/push_user_meta/#parameters)
- [Return](https://wpfusion.com/documentation/functions/push_user_meta/#return)
- [Sending all user data](https://wpfusion.com/documentation/functions/push_user_meta/#sending-all-user-data)
