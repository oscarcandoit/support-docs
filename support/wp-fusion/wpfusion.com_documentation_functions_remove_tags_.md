---
url: "https://wpfusion.com/documentation/functions/remove_tags/"
title: "remove_tags() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/remove_tags/#content)
...
### [\#](https://wpfusion.com/documentation/functions/remove_tags/\#overview) Overview

This function allows you to remove an array of tags (using tag IDs) from a user.

#### [\#](https://wpfusion.com/documentation/functions/remove_tags/\#parameters) Parameters

```php
remove_tags( $tags, $user_id = false )
```

- `$tags` _(array) (Required)_: The array of tags to remove.
- `$user_id` _(int) (Optional)_: The user ID to remove tags from.

#### [\#](https://wpfusion.com/documentation/functions/remove_tags/\#return) Return

_(bool)_ The success status.

#### [\#](https://wpfusion.com/documentation/functions/remove_tags/\#remove-tags-from-the-current-user) Remove tags from the current user
...
#### [\#](https://wpfusion.com/documentation/functions/remove_tags/\#remove-tags-from-a-specific-user-id) Remove tags from a specific user ID
...
The function will return `true` if the tags were removed successfully, and `false` if there was a connection error or the user wasn’t found in the CRM. Any errors will be logged to [the WP Fusion Logs](https://wpfusion.com/documentation/getting-started/activity-logs/).

### [\#](https://wpfusion.com/documentation/functions/remove_tags/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/functions/remove_tags/\#remove-a-tag-when-another-tag-is-applied) Remove a tag when another tag is applied
...
- [Overview](https://wpfusion.com/documentation/functions/remove_tags/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/remove_tags/#parameters)
- [Return](https://wpfusion.com/documentation/functions/remove_tags/#return)
- [Remove tags from the current user](https://wpfusion.com/documentation/functions/remove_tags/#remove-tags-from-the-current-user)
- [Remove tags from a specific user ID](https://wpfusion.com/documentation/functions/remove_tags/#remove-tags-from-a-specific-user-id)
- [Examples](https://wpfusion.com/documentation/functions/remove_tags/#examples)
- [Remove a tag when another tag is applied](https://wpfusion.com/documentation/functions/remove_tags/#remove-a-tag-when-another-tag-is-applied)
