---
url: "https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/"
title: "WooCommerce Troubleshooting | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/#content)
...
### [\#](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/\#use-a-test-user) Use a test user
...
### [\#](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/\#turn-on-logging) Turn on logging
...
### [\#](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/\#check-order-notes) Check order notes
...
### [\#](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/\#process-order-actions-again) Process order actions again
...
### [\#](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/\#disable-asynchronous-checkout) Disable asynchronous checkout
...
### [\#](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/\#default-settings) Default settings
...
#### [\#](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/\#create-contacts) Create Contacts
...
#### [\#](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/\#limit-user-roles) Limit user roles
...
- [Use a test user](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/#use-a-test-user)
- [Turn on logging](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/#turn-on-logging)
- [Check order notes](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/#check-order-notes)
- [Process order actions again](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/#process-order-actions-again)
- [Disable asynchronous checkout](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/#disable-asynchronous-checkout)
- [Default settings](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/#default-settings)
- [Create Contacts](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/#create-contacts)
- [Limit user roles](https://wpfusion.com/documentation/other-common-issues/woocommerce-troubleshooting/#limit-user-roles)
