---
url: "https://wpfusion.com/documentation/functions/wpf_is_staging_mode/"
title: "wpf_is_staging_mode() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_is_staging_mode/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_is_staging_mode/\#overview) Overview

This function checks if WP Fusion is in staging mode, `true` meaning yes.

#### [\#](https://wpfusion.com/documentation/functions/wpf_is_staging_mode/\#return) Return

_(bool)_ Whether WP Fusion is in staging mode.

#### [\#](https://wpfusion.com/documentation/functions/wpf_is_staging_mode/\#checks-if-wp-fusion-is-in-staging-mode) Checks if WP Fusion is in staging mode
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_is_staging_mode/#overview)
- [Return](https://wpfusion.com/documentation/functions/wpf_is_staging_mode/#return)
- [Checks if WP Fusion is in staging mode](https://wpfusion.com/documentation/functions/wpf_is_staging_mode/#checks-if-wp-fusion-is-in-staging-mode)
