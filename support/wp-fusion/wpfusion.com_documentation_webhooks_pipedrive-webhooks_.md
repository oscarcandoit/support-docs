---
url: "https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/"
title: "Pipedrive Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#automatic-setup-recommended) Automatic Setup (Recommended)
...
#### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#update-trigger) Update Trigger
...
#### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#add-trigger) Add Trigger
...
#### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#enable-notifications) Enable Notifications
...
### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#manual-setup) Manual Setup
...
[![](https://wpfusion.com/wp-content/uploads/2022/10/pipedrive-webhooks-2-1024x478.jpg)](https://wpfusion.com/wp-content/uploads/2022/10/pipedrive-webhooks-2-scaled.jpg)
...
In this case, we have selected _updated_, to trigger the webhook whenever a Contact is edited.

For the **Event object** field, select _person_.

Set the **Endpoint URL** following the examples below.

### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#webhook-url-parameters) Webhook URL parameters
...
#### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#create-a-new-user) Create a new user
...
#### [\#](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#overview)
- [Automatic Setup (Recommended)](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#automatic-setup-recommended)
- [Update Trigger](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#update-trigger)
- [Add Trigger](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#add-trigger)
- [Enable Notifications](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#enable-notifications)
- [Manual Setup](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#manual-setup)
- [Webhook URL parameters](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#webhook-url-parameters)
- [To update a user's tags](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#to-update-a-users-tags)
- [To update a user's tags and meta data](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/pipedrive-webhooks/#user-passwords)
