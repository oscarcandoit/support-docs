---
url: "https://wpfusion.com/documentation/webhooks/intercom-webhooks/"
title: "Intercom Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/intercom-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/intercom-webhooks/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/webhooks/intercom-webhooks/\#getting-started) Getting started
...
[![](https://wpfusion.com/wp-content/uploads/2018/01/intercom-webhooks-2-1024x389.jpg)](https://wpfusion.com/wp-content/uploads/2018/01/intercom-webhooks-2.jpg)

Click on **Webhooks** from the left sidebar to set up the webhook.

The webhook URL should follow one of the patterns below, using either “update\_tags”, “update” or “add”.

[![](https://wpfusion.com/wp-content/uploads/2018/01/intercom-webhooks-3-1024x951.jpg)](https://wpfusion.com/wp-content/uploads/2018/01/intercom-webhooks-3.jpg)
...
#### [\#](https://wpfusion.com/documentation/webhooks/intercom-webhooks/\#)

#### [\#](https://wpfusion.com/documentation/webhooks/intercom-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/intercom-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/intercom-webhooks/\#to-create-a-new-user) To create a new user
...
#### [\#](https://wpfusion.com/documentation/webhooks/intercom-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/intercom-webhooks/#overview)
- [Getting started](https://wpfusion.com/documentation/webhooks/intercom-webhooks/#getting-started)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/intercom-webhooks/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/intercom-webhooks/#to-update-a-users-tags-and-meta-data)
- [To create a new user](https://wpfusion.com/documentation/webhooks/intercom-webhooks/#to-create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/intercom-webhooks/#user-passwords)
