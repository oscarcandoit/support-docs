---
url: "https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/"
title: "wpf_pulled_user_meta | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/#content)
...
### [\#](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/\#parameters) Parameters

- `$user_meta`: Array of user meta data, in the format `array('meta_field' => 'value')`.
- `$user_id`: ID of the user being updated

### [\#](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/\#update-a-users-display-name-based-on-their-first-and-last-name) Update a user’s Display Name based on their first and last name
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/\#limit-the-fields-that-are-loaded-from-the-crm) Limit the fields that are loaded from the CRM
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/\#convert-a-role-title-to-a-role-slug) Convert a role title to a role slug
...
- [Overview](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/#overview)
- [Parameters](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/#parameters)
- [Examples](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/#examples)
- [Update a user's Display Name based on their first and last name](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/#update-a-users-display-name-based-on-their-first-and-last-name)
- [Limit the fields that are loaded from the CRM](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/#limit-the-fields-that-are-loaded-from-the-crm)
- [Convert a role title to a role slug](https://wpfusion.com/documentation/filters/wpf_pulled_user_meta/#convert-a-role-title-to-a-role-slug)
