---
url: "https://wpfusion.com/documentation/functions/wpf_get_contact_id/"
title: "wpf_get_contact_id() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_contact_id/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_contact_id/\#overview) Overview

This function retrieves a user’s CRM contact ID based on their WordPress user ID.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_contact_id/\#parameters) Parameters

```php
wpf_get_contact_id( $user_id = false, $force_update = false )
```

- `$user_id` _(int) (Optional)_: The user ID to the contact of.
- `$force_update` _(bool) (Optional)_: If the contact ID should be automatically saved.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_contact_id/\#return) Return

_(mixed)_ Returns a `string` of the contact ID, or `false` if nothing is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_contact_id/\#get-the-current-users-contact-id) Get the current user’s contact ID

```php
$contact_id = wpf_get_contact_id();
```

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_contact_id/\#get-the-contact-id-for-a-different-user) Get the contact ID for a different user

```php
$contact_id = wpf_get_contact_id( $user_id );
```

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_contact_id/\#force-an-update-of-the-users-contact-id-by-sending-an-api-call-to-your-crm) Force an update of the user’s contact ID by sending an API call to your CRM
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_contact_id/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/wpf_get_contact_id/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_contact_id/#return)
- [Get the current user's contact ID](https://wpfusion.com/documentation/functions/wpf_get_contact_id/#get-the-current-users-contact-id)
- [Get the contact ID for a different user](https://wpfusion.com/documentation/functions/wpf_get_contact_id/#get-the-contact-id-for-a-different-user)
- [Force an update of the user's contact ID by sending an API call to your CRM](https://wpfusion.com/documentation/functions/wpf_get_contact_id/#force-an-update-of-the-users-contact-id-by-sending-an-api-call-to-your-crm)
