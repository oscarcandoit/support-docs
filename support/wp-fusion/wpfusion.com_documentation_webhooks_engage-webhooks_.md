---
url: "https://wpfusion.com/documentation/webhooks/engage-webhooks/"
title: "Engage Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/engage-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/engage-webhooks/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/webhooks/engage-webhooks/\#setup) Setup
...
[![](https://wpfusion.com/wp-content/uploads/2022/12/engage-webhooks-2-1024x613.jpg)](https://wpfusion.com/wp-content/uploads/2022/12/engage-webhooks-2.jpg)

Add a new action, and from the dropdown, choose **Call webhook**.

[![](https://wpfusion.com/wp-content/uploads/2022/12/engage-webhooks-1024x562.jpg)](https://wpfusion.com/wp-content/uploads/2022/12/engage-webhooks.jpg)

Set the **Webhook URL** following the examples below.

### [\#](https://wpfusion.com/documentation/webhooks/engage-webhooks/\#webhook-url-parameters) Webhook URL parameters
...
#### [\#](https://wpfusion.com/documentation/webhooks/engage-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/engage-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/engage-webhooks/\#create-a-new-user) Create a new user
...
**Note:** By default, user accounts will be created with their email address as the username and a randomly generated password. However, if you have created a custom username field and password field in Engage , and enabled these fields in WP Fusion for sync with `user_login` and `user_pass` on your website, the new users will be given the usernames and passwords stored in their Engage contact record.

#### [\#](https://wpfusion.com/documentation/webhooks/engage-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/engage-webhooks/#overview)
- [Setup](https://wpfusion.com/documentation/webhooks/engage-webhooks/#setup)
- [Webhook URL parameters](https://wpfusion.com/documentation/webhooks/engage-webhooks/#webhook-url-parameters)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/engage-webhooks/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/engage-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/engage-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/engage-webhooks/#user-passwords)
