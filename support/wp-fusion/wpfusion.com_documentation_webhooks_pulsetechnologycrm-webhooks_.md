---
url: "https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/"
title: "PulseTechnologyCRM Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/\#workflow-method) Workflow Method

_(Recommended)_ The workflow method is best if you need to send a webhook to create or update a WordPress user as part of a specific process. For example:
...
To use webhooks in a workflow, first create a workflow at **Admin » Workflows** and add a webhook to it,  like in the example above. You have three options for the webhook, **update**, **update\_tags** and **add**(explained below). For each you will need to supply your access key, which can be obtained from the main panel in your WP Fusion settings.
...
### [\#](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/\#global-webhooks-method) Global Webhooks Method

_(Advanced)_ You can also set up webhooks which are global to your account. This is best if you’re manually editing contact records in PulseTechnologyCRM (outside of an automation) and need these changes synced to WordPress.
...
### [\#](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/\#webhook-url-parameters) Webhook URL parameters

You can format your webhook URL in a few different ways to customize the behavior:

#### [\#](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/\#create-a-new-user) Create a new user
...
#### [\#](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/#overview)
- [Workflow Method](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/#workflow-method)
- [Global Webhooks Method](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/#global-webhooks-method)
- [Webhook URL parameters](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/#webhook-url-parameters)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/pulsetechnologycrm-webhooks/#user-passwords)
