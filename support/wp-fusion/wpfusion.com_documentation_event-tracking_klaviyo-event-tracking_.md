---
url: "https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/"
title: "Klaviyo Event Tracking | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/#content)
...
### [\#](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/\#how-it-works) How it works
...
### [\#](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/\#how-it-looks) How it looks
...
### [\#](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/\#using-event-tracking-for-enhanced-ecommerce-data) Using event tracking for enhanced ecommerce data
...
- **Placed Order:** This event must be titled _Placed Order_ and contain at minimum a `value` field set to the total value of the order. In WP Fusion this uses the “Order Placed” trigger.
- **Ordered Product:** This event must be titled _Ordered Product_ and contain at minimum a `value` field that represents the total cost of the item. In WP Fusion this uses the “Purchased Product” trigger.

[![a wordpress admin dashboard shows the wp fusion plugin’s woocommerce settings, displaying event tracking automation triggers with order and product details, including integration options for klaviyo, event names, values, and test event data.](https://wpfusion.com/wp-content/uploads/2022/11/event-tracking-klaviyo-ecommerce-1024x907.jpg)](https://wpfusion.com/wp-content/uploads/2022/11/event-tracking-klaviyo-ecommerce.jpg) An example of the Event Tracking addon configured to track WooCommerce orders in Klaviyo
...
- [Overview](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/#overview)
- [How it works](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/#how-it-works)
- [How it looks](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/#how-it-looks)
- [Using event tracking for enhanced ecommerce data](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/#using-event-tracking-for-enhanced-ecommerce-data)
