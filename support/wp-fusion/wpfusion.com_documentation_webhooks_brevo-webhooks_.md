---
url: "https://wpfusion.com/documentation/webhooks/brevo-webhooks/"
title: "Brevo Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/brevo-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/brevo-webhooks/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/webhooks/brevo-webhooks/\#global-webhooks) Global Webhooks
...
[![](https://wpfusion.com/wp-content/uploads/2018/08/sendinblue-webhooks-3-1024x666.jpg)](https://wpfusion.com/wp-content/uploads/2018/08/sendinblue-webhooks-3.jpg)
...
### [\#](https://wpfusion.com/documentation/webhooks/brevo-webhooks/\#webhooks-in-workflows) Webhooks in Workflows
...
Make sure to check “ _I want to send contact properties to this webhook._” Now when the workflow is triggered the contact will be added to WordPress as a new user. There are several options for structuring the webhook URL, as follows:

### [\#](https://wpfusion.com/documentation/webhooks/brevo-webhooks/\#webhook-url-structure) Webhook URL structure

#### [\#](https://wpfusion.com/documentation/webhooks/brevo-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/brevo-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/brevo-webhooks/\#create-a-new-user) Create a new user
...
#### [\#](https://wpfusion.com/documentation/webhooks/brevo-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/brevo-webhooks/#overview)
- [Global Webhooks](https://wpfusion.com/documentation/webhooks/brevo-webhooks/#global-webhooks)
- [Webhooks in Workflows](https://wpfusion.com/documentation/webhooks/brevo-webhooks/#webhooks-in-workflows)
- [Webhook URL structure](https://wpfusion.com/documentation/webhooks/brevo-webhooks/#webhook-url-structure)
- [To update a user’s tags](https://wpfusion.com/documentation/webhooks/brevo-webhooks/#to-update-a-users-tags)
- [To update a user’s tags and meta data](https://wpfusion.com/documentation/webhooks/brevo-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/brevo-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/brevo-webhooks/#user-passwords)
