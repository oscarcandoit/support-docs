---
url: "https://wpfusion.com/documentation/functions/wpf_get_crm_field/"
title: "wpf_get_crm_field() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_crm_field/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_crm_field/\#overview) Overview

This function retrieves the CRM field ID for a single WordPress meta key.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_crm_field/\#parameters) Parameters

```php
wpf_get_crm_field( $meta_key, $default = false )
```

- `$meta_key` _(string) (Required)_: The meta key to retrieve the field ID of.
- `$default` _(bool) (Optional)_: The default value to return if no key is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_crm_field/\#return) Return

_(mixed)_ Returns a `string` of the CRM field or `false` if nothing is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_crm_field/\#get-a-crm-field-id) Get a CRM field ID

```php
$field_id = wpf_get_crm_field( $meta_key );
```

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_crm_field/\#get-a-crm-field-id-but-return-a-boolean-value-if-no-id-is-found) Get a CRM field ID, but return a boolean value if no ID is found
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_crm_field/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/wpf_get_crm_field/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_crm_field/#return)
- [Get a CRM field ID](https://wpfusion.com/documentation/functions/wpf_get_crm_field/#get-a-crm-field-id)
- [Get a CRM field ID, but return a boolean value if no ID is found](https://wpfusion.com/documentation/functions/wpf_get_crm_field/#get-a-crm-field-id-but-return-a-boolean-value-if-no-id-is-found)
