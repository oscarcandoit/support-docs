---
url: "https://wpfusion.com/documentation/functions/wpf_admin_override-2/"
title: "wpf_admin_override() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_admin_override-2/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_admin_override-2/\#overview) Overview

This function checks if the current user is an administrator and if administrators are excluded from restrictions.

#### [\#](https://wpfusion.com/documentation/functions/wpf_admin_override-2/\#return) Return

_(bool)_ Whether to do an admin override.

#### [\#](https://wpfusion.com/documentation/functions/wpf_admin_override-2/\#checks-the-current-user) Checks the current user
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_admin_override-2/#overview)
- [Return](https://wpfusion.com/documentation/functions/wpf_admin_override-2/#return)
- [Checks the current user](https://wpfusion.com/documentation/functions/wpf_admin_override-2/#checks-the-current-user)
