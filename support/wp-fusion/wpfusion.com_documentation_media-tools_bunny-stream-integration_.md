---
url: "https://wpfusion.com/documentation/media-tools/bunny-stream-integration/"
title: "Bunny Stream Integration | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/media-tools/bunny-stream-integration/#content)
...
### [\#](https://wpfusion.com/documentation/media-tools/bunny-stream-integration/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/media-tools/bunny-stream-integration/\#setup) Setup
...
- **data-wpf\_tags\_start**: These tags will be applied when the video is first played
- **data-wpf\_timecode**: This is a specific timecode at which you’d like to apply tags, either in seconds, mm:ss, or a percentage
- **data-wpf\_tags\_timecode**: These tags will be applied at the timecode specified by `wpf_timecode`
- **data-wpf\_tags\_complete:** These tags will be applied when the video is complete (when play percentage is greater than 95%)
...
These attributes would apply the tag _Started Video_ when the video is first played, and _Watched One Minute_ and _Engaged_ after one minute.
...
#### [\#](https://wpfusion.com/documentation/media-tools/bunny-stream-integration/\#multiple-timecodes) Multiple Timecodes
...
- [Overview](https://wpfusion.com/documentation/media-tools/bunny-stream-integration/#overview)
- [Setup](https://wpfusion.com/documentation/media-tools/bunny-stream-integration/#setup)
- [Multiple Timecodes](https://wpfusion.com/documentation/media-tools/bunny-stream-integration/#multiple-timecodes)
