---
url: "https://wpfusion.com/documentation/functions/wpf_get_option/"
title: "wpf_get_option() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_option/#content)
...
### [\#](https://wpfusion.com/documentation/functions/wpf_get_option/\#overview) Overview

This function retrieves an option from the WP Fusion settings based on a given settings key.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_option/\#parameters) Parameters

```php
wpf_get_option( $key, $default = false )
```

- `$key` _(string) (Required)_: The settings key to retrieve an option.
- `$default` _(string) (Optional)_: The default value to return if no type is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_option/\#return) Return

_(mixed)_ The options value.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_option/\#get-the-option-from-a-settings-key) Get the option from a settings key

```php
$option = wpf_get_option( $key );
```

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_option/\#get-an-option-from-a-settings-key-but-return-a-boolean-variable-if-none-are-found) Get an option from a settings key, but return a boolean variable if none are found
...
- [Overview](https://wpfusion.com/documentation/functions/wpf_get_option/#overview)
- [Parameters](https://wpfusion.com/documentation/functions/wpf_get_option/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_option/#return)
- [Get the option from a settings key](https://wpfusion.com/documentation/functions/wpf_get_option/#get-the-option-from-a-settings-key)
- [Get an option from a settings key, but return a boolean variable if none are found](https://wpfusion.com/documentation/functions/wpf_get_option/#get-an-option-from-a-settings-key-but-return-a-boolean-variable-if-none-are-found)
