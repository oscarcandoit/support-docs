---
url: "https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/"
title: "FluentCRM Abandoned Cart Tracking | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#content)
...
### [\#](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/\#setup-in-wordpress) Setup in WordPress
...
#### [\#](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/\#syncing-cart-fields) Syncing cart fields
...
#### [\#](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/\#recovery-urls) Recovery URLs
...
### [\#](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/\#setup-in-fluentcrm) Setup in FluentCRM
...
[![fluentcrm abandoned cart](https://wpfusion.com/wp-content/uploads/2023/03/fluentcrm-abandoned-cart.png)](https://wpfusion.com/wp-content/uploads/2023/03/fluentcrm-abandoned-cart.png)

In your email, you can dynamically include the cart recovery URL by inserting the merge tag using the merge code editor.

[![](https://wpfusion.com/wp-content/uploads/2023/03/fluentcrm-abandoned-cart-email-1024x619.jpg)](https://wpfusion.com/wp-content/uploads/2023/03/fluentcrm-abandoned-cart-email.jpg)

Publish the automation to make it live.

#### [\#](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/\#merging-the-cart-contents) Merging the cart contents

WP Fusion doesn’t have the ability to dynamically merge the cart contents into the abandoned cart email, but you _can_ [apply tags based on which products were abandoned](https://wpfusion.com/documentation/abandoned-cart-tracking/abandoned-cart-overview/#plugin-integrations).
...
[![](https://wpfusion.com/wp-content/uploads/2023/03/fcrm-abandoned-cart-conditions-1024x492.jpg)](https://wpfusion.com/wp-content/uploads/2023/03/fcrm-abandoned-cart-conditions.jpg) In this example the Fatal Error Notify checkout link is only shown if the customer has the Fatal Error Notify Pro tag (to indicate the product was abandoned in their cart).

#### [\#](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/\#benchmark-and-reporting) Benchmark and reporting

Finally, it’s recommended to end the automation with a benchmark (goal), to track the cart recovery rate of the campaign.

[![](https://wpfusion.com/wp-content/uploads/2023/03/fluentcrm-abandoned-cart-benchmark-1024x728.jpg)](https://wpfusion.com/wp-content/uploads/2023/03/fluentcrm-abandoned-cart-benchmark.jpg) This benchmark is triggered when the Abandoned Cart tag is removed after checkout, and allows you to track the recovery rate of your campaign.

The benchmark is triggered if the customer is still in the automation (i.e. the cart recovery email has been sent), and the _Abandoned Cart_ tag is removed.
...
[![](https://wpfusion.com/wp-content/uploads/2023/03/fluentcrm-abandoned-cart-reporting-1024x355.jpg)](https://wpfusion.com/wp-content/uploads/2023/03/fluentcrm-abandoned-cart-reporting-scaled.jpg) By adding a “Recovered Cart” goal to the automation, we can see the percentage of customers who finished checking out after receiving the cart recovery email.
...
### [\#](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/\#testing) Testing
...
[![](https://wpfusion.com/wp-content/uploads/2021/08/hubspot-abandoned-cart-logs-1024x550.jpg)](https://wpfusion.com/wp-content/uploads/2021/08/hubspot-abandoned-cart-logs.jpg) The [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/) show any data being sent to FluentCRM.
...
### [\#](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/\#further-reading) Further reading
...
- [Overview](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#overview)
- [Setup in WordPress](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#setup-in-wordpress)
- [Syncing cart fields](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#syncing-cart-fields)
- [Recovery URLs](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#recovery-urls)
- [Setup in FluentCRM](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#setup-in-fluentcrm)
- [Merging the cart contents](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#merging-the-cart-contents)
- [Benchmark and reporting](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#benchmark-and-reporting)
- [Testing](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#testing)
- [Further reading](https://wpfusion.com/documentation/abandoned-cart-tracking/fluentcrm-abandoned-cart-tracking/#further-reading)
