---
url: "https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/"
title: "NationBuilder Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/\#getting-started) Getting started
...
To add a new webhook first select a trigger from the _When to POST_ dropdown. In the example above we are sending the webhook whenever the person is changed.

Then enter the URL to your site, following the examples below:

#### [\#](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/\#to-update-a-users-tags) To update a user’s tags
...
#### [\#](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/\#to-update-a-users-tags-and-meta-data) To update a user’s tags and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/\#create-a-new-user) Create a new user
...
#### [\#](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/#overview)
- [Getting started](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/#getting-started)
- [To update a user's tags](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/#to-update-a-users-tags)
- [To update a user's tags and meta data](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/#to-update-a-users-tags-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/nationbuilder-webhooks/#user-passwords)
