---
url: "https://wpfusion.com/documentation/webhooks/customer-io-webhooks/"
title: "Customer.io Webhooks"
---

[Skip to content](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/#content)
...
### [\#](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/\#overview) Overview
...
### [\#](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/\#setup) Setup
...
[![](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-webhook-journey-1024x647.jpg)](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-webhook-journey.jpg)

In the workflow editor, select **Send and Receive Data** from the side panel, and connect it to your trigger.

[![](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-webhook-config-1024x309.jpg)](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-webhook-config-scaled.jpg)

In the webhook settings, enter the URL to your site following [the examples below](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/#webhook-url-parameters). For the webhook body, copy and paste the following code:
...
[![](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-webhook-test-result-1024x669.jpg)](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-webhook-test-result.jpg)
...
[![](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-webhooks-log-1024x331.jpg)](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-webhooks-log-scaled.jpg) The WP Fusion logs show a webhook was successfully received from Customer.io, and the contact’s meta and segments were loaded.
...
### [\#](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/\#webhook-url-parameters) Webhook URL parameters

You can format your webhook URL in a few different ways to customize the behavior:

#### [\#](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/\#to-update-a-users-segments) To update a user’s segments
...
#### [\#](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/\#to-update-a-users-segments-and-meta-data) To update a user’s segments and meta data
...
#### [\#](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/\#create-a-new-user) Create a new user
...
**Note:** By default, user accounts will be created with their email address as the username and a randomly generated password. However, if you have created a custom username field and password field in your Customer.io application, and enabled these fields in WP Fusion for sync with `user_login` and `user_pass` on your website, the new users will be given the usernames and passwords stored in their Customer.io contact record.

#### [\#](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/\#user-passwords) User passwords
...
- [Overview](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/#overview)
- [Setup](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/#setup)
- [Webhook URL parameters](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/#webhook-url-parameters)
- [To update a user's segments](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/#to-update-a-users-segments)
- [To update a user's segments and meta data](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/#to-update-a-users-segments-and-meta-data)
- [Create a new user](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/#create-a-new-user)
- [User passwords](https://wpfusion.com/documentation/webhooks/customer-io-webhooks/#user-passwords)
