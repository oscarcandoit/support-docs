---
url: "https://wpfusion.com/documentation/functions/wpf_get_user_id/"
title: "wpf_get_user_id() | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/functions/wpf_get_user_id/#content)
...
#### [\#](https://wpfusion.com/documentation/functions/wpf_get_user_id/\#parameters) Parameters

```php
wpf_get_user_id( $contact_id )
```

- `$contact_id` _(string) (Required)_: The contact ID to search by.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_user_id/\#return) Return

_(mixed)_ An `int` of the user ID, or `false` if nothing is found.

#### [\#](https://wpfusion.com/documentation/functions/wpf_get_user_id/\#get-the-current-users-id) Get the current user’s ID
...
- [Parameters](https://wpfusion.com/documentation/functions/wpf_get_user_id/#parameters)
- [Return](https://wpfusion.com/documentation/functions/wpf_get_user_id/#return)
- [Get the current user's ID](https://wpfusion.com/documentation/functions/wpf_get_user_id/#get-the-current-users-id)
