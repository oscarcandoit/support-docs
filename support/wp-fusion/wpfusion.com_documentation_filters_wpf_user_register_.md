---
url: "https://wpfusion.com/documentation/filters/wpf_user_register/"
title: "wpf_user_register | WP Fusion"
---

[Skip to content](https://wpfusion.com/documentation/filters/wpf_user_register/#content)
...
### [\#](https://wpfusion.com/documentation/filters/wpf_user_register/\#overview) Overview
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_user_register/\#parameters) Parameters
...
### [\#](https://wpfusion.com/documentation/filters/wpf_user_register/\#examples) Examples

#### [\#](https://wpfusion.com/documentation/filters/wpf_user_register/\#correct-an-invalid-input-field-name-on-a-registration-form) Correct an invalid input field name on a registration form
...
#### [\#](https://wpfusion.com/documentation/filters/wpf_user_register/\#preventing-a-user-from-being-synced-to-the-crm) Preventing a user from being synced to the CRM

If you return `null` from the `wpf_user_register` filter, WP Fusion will not create a contact record in your CRM.

In this example we prevent a contact record from being created at registration if the user has the _author_ role:
...
- [Overview](https://wpfusion.com/documentation/filters/wpf_user_register/#overview)
- [Parameters](https://wpfusion.com/documentation/filters/wpf_user_register/#parameters)
- [Examples](https://wpfusion.com/documentation/filters/wpf_user_register/#examples)
- [Correct an invalid input field name on a registration form](https://wpfusion.com/documentation/filters/wpf_user_register/#correct-an-invalid-input-field-name-on-a-registration-form)
- [Preventing a user from being synced to the CRM](https://wpfusion.com/documentation/filters/wpf_user_register/#preventing-a-user-from-being-synced-to-the-crm)
