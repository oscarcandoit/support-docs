---
url: "https://help.gohighlevel.com/support/solutions/articles/48001204042"
title: " How to set up Facebook Ad Reporting : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/48001204042#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/48001204042#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
[**Before we get started, please review the notes below:**](https://help.gohighlevel.com/support/solutions/articles/48001204042#Before-we-get-started,-please-review-the-notes-below%3A)

[Entry Points:](https://help.gohighlevel.com/support/solutions/articles/48001204042#Entry-Points%3A-)

[The following UTM tracking parameters are available on the contact level within the system:](https://help.gohighlevel.com/support/solutions/articles/48001204042#The-following-UTM-tracking-parameters-are-available-on-the-contact-level-within-the-system%3A)

[**How to label your campaigns within Facebook to ensure accurate reporting**](https://help.gohighlevel.com/support/solutions/articles/48001204042#How-to-label-your-campaigns-within-Facebook-to-ensure-accurate-reporting)

**[How to add UTM Parameters in Facebook Ads Manager](https://help.gohighlevel.com/support/solutions/articles/48001204042#How-to-add-UTM-Parameters-in-Facebook-Ads-Manager)**

[**Attribution Reporting**](https://help.gohighlevel.com/support/solutions/articles/48001204042#Attribution-Reporting)

[**Troubleshooting**](https://help.gohighlevel.com/support/solutions/articles/48001204042#Troubleshooting)

- [Q1: When previewing my Ad in FB I do not see the UTM parameters?](https://help.gohighlevel.com/support/solutions/articles/48001204042#Q1%3A-When-previewing-my-Ad-in-FB-I-do-not-see-the-UTM-parameters?)
- [Q2: I'm not seeing first attribution data from contacts?](https://help.gohighlevel.com/support/solutions/articles/48001204042#Q2%3A-I'm-not-seeing-first-attribution-data-from-contacts?)
- [Q3: I changed something in my Ad, Ad-set, or campaign and now my reporting is off?](https://help.gohighlevel.com/support/solutions/articles/48001204042#Q3%3A-I-changed-something-in-my-Ad,-Ad-set,-or-campaign-and-now-my-reporting-is-off?)
- [Q4: I do not have a Facebook Business Account or Ads manager?](https://help.gohighlevel.com/support/solutions/articles/48001204042#Q4%3A-I-do-not-have-a-Facebook-Business-Account-or-Ads-manager?)
- [Q5: I'm using Facebook Lead-gen Ads do I still need to use UTM parameters](https://help.gohighlevel.com/support/solutions/articles/48001204042#Q5%3A%C2%A0I'm-using-Facebook-Lead-gen-Ads-do-I-still-need-to-use-UTM-parameters)
- [Q6: Where should we add UTM parameters in tracking or destination url?](https://help.gohighlevel.com/support/solutions/articles/48001204042#Q6%3A-Where-should-we-add-UTM-parameters-in-tracking-or-destination-url?)
- [Q7: What is the Objectives drop down for?](https://help.gohighlevel.com/support/solutions/articles/48001204042#Q7%3A-What-is-the-Objectives-drop-down-for?)
...
- Campaign name, Ads and Ad-set's need to be unique (see " [CORRECT SETUP Example](https://help.gohighlevel.com/support/solutions/articles/48001204042#How-to-label-your-campaigns-within-Facebook-to-ensure-accurate-reporting)" above)
- The name parameters can’t be changed during the lifetime of the campaign / Ad-set / Ad. If the name has to be changed, then create a different campaign / Ad-set / Ad.
- If you decided to change the campaign / Ad-set / Ad and do NOT create a new campaign, then data in the CRM system will keep referring to the original/ first campaign.
...
Yes, when running FB lead-gen ads we do recommend using UTM parameters for improved reporting. You can achieve this by adding UTM parameters as [mentioned in this article](https://help.gohighlevel.com/support/solutions/articles/48001204042#How-to-add-UTM-Parameters-in-Facebook-Ads-Manager).
...
0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/48001204042)
