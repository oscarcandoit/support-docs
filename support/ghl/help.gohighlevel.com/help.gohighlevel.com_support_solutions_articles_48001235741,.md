---
url: "https://help.gohighlevel.com/support/solutions/articles/48001235741,"
title: " How to set up the NMI integration? : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/48001235741,#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/48001235741,#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
Modified on: Fri, 3 Oct, 2025 at 2:03 AM
...
#### [**What does NMI have to offer?**](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#What-does-NMI-have-to-offer?)

#### **[How can I enable payments via NMI?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#How-can-I-enable-payments-via-NMI?)**

#### [Enter the required Gateway Id and API keys with NMI:](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Enter-the-required-Gateway-Id-and-API-keys-with-NMI%3A)

#### [**FAQs**](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#FAQs)

- #### [Where can I use the NMI integration to accept payments?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Where-can-I-use-the-NMI-integration-to-accept-payments?)

- #### [Will I be required to create new products for using the integration? How should I sync the products with my payment provider?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Will-I-be-required-to-create-new-products-for-using-the-integration?-How-should-I-sync-the-products-with-my-payment-provider?)

- #### [What payment methods are supported using NMI? Are Apple Pay, Google Pay, and e-check payment methods supported?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#What-payment-methods-are-supported-using-NMI?-Are-Apple-Pay,-Google-Pay,-and-e-check-payment-methods-supported?)

- #### [Is 3DS supported with the NMI integration?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Is-3DS-supported-with-the-NMI-integration?%C2%A0)

- #### [Can I use Stripe to offer Google Pay and Apple Pay and process credit card payments using NMI/Authorize.net?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Can-I-use-Stripe-to-offer-Google-Pay-and-Apple-Pay-and-process-credit-card-payments-using-NMI/Authorize.net?%C2%A0)

- #### [Will recurring purchases be supported with NMI? Where can I find the track of subscriptions and orders placed?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Will-recurring-purchases-be-supported-with-NMI?-Where-can-I-find-the-track-of-subscriptions-and-orders-placed?)

- #### [I am already using Stripe. Do I need to disconnect Stripe to connect to NMI?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#I-am-already-using-Stripe.-Do-I-need-to-disconnect-Stripe-to-connect-to-NMI?)

- #### [What is the meaning of the Default gateway at the top of the Integrations page?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#What-is-the-meaning-of-the-Default-gateway-at-the-top-of-the-Integrations-page?)

- #### [Why don't I see Paypal among the default gateway options?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Why-don't-I-see-Paypal-among-the-default-gateway-options?)

- #### [I have connected to NMI and have selected it as the default gateway. Will transactions across the application be processed through NMI now?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#I-have-connected-to-NMI-and-have-selected-it-as-the-default-gateway.-Will-transactions-across-the-application-be-processed-through-NMI-now?)

- #### [What will change in the reporting of transactions done with Authorize.net? Where will I be able to keep track of all payments?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#What-will-change-in-the-reporting-of-transactions-done-with-Authorize.net?-Where-will-I-be-able-to-keep-track-of-all-payments?)

- #### [How do I Cancel/End a subscription created via NMI/Authorize.net? I am not able to do so in the merchant portal.](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#How-do-I-Cancel/End-a-subscription-created-via-NMI/Authorize.net?-I-am-not-able-to-do-so-in-the-merchant-portal.)

- #### [Will I be able to refund transactions as well within the application itself?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Will-I-be-able-to-refund-transactions-as-well-within-the-application-itself?)

- #### [Where will I be able to find the subscriptions created via NMI? I cannot relate to the subscription status defined on the Subscriptions page.](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Where-will-I-be-able-to-find-the-subscriptions-created-via-NMI?-I-cannot-relate-to-the-subscription-status-defined-on-the-Subscriptions-page.)

- #### [When will the NMI integration be available for Calendar payments/memberships and other areas?](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#When-will-the-NMI-integration-be-available-for-Calendar-payments/memberships-and-other-areas?)


#### [**Additional resources for reference**](https://help.gohighlevel.com/support/solutions/articles/48001235741,\#Additional-resources-for-reference-)
...
Yes, we added 3DS support in Sept 2025 and all cards where 3DS is needed must work seamlessly with NMI. A quick one-time setup is required to enable 3DS:
...
- [List of countries and bank acquirers available with NMI](https://help.gohighlevel.com/support/solutions/articles/155000001988-list-of-countries-and-bank-acquirers-available-with-nmi)
- [Square Payments: Smoother and More Secure Payments with 3D Secure (3DS)](https://help.gohighlevel.com/support/solutions/articles/155000006629-square-payments-smoother-and-more-secure-payments-with-3d-secure-3ds-)
...
0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/48001235741,)

[Home](https://help.gohighlevel.com/support/home) [Knowledge base](https://help.gohighlevel.com/support/solutions)![Article views count](https://help.gohighlevel.com/support/solutions/articles/48001235741-how-to-set-up-the-nmi-integration-/hit)