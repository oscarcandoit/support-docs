---
url: "https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know"
title: " Agency Company Settings in HighLevel: Full Setup Guide : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
6. Agency Company Settings in HighLevel
...
Modified on: Wed, 24 Sep, 2025 at 5:53 AM

An Inside Look at Agency Company Settings- What You Need to Know - YouTube
...
[An Inside Look at Agency Company Settings- What You Need to Know](https://www.youtube.com/watch?v=nKWNYAEdSzw)
...
[Watch on](https://www.youtube.com/watch?v=nKWNYAEdSzw&embeds_referring_euri=https%3A%2F%2Fhelp.gohighlevel.com%2F)
...
- [Key Benefits of Agency Company Settings](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know#Key-Benefits-of-Agency-Company-Settings)
- [What are Agency Company Settings (and How do you access Them)?](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know#What-are-Agency-Company-Settings-(and-How-do-you-access-Them)?)
- [Part 1: Basic Details Tab](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know#Part-1%3A-Basic-Details-Tab)
- [Part 2: Whitelabel Tab](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know#Part-2%3A-Whitelabel-Tab)
- [Part 3: Advanced Settings](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know#Part-3%3A-Advanced-Settings)
- [Frequently Asked Questions](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know#Frequently-Asked-Questions)
- [Related Articles](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know#Related-Articles)
...
Use custom code to style your agency dashboard and add third-party tools or custom logic.

- **Custom JavaScript**: For live chat widgets, Google Analytics, tracking pixels, etc.
- **Custom CSS**: For styling the platform, hiding elements, and adjusting branding.
...
### **Custom CSS: What You Can & Cannot Customize**

Custom CSS allows you to adjust the look and feel of HighLevel’s interface, but it’s important to know what’s supported and what is not. Below are safe customization options, practical examples, and areas you should avoid.

#### **What You Can Customize**

You can safely adjust styling for client-facing and dashboard elements.

**Login Page**

```
/* Change login button color */ .login__button {  background-color: #2E86C1 !important; }
 /* Resize login logo */ .login__logo img {  max-height: 80px !important; }
```

**Agency/Account Sidebar**

```
/* Hide Opportunities tab */ .hl_navItem[data-id="opportunities"] {  display: none !important; }
 /* Change sidebar background */ .hl_sidebar {  background: #1F2937 !important; }
```

**Header Bar**

```
/* Change top header background */ .hl_topHeader {  background: #111827 !important; }
```

**Calendars & Form Widgets**

```
/* Adjust form field styling */ .hl_formField input {  border-radius: 8px !important;  border: 2px solid #2E86C1 !important; }
```

**Funnels & Websites**

- Each funnel step has its own CSS panel.

- The global CSS panel applies across steps.


* * *

#### **What You Cannot (or Should Not) Customize**

Avoid applying CSS to the following areas, as it may cause errors or break after updates:

- Mobile apps (iOS/Android) — CSS is not supported.
- React pop-ups (e.g., Payments modals).
- Back-end generated PDF invoices/receipts.
- Core drag-and-drop builder UI (elements may shift after updates).
- Any element without a stable class or data-id.

```
Caution : After any platform update, re-check your CSS with Chrome DevTools. Unsupported overrides may stop working and can cause blank screens or broken layouts.

Always wrap your rules in <style>...</style> when pasting into the Custom CSS editor.
```

1. Right-click on the element in your HighLevel dashboard.

2. Select **Inspect** to open Chrome DevTools.

3. Copy the selector.

4. Paste it into **Company Settings → Whitelabel → Custom CSS**.
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155044341267/original/S2gnDtDeu-ci8c2_G-OBJmQeClctxiYHNA.png?1743521189)
...
0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/48000982604-an-inside-look-at-agency-company-settings-what-you-need-to-know)

[Home](https://help.gohighlevel.com/support/home) [Knowledge base](https://help.gohighlevel.com/support/solutions)![Article views count](https://help.gohighlevel.com/support/solutions/articles/48000982604-agency-company-settings-in-highlevel/hit)