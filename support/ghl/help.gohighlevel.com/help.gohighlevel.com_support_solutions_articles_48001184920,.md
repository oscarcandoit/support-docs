---
url: "https://help.gohighlevel.com/support/solutions/articles/48001184920,"
title: " SaaS Mode - Full Setup Guide + FAQ : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/48001184920,#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/48001184920,#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
- [What is SAAS?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#What-is-SAAS?)
- [Why use Highlevel's SaaS Mode?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Why-use-Highlevel's-SaaS-Mode?)

- [A Step-by-step Setup Guide to SaaS Mode](https://help.gohighlevel.com/support/solutions/articles/48001184920,#A-Step-by-step-Setup-Guide-to-SaaS-Mode)
- [Agency Account Setup](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Agency-Account-Setup)
  - [Step 1: Create an Agency Sub-Account - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-1%3A-Create-an-Agency-Sub-Account---(Skip-if-you-have-already-completed-this-step))
  - [Step 2: Activating Telephony System - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-2%3A-Activating-Telephony-System%C2%A0--(Skip-if-you-have-already-completed-this-step))
  - [Step 3: Setup White-labeled Login Domain - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-3%3A-Setup-White-labeled-Login-Domain%C2%A0--(Skip-if-you-have-already-completed-this-step))
  - [Step 4: Setup API Domain URL - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-4%3A-Setup-API-Domain-URL%C2%A0--(Skip-if-you-have-already-completed-this-step))
  - [Step 5: Upload Logo & Activate Premium features - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-5%3A-Upload-Logo-&-Activate-Premium-features%C2%A0--(Skip-if-you-have-already-completed-this-step))
  - [Step 6: Connect Stripe Account on the (Agency Level) - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-6%3A-Connect-Stripe-Account-on-the-(Agency-Level)%C2%A0--(Skip-if-you-have-already-completed-this-step))
  - [Step 7: SaaS Configurator Setup - Configuring Your Plans & Features](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-7%3A-SaaS-Configurator-Setup---Configuring-Your-Plans-&-Features)
- [Sub-Account Setup](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Sub-Account-Setup)
  - [Step 8: General Business Settings - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-8%3A-General-Business-Settings%C2%A0--(Skip-if-you-have-already-completed-this-step))
  - [Step 9: Website Domain Setup - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-9%3A-Website-Domain-Setup%C2%A0--(Skip-if-you-have-already-completed-this-step))
  - [Step 10: Purchasing a Phone Number - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-10%3A-Purchasing-a-Phone-Number%C2%A0--(Skip-if-you-have-already-completed-this-step))
  - [Step 11: Calendar Configuration - (Optional)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-11%3A%C2%A0Calendar-Configuration%C2%A0--(Optional))
  - [Step 12: Integrating Stripe on the Sub-Account Level (Where you will sell your SaaS) - (Skip if you have already completed this step)](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-12%3A-Integrating-Stripe-on-the-Sub-Account-Level-(Where-you-will-sell-your-SaaS)%C2%A0--(Skip-if-you-have-already-completed-this-step))
  - [Step 14: Import SaaS Config Plans & Setting up your Sales Page](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-14%3A-Import-SaaS-Config-Plans-&-Setting-up-your-Sales-Page%C2%A0)
  - [Setting up your Funnel/ Website](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Setting-up-your-Funnel/-Website)
  - [Step 15: Workflow Setup to notify you of 'New Sign-ups'](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-15%3A-Workflow-Setup-to-notify-you-of-'New-Sign-ups')
  - [Step 16: Build A Notification Workflow & Testing Your SaaS Flow](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Step-16%3A%C2%A0Build-A-Notification-Workflow-&-Testing-Your-SaaS-Flow)
- [Troubleshooting](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Troubleshooting)

- [What happens when someone signs up?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#What-happens-when-someone-signs-up?)
- [Can clients control their rebilling settings?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Can-clients-control-their-rebilling-settings?)
- [Can I sell SaaS Mode in a different currency?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Can-I-sell-SaaS-Mode-in-a-different-currency?)
- [Why is my subaccount not created when purchasing on the SaaS funnel?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Why-is-my-subaccount-not-created-when-purchasing-on-the-SaaS-funnel?)
- [Can I use SaaS Mode just for Twilio Rebilling (no plans)?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Can-I-use-SaaS-Mode-just-for-Twilio-Rebilling-(no-plans)?%C2%A0)
- [What about Tax?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#What-about-Tax?)
- [How can I add my products/services to SaaS Products?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#How-can-I-add-my-products/services-to-SaaS-Products?)
- [How can I change the price of SaaS Mode for a specific client?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#How-can-I-change-the-price-of-SaaS-Mode-for-a-specific-client?)
- [Can I change the permissions of an existing SaaS Mode sub-account?](https://help.gohighlevel.com/support/solutions/articles/48001184920,#Can-I-change-the-permissions-of-an-existing-SaaS-Mode-sub-account?)
...
0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/48001184920,)
