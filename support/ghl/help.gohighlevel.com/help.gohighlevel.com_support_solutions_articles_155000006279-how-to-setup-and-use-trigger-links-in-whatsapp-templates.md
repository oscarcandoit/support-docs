---
url: "https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates"
title: " How to Setup and Use Trigger Links in WhatsApp Templates : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
6. How to Setup and Use Trigger Links in WhatsApp Templates
...
Modified on: Tue, 9 Sep, 2025 at 2:42 PM
...
- [What is Trigger Link in WhatsApp Templates?](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#What-is-Trigger-Link-in%C2%A0WhatsApp-Templates?)
- [Key Benefits of Trigger Link in WhatsApp Templates](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Key-Benefits-of-Trigger-Link-in-WhatsApp-Templates%C2%A0)
- [Prerequisites](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Prerequisites)
- [WhatsApp Trigger Link Options (Choose One or Use Both)](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#WhatsApp-Trigger-Link-Options-(Choose-One-or-Use-Both))
- [Button Limits & Design Guidelines](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Button-Limits-&-Design-Guidelines)
- [How To Setup & Use Trigger Links in WhatsApp Templates](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#How-To-Setup-&-Use-Trigger-Links-in%C2%A0WhatsApp-Templates%C2%A0)
  - [Step 1: Create a Trigger Link](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Step-1%3A%C2%A0Create-a-Trigger-Link)
  - [Step 2: Create a WhatsApp Template](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Step-2%3A%C2%A0Create-a-WhatsApp-Template)
  - [Step 3: Add a Triggered CTA](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Step-3%3A-Add-a-Triggered-CTA-(Choose-A-or-B))
    - [A) Trigger Link Button (recommended)](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#A)-Trigger-Link-Button-(recommended))
    - [B) Inline Trigger Link (body text)](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#B)-Inline-Trigger-Link-(body-text))
  - [Step 4: Submit and Approve](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Step-4%3A%C2%A0Submit-and-Approve)
  - [Step 5: Track via Workflow](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Step-5%3A%C2%A0Track-via-Workflow%C2%A0)
- [Frequently Asked Questions](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Frequently-Asked-Questions)
- [Related Articles](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates#Related-Articles)
...
![](https://jumpshare.com/share/1hddN9YA9hV2zGO1r5Ur+/GIF+Recording+2025-09-09+at+10.47.53+PM.gif)

2. Click **Add Link**, name it (e.g., 20% Off Introductory Offer), and paste the destination URL (e.g., landing page with form).

3. Click **Save**.



![](https://jumpshare.com/share/YI6cvgrsItux5YQdBO5V+/Screen+Shot+2025-09-09+at+10.52.46+PM.png)


### **Step 2:** Create a WhatsApp Template

1. Go to **Settings → WhatsApp → Templates** and click **Create Template**.



![](https://jumpshare.com/share/KhynY0il5K98xUlKoRID+/GIF+Recording+2025-09-09+at+10.57.41+PM.gif)

2. Fill in **Template name**, set **Category** (e.g., Marketing), and **Language**.

3. (Optional) Add a **Header** (e.g., Image logo) for visual impact.

4. Write the **Body** copy. Add variables where needed (e.g., contact **First Name**); include **sample content** for approval.

5. (Optional) Add a **Footer** (e.g., “Reply STOP to opt out”).



**![](https://jumpshare.com/share/5g5li2TrM5VfjL6wWcrE+/GIF+Recording+2025-09-09+at+11.02.14+PM.gif)**
...
1. In the template editor, add **Button → Type: Trigger Link**.

2. Select the **Trigger Link** you created in Step 1.

3. Keep total buttons **≤ 2**.

4. Click on the **Create** button.



![](https://jumpshare.com/share/jpzQXWHgdKAOgfpRixks+/GIF+Recording+2025-09-09+at+11.08.59+PM.gif)


#### **B) Inline Trigger Link (body text)**

1. Place the cursor in the **Body** where the URL should appear.

2. Click **Add variable**, then map that variable to your **Trigger Link** (e.g., 20% Off Introductory Offer).

3. Add **sample content** (paste the destination URL) for Meta approval.



**![](https://jumpshare.com/share/npixuhtkSElsxK1hXAz4+/GIF+Recording+2025-09-09+at+11.18.27+PM.gif)**


### **Step 4:** Submit and Approve

1. Click **Create/Save** to submit the template to **Meta** for approval.

2. After approval, your template will show as **Active**.



![](https://jumpshare.com/share/JJ5VmeiZ0xfp5KlUj0tQ+/Screen+Shot+2025-09-10+at+12.48.13+AM.png)


### **Step 5:** Track via Workflow

1. Go to **Automation → Workflows → Create from scratch** (name it e.g., Track 20% Offer – WhatsApp).

2. Click **Add New Trigger.**

3. Select **Trigger Link Clicked** as the workflow trigger.

4. Click on the **Add Filters** button and from the select drop-down, choose **Trigger Link**.

5. Then select the **link you have previously created** and used in the WhatsApp template.

6. Click on the **Save Trigger** button.

7. **Publish** the workflow and monitor results in **Workflow History** and **Template Analytics** (deliver, read, button clicks).



![](https://jumpshare.com/share/f51lXJvSrIOgHrV8c7Qu+/GIF+Recording+2025-09-10+at+12.54.36+AM.gif)
...
- [Interactive WhatsApp Messages](https://help.gohighlevel.com/en/support/solutions/articles/155000006082)
...
0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates)

[Home](https://help.gohighlevel.com/support/home) [Knowledge base](https://help.gohighlevel.com/support/solutions)![Article views count](https://help.gohighlevel.com/support/solutions/articles/155000006279-how-to-setup-and-use-trigger-links-in-whatsapp-templates/hit)