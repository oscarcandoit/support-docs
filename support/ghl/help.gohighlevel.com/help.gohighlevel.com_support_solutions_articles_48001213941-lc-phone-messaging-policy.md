...
title: " LC - Phone Messaging Policy : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
- [LC - Phone Messaging Policy](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#LC---Phone-Messaging-Policy)
  - [How We Handle Violations?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#How-We-Handle-Violations?)
- [1\. SMS Ramp-Up Model (V2):](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#1.-Ramp-Up-Model-(V2)%3A)
  - [Why the change?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#Why-the-change?)
  - [How to update the limit for a sub-account?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#How-to-update-the-limit-for-a-sub-account?)
- [2\. Spam Message Handling:](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#2.-Spam-Message-Handling%3A)
  - [Spam messaging error screens:](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#Spam-messaging-error-screens%3A)
  - [How to revoke the DND for a contact?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#How-to-revoke-the-DND-for-a-contact?)
- [3\. Opt-Out Language addition](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#3.-Opt-Out-Language-addition)


  - [Sample Opt-Out Language message screen:](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#Sample-Opt-Out-Language-message-screen%3A)

  - [How can I customize the opt-out message?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#How-can-I-customize-the-opt-out-message?)
  - [What happens if my message already has an opt-out keyword?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#What-happens-if-my-message-already-has-an-opt-out-keyword?)
  - [What happens when an end-user replies with the STOP keyword?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#What-happens-when-an-end-user-replies-with-the-STOP-keyword?)
- [4\. Sender Information addition](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#4.-Sender-Information-addition)
  - [How can I customize the opt-out message?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#How-can-I-customize-the-opt-out-message?-4)
- [5\. Error and Opt-out Rate Monitoring](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#5.-Error-and-Opt-out-Rate-Monitoring)

  - [What should we do when we get a violation email?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#What-should-we-do-when-we-get-a-violation-email?)
  - [Stop all your workflows, campaigns, triggers, and/or bulk actions to contacts who have not explicitly opted in to receive messages from the sub-account.](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#Stop-all-your-workflows,-campaigns,-triggers,-and/or-bulk-actions-to-contacts-who-have-not-explicitly-opted-in-to-receive-messages-from-the-sub-account.)
  - [What are error and opt-out rates and good to have a threshold?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#What-are-error-and-opt-out-rates-and-good-to-have-a-threshold?)
  - [What do I do to get the subaccount suspension removed early?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#What-do-I-do-to-get-the-subaccount-suspension-removed-early?)
- [FAQs](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#FAQs)

  - [How often does the SMS limit last?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#How-often-does-the-SMS-limit-last?)
  - [I'd like to send more than 5000 SMS per day, how can I increase my limit?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#I'd-like-to-send-more-than-5000-SMS-per-day,-how-can-I-increase-my-limit?)
  - [What happens when we hit our daily limit, will we be able to respond to SMS if a lead replies?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#What-happens-when-we-hit-our-daily-limit,-will-we-be-able-to-respond-to-SMS-if-a-lead-replies?)
  - [Can we undo the DND option in bulk?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#Can-we-undo-the-DND-option-in-bulk?)
  - [Is the auto append Sender ID and Opt-Out Language feature applying to every first text of workflow or manual SMS as well?](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#Is-the-auto-append-Sender-ID-and-Opt-Out-Language-feature-applying-to-every-first-text-of-workflow-or-manual-SMS-as-well?)
  - [Related articles:](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy#Related-articles%3A-7)
...
### **Sample Opt-Out Language message screen:**  **![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155053453499/original/QjJraDPQbBjkiFGdJqmioh3v3Rm-P-b_9w.png?1757497254)**

## **How can I customize the opt-out message?**

Go to **Sub-account** -\> **Settings** -\> phone numbers -> advanced setting -> sms complaince where you can customize the opt-out message, below is the screenshot for reference:![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155053453762/original/-GbEFXZQWEdvoFpHxolBlf7ptBnchqL_JA.png?1757497403)![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155053454589/original/gDvz85IoJrfz0wAcKas2Ug3-vUZNGpyHXg.png?1757497788)
...
**Here’s the split of warning and suspension email thresholds for L1 and L2 ramp.**



**![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155053477221/original/Xp3s0hAvDx-YAUbpTbBVFfM0ttJRtzWvxw.png?1757508465)**
...
- [Toll-Free Number Verification Guide for LC - Phone (US/Canada)](https://help.gohighlevel.com/support/solutions/articles/48001222300-toll-free-number-verification-guide-for-lc-phone-us-canada-)
...
0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy)

[Home](https://help.gohighlevel.com/support/home) [Knowledge base](https://help.gohighlevel.com/support/solutions)![Article views count](https://help.gohighlevel.com/support/solutions/articles/48001213941-lc-phone-messaging-policy/hit)