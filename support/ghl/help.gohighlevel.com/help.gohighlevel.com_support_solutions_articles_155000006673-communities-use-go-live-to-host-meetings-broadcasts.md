---
url: "https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts"
title: " Host Meetings & Broadcasts Using Go Live in Communities : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
6. Communities - Use Go Live to Host Meetings & Broadcasts
...
# Communities - Use Go Live to Host Meetings & Broadcasts

Modified on: Fri, 21 Nov, 2025 at 3:01 PM

How To Live Stream in Community Groups with HighLevel - YouTube
...
[How To Live Stream in Community Groups with HighLevel](https://www.youtube.com/watch?v=GJZYXNuaXdw)
...
[Watch on](https://www.youtube.com/watch?v=GJZYXNuaXdw&embeds_referring_euri=https%3A%2F%2Fhelp.gohighlevel.com%2F)
...
- [What is Go Live in Communities?](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts#What-is-Go-Live-in-Communities?)
- [Key Benefits of Go Live in Communities](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts#Key-Benefits-of-Go-Live-in-Communities)
- [Meeting Room Mode](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts#Meeting-Room-Mode)
- [Stream Software Mode](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts#Stream-Software-Mode)
- [How To Use Go Live Feature in Communities](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts#How-To-Use-Go-Live-Feature-in-Communities)
- [Frequently Asked Questions](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts#Frequently-Asked-Questions)
- [Related Articles](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts#Related-Articles)
...
1. Go to **Memberships** from your sub-account.

2. Hover on the **Communities** tab.

3. Click on **Groups**.



![](https://jumpshare.com/share/0eW8XfW3SbvAIpwqvsrs+/Screenshot+2025-10-14+at+7.35.48%E2%80%AFPM.png)

4. On the group you want, click **Login** to enter it.



![](https://jumpshare.com/share/jIYcCJVctvbeaxzvaNFI+/Screen+Shot+2025-10-14+at+7.39.24+PM.png)

5. Click the **Go Live** button (red video-camera icon) near the posting tab.



![](https://jumpshare.com/share/kIKLJXu8udHcQM6URVI6+/Screen+Shot+2025-10-14+at+7.41.19+PM.png)


### **Step 2:** Fill out post details (applies to both methods)

1. On the right panel, under Add post details:
   ...
   - **Enter a Description**.
2. Under Settings, choose whether to:
...
3. Under **Choose where to post** , pick the **channel** to publish the live to.

4. When are you going live? Leave as Now (default).



![](https://jumpshare.com/share/XnNMpfdoOZ1YpIHRlGBO+/GIF+Recording+2025-10-14+at+7.50.56+PM.gif)
...
1. In **Select video source**, choose **Meeting Room**, then click **Go live**.

2. **Allow** your browser to use **Camera** and **Microphone**.



![](https://jumpshare.com/share/exaEgh1dAosdIDElFJvj+/Screen+Shot+2025-10-14+at+8.13.37+PM.png)

3. Member will see the live in the channel and can join by clicking the **Join** **Stream** button.



![](https://jumpshare.com/share/JnlGAZLhjihyGd2PoI1U+/Screen+Shot+2025-10-14+at+8.03.13+PM.png)

4. Once connected, you’re live. Use these controls:
...
9. To finish, click **End session** → confirm **End session for everyone**.



![](https://jumpshare.com/share/81BWDoeXR6LZpyjBhzC0+/GIF+Recording+2025-10-14+at+8.18.55+PM.gif)

10. **After ending:** A post appears in the selected channel. It shows that the **stream ended** and the **recording is processing**; once processed, the recording is available on that post.



![](https://jumpshare.com/share/HxK13tqLm3arBG3z8cIr+/Screen+Shot+2025-10-14+at+8.21.11+PM.png)


#### **Option 2 — Streaming Software (RTMP from Zoom/OBS/StreamYard)**

1. In **Select video source**, choose **Streaming software**.

2. Copy the provided **Server URL** and **Stream Key**.

3. In your streaming app (Zoom/OBS/StreamYard), paste the **Server URL** and **Stream Key** into its RTMP/custom streaming settings.

4. Start the **broadcast** in your streaming software.

5. Back in HighLevel, start the **Go live**; your broadcast will appear **live** in the chosen channel.



![](https://jumpshare.com/share/SH0dgEtxSWSfyClIc98n+/Screen+Shot+2025-10-14+at+8.28.02+PM.png)
...
- [Communities: Announcement Channel and Notification](https://help.gohighlevel.com/en/support/solutions/articles/155000005145)

- [Unified Search for Posts and Comments in Communities](https://help.gohighlevel.com/en/support/solutions/articles/155000004642)

- [How to make your Groups private/ public in Communities?](https://help.gohighlevel.com/en/support/solutions/articles/155000000735)
...
- [Live Streaming and Video Calling](https://help.gohighlevel.com/support/solutions/articles/155000006672-live-streaming-and-video-calling)
...
- [Introducing Chats: Start Conversations On GoKollab](https://help.gohighlevel.com/support/solutions/articles/155000006277-introducing-chats-start-conversations-on-gokollab)
...
0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts)

[Home](https://help.gohighlevel.com/support/home) [Knowledge base](https://help.gohighlevel.com/support/solutions)![Article views count](https://help.gohighlevel.com/support/solutions/articles/155000006673-communities-use-go-live-to-host-meetings-broadcasts/hit)