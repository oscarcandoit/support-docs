---
url: "https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained"
title: " Inbound Call Routing - Explained : HighLevel Support Portal "
---

[Skip to main content](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#fw-main-content)
...
5. [...](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#)   - [Knowledge base](https://help.gohighlevel.com/support/solutions)
...
- [Incoming Call to a Phone number](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#Incoming-Call-to-a-Phone-number)
- [FAQs:](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#FAQs%3A)
  - [1\. How would we know which Phone number the contact call if we have more than one Phone number?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#1.-How-would-we-know-which-Phone-number-the-contact-call-if-we-have-more-than-one-Phone-number?)
  - [2\. How to check if the Phone number is assigned to a user?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#2.-How-to-check-if-the-Phone-number-is-assigned-to-a-user?)
  - [3\. How to check if 'Ring user assigned to called number' is checked or not?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#3.-How-to-check-if-'Ring-user-assigned-to-called-number'-is-checked-or-not?)
  - [4\. How to check if the contact/lead inbound call number is assigned to a user?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#4.-How-to-check-if-the-contact/lead-inbound-call-number-is-assigned-to-a-user?)
  - [5\. How to check if 'Forward calls to business phone number' is checked or not?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#5.-How-to-check-if-'Forward-calls-to-business-phone-number'-is-checked-or-not?)
  - [6\. If you already checked, no Phone number is assigned to the users, no forwarding number configured, the call still forwards, why?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#6.-If-you-already-checked,-no-Phone-number-is-assigned-to-the-users,-no-forwarding-number-configured,-the-call-still-forwards,-why?)
  - [7\. What happens if I don't configure any forwarding numbers?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#7.-What-happens-if-I-don't-configure-any-forwarding-numbers?)
  - [8\. Can I configure the Phone number to go to a voicemail directly?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#8.-Can-I-configure-the-Phone-number-to-go-to-a-voicemail-directly?)
  - [9\. I always want calls to forward to one number no matter what, how do I set this up?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#9.-I-always-want-calls-to-forward-to-one-number-no-matter-what,-how-do-I-set-this-up?)
  - [10\. When we call the Phone number, it disconnects right away, and it won't even ring, we already reset and bought a new number but it's still showing the same issue?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#10.-When-we-call-the-Phone-number,-it-disconnects-right-away,-and-it-won't-even-ring,-we-already-reset-and-bought-a-new-number-but-it's-still-showing-the-same-issue?)
  - [11\. Can we do call forwarding with an extension?](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained#11.-Can-we-do-call-forwarding-with-an-extension?)
...
[Where do calls go when a lead calls back?](https://www.loom.com/share/3ecc7c9135db464d9b7f1ef73ccba912 "Where do calls go when a lead calls back?")
...
[Open video in Loom](https://www.loom.com/share/3ecc7c9135db464d9b7f1ef73ccba912 "Open video in Loom")

1.2×

7 min⚡️9 min 13 sec7 min 22 sec6 min 9 sec4 min 55 sec4 min 20 sec3 min 41 sec2 min 57 sec

![](https://cdn.loom.com/sessions/thumbnails/3ecc7c9135db464d9b7f1ef73ccba912-c4aa3944f4a66db0.jpg)
...
- [Understanding LeadConnector Inbound Call Rate Limits](https://help.gohighlevel.com/support/solutions/articles/155000005314-understanding-leadconnector-inbound-call-rate-limits)
- [Using Call Connect to Ensure Accurate Call Status Tracking](https://help.gohighlevel.com/support/solutions/articles/48001181825-using-call-connect-to-ensure-accurate-call-status-tracking)
...
0 of 0 [Download image](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained)

[Home](https://help.gohighlevel.com/support/home) [Knowledge base](https://help.gohighlevel.com/support/solutions)![Article views count](https://help.gohighlevel.com/support/solutions/articles/48000981432-inbound-call-routing-explained/hit)