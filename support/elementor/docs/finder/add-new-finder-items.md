---
url: https://developers.elementor.com/docs/finder/add-new-finder-items/
scraped_at: 2025-10-20T01:01:59.384Z
---

# [\#](https://developers.elementor.com/docs/finder/add-new-finder-items/\#add-new-finder-items) Add New Finder Items
...
## [\#](https://developers.elementor.com/docs/finder/add-new-finder-items/\#new-category) New Category
...
## [\#](https://developers.elementor.com/docs/finder/add-new-finder-items/\#registering-a-finder-category) Registering a Finder Category
...
←
[Finder Structure](https://developers.elementor.com/docs/finder/finder-structure/)[Add Items to an Existing Category](https://developers.elementor.com/docs/finder/add-items-to-existing-category/)
→