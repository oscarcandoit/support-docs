---
url: https://developers.elementor.com/docs/addons/namespaces/
scraped_at: 2025-10-20T00:56:29.089Z
---

# [\#](https://developers.elementor.com/docs/addons/namespaces/\#using-namespaces) Using Namespaces
...
## [\#](https://developers.elementor.com/docs/addons/namespaces/\#should-you-use-namespaces) Should you use Namespaces?
...
## [\#](https://developers.elementor.com/docs/addons/namespaces/\#example-namespace-structure) Example Namespace Structure
...
## [\#](https://developers.elementor.com/docs/addons/namespaces/\#defining-main-namespaces) Defining Main Namespaces
...
### [\#](https://developers.elementor.com/docs/addons/namespaces/\#example) Example
...
### [\#](https://developers.elementor.com/docs/addons/namespaces/\#notes) Notes
...
←
[Initialization Process](https://developers.elementor.com/docs/addons/initialization/)[Addon Wrapper Example](https://developers.elementor.com/docs/addons/addon-example/)
→