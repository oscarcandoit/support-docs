---
url: "https://docs.gravityforms.com/gform_paypalpaymentspro_verifyhost/"
title: "gform_paypalpaymentspro_verifyhost - Gravity Forms Documentation"
---
...
# gform\_paypalpaymentspro\_verifyhost

- [Description](https://docs.gravityforms.com/gform_paypalpaymentspro_verifyhost/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypalpaymentspro_verifyhost/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypalpaymentspro_verifyhost/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypalpaymentspro_verifyhost/#h-examples)
- [Since](https://docs.gravityforms.com/gform_paypalpaymentspro_verifyhost/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_paypalpaymentspro_verifyhost/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypalpaymentspro_verifyhost'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$is\_enabled** [bool](https://docs.gravityforms.com/bool)
Indicates if the CURLOPT\_SSL\_VERIFYHOST setting is enabled, which allows host verification to be bypassed. True enables host verification, false disables.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_paypalpaymentspro_verifyhost'``,``'disable_verification'``, 10, 1 );`<br>`function``disable_verification(``$is_enabled``){`<br>```return``false;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_paypalpaymentspro_verifyhost/# "Algolia")
