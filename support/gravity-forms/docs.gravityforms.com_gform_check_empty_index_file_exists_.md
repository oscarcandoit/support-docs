---
url: "https://docs.gravityforms.com/gform_check_empty_index_file_exists/"
title: "gform_check_empty_index_file_exists - Gravity Forms Documentation"
---
...
# gform\_check\_empty\_index\_file\_exists

- [Description](https://docs.gravityforms.com/gform_check_empty_index_file_exists/#h-description)
- [Usage](https://docs.gravityforms.com/gform_check_empty_index_file_exists/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_check_empty_index_file_exists/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_check_empty_index_file_exists/#h-examples)
- [Prevent the creation of multiple empty index.html files](https://docs.gravityforms.com/gform_check_empty_index_file_exists/#h-prevent-the-creation-of-multiple-empty-index-html-files)
- [Placement](https://docs.gravityforms.com/gform_check_empty_index_file_exists/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_check_empty_index_file_exists/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_check_empty_index_file_exists/#h-since)
...
|     |
| --- |
| `add_filter(``'gform_check_empty_index_file_exists'``,``'your_function_name'``, 10, 2);` |

## Parameters

- **$check\_file\_exists** [bool](https://docs.gravityforms.com/bool/)

Whether to check if the empty index file exists before adding it.

_Defaults to false._
- **$dir** [string](https://docs.gravityforms.com/string/)

The directory path where the empty file is being added.

## Examples

### Prevent the creation of multiple empty index.html files

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_check_empty_index_file_exists'``,``'only_add_once'``, 10, 2 );`<br>`function``only_add_once(``$check``,``$dir``) {`<br>```return``true;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_check_empty_index_file_exists/# "Algolia")
