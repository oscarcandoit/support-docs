---
url: "https://docs.gravityforms.com/adding-images-javascript-and-more-to-forms/"
title: "Adding Images, JavaScript, and HTML To Forms - Gravity Forms"
---
...
|     |     |
| --- | --- |
| 1 | `<``img``src``=``"https://example.com/wp-content/uploads/2020/02/my_image.jpg"``alt``=``"Profile photo"``/>` |

If you wanted to embed JavaScript into the form, you would do so like this:

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `<``script``>`<br>`function myCustomJs() {`<br>```return true;`<br>`}`<br>`function myCustomJs();`<br>`</``script``>` |
...
[Algolia](https://docs.gravityforms.com/adding-images-javascript-and-more-to-forms/# "Algolia")
