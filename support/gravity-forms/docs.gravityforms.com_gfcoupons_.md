---
url: "https://docs.gravityforms.com/gfcoupons/"
title: "GFCoupons - Gravity Forms Documentation"
---
...
- [gf\_coupons()](https://docs.gravityforms.com/gfcoupons/#h-gf_coupons)
- [get\_submitted\_coupon\_codes()](https://docs.gravityforms.com/gfcoupons/#h-get_submitted_coupon_codes)
- [get\_coupons\_by\_codes()](https://docs.gravityforms.com/gfcoupons/#h-get_coupons_by_codes)
- [insert\_feed()](https://docs.gravityforms.com/gfcoupons/#h-insert_feed)

GFCoupons is the class which houses the main functionality of the Gravity Forms Coupons Add-on, it extends the [GFFeedAddOn](https://docs.gravityforms.com/gffeedaddon) class which is part of the add-on framework. Below are a few functions which you may find useful when working on your own custom code.

## gf\_coupons()

The gf\_coupons() function is used to return an instance of the GFCoupons class.

## get\_submitted\_coupon\_codes()

Retrieves any submitted coupon codes from the entry object.

|     |     |
| --- | --- |
| 1 | `$coupon_codes``= gf_coupons()->get_submitted_coupon_codes(``$form``,``$entry``);` |
...
- **Returns** [array](https://docs.gravityforms.com/array) \| [boolean](https://docs.gravityforms.com/boolean)

An array of coupon codes or false if no codes were submitted.


## get\_coupons\_by\_codes()

Retrieves the properties for the specified coupon codes.

|     |     |
| --- | --- |
| 1 | `$coupons``= gf_coupons()->get_coupons_by_codes(``$codes``,``$form``);` |

- **$codes** [string](https://docs.gravityforms.com/string) \| [array](https://docs.gravityforms.com/array)
...
The insert\_feed() method can be used to add new coupons.

|     |     |
| --- | --- |
| 1 | `$feed_id``= gf_coupons()->insert_feed(``$form_id``,``$is_active``,``$meta``);` |
...
- **$meta** [Coupons Feed Meta](https://docs.gravityforms.com/coupons-feed-meta)
...
[Algolia](https://docs.gravityforms.com/gfcoupons/# "Algolia")
