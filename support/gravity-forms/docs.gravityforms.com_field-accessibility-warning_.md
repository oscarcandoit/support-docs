---
url: "https://docs.gravityforms.com/field-accessibility-warning/"
title: "Accessibility Warning Showing on Field - Gravity Forms Documentation"
---
...
- [Knowledge Base](https://docs.gravityforms.com/category/knowledge-base/)  - [Accessibility](https://docs.gravityforms.com/category/knowledge-base/accessibility/)    - [Accessibility Guide for Designers](https://docs.gravityforms.com/accessibility-for-designers/ "Accessibility Guide for Designers")
    - [Gravity Forms Commitment to Accessibility](https://docs.gravityforms.com/gravity-forms-commitment-to-accessibility/ "Gravity Forms Commitment to Accessibility")
    - [Accessibility Guide for Developers](https://docs.gravityforms.com/accessibility-for-developers/ "Accessibility Guide for Developers")
    - [Accessibility Guide for Content Providers](https://docs.gravityforms.com/accessibility-for-content-providers/ "Accessibility Guide for Content Providers")
    - [Accessibility Warning Showing on Field](https://docs.gravityforms.com/field-accessibility-warning/ "Accessibility Warning Showing on Field")
    - [Accessibility Checklist for Gravity Forms](https://docs.gravityforms.com/accessibility-checklist-for-gravity-forms/ "Accessibility Checklist for Gravity Forms")
...
- [Summary](https://docs.gravityforms.com/field-accessibility-warning/#h-summary)
- [Description](https://docs.gravityforms.com/field-accessibility-warning/#h-description)
- [Advice Regarding Specific Fields](https://docs.gravityforms.com/field-accessibility-warning/#h-advice-regarding-specific-fields)
- [Enhanced User Interface](https://docs.gravityforms.com/field-accessibility-warning/#h-enhanced-user-interface)
- [Image Choice](https://docs.gravityforms.com/field-accessibility-warning/#h-image-choice)
- [Multiselect](https://docs.gravityforms.com/field-accessibility-warning/#h-multiselect)
- [Google reCAPTCHA V2](https://docs.gravityforms.com/field-accessibility-warning/#h-google-recaptcha-v2)
- [Datepicker](https://docs.gravityforms.com/field-accessibility-warning/#h-datepicker)
- [Submit/Next Page Button](https://docs.gravityforms.com/field-accessibility-warning/#h-submit-next-page-button)
- [Introduced In Gravity Forms 2.5](https://docs.gravityforms.com/field-accessibility-warning/#h-introduced-in-gravity-forms-2-5)
- [Further Information](https://docs.gravityforms.com/field-accessibility-warning/#h-further-information)
- [Remove The Warning](https://docs.gravityforms.com/field-accessibility-warning/#h-remove-the-warning)
- [Example Screenshots](https://docs.gravityforms.com/field-accessibility-warning/#h-example-screenshots)

## Summary

This article provides information regarding accessibility warning messages you may receive for a particular field on your form. The message is presented in the Field Settings pane of the Form Editor. See [screenshots](https://docs.gravityforms.com/?p=24107&preview=true#example-screenshots) at bottom for some examples.
...
[![](https://docs.gravityforms.com/wp-content/uploads/2022/07/enhanced-user-interface-accessibility-warning.png)](https://docs.gravityforms.com/wp-content/uploads/2022/07/enhanced-user-interface-accessibility-warning.png)

### Image Choice

A warning will be displayed in the Form Editor when Choice Label Visibility is marked as hidden.

[![Accessibility Warning | Image Choice Field](https://docs.gravityforms.com/wp-content/uploads/2024/08/image-20.png)](https://docs.gravityforms.com/wp-content/uploads/2024/08/image-20.png)
...
[![Accessibility Warning | Multi Select Field](https://docs.gravityforms.com/wp-content/uploads/2020/06/CleanShot-2021-05-24-at-18.35.07.png)](https://docs.gravityforms.com/wp-content/uploads/2020/06/CleanShot-2021-05-24-at-18.35.07.png)
...
Gravity Forms [introduced](https://www.gravityforms.com/blog/introducing-the-new-gravity-forms-recaptcha-add-on/) a reCAPTCHA Add-On in June 2021 that provided support for reCAPTCHA v3. With [our reCAPTCHA Add-On](https://www.gravityforms.com/add-ons/recaptcha/), there is no need to add a CAPTCHA field to your form. The Google reCAPTCHA scripts are output on every page of your website. You can read more about our reCAPTCHA Add-On [here](https://docs.gravityforms.com/setting-up-the-recaptcha-add-on/).
...
Hints on what the exact date format your field expects is given by placeholders and by additional text, connected to the input field with _aria-describedby_. Then the date format is announced and visible.

For more information, read [Graman Arfiel’s article “Collecting dates in an accessible way”](https://www.hassellinclusion.com/blog/collecting-dates-accessible/), which has a good discussion about accessible datepickers.
...
[![Accessibility Warning | Submit Button](https://docs.gravityforms.com/wp-content/uploads/2022/02/Submit-Button-%E2%80%A2-Accessibility-Warning-.png)](https://docs.gravityforms.com/wp-content/uploads/2022/02/Submit-Button-%E2%80%A2-Accessibility-Warning-.png)
...
- **Use a Different Field**: Replace the problematic field with a more suitable alternative. For example, use a [Drop Down](https://docs.gravityforms.com/drop-down-field/) field or [Multiple Choice](https://docs.gravityforms.com/multiple-choice-field/) field instead of a [Multi Select](https://docs.gravityforms.com/multi-select/) field for better accessibility.
...
- **Review Best Practices**: for guidance on designing forms that align with best practices for functionality and accessibility, refer to our [Accessibility Checklist for Gravity Forms](https://docs.gravityforms.com/accessibility-checklist-for-gravity-forms/) article.

## Example Screenshots

These images show a few examples of the type of warning you may see.

[![Accessibility Warning | Post Tags](https://docs.gravityforms.com/wp-content/uploads/2020/06/Accessibility-Warning-Post-Tags.png)](https://docs.gravityforms.com/wp-content/uploads/2020/06/Accessibility-Warning-Post-Tags.png)[![Accessibility Warning | CAPTCHA Field](https://docs.gravityforms.com/wp-content/uploads/2020/06/Accessibility-Warning-CAPTCHA-Field.png)](https://docs.gravityforms.com/wp-content/uploads/2020/06/Accessibility-Warning-CAPTCHA-Field.png)[![Accessibility Warning | Multi Select Field](https://docs.gravityforms.com/wp-content/uploads/2020/06/Accessibility-Warning-Multi-Select-Field.png)](https://docs.gravityforms.com/wp-content/uploads/2020/06/Accessibility-Warning-Multi-Select-Field.png)[![](https://docs.gravityforms.com/wp-content/uploads/2021/05/118867056-84a65d80-b897-11eb-8464-1aa9fe487b03.jpg.png)](https://docs.gravityforms.com/wp-content/uploads/2021/05/118867056-84a65d80-b897-11eb-8464-1aa9fe487b03.jpg.png)
...
[Algolia](https://docs.gravityforms.com/field-accessibility-warning/# "Algolia")
