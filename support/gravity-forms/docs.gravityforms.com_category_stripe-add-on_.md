---
url: "https://docs.gravityforms.com/category/stripe-add-on/"
title: "Stripe Add-On Archives - Gravity Forms Documentation"
---
...
The Timeout Confirmation is automatically added when using the Stripe Card Element and alerts customers if their payment is delayed.](https://docs.gravityforms.com/timeout-confirmation/ "Timeout Confirmation") [**Post Payment Actions for Stripe** \\
...
This article includes feature notes and a change log for the release of the official Gravity Forms Stripe Add-On version 6.0 Beta.](https://docs.gravityforms.com/stripe-6-0/ "Stripe 6.0 Key Features") [**Customizing ACH Payment Messaging in the Stripe Add-On** \\
...
This quick reference guide lists all the settings related to the Stripe Add-On and includes a short description of their purpose.](https://docs.gravityforms.com/stripe-add-on-settings-reference/ "Stripe Add-On Settings Reference") [**Setting Up the Stripe Add-On** \\
Step-by-step instructions on how to setup the Stripe Add-On.](https://docs.gravityforms.com/downloading-installing-the-stripe-add-on/ "Setting Up the Stripe Add-On") [**Stripe Feed Settings Reference** \\
The following guide explains the many settings that you can find when creating a feed for the official Gravity Forms Stripe Add-On.](https://docs.gravityforms.com/stripe-feed-settings-reference/ "Stripe Feed Settings Reference") [**Connecting to Stripe in Live or Test Mode** \\
...
Instructions on how to set up a Stripe compatible form.](https://docs.gravityforms.com/setting-up-a-stripe-compatible-form/ "Setting Up a Stripe Compatible Form") 1 [2](https://docs.gravityforms.com/category/stripe-add-on/page/2/) [3](https://docs.gravityforms.com/category/stripe-add-on/page/3/) [Next](https://docs.gravityforms.com/category/stripe-add-on/page/2/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/stripe-add-on/# "Algolia")
