---
url: "https://docs.gravityforms.com/gform_user_registration_new_site_meta/"
title: "gform_user_registration_new_site_meta - Gravity Forms Documentation"
---
...
# gform\_user\_registration\_new\_site\_meta

- [Description](https://docs.gravityforms.com/gform_user_registration_new_site_meta/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_new_site_meta/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_new_site_meta/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_user_registration_new_site_meta/#h-example)
- [Placement](https://docs.gravityforms.com/gform_user_registration_new_site_meta/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_new_site_meta/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_user_registration_new_site_meta'``,``'your_function_name'``, 10, 6 );` |

## Parameters

- **$site\_meta** [array](https://docs.gravityforms.com/array)
...
The feed object.
- **$user\_id** [int](https://docs.gravityforms.com/integer)

The ID of the user who creates the site.
- **$is\_update\_feed** [boolean](https://docs.gravityforms.com/boolean)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_user_registration_new_site_meta'``,``'add_blog_template'``, 10, 6 );`<br>`function``add_blog_template(``$site_meta``,``$form``,``$entry``,``$feed``,``$user_id``,``$is_update_feed``) {`<br>```$site_meta``[``'blog_template'``] = 1;`<br>```return``$site_meta``;`<br>`}` |
...
This filter is located in GF\_User\_Registration::create\_site() in _gravityformsuserregistration/class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_new_site_meta/# "Algolia")
