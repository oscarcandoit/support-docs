---
url: "https://docs.gravityforms.com/gform_stripe_connect_enabled/"
title: "gform_stripe_connect_enabled - Gravity Forms Documentation"
---
...
# gform\_stripe\_connect\_enabled

- [Description](https://docs.gravityforms.com/gform_stripe_connect_enabled/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_connect_enabled/#h-usage)
- [Example](https://docs.gravityforms.com/gform_stripe_connect_enabled/#h-example)
- [Placement](https://docs.gravityforms.com/gform_stripe_connect_enabled/#h-placement)
- [Security Warning](https://docs.gravityforms.com/gform_stripe_connect_enabled/#h-security-warning)
- [Since](https://docs.gravityforms.com/gform_stripe_connect_enabled/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_connect_enabled/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_connect_enabled'``,``'__return_false'``);` |

## Parameters

- **$stripe\_connect\_enabled** [boolean](https://docs.gravityforms.com/boolean)
Set to True by default on new installations. When set to False, the [legacy Stripe setting screen](https://docs.gravityforms.com/setting-up-the-stripe-add-on-version-2-7-and-earlier) will be shown instead of the recommended [Stripe Connect settings screen](https://docs.gravityforms.com/downloading-installing-the-stripe-add-on/).
...
When disabling this method, you are choosing to instead store your _actual_ Stripe API keys in the database. These keys provide a large range of functionalities for the Stripe service, and this increases your risk if your database is compromised by bad actors or authorized users with ill intent.
...
This filter is located in _gravityformsstripe/class-gf-stripe.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_connect_enabled/# "Algolia")
