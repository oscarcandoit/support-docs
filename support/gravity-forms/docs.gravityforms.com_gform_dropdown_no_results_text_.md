---
url: "https://docs.gravityforms.com/gform_dropdown_no_results_text/"
title: "gform_dropdown_no_results_text - Gravity Forms Documentation"
---
...
# gform\_dropdown\_no\_results\_text

- [Description](https://docs.gravityforms.com/gform_dropdown_no_results_text/#h-description)
- [Usage](https://docs.gravityforms.com/gform_dropdown_no_results_text/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_dropdown_no_results_text/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_dropdown_no_results_text/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_dropdown_no_results_text/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_dropdown_no_results_text/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_dropdown_no_results_text'``,``'set_no_results_text'``, 10, 2 );` |

You can also target a specific form by adding the form id after the hook name.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_dropdown_no_results_text_6'``,``'set_no_results_text'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_dropdown_no_results_text_185'``,``'set_no_results_text'``, 10, 2 );`<br>`function``set_no_results_text(``$text``,``$form_id``) {`<br>`return``'No results found'``;`<br>`}` |
...
This filter is located in GFFormDisplay::get\_chosen\_init\_script() in _form\_display.php_.
...
[Algolia](https://docs.gravityforms.com/gform_dropdown_no_results_text/# "Algolia")
