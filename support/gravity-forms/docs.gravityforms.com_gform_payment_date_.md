---
url: "https://docs.gravityforms.com/gform_payment_date/"
title: "gform_payment_date - Gravity Forms Documentation"
---
...
# gform\_payment\_date

- [Description](https://docs.gravityforms.com/gform_payment_date/#h-description)
- [Usage](https://docs.gravityforms.com/gform_payment_date/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_payment_date/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_payment_date/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_payment_date/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_payment_date/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_payment_date'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$payment\_date** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_payment_date'``,``'change_payment_date'``, 10, 3 );`<br>`function``change_payment_date(``$payment_date``,``$form``,``$entry``){`<br>```//change date format to year/day/month`<br>```$payment_date``= GFCommon::format_date(``$payment_date``, false,``'Y/d/m'``,``$entry``[``'transaction_type'``] != 2 );`<br>```return``$payment_date``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_payment_date/# "Algolia")
