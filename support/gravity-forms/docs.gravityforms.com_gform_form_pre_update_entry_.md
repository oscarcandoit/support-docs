---
url: "https://docs.gravityforms.com/gform_form_pre_update_entry/"
title: "gform_form_pre_update_entry - Gravity Forms Documentation"
---
...
# gform\_form\_pre\_update\_entry

- [Description](https://docs.gravityforms.com/gform_form_pre_update_entry/#h-description)
- [Usage](https://docs.gravityforms.com/gform_form_pre_update_entry/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_form_pre_update_entry/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_form_pre_update_entry/#h-example)
- [Placement](https://docs.gravityforms.com/gform_form_pre_update_entry/#h-placement)
- [Since](https://docs.gravityforms.com/gform_form_pre_update_entry/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_form_pre_update_entry/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_form_pre_update_entry'``,``'your_function_name'``, 10, 3 );` |

To target a specific form, append the form id to the hook name. (format: gform\_form\_pre\_update\_entry\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_form_pre_update_entry_1'``,``'your_function_name'``, 10, 3 );` |
...
The example below removes one of the form fields from the [Form Object](https://docs.gravityforms.com/form-object) so that it is not updated with the entry data.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `add_filter(``'gform_form_pre_update_entry'``,``'modify_form'``, 10, 3 );`<br>`function``modify_form(``$form``,``$entry``,``$entry_id``){`<br>```$fields``=``$form``[``'fields'``];`<br>```foreach``(``$fields``as``$field``){`<br>```if``(``$field``[``'label'``] ==``'Test'``) {`<br>```continue``;`<br>```}`<br>```$new_fields``[] =``$field``;`<br>```}`<br>```$form``[``'fields'``] =``$new_fields``;`<br>```return``$form``;`<br>`}` |
...
This filter is located in GFAPI::update\_entry() in _includes/api.php_ and

GF\_Forms\_Model\_Legacy::update\_entry() in _includes/legacy/forms\_model\_legacy.php_.
...
[Algolia](https://docs.gravityforms.com/gform_form_pre_update_entry/# "Algolia")
