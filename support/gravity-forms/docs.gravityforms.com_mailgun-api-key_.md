---
url: "https://docs.gravityforms.com/mailgun-api-key/"
title: "Obtaining Your Mailgun API Key - Gravity Forms Documentation"
---
...
2. Then go to your [Account API Keys](https://app.mailgun.com/settings/api_security) page.
3. Under **API Keys**, locate the **Private API Key** field. Click on the eye icon to the right of the field to display your API key, and copy it.

That’s all there is to it! From here, you can continue [setting up the Mailgun Add-On](https://docs.gravityforms.com/setting-up-the-mailgun-add-on/).
...
[Algolia](https://docs.gravityforms.com/mailgun-api-key/# "Algolia")
