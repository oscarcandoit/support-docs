---
url: "https://docs.gravityforms.com/gform_slack_username/"
title: "gform_slack_username - Gravity Forms Documentation"
---
...
# gform\_slack\_username

- [Description](https://docs.gravityforms.com/gform_slack_username/#h-description)
- [Usage](https://docs.gravityforms.com/gform_slack_username/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_slack_username/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_slack_username/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_slack_username/#h-placement)
- [Since](https://docs.gravityforms.com/gform_slack_username/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_slack_username/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_slack_username'``,``'your_function_name'``, 10, 4 );` |

To target a specific form append the form id to the hook name. (Format: gform\_slack\_username\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_slack_username_10'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$username** [string](https://docs.gravityforms.com/string)
The current username being used for the Slack message. _Default is: Gravity Forms._
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_slack_username_4'``,``'change_slack_username'``, 10, 4 );`<br>`function``change_slack_username(``$username``,``$feed``,``$entry``,``$form``) {`<br>```$username``=``'Support Bot'``;`<br>```return``$username``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_slack_username'``,``array``(``$form``[``'id'``] ),``'Gravity Forms'``,``$feed``,``$entry``,``$form``)` |
...
[Algolia](https://docs.gravityforms.com/gform_slack_username/# "Algolia")
