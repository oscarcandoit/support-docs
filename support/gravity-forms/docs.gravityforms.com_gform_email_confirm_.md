---
url: "https://docs.gravityforms.com/gform_email_confirm/"
title: "gform_email_confirm - Gravity Forms Documentation"
---
...
# gform\_email\_confirm

- [Description](https://docs.gravityforms.com/gform_email_confirm/#h-description)
- [Usage](https://docs.gravityforms.com/gform_email_confirm/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_email_confirm/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_email_confirm/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_email_confirm/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_email_confirm/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_email_confirm'``,``'change_email_confirm'``, 10, 2 );` |

Applies to a specific form. In this case, form id 5.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_email_confirm_5'``,``'change_email_confirm'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_email_confirm'``,``'change_email_confirm'``, 10, 2 );`<br>`function``change_email_confirm(``$label``,``$form_id``) {`<br>```return``'Confirm Your Email'``;`<br>`}` |
...
This filter is located in GF\_Field\_Email::get\_field\_input() in _includes/fields/class-gf-field-email.php_.
...
[Algolia](https://docs.gravityforms.com/gform_email_confirm/# "Algolia")
