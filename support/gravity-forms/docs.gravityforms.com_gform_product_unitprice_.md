---
url: "https://docs.gravityforms.com/gform_product_unitprice/"
title: "gform_product_unitprice - Gravity Forms Documentation"
---
...
# gform\_product\_unitprice

- [Description](https://docs.gravityforms.com/gform_product_unitprice/#h-description)
- [Usage](https://docs.gravityforms.com/gform_product_unitprice/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_product_unitprice/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_product_unitprice/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_product_unitprice/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_product_unitprice/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_product_unitprice'``,``'change_unitprice'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_product_unitprice'``,``'change_unitprice'``, 10, 2 );`<br>`function``change_unitprice(``$label``,``$form_id``) {`<br>```return``'Sub Total'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_product_unitprice/# "Algolia")
