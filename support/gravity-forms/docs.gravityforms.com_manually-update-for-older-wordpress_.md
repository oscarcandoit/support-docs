---
url: "https://docs.gravityforms.com/manually-update-for-older-wordpress/"
title: "Manual Update for Older WordPress - Gravity"
---
...
For more recent WordPress versions, refer to our [master article here](https://docs.gravityforms.com/how-to-manually-update/).

01. If you haven’t already done so, download the Gravity Forms or Add-On zip from the [downloads page](https://www.gravityforms.com/my-account/downloads/). Be sure to save this zip file somewhere easily accessible as you will need it soon.
02. From within your WordPress admin dashboard, click **Plugins** on the left side navigation menu.
03. If the plugin is active, select the **Deactivate** option for the plugin you’re trying to update.
04. Select the **Delete** option for the plugin you’re trying to update.
05. Click **OK** or **Yes** when prompted to delete the files. This step deletes the plugin’s folder and the files inside. The data part of the message in the prompt does NOT apply to Gravity Forms or our official add-ons. As mentioned above your data will remain.
06. Click the **Add New** button.
07. Click the **Upload Plugin** button.
08. Click the **Browse** button.
09. Navigate to the zip file you previously downloaded and select it.
...
[Algolia](https://docs.gravityforms.com/manually-update-for-older-wordpress/# "Algolia")
