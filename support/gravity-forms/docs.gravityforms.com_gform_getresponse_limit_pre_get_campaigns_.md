---
url: "https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/"
title: "GetResponse Limit Pre-Get Campaigns: GForm Guide"
---
...
# gform\_getresponse\_limit\_pre\_get\_campaigns

- [Description](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/#h-description)
- [Usage](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/#h-example)
- [Placement](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/#h-placement)
- [Since](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/#h-source-code)

## Description

The “gform\_getresponse\_limit\_pre\_get\_campaigns” filter in Gravity Forms GetResponse Add-On modifies the number of campaigns that are retrieved when creating a feed. The default is 100.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_getresponse_limit_pre_get_campaigns'``,``'your_function_name'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_getresponse_limit_pre_get_campaigns'``,``function``(``$limit``) {`<br>```return``350;`<br>`} );` |
...
|     |     |
| --- | --- |
| 1 | `return``(int) apply_filters(``'gform_getresponse_limit_pre_get_campaigns'``, 100 );` |
...
[Algolia](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/# "Algolia")
