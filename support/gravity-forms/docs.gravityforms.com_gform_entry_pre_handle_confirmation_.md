---
url: "https://docs.gravityforms.com/gform_entry_pre_handle_confirmation/"
title: "gform_entry_pre_handle_confirmation - Gravity Forms Documentation"
---
...
# gform\_entry\_pre\_handle\_confirmation

- [Description](https://docs.gravityforms.com/gform_entry_pre_handle_confirmation/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_pre_handle_confirmation/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entry_pre_handle_confirmation/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_entry_pre_handle_confirmation/#h-example)
- [Placement](https://docs.gravityforms.com/gform_entry_pre_handle_confirmation/#h-placement)
- [Since](https://docs.gravityforms.com/gform_entry_pre_handle_confirmation/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_entry_pre_handle_confirmation/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_pre_handle_confirmation'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_entry_pre_handle_confirmation'``,``'change_entry'``, 10, 2 );`<br>`function``change_entry(``$entry``,``$form``){`<br>```if``( rgar(``$entry``,``'1.3'``) ==``'Rocketgenius'``|| rgar(``$entry``,``'1.6'``) ==``'Rocketgenius'``) {`<br>```$entry``[``'2'``] =``'test@rocketgenius.com'``;`<br>```}`<br>```return``$entry``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_pre_handle_confirmation/# "Algolia")
