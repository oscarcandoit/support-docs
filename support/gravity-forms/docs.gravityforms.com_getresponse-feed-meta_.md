---
url: "https://docs.gravityforms.com/getresponse-feed-meta/"
title: "GetResponse Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [GetResponse Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/getresponse-filters/)          - [GetResponse Feed Meta](https://docs.gravityforms.com/getresponse-feed-meta/ "GetResponse Feed Meta")
          - [gform\_getresponse\_contact](https://docs.gravityforms.com/gform_getresponse_contact/ "gform_getresponse_contact")
          - [gform\_getresponse\_field\_value](https://docs.gravityforms.com/gform_getresponse_field_value/ "gform_getresponse_field_value")
          - [gform\_getresponse\_limit\_pre\_get\_campaigns](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_campaigns/ "gform_getresponse_limit_pre_get_campaigns")
          - [gform\_getresponse\_limit\_pre\_get\_custom\_fields](https://docs.gravityforms.com/gform_getresponse_limit_pre_get_custom_fields/ "gform_getresponse_limit_pre_get_custom_fields")
...
- [Introduction](https://docs.gravityforms.com/getresponse-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/getresponse-feed-meta/#h-usage)
- [Parameters](https://docs.gravityforms.com/getresponse-feed-meta/#h-parameters)
- [Custom Field Properties](https://docs.gravityforms.com/getresponse-feed-meta/#h-custom-field-properties)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the GetResponse Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `$feed``[``'meta'``] =``array``(`<br>```'feed_name'``=>``'Your Feed Name'``,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
| --- | --- | --- |
| **feed\_name** | [string](https://docs.gravityforms.com/string) | The feed name which appears on the add-ons feeds tab. |
| **campaign** | [string](https://docs.gravityforms.com/string) | The ID of the GetResponse campaign this feed will add the contact to. |
| **fields\_name** | [string](https://docs.gravityforms.com/string) | The ID of the form field containing the contact name. |
| **fields\_email** | [string](https://docs.gravityforms.com/string) | The ID of the form field containing the contact email. |
| **custom\_fields** | [array](https://docs.gravityforms.com/array) | A multidimensional array containing the GetResponse custom fields. See [Custom Field Properties](https://docs.gravityforms.com/getresponse-feed-meta/#custom-field-properties). |
| **feed\_condition\_conditional\_logic** | [boolean](https://docs.gravityforms.com/boolean) | Is the feed condition (conditional logic) setting enabled. Default is false. |
| **feed\_condition\_conditional\_logic\_object** | [array](https://docs.gravityforms.com/array) | An associative array containing the conditional logic rules. See the [Conditional Logic Object](https://docs.gravityforms.com/conditional-logic-object) for more details. |

## Custom Field Properties

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `array``(`<br>```'key'``=>``'address_one'``,`<br>```'value'``=>``'3.1'``,`<br>`)` |

Each custom field is an associative array containing the following properties:

| Parameter | Type | Description |
| --- | --- | --- |
| **key** | [string](https://docs.gravityforms.com/string) | The GetResponse custom field name. Custom field names can only contain up to 32 lowercase alphanumeric characters and underscores. |
...
[Algolia](https://docs.gravityforms.com/getresponse-feed-meta/# "Algolia")
