---
url: "https://docs.gravityforms.com/setting-up-the-postmark-add-on/"
title: "Setting Up the Postmark Add-On - Gravity Forms Documentation"
---
...
- [Pre-Requisites](https://docs.gravityforms.com/setting-up-the-postmark-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-up-the-postmark-add-on/#h-setup)
...
3. From this page, click the **Postmark** tab.
4. Enter your **Account API Token** and **Server API Token**. This is obtained from Postmark. If you are unsure of how to obtain your API key, take a look at our article on [obtaining your Postmark API tokens](https://docs.gravityforms.com/get-postmark-api-keys/).
...
Once you have entered your API tokens, you’re ready to begin [sending form notifications using Postmark](https://docs.gravityforms.com/form-notifications-postmark/).
...
[Algolia](https://docs.gravityforms.com/setting-up-the-postmark-add-on/# "Algolia")
