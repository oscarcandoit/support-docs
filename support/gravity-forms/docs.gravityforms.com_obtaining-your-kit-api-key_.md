---
url: "https://docs.gravityforms.com/obtaining-your-kit-api-key/"
title: "Obtaining Your Kit API Key - Gravity Forms Documentation"
---
...
# Obtaining Your Kit API Key

To use the Kit Add-On, you will need to first obtain the Kit API key and API secret. In this article, we will show you exactly how to find it.

1. Log into your [Kit](https://app.convertkit.com/users/login) account.
...
4. Click the **Copy** button next to the API key.![ConvertKit API Key](https://docs.gravityforms.com/wp-content/uploads/2023/08/Markup-on-2023-08-31-at-100626.png)
5. Click **Show** to reveal the API secret, then click the **Copy** button next to the API secret.![ConvertKit API Secret](https://docs.gravityforms.com/wp-content/uploads/2023/08/Markup-on-2023-08-31-at-100224.png)

Now, you can paste these keys in your Gravity Forms Kit Add-On settings. Refer to the [Setting up the Kit Add-On](https://docs.gravityforms.com/?p=37163) documentation for further details.

If you need further help to get your API key or API Secret, we recommend you contact [Kit support](https://convertkit.com/support).
...
[Algolia](https://docs.gravityforms.com/obtaining-your-kit-api-key/# "Algolia")
