---
url: "https://docs.gravityforms.com/gform_trello_card/"
title: "gform_trello_card - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_trello_card/#h-description)
- [Usage](https://docs.gravityforms.com/gform_trello_card/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_trello_card/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_trello_card/#h-examples)
- [1\. Override the card name](https://docs.gravityforms.com/gform_trello_card/#h-1-override-the-card-name)
- [2\. Decode encoded characters in card description](https://docs.gravityforms.com/gform_trello_card/#h-2-decode-encoded-characters-in-card-description)
- [Placement](https://docs.gravityforms.com/gform_trello_card/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_trello_card/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_trello_card'``,``'your_function_name'``, 10, 4 );` |

To target a specific form append the form id to the hook name. (format: gform\_trello\_card\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_trello_card_5'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$card** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `array``(`<br>```'name'``=>``'New submission from feed add-on'``,`<br>```'desc'``=>``'Please add the ability to ....'``,`<br>```'labels'``=>``'green'``,`<br>```'idMembers'``=>``'TRELLO_MEMBER_ID_HERE'``,`<br>```'due'``=>``'2016-10-01T00:00:00+00:00'``,`<br>`);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_trello_card_5'``,``'change_name'``, 10, 4 );`<br>`function``change_name(``$card``,``$feed``,``$entry``,``$form``) {`<br>```$card``[``'name'``] =``'Your new card name'``;`<br>```return``$card`<br>`}` |

### 2\. Decode encoded characters in card description

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_trello_card'``,``function``(``$card``) {`<br>```$card``[``'desc'``] = htmlspecialchars_decode(``$card``[``'desc'``], ENT_QUOTES );`<br>```return``$card``;`<br>`} );` |
...
|     |     |
| --- | --- |
| 1 | `$card``= gf_apply_filters(``'gform_trello_card'``,``array``(``$form``[``'id'``] ),``$card``,``$feed``,``$entry``,``$form``);` |

This filter is located in GFTrello::process\_feed() in _class-gf-trello.php_.
...
[Algolia](https://docs.gravityforms.com/gform_trello_card/# "Algolia")
