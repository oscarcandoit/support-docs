---
url: "https://docs.gravityforms.com/gform_print_entry_header/"
title: "gform_print_entry_header - Gravity Forms Documentation"
---
...
# gform\_print\_entry\_header

- [Description](https://docs.gravityforms.com/gform_print_entry_header/#h-description)
- [Usage](https://docs.gravityforms.com/gform_print_entry_header/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_print_entry_header/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_print_entry_header/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_print_entry_header/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_print_entry_header/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_print_entry_header'``,``'custom_header'``, 10, 2 );` |
...
| **$entry** | [Entry Object](https://docs.gravityforms.com/entry-object) | The current entry object. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_action(``'gform_print_entry_header'``,``'custom_header'``, 10, 2 );`<br>`function``custom_header(``$form``,``$entry``) {`<br>```echo``"<h2>Date and Time: "``. esc_html(``$entry``[``'date_created'``] ) .``"</h2>"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_print_entry_header/# "Algolia")
