---
url: "https://docs.gravityforms.com/gform_moderation_score/"
title: "gform_moderation_score - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Moderation Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/moderation-filters/)          - [gform\_moderation\_locale](https://docs.gravityforms.com/gform_moderation_locale/ "gform_moderation_locale")
          - [gform\_moderation\_field\_types\_to\_analyze](https://docs.gravityforms.com/gform_moderation_field_types_to_analyze/ "gform_moderation_field_types_to_analyze")
          - [gform\_moderation\_score](https://docs.gravityforms.com/gform_moderation_score/ "gform_moderation_score")
...
# gform\_moderation\_score

- [Description](https://docs.gravityforms.com/gform_moderation_score/#h-description)
- [Usage](https://docs.gravityforms.com/gform_moderation_score/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_moderation_score/#h-parameters)
- [Score Parameters](https://docs.gravityforms.com/gform_moderation_score/#h-score-parameters)
- [Examples](https://docs.gravityforms.com/gform_moderation_score/#h-examples)
- [Check fields for URLs](https://docs.gravityforms.com/gform_moderation_score/#h-check-fields-for-urls)
- [Placement](https://docs.gravityforms.com/gform_moderation_score/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_moderation_score/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_moderation_score/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_moderation_score'``,``'your_function_name'``, 10, 4 );` |

## Parameters

| Setting | Type | Details |
| --- | --- | --- |
| **$score** | [Array](https://docs.gravityforms.com/array/) | An array containing the field scores and the total score. See [Score Parameters](https://docs.gravityforms.com/gform_moderation_score/#h-score-parameters). |
...
| **$fields\_to\_analyze** | [Field Object](https://docs.gravityforms.com/field-object/) [\[\]](https://docs.gravityforms.com/array/) | The fields currently being moderated. |

### Score Parameters

| Setting | Type | Details |
| --- | --- | --- |
| **$fields** | [Array](https://docs.gravityforms.com/array/) | An array using the field ID ( [string](https://docs.gravityforms.com/string/)) as the key to the field score ( [integer](https://docs.gravityforms.com/integer/) \| [float](https://docs.gravityforms.com/float/)). |
| **$total** | [Integer](https://docs.gravityforms.com/integer/) \| [Float](https://docs.gravityforms.com/float/) | The maximum score that was assigned to a field. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22<br>23<br>24<br>25<br>26<br>27<br>28<br>29<br>30<br>31 | `add_filter(``'gform_moderation_score'``,``function``(``$score``,``$entry``,``$form``,``$fields_to_analyze``) {`<br>```if``(``empty``(``$fields_to_analyze``) ) {`<br>```return``$score``;`<br>```}`<br>```$has_url``= false;`<br>```foreach``(``$fields_to_analyze``as``$field``) {`<br>```if``( ! in_array(``$field``->get_input_type(),``array``(``'text'``,``'textarea'``) ) ) {`<br>```continue``;`<br>```}`<br>```$value``=``$field``->get_value_export(``$entry``);`<br>```if``(``empty``(``$value``) ) {`<br>```continue``;`<br>```}`<br>```if``( preg_match(``"/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-a-z0-9+&@#\/%=~_|]/i"``,``$value``) ) {`<br>```$has_url``= true;`<br>```$score``[``'fields'``][ (string)``$field``->id ] = 1;`<br>```}`<br>```}`<br>```if``(``$has_url``) {`<br>```$score``[``'total'``] = 1;`<br>```}`<br>```gf_moderation()->log_debug(``'gform_moderation_score: '``. print_r(``$score``, true ) );`<br>```return``$score``;`<br>`}, 10, 4 );` |
...
This filter is located in `\Gravity_Forms\Gravity_Forms_Moderation\GF_Moderation::get_entry_toxicity_score()` in `class-gf-moderation.php`
...
[Algolia](https://docs.gravityforms.com/gform_moderation_score/# "Algolia")
