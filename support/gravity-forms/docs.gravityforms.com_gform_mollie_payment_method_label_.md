---
url: "https://docs.gravityforms.com/gform_mollie_payment_method_label/"
title: "gform_mollie_payment_method_label - Gravity Forms Documentation"
---
...
# gform\_mollie\_payment\_method\_label

- [Description](https://docs.gravityforms.com/gform_mollie_payment_method_label/#h-description)
- [Usage](https://docs.gravityforms.com/gform_mollie_payment_method_label/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_mollie_payment_method_label/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_mollie_payment_method_label/#h-examples)
- [Change the Mollie field label.](https://docs.gravityforms.com/gform_mollie_payment_method_label/#h-change-the-mollie-field-label)
- [Placement](https://docs.gravityforms.com/gform_mollie_payment_method_label/#h-placement)
- [Since](https://docs.gravityforms.com/gform_mollie_payment_method_label/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_mollie_payment_method_label/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mollie_payment_method_label, '``your_function_name', 10, 2 );` |

Applies to a specific form. In this case, form id 5.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mollie_payment_method_label_5'``,``'your_function_name'``, 10, 2 );` |

## Parameters

| **Parameter** | **Type** | **Description** |
| --- | --- | --- |
| **$label** | [string](https://docs.gravityforms.com/string) | The label to be filtered. |
| **$form\_id** | [int](https://docs.gravityforms.com/int) | The current form ID. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_mollie_payment_method_label'``,``function``(``$label``,``$form_id``) {`<br>``<br>```gf_mollie()->log_debug(``'gform_mollie_payment_method_label(): running.'``);`<br>```return``'Select Payment Processor'``;`<br>`}, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `json_encode(`<br>```gf_apply_filters(`<br>```array``(``'gform_mollie_payment_method_label'``, rgget(``'id'``) ),`<br>```esc_html__(``'Payment Method'``,``'gravityformsmollie'``),`<br>```rgget(``'id'``)`<br>```),`<br>```$default_payment_method`<br>`) . PHP_EOL;` |

This filter is located in GF\_Field\_Mollie::get\_form\_editor\_inline\_script\_on\_page\_render() in _class-gf-field-mollie.php_.
...
[Algolia](https://docs.gravityforms.com/gform_mollie_payment_method_label/# "Algolia")
