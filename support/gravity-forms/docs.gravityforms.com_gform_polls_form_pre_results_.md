---
url: "https://docs.gravityforms.com/gform_polls_form_pre_results/"
title: "gform_polls_form_pre_results - Gravity Forms Documentation"
---
...
# gform\_polls\_form\_pre\_results

- [Description](https://docs.gravityforms.com/gform_polls_form_pre_results/#h-description)
- [Usage](https://docs.gravityforms.com/gform_polls_form_pre_results/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_polls_form_pre_results/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_polls_form_pre_results/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_polls_form_pre_results/#h-placement)
- [Since](https://docs.gravityforms.com/gform_polls_form_pre_results/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_polls_form_pre_results/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_polls_form_pre_results'``,``'your_function_name'``, 10, 1 );` |

To target a specific form, append the form id to the hook name. (format: gform\_polls\_form\_pre\_results\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_polls_form_pre_results_2'``,``'your_function_name'``, 10, 1 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_polls_form_pre_results'``,``'change_poll_form'``, 10, 1 );`<br>`function``change_poll_form(``$form``){`<br>`$form``[``'title'``] =``'Testing'``;``//change some data`<br>`return``$form``;`<br>`}` |
...
This filter is located in GFPolls::gpoll\_get\_data() in _gravityformspolls/class-gf-polls.php_
...
[Algolia](https://docs.gravityforms.com/gform_polls_form_pre_results/# "Algolia")
