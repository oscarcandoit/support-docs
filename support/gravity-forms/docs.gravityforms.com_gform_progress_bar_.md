---
url: "https://docs.gravityforms.com/gform_progress_bar/"
title: "gform_progress_bar - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_progress_bar/#h-description)
- [Usage](https://docs.gravityforms.com/gform_progress_bar/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_progress_bar/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_progress_bar/#h-examples)
- [1\. Generate custom progress bar markup](https://docs.gravityforms.com/gform_progress_bar/#h-1-generate-custom-progress-bar-markup)
- [2\. Replace Step with Level](https://docs.gravityforms.com/gform_progress_bar/#h-2-replace-step-with-level)
- [Placement](https://docs.gravityforms.com/gform_progress_bar/#h-placement)
- [Since](https://docs.gravityforms.com/gform_progress_bar/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_progress_bar/#h-source-code)
...
|     |
| --- |
| `// template`<br>`add_filter(``'gform_progress_bar_{formId}'``,``'my_custom_function'``, 10, 3 );`<br>``<br>`// target form ID 1`<br>`add_filter(``'gform_progress_bar_1'``,``'my_custom_function'``, 10, 3 );` |

## Parameters

- **$progress\_bar** [string](https://docs.gravityforms.com/string)
...
|     |
| --- |
| `add_filter(``'gform_progress_bar'``,``function``(``$progress_bar``,``$form``,``$confirmation_message``) {`<br>``<br>```$progress_bar``= '<ul>`<br>```<li>Page 1</li>`<br>```<li>Page 2</li>`<br>```<li>Page 3</li>`<br>```</ul>';`<br>``<br>```return``$progress_bar``;`<br>`}, 10, 3 );` |

### 2\. Replace Step with Level

|     |
| --- |
| `add_filter(``'gform_progress_bar'``,``function``(``$progress_bar``,``$form``,``$confirmation_message``) {`<br>```$progress_bar``=``str_replace``(``'Step'``,``'Level'``,``$progress_bar``);`<br>```return``$progress_bar``;`<br>`}, 10, 3 );` |
...
This filter is located in the GFFormDisplay class in _form\_display.php_.
...
[Algolia](https://docs.gravityforms.com/gform_progress_bar/# "Algolia")
