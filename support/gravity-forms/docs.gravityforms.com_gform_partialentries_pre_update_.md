---
url: "https://docs.gravityforms.com/gform_partialentries_pre_update/"
title: "gform_partialentries_pre_update - Gravity Forms Documentation"
---
...
# gform\_partialentries\_pre\_update

- [Description](https://docs.gravityforms.com/gform_partialentries_pre_update/#h-description)
- [Usage](https://docs.gravityforms.com/gform_partialentries_pre_update/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_partialentries_pre_update/#h-examples)
- [Restore field value](https://docs.gravityforms.com/gform_partialentries_pre_update/#h-restore-field-value)
- [Placement](https://docs.gravityforms.com/gform_partialentries_pre_update/#h-placement)
- [Since](https://docs.gravityforms.com/gform_partialentries_pre_update/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_partialentries_pre_update/#h-source-code)

## Description

The gform\_partialentries\_pre\_update filter is used to modify an existing partial entry before the database is updated.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_partialentries_pre_update'``,``'your_function_name'``, 10, 3 );` |

You can also target a specific form by adding the form id after the hook name.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_partialentries_pre_update_6'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$partial\_entry** [Entry Object](https://docs.gravityforms.com/entry-object/)
...
- **$saved\_entry** [Entry Object](https://docs.gravityforms.com/entry-object/)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_partialentries_pre_update'``,``function``(``$partial_entry``,``$saved_entry``,``$form``) {`<br>```$partial_entry``[``'2'``] =``$saved_entry``[``'2'``];`<br>```return``$partial_entry``;`<br>`}, 10, 3 );` |
...
This filter is located in GF\_Partial\_Entries::filter\_partial\_entry\_before\_update() in _class-gf-partial-entries.php_.
...
[Algolia](https://docs.gravityforms.com/gform_partialentries_pre_update/# "Algolia")
