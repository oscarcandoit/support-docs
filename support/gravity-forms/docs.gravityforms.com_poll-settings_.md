---
url: "https://docs.gravityforms.com/poll-settings/"
title: "Polls Add-On Settings Reference - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/poll-settings/#h-introduction)
- [Accessing the Polls Add-On Settings](https://docs.gravityforms.com/poll-settings/#h-accessing-the-polls-add-on-settings)
- [Polls Add-On Settings](https://docs.gravityforms.com/poll-settings/#h-polls-add-on-settings)

## Introduction

Besides the field level settings available within the [Poll field](https://docs.gravityforms.com/polls/), there are additional form-level settings available within the Polls Add-On, giving you more flexibility to control your poll as it pertains to the display and behavior of your poll on a particular form.

[![Form Level Poll Settings](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-09-at-12.52.53.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-09-at-12.52.53.png)

## Accessing the Polls Add-On Settings

1. Log into your WordPress admin dashboard.
2. Click on **Forms** on the left side navigation menu, and click on your desired form.
3. On the top menu, there is a menu item labeled **Settings**. Hover over it and click on **Polls**.

## Polls Add-On Settings

|     |     |
| --- | --- |
| **Results** | Shows results to the user _after_ a vote has been submitted. Enabled by default. |
| **Results Link** | Shows the “View Results” link that displays _before_ the vote has been placed. Enabled by default. |
| **Percentages** | Shows the percentages from the poll results. Enabled by default. |
| **Counts** | Similar to the Percentages option but enables or disables the display of vote counts. Enabled by default. |
| **Style** | Adjusts the color of the results between the options of Green, Blue, Red, and Orange. |
| **Block Repeat Voters** | Choosing “Block repeat voters using cookie” will attempt to store a cookie in the user browser to limit this user from voting again. You are able to set the time frame that this cookie expires, thus allowing later votes from this user, but delayed. |
...
[Algolia](https://docs.gravityforms.com/poll-settings/# "Algolia")
