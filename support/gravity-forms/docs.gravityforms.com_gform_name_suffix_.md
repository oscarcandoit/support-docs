---
url: "https://docs.gravityforms.com/gform_name_suffix/"
title: "gform_name_suffix - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_name_suffix/#h-description)
- [Usage](https://docs.gravityforms.com/gform_name_suffix/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_name_suffix/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_name_suffix/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_name_suffix/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_name_suffix'``,``'change_suffix'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_name_suffix'``,``'change_suffix'``, 10, 2 );`<br>`function``change_suffix(``$label``,``$form_id``) {`<br>```return``"Name Suffix"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_name_suffix/# "Algolia")
