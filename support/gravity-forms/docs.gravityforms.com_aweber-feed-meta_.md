---
url: "https://docs.gravityforms.com/aweber-feed-meta/"
title: "AWeber Feed Meta - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/aweber-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/aweber-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the AWeber Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `$feed``[``'meta'``] =``array``(`<br>```'feedName'``=>``'Your Feed Name'``,`<br>```'listFields_email'``=>``'2'``,`<br>```'listFields_fullname'``=>``'1'``,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **account** [string](https://docs.gravityforms.com/string)
...
- **listFields\_cf\_ _{custom\_field\_id}_** [string](https://docs.gravityforms.com/string)

The ID of the field containing the value for the custom field.

There would be properties for any custom fields configured for your list, they all begin **listFields\_cf\_** and then end with the custom field ID, e.g. listFields\_cf\_1.
...
[Algolia](https://docs.gravityforms.com/aweber-feed-meta/# "Algolia")
