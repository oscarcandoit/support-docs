---
url: "https://docs.gravityforms.com/gform_checkbox_limit_exact_message/"
title: "gform_checkbox_limit_exact_message - Gravity Forms Documentation"
---
...
# gform\_checkbox\_limit\_exact\_message

- [Description](https://docs.gravityforms.com/gform_checkbox_limit_exact_message/#h-description)
- [Usage](https://docs.gravityforms.com/gform_checkbox_limit_exact_message/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_checkbox_limit_exact_message/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_checkbox_limit_exact_message/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_checkbox_limit_exact_message/#h-placement)
- [Since](https://docs.gravityforms.com/gform_checkbox_limit_exact_message/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_checkbox_limit_exact_message/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_checkbox_limit_exact_message'``,``'your_function_name'``, 10, 3 );` |
...
- **$number** [int](https://docs.gravityforms.com/int)

The number of choices that must be selected.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_checkbox_limit_exact_message'``,``'exact_message'``, 10, 3 );`<br>`function``exact_message(``$message``,``$number``,``$field``) {`<br>```return``'You must pick exactly '``.``$number``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_checkbox_limit_exact_message/# "Algolia")
