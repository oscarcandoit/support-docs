---
url: "https://docs.gravityforms.com/increasing-php-memory-limits/"
title: "Increasing Your PHP Memory Limits - Gravity Forms Documentation"
---
...
- [Modifying WordPress' memory limit](https://docs.gravityforms.com/increasing-php-memory-limits/#h-modifying-wordpress-memory-limit)
- [Modifying your server's memory limit](https://docs.gravityforms.com/increasing-php-memory-limits/#h-modifying-your-server-s-memory-limit)
- [Modifying your memory limit in php.ini](https://docs.gravityforms.com/increasing-php-memory-limits/#h-modifying-your-memory-limit-in-php-ini)
- [Modifying your memory limit in .htaccess](https://docs.gravityforms.com/increasing-php-memory-limits/#h-modifying-your-memory-limit-in-htaccess)
- [Follow your web host's instructions](https://docs.gravityforms.com/increasing-php-memory-limits/#h-follow-your-web-host-s-instructions)
...
|     |     |
| --- | --- |
| 1 | `define(``'WP_MEMORY_LIMIT'``,``'4096M'``);` |
...
If you have a php.ini file within your site’s home directory, locate the line containing **memory\_limit** and edit it to the following:

|     |     |
| --- | --- |
| 1 | `memory_limit = 4086M` |
...
|     |     |
| --- | --- |
| 1 | `php_value memory_limit 4086M` |
...
- [Bluehost](https://my.bluehost.com/cgi/help/memory)
- [GoDaddy](https://www.godaddy.com/help/what-filename-does-my-php-initialization-file-need-to-use-8913)
- [Hostgator](http://support.hostgator.com/articles/pre-sales-policies/php-settings-that-cannot-be-changed)
- [InMotion Hosting](http://www.inmotionhosting.com/support/website/php/update-local-php-settings)
- [Kinsta](https://kinsta.com/blog/wordpress-maximum-upload-file-size/)
- [SiteGround](https://www.siteground.com/kb/how_to_increase_php_memory/)
...
[Algolia](https://docs.gravityforms.com/increasing-php-memory-limits/# "Algolia")
