---
url: "https://docs.gravityforms.com/gform_paypal_post_ipn/"
title: "gform_paypal_post_ipn - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_paypal_post_ipn/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_post_ipn/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_paypal_post_ipn/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_paypal_post_ipn/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_paypal_post_ipn/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_paypal_post_ipn'``,``'your_function_name'``, 10, 4) ;` |

## Parameters

- **$\_POST** [array](https://docs.gravityforms.com/array)
...
- **$cancel** [boolean](https://docs.gravityforms.com/boolean)

Defaults to false. Indicates whether the IPN processing was canceled by the [gform\_paypal\_pre\_ipn](https://docs.gravityforms.com/gform_paypal_pre_ipn) hook.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13 | `add_action(``'gform_paypal_post_ipn'``,``'update_order_status'``, 10, 4 );`<br>`function``update_order_status(``$ipn_post``,``$entry``,``$feed``,``$cancel``) {`<br>`// if the IPN was canceled, don't process`<br>`if``(``$cancel``)`<br>`return``;`<br>`// get first and last name from $entry`<br>`$order_id``=``$entry``[``'id'``];`<br>`// use fictional function to add order to fictional My Third Party application`<br>`mtp_update_order(``$order_id``,``$ipn_post``);`<br>`}` |

The following example deletes the post associated with the entry when the subscription term ends.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14 | `add_action(``'gform_paypal_post_ipn'``,``'delete_post'``, 10, 4 );`<br>`function``delete_post(``$ipn_post``,``$entry``,``$feed``,``$cancel``) {`<br>`// if the IPN was canceled, don't process`<br>`if``(``$cancel``)`<br>`return``;`<br>`$transaction_type``=``$ipn_post``[``'txn_type'``];`<br>`//delete post if this is the end of term`<br>`if``(``strtolower``(``$transaction_type``) ==``'subscr_eot'``) {`<br>`wp_delete_post(``$entry``[``'post_id'``] );`<br>`}`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `do_action(``'gform_paypal_post_ipn'``,``$_POST``,``$entry``,``$feed``, true )` |

This hook is located in GFPayPal::can\_process\_ipn() in _class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_post_ipn/# "Algolia")
