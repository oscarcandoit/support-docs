---
url: "https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/"
title: "Stripe Checkout Payment Methods: GForm Guide"
---
...
# gform\_stripe\_checkout\_payment\_methods

- [Description](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-placement)
- [Notes](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-notes)
- [Populating the $payment\_method parameter](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-populating-the-payment_method-parameter)
- [Interaction With Stripe Dashboard Settings](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-interaction-with-stripe-dashboard-settings)
- [Country and Currency](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-country-and-currency)
- [Since](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_checkout_payment_methods'``,``'your_function_name'``, 10, 3);` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$payment\_methods** | array | An array of payment methods. These will be white-listed to be presented according to the payment method presentation rules. |
| **$feed** | [Feed Object](https://docs.gravityforms.com/feed-object/) | The feed being processed. |
| **$form** | [Form Object](https://docs.gravityforms.com/form-object/) | The form which created the current entry. |

## Examples

|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_stripe_checkout_payment_methods'``,``function``(``$payment_methods``,``$feed``,``$form``) {`<br>```return``array``(``'card'``,``'us_bank_account'``);`<br>`}, 10, 3);` |
...
Note that implementation of specific payment methods via hook may be limited by your country and the currency you are using. For example, to use `us_bank_account` Stripe requires that the merchant be located in the United States, and that the currency being charged is $US.

Refer to [this Stripe reference table](https://stripe.com/docs/payments/payment-methods/integration-options#country-currency-support) regarding the limitations of payment methods and currency.
...
|     |     |
| --- | --- |
| 1 | `$payment_methods``= apply_filters(``'gform_stripe_checkout_payment_methods'``,``array``(``'card'``),``$feed``,``$form``);` |

This filter is located in GFStripe::register\_init\_scripts() in _gravityformsstripe/class-gf-stripe.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_checkout_payment_methods/# "Algolia")
