---
url: "https://docs.gravityforms.com/gform_stripe_field_value/"
title: "gform_stripe_field_value - Gravity Forms Documentation"
---
...
# gform\_stripe\_field\_value

- [Description](https://docs.gravityforms.com/gform_stripe_field_value/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_field_value/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_stripe_field_value/#h-examples)
- [1\. Change value of specific custom meta key](https://docs.gravityforms.com/gform_stripe_field_value/#h-1-change-value-of-specific-custom-meta-key)
- [Placement](https://docs.gravityforms.com/gform_stripe_field_value/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_field_value/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_field_value/#h-source-code)

## Description

This filter can be used to modify a value before it is sent to Stripe. If you want to filter the value for any add-on you can use [gform\_addon\_field\_value](https://docs.gravityforms.com/gform_addon_field_value).
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_field_value'``,``'your_function_name'``, 10, 5 );` |

To target a specific form append the form id to the hook name. (format: gform\_stripe\_field\_value\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_field_value_10'``,``'your_function_name'``, 10, 4 );` |

To target a specific field append both the form id and the field id to the hook name. (format: gform\_stripe\_field\_value\_FORMID\_FIELDID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_field_value_10_3'``,``'your_function_name'``, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_stripe_field_value'``,``function``(``$field_value``,``$form``,``$entry``,``$field_id``,``$meta_key``) {`<br>`if``(``$meta_key``==``'my custom key'``) {`<br>`$field_value``=``'my custom value'``;`<br>`}`<br>`return``$field_value``;`<br>`}, 10, 5 );` |
...
This filter is located in GFStripe::maybe\_override\_field\_value() in _class-gf-stripe.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_field_value/# "Algolia")
