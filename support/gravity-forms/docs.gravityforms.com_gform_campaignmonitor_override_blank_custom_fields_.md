---
url: "https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/"
title: "gform_campaignmonitor_override_blank_custom_fields - Gravity Forms"
---
...
# gform\_campaignmonitor\_override\_blank\_custom\_fields

- [Description](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/#h-description)
- [Usage](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/#h-examples)
- [1\. Override all feeds](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/#h-1-override-all-feeds)
- [2\. Override specific feed](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/#h-2-override-specific-feed)
- [Placement](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_campaignmonitor_override_blank_custom_fields'``,``'your_function_name'``, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_campaignmonitor_override_blank_custom_fields'``,``'__return_true'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_campaignmonitor_override_blank_custom_fields'``,``function``(``$override``,``$entry``,``$form``,``$feed``) {`<br>```$feed_name``= rgars(``$feed``,``'meta/feedName'``);`<br>```return``$feed_name``==``'Your feed name'``? true : false;`<br>`}, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1 | `apply_filters(``'gform_campaignmonitor_override_blank_custom_fields'``, false,``$entry``,``$form``,``$feed``)` |
...
[Algolia](https://docs.gravityforms.com/gform_campaignmonitor_override_blank_custom_fields/# "Algolia")
