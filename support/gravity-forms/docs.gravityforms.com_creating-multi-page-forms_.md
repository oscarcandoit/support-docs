---
url: "https://docs.gravityforms.com/creating-multi-page-forms/"
title: "Creating Multi-Page Forms - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/creating-multi-page-forms/#h-introduction)
- [Setup](https://docs.gravityforms.com/creating-multi-page-forms/#h-setup)
- [Options](https://docs.gravityforms.com/creating-multi-page-forms/#h-options)
...
1. This article assumes that you have a basic understanding in creating forms, and have already created a form with multiple fields. If you need more information, see our [form creation](https://docs.gravityforms.com/creating-a-form/) article.
2. Now that you have your form fields in place, you just need to separate the fields by page. To do this, go to the right of the form editor and look inside the **Standard Fields** section. Inside this section, click and drag the **Page** field type and drop it between two fields where you would like a page break to appear.

[![](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-01-at-18.54.37.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-01-at-18.54.37.png)

3. You should see that 3 items have been added to the form editor. These items allow you to determine where pages begin and end. 2 of these items, **Begin Paging** and **End Paging** simply define that this form is a multi-page form. These items cannot be moved and will always be located at the beginning and end of the form editor when editing a multi-page form.
...
[![Multipage in Form Editor](https://docs.gravityforms.com/wp-content/uploads/2021/07/image-4-1024x543.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/image-4.png)

4. If you want to add additional pages to a multi-page form, all you have to do is click on the **Page** field type again to add an additional page break and position it where you would like the previous page to end and the next page to begin. You can add as many page breaks as you want.


## Options

To modify the behavior of multi-page forms, options exist within the individual items that are added using the _Page_ field. For more information on how you can modify settings specific to multi-page forms, take a look at the [Page Break field type](https://docs.gravityforms.com/page-break/) article.
...
[Algolia](https://docs.gravityforms.com/creating-multi-page-forms/# "Algolia")
