---
url: "https://docs.gravityforms.com/setting-up-the-kit-add-on/"
title: "Setting up the Kit Add-On - Gravity Forms Documentation"
---
...
- [Pre-Requisites](https://docs.gravityforms.com/setting-up-the-kit-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-up-the-kit-add-on/#h-setup)
...
- A [Kit](https://app.convertkit.com/users/signup) account

## Setup

1. Log into your WordPress admin dashboard.
2. On the left side navigation menu, hover over **Forms** and click on **Settings**.
3. From this page, click the **Kit** tab.
4. Enter your **API Key** and **API Secret**. This is obtained from your Kit account. If you are unsure of how to obtain your API key, you may review our documentation on [obtaining your Kit API key](https://docs.gravityforms.com/?p=37190).
5. Click **Update Settings**. If you’ve entered your account information correctly, you will be notified by two green check marks beside each box. If you do not see a green check mark, please double-check this information and try again.

Once you have entered your API key and API secret, you’re ready to begin [creating a feed for the Kit Add-On](https://docs.gravityforms.com/?p=37199).
...
[Algolia](https://docs.gravityforms.com/setting-up-the-kit-add-on/# "Algolia")
