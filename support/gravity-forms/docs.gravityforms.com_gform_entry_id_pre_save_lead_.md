---
url: "https://docs.gravityforms.com/gform_entry_id_pre_save_lead/"
title: "gform_entry_id_pre_save_lead - Gravity Forms Documentation"
---
...
# gform\_entry\_id\_pre\_save\_lead

- [Description](https://docs.gravityforms.com/gform_entry_id_pre_save_lead/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_id_pre_save_lead/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entry_id_pre_save_lead/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_entry_id_pre_save_lead/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_entry_id_pre_save_lead/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_id_pre_save_lead'``,``'my_update_entry_on_form_submission'``, 10, 2 );` |

Apply to a specific form.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_id_pre_save_lead_10'``,``'my_update_entry_on_form_submission'``, 10, 2 );` |
...
This assumes that the entry ID to be updated has been submitted with the form from an input which as the input name “my\_update\_entry\_id”. You can store it in any input, but you will need to update the input name used when you retrieve the value via the rgpost() function.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_entry_id_pre_save_lead'``,``'my_update_entry_on_form_submission'``, 10, 2 );`<br>`function``my_update_entry_on_form_submission(``$entry_id``,``$form``) {`<br>```$update_entry_id``= rgpost(``'my_update_entry_id'``);`<br>```return``$update_entry_id``?``$update_entry_id``:``$entry_id``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_id_pre_save_lead/# "Algolia")
