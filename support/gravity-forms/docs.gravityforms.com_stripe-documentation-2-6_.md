---
url: "https://docs.gravityforms.com/stripe-documentation-2-6/"
title: "Upgrading to Stripe version 2.6 - Gravity Forms Documentation"
---
...
- [New Features](https://docs.gravityforms.com/stripe-documentation-2-6/#h-new-features)
- [Upgrade Notes](https://docs.gravityforms.com/stripe-documentation-2-6/#h-upgrade-notes)
- [Further Information](https://docs.gravityforms.com/stripe-documentation-2-6/#h-further-information)

## New Features

The Gravity Forms official [Stripe add-on version 2.6](https://www.gravityforms.com/introducing-the-new-stripe-2-6-add-on-update/) includes two new methods for collecting payment information:

1. Stripe Credit Card Field (Elements)
2. Stripe Payment Form (Checkout)
...
For an overview of this release, refer to our [blog post announcement](https://www.gravityforms.com/introducing-the-new-stripe-2-6-add-on-update/).

For a list of changes, refer to the [official change log](https://docs.gravityforms.com/stripe-change-log/).

For our user guides and help articles, check out the other articles contained [in this section](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/) of our document site.
...
[Algolia](https://docs.gravityforms.com/stripe-documentation-2-6/# "Algolia")
