---
url: "https://docs.gravityforms.com/gform_moderation_locale/"
title: "gform_moderation_locale - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_moderation_locale/#h-description)
- [Usage](https://docs.gravityforms.com/gform_moderation_locale/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_moderation_locale/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_moderation_locale/#h-examples)
- [Set specific form to use Spanish locale](https://docs.gravityforms.com/gform_moderation_locale/#h-set-specific-form-to-use-spanish-locale)
- [Placement](https://docs.gravityforms.com/gform_moderation_locale/#h-placement)
- [Since](https://docs.gravityforms.com/gform_moderation_locale/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_moderation_locale/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_moderation_locale'``,``'your_function_name'``, 10, 2 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$locale** | string | The locale being filtered. |
| **$entry** | array | During a form submission, contains the current Entry Object. |

The **$locale** parameter supports the following locales and any prefixed with these strings:

|     |
| --- |
| `ar`<br>`zh`<br>`cs`<br>`nl`<br>`en`<br>`fr`<br>`de`<br>`hi`<br>`id`<br>`it`<br>`ja`<br>`ko`<br>`pl`<br>`pt`<br>`ru`<br>`es`<br>`sv` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_moderation_locale'``,``function``(``$locale``,``$entry``) {`<br>```if``( rgar(``$entry``,``'form_id'``) ==``'4'``) {`<br>```return``'es_ES'``;`<br>```}`<br>```return``$locale``;`<br>`}, 10, 2 );` |
...
[Algolia](https://docs.gravityforms.com/gform_moderation_locale/# "Algolia")
