---
url: "https://docs.gravityforms.com/gform_activecampaign_contact_pre_sync/"
title: "gform_activecampaign_contact_pre_sync - Gravity Forms"
---
...
- [Description](https://docs.gravityforms.com/gform_activecampaign_contact_pre_sync/#h-description)
- [Usage](https://docs.gravityforms.com/gform_activecampaign_contact_pre_sync/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_activecampaign_contact_pre_sync/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_activecampaign_contact_pre_sync/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_activecampaign_contact_pre_sync/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_activecampaign_contact_pre_sync/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_activecampaign_contact_pre_sync/#h-since)

## Description

The gform\_activecampaign\_contact\_pre\_sync filter can be used to override the contact properties before the contact\_sync request is sent to the API.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_activecampaign_contact_pre_sync'``,``'your_function_name'``, 10, 4 );` |

You can limit the scope of the filter to a single form by appending the form id on the end of the hook name like so:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_activecampaign_contact_pre_sync_5'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$contact** [array](https://docs.gravityforms.com/array)
The contact properties. See the [ActiveCampaign API documentation](http://www.activecampaign.com/api/example.php?call=contact_sync) for the full list of accepted properties.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_activecampaign_contact_pre_sync'``,``function``(``$contact``,``$entry``,``$form``,``$feed``) {`<br>```$contact``[``'ip4'``] = rgar(``$entry``,``'ip'``);`<br>```return``$contact``;`<br>`}, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1<br>2 | `$contact``= apply_filters(``'gform_activecampaign_contact_pre_sync'``,``$contact``,``$entry``,``$form``,``$feed``);`<br>`$contact``= apply_filters(``'gform_activecampaign_contact_pre_sync_'``.``$form``[``'id'``],``$contact``,``$entry``,``$form``,``$feed``);` |

This filter is located in GFActiveCampaign::process\_feed() in _class-gf-activecampaign.php_.
...
[Algolia](https://docs.gravityforms.com/gform_activecampaign_contact_pre_sync/# "Algolia")
