---
url: "https://docs.gravityforms.com/gform_confirmation_settings_fields/"
title: "gform_confirmation_settings_fields - Gravity Forms Documentation"
---
...
# gform\_confirmation\_settings\_fields

- [Description](https://docs.gravityforms.com/gform_confirmation_settings_fields/#h-description)
- [Usage](https://docs.gravityforms.com/gform_confirmation_settings_fields/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_confirmation_settings_fields/#h-examples)
- [1\. Add a new field](https://docs.gravityforms.com/gform_confirmation_settings_fields/#h-1-add-a-new-field)
- [Placement](https://docs.gravityforms.com/gform_confirmation_settings_fields/#h-placement)
- [Since](https://docs.gravityforms.com/gform_confirmation_settings_fields/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_confirmation_settings_fields/#h-source-code)

## Description

The gform\_confirmation\_settings\_fields filter allows the confirmation settings fields to be modified before they are displayed.
...
The confirmation settings fields. See the [Settings API](https://docs.gravityforms.com/category/developers/php-api/add-on-framework/settings-api/) for details about how the fields are defined.

- **$confirmation** [Confirmation Object](https://docs.gravityforms.com/confirmations-object)
...
This filter is located in _\\GF\_Confirmation::settings\_fields()_ in _includes/class-confirmation.php_.
...
[Algolia](https://docs.gravityforms.com/gform_confirmation_settings_fields/# "Algolia")
