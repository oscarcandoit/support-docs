---
url: "https://docs.gravityforms.com/category/fields/pricing-fields/page/2/"
title: "Pricing Fields Archives - Page 2 of 2 - Gravity Forms Documentation - Page 2 of 2"
---
...
[**Stripe Field** \\
This field is only available in the Form Editor if you have installed the official Gravity Forms Stripe Add-on. If you drag the Stripe field onto your form without having completed your Stripe setup, you will get a warning message that either setup or a feed is required.](https://docs.gravityforms.com/stripe-field/ "Stripe Field") [**Total** \\
The Total field specifies where the order total should be displayed in the form. As the user selects products and options the total will automatically update.](https://docs.gravityforms.com/total/ "Total") [Previous](https://docs.gravityforms.com/category/fields/pricing-fields/) [1](https://docs.gravityforms.com/category/fields/pricing-fields/) 2

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/fields/pricing-fields/page/2/# "Algolia")
