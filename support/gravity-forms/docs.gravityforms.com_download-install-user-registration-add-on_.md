---
url: "https://docs.gravityforms.com/download-install-user-registration-add-on/"
title: "Setting Up the User Registration Add-On"
---
...
- [Pre-Requisites](https://docs.gravityforms.com/download-install-user-registration-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/download-install-user-registration-add-on/#h-setup)

## Pre-Requisites

- The Gravity Forms plug-in must be installed.
...
After you have the add-on installed and activated, you are now ready to use the User Registration Add-On. See our article on [Using the User Registration Add-On](https://docs.gravityforms.com/user-registration-add-on/) for detailed instructions.
...
[Algolia](https://docs.gravityforms.com/download-install-user-registration-add-on/# "Algolia")
