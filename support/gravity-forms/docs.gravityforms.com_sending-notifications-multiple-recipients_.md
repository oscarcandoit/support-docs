---
url: "https://docs.gravityforms.com/sending-notifications-multiple-recipients/"
title: "Sending Notifications To Multiple Recipients- Gravity Forms"
---
...
[![](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-07-at-15.42.55.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-07-at-15.42.55.png)

2. Hover over the Notification and click **Edit**.


[![](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-07-at-15.58.13.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-07-at-15.58.13.png)

3. Scroll down to the **Send to Email** field and add each email that you want to send the notification to, separated by a comma. For example:

```
email1@example.com,email2@example.com,email3@example.com
```

[![Notification Multiple Recipients - Send To Email](https://docs.gravityforms.com/wp-content/uploads/2021/07/image-12.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/image-12.png)

4. Click the **Update Notification** button to save your settings.
...
**Note:** When using a field **merge tag in the _Send to Email_ setting**, that field should be set as **required**. If the field doesn’t have a value then the notification would not be sent.
...
[Algolia](https://docs.gravityforms.com/sending-notifications-multiple-recipients/# "Algolia")
