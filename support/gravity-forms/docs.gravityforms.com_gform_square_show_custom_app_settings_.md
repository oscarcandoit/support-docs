---
url: "https://docs.gravityforms.com/gform_square_show_custom_app_settings/"
title: "gform_square_show_custom_app_settings - Gravity Forms Documentation"
---
...
# gform\_square\_show\_custom\_app\_settings

- [Description](https://docs.gravityforms.com/gform_square_show_custom_app_settings/#h-description)
- [Usage](https://docs.gravityforms.com/gform_square_show_custom_app_settings/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_square_show_custom_app_settings/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_square_show_custom_app_settings/#h-placement)
- [Input for Custom App Settings for Square](https://docs.gravityforms.com/gform_square_show_custom_app_settings/#h-input-for-custom-app-settings-for-square)
- [Since](https://docs.gravityforms.com/gform_square_show_custom_app_settings/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_square_show_custom_app_settings/#h-source-code)

## Description

The gform\_square\_show\_custom\_app\_settings filter allows displaying the custom app settings link in the Square add-on settings page.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_square_show_custom_app_settings'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$show\_settings** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_square_show_custom_app_settings'``,``'__return_true'``);` |
...
![Square Settings Custom Application Option](https://docs.gravityforms.com/wp-content/uploads/2020/03/square-settings-custom-application-option.png)
...
![Square Settings Custom Application Authentication Option Settings](https://docs.gravityforms.com/wp-content/uploads/2020/03/square-settings-custom-application-input-1024x508.png)

In addition to the regular Mode Settings for Square (Live and Sandbox), the following three fields are available:

1. **OAuth Redirect URI**: This will change depending on whether you are pointing to **Live** or **Sandbox**, but the URI is _not editable_.
...
|     |     |
| --- | --- |
| 1 | `$show_settings``= apply_filters(``'gform_square_show_custom_app_settings'``, false );` |

This hook is located in GF\_Square::show\_custom\_app\_settings() in _class-gf-square.php_.
...
[Algolia](https://docs.gravityforms.com/gform_square_show_custom_app_settings/# "Algolia")
