---
url: "https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/"
title: "Gravity Forms 2.5 Known Limitations - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-introduction)
- [Known Changes & Limitations](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-known-changes-limitations)
- [Javascript](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-javascript)
- [Form Editor](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-form-editor)
- [Columns](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-columns)
- [Translations](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-translations)
- [Mobile Display](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-mobile-display)
- [Add-Ons](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-add-ons)
- [Deprecated Items](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-deprecated-items)
- [Filters](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-filters)
- [Add-On Framework Changes](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-add-on-framework-changes)
- [Found Something Not Listed Here?](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/#h-found-something-not-listed-here)
...
- The _gf\_inline_ and the _column_ [ready classes](https://docs.gravityforms.com/list-of-css-ready-classes/) are not supported in the new markup. This is superseded by the ability to drag & drop the fields columns directly using the editor.
...
- The [Credit Card Field](https://docs.gravityforms.com/credit-card-field/) no longer has a _Card Icon Style_ setting.
...
- The datepicker is now translated automatically. The [previous snippet](https://docs.gravityforms.com/translating-the-datepicker) that was used to load custom datepicker translations must be removed.
...
~~Processing of BuddyPress field mappings for the User Registration add-on is not currently supported.~~ Fixed in [User Registration v4.8](https://docs.gravityforms.com/userregistration-change-log/#4-8-2021-04-28).

## Deprecated Items

### Filters

[gform\_notification\_validation](https://docs.gravityforms.com/gform_notification_validation/) filter has been removed.

### Add-On Framework Changes

The following methods have been deprecated, and will return null due to no action being taken.

- GFAddOn::maybe\_save\_form\_settings()
- GFAddOn::maybe\_save\_plugin\_settings()

## Found Something Not Listed Here?

Contact our [Customer Support team here](https://www.gravityforms.com/support).
...
[Algolia](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/# "Algolia")
