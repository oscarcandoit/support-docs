---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/authorize-net-filters/"
title: "Authorize.net Filters Archives - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Authorize.net Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/authorize-net-filters/)          - [Authorize.Net Config](https://docs.gravityforms.com/authorize-net-config/ "Authorize.Net Config")
          - [Authorize.Net Feed Meta](https://docs.gravityforms.com/authorize-net-feed-meta/ "Authorize.Net Feed Meta")
          - [Form Data](https://docs.gravityforms.com/form-data/ "Form Data")
          - [gform\_authorizenet\_amount\_pre\_authorize](https://docs.gravityforms.com/gform_authorizenet_amount_pre_authorize/ "gform_authorizenet_amount_pre_authorize")
          - [gform\_authorizenet\_field\_value](https://docs.gravityforms.com/gform_authorizenet_field_value/ "gform_authorizenet_field_value")
          - [gform\_authorizenet\_post\_capture](https://docs.gravityforms.com/gform_authorizenet_post_capture/ "gform_authorizenet_post_capture")
          - [gform\_authorizenet\_subscription\_pre\_create](https://docs.gravityforms.com/gform_authorizenet_subscription_pre_create/ "gform_authorizenet_subscription_pre_create")
          - [gform\_authorizenet\_transaction\_pre\_authorize](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/ "gform_authorizenet_transaction_pre_authorize")
          - [gform\_authorizenet\_transaction\_pre\_capture](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture/ "gform_authorizenet_transaction_pre_capture")
          - [gform\_authorizenet\_transaction\_pre\_capture\_setup\_fee](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/ "gform_authorizenet_transaction_pre_capture_setup_fee")
          - [gform\_authorizenet\_validation\_message](https://docs.gravityforms.com/gform_authorizenet_validation_message/ "gform_authorizenet_validation_message")
...
The Feed Meta object for the Authorize.Net Add-On is an associative array containing the properties which determine what type of transaction should occur and what values are sent to Authorize.Net.](https://docs.gravityforms.com/authorize-net-feed-meta/ "Authorize.Net Feed Meta") [**Form Data** \\
Form Data ($form\_data) is an associative array containing all the payment related properties for the entry being processed by the Authorize.Net add-on.](https://docs.gravityforms.com/form-data/ "Form Data") [**gform\_authorizenet\_amount\_pre\_authorize** \\
...
Allows the transaction to be modified before authorization occurs.](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_authorize/ "gform_authorizenet_transaction_pre_authorize") [**gform\_authorizenet\_transaction\_pre\_capture** \\
This filter can be used to modify the transaction object before it is sent to Authorize.net.](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture/ "gform_authorizenet_transaction_pre_capture") [**gform\_authorizenet\_transaction\_pre\_capture\_setup\_fee** \\
This filter can be used to modify the transaction object for the subscription setup fee before it is sent to Authorize.net.](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/ "gform_authorizenet_transaction_pre_capture_setup_fee") 1 [2](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/authorize-net-filters/page/2/) [Next](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/authorize-net-filters/page/2/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/authorize-net-filters/# "Algolia")
