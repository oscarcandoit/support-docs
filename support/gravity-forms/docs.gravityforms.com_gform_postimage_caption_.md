---
url: "https://docs.gravityforms.com/gform_postimage_caption/"
title: "gform_postimage_caption - Gravity Forms Documentation"
---
...
# gform\_postimage\_caption

- [Description](https://docs.gravityforms.com/gform_postimage_caption/#h-description)
- [Usage](https://docs.gravityforms.com/gform_postimage_caption/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_postimage_caption/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_postimage_caption/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_postimage_caption/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_postimage_caption'``,``'your_function_name'``, 10, 2 );` |

To target a specific form append the form id to the hook name. (format: gform\_postimage\_caption\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_postimage_caption_5'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_postimage_caption'``,``'change_postimage_caption'``, 10, 2 );`<br>`function``change_postimage_caption(``$label``,``$form_id``) {`<br>```return``'Image Caption'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_postimage_caption/# "Algolia")
