---
url: "https://docs.gravityforms.com/gform_stripe_url_port/"
title: "gform_stripe_url_port - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_stripe_url_port/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_url_port/#h-usage)
- [Example](https://docs.gravityforms.com/gform_stripe_url_port/#h-example)
- [Placement](https://docs.gravityforms.com/gform_stripe_url_port/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_url_port/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_url_port/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `$server_port``= apply_filters(``'gform_stripe_url_port'``,``$_SERVER``[``'SERVER_PORT'``] );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_stripe_url_port'``,``function``(``$server_port``) {`<br>```gf_stripe()->log_debug(``__METHOD__``.``'(): Original port: '``.``$server_port``);`<br>```$server_port``=``'80'``;``// Replace 80 with the port you want to use.`<br>```gf_stripe()->log_debug(``__METHOD__``.``'(): Custom port: '``.``$server_port``);`<br>```return``$server_port``;`<br>`} );` |
...
[Algolia](https://docs.gravityforms.com/gform_stripe_url_port/# "Algolia")
