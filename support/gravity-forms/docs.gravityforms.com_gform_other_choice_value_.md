---
url: "https://docs.gravityforms.com/gform_other_choice_value/"
title: "gform_other_choice_value - Gravity Forms Documentation"
---
...
# gform\_other\_choice\_value

- [Description](https://docs.gravityforms.com/gform_other_choice_value/#h-description)
- [Usage](https://docs.gravityforms.com/gform_other_choice_value/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_other_choice_value/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_other_choice_value/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_other_choice_value/#h-placement)
- [Since](https://docs.gravityforms.com/gform_other_choice_value/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_other_choice_value/#h-source-code)
...
- **$field** [null](https://docs.gravityforms.com/null) \| [GF\_Field](https://docs.gravityforms.com/field-object/)
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_other_choice_value'``,``function``(``$value``,``$field``) {`<br>```return``'Enter your own value'``;`<br>`}, 10, 2 );` |

This example changes the text to “My Custom Text” only for a field with id 6 that is added to a form that has id 25.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_other_choice_value'``,``'set_other_choice_value'``, 10, 2 );`<br>`function``set_other_choice_value(``$value``,``$field``) {`<br>```if``(``is_object``(``$field``) && 6 ===``$field``->id && 25 ===``$field``->formId ){``// 6 and 25 to your field id and form id number.`<br>```$value``=``'My Custom Text'``;`<br>```}`<br>```return``$value``;`<br>`}` |
...
This filter is located in GFCommon::get\_other\_choice\_value() in _common.php_.
...
[Algolia](https://docs.gravityforms.com/gform_other_choice_value/# "Algolia")
