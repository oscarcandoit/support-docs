---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/"
...
The gform\_abort\_submission\_with\_confirmation filter determines if submissions are aborted without saving the entry.](https://docs.gravityforms.com/gform_abort_submission_with_confirmation/ "gform_abort_submission_with_confirmation") [**gform\_addnote\_button** \\
This filter allows modification of the HTML of the “Add Note” button for Entry Notes on the Entry Detail page.](https://docs.gravityforms.com/gform_addnote_button/ "gform_addnote_button") [**gform\_currency\_pre\_save\_entry** \\
This filter can be used to override the default currency code before the entry is saved.](https://docs.gravityforms.com/gform_currency_pre_save_entry/ "gform_currency_pre_save_entry") [**gform\_display\_field\_select\_columns\_entry\_list** \\
Allows fields to be added or removed from the \_select columns\_ UI on the entry list.](https://docs.gravityforms.com/gform_display_field_select_columns_entry_list/ "gform_display_field_select_columns_entry_list") [**gform\_entries\_column\_filter** \\
Use this filter to inject markup and replace the value of any non-first column in the entry list grid.](https://docs.gravityforms.com/gform_entries_column_filter/ "gform_entries_column_filter") [**gform\_entries\_field\_value** \\
Use this filter to change the field’s value before getting displayed on the Entry list page.](https://docs.gravityforms.com/gform_entries_field_value/ "gform_entries_field_value") [**gform\_entries\_first\_column\_actions** \\
...
The gform\_entries\_primary\_column\_filter filter is used to modify the contents of the first column in the entries list table.](https://docs.gravityforms.com/gform_entries_primary_column_filter/ "gform_entries_primary_column_filter") [**gform\_entry\_detail\_grid\_display\_empty\_fields** \\
...
This filter can be used to add custom meta boxes to the entry detail page.](https://docs.gravityforms.com/gform_entry_detail_meta_boxes/ "gform_entry_detail_meta_boxes") 1 [2](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/2/) [3](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/3/)… [5](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/5/) [Next](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/2/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/# "Algolia")
