---
url: "https://docs.gravityforms.com/gform_image_choice_input_visibility/"
title: "gform_image_choice_input_visibility - Gravity Forms Documentation"
---
...
# gform\_image\_choice\_input\_visibility

- [Description](https://docs.gravityforms.com/gform_image_choice_input_visibility/#h-description)
- [Usage](https://docs.gravityforms.com/gform_image_choice_input_visibility/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_image_choice_input_visibility/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_image_choice_input_visibility/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_image_choice_input_visibility/#h-placement)
- [Since](https://docs.gravityforms.com/gform_image_choice_input_visibility/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_image_choice_input_visibility/#h-source-code)

## Description

Allows managing the [Image Choice](https://docs.gravityforms.com/image-choice-field/) field input visibility.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_image_choice_input_visibility'``,``'your_function_name'``, 10, 2 );` |

Applies to a specific form:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_image_choice_input_visibility_FORMID'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$input\_visibility** [string](https://docs.gravityforms.com/string)
...
Hide the choice inputs for all [Image Choice](https://docs.gravityforms.com/image-choice-field/) fields.

**Note:** it will only hide the choice inputs when the choice label visibility setting is set to visible.

|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_image_choice_input_visibility'``,``function``(``$input_visibility``,``$field``) {`<br>```return``'hide'``;`<br>`}, 10, 2 );` |
...
[Algolia](https://docs.gravityforms.com/gform_image_choice_input_visibility/# "Algolia")
