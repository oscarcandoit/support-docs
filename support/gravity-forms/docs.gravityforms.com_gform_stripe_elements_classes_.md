---
url: "https://docs.gravityforms.com/gform_stripe_elements_classes/"
title: "gform_stripe_elements_classes - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_stripe_elements_classes/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_elements_classes/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_elements_classes/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_elements_classes/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_stripe_elements_classes/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_elements_classes/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_elements_classes/#h-source-code)

## Description

This filter allows classes to be used with Stripe Elements to control the look of the Credit Card field.

For more information about which classes may be applied, check out the [classes reference](https://stripe.com/docs/js/elements_object/create#elements_create-options-classes) in Stripe’s documentation.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_elements_classes'``,``'your_function_name'``, 10, 2);` |

## Parameters

- **$cardClasses** [array](https://docs.gravityforms.com/array)
...
Check out Stripe’s [documentation](https://stripe.com/docs/js/elements_object/create#elements_create-options-classes) to see what options are available for the classes.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_stripe_elements_classes'``,``'set_stripe_classes'``, 10, 2);`<br>`function``set_stripe_classes(``$cardClasses``,``$formId``){`<br>```$cardClasses``=``array``(`<br>```'base'``=>``'TestElement'``,`<br>```'complete'``=>``'TestComplete'``,`<br>```'invalid'``=>``'TestInvalid'`<br>```);`<br>```return``$cardClasses``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_stripe_elements_classes/# "Algolia")
