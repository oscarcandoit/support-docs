---
url: "https://docs.gravityforms.com/how-to-manually-update/"
title: "How to Manually Update Gravity Forms - Gravity Forms Documentation"
---
...
- [Using the WordPress Admin Dashboard](https://docs.gravityforms.com/how-to-manually-update/#h-using-the-wordpress-admin-dashboard)
- [Using the WP-CLI](https://docs.gravityforms.com/how-to-manually-update/#h-using-the-wp-cli)

**WARNING**: Do NOT use the _Uninstall_ \[plugin\] button in the Forms > Settings area – this will remove your form data.

When you follow the steps below, _all_ your data (forms, entries, feeds, settings etc.) will remain untouched. But we still recommend you [back up your database and files](https://wordpress.org/support/article/wordpress-backups/) before installing or updating any plugin.

## Using the WordPress Admin Dashboard

1. If you haven’t already done so, download the Gravity Forms or Add-On zip from the [downloads page](https://www.gravityforms.com/my-account/downloads/). Be sure to save this zip file somewhere easily accessible as you will need it soon.
...
7. On the _Installing plugin from uploaded file_ page click the **Replace current with uploaded** button.

For older WordPress versions prior to 5.5, try [this guide](https://docs.gravityforms.com/manually-update-for-older-wordpress/).
...
See the [Managing Gravity Forms and Add-Ons with WP-CLI](https://docs.gravityforms.com/manage-gravity-forms-and-add-ons-with-wpcli/#updating-gravity-forms-or-an-add-on) article for more details.
...
[Algolia](https://docs.gravityforms.com/how-to-manually-update/# "Algolia")
