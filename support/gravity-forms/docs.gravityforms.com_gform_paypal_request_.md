---
url: "https://docs.gravityforms.com/gform_paypal_request/"
title: "gform_paypal_request - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [PayPal Standard Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/paypal-standard-filters/)          - [gform\_paypal\_action\_fields](https://docs.gravityforms.com/gform_paypal_action_fields/ "gform_paypal_action_fields")
          - [gform\_paypal\_add\_option\_group](https://docs.gravityforms.com/gform_paypal_add_option_group/ "gform_paypal_add_option_group")
          - [gform\_paypal\_business\_email](https://docs.gravityforms.com/gform_paypal_business_email/ "gform_paypal_business_email")
          - [gform\_paypal\_config\_validation](https://docs.gravityforms.com/gform_paypal_config_validation/ "gform_paypal_config_validation")
          - [gform\_paypal\_feed\_settings\_fields](https://docs.gravityforms.com/gform_paypal_feed_settings_fields/ "gform_paypal_feed_settings_fields")
          - [gform\_paypal\_field\_value](https://docs.gravityforms.com/gform_paypal_field_value/ "gform_paypal_field_value")
          - [gform\_paypal\_fulfillment](https://docs.gravityforms.com/gform_paypal_fulfillment/ "gform_paypal_fulfillment")
          - [gform\_paypal\_get\_payment\_feed](https://docs.gravityforms.com/gform_paypal_get_payment_feed/ "gform_paypal_get_payment_feed")
          - [gform\_paypal\_hash\_matches](https://docs.gravityforms.com/gform_paypal_hash_matches/ "gform_paypal_hash_matches")
          - [gform\_paypal\_invoice](https://docs.gravityforms.com/gform_paypal_invoice/ "gform_paypal_invoice")
          - [gform\_paypal\_ipn\_{transaction\_type}](https://docs.gravityforms.com/gform_paypal_ipn_transaction_type/ "gform_paypal_ipn_{transaction_type}")
          - [gform\_paypal\_ipn\_url](https://docs.gravityforms.com/gform_paypal_ipn_url/ "gform_paypal_ipn_url")
          - [gform\_paypal\_post\_ipn](https://docs.gravityforms.com/gform_paypal_post_ipn/ "gform_paypal_post_ipn")
          - [gform\_paypal\_pre\_ipn](https://docs.gravityforms.com/gform_paypal_pre_ipn/ "gform_paypal_pre_ipn")
          - [gform\_paypal\_query](https://docs.gravityforms.com/gform_paypal_query/ "gform_paypal_query")
          - [gform\_paypal\_request](https://docs.gravityforms.com/gform_paypal_request/ "gform_paypal_request")
          - [gform\_paypal\_return\_url](https://docs.gravityforms.com/gform_paypal_return_url/ "gform_paypal_return_url")
          - [gform\_paypal\_return\_url\_port](https://docs.gravityforms.com/gform_paypal_return_url_port/ "gform_paypal_return_url_port")
          - [gform\_paypal\_sslverify](https://docs.gravityforms.com/gform_paypal_sslverify/ "gform_paypal_sslverify")
          - [gform\_post\_payment\_status](https://docs.gravityforms.com/gform_post_payment_status/ "gform_post_payment_status")
          - [PayPal Standard Feed Meta](https://docs.gravityforms.com/paypal-standard-feed-meta/ "PayPal Standard Feed Meta")
...
# gform\_paypal\_request

- [Description](https://docs.gravityforms.com/gform_paypal_request/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_request/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_request/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_request/#h-examples)
- [Change Return URL](https://docs.gravityforms.com/gform_paypal_request/#h-change-return-url)
- [Change IPN URL](https://docs.gravityforms.com/gform_paypal_request/#h-change-ipn-url)
- [Placement](https://docs.gravityforms.com/gform_paypal_request/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_paypal_request/#h-source-code)

## Description

Use this filter to modify the URL string that will be sent to PayPal. This filter is fired immediately before the user is redirected to PayPal. See the [PayPal Standard documentation](https://developer.paypal.com/webapps/developer/docs/classic/paypal-payments-standard/integration-guide/Appx_websitestandard_htmlvariables/) for supported arguments.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_request'``,``'your_function_name'``, 10, 5 ) ;` |

You can also specify this per form by adding the form id after the hook name.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_request_1'``,``'your_function_name'``, 10, 5 ) ;` |

## Parameters

- **$url** [string](https://docs.gravityforms.com/string)
...
- **$submission\_data** [Submission Data](https://docs.gravityforms.com/submission-data)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19 | `add_filter(``'gform_paypal_request'``,``'update_url'``, 10, 3 );`<br>`function``update_url(``$url``,``$form``,``$entry``) {`<br>```//parse url into its individual pieces (host, path, querystring, etc.)`<br>```$url_array``=``parse_url``(``$url``);`<br>```//start rebuilding url`<br>```$new_url``=``$url_array``[``'scheme'``] .``'://'``.``$url_array``[``'host'``] .``$url_array``[``'path'``] .``'?'``;`<br>```$query``=``$url_array``[``'query'``];``//get querystring`<br>```//parse querystring into pieces`<br>```parse_str``(``$query``,``$qs_param``);`<br>```$return``=``$qs_param``[``'return'``];``//return url`<br>```//parse return url so the querystring is left alone while modifying the url`<br>```$return_url``=``parse_url``(``$return``);`<br>```//rebuild url with new location`<br>```$new_return_url``=``$return_url``[``'scheme'``] .``'://'``.``'rocketgenius.com/contact-us/?'``.``$return_url``[``'query'``];`<br>```$qs_param``[``'return'``] =``$new_return_url``;``//update return querystring parameter to new value`<br>```$new_qs``= http_build_query(``$qs_param``);``//rebuild querystring`<br>```$new_url``.=``$new_qs``;``//add querystring to url`<br>```return``$new_url``;`<br>`}` |

### Change IPN URL

This example changes IPN URL used by PayPal to notify the payment. Bear in mind using this will avoid Gravity Forms to be able to update entries with the payment details and status. Simply replace https://your\_url\_here.com with your custom IPN URL.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14 | `add_filter(``'gform_paypal_request'``,``'update_url'``, 10, 3 );`<br>`function``update_url(``$url``,``$form``,``$entry``) {`<br>```//parse url into its individual pieces (host, path, querystring, etc.)`<br>```$url_array``=``parse_url``(``$url``);`<br>```//start rebuilding url`<br>```$new_url``=``$url_array``[``'scheme'``] .``'://'``.``$url_array``[``'host'``] .``$url_array``[``'path'``] .``'?'``;`<br>```$query``=``$url_array``[``'query'``];``//get querystring`<br>```//parse querystring into pieces`<br>```parse_str``(``$query``,``$qs_param``);`<br>```$qs_param``[``'notify_url'``] =``'https://your_url_here.com'``; // update notify_url querystring parameter to``new``value`<br>```$new_qs``= http_build_query(``$qs_param``);``//rebuild querystring`<br>```$new_url``.=``$new_qs``;``//add querystring to url`<br>```return``$new_url``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_paypal_request'``,``$form``[``'id'``],``$url``,``$form``,``$entry``,``$feed``,``$submission_data``)` |

This filter is located in GFPayPal::redirect\_url() in _class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_request/# "Algolia")
