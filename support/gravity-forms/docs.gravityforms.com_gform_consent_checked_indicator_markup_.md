---
url: "https://docs.gravityforms.com/gform_consent_checked_indicator_markup/"
title: "gform_consent_checked_indicator_markup - Gravity Forms Documentation"
---
...
# gform\_consent\_checked\_indicator\_markup

- [Description](https://docs.gravityforms.com/gform_consent_checked_indicator_markup/#h-description)
- [Usage](https://docs.gravityforms.com/gform_consent_checked_indicator_markup/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_consent_checked_indicator_markup/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_consent_checked_indicator_markup/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_consent_checked_indicator_markup/#h-placement)
- [Since](https://docs.gravityforms.com/gform_consent_checked_indicator_markup/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_consent_checked_indicator_markup/#h-source-code)

## Description

The “gform\_consent\_checked\_indicator\_markup” filter in Gravity Forms allows the HTML markup of the Consent check box to be modified.
...
- **$checked\_indicator\_markup** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_consent_checked_indicator_markup'``,``function``(``$markup``) {`<br>```$fragment``= WP_HTML_Processor::create_fragment(``$markup``);`<br>```$fragment``->next_token();`<br>```$fragment``->set_attribute(``'alt'``,``'Consent checkmark'``);`<br>```return``$fragment``->get_updated_html();`<br>`}, 10, 1 );` |
...
This filter is located in GF\_Field\_Consent::\_\_construct() in _gravityforms/includes/fields/class-gf-field-consent.php_.
...
[Algolia](https://docs.gravityforms.com/gform_consent_checked_indicator_markup/# "Algolia")
