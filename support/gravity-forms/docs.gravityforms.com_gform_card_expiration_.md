---
url: "https://docs.gravityforms.com/gform_card_expiration/"
title: "gform_card_expiration - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_card_expiration/#h-description)
- [Usage](https://docs.gravityforms.com/gform_card_expiration/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_card_expiration/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_card_expiration/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_card_expiration/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_card_expiration/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_card_expiration'``,``'change_expiration'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_card_expiration'``,``'change_expiration'``, 10, 2 );`<br>`function``change_expiration(``$label``,``$form_id``) {`<br>```return``"Expires"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_card_expiration/# "Algolia")
