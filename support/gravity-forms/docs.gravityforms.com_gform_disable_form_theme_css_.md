---
url: "https://docs.gravityforms.com/gform_disable_form_theme_css/"
title: "gform_disable_form_theme_css - Gravity Forms Documentation"
---
...
# gform\_disable\_form\_theme\_css

- [Description](https://docs.gravityforms.com/gform_disable_form_theme_css/#h-description)
- [Usage](https://docs.gravityforms.com/gform_disable_form_theme_css/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_disable_form_theme_css/#h-examples)
- [1\. Disable the theme](https://docs.gravityforms.com/gform_disable_form_theme_css/#h-1-disable-the-theme)
- [Placement](https://docs.gravityforms.com/gform_disable_form_theme_css/#h-placement)
- [Since](https://docs.gravityforms.com/gform_disable_form_theme_css/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_disable_form_theme_css/#h-source-code)

## Description

The gform\_disable\_form\_theme\_css filter allows the default theme used by forms created with Gravity Forms 2.5 and greater to be disabled.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_disable_form_theme_css'``,``'your_function_name'``);` |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_disable_form_theme_css'``,``'__return_true'``);` |
...
This filter is located in GFFormDisplay::get\_form\_enqueue\_assets() in _form\_display.php_.
...
[Algolia](https://docs.gravityforms.com/gform_disable_form_theme_css/# "Algolia")
