---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/credit-card-fields/"
title: "Credit Card Fields Archives - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Field Filters](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/)        - [Image Choice Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/image-choice-fields/)
        ...
        - [Credit Card Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/credit-card-fields/)          - [gform\_card\_expiration](https://docs.gravityforms.com/gform_card_expiration/ "gform_card_expiration")
          - [gform\_card\_name](https://docs.gravityforms.com/gform_card_name/ "gform_card_name")
          - [gform\_card\_number](https://docs.gravityforms.com/gform_card_number/ "gform_card_number")
          - [gform\_card\_security\_code](https://docs.gravityforms.com/gform_card_security_code/ "gform_card_security_code")
          - [gform\_enable\_credit\_card\_field](https://docs.gravityforms.com/gform_enable_credit_card_field/ "gform_enable_credit_card_field")
...
This filter is executed when creating the credit card field and can be used to modify the “Security Code” label.](https://docs.gravityforms.com/gform_card_security_code/ "gform_card_security_code") [**gform\_enable\_credit\_card\_field** \\
Use this filter to enable/disable the built-in credit card field.](https://docs.gravityforms.com/gform_enable_credit_card_field/ "gform_enable_credit_card_field")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/credit-card-fields/# "Algolia")
