---
url: "https://docs.gravityforms.com/gform_akismet_enabled/"
title: "gform_akismet_enabled - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Akismet Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/akismet-filters/)          - [gform\_akismet\_enabled](https://docs.gravityforms.com/gform_akismet_enabled/ "gform_akismet_enabled")
          - [gform\_akismet\_fields](https://docs.gravityforms.com/gform_akismet_fields/ "gform_akismet_fields")
...
- [Description](https://docs.gravityforms.com/gform_akismet_enabled/#h-description)
- [Usage](https://docs.gravityforms.com/gform_akismet_enabled/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_akismet_enabled/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_akismet_enabled/#h-examples)
- [Disable globally](https://docs.gravityforms.com/gform_akismet_enabled/#h-disable-globally)
- [Disable for a specific form only](https://docs.gravityforms.com/gform_akismet_enabled/#h-disable-for-a-specific-form-only)
- [Using one function with multiple forms](https://docs.gravityforms.com/gform_akismet_enabled/#h-using-one-function-with-multiple-forms)
- [Placement](https://docs.gravityforms.com/gform_akismet_enabled/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_akismet_enabled/#h-source-code)
...
To limit the scope of your function to a specific form, append the form ID to the end of the hook name. (format: gform\_akismet\_enabled\_FORMID)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_akismet_enabled'``,``function``(``$is_enabled``,``$form_id``) {`<br>```if``( in_array(``$form_id``,``array``( 1, 3, 5 ) ) ) {`<br>```$is_enabled``= false;`<br>```}`<br>```return``$is_enabled``;`<br>`}, 10, 2 );` |
...
Since Akismet Add-On version 1.1, this filter is located in `\Gravity_Forms\Gravity_Forms_Akismet\GF_Akismet::is_enabled_form()` in `class-gf-akismet.php`. It was previously located in Gravity Forms, in `GFCommon::akismet_enabled()` in `common.php`.
...
[Algolia](https://docs.gravityforms.com/gform_akismet_enabled/# "Algolia")
