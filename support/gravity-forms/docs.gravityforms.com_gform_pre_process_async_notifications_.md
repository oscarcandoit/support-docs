---
url: "https://docs.gravityforms.com/gform_pre_process_async_notifications/"
title: "Gform Pre Process Async Notifications"
---
...
# gform\_pre\_process\_async\_notifications

- [Description](https://docs.gravityforms.com/gform_pre_process_async_notifications/#description)
- [Usage](https://docs.gravityforms.com/gform_pre_process_async_notifications/#usage)
- [Parameters](https://docs.gravityforms.com/gform_pre_process_async_notifications/#parameters)
- [Example](https://docs.gravityforms.com/gform_pre_process_async_notifications/#examples)
- [Placement](https://docs.gravityforms.com/gform_pre_process_async_notifications/#h-placement)
- [Since](https://docs.gravityforms.com/gform_pre_process_async_notifications/#since)
- [Source Code](https://docs.gravityforms.com/gform_pre_process_async_notifications/#source-code)
...
|     |
| --- |
| `add_action(``'gform_pre_process_async_notifications'``,``function``(``$event``,``$notifications``,``$form``,``$entry``,``$data``) {`<br>```// Do something before the notifications are sent in the background.`<br>`} );` |
...
[Algolia](https://docs.gravityforms.com/gform_pre_process_async_notifications/# "Algolia")
