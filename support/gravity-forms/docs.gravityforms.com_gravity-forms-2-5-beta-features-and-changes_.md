---
url: "https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/"
title: "Gravity Forms 2.5 Key Features - Gravity Forms Documentation"
---
...
- [Summary](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-summary)
- [Major New Features](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-major-new-features)
- [Improved Front-End Accessibility](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-improved-front-end-accessibility)
- [Form Editor New UI design](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-form-editor-new-ui-design)
- [Drag and Drop Columns](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-drag-and-drop-columns)
- [Settings and Admin New UI Design](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-settings-and-admin-new-ui-design)
- [Settings API](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-settings-api)
- [Complete Revamp of CSS Styles](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-complete-revamp-of-css-styles)
- [Updates to Markup](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-updates-to-markup)
- [Theme Integration](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-theme-integration)
- [Other Form Editor Enhancements](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-other-form-editor-enhancements)
- [Known Limitations](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/#h-known-limitations)
...
For an up-to-date list of all features, refer to the [Gravity Forms official change log](https://docs.gravityforms.com/gravityforms-change-log/).

[Refer to our FAQ](https://docs.gravityforms.com/gravity-forms-2-5-faq/) for questions about the rollout process.

## Major New Features

### **Improved Front-End Accessibility**

Ethically and legally, creating accessible forms is becoming more and more essential, and an area we have [publicly stated our commitment](https://docs.gravityforms.com/gravity-forms-commitment-to-accessibility/) to enhance. 2.5 provides many improvements and sets all designers on a better path to easily creating accessible forms for your users – helping you to engage with all your audience and boosting your form submissions.

For more on improving the accessibility off your forms, refer to our comprehensive [Accessibility knowledge base](https://docs.gravityforms.com/category/knowledge-base/accessibility/).
...
The Form Editor now supports [drag and drop](https://docs.gravityforms.com/working-with-columns-2-5-beta/) for up to 4 columns, allowing you to manage your form layout in a more intuitive way directly within the editor.
...
For a good overview of many of the style and markup changes, refer to our [Guide for Theme Developers](https://docs.gravityforms.com/guide-to-gravity-forms-2-5-for-theme-developers/).

### **Updates to Markup**

The markup has been overhauled to accommodate a number of accessibility enhancements and better organization moving forward. Refer to [this article](https://docs.gravityforms.com/changes-to-markup-in-gravity-forms-2-5/) for information on what has changed.

The previous Gravity Forms markup, now referred to as _legacy markup_, will continue to work for all old forms, but it is targeted for deprecation in a future release. For now though, existing forms will automatically use the legacy markup, while new forms created under 2.5 will use the new markup.

Using legacy markup for a newly created form can be enabled with the [new legacy markup Form Setting](https://docs.gravityforms.com/form-settings/#form-options).
...
Some behaviors or previous methods may need to be changed. [Refer to this article](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/) for a list of possible changes or feature design decisions that may affect existing setups or behaviors.
...
[Algolia](https://docs.gravityforms.com/gravity-forms-2-5-beta-features-and-changes/# "Algolia")
