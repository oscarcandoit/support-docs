---
url: "https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/"
title: "gform_entry_ids_automatic_deletion - Gravity Forms Documentation"
---
...
# gform\_entry\_ids\_automatic\_deletion

- [Description](https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/#h-examples)
- [Delete only entries in Trash](https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/#h-delete-only-entries-in-trash)
- [Remove one entry from the deletion list](https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/#h-remove-one-entry-from-the-deletion-list)
- [Placement](https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/#h-placement)
- [Since](https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_entry_ids_automatic_deletion'``,``function``(``$entry_ids``) {`<br>```GFCommon::log_debug(``'(): Excluding an entry from the deletion list.'``);`<br>```// Remove entry ID 99 from the deletion list.`<br>```unset(``$entry_ids``[``'99'``] );`<br>```return``$entry_ids``;`<br>`} );` |
...
This filter is located in GF\_Personal\_Data::cron\_task() in _includes/class-personal-data.php_.
...
[Algolia](https://docs.gravityforms.com/gform_entry_ids_automatic_deletion/# "Algolia")
