---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/2checkout-add-on/"
title: "2Checkout Add-On Archives - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  - [2Checkout Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/2checkout-add-on/)    - [Setting Up the 2Checkout Add-On](https://docs.gravityforms.com/setting-up-the-2checkout-add-on/ "Setting Up the 2Checkout Add-On")
    - [Creating a Feed for the 2Checkout Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-2checkout-add-on/ "Creating a Feed for the 2Checkout Add-On")
    - [2Checkout Changelog](https://docs.gravityforms.com/2checkout-change-log/ "2Checkout Changelog")
...
Step-by-step instructions on how to setup the 2Checkout Add-On.](https://docs.gravityforms.com/setting-up-the-2checkout-add-on/ "Setting Up the 2Checkout Add-On") [**Creating a Feed for the 2Checkout Add-On** \\
This article contains step-by-step instructions on how to create a feed for the Gravity Forms 2Checkout Add-On.](https://docs.gravityforms.com/creating-a-feed-for-the-2checkout-add-on/ "Creating a Feed for the 2Checkout Add-On") [**2Checkout Changelog** \\
View the change log for the 2Checkout Add-On.](https://docs.gravityforms.com/2checkout-change-log/ "2Checkout Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/2checkout-add-on/# "Algolia")
