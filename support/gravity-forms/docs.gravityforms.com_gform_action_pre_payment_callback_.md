---
url: "https://docs.gravityforms.com/gform_action_pre_payment_callback/"
title: "gform_action_pre_payment_callback - Gravity Forms Documentation"
---
...
# gform\_action\_pre\_payment\_callback

- [Description](https://docs.gravityforms.com/gform_action_pre_payment_callback/#h-description)
- [Usage](https://docs.gravityforms.com/gform_action_pre_payment_callback/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_action_pre_payment_callback/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_action_pre_payment_callback/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `function``my_function(``$action``,``$entry``) {`<br>```if``(``$action``[``'type'``] ===``'complete_payment'``) {`<br>```// Do something`<br>```}`<br>`}`<br>`add_action(``'gform_action_pre_payment_callback'``,``'my_function'``, 10, 2 );` |
...
This action hook is located in GFPaymentAddOn::process\_callback\_action() in _includes/addon/class-gf-payment-addon.php_.
...
[Algolia](https://docs.gravityforms.com/gform_action_pre_payment_callback/# "Algolia")
