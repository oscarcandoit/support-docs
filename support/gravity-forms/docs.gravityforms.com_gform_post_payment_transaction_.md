---
url: "https://docs.gravityforms.com/gform_post_payment_transaction/"
title: "gform_post_payment_transaction - Gravity Forms Documentation"
---
...
# gform\_post\_payment\_transaction

- [Description](https://docs.gravityforms.com/gform_post_payment_transaction/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_payment_transaction/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_payment_transaction/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_payment_transaction/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_post_payment_transaction/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_post_payment_transaction/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_post_payment_transaction'``,``'my_function'``, 10, 6 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$txn\_id** | [integer](https://docs.gravityforms.com/integer) | The transaction ID associated with the payment. |
| **$entry\_id** | [integer](https://docs.gravityforms.com/integer) | The ID of the entry that was created. |
| **$transaction\_type** | [string](https://docs.gravityforms.com/string) | The type of transaction that was made. |
| **$transaction\_id** | [integer](https://docs.gravityforms.com/integer) | The transaction ID of the newly created transaction. |
| **$amount** | [string](https://docs.gravityforms.com/string) | The total amount of the payment. |
| **$is\_recurring** | [bool](https://docs.gravityforms.com/bool) | Returns true if recurring. Otherwise, false. |

## Examples

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `function``my_function() {`<br>```// Do something here`<br>```// If data from the Stripe webhook event is needed (and this hook was initiated via a Stripe webhook request), you can access event data with the following line:`<br>```$event``= gf_stripe()->get_webhook_event();`<br>```if``(``$event``) {`<br>```// Access webhook event data. For event object documentation, see: https://stripe.com/docs/api/events/object`<br>```}`<br>`}`<br>`add_action(``'gform_post_payment_transaction'``,``'my_function'``, 10, 6 );` |
...
|     |     |
| --- | --- |
| 1 | `do_action(``'gform_post_payment_transaction'``,``$txn_id``,``$entry_id``,``$transaction_type``,``$transaction_id``,``$amount``,``$is_recurring``);` |

This action hook is located in GFPaymentAddOn::insert\_transaction() in _includes/addon/class-gf-payment-addon.php_.
...
[Algolia](https://docs.gravityforms.com/gform_post_payment_transaction/# "Algolia")
