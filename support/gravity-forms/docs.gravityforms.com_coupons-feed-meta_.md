---
url: "https://docs.gravityforms.com/coupons-feed-meta/"
title: "Coupons Feed Meta - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/coupons-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/coupons-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the Coupons add-On is an associative array containing the properties which determine the type of coupon and discount available.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `$feed``[``'meta'``] =``array``(`<br>```'gravityForm'``=> 0,`<br>```'couponName'``=>``'test100'``,`<br>```'couponCode'``=>``'TEST100'``,`<br>```'couponAmountType'``=>``'percentage'``,`<br>```'couponAmount'``=> 100,`<br>```'startDate'``=>``''``,`<br>```'endDate'``=>``''``,`<br>```'usageLimit'``=> 20,`<br>```'isStackable'``=> false,`<br>```'usageCount'``=> 2,`<br>`);` |
...
- **gravityForm** [string](https://docs.gravityforms.com/string)
The form ID this coupon was created for. An ID of 0 indicates the coupon can be used with ALL forms.

- **couponName** [string](https://docs.gravityforms.com/string)

The coupon name.

- **couponCode** [string](https://docs.gravityforms.com/string)

The the value users should enter to apply this coupon to the form total.

- **couponAmountType** [string](https://docs.gravityforms.com/string)

The coupon amount type. _Possible values: flat or percentage._

- **couponAmount** [string](https://docs.gravityforms.com/string)

The coupon amount.

- **startDate** [string](https://docs.gravityforms.com/string)

The date when the coupon should start.

- **endDate** [string](https://docs.gravityforms.com/string)

The date when the coupon should expire.

- **usageLimit** [integer](https://docs.gravityforms.com/integer)

The number of times the coupon can be used.

- **isStackable** [boolean](https://docs.gravityforms.com/boolean)

Can this coupon be used in conjunction with another coupon? Default is false.

- **usageCount** [integer](https://docs.gravityforms.com/integer)
...
[Algolia](https://docs.gravityforms.com/coupons-feed-meta/# "Algolia")
