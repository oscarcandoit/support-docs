---
url: "https://docs.gravityforms.com/gform_partialentries_warning_message/"
title: "gform_partialentries_warning_message - Gravity Forms Documentation"
---
...
# gform\_partialentries\_warning\_message

- [Description](https://docs.gravityforms.com/gform_partialentries_warning_message/#h-description)
- [Usage](https://docs.gravityforms.com/gform_partialentries_warning_message/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_partialentries_warning_message/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_partialentries_warning_message/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_partialentries_warning_message/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_partialentries_warning_message/#h-source-code)

## Description

The “gform\_partialentries\_warning\_message” filter in the Gravity Forms Partial Entries Add-On allows the warning message indicating the user’s information is being saved to be changed. The default warning message is “Please note that your information is saved on our server as you enter it.”
...
|     |     |
| --- | --- |
| 1 | `add_filter(``"gform_partialentries_warning_message"``,``"your_function_name"``, 10, 1 );` |

To target a specific form, append the form id to the hook name. (format: gform\_partialentries\_warning\_message\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``"gform_partialentries_warning_message_1"``,``"your_function_name"``, 10, 1 );` |

## Parameters

- **$warning\_message** [string](https://docs.gravityforms.com/string)
The warning message.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``"gform_partialentries_warning_message"``,``"change_warning_message"``, 10, 1 );`<br>`function``change_warning_message(``$warning_message``){`<br>```return``"This is a test."``;`<br>`}` |
...
This filter is located in GF\_Partial\_Entries::action\_gform\_enqueue\_scripts() in _gravityformspartialentries/class-gf-partial-entries.php_.
...
[Algolia](https://docs.gravityforms.com/gform_partialentries_warning_message/# "Algolia")
