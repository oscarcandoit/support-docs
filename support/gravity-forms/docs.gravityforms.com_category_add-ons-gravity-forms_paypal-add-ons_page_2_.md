---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/page/2/"
title: "PayPal Add-Ons Archives - Page 2 of 3 - Gravity Forms Documentation - Page 2 of 3"
---
...
View the change log for the Gravity Forms PayPal Commerce Platform Add-On.](https://docs.gravityforms.com/paypal-checkout-add-on-change-log/ "PayPal Checkout Add-On Changelog") [**Configuring PayPal Standard IPN Settings** \\
Learn how to set up your PayPal IPN to communicate with the Gravity Forms PayPal Payments Standard Add-On.](https://docs.gravityforms.com/configuring-paypal-standard-ipn-settings/ "Configuring PayPal Standard IPN Settings") [**Getting Started with the PayPal Payments Pro Add-On** \\
In this article, we outline the steps needed to get started using the PayPal Payments Pro Add-On.](https://docs.gravityforms.com/getting-started-paypal-payments-pro-add/ "Getting Started with the PayPal Payments Pro Add-On") [**Using the PayPal Pro Add-On** \\
Discover how to use the PayPal Pro Add-On for Gravity Forms.](https://docs.gravityforms.com/paypal-pro-add-on/ "Using the PayPal Pro Add-On") [**Setting Up the PayPal Pro Add-On**\\
Step-by-step instructions on how to setup the PayPal Pro Add-On.](https://docs.gravityforms.com/setting-up-the-paypal-pro-add-on/ "Setting Up the PayPal Pro Add-On") [**PayPal Payments Pro Add-On Requirements** \\
...
This article contains step-by-step instructions on how to create a feed for the PayPal Payments Pro Add-On.](https://docs.gravityforms.com/configuring-paypal-payments-pro-feeds/ "Creating a Feed for the PayPal Payments Pro Add-On") [**Subscription Cancelations with PayPal Payments Pro** \\
Users are not able to cancel their own subscriptions so they must be manually processed by a site admin.](https://docs.gravityforms.com/canceling-subscription-paypal-payments-pro/ "Subscription Cancelations with PayPal Payments Pro") [Previous](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/) [1](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/) 2 [3](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/page/3/) [Next](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/page/3/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/page/2/# "Algolia")
