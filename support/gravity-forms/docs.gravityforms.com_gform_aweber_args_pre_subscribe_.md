---
url: "https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/"
title: "gform_aweber_args_pre_subscribe - Gravity Forms Documentation"
---
...
# gform\_aweber\_args\_pre\_subscribe

- [Description](https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/#h-description)
- [Usage](https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/#h-examples)
- [1\. Add ip\_address Parameter](https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/#h-1-add-ip_address-parameter)
- [Placement](https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_aweber_args_pre_subscribe'``,``'your_function_name'``, 10, 4 );` |

You can limit the scope of the filter to a single form by appending the form id on the end of the hook name like so:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_aweber_args_pre_subscribe_5'``,``'your_function_name'``, 10, 4 );` |
...
### 1\. Add ip\_address Parameter

The following example shows how you can add the ip\_address parameter.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_aweber_args_pre_subscribe'``,``function``(``$args``,``$form``,``$entry``,``$feed``) {`<br>```$args``[``'ip_address'``] = rgar(``$entry``,``'ip'``);`<br>```return``$args``;`<br>`}, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1 | `apply_filters(``"gform_aweber_args_pre_subscribe_{$form['id']}"``, apply_filters(``'gform_aweber_args_pre_subscribe'``,``$params``,``$form``,``$entry``,``$feed``),``$form``,``$entry``,``$feed``)` |
...
[Algolia](https://docs.gravityforms.com/gform_aweber_args_pre_subscribe/# "Algolia")
