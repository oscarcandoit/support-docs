---
url: "https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/"
title: "gform_dropbox_shareable_link_settings - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Dropbox Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/dropbox-filters/)          - [Dropbox Feed Meta](https://docs.gravityforms.com/dropbox-feed-meta/ "Dropbox Feed Meta")
          - [gform\_dropbox\_file\_name](https://docs.gravityforms.com/gform_dropbox_file_name/ "gform_dropbox_file_name")
          - [gform\_dropbox\_folder\_path](https://docs.gravityforms.com/gform_dropbox_folder_path/ "gform_dropbox_folder_path")
          - [gform\_dropbox\_link\_type](https://docs.gravityforms.com/gform_dropbox_link_type/ "gform_dropbox_link_type")
          - [gform\_dropbox\_post\_upload](https://docs.gravityforms.com/gform_dropbox_post_upload/ "gform_dropbox_post_upload")
          - [gform\_dropbox\_request\_timeout](https://docs.gravityforms.com/gform_dropbox_request_timeout/ "gform_dropbox_request_timeout")
          - [gform\_dropbox\_shareable\_link\_settings](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/ "gform_dropbox_shareable_link_settings")
          - [gform\_dropbox\_should\_upload\_file](https://docs.gravityforms.com/gform_dropbox_should_upload_file/ "gform_dropbox_should_upload_file")
          - [gform\_dropbox\_ssl\_compatibility](https://docs.gravityforms.com/gform_dropbox_ssl_compatibility/ "gform_dropbox_ssl_compatibility")
          - [gform\_dropbox\_store\_local\_version](https://docs.gravityforms.com/gform_dropbox_store_local_version/ "gform_dropbox_store_local_version")
          - [https\_local\_ssl\_verify](https://docs.gravityforms.com/https_local_ssl_verify/ "https_local_ssl_verify")
...
# gform\_dropbox\_shareable\_link\_settings

- [Description](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/#h-description)
- [Usage](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/#h-examples)
- [1\. Team Only](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/#h-1-team-only)
- [2\. Password Protected](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/#h-2-password-protected)
- [3\. Expiration Date](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/#h-3-expiration-date)
- [Placement](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/#h-source-code)
...
Dropbox.com requires an account with a **Professional** or **Business** plan to control the [share link settings](https://help.dropbox.com/files-folders/share/set-link-permissions).
...
To target a specific form append the form id to the hook name. (format: gform\_dropbox\_shareable\_link\_settings\_FORMID)

```
add_filter( 'gform_dropbox_shareable_link_settings_10', 'your_function_name', 10, 5 );
```

To target a specific field append both the form id and the field id to the hook name. (format: gform\_dropbox\_shareable\_link\_settings\_FORMID\_FIELDID)
...
- **$shareable\_link\_settings** [array](https://docs.gravityforms.com/array)
The shareable links settings. Possible values are public, team\_only or password. More details can be found in [Dropbox API docs](https://www.dropbox.com/developers/documentation/http/documentation#sharing-create_shared_link_with_settings).
...
- **$field\_id** [string](https://docs.gravityforms.com/string)
...
function shareable_link_team_only( $shareable_link_settings, $field_id, $form, $entry, $feed ) {
    $shareable_link_one_week['expires'] = date( 'Y-m-d\TH:i:s\Z', strtotime( '+1 week' ) );
...
This filter is located in GFDropbox::upload\_file() in _class-gf-dropbox.php_.
...
[Algolia](https://docs.gravityforms.com/gform_dropbox_shareable_link_settings/# "Algolia")
