---
url: "https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/"
title: "Stripe Subscriptions Self-Serve Markup - Gravity"
---
...
# gform\_stripe\_subscriptions\_self\_serve\_markup

- [Description](https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/#h-examples)
- [1\. Append link to create subscription if none exist.](https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/#h-1-append-link-to-create-subscription-if-none-exist)
- [Placement](https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/#h-source-code)
...
- **$markup** [string](https://docs.gravityforms.com/string)

This list markup.
- **$subscriptions** [array](https://docs.gravityforms.com/array)
...
### 1\. Append link to create subscription if none exist.
...
|     |
| --- |
| `// Add a link to create a subscription if no subscriptions found`<br>`add_filter(``'gform_stripe_subscriptions_self_serve_markup'``,``function``(``$markup``,``$subscriptions``,``$form_id``) {`<br>``<br>```if``(``empty``(``$subscriptions``) ) {`<br>```$markup``.=``'<br><a href="{some_url}">Create a subscription now!</a>'``;`<br>```}`<br>``<br>```return``$markup``;`<br>`});` |
...
This filter is located in GF\_Stripe\_Billing\_Portal in _gravityformsstripe/includes/class-gf-stripe-billing-portal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_subscriptions_self_serve_markup/# "Algolia")
