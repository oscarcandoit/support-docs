---
url: "https://docs.gravityforms.com/html-field/"
title: "HTML Field CSS Selectors - Gravity Forms Documentation"
---
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield_html {``border``:``1px``solid``red``}` |

example: HTML field (li) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_body .gform_fields .gfield_html {``border``:``1px``solid``red``}` |

example: HTML field (li) – applies just to specific HTML field (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields #field_XX_X.gfield_html {``border``:``1px``solid``red``}` |
...
[Algolia](https://docs.gravityforms.com/html-field/# "Algolia")
