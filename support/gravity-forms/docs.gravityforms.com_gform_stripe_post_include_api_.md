---
url: "https://docs.gravityforms.com/gform_stripe_post_include_api/"
title: "gform_stripe_post_include_api - Gravity Forms Documentation"
---
...
# gform\_stripe\_post\_include\_api

- [Descriptions](https://docs.gravityforms.com/gform_stripe_post_include_api/#h-descriptions)
- [Usage](https://docs.gravityforms.com/gform_stripe_post_include_api/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_post_include_api/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_post_include_api/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_stripe_post_include_api/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_post_include_api/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_post_include_api/#h-source-code)

## Descriptions

The “gform\_stripe\_post\_include\_api” action in the Gravity Forms Stripe Add-On allows further actions to be performed after the Stripe API is initialized.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_stripe_post_include_api'``,``'your_function_name'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_stripe_post_include_api'``,``'log_it'``);`<br>`function``log_it(){`<br>```GFLogging::log_message(``'gravityformsstripe'``,``__METHOD__``.``'(): Stripe API Initialized. Performing further actions.'``, 1 );`<br>`}` |
...
This filter is located in GFStripe::include\_stripe\_api() in _gravityformsstripe/class-gf-stripe.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_post_include_api/# "Algolia")
