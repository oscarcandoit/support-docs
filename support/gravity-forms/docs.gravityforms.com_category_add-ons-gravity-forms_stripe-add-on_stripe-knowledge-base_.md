---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-knowledge-base/"
title: "Stripe Knowledge Base Archives - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Stripe Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/)    - [Stripe Getting Started](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-getting-started/)
    ...
    - [Stripe Knowledge Base](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-knowledge-base/)      - [Post Payment Actions for Stripe](https://docs.gravityforms.com/stripe-60-delayed-feed-upgrade/ "Post Payment Actions for Stripe")
      - [Timeout Confirmation](https://docs.gravityforms.com/timeout-confirmation/ "Timeout Confirmation")
...
Stripe Add-On 6.0 update introduces an upgrade routine that automatically enables the Post Payment Actions Feed setting for all existing Stripe feeds using the Card Element field.](https://docs.gravityforms.com/stripe-60-delayed-feed-upgrade/ "Post Payment Actions for Stripe") [**Timeout Confirmation** \\
The Timeout Confirmation is automatically added when using the Stripe Card Element and alerts customers if their payment is delayed.](https://docs.gravityforms.com/timeout-confirmation/ "Timeout Confirmation")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-knowledge-base/# "Algolia")
