---
url: "https://docs.gravityforms.com/working-with-columns/"
title: "Creating Columns in the Form Editor - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/working-with-columns/#h-introduction)
- [Drag And drop](https://docs.gravityforms.com/working-with-columns/#h-drag-and-drop)
- [Drag and Drop Not Working?](https://docs.gravityforms.com/working-with-columns/#h-drag-and-drop-not-working)
- [Column Drop Zones](https://docs.gravityforms.com/working-with-columns/#h-column-drop-zones)
- [Row Drop Zones](https://docs.gravityforms.com/working-with-columns/#h-row-drop-zones)
- [Dragging Fields to Create Columns](https://docs.gravityforms.com/working-with-columns/#h-dragging-fields-to-create-columns)
- [Resize Columns using Column Handles](https://docs.gravityforms.com/working-with-columns/#h-resize-columns-using-column-handles)
- [Known Issues or Limitations](https://docs.gravityforms.com/working-with-columns/#h-known-issues-or-limitations)
...
![Demonstrates dragging fields from the Field Select List into the Form Editor](https://docs.gravityforms.com/wp-content/uploads/2020/06/drag-and-drop-fields.gif)
...
If you wish to change to using the standard markup, you will need to disabling the **Enable legacy markup** toggle, found within the [**Form Settings** → **Form Options**](https://docs.gravityforms.com/form-settings/#h-form-options)

## Column Drop Zones

**To create multiple columns of fields**, drag fields into the _Column Drop Zones_ to the left or right of existing fields in the editor.

![Demonstrates dragging fields from the Field Selector to the left and right of existing fields in their Column Drop Zones](https://docs.gravityforms.com/wp-content/uploads/2020/06/column-drop-zones.gif)

## Row Drop Zones

**To create multiple rows of fields**, drag fields into the _Row Drop Zones_ to the top and bottom of an existing row of fields in the editor.

![Demonstrates adding fields in a row above or below existing row of fields by dragging and dropping fields into the Row Drop Zones in the editor](https://docs.gravityforms.com/wp-content/uploads/2020/06/row-drop-zones-for-fields.gif)
...
![Demonstrates creating columns by dragging a field by the field handle and dropping it into a Column Zone to automatically add a column](https://docs.gravityforms.com/wp-content/uploads/2020/06/field-handles-drop-zones.gif)
...
**To resize existing columns in the editor**, use _Column Handles_ to shrink or enlarge the width of a column.

![Demonstrates resizing columns in the form editor by dragging the Column Handle to the left to shrink or to the right to enlarge the width of the column](https://docs.gravityforms.com/wp-content/uploads/2020/06/column-resize.gif)
...
- Columns are not supported on forms with [legacy markup](https://docs.gravityforms.com/form-settings/#h-form-options) enabled.
- The field types of [Page Break](https://docs.gravityforms.com/page-break/), [Section Break](https://docs.gravityforms.com/section-break/), & [Hidden](https://docs.gravityforms.com/hidden/) cannot be placed in columns.
...
[Algolia](https://docs.gravityforms.com/working-with-columns/# "Algolia")
