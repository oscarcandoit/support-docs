---
url: "https://docs.gravityforms.com/category/knowledge-base/page/15/"
title: "Knowledge Base Archives - Page 15 of 18 - Gravity Forms Documentation - Page 15 of 18"
---
...
In this article, we explain how you can use the Loco Translate WordPress plugin to create and update translations for Gravity Forms (or an add-on).](https://docs.gravityforms.com/translating-using-loco-translate/ "Translating Gravity Forms (or an add-on) using Loco Translate") [**Translating Gravity Forms (or an add-on) using Poedit** \\
In this article, we explain how you can use Poedit, the Gettext translations editor, to create and update translations for Gravity Forms (or an add-on).](https://docs.gravityforms.com/translating-using-poedit/ "Translating Gravity Forms (or an add-on) using Poedit") [**Translating the Datepicker** \\
 This work-around is only necessary for Gravity Forms versions 2.4 and prior. The datepicker translations are part of the standard translation package in Gravity Forms 2.5.](https://docs.gravityforms.com/translating-the-datepicker/ "Translating the Datepicker") [**Troubleshoot/Resolve Issues with Gravity Forms Entry Exports** \\
At times, some users may experience issues when attempting to export entries. These issues are typically caused by theme/plugin conflicts or settings defined by the web host.](https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/ "Troubleshoot/Resolve Issues with Gravity Forms Entry Exports") [**Troubleshooting a Missing ‘Feeds’ Menu Item** \\
...
Many of the add-ons that Gravity Forms offers require form data being sent to a 3rd party service, such as Dropbox. If you are having issues, here's how to troubleshoot it.](https://docs.gravityforms.com/troubleshoot-form-data-not-sent-to-service/ "Troubleshooting Form Data Not Being Sent to a Service") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/14/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [13](https://docs.gravityforms.com/category/knowledge-base/page/13/) [14](https://docs.gravityforms.com/category/knowledge-base/page/14/) 15 [16](https://docs.gravityforms.com/category/knowledge-base/page/16/) [17](https://docs.gravityforms.com/category/knowledge-base/page/17/) [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/16/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/15/# "Algolia")
