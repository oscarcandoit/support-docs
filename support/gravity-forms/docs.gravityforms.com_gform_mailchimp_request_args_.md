---
url: "https://docs.gravityforms.com/gform_mailchimp_request_args/"
title: "gform_mailchimp_request_args - Gravity Forms Documentation"
---
...
# gform\_mailchimp\_request\_args

- [Description](https://docs.gravityforms.com/gform_mailchimp_request_args/#h-description)
- [Usage](https://docs.gravityforms.com/gform_mailchimp_request_args/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_mailchimp_request_args/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_mailchimp_request_args/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_mailchimp_request_args/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_mailchimp_request_args/#h-source-code)

## Description

The “gform\_mailchimp\_request\_args” filter in the Gravity Forms Mailchimp Add-On allows the request arguments to be modified before being sent to Mailchimp.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mailchimp_request_args'``,``'your_function_name'``, 10, 2 );` |
...
- **$path** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_mailchimp_request_args'``,``'change_request_args'``, 10, 2 );`<br>`function``change_request_args(``$args``,``$path``){`<br>```//change method`<br>```$args``[``'method'``] =``'POST'``;`<br>```return``$args``;`<br>`}` |
...
This filter is located in GF\_Mail\_Chimp::process\_request() in _gravityformsmailchimp/includes/class-gf-mailchimp-api.php_.
...
[Algolia](https://docs.gravityforms.com/gform_mailchimp_request_args/# "Algolia")
