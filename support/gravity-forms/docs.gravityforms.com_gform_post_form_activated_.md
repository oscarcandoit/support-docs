---
url: "https://docs.gravityforms.com/gform_post_form_activated/"
title: "gform_post_form_activated - Gravity Forms Documentation"
---
...
# gform\_post\_form\_activated

- [Description](https://docs.gravityforms.com/gform_post_form_activated/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_form_activated/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_form_activated/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_form_activated/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_post_form_activated/#h-source-code)

## Description

The “gform\_post\_form\_activated” action in Gravity Forms is triggered after an inactive form is marked as active, allowing further actions to be performed.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_post_form_activated'``,``'my_function'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_action(``'gform_post_form_activated'``,``'my_post_form_activated_func'``, 10);`<br>`function``my_post_form_activated_func(``$form_id``) {`<br>```// perform action after a form has been activated`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_post_form_activated/# "Algolia")
