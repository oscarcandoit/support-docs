---
url: "https://docs.gravityforms.com/gform_routing_field_types/"
title: "gform_routing_field_types - Gravity Forms Documentation"
---
...
# gform\_routing\_field\_types

- [Description](https://docs.gravityforms.com/gform_routing_field_types/#h-description)
- [Usage](https://docs.gravityforms.com/gform_routing_field_types/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_routing_field_types/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_routing_field_types/#h-example)
- [Placement](https://docs.gravityforms.com/gform_routing_field_types/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_routing_field_types/#h-source-code)

## Description

The “gform\_routing\_field\_types” filter in Gravity Forms allows the field types supported by notification routing to be modified.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_routing_field_types'``,``'your_function_name'``);` |

## Parameters

- **$field\_types** [array](https://docs.gravityforms.com/array)
Currently supported field types. Generated from GFNotification::$supported\_fields
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_routing_field_types'``,``function``(``$field_types``) {`<br>`array_push``(``$field_types``,``'my-custom-field-type'``);`<br>```return``$field_types``;`<br>`} );` |
...
This filter is located in _notification.php_
...
[Algolia](https://docs.gravityforms.com/gform_routing_field_types/# "Algolia")
