---
url: "https://docs.gravityforms.com/gform_zoho_api_url/"
title: "gform_zoho_api_url - Gravity Forms Documentation"
---
...
# gform\_zoho\_api\_url

- [Description](https://docs.gravityforms.com/gform_zoho_api_url/#h-description)
- [Usage](https://docs.gravityforms.com/gform_zoho_api_url/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_zoho_api_url/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_zoho_api_url/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_zoho_api_url/#h-placement)
- [Since](https://docs.gravityforms.com/gform_zoho_api_url/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_zoho_api_url/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_zoho_api_url'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$api\_url** [string](https://docs.gravityforms.com/string/)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_zoho_api_url'``,``'change_zoho_api_url'``, 10, 1 );`<br>`function``change_zoho_api_url(``$api_url``){`<br>`return``'https://www.zohoapis.eu/crm/'``;`<br>`}` |

Refer to this [article](https://docs.gravityforms.com/setting-up-the-zoho-crm-add-on/#h-pre-requisites) for more information about available domains.
...
This filter is located in GF\_ZohoCRM\_API::\_\_construct() in _gravityformszohocrm/class-gf-zohocrm-api.php_.
...
[Algolia](https://docs.gravityforms.com/gform_zoho_api_url/# "Algolia")
