---
url: "https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/"
title: "Duplicating Forms with the GFAPI - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/#h-introduction)
- [Method Overview](https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/#h-method-overview)
- [Source Code](https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/#duplicate-form-source-code)
- [Parameters](https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/#h-parameters)
- [Returns](https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/#h-returns)
- [Usage Example](https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/#h-usage-example)

## Introduction

The **GFAPI::duplicate\_form()** method is used to duplicate forms.
...
| --- | --- |
| Class | **GFAPI** |
| Function | **duplicate\_form** |
| Parameters | [see below](https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/#h-parameters) |
| Returns | [see below](https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/#h-returns) |
...
| --- | --- | --- |
| **$form\_id** | [integer](https://docs.gravityforms.com/array) | The ID of an existing form to be duplicated. |

## Returns

An [integer](https://docs.gravityforms.com/integer) (the new form ID) or a [WP\_Error](https://developer.wordpress.org/reference/classes/wp_error/) instance if an error occurs.
...
[Algolia](https://docs.gravityforms.com/duplicating-forms-with-the-gfapi/# "Algolia")
