---
url: "https://docs.gravityforms.com/gform_paypalpaymentspro_verifypeer/"
title: "gform_paypalpaymentspro_verifypeer - Gravity Forms Documentation"
---
...
# gform\_paypalpaymentspro\_verifypeer

- [Description](https://docs.gravityforms.com/gform_paypalpaymentspro_verifypeer/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypalpaymentspro_verifypeer/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypalpaymentspro_verifypeer/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypalpaymentspro_verifypeer/#h-examples)
- [Since](https://docs.gravityforms.com/gform_paypalpaymentspro_verifypeer/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_paypalpaymentspro_verifypeer/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypalpaymentspro_verifypeer'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$is\_enabled** [bool](https://docs.gravityforms.com/bool)
Indicates if the CURLOPT\_SSL\_VERIFYPEER setting is enabled, which allows peer verification to be bypassed. True enables peer verification, false disables.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_paypalpaymentspro_verifypeer'``,``'disable_verification'``, 10, 1 );`<br>`function``disable_verification(``$is_enabled``){`<br>```return``false;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_paypalpaymentspro_verifypeer/# "Algolia")
