---
url: "https://docs.gravityforms.com/gform_ppcp_card_style/"
title: "gform_ppcp_card_style - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_ppcp_card_style/#h-description)
- [Usage](https://docs.gravityforms.com/gform_ppcp_card_style/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_ppcp_card_style/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_ppcp_card_style/#h-example)
- [Placement](https://docs.gravityforms.com/gform_ppcp_card_style/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_ppcp_card_style/#h-source-code)

## Description

The gform\_ppcp\_card\_style filter can be used to customize the appearance of the credit card inputs for the [PayPal Field](https://docs.gravityforms.com/paypal-field) which is available with the [PayPal Checkout Add-On](https://docs.gravityforms.com/paypal-checkout-add-on).
...
- **$card\_style** [array](https://docs.gravityforms.com/array)


An array of styles. See the [PayPal API documentation](https://developer.paypal.com/docs/checkout/advanced/customize/card-fields/v1/style/) for details about supported properties.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_ppcp_card_style'``,``'ppcp_card_style_font_size'``, 10, 2 );`<br>`function``ppcp_card_style_font_size(``$card_style``,``$form_id``) {`<br>```$card_style``[``'input'``][``'font-size'``] =``'1.5em'``;`<br>```return``$card_style``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_ppcp_card_style/# "Algolia")
