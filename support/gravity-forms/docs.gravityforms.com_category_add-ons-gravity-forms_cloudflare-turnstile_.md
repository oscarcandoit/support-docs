---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/cloudflare-turnstile/"
title: "Cloudflare Turnstile Add-on for Gravity Forms"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Cloudflare Turnstile Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/cloudflare-turnstile/)    - [Using the Cloudflare Turnstile Add-On](https://docs.gravityforms.com/using-the-cloudflare-turnstile-add-on/ "Using the Cloudflare Turnstile Add-On")
    - [Setting up the Cloudflare Turnstile Add-On](https://docs.gravityforms.com/setting-up-the-cloudflare-turnstile-add-on/ "Setting up the Cloudflare Turnstile Add-On")
    - [Cloudflare Turnstile Add-On Settings Reference](https://docs.gravityforms.com/cloudflare-settings-ref/ "Cloudflare Turnstile Add-On Settings Reference")
    - [Cloudflare Turnstile Add-On Changelog](https://docs.gravityforms.com/cloudflare-turnstile-add-on-changelog/ "Cloudflare Turnstile Add-On Changelog")
...
This article shows you how to use and customize the official Gravity Forms Cloudflare Turnstile Add-On.](https://docs.gravityforms.com/using-the-cloudflare-turnstile-add-on/ "Using the Cloudflare Turnstile Add-On") [**Setting up the Cloudflare Turnstile Add-On** \\
Step-by-step instructions on how to setup the Cloudflare Turnstile Add-On.](https://docs.gravityforms.com/setting-up-the-cloudflare-turnstile-add-on/ "Setting up the Cloudflare Turnstile Add-On") [**Cloudflare Turnstile Add-On Settings Reference** \\
This quick reference guide lists all the settings related to the Official Gravity Forms Cloudflare Turnstile Add-On.](https://docs.gravityforms.com/cloudflare-settings-ref/ "Cloudflare Turnstile Add-On Settings Reference") [**Cloudflare Turnstile Add-On Changelog** \\
Changelog for the official Cloudflare Turnstile Add-On for Gravity Forms.](https://docs.gravityforms.com/cloudflare-turnstile-add-on-changelog/ "Cloudflare Turnstile Add-On Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/cloudflare-turnstile/# "Algolia")
