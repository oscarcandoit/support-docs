---
url: "https://docs.gravityforms.com/gf_field_hidden/"
title: "GF_Field_Hidden - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_hidden/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_hidden/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_hidden/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_hidden/#h-properties)
- [Source Code](https://docs.gravityforms.com/gf_field_hidden/#h-source-code)

## Introduction

The GF\_Field\_Hidden class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Hidden field and the Hidden Quantity field are rendered when the form is displayed and how its value is handled during and after form submission.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `//get the field`<br>`$field``= GFFormsModel::get_field(``$form``, 1 );`<br>`//get the label`<br>`$label``=``$field``->label;` |
...
The source code is located in _includes/fields/class-gf-field-hidden.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_hidden/# "Algolia")
