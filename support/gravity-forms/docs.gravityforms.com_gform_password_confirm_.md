---
url: "https://docs.gravityforms.com/gform_password_confirm/"
title: "gform_password_confirm - Gravity Forms Documentation"
---
...
# gform\_password\_confirm

- [Description](https://docs.gravityforms.com/gform_password_confirm/#h-description)
- [Usage](https://docs.gravityforms.com/gform_password_confirm/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_password_confirm/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_password_confirm/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_password_confirm'``,``'your_function_name'``, 10, 2 );` |

To target a specific form append the form id to the hook name. (format: gform\_password\_confirm\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_password_confirm_6'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_password_confirm_185'``,``'set_password_label'``, 10, 2 );`<br>`function``set_password_label(``$sublabel``,``$form_id``) {`<br>`return``'Enter your password again'``;`<br>`}` |

## Source Code

This filter is located in _common.php_ This filter is located in GF\_Field\_Password::get\_field\_input() in _includes/fields/class-gf-field-password.php_.
...
[Algolia](https://docs.gravityforms.com/gform_password_confirm/# "Algolia")
