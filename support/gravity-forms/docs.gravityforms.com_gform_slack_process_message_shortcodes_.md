---
url: "https://docs.gravityforms.com/gform_slack_process_message_shortcodes/"
title: "gform_slack_process_message_shortcodes - Gravity Forms"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Slack Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/slack-filters/)          - [gform\_slack\_field\_value](https://docs.gravityforms.com/gform_slack_field_value/ "gform_slack_field_value")
          - [gform\_slack\_icon](https://docs.gravityforms.com/gform_slack_icon/ "gform_slack_icon")
          - [gform\_slack\_invite](https://docs.gravityforms.com/gform_slack_invite/ "gform_slack_invite")
          - [gform\_slack\_process\_message\_shortcodes](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/ "gform_slack_process_message_shortcodes")
          - [gform\_slack\_username](https://docs.gravityforms.com/gform_slack_username/ "gform_slack_username")
          - [Slack Feed Meta](https://docs.gravityforms.com/slack-feed-meta/ "Slack Feed Meta")
...
- [Description](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/#h-description)
- [Usage](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/#h-examples)
- [1\. Enable for all forms](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/#h-1-enable-for-all-forms)
- [2\. Enable for a specific feed name](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/#h-2-enable-for-a-specific-feed-name)
- [Placement](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/#h-placement)
- [Since](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_slack_process_message_shortcodes'``,``'your_function_name'``, 10, 3 );` |

To target a specific form append the form id to the hook name. (Format: gform\_slack\_process\_message\_shortcodes\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_slack_process_message_shortcodes_4'``,``'your_function_name'``, 10, 3 );` |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_slack_process_message_shortcodes'``,``'__return_true'``);` |

### 2\. Enable for a specific feed name

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_slack_process_message_shortcodes'``,``function``(``$process_shortcodes``,``$form``,``$feed``) {`<br>```return``rgars(``$feed``,``'meta/feed_name'``) ==``'Slack Feed 1'``? true :``$process_shortcodes``;`<br>`}, 10, 3 );` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_slack_process_message_shortcodes'``,``$form``[``'id'``], false,``$form``,``$feed``)` |

This filter is located in GFSlack::process\_feed() in _class-gf-slack.php_.
...
[Algolia](https://docs.gravityforms.com/gform_slack_process_message_shortcodes/# "Algolia")
