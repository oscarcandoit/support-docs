---
url: "https://docs.gravityforms.com/gform_post_payment_status/"
title: "gform_post_payment_status - Gravity Forms Documentation"
---
...
# gform\_post\_payment\_status

- [Description](https://docs.gravityforms.com/gform_post_payment_status/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_payment_status/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_payment_status/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_payment_status/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_post_payment_status/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_post_payment_status/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_post_payment_status'``,``'your_function_name'``, 10, 8 );` |
...
- **$status** [string](https://docs.gravityforms.com/string)
...
- **$subscriber\_id** [integer](https://docs.gravityforms.com/integer)
...
- **$pending\_reason** [string](https://docs.gravityforms.com/string)

If the payment status is set to “Pending”, the reason will be passed in this variable.

- **$reason** [string](https://docs.gravityforms.com/string)

If the payment status is set to “Reversed”, “Refunded”, or “Canceled\_Reversal” the reason for this change will be provided in this variable.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `add_action(``'gform_post_payment_status'``,``'admin_payment_notification'``, 10, 8 );`<br>`function``admin_payment_notification(``$feed``,``$entry``,``$status``,``$transaction_id``,``$subscriber_id``,``$amount``,``$pending_reason``,``$reason``) {`<br>```$admin_email``= get_bloginfo(``'admin_email'``);`<br>```if``(``$status``==``'Completed'``) {`<br>```wp_mail(``$admin_email``,``'Payment Successful!'``,``'Message about the successful payment'``);`<br>```}``elseif``(``$status``==``'Refunded'``||``$status``==``'Reversed'``||``$status``'Canceled_Reversal'``) {`<br>```wp_mail(``$admin_email``,``"Payment $status"``,``"There was an issue with this payment: $reason"``);`<br>```}`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `do_action(``'gform_post_payment_status'``,``$feed``,``$entry``,``$status``,``$transaction_id``,``$subscriber_id``,``$amount``,``$pending_reason``,``$reason``)` |

This hook is located in GFPayPal::post\_callback() in _class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_post_payment_status/# "Algolia")
