---
url: "https://docs.gravityforms.com/gform_embed_edit_post_link/"
title: "gform_embed_edit_post_link - Gravity Forms Documentation"
---
...
- [Developers](https://docs.gravityforms.com/category/developers/)  - [Theme Framework](https://docs.gravityforms.com/category/developers/theme-framework/)
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Editor Filters](https://docs.gravityforms.com/category/developers/hooks/filters/editor-filters/)        - [gform\_add\_field\_buttons](https://docs.gravityforms.com/gform_add_field_buttons/ "gform_add_field_buttons")
        - [gform\_disable\_ajax\_save](https://docs.gravityforms.com/gform_disable_ajax_save/ "gform_disable_ajax_save")
        - [gform\_editor\_sidebar\_panels](https://docs.gravityforms.com/gform_editor_sidebar_panels/ "gform_editor_sidebar_panels")
        - [gform\_embed\_edit\_post\_link](https://docs.gravityforms.com/gform_embed_edit_post_link/ "gform_embed_edit_post_link")
        - [gform\_embed\_post\_types](https://docs.gravityforms.com/gform_embed_post_types/ "gform_embed_post_types")
        - [gform\_field\_groups\_form\_editor](https://docs.gravityforms.com/gform_field_groups_form_editor/ "gform_field_groups_form_editor")
        - [gform\_field\_settings\_tabs](https://docs.gravityforms.com/gform_field_settings_tabs/ "gform_field_settings_tabs")
...
# gform\_embed\_edit\_post\_link

- [Description](https://docs.gravityforms.com/gform_embed_edit_post_link/#h-description)
- [Usage](https://docs.gravityforms.com/gform_embed_edit_post_link/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_embed_edit_post_link/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_embed_edit_post_link/#h-example)
- [Placement](https://docs.gravityforms.com/gform_embed_edit_post_link/#h-placement)
- [Since](https://docs.gravityforms.com/gform_embed_edit_post_link/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_embed_edit_post_link/#h-source-code)

## Description

The gform\_embed\_edit\_post\_link filter is used to customize the edit post link template for the Embed Form flyout.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_embed_edit_post_link'``,``'your_function_name'``);` |

## Parameters

- **$edit\_link** [string](https://docs.gravityforms.com/string/)

The edit link. Use `%1$s` as the placeholder for the page/post ID.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_embed_edit_post_link'``,``function``(``$edit_link``) {`<br>```$edit_link``=``str_replace``(``'post.php?post='``,``'custom-page.php?something='``,``$edit_link``);`<br>``<br>```return``$edit_link``;`<br>`} );` |
...
This filter is located in \\Gravity\_Forms\\Gravity\_Forms\\Embed\_Form\\Config\\GF\_Embed\_Config::get\_urls() in _includes/embed-form/config/class-gf-embed-config.php_.
...
[Algolia](https://docs.gravityforms.com/gform_embed_edit_post_link/# "Algolia")
