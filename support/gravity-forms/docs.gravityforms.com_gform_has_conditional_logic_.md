---
url: "https://docs.gravityforms.com/gform_has_conditional_logic/"
title: "gform_has_conditional_logic - Gravity Forms Documentation"
---
...
# gform\_has\_conditional\_logic

- [Description](https://docs.gravityforms.com/gform_has_conditional_logic/#h-description)
- [Usage](https://docs.gravityforms.com/gform_has_conditional_logic/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_has_conditional_logic/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_has_conditional_logic/#h-examples)
- [Returns if the form has conditional logic.](https://docs.gravityforms.com/gform_has_conditional_logic/#h-returns-if-the-form-has-conditional-logic)
- [Placement](https://docs.gravityforms.com/gform_has_conditional_logic/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_has_conditional_logic/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_has_conditional_logic/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_has_conditional_logic'``,``'your_function_name'``, 10, 2 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$has\_conditional\_logic** | bool | True or False if the user has enabled conditional logic in the current form settings |
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_has_conditional_logic'``,``function``(``$has_conditional_logic``,``$form``) {`<br>```return``$has_conditional_logic``;`<br>`}, 10, 2 );` |
...
This filter is located in GFFormDisplay::has\_conditional\_logic() in form\_display.php.

## Since

This filter was added in Gravity Forms 2.8.
...
[Algolia](https://docs.gravityforms.com/gform_has_conditional_logic/# "Algolia")
