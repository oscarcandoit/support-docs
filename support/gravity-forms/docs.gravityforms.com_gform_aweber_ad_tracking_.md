---
url: "https://docs.gravityforms.com/gform_aweber_ad_tracking/"
title: "gform_aweber_ad_tracking - Gravity Forms Documentation"
---
...
# gform\_aweber\_ad\_tracking

- [Description](https://docs.gravityforms.com/gform_aweber_ad_tracking/#h-description)
- [Usage](https://docs.gravityforms.com/gform_aweber_ad_tracking/#h-usage)
- [Example](https://docs.gravityforms.com/gform_aweber_ad_tracking/#h-example)
- [Placement](https://docs.gravityforms.com/gform_aweber_ad_tracking/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_aweber_ad_tracking/#h-source-code)

## Description

This filter can be used to modify the ad\_tracking parameter value before it is sent to AWeber.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_aweber_ad_tracking'``,``'your_function_name'``, 10, 4 );` |

You can limit the scope of the filter to a single form by appending the form id on the end of the hook name like so:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_aweber_ad_tracking_5'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$ad\_tracking** [string](https://docs.gravityforms.com/string)
The default value of the ad\_tracking parameter is the form title.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_aweber_ad_tracking'``,``function``(``$ad_tracking``,``$form``,``$entry``,``$feed``) {`<br>`return``'your new value'``;`<br>`}, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1 | `apply_filters(``"gform_aweber_ad_tracking_{$form['id']}"``, apply_filters(``'gform_aweber_ad_tracking'``,``$form``[``'title'``],``$entry``,``$form``,``$feed``),``$entry``,``$form``,``$feed``)` |
...
[Algolia](https://docs.gravityforms.com/gform_aweber_ad_tracking/# "Algolia")
