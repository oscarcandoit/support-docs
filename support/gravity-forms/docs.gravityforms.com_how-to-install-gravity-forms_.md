---
url: "https://docs.gravityforms.com/how-to-install-gravity-forms/"
title: "How To Install Gravity Forms - Gravity Forms Documentation"
---
...
- [Using the WordPress dashboard](https://docs.gravityforms.com/how-to-install-gravity-forms/#h-using-the-wordpress-dashboard)
- [Using FTP](https://docs.gravityforms.com/how-to-install-gravity-forms/#h-using-ftp)
...
If your site is hosted by WordPress.com you can only install Gravity Forms if you are on their Creator plan, with a custom domain configured, and have installed the Hello Dolly plugin. You can then install Gravity Forms from the /wp-admin/ dashboard using the instructions below.

## Using the WordPress dashboard

1. After [downloading](https://www.gravityforms.com/my-account/downloads/) Gravity Forms go to the plugins page then click **Add New**.
...
1. First, download Gravity Forms. To do so, simply access the [Gravity Forms download page](https://www.gravityforms.com/my-account/downloads/), log into your account, and download the plugin zip file.
2. As you are installing via FTP, you will need to unpack the zip file that you downloaded.
3. Next, access your WordPress site via FTP and navigate to the _wp\_content/plugins_ directory. Inside there, upload the entire **‘gravityforms’** folder that you have obtained as result of unzipping the zip file.
4. Once fully uploaded, access your WordPress admin dashboard and click on **Plugins**. Inside this page, you should now see an entry for Gravity Forms. All you have to do now is activate it by clicking one **Activate Plugin**.
...
[Algolia](https://docs.gravityforms.com/how-to-install-gravity-forms/# "Algolia")
