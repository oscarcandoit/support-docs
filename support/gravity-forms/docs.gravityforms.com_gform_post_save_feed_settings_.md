---
url: "https://docs.gravityforms.com/gform_post_save_feed_settings/"
title: "gform_post_save_feed_settings - Gravity Forms Documentation"
---
...
# gform\_post\_save\_feed\_settings

- [Description](https://docs.gravityforms.com/gform_post_save_feed_settings/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_save_feed_settings/#h-usage)
- [Placement](https://docs.gravityforms.com/gform_post_save_feed_settings/#h-placement)
- [Since](https://docs.gravityforms.com/gform_post_save_feed_settings/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_post_save_feed_settings/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `do_action(``'gform_post_save_feed_settings'``,``$result``,``$form_id``,``$settings``,``$this``);` |

## Parameters

- **$feed\_id** [string](https://docs.gravityforms.com/string)
...
- **$addon** [GFAddon](https://docs.gravityforms.com/gfaddon)

The current instance of the GFAddOn object which extends GFFeedAddOn or GFPaymentAddOn (i.e. GFCoupons, GF\_User\_Registration, GFStripe).
...
[Algolia](https://docs.gravityforms.com/gform_post_save_feed_settings/# "Algolia")
