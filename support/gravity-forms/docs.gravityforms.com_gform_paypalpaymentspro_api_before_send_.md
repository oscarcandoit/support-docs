---
url: "https://docs.gravityforms.com/gform_paypalpaymentspro_api_before_send/"
title: "gform_paypalpaymentspro_api_before_send - Gravity Forms"
---
...
- [Description](https://docs.gravityforms.com/gform_paypalpaymentspro_api_before_send/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypalpaymentspro_api_before_send/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypalpaymentspro_api_before_send/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypalpaymentspro_api_before_send/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_paypalpaymentspro_api_before_send/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_paypalpaymentspro_api_before_send/#h-source-code)
...
- **$api\_info** [array](https://docs.gravityforms.com/array)
The API information: API\_Endpoint, API\_UserName, API\_Password, Vendor, Partner.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_paypalpaymentspro_api_before_send'``,``'change_paypal_endpoint'``, 10, 2 );`<br>`function``change_paypal_endpoint (``$api_info``,``$form_id``){`<br>```$api_info``[``'API_Endpoint'``] =``'https://pilot-payflowpro.paypal.com'``;`<br>```return``$api_info``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_paypalpaymentspro_api_before_send/# "Algolia")
