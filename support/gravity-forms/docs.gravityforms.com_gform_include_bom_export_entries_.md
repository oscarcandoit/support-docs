---
url: "https://docs.gravityforms.com/gform_include_bom_export_entries/"
title: "gform_include_bom_export_entries - Gravity Forms Documentation"
---
...
# gform\_include\_bom\_export\_entries

- [Description](https://docs.gravityforms.com/gform_include_bom_export_entries/#h-description)
- [Usage](https://docs.gravityforms.com/gform_include_bom_export_entries/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_include_bom_export_entries/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_include_bom_export_entries/#h-example)
- [Placement](https://docs.gravityforms.com/gform_include_bom_export_entries/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_include_bom_export_entries/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_include_bom_export_entries'``,``'your_function_name'``);` |

## Parameters

- **$include\_bom** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_include_bom_export_entries'``,``'exclude_bom'``, 10, 2 );`<br>`function``exclude_bom(``$include_bom``,``$form``){`<br>```// change the bom to false`<br>```return``false;`<br>`}` |
...
This filter is located in _export.php_.
...
[Algolia](https://docs.gravityforms.com/gform_include_bom_export_entries/# "Algolia")
