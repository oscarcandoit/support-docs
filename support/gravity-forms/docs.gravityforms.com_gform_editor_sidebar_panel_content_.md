---
url: "https://docs.gravityforms.com/gform_editor_sidebar_panel_content/"
title: "gform_editor_sidebar_panel_content - Gravity Forms Documentation"
---
...
# gform\_editor\_sidebar\_panel\_content

- [Description](https://docs.gravityforms.com/gform_editor_sidebar_panel_content/#h-description)
- [Usage](https://docs.gravityforms.com/gform_editor_sidebar_panel_content/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_editor_sidebar_panel_content/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_editor_sidebar_panel_content/#h-examples)
- [1\. Add a new panel](https://docs.gravityforms.com/gform_editor_sidebar_panel_content/#h-1-add-a-new-panel)
- [Placement](https://docs.gravityforms.com/gform_editor_sidebar_panel_content/#h-placement)
- [Since](https://docs.gravityforms.com/gform_editor_sidebar_panel_content/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_editor_sidebar_panel_content/#h-source-code)

## Description

The gform\_editor\_sidebar\_panel\_content action hook is used to echo the content for a custom panel in the form editor sidebar. Use the [gform\_editor\_sidebar\_panels](https://docs.gravityforms.com/gform_editor_sidebar_panels) filter to register the panel.
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_editor_sidebar_panel_content'``,``'your_function_name'``, 10, 2 );` |

You can target a specific tab by adding the tab id after the hook name.

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_editor_sidebar_panel_content_thepanelid'``,``'your_function_name'``, 10, 2 );` |

You can target a specific tab and form by adding the id’s after the hook name.

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_editor_sidebar_panel_content_thepanelid_6'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$panel** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_action(``'gform_editor_sidebar_panel_content_my_custom_panel_1'``,``function``(``$panel``,``$form``) {`<br>```echo``'the content of my custom panel.'``;`<br>`}, 10, 2 );` |
...
[Algolia](https://docs.gravityforms.com/gform_editor_sidebar_panel_content/# "Algolia")
