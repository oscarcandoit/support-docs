---
url: "https://docs.gravityforms.com/icontact-feed-meta/"
title: "iContact Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [iContact Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/icontact-filters/)          - [gform\_icontact\_field\_value](https://docs.gravityforms.com/gform_icontact_field_value/ "gform_icontact_field_value")
          - [gform\_icontact\_request\_args](https://docs.gravityforms.com/gform_icontact_request_args/ "gform_icontact_request_args")
          - [iContact Feed Meta](https://docs.gravityforms.com/icontact-feed-meta/ "iContact Feed Meta")
...
- [Introduction](https://docs.gravityforms.com/icontact-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/icontact-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the iContact Add-On is an associative array containing the properties which determine how the add-on should process the form submission.
...
- **fields\_prefix** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s name prefix.

- **fields\_first\_name** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s first name.

- **fields\_last\_name** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s last name.

- **fields\_suffix** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s name suffix.

- **fields\_street** [string](https://docs.gravityforms.com/string)

The ID of the field containing the first line of the customer’s address.

- **fields\_street2** [string](https://docs.gravityforms.com/string)
...
- **fields\_postal\_code** [string](https://docs.gravityforms.com/string)
...
- **fields\_fax** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s fax number.

- **fields\_business** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s business number.

- **custom\_fields** [array](https://docs.gravityforms.com/array)

A multidimensional array containing the iContact custom fields. See [Custom Field Properties](https://docs.gravityforms.com/icontact-feed-meta/#custom-field-properties).
...
- **key** [integer](https://docs.gravityforms.com/integer)
...
[Algolia](https://docs.gravityforms.com/icontact-feed-meta/# "Algolia")
