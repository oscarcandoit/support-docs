---
url: "https://docs.gravityforms.com/gform_import_form_xml_options/"
title: "gform_import_form_xml_options - Gravity Forms Documentation"
---
...
# gform\_import\_form\_xml\_options

- [Description](https://docs.gravityforms.com/gform_import_form_xml_options/#h-description)
- [Usage](https://docs.gravityforms.com/gform_import_form_xml_options/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_import_form_xml_options/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_import_form_xml_options/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_import_form_xml_options/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_import_form_xml_options/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_import_form_xml_options'``,``'my_custom_function'``);` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$options** | [array](https://docs.gravityforms.com/array) | Array of options for the XML import. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_import_form_xml_options'``,``'my_custom_import_xml_options'``);`<br>`function``my_custom_import_xml_options(``$options``) {`<br>```$options``[``'my_custom_form_setting'``] =``array``(``'unserialize_as_array'``=> true );`<br>```return``$options``;`<br>`}` |
...
This filter is located in GFExport::import\_xml() in _export.php_.
...
[Algolia](https://docs.gravityforms.com/gform_import_form_xml_options/# "Algolia")
