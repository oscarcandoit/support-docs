---
url: "https://docs.gravityforms.com/gform_polls_results_ajax_response/"
title: "gform_polls_results_ajax_response - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Polls Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/polls-filters/)          - [gform\_polls\_cron](https://docs.gravityforms.com/gform_polls_cron/ "gform_polls_cron")
          - [gform\_polls\_cron\_schedule](https://docs.gravityforms.com/gform_polls_cron_schedule/ "gform_polls_cron_schedule")
          - [gform\_polls\_form\_pre\_results](https://docs.gravityforms.com/gform_polls_form_pre_results/ "gform_polls_form_pre_results")
          - [gform\_polls\_percentage\_precision](https://docs.gravityforms.com/gform_polls_percentage_precision/ "gform_polls_percentage_precision")
          - [gform\_polls\_results\_ajax\_response](https://docs.gravityforms.com/gform_polls_results_ajax_response/ "gform_polls_results_ajax_response")
...
# gform\_polls\_results\_ajax\_response

- [Description](https://docs.gravityforms.com/gform_polls_results_ajax_response/#h-description)
- [Usage](https://docs.gravityforms.com/gform_polls_results_ajax_response/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_polls_results_ajax_response/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_polls_results_ajax_response/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_polls_results_ajax_response/#h-placement)
- [Since](https://docs.gravityforms.com/gform_polls_results_ajax_response/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_polls_results_ajax_response/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_polls_results_ajax_response'``,``'your_function_name'``, 10, 2 );` |

To target a specific form, append the form id to the hook name. (format: gform\_polls\_results\_ajax\_response\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_polls_results_ajax_response_1'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$response** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_polls_results_ajax_response'``,``'change_result'``, 10, 2 );`<br>`function``change_result(``$response``,``$form``){`<br>```//change the color of the text of the first question`<br>```$response``[``'resultsUI'``] =``str_replace``(``'<div class=\'gpoll_field_label\'>'``,``'<div class=\'gpoll_field_label\' style=\'color:red\'>'``,``$response``[``'resultsUI'``]);`<br>```return``$response``;`<br>`}` |
...
This filter is located in GFPolls::gpoll\_ajax() in _gravityformspolls/class-gf-polls.php_.
...
[Algolia](https://docs.gravityforms.com/gform_polls_results_ajax_response/# "Algolia")
