---
url: "https://docs.gravityforms.com/gform_print_entry_notes/"
title: "gform_print_entry_notes - Gravity Forms Documentation"
---
...
# gform\_print\_entry\_notes

- [Description](https://docs.gravityforms.com/gform_print_entry_notes/#h-description)
- [Usage](https://docs.gravityforms.com/gform_print_entry_notes/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_print_entry_notes/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_print_entry_notes/#h-examples)
- [Always include the notes](https://docs.gravityforms.com/gform_print_entry_notes/#h-always-include-the-notes)
- [Always exclude the notes](https://docs.gravityforms.com/gform_print_entry_notes/#h-always-exclude-the-notes)
- [Invert the choice selected in the admin](https://docs.gravityforms.com/gform_print_entry_notes/#h-invert-the-choice-selected-in-the-admin)
- [Placement](https://docs.gravityforms.com/gform_print_entry_notes/#h-placement)
- [Since](https://docs.gravityforms.com/gform_print_entry_notes/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_print_entry_notes/#h-source-code)

## Description

The gform\_print\_entry\_notes filter allows printing of entry notes to be overridden as the entry markup is being prepared for the print view.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_print_entry_notes'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$print\_entry\_notes** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_print_entry_notes'``,``'__return_true'``);` |

### Always exclude the notes

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_print_entry_notes'``,``'__return_false'``);` |

### Invert the choice selected in the admin

|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_print_entry_notes'``,``function``(``$print_entry_notes``) {`<br>```return``!``$print_entry_notes``;`<br>`} );` |
...
This filter is located in gform\_default\_entry\_content() in _print-entry.php_.
...
[Algolia](https://docs.gravityforms.com/gform_print_entry_notes/# "Algolia")
