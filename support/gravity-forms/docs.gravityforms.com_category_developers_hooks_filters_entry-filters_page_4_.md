---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/4/"
...
Allows the “entry\_detail” page to be marked as a regular page, not an admin or edit page, or a regular page to be marked as an Entry Detail page.](https://docs.gravityforms.com/gform_is_entry_detail_view/ "gform_is_entry_detail_view") [**gform\_notes\_apply\_button** \\
...
The gform\_notes\_avatar filter can be used to filter the avatar used in the entry note.](https://docs.gravityforms.com/gform_notes_avatar/ "gform_notes_avatar") [**gform\_notification\_note** \\
Use this filter to modify the note(s) being added to the entry detail page that contain the sending result of notifications for the entry.](https://docs.gravityforms.com/gform_notification_note/ "gform_notification_note") [**gform\_order\_label** \\
The "gform\_order\_label" filter in Gravity Forms is executed when displaying the "Order" heading on the entry detail page or when sending the order information via email.](https://docs.gravityforms.com/gform_order_label/ "gform_order_label") [**gform\_payment\_amount** \\
...
Allows the payment date displayed for the entry in the Payment Details section to be modified.](https://docs.gravityforms.com/gform_payment_date/ "gform_payment_date") [Previous](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/3/) [1](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/) [2](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/2/) [3](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/3/) 4 [5](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/5/) [Next](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/5/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/entry-filters/page/4/# "Algolia")
