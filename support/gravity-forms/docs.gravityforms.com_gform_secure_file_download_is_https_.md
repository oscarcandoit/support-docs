---
url: "https://docs.gravityforms.com/gform_secure_file_download_is_https/"
title: "gform_secure_file_download_is_https - Gravity Forms Documentation"
---
...
# gform\_secure\_file\_download\_is\_https

- [Description](https://docs.gravityforms.com/gform_secure_file_download_is_https/#h-description)
- [Usage](https://docs.gravityforms.com/gform_secure_file_download_is_https/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_secure_file_download_is_https/#h-parameters)
- [Placement](https://docs.gravityforms.com/gform_secure_file_download_is_https/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_secure_file_download_is_https/#h-source-code)

## Description

Allows for override of SSL replacement.

By default Gravity Forms will attempt to determine if the schema of the URL should be overwritten for SSL. This is not ideal for all situations, particularly domain mapping. Setting $field\_ssl to false will prevent the override.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_secure_file_download_is_https'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$field\_ssl** [bool](https://docs.gravityforms.com/bool)
...
[Algolia](https://docs.gravityforms.com/gform_secure_file_download_is_https/# "Algolia")
