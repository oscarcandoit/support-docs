---
url: "https://docs.gravityforms.com/gform_polls_percentage_precision/"
title: "gform_polls_percentage_precision - Gravity Forms Documentation"
---
...
# gform\_polls\_percentage\_precision

- [Description](https://docs.gravityforms.com/gform_polls_percentage_precision/#h-description)
- [Usage](https://docs.gravityforms.com/gform_polls_percentage_precision/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_polls_percentage_precision/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_polls_percentage_precision/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_polls_percentage_precision/#h-placement)
- [Since](https://docs.gravityforms.com/gform_polls_percentage_precision/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_polls_percentage_precision/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_polls_percentage_precision'``,``'your_function_name'``, 10, 2);` |

## Parameters

- **$precision** [int](https://docs.gravityforms.com/int)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_polls_percentage_precision'``,``'gform_polls_custom_precision'``, 10, 2);`<br>`function``gform_polls_custom_precision(``$precision``,``$form_id``){`<br>```return``1;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_polls_percentage_precision/# "Algolia")
