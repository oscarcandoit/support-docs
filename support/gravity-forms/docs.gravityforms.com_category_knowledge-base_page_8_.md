---
url: "https://docs.gravityforms.com/category/knowledge-base/page/8/"
title: "Knowledge Base Archives - Page 8 of 18 - Gravity Forms Documentation - Page 8 of 18"
---
...
"Everyone should be able to use the web and web forms, regardless of device or ability." We want everyone to be able to use our forms, and we want site owners to be able to comply with government laws on accessibility, regardless of which country they live in or where they visit a website from.](https://docs.gravityforms.com/gravity-forms-commitment-to-accessibility/ "Gravity Forms Commitment to Accessibility") [**Gravity Forms Custom Development** \\
If you need custom functionality, you might need to hire a developer. We can point you to two starter places that may help.](https://docs.gravityforms.com/custom-development/ "Gravity Forms Custom Development") [**Gravity Forms Entry Payment Statuses** \\
This article provides an overview of the various payment statuses that Gravity Forms and its add-ons may set on an entry.](https://docs.gravityforms.com/gravity-forms-entry-payment-statuses/ "Gravity Forms Entry Payment Statuses") [**Gravity Forms Gutenberg Block** \\
The Gravity Forms Gutenberg Block is a content block for the new WordPress Gutenberg page editor that allows you to add any of your saved Gravity Forms as a content block from directly within the Gutenberg editor.](https://docs.gravityforms.com/gravity-forms-gutenberg-block/ "Gravity Forms Gutenberg Block") [**Gravity Forms Pricing: Adding Tax** \\
If you would like to implement tax you can use the Product Field configured as a Calculation field type. Then configure the formula for the calculation to calculate the appropriate tax.](https://docs.gravityforms.com/gravity-forms-pricing-adding-tax/ "Gravity Forms Pricing: Adding Tax") [**Gravity Forms Security Whitepaper** \\
Learn more about Gravity Forms software security in this free white paper which is forked from the original security white paper for WordPress.](https://docs.gravityforms.com/security-whitepaper/ "Gravity Forms Security Whitepaper") [**Gravity Forms System Requirements** \\
The following table shows the minimum version numbers required for multiple categories. ComponentRecommendedFor SupportMinimumWordPress6.86.76.5PHP8.17.47.4MySQL (MariaDB)8.0 (10.5)——.](https://docs.gravityforms.com/gravity-forms-system-requirements/ "Gravity Forms System Requirements") [**Gravity Forms Version Numbering** \\
This article provides an overview of our Gravity Forms version numbering scheme and describes how they indicate the various types of updates we offer and what each type of update may contain.](https://docs.gravityforms.com/version-numbering/ "Gravity Forms Version Numbering") [**Guide to Gravity Forms 2.5 for Theme Developers** \\
Gravity Forms 2.5 introduces some big changes to our front-end form markup that will have some big impacts on theme developers.](https://docs.gravityforms.com/guide-to-gravity-forms-2-5-for-theme-developers/ "Guide to Gravity Forms 2.5 for Theme Developers") [**Gutenberg Block Changelog** \\
View the change log for the Gutenberg Block Add-On.](https://docs.gravityforms.com/gutenberg-block-change-log/ "Gutenberg Block Changelog") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/7/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [6](https://docs.gravityforms.com/category/knowledge-base/page/6/) [7](https://docs.gravityforms.com/category/knowledge-base/page/7/) 8 [9](https://docs.gravityforms.com/category/knowledge-base/page/9/) [10](https://docs.gravityforms.com/category/knowledge-base/page/10/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/9/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/8/# "Algolia")
