---
url: "https://docs.gravityforms.com/processor-decline-errors/"
title: "Processor Decline Errors - Gravity Guide"
---
...
- [Introduction](https://docs.gravityforms.com/processor-decline-errors/#h-introduction)
- [What is a Processor Decline?](https://docs.gravityforms.com/processor-decline-errors/#h-what-is-a-processor-decline)
- [But Why Did They Reject The Charge?](https://docs.gravityforms.com/processor-decline-errors/#h-but-why-did-they-reject-the-charge)
- [But there is no problem with my card!](https://docs.gravityforms.com/processor-decline-errors/#h-but-there-is-no-problem-with-my-card)
- [What can Gravity Forms do to resolve this?](https://docs.gravityforms.com/processor-decline-errors/#h-what-can-gravity-forms-do-to-resolve-this)
- [How can I resolve this?](https://docs.gravityforms.com/processor-decline-errors/#h-how-can-i-resolve-this)
...
In more detail—when you enter your transaction details and press “go” on our [purchase page](https://www.gravityforms.com/pricing), your details are securely sent from our payment collection site to a payment gateway, who’s job it is to obtain authorization for the charge from your bank, and then execute the commands necessary to initiate the transfer of funds between financial institutions.
...
The link below shows a list of the types of error codes your bank may send with a processor decline. These are not always visible when you make a purchase, but we can look them up with you transaction metadata. Link: [list of decline codes](https://developer.paypal.com/braintree/articles/control-panel/transactions/declines#authorization-decline-codes).

## But there is no problem with my card!

We know, we hear that _all the time_! In our experience, how banks utilize their error codes can vary widely. With all the various state and country regulations, combined with a myriad of internal processes and staff training levels, financial institutions seem far from consistent in this, and definitely not faultless in how each executes this process.
...
Lesson being, _don’t trust the error code as written_. If you have any doubt, ask your bank!
...
[Algolia](https://docs.gravityforms.com/processor-decline-errors/# "Algolia")
