---
url: "https://docs.gravityforms.com/gform_stripe_sca_success_pre_validation/"
title: "gform_stripe_sca_success_pre_validation - Gravity Forms Documentation"
---
...
# gform\_stripe\_sca\_success\_pre\_validation

- [Description](https://docs.gravityforms.com/gform_stripe_sca_success_pre_validation/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_sca_success_pre_validation/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_sca_success_pre_validation/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_stripe_sca_success_pre_validation/#h-example)
- [Since](https://docs.gravityforms.com/gform_stripe_sca_success_pre_validation/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_sca_success_pre_validation/#h-source-code)
- [Placement](https://docs.gravityforms.com/gform_stripe_sca_success_pre_validation/#h-placement)
...
- **$result** [array](https://docs.gravityforms.com/array/)

The validation result
- **$value** [array](https://docs.gravityforms.com/array/)

The field value being validated.
- **$form** [array](https://docs.gravityforms.com/form-object/)

The current form object.
- **$field** [array](https://docs.gravityforms.com/field-object/)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_stripe_sca_success_pre_validation'``,``'stop_second_recaptcha_validation'``, 10, 4 );`<br>`function``stop_second_recaptcha_validation(``$result``,``$value``,``$form``,``$field``) {`<br>```if``(``$field``->type ===``'captcha'``) {`<br>```$result``[``'is_valid'``] = true;`<br>```$result``[``'message'``]  =``''``;`<br>```}`<br>```return``$result``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_stripe_sca_success_pre_validation/# "Algolia")
