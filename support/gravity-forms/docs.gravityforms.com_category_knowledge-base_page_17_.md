---
url: "https://docs.gravityforms.com/category/knowledge-base/page/17/"
title: "Knowledge Base Archives - Page 17 of 18 - Gravity Forms Documentation - Page 17 of 18"
---
...
Within Gravity Forms, URL validation methods exist to heighten security as well as avoid possible bugs. In this article, we will explain how URL validation works in Gravity Forms, and how to manipulate it.](https://docs.gravityforms.com/url-validation-gravity-forms/ "URL Validation In Gravity Forms") [**URLs Ignored for Gravity Forms License Site Limits** \\
This article identifies how Gravity Forms classifies sites for the purposes of enforcing license site limits.](https://docs.gravityforms.com/urls-ignored-for-gravity-forms-license-site-limits/ "URLs Ignored for Gravity Forms License Site Limits") [**Using Confirmation Query Strings to Populate a Form Based on Another Submission** \\
You have two forms. The first form is used to capture general customer information, and the second is used to create a new user account on your site.](https://docs.gravityforms.com/confirmation-query-string-populate-form/ "Using Confirmation Query Strings to Populate a Form Based on Another Submission") [**Using Survey Fields In Conditional Logic** \\
Learn how to apply conditional logic to survey fields such as Likert, Rank and Rating.](https://docs.gravityforms.com/using-survey-fields-in-conditional-logic/ "Using Survey Fields In Conditional Logic") [**Using the Advanced Post Creation Add-On with Advanced Custom Fields** \\
This article outlines how to correctly map values to Advanced Custom Fields (ACF) when creating an Advanced Post Creation feed.](https://docs.gravityforms.com/using-the-advanced-post-creation-add-on-with-advanced-custom-fields/ "Using the Advanced Post Creation Add-On with Advanced Custom Fields") [**Using the Gravity Forms “gform\_validation” Hook** \\
The gform\_valiation hook will allow you to modify how your forms are validated.](https://docs.gravityforms.com/using-gform-validation-hook/ "Using the Gravity Forms “gform_validation” Hook") [**Viewing Sales Results** \\
Learn how to view the results and statistics from your Gravity Forms payment processor.](https://docs.gravityforms.com/viewing-sales-results/ "Viewing Sales Results") [**What is this Charge on my Credit Card?** \\
Do you have a credit card charge form us and you are wondering what Gravity Forms is for? This article should give you the basics and how to get more information.](https://docs.gravityforms.com/what-is-this-charge-on-my-credit-card/ "What is this Charge on my Credit Card?") [**What To Do If You Suspect a Security Issue** \\
We take security issues very seriously and want to make sure that any security concerns are appropriately addressed in a timely manner.](https://docs.gravityforms.com/what-to-do-if-you-suspect-a-security-issue/ "What To Do If You Suspect a Security Issue") [**Where Do I Put This Code?** \\
In this article, we will show you where you should typically place code that is shown in our documentation.](https://docs.gravityforms.com/where-do-i-put-this-code/ "Where Do I Put This Code?") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/16/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [15](https://docs.gravityforms.com/category/knowledge-base/page/15/) [16](https://docs.gravityforms.com/category/knowledge-base/page/16/) 17 [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/18/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/17/# "Algolia")
