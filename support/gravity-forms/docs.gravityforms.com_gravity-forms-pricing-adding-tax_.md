---
url: "https://docs.gravityforms.com/gravity-forms-pricing-adding-tax/"
title: "Gravity Forms Pricing: Adding Tax - Gravity Forms Documentation"
---
...
- [Using A Calculation Field](https://docs.gravityforms.com/gravity-forms-pricing-adding-tax/#h-using-a-calculation-field)
- [Third Party Possibilities](https://docs.gravityforms.com/gravity-forms-pricing-adding-tax/#h-third-party-possibilities)
- [GravityWiz Subtotal Merge Tag (for Calculations)](https://docs.gravityforms.com/gravity-forms-pricing-adding-tax/#h-gravitywiz-subtotal-merge-tag-for-calculations)
- [Gravity Perks eCommerce Fields](https://docs.gravityforms.com/gravity-forms-pricing-adding-tax/#h-gravity-perks-ecommerce-fields)
...
The above is just an example of a basic calculation formula to calculate a 10% surcharge over two single products. If you’re new to calculations, please check the [Using Calculations](https://docs.gravityforms.com/using-calculations/) documentation page.

If tax should only be applied in certain situations, you can then use [conditional logic](https://docs.gravityforms.com/enable-conditional-logic/) to show or hide that field based on the conditions that must exist in order for the tax to be applied.
...
#### [GravityWiz Subtotal Merge Tag (for Calculations)](http://gravitywiz.com/subtotal-merge-tag-for-calculations/)
...
#### [Gravity Perks eCommerce Fields](https://www.gravityforms.com/community/ecommerce-fields/)
...
[Algolia](https://docs.gravityforms.com/gravity-forms-pricing-adding-tax/# "Algolia")
