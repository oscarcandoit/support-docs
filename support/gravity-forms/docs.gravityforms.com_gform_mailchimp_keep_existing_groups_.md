---
url: "https://docs.gravityforms.com/gform_mailchimp_keep_existing_groups/"
title: "gform_mailchimp_keep_existing_groups - Gravity Forms Documentation"
---
...
# gform\_mailchimp\_keep\_existing\_groups

- [Description](https://docs.gravityforms.com/gform_mailchimp_keep_existing_groups/#h-description)
- [Usage](https://docs.gravityforms.com/gform_mailchimp_keep_existing_groups/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_mailchimp_keep_existing_groups/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_mailchimp_keep_existing_groups/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_mailchimp_keep_existing_groups/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_mailchimp_keep_existing_groups/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mailchimp_keep_existing_groups'``,``'__return_false'``);` |

You can also specify this per form by adding the form id after the hook name.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mailchimp_keep_existing_groups_1'``,``'__return_false'``);` |
...
[Algolia](https://docs.gravityforms.com/gform_mailchimp_keep_existing_groups/# "Algolia")
