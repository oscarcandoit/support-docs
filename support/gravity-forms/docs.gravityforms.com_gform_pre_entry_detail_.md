---
url: "https://docs.gravityforms.com/gform_pre_entry_detail/"
title: "gform_pre_entry_detail - Gravity Forms Documentation"
---
...
# gform\_pre\_entry\_detail

- [Description](https://docs.gravityforms.com/gform_pre_entry_detail/#h-description)
- [Usage](https://docs.gravityforms.com/gform_pre_entry_detail/#h-usage)
- [Example](https://docs.gravityforms.com/gform_pre_entry_detail/#h-example)
- [Placement](https://docs.gravityforms.com/gform_pre_entry_detail/#h-placement)
- [Since](https://docs.gravityforms.com/gform_pre_entry_detail/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_pre_entry_detail/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_pre_entry_detail'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_pre_entry_detail'``,``'mark_entry_read'``, 10, 2 );`<br>`function``mark_entry_read(``$form``,``$entry``){`<br>`echo``'Hello, World!'``;`<br>`}` |
...
This action is located in GFEntryDetail::lead\_detail\_page in _entry\_detail.php_.
...
[Algolia](https://docs.gravityforms.com/gform_pre_entry_detail/# "Algolia")
