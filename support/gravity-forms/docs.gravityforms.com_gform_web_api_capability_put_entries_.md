---
url: "https://docs.gravityforms.com/gform_web_api_capability_put_entries/"
title: "gform_web_api_capability_put_entries - Gravity Forms Documentation"
---
...
# gform\_web\_api\_capability\_put\_entries

- [Description](https://docs.gravityforms.com/gform_web_api_capability_put_entries/#h-description)
- [Usage](https://docs.gravityforms.com/gform_web_api_capability_put_entries/#h-usage)
- [Example](https://docs.gravityforms.com/gform_web_api_capability_put_entries/#h-example)
- [Source Code](https://docs.gravityforms.com/gform_web_api_capability_put_entries/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_web_api_capability_put_entries'``,``function``(``$capability``) {``return``'my_custom_capability'``; } );` |
...
[Algolia](https://docs.gravityforms.com/gform_web_api_capability_put_entries/# "Algolia")
