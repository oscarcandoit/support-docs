---
url: "https://docs.gravityforms.com/setting-pipe-add/"
title: "Setting Up the Pipe Add-On - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Pipe Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/pipe-add-on/)    - [Setting Up the Pipe Add-On](https://docs.gravityforms.com/setting-pipe-add/ "Setting Up the Pipe Add-On")
    - [Pipe Changelog](https://docs.gravityforms.com/pipe-change-log/ "Pipe Changelog")
...
- [Pre-Requisites](https://docs.gravityforms.com/setting-pipe-add/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-pipe-add/#h-setup)
- [Adding Pipe to Your Form](https://docs.gravityforms.com/setting-pipe-add/#h-adding-pipe-to-your-form)
...
- A [Pipe](https://addpipe.com/) account

## Setup

1. Log into your WordPress admin dashboard.
2. On the left side navigation menu, hover over **Forms** and click on **Settings**.
3. From this page, click the **Pipe** tab.
4. Enter your **Account Hash** and **API Key**. This can be found by logging into your [Pipe](https://addpipe.com/) account and clicking on **Account** at the top of the page.
...
![Screenshot of Pipe Add-on Site Level Setting](https://docs.gravityforms.com/wp-content/uploads/2021/08/CleanShot-2021-08-24-at-13.19.59.png)

Once you have entered your API key, you’re ready to add Pipe to your form.

## Adding Pipe to Your Form

To add Pipe video recording to your form, you’ll need to add the Pipe field by using the form editor. See our User Guide for the [Pipe Recording Field](https://docs.gravityforms.com/pipe-recorder-field/) for more information.
...
[Algolia](https://docs.gravityforms.com/setting-pipe-add/# "Algolia")
