---
url: "https://docs.gravityforms.com/gform_mailchimp_lists_params/"
title: "gform_mailchimp_lists_params - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_mailchimp_lists_params/#h-description)
- [Usage](https://docs.gravityforms.com/gform_mailchimp_lists_params/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_mailchimp_lists_params/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_mailchimp_lists_params/#h-examples)
- [1\. Increase limit](https://docs.gravityforms.com/gform_mailchimp_lists_params/#h-1-increase-limit)
- [Placement](https://docs.gravityforms.com/gform_mailchimp_lists_params/#h-placement)
- [Since](https://docs.gravityforms.com/gform_mailchimp_lists_params/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_mailchimp_lists_params/#h-source-code)

## Description

The “gform\_mailchimp\_lists\_params” filter in Gravity Forms Mailchimp Add-On allows the request parameters to be modified when getting Mailchimp lists/audiences.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mailchimp_lists_params'``,``'my_function'``);` |

## Parameters

- **$params** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1 | `$params``=``array``(``'start'``=> 0,``'limit'``=> 100 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_mailchimp_lists_params'``,``function``(``$params``) {`<br>```$params``[``'limit'``] = 200;`<br>```return``$params``;`<br>`} );` |
...
This filter is located in _class-gf-mailchimp.php_.
...
[Algolia](https://docs.gravityforms.com/gform_mailchimp_lists_params/# "Algolia")
