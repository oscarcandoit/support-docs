---
url: "https://docs.gravityforms.com/gform_zapier_products/"
title: "gform_zapier_products - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_zapier_products/#h-description)
- [Usage](https://docs.gravityforms.com/gform_zapier_products/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_zapier_products/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_zapier_products/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_zapier_products/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_zapier_products/#h-source-code)

## Description

The “gform\_zapier\_products” filter allows the products array to be modified before it is sent to Zapier.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_zapier_products'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$products** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13 | `add_filter(``'gform_zapier_products'``,``'modify_products'``, 10, 3 );`<br>`function``modify_products(``$products``,``$form``,``$entry``){`<br>```$products``[] =``array``(`<br>```'product_id'``=>``'TEST01'``,`<br>```'product_name'``=>``'Test Product'``,`<br>```'product_quantity'``=> 2,`<br>```'product_price'``=> 5,`<br>```'product_price_with_options'``=> 5,`<br>```'product_subtotal'``=> 10,`<br>```'product_options'``=>``'Blue'`<br>```);`<br>```return``$products``;`<br>`}` |
...
This filter is located in GFZapier::get\_products\_array() in _gravityformszapier/zapier.php_.
...
[Algolia](https://docs.gravityforms.com/gform_zapier_products/# "Algolia")
