---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/slack-add-on/"
title: "Slack Add-On Archives - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Slack Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/slack-add-on/)    - [Setting Up the Slack Add-On](https://docs.gravityforms.com/setting-slack-add/ "Setting Up the Slack Add-On")
    - [Creating a Feed for the Slack Add-On](https://docs.gravityforms.com/creating-feed-slack-add/ "Creating a Feed for the Slack Add-On")
    - [Slack Update for New API](https://docs.gravityforms.com/slack-update-for-new-api/ "Slack Update for New API")
    - [Slack Changelog](https://docs.gravityforms.com/slack-change-log/ "Slack Changelog")
...
Step-by-step instructions on how to setup the Slack Add-On.](https://docs.gravityforms.com/setting-slack-add/ "Setting Up the Slack Add-On") [**Creating a Feed for the Slack Add-On**\\
This article contains step-by-step instructions on how to create a feed for the Slack Add-On.](https://docs.gravityforms.com/creating-feed-slack-add/ "Creating a Feed for the Slack Add-On") [**Slack Update for New API** \\
This article describes the process needed to upgrade to the new Gravity Forms Slack Add-On version.](https://docs.gravityforms.com/slack-update-for-new-api/ "Slack Update for New API") [**Slack Changelog** \\
View the change log for the Slack Add-On.](https://docs.gravityforms.com/slack-change-log/ "Slack Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/slack-add-on/# "Algolia")
