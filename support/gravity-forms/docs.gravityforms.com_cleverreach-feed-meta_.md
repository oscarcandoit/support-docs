---
url: "https://docs.gravityforms.com/cleverreach-feed-meta/"
title: "CleverReach Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [CleverReach Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/cleverreach-filters/)          - [CleverReach Feed Meta](https://docs.gravityforms.com/cleverreach-feed-meta/ "CleverReach Feed Meta")
          - [gform\_cleverreach\_field\_value](https://docs.gravityforms.com/gform_cleverreach_field_value/ "gform_cleverreach_field_value")
...
- [Introduction](https://docs.gravityforms.com/cleverreach-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/cleverreach-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the CleverReach Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `$feed``[``'meta'``] =``array``(`<br>```'feed_name'``=>``'Your Feed Name'``,`<br>```'email'``=>``'2'``,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **group** [string](https://docs.gravityforms.com/string)
...
A multidimensional array containing the CleverReach custom fields. See [Custom Field Properties](https://docs.gravityforms.com/cleverreach-feed-meta/#custom-field-properties).

- **double\_optin\_form** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `$array``=``array``(`<br>```'key'``=>``'first_name'``,`<br>```'value'``=>``'1.3'``,`<br>`);` |
...
[Algolia](https://docs.gravityforms.com/cleverreach-feed-meta/# "Algolia")
