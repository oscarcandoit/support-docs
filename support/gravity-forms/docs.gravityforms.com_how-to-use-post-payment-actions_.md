---
url: "https://docs.gravityforms.com/how-to-use-post-payment-actions/"
title: "How to Use Post Payment Actions - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-introduction)
- [Supported Payment add-ons](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-supported-payment-add-ons)
- [How To Setup a Post Payment Action](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-how-to-setup-a-post-payment-action)
- [Install and Configure Required Add-Ons](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-install-and-configure-required-add-ons)
- [Create Your Form](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-create-your-form)
- [Set Up the Dropbox Feed](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-set-up-the-dropbox-feed)
- [Set Up the Stripe Feed](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-set-up-the-stripe-feed)
- [Add-On Support](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-add-on-support)
- [Advanced Post Creation](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-advanced-post-creation)
- [Brevo](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-brevo)
- [Dropbox](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-dropbox)
- [User Registration Add-On](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-user-registration-add-on)
...
| --- | --- |
| Stripe | Yes. **_[See notes](https://docs.gravityforms.com/how-to-use-post-payment-actions/#h-notes)_** |
| PayPal Checkout | Yes |
| Mollie | Yes |
| Square | Yes |
...
- **[Stripe Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/)** (configured to use **Stripe Checkout**).
...
- A **[File Upload](https://docs.gravityforms.com/file-upload/)** field.
- A **[Product](https://docs.gravityforms.com/product/)** field (to collect payment).

### Set Up the Dropbox Feed

Create a Dropbox feed following the steps outlined in [this article.](https://docs.gravityforms.com/creating-a-feed-for-the-dropbox/)

### Set Up the Stripe Feed

- Create a Stripe feed following the steps outlined in [this article.](https://docs.gravityforms.com/setting-up-the-stripe-feeds/)
- Enable the checkbox: **“Upload file to Dropbox only when payment is received**“.

[![](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-43-1024x213.png)](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-43.png)
...
![](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-46-1024x224.png)
...
![](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-47-1024x224.png)
...
| Setting | Post Payment Action support |
| --- | --- |
| **Delay User Registration** | Stripe Checkout only. The entry is created _before_ payment, making the delay option relevant. |
| **Update user when subscription is cancelled** | Available only for Subscription feeds. |

![](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-45-1024x288.png)
...
[Algolia](https://docs.gravityforms.com/how-to-use-post-payment-actions/# "Algolia")
