---
url: "https://docs.gravityforms.com/category/knowledge-base/security/"
title: "Privacy, Security and Compliance Archives"
---
...
- [Knowledge Base](https://docs.gravityforms.com/category/knowledge-base/)  - [Accessibility](https://docs.gravityforms.com/category/knowledge-base/accessibility/)
  ...
  - [Privacy, Security and Compliance](https://docs.gravityforms.com/category/knowledge-base/security/)    - [State Validation](https://docs.gravityforms.com/state-validation/ "State Validation")
    - [Non-Applicability of Data Processing Agreements](https://docs.gravityforms.com/non-applicability-of-data-processing-agreements/ "Non-Applicability of Data Processing Agreements")
    - [Gravity Forms Security Whitepaper](https://docs.gravityforms.com/security-whitepaper/ "Gravity Forms Security Whitepaper")
    - [WordPress, Gravity Forms, and GDPR Compliance](https://docs.gravityforms.com/wordpress-gravity-forms-and-gdpr-compliance/ "WordPress, Gravity Forms, and GDPR Compliance")
    - [URL Validation In Gravity Forms](https://docs.gravityforms.com/url-validation-gravity-forms/ "URL Validation In Gravity Forms")
    - [Is Gravity Forms PCI Compliant?](https://docs.gravityforms.com/is-gravity-forms-pci-compliant/ "Is Gravity Forms PCI Compliant?")
    - [Information for Security Researchers](https://docs.gravityforms.com/information-for-security-researchers/ "Information for Security Researchers")
    - [The Importance of Updates](https://docs.gravityforms.com/the-importance-of-updates/ "The Importance of Updates")
    - [What To Do If You Suspect a Security Issue](https://docs.gravityforms.com/what-to-do-if-you-suspect-a-security-issue/ "What To Do If You Suspect a Security Issue")
    - [How To Report a Security Issue](https://docs.gravityforms.com/how-to-report-a-security-issue/ "How To Report a Security Issue")
    - [Security Best Practices](https://docs.gravityforms.com/security/ "Security Best Practices")
    - [HIPAA and Gravity Forms](https://docs.gravityforms.com/hipaa-and-gravity-forms/ "HIPAA and Gravity Forms")
...
[**State Validation** \\
State validation enhances form security by ensuring submitted field values have not been altered client-side. When a form is displayed, a state is generated based on the configuration and allowed values of supported fields.](https://docs.gravityforms.com/state-validation/ "State Validation") [**Non-Applicability of Data Processing Agreements** \\
This article describes why Gravity Forms does not provide data processing agreements to its customers.](https://docs.gravityforms.com/non-applicability-of-data-processing-agreements/ "Non-Applicability of Data Processing Agreements") [**Gravity Forms Security Whitepaper** \\
Learn more about Gravity Forms software security in this free white paper which is forked from the original security white paper for WordPress.](https://docs.gravityforms.com/security-whitepaper/ "Gravity Forms Security Whitepaper") [**WordPress, Gravity Forms, and GDPR Compliance** \\
You’ve probably heard about GDPR compliance but aren’t quite sure how it affects your forms or WordPress site in general. Your best option is always to consult legal counsel, but we’ll try to get things clarified for you in the meantime.](https://docs.gravityforms.com/wordpress-gravity-forms-and-gdpr-compliance/ "WordPress, Gravity Forms, and GDPR Compliance") [**URL Validation In Gravity Forms** \\
Within Gravity Forms, URL validation methods exist to heighten security as well as avoid possible bugs. In this article, we will explain how URL validation works in Gravity Forms, and how to manipulate it.](https://docs.gravityforms.com/url-validation-gravity-forms/ "URL Validation In Gravity Forms") [**Is Gravity Forms PCI Compliant?** \\
The short answer is yes, Gravity Forms is PCI compliant. However, this is subject to change depending on your environment and setup, as Gravity Forms is simply a single piece of the puzzle.](https://docs.gravityforms.com/is-gravity-forms-pci-compliant/ "Is Gravity Forms PCI Compliant?") [**Information for Security Researchers** \\
If you have discovered a vulnerability in one of our products we want to hear from you as soon as possible. Please gather as much information together as you can so we can work quickly to address it.](https://docs.gravityforms.com/information-for-security-researchers/ "Information for Security Researchers") [**The Importance of Updates** \\
Oftentimes when running a website, individuals will only make the changes they need and neglect the general maintenance of the site, including things such as updates.](https://docs.gravityforms.com/the-importance-of-updates/ "The Importance of Updates") [**What To Do If You Suspect a Security Issue** \\
We take security issues very seriously and want to make sure that any security concerns are appropriately addressed in a timely manner.](https://docs.gravityforms.com/what-to-do-if-you-suspect-a-security-issue/ "What To Do If You Suspect a Security Issue") [**How To Report a Security Issue** \\
We take security issues very seriously and want to ensure that you always feel safe when using Gravity Forms. Here are a few steps you should take if you believe you have a security issue with Gravity Forms.](https://docs.gravityforms.com/how-to-report-a-security-issue/ "How To Report a Security Issue") 1 [2](https://docs.gravityforms.com/category/knowledge-base/security/page/2/) [Next](https://docs.gravityforms.com/category/knowledge-base/security/page/2/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/security/# "Algolia")
