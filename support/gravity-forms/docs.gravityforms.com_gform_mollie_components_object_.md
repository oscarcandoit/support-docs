---
url: "https://docs.gravityforms.com/gform_mollie_components_object/"
title: "gform_mollie_components_object - Gravity Forms Documentation"
---
...
# gform\_mollie\_components\_object

- [Description](https://docs.gravityforms.com/gform_mollie_components_object/#h-description)
- [Usage](https://docs.gravityforms.com/gform_mollie_components_object/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_mollie_components_object/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_mollie_components_object/#h-examples)
- [Modify the card style](https://docs.gravityforms.com/gform_mollie_components_object/#h-modify-the-card-style)
- [Placement](https://docs.gravityforms.com/gform_mollie_components_object/#h-placement)
- [Since](https://docs.gravityforms.com/gform_mollie_components_object/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_mollie_components_object/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_mollie_components_object'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19 | `add_filter(``'gform_mollie_components_object'``,``'custom_mollie_components_object'``, 10, 2 );`<br>`function``custom_mollie_components_object(``$args``,``$form_id``) {`<br>```// Check the form ID if you want to target specific forms`<br>```if``(``$form_id``== 1 ) {``// Replace 1 with your specific form ID`<br>```// Customize card style, for example`<br>```$args``[``'cardStyle'``] =``array``(`<br>```'base'``=>``array``(`<br>```'fontSize'``=>``'16px'``,`<br>```'color'``=>``'#32325d'``,`<br>```),`<br>```'invalid'``=>``array``(`<br>```'color'``=>``'#fa755a'``,`<br>```),`<br>```);`<br>``<br>```}`<br>```return``$args``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `$args``= apply_filters(``'gform_mollie_components_object'``,``$args``,``$form``[``'id'``] );` |

This hook is located in GF\_Mollie::register\_init\_scripts() in _class-gf-mollie.php_.
...
[Algolia](https://docs.gravityforms.com/gform_mollie_components_object/# "Algolia")
