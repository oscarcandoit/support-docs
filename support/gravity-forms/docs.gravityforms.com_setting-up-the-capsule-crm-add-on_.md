---
url: "https://docs.gravityforms.com/setting-up-the-capsule-crm-add-on/"
title: "Setting Up the Capsule CRM Add-On - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Capsule CRM Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/capsule-crm-add-on/)    - [Obtaining Your Capsule CRM API Key](https://docs.gravityforms.com/getting-you-capsule-crm-api-key/ "Obtaining Your Capsule CRM API Key")
    - [Setting Up the Capsule CRM Add-On](https://docs.gravityforms.com/setting-up-the-capsule-crm-add-on/ "Setting Up the Capsule CRM Add-On")
    - [Creating a Feed for the Capsule CRM Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-capsule-crm-add-on/ "Creating a Feed for the Capsule CRM Add-On")
    - [Capsule CRM Changelog](https://docs.gravityforms.com/capsule-crm-change-log/ "Capsule CRM Changelog")
...
- [Pre-Requisites](https://docs.gravityforms.com/setting-up-the-capsule-crm-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-up-the-capsule-crm-add-on/#h-setup)
...
- A [Capsule CRM](https://capsulecrm.com/) account

## Setup

1. Log into your WordPress admin dashboard.
2. On the left side navigation menu, hover over **Forms** and click on **Settings**.
3. From this page, click the **Capsule CRM** tab.
4. Enter your **Personal Access Token**. This is obtained from Capsule CRM. If you are unsure of how to obtain your API key, take a look at our article on [obtaining your Capsule CRM API key](https://docs.gravityforms.com/getting-you-capsule-crm-api-key/).
...
Once you have entered your API key, you’re ready to begin [creating a feed for the Capsule CRM Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-capsule-crm-add-on/).
...
[Algolia](https://docs.gravityforms.com/setting-up-the-capsule-crm-add-on/# "Algolia")
