---
url: "https://docs.gravityforms.com/gform_shortcode_builder_forms/"
title: "gform_shortcode_builder_forms - Gravity Forms Documentation"
---
...
# gform\_shortcode\_builder\_forms

- [Description](https://docs.gravityforms.com/gform_shortcode_builder_forms/#h-description)
- [Usage](https://docs.gravityforms.com/gform_shortcode_builder_forms/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_shortcode_builder_forms/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_shortcode_builder_forms/#h-examples)
- [1\. Remove](https://docs.gravityforms.com/gform_shortcode_builder_forms/#h-1-remove)
- [Placement](https://docs.gravityforms.com/gform_shortcode_builder_forms/#h-placement)
- [Since](https://docs.gravityforms.com/gform_shortcode_builder_forms/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_shortcode_builder_forms/#h-source-code)

## Description

The gform\_shortcode\_builder\_forms filter allows the list of available forms displayed in the shortcode builder to be overridden.
...
|     |     |
| --- | --- |
| 1 | `add_filter( 'gform_shortcode_builder_forms', 'your_function_name' );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_shortcode_builder_forms'``,``function``(``$forms``) {`<br>```unset(``$forms``[1] );`<br>```return``$forms``;`<br>`});` |
...
This filter is located in _GFForms::get\_shortcodes()_ in _gravityforms.php_.
...
[Algolia](https://docs.gravityforms.com/gform_shortcode_builder_forms/# "Algolia")
