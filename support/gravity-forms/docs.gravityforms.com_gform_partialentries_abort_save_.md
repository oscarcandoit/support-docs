---
url: "https://docs.gravityforms.com/gform_partialentries_abort_save/"
title: "gform_partialentries_abort_save - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Partial Entries Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/partial-entries-filters/)          - [gform\_partialentries\_abort\_save](https://docs.gravityforms.com/gform_partialentries_abort_save/ "gform_partialentries_abort_save")
          - [gform\_partialentries\_post\_EVENT](https://docs.gravityforms.com/gform_partialentries_post_event/ "gform_partialentries_post_EVENT")
          - [gform\_partialentries\_pre\_update](https://docs.gravityforms.com/gform_partialentries_pre_update/ "gform_partialentries_pre_update")
          - [gform\_partialentries\_warning\_message](https://docs.gravityforms.com/gform_partialentries_warning_message/ "gform_partialentries_warning_message")
...
# gform\_partialentries\_abort\_save

- [Description](https://docs.gravityforms.com/gform_partialentries_abort_save/#h-description)
- [Usage](https://docs.gravityforms.com/gform_partialentries_abort_save/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_partialentries_abort_save/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_partialentries_abort_save/#h-examples)
- [Abort saving a partial entry based on Gravity Wiz GP Limit Submissions rules](https://docs.gravityforms.com/gform_partialentries_abort_save/#h-abort-saving-a-partial-entry-based-on-gravity-wiz-gp-limit-submissions-rules)
- [Placement](https://docs.gravityforms.com/gform_partialentries_abort_save/#h-placement)
- [Since](https://docs.gravityforms.com/gform_partialentries_abort_save/#h-since)
- [Source](https://docs.gravityforms.com/gform_partialentries_abort_save/#h-source)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_partialentries_abort_save'``,``'your_function_name'``, 10, 4 );` |

Applies to a specific form. Replace {FORMID} with your Form ID:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_partialentries_abort_save_{FORMID}'``,``'your_function_name'``, 10, 4 );` |

## Parameters

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| $abort | [bool](https://docs.gravityforms.com/bool/) | Indicates if saving or updating of the partial entry should be aborted. Default is false. |
| $partial\_entry | [array](https://docs.gravityforms.com/array/) | The partial entry to be saved or updated. |
| $partial\_entry\_id | [string](https://docs.gravityforms.com/string/) | The value of the partial\_entry\_id input. pending on first save, or the UUID of the partial entry being updated. |
| $form | [array](https://docs.gravityforms.com/array/) | The form currently being processed. |

## Examples

### Abort saving a partial entry based on Gravity Wiz GP [Limit Submissions](https://gravitywiz.com/documentation/gravity-forms-limit-submissions/) rules

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19 | `add_filter(``'gform_partialentries_abort_save'``,``function``(``$abort``) {`<br>```if``(``$abort``|| ! function_exists(``'gp_limit_submissions'``) ) {`<br>```return``$abort``;`<br>```}`<br>```$perk``= gp_limit_submissions();`<br>```if``(``empty``(``$perk``->enforce ) ||``empty``(``$perk``->enforce->get_rule_groups() ) ) {`<br>```return``false;`<br>```}`<br>```$result``=``$perk``->enforce->get_test_result();`<br>```if``(``empty``(``$result``) ) {`<br>```return``false;`<br>```}`<br>```gf_partial_entries()->log_debug(``'gform_partialentries_abort_save: gp limit submissions result => '``. print_r(``$result``, true ) );`<br>```return``(bool) rgobj(``$result``,``'fail'``);`<br>`} );` |
...
This filter is located in GF\_Partial\_Entries::maybe\_save\_partial\_entry() in class-gf-partial-entries.php
...
[Algolia](https://docs.gravityforms.com/gform_partialentries_abort_save/# "Algolia")
