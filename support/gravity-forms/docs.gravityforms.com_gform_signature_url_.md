---
url: "https://docs.gravityforms.com/gform_signature_url/"
title: "gform_signature_url - Gravity Forms Documentation"
---
...
# gform\_signature\_url

- [Description](https://docs.gravityforms.com/gform_signature_url/#h-description)
- [Usage](https://docs.gravityforms.com/gform_signature_url/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_signature_url/#h-examples)
- [1\. Enable transparency](https://docs.gravityforms.com/gform_signature_url/#h-1-enable-transparency)
- [Placement](https://docs.gravityforms.com/gform_signature_url/#h-placement)
- [Since](https://docs.gravityforms.com/gform_signature_url/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_signature_url/#h-source-code)

## Description

The gform\_signature\_url filter allows the signature URL to be customized.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_signature_url'``,``'your_function_name'``, 10, 4 );` |

You can also target all signature fields in a form by adding the form id after the hook name.

|     |     |
| --- | --- |
| 1<br>2 | `// The following declaration targets all fields in form 6`<br>`add_filter(``'gform_signature_url_6'``,``'your_function_name'``, 10, 4 );` |

You can also target a specific field by adding the form id and field id after the hook name.

|     |     |
| --- | --- |
| 1<br>2 | `// The following declaration targets field 1 in form 6`<br>`add_filter(``'gform_signature_url_6_1'``,``'your_function_name'``, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_signature_url'``,``'enable_signature_transparency'``, 10, 4 );`<br>`function``enable_signature_transparency(``$url``,``$file_name``,``$form_id``,``$field_id``){`<br>`return``add_query_arg(``'t'``, 1,``$url``);`<br>`}` |
...
This filter is located in GF\_Signature\_Image::get\_url() in _includes/class-gf-signature-image.php_.
...
[Algolia](https://docs.gravityforms.com/gform_signature_url/# "Algolia")
