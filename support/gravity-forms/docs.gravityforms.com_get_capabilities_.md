---
url: "https://docs.gravityforms.com/get_capabilities/"
title: "get_capabilities() - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/get_capabilities/#h-description)
- [Usage](https://docs.gravityforms.com/get_capabilities/#h-usage)
- [Parameters](https://docs.gravityforms.com/get_capabilities/#h-parameters)
- [Examples](https://docs.gravityforms.com/get_capabilities/#h-examples)
- [Source Code](https://docs.gravityforms.com/get_capabilities/#h-source-code)

## Description

The get\_capabilities() function in the Add-On Framework retrieves all capabilities or a specific capability for the add-on.

## Usage

|     |     |
| --- | --- |
| 1 | `$capabilities``= get_capabilities(``$capability``);` |
...
This example retrieves the capability for “gravityforms\_mailchimp”

|     |     |
| --- | --- |
| 1 | `$capabilities``= get_capabilities(``'gravityforms_mailchimp'``);` |

## Source Code

This function is located in the GFAddOn class in gravityforms/includes/addon/ _class-gf-addon.php_
...
[Algolia](https://docs.gravityforms.com/get_capabilities/# "Algolia")
