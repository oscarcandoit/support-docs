---
url: "https://docs.gravityforms.com/populate-a-default-value/"
title: "How To Populate A Field With A Default Value - Gravity Forms Documentation"
---
...
- [What is a Default Value?](https://docs.gravityforms.com/populate-a-default-value/#h-what-is-a-default-value)
- [Where can I find the Default Value option?](https://docs.gravityforms.com/populate-a-default-value/#h-where-can-i-find-the-default-value-option)
- [Options for Populating a Default Value](https://docs.gravityforms.com/populate-a-default-value/#h-options-for-populating-a-default-value)
- [Set with a static value.](https://docs.gravityforms.com/populate-a-default-value/#h-set-with-a-static-value)
- [Use a merge tag](https://docs.gravityforms.com/populate-a-default-value/#h-use-a-merge-tag)
- [Display within the Form Editor](https://docs.gravityforms.com/populate-a-default-value/#h-display-within-the-form-editor)
- [Note about third-party plugins](https://docs.gravityforms.com/populate-a-default-value/#h-note-about-third-party-plugins)
...
**Note:** This guide explains how to set a default value for those fields that support it. If you need to dynamically populate a field by passing data to the form from an external source (for example, passing a parameter in the form’s URL), refer to [this guide](https://docs.gravityforms.com/using-dynamic-population/).

## Where can I find the Default Value option?

For those fields that support it, default values are offered within the Form Editor inside the Settings panel for the field type. You can find them under the [_Advanced_ Settings section](https://docs.gravityforms.com/common-field-settings/#h-advanced-settings-section).
...
**Note:** For [choice based fields](https://docs.gravityforms.com/multiple-choice-field/) that support default values, the default value will only be auto selected if it matches a choice value that has been defined in the field. A choice field that allows multiple selections can only have a single default value specified.

[![Image showing the field Default Value](https://docs.gravityforms.com/wp-content/uploads/2024/10/image.png)](https://docs.gravityforms.com/wp-content/uploads/2024/10/image.png)

### Use a merge tag

[Merge tags](https://docs.gravityforms.com/category/user-guides/merge-tags-getting-started/) are a helpful option in Gravity Forms that lets you use a piece of available metadata (such as the current date or time) to help define something. In this way, they are more dynamic and can be more personalized than just a static value. Refer to the [Merge tags](https://docs.gravityforms.com/category/user-guides/merge-tags-getting-started/) category of our user guides for more information on all the different merge tags available in Gravity Forms.

**Note:** Using [field merge tags](https://docs.gravityforms.com/field-merge-tags/) as a default value is not supported by Gravity Forms. If you want to use the value of another field in your submitted form as a default value, try a third-party plugin such as [Populate Anything by Gravity Wiz](https://gravitywiz.com/documentation/gravity-forms-populate-anything/). Be aware of our disclaimer related to third-party plugins, as listed at the [bottom](https://docs.gravityforms.com/populate-a-default-value/#h-note-about-third-party-plugins) of the page.
...
[![Image showing the field Default Value](https://docs.gravityforms.com/wp-content/uploads/2024/10/image-1.png)](https://docs.gravityforms.com/wp-content/uploads/2024/10/image-1.png)

[![Image showing the field Default Value](https://docs.gravityforms.com/wp-content/uploads/2024/10/image-2-713x1024.png)](https://docs.gravityforms.com/wp-content/uploads/2024/10/image-2.png)

For example, you can use the **{today}** merge tag to output date related data, the **{user}** merge tag to populate data from the currently logged-in user, **{embed\_post}** or **{custom\_field}** for post related information. Refer to these articles for more information about each merge tag:

- [{embed\_post}](https://docs.gravityforms.com/embed_post-merge-tag/)
- [{custom\_field}](https://docs.gravityforms.com/custom-field-merge-tags/)
- [{user}](https://docs.gravityforms.com/user-merge-tag/)
- [{today}](https://docs.gravityforms.com/today-merge-tags/)
...
[![Image showing the form editor with default values](https://docs.gravityforms.com/wp-content/uploads/2024/10/image-3.png)](https://docs.gravityforms.com/wp-content/uploads/2024/10/image-3.png)
...
[Algolia](https://docs.gravityforms.com/populate-a-default-value/# "Algolia")
