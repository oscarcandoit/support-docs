---
url: "https://docs.gravityforms.com/option-field/"
title: "Option Field CSS Selectors - Gravity Forms Documentation"
---
...
- [Container](https://docs.gravityforms.com/option-field/#h-container)
- [Drop Down](https://docs.gravityforms.com/option-field/#h-drop-down)
- [Items](https://docs.gravityforms.com/option-field/#h-items)
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield_price .ginput_container_select {``border``:``1px``solid``red``;}` |

example: option field container (div) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields .gfield_price ginput_container_select {``border``:``1px``solid``red``;}` |

example: option field container (div) – applies just to specific container (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields #field_XX_X.gfield_price ginput_container_select {``border``:``1px``solid``red``;}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield_price .ginput_container_select select {``border``:``1px``solid``red``;}` |

example: option field drop down (select) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields .gfield_price .ginput_container_select select {``border``:``1px``solid``red``;}` |

example: option field drop down (select) – applies just to specific container (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields #field_XX_X.gfield_price .ginput_container_select select {``border``:``1px``solid``red``;}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield_price .ginput_container_select select option {``border``:``1px``solid``red``;}` |

example: option field items (option) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields .gfield_price .ginput_container_select select option {``border``:``1px``solid``red``;}` |

example: option field items (option) – applies just to specific container (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper_``1``.gform_body .gform_fields #field_XX_X.gfield_price .ginput_container_select select option {``border``:``1px``solid``red``;}` |
...
[Algolia](https://docs.gravityforms.com/option-field/# "Algolia")
