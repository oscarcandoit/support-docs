---
url: "https://docs.gravityforms.com/gform_signature_url_require_login/"
title: "gform_signature_url_require_login - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Signature Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/signature-filters/)          - [gform\_signature\_delete\_file\_pre\_delete\_entry](https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/ "gform_signature_delete_file_pre_delete_entry")
          - [gform\_signature\_init\_options](https://docs.gravityforms.com/gform_signature_init_options/ "gform_signature_init_options")
          - [gform\_signature\_url](https://docs.gravityforms.com/gform_signature_url/ "gform_signature_url")
          - [gform\_signature\_url\_permission\_granted](https://docs.gravityforms.com/gform_signature_url_permission_granted/ "gform_signature_url_permission_granted")
          - [gform\_signature\_url\_require\_login](https://docs.gravityforms.com/gform_signature_url_require_login/ "gform_signature_url_require_login")
          - [GFSignature](https://docs.gravityforms.com/gfsignature/ "GFSignature")
...
- [Description](https://docs.gravityforms.com/gform_signature_url_require_login/#h-description)
- [Usage](https://docs.gravityforms.com/gform_signature_url_require_login/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_signature_url_require_login/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_signature_url_require_login/#h-examples)
- [1\. Require login for all forms](https://docs.gravityforms.com/gform_signature_url_require_login/#h-1-require-login-for-all-forms)
- [2\. Require login for specific form and field](https://docs.gravityforms.com/gform_signature_url_require_login/#h-2-require-login-for-specific-form-and-field)
- [Placement](https://docs.gravityforms.com/gform_signature_url_require_login/#h-placement)
- [Since](https://docs.gravityforms.com/gform_signature_url_require_login/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_signature_url_require_login/#h-source-code)

## Description

The gform\_signature\_url\_require\_login filter can be used to require the user be logged in before the signature URL will allow access to the file.
...
- **$require\_login** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `add_filter(``'gform_signature_url_require_login'``,``'require_login_for_signatures'``, 10, 3 );`<br>`function``require_login_for_signatures(``$require_login``,``$form_id``,``$field_id``){`<br>``<br>```// Update values below to match your form and field id's`<br>```if``(``$form_id``==``'97'``&&``$field_id``==``'2'``) {`<br>``<br>```$require_login``= true;`<br>``<br>```}`<br>``<br>```return``$require_login``;`<br>`}` |
...
This filter is located in GF\_Signature\_Image::maybe\_require\_login() in _includes/class-gf-signature-image.php_.
...
[Algolia](https://docs.gravityforms.com/gform_signature_url_require_login/# "Algolia")
