---
url: "https://docs.gravityforms.com/gform_address_country/"
title: "gform_address_country - Gravity Forms Documentation"
---
...
# gform\_address\_country

- [Description](https://docs.gravityforms.com/gform_address_country/#h-description)
- [Usage](https://docs.gravityforms.com/gform_address_country/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_address_country/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_address_country/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_address_country/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_address_country/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_address_country'``,``'change_address_country'``, 10, 2 );` |

Applies to a specific form. In this case, form id 5.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_address_country_5'``,``'change_address_country'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_address_country'``,``'change_address_country'``, 10, 2 );`<br>`function``change_address_country(``$label``,``$form_id``) {`<br>```return``"Address Country"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_address_country/# "Algolia")
