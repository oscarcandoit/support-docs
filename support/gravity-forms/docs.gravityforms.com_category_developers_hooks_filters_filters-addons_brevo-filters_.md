---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/brevo-filters/"
title: "Brevo Filters Archives - Gravity Forms Documentation"
---
...
The gform\_brevo\_request\_args filter filters the Brevo request arguments. It allows you to modify the request arguments sent to the Brevo API before the request is made.](https://docs.gravityforms.com/gform_brevo_request_args/ "gform_brevo_request_args") [**gform\_brevo\_allow\_resubscription** \\
The gform\_brevo\_allow\_resubscription filter allows you to modify whether a user with the unsubscribed status on your list has been resubscribed. By default, the user is resubscribed.](https://docs.gravityforms.com/gform_brevo_allow_resubscription/ "gform_brevo_allow_resubscription") [**Brevo Feed Meta** \\
The Feed Meta object for the Brevo Add-On is an associative array containing the properties which determine how the add-on should process the form submission.](https://docs.gravityforms.com/brevo-feed-meta/ "Brevo Feed Meta")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/brevo-filters/# "Algolia")
