---
url: "https://docs.gravityforms.com/gform_postmark_send_email_failed/"
title: "gform_postmark_send_email_failed - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Postmark Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/postmark-filters/)          - [gform\_postmark\_send\_email\_failed](https://docs.gravityforms.com/gform_postmark_send_email_failed/ "gform_postmark_send_email_failed")
...
# gform\_postmark\_send\_email\_failed

- [Description](https://docs.gravityforms.com/gform_postmark_send_email_failed/#h-description)
- [Usage](https://docs.gravityforms.com/gform_postmark_send_email_failed/#h-usage)
- [Since](https://docs.gravityforms.com/gform_postmark_send_email_failed/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_postmark_send_email_failed/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_postmark_send_email_failed'``,``'my_function'``, 10, 6 );` |
...
- **$postmark\_email** [array](https://docs.gravityforms.com/array)
...
This action hook is located in GF\_Postmark::maybe\_send\_email() in _gravityformspostmark/class-gf-postmark.php_.
...
[Algolia](https://docs.gravityforms.com/gform_postmark_send_email_failed/# "Algolia")
