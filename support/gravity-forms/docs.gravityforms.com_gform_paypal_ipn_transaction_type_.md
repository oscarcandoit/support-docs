---
url: "https://docs.gravityforms.com/gform_paypal_ipn_transaction_type/"
title: "gform_paypal_ipn_{transaction_type} - Gravity Forms Documentation"
---
...
# gform\_paypal\_ipn\_{transaction\_type}

- [Description](https://docs.gravityforms.com/gform_paypal_ipn_transaction_type/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_ipn_transaction_type/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_paypal_ipn_transaction_type/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_paypal_ipn_transaction_type/#h-placement)
- [Since](https://docs.gravityforms.com/gform_paypal_ipn_transaction_type/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_paypal_ipn_transaction_type/#h-source-code)

## Description

This action hook allows actions to be performed for a specific IPN transaction type. The “{transaction\_type}” will be replaced with the current transaction type.
...
- **$entry** [Entry Object](https://docs.gravityforms.com/entry-object) The current entry.
...
- **$txn\_type** [string](https://docs.gravityforms.com/string)
The transaction type. For example: cart, subscr\_payment, subscr\_cancel.

- **$transaction\_id** [int](https://docs.gravityforms.com/int)
The transaction id.

- **$parent\_txn\_id** [int](https://docs.gravityforms.com/int)
The parent transaction id, in case of some transactions, such as a refund.

- **$subscriber\_id** [int](https://docs.gravityforms.com/int)
The subscriber id.

- **$amount** [string](https://docs.gravityforms.com/string)
The payment amount.
...
This filter is located in GFPayPal::post\_callback() in _gravityformspaypal/class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_ipn_transaction_type/# "Algolia")
