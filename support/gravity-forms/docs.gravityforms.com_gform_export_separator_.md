---
url: "https://docs.gravityforms.com/gform_export_separator/"
title: "gform_export_separator - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_export_separator/#h-description)
- [Usage](https://docs.gravityforms.com/gform_export_separator/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_export_separator/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_export_separator/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_export_separator/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_export_separator/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_export_separator'``,``'change_separator'``, 10, 2 );` |

You can also target a specific form by adding the form id after the filter name.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_export_separator_6'``,``'change_separator'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_export_separator'``,``'change_separator'``, 10, 2 );`<br>`function``change_separator(``$separator``,``$form_id``) {`<br>`return``'|'``;`<br>`}` |
...
This action hook is located in GFExport::start\_export() in _export.php_.
...
[Algolia](https://docs.gravityforms.com/gform_export_separator/# "Algolia")
