---
url: "https://docs.gravityforms.com/agile-crm-feed-meta/"
title: "Agile CRM Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Agile CRM Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/agile-crm-filters/)          - [Agile CRM Feed Meta](https://docs.gravityforms.com/agile-crm-feed-meta/ "Agile CRM Feed Meta")
          - [gform\_agilecrm\_field\_value](https://docs.gravityforms.com/gform_agilecrm_field_value/ "gform_agilecrm_field_value")
          - [gform\_agilecrm\_tags](https://docs.gravityforms.com/gform_agilecrm_tags/ "gform_agilecrm_tags")
...
- [Introduction](https://docs.gravityforms.com/agile-crm-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/agile-crm-feed-meta/#h-usage)
- [Custom Properties](https://docs.gravityforms.com/agile-crm-feed-meta/#h-custom-properties)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the Agile CRM Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `$feed``[``'meta'``] =``array``(`<br>```'feedName'``=>``'Agile CRM Feed 1'``,`<br>```'createContact'``=> true,`<br>```'contactCustomFields'``=>``array``(),`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **createContact** [boolean](https://docs.gravityforms.com/boolean)

Create new contact. Default is false.

- **createTask** [boolean](https://docs.gravityforms.com/boolean)

Create new task. Default is false.

- **contactStandardFields\_first\_name** [string](https://docs.gravityforms.com/string)

The ID of the form field containing the contact’s first name.

- **contactStandardFields\_last\_name** [string](https://docs.gravityforms.com/string)

The ID of the form field containing the contact’s last name.

- **contactStandardFields\_email\_address** [string](https://docs.gravityforms.com/string)

The ID of the form field containing the contact’s email.

- **contactCustomFields** [array](https://docs.gravityforms.com/array)

A multidimensional array containing the Agile CRM custom fields. See [Custom Field Properties](https://docs.gravityforms.com/agile-crm-feed-meta/#custom-field-properties).

- **contactTags** [string](https://docs.gravityforms.com/string)

A comma separated list of tags to be assigned to the contact. Merge tags supported.

- **updateContactEnable** [boolean](https://docs.gravityforms.com/boolean)

Should an existing contact be updated if found? Default is false.

- **updateContactAction** [string](https://docs.gravityforms.com/string)

The update action. Should the contact details be replaced or appended. _Possible values: replace or append_.

- **taskSubject** [string](https://docs.gravityforms.com/string)

The task subject line. Merge tags supported.

- **taskDaysUntilDue** [integer](https://docs.gravityforms.com/integer)

The number of days until the task is due.

- **taskPriority** [string](https://docs.gravityforms.com/string)

The task priority. _Possible values: HIGH, NORMAL or LOW_.

- **taskStatus** [string](https://docs.gravityforms.com/string)

The task status. _Possible values: YET\_TO\_START, IN\_PROGRESS or COMPLETED_.

- **taskType** [string](https://docs.gravityforms.com/string)

The task type. _Possible values: CALL, EMAIL, FOLLOW\_UP, MEETING, MILESTONE, SEND, TWEET or OTHER_.

- **taskCreateNote** [boolean](https://docs.gravityforms.com/boolean)

Should a note be created for the task? Default is false.

- **taskNoteSubject** [string](https://docs.gravityforms.com/string)

The task note subject. Merge tags supported.

- **taskNoteDescription** [string](https://docs.gravityforms.com/string)

The task note description. Merge tags supported.

- **taskAssignToContact** [boolean](https://docs.gravityforms.com/boolean)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `array``(`<br>```'key'``=>``'title'``,`<br>```'value'``=>``'3'``,`<br>`);` |
...
The Agile CRM custom field key. _Possible values: title, company, email\_work, email\_personal, phone\_work, phone\_home, phone\_mobile, phone\_home\_fax, phone\_work\_fax, phone\_other, address\_home, address\_postal, address\_office, website\_url, website\_skype, website\_twitter, website\_linkedin, website\_facebook, website\_xing, website\_feed, website\_google\_plus, website\_flickr, website\_github, website\_youtube or gf\_custom_.

- **value** [string](https://docs.gravityforms.com/string) The ID of the form field or entry meta item containing the value for this custom field.

- **custom\_key** [string](https://docs.gravityforms.com/string) The custom key. Only used when the custom field **key** is set to _gf\_custom_.
...
[Algolia](https://docs.gravityforms.com/agile-crm-feed-meta/# "Algolia")
