---
url: "https://docs.gravityforms.com/gform_date_min_year/"
title: "gform_date_min_year - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Field Filters](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/)        - [Image Choice Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/image-choice-fields/)
        ...
        - [Date Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/date-fields/)          - [gform\_date\_max\_year](https://docs.gravityforms.com/gform_date_max_year/ "gform_date_max_year")
          - [gform\_date\_min\_year](https://docs.gravityforms.com/gform_date_min_year/ "gform_date_min_year")
...
# gform\_date\_min\_year

- [Description](https://docs.gravityforms.com/gform_date_min_year/#h-description)
- [Usage](https://docs.gravityforms.com/gform_date_min_year/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_date_min_year/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_date_min_year/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_date_min_year/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_date_min_year/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_date_min_year'``,``'set_min_year'``);` |

## Parameters

- **$min\_year** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_date_min_year'``,``'set_min_year'``);`<br>`function``set_min_year(``$min_year``) {`<br>```return``1900;`<br>`}` |

This example changes the min date for a specific field on a specific form.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_date_min_year'``,``function``(``$min_year``,``$form``,``$field``) {`<br>```return``$form``[``'id'``] == 7 &&``$field``->id == 5 ? 2014 :``$min_year``;`<br>`}, 10, 3 );` |
...
This filter is located in the following methods in _includes/fields/class-gf-field-date.php_:

- GF\_Field\_Date::get\_field\_input()
- GF\_Field\_Date::get\_year\_dropdown()
...
[Algolia](https://docs.gravityforms.com/gform_date_min_year/# "Algolia")
