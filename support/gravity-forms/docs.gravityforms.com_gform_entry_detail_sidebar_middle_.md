---
url: "https://docs.gravityforms.com/gform_entry_detail_sidebar_middle/"
title: "gform_entry_detail_sidebar_middle - Gravity Forms Documentation"
---
...
# gform\_entry\_detail\_sidebar\_middle

- [Description](https://docs.gravityforms.com/gform_entry_detail_sidebar_middle/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_detail_sidebar_middle/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entry_detail_sidebar_middle/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_entry_detail_sidebar_middle/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_entry_detail_sidebar_middle/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_entry_detail_sidebar_middle/#h-source-code)
...
**Note:** To add custom meta boxes to the sidebar, we recommend using the [gform\_entry\_detail\_meta\_boxes](https://docs.gravityforms.com/gform_entry_detail_meta_boxes) filter.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_entry_detail_sidebar_middle'``,``'add_sidebar_text_middle'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_entry_detail_sidebar_middle'``,``'add_sidebar_text_middle'``, 10, 2 );`<br>`function``add_sidebar_text_middle(``$form``,``$entry``) {`<br>```echo``"<div class='stuffbox'><h3><span class='hndle'>Stuff in the Middle</span></h3><div class='inside'>text added in the middle!<br/></div></div>"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_detail_sidebar_middle/# "Algolia")
