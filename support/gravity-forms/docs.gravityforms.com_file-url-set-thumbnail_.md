---
url: "https://docs.gravityforms.com/file-url-set-thumbnail/"
title: "AdvancedPostCreation File URL & Post Thumbnail"
---
...
# gform\_advancedpostcreation\_file\_url\_pre\_set\_post\_thumbnail

- [Description](https://docs.gravityforms.com/file-url-set-thumbnail/#description)
- [Usage](https://docs.gravityforms.com/file-url-set-thumbnail/#usage)
- [Parameters](https://docs.gravityforms.com/file-url-set-thumbnail/#parameters)
- [Examples](https://docs.gravityforms.com/file-url-set-thumbnail/#examples)
- [Use a file from multi-file field](https://docs.gravityforms.com/file-url-set-thumbnail/#h-use-a-file-from-multi-file-field)
- [Placement](https://docs.gravityforms.com/file-url-set-thumbnail/#h-placement)
- [Since](https://docs.gravityforms.com/file-url-set-thumbnail/#since)
- [Source Code](https://docs.gravityforms.com/file-url-set-thumbnail/#source-code)
...
To limit the scope of your function to a specific form, append the form id to the end of the hook name. (format: gform\_advancedpostcreation\_file\_url\_pre\_set\_post\_thumbnail\_FORMID)

|     |
| --- |
| `add_filter(``'gform_advancedpostcreation_file_url_pre_set_post_thumbnail_3'``,``'your_function_name'``, 10, 6 );` |

To limit the scope of your function to a specific form and field, append both the form and field id’s to the end of the hook name. (format: gform\_advancedpostcreation\_file\_url\_pre\_set\_post\_thumbnail\_FORMID\_FIELDID)
...
- **$file\_url** [string](https://docs.gravityforms.com/boolean/)

The URL of the file to be added to the media library and set as the post thumbnail.
- **$field\_id** [int](https://docs.gravityforms.com/integer/) \| [string](https://docs.gravityforms.com/string/)
...
- **$post\_id** [int](https://docs.gravityforms.com/integer/)
...
|     |
| --- |
| `add_filter(``'gform_advancedpostcreation_file_url_pre_set_post_thumbnail'``,``function``(``$file_url``,``$field_id``,``$feed``,``$entry``,``$form``,``$post_id``) {`<br>```$file_urls``= json_decode( rgar(``$entry``, 3 ), true );`<br>```if``( !``empty``(``$file_urls``) ) {`<br>```$file_url``=``$file_urls``[0];`<br>```}`<br>```return``$file_url``;`<br>`}, 10, 6 );` |
...
This filter is located in `GF_Advanced_Post_Creation::maybe_set_post_thumbnail()` in _class-gf-advancedpostcreation.php_.
...
[Algolia](https://docs.gravityforms.com/file-url-set-thumbnail/# "Algolia")
