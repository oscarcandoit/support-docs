---
url: "https://docs.gravityforms.com/gform_user_registration_validation_message/"
title: "gform_user_registration_validation_message - Gravity Forms"
---
...
# gform\_user\_registration\_validation\_message

- [Description](https://docs.gravityforms.com/gform_user_registration_validation_message/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_validation_message/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_validation_message/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_user_registration_validation_message/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_user_registration_validation_message/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_validation_message/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_user_registration_validation_message'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_user_registration_validation_message'``,``'update_validation_msgs'``, 10, 2 );`<br>`function``update_validation_msgs(``$message``,``$form``) {`<br>```if``(``$message``==``'This username is already registered'``) {`<br>```$message``=``"We're sorry, this username is already registered. Try submitting with a different username."``;`<br>```}`<br>```return``$message``;`<br>`}` |
...
This filter is located in GF\_User\_Registration::add\_validation\_error() in _class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_validation_message/# "Algolia")
