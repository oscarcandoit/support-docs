---
url: "https://docs.gravityforms.com/gform_form_export_filename/"
title: "gform_form_export_filename - Gravity Forms Documentation"
---
...
# gform\_form\_export\_filename

- [Description](https://docs.gravityforms.com/gform_form_export_filename/#h-description)
- [Usage](https://docs.gravityforms.com/gform_form_export_filename/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_form_export_filename/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_form_export_filename/#h-example)
- [Placement](https://docs.gravityforms.com/gform_form_export_filename/#h-placement)
- [Since](https://docs.gravityforms.com/gform_form_export_filename/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_form_export_filename/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_form_export_filename'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$filename** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_form_export_filename'``,``function``(``$filename``) {`<br>```return``'new-filename-without-extension'``;`<br>`} );` |
...
This filter is located in GFExport::export\_forms() in _export.php_.
...
[Algolia](https://docs.gravityforms.com/gform_form_export_filename/# "Algolia")
