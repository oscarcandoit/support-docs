---
url: "https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/"
title: "gform_helpscout_process_body_shortcodes - Gravity Forms"
---
...
# gform\_helpscout\_process\_body\_shortcodes

- [Description](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/#h-description)
- [Usage](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/#h-examples)
- [1\. Enable for all forms](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/#h-1-enable-for-all-forms)
- [2\. Enable for a specific feed name](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/#h-2-enable-for-a-specific-feed-name)
- [Placement](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/#h-since)
...
- **$process\_shortcodes** [boolean](https://docs.gravityforms.com/boolean)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_helpscout_process_body_shortcodes'``,``function``(``$process_shortcodes``,``$form``,``$feed``) {`<br>`return``rgars(``$feed``,``'meta/feed_name'``) ==``'Help Scout Feed 1'``? true :``$process_shortcodes``;`<br>`}, 10, 3 );` |
...
[Algolia](https://docs.gravityforms.com/gform_helpscout_process_body_shortcodes/# "Algolia")
