---
url: "https://docs.gravityforms.com/post-body-2/"
title: "Post Body CSS Selectors - Gravity Forms Documentation"
---
...
- [Container](https://docs.gravityforms.com/post-body-2/#h-container)
- [Input](https://docs.gravityforms.com/post-body-2/#h-input)
...
example: post body input (input) – applies just to specific container (based on the unique parent element ID – replace “XX\_X” with your actual element ID)
...
[Algolia](https://docs.gravityforms.com/post-body-2/# "Algolia")
