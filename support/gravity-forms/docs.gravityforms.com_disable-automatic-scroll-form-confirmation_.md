---
url: "https://docs.gravityforms.com/disable-automatic-scroll-form-confirmation/"
title: "Disabling Automatic Scrolling On Form Confirmations - Gravity Forms"
---
...
- [Summary](https://docs.gravityforms.com/disable-automatic-scroll-form-confirmation/#h-summary)
- [Use the gform\_confirmation\_anchor Filter](https://docs.gravityforms.com/disable-automatic-scroll-form-confirmation/#h-use-the-gform-confirmation-anchor-filter)
- [Disabling Automatic Scrolling On a Specific Form](https://docs.gravityforms.com/disable-automatic-scroll-form-confirmation/#h-disabling-automatic-scrolling-on-a-specific-form)
- [Disabling Automatic Scrolling On All Forms](https://docs.gravityforms.com/disable-automatic-scroll-form-confirmation/#h-disabling-automatic-scrolling-on-all-forms)
- [Placement](https://docs.gravityforms.com/disable-automatic-scroll-form-confirmation/#h-placement)
...
## Use the gform\_confirmation\_anchor Filter
...
To disable automatic scrolling on a specific form, use the **gform\_confirmation\_anchor** filter like so, replacing # with the form ID:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_confirmation_anchor_#'``,``'__return_false'``);` |
...
[Algolia](https://docs.gravityforms.com/disable-automatic-scroll-form-confirmation/# "Algolia")
