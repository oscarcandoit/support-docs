---
url: "https://docs.gravityforms.com/gform_advancedpostcreation_update_post_data/"
title: "Advanced Post Creation Update Data - Gravity Guide"
---
...
# gform\_advancedpostcreation\_update\_post\_data

- [Description](https://docs.gravityforms.com/gform_advancedpostcreation_update_post_data/#h-description)
- [Usage](https://docs.gravityforms.com/gform_advancedpostcreation_update_post_data/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_advancedpostcreation_update_post_data/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_advancedpostcreation_update_post_data/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_advancedpostcreation_update_post_data/#h-placement)
- [Since](https://docs.gravityforms.com/gform_advancedpostcreation_update_post_data/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_advancedpostcreation_update_post_data/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_advancedpostcreation_update_post_data'``,``'your_function_name'``, 10, 3 );` |
...
The post array being updated. Array returned is the WP [get\_post](https://developer.wordpress.org/reference/functions/get_post/) function.
- **$feed** [Feed Object](https://docs.gravityforms.com/array/)

The feed being processed.
- **$entry** [Entry Object](https://docs.gravityforms.com/array/)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_advancedpostcreation_update_post_data'``,``'your_update_post_data'``, 10, 3 );`<br>`function``your_update_post_data (``$post``,``$feed``,``$entry``) {`<br>```// do something`<br>`}` |
...
This filter is located in GF\_AdvancedPost\_Creation::update() in _class-post-update-handler.php_
...
[Algolia](https://docs.gravityforms.com/gform_advancedpostcreation_update_post_data/# "Algolia")
