---
url: "https://docs.gravityforms.com/troubleshoot-form-data-not-sent-to-service/"
title: "Troubleshooting Form Data Not Being Sent to a Service - Gravity Forms"
---
...
- [Check Gravity Forms and Add-On versions](https://docs.gravityforms.com/troubleshoot-form-data-not-sent-to-service/#check-gravity-forms-and-add-on-versions)
- [Check Your Feeds](https://docs.gravityforms.com/troubleshoot-form-data-not-sent-to-service/#check-your-feeds)
- [Enable Logging](https://docs.gravityforms.com/troubleshoot-form-data-not-sent-to-service/#enable-logging)
- [Background Processing](https://docs.gravityforms.com/troubleshoot-form-data-not-sent-to-service/#background-processing)
...
If you are continuing to have issues, and you are certain that everything is configured properly by following the previous steps, testing with [logging enabled](https://docs.gravityforms.com/logging-and-debugging/) is the next step.
...
If you’re unable to see an issue within the logs, include the links to the logs in with your support ticket, and we will be happy to help.

## Background Processing

For add-ons that process their feeds in the background, see [Troubleshooting Background (async) Processing Issues](https://docs.gravityforms.com/troubleshooting-background-issues/).

If you aren’t certain if an add-on uses background processing, check [Add-On Support for Background Feed Processing](https://docs.gravityforms.com/add-on-support-for-background-feed-processing/).
...
[Algolia](https://docs.gravityforms.com/troubleshoot-form-data-not-sent-to-service/# "Algolia")
