---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/page/4/"
title: "User Registration Filters Archives - Page 4 of 4 - Gravity Forms Documentation - Page 4 of 4"
---
...
This filter allows the modification of the object for the login form used in the Gravity Forms Login Widget.](https://docs.gravityforms.com/gform_user_registration_login_form/ "gform_userregistration_login_form") [**User Registration Feed Meta** \\
The Feed Meta object for the User Registration Add-On is an associative array containing the properties which determine how the add-on should process the form submission.](https://docs.gravityforms.com/user-registration-feed-meta/ "User Registration Feed Meta") [Previous](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/page/3/) [1](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/) [2](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/page/2/) [3](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/page/3/) 4

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/page/4/# "Algolia")
