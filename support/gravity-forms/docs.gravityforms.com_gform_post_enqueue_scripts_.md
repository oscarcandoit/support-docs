---
url: "https://docs.gravityforms.com/gform_post_enqueue_scripts/"
title: "gform_post_enqueue_scripts - Gravity Forms Documentation"
---
...
# gform\_post\_enqueue\_scripts

- [Description](https://docs.gravityforms.com/gform_post_enqueue_scripts/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_enqueue_scripts/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_enqueue_scripts/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_post_enqueue_scripts/#h-examples)
- [Basic Usage](https://docs.gravityforms.com/gform_post_enqueue_scripts/#h-basic-usage)
- [Placement](https://docs.gravityforms.com/gform_post_enqueue_scripts/#h-placement)
- [Since](https://docs.gravityforms.com/gform_post_enqueue_scripts/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_post_enqueue_scripts/#h-source-code)

## Description

The gform\_post\_enqueue\_scripts action hook is executed at the end of the process of enqueuing scripts and styles for each form embedded in the current page by shortcode or block.
...
- **$found\_forms** [array](https://docs.gravityforms.com/array)


An array of found forms using the form ID as the key to the ajax status.

- **$found\_blocks** [array](https://docs.gravityforms.com/array)


A filtered version of the array returned by [parse\_blocks](https://developer.wordpress.org/reference/functions/parse_blocks/) containing only Gravity Forms blocks.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_action(``'gform_post_enqueue_scripts'``,``function``(``$found_forms``,``$found_blocks``,``$post``) {`<br>```foreach``(``$found_forms``as``$form_id``=>``$ajax_status``) {`<br>```// Do something for each form.`<br>```}`<br>`}, 10, 3 );` |
...
This hook is located in GFFormDisplay::enqueue\_scripts() in _form\_display.php_.
...
[Algolia](https://docs.gravityforms.com/gform_post_enqueue_scripts/# "Algolia")
