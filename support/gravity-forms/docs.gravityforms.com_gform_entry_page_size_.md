---
url: "https://docs.gravityforms.com/gform_entry_page_size/"
title: "gform_entry_page_size - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_entry_page_size/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_page_size/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_entry_page_size/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_entry_page_size/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_page_size'``,``'your_function_name'``, 10, 2 );` |

To target a specific form append the form id to the hook name. (format: gform\_entry\_page\_size\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_page_size_10'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$page\_size** [integer](https://docs.gravityforms.com/integer)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_entry_page_size'``,``'my_entry_page_size'``);`<br>`function``my_entry_page_size() {`<br>`return``40;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_page_size/# "Algolia")
