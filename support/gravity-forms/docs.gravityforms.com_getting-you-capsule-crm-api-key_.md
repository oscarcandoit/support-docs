---
url: "https://docs.gravityforms.com/getting-you-capsule-crm-api-key/"
title: "Obtaining Your Capsule CRM API Key - Gravity Forms Documentation"
---
...
1. Log into your [Capsule CRM](https://capsulecrm.com/) account.
2. Click on your name at the top right corner and then on **My Preferences**.
3. From the left side menu, click **API Authentication Tokens**.
4. Under **Personal Access Tokens**, click the **Generate new API token** button.

![Capsule CRM Generate API Token](https://docs.gravityforms.com/wp-content/uploads/2015/07/Capsule-CRM-Generate-API-Token.png)
5. Give the token a **Description**, and check the boxes as applicable.

![Capsule CRM Generate Personal Access Token Settings](https://docs.gravityforms.com/wp-content/uploads/2015/07/Capsule-CRM-Generate-Personal-Access-Token-Settings.png)
6. Click the **Save new Token** button.
...
[Algolia](https://docs.gravityforms.com/getting-you-capsule-crm-api-key/# "Algolia")
