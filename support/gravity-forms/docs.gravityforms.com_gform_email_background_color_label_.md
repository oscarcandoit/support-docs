---
url: "https://docs.gravityforms.com/gform_email_background_color_label/"
title: "gform_email_background_color_label - Gravity Forms Documentation"
---
...
# gform\_email\_background\_color\_label

- [Description](https://docs.gravityforms.com/gform_email_background_color_label/#h-description)
- [Usage](https://docs.gravityforms.com/gform_email_background_color_label/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_email_background_color_label/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_email_background_color_label/#h-example)
- [Placement](https://docs.gravityforms.com/gform_email_background_color_label/#h-placement)
- [Since](https://docs.gravityforms.com/gform_email_background_color_label/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_email_background_color_label/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_email_background_color_label'``,``'your_function_name'``, 10, 3 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_email_background_color_label'``,``'set_email_label_color'``, 10, 3 );`<br>```function``set_email_label_color(``$color``,``$field``,``$lead``){`<br>```return``'#CC99FF'``;`<br>```}` |
...
This filter is located in GFCommon::get\_submitted\_fields() in **common.php**.
...
[Algolia](https://docs.gravityforms.com/gform_email_background_color_label/# "Algolia")
