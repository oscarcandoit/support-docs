---
url: "https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/"
title: "gform_campaignmonitor_override_subscriber - Gravity Forms"
---
...
# gform\_campaignmonitor\_override\_subscriber

- [Description](https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/#h-description)
- [Usage](https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/#h-examples)
- [1\. Add RestartSubscriptionBasedAutoresponders parameter](https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/#h-1-add-restartsubscriptionbasedautoresponders-parameter)
- [Placement](https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_campaignmonitor_override_subscriber'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$subscriber** [array](https://docs.gravityforms.com/array)
An associative array containing all the [parameters](https://www.campaignmonitor.com/api/subscribers/) to be passed to Campaign Monitor.
...
This example shows how you can add the RestartSubscriptionBasedAutoresponders parameter to the subscriber array. This will restart the any automated workflows for resubscribed subscribers, more details in [Campaign Monitor API docs](https://www.campaignmonitor.com/api/subscribers/).

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_campaignmonitor_override_subscriber'``,``function``(``$subscriber``,``$entry``,``$form``,``$feed``) {`<br>```$subscriber``[``'RestartSubscriptionBasedAutoresponders'``] = true;`<br>```return``$subscriber``;`<br>`}, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1 | `apply_filters(``'gform_campaignmonitor_override_subscriber'``,``$subscriber``,``$entry``,``$form``,``$feed``)` |

This filter is located in GFCampaignMonitor::export\_feed() in _class-gf-campaignmonitor.php_.
...
[Algolia](https://docs.gravityforms.com/gform_campaignmonitor_override_subscriber/# "Algolia")
