---
url: "https://docs.gravityforms.com/troubleshooting-issues-with-calculation-results/"
title: "Troubleshooting Issues with Calculation Results - Gravity Forms"
---
...
- [Summary](https://docs.gravityforms.com/troubleshooting-issues-with-calculation-results/#h-summary)
- [Solutions](https://docs.gravityforms.com/troubleshooting-issues-with-calculation-results/#h-solutions)
- [Example Logging Statements](https://docs.gravityforms.com/troubleshooting-issues-with-calculation-results/#h-example-logging-statements)
...
The solution to the total field not being available is to use a Number field with a subtotal calculation. Refer to the [GravityWiz Subtotal Merge Tag (for Calculations)](http://gravitywiz.com/subtotal-merge-tag-for-calculations/) article for more information.

You can test with logging enabled to determine which field value wasn’t available when the calculation was rerun. See [Logging and Debugging](https://docs.gravityforms.com/logging-and-debugging/) for details on how to do so.

## Example Logging Statements

- DEBUG –> GFFormsModel::save\_input(): Queued field operation: Calculated Subtotal (\[field label\])(#\[field id\] – \[field type\]).
- DEBUG –> GFCommon::get\_calculation\_value(): No value or non-numeric value available for field #\[field id\]. Returning zero instead.
...
[Algolia](https://docs.gravityforms.com/troubleshooting-issues-with-calculation-results/# "Algolia")
