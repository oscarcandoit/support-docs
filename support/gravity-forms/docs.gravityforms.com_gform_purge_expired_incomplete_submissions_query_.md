---
url: "https://docs.gravityforms.com/gform_purge_expired_incomplete_submissions_query/"
title: "gform_purge_expired_incomplete_submissions_query - Gravity Forms"
---
...
# gform\_purge\_expired\_incomplete\_submissions\_query

- [Description](https://docs.gravityforms.com/gform_purge_expired_incomplete_submissions_query/#h-description)
- [Usage](https://docs.gravityforms.com/gform_purge_expired_incomplete_submissions_query/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_purge_expired_incomplete_submissions_query/#h-parameters)
- [Placement](https://docs.gravityforms.com/gform_purge_expired_incomplete_submissions_query/#h-placement)
- [Since](https://docs.gravityforms.com/gform_purge_expired_incomplete_submissions_query/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_purge_expired_incomplete_submissions_query/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_purge_expired_incomplete_submissions_query'``,``'your_function_name'``, 10 );` |

## Parameters

- **$query** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `$query``=``array``(`<br>```'delete'``=>``'DELETE'``,`<br>```'from'``=> sprintf(``'FROM %s'``, self::get_incomplete_submissions_table_name() ),`<br>```'where'``=>``$wpdb``->prepare(``'WHERE date_created < %s'``,``$expiration_date``),`<br>`);`<br>``<br>`$query``= apply_filters(``'gform_purge_expired_incomplete_submissions_query'``,``$query``);`<br>``<br>`$result``=``$wpdb``->query( implode(``"n"``,``$query``) );` |

This filter is located in GFFormsModel::purge\_expired\_incomplete\_submissions() in _forms\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_purge_expired_incomplete_submissions_query/# "Algolia")
