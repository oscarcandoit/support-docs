---
url: "https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/"
title: "gform_recaptcha_spam_score_threshold - Gravity Forms Documentation"
---
...
# gform\_recaptcha\_spam\_score\_threshold

- [Description](https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/#h-description)
- [Usage](https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/#h-examples)
- [Apply a custom spam score threshold for form ID 4.](https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/#h-apply-a-custom-spam-score-threshold-for-form-id-4)
- [Placement](https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/#h-placement)
- [Since](https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_recaptcha_spam_score_threshold'``,``'your_function_name'``, 10, 2 );` |

Applies to a specific form. Replace {FORMID} with your Form ID.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_recaptcha_spam_score_threshold_{FORMID}'``,``'your_function_name'``, 10, 2 );` |

## Parameters

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| **$threshold** | [float](https://docs.gravityforms.com/float/) | The spam score threshold used to determine whether a submission is considered spam. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_recaptcha_spam_score_threshold_4'``,``function``(``$threshold``,``$form``) {`<br>```return``0.8;`<br>`}, 10, 2 );` |
...
[Algolia](https://docs.gravityforms.com/gform_recaptcha_spam_score_threshold/# "Algolia")
