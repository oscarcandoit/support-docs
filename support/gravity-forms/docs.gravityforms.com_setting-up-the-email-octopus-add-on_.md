---
url: "https://docs.gravityforms.com/setting-up-the-email-octopus-add-on/"
title: "Setting Up The EmailOctopus Add-On - Gravity Forms Documentation"
---
...
- [Pre-Requisites](https://docs.gravityforms.com/setting-up-the-email-octopus-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-up-the-email-octopus-add-on/#h-setup)
- [Add-on Framework Hooks](https://docs.gravityforms.com/setting-up-the-email-octopus-add-on/#h-add-on-framework-hooks)

## Pre-Requisites

- [Download](https://docs.gravityforms.com/downloading-a-gravity-forms-add-on) and [install](https://docs.gravityforms.com/installing-a-gravity-forms-add-on/) the add-on
- An [EmailOctopus](https://www.emailoctopus.com/) account, that contains a [list](https://help.emailoctopus.com/article/38-what-is-a-list) with [fields associated](https://help.emailoctopus.com/article/37-adding-new-fields).
- An [EmailOctopus API key](https://help.emailoctopus.com/article/165-how-to-create-and-revoke-api-keys), which can be found within your EmailOctopus API area.

## Setup

1. Log into your WordPress admin dashboard.
2. On the left side navigation menu, hover over **Forms** and click on **Settings**.
3. From this page, click the **EmailOctopus** tab.
4. Enter the EmailOctopus **API Key** as mentioned in the Pre-requisites section.
5. Click **Update Settings**. If you’ve entered your account information correctly, you will be notified by a green check mark beside each box. If you do not see green check marks next to the credentials, double check your information and try again.

Once you have entered your API keys, you’re ready to begin [creating a feed for the EmailOctopus Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-emailoctopus-add-on/).

## Add-on Framework Hooks

Because this Add-On is built using the [Add-On Framework](https://docs.gravityforms.com/category/developers/php-api/add-on-framework) it also inherits [any hooks available in the framework methods](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/) it uses such as:

- [gform\_short\_slug\_field\_value](https://docs.gravityforms.com/gform_short_slug_field_value) for changing a field value before it is passed.
...
[Algolia](https://docs.gravityforms.com/setting-up-the-email-octopus-add-on/# "Algolia")
