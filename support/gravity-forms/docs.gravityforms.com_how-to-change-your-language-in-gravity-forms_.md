---
url: "https://docs.gravityforms.com/how-to-change-your-language-in-gravity-forms/"
title: "How To Change Your Language In Gravity Forms"
---
...
- [Languages available in Gravity Forms](https://docs.gravityforms.com/how-to-change-your-language-in-gravity-forms/#h-languages-available-in-gravity-forms)
- [Changing your WordPress installation language](https://docs.gravityforms.com/how-to-change-your-language-in-gravity-forms/#h-changing-your-wordpress-installation-language)
- [I want to present one form in multiple languages](https://docs.gravityforms.com/how-to-change-your-language-in-gravity-forms/#h-i-want-to-present-one-form-in-multiple-languages)
...
To change the language of Gravity Forms, all you need to do is **change the language of your WordPress installation**. In this article, we will show you how to change the language of your WordPress installation, which subsequently changes the language of Gravity Forms.

## Languages available in Gravity Forms

A list of all translations included with Gravity Forms, as well as download links for their source files may be found on our [Translations page](https://www.gravityforms.com/my-account/downloads/translations/).

## Changing your WordPress installation language

1. First, log into your WordPress admin dashboard.
2. Once logged in, hover over **Settings** on the left side menu panel, and click on **General**.

![Image showing language settings for WordPress.](https://docs.gravityforms.com/wp-content/uploads/2024/07/image-66.png)

3. From within this page, there is a dropdown labeled **Site Language**. Simply use this dropdown to select your desired language.
4. Now that your language is selected, simply click the **Save Changes** button.
...
Although WordPress displays in U.S. English by default, it can be used in any language. The WordPress community has already translated WordPress into many languages, and there are Themes, translation files, and support available in many other languages (see [WordPress in Your Language](https://developer.wordpress.org/advanced-administration/wordpress/multilingual/)).

Gravity Forms also supports loading translations from a gravityforms folder in the WP\_LANG\_DIR directory e.g. /wp-content/languages/gravityforms/

## I want to present one form in multiple languages

If changing the language for your site is not an option, but you still want to present your forms in different languages, consider the [Gravity Forms Multilingual](https://wpml.org/documentation/related-projects/gravity-forms-multilingual/) plugin from [WPML](https://www.wpml.org/).

More information is available in our [blog post here](https://www.gravityforms.com/blog/multilingual-wpml/).
...
[Algolia](https://docs.gravityforms.com/how-to-change-your-language-in-gravity-forms/# "Algolia")
