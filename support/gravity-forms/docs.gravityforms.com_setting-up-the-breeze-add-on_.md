---
url: "https://docs.gravityforms.com/setting-up-the-breeze-add-on/"
title: "Setting Up the Breeze Add-On - Gravity Forms Documentation"
---
...
- [Pre-Requisites](https://docs.gravityforms.com/setting-up-the-breeze-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-up-the-breeze-add-on/#h-setup)
...
- A [Breeze](https://www.breeze.pm/) account

## Setup

1. Log into your WordPress admin dashboard.
2. On the left side navigation menu, hover over **Forms** and click on **Settings**.
3. From this page, click the **Breeze** tab.
4. Enter your **API Token**. This is obtained from Breeze. Refer to this article for [how to obtain your API token](https://docs.gravityforms.com/obtaining-activating-breeze-api-key/).
5. Click **Update Settings**. If you’ve entered your API token correctly, you will be notified by a green check mark beside the box. If you do not see a green check mark, please double check this information and try again.

Once you have entered your API key, you’re ready to begin [creating a feed for the Breeze Add-On](https://docs.gravityforms.com/creating-feeds-breeze-add/).
...
[Algolia](https://docs.gravityforms.com/setting-up-the-breeze-add-on/# "Algolia")
