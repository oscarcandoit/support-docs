---
url: "https://docs.gravityforms.com/gform_user_registration_signup_meta/"
title: "gform_user_registration_signup_meta - Gravity Forms Documentation"
---
...
# gform\_user\_registration\_signup\_meta

- [Description](https://docs.gravityforms.com/gform_user_registration_signup_meta/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_signup_meta/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_signup_meta/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_user_registration_signup_meta/#h-example)
- [Placement](https://docs.gravityforms.com/gform_user_registration_signup_meta/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_signup_meta/#h-source-code)

## Description

The “gform\_user\_registration\_signup\_meta” filter allows the modification of the signup meta data. This filter is used in the User Registration Add-On for Gravity Forms.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_user_registration_signup_meta'``,``'your_function_name'``, 10, 4 );` |

To target a specific form, append the form id to the hook name. (format: gform\_user\_registration\_signup\_meta\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_user_registration_signup_meta_74'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$meta** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_user_registration_signup_meta'``,``'add_blog_template'``, 10, 4 );`<br>```function``add_blog_template(``$signup_meta``,``$form``,``$entry``,``$feed``) {`<br>```$signup_meta``[``'blog_template'``] = 1;`<br>```return``$signup_meta``;`<br>```}` |
...
This filter is located in GF\_User\_Registration::handle\_user\_activation() in _gravityformsuserregistration/class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_signup_meta/# "Algolia")
