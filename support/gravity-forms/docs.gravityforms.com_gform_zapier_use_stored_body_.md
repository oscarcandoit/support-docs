---
url: "https://docs.gravityforms.com/gform_zapier_use_stored_body/"
title: "gform_zapier_use_stored_body - Gravity Forms Documentation"
---
...
# gform\_zapier\_use\_stored\_body

- [Description](https://docs.gravityforms.com/gform_zapier_use_stored_body/#h-description)
- [Usage](https://docs.gravityforms.com/gform_zapier_use_stored_body/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_zapier_use_stored_body/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_zapier_use_stored_body/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_zapier_use_stored_body/#h-placement)
- [Since](https://docs.gravityforms.com/gform_zapier_use_stored_body/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_zapier_use_stored_body/#h-source-code)

## Description

The “gform\_zapier\_use\_stored\_body” filter is used to determine if the already stored body should be used.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_zapier_use_stored_body'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$use\_body** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_zapier_use_stored_body'``,``'use_body'``, 10, 4 );`<br>`function``use_body(``$use_body``,``$entry``,``$form``,``$feed``){`<br>```return``false;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_zapier_use_stored_body/# "Algolia")
