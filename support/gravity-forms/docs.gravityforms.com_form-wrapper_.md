---
url: "https://docs.gravityforms.com/form-wrapper/"
title: "Form Wrapper CSS Selectors - Gravity Forms Documentation"
---
...
|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``{``border``:``1px``solid``red``}` |
...
[Algolia](https://docs.gravityforms.com/form-wrapper/# "Algolia")
