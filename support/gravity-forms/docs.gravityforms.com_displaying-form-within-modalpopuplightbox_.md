---
url: "https://docs.gravityforms.com/displaying-form-within-modalpopuplightbox/"
title: "Displaying a Form Within a Modal/Popup/Lightbox - Gravity Forms"
---
...
- [Introduction](https://docs.gravityforms.com/displaying-form-within-modalpopuplightbox/#h-introduction)
- [Obtain the Popup Maker plugin](https://docs.gravityforms.com/displaying-form-within-modalpopuplightbox/#h-obtain-the-popup-maker-plugin)
- [Embed your Form](https://docs.gravityforms.com/displaying-form-within-modalpopuplightbox/#h-embed-your-form)

**Note**: This tutorial is provided as a suggestion only. We do not support third party solutions. If you have any trouble using Popup Maker, please [contact with its author](https://wordpress.org/support/plugin/popup-maker/).
...
The easiest way to create a popup window and embed Gravity Forms into it is to do so using the Popup Maker plugin. Simply download and install the [Popup Maker plugin](https://wordpress.org/plugins/popup-maker/) either from within your WordPress admin dashboard or manually.
...
When embedding your form, ensure that AJAX is enabled to avoid the page refreshing. To do so, either use the **Enable AJAX** checkbox when adding a form using the button, or add _ajax=”true”_ to your Gravity Forms embed shortcode.

¿Need more help creating your popup? Please [contact the Popup Maker author](https://wordpress.org/support/plugin/popup-maker) for further assistance and tips.
...
[Algolia](https://docs.gravityforms.com/displaying-form-within-modalpopuplightbox/# "Algolia")
