---
url: "https://docs.gravityforms.com/gf_field_name/"
title: "GF_Field_Name - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_name/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_name/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_name/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_name/#h-properties)
- [Source Code](https://docs.gravityforms.com/gf_field_name/#h-source-code)

## Introduction

The GF\_Field\_Name class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Name field is rendered when the form is displayed and how its value is handled during and after form submission.
...
For complex fields like the name, time, address fields, this controls whether the “Default Values” section will appear which lets you set values for the individual components of the field. When it is not a complex field, the “default\_value\_setting” controls the display of this section.
...
For complex fields like the name, time, and address fields, this controls whether the “Placeholders” section will appear which lets you set placeholder text for the individual components of the field. When it is not a complex field, the “placeholder\_setting” controls the display of this section.
...
- **adminOnly** [boolean](https://docs.gravityforms.com/boolean)
...
- **inputs** [array](https://docs.gravityforms.com/array)
...
An array containing the the individual properties for each element of the name field.
  ...
  - **customLabel** [string](https://docs.gravityforms.com/string)
  ...
  - **defaultValue** [string](https://docs.gravityforms.com/string)

    The default value to be displayed/chosen in the input field.

  - **isHidden** [boolean](https://docs.gravityforms.com/boolean)

    Controls whether the input is visible.

  - **enableChoiceValue** [boolean](https://docs.gravityforms.com/boolean)

    Indicates whether the choice has a value, not just the text. This is only available for the Prefix field.

  - **inputType** [string](https://docs.gravityforms.com/string)
  ...
  - **choices** [array](https://docs.gravityforms.com/array)
    ...
    - **isSelected** [boolean](https://docs.gravityforms.com/boolean)
      ...
      |     |     |
      | --- | --- |
      | 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22<br>23<br>24<br>25<br>26<br>27<br>28<br>29<br>30<br>31<br>32<br>33<br>34<br>35<br>36<br>37<br>38<br>39<br>40<br>41<br>42<br>43<br>44<br>45<br>46<br>47<br>48<br>49<br>50<br>51<br>52<br>53<br>54<br>55<br>56<br>57<br>58<br>59<br>60<br>61 | `$inputs``=``array``(`<br>```array``(`<br>```'id'``=>``'1.2'``,`<br>```'label'``=>``'Prefix'``,`<br>```'name'``=>``'param_prefix'``,`<br>```'customLabel'``=>``''``,`<br>```'placeholder'``=>``'Select a Prefix'``,`<br>```'defaultValue'``=>``''``,`<br>```'isHidden'``=> false,`<br>```'inputType'``=>``'radio'``,`<br>```'enableChoiceValue'``=> false,`<br>```'choices'``=>``array``(`<br>```array``(`<br>```'text'``=>``'Mr.'``,`<br>```'value'``=>``'Mr.'``,`<br>```'isSelected'``=> false`<br>```),`<br>```array``(`<br>```'text'``=>``'Ms.'``,`<br>```'value'``=>``'Ms.'``,`<br>```'isSelected'``=> true`<br>```)`<br>```)`<br>```),`<br>```array``(`<br>```'id'``=>``'1.3'``,`<br>```'label'``=>``'First'``,`<br>```'name'``=>``'param_first'``,`<br>```'customLabel'``=>``'First Name'``,`<br>```'placeholder'``=>``''``,`<br>```'defaultValue'``=>``''``,`<br>```'isHidden'``=> false`<br>```),`<br>```array``(`<br>```'id'``=>``'1.4'``,`<br>```'label'``=>``'Middle'``,`<br>```'name'``=>``''``,`<br>```'customLabel'``=>``'Middle Initial'``,`<br>```'placeholder'``=>``'Enter your middle initial'``,`<br>```'defaultValue'``=>``''``,`<br>```'isHidden'``=> false`<br>```),`<br>```array``(`<br>```'id'``=>``'1.6'``,`<br>```'label'``=>``'Last'``,`<br>```'name'``=>``'param_last'``,`<br>```'customLabel'``=>``'Last Name'``,`<br>```'placeholder'``=>``''``,`<br>```'defaultValue'``=>``''``,`<br>```'isHidden'``=> false`<br>```),`<br>```array``(`<br>```'id'``=>``'1.8'``,`<br>```'label'``=>``'Suffix'``,`<br>```'name'``=>``''``,`<br>```'customLabel'``=>``''``,`<br>```'placeholder'``=>``''``,`<br>```'defaultValue'``=>``''``,`<br>```'isHidden'``=> true`<br>```),`<br>```);` |
...
- **nameFormat** [string](https://docs.gravityforms.com/string)
...
- **size** [string](https://docs.gravityforms.com/string)

Controls the width of the input field. The choices are “small”, “medium”, and “large”.

- **subLabelPlacement** [string](https://docs.gravityforms.com/string)
...
The source code is located in _includes/fields/class-gf-field-name.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_name/# "Algolia")
