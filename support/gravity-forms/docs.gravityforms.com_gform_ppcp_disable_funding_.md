---
url: "https://docs.gravityforms.com/gform_ppcp_disable_funding/"
title: "gform_ppcp_disable_funding - Gravity Forms Documentation"
---
...
# gform\_ppcp\_disable\_funding

- [Description](https://docs.gravityforms.com/gform_ppcp_disable_funding/#h-description)
- [Usage](https://docs.gravityforms.com/gform_ppcp_disable_funding/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_ppcp_disable_funding/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_ppcp_disable_funding/#h-examples)
- [Disable SEPA](https://docs.gravityforms.com/gform_ppcp_disable_funding/#h-disable-sepa)
- [Disable Pay Later / PayPal Credit](https://docs.gravityforms.com/gform_ppcp_disable_funding/#h-disable-pay-later-paypal-credit)
- [Placement](https://docs.gravityforms.com/gform_ppcp_disable_funding/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_ppcp_disable_funding/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_ppcp_disable_funding/#h-since)

## Description

This filter can be used to disable funding sources when using the PayPal Checkout method on the [PayPal Field](https://docs.gravityforms.com/paypal-field/) with the [PayPal Checkout Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/paypal-checkout-add-on/).
...
- **$disabled\_funding** [array](https://docs.gravityforms.com/array)


An array of disabled founding sources. Defaults to an empty array.

The possible values are: card, credit, paylater, bancontact, blik, eps, giropay, ideal, mercadopago, mybank, p24, sepa, venmo

See the [PayPal Checkout developer documentation](https://developer.paypal.com/sdk/js/configuration/#disable-funding) for the latest updates.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_ppcp_disable_funding'``,``'ppcp_disable_sepa'``);`<br>`function``ppcp_disable_sepa(``$disabled_funding``) {`<br>```$disabled_funding``[] =``'sepa'``;`<br>```return``$disabled_funding``;`<br>`}` |

### Disable Pay Later / PayPal Credit

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_ppcp_disable_funding'``,``function``(``$disabled_funding``) {`<br>```$disabled_funding``[] =``'credit'``;``// PayPal Credit (US, UK).`<br>```$disabled_funding``[] =``'paylater'``;``// Pay Later (US, UK), Pay in 4 (AU), 4X PayPal (France), Später Bezahlen (Germany).`<br>```return``$disabled_funding``;`<br>`} );` |
...
This filter is located in GF\_PPCP::get\_disable\_funding() in _class-gf-ppcp.php_.
...
[Algolia](https://docs.gravityforms.com/gform_ppcp_disable_funding/# "Algolia")
