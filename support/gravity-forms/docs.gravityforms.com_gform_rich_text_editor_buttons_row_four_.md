---
url: "https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_four/"
title: "gform_rich_text_editor_buttons_row_four - Gravity Forms Documentation"
---
...
# gform\_rich\_text\_editor\_buttons\_row\_four

- [Description](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_four/#h-description)
- [Usage](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_four/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_four/#h-parameters)
- [Source Code](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_four/#h-source-code)

## Description

The “gform\_rich\_text\_editor\_buttons\_row\_four” filter in Gravity Forms controls the buttons displayed in the fourth row within the Gravity Forms rich text editor. Note: WordPress and Gravity Forms do not include any buttons on the fourth row of the rich text editor by default.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_rich_text_editor_buttons_row_four'``,``'my_function'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_rich_text_editor_buttons_row_four_2'``,``'my_function'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_rich_text_editor_buttons_row_four_2_6'``,``'my_function'``, 10, 2 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| $mce\_buttons | [array](https://docs.gravityforms.com/array) | Array (empty by default) of fourth row buttons to include within the TinyMCE editor inside Gravity Forms. |
| $editor\_id | [string](https://docs.gravityforms.com/string) | The HTML element ID for the field using the rich text editor. |
| $field\_object | [object](https://docs.gravityforms.com/object) | Object containing information about the field. |
|  |  |  |
...
[Algolia](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_four/# "Algolia")
