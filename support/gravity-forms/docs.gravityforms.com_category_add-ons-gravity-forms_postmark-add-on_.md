---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/postmark-add-on/"
title: "Postmark Add-On Archives - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Postmark Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/postmark-add-on/)    - [Obtaining Your Postmark API Keys](https://docs.gravityforms.com/get-postmark-api-keys/ "Obtaining Your Postmark API Keys")
    - [Setting Up the Postmark Add-On](https://docs.gravityforms.com/setting-up-the-postmark-add-on/ "Setting Up the Postmark Add-On")
    - [Sending Form Notifications Using Postmark](https://docs.gravityforms.com/form-notifications-postmark/ "Sending Form Notifications Using Postmark")
    - [Email Tracking with Postmark](https://docs.gravityforms.com/email-tracking-postmark/ "Email Tracking with Postmark")
    - [Postmark Changelog](https://docs.gravityforms.com/postmark-change-log/ "Postmark Changelog")
...
Learn how to obtain your Postmark API Keys.](https://docs.gravityforms.com/get-postmark-api-keys/ "Obtaining Your Postmark API Keys") [**Setting Up the Postmark Add-On**\\
Step-by-step instructions on how to setup the Postmark Add-On.](https://docs.gravityforms.com/setting-up-the-postmark-add-on/ "Setting Up the Postmark Add-On") [**Sending Form Notifications Using Postmark** \\
Learn how to use Postmark to send your form notifications.](https://docs.gravityforms.com/form-notifications-postmark/ "Sending Form Notifications Using Postmark") [**Email Tracking with Postmark** \\
Discover how to enable Postmark tracking within your form notifications.](https://docs.gravityforms.com/email-tracking-postmark/ "Email Tracking with Postmark") [**Postmark Changelog** \\
View the change log for the Postmark Add-On.](https://docs.gravityforms.com/postmark-change-log/ "Postmark Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/postmark-add-on/# "Algolia")
