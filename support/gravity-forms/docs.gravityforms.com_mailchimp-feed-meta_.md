---
url: "https://docs.gravityforms.com/mailchimp-feed-meta/"
title: "Mailchimp Feed Meta - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/mailchimp-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/mailchimp-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the Mailchimp Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `$feed``[``'meta'``] =``array``(`<br>```'feedName'``=>``'Your Feed Name'``,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **mailchimpList** [string](https://docs.gravityforms.com/string)

The API List ID for the Mailchimp list this feed will subscribe the user to when processed.

- **mappedFields\_EMAIL** [string](https://docs.gravityforms.com/string)

The ID of the field containing the user’s email address.

- **mappedFields\_FNAME** [string](https://docs.gravityforms.com/string)
...
- **mappedFields\_ _{tag}_** [string](https://docs.gravityforms.com/string)

The ID of the field containing the value for the list field.

There would also be properties for any other List fields and \*\|MERGE\|\* tags configured for your list, they all begin **mappedFields\_** and then end with the tag, e.g. mappedFields\_MMERGE3.
...
- **mc\_group\_{GROUPID}\_enabled** [boolean](https://docs.gravityforms.com/boolean)
Should the user be added to the group.

- **mc\_group\_{GROUPID}\_decision** [string](https://docs.gravityforms.com/string)

Should the user always be added to the group or only if the configured condition is met. _Possible values: if or always._

- **mc\_group\_{GROUPID}\_field\_id** [string](https://docs.gravityforms.com/string)

The ID of the field containing the value which should be compared against **mc\_group\_{GROUPID}\_value**.

- **mc\_group\_{GROUPID}\_operator** [string](https://docs.gravityforms.com/string)

Operator to be used when evaluating this rule. _Possible values: is, isnot, >, <, contains, starts\_with, or ends\_with._

- **mc\_group\_{GROUPID}\_value** [string](https://docs.gravityforms.com/string)
...
[Algolia](https://docs.gravityforms.com/mailchimp-feed-meta/# "Algolia")
