---
url: "https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/"
title: "gform_process_template_shortcodes_pre_create_post - Gravity Forms"
---
...
# gform\_process\_template\_shortcodes\_pre\_create\_post

- [Description](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/#h-description)
- [Usage](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/#h-examples)
- [1\. Enable for all forms](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/#h-1-enable-for-all-forms)
- [2\. Disable for a specific form](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/#h-2-disable-for-a-specific-form)
- [Placement](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_process_template_shortcodes_pre_create_post'``,``'your_function_name'``, 10, 3 );` |

Applies to a specific form:

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_process_template_shortcodes_pre_create_post_5'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$process\_template\_shortcodes** [boolean](https://docs.gravityforms.com/boolean)
Is shortcode processing enabled? Default is false for the post content or true in other areas.

- **$field\_type** [string](https://docs.gravityforms.com/string)

The field type currently being processed. Possible values: post\_custom\_field, post\_content, or post\_title.

- **$post\_data** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_process_template_shortcodes_pre_create_post'``,``'__return_true'``);` |

### 2\. Disable for a specific form

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_process_template_shortcodes_pre_create_post_5'``,``'__return_false'``);` |
...
This filter is located in GFFormsModel::process\_post\_template() in _forms\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_process_template_shortcodes_pre_create_post/# "Algolia")
