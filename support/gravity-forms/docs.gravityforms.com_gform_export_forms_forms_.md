---
url: "https://docs.gravityforms.com/gform_export_forms_forms/"
title: "gform_export_forms_forms - Gravity Forms Documentation"
---
...
# gform\_export\_forms\_forms

- [Description](https://docs.gravityforms.com/gform_export_forms_forms/#h-description)
- [Usage](https://docs.gravityforms.com/gform_export_forms_forms/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_export_forms_forms/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_export_forms_forms/#h-placement)
- [Since](https://docs.gravityforms.com/gform_export_forms_forms/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_export_forms_forms/#h-source-code)

## Description

The “gform\_export\_forms\_forms” filter in Gravity Forms allows the forms displayed on the Export Forms page to be filtered.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_export_forms_forms'``,``'your_function_name'``, 10, 1 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_export_forms_forms'``,``'filter_forms'``, 10, 1 );`<br>`function``filter_forms(``$forms``){`<br>`//remove half of the forms`<br>`$forms``=``array_slice``(``$forms``, 0,``round``(``count``(``$forms``) / 2 ) );`<br>`return``$forms``;`<br>`}` |
...
This filter is located in GFExport::export\_form\_page() in _export.php_.
...
[Algolia](https://docs.gravityforms.com/gform_export_forms_forms/# "Algolia")
