---
url: "https://docs.gravityforms.com/setting-up-the-campaign-monitor-add-on/"
title: "Setting Up the Campaign Monitor Add-On - Gravity Forms"
---
...
- [Pre-Requisites](https://docs.gravityforms.com/setting-up-the-campaign-monitor-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-up-the-campaign-monitor-add-on/#h-setup)
...
- A [Campaign Monitor](https://www.campaignmonitor.com/) account

## Setup

1. Log into your WordPress admin dashboard.
2. On the left side navigation menu, hover over **Forms** and click on **Settings**.
3. From this page, click the **Campaign Monitor** tab.
4. Enter your **API Key**. This is obtained from Campaign Monitor. If you are unsure of how to obtain your API key, you may review our documentation on [obtaining your Campaign Monitor API key](https://docs.gravityforms.com/activating-your-campaign-monitor-api-key/).
5. Click **Update Settings**. If you’ve entered your account information correctly, you will be notified by a green check mark beside the box. If you do not see a green check mark, please double check this information and try again.

Once you have entered your API key, you’re ready to begin [creating a feed for the Campaign Monitor Add-On](https://docs.gravityforms.com/creating-a-feed-campaign-monitor-add-on/).
...
[Algolia](https://docs.gravityforms.com/setting-up-the-campaign-monitor-add-on/# "Algolia")
