---
url: "https://docs.gravityforms.com/gform_paypal_hash_matches/"
title: "gform_paypal_hash_matches - Gravity Forms Documentation"
---
...
# gform\_paypal\_hash\_matches

- [Description](https://docs.gravityforms.com/gform_paypal_hash_matches/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_hash_matches/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_hash_matches/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_hash_matches/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_paypal_hash_matches/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_paypal_hash_matches/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_hash_matches'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$hash\_matches** [bool](https://docs.gravityforms.com/bool)
...
- **$hash** [string](https://docs.gravityforms.com/string)

The hash.

- **$custom\_field** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_paypal_hash_matches'``,``'validate_hash'``, 10, 4 );`<br>`function``validate_hash(``$hash_matches``,``$entry_id``,``$hash``,``$custom_field``){`<br>```//do further checks on the hash or force failure, whatever`<br>```if``(``$entry_id``> 100 ){`<br>```return``false;`<br>```}`<br>```return``true;`<br>`}` |
...
This filter is located in GFPayPal::get\_entry() in _gravityformspaypal/class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_hash_matches/# "Algolia")
