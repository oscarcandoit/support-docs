---
url: "https://docs.gravityforms.com/gform_coupons_post_delete_coupon/"
title: "gform_coupons_post_delete_coupon - Gravity Forms Documentation"
---
...
# gform\_coupons\_post\_delete\_coupon

- [Description](https://docs.gravityforms.com/gform_coupons_post_delete_coupon/#h-description)
- [Usage](https://docs.gravityforms.com/gform_coupons_post_delete_coupon/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_coupons_post_delete_coupon/#h-parameters)
- [Placement](https://docs.gravityforms.com/gform_coupons_post_delete_coupon/#h-placement)
- [Since](https://docs.gravityforms.com/gform_coupons_post_delete_coupon/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_coupons_post_delete_coupon/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `gform.addAction(``'gform_coupons_post_delete_coupon'``,``function``( code, formId ) {`<br>```// do stuff`<br>`} );` |

## Parameters

- **code** [string](https://docs.gravityforms.com/string)
...
This hook is located in DeleteCoupon() in _gravityformscoupons/js/coupons.js_.
...
[Algolia](https://docs.gravityforms.com/gform_coupons_post_delete_coupon/# "Algolia")
