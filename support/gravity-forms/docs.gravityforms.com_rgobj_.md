---
url: "https://docs.gravityforms.com/rgobj/"
title: "rgobj() - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/rgobj/#h-description)
- [Usage](https://docs.gravityforms.com/rgobj/#h-usage)
- [Parameters](https://docs.gravityforms.com/rgobj/#h-parameters)
- [Examples](https://docs.gravityforms.com/rgobj/#h-examples)
- [Source Code](https://docs.gravityforms.com/rgobj/#h-source-code)
...
- **$obj** [object](https://docs.gravityforms.com/object)
...
|     |     |
| --- | --- |
| 1<br>2 | `// Returns the value of the field object id property`<br>`$id``= rgobj(``$field``,``'id'``);` |
...
[Algolia](https://docs.gravityforms.com/rgobj/# "Algolia")
