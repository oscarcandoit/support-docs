---
url: "https://docs.gravityforms.com/form-footer/"
title: "Form Footer CSS Selectors - Gravity Forms Documentation"
---
...
- [Container](https://docs.gravityforms.com/form-footer/#h-container)
- [Submit Button](https://docs.gravityforms.com/form-footer/#h-submit-button)
- [Submit Button (image)](https://docs.gravityforms.com/form-footer/#h-submit-button-image)
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_footer {``border``:``1px``solid``red``}` |

**example:** the form footer section (div) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_footer {``border``:``1px``solid``red``}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_footer input[type=submit] {``border``:``1px``solid``red``}` |

**example:** the form submit button (input) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_footer input[type=submit] {``border``:``1px``solid``red``}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_footer input[type=image] {``border``:``1px``solid``red``}` |

**example:** the form submit button (image) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_footer input[type=image] {``border``:``1px``solid``red``}` |
...
[Algolia](https://docs.gravityforms.com/form-footer/# "Algolia")
