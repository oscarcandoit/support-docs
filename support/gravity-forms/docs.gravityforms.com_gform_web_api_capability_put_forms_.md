---
url: "https://docs.gravityforms.com/gform_web_api_capability_put_forms/"
title: "gform_web_api_capability_put_forms - Gravity Forms Documentation"
---
...
# gform\_web\_api\_capability\_put\_forms

- [Description](https://docs.gravityforms.com/gform_web_api_capability_put_forms/#h-description)
- [Usage](https://docs.gravityforms.com/gform_web_api_capability_put_forms/#h-usage)
- [Example](https://docs.gravityforms.com/gform_web_api_capability_put_forms/#h-example)
- [Source Code](https://docs.gravityforms.com/gform_web_api_capability_put_forms/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_web_api_capability_put_forms'``,``function``(``$capability``) {``return``'my_custom_capability'``; } );` |
...
[Algolia](https://docs.gravityforms.com/gform_web_api_capability_put_forms/# "Algolia")
