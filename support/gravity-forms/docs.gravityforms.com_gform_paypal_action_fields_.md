---
url: "https://docs.gravityforms.com/gform_paypal_action_fields/"
title: "gform_paypal_action_fields - Gravity Forms Documentation"
---
...
# gform\_paypal\_action\_fields

- [Description](https://docs.gravityforms.com/gform_paypal_action_fields/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_action_fields/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_paypal_action_fields/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_paypal_action_fields/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_paypal_action_fields'``,``'add_paypal_options'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11 | `add_action(``'gform_paypal_action_fields'``,``'add_paypal_options'``, 10, 2 );`<br>`function``add_paypal_options(``$feed``,``$form``) {`<br>`?>`<br>`<li id=``"my_third_party_option"``>`<br>`<input type=``"checkbox"``value=``"1"``id=``"paypal_my_third_party"``name=``"paypal_my_third_party"``>`<br>`<label``for``=``"paypal_my_third_party"``class``=``"inline"``>Send transactions to My Third Party</label>`<br>`</li>`<br>`<?php`<br>`}` |

## Source Code

|     |     |
| --- | --- |
| 1 | `do_action(``'gform_paypal_action_fields'``,``$this``->get_current_feed(),``$this``->get_current_form() )` |

This filter is located in GFPayPal::settings\_options() in _class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_action_fields/# "Algolia")
