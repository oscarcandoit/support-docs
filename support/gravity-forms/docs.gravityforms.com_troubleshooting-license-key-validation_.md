---
url: "https://docs.gravityforms.com/troubleshooting-license-key-validation/"
title: "License Key Validation Troubleshooting"
---
...
- [Knowledge Base](https://docs.gravityforms.com/category/knowledge-base/)  - [Accessibility](https://docs.gravityforms.com/category/knowledge-base/accessibility/)
  ...
  - [Troubleshooting](https://docs.gravityforms.com/category/knowledge-base/troubleshooting/)    - [Checking Your Environment Details](https://docs.gravityforms.com/checking-environment-details/ "Checking Your Environment Details")
    - [Custom Logging Statements](https://docs.gravityforms.com/custom-logging-statements/ "Custom Logging Statements")
    - [Enabling No Conflict Mode](https://docs.gravityforms.com/enabling-no-conflict-mode/ "Enabling No Conflict Mode")
    - [Forcing Gravity Forms Database Upgrades](https://docs.gravityforms.com/forcing-gravity-forms-database-upgrades/ "Forcing Gravity Forms Database Upgrades")
    - [Gravity API Outage Impacts](https://docs.gravityforms.com/api-outage/ "Gravity API Outage Impacts")
    - [Logging and Debugging](https://docs.gravityforms.com/logging-and-debugging/ "Logging and Debugging")
    - [Resolving “FAILED (Temporary file could not be moved)” and “Upload folder is not writable” Errors](https://docs.gravityforms.com/resolving-failed-upload-errors/ "Resolving “FAILED (Temporary file could not be moved)” and “Upload folder is not writable” Errors")
    - [Testing for a Theme/Plugin Conflict](https://docs.gravityforms.com/testing-theme-plugin-conflict/ "Testing for a Theme/Plugin Conflict")
    - [Testing for a Theme/Plugin Conflict using the Health Check & Troubleshooting Plugin](https://docs.gravityforms.com/conflict-testing-using-health-check-plugin/ "Testing for a Theme/Plugin Conflict using the Health Check & Troubleshooting Plugin")
    - [Troubleshoot/Resolve Issues with Gravity Forms Entry Exports](https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/ "Troubleshoot/Resolve Issues with Gravity Forms Entry Exports")
    - [Troubleshooting a Missing 'Feeds' Menu Item](https://docs.gravityforms.com/troubleshooting-a-missing-feeds-menu-item/ "Troubleshooting a Missing 'Feeds' Menu Item")
    - [Troubleshooting a Missing Settings Page](https://docs.gravityforms.com/troubleshooting-missing-settings-page/ "Troubleshooting a Missing Settings Page")
    - [Troubleshooting an Empty or Incomplete Settings Page](https://docs.gravityforms.com/troubleshoot-empty-incomplete-settings-page/ "Troubleshooting an Empty or Incomplete Settings Page")
    - [Troubleshooting API Key Validation Issues](https://docs.gravityforms.com/troubleshooting-api-key-validation-issues/ "Troubleshooting API Key Validation Issues")
    - [Troubleshooting Background (async) Processing Issues](https://docs.gravityforms.com/troubleshooting-background-issues/ "Troubleshooting Background (async) Processing Issues")
    - [Troubleshooting Form Data Not Being Sent to a Service](https://docs.gravityforms.com/troubleshoot-form-data-not-sent-to-service/ "Troubleshooting Form Data Not Being Sent to a Service")
    - [Troubleshooting Form Submission Performance](https://docs.gravityforms.com/troubleshooting-form-submission-performance/ "Troubleshooting Form Submission Performance")
    - [Troubleshooting Issues with Calculation Results](https://docs.gravityforms.com/troubleshooting-issues-with-calculation-results/ "Troubleshooting Issues with Calculation Results")
    - [Troubleshooting Issues with Gravity Forms Download and Signature Links](https://docs.gravityforms.com/troubleshooting-issues-with-gravity-forms-download-links/ "Troubleshooting Issues with Gravity Forms Download and Signature Links")
    - [Troubleshooting license key validation errors](https://docs.gravityforms.com/troubleshooting-license-key-validation/ "Troubleshooting license key validation errors")
    - [Troubleshooting Payment Feeds Not Processing](https://docs.gravityforms.com/troubleshooting-payment-feeds-not-processing/ "Troubleshooting Payment Feeds Not Processing")
    - [Troubleshooting Scheduled Events](https://docs.gravityforms.com/troubleshooting-scheduled-events/ "Troubleshooting Scheduled Events")
    - [Troubleshooting The HubSpot Tracking Cookie](https://docs.gravityforms.com/troubleshooting-the-hubspot-tracking-cookie/ "Troubleshooting The HubSpot Tracking Cookie")
...
- [Summary](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-summary)
- [Areas To Troubleshoot](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-areas-to-troubleshoot)
- [Check your License Key](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-check-your-license-key)
- [Try a Different Browser](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-try-a-different-browser)
- [Check the Revoked Sites List](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-check-the-revoked-sites-list)
- [Check your Gravity Forms version](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-check-your-gravity-forms-version)
- [Check the PHP version](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-check-the-php-version)
- [Check that cURL is enabled](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-check-that-curl-is-enabled)
- [Check the OpenSSL version](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-check-the-openssl-version)
- [Enable Logging and Open a Ticket](https://docs.gravityforms.com/troubleshooting-license-key-validation/#h-enable-logging-and-open-a-ticket)

## Summary

This article describes what to check when your Gravity Forms license key will not validate. There are a number of checks you can perform to confirm your license key is correct, and that you have proper connectivity from your website host to our licensing server in order to obtain proper validation.

![](https://docs.gravityforms.com/wp-content/uploads/2022/04/invalid-license-key-1024x337.png)_Sample Error Message: The license key entered is incorrect; please visit the Gravity Forms website to verify your license._

If you are receiving a more specific error than the “incorrect” one as listed above, then you can find more information on those this in this knowledge base article: [List of Gravity Forms license key validation errors](https://docs.gravityforms.com/license-key-validation-errors/).

**Note:** This article refers to validating your Gravity Forms license key. Please see [this article](https://docs.gravityforms.com/troubleshooting-api-key-validation-issues/) if you’re having trouble validating the API keys needed to create a connection from an official Gravity Forms Add-On to an external service.

## Areas To Troubleshoot

### Check your License Key

Be sure that the license key you are trying to use is correct. Double-check your [licenses page](https://www.gravityforms.com/my-account/licenses/) to ensure that the license key you are using is valid, and that you have all 32 characters of the license key, with no extra characters.

### Try a Different Browser

Browser autocomplete and password managers can interfere with the license key being saved. Try a different browser or disable the password manager temporarily to ensure you can paste in your license key without interference. You can also try with an incognito browser or anonymous browser session.

### Check the Revoked Sites List

From [your licenses](https://www.gravityforms.com/my-account/licenses/) page, click the “ **Manage License**” button and follow the **Your Revoked Sites** link. If your website URL is listed here, you won’t be able to validate this license key on the website. Follow [these instructions](https://docs.gravityforms.com/find-sites-using-license-key/#h-removing-a-site-from-the-revoked-list) to remove a site from your Revoked site list.

### Check your Gravity Forms version

Older versions of Gravity Forms may not be able to contact our licensing server due to changes in license validation as the product has matured. If you have an older version of Gravity Forms installed and have recently purchased a new key, you may find that the license key cannot be validated automatically, which will stop you from being able to update Gravity Forms. In this case, [follow these instructions to update your Gravity Forms software manually](https://docs.gravityforms.com/how-to-manually-update/), then attempt the license key validation again.

### Check the PHP version

Gravity Forms has the same PHP version requirements as WordPress. You can find the WordPress PHP and hosting requirements [here](https://wordpress.org/about/requirements/). You will find the PHP version in use on your site on the Forms → System Status page, in the PHP section (see [item 1](https://docs.gravityforms.com/troubleshooting-license-key-validation/#php-version-info) in the image below.)

There is no “correct” version of PHP, but if your PHP version is old, or your PHP version is up to date, but your libraries are old, you may have trouble validating your license key. If you have any question about the PHP version causing your license validation issue, please [open a support ticket](https://www.gravityforms.com/open-support-ticket/technical/).

### Check that cURL is enabled

Gravity Forms and WordPress rely on the PHP cURL library to communicate with external websites. If cURL is not enabled on your web server, your website will not be able to communicate with our licensing server, and your license key will not be validated.

You can check to see if cURL is enabled in the System Status report, in the PHP section (see [item 2](https://docs.gravityforms.com/troubleshooting-license-key-validation/#php-version-info) in the image below.)

### Check the OpenSSL version

There is no “correct” version of the OpenSSL library, but an out-of-date OpenSSL library may be unable to securely connect to the Gravity Forms licensing server. You can find the OpenSSL library version in the System Status report, in the PHP section (see [item 3](https://docs.gravityforms.com/troubleshooting-license-key-validation/#php-version-info) in the image below.)

If the OpenSSL library version is significantly older than your PHP version, ( _e.g PHP version is less than six months old, but the OpenSSL library is five years old_) then you may not be able to validate the Gravity Forms license key on your website. If you have any question about the OpenSSL version causing your license validation issue, please [contact support](https://www.gravityforms.com/open-support-ticket/technical/).

![](https://docs.gravityforms.com/wp-content/uploads/2022/04/PHP-1024x697.png)The PHP information section of the Gravity Forms System Status Report

## Enable Logging and Open a Ticket

If you are unable to find the source of the issue in these troubleshooting steps, you can use the [Gravity Forms logging](https://docs.gravityforms.com/logging-and-debugging/) functionality.

1. [Enable logging](https://docs.gravityforms.com/logging-and-debugging/#h-enabling-logging) for Gravity Forms Core.
2. Attempt to add and **save** the license key to your **Forms → Settings** page.
3. To go **Forms → Settings → System Status > Updates**, loading this page will force a refresh of the validation cache. And go to **Forms → Settings** again.
4. If the license key cannot be validated, you can view the Gravity Forms Core log by going to **Forms → Settings → Logging** and clicking the “view log” link under Gravity Forms Core.
5. If you’re not able to identify the issue within the Gravity Forms Core log, please open a [support ticket](https://www.gravityforms.com/open-support-ticket/technical/) and be sure to include your [System Status report](https://docs.gravityforms.com/checking-environment-details/#h-sending-system-reports). That report will contain a **link** to the log file we need in order to help you with your license validation issue.

**Please note:** disabling logging will delete the log files, so please leave logging enabled until we are done troubleshooting.

![](https://docs.gravityforms.com/wp-content/uploads/2022/04/validated-1024x339.png)Your license key has been successfully validated.
...
[Algolia](https://docs.gravityforms.com/troubleshooting-license-key-validation/# "Algolia")
