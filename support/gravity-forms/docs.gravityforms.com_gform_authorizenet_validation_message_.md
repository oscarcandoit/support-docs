---
url: "https://docs.gravityforms.com/gform_authorizenet_validation_message/"
title: "gform_authorizenet_validation_message - Gravity Forms"
---
...
# gform\_authorizenet\_validation\_message

- [Description](https://docs.gravityforms.com/gform_authorizenet_validation_message/#h-description)
- [Usage](https://docs.gravityforms.com/gform_authorizenet_validation_message/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_authorizenet_validation_message/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_authorizenet_validation_message/#h-examples)
- [1\. Use the Authorize.net Response Reason Text](https://docs.gravityforms.com/gform_authorizenet_validation_message/#h-1-use-the-authorize-net-response-reason-text)
- [Placement](https://docs.gravityforms.com/gform_authorizenet_validation_message/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_authorizenet_validation_message/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_authorizenet_validation_message'``,``'your_function_name'``, 10, 5 );` |
...
- **$validation\_result** [array](https://docs.gravityforms.com/array)
...
- **$response** [object](https://docs.gravityforms.com/object)

The response from Authorize.net.

- **$responsetype** [string](https://docs.gravityforms.com/string)

The type of response. _Possible values: arb or aim._
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_authorizenet_validation_message'``,``function``(``$message``,``$validation_result``,``$post``,``$response``,``$responsetype``) {`<br>```$message``=``$response``->response_reason_text;`<br>```return``$message``;`<br>`}, 10, 5 );` |
...
This filter is located in GFAuthorizeNet::authorize() and GFAuthorizeNet::subscribe() in _class-gf-authorizenet.php_
...
[Algolia](https://docs.gravityforms.com/gform_authorizenet_validation_message/# "Algolia")
