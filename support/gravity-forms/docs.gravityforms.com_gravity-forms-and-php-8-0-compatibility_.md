---
url: "https://docs.gravityforms.com/gravity-forms-and-php-8-0-compatibility/"
title: "Gravity Forms and PHP 8.0 Compatibility - Gravity Forms Documentation"
---
...
- [Compatibility](https://docs.gravityforms.com/gravity-forms-and-php-8-0-compatibility/#h-compatibility)
- [Reporting Issues](https://docs.gravityforms.com/gravity-forms-and-php-8-0-compatibility/#h-reporting-issues)
- [Known Issues](https://docs.gravityforms.com/gravity-forms-and-php-8-0-compatibility/#h-known-issues)
- [Updates](https://docs.gravityforms.com/gravity-forms-and-php-8-0-compatibility/#h-updates)

## Compatibility

PHP 8.0 is a [major new release](https://www.php.net/releases/8.0/en.php) of the PHP language with many changes.

WordPress is working towards full compatibility [with PHP 8.0](https://make.wordpress.org/core/2020/11/23/wordpress-and-php-8-0/), but has ascertained a “beta-compatible” status. With that, the Gravity Forms product team have also been working on compatiblity with all known issues resolved.

Related: [Gravity Forms and PHP 8.1 Compatibility](https://docs.gravityforms.com/gravity-forms-and-php-8-1-compatibility/)

## Reporting Issues

If you think you have discovered a PHP 8.0 related issue with a Gravity Forms product in your own testing, please let us know by [contacting Support](http://gravityforms.com/support). Thank you for contributing!

## Known Issues

The following issues are known to the team:

- _version\_compare()_ fatal error in _gravityforms.php_ – Fixed in 2.4.23.
- Unknown named parameter fatal error in _class-gf-addon.php_ when enqueueing scripts – Fixed in 2.4.23.
...
- _usort()_ returning bool from comparison function is deprecated notice in _form\_list.php_ – Fixed in 2.4.23.
- Uncaught ValueError: _array\_combine()_: Argument #1 ($keys) and argument #2 ($values) must have the same number of elements in _class-gf-field-date.php_ – Fixed in 2.5.16.3.
...
[Algolia](https://docs.gravityforms.com/gravity-forms-and-php-8-0-compatibility/# "Algolia")
