---
url: "https://docs.gravityforms.com/gform_helpscout_process_note_shortcodes/"
title: "gform_helpscout_process_note_shortcodes - Gravity Forms"
---
...
# gform\_helpscout\_process\_note\_shortcodes

- [Description](https://docs.gravityforms.com/gform_helpscout_process_note_shortcodes/#h-description)
- [Usage](https://docs.gravityforms.com/gform_helpscout_process_note_shortcodes/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_helpscout_process_note_shortcodes/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_helpscout_process_note_shortcodes/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_helpscout_process_note_shortcodes/#h-placement)
- [Since](https://docs.gravityforms.com/gform_helpscout_process_note_shortcodes/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_helpscout_process_note_shortcodes/#h-source-code)

## Description

The “gform\_helpscout\_process\_note\_shortcodes” filter in the Help Scout Add-On for Gravity Forms indicates whether shortcodes should be processed in the notes.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_helpscout_process_note_shortcodes'``,``'your_function_name'``, 10, 3 );` |

To target a specific form, append the form id to the hook name. (format: gform\_helpscout\_process\_note\_shortcodes\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_helpscout_process_note_shortcodes_1'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$process\_shortcodes** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_helpscout_process_note_shortcodes'``,``'process_note_sc'``, 10, 3 );`<br>`function``process_note_sc(``$process_shortcodes``,``$form``,``$feed``){`<br>```return``false;`<br>`}` |
...
This filter is located in GFHelpScout::process\_feed() in _gravityformshelpscout/class-gf-helpscout.php_.
...
[Algolia](https://docs.gravityforms.com/gform_helpscout_process_note_shortcodes/# "Algolia")
