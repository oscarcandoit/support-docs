---
url: "https://docs.gravityforms.com/gf_field_option/"
title: "GF_Field_Option - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_option/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_option/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_option/#h-settings)
- [Source Code](https://docs.gravityforms.com/gf_field_option/#h-source-code)

## Introduction

The GF\_Field\_Option class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for handling the Option field. Because Option fields are either a Drop Down, Radio Button, or Checkbox, this class only adds some settings and sets the title for the field in the editor. The rendering of the Option field is handled by the class associated with its sub-type. The field “type” property will be set to “option” and the field “inputType” property will be “select”, “radio”, or “checkbox”.
...
Checkboxes – [GF\_Field\_Checkbox](https://docs.gravityforms.com/gf_field_checkbox) class
...
The source code is located in _includes/fields/class-gf-field-option.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_option/# "Algolia")
