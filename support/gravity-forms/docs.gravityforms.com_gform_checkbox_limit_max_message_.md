---
url: "https://docs.gravityforms.com/gform_checkbox_limit_max_message/"
title: "gform_checkbox_limit_max_message - Gravity Forms Documentation"
---
...
# gform\_checkbox\_limit\_max\_message

- [Description](https://docs.gravityforms.com/gform_checkbox_limit_max_message/#h-description)
- [Usage](https://docs.gravityforms.com/gform_checkbox_limit_max_message/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_checkbox_limit_max_message/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_checkbox_limit_max_message/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_checkbox_limit_max_message/#h-placement)
- [Since](https://docs.gravityforms.com/gform_checkbox_limit_max_message/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_checkbox_limit_max_message/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_checkbox_limit_max_message'``,``'max_message'``, 10, 3 );`<br>`function``max_message(``$message``,``$number``,``$field``) {`<br>```return``'You cannot choose more than '``.``$number``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_checkbox_limit_max_message/# "Algolia")
