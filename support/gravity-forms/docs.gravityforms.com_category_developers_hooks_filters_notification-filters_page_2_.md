---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/page/2/"
title: "Notification Filters Archives - Page 2 of 3 - Gravity Forms Documentation - Page 2 of 3"
---
...
[**gform\_notification\_services** \\
Description.](https://docs.gravityforms.com/gform_notification_services/ "gform_notification_services") [**gform\_notification\_ui\_settings** \\
This filter has been deprecated. Use the gform\_notification\_settings\_fields filter instead.](https://docs.gravityforms.com/gform_notification_ui_settings/ "gform_notification_ui_settings") [**gform\_notification\_events** \\
Use this filter to add a new event to the drop down of available triggers for notifications. Additional code is necessary to handle the event since this hook only adds it to the Event drop down on the notifications admin page.](https://docs.gravityforms.com/gform_notification_events/ "gform_notification_events") [**gform\_pre\_notification\_save** \\
Description.](https://docs.gravityforms.com/gform_pre_notification_save/ "gform_pre_notification_save") [**gform\_notification\_actions** \\
Description.](https://docs.gravityforms.com/gform_notification_actions/ "gform_notification_actions") [**gform\_notification** \\
Modify a notification object before it is converted into an email and sent.](https://docs.gravityforms.com/gform_notification/ "gform_notification") [**gform\_is\_valid\_notification\_to** \\
Description.](https://docs.gravityforms.com/gform_is_valid_notification_to/ "gform_is_valid_notification_to") [**gform\_entry\_meta\_conditional\_logic\_notifications** \\
Enables the entry meta conditional logic filters to be modified on the notification edit page.](https://docs.gravityforms.com/gform_entry_meta_conditional_logic_notifications/ "gform_entry_meta_conditional_logic_notifications") [**gform\_disable\_notification** \\
Use this filter to disable admin and user notification emails.](https://docs.gravityforms.com/gform_disable_notification/ "gform_disable_notification") [**gform\_default\_notification** \\
Use this filter to disable the default admin notification automatically generated for new forms.](https://docs.gravityforms.com/gform_default_notification/ "gform_default_notification") [Previous](https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/) [1](https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/) 2 [3](https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/page/3/) [Next](https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/page/3/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/notification-filters/page/2/# "Algolia")
