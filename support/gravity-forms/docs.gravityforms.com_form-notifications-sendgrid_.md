---
url: "https://docs.gravityforms.com/form-notifications-sendgrid/"
title: "Sending Form Notifications Using SendGrid - Gravity Forms"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [SendGrid Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/sendgrid-add-on/)    - [Generating Your SendGrid API Key](https://docs.gravityforms.com/sendgrid-api-key/ "Generating Your SendGrid API Key")
    - [Setting Up the SendGrid Add-On](https://docs.gravityforms.com/setting-up-the-sendgrid-add-on/ "Setting Up the SendGrid Add-On")
    - [Sending Form Notifications Using SendGrid](https://docs.gravityforms.com/form-notifications-sendgrid/ "Sending Form Notifications Using SendGrid")
    - [SendGrid Changelog](https://docs.gravityforms.com/sendgrid-change-log/ "SendGrid Changelog")
...
- [Pre-Requisites](https://docs.gravityforms.com/form-notifications-sendgrid/#h-pre-requisites)
- [Configuring Notifications](https://docs.gravityforms.com/form-notifications-sendgrid/#h-configuring-notifications)
...
Make sure you have completed the steps in this article to ensure you have [setup the SendGrid Add-On](https://docs.gravityforms.com/setting-up-the-sendgrid-add-on/).
...
2. Within your notification, you should see a setting labeled **Email Service**. Within this setting, select the **SendGrid** option.
3. Continue setting up your notification like usual. For more information, see our article on [configuring notifications in Gravity Forms.](https://docs.gravityforms.com/configuring-notifications-in-gravity-forms/)
4. Save your settings.

[![SendGrid Notifications Settings Name](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-09-at-14.28.34.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-09-at-14.28.34.png)
...
[Algolia](https://docs.gravityforms.com/form-notifications-sendgrid/# "Algolia")
