---
url: "https://docs.gravityforms.com/gform_is_encrypted_field/"
title: "gform_is_encrypted_field - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_is_encrypted_field/#h-description)
- [Usage](https://docs.gravityforms.com/gform_is_encrypted_field/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_is_encrypted_field/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_is_encrypted_field/#h-example)
- [Placement](https://docs.gravityforms.com/gform_is_encrypted_field/#h-placement)
- [Since](https://docs.gravityforms.com/gform_is_encrypted_field/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_is_encrypted_field/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_is_encrypted_field'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$is\_encrypted** [string](https://docs.gravityforms.com/string)
Defaults to ”
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_is_encrypted_field'``,``'not_encrypted'``, 10, 3 );`<br>`function``not_encrypted(``$is_encrypted``,``$entry_id``,``$field_id``){`<br>```return``false;`<br>`}` |
...
GFFormsModel::is\_encrypted\_field() in _forms\_model.php_

GFFormsModel::is\_openssl\_encrypted\_field() in _forms\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_is_encrypted_field/# "Algolia")
