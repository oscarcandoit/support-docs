---
url: "https://docs.gravityforms.com/category/knowledge-base/page/7/"
title: "Knowledge Base Archives - Page 7 of 18 - Gravity Forms Documentation - Page 7 of 18"
---
...
This document contains a list of known issues and limitations for the Gravity Forms 2.5 Beta releases. This list is not considered exhaustive, but will be updated periodically during the beta period.](https://docs.gravityforms.com/gravity-forms-2-5-known-limitations/ "Gravity Forms 2.5 Known Limitations") [**Gravity Forms 2.5 Release FAQ** \\
This article covers common questions about the Gravity Forms 2.5 rollout.](https://docs.gravityforms.com/gravity-forms-2-5-faq/ "Gravity Forms 2.5 Release FAQ") [**Gravity Forms 2.7 Key Features** \\
A summary of major features, and release notes for the beta release of Gravity Forms 2.7.](https://docs.gravityforms.com/gravity-forms-2-7-beta-features/ "Gravity Forms 2.7 Key Features") [**Gravity Forms and PHP 8.0 Compatibility** \\
This article describes the current status of efforts to confirm compatibility of Gravity Forms products with the new PHP 8 major release.](https://docs.gravityforms.com/gravity-forms-and-php-8-0-compatibility/ "Gravity Forms and PHP 8.0 Compatibility") [**Gravity Forms and PHP 8.1 Compatibility** \\
This article describes the current status of efforts to confirm compatibility of Gravity Forms products with the new PHP 8.1 major release.](https://docs.gravityforms.com/gravity-forms-and-php-8-1-compatibility/ "Gravity Forms and PHP 8.1 Compatibility") [**Gravity Forms and PHP 8.2 Compatibility** \\
This article describes the current status of efforts to confirm compatibility of Gravity Forms products with the new PHP 8.2 major release.](https://docs.gravityforms.com/gravity-forms-and-php-8-2-compatibility/ "Gravity Forms and PHP 8.2 Compatibility") [**Gravity Forms and PHP 8.3 Compatibility** \\
This article describes the current status of efforts to confirm compatibility of Gravity Forms products with the new PHP 8.3 major release.](https://docs.gravityforms.com/gravity-forms-and-php-8-3-compatibility/ "Gravity Forms and PHP 8.3 Compatibility") [**Gravity Forms and PHP 8.4 Compatibility** \\
This article describes the current status of efforts to confirm compatibility of Gravity Forms products with the new PHP 8.4 major release.](https://docs.gravityforms.com/gravity-forms-and-php-8-4-compatibility/ "Gravity Forms and PHP 8.4 Compatibility") [**Gravity Forms and PHP 8.5 Compatibility** \\
This article describes the current status of efforts to confirm compatibility of Gravity Forms products with the new PHP 8.5 major release.](https://docs.gravityforms.com/php-8-5-compatibility/ "Gravity Forms and PHP 8.5 Compatibility") [**Gravity Forms Changelog** \\
View the Gravity Forms change log.](https://docs.gravityforms.com/gravityforms-change-log/ "Gravity Forms Changelog") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/6/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [5](https://docs.gravityforms.com/category/knowledge-base/page/5/) [6](https://docs.gravityforms.com/category/knowledge-base/page/6/) 7 [8](https://docs.gravityforms.com/category/knowledge-base/page/8/) [9](https://docs.gravityforms.com/category/knowledge-base/page/9/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/8/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/7/# "Algolia")
