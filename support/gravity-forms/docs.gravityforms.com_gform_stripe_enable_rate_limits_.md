---
url: "https://docs.gravityforms.com/gform_stripe_enable_rate_limits/"
title: "gform_stripe_enable_rate_limits - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_stripe_enable_rate_limits/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_enable_rate_limits/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_enable_rate_limits/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_stripe_enable_rate_limits/#h-example)
- [Placement](https://docs.gravityforms.com/gform_stripe_enable_rate_limits/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_enable_rate_limits/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_enable_rate_limits/#h-source-code)
...
Error rate limiting is implemented to prevent your forms that use the Stripe Add-On from being used for card testing (“ [carding](https://stripe.com/resources/more/what-is-carding-how-this-type-of-fraud-works-and-how-businesses-can-prevent-it)“). If you disable error rate limiting in a production environment, you leave yourself open to processing transactions for stolen credit cards, which may lead to more credit card disputes.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_enable_rate_limits'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$has\_error** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_enable_rate_limits'``,``'__return_false'``);` |
...
[Algolia](https://docs.gravityforms.com/gform_stripe_enable_rate_limits/# "Algolia")
