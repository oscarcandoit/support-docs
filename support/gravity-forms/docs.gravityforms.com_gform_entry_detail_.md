---
url: "https://docs.gravityforms.com/gform_entry_detail/"
title: "gform_entry_detail - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_entry_detail/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_detail/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entry_detail/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_entry_detail/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_entry_detail/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_entry_detail/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_action(``'gform_entry_detail'``,``'add_to_details'``, 10, 2 );`<br>`function``add_to_details(``$form``,``$entry``) {`<br>```if``(``$form``[``'id'``] == 31 ) {`<br>```echo``'<div>This hook is used to add additional information to the details page for an entry.</div>'``;`<br>```}`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_detail/# "Algolia")
