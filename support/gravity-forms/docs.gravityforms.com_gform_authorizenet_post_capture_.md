---
url: "https://docs.gravityforms.com/gform_authorizenet_post_capture/"
title: "gform_authorizenet_post_capture - Gravity Forms Documentation"
---
...
# gform\_authorizenet\_post\_capture

- [Description](https://docs.gravityforms.com/gform_authorizenet_post_capture/#h-description)
- [Usage](https://docs.gravityforms.com/gform_authorizenet_post_capture/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_authorizenet_post_capture/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_authorizenet_post_capture/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_authorizenet_post_capture/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_authorizenet_post_capture/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_authorizenet_post_capture'``,``'your_function_name'``, 10, 6 )` |

## Parameters

- **$is\_authorized** [bool](https://docs.gravityforms.com/bool)
...
- **$config** [Feed Object](https://docs.gravityforms.com/feed-object)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_authorizenet_post_capture'``,``'notify_of_capture'``, 10, 6 );`<br>`function``notify_of_capture(``$is_authorized``,``$amount``,``$entry``,``$form``,``$config``,``$response``){`<br>```GFCommon::send_email(``'test@rocketgenius.com'``,``'test@rocketgenius.com'``,``''``,``''``,``'testing'``,``'Funds were captured.'``);`<br>`}` |
...
This filter is located in GFAuthorizeNet::process\_capture() in _gravityformsauthorizenet/class-gf-authorizenet.php_.
...
[Algolia](https://docs.gravityforms.com/gform_authorizenet_post_capture/# "Algolia")
