---
url: "https://docs.gravityforms.com/obtaining-prior-versions-of-gravity-forms/"
title: "Get Prior Versions of Gravity Forms"
---
...
Commonly, issues you may be experiencing after an update can be due to a [conflict with a theme or plugin](https://docs.gravityforms.com/conflict-testing-using-health-check-plugin/), or may already have been corrected with a hotfix release. For this reason, [opening a ticket with the Support Team](https://gravityforms.com/support/) to check may be a better initial option than starting a downgrade process.

We always recommend running the most up-to-date version of Gravity Forms and it’s add-ons, to guard against security vulnerabilities, known bugs, and ensuring compatibility with WordPress core. Check out this article for more on [the importance of staying up to date](https://docs.gravityforms.com/the-importance-of-updates/).

If you do need access to a prior version of Gravity Forms for testing or other purposes, please identify what you need and why in [your Support request](https://gravityforms.com/support/) so we can review your issue. Note that providing access to previous versions is not guaranteed, and will be evaluated by the Support team on a case-by-case basis.
...
[Algolia](https://docs.gravityforms.com/obtaining-prior-versions-of-gravity-forms/# "Algolia")
