---
url: "https://docs.gravityforms.com/gform_plupload_settings/"
title: "gform_plupload_settings - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_plupload_settings/#h-description)
- [Usage](https://docs.gravityforms.com/gform_plupload_settings/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_plupload_settings/#h-examples)
- [1\. Maximum File Size](https://docs.gravityforms.com/gform_plupload_settings/#h-1-maximum-file-size)
- [2\. The uploader URL](https://docs.gravityforms.com/gform_plupload_settings/#h-2-the-uploader-url)
- [Placement](https://docs.gravityforms.com/gform_plupload_settings/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_plupload_settings/#h-source-code)

## Description

The filter gform\_pluploads\_settings allows the initialization settings (file size, file count, browse button, drag and drop, and more) for Plupload to be changed. Plupload is used when the allow multiple files option is enabled.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_plupload_settings'``,``'your_function_name'``, 10, 3 );` |

To limit the scope of your function to a specific form, append the form id to the end of the hook name. (format: gform\_plupload\_settings\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_plupload_settings_75'``,``'init_plupload_settings'``, 10, 3 );` |

## Parameters

- **$settings** [array](https://docs.gravityforms.com/array)
...
- **$field** [GF\_Field\_Fileupload](https://docs.gravityforms.com/gf_field_fileupload)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_plupload_settings'``,``'init_plupload_settings'``, 10, 3 );`<br>`function``init_plupload_settings(``$settings``,``$form_id``,``$field``){`<br>`$settings``[``'filters'``][``'max_file_size'``] =``'100kb'``;`<br>`return``$settings``;`<br>`}` |

### 2\. The uploader URL

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_plupload_settings'``,``function``(``$settings``,``$form_id``,``$field``){`<br>`$settings``[``'url'``] = trailingslashit( site_url() ) .``'?gf_page='``. GFCommon::get_upload_page_slug();`<br>`return``$settings``;`<br>`}, 10, 3 );` |
...
This filter is located in GF\_Field\_FileUpload::get\_field\_input() in _includes/fields/class-gf-field-fileupload.php_.
...
[Algolia](https://docs.gravityforms.com/gform_plupload_settings/# "Algolia")
