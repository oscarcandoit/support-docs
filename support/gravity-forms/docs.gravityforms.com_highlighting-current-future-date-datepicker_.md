---
url: "https://docs.gravityforms.com/highlighting-current-future-date-datepicker/"
title: "Highlighting Current/Future Date In Datepicker - Gravity Forms"
---
...
- [Introduction](https://docs.gravityforms.com/highlighting-current-future-date-datepicker/#h-introduction)
- [Snippet](https://docs.gravityforms.com/highlighting-current-future-date-datepicker/#h-snippet)
- [Placement](https://docs.gravityforms.com/highlighting-current-future-date-datepicker/#h-placement)

## Introduction

If you need to highlight a current or future date within the datepicker, here’s a code snippet to do it.

**Note**: You’ll need to replace _#input\_1\_20_ with a selector for your field.

## Snippet

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12 | `jQuery.noConflict();`<br>`jQuery(document).ready(``function``($) {`<br>```$(``"#input_1_20"``).datepicker({`<br>```defaultDate:``'+7d'``,`<br>```minDate:``'+7d'``,`<br>```gotoCurrent:``true``,`<br>```prevText:``''``,`<br>```showOn:``'both'``,`<br>```buttonImage:``'https://s22280.pcdn.co/wp-content/plugins/gravityforms/images/calendar.png'``,`<br>```buttonImageOnly:``true`<br>```});`<br>`});` |
...
[Algolia](https://docs.gravityforms.com/highlighting-current-future-date-datepicker/# "Algolia")
