---
url: "https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/"
title: "gform_signature_delete_file_pre_delete_entry - Gravity Forms"
---
...
- [Description](https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/#h-description)
- [Usage](https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/#h-placement)
- [Since](https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_signature_delete_file_pre_delete_entry'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$delete\_file** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `//keep signature`<br>`add_filter(``'gform_signature_delete_file_pre_delete_entry'``,``'keep_signature'``, 10, 4 );`<br>`function``keep_signature(``$delete_file``,``$form``,``$entry_id``,``$field_id``){`<br>```return``false;`<br>`}` |
...
This filter is located in GFSignature::delete\_entry() in _class-gf-signature.php_.
...
[Algolia](https://docs.gravityforms.com/gform_signature_delete_file_pre_delete_entry/# "Algolia")
