---
url: "https://docs.gravityforms.com/gform_emma_verifypeer/"
title: "gform_emma_verifypeer - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Emma Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/emma-filters/)          - [Emma Feed Meta](https://docs.gravityforms.com/emma-feed-meta/ "Emma Feed Meta")
          - [gform\_emma\_field\_value](https://docs.gravityforms.com/gform_emma_field_value/ "gform_emma_field_value")
          - [gform\_emma\_verifypeer](https://docs.gravityforms.com/gform_emma_verifypeer/ "gform_emma_verifypeer")
...
- [Description](https://docs.gravityforms.com/gform_emma_verifypeer/#h-description)
- [Usage](https://docs.gravityforms.com/gform_emma_verifypeer/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_emma_verifypeer/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_emma_verifypeer/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_emma_verifypeer/#h-placement)
- [Since](https://docs.gravityforms.com/gform_emma_verifypeer/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_emma_verifypeer/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_emma_verifypeer'``,``'your_function_name'``);` |

## Parameters

- **$is\_enabled** [bool](https://docs.gravityforms.com/bool)

Indicates if the CURLOPT\_SSL\_VERIFYPEER option is enabled, which allows peer verification to be bypassed. True enables peer verification, false bypasses peer verification.

## Examples

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_emma_verifypeer'``,``'__return_false'``);` |
...
This filter is located in Emma::\_verify\_peer() in _includes/api/Emma.php_.
...
[Algolia](https://docs.gravityforms.com/gform_emma_verifypeer/# "Algolia")
