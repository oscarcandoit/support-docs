---
url: "https://docs.gravityforms.com/gform_is_entry_detail/"
title: "gform_is_entry_detail - Gravity Forms Documentation"
---
...
# gform\_is\_entry\_detail

- [Description](https://docs.gravityforms.com/gform_is_entry_detail/#h-description)
- [Usage](https://docs.gravityforms.com/gform_is_entry_detail/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_is_entry_detail/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_is_entry_detail/#h-example)
- [Placement](https://docs.gravityforms.com/gform_is_entry_detail/#h-placement)
- [Since](https://docs.gravityforms.com/gform_is_entry_detail/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_is_entry_detail/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_is_entry_detail'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$is\_entry\_detail** [bool](https://docs.gravityforms.com/bool)
Whether the current page is the Entry Detail Edit (entry\_detail\_edit) page or the Entry Edit (entry\_detail) page.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_is_entry_detail'``,``'set_entry_edit'``, 10, 1 );`<br>`function``set_entry_edit(``$is_entry_detail``){`<br>```return``false;`<br>`}` |
...
This filter is located in GFCommon::is\_entry\_detail() in _common.php_.
...
[Algolia](https://docs.gravityforms.com/gform_is_entry_detail/# "Algolia")
