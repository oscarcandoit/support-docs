---
url: "https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/"
title: "Troubleshoot/Resolve Issues with Gravity Forms Entry Exports"
---
...
- [Test for a conflict](https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/#h-test-for-a-conflict)
- [Increase available PHP memory](https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/#h-increase-available-php-memory)
- [Increase the PHP max execution time](https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/#h-increase-the-php-max-execution-time)
- [Make multiple smaller exports](https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/#h-make-multiple-smaller-exports)
- [Check permissions and ownership](https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/#h-check-permissions-and-ownership)
- [The sanitize\_file\_name filter](https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/#h-the-sanitize-file-name-filter)
...
[Increasing Your PHP Memory Limits](https://docs.gravityforms.com/increasing-php-memory-limits/)
...
[Increasing Your PHP Max Execution Time](https://docs.gravityforms.com/increasing-php-max-execution-time/)
...
For more information on selecting date ranges in your entry exports, review our article on [exporting form entries](https://docs.gravityforms.com/exporting-form-entries/).

## Check permissions and ownership

Gravity Forms will ask WordPress to use _/wp-content/uploads/gravity\_forms/export/_ folder to generate your export file. If permissions or ownership of this folder is not correctly set to allow WordPress to write files into it, the export will fail. Check the [Troubleshooting and fixing “Upload folder is not writable” Errors](https://docs.gravityforms.com/fixing-upload-folder-is-not-writable-errors/#check-folder-permissions) doc page for more details.

## The sanitize\_file\_name filter

In some cases usage of the WordPress sanitize\_file\_name filter in the theme or another plugin can cause an empty .csv file download. This usually happens when the filter is using the PHP uniqid() function to return a unique filename, this can result in the name of the temporary .csv file not matching the name the downloader is looking for.
...
|     |
| --- |
| `function``your_function_name(``$filename``) {`<br>```if``(``strpos``(``$filename``,``'export-'``) !== false ) {`<br>```return``$filename``;`<br>```}`<br>```// override the filename` |
...
[Algolia](https://docs.gravityforms.com/resolving-issues-gravity-forms-exports/# "Algolia")
