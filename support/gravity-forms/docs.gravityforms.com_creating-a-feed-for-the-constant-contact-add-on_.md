---
url: "https://docs.gravityforms.com/creating-a-feed-for-the-constant-contact-add-on/"
title: "Creating a Feed for the Constant Contact Add-On - Gravity Forms"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Constant Contact Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/constant-contact-add-on/)    - [Setting Up the Constant Contact Add-On](https://docs.gravityforms.com/constant-contact-add-on/ "Setting Up the Constant Contact Add-On")
    - [Creating a Feed for the Constant Contact Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-constant-contact-add-on/ "Creating a Feed for the Constant Contact Add-On")
    - [Migrating from the Legacy Version of the Constant Contact Add-On](https://docs.gravityforms.com/migrating-from-the-legacy-version-of-the-constant-contact-add-on/ "Migrating from the Legacy Version of the Constant Contact Add-On")
    - [Constant Contact Changelog](https://docs.gravityforms.com/constant-contact-change-log/ "Constant Contact Changelog")
...
# Creating a Feed for the Constant Contact Add-On

- [Summary](https://docs.gravityforms.com/creating-a-feed-for-the-constant-contact-add-on/#h-summary)
- [Create a Feed](https://docs.gravityforms.com/creating-a-feed-for-the-constant-contact-add-on/#h-create-a-feed)
- [Feed Settings Reference](https://docs.gravityforms.com/creating-a-feed-for-the-constant-contact-add-on/#h-feed-settings-reference)

## Summary

Before the Constant Contact Add-On can be used with Gravity Forms, you will first need to create [a feed](https://docs.gravityforms.com/what-is-a-feed/). A feed simply allows form submission data to be sent to another source. In this instance, contact data being sent to Constant Contact.

## Create a Feed

To create a feed to Constant Contact using the Constant Contact Add-On for Gravity Forms, do the following from your WordPress Admin Dashboard:

1. Click on **Forms** in the left side menu.
2. Select the form that you want to use with Constant Contact.
3. Once within your desired form, hover over **Settings** and click on **Constant Contact**.
4. Click **Add New** to create a new feed. You will be presented with the Constant Contact feed settings screen.

## Feed Settings Reference

![Constant Contact Add-On Feed Settings](https://docs.gravityforms.com/wp-content/uploads/2019/03/constant-contact-feed-settings-738x1024.png)

This table describes the feed settings options you will be offered for a Constant Contact feed.

| Setting | Description | Image Key |
| --- | --- | --- |
| **Name** | To identify your feed when viewing the feed list page. **Required** | 1 |
| **List** | Select the mailing list the subscriber will be added to from the drop down. **Required** | 2 |
| **Map Fields** | Map Constant Contact fields to the form field that will send that information. Email field is required. | 3 |
| **Custom Fields** | Map any custom fields set up in Constant Contact to the form fields that will contain that information. | 4 |
| **Conditional Logic** | If unchecked, every successful form submission will be sent to Constant Contact. If you wish to set specific conditions for sending form data to Constant Contact, then check the “Enable Condition” box and fill out your required criteria. | 5 |
...
[Algolia](https://docs.gravityforms.com/creating-a-feed-for-the-constant-contact-add-on/# "Algolia")
