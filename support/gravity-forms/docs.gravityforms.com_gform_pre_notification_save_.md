---
url: "https://docs.gravityforms.com/gform_pre_notification_save/"
title: "gform_pre_notification_save - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_pre_notification_save/#h-description)
- [Usage](https://docs.gravityforms.com/gform_pre_notification_save/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_pre_notification_save/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_pre_notification_save/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_pre_notification_save/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_pre_notification_save'``,``'your_function_name'``, 10, 2 );` |

To limit the scope of your function to a specific form, append the form id to the end of the hook name. (format: gform\_pre\_notification\_save\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_pre_notification_save_5'``,``'your_function_name'``, 10, 2 );` |
...
This example demonstrates how you can add the value entered via our [gform\_notification\_ui\_settings](https://docs.gravityforms.com/gform_notification_ui_settings) to the notification object before it is saved to the database. Use with the [gform\_notification\_ui\_settings](https://docs.gravityforms.com/gform_pre_notification_save/) hook to display your custom settings UI.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_pre_notification_save'``,``'my_custom_notification_save'``, 10, 2 );`<br>`function``my_custom_notification_save(``$notification``,``$form``) {`<br>```$notification``[``'my_custom_setting'``] = rgpost(``'my_custom_setting'``);`<br>```return``$notification``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_pre_notification_save/# "Algolia")
