---
url: "https://docs.gravityforms.com/gform_zohocrm_post_create_task/"
title: "gform_zohocrm_post_create_task - Gravity Forms Documentation"
---
...
# gform\_zohocrm\_post\_create\_task

- [Description](https://docs.gravityforms.com/gform_zohocrm_post_create_task/#h-description)
- [Usage](https://docs.gravityforms.com/gform_zohocrm_post_create_task/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_zohocrm_post_create_task/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_zohocrm_post_create_task/#h-example)
- [Since](https://docs.gravityforms.com/gform_zohocrm_post_create_task/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_zohocrm_post_create_task/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | ```{`<br>```add_action(``'gform_zohocrm_post_create_task'``,``$task_record``,``$task``,``$feed``,``$entry``,``$form``);`<br>```return``$task_id``;`<br>`}` |

## Parameters

- **$task\_record** [array](https://docs.gravityforms.com/array)
The task record.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_action(``'gform_zohocrm_post_create_task'``,``'action_after_task_creation'``, 10, 5 );`<br>```function``action_after_task_creation(``$task_record``,``$task``,``$feed``,``$entry``,``$form``) {`<br>```// Do your stuff`<br>```}` |
...
This filter is located in _class-gf-zohocrm.php_.
...
[Algolia](https://docs.gravityforms.com/gform_zohocrm_post_create_task/# "Algolia")
