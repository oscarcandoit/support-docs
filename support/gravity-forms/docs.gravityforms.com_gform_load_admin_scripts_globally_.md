---
url: "https://docs.gravityforms.com/gform_load_admin_scripts_globally/"
title: "gform_load_admin_scripts_globally - Gravity Forms Documentation"
---
...
# gform\_load\_admin\_scripts\_globally

- [Description](https://docs.gravityforms.com/gform_load_admin_scripts_globally/#h-description)
- [Usage](https://docs.gravityforms.com/gform_load_admin_scripts_globally/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_load_admin_scripts_globally/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_load_admin_scripts_globally/#h-examples)
- [1\. Disable global admin script loading](https://docs.gravityforms.com/gform_load_admin_scripts_globally/#h-1-disable-global-admin-script-loading)
- [Placement](https://docs.gravityforms.com/gform_load_admin_scripts_globally/#h-placement)
- [Since](https://docs.gravityforms.com/gform_load_admin_scripts_globally/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_load_admin_scripts_globally/#h-source-code)
...
- **$load\_scripts** [bool](https://docs.gravityforms.com/bool)

Load admin scripts globally? _Default is true._
...
This filter is located in GFForms::enqueue\_admin\_scripts() and GFForms::no\_conflict\_mode\_script() in _gravityforms.php_.
...
[Algolia](https://docs.gravityforms.com/gform_load_admin_scripts_globally/# "Algolia")
