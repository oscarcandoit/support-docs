---
url: "https://docs.gravityforms.com/gquiz_correct_indicator/"
title: "gquiz_correct_indicator - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gquiz_correct_indicator/#h-description)
- [Usage](https://docs.gravityforms.com/gquiz_correct_indicator/#h-usage)
- [Parameters](https://docs.gravityforms.com/gquiz_correct_indicator/#h-parameters)
- [Examples](https://docs.gravityforms.com/gquiz_correct_indicator/#h-examples)
- [Placement](https://docs.gravityforms.com/gquiz_correct_indicator/#h-placement)
- [Source Code](https://docs.gravityforms.com/gquiz_correct_indicator/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gquiz_correct_indicator'``,``'gquiz_correct_indicator'``);` |

## Parameters

- **$correct\_answer\_indicator\_url** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gquiz_correct_indicator'``,``'gquiz_correct_indicator'``);`<br>```function``gquiz_correct_indicator (``$correct_answer_indicator_url``){`<br>```$correct_answer_indicator_url``=``"http://mydomain.com/correct.png"``;`<br>```return``$correct_answer_indicator_url``;`<br>```}` |
...
[Algolia](https://docs.gravityforms.com/gquiz_correct_indicator/# "Algolia")
