---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/user-registration-add-on/"
title: "User Registration Add-On Archives - Gravity Forms Documentation"
---
...
In this article, we will show you how to create new network sites on a WordPress multisite, using the User Registration Add-On.](https://docs.gravityforms.com/create-new-sites-within-multisite/ "Using Gravity Forms to Create New Sites Within Multisite") [**Using the User Registration Add-On** \\
...
Step-by-step instructions on how to setup the User Registration Add-On.](https://docs.gravityforms.com/download-install-user-registration-add-on/ "Setting Up the User Registration Add-On") [**Creating a Feed for the User Registration Add-On**\\
This article contains step-by-step instructions on how to create a feed for the User Registration Add-On.](https://docs.gravityforms.com/creating-feed-user-registration-add/ "Creating a Feed for the User Registration Add-On") [**User Registration Add-On Login Widget** \\
In addition to creating or updating users, the User Registration Add-On also contains a widget which will allow users to log in and register from the front-end of your site.](https://docs.gravityforms.com/user-registration-widget/ "User Registration Add-On Login Widget") [**Login Form Shortcode** \\
...
View the change log for the UserRegistration Add-On.](https://docs.gravityforms.com/userregistration-change-log/ "User Registration Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/user-registration-add-on/# "Algolia")
