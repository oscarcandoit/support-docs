---
url: "https://docs.gravityforms.com/gform_currency/"
title: "gform_currency - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_currency/#h-description)
- [Usage](https://docs.gravityforms.com/gform_currency/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_currency/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_currency/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_currency/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_currency'``,``'your_function_name'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_currency'``,``'usd_currency'``);`<br>`function``usd_currency(``$currency``) {`<br>`return``'USD'``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `apply_filters(``'gform_currency'``,``$currency``)` |

This filter is located in GFCommon::get\_currency() in _common.php_.
...
[Algolia](https://docs.gravityforms.com/gform_currency/# "Algolia")
