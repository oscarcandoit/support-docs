---
url: "https://docs.gravityforms.com/gform_entry_list_columns/"
title: "gform_entry_list_columns - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_entry_list_columns/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_list_columns/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entry_list_columns/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_entry_list_columns/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_entry_list_columns/#h-placement)
- [Since](https://docs.gravityforms.com/gform_entry_list_columns/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_entry_list_columns/#h-source-code)

## Description

The “gform\_entry\_list\_columns” filter in Gravity Forms allows the columns set to be displayed on the Entry List page to be changed. This allows different columns to be displayed for each form.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_list_columns'``,``'your_function_name'``, 10, 2 );` |

To target a specific form, append the form id to the hook name. (format: gform\_entry\_list\_columns\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_list_columns_1'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$table\_columns** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_entry_list_columns'``,``'set_columns'``, 10, 2 );`<br>`function``set_columns(``$table_columns``,``$form_id``){`<br>```$table_columns``[``'field_id-3.3'``] =``'City'``;`<br>```return``$table_columns``;`<br>`}` |
...
This filter is located in GF\_Entry\_List\_Table::get\_columns() in _entry\_list.php_.
...
[Algolia](https://docs.gravityforms.com/gform_entry_list_columns/# "Algolia")
