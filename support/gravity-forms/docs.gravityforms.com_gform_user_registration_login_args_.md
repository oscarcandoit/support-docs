---
url: "https://docs.gravityforms.com/gform_user_registration_login_args/"
title: "gform_user_registration_login_args - Gravity Forms Documentation"
---
...
# gform\_user\_registration\_login\_args

- [Description](https://docs.gravityforms.com/gform_user_registration_login_args/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_login_args/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_login_args/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_user_registration_login_args/#h-example)
- [Placement](https://docs.gravityforms.com/gform_user_registration_login_args/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_login_args/#h-source-code)

## Description

The “gform\_user\_registration\_login\_args” filter allows the modification of the login form arguments used to create the HTML for the Gravity Forms Login Widget. This filter is used in the User Registration Add-On for Gravity Forms.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_user_registration_login_args'``,``'your_function_name'``, 10, 1 );` |
...
Potential values:
  ...
  - display\_title [boolean](https://docs.gravityforms.com/boolean)
  - display\_description [boolean](https://docs.gravityforms.com/boolean)
  - display\_lost\_password [boolean](https://docs.gravityforms.com/boolean)
  - logged\_in\_avatar [boolean](https://docs.gravityforms.com/boolean)
  - logged\_in\_links [array](https://docs.gravityforms.com/array)
  - logged\_in\_message [string](https://docs.gravityforms.com/string)
  - logged\_out\_links [array](https://docs.gravityforms.com/array)
  - login\_redirect [string](https://docs.gravityforms.com/string)
  - logout\_redirect [string](https://docs.gravityforms.com/string)
  - tabindex [int](https://docs.gravityforms.com/int)

## Example

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_user_registration_login_args'``,``'set_html_args'``, 10, 1 );`<br>`function``set_html_args(``$args``) {`<br>```$args``[``'logged_out_links'``] =``array``();`<br>```return``$args``;`<br>`}` |
...
This filter is located in GF\_User\_Registration::get\_login\_html() in _gravityformsuserregistration/class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_login_args/# "Algolia")
