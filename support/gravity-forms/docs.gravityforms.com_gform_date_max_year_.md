---
url: "https://docs.gravityforms.com/gform_date_max_year/"
title: "gform_date_max_year - Gravity Forms Documentation"
---
...
# gform\_date\_max\_year

- [Description](https://docs.gravityforms.com/gform_date_max_year/#h-description)
- [Usage](https://docs.gravityforms.com/gform_date_max_year/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_date_max_year/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_date_max_year/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_date_max_year/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_date_max_year/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_date_max_year'``,``'set_max_year'``);` |

## Parameters

- **$max\_date** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_date_max_year'``,``'set_max_year'``);`<br>`function``set_max_year(``$max_date``) {`<br>```return``2022;`<br>`}` |

This example changes the max date for a specific field on a specific form.

|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_date_max_year'``,``function``(``$max_date``,``$form``,``$field``) {`<br>```return``$form``[``'id'``] == 7 &&``$field``->id == 5 ? 2022 :``$max_date``;`<br>`}, 10, 3 );` |
...
[Algolia](https://docs.gravityforms.com/gform_date_max_year/# "Algolia")
