---
url: "https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/"
title: "gform_authorizenet_transaction_pre_capture_setup_fee - Gravity Forms"
---
...
# gform\_authorizenet\_transaction\_pre\_capture\_setup\_fee

- [Description](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/#h-description)
- [Usage](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/#h-examples)
- [1\. Modify the Amount](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/#h-1-modify-the-amount)
- [Placement](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_authorizenet_transaction_pre_capture_setup_fee'``,``'your_function_name'``, 10, 5 );` |

## Parameters

- **$transaction** [object](https://docs.gravityforms.com/object)
The Authorize.net [transaction object](http://developer.authorize.net/api/reference/#payment-transactions-charge-a-credit-card).

- **$form\_data** [Form Data](https://docs.gravityforms.com/form-data)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_filter(``'gform_authorizenet_transaction_pre_capture_setup_fee'``,``'set_fee_amount'``, 10, 4 );`<br>`function``set_fee_amount(``$transaction``,``$form_data``,``$config``,``$form``) {`<br>```if``(``$form``[``'id'``] == 10 ) {`<br>```$transaction``->amount = 50;`<br>```}`<br>```return``$transaction``;`<br>`}` |
...
This filter is located in GFAuthorizeNet::subscribe() in _class-gf-authorizenet.php_
...
[Algolia](https://docs.gravityforms.com/gform_authorizenet_transaction_pre_capture_setup_fee/# "Algolia")
