---
url: "https://docs.gravityforms.com/gform_salesforce_object_data/"
title: "gform_salesforce_object_data - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_salesforce_object_data/#h-description)
- [Usage](https://docs.gravityforms.com/gform_salesforce_object_data/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_salesforce_object_data/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_salesforce_object_data/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_salesforce_object_data/#h-placement)
- [Since](https://docs.gravityforms.com/gform_salesforce_object_data/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_salesforce_object_data/#h-source-code)
...
- **$body** [Array](https://docs.gravityforms.com/array/)

The mapped fields and values.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19 | `// Set LeadSource before sending to Salesforce for all forms`<br>`add_filter(``'gform_salesforce_object_data'``,``function``(``$body``,``$form``,``$entry``,``$feed``) {`<br>```// Log the initial state of the $body before modifications`<br>```gf_salesforce()->log_debug(``'gform_salesforce_object_data: Original Salesforce object data: '``. print_r(``$body``, true ) );`<br>```// Log form and entry IDs.`<br>```gf_salesforce()->log_debug(``'gform_salesforce_object_data: Processing form ID '``.``$form``[``'id'``] .``' and entry ID '``.``$entry``[``'id'``] );`<br>``<br>```$body``[``'LeadSource'``] =``'Website'``;`<br>```// Log the modified $body before returning it`<br>```gf_salesforce()->log_debug(``'gform_salesforce_object_data: Final Salesforce object data: '``. print_r(``$body``, true ) );`<br>```// Always return the body`<br>```return``$body``;`<br>`}, 10, 4 );` |
...
This filter is located in _class-gf-salesforce.php_.
...
[Algolia](https://docs.gravityforms.com/gform_salesforce_object_data/# "Algolia")
