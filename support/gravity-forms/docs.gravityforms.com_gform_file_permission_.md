---
url: "https://docs.gravityforms.com/gform_file_permission/"
title: "gform_file_permission - Gravity Forms Documentation"
---
...
# gform\_file\_permission

- [Description](https://docs.gravityforms.com/gform_file_permission/#h-description)
- [Usage](https://docs.gravityforms.com/gform_file_permission/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_file_permission/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_file_permission/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_file_permission/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_file_permission'``,``'set_file_permission'``, 10, 2 );` |

## Parameters

- **$permission** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_file_permission'``,``'set_file_permission'``, 10, 2 );`<br>`function``set_file_permission(``$permission``,``$path``) {`<br>```// Note the octal value with the leading zero. Don't return a string.`<br>```return``0755;`<br>`}` |

## Source Code

This filter is located in GFFormsModel::set\_permissions() in _forms\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_file_permission/# "Algolia")
