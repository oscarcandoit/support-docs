---
url: "https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/"
title: "Asynchronous Notifications Enabled? - Gravity Guide"
---
...
# gform\_is\_asynchronous\_notifications\_enabled

- [Description](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#description)
- [Usage](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#usage)
- [Parameters](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#parameters)
- [Examples](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#examples)
- [Enable for ALL forms](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#h-enable-for-all-forms)
- [Disable for ALL forms](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#h-disable-for-all-forms)
- [Enable for a specific event](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#h-enable-for-a-specific-event)
- [Placement](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#h-placement)
- [Since](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#since)
- [Source Code](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/#source-code)
...
To limit the scope of your function to a specific form, append the form id to the end of the hook name. (format: gform\_is\_asynchronous\_notifications\_enabled\_FORMID)
...
- **$is\_asynchronous** [boolean](https://docs.gravityforms.com/boolean/)
...
- **$notifications\_to\_send** [array](https://docs.gravityforms.com/array/)
...
This example shows how you can enable async (background) processing of notifications for all forms, but only for those assigned to the [Form is submitted event](https://docs.gravityforms.com/gravity-forms-notification-events/).

|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_is_asynchronous_notifications_enabled'``,``function``(``$is_asynchronous``,``$event``) {`<br>```return``$event``===``'form_submission'``;`<br>`}, 10, 2 );` |
...
This filter is located in `GFAPI::send_notifications()` in _/includes/api.php_.
...
[Algolia](https://docs.gravityforms.com/gform_is_asynchronous_notifications_enabled/# "Algolia")
