---
url: "https://docs.gravityforms.com/paragraph-text-field-2/"
title: "Paragraph Text Field CSS Selectors - Gravity Forms"
---
...
- [Container](https://docs.gravityforms.com/paragraph-text-field-2/#h-container)
- [Input](https://docs.gravityforms.com/paragraph-text-field-2/#h-input)
- [Maximum Characters Counter](https://docs.gravityforms.com/paragraph-text-field-2/#h-maximum-characters-counter)
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield .ginput_container_textarea {``border``:``1px``solid``red``}` |

**example:** paragraph text field container (div) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_body .gform_fields .gfield .ginput_container_textarea {``border``:``1px``solid``red``}` |

**example:** paragraph text field container (div) – applies just to specific indicator (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields  #field_XX_X.gfield .ginput_container_textarea {``border``:``1px``solid``red``}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield .ginput_container_textarea textarea {``color``:``red``}` |

**example:** paragraph text field (textarea) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_body .gform_fields .gfield .ginput_container_textarea textarea {``color``:``red``}` |

**example:** paragraph text field (textarea) – applies just to specific indicator (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields  #field_XX_X.gfield .ginput_container_textarea textarea {``color``:``red``}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield .ginput_container_textarea .charleft {``color``:``red``}` |

**example:** paragraph text field (textarea) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_body .gform_fields .gfield .ginput_container_textarea .charleft {``color``:``red``}` |

**example:** paragraph text field (textarea) – applies just to specific indicator (based on the unique parent element ID – replace “XX\_X” with your actual element ID)

|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields  #field_XX_X.gfield .ginput_container_textarea .charleft {``color``:``red``}` |
...
[Algolia](https://docs.gravityforms.com/paragraph-text-field-2/# "Algolia")
