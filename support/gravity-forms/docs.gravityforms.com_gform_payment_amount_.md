---
url: "https://docs.gravityforms.com/gform_payment_amount/"
title: "gform_payment_amount - Gravity Forms Documentation"
---
...
# gform\_payment\_amount

- [Description](https://docs.gravityforms.com/gform_payment_amount/#h-description)
- [Usage](https://docs.gravityforms.com/gform_payment_amount/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_payment_amount/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_payment_amount/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_payment_amount/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_payment_amount/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_payment_amount'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$payment\_amount** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_payment_amount'``,``'change_payment_amount'``, 10, 3 );`<br>`function``change_payment_amount(``$payment_amount``,``$form``,``$entry``){`<br>```return``'USD '``.``$payment_amount``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_payment_amount/# "Algolia")
