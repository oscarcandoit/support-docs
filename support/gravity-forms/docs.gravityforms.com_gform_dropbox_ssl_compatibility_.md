---
url: "https://docs.gravityforms.com/gform_dropbox_ssl_compatibility/"
title: "gform_dropbox_ssl_compatibility - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_dropbox_ssl_compatibility/#h-description)
- [Usage](https://docs.gravityforms.com/gform_dropbox_ssl_compatibility/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_dropbox_ssl_compatibility/#h-parameters)
- [Placement](https://docs.gravityforms.com/gform_dropbox_ssl_compatibility/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_dropbox_ssl_compatibility/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_dropbox_ssl_compatibility'``,``'__return_true'``);` |

## Parameters

- **$ssl\_support** [bool](https://docs.gravityforms.com/bool)
If SSL is supported. If the gravityformsaddon\_gravityformsdropbox\_ssl option is present, returns true. Otherwise, result of checks.


## Placement

This code should be placed in the [functions.php](http://codex.wordpress.org/Theme_Development#Functions_File) file of your active theme, or ideally, in its own plugin.

## Source Code

This filter is located in _dropbox.php_.
...
[Algolia](https://docs.gravityforms.com/gform_dropbox_ssl_compatibility/# "Algolia")
