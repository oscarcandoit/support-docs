---
url: "https://docs.gravityforms.com/gform_email_field_rejectable_values/"
title: "gform_email_field_rejectable_values - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-description)
- [Usage](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-examples)
- [Reject any email addresses containing the word 'testing'.](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-reject-any-email-addresses-containing-the-word-nbsp-testing)
- [Reject specific domains.](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-reject-specific-domains)
- [Reject specific addresses.](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-reject-specific-addresses)
- [Placement](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-placement)
- [Since](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_email_field_rejectable_values/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_email_field_rejectable_values'``,``'your_function_name'``, 10, 3 );` |

To limit the scope of your function to a specific form, append the form id to the end of the hook name. (format: gform\_email\_field\_rejectable\_values\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_email_field_rejectable_values_123'``,``'your_function_name'``, 10, 3 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$rejectable\_values** | array | An array of values or partial values to be rejected. |
| **$email** | string | The submitted email value being validated. |
| **$field** | GF\_Field\_Email | The email field object being validated. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_email_field_rejectable_values'``,``function``(``$values``) {`<br>```$values``[] =``'testing'``;`<br>```return``$values``;`<br>`} );` |

### Reject specific domains.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_email_field_rejectable_values'``,``function``(``$values``) {`<br>```$values``[] =``'@gmail.com'``;`<br>```$values``[] =``'@mailinator'``;`<br>```return``$values``;`<br>`} );` |

### Reject specific addresses.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_email_field_rejectable_values'``,``function``(``$values``) {`<br>```$values``[] =``'test@gmail.com'``;`<br>```return``$values``;`<br>`} );` |
...
[Algolia](https://docs.gravityforms.com/gform_email_field_rejectable_values/# "Algolia")
