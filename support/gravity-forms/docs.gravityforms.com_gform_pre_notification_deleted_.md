---
url: "https://docs.gravityforms.com/gform_pre_notification_deleted/"
title: "gform_pre_notification_deleted - Gravity Forms Documentation"
---
...
# gform\_pre\_notification\_deleted

- [Description](https://docs.gravityforms.com/gform_pre_notification_deleted/#h-description)
- [Usage](https://docs.gravityforms.com/gform_pre_notification_deleted/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_pre_notification_deleted/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_pre_notification_deleted/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_pre_notification_deleted/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_pre_notification_deleted'``,``'my_function'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `function``my_function() {`<br>```//Do something here`<br>`}`<br>`add_action(``'gform_pre_notification_deleted'``,``'my_function'``, 10, 2 );` |

## Source Code

This action hook is located in _notification.php_.
...
[Algolia](https://docs.gravityforms.com/gform_pre_notification_deleted/# "Algolia")
