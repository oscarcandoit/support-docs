---
url: "https://docs.gravityforms.com/gform_email_fields_notification_admin/"
title: "gform_email_fields_notification_admin - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Field Filters](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/)        - [Image Choice Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/image-choice-fields/)
        ...
        - [Email Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/email-filters/)          - [gform\_email](https://docs.gravityforms.com/gform_email/ "gform_email")
          - [gform\_email\_confirm](https://docs.gravityforms.com/gform_email_confirm/ "gform_email_confirm")
          - [gform\_email\_fields\_notification\_admin](https://docs.gravityforms.com/gform_email_fields_notification_admin/ "gform_email_fields_notification_admin")
...
# gform\_email\_fields\_notification\_admin

- [Description](https://docs.gravityforms.com/gform_email_fields_notification_admin/#h-description)
- [Usage](https://docs.gravityforms.com/gform_email_fields_notification_admin/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_email_fields_notification_admin/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_email_fields_notification_admin/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_email_fields_notification_admin/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_email_fields_notification_admin/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_email_fields_notification_admin'``,``'add_field_to_email_list'``, 10, 2 );` |

Applies to a specific form. In this case, form id 5.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_email_fields_notification_admin_5'``,``'add_field_to_email_list'``, 10, 2 );` |

## Parameters

- **$field\_list** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13 | `add_filter(``'gform_email_fields_notification_admin'``,``'add_field_to_email_list'``, 10, 2 );`<br>`function``add_field_to_email_list(``$field_list``,``$form``) {`<br>```//Adds field with ID=1 to the list of email fields`<br>```foreach``(``$form``[``'fields'``]``as``$field``) {`<br>```if``(``$field``->id ==``'1'``) {`<br>```$field_list``[] =``$field``;`<br>```break``;`<br>```}`<br>```}`<br>```return``$field_list``;`<br>`}` |
...
This filter is located in GFNotification::get\_notification\_ui\_settings() in _notification.php_.
...
[Algolia](https://docs.gravityforms.com/gform_email_fields_notification_admin/# "Algolia")
