---
url: "https://docs.gravityforms.com/gform_capsulecrm_case/"
title: "gform_capsulecrm_case - Gravity Forms Documentation"
---
...
# gform\_capsulecrm\_case

- [Description](https://docs.gravityforms.com/gform_capsulecrm_case/#h-description)
- [Usage](https://docs.gravityforms.com/gform_capsulecrm_case/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_capsulecrm_case/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_capsulecrm_case/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_capsulecrm_case/#h-placement)
- [Since](https://docs.gravityforms.com/gform_capsulecrm_case/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_capsulecrm_case/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_capsulecrm_case'``,``'your_function_name'``, 10, 4 );` |

To target a specific form, append the form id to the hook name. (format: gform\_capsulecrm\_case\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_capsulecrm_case_1'``,``'your_function_name'``, 10, 4 );` |

To target a specific feed for a form, append the form id and feed id to the hook name. (format: gform\_capsulecrm\_case\_FORMID\_FEEDID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_capsulecrm_case_1_7'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$case** [array](https://docs.gravityforms.com/array)
Capsule CRM case.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13 | `array``(`<br>```'name'``=>``'Capsule CRM'``,`<br>```'description'``=>``'Test Case'``,`<br>```'status'``=>``'OPEN'``,`<br>```'party'``=>`<br>```array``(`<br>```'id'``=> 179884585,`<br>```'owner'``=>`<br>```array``(`<br>```'username'``=>``'testuser'`<br>```)`<br>```)`<br>`)` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_capsulecrm_case'``,``'change_case_object'``, 10, 4 );`<br>`function``change_case_object(``$case``,``$form``,``$entry``,``$feed``){`<br>```$case``[``'description'``] =``'Created by API'``;`<br>```return``$case``;`<br>`}` |
...
This filter is located in GFCapsuleCRM::create\_case() in _class-gf-capsulecrm.php_.
...
[Algolia](https://docs.gravityforms.com/gform_capsulecrm_case/# "Algolia")
