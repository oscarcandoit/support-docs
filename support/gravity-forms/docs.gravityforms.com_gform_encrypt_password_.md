---
url: "https://docs.gravityforms.com/gform_encrypt_password/"
title: "gform_encrypt_password - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Field Filters](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/)        - [Image Choice Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/image-choice-fields/)
        ...
        - [Password Fields](https://docs.gravityforms.com/category/developers/hooks/filters/field-filters/password-fields/)          - [gform\_enable\_password\_field](https://docs.gravityforms.com/gform_enable_password_field/ "gform_enable_password_field")
          - [gform\_encrypt\_password](https://docs.gravityforms.com/gform_encrypt_password/ "gform_encrypt_password")
          - [gform\_password](https://docs.gravityforms.com/gform_password/ "gform_password")
          - [gform\_password\_confirm](https://docs.gravityforms.com/gform_password_confirm/ "gform_password_confirm")
...
# gform\_encrypt\_password

- [Description](https://docs.gravityforms.com/gform_encrypt_password/#h-description)
- [Usage](https://docs.gravityforms.com/gform_encrypt_password/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_encrypt_password/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_encrypt_password/#h-placement)
- [Since](https://docs.gravityforms.com/gform_encrypt_password/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_encrypt_password/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_encrypt_password'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$encrypt\_password** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_encrypt_password'``,``'__return_true'``);` |

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_encrypt_password'``,``'encrypt_password'``, 10, 3 );`<br>`function``encrypt_password(``$encrypt_password``,``$field``,``$form``){`<br>`if``(``$form``[``'id'``] == 53 ){`<br>`$encrypt_password``= true;`<br>`}`<br>`return``$encrypt_password``;`<br>`}` |
...
This filter is located in GF\_Field\_Password::get\_value\_save\_entry() in _class-gf-field-password.php_.
...
[Algolia](https://docs.gravityforms.com/gform_encrypt_password/# "Algolia")
