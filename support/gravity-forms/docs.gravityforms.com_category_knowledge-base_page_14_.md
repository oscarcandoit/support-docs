---
url: "https://docs.gravityforms.com/category/knowledge-base/page/14/"
title: "Knowledge Base Archives - Page 14 of 18 - Gravity Forms Documentation - Page 14 of 18"
---
...
[**Accessibility** \\
Articles on accessibility guidelines and best practices.](https://docs.gravityforms.com/category/knowledge-base/accessibility/) [**How To** \\
Step-by-step instructions.](https://docs.gravityforms.com/category/knowledge-base/how-to/) [**Licensing** \\
Articles that cover purchasing and using Gravity Forms licenses.](https://docs.gravityforms.com/category/knowledge-base/licensing/) [**Privacy, Security and Compliance** \\
Articles on security issues and best practices.](https://docs.gravityforms.com/category/knowledge-base/security/) [**Troubleshooting** \\
Articles to help you troubleshoot issues with Gravity Forms and add-ons.](https://docs.gravityforms.com/category/knowledge-base/troubleshooting/)

## Articles

[**Setting Up Conditional Feeds for Offline Payments** \\
This article covers how to use conditional feeds to manage workflows based on whether users choose online or offline payment methods.](https://docs.gravityforms.com/setting-up-conditional-feeds-for-offline-payments/ "Setting Up Conditional Feeds for Offline Payments") [**Setting Up Conditional Payments for One Time and Recurring Transactions** \\
This article explains how to use conditional logic to set up payment feeds based on a user’s selected payment frequency.](https://docs.gravityforms.com/setting-up-conditional-payments-for-one-time-and-recurring-transactions/ "Setting Up Conditional Payments for One Time and Recurring Transactions") [**Setting Up Conditional Payments in Gravity Forms** \\
Sometimes, you may want to allow a user to choose between different payment options. In this article, we will show you how to do this using conditional logic.](https://docs.gravityforms.com/setting-up-conditional-payments/ "Setting Up Conditional Payments in Gravity Forms") [**Show Values For Choice Based Fields** \\
This article explains how choice values work, why they are useful, when they are required, and how to set them up for your forms.](https://docs.gravityforms.com/show-values-for-choice-based-fields/ "Show Values For Choice Based Fields") [**State Validation** \\
State validation enhances form security by ensuring submitted field values have not been altered client-side. When a form is displayed, a state is generated based on the configuration and allowed values of supported fields.](https://docs.gravityforms.com/state-validation/ "State Validation") [**Taking a Screenshot of Your Feed Settings** \\
This article reviews how to take a screenshot of your settings to help when getting technical support.](https://docs.gravityforms.com/taking-a-screenshot-of-your-feed-settings/ "Taking a Screenshot of Your Feed Settings") [**Testing for a Theme/Plugin Conflict** \\
...
This guide provides advice on debugging an issue that may be caused by a conflict between Gravity Forms and a third party theme of plugin.](https://docs.gravityforms.com/conflict-testing-using-health-check-plugin/ "Testing for a Theme/Plugin Conflict using the Health Check & Troubleshooting Plugin") [**Testing For Blank Fields With Conditional Logic** \\
Using conditional logic to detect if a field’s value is blank can be confusing to some people, but it’s quite simple. This article explains how to do this.](https://docs.gravityforms.com/test-blank-fields-with-conditional-logic/ "Testing For Blank Fields With Conditional Logic") [**The Importance of Updates** \\
Oftentimes when running a website, individuals will only make the changes they need and neglect the general maintenance of the site, including things such as updates.](https://docs.gravityforms.com/the-importance-of-updates/ "The Importance of Updates") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/13/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [12](https://docs.gravityforms.com/category/knowledge-base/page/12/) [13](https://docs.gravityforms.com/category/knowledge-base/page/13/) 14 [15](https://docs.gravityforms.com/category/knowledge-base/page/15/) [16](https://docs.gravityforms.com/category/knowledge-base/page/16/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/15/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/14/# "Algolia")
