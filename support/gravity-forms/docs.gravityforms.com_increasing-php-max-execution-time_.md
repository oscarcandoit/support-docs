---
url: "https://docs.gravityforms.com/increasing-php-max-execution-time/"
title: "Increasing Your PHP Max Execution Time"
---
...
- [Modifying your max execution time in php.ini](https://docs.gravityforms.com/increasing-php-max-execution-time/#h-modifying-your-max-execution-time-in-php-ini)
- [Modifying your max execution time in .htaccess](https://docs.gravityforms.com/increasing-php-max-execution-time/#h-modifying-your-max-execution-time-in-htaccess)
...
Depending on your hosting provider, you may have a php.ini file within your home directory. If it is present, find the **max\_execution\_time** parameter and modify it to increase the number of seconds PHP scripts are allowed to run.
...
[Algolia](https://docs.gravityforms.com/increasing-php-max-execution-time/# "Algolia")
