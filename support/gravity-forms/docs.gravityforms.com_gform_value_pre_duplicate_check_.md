---
url: "https://docs.gravityforms.com/gform_value_pre_duplicate_check/"
title: "gform_value_pre_duplicate_check - Gravity Forms Documentation"
---
...
# gform\_value\_pre\_duplicate\_check

- [Description](https://docs.gravityforms.com/gform_value_pre_duplicate_check/#h-description)
- [Usage](https://docs.gravityforms.com/gform_value_pre_duplicate_check/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_value_pre_duplicate_check/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_value_pre_duplicate_check/#h-examples)
- [Sanitize an email](https://docs.gravityforms.com/gform_value_pre_duplicate_check/#h-sanitize-an-email)
- [Placement](https://docs.gravityforms.com/gform_value_pre_duplicate_check/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_value_pre_duplicate_check/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_value_pre_duplicate_check/#h-since)

## Description

The `gform_value_pre_duplicate_check` The filter allows for the modification of the field value just before the duplicate check.
...
- **$valu** e [string](https://docs.gravityforms.com/bool/) or [array](https://docs.gravityforms.com/array/)

The value being checked against existing entries for duplicates.
- **$field** [GF\_Field](https://docs.gravityforms.com/object/)

The field being checked for duplicates.
...
Sanitize emails and consider values like `name+tag@gmail.com` the same as `name@gmail.com`

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15 | `add_filter(``'gform_value_pre_duplicate_check'``,``function``(``$value``,``$field``,``$form_id``) {`<br>```if``(``$field``->type !==``'email'``) {`<br>```return``$value``;`<br>```}`<br>```$value``=``is_array``(``$value``) ? rgar(``$value``, 0,``''``) :``$value``;`<br>```$value``=``strtolower``(``$value``);`<br>```if``(``strpos``(``$value``,``'@gmail.com'``) === false ||``strpos``(``$value``,``'+'``) === false ) {`<br>```return``$value``;`<br>```}`<br>```$username``=``str_replace``(``'@gmail.com'``,``''``,``$value``);`<br>```$username``=``substr``(``$username``, 0 ,``strpos``(``$username``,``'+'``) );`<br>```return``$username``.``'@gmail.com'``;`<br>`}, 10, 3 );` |
...
This filter is located in /form\_display.php
...
[Algolia](https://docs.gravityforms.com/gform_value_pre_duplicate_check/# "Algolia")
