---
url: "https://docs.gravityforms.com/category/knowledge-base/page/4/"
title: "Knowledge Base Archives - Page 4 of 18 - Gravity Forms Documentation - Page 4 of 18"
---
...
Details of the messages displayed by third-party payment processors when there is an error processing a credit card.](https://docs.gravityforms.com/credit-card-processing-error-messages/ "Credit Card Processing Error Messages") [**Custom Logging Statements** \\
While Gravity Forms and its add-ons include numerous logging statements, sometimes you may need to add more. Discover how to add custom logging.](https://docs.gravityforms.com/custom-logging-statements/ "Custom Logging Statements") [**Customizing Forms created from the Template Library** \\
This article discusses all the steps you should take to turn a Gravity Forms template form into a tailored fully functioning form on your own website.](https://docs.gravityforms.com/custom-form-template-library/ "Customizing Forms created from the Template Library") [**Delete Entry Data After Post Submission** \\
https://docs.gravityforms.com/delete-entry-data-after-submission/.](https://docs.gravityforms.com/delete-entry-data-after-post-submission/ "Delete Entry Data After Post Submission") [**Delete Entry Data after Submission** \\
This article explains how how to manage deletion using Personal Data Settings, third-party tools, or custom code.](https://docs.gravityforms.com/delete-entry-data-after-submission/ "Delete Entry Data after Submission") [**Deprecated Gravity Forms Database Tables** \\
The following database tables have been deprecated as of Gravity Forms 2.3, and should not be utilized by any custom code or third-party plug-ins etc.](https://docs.gravityforms.com/deprecated-database-tables/ "Deprecated Gravity Forms Database Tables") [**Deprecation of the Gravity Forms Credit Card Field** \\
❗The Gravity Forms Credit Card Field has been deprecated for use with all our modern payment add-ons. Instead, use the gateway-specific payment collection fields.](https://docs.gravityforms.com/deprecation-of-the-gravity-forms-credit-card-field/ "Deprecation of the Gravity Forms Credit Card Field") [**Deprecation of the Rocketgenius Namespace for Gravity Forms 2.5** \\
The top-level Rocketgenius namespace is being replaced with Gravity\_Forms, which may break third party add-ons using the old namespace. This document describes those changes in Gravity Forms 2.5 Beta 3.](https://docs.gravityforms.com/deprecation-of-the-rocketgenius-namespace-for-gravity-forms-2-5-beta-3/ "Deprecation of the Rocketgenius Namespace for Gravity Forms 2.5") [**Disabling Automatic Scrolling On Form Confirmations** \\
Disable automatic scrolling to the form confirmation message in Gravity Forms.](https://docs.gravityforms.com/disable-automatic-scroll-form-confirmation/ "Disabling Automatic Scrolling On Form Confirmations") [**Displaying a Form Within a Modal/Popup/Lightbox** \\
Note: This tutorial is provided as a suggestion only. We do not support third party solutions. If you have any trouble using Popup Maker, please contact with its author.](https://docs.gravityforms.com/displaying-form-within-modalpopuplightbox/ "Displaying a Form Within a Modal/Popup/Lightbox") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/3/) [1](https://docs.gravityforms.com/category/knowledge-base/) [2](https://docs.gravityforms.com/category/knowledge-base/page/2/) [3](https://docs.gravityforms.com/category/knowledge-base/page/3/) 4 [5](https://docs.gravityforms.com/category/knowledge-base/page/5/) [6](https://docs.gravityforms.com/category/knowledge-base/page/6/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/5/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/4/# "Algolia")
