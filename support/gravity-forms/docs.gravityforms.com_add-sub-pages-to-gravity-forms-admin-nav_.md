---
url: "https://docs.gravityforms.com/add-sub-pages-to-gravity-forms-admin-nav/"
title: "Add Sub-Pages to Gravity Forms Admin Navigation - Gravity Forms"
---
...
- [Introduction](https://docs.gravityforms.com/add-sub-pages-to-gravity-forms-admin-nav/#h-introduction)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11 | `add_filter(``'gform_addon_navigation'``,``'create_menu'``);`<br>`function``create_menu(``$menus``) {`<br>```$menus``[] =``array``(``'name'``=>``'simple_addon_page'``,``'label'``=> __(``'Simple Add-On'``),``'callback'``=>``'simple_addon_page'``);`<br>```return``$menus``;`<br>`}`<br>``<br>`function``simple_addon_page(){`<br>``<br>```echo``'Simple Add-On Page'``;`<br>``<br>`}` |

This would create a page called Simple Add-On that shows text on it that says _Simple Add-On Page_.

[![](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-25.png)](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-25.png)
...
[Algolia](https://docs.gravityforms.com/add-sub-pages-to-gravity-forms-admin-nav/# "Algolia")
