---
url: "https://docs.gravityforms.com/gform_submission_values_pre_save/"
title: "gform_submission_values_pre_save - Gravity Forms Documentation"
---
...
# gform\_submission\_values\_pre\_save

- [Description](https://docs.gravityforms.com/gform_submission_values_pre_save/#h-description)
- [Usage](https://docs.gravityforms.com/gform_submission_values_pre_save/#h-usage)
- [Example](https://docs.gravityforms.com/gform_submission_values_pre_save/#h-example)
- [Source Code](https://docs.gravityforms.com/gform_submission_values_pre_save/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_submission_values_pre_save'``,``'my_function_call'``);` |

## Parameters

- **$submitted\_values** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_submission_values_pre_save'``,``'submission_values_pre_save'``, 10, 2 );`<br>``<br>`function``submission_values_pre_save(``$submitted_values``,``$form``) {`<br>`$submitted_values``[``'custom_value'``] =``$_POST``[``'custom_value'``];`<br>`return``$submitted_values``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_submission_values_pre_save/# "Algolia")
