---
url: "https://docs.gravityforms.com/gform_address_state/"
title: "gform_address_state - Gravity Forms Documentation"
---
...
# gform\_address\_state

- [Description](https://docs.gravityforms.com/gform_address_state/#h-description)
- [Usage](https://docs.gravityforms.com/gform_address_state/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_address_state/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_address_state/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_address_state/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_address_state/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_address_state'``,``'change_address_state'``, 10, 2 );` |

Applies to a specific form. In this case, form id 5.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_address_state_5'``,``'change_address_state'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_address_state'``,``'change_address_state'``, 10, 2 );`<br>`function``change_address_state(``$label``,``$form_id``) {`<br>```return``"Address State"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_address_state/# "Algolia")
