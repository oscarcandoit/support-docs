---
url: "https://docs.gravityforms.com/gform_advancedpostcreation_excerpt/"
title: "gform_advancedpostcreation_excerpt - Gravity Forms Documentation"
---
...
# gform\_advancedpostcreation\_excerpt

- [Description](https://docs.gravityforms.com/gform_advancedpostcreation_excerpt/#h-description)
- [Usage](https://docs.gravityforms.com/gform_advancedpostcreation_excerpt/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_advancedpostcreation_excerpt/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_advancedpostcreation_excerpt/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_advancedpostcreation_excerpt/#h-placement)
- [Since](https://docs.gravityforms.com/gform_advancedpostcreation_excerpt/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_advancedpostcreation_excerpt/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_advancedpostcreation_excerpt'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$enable\_excerpt** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_advancedpostcreation_excerpt'``,``'enable_excerpt'``, 10, 1 );`<br>`function``enable_excerpt(``$enable_excerpt``){`<br>```return``true;`<br>`}` |
...
This filter is located in GF\_Advanced\_Post\_Creation::feed\_settings\_fields\_create\_post() in _gf-class-advancedpostcreation.php_.
...
[Algolia](https://docs.gravityforms.com/gform_advancedpostcreation_excerpt/# "Algolia")
