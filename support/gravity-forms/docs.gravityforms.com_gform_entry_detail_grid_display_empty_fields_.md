---
url: "https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/"
title: "gform_entry_detail_grid_display_empty_fields - Gravity Forms"
---
...
# gform\_entry\_detail\_grid\_display\_empty\_fields

- [Description](https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/#h-usage)
- [Example](https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/#h-example)
- [1\. Force display](https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/#h-1-force-display)
- [2\. Use the cookie set by the "show empty fields" checkbox](https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/#h-2-use-the-cookie-set-by-the-show-empty-fields-checkbox)
- [Placement](https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_detail_grid_display_empty_fields'``,``'your_function_name'``);` |

## Parameters

- **$display\_empty\_fields** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_detail_grid_display_empty_fields'``,``'__return_true'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_entry_detail_grid_display_empty_fields'``,``function``(``$display_empty_fields``) {`<br>`if``( !``$display_empty_fields``) {`<br>`$display_empty_fields``= rgget(``'gf_display_empty_fields'``,``$_COOKIE``);`<br>`}`<br>`return``$display_empty_fields``;`<br>`} );` |
...
|     |     |
| --- | --- |
| 1 | `$display_empty_fields``= apply_filters(``'gform_entry_detail_grid_display_empty_fields'``,``$display_empty_fields``,``$form``,``$lead``);` |
...
[Algolia](https://docs.gravityforms.com/gform_entry_detail_grid_display_empty_fields/# "Algolia")
