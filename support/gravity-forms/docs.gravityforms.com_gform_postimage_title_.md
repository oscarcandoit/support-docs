---
url: "https://docs.gravityforms.com/gform_postimage_title/"
title: "gform_postimage_title - Gravity Forms Documentation"
---
...
# gform\_postimage\_title

- [Description](https://docs.gravityforms.com/gform_postimage_title/#h-description)
- [Usage](https://docs.gravityforms.com/gform_postimage_title/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_postimage_title/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_postimage_title/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_postimage_title/#h-source-code)
...
To target a specific form append the form id to the hook name. (format: gform\_postimage\_title\_FORMID)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_postimage_title'``,``'change_postimage_title'``, 10, 2 );`<br>`function``change_postimage_title(``$label``,``$form_id``) {`<br>```return``'Image Title'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_postimage_title/# "Algolia")
