---
url: "https://docs.gravityforms.com/gform_pre_confirmation_deleted/"
title: "gform_pre_confirmation_deleted - Gravity Forms Documentation"
---
...
# gform\_pre\_confirmation\_deleted

- [Description](https://docs.gravityforms.com/gform_pre_confirmation_deleted/#h-description)
- [Usage](https://docs.gravityforms.com/gform_pre_confirmation_deleted/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_pre_confirmation_deleted/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_pre_confirmation_deleted/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_action(``'gform_pre_confirmation_deleted'``,``'my_pre_confirmation_deleted_func'``10, 2);`<br>`function``my_pre_confirmation_deleted_func(``$confirmation_id``,``$form``) {`<br>`// perform action before a confirmation is deleted`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_pre_confirmation_deleted/# "Algolia")
