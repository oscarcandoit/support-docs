---
url: "https://docs.gravityforms.com/gform_form_list_column_column_name/"
title: "gform_form_list_column_COLUMN_NAME - Gravity Forms Documentation"
---
...
- [Developers](https://docs.gravityforms.com/category/developers/)  - [Theme Framework](https://docs.gravityforms.com/category/developers/theme-framework/)
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Form List Filters](https://docs.gravityforms.com/category/developers/hooks/filters/form-list/)        - [gform\_disable\_view\_counter](https://docs.gravityforms.com/gform_disable_view_counter/ "gform_disable_view_counter")
        - [gform\_form\_actions](https://docs.gravityforms.com/gform_form_actions/ "gform_form_actions")
        - [gform\_form\_list\_column\_COLUMN\_NAME](https://docs.gravityforms.com/gform_form_list_column_column_name/ "gform_form_list_column_COLUMN_NAME")
        - [gform\_form\_list\_columns](https://docs.gravityforms.com/gform_form_list_columns/ "gform_form_list_columns")
        - [gform\_page\_size\_form\_list](https://docs.gravityforms.com/gform_page_size_form_list/ "gform_page_size_form_list")
...
# gform\_form\_list\_column\_COLUMN\_NAME

- [Description](https://docs.gravityforms.com/gform_form_list_column_column_name/#h-description)
- [Usage](https://docs.gravityforms.com/gform_form_list_column_column_name/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_form_list_column_column_name/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_form_list_column_column_name/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_form_list_column_column_name/#h-placement)
- [Since](https://docs.gravityforms.com/gform_form_list_column_column_name/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_form_list_column_column_name/#h-source-code)

## Description

This action enables you to display custom column content on the Form List page after creating a custom column with the [gform\_form\_list\_columns](https://docs.gravityforms.com/gform_form_list_columns/) filter.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_form_list_column_COLUMN_NAME'``,``'your_function_name'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_action(``'gform_form_list_column_date_created'``,``function``(``$form``) {`<br>```echo``esc_html( rgobj(``$form``,``'date_created'``) );`<br>`} );` |
...
This filter was added in Gravity Forms version _2.3-beta-3_

## Source Code

This action is located in GF\_Form\_List\_Table::get\_columns() in _form\_list.php_.
...
[Algolia](https://docs.gravityforms.com/gform_form_list_column_column_name/# "Algolia")
