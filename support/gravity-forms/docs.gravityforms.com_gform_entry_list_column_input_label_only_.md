---
url: "https://docs.gravityforms.com/gform_entry_list_column_input_label_only/"
title: "gform_entry_list_column_input_label_only - Gravity Forms"
---
...
# gform\_entry\_list\_column\_input\_label\_only

- [Description](https://docs.gravityforms.com/gform_entry_list_column_input_label_only/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_list_column_input_label_only/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entry_list_column_input_label_only/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_entry_list_column_input_label_only/#h-examples)
- [Include Product Field Label](https://docs.gravityforms.com/gform_entry_list_column_input_label_only/#h-include-product-field-label)
- [Placement](https://docs.gravityforms.com/gform_entry_list_column_input_label_only/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_entry_list_column_input_label_only/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_entry_list_column_input_label_only/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_list_column_input_label_only'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$input\_label\_only** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_entry_list_column_input_label_only'``,``function``(``$input_label_only``,``$form``,``$field``) {`<br>```return``$field``->type ==``'product'``? false :``$input_label_only``;`<br>`}, 10, 3 );` |
...
|     |     |
| --- | --- |
| 1 | `$input_label_only``= apply_filters(``'gform_entry_list_column_input_label_only'``,``$input_label_only``,``$form``,``$field``);` |

This filter is located in GFFormsModel::get\_grid\_columns() in _forms\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_entry_list_column_input_label_only/# "Algolia")
