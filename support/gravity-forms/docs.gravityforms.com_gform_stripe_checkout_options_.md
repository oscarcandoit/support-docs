---
url: "https://docs.gravityforms.com/gform_stripe_checkout_options/"
title: "gform_stripe_checkout_options - Gravity Forms Documentation"
---
...
# gform\_stripe\_checkout\_options

- [Description](https://docs.gravityforms.com/gform_stripe_checkout_options/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_checkout_options/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_checkout_options/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_stripe_checkout_options/#h-example)
- [Placement](https://docs.gravityforms.com/gform_stripe_checkout_options/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_checkout_options/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_checkout_options/#h-source-code)

This filter was removed in version 3.0 of the Stripe add-on. For versions 3.0 or greater, you’ll want to use the [gform\_stripe\_session\_data](https://docs.gravityforms.com/gform_stripe_session_data) filter.

## Description

The “gform\_stripe\_checkout\_options” JavaScript based filter in the Gravity Forms Stripe add-on allows for altering the checkout options just before the Stripe checkout modal is loaded. This filter can only be used if you’re using the Stripe Checkout payment method in your Stripe add-on settings.
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `gform.addFilter(``'gform_stripe_checkout_options'``,``function``( options, formId ) {`<br>```return``options;`<br>`} );` |

## Parameters

- **$options** [object](https://docs.gravityforms.com/object)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `gform.addFilter(``'gform_stripe_checkout_options'``,``function``( options, formId ) {`<br>```options.email = GFMergeTag.replaceMergeTags( formId,``'{:8}'``);`<br>```return``options;`<br>`} );` |
...
This filter is located in _js/frontend.js_
...
[Algolia](https://docs.gravityforms.com/gform_stripe_checkout_options/# "Algolia")
