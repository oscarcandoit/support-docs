---
url: "https://docs.gravityforms.com/troubleshooting-missing-settings-page/"
title: "Troubleshooting a Missing Settings Page - Gravity Forms"
---
...
- [Check that the add-on is activated](https://docs.gravityforms.com/troubleshooting-missing-settings-page/#h-check-that-the-add-on-is-activated)
- [Ensure you have the correct user capabilities](https://docs.gravityforms.com/troubleshooting-missing-settings-page/#h-ensure-you-have-the-correct-user-capabilities)
- [Eliminate possible conflicts](https://docs.gravityforms.com/troubleshooting-missing-settings-page/#h-eliminate-possible-conflicts)
- [Check for errors](https://docs.gravityforms.com/troubleshooting-missing-settings-page/#h-check-for-errors)
...
For further details, see [Role and Capability Management](https://docs.gravityforms.com/role-management-guide/).
...
See [Testing for a Theme/Plugin Conflict](https://docs.gravityforms.com/testing-theme-plugin-conflict/).

## Check for errors

Occasionally, there might be an error occurring within the Gravity Forms code, or a conflict with another plugin or theme. If you encounter any PHP errors on your site with [WP\_DEBUG](https://wordpress.org/documentation/article/debugging-in-wordpress/) turned on, they may be causing the issue.
...
[Algolia](https://docs.gravityforms.com/troubleshooting-missing-settings-page/# "Algolia")
