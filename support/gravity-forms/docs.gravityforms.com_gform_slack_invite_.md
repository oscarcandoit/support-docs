---
url: "https://docs.gravityforms.com/gform_slack_invite/"
title: "gform_slack_invite - Gravity Forms Documentation"
---
...
# gform\_slack\_invite

- [Description](https://docs.gravityforms.com/gform_slack_invite/#h-description)
- [Usage](https://docs.gravityforms.com/gform_slack_invite/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_slack_invite/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_slack_invite/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_slack_invite/#h-placement)
- [Since](https://docs.gravityforms.com/gform_slack_invite/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_slack_invite/#h-source-code)

## Description

The “gform\_slack\_invite” filter in the Gravity Forms Slack Add-On allows the invite user parameters to be modified before the invite is sent to Slack. The Invite User option in the Feed Setup only appears if setup is done by an admin user.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_slack_invite'``,``'your_function_name'``, 10, 4 );` |

To target a specific form, append the form id to the hook name. (format: gform\_slack\_invite\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_slack_invite_1'``,``'your_function_name'``, 10, 4 );` |

## Parameters

- **$invite** [array](https://docs.gravityforms.com/array)
Invite parameters.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_slack_invite'``,``'change_invite'``, 10, 4 );`<br>`function``change_invite(``$invite``,``$feed``,``$entry``,``$form``){`<br>```$invite``[``'team'``] =``'rocketgenius'``;`<br>```return``$invite``;`<br>`}` |
...
This filter is located in GFSlack::send\_invite() in _gravityformsslack/class-gf-slack.php_.
...
[Algolia](https://docs.gravityforms.com/gform_slack_invite/# "Algolia")
