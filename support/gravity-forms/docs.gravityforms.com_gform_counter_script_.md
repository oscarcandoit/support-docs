---
url: "https://docs.gravityforms.com/gform_counter_script/"
title: "gform_counter_script - Gravity Forms Documentation"
---
...
# gform\_counter\_script

- [Description](https://docs.gravityforms.com/gform_counter_script/#h-description)
- [Usage](https://docs.gravityforms.com/gform_counter_script/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_counter_script/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_counter_script/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_counter_script/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_counter_script/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_counter_script'``,``'set_counter_script'``, 10, 5 );` |

You can also target a specific form by adding the form id after the hook name.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_counter_script_6'``,``'set_counter_script'``, 10, 5 );` |
...
- **$maxLength** [integer](https://docs.gravityforms.com/integer)

Configured max character length.

- **$field** [GF\_Field](https://docs.gravityforms.com/gf_field)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `add_filter(``'gform_counter_script_187'``,``'set_counter_script'``, 10, 5 );`<br>`function``set_counter_script(``$script``,``$form_id``,``$input_id``,``$max_length``,``$field``) {`<br>```$script``=``"jQuery('#{$input_id}').textareaCount("``.`<br>```"    {"``.`<br>```"    'maxCharacterSize': {$max_length},"``.`<br>```"    'originalStyle': 'ginput_counter',"``.`<br>```"    'displayFormat' : '#left characters remaining.'"``.`<br>```"    });"``;`<br>```return``$script``;`<br>`}` |

A full list of available initialization options can be found at:

[https://github.com/LeadSift/jquery-textareaCounter](https://github.com/LeadSift/jquery-textareaCounter)
...
This filter is located in GFFormDisplay::get\_counter\_init\_script() in _form\_display.php_
...
[Algolia](https://docs.gravityforms.com/gform_counter_script/# "Algolia")
