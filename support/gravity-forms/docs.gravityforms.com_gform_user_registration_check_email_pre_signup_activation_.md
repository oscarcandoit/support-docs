---
url: "https://docs.gravityforms.com/gform_user_registration_check_email_pre_signup_activation/"
title: "Check Email Pre-Signup Activation - Gravity Guide"
---
...
# gform\_user\_registration\_check\_email\_pre\_signup\_activation

- [Description](https://docs.gravityforms.com/gform_user_registration_check_email_pre_signup_activation/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_check_email_pre_signup_activation/#h-usage)
- [Placement](https://docs.gravityforms.com/gform_user_registration_check_email_pre_signup_activation/#h-placement)
- [Since](https://docs.gravityforms.com/gform_user_registration_check_email_pre_signup_activation/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_check_email_pre_signup_activation/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_user_registration_check_email_pre_signup_activation'``,``'__return_false'``);` |

If you plan to use this filter to allow users to use already registered emails for new registrations, you need to use also the [gform\_user\_registration\_validation](https://docs.gravityforms.com/gform_user_registration_validation/) filter.

## Parameters

- **$check\_email** [bool](https://docs.gravityforms.com/bool)
True or false.
...
|     |     |
| --- | --- |
| 1 | `$check_email``= apply_filters(``'gform_user_registration_check_email_pre_signup_activation'``, true );` |

This filter is located in GFUserSignups::activate\_signup() in _signups.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_check_email_pre_signup_activation/# "Algolia")
