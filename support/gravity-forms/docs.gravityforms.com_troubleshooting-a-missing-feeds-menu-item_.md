---
url: "https://docs.gravityforms.com/troubleshooting-a-missing-feeds-menu-item/"
title: "Troubleshooting a Missing 'Feeds' Menu Item - Gravity Forms"
---
...
- [Check that the plugin is activated](https://docs.gravityforms.com/troubleshooting-a-missing-feeds-menu-item/#h-check-that-the-plugin-is-activated)
- [Check your WordPress user capabilities](https://docs.gravityforms.com/troubleshooting-a-missing-feeds-menu-item/#h-check-your-wordpress-user-capabilities)
- [Check for conflicts](https://docs.gravityforms.com/troubleshooting-a-missing-feeds-menu-item/#h-check-for-conflicts)
- [Look for errors](https://docs.gravityforms.com/troubleshooting-a-missing-feeds-menu-item/#h-look-for-errors)
...
Your user simply may not have access to a capability that Gravity Forms is checking for. The easiest way to check over your current capabilities, as well as modify them if needed, is the 3rd party [User Role Editor plugin](https://wordpress.org/plugins/user-role-editor/).
...
If you’re still not seeing the menu item, look for errors that may be appearing when [WP\_DEBUG](https://wordpress.org/documentation/article/debugging-in-wordpress/) is enabled. These errors can provide additional information as to what the issue may be.
...
[Algolia](https://docs.gravityforms.com/troubleshooting-a-missing-feeds-menu-item/# "Algolia")
