---
url: "https://docs.gravityforms.com/gform_stripe_webhook_signing_secret/"
title: "gform_stripe_webhook_signing_secret - Gravity Forms Documentation"
---
...
# gform\_stripe\_webhook\_signing\_secret

- [Description](https://docs.gravityforms.com/gform_stripe_webhook_signing_secret/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_webhook_signing_secret/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_webhook_signing_secret/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_webhook_signing_secret/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_stripe_webhook_signing_secret/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_webhook_signing_secret/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_webhook_signing_secret/#h-source-code)

## Description

The “gform\_stripe\_webhook\_signing\_secret” filter in the Gravity Forms Stripe Add-On allows the webhook signing secret for the specified API mode to be modified.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_webhook_signing_secret'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$signing\_secret** [string](https://docs.gravityforms.com/string)
...
- **$gfstripe** [object](https://docs.gravityforms.com/object)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_stripe_webhook_signing_secret'``,``'change_secret'``, 10, 3 );`<br>`function``change_secret(``$signing_secret``,``$mode``,``$gfstripe``){`<br>```if``(``$mode``==``'test'``){`<br>```return``'1234567890'``;`<br>```}`<br>```else``{`<br>```return``'222222222'``;`<br>```}`<br>`}` |
...
This filter is located in GFStripe::get\_webhook\_signing\_secret() in _gravityformsstripe/class-gf-stripe.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_webhook_signing_secret/# "Algolia")
