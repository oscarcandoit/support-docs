---
url: "https://docs.gravityforms.com/rgars/"
title: "rgars() - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/rgars/#h-description)
- [Usage](https://docs.gravityforms.com/rgars/#h-usage)
- [Parameters](https://docs.gravityforms.com/rgars/#h-parameters)
- [Examples](https://docs.gravityforms.com/rgars/#h-examples)
- [Source Code](https://docs.gravityforms.com/rgars/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `// Defines the multilevel array, and transcends it to get the value.`<br>`$array``=``array``(`<br>```'firstlevel'``=>``array``(`<br>```'secondlevel'``=>``array``(`<br>```'thirdlevel'``=>``'Desired Value'`<br>```)`<br>```)`<br>`)`<br>`$name``=``'firstlevel/secondlevel/thirdlevel'``;`<br>`rgars(``$array``,``$name``);` |
...
[Algolia](https://docs.gravityforms.com/rgars/# "Algolia")
