---
url: "https://docs.gravityforms.com/gform_agilecrm_tags/"
title: "gform_agilecrm_tags - Gravity Forms Documentation"
---
...
# gform\_agilecrm\_tags

- [Description](https://docs.gravityforms.com/gform_agilecrm_tags/#h-description)
- [Usage](https://docs.gravityforms.com/gform_agilecrm_tags/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_agilecrm_tags/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_agilecrm_tags/#h-examples)
- [1\. Always add tags](https://docs.gravityforms.com/gform_agilecrm_tags/#h-1-always-add-tags)
- [2\. Add tag depending on field value](https://docs.gravityforms.com/gform_agilecrm_tags/#h-2-add-tag-depending-on-field-value)
- [Placement](https://docs.gravityforms.com/gform_agilecrm_tags/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_agilecrm_tags/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_agilecrm_tags'``,``'your_function_name'``, 10, 4 );` |

To target feeds for a specific form append the form id to the hook name. (format: gform\_agilecrm\_tags\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_agilecrm_tags_4'``,``'your_function_name'``, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_agilecrm_tags'``,``'add_new_tag'``, 10, 4 );`<br>`function``add_new_tag(``$tags``,``$feed``,``$entry``,``$form``) {`<br>`$tags``[] =``'some tag'``;`<br>`return``$tags``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10 | `add_filter(``'gform_agilecrm_tags'``,``'add_new_tag'``, 10, 4 );`<br>`function``add_new_tag(``$tags``,``$feed``,``$entry``,``$form``) {`<br>`$product``= rgar(``$entry``,``'15'``);`<br>`if``(``$product``!=``'gravityforms'``) {`<br>`$tags``[] =``'some tag'``;`<br>`}`<br>`return``$tags``;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_agilecrm_tags'``,``$form``[``'id'``],``$tags``,``$feed``,``$entry``,``$form``);` |

This filter is located in the following methods in _class-gf-agilecrm.php_:

- GFAgileCRM::create\_contact()
- GFAgileCRM::update\_contact()
...
[Algolia](https://docs.gravityforms.com/gform_agilecrm_tags/# "Algolia")
