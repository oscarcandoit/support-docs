---
url: "https://docs.gravityforms.com/gform_force_hooks_js_output/"
title: "gform_force_hooks_js_output - Gravity Forms Documentation"
---
...
# gform\_force\_hooks\_js\_output

- [Description](https://docs.gravityforms.com/gform_force_hooks_js_output/#h-description)
- [Usage](https://docs.gravityforms.com/gform_force_hooks_js_output/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_force_hooks_js_output/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_force_hooks_js_output/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_force_hooks_js_output/#h-placement)
- [Since](https://docs.gravityforms.com/gform_force_hooks_js_output/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_force_hooks_js_output/#h-source-code)

## Description

The gform\_force\_hooks\_js\_output filter can be used to prevent the Gravity Forms scripts from being injected into the pages if they’re not necessary.

**Note:** Enabling this filter may cause the server to use more memory. It is recommended that you monitor memory usage if you experience performance issues, particularly in cases where the Dom\_Parser class is involved.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_force_hooks_js_output'``,``'your_function_name'``);` |

## Parameters

Defaults to false. Set to true using the WordPress \_\_return\_true function or a custom function that returns true.

## Examples

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_force_hooks_js_output'``,``'__return_true'``);` |
...
This filter is located in `Gravity_Forms\Gravity_Forms\Libraries\Dom_Parser::get_injected_html()` in _includes/libraries/class-dom-parser.php_ and `GFForms::localize_hook_vars()` in _gravityforms.php_.
...
[Algolia](https://docs.gravityforms.com/gform_force_hooks_js_output/# "Algolia")
