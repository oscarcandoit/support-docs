---
url: "https://docs.gravityforms.com/gform_post_paging/"
title: "gform_post_paging - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_post_paging/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_paging/#h-usage)
- [Example](https://docs.gravityforms.com/gform_post_paging/#h-example)
- [Placement](https://docs.gravityforms.com/gform_post_paging/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_post_paging/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action( 'gform_post_paging_1', 'set_default_value', 10, 3 );` |
...
- **$source\_page\_number** [integer](https://docs.gravityforms.com/integer)

Number of page user is coming from.

- **$current\_page\_number** [integer](https://docs.gravityforms.com/integer)
...
|     |
| --- |
| `add_action(``'gform_post_paging'``,``'alert_user'``, 10, 3 );`<br>`function``alert_user(``$form``,``$source_page_number``,``$current_page_number``) {`<br>```if``(``$current_page_number``== 2 ) {`<br>```echo``'<script>alert( \'Almost done! Just one more page to fill out.\' );</script>'``;`<br>```}`<br>`}` |
...
This action hook is located in GFFormDisplay::get\_form() in _form\_display.php_.
...
[Algolia](https://docs.gravityforms.com/gform_post_paging/# "Algolia")
