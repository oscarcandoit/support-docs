---
url: "https://docs.gravityforms.com/setting-up-the-mailerlite-add-on/"
title: "Setting up the MailerLite Add-On - Gravity Forms Documentation"
---
...
# Setting up the MailerLite Add-On

- [Pre-Requisites](https://docs.gravityforms.com/setting-up-the-mailerlite-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-up-the-mailerlite-add-on/#h-setup)
...
- A [MailerLite](https://accounts.mailerlite.com/dashboard) account

**Note:** The MailerLite Add-On does not support MailerLite Classic accounts. For more information about migrating from MailerLite Classic, refer to the [MailerLite documentation page](https://www.mailerlite.com/help/migration).

## Setup

1. Log into your WordPress admin dashboard.
2. On the left side navigation menu, hover over **Forms** and click on **Settings**.
3. From this page, click the **MailerLite** tab.
4. Enter your **API Key**. This is obtained from your MailerLite account. If you are unsure of how to obtain your API key, you may review our documentation on [obtaining your MailerLite API key](https://docs.gravityforms.com/obtaining-your-mailerlite-api-key/).
5. Click **Save Settings**. If you’ve entered your account information correctly, you will be notified by a green check mark beside the box. If you do not see a green check mark, please double-check this information and try again.

![MailerLite Add-On Settings](https://docs.gravityforms.com/wp-content/uploads/2024/08/image-17-1024x268.png)

Once you have entered your API key, you can begin [creating a feed for the MailerLite Add-On](https://docs.gravityforms.com/?p=38767).
...
[Algolia](https://docs.gravityforms.com/setting-up-the-mailerlite-add-on/# "Algolia")
