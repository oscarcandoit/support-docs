---
url: "https://docs.gravityforms.com/category/user-guides/standard-fields/page/2/"
title: "Standard Fields Archives - Page 2 of 2 - Gravity Forms Documentation - Page 2 of 2"
---
...
[**Section Break** \\
The Section Break field allows you to add a content separator to your form to help organize groups of fields. This is a visual element rather than an actual data collecting form field.](https://docs.gravityforms.com/section-break/ "Section Break") [**Single Line Text** \\
The Single Line Text field allows users to submit a single line of text. This basic field can be used for anything where no more than a single line of input is required.](https://docs.gravityforms.com/single-line-text/ "Single Line Text") [Previous](https://docs.gravityforms.com/category/user-guides/standard-fields/) [1](https://docs.gravityforms.com/category/user-guides/standard-fields/) 2

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/user-guides/standard-fields/page/2/# "Algolia")
