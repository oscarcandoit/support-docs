---
url: "https://docs.gravityforms.com/gform_paypalpaymentspro_log_api_request/"
title: "gform_paypalpaymentspro_log_api_request - Gravity Forms"
---
...
# gform\_paypalpaymentspro\_log\_api\_request

- [Description](https://docs.gravityforms.com/gform_paypalpaymentspro_log_api_request/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypalpaymentspro_log_api_request/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypalpaymentspro_log_api_request/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypalpaymentspro_log_api_request/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_paypalpaymentspro_log_api_request/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypalpaymentspro_log_api_request'``,``'your_function_name'``, 10, 1 );` |

## Parameters

- **$log\_request** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_paypalpaymentspro_log_api_request'``,``'log_request'``, 10, 1 );`<br>`function``log_request(``$log_request``){`<br>```return``true;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_paypalpaymentspro_log_api_request/# "Algolia")
