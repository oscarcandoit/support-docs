---
url: "https://docs.gravityforms.com/category/knowledge-base/page/16/"
title: "Knowledge Base Archives - Page 16 of 18 - Gravity Forms Documentation - Page 16 of 18"
---
...
This article describes the checks you can perform when your Gravity Forms license key will not validate successfully.](https://docs.gravityforms.com/troubleshooting-license-key-validation/ "Troubleshooting license key validation errors") [**Troubleshooting Payment Feeds Not Processing** \\
Of course, payments being properly processed is the most important part of selling anything. When it's not working as expected, it can be frustrating.](https://docs.gravityforms.com/troubleshooting-payment-feeds-not-processing/ "Troubleshooting Payment Feeds Not Processing") [**Troubleshooting Scheduled Events** \\
A list of events that Gravity Forms and add-ons schedule with WP-Cron and steps to troubleshoot.](https://docs.gravityforms.com/troubleshooting-scheduled-events/ "Troubleshooting Scheduled Events") [**Troubleshooting The HubSpot Tracking Cookie** \\
This guide provides steps to troubleshoot tracking cookie issues in the Gravity Forms HubSpot Add-On.](https://docs.gravityforms.com/troubleshooting-the-hubspot-tracking-cookie/ "Troubleshooting The HubSpot Tracking Cookie") [**Understanding Entry Limits in Gravity Forms** \\
The Entry Limit feature in Form Settings allows you to restrict the number of submissions a form can receive.](https://docs.gravityforms.com/understanding-entry-limits-in-gravity-forms/ "Understanding Entry Limits in Gravity Forms") [**Upgrade/Add-on Issues** \\
Having an issue where you can’t upgrade Gravity Forms or its add-ons?](https://docs.gravityforms.com/upgradeadd-on-issues/ "Upgrade/Add-on Issues") [**Upgrading to Gravity Forms v2.3** \\
This article describes the process for upgrading to Gravity Forms version 2.3x and the important steps to take beforehand.](https://docs.gravityforms.com/upgrading-to-gravity-forms-2-3/ "Upgrading to Gravity Forms v2.3") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/15/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [14](https://docs.gravityforms.com/category/knowledge-base/page/14/) [15](https://docs.gravityforms.com/category/knowledge-base/page/15/) 16 [17](https://docs.gravityforms.com/category/knowledge-base/page/17/) [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/17/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/16/# "Algolia")
