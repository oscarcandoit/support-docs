---
url: "https://docs.gravityforms.com/gform_ppcp_object/"
title: "gform_ppcp_object - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_ppcp_object/#h-description)
- [Usage](https://docs.gravityforms.com/gform_ppcp_object/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_ppcp_object/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_ppcp_object/#h-example)
- [Placement](https://docs.gravityforms.com/gform_ppcp_object/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_ppcp_object/#h-source-code)

## Description

The gform\_ppcp\_object filter can be used to customize the GFPPCP object that is included in the form initialization scripts for the [PayPal Field](https://docs.gravityforms.com/paypal-field) which is available with the [PayPal Checkout Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/paypal-add-ons/paypal-checkout-add-on/).
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_ppcp_object'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19 | `array``(`<br>```'formId'``=> 1,`<br>```'isAjax'``=> false,`<br>```'currency'``=>``'USD'``,`<br>```'feeds'``=>``array``(),`<br>```'smartPaymentButtons'``=>``array``(`<br>```'buttonsLayout'``=>``'vertical'``,`<br>```'buttonsSize'``=>``'responsive'``,`<br>```'buttonsShape'``=>``'rect'``,`<br>```'buttonsColor'``=>``'gold'``,`<br>```),`<br>```'ccFieldID'``=> 4,`<br>```'ccPage'``=> 1,`<br>```'paymentMethods'``=>``array``(`<br>```array``(``'text'``=>``'PayPal Checkout'``,``'value'``=>``'PayPal Checkout'``),`<br>```array``(``'text'``=>``'Credit Card'``,``'value'``=>``'Credit Card'``)`<br>```),`<br>```'cardStyle'``=>``array``(),`<br>`);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_ppcp_object'``,``'ppcp_object_buttons_shape'``, 10, 2 );`<br>`function``ppcp_object_buttons_shape(``$args``,``$form_id``) {`<br>```$args``[``'smartPaymentButtons'``][``'buttonsShape'``] =``'pill'``;`<br>```return``$args``;`<br>`}` |
...
This filter is located in GF\_PPCP::register\_init\_scripts() in _class-gf-ppcp.php_.
...
[Algolia](https://docs.gravityforms.com/gform_ppcp_object/# "Algolia")
