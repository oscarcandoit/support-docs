---
url: "https://docs.gravityforms.com/gform_webapi_endpoint/"
title: "gform_webapi_ENDPOINT - Gravity Forms Documentation"
---
...
# gform\_webapi\_ENDPOINT

- [Description](https://docs.gravityforms.com/gform_webapi_endpoint/#h-description)
- [Usage](https://docs.gravityforms.com/gform_webapi_endpoint/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_webapi_endpoint/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_webapi_endpoint/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_webapi_get_forms'``,``'my_function'``, 10, 4 );` |
...
- **$id2** [string](https://docs.gravityforms.com/string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `function``my_function() {`<br>`//Do something here`<br>`}`<br>`add_action(``'gform_webapi_get_forms'``,``'my_function'``, 10, 4 );` |
...
[Algolia](https://docs.gravityforms.com/gform_webapi_endpoint/# "Algolia")
