---
url: "https://docs.gravityforms.com/rgget/"
title: "rgget() - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/rgget/#h-description)
- [Usage](https://docs.gravityforms.com/rgget/#h-usage)
- [Parameters](https://docs.gravityforms.com/rgget/#h-parameters)
- [Examples](https://docs.gravityforms.com/rgget/#h-examples)
...
|     |     |
| --- | --- |
| 1<br>2 | `// Gets the current form ID on the Edit page.`<br>`$form_id``= rgget(``'id'``);` |
...
[Algolia](https://docs.gravityforms.com/rgget/# "Algolia")
