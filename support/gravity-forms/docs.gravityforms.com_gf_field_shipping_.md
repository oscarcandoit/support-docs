---
url: "https://docs.gravityforms.com/gf_field_shipping/"
title: "GF_Field_Shipping - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_shipping/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_shipping/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_shipping/#h-settings)
- [Source Code](https://docs.gravityforms.com/gf_field_shipping/#h-source-code)

## Introduction

The GF\_Field\_Shipping class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for handling the [Shipping field](https://docs.gravityforms.com/shipping/). Because Shipping fields are either a Single Method, Drop Down, or Radio Button, this class only adds some settings and sets the title for the field in the editor. The rendering of the Shipping field is handled by the class associated with its sub-type. The field “type” property will be set to “shipping” and the field “inputType” property will be “singleshipping”, “select”, or “radio”.
...
Single Method – [GF\_Field\_Singleshipping](https://docs.gravityforms.com/gf_field_singleshipping) class
...
The source code is located in _includes/fields/class-gf-field-shipping.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_shipping/# "Algolia")
