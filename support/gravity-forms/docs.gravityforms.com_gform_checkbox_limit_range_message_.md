---
url: "https://docs.gravityforms.com/gform_checkbox_limit_range_message/"
title: "gform_checkbox_limit_range_message - Gravity Forms Documentation"
---
...
# gform\_checkbox\_limit\_range\_message

- [Description](https://docs.gravityforms.com/gform_checkbox_limit_range_message/#h-description)
- [Usage](https://docs.gravityforms.com/gform_checkbox_limit_range_message/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_checkbox_limit_range_message/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_checkbox_limit_range_message/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_checkbox_limit_range_message/#h-placement)
- [Since](https://docs.gravityforms.com/gform_checkbox_limit_range_message/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_checkbox_limit_range_message/#h-source-code)

## Description

The filter allows you to modify the message displayed when a [Multiple Choice field](https://docs.gravityforms.com/multiple-choice-field/) is configured as “Select a Range” with a minimum and maximum number of choices.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_checkbox_limit_range_message'``,``'your_function_name'``, 10, 4 );` |
...
- **$min** [int](https://docs.gravityforms.com/int)

The minimum number of choices that must be selected.
- **$max** [int](https://docs.gravityforms.com/int)

The maximum number of choices that must be selected.
- **$field** [integer](https://docs.gravityforms.com/integer/)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_checkbox_limit_range_message'``,``'range_message'``, 10, 4 );`<br>`function``range_message(``$message``,``$min``,``$max``,``$field``) {`<br>```return``'You must pick between '``.``$min``.``' and '``.``$max``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_checkbox_limit_range_message/# "Algolia")
