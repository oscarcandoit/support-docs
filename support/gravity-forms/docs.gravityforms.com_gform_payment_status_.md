---
url: "https://docs.gravityforms.com/gform_payment_status/"
title: "gform_payment_status - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_payment_status/#h-description)
- [Usage](https://docs.gravityforms.com/gform_payment_status/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_payment_status/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_payment_status/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_payment_status/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_payment_status/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_payment_status'``,``'your_function_name'``, 10, 3 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_payment_status'``,``'change_payment_status'``, 10, 3 );`<br>`function``change_payment_status(``$payment_status``,``$form``,``$entry``){`<br>```if``(``$payment_status``==``'Processing'``){`<br>```$payment_status``=``'Testing'``;`<br>```}`<br>```return``$payment_status``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_payment_status/# "Algolia")
