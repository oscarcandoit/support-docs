---
url: "https://docs.gravityforms.com/gform_user_registration_form_selected/"
title: "gform_user_registration_form_selected - Gravity Forms Documentation"
---
...
# gform\_user\_registration\_form\_selected

- [Description](https://docs.gravityforms.com/gform_user_registration_form_selected/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_form_selected/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_form_selected/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_user_registration_form_selected/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_form_selected/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `<script type=``"text/javascript"``>`<br>```jQuery(document).on(``'gform_user_registration_form_selected'``,``function``(event, form){`<br>```// code to be fired once the form is selected`<br>```});`<br>`</script>` |

## Parameters

- **event** [Event Object](https://docs.gravityforms.com/event-object)
The Javascript [event object](http://api.jquery.com/category/events/event-object/).
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `<script type=``"text/javascript"``>`<br>```jQuery(document).on(``'gform_user_registration_form_selected'``,``function``(event, form){`<br>```CreateBuddyPressMetaOptions();`<br>```});`<br>`</script>` |
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_form_selected/# "Algolia")
