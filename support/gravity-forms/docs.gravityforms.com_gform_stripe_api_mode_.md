---
url: "https://docs.gravityforms.com/gform_stripe_api_mode/"
title: "gform_stripe_api_mode - Gravity Forms Documentation"
---
...
# gform\_stripe\_api\_mode

- [Description](https://docs.gravityforms.com/gform_stripe_api_mode/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_api_mode/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_api_mode/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_api_mode/#h-examples)
- [Set Live mode globally.](https://docs.gravityforms.com/gform_stripe_api_mode/#h-set-live-mode-globally)
- [Set Live mode for a specific feed\_id.](https://docs.gravityforms.com/gform_stripe_api_mode/#h-set-live-mode-for-a-specific-feed-id)
- [Placement](https://docs.gravityforms.com/gform_stripe_api_mode/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_api_mode/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_api_mode/#h-source-code)
...
- **$api\_mode** [string](https://docs.gravityforms.com/string)

The API mode. Possible values are `live` or `test`.
- **$feed\_id** [int](https://docs.gravityforms.com/integer/)

Determines the context in which the API mode is applied. When `null`, the global connection settings apply. When specified, the API mode applies to the feed-specific connection.
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_stripe_api_mode'``,``function``(``$api_mode``,``$feed_id``) {`<br>```return``'live'``;`<br>`}, 10, 2 );` |

### Set Live mode for a specific feed\_id.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_stripe_api_mode'``,``function``(``$api_mode``,``$feed_id``) {`<br>```if``(``$feed_id``=== 521 ) {`<br>```return``'live'``;`<br>```}`<br>```return``$api_mode``;`<br>`}, 10, 2 );` |
...
This filter is located in GFStripe::get\_api\_mode() in _gravityformsstripe/class-gf-stripe.php_.
...
[Algolia](https://docs.gravityforms.com/gform_stripe_api_mode/# "Algolia")
