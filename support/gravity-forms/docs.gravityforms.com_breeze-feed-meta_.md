---
url: "https://docs.gravityforms.com/breeze-feed-meta/"
title: "Breeze Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Breeze Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/breeze-filters/)          - [Breeze Feed Meta](https://docs.gravityforms.com/breeze-feed-meta/ "Breeze Feed Meta")
          - [gform\_breeze\_card](https://docs.gravityforms.com/gform_breeze_card/ "gform_breeze_card")
...
- [Introduction](https://docs.gravityforms.com/breeze-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/breeze-feed-meta/#h-usage)
- [Properties](https://docs.gravityforms.com/breeze-feed-meta/#h-properties)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) for the Breeze Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `$feed``[``'meta'``] =``array``(`<br>```'feedName'``=>``'Breeze Feed 1'``,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **project** [string](https://docs.gravityforms.com/string)
...
The ID of the date field or a custom value. _Possible values: The ID of a Date type field or gf\_custom._
...
- **cardInvitees** [array](https://docs.gravityforms.com/array)

|     |     |
| --- | --- |
| 1<br>2<br>3 | `array``(`<br>```'USER_EMAIL_HERE'``=> true,`<br>`);` |
...
[Algolia](https://docs.gravityforms.com/breeze-feed-meta/# "Algolia")
