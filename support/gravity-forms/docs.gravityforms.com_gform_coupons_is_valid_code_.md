---
url: "https://docs.gravityforms.com/gform_coupons_is_valid_code/"
title: "gform_coupons_is_valid_code - Gravity Forms Documentation"
---
...
# gform\_coupons\_is\_valid\_code

- [Description](https://docs.gravityforms.com/gform_coupons_is_valid_code/#h-description)
- [Usage](https://docs.gravityforms.com/gform_coupons_is_valid_code/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_coupons_is_valid_code/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_coupons_is_valid_code/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_coupons_is_valid_code/#h-placement)
- [Since](https://docs.gravityforms.com/gform_coupons_is_valid_code/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_coupons_is_valid_code/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_coupons_is_valid_code'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$is\_alphanumeric** [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_coupons_is_valid_code'``,``'mark_coupon_valid'``, 10, 2 );`<br>`function``mark_coupon_valid(``$alphanumeric``,``$field``){`<br>```return``true;`<br>`}` |
...
This filter is located in GFCoupons::check\_if\_duplicate\_coupon\_code() in _gravityformscoupons/class-gf-coupons.php_.
...
[Algolia](https://docs.gravityforms.com/gform_coupons_is_valid_code/# "Algolia")
