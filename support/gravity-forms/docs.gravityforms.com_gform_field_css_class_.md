---
url: "https://docs.gravityforms.com/gform_field_css_class/"
title: "gform_field_css_class - Gravity Forms Documentation"
---
...
- [Developers](https://docs.gravityforms.com/category/developers/)  - [Theme Framework](https://docs.gravityforms.com/category/developers/theme-framework/)
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Styling/Theme/CSS Filters](https://docs.gravityforms.com/category/developers/hooks/filters/styling-filters/)        - [gform\_default\_styles](https://docs.gravityforms.com/gform_default_styles/ "gform_default_styles")
        - [gform\_disable\_css](https://docs.gravityforms.com/gform_disable_css/ "gform_disable_css")
        - [gform\_disable\_form\_legacy\_css](https://docs.gravityforms.com/gform_disable_form_legacy_css/ "gform_disable_form_legacy_css")
        - [gform\_disable\_form\_theme\_css](https://docs.gravityforms.com/gform_disable_form_theme_css/ "gform_disable_form_theme_css")
        - [gform\_field\_css\_class](https://docs.gravityforms.com/gform_field_css_class/ "gform_field_css_class")
        - [gform\_form\_theme\_slug](https://docs.gravityforms.com/gform_form_theme_slug/ "gform_form_theme_slug")
        - [gform\_noconflict\_styles](https://docs.gravityforms.com/gform_noconflict_styles/ "gform_noconflict_styles")
        - [gform\_preview\_styles](https://docs.gravityforms.com/gform_preview_styles/ "gform_preview_styles")
...
# gform\_field\_css\_class

- [Description](https://docs.gravityforms.com/gform_field_css_class/#h-description)
- [Usage](https://docs.gravityforms.com/gform_field_css_class/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_field_css_class/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_field_css_class/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_field_css_class/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_field_css_class/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_field_css_class'``,``'custom_class'``, 10, 3 );` |

You can also specify this per form by adding the form id after the hook name.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_field_css_class_6'``,``'custom_class'``, 10, 3 );` |

## Parameters

- **$classes** [string](https://docs.gravityforms.com/string)
The CSS classes to be filtered, separated by empty spaces, (i.e. “gfield custom\_class”).
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_filter(``'gform_field_css_class'``,``'custom_class'``, 10, 3 );`<br>`function``custom_class(``$classes``,``$field``,``$form``) {`<br>`if``(``$field``-&gt;type ==``'text'``) {`<br>`$classes``.=``' custom_textfield_class'``;`<br>`}`<br>`return``$classes``;`<br>`}` |
...
This filter is located in GFFormDisplay::get\_field() in _form\_display.php_.
...
[Algolia](https://docs.gravityforms.com/gform_field_css_class/# "Algolia")
