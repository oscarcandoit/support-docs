---
url: "https://docs.gravityforms.com/paragraph-text-field/"
title: "Paragraph Text Field - Gravity Forms Documentation"
---
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields .gfield textarea {``border``:``1px``solid``red``}` |

**example:** standard paragraph field (textarea) – applies just to form ID #1

|     |     |
| --- | --- |
| 1 | `body #gform_wrapper_``1``.gform_body .gform_fields .gfield textarea {``border``:``1px``solid``red``}` |
...
|     |     |
| --- | --- |
| 1 | `body .gform_wrapper .gform_body .gform_fields #field_XX_X.gfield textarea {``border``:``1px``solid``red``}` |
...
[Algolia](https://docs.gravityforms.com/paragraph-text-field/# "Algolia")
