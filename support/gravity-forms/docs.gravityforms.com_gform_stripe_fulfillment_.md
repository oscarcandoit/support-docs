---
url: "https://docs.gravityforms.com/gform_stripe_fulfillment/"
title: "gform_stripe_fulfillment - Gravity Forms Documentation"
---
...
# gform\_stripe\_fulfillment

- [Description](https://docs.gravityforms.com/gform_stripe_fulfillment/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_fulfillment/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_fulfillment/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_stripe_fulfillment/#h-example)
- [Placement](https://docs.gravityforms.com/gform_stripe_fulfillment/#h-placement)
- [Since](https://docs.gravityforms.com/gform_stripe_fulfillment/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_stripe_fulfillment/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `do_action(``'gform_stripe_fulfillment'``,``$session``,``$entry``,``$feed``,``$form``);` |

## Parameters

- **$session** [array](https://docs.gravityforms.com/array)
The session object.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `add_action(``'gform_stripe_fulfillment'``,``'notify_on_checkout_success'``, 10, 4 );`<br>`function``notify_on_checkout_success(``$session``,``$entry``,``$feed``,``$form``) {`<br>```$admin_email``= get_bloginfo(``'admin_email'``);`<br>```wp_mail(``$admin_email``,``'Payment via Stripe Checkout successful!'``,``'Message about the successful payment'``);`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_stripe_fulfillment/# "Algolia")
