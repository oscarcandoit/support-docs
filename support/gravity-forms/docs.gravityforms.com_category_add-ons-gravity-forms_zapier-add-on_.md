---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/zapier-add-on/"
title: "Zapier Add-On Archives - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Zapier Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/zapier-add-on/)    - [Using the Zapier Add-On](https://docs.gravityforms.com/zapier-add-on/ "Using the Zapier Add-On")
    - [Setting up a Zapier Transfer](https://docs.gravityforms.com/setting-up-a-zapier-transfer/ "Setting up a Zapier Transfer")
    - [Setting Up the Zapier Add-On](https://docs.gravityforms.com/setting-up-the-zapier-add-on/ "Setting Up the Zapier Add-On")
    - [Creating a Feed for the Zapier Add-On](https://docs.gravityforms.com/setting-up-your-zapier-feed/ "Creating a Feed for the Zapier Add-On")
    - [Setting Up a Legacy Zapier Zap](https://docs.gravityforms.com/setting-up-your-zapier-zap/ "Setting Up a Legacy Zapier Zap")
    - [Troubleshooting the Zapier Add-On](https://docs.gravityforms.com/troubleshooting-the-zapier-add-on/ "Troubleshooting the Zapier Add-On")
    - [Sending List Field and Product Data as Arrays to Zapier](https://docs.gravityforms.com/send-list-field-product-data-arrays-zapier/ "Sending List Field and Product Data as Arrays to Zapier")
    - [Zapier Add-On Related Articles and Tutorials](https://docs.gravityforms.com/zapier-add-on-related-articles-and-tutorials/ "Zapier Add-On Related Articles and Tutorials")
    - [Using real form entries as Zapier test data](https://docs.gravityforms.com/using-real-form-entries-as-zapier-test-data/ "Using real form entries as Zapier test data")
    - [Zapier Changelog](https://docs.gravityforms.com/zapier-change-log/ "Zapier Changelog")
...
Step-by-step instructions on how to use and configure the Zapier Add-On.](https://docs.gravityforms.com/zapier-add-on/ "Using the Zapier Add-On") [**Setting up a Zapier Transfer** \\
Setting up the Zapier add-on Zapier Transfer requires our Zapier Add-On v4.2 or later. Zapier is an add-on that allows you to trigger an action upon submission of a form.](https://docs.gravityforms.com/setting-up-a-zapier-transfer/ "Setting up a Zapier Transfer") [**Setting Up the Zapier Add-On**\\
...
This article contains details on managing the feeds to Zapier from Gravity Forms, including enabling conditional logic or sending Admin Labels to your Zapier connection.](https://docs.gravityforms.com/setting-up-your-zapier-feed/ "Creating a Feed for the Zapier Add-On") [**Setting Up a Legacy Zapier Zap** \\
Step-by-step instructions on how to set up your Zap through Zapier.](https://docs.gravityforms.com/setting-up-your-zapier-zap/ "Setting Up a Legacy Zapier Zap") [**Troubleshooting the Zapier Add-On** \\
Having trouble getting Zapier to Connect to your Gravity Forms? This troubleshooting guide will help.](https://docs.gravityforms.com/troubleshooting-the-zapier-add-on/ "Troubleshooting the Zapier Add-On") [**Sending List Field and Product Data as Arrays to Zapier** \\
As of Zapier 3.0, the data for List and Product fields is now sent to Zapier as an array.](https://docs.gravityforms.com/send-list-field-product-data-arrays-zapier/ "Sending List Field and Product Data as Arrays to Zapier") [**Zapier Add-On Related Articles and Tutorials** \\
This document contains a quick reference list of articles and tutorials which can help you get the most out of the Zapier add-on.](https://docs.gravityforms.com/zapier-add-on-related-articles-and-tutorials/ "Zapier Add-On Related Articles and Tutorials") [**Using real form entries as Zapier test data** \\
This article provides a code snippet that you can use to fetch actual form submissions from your entries table to see when you are testing out your Zapier Zap.](https://docs.gravityforms.com/using-real-form-entries-as-zapier-test-data/ "Using real form entries as Zapier test data") [**Zapier Changelog** \\
View the change log for the Zapier Add-On.](https://docs.gravityforms.com/zapier-change-log/ "Zapier Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/zapier-add-on/# "Algolia")
