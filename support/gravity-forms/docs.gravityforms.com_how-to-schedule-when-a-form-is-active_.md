---
url: "https://docs.gravityforms.com/how-to-schedule-when-a-form-is-active/"
title: "How To Schedule When A Form Is Active - Gravity Forms Documentation"
---
...
- [Schedule Form Settings](https://docs.gravityforms.com/how-to-schedule-when-a-form-is-active/#h-schedule-form-settings)
- [How Form Scheduling Works](https://docs.gravityforms.com/how-to-schedule-when-a-form-is-active/#h-how-form-scheduling-works)
- [Examples](https://docs.gravityforms.com/how-to-schedule-when-a-form-is-active/#h-examples)
- [Schedule a form for a limited event registration](https://docs.gravityforms.com/how-to-schedule-when-a-form-is-active/#h-schedule-a-form-for-a-limited-event-registration)
- [Settings Reference](https://docs.gravityforms.com/how-to-schedule-when-a-form-is-active/#h-settings-reference)
- [Resources](https://docs.gravityforms.com/how-to-schedule-when-a-form-is-active/#h-resources)

The Schedule Form feature in  [Form Settings](https://docs.gravityforms.com/form-settings/#h-restrictions) allows you to define a specific time period during which your form is active and accepting submissions.

## Schedule Form Settings

To enable a scheduled form:

1. Go to  [Form Settings](https://docs.gravityforms.com/form-settings/#h-restrictions).
2. Navigate to the “Restrictions” section.
3. Check “Schedule form” to activate scheduling options.

## How Form Scheduling Works

When the “Schedule form” option is enabled, the form will only be active between the specified Start Date and Time and End Date and Time. Outside this period, the form will display custom messages to users.

Here’s how the scheduling affects form availability:

- **Before Start Date/Time**: Displays the “Pending Message”.
- **During Scheduled Period**: Form is active and accepts submissions.
- **After End Date/Time**: Displays the “Expired Message”.

## Examples

### Schedule a form for a limited event registration

Set a form to be active from **April 1, 2025, 10:00 AM** to **May 1, 2025, 9:00 AM** with custom messages:

- **Pending Message**: “Registration opens soon! Check back on April 1st.”
- **Expired Message**: “Sorry, registration for this event has closed.”

[![Image showing Form schedule settings](https://docs.gravityforms.com/wp-content/uploads/2025/04/image-26-1024x615.png)](https://docs.gravityforms.com/wp-content/uploads/2025/04/image-26.png)

## Settings Reference

| Setting | Description |
| --- | --- |
| **Start Date and Time** | Sets the exact date and time when the form becomes active. |
| **End Date and Time** | Sets the exact date and time when the form expires and becomes inactive. |
| **Pending Message** | Custom message shown before the form’s start time. Supports HTML. |
| **Expired Message** | Custom message shown after the form’s end time. Supports HTML. |

The schedule uses your WordPress site’s timezone, configured under **Settings > General > Timezone**.

## Resources

- [gform\_pre\_form\_settings\_save](https://docs.gravityforms.com/gform_pre_form_settings_save/)
...
[Algolia](https://docs.gravityforms.com/how-to-schedule-when-a-form-is-active/# "Algolia")
