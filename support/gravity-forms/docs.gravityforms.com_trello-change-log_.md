---
url: "https://docs.gravityforms.com/trello-change-log/"
title: "Trello Changelog - Gravity Forms Documentation"
---
...
- Fixed an issue introduced in 2.2.0.1 where some URLs are not attached when the file is stored outside the default form/year/month folders.

### 2.2.0.1

- Updated to send the gf-download file URL to Trello.
...
[Algolia](https://docs.gravityforms.com/trello-change-log/# "Algolia")
