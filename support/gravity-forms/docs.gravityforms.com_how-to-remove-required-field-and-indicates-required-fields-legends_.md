---
url: "https://docs.gravityforms.com/how-to-remove-required-field-and-indicates-required-fields-legends/"
title: "How To Remove Required Field And Indicates Required Fields legends - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/how-to-remove-required-field-and-indicates-required-fields-legends/#h-introduction)
- [Disable Placeholder Options in Select Fields](https://docs.gravityforms.com/how-to-remove-required-field-and-indicates-required-fields-legends/#h-disable-placeholder-options-in-select-fields)
- [Remove the “\* Indicates Required Fields” Message](https://docs.gravityforms.com/how-to-remove-required-field-and-indicates-required-fields-legends/#h-remove-the-indicates-required-fields-message)
- [Placement](https://docs.gravityforms.com/how-to-remove-required-field-and-indicates-required-fields-legends/#h-placement)
...
[![](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-48-1024x712.png)](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-48.png)

To prevent this, use the following code:

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13 | `// Disable placeholder in dropdown choices so it can't be selected`<br>`add_filter(``'gform_field_content'``,``function``(``$content``,``$field``,``$value``,``$lead_id``,``$form_id``) {`<br>```if``(``$field``instanceof``GF_Field_Select &&``$field``->placeholder ) {`<br>```// Add 'disabled' and 'selected' attributes to the placeholder option`<br>```$content``= preg_replace(`<br>```'/<option\s+class=[\'"]gf_placeholder[\'"]/'``,`<br>```'<option class="gf_placeholder" disabled selected'``,`<br>```$content`<br>```);`<br>```}`<br>```return``$content``;`<br>`}, 10, 5 );` |

[![](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-49-1024x495.png)](https://docs.gravityforms.com/wp-content/uploads/2025/05/image-49.png)
...
Refer to this article for more information about the [gform\_required\_legend](https://docs.gravityforms.com/gform_required_legend/) and [gform\_field\_content](https://docs.gravityforms.com/gform_field_content/) for further details on usage and options.
...
[Algolia](https://docs.gravityforms.com/how-to-remove-required-field-and-indicates-required-fields-legends/# "Algolia")
