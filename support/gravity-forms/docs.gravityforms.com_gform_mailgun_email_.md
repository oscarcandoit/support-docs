---
url: "https://docs.gravityforms.com/gform_mailgun_email/"
title: "gform_mailgun_email - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Mailgun Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/mailgun-filters/)          - [gform\_mailgun\_email](https://docs.gravityforms.com/gform_mailgun_email/ "gform_mailgun_email")
          - [gform\_mailgun\_send\_email\_failed](https://docs.gravityforms.com/gform_mailgun_send_email_failed/ "gform_mailgun_send_email_failed")
...
# gform\_mailgun\_email

- [Description](https://docs.gravityforms.com/gform_mailgun_email/#h-description)
- [Usage](https://docs.gravityforms.com/gform_mailgun_email/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_mailgun_email/#h-parameters)
- [Placement](https://docs.gravityforms.com/gform_mailgun_email/#h-placement)
- [Since](https://docs.gravityforms.com/gform_mailgun_email/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_mailgun_email/#h-source-code)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_mailgun_email'``,``function``(``$mailgun_email``,``$email``,``$message_format``,``$notification``,``$entry``) {`<br>`$mailgun_email``[``'h:x-mailgun-native-send'``] = false;`<br>`return``$mailgun_email``;`<br>`}, 10, 5 );` |

## Parameters

- **$mailgun\_email** [array](https://docs.gravityforms.com/array)
...
- **$message\_format** [array](https://docs.gravityforms.com/array)
...
This filter is located in _class-gf-mailgun.php_.
...
[Algolia](https://docs.gravityforms.com/gform_mailgun_email/# "Algolia")
