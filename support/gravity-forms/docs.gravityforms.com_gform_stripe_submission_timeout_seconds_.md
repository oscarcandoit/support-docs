---
url: "https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/"
title: "gform_stripe_submission_timeout_seconds - Gravity Forms Documentation"
---
...
# gform\_stripe\_submission\_timeout\_seconds

- [Description](https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/#h-description)
- [Usage](https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/#h-examples)
- [Customize Stripe Webhook Timeout Duration](https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/#h-customize-stripe-webhook-timeout-duration)
- [Placement](https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_submission_timeout_seconds'``,``'custom_function'``, 10, 2 );` |

To target a specific form append the form id to the hook name. (format: gform\_stripe\_submission\_timeout\_seconds\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_stripe_submission_timeout_seconds_123'``,``'custom_function'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_stripe_submission_timeout_seconds_123'``,``'custom_stripe_timeout_for_form_123'``, 10, 2 );`<br>`function``custom_stripe_timeout_for_form_123(``$timeout_seconds``,``$form``) {`<br>```return``60;``// Extend to 60 seconds for form ID 123`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_stripe_submission_timeout_seconds/# "Algolia")
