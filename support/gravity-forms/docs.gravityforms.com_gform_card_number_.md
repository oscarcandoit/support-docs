---
url: "https://docs.gravityforms.com/gform_card_number/"
title: "gform_card_number - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_card_number/#h-description)
- [Usage](https://docs.gravityforms.com/gform_card_number/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_card_number/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_card_number/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_card_number/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_card_number/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_card_number'``,``'change_number'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_card_number'``,``'change_number'``, 10, 2 );`<br>`function``change_number(``$label``,``$form_id``) {`<br>```return``"Number"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_card_number/# "Algolia")
