---
url: "https://docs.gravityforms.com/category/knowledge-base/page/2/"
title: "Knowledge Base Archives - Page 2 of 18 - Gravity Forms Documentation - Page 2 of 18"
---
...
If you need to insert an image or other HTML content within your form, Gravity Forms makes the process easy and painless with the HTML field.](https://docs.gravityforms.com/adding-images-javascript-and-more-to-forms/ "Adding Images, JavaScript, and HTML To Forms") [**Adding Javascript Code to the Admin Side of Your Site** \\
Adding scripts and styles for use in the wp-admin area of your site can be accomplished in a few ways.](https://docs.gravityforms.com/adding-javascript-code-to-the-admin-side-of-your-site/ "Adding Javascript Code to the Admin Side of Your Site") [**Adding JavaScript Code to the Frontend of Your Site** \\
This article explores the most common methods for adding JavaScript to your site.](https://docs.gravityforms.com/adding-javascript-code-to-the-frontend-of-your-site/ "Adding JavaScript Code to the Frontend of Your Site") [**Adding Row Spans in the Gravity Forms 2.5 Form Editor** \\
Add fields that span multiple rows to your Gravity Forms in the 2.5 Form Editor using CSS Grid.](https://docs.gravityforms.com/adding-row-spans-in-the-2-5-form-editor/ "Adding Row Spans in the Gravity Forms 2.5 Form Editor") [**Authorized Gravity Forms Sellers** \\
Information regarding the only authorized sellers permitted to sell official Gravity Forms licenses. Only licenses purchased via these avenues are eligible for updates and support.](https://docs.gravityforms.com/authorized-gravity-forms-sellers/ "Authorized Gravity Forms Sellers") [**Automatically Block Unwanted Emails Using Code** \\
This how to article shows you how to automatically learn, store, and block email addresses that your spam defenses catch.](https://docs.gravityforms.com/automatically-block-unwanted-emails-using-code/ "Automatically Block Unwanted Emails Using Code") [**Campfire Changelog** \\
View the change log for the Campfire Add-On.](https://docs.gravityforms.com/campfire-change-log/ "Campfire Changelog") [**Can Gravity Forms Do…?** \\
Gravity Forms offers hundreds of features for new and experienced Wordpress users alike. Additionally, there are many different ways to extend what the core product does.](https://docs.gravityforms.com/features/ "Can Gravity Forms Do…?") [**Changing the Payment Description in the Stripe Add-On** \\
If you need to change the payment description that is sent from your form to Stripe, you can do so quite easily using the gform\_stripe\_charge\_description filter.](https://docs.gravityforms.com/changing-payment-description-stripe-add-on/ "Changing the Payment Description in the Stripe Add-On") [**Checking Your Environment Details** \\
This article provides a guide to checking environment details in Gravity Forms, helping you assess server settings and configurations that affect form functionality.](https://docs.gravityforms.com/checking-environment-details/ "Checking Your Environment Details") [Previous](https://docs.gravityforms.com/category/knowledge-base/) [1](https://docs.gravityforms.com/category/knowledge-base/) 2 [3](https://docs.gravityforms.com/category/knowledge-base/page/3/) [4](https://docs.gravityforms.com/category/knowledge-base/page/4/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/3/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/2/# "Algolia")
