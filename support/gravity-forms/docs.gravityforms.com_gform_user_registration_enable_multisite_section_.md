---
url: "https://docs.gravityforms.com/gform_user_registration_enable_multisite_section/"
title: "gform_user_registration_enable_multisite_section - Gravity Forms"
---
...
# gform\_user\_registration\_enable\_multisite\_section

- [Description](https://docs.gravityforms.com/gform_user_registration_enable_multisite_section/#h-description)
- [Usage](https://docs.gravityforms.com/gform_user_registration_enable_multisite_section/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_user_registration_enable_multisite_section/#h-parameters)
- [Placement](https://docs.gravityforms.com/gform_user_registration_enable_multisite_section/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_user_registration_enable_multisite_section/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_user_registration_enable_multisite_section/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_user_registration_enable_multisite_section'``,``'__return_true'``);` |

## Parameters

- **$enable\_multisite\_section** [bool](https://docs.gravityforms.com/bool)
True or false.
...
|     |     |
| --- | --- |
| 1 | `$enable_multisite_section``= apply_filters(``'gform_user_registration_enable_multisite_section'``,``$this``->is_root_site() );` |

This filter is located in GF\_User\_Registration::feed\_settings\_fields() in _class-gf-user-registration.php_.
...
[Algolia](https://docs.gravityforms.com/gform_user_registration_enable_multisite_section/# "Algolia")
