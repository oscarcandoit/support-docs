---
url: "https://docs.gravityforms.com/trello-feed-meta/"
title: "Trello Feed Meta - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Trello Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/trello-filters/)          - [gform\_trello\_card](https://docs.gravityforms.com/gform_trello_card/ "gform_trello_card")
          - [gform\_trello\_field\_value](https://docs.gravityforms.com/gform_trello_field_value/ "gform_trello_field_value")
          - [Trello Feed Meta](https://docs.gravityforms.com/trello-feed-meta/ "Trello Feed Meta")
...
- [Introduction](https://docs.gravityforms.com/trello-feed-meta/#h-introduction)
- [Usage](https://docs.gravityforms.com/trello-feed-meta/#h-usage)

## Introduction

The [Feed Meta object](https://docs.gravityforms.com/feed-object) meta for the Trello Add-On is an associative array containing the properties which determine how the add-on should process the form submission.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `$feed``[``'meta'``] =``array``(`<br>```'feedName'``=>``'Trello Feed 1'``,`<br>```'feed_condition_conditional_logic'``=> true,`<br>```'feed_condition_conditional_logic_object'``=>``array``(`<br>```'conditionalLogic'``=>``array``(),`<br>```),`<br>`);` |
...
- **board** [string](https://docs.gravityforms.com/string)
...
- **cardName** [string](https://docs.gravityforms.com/string)

The name to be assigned to the card. Merge tags are supported.

- **cardDescription** [string](https://docs.gravityforms.com/string)

The description to be assigned to the card. Merge tags are supported.

- **cardDueDate** [string](https://docs.gravityforms.com/string)

The ID of the date field or a custom value. _Possible values: The ID of a Date type field or gf\_custom_

- **cardDueDate\_custom** [integer](https://docs.gravityforms.com/integer)

The number of days after today, used when the value of **cardDueDate** is gf\_custom.

- **cardLabels** [array](https://docs.gravityforms.com/array)


|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `array``(`<br>```'green'``=> true,`<br>```'red'``=> false,`<br>```'yellow'``=> false,`<br>```'purple'``=> false,`<br>```'orange'``=> false,`<br>```'blue'``=> false,`<br>`);` |
...
- **cardMembers** [array](https://docs.gravityforms.com/array)

|     |     |
| --- | --- |
| 1<br>2<br>3 | `array``(`<br>```'TRELLO_MEMBER_ID_HERE'``=> true,`<br>`);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `array``(`<br>```'10'``=> true,`<br>```'11'``=> false,`<br>`);` |
...
[Algolia](https://docs.gravityforms.com/trello-feed-meta/# "Algolia")
