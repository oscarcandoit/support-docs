---
url: "https://docs.gravityforms.com/gform_paypal_business_email/"
title: "gform_paypal_business_email - Gravity Forms Documentation"
---
...
# gform\_paypal\_business\_email

- [Description](https://docs.gravityforms.com/gform_paypal_business_email/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_business_email/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_business_email/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_business_email/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_paypal_business_email/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_paypal_business_email/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_business_email'``,``'your_function_name'``, 10, 3 );` |

## Parameters

- **$paypalEmail** [bool](https://docs.gravityforms.com/bool)
The PayPal email.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_paypal_business_email'``,``'change_email'``, 10, 3 );`<br>`function``change_email(``$paypalEmail``,``$feed``,``$entry``){`<br>```$paypalEmail``=``'test@rocketgenius.com'``;`<br>```return``$paypalEmail``;`<br>`}` |
...
This filter is located in GFPayPal::can\_process\_ipn() in _gravityformspaypal/class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_business_email/# "Algolia")
