---
url: "https://docs.gravityforms.com/gform_entry_detail_title/"
title: "gform_entry_detail_title - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_entry_detail_title/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entry_detail_title/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entry_detail_title/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_entry_detail_title/#h-example)
- [Source Code](https://docs.gravityforms.com/gform_entry_detail_title/#h-source-code)

## Description

The “gform\_entry\_detail\_title” filter in Gravity Forms allows the title displayed on the entry detail page to be modified.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entry_detail_title'``,``'my_function_call'``);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3 | `add_filter(``'gform_entry_detail_title'``,``function``(``$title``,``$form``,``$entry``) {`<br>```return``'Your new title for entry #'``.``$entry``[``'id'``];`<br>```}, 10, 3 );` |

## Source Code

This filter is located in _entry\_detail.php_.
...
[Algolia](https://docs.gravityforms.com/gform_entry_detail_title/# "Algolia")
