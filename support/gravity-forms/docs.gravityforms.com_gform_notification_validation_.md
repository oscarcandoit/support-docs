---
url: "https://docs.gravityforms.com/gform_notification_validation/"
title: "gform_notification_validation - Gravity Forms Documentation"
---
...
# gform\_notification\_validation

- [Description](https://docs.gravityforms.com/gform_notification_validation/#h-description)
- [Usage](https://docs.gravityforms.com/gform_notification_validation/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_notification_validation/#h-examples)
- [1\. Require a setting](https://docs.gravityforms.com/gform_notification_validation/#h-1-require-a-setting)
- [Since](https://docs.gravityforms.com/gform_notification_validation/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_notification_validation/#h-source-code)

This filter was removed in Gravity Forms v2.5 and is no longer supported.

From Gravity Forms 2.5, notification settings and their validation callbacks are now defined via the [gform\_notification\_settings\_fields](https://docs.gravityforms.com/gform_notification_settings_fields) filter.

## Description

The gform\_notification\_validation filter can be used to validate custom notification settings added using the [gform\_notification\_ui\_settings](https://docs.gravityforms.com/gform_notification_ui_settings) and [gform\_pre\_notification\_save](https://docs.gravityforms.com/gform_pre_notification_save) filters and override the default validation result.
...
To limit the scope of your function to a specific form, append the form id to the end of the hook name. (format: gform\_notification\_validation\_FORMID)
...
An array of properties which make up the notification object to be saved. See [Notifications Object](https://docs.gravityforms.com/notifications-object) for default properties.
...
This example shows how the new setting added by the [gform\_notification\_ui\_settings](https://docs.gravityforms.com/gform_notification_ui_settings) and [gform\_pre\_notification\_save](https://docs.gravityforms.com/gform_pre_notification_save) filters can be required.
...
This filter is located in GFNotification::notification\_edit\_page() in _notification.php_
...
[Algolia](https://docs.gravityforms.com/gform_notification_validation/# "Algolia")
