---
url: "https://docs.gravityforms.com/gf_field_checkbox/"
title: "GF_Field_Checkbox - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_checkbox/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_checkbox/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_checkbox/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_checkbox/#h-properties)
- [Hooks](https://docs.gravityforms.com/gf_field_checkbox/#h-hooks)
- [Source Code](https://docs.gravityforms.com/gf_field_checkbox/#h-source-code)

## Introduction

The GF\_Field\_Checkbox class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Checkbox field is rendered when the form is displayed and how its value is handled during and after form submission. This class also handles the Product Option field rendering when it is a checkbox.
...
An array containing the the individual properties for each checkbox.
  ...
  - **price** [string](https://docs.gravityforms.com/string)
    ...
    |     |     |
    | --- | --- |
    | 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20 | `$choices``=``array``(`<br>```array``(`<br>```'text'``=>``'First Choice'``,`<br>```'value'``=>``'one'``,`<br>```'isSelected'``=> false,`<br>```'price'``=>``'$5.00'``//only populated if a product option field`<br>```),`<br>```array``(`<br>```'text'``=>``'Second Choice'``,`<br>```'value'``=>``'two'``,`<br>```'isSelected'``=> true,`<br>```'price'``=>``''`<br>```),`<br>```array``(`<br>```'text'``=>``'Third Choice'``,`<br>```'value'``=>``'three'``,`<br>```'isSelected'``=> false,`<br>```'price'``=>``''`<br>```),`<br>```);` |
...
- **enablePrice** [boolean](https://docs.gravityforms.com/boolean)
...
An array containing the the individual properties for each checkbox.
  ...
  - **label** [string](https://docs.gravityforms.com/string)
    ...
    |     |     |
    | --- | --- |
    | 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14 | `$inputs``=``array``(`<br>```array``(`<br>```'id'``=>``'1.1'``,`<br>```'label'``=>``'First Choice'``,`<br>```),`<br>```array``(`<br>```'id'``=>``'1.2'``,`<br>```'label'``=>``'Second Choice'``,`<br>```),`<br>```array``(`<br>```'id'``=>``'1.3'``,`<br>```'label'``=>``'Third Choice'``,`<br>```),`<br>```);` |
...
- **productField** [integer](https://docs.gravityforms.com/integer)
...
The following hooks are located in GF\_Field\_Checkbox:

- [gform\_field\_choice\_markup\_pre\_render](https://docs.gravityforms.com/gform_field_choice_markup_pre_render)
- [gform\_field\_choices](https://docs.gravityforms.com/gform_field_choices)

## Source Code

The source code is located in _includes/fields/class-gf-field-checkbox.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_checkbox/# "Algolia")
