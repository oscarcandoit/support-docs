---
url: "https://docs.gravityforms.com/gform_capsulecrm_task/"
title: "gform_capsulecrm_task - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Capsule CRM Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/capsule-crm-filters/)          - [Capsule CRM Feed Meta](https://docs.gravityforms.com/capsule-crm-feed-meta/ "Capsule CRM Feed Meta")
          - [gform\_capsulecrm\_case](https://docs.gravityforms.com/gform_capsulecrm_case/ "gform_capsulecrm_case")
          - [gform\_capsulecrm\_field\_value](https://docs.gravityforms.com/gform_capsulecrm_field_value/ "gform_capsulecrm_field_value")
          - [gform\_capsulecrm\_opportunity](https://docs.gravityforms.com/gform_capsulecrm_opportunity/ "gform_capsulecrm_opportunity")
          - [gform\_capsulecrm\_person](https://docs.gravityforms.com/gform_capsulecrm_person/ "gform_capsulecrm_person")
          - [gform\_capsulecrm\_task](https://docs.gravityforms.com/gform_capsulecrm_task/ "gform_capsulecrm_task")
...
# gform\_capsulecrm\_task

- [Description](https://docs.gravityforms.com/gform_capsulecrm_task/#h-description)
- [Usage](https://docs.gravityforms.com/gform_capsulecrm_task/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_capsulecrm_task/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_capsulecrm_task/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_capsulecrm_task/#h-placement)
- [Since](https://docs.gravityforms.com/gform_capsulecrm_task/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_capsulecrm_task/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_capsulecrm_task'``,``'your_function_name'``, 10, 4 );` |

To target a specific form, append the form id to the hook name. (format: gform\_capsulecrm\_task\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_capsulecrm_task_1'``,``'your_function_name'``, 10, 4 );` |

To target a specific feed for a form, append the form id and feed id to the hook name. (format: gform\_capsulecrm\_task\_FORMID\_FEEDID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_capsulecrm_task_1_7'``,``'your_function_name'``, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16 | `array``(`<br>```'description'``=>``'Capsule CRM'``,`<br>```'detail'``=>``'Task Created by API'``,`<br>```'lastName'``=>``'TestLast'``,`<br>```'dueOn'``=>``'2019-02-14'``,`<br>```'dueTime => '``21:25:08',`<br>```'status'``=>``'OPEN'``,`<br>```'category'``=>`<br>```array``(`<br>```'name'``=>``'Follow-up'`<br>```),`<br>```'owner'``=>`<br>```array``(`<br>```'username'``=>``'testuser'`<br>```)`<br>`)` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_capsulecrm_task'``,``'change_task_object'``, 10, 4 );`<br>`function``change_task_object(``$task``,``$form``,``$entry``,``$feed``){`<br>```$task``[``'description'``] =``'Task Created by API'``;`<br>```return``$task``;`<br>`}` |
...
This filter is located in GFCapsuleCRM::create\_task() in _class-gf-capsulecrm.php_.
...
[Algolia](https://docs.gravityforms.com/gform_capsulecrm_task/# "Algolia")
