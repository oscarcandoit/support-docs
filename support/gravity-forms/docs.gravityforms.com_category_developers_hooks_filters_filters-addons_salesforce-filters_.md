---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/salesforce-filters/"
title: "Salesforce Filters Archives - Gravity Forms Documentation"
---
...
The Feed Meta Object for the Salesforce Add-On is an associative array containing the properties which determine how the add-on should process the form submission.](https://docs.gravityforms.com/salesforce-feed-meta/ "Salesforce Feed Meta") [**gform\_salesforce\_object\_request\_path** \\
The gf\_salesforce\_object\_request\_path filter allows developers to customize the request path used to fetch Salesforce Object Types in the feed creation dropdown for the Gravity Forms Salesforce Add-On to limit or modify the displayed object types.](https://docs.gravityforms.com/gform_salesforce_object_request_path/ "gform_salesforce_object_request_path") [**gform\_salesforce\_object\_data** \\
Filters the object sent to Salesforce when processing the feed.](https://docs.gravityforms.com/gform_salesforce_object_data/ "gform_salesforce_object_data") [**gform\_salesforce\_allow\_manual\_configuration** \\
Enable manual configuration settings for connecting to the Salesforce API.](https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/ "gform_salesforce_allow_manual_configuration")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/salesforce-filters/# "Algolia")
