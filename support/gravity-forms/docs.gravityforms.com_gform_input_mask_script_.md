---
url: "https://docs.gravityforms.com/gform_input_mask_script/"
title: "gform_input_mask_script - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_input_mask_script/#h-description)
- [Usage](https://docs.gravityforms.com/gform_input_mask_script/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_input_mask_script/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_input_mask_script/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_input_mask_script/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_input_mask_script/#h-source-code)
...
To target a specific form append the form id to the hook name. (format: gform\_input\_mask\_script\_FORMID)
...
ID of current field.
- **$mask** [string](https://docs.gravityforms.com/string)
...
|     |
| --- |
| `add_filter(``'gform_input_mask_script_185'``,``'set_mask_script'``, 10, 4 );`<br>`function``set_mask_script(``$script``,``$form_id``,``$field_id``,``$mask``) {`<br>```$script``=``"jQuery('#input_{$form_id}_{$field_id}').mask('"``. esc_js(``$mask``) .``"',{placeholder:' '}).on('keypress', function(e){if(e.which == 13){jQuery(this).blur();} } );"``;`<br>``<br>```return``$script``;`<br>`}` |
...
This filter is located in GFFormDisplay::get\_input\_mask\_init\_script() in _form\_display.php_
...
[Algolia](https://docs.gravityforms.com/gform_input_mask_script/# "Algolia")
