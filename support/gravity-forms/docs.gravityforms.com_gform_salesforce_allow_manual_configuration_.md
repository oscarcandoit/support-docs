---
url: "https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/"
title: "gform_salesforce_allow_manual_configuration - Gravity Forms Documentation"
---
...
# gform\_salesforce\_allow\_manual\_configuration

- [Description](https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/#h-description)
- [Usage](https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/#h-example)
- [Placement](https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/#h-placement)
- [Since](https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/#h-source-code)

## Description

Enable manual configuration settings for connecting to the Salesforce API.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_salesforce_allow_manual_configuration'``,``'your_function_name'``, 10 );` |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_salesforce_allow_manual_configuration'``,``'__return_true'``);` |
...
This filter was added in Salesforce version 1.0.

## Source Code

This filter is located in class GF\_Salesforce in _/class-gf-salesforce.php_.
...
[Algolia](https://docs.gravityforms.com/gform_salesforce_allow_manual_configuration/# "Algolia")
