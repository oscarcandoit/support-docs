---
url: "https://docs.gravityforms.com/state-validation/"
title: "State Validation - Gravity Forms Documentation"
---
...
- [Overview](https://docs.gravityforms.com/state-validation/#h-overview)
- [How It Works](https://docs.gravityforms.com/state-validation/#h-how-it-works)
- [Supported Fields](https://docs.gravityforms.com/state-validation/#h-supported-fields)
...
Upon submission, Gravity Forms validates the submitted values against the stored state. If the submitted value does not match the original configuration, the submission is rejected. State validation is bypassed when **[dynamic population](https://docs.gravityforms.com/allow-field-to-be-populated-dynamically/)** is enabled for a field.
...
| --- | --- | --- |
| **Standard Fields** | [Checkboxes](https://docs.gravityforms.com/checkboxes/), [Consent](https://docs.gravityforms.com/consent-field/), [Image Choice](https://docs.gravityforms.com/image-choices/), [Multiple Choice](https://docs.gravityforms.com/multiple-choice/), [Radio Buttons](https://docs.gravityforms.com/radio-buttons/), [Drop Down](https://docs.gravityforms.com/drop-down/) | – |
| **Product Fields** | [Product](https://docs.gravityforms.com/product/) | Single Product, Drop Down, Radio Buttons, Hidden |
| **Product Fields** | [Option](https://docs.gravityforms.com/option/) | Checkboxes, Drop Down, Radio Buttons |
| **Product Fields** | [Quantity](https://docs.gravityforms.com/quantity/) | Drop Down |
| **Product Fields** | [Shipping](https://docs.gravityforms.com/shipping/) | Drop Down, Radio Buttons |
| **Product Fields** | [Total](https://docs.gravityforms.com/total/) | – |
| **Post Fields** | [Post Category](https://docs.gravityforms.com/post-category/) | Checkboxes, Radio Buttons, Drop Down |
| **Post Fields** | [Post Custom Field](https://docs.gravityforms.com/post-custom-field/) | Checkboxes, Radio Buttons, Drop Down |
| **Post Fields** | [Post Tags](https://docs.gravityforms.com/post-tags/) | Checkboxes, Radio Buttons, Drop Down |
| **Add-On Fields** | Any Add-On field extending [Checkboxes](https://docs.gravityforms.com/checkboxes/), [Radio Buttons](https://docs.gravityforms.com/radio-buttons/), or [Drop Down](https://docs.gravityforms.com/drop-down/) | Same as extended field type |
...
[Algolia](https://docs.gravityforms.com/state-validation/# "Algolia")
