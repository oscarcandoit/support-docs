---
url: "https://docs.gravityforms.com/gform_pre_notification_deactivated/"
title: "gform_pre_notification_deactivated - Gravity Forms Documentation"
---
...
# gform\_pre\_notification\_deactivated

- [Description](https://docs.gravityforms.com/gform_pre_notification_deactivated/#h-description)
- [Usage](https://docs.gravityforms.com/gform_pre_notification_deactivated/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_pre_notification_deactivated/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_pre_notification_deactivated/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_pre_notification_deactivated/#h-source-code)

## Description

The “gform\_pre\_notification\_deactivated” action in Gravity Forms is triggered before a notification is deactivated, allowing further actions to be performed.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_pre_notification_deactivated'``,``'my_function'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `function``my_function() {`<br>```//Do something here`<br>`}`<br>`add_action(``'gform_pre_notification_deactivated'``,``'my_function'``, 10, 2 );` |
...
[Algolia](https://docs.gravityforms.com/gform_pre_notification_deactivated/# "Algolia")
