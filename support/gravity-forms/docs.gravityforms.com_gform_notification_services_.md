---
url: "https://docs.gravityforms.com/gform_notification_services/"
title: "gform_notification_services - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_notification_services/#h-description)
- [Usage](https://docs.gravityforms.com/gform_notification_services/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_notification_services/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_notification_services/#h-examples)
- [1\. Add a new service](https://docs.gravityforms.com/gform_notification_services/#h-1-add-a-new-service)
- [Placement](https://docs.gravityforms.com/gform_notification_services/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_notification_services/#h-source-code)

## Description

The gform\_notification\_services filter can be used to add a new choice to the “Email Service” setting on the edit notification page.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_notification_services'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$services** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `$services``=``array``(`<br>```'wordpress'``=>``array``(`<br>```'label'``=> esc_html__(``'WordPress'``,``'gravityforms'``),`<br>```'image'``=> admin_url(``'images/wordpress-logo.svg'``)`<br>```)`<br>`);` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9 | `add_filter(``'gform_notification_services'``,``'add_notification_service'``);`<br>`function``add_notification_service(``$services``) {`<br>```$services``[``'the_service_name'``] =``array``(`<br>```'label'``=> esc_html__(``'Your Custom Service'``,``'gravityforms'``),`<br>```'image'``=>``'http://someurl.com/image.svg'`<br>```);`<br>```return``$services``;`<br>`}` |
...
This action hook is located in GFNotification::get\_notification\_services() in _notification.php_
...
[Algolia](https://docs.gravityforms.com/gform_notification_services/# "Algolia")
