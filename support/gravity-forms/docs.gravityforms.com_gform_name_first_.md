---
url: "https://docs.gravityforms.com/gform_name_first/"
title: "gform_name_first - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_name_first/#h-description)
- [Usage](https://docs.gravityforms.com/gform_name_first/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_name_first/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_name_first/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_name_first/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_name_first/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_name_first'``,``'change_first'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_name_first'``,``'change_first'``, 10, 2 );`<br>`function``change_first(``$label``,``$form_id``) {`<br>```return``"First Name"``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_name_first/# "Algolia")
