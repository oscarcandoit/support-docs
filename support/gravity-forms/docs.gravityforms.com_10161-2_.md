---
url: "https://docs.gravityforms.com/10161-2/"
title: "gform_updates - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/10161-2/#h-description)
- [Usage](https://docs.gravityforms.com/10161-2/#h-usage)
- [Examples](https://docs.gravityforms.com/10161-2/#h-examples)
- [Source Code](https://docs.gravityforms.com/10161-2/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_action(``'gform_updates'``,``'my_function'``, 10, 0 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `function``my_function() {`<br>`//Do something here`<br>`}`<br>`add_action(``'gform_updates'``,``'my_function'``, 10, 0 );` |
...
[Algolia](https://docs.gravityforms.com/10161-2/# "Algolia")
