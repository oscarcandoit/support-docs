---
url: "https://docs.gravityforms.com/gform_entrydetail_update_button/"
title: "gform_entrydetail_update_button - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_entrydetail_update_button/#h-description)
- [Usage](https://docs.gravityforms.com/gform_entrydetail_update_button/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_entrydetail_update_button/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_entrydetail_update_button/#h-examples)
- [Change the update button text and styling.](https://docs.gravityforms.com/gform_entrydetail_update_button/#h-change-the-update-button-text-nbsp-and-nbsp-styling)
- [Placement](https://docs.gravityforms.com/gform_entrydetail_update_button/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_entrydetail_update_button/#h-source-nbsp-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_entrydetail_update_button'``,``'your_function_name'``);` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$update\_button** | string | The HTML rendered for the Entry Detail update button. |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_entrydetail_update_button'``,``'custom_update_button'``);`<br>`function``custom_update_button(``$update_button``) {`<br>```// Replace the button text and add custom styling`<br>```return``$update_button``;`<br>`}` |
...
This filter is located in includes/functions\_include.php
...
[Algolia](https://docs.gravityforms.com/gform_entrydetail_update_button/# "Algolia")
