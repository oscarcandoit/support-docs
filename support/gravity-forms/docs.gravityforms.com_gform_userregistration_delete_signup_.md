---
url: "https://docs.gravityforms.com/gform_userregistration_delete_signup/"
title: "gform_userregistration_delete_signup - Gravity Forms Documentation"
---
...
# gform\_userregistration\_delete\_signup

- [Description](https://docs.gravityforms.com/gform_userregistration_delete_signup/#h-description)
- [Usage](https://docs.gravityforms.com/gform_userregistration_delete_signup/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_userregistration_delete_signup/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_userregistration_delete_signup/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_userregistration_delete_signup/#h-placement)
- [Since](https://docs.gravityforms.com/gform_userregistration_delete_signup/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_userregistration_delete_signup/#h-source-code)

## Description

The action gform\_userregistration\_delete\_signup allows custom actions to be performed when pending activations are deleted.

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_userregistration_delete_signup'``,``'your_function_name'``);` |

## Parameters

- **$signup** [object](https://docs.gravityforms.com/object)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `add_action(``'gform_userregistration_delete_signup'``,``'save_data_in_delete_table'``);`<br>`function``save_data_in_delete_table (``$signup``){`<br>```//save data into a deletion table if not admin signup`<br>```if``(``$signup``->user_login !=``'admin'``){`<br>```//insert into table`<br>```}`<br>`}` |
...
This action is located in GFUserSignups::delete\_signup() in _includes/signups.php_.
...
[Algolia](https://docs.gravityforms.com/gform_userregistration_delete_signup/# "Algolia")
