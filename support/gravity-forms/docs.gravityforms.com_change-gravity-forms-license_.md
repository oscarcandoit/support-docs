---
url: "https://docs.gravityforms.com/change-gravity-forms-license/"
title: "Change Gravity Forms License on Site Guide"
---
...
- [Summary](https://docs.gravityforms.com/change-gravity-forms-license/#h-summary)
- [Pre-Requisites](https://docs.gravityforms.com/change-gravity-forms-license/#h-pre-requisites)
- [Updating the Key](https://docs.gravityforms.com/change-gravity-forms-license/#h-updating-the-key)

## Summary

In some situations you may need to replace the Gravity Forms license key in use on one of your websites with a different Gravity Forms license key.
...
Changing your license key will not alter any of your form functionality and will not cause the loss of any existing form data. You can change a license key without disruption by following the steps described here.
...
- A new Gravity Forms license key (with the same capabilities). You can purchase from the [Gravity Forms pricing page](https://www.gravityforms.com/pricing). See [this article](https://docs.gravityforms.com/finding-your-license-key/) for information on where to find your key within your Gravity Forms account.

**Make sure** the new license key has the same (or greater) capabilities as the installed license you are replacing. Otherwise you may lose access to updates etc for installed add-on, have an insufficient site allowance, or lose your Priority Support status. See [this article](https://docs.gravityforms.com/gravity-forms-license-types/) for a summary of license types and their benefits.

## Updating the Key

It really is as easy as going to **Forms → Settings** and pasting the new key over the old one (the old one is a hidden field represented only by asterisks).

[This guide](https://docs.gravityforms.com/finding-your-license-key/) provides step-by-step instructions for where to find your key and how to enter it if you need more information. It also includes a link to all validation error codes if you encounter an issue.

[![WordPress General Settings License Key](https://docs.gravityforms.com/wp-content/uploads/2021/07/image-1-1024x234.png)](https://docs.gravityforms.com/wp-content/uploads/2021/07/image-1.png) Image: A successfully validated Gravity Forms license key
...
[Algolia](https://docs.gravityforms.com/change-gravity-forms-license/# "Algolia")
