---
url: "https://docs.gravityforms.com/gform_input_masks/"
title: "gform_input_masks - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_input_masks/#h-description)
- [Usage](https://docs.gravityforms.com/gform_input_masks/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_input_masks/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_input_masks/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_input_masks/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_input_masks/#h-source-code)

## Description

Use this filter to edit the list of built-in input masks that are displayed in the Text Field [input mask](https://docs.gravityforms.com/input-mask/) setting. Useful when adding a new custom input mask that will be used repeatedly.
...
- **$masks** [array](https://docs.gravityforms.com/array)

Current list of masks to be filtered, in the following format:

|     |
| --- |
| `array``(`<br>```'US Phone'``=>``'(999) 999-9999'``,`<br>```'US Phone + Ext'``=>``'(999) 999-9999? x99999'``,`<br>```'Date'``=>``'99/99/9999'``,`<br>```'Tax ID'``=>``'99-9999999'``,`<br>```'SSN'``=>``'999-99-9999'``,`<br>```'Zip Code'``=>``'99999'``,`<br>```'Full Zip Code'``=>``'99999?-9999'`<br>`);` |
...
|     |
| --- |
| `add_filter(``'gform_input_masks'``,``function``(``$masks``) {`<br>```$masks``[``'Product Key'``] =``'a*-999-a999'``;`<br>```return``$masks``;`<br>`} );` |
...
This filter is located in GFFormsModel::get\_input\_masks() in _forms\_model.php_.
...
[Algolia](https://docs.gravityforms.com/gform_input_masks/# "Algolia")
