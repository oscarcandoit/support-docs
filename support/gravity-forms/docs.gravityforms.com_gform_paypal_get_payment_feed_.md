---
url: "https://docs.gravityforms.com/gform_paypal_get_payment_feed/"
title: "gform_paypal_get_payment_feed - Gravity Forms Documentation"
---
...
# gform\_paypal\_get\_payment\_feed

- [Description](https://docs.gravityforms.com/gform_paypal_get_payment_feed/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_get_payment_feed/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_get_payment_feed/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_get_payment_feed/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_paypal_get_payment_feed/#h-placement)
- [Since](https://docs.gravityforms.com/gform_paypal_get_payment_feed/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_paypal_get_payment_feed/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_get_payment_feed'``,``'your_function_name'``, 10, 3 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_paypal_get_payment_feed'``,``'change_feed'``, 10, 3 );`<br>`function``change_feed(``$feed``,``$entry``,``$form``){`<br>```$feed``[``'meta'``][``'feedName'``] =``'Testing'``;`<br>```return``$feed``;`<br>`}` |
...
This filter is located in GFPayPal::get\_payment\_feed() in _gravityformspaypal/class-gf-paypal.php_.
...
[Algolia](https://docs.gravityforms.com/gform_paypal_get_payment_feed/# "Algolia")
