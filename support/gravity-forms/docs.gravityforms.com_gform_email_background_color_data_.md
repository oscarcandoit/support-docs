---
url: "https://docs.gravityforms.com/gform_email_background_color_data/"
title: "gform_email_background_color_data - Gravity Forms Documentation"
---
...
# gform\_email\_background\_color\_data

- [Description](https://docs.gravityforms.com/gform_email_background_color_data/#h-description)
- [Usage](https://docs.gravityforms.com/gform_email_background_color_data/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_email_background_color_data/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_email_background_color_data/#h-example)
- [Placement](https://docs.gravityforms.com/gform_email_background_color_data/#h-placement)
- [Since](https://docs.gravityforms.com/gform_email_background_color_data/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_email_background_color_data/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_email_background_color_data'``,``'your_function_name'``, 10, 3 )` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``"gform_email_background_color_data"``,``"set_email_data_color"``, 10, 3);`<br>```function``set_email_data_color(``$color``,``$field``,``$entry``){`<br>```return``"#CCCCFF"``;`<br>```}` |
...
[Algolia](https://docs.gravityforms.com/gform_email_background_color_data/# "Algolia")
