---
url: "https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_three/"
title: "gform_rich_text_editor_buttons_row_three - Gravity Forms Documentation"
---
...
- [Developers](https://docs.gravityforms.com/category/developers/)  - [Theme Framework](https://docs.gravityforms.com/category/developers/theme-framework/)
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      ...
      - [Rich Text Editor Filters](https://docs.gravityforms.com/category/developers/hooks/filters/rich-text-editor/)        - [gform\_rich\_text\_editor\_buttons](https://docs.gravityforms.com/gform_rich_text_editor_buttons/ "gform_rich_text_editor_buttons")
        - [gform\_rich\_text\_editor\_buttons\_row\_four](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_four/ "gform_rich_text_editor_buttons_row_four")
        - [gform\_rich\_text\_editor\_buttons\_row\_three](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_three/ "gform_rich_text_editor_buttons_row_three")
        - [gform\_rich\_text\_editor\_buttons\_row\_two](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_two/ "gform_rich_text_editor_buttons_row_two")
        - [gform\_rich\_text\_editor\_options](https://docs.gravityforms.com/gform_rich_text_editor_options/ "gform_rich_text_editor_options")
...
# gform\_rich\_text\_editor\_buttons\_row\_three

- [Description](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_three/#h-description)
- [Usage](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_three/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_three/#h-parameters)
- [Source Code](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_three/#h-source-code)

## Description

The “gform\_rich\_text\_editor\_buttons\_row\_three” filter in Gravity Forms controls the buttons displayed in the third row within the Gravity Forms rich text editor. Note: WordPress and Gravity Forms do not include any buttons on the third row of the rich text editor by default.

For more specific use case examples please see our documentation for the [gform\_rich\_text\_editor\_buttons](https://docs.gravityforms.com/gform_rich_text_editor_buttons/#examples) parent filter.
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_rich_text_editor_buttons_row_three'``,``'my_function'``, 10, 2 );` |

To target a specific form append the form id to the hook name. (format: gform\_rich\_text\_editor\_buttons\_row\_three\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_rich_text_editor_buttons_row_three_2'``,``'my_function'``, 10, 2 );` |

To target a specific form field append the form id and field id to the hook name. (format: gform\_rich\_text\_editor\_buttons\_row\_three\_FORMID\_FIELDID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_rich_text_editor_buttons_row_three_2_6'``,``'my_function'``, 10, 2 );` |

## Parameters

- **$mce\_buttons** [array](https://docs.gravityforms.com/array)
Array (empty by default) of third row buttons to include within the TinyMCE editor inside Gravity Forms.

- **$editor\_id** [string](https://docs.gravityforms.com/string)

The HTML element ID for the field using the rich text editor.

- **$field\_object** [object](https://docs.gravityforms.com/object)
...
This filter hook is located in _class-gf-field-textarea.php_.
...
[Algolia](https://docs.gravityforms.com/gform_rich_text_editor_buttons_row_three/# "Algolia")
