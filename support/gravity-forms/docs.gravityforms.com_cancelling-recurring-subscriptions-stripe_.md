---
url: "https://docs.gravityforms.com/cancelling-recurring-subscriptions-stripe/"
title: "Cancel Stripe Subscriptions via Gravity Guide"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Stripe Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/)    - [Stripe Getting Started](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-getting-started/)
    - [Stripe Feeds And Entries](https://docs.gravityforms.com/category/add-ons-gravity-forms/stripe-add-on/stripe-feeds-and-entries/)      - [Stripe Feed Settings Reference](https://docs.gravityforms.com/stripe-feed-settings-reference/ "Stripe Feed Settings Reference")
      - [Creating a Feed for the Stripe Add-On](https://docs.gravityforms.com/setting-up-the-stripe-feeds/ "Creating a Feed for the Stripe Add-On")
      - [Managing Stripe Entries](https://docs.gravityforms.com/stripe-entry-detail-actions/ "Managing Stripe Entries")
      - [Canceling Recurring Subscriptions in Stripe](https://docs.gravityforms.com/cancelling-recurring-subscriptions-stripe/ "Canceling Recurring Subscriptions in Stripe")
      - [Stripe Marks Charge As Recurring When It Is Non-Recurring](https://docs.gravityforms.com/stripe-marking-charges-as-recurring/ "Stripe Marks Charge As Recurring When It Is Non-Recurring")
...
- [Introduction](https://docs.gravityforms.com/cancelling-recurring-subscriptions-stripe/#h-introduction)
- [Steps](https://docs.gravityforms.com/cancelling-recurring-subscriptions-stripe/#h-steps)
...
**Note:** If you’d like to learn how to cancel subscriptions from within your Stripe account, please use [this tutorial provided by Stripe](https://support.stripe.com/questions/how-to-pause-or-cancel-subscriptions).

## Steps

1. Login to your WordPress admin dashboard.
2. Access the [list of entries for your form](https://docs.gravityforms.com/category/user-guides/form-entries/) by hovering over **Forms** on the left side menu and clicking on **Entries**. You should see a list of the entries collected by this form. If you do not see the entries you were expecting, make sure you are viewing the correct form. You can switch forms using the drop down on the top right of the page.
3. Click on the name of the entry to access it.
4. On the right side of the entry page, you should see a button labeled **Cancel Subscription** within the subscription details. Simply click it to cancel the recurring subscription.

[![Image showing Entry detail with Cancel Subscription button enabled](https://docs.gravityforms.com/wp-content/uploads/2025/03/image-20.png)](https://docs.gravityforms.com/wp-content/uploads/2025/03/image-20.png)

5. A confirmation dialog is displayed for verification.
6. The subscription status should now show as _Canceled_.

[![Image showing Entry detail with cancelled subscription](https://docs.gravityforms.com/wp-content/uploads/2025/03/image-21.png)](https://docs.gravityforms.com/wp-content/uploads/2025/03/image-21.png)

If you have a [Subscription Canceled notification](https://docs.gravityforms.com/gravity-forms-notification-events/#subscription-canceled) configured, the customer will receive an email informing them that their subscription was canceled.
...
[Algolia](https://docs.gravityforms.com/cancelling-recurring-subscriptions-stripe/# "Algolia")
