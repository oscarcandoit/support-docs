---
url: "https://docs.gravityforms.com/gform_product_price/"
title: "gform_product_price - Gravity Forms Documentation"
---
...
# gform\_product\_price

- [Description](https://docs.gravityforms.com/gform_product_price/#h-description)
- [Usage](https://docs.gravityforms.com/gform_product_price/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_product_price/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_product_price/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_product_price/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_product_price/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_product_price'``,``'your_function_name'``, 10, 2 );` |

You can also target a specific form by adding the form id after the hook name. (format: gform\_product\_price\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_product_price_6'``,``'your_function_name'``, 10, 2 );` |

## Parameters

- **$sublabel** [string](file:///string)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_product_price_185'``,``function``(``$sublabel``,``$form_id``) {`<br>```GFCommon::log_debug(``__METHOD__``.``'(): Running...'``);`<br>```return``'Cost'``;`<br>`}, 10, 2 );` |
...
- GFCommon::get\_submitted\_pricing\_fields() in _common.php_
- GFEntryDetail::lead\_detail\_grid() in _entry\_detail.php_
- GF\_Field\_Calculation::get\_field\_input() in _includes/fields/class-gf-field-calculation.php_
- GF\_Field\_SingleProduct::get\_field\_input() in _includes/fields/class-gf-field-singleproduct.php_
...
[Algolia](https://docs.gravityforms.com/gform_product_price/# "Algolia")
