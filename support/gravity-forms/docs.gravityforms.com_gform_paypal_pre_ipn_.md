---
url: "https://docs.gravityforms.com/gform_paypal_pre_ipn/"
title: "gform_paypal_pre_ipn - Gravity Forms Documentation"
---
...
# gform\_paypal\_pre\_ipn

- [Description](https://docs.gravityforms.com/gform_paypal_pre_ipn/#h-description)
- [Usage](https://docs.gravityforms.com/gform_paypal_pre_ipn/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_paypal_pre_ipn/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_paypal_pre_ipn/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_paypal_pre_ipn/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_paypal_pre_ipn/#h-source-code)
- [More Info](https://docs.gravityforms.com/gform_paypal_pre_ipn/#h-more-info)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_paypal_pre_ipn'``,``'your_function_name'``, 10, 4 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_paypal_pre_ipn'``,``'cancel_ipn'``);`<br>`function``cancel_ipn(``$cancel``) {`<br>```return``true;`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `apply_filters(``'gform_paypal_pre_ipn'``, false,``$_POST``,``$entry``,``$feed``)` |

This filter is located in GFPayPal::can\_process\_ipn() in _class-gf-paypal.php_.

## More Info

For more information on the WordPress **add\_filter** function, refer to the [WordPress Code Reference](https://developer.wordpress.org/reference/functions/add_filter/).
...
[Algolia](https://docs.gravityforms.com/gform_paypal_pre_ipn/# "Algolia")
