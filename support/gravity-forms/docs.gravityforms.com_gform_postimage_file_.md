---
url: "https://docs.gravityforms.com/gform_postimage_file/"
title: "gform_postimage_file - Gravity Forms Documentation"
---
...
# gform\_postimage\_file

- [Description](https://docs.gravityforms.com/gform_postimage_file/#h-description)
- [Usage](https://docs.gravityforms.com/gform_postimage_file/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_postimage_file/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_postimage_file/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_postimage_file/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_postimage_file'``,``'your_function_name'``, 10, 2 );` |

To target a specific form append the form id to the hook name. (format: gform\_postimage\_file\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_postimage_file_5'``,``'your_function_name'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_postimage_file'``,``'change_postimage_file'``, 10, 2 );`<br>`function``change_postimage_file(``$label``,``$form_id``) {`<br>```return``'Image File'``;`<br>`}` |
...
[Algolia](https://docs.gravityforms.com/gform_postimage_file/# "Algolia")
