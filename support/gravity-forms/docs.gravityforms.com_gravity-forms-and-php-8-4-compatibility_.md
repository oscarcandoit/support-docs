---
url: "https://docs.gravityforms.com/gravity-forms-and-php-8-4-compatibility/"
title: "Gravity Forms and PHP 8.4 Compatibility - Gravity Forms Documentation"
---
...
- [Compatibility](https://docs.gravityforms.com/gravity-forms-and-php-8-4-compatibility/#h-compatibility)
- [Reporting Issues](https://docs.gravityforms.com/gravity-forms-and-php-8-4-compatibility/#h-reporting-issues)
- [Known Issues](https://docs.gravityforms.com/gravity-forms-and-php-8-4-compatibility/#h-known-issues)

## Compatibility

PHP 8.4 is a [major new](https://www.php.net/releases/8.4/en.php)release with many new features and changes.

WordPress currently has beta support [for PHP 8.4](https://make.wordpress.org/core/handbook/references/php-compatibility-and-wordpress-versions/).

Gravity Forms core has been tested and confirmed compatible with PHP 8.4. While we haven’t encountered any issues so far, testing is ongoing, especially with our Gravity Forms add-ons, to ensure full compatibility.

## Reporting Issues

If you think you have discovered a PHP 8.4-related issue with a Gravity Forms product in your own testing, which isn’t listed below, please let us know by [contacting Support](http://gravityforms.com/support). Thank you for contributing!
...
[Algolia](https://docs.gravityforms.com/gravity-forms-and-php-8-4-compatibility/# "Algolia")
