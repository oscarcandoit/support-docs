---
url: "https://docs.gravityforms.com/setting-up-the-hubspot-add-on/"
title: "Setting Up the HubSpot Add-On - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [HubSpot Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/hubspot/)    - [Setting Up the HubSpot Add-On](https://docs.gravityforms.com/setting-up-the-hubspot-add-on/ "Setting Up the HubSpot Add-On")
    - [Creating a Feed for the HubSpot Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-hubspot-add-on/ "Creating a Feed for the HubSpot Add-On")
    - [HubSpot Changelog](https://docs.gravityforms.com/hubspot-change-log/ "HubSpot Changelog")
...
# Setting Up the HubSpot Add-On

- [Pre-Requisites](https://docs.gravityforms.com/setting-up-the-hubspot-add-on/#h-pre-requisites)
- [Setup](https://docs.gravityforms.com/setting-up-the-hubspot-add-on/#h-setup)
...
- A [HubSpot](https://www.hubspot.com/products/crm?utm_source=gravity-forms-wordpress&utm_medium=referral&utm_campaign=gravity-forms-hubspot-addon) account

## Setup

1. Log into your WordPress admin dashboard.
2. On the left side navigation menu, hover over **Forms** and click on **Settings**.
3. From this page, click the **HubSpot** tab.
4. Click the **Click here to connect your HubSpot account** button.


![Screenshot of Hubspot Settings](https://docs.gravityforms.com/wp-content/uploads/2021/07/CleanShot-2021-07-08-at-17.43.29.png)

5. Click the **Grant Access** button on the HubSpot page to authorize the connection.

![](https://docs.gravityforms.com/wp-content/uploads/2019/07/Gravity_Forms_create_HubSpot_Account_1020_Permisions-1024x826.png)

Once you have successfully authenticated your account, you will see the message **Signed into HubSpot**.

And then… set up your HubSpot feed using [this help guide](https://docs.gravityforms.com/creating-a-feed-for-the-hubspot-add-on/)!
...
[Algolia](https://docs.gravityforms.com/setting-up-the-hubspot-add-on/# "Algolia")
