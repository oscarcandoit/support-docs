---
url: "https://docs.gravityforms.com/gform_dropbox_folder_path/"
title: "gform_dropbox_folder_path - Gravity Forms Documentation"
---
...
# gform\_dropbox\_folder\_path

- [Description](https://docs.gravityforms.com/gform_dropbox_folder_path/#h-description)
- [Usage](https://docs.gravityforms.com/gform_dropbox_folder_path/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_dropbox_folder_path/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_dropbox_folder_path/#h-examples)
- [1\. Use an entry value in the destination path](https://docs.gravityforms.com/gform_dropbox_folder_path/#h-1-use-an-entry-value-in-the-destination-path)
- [Placement](https://docs.gravityforms.com/gform_dropbox_folder_path/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_dropbox_folder_path/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_dropbox_folder_path'``,``'your_function_name'``, 10, 6 );` |

To target a specific form append the form id to the hook name. (format: gform\_dropbox\_folder\_path\_FORMID)

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_dropbox_folder_path_10'``,``'your_function_name'``, 10, 6 );` |

## Parameters

- **$folder\_path** [string](https://docs.gravityforms.com/string)
...
- **$file\_url** [string](https://docs.gravityforms.com/string)
...
This example shows how you can use a field value from the [Entry Object](https://docs.gravityforms.com/entry-object) when modifying the path.

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_dropbox_folder_path_10'``,``'change_path'``, 10, 6 );`<br>`function``change_path(``$folder_path``,``$form``,``$field_id``,``$entry``,``$feed``,``$file_url``) {`<br>``<br>`return``$folder_path``.``'/'``. rgar(``$entry``,``'5'``);`<br>`}` |
...
|     |     |
| --- | --- |
| 1 | `gf_apply_filters(``'gform_dropbox_folder_path'``,``$form``[``'id'``],``$file``[``'destination'``],``$form``,``$field_id``,``$entry``,``$feed``,``$file_url``)` |

This filter is located in the following methods in _class-gf-dropbox.php_:

- GFDropbox::upload\_file()
- GFDropbox::process\_dropbox\_fields()
...
[Algolia](https://docs.gravityforms.com/gform_dropbox_folder_path/# "Algolia")
