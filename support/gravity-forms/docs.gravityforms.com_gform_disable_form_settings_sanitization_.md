---
url: "https://docs.gravityforms.com/gform_disable_form_settings_sanitization/"
title: "gform_disable_form_settings_sanitization - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_disable_form_settings_sanitization/#h-description)
- [Usage](https://docs.gravityforms.com/gform_disable_form_settings_sanitization/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_disable_form_settings_sanitization/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_disable_form_settings_sanitization/#h-examples)
- [Disable form settings sanitization.](https://docs.gravityforms.com/gform_disable_form_settings_sanitization/#h-disable-nbsp-form-settings-sanitization)
- [Placement](https://docs.gravityforms.com/gform_disable_form_settings_sanitization/#h-placement)
- [Since](https://docs.gravityforms.com/gform_disable_form_settings_sanitization/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_disable_form_settings_sanitization/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_disable_form_settings_sanitization'``,``'your_function_name'``, 10, 1 );` |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_disable_form_settings_sanitization'``,``'__return_true'``);` |
...
This filter is located in GFFormsModel::sanitize\_settings() in forms\_model.php.
...
[Algolia](https://docs.gravityforms.com/gform_disable_form_settings_sanitization/# "Algolia")
