---
url: "https://docs.gravityforms.com/category/add-ons-gravity-forms/kit-add-on/"
title: "Kit Add-On Archives - Gravity Forms Documentation"
---
...
- [Add-Ons](https://docs.gravityforms.com/category/add-ons-gravity-forms/)  - [Add-On Basics](https://docs.gravityforms.com/category/add-ons-gravity-forms/add-on-basics/)
  ...
  - [Kit Add-On](https://docs.gravityforms.com/category/add-ons-gravity-forms/kit-add-on/)    - [Using the Kit Add-On](https://docs.gravityforms.com/using-the-kit-add-on/ "Using the Kit Add-On")
    - [Setting up the Kit Add-On](https://docs.gravityforms.com/setting-up-the-kit-add-on/ "Setting up the Kit Add-On")
    - [Obtaining Your Kit API Key](https://docs.gravityforms.com/obtaining-your-kit-api-key/ "Obtaining Your Kit API Key")
    - [Creating a Feed for the Kit Add-On](https://docs.gravityforms.com/creating-a-feed-for-the-kit-add-on/ "Creating a Feed for the Kit Add-On")
    - [Using the Kit Creator Network](https://docs.gravityforms.com/using-the-kit-creator-network/ "Using the Kit Creator Network")
    - [Kit Changelog](https://docs.gravityforms.com/kit-changelog/ "Kit Changelog")
...
[**Using the Kit Add-On** \\
This article shows you how to use and customize the official Gravity Forms Kit Add-On.](https://docs.gravityforms.com/using-the-kit-add-on/ "Using the Kit Add-On") [**Setting up the Kit Add-On** \\
...
Details on the Kit Creator Network and requirements to use this feature](https://docs.gravityforms.com/using-the-kit-creator-network/ "Using the Kit Creator Network") [**Kit Changelog** \\
View the change log for the Kit Add-On.](https://docs.gravityforms.com/kit-changelog/ "Kit Changelog")

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/add-ons-gravity-forms/kit-add-on/# "Algolia")
