---
url: "https://docs.gravityforms.com/gform_address_street2/"
title: "gform_address_street2 - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_address_street2/#h-description)
- [Usage](https://docs.gravityforms.com/gform_address_street2/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_address_street2/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_address_street2/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_address_street2/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_address_street2/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_address_street2'``,``'change_address_street2'``, 10, 2 );` |

Applies to a specific form. In this case, form id 5.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_address_street2_5'``,``'change_address_street2'``, 10, 2 );` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `add_filter(``'gform_address_street2'``,``'change_address_street2'``, 10, 2 );`<br>`function``change_address_street2(``$label``,``$form_id``) {`<br>```return``"Address Street 2"``;`<br>`}` |
...
This filter is located in _js.php_ and GF\_Field\_Address::get\_field\_input() in _includes/fields/class-gf-field-address.php_.
...
[Algolia](https://docs.gravityforms.com/gform_address_street2/# "Algolia")
