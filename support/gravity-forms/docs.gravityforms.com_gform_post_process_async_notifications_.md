---
url: "https://docs.gravityforms.com/gform_post_process_async_notifications/"
title: "Post Process Async Notifications Guide"
---
...
# gform\_post\_process\_async\_notifications

- [Description](https://docs.gravityforms.com/gform_post_process_async_notifications/#description)
- [Usage](https://docs.gravityforms.com/gform_post_process_async_notifications/#usage)
- [Parameters](https://docs.gravityforms.com/gform_post_process_async_notifications/#parameters)
- [Example](https://docs.gravityforms.com/gform_post_process_async_notifications/#examples)
- [Placement](https://docs.gravityforms.com/gform_post_process_async_notifications/#h-placement)
- [Since](https://docs.gravityforms.com/gform_post_process_async_notifications/#since)
- [Source Code](https://docs.gravityforms.com/gform_post_process_async_notifications/#source-code)
...
The event the notifications were sent for. Default is `form_submission`.
- **$notifications** [array](https://docs.gravityforms.com/array/)

An array containing the IDs of processed notifications.
...
|     |
| --- |
| `add_action(``'gform_post_process_async_notifications'``,``function``(``$event``,``$notifications``,``$form``,``$entry``,``$data``) {`<br>```// Do something after the notifications are sent in the background.`<br>`} );` |
...
This action hook is located in `\Gravity_Forms\Gravity_Forms\Async\GF_Notifications_Processor::task()` in _/includes/async/class-gf-notifications-processor.php_.
...
[Algolia](https://docs.gravityforms.com/gform_post_process_async_notifications/# "Algolia")
