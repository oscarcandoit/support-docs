---
url: "https://docs.gravityforms.com/gform_delete_meta/"
title: "gform_delete_meta() - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_delete_meta/#h-description)
- [Usage](https://docs.gravityforms.com/gform_delete_meta/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_delete_meta/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_delete_meta/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_delete_meta/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `gform_delete_meta(``$entry_id``,``$meta_key``);` |
...
|     |     |
| --- | --- |
| 1<br>2 | `// deletes the meta value of the "temporary_value" entry meta key for entry ID 13`<br>`gform_delete_meta( 13,``'temporary_value'``);` |
...
[Algolia](https://docs.gravityforms.com/gform_delete_meta/# "Algolia")
