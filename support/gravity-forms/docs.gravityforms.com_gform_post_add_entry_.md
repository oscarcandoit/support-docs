---
url: "https://docs.gravityforms.com/gform_post_add_entry/"
title: "gform_post_add_entry - Gravity Forms Documentation"
---
...
# gform\_post\_add\_entry

- [Description](https://docs.gravityforms.com/gform_post_add_entry/#h-description)
- [Usage](https://docs.gravityforms.com/gform_post_add_entry/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_post_add_entry/#h-parameters)
- [Example](https://docs.gravityforms.com/gform_post_add_entry/#h-example)
- [Placement](https://docs.gravityforms.com/gform_post_add_entry/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_post_add_entry/#h-source-code)

## Description

This hook fires after an entry has been added via [GFAPI::add\_entry()](https://www.gravityhelp.com/documentation/article/api-functions/#add_entry).

## Usage

|     |     |
| --- | --- |
| 1 | `add_action(``'gform_post_add_entry'``,``'your_function_name'``, 10, 2 );` |

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| **$entry** | [Entry Object](https://docs.gravityforms.com/entry-object) | The entry after being added. |
| **$form** | [Form Object](https://docs.gravityforms.com/form-object) | The form object. |

## Example

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_action(``'gform_post_add_entry'``,``'log_post_add_entry'``, 10, 2 );`<br>`function``log_post_add_entry(``$entry``,``$form``) {`<br>```GFCommon::log_debug(``'gform_post_add_entry: entry => '``. print_r(``$entry``, true ) );`<br>`}` |
...
This action is located in GFAPI::add\_entry() in _includes/api.php_.
...
[Algolia](https://docs.gravityforms.com/gform_post_add_entry/# "Algolia")
