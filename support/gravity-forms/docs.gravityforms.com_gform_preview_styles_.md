---
url: "https://docs.gravityforms.com/gform_preview_styles/"
title: "gform_preview_styles - Gravity Forms Documentation"
---
...
# gform\_preview\_styles

- [Description](https://docs.gravityforms.com/gform_preview_styles/#h-description)
- [Usage](https://docs.gravityforms.com/gform_preview_styles/#h-usage)
- [Examples](https://docs.gravityforms.com/gform_preview_styles/#h-examples)
- [Source Code](https://docs.gravityforms.com/gform_preview_styles/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter( &#039;gform_preview_styles&#039;, &#039;your_function_name&#039;, 10, 2 );` |

## Parameters

- **$styles** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter( &#039;gform_preview_styles&#039;, &#039;enqueue_custom_style&#039;, 10, 2) ;`<br>`function``enqueue_custom_style(``$styles``,``$form``) {`<br>`wp_register_style( &#039;my_style&#039;, get_stylesheet_directory_uri() . &#039;/my_style.css&#039; );`<br>`$styles``=``array``( &#039;my_style&#039; );`<br>`return``$styles``;`<br>`}` |

## Source Code

This filter is located in _preview.php_.
...
[Algolia](https://docs.gravityforms.com/gform_preview_styles/# "Algolia")
