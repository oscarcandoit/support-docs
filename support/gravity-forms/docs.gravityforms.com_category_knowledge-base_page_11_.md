---
url: "https://docs.gravityforms.com/category/knowledge-base/page/11/"
title: "Knowledge Base Archives - Page 11 of 18 - Gravity Forms Documentation - Page 11 of 18"
---
...
Schedule your form’s active period with ease. Set Start and End Date/Time, and customize Pending and Expired Messages.](https://docs.gravityforms.com/how-to-schedule-when-a-form-is-active/ "How To Schedule When A Form Is Active") [**How to Separate Product Selection and Price When Exporting Entries** \\
By default, export columns which separate the product name and the product price are available for single product fields.](https://docs.gravityforms.com/how-to-separate-product-selection-and-price-when-exporting-entries/ "How to Separate Product Selection and Price When Exporting Entries") [**How to Trigger Gravity Forms Scripts in Elementor Popups** \\
This article explains how to trigger Gravity Forms scripts when a form is displayed inside an Elementor popup.](https://docs.gravityforms.com/how-to-trigger-gravity-forms-scripts-in-elementor-popups/ "How to Trigger Gravity Forms Scripts in Elementor Popups") [**How to Use Post Payment Actions** \\
Delay actions like file uploads or third-party integrations until after payment is complete when using add-ons like Stripe or PayPal Checkout.](https://docs.gravityforms.com/how-to-use-post-payment-actions/ "How to Use Post Payment Actions") [**Incompatibilities with the third-party HubSpot Plugin for WordPress** \\
If you’re using the HubSpot plugin for WordPress, it includes a tracking script that captures data from non-HubSpot forms, but this plugin is not compatible with Gravity Forms.](https://docs.gravityforms.com/using-gravity-forms-with-the-hubspot-plugin-what-you-need-to-know/ "Incompatibilities with the third-party HubSpot Plugin for WordPress") [**Increasing Your PHP Max Execution Time** \\
If you are receiving errors due to PHP scripts timing out when manipulating large amounts of data, such as a large import or export, you may need to increase the max execution time in PHP.](https://docs.gravityforms.com/increasing-php-max-execution-time/ "Increasing Your PHP Max Execution Time") [**Increasing Your PHP Memory Limits** \\
Sometimes, you may come across issues such as errors when exporting a large number of entries, or even errors stating that your available memory has been exhausted.](https://docs.gravityforms.com/increasing-php-memory-limits/ "Increasing Your PHP Memory Limits") [**Information for Security Researchers** \\
If you have discovered a vulnerability in one of our products we want to hear from you as soon as possible. Please gather as much information together as you can so we can work quickly to address it.](https://docs.gravityforms.com/information-for-security-researchers/ "Information for Security Researchers") [**Installing Gravity Plugins and Add-Ons using Composer** \\
Discover the commands required to use Composer to manage Gravity Forms, Gravity SMTP, and related add-ons.](https://docs.gravityforms.com/install-gravity-plugins-and-add-ons-via-composer/ "Installing Gravity Plugins and Add-Ons using Composer") [**Is Gravity Forms PCI Compliant?** \\
The short answer is yes, Gravity Forms is PCI compliant. However, this is subject to change depending on your environment and setup, as Gravity Forms is simply a single piece of the puzzle.](https://docs.gravityforms.com/is-gravity-forms-pci-compliant/ "Is Gravity Forms PCI Compliant?") [Previous](https://docs.gravityforms.com/category/knowledge-base/page/10/) [1](https://docs.gravityforms.com/category/knowledge-base/)… [9](https://docs.gravityforms.com/category/knowledge-base/page/9/) [10](https://docs.gravityforms.com/category/knowledge-base/page/10/) 11 [12](https://docs.gravityforms.com/category/knowledge-base/page/12/) [13](https://docs.gravityforms.com/category/knowledge-base/page/13/)… [18](https://docs.gravityforms.com/category/knowledge-base/page/18/) [Next](https://docs.gravityforms.com/category/knowledge-base/page/12/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/knowledge-base/page/11/# "Algolia")
