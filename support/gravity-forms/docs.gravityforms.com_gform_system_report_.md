---
url: "https://docs.gravityforms.com/gform_system_report/"
title: "gform_system_report - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_system_report/#h-description)
- [Usage](https://docs.gravityforms.com/gform_system_report/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_system_report/#h-parameters)
- [Since](https://docs.gravityforms.com/gform_system_report/#h-since)
- [Placement](https://docs.gravityforms.com/gform_system_report/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_system_report/#h-source-code)

## Description

The “gform\_system\_report” filter allows the sections displayed on the [System Status](https://docs.gravityforms.com/checking-environment-details) page to be modified. Sections may be added/removed with the displayed text changed.

## Usage

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_system_report'``,``'your_function_name'``);` |

## Parameters

- **$system\_report** [array](https://docs.gravityforms.com/array)
...
This filter is located in _system\_report.php_.
...
[Algolia](https://docs.gravityforms.com/gform_system_report/# "Algolia")
