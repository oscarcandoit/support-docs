---
url: "https://docs.gravityforms.com/deleting-entries-with-the-gfapi/"
title: "Deleting Entries with the GFAPI - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/deleting-entries-with-the-gfapi/#introduction)
- [Method Overview](https://docs.gravityforms.com/deleting-entries-with-the-gfapi/#h-method-overview)
- [Source Code](https://docs.gravityforms.com/deleting-entries-with-the-gfapi/#source-code)
- [Parameters](https://docs.gravityforms.com/deleting-entries-with-the-gfapi/#parameters)
- [Returns](https://docs.gravityforms.com/deleting-entries-with-the-gfapi/#returns)
- [Usage Example](https://docs.gravityforms.com/deleting-entries-with-the-gfapi/#usage-example)

## Introduction

The **GFAPI::delete\_entry()** method is used to permanently delete an entry.
...
| --- | --- |
| Class | **GFAPI** |
| Function | **delete\_entry** |
| Parameters | [see below](https://docs.gravityforms.com/deleting-entries-with-the-gfapi/#delete-entry-parameters) |
| Returns | [see below](https://docs.gravityforms.com/deleting-entries-with-the-gfapi/#delete-entry-returns) |
...
| --- | --- | --- |
| **$entry\_id** | [integer](https://docs.gravityforms.com/array) | The ID of the entry to be deleted. |
...
[Algolia](https://docs.gravityforms.com/deleting-entries-with-the-gfapi/# "Algolia")
