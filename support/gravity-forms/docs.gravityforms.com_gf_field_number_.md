---
url: "https://docs.gravityforms.com/gf_field_number/"
title: "GF_Field_Number - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/gf_field_number/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_number/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_number/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_number/#h-properties)
- [Source Code](https://docs.gravityforms.com/gf_field_number/#h-source-code)

## Introduction

The GF\_Field\_Number class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Number field is rendered when the form is displayed and how its value is handled during and after form submission. If a field is a Quantity field and Number is the chosen type of quantity, then this also handles the Quantity field.
...
- **calculationRounding** [string](https://docs.gravityforms.com/string)
...
- **numberFormat** [string](https://docs.gravityforms.com/string)

The format for the number. The choices are “currency”, “decimal\_comma”, “decimal\_dot”.
...
- **rangeMax** [integer](https://docs.gravityforms.com/integer)

The maximum number the value may be. This is not available when enableCalculation is true.

- **rangeMin** [integer](https://docs.gravityforms.com/integer)
...
The source code is located in _includes/fields/class-gf-field-number.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_number/# "Algolia")
