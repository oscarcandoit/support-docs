---
url: "https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/"
title: "gform_googleanalytics_pagination_event_name - Gravity Forms Documentation"
---
...
# gform\_googleanalytics\_pagination\_event\_name

- [Description](https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/#description)
- [Usage](https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/#usage)
- [Parameters](https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/#parameters)
- [Examples](https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/#examples)
- [1\. Append form ID to event name](https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/#h-1-append-form-id-to-event-name)
- [Placement](https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/#h-placement)
- [Since](https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/#since)
- [Source Code](https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/#source-code)

## Description

The `gform_googleanalytics_pagination_event_name` filter hook can be used to filter the name of the pagination event to be sent to Google Analytics. This filter only applies to Google Analytics or Measurement Protocol (not Tag Manager).

**Note:** For more information about restrictions on resetting the event name, refer to [\[GA4\] Event naming rules – Analytics Help](https://support.google.com/analytics/answer/13316687?hl=en).
...
- **$event\_name** [string](https://docs.gravityforms.com/string/)

The event name sent to Google Analytics. Default is `gforms_pagination`.
- **$mode** [string](https://docs.gravityforms.com/string/)

Google Analytics connection mode. “ga” for Analytics, “gtm” for Tag Manager, “gmp” for Management Protocol.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_googleanalytics_pagination_event_name'``,``function``(``$event_name``,``$mode``,``$form``) {`<br>```return``"{$event_name}_{$form['id']}"``;`<br>`}, 10, 3 );` |
...
This action hook is located in class `GF_Google_Analytics` in _/class-gf-google-analytics.php_.
...
[Algolia](https://docs.gravityforms.com/gform_googleanalytics_pagination_event_name/# "Algolia")
