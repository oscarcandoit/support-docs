---
url: "https://docs.gravityforms.com/gform_before_resend_notifications/"
title: "gform_before_resend_notifications - Gravity Forms Documentation"
---
...
# gform\_before\_resend\_notifications

- [Description](https://docs.gravityforms.com/gform_before_resend_notifications/#h-description)
- [Usage](https://docs.gravityforms.com/gform_before_resend_notifications/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_before_resend_notifications/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_before_resend_notifications/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_before_resend_notifications/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_before_resend_notifications/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_before_resend_notifications'``,``'change_subject'``, 10, 2 );` |

Applies to a specific form. In this case, form Id 5.

|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_before_resend_notifications_5'``,``'change_subject'``, 10, 2 );` |
...
- **$lead\_ids** [array](https://docs.gravityforms.com/array)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `add_filter(``'gform_before_resend_notifications'``,``'change_subject'``, 10, 2 );`<br>`function``change_subject(``$form``,``$lead_ids``) {`<br>```$original_subject``=``$form``[``'notification'``][``'subject'``];`<br>```$form``[``'notification'``][``'subject'``] =``'Resending - '``.``$original_subject``;`<br>```return``$form``;`<br>`}` |
...
This filter is located in GFForms::resend\_notifications() in _gravityforms.php_
...
[Algolia](https://docs.gravityforms.com/gform_before_resend_notifications/# "Algolia")
