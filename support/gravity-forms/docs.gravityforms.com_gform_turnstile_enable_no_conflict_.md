---
url: "https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/"
title: "gform_turnstile_enable_no_conflict - Gravity Forms Documentation"
---
  ...
  - [Hooks](https://docs.gravityforms.com/category/developers/hooks/)    - [Actions](https://docs.gravityforms.com/category/developers/hooks/actions/)
    - [Filters](https://docs.gravityforms.com/category/developers/hooks/filters/)      - [Add-On Framework Filters](https://docs.gravityforms.com/category/developers/hooks/filters/addon-framework-filters/)
      - [Add-On Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/)        - [2Checkout Add-On](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/2checkout-add-on-filters-addons/)
        ...
        - [Turnstile Filters](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/turnstile-filters/)          - [gform\_turnstile\_enable\_no\_conflict](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/ "gform_turnstile_enable_no_conflict")
...
# gform\_turnstile\_enable\_no\_conflict

- [Description](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/#h-description)
- [Usage](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/#h-examples)
- [Enable No-Conflict mode for Turnstile.](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/#h-enable-no-conflict-mode-for-nbsp-turnstile)
- [Placement](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/#h-placement)
- [Since](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/#h-since)
- [Source Code](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/#h-source-code)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_turnstile_enable_no_conflict'``,``'your_function_name'``, 10, 1 );` |
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_turnstile_enable_no_conflict'``,``'__return_true'``);` |
...
This filter is located in GFTurnstile::handle\_no\_conflict() in class-gf-turnstile.php.
...
[Algolia](https://docs.gravityforms.com/gform_turnstile_enable_no_conflict/# "Algolia")
