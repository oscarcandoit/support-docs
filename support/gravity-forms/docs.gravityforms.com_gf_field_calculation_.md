---
url: "https://docs.gravityforms.com/gf_field_calculation/"
title: "GF_Field_Calculation - Gravity Forms Documentation"
---
...
# GF\_Field\_Calculation

- [Introduction](https://docs.gravityforms.com/gf_field_calculation/#h-introduction)
- [Settings and Properties](https://docs.gravityforms.com/gf_field_calculation/#h-settings-and-properties)
- [Settings](https://docs.gravityforms.com/gf_field_calculation/#h-settings)
- [Properties](https://docs.gravityforms.com/gf_field_calculation/#h-properties)
- [Hooks](https://docs.gravityforms.com/gf_field_calculation/#h-hooks)
- [Source Code](https://docs.gravityforms.com/gf_field_calculation/#h-source-code)

## Introduction

The GF\_Field\_Calculation class extends the [GF\_Field](https://docs.gravityforms.com/gf_field) class, also known as the [Field Object](https://docs.gravityforms.com/field-object). This class is responsible for determining how the Calculation type Product field is rendered when the form is displayed and how its value is handled during and after form submission.
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `//get the field`<br>`$field``= GFFormsModel::get_field(``$form``, 1 );`<br>`//get the formula`<br>`$formula``=``$field``->calculationFormula;` |
...
- **calculationFormula** [string](https://docs.gravityforms.com/string)
...
- **enableCalculation** [boolean](https://docs.gravityforms.com/boolean)
...
- **disableQuantity** [boolean](https://docs.gravityforms.com/boolean)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17 | `$inputs``=``array``(`<br>```array``(`<br>```'id'``=>``'1.1'``,`<br>```'label'``=>``'Product Name'``,`<br>```'name'``=>``'param_product'`<br>```),`<br>```array``(`<br>```'id'``=>``'1.2'``,`<br>```'label'``=>``'Price'``,`<br>```'name'``=>``'param_price'`<br>```),`<br>```array``(`<br>```'id'``=>``'1.3'``,`<br>```'label'``=>``'Quantity'``,`<br>```'name'``=>``'param_qty'`<br>```),`<br>```)` |
...
The following hooks are located in GF\_Field\_Calculation:

- [gform\_product\_quantity](https://docs.gravityforms.com/gform_product_quantity)
- [gform\_product\_price](https://docs.gravityforms.com/gform_product_price)

## Source Code

The source code is located in _includes/fields/class-gf-field-calculation.php_ in the Gravity Forms folder of your sites plugins directory.
...
[Algolia](https://docs.gravityforms.com/gf_field_calculation/# "Algolia")
