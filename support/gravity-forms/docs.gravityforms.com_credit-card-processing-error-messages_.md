---
url: "https://docs.gravityforms.com/credit-card-processing-error-messages/"
title: "Credit Card Processing Error Messages - Gravity Forms Documentation"
---
...
Payment decline messages (e.g. “Your credit card has expired”) are transmitted from the third party payment gateway being used directly back to the user. The Gravity Forms Add-On will just pass them on.

If the meaning of a payment decline message is unclear, consult the help page for the gateway in question.

- [2Checkout knowledge center](https://verifone.cloud/docs/2checkout)
- [Authorize.net article](https://support.authorize.net/knowledgebase/Knowledgearticle/?code=000001554)
- [Mollie support center](https://help.mollie.com/hc/en-us)
- [PayPal help center](https://www.paypal.com/us/smarthelp/home)
- [Square payment failure article](https://squareup.com/help/us/en/article/5082-why-did-my-payment-fail#declined-card)
...
[Algolia](https://docs.gravityforms.com/credit-card-processing-error-messages/# "Algolia")
