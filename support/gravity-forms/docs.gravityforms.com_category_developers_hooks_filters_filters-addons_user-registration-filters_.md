---
url: "https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/"
title: "User Registration Filters Archives - Gravity Forms Documentation"
---
...
If you're using the Gravity Forms login form but want to use a custom template, you can easily do so. This is especially helpful for theme developers who want to utilize the existing login form already built into Gravity Forms.](https://docs.gravityforms.com/customizing-login-widget-template/ "Customizing The Login Form Template") [**GF\_User\_Registration** \\
GF\_User\_Registration is the class which houses the main functionality of the Gravity Forms User Registration Add-on; it extends the GFFeedAddOn class which is part of the add-on framework.](https://docs.gravityforms.com/gf_user_registration/ "GF_User_Registration") [**gform\_activate\_user** \\
This action fires after a user signup has been activated.](https://docs.gravityforms.com/gform_activate_user/ "gform_activate_user") [**gform\_disable\_registration** \\
This filter allows add-ons to prevent the User Registration add-on from registering/updating a user.](https://docs.gravityforms.com/gform_disable_registration/ "gform_disable_registration") [**gform\_gfuser\_object\_init** \\
This hook was removed in version 3.0 with no replacement.](https://docs.gravityforms.com/gform_gfuser_object_init/ "gform_gfuser_object_init") [**gform\_shortcode\_login** \\
This filter is a hook name that is dynamically generated. See gform\_shortcode\_{ACTION} for details on using this hook.](https://docs.gravityforms.com/gform_shortcode_login/ "gform_shortcode_login") [**gform\_shortcode\_user** \\
This filter is a hook name that is dynamically generated. See gform\_shortcode\_{ACTION} for details on using this hook.](https://docs.gravityforms.com/gform_shortcode_user/ "gform_shortcode_user") [**gform\_site\_created** \\
Fires after the site has been created. Only applicable to Network installs with the “Create Site” option enabled.](https://docs.gravityforms.com/gform_site_created/ "gform_site_created") [**gform\_user\_registered** \\
...
This hook was removed in version 3.0 and replaced by gform\_userregistration\_feed\_settings\_fields.](https://docs.gravityforms.com/gform_user_registration_add_option_group/ "gform_user_registration_add_option_group") 1 [2](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/page/2/) [3](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/page/3/) [4](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/page/4/) [Next](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/page/2/)

© Copyright 2008 - 2025 Rocketgenius, Inc

[Return to Gravity Forms](https://www.gravityforms.com/)

[Algolia](https://docs.gravityforms.com/category/developers/hooks/filters/filters-addons/user-registration-filters/# "Algolia")
