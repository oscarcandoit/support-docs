---
url: "https://docs.gravityforms.com/not-receiving-notifications/"
title: "Not Receiving Notifications - Gravity Forms Documentation"
---
...
- [Introduction](https://docs.gravityforms.com/not-receiving-notifications/#h-introduction)
- [Common Signs](https://docs.gravityforms.com/not-receiving-notifications/#h-common-signs)
- [Quick Fixes to Try](https://docs.gravityforms.com/not-receiving-notifications/#h-quick-fixes-to-try)
...
- Entries are recorded successfully in **Forms → Entries** **→** **[Entry Detail](https://docs.gravityforms.com/entry-detail/)**.
- No error messages are shown in Gravity Forms.
- Notifications appear to be sent, but no email arrives.

[![Image showing Notification sent in the Entry Notes](https://docs.gravityforms.com/wp-content/uploads/2025/06/image-1024x597.png)](https://docs.gravityforms.com/wp-content/uploads/2025/06/image.png)

### Quick Fixes to Try

- **Avoid free email providers** like Gmail or Yahoo in the “From Email” field.
- Use an email address at **your website domain** in the “From Email” field.
- **Set up SMTP** using a plugin like [Gravity SMTP](https://gravitysmtp.com/) for more reliable delivery.
- **Check your spam/junk folder** or test with a different email address.
- **Review your DNS settings** to ensure SPF, DKIM, and DMARC records are correctly configured.

For a full troubleshooting guide, see [Troubleshooting Notifications](https://docs.gravityforms.com/troubleshooting-notifications/).
...
[Algolia](https://docs.gravityforms.com/not-receiving-notifications/# "Algolia")
