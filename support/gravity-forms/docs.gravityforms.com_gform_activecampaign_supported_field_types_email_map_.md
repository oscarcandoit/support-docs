---
url: "https://docs.gravityforms.com/gform_activecampaign_supported_field_types_email_map/"
title: "gform_activecampaign_supported_field_types_email_map - Gravity Forms Documentation"
---
...
- [Description](https://docs.gravityforms.com/gform_activecampaign_supported_field_types_email_map/#h-description)
- [Usage](https://docs.gravityforms.com/gform_activecampaign_supported_field_types_email_map/#h-usage)
- [Parameters](https://docs.gravityforms.com/gform_activecampaign_supported_field_types_email_map/#h-parameters)
- [Examples](https://docs.gravityforms.com/gform_activecampaign_supported_field_types_email_map/#h-examples)
- [Placement](https://docs.gravityforms.com/gform_activecampaign_supported_field_types_email_map/#h-placement)
- [Source Code](https://docs.gravityforms.com/gform_activecampaign_supported_field_types_email_map/#h-source-code)
- [Since](https://docs.gravityforms.com/gform_activecampaign_supported_field_types_email_map/#h-since)
...
|     |     |
| --- | --- |
| 1 | `add_filter(``'gform_activecampaign_supported_field_types_email_map'``,``'your_function_name'``);` |

## Parameters

- **$field\_types** [array](https://docs.gravityforms.com/array) \| [bool](https://docs.gravityforms.com/bool)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5 | `add_filter(``'gform_activecampaign_supported_field_types_email_map'``,``function``(``$field_types``) {`<br>```return``array``(``'email'``,``'hidden'``,``'text'``);`<br>``<br>`} );` |
...
|     |     |
| --- | --- |
| 1 | `$field_types``= apply_filters(``'gform_activecampaign_supported_field_types_email_map'``,``array``(``'email'``,``'hidden'``) );` |
...
[Algolia](https://docs.gravityforms.com/gform_activecampaign_supported_field_types_email_map/# "Algolia")
