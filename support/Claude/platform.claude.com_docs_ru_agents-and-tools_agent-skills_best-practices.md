---
url: "https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices"
title: "Лучшие практики создания Skills - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
Для концептуального понимания того, как работают Skills, см. [обзор Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/overview).

## Основные принципы

### Лаконичность — ключ к успеху

[Контекстное окно](https://platform.claude.com/docs/ru/build-with-claude/context-windows) — это общественное благо. Ваш Skill делит контекстное окно со всем остальным, что нужно знать Claude, включая:
...
Для полных деталей структуры Skill см. [обзор Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/overview#skill-structure).
...
SKILL.md служит обзором, который указывает Claude на подробные материалы по мере необходимости, как оглавление в руководстве по адаптации. Для объяснения того, как работает прогрессивное раскрытие, см. [Как работают Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/overview#how-skills-work) в обзоре.
...
![Простой файл SKILL.md, показывающий YAML frontmatter и тело markdown](https://platform.claude.com/docs/images/agent-skills-simple-file.png)
...
![Объединение дополнительных справочных файлов, таких как reference.md и forms.md.](https://platform.claude.com/docs/images/agent-skills-bundling-content.png)
...
Для деталей того, как эта архитектура на основе файловой системы позволяет прогрессивное раскрытие, см. раздел [Среда выполнения](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#runtime-environment) в разделе Advanced ниже.
...
Это показывает паттерн цикла валидации, используя справочные документы вместо скриптов. "Валидатор" — это STYLE\_GUIDE.md, и Claude выполняет проверку путем чтения и сравнения.
...
Разделы ниже сосредоточены на Skills, которые включают исполняемые скрипты. Если ваш Skill использует только инструкции markdown, перейдите к [Контрольному списку для эффективных Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#checklist-for-effective-skills).
...
![Объединение исполняемых скриптов рядом с файлами инструкций](https://platform.claude.com/docs/images/agent-skills-executable-scripts.png)
...
Для большинства служебных скриптов выполнение предпочтительно, потому что оно более надежно и эффективно. См. раздел [Среда выполнения](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#runtime-environment) ниже для деталей того, как работает выполнение скрипта.
...
**Совет реализации**: Сделайте скрипты валидации многословными с конкретными сообщениями об ошибках, такими как "Поле 'signature\_date' не найдено. Доступные поля: customer\_name, order\_total, signature\_date\_signed", чтобы помочь Claude исправить проблемы.
...
Перечислите требуемые пакеты в вашем SKILL.md и проверьте, что они доступны в [документации инструмента выполнения кода](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/code-execution-tool).

### Среда выполнения

Skills работают в среде выполнения кода с доступом к файловой системе, командам bash и возможностями выполнения кода. Для концептуального объяснения этой архитектуры см. [Архитектура Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/overview#the-skills-architecture) в обзоре.
...
Для полных деталей технической архитектуры см. [Как работают Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/overview#how-skills-work) в обзоре Skills.
...
См. [обзор Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/overview#skill-structure) для полных деталей структуры.

### Бюджеты токенов

Держите тело SKILL.md под 500 строк для оптимальной производительности. Если ваше содержимое превышает это, разделите его на отдельные файлы, используя паттерны прогрессивного раскрытия, описанные ранее. Для архитектурных деталей см. [обзор Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/overview#how-skills-work).
...
\\
Создайте ваш первый Skill](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/quickstart) [Используйте Skills в Claude Code\\
\\
Создавайте и управляйте Skills в Claude Code](https://code.claude.com/docs/skills) [Используйте Skills в Agent SDK\\
\\
Используйте Skills программно в TypeScript и Python](https://platform.claude.com/docs/ru/agent-sdk/skills) [Используйте Skills с API\\
\\
Загружайте и используйте Skills программно](https://platform.claude.com/docs/ru/build-with-claude/skills-guide)

- [Основные принципы](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#osnovnye-printsipy)
- [Лаконичность — ключ к успеху](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#lakonichnost-klyuch-k-uspekhu)
- [Установите надлежащие степени свободы](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#ustanovite-nadlezhaschie-stepeni-svobody)
- [Тестируйте со всеми моделями, которые вы планируете использовать](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#testiruyte-so-vsemi-modelyami-kotorye-vy-planiruete-ispolzovat)
- [Структура Skill](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#struktura-skill)
- [Соглашения об именовании](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#soglasheniya-ob-imenovanii)
- [Написание эффективных описаний](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#napisanie-effektivnykh-opisaniy)
- [Паттерны прогрессивного раскрытия](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#patterny-progressivnogo-raskrytiya)
- [Избегайте глубоко вложенных ссылок](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#izbegayte-gluboko-vlozhennykh-ssylok)
- [Структурируйте более длинные справочные файлы с оглавлением](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#strukturiruyte-bolee-dlinnye-spravochnye-fayly-s-oglavleniem)
- [Рабочие процессы и циклы обратной связи](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#rabochie-protsessy-i-tsikly-obratnoy-svyazi)
- [Используйте рабочие процессы для сложных задач](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#ispolzuyte-rabochie-protsessy-dlya-slozhnykh-zadach)
- [Реализуйте циклы обратной связи](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#realizuyte-tsikly-obratnoy-svyazi)
- [Рекомендации по содержимому](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#rekomendatsii-po-soderzhimomu)
- [Избегайте информации, чувствительной ко времени](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#izbegayte-informatsii-chuvstvitelnoy-ko-vremeni)
- [Используйте согласованную терминологию](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#ispolzuyte-soglasovannuyu-terminologiyu)
- [Распространенные паттерны](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#rasprostranennye-patterny)
- [Паттерн шаблона](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#pattern-shablona)
- [Паттерн примеров](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#pattern-primerov)
- [Паттерн условного рабочего процесса](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#pattern-uslovnogo-rabochego-protsessa)
- [Оценка и итерация](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#otsenka-i-iteratsiya)
- [Создайте оценки в первую очередь](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#sozdayte-otsenki-v-pervuyu-ochered)
- [Разрабатывайте Skills итеративно с Claude](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#razrabatyvayte-skills-iterativno-s-claude)
- [Наблюдайте, как Claude навигирует Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#nablyudayte-kak-claude-navigiruet-skills)
- [Антипаттерны, которых следует избегать](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#antipatterny-kotorykh-sleduet-izbegat)
- [Избегайте путей в стиле Windows](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#izbegayte-putey-v-stile-windows)
- [Избегайте предложения слишком много вариантов](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#izbegayte-predlozheniya-slishkom-mnogo-variantov)
- [Advanced: Skills с исполняемым кодом](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#advanced-skills-s-ispolnyaemym-kodom)
- [Решайте, не избегайте](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#reshayte-ne-izbegayte)
- [Предоставьте служебные скрипты](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#predostavte-sluzhebnye-skripty)
- [Используйте визуальный анализ](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#ispolzuyte-vizualniy-analiz)
- [Создайте проверяемые промежуточные выходы](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#sozdayte-proveryaemye-promezhutochnye-vykhody)
- [Упакуйте зависимости](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#upakuyte-zavisimosti)
- [Среда выполнения](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#sreda-vypolneniya)
- [Ссылки на инструменты MCP](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#ssylki-na-instrumenty-mcp)
- [Избегайте предположения, что инструменты установлены](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#izbegayte-predpolozheniya-chto-instrumenty-ustanovleny)
- [Технические заметки](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#tekhnicheskie-zametki)
- [Требования YAML frontmatter](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#trebovaniya-yaml-frontmatter)
- [Бюджеты токенов](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#byudzhety-tokenov)
- [Контрольный список для эффективных Skills](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#kontrolniy-spisok-dlya-effektivnykh-skills)
- [Основное качество](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#osnovnoe-kachestvo)
- [Код и скрипты](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#kod-i-skripty)
- [Тестирование](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#testirovanie)
- [Следующие шаги](https://platform.claude.com/docs/ru/agents-and-tools/agent-skills/best-practices#sleduyuschie-shagi)
