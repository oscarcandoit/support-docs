...
title: "Praktik terbaik pembuatan Skill - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
Untuk latar belakang konseptual tentang cara kerja Skill, lihat [ringkasan Skill](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/overview).

## Prinsip inti

### Ringkas adalah kunci

[Jendela konteks](https://platform.claude.com/docs/id/build-with-claude/context-windows) adalah barang publik. Skill Anda berbagi jendela konteks dengan semua hal lain yang perlu diketahui Claude, termasuk:
...
Untuk detail struktur Skill lengkap, lihat [ringkasan Skill](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/overview#skill-structure).
...
SKILL.md berfungsi sebagai ikhtisar yang menunjukkan Claude ke materi terperinci sesuai kebutuhan, seperti daftar isi dalam panduan orientasi. Untuk penjelasan tentang cara kerja pengungkapan progresif, lihat [Cara kerja Skill](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/overview#how-skills-work) dalam ringkasan.
...
![File SKILL.md sederhana menunjukkan frontmatter YAML dan badan markdown](https://platform.claude.com/docs/images/agent-skills-simple-file.png)
...
Untuk detail tentang bagaimana arsitektur berbasis filesystem ini memungkinkan pengungkapan progresif, lihat bagian [Lingkungan runtime](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#runtime-environment) di bagian Lanjutan di bawah.
...
Ini menunjukkan pola loop validasi menggunakan dokumen referensi daripada skrip. "Validator" adalah STYLE\_GUIDE.md, dan Claude melakukan pemeriksaan dengan membaca dan membandingkan.
...
Bagian di bawah ini fokus pada Skill yang mencakup skrip yang dapat dieksekusi. Jika Skill Anda hanya menggunakan instruksi markdown, lewati ke [Daftar periksa untuk Skill yang efektif](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#checklist-for-effective-skills).
...
Untuk sebagian besar skrip utilitas, eksekusi lebih disukai karena lebih andal dan efisien. Lihat bagian [Lingkungan runtime](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#runtime-environment) di bawah untuk detail tentang cara kerja eksekusi skrip.
...
**Tip implementasi**: Buat skrip validasi verbose dengan pesan kesalahan spesifik seperti "Bidang 'signature\_date' tidak ditemukan. Bidang yang tersedia: customer\_name, order\_total, signature\_date\_signed" untuk membantu Claude memperbaiki masalah.
...
Daftar paket yang diperlukan dalam SKILL.md Anda dan verifikasi tersedia di [dokumentasi alat eksekusi kode](https://platform.claude.com/docs/id/agents-and-tools/tool-use/code-execution-tool).

### Lingkungan runtime

Skill berjalan di lingkungan eksekusi kode dengan akses filesystem, perintah bash, dan kemampuan eksekusi kode. Untuk penjelasan konseptual arsitektur ini, lihat [Arsitektur Skill](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/overview#the-skills-architecture) dalam ringkasan.
...
Untuk detail lengkap tentang arsitektur teknis, lihat [Cara kerja Skill](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/overview#how-skills-work) dalam ringkasan Skill.
...
Lihat [ringkasan Skill](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/overview#skill-structure) untuk detail struktur lengkap.

### Anggaran token

Jaga badan SKILL.md di bawah 500 baris untuk kinerja optimal. Jika konten Anda melebihi ini, pisahkan ke file terpisah menggunakan pola pengungkapan progresif yang dijelaskan sebelumnya. Untuk detail arsitektur, lihat [ringkasan Skill](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/overview#how-skills-work).
...
\\
Buat Skill pertama Anda](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/quickstart) [Gunakan Skills dalam Claude Code\\
\\
Buat dan kelola Skills dalam Claude Code](https://code.claude.com/docs/skills) [Gunakan Skills dalam Agent SDK\\
\\
Gunakan Skills secara terprogram dalam TypeScript dan Python](https://platform.claude.com/docs/id/agent-sdk/skills) [Gunakan Skills dengan API\\
\\
Unggah dan gunakan Skills secara terprogram](https://platform.claude.com/docs/id/build-with-claude/skills-guide)

- [Prinsip inti](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#prinsip-inti)
- [Ringkas adalah kunci](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#ringkas-adalah-kunci)
- [Tetapkan tingkat kebebasan yang sesuai](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#tetapkan-tingkat-kebebasan-yang-sesuai)
- [Uji dengan semua model yang Anda rencanakan untuk digunakan](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#uji-dengan-semua-model-yang-anda-rencanakan-untuk-digunakan)
- [Struktur Skill](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#struktur-skill)
- [Konvensi penamaan](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#konvensi-penamaan)
- [Menulis deskripsi yang efektif](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#menulis-deskripsi-yang-efektif)
- [Pola pengungkapan progresif](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#pola-pengungkapan-progresif)
- [Hindari referensi yang sangat bersarang](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#hindari-referensi-yang-sangat-bersarang)
- [Struktur file referensi yang lebih panjang dengan daftar isi](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#struktur-file-referensi-yang-lebih-panjang-dengan-daftar-isi)
- [Alur kerja dan loop umpan balik](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#alur-kerja-dan-loop-umpan-balik)
- [Gunakan alur kerja untuk tugas kompleks](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#gunakan-alur-kerja-untuk-tugas-kompleks)
- [Implementasikan loop umpan balik](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#implementasikan-loop-umpan-balik)
- [Panduan konten](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#panduan-konten)
- [Hindari informasi sensitif waktu](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#hindari-informasi-sensitif-waktu)
- [Gunakan terminologi yang konsisten](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#gunakan-terminologi-yang-konsisten)
- [Pola umum](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#pola-umum)
- [Pola template](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#pola-template)
- [Pola contoh](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#pola-contoh)
- [Pola alur kerja bersyarat](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#pola-alur-kerja-bersyarat)
- [Evaluasi dan iterasi](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#evaluasi-dan-iterasi)
- [Bangun evaluasi terlebih dahulu](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#bangun-evaluasi-terlebih-dahulu)
- [Kembangkan Skill secara iteratif dengan Claude](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#kembangkan-skill-secara-iteratif-dengan-claude)
- [Amati bagaimana Claude menavigasi Skill](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#amati-bagaimana-claude-menavigasi-skill)
- [Anti-pola untuk dihindari](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#anti-pola-untuk-dihindari)
- [Hindari jalur gaya Windows](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#hindari-jalur-gaya-windows)
- [Hindari menawarkan terlalu banyak pilihan](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#hindari-menawarkan-terlalu-banyak-pilihan)
- [Lanjutan: Skill dengan kode yang dapat dieksekusi](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#lanjutan-skill-dengan-kode-yang-dapat-dieksekusi)
- [Selesaikan, jangan hindari](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#selesaikan-jangan-hindari)
- [Berikan skrip utilitas](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#berikan-skrip-utilitas)
- [Gunakan analisis visual](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#gunakan-analisis-visual)
- [Buat output antara yang dapat diverifikasi](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#buat-output-antara-yang-dapat-diverifikasi)
- [Paket dependensi](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#paket-dependensi)
- [Lingkungan runtime](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#lingkungan-runtime)
- [Referensi alat MCP](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#referensi-alat-mcp)
- [Hindari menganggap alat diinstal](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#hindari-menganggap-alat-diinstal)
- [Catatan teknis](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#catatan-teknis)
- [Persyaratan frontmatter YAML](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#persyaratan-frontmatter-yaml)
- [Anggaran token](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#anggaran-token)
- [Daftar periksa untuk Skill yang efektif](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#daftar-periksa-untuk-skill-yang-efektif)
- [Kualitas inti](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#kualitas-inti)
- [Kode dan skrip](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#kode-dan-skrip)
- [Pengujian](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#pengujian)
- [Langkah berikutnya](https://platform.claude.com/docs/id/agents-and-tools/agent-skills/best-practices#langkah-berikutnya)
