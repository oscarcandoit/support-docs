---
url: "https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices"
title: "Best Practices für Prompting - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fde%2Fbuild-with-claude%2Fprompt-engineering%2Fclaude-4-best-practices)
...
Einen Überblick über die neuen Funktionen von Claude 4.5 finden Sie unter [Was ist neu in Claude 4.5](https://platform.claude.com/docs/de/about-claude/models/whats-new-claude-4-5). Für Migrationsleitfäden von früheren Modellen siehe [Migration zu Claude 4.5](https://platform.claude.com/docs/de/about-claude/models/migrating-to-claude-4).
...
Das [Memory-Tool](https://platform.claude.com/docs/de/agents-and-tools/tool-use/memory-tool) passt natürlich zum Kontextbewusstsein für nahtlose Kontextübergänge.
...
2. **Verwenden Sie XML-Format-Indikatoren**
   - Versuchen Sie: „Schreiben Sie die Prosa-Abschnitte Ihrer Antwort in <smoothly\_flowing\_prose\_paragraphs> Tags."
...
Weitere Informationen zu Denk-Fähigkeiten finden Sie unter [Erweitertes Denken](https://platform.claude.com/docs/de/build-with-claude/extended-thinking).
...
Beispiel-Prompt zur Minimierung von Überengineering
...
Beispiel-Prompt für Code-Erkundung
...
- [Allgemeine Prinzipien](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#allgemeine-prinzipien)
- [Seien Sie explizit mit Ihren Anweisungen](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#seien-sie-explizit-mit-ihren-anweisungen)
- [Fügen Sie Kontext hinzu, um die Leistung zu verbessern](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#fuegen-sie-kontext-hinzu-um-die-leistung-zu-verbessern)
- [Seien Sie wachsam mit Beispielen und Details](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#seien-sie-wachsam-mit-beispielen-und-details)
- [Langfristige Überlegungen und Zustandsverfolgung](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#langfristige-ueberlegungen-und-zustandsverfolgung)
- [Kommunikationsstil](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#kommunikationsstil)
- [Anleitung für spezifische Situationen](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#anleitung-fuer-spezifische-situationen)
- [Verbosität ausgleichen](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#verbositaet-ausgleichen)
- [Tool-Nutzungsmuster](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#tool-nutzungsmuster)
- [Tool-Nutzung und Auslösung](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#tool-nutzung-und-ausloesung)
- [Steuern Sie das Format von Antworten](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#steuern-sie-das-format-von-antworten)
- [Recherche und Informationsbeschaffung](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#recherche-und-informationsbeschaffung)
- [Subagent-Orchestrierung](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#subagent-orchestrierung)
- [Modell-Selbstkenntnis](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#modell-selbstkenntnis)
- [Denk-Sensitivität](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#denk-sensitivitaet)
- [Nutzen Sie Denk- und verschachtelte Denk-Fähigkeiten](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#nutzen-sie-denk-und-verschachtelte-denk-faehigkeiten)
- [Dokumentenerstellung](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#dokumentenerstellung)
- [Verbesserte Vision-Fähigkeiten](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#verbesserte-vision-faehigkeiten)
- [Optimieren Sie parallele Tool-Aufrufe](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#optimieren-sie-parallele-tool-aufrufe)
- [Reduzieren Sie die Dateierstellung in agentengestütztem Coding](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#reduzieren-sie-die-dateierstellung-in-agentengestuetztem-coding)
- [Übereifrigkeit und Dateierstellung](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#uebereifrigkeit-und-dateierstellung)
- [Frontend-Design](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#frontend-design)
- [Vermeiden Sie die Fokussierung auf das Bestehen von Tests und Hard-Coding](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#vermeiden-sie-die-fokussierung-auf-das-bestehen-von-tests-und-hard-coding)
- [Ermutigung zur Code-Erkundung](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#ermutigung-zur-code-erkundung)
- [Minimierung von Halluzinationen in agentengestütztem Coding](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#minimierung-von-halluzinationen-in-agentengestuetztem-coding)
- [Migrationsbedingungen](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices#migrationsbedingungen)
