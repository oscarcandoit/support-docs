---
url: "https://platform.claude.com/docs/ja/intro"
title: "Claudeの紹介 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fintro)
...
Claudeは、Anthropicによって構築された、高性能で信頼性が高く、インテリジェントなAIプラットフォームです。Claudeは、言語、推論、分析、コーディングなど、多くのタスクに優れています。
...
Claudeとチャットしたいですか？ [claude.ai](http://www.claude.ai/) にアクセスしてください！

## はじめに

Claudeが初めての場合は、ここから始めて、基本を学び、最初のAPI呼び出しを行ってください。

[はじめに\\
\\
Claudeで構築するための開発環境をセットアップします。](https://platform.claude.com/docs/ja/get-started) [Claudeについて学ぶ\\
\\
Claudeモデルのファミリーについて学びます。](https://platform.claude.com/docs/ja/about-claude/models/overview) [プロンプトライブラリ\\
\\
インスピレーションのためのサンプルプロンプトを探索します。](https://platform.claude.com/docs/ja/resources/prompt-library/library)

* * *

## Claudeで開発する

Anthropicは、Claudeを使用してスケーラブルなアプリケーションを構築するための業界最高水準の開発者ツールを提供しています。

[Developer Console\\
\\
Workbenchとプロンプトジェネレータツールでブラウザでより簡単で強力なプロンプティングを楽しみます。](https://platform.claude.com/) [APIリファレンス\\
\\
Claude APIとSDKを使用して、探索、実装、スケーリングを行います。](https://platform.claude.com/docs/ja/api/overview) [Claude Cookbook\\
\\
PDFのアップロード、埋め込みなどを実演するインタラクティブなJupyterノートブックで学びます。](https://github.com/anthropics/anthropic-cookbook)
...
[テキストとコード生成\\
\\
テキストを要約し、質問に答え、データを抽出し、テキストを翻訳し、コードを説明および生成します。](https://platform.claude.com/docs/ja/build-with-claude/text-generation) [Vision\\
\\
ビジュアル入力を処理および分析し、画像からテキストとコードを生成します。](https://platform.claude.com/docs/ja/build-with-claude/vision)
...
[ヘルプセンター\\
\\
よくある質問のアカウントと請求に関する回答を見つけます。](https://support.claude.com/en/) [サービスステータス\\
\\
Anthropicサービスのステータスを確認します。](https://status.claude.com/)

- [Claudeで開発する](https://platform.claude.com/docs/ja/intro#claude)
