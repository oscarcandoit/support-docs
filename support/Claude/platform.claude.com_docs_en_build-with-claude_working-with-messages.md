...
title: "Using the Messages API - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fbuild-with-claude%2Fworking-with-messages)
...
See our [guide](https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview) for examples of how to use tools with the Messages API.
See our [computer use guide](https://platform.claude.com/docs/en/agents-and-tools/tool-use/computer-use-tool) for examples of how to control desktop computer environments with the Messages API.
...
- [Tool use and computer use](https://platform.claude.com/docs/en/build-with-claude/working-with-messages#tool-use-and-computer-use)
