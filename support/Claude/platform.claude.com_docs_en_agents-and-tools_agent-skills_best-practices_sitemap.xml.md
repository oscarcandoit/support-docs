---
url: "https://platform.claude.com/docs/en/agents-and-tools/agent-skills/best-practices/sitemap.xml"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagents-and-tools%2Fagent-skills%2Fbest-practices%2Fsitemap.xml)
