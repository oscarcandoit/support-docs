---
url: "https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/prompt-generator"
title: "Автоматическая генерация шаблонов промптов первого черновика - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fbuild-with-claude%2Fprompt-engineering%2Fprompt-generator)
...
Наш генератор промптов совместим со всеми моделями Claude, включая те, которые обладают расширенными возможностями мышления. Советы по составлению промптов для моделей с расширенным мышлением смотрите [здесь](https://platform.claude.com/docs/ru/build-with-claude/extended-thinking).
...
Попробуйте генератор промптов прямо сейчас в [Console](https://platform.claude.com/dashboard).
...
Обратите внимание, что для запуска блокнота Colab вам потребуется [API ключ](https://platform.claude.com/settings/keys).

* * *

## Следующие шаги

[Начать инженерию промптов\\
\\
Получите вдохновение из подборки промптов для различных задач и случаев использования.](https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/be-clear-and-direct) [Библиотека промптов\\
\\
Получите вдохновение из подборки промптов для различных задач и случаев использования.](https://platform.claude.com/docs/ru/resources/prompt-library/library) [Руководство по промптам на GitHub\\
\\
Учебное пособие с примерами, охватывающее концепции инженерии промптов из нашей документации.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Руководство по промптам в Google Sheets\\
\\
Облегченная версия нашего руководства по инженерии промптов в виде интерактивной таблицы.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Следующие шаги](https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/prompt-generator#sleduyuschie-shagi)
