---
url: "https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/system-prompts"
title: "使用系統提示詞給 Claude 設定角色 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-TW%2Fbuild-with-claude%2Fprompt-engineering%2Fsystem-prompts)
...
**系統提示詞提示**：使用 `system` 參數設定 Claude 的角色。將其他所有內容（如特定任務的指示）放在 `user` 輪次中。
...
在 [Messages API](https://platform.claude.com/docs/zh-TW/api/messages) 中使用 `system` 參數來設定 Claude 的角色：
...
**角色提示提示**：嘗試不同的角色！`數據科學家` 可能會看到與 `行銷策略師` 對相同數據的不同見解。`專門從事財富 500 強公司客戶洞察分析的數據科學家` 可能會產生完全不同的結果！
...
[提示詞庫\\
\\
獲得為各種任務和用例精心策劃的提示詞選擇的靈感。](https://platform.claude.com/docs/zh-TW/resources/prompt-library/library) [GitHub 提示詞教程\\
\\
一個充滿示例的教程，涵蓋我們文檔中的提示詞工程概念。](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Google Sheets 提示詞教程\\
\\
通過互動式電子表格提供的更輕量級版本的提示詞工程教程。](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [如何給 Claude 設定角色](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/system-prompts#claude)
- [範例 1：法律合約分析](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/system-prompts#1)
- [範例 2：財務分析](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/system-prompts#2)
