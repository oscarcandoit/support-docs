---
url: "https://platform.claude.com/docs/fr/agent-sdk/todo-tracking"
title: "Listes de Tâches - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fagent-sdk%2Ftodo-tracking)
...
- [Mode Streaming vs Mode Unique](https://platform.claude.com/docs/fr/agent-sdk/streaming-vs-single-mode)
- [Outils Personnalisés](https://platform.claude.com/docs/fr/agent-sdk/custom-tools)

- [Cycle de Vie des Tâches à Faire](https://platform.claude.com/docs/fr/agent-sdk/todo-tracking#cycle-de-vie-des-taches-a-faire)
- [Quand les Tâches à Faire Sont Utilisées](https://platform.claude.com/docs/fr/agent-sdk/todo-tracking#quand-les-taches-a-faire-sont-utilisees)
- [Exemples](https://platform.claude.com/docs/fr/agent-sdk/todo-tracking#exemples)
- [Surveillance des Changements de Tâches à Faire](https://platform.claude.com/docs/fr/agent-sdk/todo-tracking#surveillance-des-changements-de-taches-a-faire)
- [Affichage des Progrès en Temps Réel](https://platform.claude.com/docs/fr/agent-sdk/todo-tracking#affichage-des-progres-en-temps-reel)
- [Documentation Connexe](https://platform.claude.com/docs/fr/agent-sdk/todo-tracking#documentation-connexe)
