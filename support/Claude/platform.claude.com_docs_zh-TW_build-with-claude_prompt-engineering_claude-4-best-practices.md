---
url: "https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/claude-4-best-practices"
title: "提示工程最佳實踐 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-TW%2Fbuild-with-claude%2Fprompt-engineering%2Fclaude-4-best-practices)
...
如需了解 Claude 4.5 的新功能概述，請參閱 [Claude 4.5 的新功能](https://platform.claude.com/docs/zh-TW/about-claude/models/whats-new-claude-4-5)。如需從之前的模型遷移的指導，請參閱 [遷移到 Claude 4.5](https://platform.claude.com/docs/zh-TW/about-claude/models/migrating-to-claude-4)。
...
Claude 4.5 模型具有 [上下文感知](https://platform.claude.com/docs/zh-TW/build-with-claude/context-windows#context-awareness-in-claude-sonnet-4-5) 功能，使模型能夠在整個對話中追蹤其剩餘上下文窗口（即「令牌預算」）。這使 Claude 能夠通過理解它有多少空間來工作，更有效地執行任務和管理上下文。
...
[記憶工具](https://platform.claude.com/docs/zh-TW/agents-and-tools/tool-use/memory-tool) 與上下文感知自然配對，實現無縫的上下文轉換。
...
2. **使用 XML 格式指示符**
   - 嘗試：「在 <smoothly\_flowing\_prose\_paragraphs> 標籤中編寫回應的散文部分。」
3. **將您的提示風格與所需輸出相匹配**
...
有關思考能力的更多信息，請參閱 [擴展思考](https://platform.claude.com/docs/zh-TW/build-with-claude/extended-thinking)。
...
我們發現有效的一種技術是給 Claude Opus 4.5 一個裁剪工具或 [技能](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/overview)。我們在圖像評估中看到了一致的提升，當 Claude 能夠「放大」圖像的相關區域時。我們在 [此處](https://github.com/anthropics/claude-cookbooks/blob/main/multimodal/crop_tool.ipynb) 為裁剪工具編制了一本食譜。
