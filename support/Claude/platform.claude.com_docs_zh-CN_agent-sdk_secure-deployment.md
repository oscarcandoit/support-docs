---
url: "https://platform.claude.com/docs/zh-CN/agent-sdk/secure-deployment"
title: "安全部署 AI 代理 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Fagent-sdk%2Fsecure-deployment)
...
- [托管 Agent SDK](https://platform.claude.com/docs/zh-CN/agent-sdk/hosting)
- [处理权限](https://platform.claude.com/docs/zh-CN/agent-sdk/permissions)
...
- [gVisor](https://platform.claude.com/docs/zh-CN/agent-sdk/secure-deployment#g-visor)
- [配置 Claude Code 使用代理](https://platform.claude.com/docs/zh-CN/agent-sdk/secure-deployment#claude-code)
