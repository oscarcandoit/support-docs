...
title: "Tentukan kriteria keberhasilan Anda - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Ftest-and-evaluate%2Fdefine-success)
...
- **Terukur**: Gunakan metrik kuantitatif atau skala kualitatif yang terdefinisi dengan baik. Angka memberikan kejelasan dan skalabilitas, tetapi ukuran kualitatif bisa berharga jika diterapkan secara konsisten _bersamaan_ dengan ukuran kuantitatif.
...
\\
**Tip**: Masukkan halaman ini ke dalam obrolan sebagai panduan untuk Claude!](https://claude.ai/) [Desain evaluasi\\
\\
Pelajari cara membangun set pengujian yang kuat untuk mengukur kinerja Claude terhadap kriteria Anda.](https://platform.claude.com/docs/id/be-clear-direct)

- [Membangun kriteria yang kuat](https://platform.claude.com/docs/id/test-and-evaluate/define-success#membangun-kriteria-yang-kuat)
- [Kriteria keberhasilan umum yang perlu dipertimbangkan](https://platform.claude.com/docs/id/test-and-evaluate/define-success#kriteria-keberhasilan-umum-yang-perlu-dipertimbangkan)
- [Langkah selanjutnya](https://platform.claude.com/docs/id/test-and-evaluate/define-success#langkah-selanjutnya)
