---
url: "https://platform.claude.com/docs/it/home"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fhome)
...
Scopri come iniziare con la Claude Developer Platform e Claude Code.

Chiedi a Claude della documentazione...
...
[Inizia\\
\\
Effettua la tua prima chiamata API in pochi minuti.](https://platform.claude.com/docs/it/get-started) [Panoramica delle funzionalità\\
\\
Esplora le funzionalità avanzate e le capacità ora disponibili in Claude.](https://platform.claude.com/docs/it/api/overview) [Novità in Claude 4.5\\
\\
Scopri i progressi più recenti nei modelli Claude 4.5.](https://platform.claude.com/docs/it/about-claude/models/whats-new-claude-4-5) [Riferimento API\\
\\
Integra e scala utilizzando la nostra API e gli SDK.](https://platform.claude.com/docs/it/api/overview) [Claude Console\\
\\
Crea e testa prompt potenti direttamente nel tuo browser.](https://platform.claude.com/) [Note di rilascio\\
\\
Scopri i cambiamenti e le nuove funzionalità della Claude Developer Platform.](https://platform.claude.com/docs/it/release-notes/api)

## Claude Code

[Guida rapida di Claude Code\\
\\
Inizia con Claude Code.](https://code.claude.com/docs/it/quickstart) [Riferimento di Claude Code\\
\\
Consulta la documentazione di riferimento di Claude Code per i dettagli sull'implementazione delle funzionalità e la configurazione.](https://code.claude.com/docs/it/overview) [Changelog di Claude Code\\
\\
Scopri i cambiamenti e le nuove funzionalità in Claude Code.](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md)

## Risorse di apprendimento

[Corsi Anthropic\\
\\
Esplora i corsi educativi e i progetti di Anthropic.](https://anthropic.skilljar.com/) [Claude Cookbook\\
\\
Vedi esempi di codice replicabili e implementazioni.](https://github.com/anthropics/anthropic-cookbook) [Claude Quickstarts\\
\\
Applicazioni distribuibili costruite con la nostra API.](https://github.com/anthropics/anthropic-quickstarts)
