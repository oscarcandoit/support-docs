...
title: "Tingkatkan konsistensi output - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fincrease-consistency)
...
### Contoh: Standardisasi umpan balik pelanggan
...
### Contoh: Menghasilkan intelijen pasar yang konsisten
...
### Contoh: Meningkatkan konsistensi dukungan IT
...
- [Tentukan format output yang diinginkan](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/increase-consistency#tentukan-format-output-yang-diinginkan)
- [Isi sebelumnya respons Claude](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/increase-consistency#isi-sebelumnya-respons-claude)
- [Batasi dengan contoh](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/increase-consistency#batasi-dengan-contoh)
- [Gunakan retrieval untuk konsistensi kontekstual](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/increase-consistency#gunakan-retrieval-untuk-konsistensi-kontekstual)
- [Rantai prompt untuk tugas kompleks](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/increase-consistency#rantai-prompt-untuk-tugas-kompleks)
