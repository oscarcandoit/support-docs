---
url: "https://platform.claude.com/docs/zh-CN/build-with-claude/prompt-engineering/claude-4-best-practices"
title: "提示词工程最佳实践 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Fbuild-with-claude%2Fprompt-engineering%2Fclaude-4-best-practices)
...
有关 Claude 4.5 新功能的概述，请参阅 [Claude 4.5 中的新增功能](https://platform.claude.com/docs/zh-CN/about-claude/models/whats-new-claude-4-5)。有关从之前模型迁移的指导，请参阅 [迁移到 Claude 4.5](https://platform.claude.com/docs/zh-CN/about-claude/models/migrating-to-claude-4)。
...
Claude 4.5 模型具有 [上下文感知](https://platform.claude.com/docs/zh-CN/build-with-claude/context-windows#context-awareness-in-claude-sonnet-4-5) 功能，使模型能够在整个对话中跟踪其剩余上下文窗口（即"令牌预算"）。这使 Claude 能够通过理解有多少空间可用来更有效地执行任务和管理上下文。
...
[内存工具](https://platform.claude.com/docs/zh-CN/agents-and-tools/tool-use/memory-tool) 与上下文感知自然配对，可实现无缝的上下文转换。
...
有关思考能力的更多信息，请参阅 [扩展思考](https://platform.claude.com/docs/zh-CN/build-with-claude/extended-thinking)。
...
我们发现有效增强性能的一种技术是为 Claude Opus 4.5 提供裁剪工具或 [技能](https://platform.claude.com/docs/zh-CN/agents-and-tools/agent-skills/overview)。当 Claude 能够"放大"图像的相关区域时，我们在图像评估上看到了一致的提升。我们在 [这里](https://github.com/anthropics/claude-cookbooks/blob/main/multimodal/crop_tool.ipynb) 为裁剪工具编制了一份食谱。
