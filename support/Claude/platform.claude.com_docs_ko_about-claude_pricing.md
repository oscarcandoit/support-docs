---
url: "https://platform.claude.com/docs/ko/about-claude/pricing"
title: "가격 책정 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fko%2Fabout-claude%2Fpricing)
...
MTok = 백만 토큰. "Base Input Tokens" 열은 표준 입력 가격을 보여주고, "Cache Writes"와 "Cache Hits"는 [프롬프트 캐싱](https://platform.claude.com/docs/ko/build-with-claude/prompt-caching) 에 특정하며, "Output Tokens"는 출력 가격을 보여줍니다. 프롬프트 캐싱은 다양한 사용 사례에 대한 비용을 최적화하기 위해 5분(기본값) 및 1시간 캐시 지속 시간을 모두 제공합니다.
...
Claude 모델은 [AWS Bedrock](https://platform.claude.com/docs/ko/build-with-claude/claude-on-amazon-bedrock), [Google Vertex AI](https://platform.claude.com/docs/ko/build-with-claude/claude-on-vertex-ai), 및 [Microsoft Foundry](https://platform.claude.com/docs/ko/build-with-claude/claude-in-microsoft-foundry) 에서 사용할 수 있습니다. 공식 가격 책정은 다음을 방문하세요:
...
배치 처리에 대한 자세한 정보는 [배치 처리 문서](https://platform.claude.com/docs/ko/build-with-claude/batch-processing) 를 참조하세요.

### 긴 컨텍스트 가격 책정

Claude Sonnet 4 또는 Sonnet 4.5를 [1M 토큰 컨텍스트 윈도우 활성화](https://platform.claude.com/docs/ko/build-with-claude/context-windows#1m-token-context-window) 와 함께 사용할 때, 200K 입력 토큰을 초과하는 요청은 자동으로 프리미엄 긴 컨텍스트 요금으로 청구됩니다:

1M 토큰 컨텍스트 윈도우는 현재 [사용 계층](https://platform.claude.com/docs/ko/api/rate-limits) 4의 조직 및 사용자 정의 속도 제한이 있는 조직에 대해 베타 버전입니다. 1M 토큰 컨텍스트 윈도우는 Claude Sonnet 4 및 Sonnet 4.5에서만 사용할 수 있습니다.
...
- [Batch API 50% 할인](https://platform.claude.com/docs/ko/about-claude/pricing#batch-processing) 은 긴 컨텍스트 가격 책정에 적용됩니다
- [프롬프트 캐싱 승수](https://platform.claude.com/docs/ko/about-claude/pricing#model-pricing) 는 긴 컨텍스트 가격 책정 위에 적용됩니다
...
`usage` 객체에 대한 자세한 정보는 [API 응답 문서](https://platform.claude.com/docs/ko/api/messages#response-usage) 를 참조하세요.
...
현재 모델별 가격은 위의 [모델 가격 책정](https://platform.claude.com/docs/ko/about-claude/pricing#model-pricing) 섹션을 참조하세요.

도구 사용 구현 및 모범 사례에 대한 자세한 정보는 [도구 사용 문서](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/overview) 를 참조하세요.
...
완전한 가격 책정 세부 사항은 [도구 사용 가격 책정](https://platform.claude.com/docs/ko/about-claude/pricing#tool-use-pricing) 을 참조하세요.
...
이 계산에 대한 자세한 설명은 [고객 지원 에이전트 가이드](https://platform.claude.com/docs/ko/about-claude/use-case-guides/customer-support-chat) 를 참조하세요.
...
에이전트 가격 책정 패턴에 대한 포괄적인 가이드는 [에이전트 사용 사례 가이드](https://platform.claude.com/docs/ko/about-claude/use-case-guides) 를 참조하세요.
...
자세한 속도 제한 정보는 [속도 제한 문서](https://platform.claude.com/docs/ko/api/rate-limits) 를 참조하세요.
...
[sales@anthropic.com](mailto:sales@anthropic.com) 의 영업팀에 문의하거나 [Claude Console](https://platform.claude.com/settings/limits) 을 통해 엔터프라이즈 가격 책정 옵션을 논의하세요.
...
- 결제는 USD로 처리됩니다
- 신용 카드 및 송장 옵션 사용 가능
- [Claude Console](https://platform.claude.com/) 에서 사용 추적 가능
...
- [제3자 플랫폼 가격 책정](https://platform.claude.com/docs/ko/about-claude/pricing#3)
