...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Fabout-claude%2Fglossary)
...
查看我们的 [理解上下文窗口指南](https://platform.claude.com/docs/zh-CN/build-with-claude/context-windows) 了解更多信息。
...
模型上下文协议（MCP）是一个开放协议，标准化了应用程序如何为LLM提供上下文。就像AI应用程序的USB-C端口一样，MCP提供了一种统一的方式来连接AI模型到不同的数据源和工具。MCP使AI系统能够在交互中保持一致的上下文，并以标准化的方式访问外部资源。查看我们的 [MCP文档](https://platform.claude.com/docs/zh-CN/mcp) 了解更多信息。

## MCP连接器

MCP连接器是一个功能，允许API用户直接从Messages API连接到MCP服务器，而无需构建MCP客户端。这通过Claude API实现了与MCP兼容工具和服务的无缝集成。MCP连接器支持工具调用等功能，目前处于公开测试阶段。查看我们的 [MCP连接器文档](https://platform.claude.com/docs/zh-CN/agents-and-tools/mcp-connector) 了解更多信息。
...
- [HHH](https://platform.claude.com/docs/zh-CN/about-claude/glossary#hhh)
- [LLM](https://platform.claude.com/docs/zh-CN/about-claude/glossary#llm)
- [MCP（模型上下文协议）](https://platform.claude.com/docs/zh-CN/about-claude/glossary#mcp)
- [MCP连接器](https://platform.claude.com/docs/zh-CN/about-claude/glossary#mcp-2)
- [RAG（检索增强生成）](https://platform.claude.com/docs/zh-CN/about-claude/glossary#rag)
- [RLHF](https://platform.claude.com/docs/zh-CN/about-claude/glossary#rlhf)
- [TTFT（首个令牌时间）](https://platform.claude.com/docs/zh-CN/about-claude/glossary#ttft)
