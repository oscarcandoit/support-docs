---
url: "https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/multishot-prompting"
title: "Utiliser des exemples (prompting multishot) pour guider le comportement de Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fbuild-with-claude%2Fprompt-engineering%2Fmultishot-prompting)
...
Utiliser des exemples (prompting multishot)
...
**Améliorez vos prompts** : Incluez 3-5 exemples diversifiés et pertinents pour montrer à Claude exactement ce que vous voulez. Plus d'exemples = meilleures performances, surtout pour les tâches complexes.
...
Demandez à Claude d'évaluer vos exemples pour leur pertinence, leur diversité ou leur clarté. Ou demandez à Claude de générer plus d'exemples basés sur votre ensemble initial.
...
\\
Un tutoriel riche en exemples qui couvre les concepts d'ingénierie de prompts trouvés dans notre documentation.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutoriel de prompting Google Sheets\\
\\
Une version plus légère de notre tutoriel d'ingénierie de prompts via une feuille de calcul interactive.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Pourquoi utiliser des exemples ?](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/multishot-prompting#pourquoi-utiliser-des-exemples)
- [Créer des exemples efficaces](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/multishot-prompting#creer-des-exemples-efficaces)
