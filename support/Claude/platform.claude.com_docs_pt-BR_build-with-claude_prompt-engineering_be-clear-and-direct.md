---
url: "https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/be-clear-and-direct"
title: "Seja claro, direto e detalhado - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Fbuild-with-claude%2Fprompt-engineering%2Fbe-clear-and-direct)
...
**A regra de ouro da prompting clara**

Mostre seu prompt a um colega, idealmente alguém que tenha contexto mínimo sobre a tarefa, e peça-lhe que siga as instruções. Se ele ficar confuso, Claude provavelmente também ficará.
...
### Exemplo: Criando uma campanha de email de marketing
...
- [Como ser claro, contextual e específico](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/be-clear-and-direct#como-ser-claro-contextual-e-especifico)
- [Exemplos](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/be-clear-and-direct#exemplos)
