---
url: "https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/increase-consistency"
title: "Aumentare la coerenza dell'output - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fincrease-consistency)
...
Aumenta la coerenza dell'output
...
### Esempio: Standardizzazione del feedback dei clienti
...
### Esempio: Miglioramento della coerenza del supporto IT
...
- [Specifica il formato di output desiderato](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/increase-consistency#specifica-il-formato-di-output-desiderato)
- [Precompila la risposta di Claude](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/increase-consistency#precompila-la-risposta-di-claude)
- [Vincola con esempi](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/increase-consistency#vincola-con-esempi)
- [Usa il retrieval per la coerenza contestuale](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/increase-consistency#usa-il-retrieval-per-la-coerenza-contestuale)
- [Concatena i prompt per attività complesse](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/increase-consistency#concatena-i-prompt-per-attivita-complesse)
