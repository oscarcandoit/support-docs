---
url: "https://platform.claude.com/docs/ko/test-and-evaluate/strengthen-guardrails/keep-claude-in-character"
title: "역할 프롬프팅과 사전 채우기로 Claude의 캐릭터 유지하기 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fko%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fkeep-claude-in-character)
...
- **시스템 프롬프트로 역할 설정하기:** [시스템 프롬프트](https://platform.claude.com/docs/ko/build-with-claude/prompt-engineering/system-prompts) 를 사용하여 Claude의 역할과 성격을 정의하세요. 이는 일관된 응답을 위한 강력한 기반을 마련합니다.
