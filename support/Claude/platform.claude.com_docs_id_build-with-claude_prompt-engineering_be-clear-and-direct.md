---
url: "https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/be-clear-and-direct"
title: "Jadilah jelas, langsung, dan terperinci - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fbuild-with-claude%2Fprompt-engineering%2Fbe-clear-and-direct)
...
**Aturan emas dari prompting yang jelas**

Tunjukkan prompt Anda kepada rekan kerja, idealnya seseorang yang memiliki konteks minimal tentang tugas tersebut, dan minta mereka mengikuti instruksi. Jika mereka bingung, Claude kemungkinan besar juga akan bingung.
...
### Contoh: Menganonimkan umpan balik pelanggan

### Contoh: Membuat kampanye email pemasaran
...
- [Cara menjadi jelas, kontekstual, dan spesifik](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/be-clear-and-direct#cara-menjadi-jelas-kontekstual-dan-spesifik)
- [Contoh](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/be-clear-and-direct#contoh)
