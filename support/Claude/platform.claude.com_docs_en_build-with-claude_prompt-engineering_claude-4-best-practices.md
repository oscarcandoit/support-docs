...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fbuild-with-claude%2Fprompt-engineering%2Fclaude-4-best-practices)
...
- [General principles](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#general-principles)
- [Be explicit with your instructions](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#be-explicit-with-your-instructions)
- [Add context to improve performance](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#add-context-to-improve-performance)
- [Be vigilant with examples & details](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#be-vigilant-with-examples-and-details)
- [Long-horizon reasoning and state tracking](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#long-horizon-reasoning-and-state-tracking)
- [Communication style](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#communication-style)
- [Guidance for specific situations](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#guidance-for-specific-situations)
- [Balance verbosity](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#balance-verbosity)
- [Tool usage patterns](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#tool-usage-patterns)
- [Tool usage and triggering](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#tool-usage-and-triggering)
- [Control the format of responses](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#control-the-format-of-responses)
- [Research and information gathering](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#research-and-information-gathering)
- [Subagent orchestration](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#subagent-orchestration)
- [Model self-knowledge](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#model-self-knowledge)
- [Thinking sensitivity](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#thinking-sensitivity)
- [Leverage thinking & interleaved thinking capabilities](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#leverage-thinking-and-interleaved-thinking-capabilities)
- [Document creation](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#document-creation)
- [Improved vision capabilities](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#improved-vision-capabilities)
- [Optimize parallel tool calling](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#optimize-parallel-tool-calling)
- [Reduce file creation in agentic coding](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#reduce-file-creation-in-agentic-coding)
- [Overeagerness and file creation](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#overeagerness-and-file-creation)
- [Frontend design](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#frontend-design)
- [Avoid focusing on passing tests and hard-coding](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#avoid-focusing-on-passing-tests-and-hard-coding)
- [Encouraging code exploration](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#encouraging-code-exploration)
- [Minimizing hallucinations in agentic coding](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#minimizing-hallucinations-in-agentic-coding)
- [Migration considerations](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices#migration-considerations)
