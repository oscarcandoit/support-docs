---
url: "https://platform.claude.com/docs/it/test-and-evaluate/develop-tests"
title: "Creare valutazioni empiriche solide - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Ftest-and-evaluate%2Fdevelop-tests)
...
\\
Impara come creare prompt che massimizzano i tuoi punteggi di valutazione.](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/overview) [Cookbook delle valutazioni\\
\\
Altri esempi di codice di valutazioni valutate da umani, codice e LLM.](https://github.com/anthropics/anthropic-cookbook/blob/main/misc/building%5Fevals.ipynb)

- [Costruire valutazioni e casi di test](https://platform.claude.com/docs/it/test-and-evaluate/develop-tests#costruire-valutazioni-e-casi-di-test)
- [Principi di progettazione delle valutazioni](https://platform.claude.com/docs/it/test-and-evaluate/develop-tests#principi-di-progettazione-delle-valutazioni)
- [Esempi di valutazioni](https://platform.claude.com/docs/it/test-and-evaluate/develop-tests#esempi-di-valutazioni)
- [Valutare le valutazioni](https://platform.claude.com/docs/it/test-and-evaluate/develop-tests#valutare-le-valutazioni)
- [Suggerimenti per la valutazione basata su LLM](https://platform.claude.com/docs/it/test-and-evaluate/develop-tests#suggerimenti-per-la-valutazione-basata-su-llm)
- [Prossimi passi](https://platform.claude.com/docs/it/test-and-evaluate/develop-tests#prossimi-passi)
