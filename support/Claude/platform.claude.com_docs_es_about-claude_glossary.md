---
url: "https://platform.claude.com/docs/es/about-claude/glossary"
title: "Glosario - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fabout-claude%2Fglossary)
...
Consulta nuestra [guía para entender las ventanas de contexto](https://platform.claude.com/docs/es/build-with-claude/context-windows) para aprender más.
...
- [Ventana de contexto](https://platform.claude.com/docs/es/about-claude/glossary#ventana-de-contexto)
- [Ajuste fino](https://platform.claude.com/docs/es/about-claude/glossary#ajuste-fino)
- [HHH](https://platform.claude.com/docs/es/about-claude/glossary#hhh)
- [Latencia](https://platform.claude.com/docs/es/about-claude/glossary#latencia)
- [LLM](https://platform.claude.com/docs/es/about-claude/glossary#llm)
- [MCP (Protocolo de Contexto del Modelo)](https://platform.claude.com/docs/es/about-claude/glossary#mcp-protocolo-de-contexto-del-modelo)
- [Conector MCP](https://platform.claude.com/docs/es/about-claude/glossary#conector-mcp)
- [Preentrenamiento](https://platform.claude.com/docs/es/about-claude/glossary#preentrenamiento)
- [RAG (Generación aumentada por recuperación)](https://platform.claude.com/docs/es/about-claude/glossary#rag-generacion-aumentada-por-recuperacion)
- [RLHF](https://platform.claude.com/docs/es/about-claude/glossary#rlhf)
- [Temperatura](https://platform.claude.com/docs/es/about-claude/glossary#temperatura)
- [TTFT (Tiempo al primer token)](https://platform.claude.com/docs/es/about-claude/glossary#ttft-tiempo-al-primer-token)
- [Tokens](https://platform.claude.com/docs/es/about-claude/glossary#tokens)
