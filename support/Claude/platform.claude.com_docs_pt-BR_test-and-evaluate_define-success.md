---
url: "https://platform.claude.com/docs/pt-BR/test-and-evaluate/define-success"
title: "Defina seus critérios de sucesso - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Ftest-and-evaluate%2Fdefine-success)
...
- **Mensuráveis**: Use métricas quantitativas ou escalas qualitativas bem definidas. Números proporcionam clareza e escalabilidade, mas medidas qualitativas podem ser valiosas se aplicadas consistentemente _junto_ com medidas quantitativas.
...
\\
**Dica**: Coloque esta página no chat como orientação para o Claude!](https://claude.ai/) [Projete avaliações\\
\\
Aprenda a construir conjuntos de teste fortes para medir o desempenho do Claude em relação aos seus critérios.](https://platform.claude.com/docs/pt-BR/be-clear-direct)

- [Construindo critérios fortes](https://platform.claude.com/docs/pt-BR/test-and-evaluate/define-success#construindo-criterios-fortes)
- [Critérios de sucesso comuns a considerar](https://platform.claude.com/docs/pt-BR/test-and-evaluate/define-success#criterios-de-sucesso-comuns-a-considerar)
- [Próximos passos](https://platform.claude.com/docs/pt-BR/test-and-evaluate/define-success#proximos-passos)
