---
url: "https://platform.claude.com/docs/ja/test-and-evaluate/develop-tests"
title: "強力な実証的評価を作成する - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Ftest-and-evaluate%2Fdevelop-tests)
...
[評価をブレインストーミングする\\
\\
評価スコアを最大化するプロンプトの作成方法を学びます。](https://platform.claude.com/docs/ja/build-with-claude/prompt-engineering/overview) [評価クックブック\\
\\
人間、コード、LLM採点評価のより多くのコード例。](https://github.com/anthropics/anthropic-cookbook/blob/main/misc/building%5Fevals.ipynb)

- [LLMベースの採点のヒント](https://platform.claude.com/docs/ja/test-and-evaluate/develop-tests#llm)
