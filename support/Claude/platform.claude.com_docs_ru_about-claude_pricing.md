---
url: "https://platform.claude.com/docs/ru/about-claude/pricing"
title: "Ценообразование - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fabout-claude%2Fpricing)
...
- [Ценообразование моделей](https://platform.claude.com/docs/ru/about-claude/pricing#tsenoobrazovanie-modeley)
- [Ценообразование на платформах третьих сторон](https://platform.claude.com/docs/ru/about-claude/pricing#tsenoobrazovanie-na-platformakh-tretikh-storon)
- [Ценообразование функций](https://platform.claude.com/docs/ru/about-claude/pricing#tsenoobrazovanie-funktsiy)
- [Пакетная обработка](https://platform.claude.com/docs/ru/about-claude/pricing#paketnaya-obrabotka)
- [Ценообразование для больших контекстов](https://platform.claude.com/docs/ru/about-claude/pricing#tsenoobrazovanie-dlya-bolshikh-kontekstov)
- [Ценообразование использования инструментов](https://platform.claude.com/docs/ru/about-claude/pricing#tsenoobrazovanie-ispolzovaniya-instrumentov)
- [Ценообразование конкретных инструментов](https://platform.claude.com/docs/ru/about-claude/pricing#tsenoobrazovanie-konkretnykh-instrumentov)
- [Примеры ценообразования для случаев использования агентов](https://platform.claude.com/docs/ru/about-claude/pricing#primery-tsenoobrazovaniya-dlya-sluchaev-ispolzovaniya-agentov)
- [Пример агента поддержки клиентов](https://platform.claude.com/docs/ru/about-claude/pricing#primer-agenta-podderzhki-klientov)
- [Ценообразование общего рабочего процесса агента](https://platform.claude.com/docs/ru/about-claude/pricing#tsenoobrazovanie-obschego-rabochego-protsessa-agenta)
- [Стратегии оптимизации затрат](https://platform.claude.com/docs/ru/about-claude/pricing#strategii-optimizatsii-zatrat)
- [Дополнительные соображения по ценообразованию](https://platform.claude.com/docs/ru/about-claude/pricing#dopolnitelnye-soobrazheniya-po-tsenoobrazovaniyu)
- [Ограничения скорости](https://platform.claude.com/docs/ru/about-claude/pricing#ogranicheniya-skorosti)
- [Скидки за объём](https://platform.claude.com/docs/ru/about-claude/pricing#skidki-za-obyom)
- [Корпоративное ценообразование](https://platform.claude.com/docs/ru/about-claude/pricing#korporativnoe-tsenoobrazovanie)
- [Выставление счётов и платежи](https://platform.claude.com/docs/ru/about-claude/pricing#vystavlenie-schyotov-i-platezhi)
- [Часто задаваемые вопросы](https://platform.claude.com/docs/ru/about-claude/pricing#chasto-zadavaemye-voprosy)