---
url: "https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/multishot-prompting"
title: "Usa ejemplos (multishot prompting) para guiar el comportamiento de Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fbuild-with-claude%2Fprompt-engineering%2Fmultishot-prompting)
...
Usar ejemplos (prompting multishot)
...
**Potencia tus prompts**: Incluye 3-5 ejemplos diversos y relevantes para mostrar a Claude exactamente lo que quieres. Más ejemplos = mejor rendimiento, especialmente para tareas complejas.
...
Pídele a Claude que evalúe tus ejemplos por relevancia, diversidad o claridad. O haz que Claude genere más ejemplos basados en tu conjunto inicial.
...
- [¿Por qué usar ejemplos?](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/multishot-prompting#por-que-usar-ejemplos)
- [Elaboración de ejemplos efectivos](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/multishot-prompting#elaboracion-de-ejemplos-efectivos)
