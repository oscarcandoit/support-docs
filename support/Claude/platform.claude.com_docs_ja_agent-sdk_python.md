---
url: "https://platform.claude.com/docs/ja/agent-sdk/python"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fagent-sdk%2Fpython)
...
| `output_format` | [`OutputFormat`](https://platform.claude.com/docs/ja/agent-sdk/python#outputformat)` | None` | `None` | エージェント結果の出力形式を定義します。詳細は [構造化出力](https://platform.claude.com/docs/ja/agent-sdk/structured-outputs) を参照してください |
...
| `plugins` | `list[SdkPluginConfig]` | `[]` | ローカルパスからカスタムプラグインをロードします。詳細は [プラグイン](https://platform.claude.com/docs/ja/agent-sdk/plugins) を参照してください |
| `sandbox` | [`SandboxSettings`](https://platform.claude.com/docs/ja/agent-sdk/python#sandboxsettings)` | None` | `None` | サンドボックス動作をプログラムで設定します。詳細は [サンドボックス設定](https://platform.claude.com/docs/ja/agent-sdk/python#sandboxsettings) を参照してください |
...
プラグインの作成と使用に関する完全な情報については、 [プラグイン](https://platform.claude.com/docs/ja/agent-sdk/plugins) を参照してください。
...
フックの使用に関する包括的なガイドと例、一般的なパターンについては、 [フックガイド](https://platform.claude.com/docs/ja/agent-sdk/hooks) を参照してください。
...
- `input_data`: フック固有の入力データ（ [フックガイド](https://platform.claude.com/docs/ja/agent-sdk/hooks#input-data) を参照）
...
| `allowUnsandboxedCommands` | `bool` | `False` | モデルがサンドボックス外でコマンドを実行するようリクエストすることを許可。`True`の場合、モデルはツール入力で`dangerouslyDisableSandbox`を設定でき、これは [パーミッションシステム](https://platform.claude.com/docs/ja/agent-sdk/python#permissions-fallback-for-unsandboxed-commands) にフォールバックします |
| `network` | [`SandboxNetworkConfig`](https://platform.claude.com/docs/ja/agent-sdk/python#sandboxnetworkconfig) | `None` | ネットワーク固有のサンドボックス設定 |
| `ignoreViolations` | [`SandboxIgnoreViolations`](https://platform.claude.com/docs/ja/agent-sdk/python#sandboxignoreviolations) | `None` | 無視するサンドボックス違反を設定 |
...
- [Python SDKガイド](https://platform.claude.com/docs/ja/agent-sdk/python) \- チュートリアルと例
- [SDKの概要](https://platform.claude.com/docs/ja/agent-sdk/overview) \- 一般的なSDKコンセプト
- [TypeScript SDKリファレンス](https://platform.claude.com/docs/ja/agent-sdk/typescript) \- TypeScript SDKドキュメント
...
- [query() と ClaudeSDKClient の選択](https://platform.claude.com/docs/ja/agent-sdk/python#query-claude-sdk-client)
- [query() を使用する場合（毎回新しいセッション）](https://platform.claude.com/docs/ja/agent-sdk/python#query)
- [ClaudeSDKClient を使用する場合（継続的な会話）](https://platform.claude.com/docs/ja/agent-sdk/python#claude-sdk-client)
- [query()](https://platform.claude.com/docs/ja/agent-sdk/python#query-2)
- [tool()](https://platform.claude.com/docs/ja/agent-sdk/python#tool)
- [create\_sdk\_mcp\_server()](https://platform.claude.com/docs/ja/agent-sdk/python#create-sdk-mcp-server)
- [ClaudeSDKClient](https://platform.claude.com/docs/ja/agent-sdk/python#claude-sdk-client-2)
- [SdkMcpTool](https://platform.claude.com/docs/ja/agent-sdk/python#sdk-mcp-tool)
- [ClaudeAgentOptions](https://platform.claude.com/docs/ja/agent-sdk/python#claude-agent-options)
- [OutputFormat](https://platform.claude.com/docs/ja/agent-sdk/python#output-format)
- [SystemPromptPreset](https://platform.claude.com/docs/ja/agent-sdk/python#system-prompt-preset)
- [SettingSource](https://platform.claude.com/docs/ja/agent-sdk/python#setting-source)
- [AgentDefinition](https://platform.claude.com/docs/ja/agent-sdk/python#agent-definition)
- [PermissionMode](https://platform.claude.com/docs/ja/agent-sdk/python#permission-mode)
- [McpSdkServerConfig](https://platform.claude.com/docs/ja/agent-sdk/python#mcp-sdk-server-config)
- [McpServerConfig](https://platform.claude.com/docs/ja/agent-sdk/python#mcp-server-config)
- [SdkPluginConfig](https://platform.claude.com/docs/ja/agent-sdk/python#sdk-plugin-config)
- [Message](https://platform.claude.com/docs/ja/agent-sdk/python#message)
- [UserMessage](https://platform.claude.com/docs/ja/agent-sdk/python#user-message)
- [AssistantMessage](https://platform.claude.com/docs/ja/agent-sdk/python#assistant-message)
- [SystemMessage](https://platform.claude.com/docs/ja/agent-sdk/python#system-message)
- [ResultMessage](https://platform.claude.com/docs/ja/agent-sdk/python#result-message)
- [ContentBlock](https://platform.claude.com/docs/ja/agent-sdk/python#content-block)
- [TextBlock](https://platform.claude.com/docs/ja/agent-sdk/python#text-block)
- [ThinkingBlock](https://platform.claude.com/docs/ja/agent-sdk/python#thinking-block)
- [ToolUseBlock](https://platform.claude.com/docs/ja/agent-sdk/python#tool-use-block)
- [ToolResultBlock](https://platform.claude.com/docs/ja/agent-sdk/python#tool-result-block)
- [ClaudeSDKError](https://platform.claude.com/docs/ja/agent-sdk/python#claude-sdk-error)
- [CLINotFoundError](https://platform.claude.com/docs/ja/agent-sdk/python#cli-not-found-error)
- [CLIConnectionError](https://platform.claude.com/docs/ja/agent-sdk/python#cli-connection-error)
- [ProcessError](https://platform.claude.com/docs/ja/agent-sdk/python#process-error)
- [CLIJSONDecodeError](https://platform.claude.com/docs/ja/agent-sdk/python#clijson-decode-error)
- [HookEvent](https://platform.claude.com/docs/ja/agent-sdk/python#hook-event)
- [HookCallback](https://platform.claude.com/docs/ja/agent-sdk/python#hook-callback)
- [HookContext](https://platform.claude.com/docs/ja/agent-sdk/python#hook-context)
- [HookMatcher](https://platform.claude.com/docs/ja/agent-sdk/python#hook-matcher)
- [Task](https://platform.claude.com/docs/ja/agent-sdk/python#task)
- [Bash](https://platform.claude.com/docs/ja/agent-sdk/python#bash)
- [Edit](https://platform.claude.com/docs/ja/agent-sdk/python#edit)
- [Read](https://platform.claude.com/docs/ja/agent-sdk/python#read)
- [Write](https://platform.claude.com/docs/ja/agent-sdk/python#write)
- [Glob](https://platform.claude.com/docs/ja/agent-sdk/python#glob)
- [Grep](https://platform.claude.com/docs/ja/agent-sdk/python#grep)
- [NotebookEdit](https://platform.claude.com/docs/ja/agent-sdk/python#notebook-edit)
- [WebFetch](https://platform.claude.com/docs/ja/agent-sdk/python#web-fetch)
- [WebSearch](https://platform.claude.com/docs/ja/agent-sdk/python#web-search)
- [TodoWrite](https://platform.claude.com/docs/ja/agent-sdk/python#todo-write)
- [BashOutput](https://platform.claude.com/docs/ja/agent-sdk/python#bash-output)
- [KillBash](https://platform.claude.com/docs/ja/agent-sdk/python#kill-bash)
- [ExitPlanMode](https://platform.claude.com/docs/ja/agent-sdk/python#exit-plan-mode)
- [ListMcpResources](https://platform.claude.com/docs/ja/agent-sdk/python#list-mcp-resources)
- [ReadMcpResource](https://platform.claude.com/docs/ja/agent-sdk/python#read-mcp-resource)
- [ClaudeSDKClientを使用した高度な機能](https://platform.claude.com/docs/ja/agent-sdk/python#claude-sdk-client-3)
- [基本的なファイル操作（queryを使用）](https://platform.claude.com/docs/ja/agent-sdk/python#query-3)
- [ClaudeSDKClientでカスタムツールを使用](https://platform.claude.com/docs/ja/agent-sdk/python#claude-sdk-client-4)
- [SandboxSettings](https://platform.claude.com/docs/ja/agent-sdk/python#sandbox-settings)
- [SandboxNetworkConfig](https://platform.claude.com/docs/ja/agent-sdk/python#sandbox-network-config)
- [SandboxIgnoreViolations](https://platform.claude.com/docs/ja/agent-sdk/python#sandbox-ignore-violations)
