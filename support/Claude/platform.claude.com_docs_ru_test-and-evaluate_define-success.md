---
url: "https://platform.claude.com/docs/ru/test-and-evaluate/define-success"
title: "Определите критерии успеха - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Ftest-and-evaluate%2Fdefine-success)
...
- **Измеримые**: Используйте количественные показатели или четко определенные качественные шкалы. Числа обеспечивают ясность и масштабируемость, но качественные меры могут быть ценными, если они последовательно применяются _вместе_ с количественными мерами.
...
\\
**Совет**: Добавьте эту страницу в чат в качестве руководства для Claude!](https://claude.ai/) [Разработка оценок\\
\\
Узнайте, как создавать надежные тестовые наборы для оценки производительности Claude по вашим критериям.](https://platform.claude.com/docs/ru/be-clear-direct)

- [Создание надежных критериев](https://platform.claude.com/docs/ru/test-and-evaluate/define-success#sozdanie-nadezhnykh-kriteriev)
- [Общие критерии успеха, которые следует учитывать](https://platform.claude.com/docs/ru/test-and-evaluate/define-success#obschie-kriterii-uspekha-kotorye-sleduet-uchityvat)
- [Следующие шаги](https://platform.claude.com/docs/ru/test-and-evaluate/define-success#sleduyuschie-shagi)
