---
url: "https://platform.claude.com/docs/ru/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak"
title: "Уменьшение утечки промпта - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Freduce-prompt-leak)
...
### Пример: Защита проприетарной аналитики
...
- [Прежде чем пытаться уменьшить утечку промпта](https://platform.claude.com/docs/ru/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak#prezhde-chem-pytatsya-umenshit-utechku-prompta)
- [Стратегии уменьшения утечки промпта](https://platform.claude.com/docs/ru/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak#strategii-umensheniya-utechki-prompta)
