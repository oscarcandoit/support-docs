---
url: "https://platform.claude.com/docs/ko/agents-and-tools/tool-use/programmatic-tool-calling"
title: "프로그래매틱 도구 호출 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fko%2Fagents-and-tools%2Ftool-use%2Fprogrammatic-tool-calling)
...
프로그래매틱 도구 호출을 통해 Claude는 각 도구 호출마다 모델을 통한 왕복을 요구하지 않고 [코드 실행](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/code-execution-tool) 컨테이너 내에서 프로그래매틱하게 도구를 호출하는 코드를 작성할 수 있습니다. 이는 다중 도구 워크플로우의 지연 시간을 줄이고 Claude가 데이터를 필터링하거나 처리한 후 모델의 컨텍스트 윈도우에 도달하도록 함으로써 토큰 소비를 감소시킵니다.

프로그래매틱 도구 호출은 현재 공개 베타 상태입니다.

이 기능을 사용하려면 API 요청에 `"advanced-tool-use-2025-11-20"` [베타 헤더](https://platform.claude.com/docs/ko/api/beta-headers) 를 추가하세요.
...
| 오류 | 설명 | 해결 방법 |
| --- | --- | --- |
| `invalid_tool_input` | 도구 입력이 스키마와 일치하지 않음 | 도구의 input\_schema 검증 |
...
- 웹 검색
- 웹 가져오기
- [MCP 커넥터](https://platform.claude.com/docs/ko/agents-and-tools/mcp-connector) 에서 제공하는 도구
...
프로그래매틱 도구 호출은 코드 실행과 동일한 가격 책정을 사용합니다. 자세한 내용은 [코드 실행 가격 책정](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/code-execution-tool#usage-and-pricing) 을 참조하세요.
...
[코드 실행 도구\\
\\
프로그래매틱 도구 호출을 지원하는 기본 코드 실행 기능에 대해 알아봅니다.](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/code-execution-tool) [도구 사용 개요\\
\\
Claude를 사용한 도구 사용의 기본 사항을 이해합니다.](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/overview) [도구 사용 구현\\
\\
도구 구현을 위한 단계별 가이드입니다.](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/implement-tool-use)

- [allowed\_callers 필드](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/programmatic-tool-calling#allowed-callers)
- [응답의 caller 필드](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/programmatic-tool-calling#caller)
- [단계 1: 초기 요청](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/programmatic-tool-calling#1)
- [단계 2: 도구 호출이 있는 API 응답](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/programmatic-tool-calling#2-api)
- [단계 3: 도구 결과 제공](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/programmatic-tool-calling#3)
- [단계 4: 다음 도구 호출 또는 완료](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/programmatic-tool-calling#4)
- [단계 5: 최종 응답](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/programmatic-tool-calling#5)
- [Anthropic 관리형 실행](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/programmatic-tool-calling#anthropic)
