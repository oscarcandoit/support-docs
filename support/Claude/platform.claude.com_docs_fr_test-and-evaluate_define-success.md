---
url: "https://platform.claude.com/docs/fr/test-and-evaluate/define-success"
title: "Définir vos critères de réussite - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Ftest-and-evaluate%2Fdefine-success)
...
- **Mesurables** : Utilisez des métriques quantitatives ou des échelles qualitatives bien définies. Les chiffres apportent de la clarté et de l'évolutivité, mais les mesures qualitatives peuvent être précieuses si elles sont appliquées de manière cohérente _avec_ des mesures quantitatives.
...
\\
**Astuce** : Déposez cette page dans le chat comme guide pour Claude !](https://claude.ai/) [Concevoir des évaluations\\
\\
Apprenez à créer des ensembles de tests solides pour évaluer les performances de Claude par rapport à vos critères.](https://platform.claude.com/docs/fr/be-clear-direct)

- [Élaborer des critères solides](https://platform.claude.com/docs/fr/test-and-evaluate/define-success#elaborer-des-criteres-solides)
- [Critères de réussite courants à considérer](https://platform.claude.com/docs/fr/test-and-evaluate/define-success#criteres-de-reussite-courants-a-considerer)
- [Prochaines étapes](https://platform.claude.com/docs/fr/test-and-evaluate/define-success#prochaines-etapes)
