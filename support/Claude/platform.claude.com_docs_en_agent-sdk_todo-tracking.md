...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagent-sdk%2Ftodo-tracking)
...
- [Todo Lifecycle](https://platform.claude.com/docs/en/agent-sdk/todo-tracking#todo-lifecycle)
- [When Todos Are Used](https://platform.claude.com/docs/en/agent-sdk/todo-tracking#when-todos-are-used)
- [Examples](https://platform.claude.com/docs/en/agent-sdk/todo-tracking#examples)
- [Monitoring Todo Changes](https://platform.claude.com/docs/en/agent-sdk/todo-tracking#monitoring-todo-changes)
- [Real-time Progress Display](https://platform.claude.com/docs/en/agent-sdk/todo-tracking#real-time-progress-display)
- [Related Documentation](https://platform.claude.com/docs/en/agent-sdk/todo-tracking#related-documentation)
