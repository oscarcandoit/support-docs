---
url: "https://platform.claude.com/docs/ru/intro"
title: "Введение в Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fintro)
...
Claude — это высокопроизводительная, надежная и интеллектуальная платформа искусственного интеллекта, созданная компанией Anthropic. Claude отлично справляется с задачами, связанными с языком, рассуждениями, анализом, кодированием и многим другим.
...
Хотите поговорить с Claude? Посетите [claude.ai](http://www.claude.ai/)!

## Начало работы

Если вы новичок в Claude, начните здесь, чтобы изучить основы и сделать свой первый вызов API.

[Начало работы\\
\\
Настройте среду разработки для работы с Claude.](https://platform.claude.com/docs/ru/get-started) [Узнайте о Claude\\
\\
Узнайте о семействе моделей Claude.](https://platform.claude.com/docs/ru/about-claude/models/overview) [Библиотека подсказок\\
\\
Изучите примеры подсказок для вдохновения.](https://platform.claude.com/docs/ru/resources/prompt-library/library)

* * *

## Разработка с Claude

Anthropic предоставляет инструменты разработчика мирового класса для создания масштабируемых приложений с Claude.

[Консоль разработчика\\
\\
Наслаждайтесь более простым и мощным созданием подсказок в вашем браузере с помощью Workbench и инструмента генератора подсказок.](https://platform.claude.com/) [Справочник API\\
\\
Изучайте, внедряйте и масштабируйте с помощью Claude API и SDK.](https://platform.claude.com/docs/ru/api/overview) [Claude Cookbook\\
\\
Учитесь с помощью интерактивных записных книжек Jupyter, которые демонстрируют загрузку PDF-файлов, встраивания и многое другое.](https://github.com/anthropics/anthropic-cookbook)

* * *

## Ключевые возможности

Claude может помочь со многими задачами, связанными с текстом, кодом и изображениями.

[Генерация текста и кода\\
\\
Суммируйте текст, отвечайте на вопросы, извлекайте данные, переводите текст, объясняйте и генерируйте код.](https://platform.claude.com/docs/ru/build-with-claude/text-generation) [Зрение\\
\\
Обрабатывайте и анализируйте визуальный ввод и генерируйте текст и код из изображений.](https://platform.claude.com/docs/ru/build-with-claude/vision)
...
[Центр справки\\
\\
Найдите ответы на часто задаваемые вопросы об учетной записи и выставлении счетов.](https://support.claude.com/en/) [Статус сервиса\\
\\
Проверьте статус сервисов Anthropic.](https://status.claude.com/)

- [Начало работы](https://platform.claude.com/docs/ru/intro#nachalo-raboty)
- [Разработка с Claude](https://platform.claude.com/docs/ru/intro#razrabotka-s-claude)
- [Ключевые возможности](https://platform.claude.com/docs/ru/intro#klyuchevye-vozmozhnosti)
- [Поддержка](https://platform.claude.com/docs/ru/intro#podderzhka)
