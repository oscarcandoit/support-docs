---
url: "https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/be-clear-and-direct"
title: "Soyez clair, direct et détaillé - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fbuild-with-claude%2Fprompt-engineering%2Fbe-clear-and-direct)
...
**La règle d'or de la formulation claire**
...
### Exemple : Anonymiser les commentaires des clients

### Exemple : Créer une campagne d'e-mail marketing

### Exemple : Réponse aux incidents
...
- [Comment être clair, contextuel et spécifique](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/be-clear-and-direct#comment-etre-clair-contextuel-et-specifique)
- [Exemples](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/be-clear-and-direct#exemples)
