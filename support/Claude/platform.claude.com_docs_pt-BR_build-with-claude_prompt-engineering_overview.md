---
url: "https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/overview"
title: "Visão geral da engenharia de prompts - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Fbuild-with-claude%2Fprompt-engineering%2Foverview)
...
Se não, sugerimos fortemente que você dedique tempo para estabelecer isso primeiro. Confira [Defina seus critérios de sucesso](https://platform.claude.com/docs/pt-BR/test-and-evaluate/define-success) e [Crie avaliações empíricas fortes](https://platform.claude.com/docs/pt-BR/test-and-evaluate/develop-tests) para dicas e orientações.

[Gerador de prompts\\
\\
Não tem um primeiro rascunho de prompt? Tente o gerador de prompts no Claude Console!](https://platform.claude.com/dashboard)
...
1. [Gerador de prompts](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/prompt-generator)
2. [Seja claro e direto](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/be-clear-and-direct)
3. [Use exemplos (multishot)](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/multishot-prompting)
4. [Deixe Claude pensar (chain of thought)](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/chain-of-thought)
5. [Use tags XML](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/use-xml-tags)
6. [Dê um papel ao Claude (system prompts)](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/system-prompts)
7. [Preencha previamente a resposta do Claude](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/prefill-claudes-response)
8. [Encadeie prompts complexos](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/chain-prompts)
9. [Dicas de contexto longo](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/long-context-tips)
...
\\
Uma versão mais leve do nosso tutorial de engenharia de prompts via uma planilha interativa.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Antes da engenharia de prompts](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/overview#antes-da-engenharia-de-prompts)
- [Quando fazer engenharia de prompts](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/overview#quando-fazer-engenharia-de-prompts)
- [Como fazer engenharia de prompts](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/overview#como-fazer-engenharia-de-prompts)
- [Tutorial de engenharia de prompts](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/overview#tutorial-de-engenharia-de-prompts)
