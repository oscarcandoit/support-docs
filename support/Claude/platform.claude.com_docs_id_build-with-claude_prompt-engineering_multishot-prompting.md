...
title: "Gunakan contoh (multishot prompting) untuk membimbing perilaku Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fbuild-with-claude%2Fprompt-engineering%2Fmultishot-prompting)
...
Gunakan contoh (multishot prompting)
...
**Tingkatkan prompt Anda**: Sertakan 3-5 contoh yang beragam dan relevan untuk menunjukkan kepada Claude persis apa yang Anda inginkan. Lebih banyak contoh = performa yang lebih baik, terutama untuk tugas-tugas yang kompleks.
...
Minta Claude untuk mengevaluasi contoh Anda untuk relevansi, keragaman, atau kejelasan. Atau biarkan Claude menghasilkan lebih banyak contoh berdasarkan set awal Anda.

### Contoh: Menganalisis umpan balik pelanggan
...
\\
Tutorial yang penuh dengan contoh yang mencakup konsep prompt engineering yang ditemukan di dokumentasi kami.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutorial prompting Google Sheets\\
\\
...
- [Mengapa menggunakan contoh?](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/multishot-prompting#mengapa-menggunakan-contoh)
- [Membuat contoh yang efektif](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/multishot-prompting#membuat-contoh-yang-efektif)
