...
title: "Mitigasi jailbreak dan injeksi prompt - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fmitigate-jailbreaks)
...
- [Lanjutan: Pengamanan berantai](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#lanjutan-pengamanan-berantai)
- [Prompt sistem bot](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#prompt-sistem-bot)
- [Prompt dalam alat harmlessness\_screen](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#prompt-dalam-alat-harmlessness-screen)
