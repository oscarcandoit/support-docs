...
title: "Agent SDK reference - Python - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagent-sdk%2Fpython)
...
- [Installation](https://platform.claude.com/docs/en/agent-sdk/python#installation)
- [Choosing Between query() and ClaudeSDKClient](https://platform.claude.com/docs/en/agent-sdk/python#choosing-between-query-and-claude-sdk-client)
- [Quick Comparison](https://platform.claude.com/docs/en/agent-sdk/python#quick-comparison)
- [When to Use query() (New Session Each Time)](https://platform.claude.com/docs/en/agent-sdk/python#when-to-use-query-new-session-each-time)
- [When to Use ClaudeSDKClient (Continuous Conversation)](https://platform.claude.com/docs/en/agent-sdk/python#when-to-use-claude-sdk-client-continuous-conversation)
- [Functions](https://platform.claude.com/docs/en/agent-sdk/python#functions)
- [query()](https://platform.claude.com/docs/en/agent-sdk/python#query)
- [tool()](https://platform.claude.com/docs/en/agent-sdk/python#tool)
- [create\_sdk\_mcp\_server()](https://platform.claude.com/docs/en/agent-sdk/python#create-sdk-mcp-server)
- [Classes](https://platform.claude.com/docs/en/agent-sdk/python#classes)
- [ClaudeSDKClient](https://platform.claude.com/docs/en/agent-sdk/python#claude-sdk-client)
- [Types](https://platform.claude.com/docs/en/agent-sdk/python#types)
- [SdkMcpTool](https://platform.claude.com/docs/en/agent-sdk/python#sdk-mcp-tool)
- [ClaudeAgentOptions](https://platform.claude.com/docs/en/agent-sdk/python#claude-agent-options)
- [OutputFormat](https://platform.claude.com/docs/en/agent-sdk/python#output-format)
- [SystemPromptPreset](https://platform.claude.com/docs/en/agent-sdk/python#system-prompt-preset)
- [SettingSource](https://platform.claude.com/docs/en/agent-sdk/python#setting-source)
- [AgentDefinition](https://platform.claude.com/docs/en/agent-sdk/python#agent-definition)
- [PermissionMode](https://platform.claude.com/docs/en/agent-sdk/python#permission-mode)
- [McpSdkServerConfig](https://platform.claude.com/docs/en/agent-sdk/python#mcp-sdk-server-config)
- [McpServerConfig](https://platform.claude.com/docs/en/agent-sdk/python#mcp-server-config)
- [SdkPluginConfig](https://platform.claude.com/docs/en/agent-sdk/python#sdk-plugin-config)
- [Message Types](https://platform.claude.com/docs/en/agent-sdk/python#message-types)
- [Message](https://platform.claude.com/docs/en/agent-sdk/python#message)
- [UserMessage](https://platform.claude.com/docs/en/agent-sdk/python#user-message)
- [AssistantMessage](https://platform.claude.com/docs/en/agent-sdk/python#assistant-message)
- [SystemMessage](https://platform.claude.com/docs/en/agent-sdk/python#system-message)
- [ResultMessage](https://platform.claude.com/docs/en/agent-sdk/python#result-message)
- [Content Block Types](https://platform.claude.com/docs/en/agent-sdk/python#content-block-types)
- [ContentBlock](https://platform.claude.com/docs/en/agent-sdk/python#content-block)
- [TextBlock](https://platform.claude.com/docs/en/agent-sdk/python#text-block)
- [ThinkingBlock](https://platform.claude.com/docs/en/agent-sdk/python#thinking-block)
- [ToolUseBlock](https://platform.claude.com/docs/en/agent-sdk/python#tool-use-block)
- [ToolResultBlock](https://platform.claude.com/docs/en/agent-sdk/python#tool-result-block)
- [Error Types](https://platform.claude.com/docs/en/agent-sdk/python#error-types)
- [ClaudeSDKError](https://platform.claude.com/docs/en/agent-sdk/python#claude-sdk-error)
- [CLINotFoundError](https://platform.claude.com/docs/en/agent-sdk/python#cli-not-found-error)
- [CLIConnectionError](https://platform.claude.com/docs/en/agent-sdk/python#cli-connection-error)
- [ProcessError](https://platform.claude.com/docs/en/agent-sdk/python#process-error)
- [CLIJSONDecodeError](https://platform.claude.com/docs/en/agent-sdk/python#clijson-decode-error)
- [Hook Types](https://platform.claude.com/docs/en/agent-sdk/python#hook-types)
- [HookEvent](https://platform.claude.com/docs/en/agent-sdk/python#hook-event)
- [HookCallback](https://platform.claude.com/docs/en/agent-sdk/python#hook-callback)
- [HookContext](https://platform.claude.com/docs/en/agent-sdk/python#hook-context)
- [HookMatcher](https://platform.claude.com/docs/en/agent-sdk/python#hook-matcher)
- [Hook Usage Example](https://platform.claude.com/docs/en/agent-sdk/python#hook-usage-example)
- [Tool Input/Output Types](https://platform.claude.com/docs/en/agent-sdk/python#tool-input-output-types)
- [Task](https://platform.claude.com/docs/en/agent-sdk/python#task)
- [Bash](https://platform.claude.com/docs/en/agent-sdk/python#bash)
- [Edit](https://platform.claude.com/docs/en/agent-sdk/python#edit)
- [Read](https://platform.claude.com/docs/en/agent-sdk/python#read)
- [Write](https://platform.claude.com/docs/en/agent-sdk/python#write)
- [Glob](https://platform.claude.com/docs/en/agent-sdk/python#glob)
- [Grep](https://platform.claude.com/docs/en/agent-sdk/python#grep)
- [NotebookEdit](https://platform.claude.com/docs/en/agent-sdk/python#notebook-edit)
- [WebFetch](https://platform.claude.com/docs/en/agent-sdk/python#web-fetch)
- [WebSearch](https://platform.claude.com/docs/en/agent-sdk/python#web-search)
- [TodoWrite](https://platform.claude.com/docs/en/agent-sdk/python#todo-write)
- [BashOutput](https://platform.claude.com/docs/en/agent-sdk/python#bash-output)
- [KillBash](https://platform.claude.com/docs/en/agent-sdk/python#kill-bash)
- [ExitPlanMode](https://platform.claude.com/docs/en/agent-sdk/python#exit-plan-mode)
- [ListMcpResources](https://platform.claude.com/docs/en/agent-sdk/python#list-mcp-resources)
- [ReadMcpResource](https://platform.claude.com/docs/en/agent-sdk/python#read-mcp-resource)
- [Advanced Features with ClaudeSDKClient](https://platform.claude.com/docs/en/agent-sdk/python#advanced-features-with-claude-sdk-client)
- [Building a Continuous Conversation Interface](https://platform.claude.com/docs/en/agent-sdk/python#building-a-continuous-conversation-interface)
- [Using Hooks for Behavior Modification](https://platform.claude.com/docs/en/agent-sdk/python#using-hooks-for-behavior-modification)
- [Real-time Progress Monitoring](https://platform.claude.com/docs/en/agent-sdk/python#real-time-progress-monitoring)
- [Example Usage](https://platform.claude.com/docs/en/agent-sdk/python#example-usage)
- [Basic file operations (using query)](https://platform.claude.com/docs/en/agent-sdk/python#basic-file-operations-using-query)
- [Error handling](https://platform.claude.com/docs/en/agent-sdk/python#error-handling)
- [Streaming mode with client](https://platform.claude.com/docs/en/agent-sdk/python#streaming-mode-with-client)
- [Using custom tools with ClaudeSDKClient](https://platform.claude.com/docs/en/agent-sdk/python#using-custom-tools-with-claude-sdk-client)
- [Sandbox Configuration](https://platform.claude.com/docs/en/agent-sdk/python#sandbox-configuration)
- [SandboxSettings](https://platform.claude.com/docs/en/agent-sdk/python#sandbox-settings)
- [SandboxNetworkConfig](https://platform.claude.com/docs/en/agent-sdk/python#sandbox-network-config)
- [SandboxIgnoreViolations](https://platform.claude.com/docs/en/agent-sdk/python#sandbox-ignore-violations)
- [Permissions Fallback for Unsandboxed Commands](https://platform.claude.com/docs/en/agent-sdk/python#permissions-fallback-for-unsandboxed-commands)
- [See also](https://platform.claude.com/docs/en/agent-sdk/python#see-also)
