...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fapi%2Fpython%2Fbeta%2Ffiles%2Fupload)
...
file: [FileTypes](https://platform.claude.com/docs/en/api/beta/files/upload)
