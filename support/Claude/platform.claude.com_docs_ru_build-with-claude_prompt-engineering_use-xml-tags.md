---
url: "https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/use-xml-tags"
title: "Используйте XML-теги для структурирования ваших подсказок - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fbuild-with-claude%2Fprompt-engineering%2Fuse-xml-tags)
...
**Совет по XML**: Используйте теги вроде `<instructions>`, `<example>` и `<formatting>` для четкого разделения различных частей вашей подсказки. Это предотвращает смешивание инструкций с примерами или контекстом.
...
Нет канонических "лучших" XML-тегов, на которых Claude был бы специально обучен, хотя мы рекомендуем, чтобы названия ваших тегов имели смысл в отношении информации, которую они окружают.
...
**Совет для опытных пользователей**: Комбинируйте XML-теги с другими методами, такими как многошаговое промптирование (`<examples>`) или цепочка рассуждений (`<thinking>`, `<answer>`). Это создает супер-структурированные, высокопроизводительные подсказки.

### Примеры

### Пример: Создание финансовых отчетов

### Пример: Анализ юридического контракта

* * *

[Библиотека подсказок\\
\\
Вдохновитесь тщательно отобранной коллекцией подсказок для различных задач и вариантов использования.](https://platform.claude.com/docs/ru/resources/prompt-library/library) [Учебное пособие GitHub по промптингу\\
\\
Полное примерами учебное пособие, охватывающее концепции инженерии подсказок, найденные в нашей документации.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Учебное пособие Google Sheets по промптингу\\
\\
Более легкая версия нашего учебного пособия по инженерии подсказок через интерактивную электронную таблицу.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Зачем использовать XML-теги?](https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/use-xml-tags#zachem-ispolzovat-xml-tegi)
- [Лучшие практики использования тегов](https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/use-xml-tags#luchshie-praktiki-ispolzovaniya-tegov)
- [Примеры](https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/use-xml-tags#primery)
