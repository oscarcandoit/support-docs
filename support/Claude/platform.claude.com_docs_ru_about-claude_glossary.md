---
url: "https://platform.claude.com/docs/ru/about-claude/glossary"
title: "Глоссарий - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fabout-claude%2Fglossary)
...
Смотрите наше [руководство по пониманию контекстных окон](https://platform.claude.com/docs/ru/build-with-claude/context-windows), чтобы узнать больше.
...
Model Context Protocol (MCP) - это открытый протокол, который стандартизирует то, как приложения предоставляют контекст LLM. Как USB-C порт для приложений ИИ, MCP обеспечивает единый способ подключения моделей ИИ к различным источникам данных и инструментам. MCP позволяет системам ИИ поддерживать согласованный контекст между взаимодействиями и получать доступ к внешним ресурсам стандартизированным способом. Смотрите нашу [документацию MCP](https://platform.claude.com/docs/ru/mcp), чтобы узнать больше.

## MCP коннектор

MCP коннектор - это функция, которая позволяет пользователям API подключаться к MCP серверам напрямую из Messages API без создания MCP клиента. Это обеспечивает бесшовную интеграцию с MCP-совместимыми инструментами и сервисами через Claude API. MCP коннектор поддерживает функции, такие как вызов инструментов, и доступен в публичной бета-версии. Смотрите нашу [документацию MCP коннектора](https://platform.claude.com/docs/ru/agents-and-tools/mcp-connector), чтобы узнать больше.
...
- [Контекстное окно](https://platform.claude.com/docs/ru/about-claude/glossary#kontekstnoe-okno)
- [Тонкая настройка](https://platform.claude.com/docs/ru/about-claude/glossary#tonkaya-nastroyka)
- [HHH](https://platform.claude.com/docs/ru/about-claude/glossary#hhh)
- [Задержка](https://platform.claude.com/docs/ru/about-claude/glossary#zaderzhka)
- [LLM](https://platform.claude.com/docs/ru/about-claude/glossary#llm)
- [MCP (Model Context Protocol)](https://platform.claude.com/docs/ru/about-claude/glossary#mcp-model-context-protocol)
- [MCP коннектор](https://platform.claude.com/docs/ru/about-claude/glossary#mcp-konnektor)
- [Предварительное обучение](https://platform.claude.com/docs/ru/about-claude/glossary#predvaritelnoe-obuchenie)
- [RAG (Retrieval augmented generation)](https://platform.claude.com/docs/ru/about-claude/glossary#rag-retrieval-augmented-generation)
- [RLHF](https://platform.claude.com/docs/ru/about-claude/glossary#rlhf)
- [Температура](https://platform.claude.com/docs/ru/about-claude/glossary#temperatura)
- [TTFT (Time to first token)](https://platform.claude.com/docs/ru/about-claude/glossary#ttft-time-to-first-token)
- [Токены](https://platform.claude.com/docs/ru/about-claude/glossary#tokeny)
