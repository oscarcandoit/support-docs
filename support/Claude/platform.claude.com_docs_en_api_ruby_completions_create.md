...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fapi%2Fruby%2Fcompletions%2Fcreate)
...
completions.create(\*\*kwargs) -\> [Completion](https://platform.claude.com/docs/en/api/completions#completion) {id, completion, model, 2 more}
