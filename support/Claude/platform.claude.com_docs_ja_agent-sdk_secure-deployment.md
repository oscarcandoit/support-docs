---
url: "https://platform.claude.com/docs/ja/agent-sdk/secure-deployment"
title: "AIエージェントの安全なデプロイ - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fagent-sdk%2Fsecure-deployment)
...
**オプション1：ANTHROPIC\_BASE\_URL（シンプルですがサンプリングAPIリクエストのみ）**
...
**オプション2：HTTP\_PROXY / HTTPS\_PROXY（システム全体）**
...
- [Agent SDKのホスティング](https://platform.claude.com/docs/ja/agent-sdk/hosting)
- [権限の処理](https://platform.claude.com/docs/ja/agent-sdk/permissions)
...
- [gVisor](https://platform.claude.com/docs/ja/agent-sdk/secure-deployment#g-visor)
- [Claude Codeをプロキシを使用するように設定する](https://platform.claude.com/docs/ja/agent-sdk/secure-deployment#claude-code)
