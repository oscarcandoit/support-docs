---
url: "https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/chain-prompts"
title: "Concatenare prompt complessi per prestazioni più forti - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fbuild-with-claude%2Fprompt-engineering%2Fchain-prompts)
...
### Esempio: Riepilogo di ricerca auto-correttivo

* * *

## Esempi

### Esempio: Analisi di un contratto legale (senza concatenazione)

### Esempio: Analisi di un contratto legale (con concatenazione)

### Esempio: Revisione della strategia multi-tenancy
...
- [Perché concatenare i prompt?](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/chain-prompts#perche-concatenare-i-prompt)
- [Quando concatenare i prompt](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/chain-prompts#quando-concatenare-i-prompt)
- [Come concatenare i prompt](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/chain-prompts#come-concatenare-i-prompt)
- [Flussi di lavoro concatenati di esempio:](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/chain-prompts#flussi-di-lavoro-concatenati-di-esempio)
- [Avanzate: Catene di auto-correzione](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/chain-prompts#avanzate-catene-di-auto-correzione)
- [Esempi](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/chain-prompts#esempi)
