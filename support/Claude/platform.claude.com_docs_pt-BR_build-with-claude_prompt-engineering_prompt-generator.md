---
url: "https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/prompt-generator"
title: "Gerar automaticamente modelos de prompt de primeiro rascunho - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Fbuild-with-claude%2Fprompt-engineering%2Fprompt-generator)
...
# Gerar automaticamente modelos de prompt de primeiro rascunho

Copy page

Copy page

Nosso gerador de prompts é compatível com todos os modelos Claude, incluindo aqueles com capacidades de pensamento estendido. Para dicas de prompting específicas para modelos de pensamento estendido, veja [aqui](https://platform.claude.com/docs/pt-BR/build-with-claude/extended-thinking).

Às vezes, a parte mais difícil de usar um modelo de IA é descobrir como fazer prompts de forma eficaz. Para ajudar com isso, criamos uma ferramenta de geração de prompts que orienta o Claude a gerar modelos de prompts de alta qualidade adaptados às suas tarefas específicas. Esses modelos seguem muitas das nossas melhores práticas de engenharia de prompts.

O gerador de prompts é particularmente útil como uma ferramenta para resolver o "problema da página em branco" e dar a você um ponto de partida para testes e iterações adicionais.

Experimente o gerador de prompts agora diretamente no [Console](https://platform.claude.com/dashboard).

Se você estiver interessado em analisar o prompt subjacente e a arquitetura, confira nosso [notebook Google Colab do gerador de prompts](https://anthropic.com/metaprompt-notebook/). Lá, você pode facilmente executar o código para que o Claude construa prompts em seu nome.

Observe que para executar o notebook Colab, você precisará de uma [chave de API](https://platform.claude.com/settings/keys).

* * *

## Próximos passos

[Começar engenharia de prompts\\
\\
Comece a criar prompts eficazes com nossas diretrizes e melhores práticas.](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/be-clear-and-direct) [Biblioteca de prompts\\
\\
Inspire-se com uma seleção curada de prompts para várias tarefas e casos de uso.](https://platform.claude.com/docs/pt-BR/resources/prompt-library/library) [Tutorial de prompting no GitHub\\
\\
Um tutorial repleto de exemplos que aborda os conceitos de engenharia de prompts encontrados em nossa documentação.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutorial de prompting no Google Sheets\\
\\
...
- [Próximos passos](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/prompt-generator#proximos-passos)
