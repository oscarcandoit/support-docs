...
title: "Create strong empirical evaluations - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Ftest-and-evaluate%2Fdevelop-tests)
...
\\
Learn how to craft prompts that maximize your eval scores.](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/overview) [Evals cookbook\\
\\
...
- [Building evals and test cases](https://platform.claude.com/docs/en/test-and-evaluate/develop-tests#building-evals-and-test-cases)
...
- [Grading evals](https://platform.claude.com/docs/en/test-and-evaluate/develop-tests#grading-evals)
