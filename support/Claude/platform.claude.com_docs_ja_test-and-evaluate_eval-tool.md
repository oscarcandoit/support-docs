---
url: "https://platform.claude.com/docs/ja/test-and-evaluate/eval-tool"
title: "評価ツールの使用 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Ftest-and-evaluate%2Feval-tool)
...
[Claude Console](https://platform.claude.com/dashboard) には、様々なシナリオでプロンプトをテストできる **評価ツール** が搭載されています。
...
![評価機能へのアクセス](https://platform.claude.com/docs/images/access_evaluate.png)

プロンプトに二重波括弧構文を使用した少なくとも1〜2個の動的変数が含まれていることを確認してください：{{variable}}。これは評価テストセットを作成するために必要です。

## プロンプトの生成

Consoleには、Claude Opus 4.1を搭載した内蔵の [プロンプトジェネレーター](https://platform.claude.com/docs/ja/build-with-claude/prompt-engineering/prompt-generator) があります：
...
![プロンプトジェネレーター](https://platform.claude.com/docs/images/promptgenerator.png)
...
![入力済み評価画面](https://platform.claude.com/docs/images/eval_populated.png)
