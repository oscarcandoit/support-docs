---
url: "https://platform.claude.com/docs/ja/agent-sdk/mcp"
title: "SDK内のMCP - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fagent-sdk%2Fmcp)
...
アプリケーション内で実行されるインプロセスサーバー。カスタムツールの作成に関する詳細情報については、 [カスタムツールガイド](https://platform.claude.com/docs/ja/agent-sdk/custom-tools) を参照してください：
...
- [カスタムツールガイド](https://platform.claude.com/docs/ja/agent-sdk/custom-tools) \- SDK MCPサーバーの作成に関する詳細ガイド
- [TypeScript SDKリファレンス](https://platform.claude.com/docs/ja/agent-sdk/typescript)
- [Python SDKリファレンス](https://platform.claude.com/docs/ja/agent-sdk/python)
- [SDK権限](https://platform.claude.com/docs/ja/agent-sdk/permissions)
- [一般的なワークフロー](https://code.claude.com/docs/common-workflows)

- [SDK内でのMCPサーバーの使用](https://platform.claude.com/docs/ja/agent-sdk/mcp#sdk-mcp)
- [stdioサーバー](https://platform.claude.com/docs/ja/agent-sdk/mcp#stdio)
- [HTTP/SSEサーバー](https://platform.claude.com/docs/ja/agent-sdk/mcp#http-sse)
- [SDK MCPサーバー](https://platform.claude.com/docs/ja/agent-sdk/mcp#sdk-mcp-2)
- [OAuth2認証](https://platform.claude.com/docs/ja/agent-sdk/mcp#o-auth2)
