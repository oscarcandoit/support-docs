...
title: "Claude in Microsoft Foundry - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fbuild-with-claude%2Fclaude-in-microsoft-foundry)
...
Claude on Foundry supports most of Claude's powerful features. You can find all the features currently supported [here](https://platform.claude.com/docs/en/build-with-claude/overview).
...
- [Supported features](https://platform.claude.com/docs/en/build-with-claude/claude-in-microsoft-foundry#supported-features)
