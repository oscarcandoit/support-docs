---
url: "https://platform.claude.com/docs/fr/home"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fhome)
...
Découvrez comment démarrer avec la plateforme Claude Developer et Claude Code.

Posez une question à Claude sur la documentation...
...
[Démarrer\\
\\
Effectuez votre premier appel API en quelques minutes.](https://platform.claude.com/docs/fr/get-started) [Aperçu des fonctionnalités\\
\\
Explorez les fonctionnalités avancées et les capacités désormais disponibles dans Claude.](https://platform.claude.com/docs/fr/api/overview) [Nouveautés de Claude 4.5\\
\\
Découvrez les dernières avancées des modèles Claude 4.5.](https://platform.claude.com/docs/fr/about-claude/models/whats-new-claude-4-5) [Référence API\\
\\
Intégrez et mettez à l'échelle en utilisant notre API et nos SDK.](https://platform.claude.com/docs/fr/api/overview) [Console Claude\\
\\
Créez et testez des invites puissantes directement dans votre navigateur.](https://platform.claude.com/) [Notes de version\\
\\
Découvrez les modifications et les nouvelles fonctionnalités de la plateforme Claude Developer.](https://platform.claude.com/docs/fr/release-notes/api)

## Claude Code

[Démarrage rapide Claude Code\\
\\
Démarrez avec Claude Code.](https://code.claude.com/docs/fr/quickstart) [Référence Claude Code\\
\\
Consultez la documentation de référence de Claude Code pour obtenir des détails sur l'implémentation des fonctionnalités et la configuration.](https://code.claude.com/docs/fr/overview) [Journal des modifications Claude Code\\
\\
Découvrez les modifications et les nouvelles fonctionnalités de Claude Code.](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md)

## Ressources d'apprentissage

[Cours Anthropic\\
\\
Explorez les cours et projets éducatifs d'Anthropic.](https://anthropic.skilljar.com/) [Claude Cookbook\\
\\
Consultez des exemples de code reproductibles et des implémentations.](https://github.com/anthropics/anthropic-cookbook) [Démarrages rapides Claude\\
\\
Applications déployables créées avec notre API.](https://github.com/anthropics/anthropic-quickstarts)
