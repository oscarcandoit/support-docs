...
title: "Introdução ao Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Fintro)
...
Claude é uma plataforma de IA altamente performática, confiável e inteligente construída pela Anthropic. Claude se destaca em tarefas envolvendo linguagem, raciocínio, análise, codificação e muito mais.
...
Procurando conversar com Claude? Visite [claude.ai](http://www.claude.ai/)!

## Comece agora

Se você é novo no Claude, comece aqui para aprender o essencial e fazer sua primeira chamada de API.

[Comece agora\\
\\
Configure seu ambiente de desenvolvimento para construir com Claude.](https://platform.claude.com/docs/pt-BR/get-started) [Saiba mais sobre Claude\\
\\
Saiba mais sobre a família de modelos Claude.](https://platform.claude.com/docs/pt-BR/about-claude/models/overview) [Biblioteca de Prompts\\
\\
Explore prompts de exemplo para inspiração.](https://platform.claude.com/docs/pt-BR/resources/prompt-library/library)

* * *

## Desenvolva com Claude

Anthropic possui ferramentas de desenvolvedor de classe mundial para construir aplicações escaláveis com Claude.

[Console do Desenvolvedor\\
\\
Aproveite prompting mais fácil e poderoso em seu navegador com o Workbench e a ferramenta geradora de prompts.](https://platform.claude.com/) [Referência da API\\
\\
Explore, implemente e dimensione com a API Claude e SDKs.](https://platform.claude.com/docs/pt-BR/api/overview) [Claude Cookbook\\
\\
Aprenda com notebooks Jupyter interativos que demonstram upload de PDFs, embeddings e muito mais.](https://github.com/anthropics/anthropic-cookbook)

* * *

## Capacidades principais

Claude pode ajudar com muitas tarefas que envolvem texto, código e imagens.

[Geração de texto e código\\
\\
Resuma texto, responda perguntas, extraia dados, traduza texto e explique e gere código.](https://platform.claude.com/docs/pt-BR/build-with-claude/text-generation) [Visão\\
\\
Processe e analise entrada visual e gere texto e código a partir de imagens.](https://platform.claude.com/docs/pt-BR/build-with-claude/vision)
...
[Centro de Ajuda\\
\\
Encontre respostas para perguntas frequentes sobre conta e faturamento.](https://support.claude.com/en/) [Status do Serviço\\
\\
Verifique o status dos serviços Anthropic.](https://status.claude.com/)

- [Comece agora](https://platform.claude.com/docs/pt-BR/intro#comece-agora)
- [Desenvolva com Claude](https://platform.claude.com/docs/pt-BR/intro#desenvolva-com-claude)
- [Capacidades principais](https://platform.claude.com/docs/pt-BR/intro#capacidades-principais)
- [Suporte](https://platform.claude.com/docs/pt-BR/intro#suporte)
