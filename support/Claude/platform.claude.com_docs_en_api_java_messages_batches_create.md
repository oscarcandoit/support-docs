...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fapi%2Fjava%2Fmessages%2Fbatches%2Fcreate)
...
Optional<List<[ToolUnion](https://platform.claude.com/docs/en/api/messages#tool_union)>>tools
