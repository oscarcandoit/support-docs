---
url: "https://platform.claude.com/docs/es/test-and-evaluate/strengthen-guardrails/keep-claude-in-character"
title: "Mantener a Claude en personaje con indicaciones de rol y precompletado - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fkeep-claude-in-character)
...
Mantener a Claude en personaje
...
- **Usa indicaciones del sistema para establecer el rol:** Utiliza [indicaciones del sistema](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/system-prompts) para definir el rol y la personalidad de Claude. Esto establece una base sólida para respuestas consistentes.
...
Al establecer el personaje, proporciona información detallada sobre la personalidad, antecedentes y cualquier rasgo o peculiaridad específica. Esto ayudará al modelo a emular y generalizar mejor los rasgos del personaje.
...
### Ejemplo: Chatbot empresarial para indicaciones de rol
