...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fbuild-with-claude%2Fprompt-engineering%2Fuse-xml-tags)
...
- [Why use XML tags?](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/use-xml-tags#why-use-xml-tags)
- [Tagging best practices](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/use-xml-tags#tagging-best-practices)
- [Examples](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/use-xml-tags#examples)
