---
url: "https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/long-context-tips"
title: "Suggerimenti per il prompting con contesto lungo - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fbuild-with-claude%2Fprompt-engineering%2Flong-context-tips)
...
Suggerimenti per il contesto lungo
...
Le query alla fine possono migliorare la qualità della risposta fino al 30% nei test, soprattutto con input complessi e multi-documento.
...
[Libreria di prompt\\
\\
Ispirati da una selezione curata di prompt per vari compiti e casi d'uso.](https://platform.claude.com/docs/it/resources/prompt-library/library) [Tutorial di prompting su GitHub\\
\\
Un tutorial ricco di esempi che copre i concetti di prompt engineering trovati nella nostra documentazione.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutorial di prompting su Google Sheets\\
\\
...
- [Suggerimenti essenziali per i prompt con contesto lungo](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/long-context-tips#suggerimenti-essenziali-per-i-prompt-con-contesto-lungo)
