---
url: "https://platform.claude.com/docs/ja/test-and-evaluate/strengthen-guardrails/increase-consistency"
title: "出力の一貫性を向上させる - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fincrease-consistency)
...
Claudeが常に特定のスキーマに準拠した有効なJSONを出力する必要がある場合は、以下のプロンプトエンジニアリング技法の代わりに [構造化出力](https://platform.claude.com/docs/ja/build-with-claude/structured-outputs) を使用してください。構造化出力は、スキーマ準拠を保証し、このユースケースのために特別に設計されています。
...
- [Claudeの応答を事前入力する](https://platform.claude.com/docs/ja/test-and-evaluate/strengthen-guardrails/increase-consistency#claude)
