---
url: "https://platform.claude.com/docs/en/api/kotlin/models"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fapi%2Fkotlin%2Fmodels)
...
models().retrieve(ModelRetrieveParamsparams=ModelRetrieveParams.none(), RequestOptionsrequestOptions=RequestOptions.none()):[ModelInfo](https://platform.claude.com/docs/en/api/models#model_info)
