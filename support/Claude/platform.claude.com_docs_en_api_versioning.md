...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fapi%2Fversioning)
...
When making API requests, you must send an `anthropic-version` request header. For example, `anthropic-version: 2023-06-01`. If you are using our [client SDKs](https://platform.claude.com/docs/en/api/client-sdks), this is handled for you automatically.
