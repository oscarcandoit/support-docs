...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fabout-claude%2Fglossary)
...
- [Context window](https://platform.claude.com/docs/en/about-claude/glossary#context-window)
- [Fine-tuning](https://platform.claude.com/docs/en/about-claude/glossary#fine-tuning)
- [HHH](https://platform.claude.com/docs/en/about-claude/glossary#hhh)
- [Latency](https://platform.claude.com/docs/en/about-claude/glossary#latency)
- [LLM](https://platform.claude.com/docs/en/about-claude/glossary#llm)
- [MCP (Model Context Protocol)](https://platform.claude.com/docs/en/about-claude/glossary#mcp-model-context-protocol)
- [MCP connector](https://platform.claude.com/docs/en/about-claude/glossary#mcp-connector)
- [Pretraining](https://platform.claude.com/docs/en/about-claude/glossary#pretraining)
- [RAG (Retrieval augmented generation)](https://platform.claude.com/docs/en/about-claude/glossary#rag-retrieval-augmented-generation)
- [RLHF](https://platform.claude.com/docs/en/about-claude/glossary#rlhf)
- [Temperature](https://platform.claude.com/docs/en/about-claude/glossary#temperature)
- [TTFT (Time to first token)](https://platform.claude.com/docs/en/about-claude/glossary#ttft-time-to-first-token)
