...
title: "Mengurangi kebocoran prompt - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Freduce-prompt-leak)
...
- [Sebelum Anda mencoba mengurangi kebocoran prompt](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak#sebelum-anda-mencoba-mengurangi-kebocoran-prompt)
- [Strategi untuk mengurangi kebocoran prompt](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak#strategi-untuk-mengurangi-kebocoran-prompt)
