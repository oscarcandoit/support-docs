---
url: "https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/overview"
title: "Panoramica dell'ingegneria dei prompt - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fbuild-with-claude%2Fprompt-engineering%2Foverview)
...
Se non è così, ti consigliamo vivamente di dedicare tempo a stabilire prima questo. Consulta [Definisci i tuoi criteri di successo](https://platform.claude.com/docs/it/test-and-evaluate/define-success) e [Crea valutazioni empiriche forti](https://platform.claude.com/docs/it/test-and-evaluate/develop-tests) per suggerimenti e orientamenti.

[Generatore di prompt\\
\\
Non hai una bozza iniziale di prompt? Prova il generatore di prompt nella Claude Console!](https://platform.claude.com/dashboard)
...
7. [Precompila la risposta di Claude](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/prefill-claudes-response)
8. [Concatena prompt complessi](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/chain-prompts)
9. [Suggerimenti per il contesto lungo](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/long-context-tips)
...
\\
Un tutorial ricco di esempi che copre i concetti di ingegneria dei prompt trovati nella nostra documentazione.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutorial di prompting Google Sheets\\
\\
...
- [Prima dell'ingegneria dei prompt](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/overview#prima-dell-ingegneria-dei-prompt)
- [Quando fare ingegneria dei prompt](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/overview#quando-fare-ingegneria-dei-prompt)
- [Come fare ingegneria dei prompt](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/overview#come-fare-ingegneria-dei-prompt)
- [Tutorial di ingegneria dei prompt](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/overview#tutorial-di-ingegneria-dei-prompt)
