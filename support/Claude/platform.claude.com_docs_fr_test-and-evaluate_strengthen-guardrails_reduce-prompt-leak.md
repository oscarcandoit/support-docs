---
url: "https://platform.claude.com/docs/fr/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak"
title: "Réduire la fuite de prompt - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Freduce-prompt-leak)
...
Essayez d'abord les techniques de surveillance, comme le filtrage des sorties et le post-traitement, pour tenter de détecter les cas de fuite de prompt.
...
- [Avant d'essayer de réduire la fuite de prompt](https://platform.claude.com/docs/fr/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak#avant-d-essayer-de-reduire-la-fuite-de-prompt)
- [Stratégies pour réduire la fuite de prompt](https://platform.claude.com/docs/fr/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak#strategies-pour-reduire-la-fuite-de-prompt)
