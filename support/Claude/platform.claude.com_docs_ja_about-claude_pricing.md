---
url: "https://platform.claude.com/docs/ja/about-claude/pricing"
title: "料金 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fabout-claude%2Fpricing)
...
MTok = 100万トークン。「Base Input Tokens」列は標準入力料金を示し、「Cache Writes」と「Cache Hits」は [プロンプトキャッシング](https://platform.claude.com/docs/ja/build-with-claude/prompt-caching) に固有のもので、「Output Tokens」は出力料金を示しています。プロンプトキャッシングは、異なるユースケースのコストを最適化するために、5分（デフォルト）と1時間のキャッシュ期間の両方を提供しています。
...
Claudeモデルは [AWS Bedrock](https://platform.claude.com/docs/ja/build-with-claude/claude-on-amazon-bedrock)、 [Google Vertex AI](https://platform.claude.com/docs/ja/build-with-claude/claude-on-vertex-ai)、および [Microsoft Foundry](https://platform.claude.com/docs/ja/build-with-claude/claude-in-microsoft-foundry) で利用可能です。公式料金については、以下をご覧ください：
...
- [AWS Bedrockグローバルエンドポイント対リージョナルエンドポイント](https://platform.claude.com/docs/ja/build-with-claude/claude-on-amazon-bedrock#global-vs-regional-endpoints)
- [Google Vertex AIグローバルエンドポイント対リージョナルエンドポイント](https://platform.claude.com/docs/ja/build-with-claude/claude-on-vertex-ai#global-vs-regional-endpoints)
...
バッチ処理の詳細については、 [バッチ処理ドキュメント](https://platform.claude.com/docs/ja/build-with-claude/batch-processing) をご覧ください。

### 長いコンテキスト料金

Claude Sonnet 4またはSonnet 4.5を [1Mトークンコンテキストウィンドウが有効](https://platform.claude.com/docs/ja/build-with-claude/context-windows#1m-token-context-window) にして使用する場合、200K入力トークンを超えるリクエストは自動的にプレミアム長いコンテキスト料金で課金されます：

1Mトークンコンテキストウィンドウは現在、 [使用量階層](https://platform.claude.com/docs/ja/api/rate-limits) 4の組織およびカスタムレート制限を持つ組織のベータ版です。1MトークンコンテキストウィンドウはClaude Sonnet 4とSonnet 4.5でのみ利用可能です。
...
- [Batch API 50%割引](https://platform.claude.com/docs/ja/about-claude/pricing#batch-processing) は長いコンテキスト料金に適用されます
- [プロンプトキャッシング乗数](https://platform.claude.com/docs/ja/about-claude/pricing#model-pricing) は長いコンテキスト料金の上に適用されます
...
`usage`オブジェクトの詳細については、 [APIレスポンスドキュメント](https://platform.claude.com/docs/ja/api/messages#response-usage) をご覧ください。
...
現在のモデルごとの価格については、上記の [モデル料金](https://platform.claude.com/docs/ja/about-claude/pricing#model-pricing) セクションを参照してください。

ツール使用の実装とベストプラクティスの詳細については、 [ツール使用ドキュメント](https://platform.claude.com/docs/ja/agents-and-tools/tool-use/overview) をご覧ください。
...
完全な料金詳細については [ツール使用料金](https://platform.claude.com/docs/ja/about-claude/pricing#tool-use-pricing) をご覧ください。
...
この計算の詳細なウォークスルーについては、 [カスタマーサポートエージェントガイド](https://platform.claude.com/docs/ja/about-claude/use-case-guides/customer-support-chat) をご覧ください。
...
エージェント料金パターンの包括的なガイドについては、 [エージェントユースケースガイド](https://platform.claude.com/docs/ja/about-claude/use-case-guides) をご覧ください。
...
詳細なレート制限情報については、 [レート制限ドキュメント](https://platform.claude.com/docs/ja/api/rate-limits) をご覧ください。
...
[sales@anthropic.com](mailto:sales@anthropic.com) でセールスチームに連絡するか、 [Claude Console](https://platform.claude.com/settings/limits) を通じてエンタープライズ料金オプションについて相談してください。
...
- 使用状況追跡は [Claude Console](https://platform.claude.com/) で利用可能です
