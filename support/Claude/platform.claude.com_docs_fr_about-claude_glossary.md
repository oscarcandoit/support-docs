---
url: "https://platform.claude.com/docs/fr/about-claude/glossary"
title: "Glossaire - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fabout-claude%2Fglossary)
...
Consultez notre [guide pour comprendre les fenêtres de contexte](https://platform.claude.com/docs/fr/build-with-claude/context-windows) pour en savoir plus.
...
- [Fenêtre de contexte](https://platform.claude.com/docs/fr/about-claude/glossary#fenetre-de-contexte)
- [Ajustement fin](https://platform.claude.com/docs/fr/about-claude/glossary#ajustement-fin)
- [HHH](https://platform.claude.com/docs/fr/about-claude/glossary#hhh)
- [Latence](https://platform.claude.com/docs/fr/about-claude/glossary#latence)
- [LLM](https://platform.claude.com/docs/fr/about-claude/glossary#llm)
- [MCP (Model Context Protocol)](https://platform.claude.com/docs/fr/about-claude/glossary#mcp-model-context-protocol)
- [Connecteur MCP](https://platform.claude.com/docs/fr/about-claude/glossary#connecteur-mcp)
- [Pré-entraînement](https://platform.claude.com/docs/fr/about-claude/glossary#pre-entrainement)
- [RAG (Génération augmentée par récupération)](https://platform.claude.com/docs/fr/about-claude/glossary#rag-generation-augmentee-par-recuperation)
- [RLHF](https://platform.claude.com/docs/fr/about-claude/glossary#rlhf)
- [Température](https://platform.claude.com/docs/fr/about-claude/glossary#temperature)
- [TTFT (Temps jusqu'au premier jeton)](https://platform.claude.com/docs/fr/about-claude/glossary#ttft-temps-jusqu-au-premier-jeton)
- [Jetons](https://platform.claude.com/docs/fr/about-claude/glossary#jetons)
