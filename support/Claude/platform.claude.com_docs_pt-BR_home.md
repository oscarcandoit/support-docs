---
url: "https://platform.claude.com/docs/pt-BR/home"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Fhome)
...
Aprenda como começar com a Plataforma de Desenvolvedores Claude e Claude Code.

Pergunte ao Claude sobre os docs...
...
[Começar\\
\\
Faça sua primeira chamada de API em minutos.](https://platform.claude.com/docs/pt-BR/get-started) [Visão geral dos recursos\\
\\
Explore os recursos avançados e capacidades agora disponíveis no Claude.](https://platform.claude.com/docs/pt-BR/api/overview) [Novidades no Claude 4.5\\
\\
Descubra os últimos avanços nos modelos Claude 4.5.](https://platform.claude.com/docs/pt-BR/about-claude/models/whats-new-claude-4-5) [Referência de API\\
\\
Integre e dimensione usando nossa API e SDKs.](https://platform.claude.com/docs/pt-BR/api/overview) [Console Claude\\
\\
Crie e teste prompts poderosos diretamente no seu navegador.](https://platform.claude.com/) [Notas de lançamento\\
\\
Saiba mais sobre mudanças e novos recursos na Plataforma de Desenvolvedores Claude.](https://platform.claude.com/docs/pt-BR/release-notes/api)

## Claude Code

[Guia de início rápido do Claude Code\\
\\
Comece com Claude Code.](https://code.claude.com/docs/pt-BR/quickstart) [Referência do Claude Code\\
\\
Consulte a documentação de referência do Claude Code para detalhes sobre implementação de recursos e configuração.](https://code.claude.com/docs/pt-BR/overview) [Changelog do Claude Code\\
\\
Saiba mais sobre mudanças e novos recursos no Claude Code.](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md)

## Recursos de aprendizado

[Cursos Anthropic\\
\\
Explore os cursos educacionais e projetos da Anthropic.](https://anthropic.skilljar.com/) [Claude Cookbook\\
\\
Veja exemplos de código replicáveis e implementações.](https://github.com/anthropics/anthropic-cookbook) [Claude Quickstarts\\
\\
Aplicações implantáveis construídas com nossa API.](https://github.com/anthropics/anthropic-quickstarts)
