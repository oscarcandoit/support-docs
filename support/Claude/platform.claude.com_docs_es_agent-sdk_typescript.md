---
url: "https://platform.claude.com/docs/es/agent-sdk/typescript"
title: "Referencia del SDK de Agent - TypeScript - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fagent-sdk%2Ftypescript)
...
**Prueba la nueva interfaz V2 (vista previa):** Una interfaz simplificada con patrones `send()` y `receive()` está disponible ahora, haciendo que las conversaciones multi-turno sean más fáciles. [Aprende más](https://platform.claude.com/docs/es/agent-sdk/typescript-v2-preview)
...
| --- | --- | --- |
| `prompt` | `string | AsyncIterable<` [`SDKUserMessage`](https://platform.claude.com/docs/es/agent-sdk/typescript#sdkusermessage)`>` | El mensaje de entrada como una cadena o iterable asincrónico para modo de transmisión |
| `options` | [`Options`](https://platform.claude.com/docs/es/agent-sdk/typescript#options) | Objeto de configuración opcional (ver tipo Options a continuación) |

#### Retorna

Retorna un objeto [`Query`](https://platform.claude.com/docs/es/agent-sdk/typescript#query-1) que extiende `AsyncGenerator<` [`SDKMessage`](https://platform.claude.com/docs/es/agent-sdk/typescript#sdkmessage)`, void>` con métodos adicionales.
...
| `handler` | `(args, extra) => Promise<` [`CallToolResult`](https://platform.claude.com/docs/es/agent-sdk/typescript#calltoolresult)`>` | Función asincrónica que ejecuta la lógica de la herramienta |
...
| `options.tools` | `Array<SdkMcpToolDefinition>` | Matriz de definiciones de herramientas creadas con [`tool()`](https://platform.claude.com/docs/es/agent-sdk/typescript#tool) |
...
| `betas` | [`SdkBeta`](https://platform.claude.com/docs/es/agent-sdk/typescript#sdkbeta)`[]` | `[]` | Habilitar características beta (por ejemplo, `['context-1m-2025-08-07']`) |
| `canUseTool` | [`CanUseTool`](https://platform.claude.com/docs/es/agent-sdk/typescript#canusetool) | `undefined` | Función de permiso personalizada para uso de herramientas |
...
| `hooks` | `Partial<Record<` [`HookEvent`](https://platform.claude.com/docs/es/agent-sdk/typescript#hookevent)`,` [`HookCallbackMatcher`](https://platform.claude.com/docs/es/agent-sdk/typescript#hookcallbackmatcher)`[]>>` | `{}` | Devoluciones de llamada de gancho para eventos |
...
| `outputFormat` | `{ type: 'json_schema', schema: JSONSchema }` | `undefined` | Definir formato de salida para resultados del agente. Ver [Salidas estructuradas](https://platform.claude.com/docs/es/agent-sdk/structured-outputs) para detalles |
| `pathToClaudeCodeExecutable` | `string` | Usa ejecutable integrado | Ruta al ejecutable de Claude Code |
| `permissionMode` | [`PermissionMode`](https://platform.claude.com/docs/es/agent-sdk/typescript#permissionmode) | `'default'` | Modo de permiso para la sesión |
| `permissionPromptToolName` | `string` | `undefined` | Nombre de herramienta MCP para solicitudes de permiso |
| `plugins` | [`SdkPluginConfig`](https://platform.claude.com/docs/es/agent-sdk/typescript#sdkpluginconfig)`[]` | `[]` | Cargar complementos personalizados desde rutas locales. Ver [Complementos](https://platform.claude.com/docs/es/agent-sdk/plugins) para detalles |
...
| `sandbox` | [`SandboxSettings`](https://platform.claude.com/docs/es/agent-sdk/typescript#sandboxsettings) | `undefined` | Configurar comportamiento de sandbox programáticamente. Ver [Configuración de sandbox](https://platform.claude.com/docs/es/agent-sdk/typescript#sandboxsettings) para detalles |
| `settingSources` | [`SettingSource`](https://platform.claude.com/docs/es/agent-sdk/typescript#settingsource)`[]` | `[]` (sin configuración) | Controlar qué configuraciones del sistema de archivos cargar. Cuando se omite, no se carga ninguna configuración. **Nota:** Debe incluir `'project'` para cargar archivos CLAUDE.md |
...
Para información completa sobre crear y usar complementos, ver [Complementos](https://platform.claude.com/docs/es/agent-sdk/plugins).
...
Para una guía completa sobre el uso de ganchos con ejemplos y patrones comunes, ver la [guía de Ganchos](https://platform.claude.com/docs/es/agent-sdk/hooks).
...
Hace preguntas aclaratorias al usuario durante la ejecución. Ver [Manejo de la herramienta AskUserQuestion](https://platform.claude.com/docs/es/agent-sdk/permissions#handling-the-askuserquestion-tool) para detalles de uso.
...
Características beta disponibles que se pueden habilitar a través de la opción `betas`. Consulte [encabezados beta](https://platform.claude.com/docs/es/api/beta-headers) para más información.
...
| --- | --- | --- |
| `'context-1m-2025-08-07'` | Habilita [ventana de contexto](https://platform.claude.com/docs/es/build-with-claude/context-windows) de 1 millón de tokens | Claude Sonnet 4, Claude Sonnet 4.5 |
...
Una versión de [`Usage`](https://platform.claude.com/docs/es/agent-sdk/typescript#usage) con todos los campos anulables hechos no anulables.
...
| `allowUnsandboxedCommands` | `boolean` | `false` | Permitir que el modelo solicite ejecutar comandos fuera del sandbox. Cuando es `true`, el modelo puede establecer `dangerouslyDisableSandbox` en la entrada de la herramienta, que recurre al [sistema de permisos](https://platform.claude.com/docs/es/agent-sdk/typescript#permissions-fallback-for-unsandboxed-commands) |
| `network` | [`NetworkSandboxSettings`](https://platform.claude.com/docs/es/agent-sdk/typescript#networksandboxsettings) | `undefined` | Configuración de sandbox específica de red |
| `ignoreViolations` | [`SandboxIgnoreViolations`](https://platform.claude.com/docs/es/agent-sdk/typescript#sandboxignoreviolations) | `undefined` | Configurar qué violaciones de sandbox ignorar |
...
- [Descripción general del SDK](https://platform.claude.com/docs/es/agent-sdk/overview) \- Conceptos generales del SDK
- [Referencia del SDK de Python](https://platform.claude.com/docs/es/agent-sdk/python) \- Documentación del SDK de Python
...
- [Instalación](https://platform.claude.com/docs/es/agent-sdk/typescript#instalacion)
- [Funciones](https://platform.claude.com/docs/es/agent-sdk/typescript#funciones)
- [query()](https://platform.claude.com/docs/es/agent-sdk/typescript#query)
- [tool()](https://platform.claude.com/docs/es/agent-sdk/typescript#tool)
- [createSdkMcpServer()](https://platform.claude.com/docs/es/agent-sdk/typescript#create-sdk-mcp-server)
- [Tipos](https://platform.claude.com/docs/es/agent-sdk/typescript#tipos)
- [Options](https://platform.claude.com/docs/es/agent-sdk/typescript#options)
- [Query](https://platform.claude.com/docs/es/agent-sdk/typescript#query-2)
- [AgentDefinition](https://platform.claude.com/docs/es/agent-sdk/typescript#agent-definition)
- [SettingSource](https://platform.claude.com/docs/es/agent-sdk/typescript#setting-source)
- [PermissionMode](https://platform.claude.com/docs/es/agent-sdk/typescript#permission-mode)
- [CanUseTool](https://platform.claude.com/docs/es/agent-sdk/typescript#can-use-tool)
- [PermissionResult](https://platform.claude.com/docs/es/agent-sdk/typescript#permission-result)
- [McpServerConfig](https://platform.claude.com/docs/es/agent-sdk/typescript#mcp-server-config)
- [SdkPluginConfig](https://platform.claude.com/docs/es/agent-sdk/typescript#sdk-plugin-config)
- [Tipos de Mensaje](https://platform.claude.com/docs/es/agent-sdk/typescript#tipos-de-mensaje)
- [SDKMessage](https://platform.claude.com/docs/es/agent-sdk/typescript#sdk-message)
- [SDKAssistantMessage](https://platform.claude.com/docs/es/agent-sdk/typescript#sdkassistant-message)
- [SDKUserMessage](https://platform.claude.com/docs/es/agent-sdk/typescript#sdkuser-message)
- [SDKUserMessageReplay](https://platform.claude.com/docs/es/agent-sdk/typescript#sdkuser-message-replay)
- [SDKResultMessage](https://platform.claude.com/docs/es/agent-sdk/typescript#sdk-result-message)
- [SDKSystemMessage](https://platform.claude.com/docs/es/agent-sdk/typescript#sdk-system-message)
- [SDKPartialAssistantMessage](https://platform.claude.com/docs/es/agent-sdk/typescript#sdk-partial-assistant-message)
- [SDKCompactBoundaryMessage](https://platform.claude.com/docs/es/agent-sdk/typescript#sdk-compact-boundary-message)
- [SDKPermissionDenial](https://platform.claude.com/docs/es/agent-sdk/typescript#sdk-permission-denial)
- [Tipos de Gancho](https://platform.claude.com/docs/es/agent-sdk/typescript#tipos-de-gancho)
- [HookEvent](https://platform.claude.com/docs/es/agent-sdk/typescript#hook-event)
- [HookCallback](https://platform.claude.com/docs/es/agent-sdk/typescript#hook-callback)
- [HookCallbackMatcher](https://platform.claude.com/docs/es/agent-sdk/typescript#hook-callback-matcher)
- [HookInput](https://platform.claude.com/docs/es/agent-sdk/typescript#hook-input)
- [BaseHookInput](https://platform.claude.com/docs/es/agent-sdk/typescript#base-hook-input)
- [HookJSONOutput](https://platform.claude.com/docs/es/agent-sdk/typescript#hook-json-output)
- [Tipos de Entrada de Herramienta](https://platform.claude.com/docs/es/agent-sdk/typescript#tipos-de-entrada-de-herramienta)
- [ToolInput](https://platform.claude.com/docs/es/agent-sdk/typescript#tool-input)
- [Task](https://platform.claude.com/docs/es/agent-sdk/typescript#task)
- [AskUserQuestion](https://platform.claude.com/docs/es/agent-sdk/typescript#ask-user-question)
- [Bash](https://platform.claude.com/docs/es/agent-sdk/typescript#bash)
- [BashOutput](https://platform.claude.com/docs/es/agent-sdk/typescript#bash-output)
- [Edit](https://platform.claude.com/docs/es/agent-sdk/typescript#edit)
- [Read](https://platform.claude.com/docs/es/agent-sdk/typescript#read)
- [Write](https://platform.claude.com/docs/es/agent-sdk/typescript#write)
- [Glob](https://platform.claude.com/docs/es/agent-sdk/typescript#glob)
- [Grep](https://platform.claude.com/docs/es/agent-sdk/typescript#grep)
- [KillBash](https://platform.claude.com/docs/es/agent-sdk/typescript#kill-bash)
- [NotebookEdit](https://platform.claude.com/docs/es/agent-sdk/typescript#notebook-edit)
- [WebFetch](https://platform.claude.com/docs/es/agent-sdk/typescript#web-fetch)
- [WebSearch](https://platform.claude.com/docs/es/agent-sdk/typescript#web-search)
- [TodoWrite](https://platform.claude.com/docs/es/agent-sdk/typescript#todo-write)
- [ExitPlanMode](https://platform.claude.com/docs/es/agent-sdk/typescript#exit-plan-mode)
- [ListMcpResources](https://platform.claude.com/docs/es/agent-sdk/typescript#list-mcp-resources)
- [ReadMcpResource](https://platform.claude.com/docs/es/agent-sdk/typescript#read-mcp-resource)
- [Tipos de Salida de Herramienta](https://platform.claude.com/docs/es/agent-sdk/typescript#tipos-de-salida-de-herramienta)
- [ToolOutput](https://platform.claude.com/docs/es/agent-sdk/typescript#tool-output)
- [Task](https://platform.claude.com/docs/es/agent-sdk/typescript#task-2)
- [AskUserQuestion](https://platform.claude.com/docs/es/agent-sdk/typescript#ask-user-question-2)
- [Bash](https://platform.claude.com/docs/es/agent-sdk/typescript#bash-2)
- [BashOutput](https://platform.claude.com/docs/es/agent-sdk/typescript#bash-output-2)
- [Edit](https://platform.claude.com/docs/es/agent-sdk/typescript#edit-2)
- [Leer](https://platform.claude.com/docs/es/agent-sdk/typescript#leer)
- [Escribir](https://platform.claude.com/docs/es/agent-sdk/typescript#escribir)
- [Glob](https://platform.claude.com/docs/es/agent-sdk/typescript#glob-2)
- [Grep](https://platform.claude.com/docs/es/agent-sdk/typescript#grep-2)
- [KillBash](https://platform.claude.com/docs/es/agent-sdk/typescript#kill-bash-2)
- [NotebookEdit](https://platform.claude.com/docs/es/agent-sdk/typescript#notebook-edit-2)
- [WebFetch](https://platform.claude.com/docs/es/agent-sdk/typescript#web-fetch-2)
- [WebSearch](https://platform.claude.com/docs/es/agent-sdk/typescript#web-search-2)
- [TodoWrite](https://platform.claude.com/docs/es/agent-sdk/typescript#todo-write-2)
- [ExitPlanMode](https://platform.claude.com/docs/es/agent-sdk/typescript#exit-plan-mode-2)
- [ListMcpResources](https://platform.claude.com/docs/es/agent-sdk/typescript#list-mcp-resources-2)
- [ReadMcpResource](https://platform.claude.com/docs/es/agent-sdk/typescript#read-mcp-resource-2)
- [Tipos de Permisos](https://platform.claude.com/docs/es/agent-sdk/typescript#tipos-de-permisos)
- [PermissionUpdate](https://platform.claude.com/docs/es/agent-sdk/typescript#permission-update)
- [PermissionBehavior](https://platform.claude.com/docs/es/agent-sdk/typescript#permission-behavior)
- [PermissionUpdateDestination](https://platform.claude.com/docs/es/agent-sdk/typescript#permission-update-destination)
- [PermissionRuleValue](https://platform.claude.com/docs/es/agent-sdk/typescript#permission-rule-value)
- [Otros Tipos](https://platform.claude.com/docs/es/agent-sdk/typescript#otros-tipos)
- [ApiKeySource](https://platform.claude.com/docs/es/agent-sdk/typescript#api-key-source)
- [SdkBeta](https://platform.claude.com/docs/es/agent-sdk/typescript#sdk-beta)
- [SlashCommand](https://platform.claude.com/docs/es/agent-sdk/typescript#slash-command)
- [ModelInfo](https://platform.claude.com/docs/es/agent-sdk/typescript#model-info)
- [McpServerStatus](https://platform.claude.com/docs/es/agent-sdk/typescript#mcp-server-status)
- [AccountInfo](https://platform.claude.com/docs/es/agent-sdk/typescript#account-info)
- [ModelUsage](https://platform.claude.com/docs/es/agent-sdk/typescript#model-usage)
- [ConfigScope](https://platform.claude.com/docs/es/agent-sdk/typescript#config-scope)
- [NonNullableUsage](https://platform.claude.com/docs/es/agent-sdk/typescript#non-nullable-usage)
- [Usage](https://platform.claude.com/docs/es/agent-sdk/typescript#usage)
- [CallToolResult](https://platform.claude.com/docs/es/agent-sdk/typescript#call-tool-result)
- [AbortError](https://platform.claude.com/docs/es/agent-sdk/typescript#abort-error)
- [Configuración de Sandbox](https://platform.claude.com/docs/es/agent-sdk/typescript#configuracion-de-sandbox)
- [SandboxSettings](https://platform.claude.com/docs/es/agent-sdk/typescript#sandbox-settings)
- [NetworkSandboxSettings](https://platform.claude.com/docs/es/agent-sdk/typescript#network-sandbox-settings)
- [SandboxIgnoreViolations](https://platform.claude.com/docs/es/agent-sdk/typescript#sandbox-ignore-violations)
- [Fallback de Permisos para Comandos Sin Sandbox](https://platform.claude.com/docs/es/agent-sdk/typescript#fallback-de-permisos-para-comandos-sin-sandbox)
- [Ver también](https://platform.claude.com/docs/es/agent-sdk/typescript#ver-tambien)
