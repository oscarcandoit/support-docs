...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Fhome)
...
了解如何开始使用 Claude 开发者平台和 Claude Code。
...
[快速开始\\
\\
在几分钟内进行您的第一次 API 调用。](https://platform.claude.com/docs/zh-CN/get-started) [功能概览\\
\\
探索 Claude 中现在可用的高级功能和能力。](https://platform.claude.com/docs/zh-CN/api/overview) [Claude 4.5 中的新功能\\
\\
发现 Claude 4.5 模型中的最新进展。](https://platform.claude.com/docs/zh-CN/about-claude/models/whats-new-claude-4-5) [API 参考\\
\\
使用我们的 API 和 SDK 进行集成和扩展。](https://platform.claude.com/docs/zh-CN/api/overview) [Claude 控制台\\
\\
直接在浏览器中创建和测试强大的提示。](https://platform.claude.com/) [发布说明\\
\\
了解 Claude 开发者平台中的更改和新功能。](https://platform.claude.com/docs/zh-CN/release-notes/api)

## Claude Code

[Claude Code 快速开始\\
\\
开始使用 Claude Code。](https://code.claude.com/docs/zh-CN/quickstart) [Claude Code 参考\\
\\
查阅 Claude Code 参考文档，了解功能实现和配置的详细信息。](https://code.claude.com/docs/zh-CN/overview) [Claude Code 更新日志\\
\\
了解 Claude Code 中的更改和新功能。](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md)

## 学习资源

[Anthropic 课程\\
\\
探索 Anthropic 的教育课程和项目。](https://anthropic.skilljar.com/) [Claude 食谱\\
\\
查看可复制的代码示例和实现。](https://github.com/anthropics/anthropic-cookbook) [Claude 快速开始\\
\\
使用我们的 API 构建的可部署应用程序。](https://github.com/anthropics/anthropic-quickstarts)
