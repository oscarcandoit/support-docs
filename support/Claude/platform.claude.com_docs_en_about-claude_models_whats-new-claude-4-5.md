...
title: "What's new in Claude 4.5 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fabout-claude%2Fmodels%2Fwhats-new-claude-4-5)
...
[Best practices\\
\\
Learn prompt engineering techniques for Claude 4.5 models](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices) [Model overview\\
\\
Compare Claude 4.5 models with other Claude models](https://platform.claude.com/docs/en/about-claude/models/overview) [Migration guide\\
\\
Upgrade from previous models](https://platform.claude.com/docs/en/about-claude/models/migrating-to-claude-4)

- [Key improvements in Opus 4.5 over Opus 4.1](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#key-improvements-in-opus-4-5-over-opus-4-1)
- [Maximum intelligence](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#maximum-intelligence)
- [Effort parameter](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#effort-parameter)
- [Computer use excellence](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#computer-use-excellence)
- [Practical performance](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#practical-performance)
- [Thinking block preservation](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#thinking-block-preservation)
- [Key improvements in Sonnet 4.5 over Sonnet 4](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#key-improvements-in-sonnet-4-5-over-sonnet-4)
- [Coding excellence](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#coding-excellence)
- [Agent capabilities](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#agent-capabilities)
- [Communication and interaction style](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#communication-and-interaction-style)
- [Creative content generation](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#creative-content-generation)
- [Key improvements in Haiku 4.5 over Haiku 3.5](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#key-improvements-in-haiku-4-5-over-haiku-3-5)
- [Near-frontier intelligence with blazing speed](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#near-frontier-intelligence-with-blazing-speed)
- [Extended thinking capabilities](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#extended-thinking-capabilities)
- [Context awareness](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#context-awareness)
- [Strong coding and tool use](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#strong-coding-and-tool-use)
- [New API features](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#new-api-features)
- [Programmatic tool calling (Beta)](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#programmatic-tool-calling-beta)
- [Tool search tool (Beta)](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#tool-search-tool-beta)
- [Effort parameter (Beta)](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#effort-parameter-beta)
- [Tool use examples (Beta)](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#tool-use-examples-beta)
- [Memory tool (Beta)](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#memory-tool-beta)
- [Context editing](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#context-editing)
- [Enhanced stop reasons](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#enhanced-stop-reasons)
- [Improved tool parameter handling](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#improved-tool-parameter-handling)
- [Token count optimizations](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#token-count-optimizations)
- [Features introduced in Claude 4](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#features-introduced-in-claude-4)
- [New refusal stop reason](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#new-refusal-stop-reason)
- [Summarized thinking](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#summarized-thinking)
- [Interleaved thinking](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#interleaved-thinking)
- [Behavioral differences](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#behavioral-differences)
- [Updated text editor tool](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#updated-text-editor-tool)
- [Updated code execution tool](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#updated-code-execution-tool)
- [Pricing and availability](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#pricing-and-availability)
- [Pricing](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#pricing)
- [Third-party platform pricing](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#third-party-platform-pricing)
- [Availability](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#availability)
- [Migration guide](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#migration-guide)
- [Next steps](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5#next-steps)
