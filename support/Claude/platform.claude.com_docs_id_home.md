...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fhome)
...
Pelajari cara memulai dengan Claude Developer Platform dan Claude Code.

Tanyakan Claude tentang docs...
...
[Memulai\\
\\
Buat panggilan API pertama Anda dalam hitungan menit.](https://platform.claude.com/docs/id/get-started) [Ikhtisar fitur\\
\\
Jelajahi fitur dan kemampuan canggih yang sekarang tersedia di Claude.](https://platform.claude.com/docs/id/api/overview) [Yang baru di Claude 4.5\\
\\
Temukan kemajuan terbaru dalam model Claude 4.5.](https://platform.claude.com/docs/id/about-claude/models/whats-new-claude-4-5) [Referensi API\\
\\
Integrasikan dan skalakan menggunakan API dan SDK kami.](https://platform.claude.com/docs/id/api/overview) [Claude Console\\
\\
Buat dan uji prompt yang kuat langsung di browser Anda.](https://platform.claude.com/) [Catatan rilis\\
\\
Pelajari tentang perubahan dan fitur baru di Claude Developer Platform.](https://platform.claude.com/docs/id/release-notes/api)

## Claude Code

[Panduan cepat Claude Code\\
\\
Mulai dengan Claude Code.](https://code.claude.com/docs/id/quickstart) [Referensi Claude Code\\
\\
Konsultasikan dokumentasi referensi Claude Code untuk detail tentang implementasi fitur dan konfigurasi.](https://code.claude.com/docs/id/overview) [Changelog Claude Code\\
\\
Pelajari tentang perubahan dan fitur baru di Claude Code.](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md)

## Sumber daya pembelajaran

[Kursus Anthropic\\
\\
Jelajahi kursus dan proyek pendidikan Anthropic.](https://anthropic.skilljar.com/) [Claude Cookbook\\
\\
Lihat sampel kode dan implementasi yang dapat direplikasi.](https://github.com/anthropics/anthropic-cookbook) [Claude Quickstarts\\
\\
Aplikasi yang dapat digunakan yang dibangun dengan API kami.](https://github.com/anthropics/anthropic-quickstarts)
