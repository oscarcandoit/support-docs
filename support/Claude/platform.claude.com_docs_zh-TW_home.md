---
url: "https://platform.claude.com/docs/zh-TW/home"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-TW%2Fhome)
...
了解如何開始使用 Claude 開發者平台和 Claude Code。
...
[開始使用\\
\\
在幾分鐘內進行您的第一次 API 呼叫。](https://platform.claude.com/docs/zh-TW/get-started) [功能概覽\\
\\
探索 Claude 中現在可用的進階功能和能力。](https://platform.claude.com/docs/zh-TW/api/overview) [Claude 4.5 的新功能\\
\\
探索 Claude 4.5 模型中的最新進展。](https://platform.claude.com/docs/zh-TW/about-claude/models/whats-new-claude-4-5) [API 參考\\
\\
使用我們的 API 和 SDK 進行整合和擴展。](https://platform.claude.com/docs/zh-TW/api/overview) [Claude 控制台\\
\\
直接在您的瀏覽器中製作和測試強大的提示。](https://platform.claude.com/) [發行說明\\
\\
了解 Claude 開發者平台中的變更和新功能。](https://platform.claude.com/docs/zh-TW/release-notes/api)

## Claude Code

[Claude Code 快速入門\\
\\
開始使用 Claude Code。](https://code.claude.com/docs/zh-TW/quickstart) [Claude Code 參考\\
\\
查閱 Claude Code 參考文件，了解功能實現和配置的詳細資訊。](https://code.claude.com/docs/zh-TW/overview) [Claude Code 變更日誌\\
\\
了解 Claude Code 中的變更和新功能。](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md)

## 學習資源

[Anthropic 課程\\
\\
探索 Anthropic 的教育課程和專案。](https://anthropic.skilljar.com/) [Claude 食譜\\
\\
查看可複製的程式碼範例和實現。](https://github.com/anthropics/anthropic-cookbook) [Claude 快速入門\\
\\
使用我們的 API 建構的可部署應用程式。](https://github.com/anthropics/anthropic-quickstarts)
