...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fapi%2Fgo%2Fbeta)
...
client.Beta.Models.List(ctx, params)(\*Page\[[BetaModelInfo](https://platform.claude.com/docs/en/api/beta#beta_model_info)\], error)

get/v1/models

##### [Get a Model](https://platform.claude.com/docs/en/api/beta/models/retrieve)

client.Beta.Models.Get(ctx, modelID, query)(\*[BetaModelInfo](https://platform.claude.com/docs/en/api/beta#beta_model_info), error)

get/v1/models/{model\_id}

##### ModelsExpand Collapse

type BetaModelInfostruct{…}
...
client.Beta.Files.GetMetadata(ctx, fileID, query)(\*[FileMetadata](https://platform.claude.com/docs/en/api/beta#file_metadata), error)

get/v1/files/{file\_id}

##### [Delete File](https://platform.claude.com/docs/en/api/beta/files/delete)

client.Beta.Files.Delete(ctx, fileID, body)(\*[DeletedFile](https://platform.claude.com/docs/en/api/beta#deleted_file), error)

delete/v1/files/{file\_id}

##### ModelsExpand Collapse

type DeletedFilestruct{…}

IDstring

ID of the deleted file.

TypeDeletedFileTypeoptional
...
const DeletedFileTypeFileDeletedDeletedFileType = "file\_deleted"
...
client.Beta.Skills.New(ctx, params)(\*[BetaSkillNewResponse](https://platform.claude.com/docs/en/api/beta#BetaSkillNewResponse), error)

post/v1/skills

##### [List Skills](https://platform.claude.com/docs/en/api/beta/skills/list)

client.Beta.Skills.List(ctx, params)(\*PageCursor\[[BetaSkillListResponse](https://platform.claude.com/docs/en/api/beta#BetaSkillListResponse)\], error)

get/v1/skills

##### [Get Skill](https://platform.claude.com/docs/en/api/beta/skills/retrieve)

client.Beta.Skills.Get(ctx, skillID, query)(\*[BetaSkillGetResponse](https://platform.claude.com/docs/en/api/beta#BetaSkillGetResponse), error)

get/v1/skills/{skill\_id}

##### [Delete Skill](https://platform.claude.com/docs/en/api/beta/skills/delete)

client.Beta.Skills.Delete(ctx, skillID, body)(\*[BetaSkillDeleteResponse](https://platform.claude.com/docs/en/api/beta#BetaSkillDeleteResponse), error)
...
client.Beta.Skills.Versions.New(ctx, skillID, params)(\*[BetaSkillVersionNewResponse](https://platform.claude.com/docs/en/api/beta#BetaSkillVersionNewResponse), error)

post/v1/skills/{skill\_id}/versions

##### [List Skill Versions](https://platform.claude.com/docs/en/api/beta/skills/versions/list)

client.Beta.Skills.Versions.List(ctx, skillID, params)(\*PageCursor\[[BetaSkillVersionListResponse](https://platform.claude.com/docs/en/api/beta#BetaSkillVersionListResponse)\], error)

get/v1/skills/{skill\_id}/versions

##### [Get Skill Version](https://platform.claude.com/docs/en/api/beta/skills/versions/retrieve)

client.Beta.Skills.Versions.Get(ctx, version, params)(\*[BetaSkillVersionGetResponse](https://platform.claude.com/docs/en/api/beta#BetaSkillVersionGetResponse), error)
