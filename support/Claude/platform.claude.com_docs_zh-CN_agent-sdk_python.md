---
url: "https://platform.claude.com/docs/zh-CN/agent-sdk/python"
title: "Agent SDK 参考 - Python - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Fagent-sdk%2Fpython)
...
| `output_format` | [`OutputFormat`](https://platform.claude.com/docs/zh-CN/agent-sdk/python#outputformat)` | None` | `None` | 为代理结果定义输出格式。详见 [结构化输出](https://platform.claude.com/docs/zh-CN/agent-sdk/structured-outputs) |
...
| `plugins` | `list[SdkPluginConfig]` | `[]` | 从本地路径加载自定义插件。详见 [插件](https://platform.claude.com/docs/zh-CN/agent-sdk/plugins) |
| `sandbox` | [`SandboxSettings`](https://platform.claude.com/docs/zh-CN/agent-sdk/python#sandboxsettings)` | None` | `None` | 以编程方式配置沙箱行为。详见 [沙箱设置](https://platform.claude.com/docs/zh-CN/agent-sdk/python#sandboxsettings) |
...
有关创建和使用插件的完整信息，请参见 [插件](https://platform.claude.com/docs/zh-CN/agent-sdk/plugins)。
...
有关使用 hook 的综合指南、示例和常见模式，请参阅 [Hooks 指南](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks)。
...
- `input_data`: Hook 特定的输入数据（参见 [Hooks 指南](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks#input-data)）
...
| `allowUnsandboxedCommands` | `bool` | `False` | 允许模型请求在沙箱外运行命令。当为 `True` 时，模型可以在工具输入中设置 `dangerouslyDisableSandbox`，这会回退到 [权限系统](https://platform.claude.com/docs/zh-CN/agent-sdk/python#permissions-fallback-for-unsandboxed-commands) |
| `network` | [`SandboxNetworkConfig`](https://platform.claude.com/docs/zh-CN/agent-sdk/python#sandboxnetworkconfig) | `None` | 网络特定的沙箱配置 |
| `ignoreViolations` | [`SandboxIgnoreViolations`](https://platform.claude.com/docs/zh-CN/agent-sdk/python#sandboxignoreviolations) | `None` | 配置要忽略的沙箱违规 |
...
- [Python SDK 指南](https://platform.claude.com/docs/zh-CN/agent-sdk/python) \- 教程和示例
- [SDK 概述](https://platform.claude.com/docs/zh-CN/agent-sdk/overview) \- 常规 SDK 概念
- [TypeScript SDK 参考](https://platform.claude.com/docs/zh-CN/agent-sdk/typescript) \- TypeScript SDK 文档
- [CLI 参考](https://code.claude.com/docs/en/cli-reference) \- 命令行界面
- [常见工作流](https://code.claude.com/docs/en/common-workflows) \- 分步指南

- [在 query() 和 ClaudeSDKClient 之间选择](https://platform.claude.com/docs/zh-CN/agent-sdk/python#query-claude-sdk-client)
- [何时使用 query()（每次新建会话）](https://platform.claude.com/docs/zh-CN/agent-sdk/python#query)
- [何时使用 ClaudeSDKClient（持续对话）](https://platform.claude.com/docs/zh-CN/agent-sdk/python#claude-sdk-client)
- [query()](https://platform.claude.com/docs/zh-CN/agent-sdk/python#query-2)
- [tool()](https://platform.claude.com/docs/zh-CN/agent-sdk/python#tool)
- [create\_sdk\_mcp\_server()](https://platform.claude.com/docs/zh-CN/agent-sdk/python#create-sdk-mcp-server)
- [ClaudeSDKClient](https://platform.claude.com/docs/zh-CN/agent-sdk/python#claude-sdk-client-2)
- [SdkMcpTool](https://platform.claude.com/docs/zh-CN/agent-sdk/python#sdk-mcp-tool)
- [ClaudeAgentOptions](https://platform.claude.com/docs/zh-CN/agent-sdk/python#claude-agent-options)
- [OutputFormat](https://platform.claude.com/docs/zh-CN/agent-sdk/python#output-format)
- [SystemPromptPreset](https://platform.claude.com/docs/zh-CN/agent-sdk/python#system-prompt-preset)
- [SettingSource](https://platform.claude.com/docs/zh-CN/agent-sdk/python#setting-source)
- [AgentDefinition](https://platform.claude.com/docs/zh-CN/agent-sdk/python#agent-definition)
- [PermissionMode](https://platform.claude.com/docs/zh-CN/agent-sdk/python#permission-mode)
- [McpSdkServerConfig](https://platform.claude.com/docs/zh-CN/agent-sdk/python#mcp-sdk-server-config)
- [McpServerConfig](https://platform.claude.com/docs/zh-CN/agent-sdk/python#mcp-server-config)
- [SdkPluginConfig](https://platform.claude.com/docs/zh-CN/agent-sdk/python#sdk-plugin-config)
- [Message](https://platform.claude.com/docs/zh-CN/agent-sdk/python#message)
- [UserMessage](https://platform.claude.com/docs/zh-CN/agent-sdk/python#user-message)
- [AssistantMessage](https://platform.claude.com/docs/zh-CN/agent-sdk/python#assistant-message)
- [SystemMessage](https://platform.claude.com/docs/zh-CN/agent-sdk/python#system-message)
- [ResultMessage](https://platform.claude.com/docs/zh-CN/agent-sdk/python#result-message)
- [ContentBlock](https://platform.claude.com/docs/zh-CN/agent-sdk/python#content-block)
- [TextBlock](https://platform.claude.com/docs/zh-CN/agent-sdk/python#text-block)
- [ThinkingBlock](https://platform.claude.com/docs/zh-CN/agent-sdk/python#thinking-block)
- [ToolUseBlock](https://platform.claude.com/docs/zh-CN/agent-sdk/python#tool-use-block)
- [ToolResultBlock](https://platform.claude.com/docs/zh-CN/agent-sdk/python#tool-result-block)
- [ClaudeSDKError](https://platform.claude.com/docs/zh-CN/agent-sdk/python#claude-sdk-error)
- [CLINotFoundError](https://platform.claude.com/docs/zh-CN/agent-sdk/python#cli-not-found-error)
- [CLIConnectionError](https://platform.claude.com/docs/zh-CN/agent-sdk/python#cli-connection-error)
- [ProcessError](https://platform.claude.com/docs/zh-CN/agent-sdk/python#process-error)
- [CLIJSONDecodeError](https://platform.claude.com/docs/zh-CN/agent-sdk/python#clijson-decode-error)
- [Hook 类型](https://platform.claude.com/docs/zh-CN/agent-sdk/python#hook)
- [HookEvent](https://platform.claude.com/docs/zh-CN/agent-sdk/python#hook-event)
- [HookCallback](https://platform.claude.com/docs/zh-CN/agent-sdk/python#hook-callback)
- [HookContext](https://platform.claude.com/docs/zh-CN/agent-sdk/python#hook-context)
- [HookMatcher](https://platform.claude.com/docs/zh-CN/agent-sdk/python#hook-matcher)
- [Hook 使用示例](https://platform.claude.com/docs/zh-CN/agent-sdk/python#hook-2)
- [Task](https://platform.claude.com/docs/zh-CN/agent-sdk/python#task)
- [Bash](https://platform.claude.com/docs/zh-CN/agent-sdk/python#bash)
- [Edit](https://platform.claude.com/docs/zh-CN/agent-sdk/python#edit)
- [Read](https://platform.claude.com/docs/zh-CN/agent-sdk/python#read)
- [Write](https://platform.claude.com/docs/zh-CN/agent-sdk/python#write)
- [Glob](https://platform.claude.com/docs/zh-CN/agent-sdk/python#glob)
- [Grep](https://platform.claude.com/docs/zh-CN/agent-sdk/python#grep)
- [NotebookEdit](https://platform.claude.com/docs/zh-CN/agent-sdk/python#notebook-edit)
- [WebFetch](https://platform.claude.com/docs/zh-CN/agent-sdk/python#web-fetch)
- [WebSearch](https://platform.claude.com/docs/zh-CN/agent-sdk/python#web-search)
- [TodoWrite](https://platform.claude.com/docs/zh-CN/agent-sdk/python#todo-write)
- [BashOutput](https://platform.claude.com/docs/zh-CN/agent-sdk/python#bash-output)
- [KillBash](https://platform.claude.com/docs/zh-CN/agent-sdk/python#kill-bash)
- [ExitPlanMode](https://platform.claude.com/docs/zh-CN/agent-sdk/python#exit-plan-mode)
- [ListMcpResources](https://platform.claude.com/docs/zh-CN/agent-sdk/python#list-mcp-resources)
- [ReadMcpResource](https://platform.claude.com/docs/zh-CN/agent-sdk/python#read-mcp-resource)
- [使用 ClaudeSDKClient 的高级功能](https://platform.claude.com/docs/zh-CN/agent-sdk/python#claude-sdk-client-3)
- [使用 Hook 进行行为修改](https://platform.claude.com/docs/zh-CN/agent-sdk/python#hook-3)
- [基本文件操作（使用 query）](https://platform.claude.com/docs/zh-CN/agent-sdk/python#query-3)
- [使用 ClaudeSDKClient 的自定义工具](https://platform.claude.com/docs/zh-CN/agent-sdk/python#claude-sdk-client-4)
- [SandboxSettings](https://platform.claude.com/docs/zh-CN/agent-sdk/python#sandbox-settings)
- [SandboxNetworkConfig](https://platform.claude.com/docs/zh-CN/agent-sdk/python#sandbox-network-config)
- [SandboxIgnoreViolations](https://platform.claude.com/docs/zh-CN/agent-sdk/python#sandbox-ignore-violations)
