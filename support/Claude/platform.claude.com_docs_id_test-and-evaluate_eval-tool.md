...
title: "Menggunakan Alat Evaluasi - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Ftest-and-evaluate%2Feval-tool)
...
[Claude Console](https://platform.claude.com/dashboard) menampilkan **alat Evaluasi** yang memungkinkan Anda menguji prompt Anda dalam berbagai skenario.
...
![Mengakses Fitur Evaluate](https://platform.claude.com/docs/images/access_evaluate.png)
...
Console menawarkan [generator prompt](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/prompt-generator) bawaan yang didukung oleh Claude Opus 4.1:
...
![Generator Prompt](https://platform.claude.com/docs/images/promptgenerator.png)
...
![Layar Evaluasi Terisi](https://platform.claude.com/docs/images/eval_populated.png)
...
### Struktur Prompt untuk Evaluasi
...
- [Mengakses Fitur Evaluate](https://platform.claude.com/docs/id/test-and-evaluate/eval-tool#mengakses-fitur-evaluate)
- [Menghasilkan Prompt](https://platform.claude.com/docs/id/test-and-evaluate/eval-tool#menghasilkan-prompt)
- [Membuat Kasus Uji](https://platform.claude.com/docs/id/test-and-evaluate/eval-tool#membuat-kasus-uji)
- [Tips untuk Evaluasi yang Efektif](https://platform.claude.com/docs/id/test-and-evaluate/eval-tool#tips-untuk-evaluasi-yang-efektif)
- [Memahami dan membandingkan hasil](https://platform.claude.com/docs/id/test-and-evaluate/eval-tool#memahami-dan-membandingkan-hasil)
