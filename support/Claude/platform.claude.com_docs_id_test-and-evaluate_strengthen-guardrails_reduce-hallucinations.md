...
title: "Mengurangi halusinasi - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Freduce-hallucinations)
...
### Contoh: Menganalisis laporan merger & akuisisi
...
### Contoh: Mengaudit kebijakan privasi data
...
### Contoh: Menyusun siaran pers tentang peluncuran produk
...
- [Strategi dasar minimalisasi halusinasi](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/reduce-hallucinations#strategi-dasar-minimalisasi-halusinasi)
- [Teknik lanjutan](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/reduce-hallucinations#teknik-lanjutan)
