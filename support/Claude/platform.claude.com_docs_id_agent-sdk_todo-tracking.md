...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fagent-sdk%2Ftodo-tracking)
...
- [Referensi TypeScript SDK](https://platform.claude.com/docs/id/agent-sdk/typescript)
- [Referensi Python SDK](https://platform.claude.com/docs/id/agent-sdk/python)
- [Streaming vs Single Mode](https://platform.claude.com/docs/id/agent-sdk/streaming-vs-single-mode)
- [Custom Tools](https://platform.claude.com/docs/id/agent-sdk/custom-tools)

- [Siklus Hidup Todo](https://platform.claude.com/docs/id/agent-sdk/todo-tracking#siklus-hidup-todo)
- [Kapan Todo Digunakan](https://platform.claude.com/docs/id/agent-sdk/todo-tracking#kapan-todo-digunakan)
- [Contoh](https://platform.claude.com/docs/id/agent-sdk/todo-tracking#contoh)
- [Memantau Perubahan Todo](https://platform.claude.com/docs/id/agent-sdk/todo-tracking#memantau-perubahan-todo)
- [Tampilan Kemajuan Real-time](https://platform.claude.com/docs/id/agent-sdk/todo-tracking#tampilan-kemajuan-real-time)
- [Dokumentasi Terkait](https://platform.claude.com/docs/id/agent-sdk/todo-tracking#dokumentasi-terkait)
