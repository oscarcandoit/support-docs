---
url: "https://platform.claude.com/docs/zh-TW/intro"
title: "Claude 簡介 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-TW%2Fintro)
...
Claude 是由 Anthropic 開發的高性能、可信賴且智能的 AI 平台。Claude 在涉及語言、推理、分析、編碼等任務方面表現出色。
...
想要與 Claude 聊天？請訪問 [claude.ai](http://www.claude.ai/)！

## 開始使用

如果您是 Claude 的新手，請從這裡開始學習基礎知識並進行您的第一次 API 調用。

[開始使用\\
\\
為使用 Claude 進行開發設置您的開發環境。](https://platform.claude.com/docs/zh-TW/get-started) [了解 Claude\\
\\
了解 Claude 模型系列。](https://platform.claude.com/docs/zh-TW/about-claude/models/overview) [提示詞庫\\
\\
探索示例提示詞以獲得靈感。](https://platform.claude.com/docs/zh-TW/resources/prompt-library/library)

* * *

## 使用 Claude 進行開發

Anthropic 擁有同類最佳的開發者工具，可用於使用 Claude 構建可擴展應用程序。

[開發者控制台\\
\\
在您的瀏覽器中使用 Workbench 和提示詞生成器工具享受更輕鬆、更強大的提示詞編寫體驗。](https://platform.claude.com/) [API 參考\\
\\
使用 Claude API 和 SDK 進行探索、實現和擴展。](https://platform.claude.com/docs/zh-TW/api/overview) [Claude 食譜\\
\\
通過演示上傳 PDF、嵌入等功能的互動式 Jupyter 筆記本進行學習。](https://github.com/anthropics/anthropic-cookbook)

* * *

## 主要功能

Claude 可以協助處理涉及文本、代碼和圖像的許多任務。

[文本和代碼生成\\
\\
總結文本、回答問題、提取數據、翻譯文本以及解釋和生成代碼。](https://platform.claude.com/docs/zh-TW/build-with-claude/text-generation) [視覺\\
\\
處理和分析視覺輸入，並從圖像生成文本和代碼。](https://platform.claude.com/docs/zh-TW/build-with-claude/vision)
...
[幫助中心\\
\\
查找常見帳戶和計費問題的答案。](https://support.claude.com/en/) [服務狀態\\
\\
檢查 Anthropic 服務的狀態。](https://status.claude.com/)

- [使用 Claude 進行開發](https://platform.claude.com/docs/zh-TW/intro#claude)
