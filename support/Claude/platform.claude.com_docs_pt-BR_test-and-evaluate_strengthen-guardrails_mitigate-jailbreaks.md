---
url: "https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks"
title: "Mitigar jailbreaks e injeções de prompt - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fmitigate-jailbreaks)
...
- [Avançado: Proteções em cadeia](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#avancado-protecoes-em-cadeia)
- [Prompt de sistema do bot](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#prompt-de-sistema-do-bot)
- [Prompt dentro da ferramenta harmlessness\_screen](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#prompt-dentro-da-ferramenta-harmlessness-screen)
