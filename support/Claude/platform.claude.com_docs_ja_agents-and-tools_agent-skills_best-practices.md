---
url: "https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/best-practices"
title: "スキル作成のベストプラクティス - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
完全なスキル構造の詳細については、 [スキル概要](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/overview#skill-structure) を参照してください。
...
このファイルシステムベースのアーキテクチャが段階的開示を有効にする方法の詳細については、以下の高度なセクションの [ランタイム環境](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/best-practices#runtime-environment) セクションを参照してください。
...
以下のセクションは、実行可能なスクリプトを含むスキルに焦点を当てています。スキルがマークダウン指示のみを使用する場合は、 [効果的なスキルのチェックリスト](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/best-practices#checklist-for-effective-skills) にスキップしてください。
...
ほとんどのユーティリティスクリプトでは、実行がより信頼性が高く効率的であるため、実行が推奨されます。スクリプト実行がどのように機能するかの詳細については、以下の [ランタイム環境](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/best-practices#runtime-environment) セクションを参照してください。
...
[エージェントスキルを始める\\
\\
最初のスキルを作成する](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/quickstart) [Claude Codeでスキルを使用する\\
\\
Claude Codeでスキルを作成および管理する](https://code.claude.com/docs/skills) [エージェントSDKでスキルを使用する\\
\\
TypeScriptとPythonでプログラム的にスキルを使用する](https://platform.claude.com/docs/ja/agent-sdk/skills) [APIでスキルを使用する\\
\\
プログラム的にスキルをアップロードして使用する](https://platform.claude.com/docs/ja/build-with-claude/skills-guide)

- [Claudeを使用してスキルを反復的に開発する](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/best-practices#claude)
- [Claudeがスキルをナビゲートする方法を観察する](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/best-practices#claude-2)
- [Windowsスタイルのパスを避ける](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/best-practices#windows)
- [MCPツール参照](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/best-practices#mcp)
- [YAMLフロントマター要件](https://platform.claude.com/docs/ja/agents-and-tools/agent-skills/best-practices#yaml)
