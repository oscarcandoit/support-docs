---
url: "https://platform.claude.com/docs/zh-CN/build-with-claude/prompt-engineering/long-context-tips"
title: "长上下文提示技巧 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Fbuild-with-claude%2Fprompt-engineering%2Flong-context-tips)
...
根据测试，将查询放在末尾可以将响应质量提高多达30%，特别是对于复杂的多文档输入。
...
[提示库\\
\\
获得精选的提示灵感，涵盖各种任务和用例。](https://platform.claude.com/docs/zh-CN/resources/prompt-library/library) [GitHub提示教程\\
\\
一个充满示例的教程，涵盖我们文档中的提示工程概念。](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Google Sheets提示教程\\
\\
