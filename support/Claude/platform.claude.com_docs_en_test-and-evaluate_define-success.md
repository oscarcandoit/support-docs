...
title: "Define your success criteria - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Ftest-and-evaluate%2Fdefine-success)
...
\\
Learn to build strong test sets to gauge Claude's performance against your criteria.](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/be-clear-and-direct)

- [Building strong criteria](https://platform.claude.com/docs/en/test-and-evaluate/define-success#building-strong-criteria)
- [Common success criteria to consider](https://platform.claude.com/docs/en/test-and-evaluate/define-success#common-success-criteria-to-consider)
- [Next steps](https://platform.claude.com/docs/en/test-and-evaluate/define-success#next-steps)
