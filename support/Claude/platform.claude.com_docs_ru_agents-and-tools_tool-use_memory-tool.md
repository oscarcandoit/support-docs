---
url: "https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool"
title: "Инструмент памяти - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fagents-and-tools%2Ftool-use%2Fmemory-tool)
...
- [Варианты использования](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#varianty-ispolzovaniya)
- [Как это работает](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#kak-eto-rabotaet)
- [Пример: Как работают вызовы инструмента памяти](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#primer-kak-rabotayut-vyzovy-instrumenta-pamyati)
- [Поддерживаемые модели](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#podderzhivaemye-modeli)
- [Начало работы](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#nachalo-raboty)
- [Базовое использование](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#bazovoe-ispolzovanie)
- [Команды инструмента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#komandy-instrumenta)
- [view](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#view)
- [create](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#create)
- [str\_replace](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#str-replace)
- [insert](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#insert)
- [delete](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#delete)
- [rename](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#rename)
- [Рекомендации по подсказкам](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#rekomendatsii-po-podskazkam)
- [Соображения безопасности](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#soobrazheniya-bezopasnosti)
- [Конфиденциальная информация](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#konfidentsialnaya-informatsiya)
- [Размер хранилища файлов памяти](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#razmer-khranilischa-faylov-pamyati)
- [Истечение памяти](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#istechenie-pamyati)
- [Защита от обхода пути](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#zaschita-ot-obkhoda-puti)
- [Обработка ошибок](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#obrabotka-oshibok)
- [Использование с редактированием контекста](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#ispolzovanie-s-redaktirovaniem-konteksta)
- [Как они работают вместе](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#kak-oni-rabotayut-vmeste)
- [Пример рабочего процесса](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#primer-rabochego-protsessa)
- [Конфигурация](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/memory-tool#konfiguratsiya)
