---
url: "https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/use-xml-tags"
title: "Utilisez des balises XML pour structurer vos invites - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fbuild-with-claude%2Fprompt-engineering%2Fuse-xml-tags)
...
**Conseil XML** : Utilisez des balises comme `<instructions>`, `<example>` et `<formatting>` pour séparer clairement les différentes parties de votre invite. Cela empêche Claude de confondre les instructions avec les exemples ou le contexte.
...
Il n'existe pas de balises XML « canoniques » sur lesquelles Claude a été entraîné en particulier, bien que nous recommandions que vos noms de balises aient du sens par rapport aux informations qu'elles entourent.
...
**Conseil pour utilisateurs avancés** : Combinez les balises XML avec d'autres techniques comme l'invite multi-coups (`<examples>`) ou la chaîne de pensée (`<thinking>`, `<answer>`). Cela crée des invites super structurées et hautement performantes.

### Exemples

### Exemple : Générer des rapports financiers
...
\\
Inspirez-vous d'une sélection organisée d'invites pour diverses tâches et cas d'usage.](https://platform.claude.com/docs/fr/resources/prompt-library/library) [Tutoriel de prompting GitHub\\
\\
Un tutoriel riche en exemples qui couvre les concepts d'ingénierie d'invites trouvés dans notre documentation.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutoriel de prompting Google Sheets\\
\\
...
- [Pourquoi utiliser des balises XML ?](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/use-xml-tags#pourquoi-utiliser-des-balises-xml)
- [Meilleures pratiques de balisage](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/use-xml-tags#meilleures-pratiques-de-balisage)
- [Exemples](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/use-xml-tags#exemples)
