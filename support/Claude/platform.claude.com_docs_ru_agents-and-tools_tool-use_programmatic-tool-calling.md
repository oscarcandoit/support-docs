---
url: "https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling"
title: "Программный вызов инструментов - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fagents-and-tools%2Ftool-use%2Fprogrammatic-tool-calling)
...
| --- | --- | --- |
| `invalid_tool_input` | Входные данные инструмента не соответствуют схеме | Проверьте input\_schema вашего инструмента |
...
- Веб-поиск
- Веб-выборка
- Инструменты, предоставленные [коннектором MCP](https://platform.claude.com/docs/ru/agents-and-tools/mcp-connector)
...
Программный вызов инструментов использует те же цены, что и выполнение кода. Подробнее см. в разделе [цены выполнения кода](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/code-execution-tool#usage-and-pricing).
...
\\
Узнайте об основной возможности выполнения кода, которая питает программный вызов инструментов.](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/code-execution-tool) [Обзор использования инструментов\\
\\
Поймите основы использования инструментов с Claude.](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/overview) [Реализация использования инструментов\\
\\
Пошаговое руководство по реализации инструментов.](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/implement-tool-use)

- [Совместимость моделей](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#sovmestimost-modeley)
- [Быстрый старт](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#bystriy-start)
- [Как работает программный вызов инструментов](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#kak-rabotaet-programmniy-vyzov-instrumentov)
- [Основные концепции](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#osnovnye-kontseptsii)
- [Поле allowed\_callers](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#pole-allowed-callers)
- [Поле caller в ответах](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#pole-caller-v-otvetakh)
- [Жизненный цикл контейнера](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#zhiznenniy-tsikl-konteynera)
- [Пример рабочего процесса](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#primer-rabochego-protsessa)
- [Шаг 1: Начальный запрос](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#shag-1-nachalniy-zapros)
- [Шаг 2: Ответ API с вызовом инструмента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#shag-2-otvet-api-s-vyzovom-instrumenta)
- [Шаг 3: Предоставление результата инструмента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#shag-3-predostavlenie-rezultata-instrumenta)
- [Шаг 4: Следующий вызов инструмента или завершение](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#shag-4-sleduyuschiy-vyzov-instrumenta-ili-zavershenie)
- [Шаг 5: Окончательный ответ](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#shag-5-okonchatelniy-otvet)
- [Продвинутые паттерны](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#prodvinutye-patterny)
- [Пакетная обработка с циклами](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#paketnaya-obrabotka-s-tsiklami)
- [Раннее завершение](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#rannee-zavershenie)
- [Условный выбор инструмента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#uslovniy-vybor-instrumenta)
- [Фильтрация данных](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#filtratsiya-dannykh)
- [Формат ответа](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#format-otveta)
- [Программный вызов инструмента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#programmniy-vyzov-instrumenta)
- [Обработка результата инструмента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#obrabotka-rezultata-instrumenta)
- [Завершение выполнения кода](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#zavershenie-vypolneniya-koda)
- [Обработка ошибок](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#obrabotka-oshibok)
- [Распространенные ошибки](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#rasprostranennye-oshibki)
- [Истечение контейнера во время вызова инструмента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#istechenie-konteynera-vo-vremya-vyzova-instrumenta)
- [Ошибки выполнения инструмента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#oshibki-vypolneniya-instrumenta)
- [Ограничения и ограничивающие факторы](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#ogranicheniya-i-ogranichivayuschie-faktory)
- [Несовместимость функций](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#nesovmestimost-funktsiy)
- [Ограничения инструментов](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#ogranicheniya-instrumentov)
- [Ограничения форматирования сообщений](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#ogranicheniya-formatirovaniya-soobscheniy)
- [Ограничения скорости](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#ogranicheniya-skorosti)
- [Проверьте результаты инструментов перед использованием](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#proverte-rezultaty-instrumentov-pered-ispolzovaniem)
- [Эффективность токенов](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#effektivnost-tokenov)
- [Использование и цены](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#ispolzovanie-i-tseny)
- [Лучшие практики](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#luchshie-praktiki)
- [Дизайн инструмента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#dizayn-instrumenta)
- [Когда использовать программный вызов](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#kogda-ispolzovat-programmniy-vyzov)
- [Оптимизация производительности](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#optimizatsiya-proizvoditelnosti)
- [Устранение неполадок](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#ustranenie-nepoladok)
- [Распространенные проблемы](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#rasprostranennye-problemy)
- [Советы по отладке](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#sovety-po-otladke)
- [Почему работает программный вызов инструментов](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#pochemu-rabotaet-programmniy-vyzov-instrumentov)
- [Альтернативные реализации](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#alternativnye-realizatsii)
- [Прямое выполнение на стороне клиента](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#pryamoe-vypolnenie-na-storone-klienta)
- [Самоуправляемое изолированное выполнение](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#samoupravlyaemoe-izolirovannoe-vypolnenie)
- [Управляемое выполнение Anthropic](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#upravlyaemoe-vypolnenie-anthropic)
- [Связанные функции](https://platform.claude.com/docs/ru/agents-and-tools/tool-use/programmatic-tool-calling#svyazannye-funktsii)
