---
url: "https://platform.claude.com/docs/ru/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks"
title: "Предотвращение взлома и инъекций промптов - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fmitigate-jailbreaks)
...
- [Продвинутый уровень: Цепочки защиты](https://platform.claude.com/docs/ru/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#prodvinutiy-uroven-tsepochki-zaschity)
- [Системный промпт бота](https://platform.claude.com/docs/ru/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#sistemniy-prompt-bota)
- [Промпт внутри инструмента harmlessness\_screen](https://platform.claude.com/docs/ru/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#prompt-vnutri-instrumenta-harmlessness-screen)
