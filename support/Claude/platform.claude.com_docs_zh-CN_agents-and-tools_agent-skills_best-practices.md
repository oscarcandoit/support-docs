...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
[开始使用代理技能\\
\\
创建您的第一个技能](https://platform.claude.com/docs/zh-CN/agents-and-tools/agent-skills/quickstart) [在 Claude Code 中使用技能\\
\\
在 Claude Code 中创建和管理技能](https://code.claude.com/docs/skills) [在代理 SDK 中使用技能\\
\\
在 TypeScript 和 Python 中以编程方式使用技能](https://platform.claude.com/docs/zh-CN/agent-sdk/skills) [使用 API 使用技能\\
\\
以编程方式上传和使用技能](https://platform.claude.com/docs/zh-CN/build-with-claude/skills-guide)

- [与 Claude 一起迭代开发技能](https://platform.claude.com/docs/zh-CN/agents-and-tools/agent-skills/best-practices#claude)
- [观察 Claude 如何导航技能](https://platform.claude.com/docs/zh-CN/agents-and-tools/agent-skills/best-practices#claude-2)
- [避免 Windows 风格的路径](https://platform.claude.com/docs/zh-CN/agents-and-tools/agent-skills/best-practices#windows)
- [MCP 工具参考](https://platform.claude.com/docs/zh-CN/agents-and-tools/agent-skills/best-practices#mcp)
- [YAML 前置事项要求](https://platform.claude.com/docs/zh-CN/agents-and-tools/agent-skills/best-practices#yaml)
