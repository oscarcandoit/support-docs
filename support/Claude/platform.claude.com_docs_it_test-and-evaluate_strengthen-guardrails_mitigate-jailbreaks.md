---
url: "https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks"
title: "Mitigare i jailbreak e le iniezioni di prompt - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fmitigate-jailbreaks)
...
- [Avanzato: Protezioni a catena](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#avanzato-protezioni-a-catena)
- [Prompt di sistema del bot](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#prompt-di-sistema-del-bot)
- [Prompt all'interno dello strumento harmlessness\_screen](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#prompt-all-interno-dello-strumento-harmlessness-screen)
