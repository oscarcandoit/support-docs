---
url: "https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices"
title: "Bonnes pratiques de création de Skills - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
Pour des informations conceptuelles sur le fonctionnement des Skills, consultez la [présentation des Skills](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/overview).

## Principes fondamentaux

### La concision est essentielle

La [fenêtre de contexte](https://platform.claude.com/docs/fr/build-with-claude/context-windows) est un bien public. Votre Skill partage la fenêtre de contexte avec tout ce que Claude doit savoir, notamment :
...
Pour les détails complets de la structure du Skill, consultez la [présentation des Skills](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/overview#skill-structure).
...
SKILL.md sert de présentation qui pointe Claude vers des matériaux détaillés selon les besoins, comme une table des matières dans un guide d'intégration. Pour une explication du fonctionnement de la divulgation progressive, consultez [Comment fonctionnent les Skills](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/overview#how-skills-work) dans la présentation.
...
![Fichier SKILL.md simple montrant le frontmatter YAML et le corps markdown](https://platform.claude.com/docs/images/agent-skills-simple-file.png)
...
![Regroupement de fichiers de référence supplémentaires comme reference.md et forms.md.](https://platform.claude.com/docs/images/agent-skills-bundling-content.png)
...
Pour plus de détails sur la façon dont cette architecture basée sur le système de fichiers permet la divulgation progressive, consultez la section [Environnement d'exécution](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#runtime-environment) dans la section Avancé ci-dessous.
...
Cela montre le modèle de boucle de validation utilisant des documents de référence au lieu de scripts. Le « validateur » est STYLE\_GUIDE.md, et Claude effectue la vérification en lisant et en comparant.
...
Les sections ci-dessous se concentrent sur les Skills qui incluent des scripts exécutables. Si votre Skill utilise uniquement des instructions markdown, passez à [Liste de contrôle pour les Skills efficaces](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#checklist-for-effective-skills).
...
![Regroupement de scripts exécutables aux côtés des fichiers d'instructions](https://platform.claude.com/docs/images/agent-skills-executable-scripts.png)
...
Pour la plupart des scripts utilitaires, l'exécution est préférable car elle est plus fiable et efficace. Consultez la section [Environnement d'exécution](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#runtime-environment) ci-dessous pour plus de détails sur le fonctionnement de l'exécution de scripts.
...
**Conseil d'implémentation** : Rendez les scripts de validation verbeux avec des messages d'erreur spécifiques comme « Le champ 'signature\_date' n'a pas été trouvé. Champs disponibles : customer\_name, order\_total, signature\_date\_signed » pour aider Claude à corriger les problèmes.
...
Listez les packages requis dans votre SKILL.md et vérifiez qu'ils sont disponibles dans la [documentation de l'outil d'exécution du code](https://platform.claude.com/docs/fr/agents-and-tools/tool-use/code-execution-tool).

### Environnement d'exécution

Les Skills s'exécutent dans un environnement d'exécution du code avec accès au système de fichiers, commandes bash et capacités d'exécution du code. Pour l'explication conceptuelle de cette architecture, consultez [L'architecture des Skills](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/overview#the-skills-architecture) dans la présentation.
...
Pour les détails techniques complets sur l'architecture, consultez [Comment fonctionnent les Skills](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/overview#how-skills-work) dans la présentation des Skills.
...
Consultez la [présentation des Skills](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/overview#skill-structure) pour les détails complets de la structure.

### Budgets de tokens

Gardez le corps de SKILL.md sous 500 lignes pour des performances optimales. Si votre contenu dépasse cela, divisez-le en fichiers séparés en utilisant les modèles de divulgation progressive décrits précédemment. Pour les détails architecturaux, consultez la [présentation des Skills](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/overview#how-skills-work).
...
\\
Créez votre premier Skill](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/quickstart) [Utiliser les Skills dans Claude Code\\
\\
Créer et gérer les Skills dans Claude Code](https://code.claude.com/docs/skills) [Utiliser les Skills dans l'Agent SDK\\
\\
Utiliser les Skills de manière programmatique en TypeScript et Python](https://platform.claude.com/docs/fr/agent-sdk/skills) [Utiliser les Skills avec l'API\\
\\
Télécharger et utiliser les Skills de manière programmatique](https://platform.claude.com/docs/fr/build-with-claude/skills-guide)

- [Principes fondamentaux](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#principes-fondamentaux)
- [La concision est essentielle](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#la-concision-est-essentielle)
- [Définir des degrés de liberté appropriés](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#definir-des-degres-de-liberte-appropries)
- [Tester avec tous les modèles que vous prévoyez d'utiliser](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#tester-avec-tous-les-modeles-que-vous-prevoyez-d-utiliser)
- [Structure du Skill](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#structure-du-skill)
- [Conventions de nommage](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#conventions-de-nommage)
- [Rédiger des descriptions efficaces](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#rediger-des-descriptions-efficaces)
- [Modèles de divulgation progressive](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#modeles-de-divulgation-progressive)
- [Éviter les références profondément imbriquées](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#eviter-les-references-profondement-imbriquees)
- [Structurer les fichiers de référence plus longs avec une table des matières](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#structurer-les-fichiers-de-reference-plus-longs-avec-une-table-des-matieres)
- [Flux de travail et boucles de rétroaction](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#flux-de-travail-et-boucles-de-retroaction)
- [Utiliser les flux de travail pour les tâches complexes](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#utiliser-les-flux-de-travail-pour-les-taches-complexes)
- [Implémenter des boucles de rétroaction](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#implementer-des-boucles-de-retroaction)
- [Directives de contenu](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#directives-de-contenu)
- [Éviter les informations sensibles au temps](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#eviter-les-informations-sensibles-au-temps)
- [Utiliser une terminologie cohérente](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#utiliser-une-terminologie-coherente)
- [Modèles courants](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#modeles-courants)
- [Modèle de modèle](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#modele-de-modele)
- [Modèle d'exemples](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#modele-d-exemples)
- [Modèle de flux de travail conditionnel](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#modele-de-flux-de-travail-conditionnel)
- [Évaluation et itération](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#evaluation-et-iteration)
- [Construire les évaluations en premier](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#construire-les-evaluations-en-premier)
- [Développer les Skills de manière itérative avec Claude](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#developper-les-skills-de-maniere-iterative-avec-claude)
- [Observez comment Claude navigue dans les Skills](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#observez-comment-claude-navigue-dans-les-skills)
- [Anti-modèles à éviter](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#anti-modeles-a-eviter)
- [Éviter les chemins de style Windows](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#eviter-les-chemins-de-style-windows)
- [Éviter d'offrir trop d'options](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#eviter-d-offrir-trop-d-options)
- [Avancé : Skills avec code exécutable](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#avance-skills-avec-code-executable)
- [Résoudre, ne pas esquiver](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#resoudre-ne-pas-esquiver)
- [Fournir des scripts utilitaires](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#fournir-des-scripts-utilitaires)
- [Utiliser l'analyse visuelle](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#utiliser-l-analyse-visuelle)
- [Créer des sorties intermédiaires vérifiables](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#creer-des-sorties-intermediaires-verifiables)
- [Dépendances de package](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#dependances-de-package)
- [Environnement d'exécution](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#environnement-d-execution)
- [Références d'outils MCP](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#references-d-outils-mcp)
- [Éviter de supposer que les outils sont installés](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#eviter-de-supposer-que-les-outils-sont-installes)
- [Notes techniques](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#notes-techniques)
- [Exigences du frontmatter YAML](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#exigences-du-frontmatter-yaml)
- [Budgets de tokens](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#budgets-de-tokens)
- [Liste de contrôle pour les Skills efficaces](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#liste-de-controle-pour-les-skills-efficaces)
- [Qualité de base](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#qualite-de-base)
- [Code et scripts](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#code-et-scripts)
- [Test](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#test)
- [Prochaines étapes](https://platform.claude.com/docs/fr/agents-and-tools/agent-skills/best-practices#prochaines-etapes)
