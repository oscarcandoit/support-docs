---
url: "https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/multishot-prompting"
title: "使用範例（多次提示）來引導 Claude 的行為 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-TW%2Fbuild-with-claude%2Fprompt-engineering%2Fmultishot-prompting)
...
**增強您的提示**：包含 3-5 個多樣化、相關的範例來向 Claude 展示您確切想要的內容。更多範例 = 更好的性能，特別是對於複雜任務。
...
要求 Claude 評估您的範例的相關性、多樣性或清晰性。或者讓 Claude 根據您的初始集合生成更多範例。
...
[提示庫\\
\\
從為各種任務和使用案例精心挑選的提示集合中獲得靈感。](https://platform.claude.com/docs/zh-TW/resources/prompt-library/library) [GitHub 提示教程\\
\\
一個充滿範例的教程，涵蓋我們文檔中的提示工程概念。](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Google Sheets 提示教程\\
\\
通過互動式電子表格提供的我們提示工程教程的輕量級版本。](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)
