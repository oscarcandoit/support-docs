...
title: "Server MCP jarak jauh - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fagents-and-tools%2Fremote-mcp-servers)
...
Server MCP jarak jauh yang dapat dihubungkan oleh pengembang melalui API konektor MCP Anthropic.
...
Server MCP jarak jauh yang tercantum di bawah ini adalah layanan pihak ketiga yang dirancang untuk bekerja dengan API Claude. Server-server ini
tidak dimiliki, dioperasikan, atau didukung oleh Anthropic. Pengguna hanya boleh terhubung ke server MCP jarak jauh yang mereka percayai dan
harus meninjau praktik keamanan dan ketentuan setiap server sebelum terhubung.
...
3. Ikuti instruksi koneksi khusus server yang disediakan oleh setiap perusahaan.

Untuk informasi lebih lanjut tentang menggunakan server MCP jarak jauh dengan API Claude, lihat [dokumentasi konektor MCP](https://platform.claude.com/docs/id/agents-and-tools/mcp-connector).
...
[Aiera](https://rest.aiera.com/docs/mcp)
...
[London Stock Exchange Group](https://www.lseg.com/en/solutions/ai-finance-solutions/anthropic)
...
- [Menghubungkan ke server MCP jarak jauh](https://platform.claude.com/docs/id/agents-and-tools/remote-mcp-servers#menghubungkan-ke-server-mcp-jarak-jauh)
- [Contoh server MCP jarak jauh](https://platform.claude.com/docs/id/agents-and-tools/remote-mcp-servers#contoh-server-mcp-jarak-jauh)
