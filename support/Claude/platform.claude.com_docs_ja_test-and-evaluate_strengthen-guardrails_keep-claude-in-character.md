---
url: "https://platform.claude.com/docs/ja/test-and-evaluate/strengthen-guardrails/keep-claude-in-character"
title: "ロールプロンプトとプリフィルでClaudeのキャラクターを維持する - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fkeep-claude-in-character)
...
- **システムプロンプトでロールを設定する:** [システムプロンプト](https://platform.claude.com/docs/ja/build-with-claude/prompt-engineering/system-prompts) を使用してClaudeの役割と性格を定義します。これにより、一貫した応答の強固な基盤が構築されます。
