---
url: "https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices"
title: "Mejores prácticas de prompting - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fbuild-with-claude%2Fprompt-engineering%2Fclaude-4-best-practices)
...
Para una descripción general de las nuevas capacidades de Claude 4.5, consulta [Novedades en Claude 4.5](https://platform.claude.com/docs/es/about-claude/models/whats-new-claude-4-5). Para orientación sobre migración desde modelos anteriores, consulta [Migración a Claude 4.5](https://platform.claude.com/docs/es/about-claude/models/migrating-to-claude-4).
...
La [herramienta de memoria](https://platform.claude.com/docs/es/agents-and-tools/tool-use/memory-tool) se empareja naturalmente con la conciencia de contexto para transiciones de contexto sin problemas.
...
2. **Usa indicadores de formato XML**
   - Intenta: "Escribe las secciones de prosa de tu respuesta en etiquetas <smoothly\_flowing\_prose\_paragraphs>."
...
Prompt de ejemplo para uso conservador de subagentes
...
Para más información sobre capacidades de pensamiento, consulta [Pensamiento extendido](https://platform.claude.com/docs/es/build-with-claude/extended-thinking).
...
Prompt de ejemplo para minimizar sobreingeniería
...
- [Principios generales](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#principios-generales)
- [Sé explícito con tus instrucciones](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#se-explicito-con-tus-instrucciones)
- [Añade contexto para mejorar el rendimiento](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#anade-contexto-para-mejorar-el-rendimiento)
- [Sé vigilante con ejemplos y detalles](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#se-vigilante-con-ejemplos-y-detalles)
- [Razonamiento de largo horizonte y seguimiento de estado](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#razonamiento-de-largo-horizonte-y-seguimiento-de-estado)
- [Estilo de comunicación](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#estilo-de-comunicacion)
- [Orientación para situaciones específicas](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#orientacion-para-situaciones-especificas)
- [Equilibra la verbosidad](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#equilibra-la-verbosidad)
- [Patrones de uso de herramientas](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#patrones-de-uso-de-herramientas)
- [Uso de herramientas y activación](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#uso-de-herramientas-y-activacion)
- [Controla el formato de respuestas](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#controla-el-formato-de-respuestas)
- [Investigación y recopilación de información](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#investigacion-y-recopilacion-de-informacion)
- [Orquestación de subagentes](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#orquestacion-de-subagentes)
- [Autoconocimiento del modelo](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#autoconocimiento-del-modelo)
- [Sensibilidad del pensamiento](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#sensibilidad-del-pensamiento)
- [Aprovecha las capacidades de pensamiento e interleaved thinking](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#aprovecha-las-capacidades-de-pensamiento-e-interleaved-thinking)
- [Creación de documentos](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#creacion-de-documentos)
- [Capacidades de visión mejoradas](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#capacidades-de-vision-mejoradas)
- [Optimiza llamadas de herramientas paralelas](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#optimiza-llamadas-de-herramientas-paralelas)
- [Reduce la creación de archivos en codificación agente](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#reduce-la-creacion-de-archivos-en-codificacion-agente)
- [Sobreeagerness y creación de archivos](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#sobreeagerness-y-creacion-de-archivos)
- [Diseño frontend](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#diseno-frontend)
- [Evita enfocarse en pasar pruebas y hardcoding](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#evita-enfocarse-en-pasar-pruebas-y-hardcoding)
- [Anima la exploración de código](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#anima-la-exploracion-de-codigo)
- [Minimiza alucinaciones en codificación agente](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#minimiza-alucinaciones-en-codificacion-agente)
- [Consideraciones de migración](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/claude-4-best-practices#consideraciones-de-migracion)
