---
url: "https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/prompt-generator"
title: "Genera automaticamente modelli di prompt di prima bozza - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fbuild-with-claude%2Fprompt-engineering%2Fprompt-generator)
...
# Genera automaticamente modelli di prompt di prima bozza

Copy page

Copy page

Il nostro generatore di prompt è compatibile con tutti i modelli Claude, inclusi quelli con capacità di pensiero esteso. Per suggerimenti specifici sui prompt per i modelli con pensiero esteso, consulta [qui](https://platform.claude.com/docs/it/build-with-claude/extended-thinking).

A volte, la parte più difficile nell'utilizzo di un modello di IA è capire come sollecitarlo efficacemente. Per aiutare in questo, abbiamo creato uno strumento di generazione di prompt che guida Claude a generare modelli di prompt di alta qualità adattati ai tuoi compiti specifici. Questi modelli seguono molte delle nostre migliori pratiche di ingegneria dei prompt.

Il generatore di prompt è particolarmente utile come strumento per risolvere il "problema della pagina bianca" e darti un punto di partenza per ulteriori test e iterazioni.

Prova subito il generatore di prompt direttamente sulla [Console](https://platform.claude.com/dashboard).

Se sei interessato ad analizzare il prompt sottostante e l'architettura, dai un'occhiata al nostro [notebook Google Colab del generatore di prompt](https://anthropic.com/metaprompt-notebook/). Lì, puoi facilmente eseguire il codice per far costruire i prompt a Claude per tuo conto.

Nota che per eseguire il notebook Colab, avrai bisogno di una [chiave API](https://platform.claude.com/settings/keys).

* * *

## Prossimi passi

[Inizia l'ingegneria dei prompt\\
\\
Ottieni ispirazione da una selezione curata di prompt per varie attività e casi d'uso.](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/be-clear-and-direct) [Libreria di prompt\\
\\
Ottieni ispirazione da una selezione curata di prompt per varie attività e casi d'uso.](https://platform.claude.com/docs/it/resources/prompt-library/library) [Tutorial di prompting su GitHub\\
\\
Un tutorial ricco di esempi che copre i concetti di ingegneria dei prompt presenti nella nostra documentazione.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutorial di prompting su Google Sheets\\
\\
Una versione più leggera del nostro tutorial di ingegneria dei prompt attraverso un foglio di calcolo interattivo.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Prossimi passi](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/prompt-generator#prossimi-passi)
