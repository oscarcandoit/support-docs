---
url: "https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/long-context-tips"
title: "Советы по работе с длинным контекстом - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fbuild-with-claude%2Fprompt-engineering%2Flong-context-tips)
...
Запросы в конце могут улучшить качество ответа на 30% в тестах, особенно со сложными многодокументными входными данными.
...
### Пример структуры многодокументного формата
...
[Библиотека промптов\\
\\
Вдохновитесь подобранной коллекцией промптов для различных задач и вариантов использования.](https://platform.claude.com/docs/ru/resources/prompt-library/library) [Учебник по промптингу на GitHub\\
\\
Учебник, наполненный примерами, который охватывает концепции инженерии промптов, найденные в нашей документации.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Учебник по промптингу в Google Sheets\\
\\
Облегченная версия нашего учебника по инженерии промптов через интерактивную электронную таблицу.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Основные советы для промптов с длинным контекстом](https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/long-context-tips#osnovnye-sovety-dlya-promptov-s-dlinnym-kontekstom)
