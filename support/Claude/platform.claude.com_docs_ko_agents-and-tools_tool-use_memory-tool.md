---
url: "https://platform.claude.com/docs/ko/agents-and-tools/tool-use/memory-tool"
title: "메모리 도구 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fko%2Fagents-and-tools%2Ftool-use%2Fmemory-tool)
...
메모리 도구는 [텍스트 편집기 도구](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/text-editor-tool#handle-errors) 와 유사한 오류 처리 패턴을 사용합니다. 자세한 오류 메시지 및 동작은 위의 개별 도구 명령 섹션을 참조하세요. 일반적인 오류에는 파일을 찾을 수 없음, 권한 오류, 잘못된 경로 및 중복 텍스트 일치가 포함됩니다.

## 컨텍스트 편집과 함께 사용

메모리 도구는 [컨텍스트 편집](https://platform.claude.com/docs/ko/build-with-claude/context-editing) 과 결합할 수 있으며, 이는 대화 컨텍스트가 구성된 임계값을 초과할 때 자동으로 이전 도구 결과를 지웁니다. 이 조합은 그렇지 않으면 컨텍스트 제한을 초과할 장기 실행 에이전트 워크플로우를 가능하게 합니다.
...
- [view](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/memory-tool#view)
- [create](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/memory-tool#create)
- [str\_replace](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/memory-tool#str-replace)
- [insert](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/memory-tool#insert)
- [delete](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/memory-tool#delete)
- [rename](https://platform.claude.com/docs/ko/agents-and-tools/tool-use/memory-tool#rename)
