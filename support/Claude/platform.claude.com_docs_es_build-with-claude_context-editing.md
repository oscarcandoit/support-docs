---
url: "https://platform.claude.com/docs/es/build-with-claude/context-editing"
title: "Edición de contexto - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fbuild-with-claude%2Fcontext-editing)
...
| **Lado del cliente** | SDK | Compactación | Disponible en [SDKs de Python y TypeScript](https://platform.claude.com/docs/es/api/client-sdks) cuando se usa [`tool_runner`](https://platform.claude.com/docs/es/agents-and-tools/tool-use/implement-tool-use#tool-runner-beta). Genera un resumen y reemplaza el historial completo de conversación. Ver [Compactación](https://platform.claude.com/docs/es/build-with-claude/context-editing#client-side-compaction-sdk) abajo. |
...
Un turno de conversación del asistente puede incluir múltiples bloques de contenido (por ejemplo, cuando se usan herramientas) y múltiples bloques de pensamiento (por ejemplo, con [pensamiento intercalado](https://platform.claude.com/docs/es/build-with-claude/extended-thinking#interleaved-thinking)).
...
La interacción de la edición de contexto con [almacenamiento en caché de mensajes](https://platform.claude.com/docs/es/build-with-claude/prompt-caching) varía según la estrategia:
...
La forma más simple de habilitar la limpieza de resultados de herramientas es especificar solo el tipo de estrategia, ya que todas las otras [opciones de configuración](https://platform.claude.com/docs/es/build-with-claude/context-editing#configuration-options-for-tool-result-clearing) usarán sus valores predeterminados:
...
El endpoint de [conteo de tokens](https://platform.claude.com/docs/es/build-with-claude/token-counting) admite gestión de contexto, permitiéndole obtener una vista previa de cuántos tokens usará su prompt después de que se aplique la edición de contexto.
...
La compactación está disponible en los [SDK de Python y TypeScript](https://platform.claude.com/docs/es/api/client-sdks) cuando se usa el método [`tool_runner`](https://platform.claude.com/docs/es/agents-and-tools/tool-use/implement-tool-use#tool-runner-beta).

La compactación es una característica del SDK que gestiona automáticamente el contexto de la conversación generando resúmenes cuando el uso de tokens crece demasiado. A diferencia de las estrategias de edición de contexto del lado del servidor que limpian contenido, la compactación instruye a Claude para resumir el historial de conversación, luego reemplaza el historial completo con ese resumen. Esto permite que Claude continúe trabajando en tareas de larga duración que de otro modo excederían la [ventana de contexto](https://platform.claude.com/docs/es/build-with-claude/context-windows).
...
La compactación es una característica del SDK que gestiona automáticamente el contexto de la conversación generando resúmenes cuando el uso de tokens crece demasiado. A diferencia de las estrategias de edición de contexto del lado del servidor que borran contenido, la compactación instruye a Claude para que resuma el historial de conversación, luego reemplaza el historial completo con ese resumen. Esto permite que Claude continúe trabajando en tareas de larga duración que de otro modo excederían la [ventana de contexto](https://platform.claude.com/docs/es/build-with-claude/context-windows).
...
La compactación requiere consideración especial cuando se usan herramientas del lado del servidor como [búsqueda web](https://platform.claude.com/docs/es/agents-and-tools/tool-use/web-search-tool) o [búsqueda web](https://platform.claude.com/docs/es/agents-and-tools/tool-use/web-fetch-tool).
...
- Usa el punto final de [conteo de tokens](https://platform.claude.com/docs/es/build-with-claude/token-counting) para obtener la longitud de contexto precisa
...
- [Descripción general](https://platform.claude.com/docs/es/build-with-claude/context-editing#descripcion-general)
- [Descripción general](https://platform.claude.com/docs/es/build-with-claude/context-editing#descripcion-general-2)
- [Estrategias del lado del servidor](https://platform.claude.com/docs/es/build-with-claude/context-editing#estrategias-del-lado-del-servidor)
- [Limpieza de resultados de herramientas](https://platform.claude.com/docs/es/build-with-claude/context-editing#limpieza-de-resultados-de-herramientas)
- [Limpieza de bloques de pensamiento](https://platform.claude.com/docs/es/build-with-claude/context-editing#limpieza-de-bloques-de-pensamiento)
- [Modelos soportados](https://platform.claude.com/docs/es/build-with-claude/context-editing#modelos-soportados)
- [Uso de limpieza de resultados de herramientas](https://platform.claude.com/docs/es/build-with-claude/context-editing#uso-de-limpieza-de-resultados-de-herramientas)
- [Configuración avanzada](https://platform.claude.com/docs/es/build-with-claude/context-editing#configuracion-avanzada)
- [Descripción general](https://platform.claude.com/docs/es/build-with-claude/context-editing#descripcion-general-3)
- [Estrategias del lado del servidor](https://platform.claude.com/docs/es/build-with-claude/context-editing#estrategias-del-lado-del-servidor-2)
- [Limpieza de resultados de herramientas](https://platform.claude.com/docs/es/build-with-claude/context-editing#limpieza-de-resultados-de-herramientas-2)
- [Limpieza de bloques de pensamiento](https://platform.claude.com/docs/es/build-with-claude/context-editing#limpieza-de-bloques-de-pensamiento-2)
- [Modelos soportados](https://platform.claude.com/docs/es/build-with-claude/context-editing#modelos-soportados-2)
- [Uso de limpieza de resultados de herramientas](https://platform.claude.com/docs/es/build-with-claude/context-editing#uso-de-limpieza-de-resultados-de-herramientas-2)
- [Configuración avanzada](https://platform.claude.com/docs/es/build-with-claude/context-editing#configuracion-avanzada-2)
- [Uso de limpieza de bloques de pensamiento](https://platform.claude.com/docs/es/build-with-claude/context-editing#uso-de-limpieza-de-bloques-de-pensamiento)
- [Opciones de configuración para limpieza de bloques de pensamiento](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion-para-limpieza-de-bloques-de-pensamiento)
- [Opciones de configuración para limpieza de bloques de pensamiento](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion-para-limpieza-de-bloques-de-pensamiento-2)
- [Combinación de estrategias](https://platform.claude.com/docs/es/build-with-claude/context-editing#combinacion-de-estrategias)
- [Opciones de configuración para limpieza de bloques de pensamiento](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion-para-limpieza-de-bloques-de-pensamiento-3)
- [Combinación de estrategias](https://platform.claude.com/docs/es/build-with-claude/context-editing#combinacion-de-estrategias-2)
- [Opciones de configuración para limpieza de resultados de herramientas](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion-para-limpieza-de-resultados-de-herramientas)
- [Opciones de configuración para limpieza de bloques de pensamiento](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion-para-limpieza-de-bloques-de-pensamiento-4)
- [Combinación de estrategias](https://platform.claude.com/docs/es/build-with-claude/context-editing#combinacion-de-estrategias-3)
- [Opciones de configuración para limpieza de resultados de herramientas](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion-para-limpieza-de-resultados-de-herramientas-2)
- [Respuesta de edición de contexto](https://platform.claude.com/docs/es/build-with-claude/context-editing#respuesta-de-edicion-de-contexto)
- [Opciones de configuración para limpiar bloques de pensamiento](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion-para-limpiar-bloques-de-pensamiento)
- [Combinación de estrategias](https://platform.claude.com/docs/es/build-with-claude/context-editing#combinacion-de-estrategias-4)
- [Opciones de configuración para limpieza de resultados de herramientas](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion-para-limpieza-de-resultados-de-herramientas-3)
- [Respuesta de edición de contexto](https://platform.claude.com/docs/es/build-with-claude/context-editing#respuesta-de-edicion-de-contexto-2)
- [Conteo de tokens](https://platform.claude.com/docs/es/build-with-claude/context-editing#conteo-de-tokens)
- [Uso con la herramienta de memoria](https://platform.claude.com/docs/es/build-with-claude/context-editing#uso-con-la-herramienta-de-memoria)
- [Compactación del lado del cliente (SDK)](https://platform.claude.com/docs/es/build-with-claude/context-editing#compactacion-del-lado-del-cliente-sdk)
- [Cómo funciona la compactación](https://platform.claude.com/docs/es/build-with-claude/context-editing#como-funciona-la-compactacion)
- [Uso de compactación](https://platform.claude.com/docs/es/build-with-claude/context-editing#uso-de-compactacion)
- [Opciones de configuración](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion)
- [Uso con la herramienta de memoria](https://platform.claude.com/docs/es/build-with-claude/context-editing#uso-con-la-herramienta-de-memoria-2)
- [Compactación del lado del cliente (SDK)](https://platform.claude.com/docs/es/build-with-claude/context-editing#compactacion-del-lado-del-cliente-sdk-2)
- [Cómo funciona la compactación](https://platform.claude.com/docs/es/build-with-claude/context-editing#como-funciona-la-compactacion-2)
- [Uso de compactación](https://platform.claude.com/docs/es/build-with-claude/context-editing#uso-de-compactacion-2)
- [Opciones de configuración](https://platform.claude.com/docs/es/build-with-claude/context-editing#opciones-de-configuracion-2)
- [Mensaje de resumen predeterminado](https://platform.claude.com/docs/es/build-with-claude/context-editing#mensaje-de-resumen-predeterminado)
- [Limitaciones](https://platform.claude.com/docs/es/build-with-claude/context-editing#limitaciones)
- [Limitaciones](https://platform.claude.com/docs/es/build-with-claude/context-editing#limitaciones-2)
- [Monitoreo de compactación](https://platform.claude.com/docs/es/build-with-claude/context-editing#monitoreo-de-compactacion)
- [Limitaciones](https://platform.claude.com/docs/es/build-with-claude/context-editing#limitaciones-3)
- [Monitoreo de compactación](https://platform.claude.com/docs/es/build-with-claude/context-editing#monitoreo-de-compactacion-2)
- [Cuándo usar compactación](https://platform.claude.com/docs/es/build-with-claude/context-editing#cuando-usar-compactacion)
