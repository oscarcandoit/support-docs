---
url: "https://platform.claude.com/docs/ru/home"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fhome)
...
Узнайте, как начать работу с платформой Claude Developer Platform и Claude Code.

Спросите Claude о документации...
...
[Начало работы\\
\\
Сделайте свой первый вызов API за несколько минут.](https://platform.claude.com/docs/ru/get-started) [Обзор функций\\
\\
Изучите передовые функции и возможности, доступные в Claude.](https://platform.claude.com/docs/ru/api/overview) [Что нового в Claude 4.5\\
\\
Откройте для себя последние достижения в моделях Claude 4.5.](https://platform.claude.com/docs/ru/about-claude/models/whats-new-claude-4-5) [Справочник API\\
\\
Интегрируйте и масштабируйте, используя наш API и SDK.](https://platform.claude.com/docs/ru/api/overview) [Claude Console\\
\\
Создавайте и тестируйте мощные подсказки прямо в вашем браузере.](https://platform.claude.com/) [Примечания к выпуску\\
\\
Узнайте об изменениях и новых функциях в Claude Developer Platform.](https://platform.claude.com/docs/ru/release-notes/api)

## Claude Code

[Быстрый старт Claude Code\\
\\
Начните работу с Claude Code.](https://code.claude.com/docs/ru/quickstart) [Справочник Claude Code\\
\\
Обратитесь к справочной документации Claude Code для получения подробной информации о реализации функций и конфигурации.](https://code.claude.com/docs/ru/overview) [Журнал изменений Claude Code\\
\\
Узнайте об изменениях и новых функциях в Claude Code.](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md)

## Учебные ресурсы

[Курсы Anthropic\\
\\
Изучите образовательные курсы и проекты Anthropic.](https://anthropic.skilljar.com/) [Claude Cookbook\\
\\
Посмотрите воспроизводимые примеры кода и реализации.](https://github.com/anthropics/anthropic-cookbook) [Claude Quickstarts\\
\\
Развертываемые приложения, созданные с помощью нашего API.](https://github.com/anthropics/anthropic-quickstarts)
