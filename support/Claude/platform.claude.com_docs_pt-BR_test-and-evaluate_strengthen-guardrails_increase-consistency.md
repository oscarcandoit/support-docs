---
url: "https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/increase-consistency"
title: "Aumentar a consistência da saída - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fincrease-consistency)
...
Aumentar consistência de saída
...
### Exemplo: Padronizando feedback de clientes
...
### Exemplo: Relatório de vendas diário
...
### Exemplo: Melhorando a consistência do suporte de TI
...
- [Especifique o formato de saída desejado](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/increase-consistency#especifique-o-formato-de-saida-desejado)
- [Preencha previamente a resposta do Claude](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/increase-consistency#preencha-previamente-a-resposta-do-claude)
- [Restrinja com exemplos](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/increase-consistency#restrinja-com-exemplos)
- [Use recuperação para consistência contextual](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/increase-consistency#use-recuperacao-para-consistencia-contextual)
- [Encadeie prompts para tarefas complexas](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/increase-consistency#encadeie-prompts-para-tarefas-complexas)
