---
url: "https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/be-clear-and-direct"
title: "Sii chiaro, diretto e dettagliato - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fbuild-with-claude%2Fprompt-engineering%2Fbe-clear-and-direct)
...
**La regola d'oro della comunicazione chiara**
...
### Esempio: Anonimizzazione del feedback dei clienti

### Esempio: Creazione di una campagna di email marketing

### Esempio: Risposta agli incidenti
...
- [Come essere chiaro, contestuale e specifico](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/be-clear-and-direct#come-essere-chiaro-contestuale-e-specifico)
- [Esempi](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/be-clear-and-direct#esempi)
