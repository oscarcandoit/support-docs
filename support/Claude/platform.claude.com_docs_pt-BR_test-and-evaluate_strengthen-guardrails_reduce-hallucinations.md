---
url: "https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/reduce-hallucinations"
title: "Reduzir alucinações - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Freduce-hallucinations)
...
### Exemplo: Analisando um relatório de fusão e aquisição
...
### Exemplo: Redigindo um comunicado de imprensa sobre o lançamento de um produto
...
- [Estratégias básicas de minimização de alucinações](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/reduce-hallucinations#estrategias-basicas-de-minimizacao-de-alucinacoes)
- [Técnicas avançadas](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/reduce-hallucinations#tecnicas-avancadas)
