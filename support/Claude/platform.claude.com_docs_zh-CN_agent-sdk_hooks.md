---
url: "https://platform.claude.com/docs/zh-CN/agent-sdk/hooks"
title: "使用钩子拦截和控制代理行为 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Fagent-sdk%2Fhooks)
...
[流式输入](https://platform.claude.com/docs/zh-CN/agent-sdk/streaming-vs-single-mode) [处理权限](https://platform.claude.com/docs/zh-CN/agent-sdk/permissions) [使用钩子控制执行](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks) [会话管理](https://platform.claude.com/docs/zh-CN/agent-sdk/sessions) [SDK 中的结构化输出](https://platform.claude.com/docs/zh-CN/agent-sdk/structured-outputs) [托管 Agent SDK](https://platform.claude.com/docs/zh-CN/agent-sdk/hosting) [安全部署 AI 代理](https://platform.claude.com/docs/zh-CN/agent-sdk/secure-deployment) [修改系统提示词](https://platform.claude.com/docs/zh-CN/agent-sdk/modifying-system-prompts) [SDK 中的 MCP](https://platform.claude.com/docs/zh-CN/agent-sdk/mcp) [自定义工具](https://platform.claude.com/docs/zh-CN/agent-sdk/custom-tools) [SDK 中的子代理](https://platform.claude.com/docs/zh-CN/agent-sdk/subagents) [SDK 中的斜杠命令](https://platform.claude.com/docs/zh-CN/agent-sdk/slash-commands) [SDK 中的 Agent Skills](https://platform.claude.com/docs/zh-CN/agent-sdk/skills) [跟踪成本和使用情况](https://platform.claude.com/docs/zh-CN/agent-sdk/cost-tracking) [待办事项列表](https://platform.claude.com/docs/zh-CN/agent-sdk/todo-tracking) [SDK 中的插件](https://platform.claude.com/docs/zh-CN/agent-sdk/plugins)
...
- **键** 是 [钩子事件名称](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks#available-hooks)（例如 `'PreToolUse'`、`'PostToolUse'`、`'Stop'`）
- **值** 是 [匹配器](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks#matchers) 数组，每个包含可选的过滤模式和你的 [回调函数](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks#callback-function-inputs)

你的钩子回调函数接收关于事件的 [输入数据](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks#input-data)，并返回一个 [响应](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks#callback-outputs)，以便代理知道是否允许、阻止或修改操作。
...
1. **输入数据**（`dict` / `HookInput`）：事件详情。参见 [输入数据](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks#input-data) 了解字段
...
你的钩子回调的第一个参数包含关于事件的信息。字段名称在 SDK 中相同（都使用 snake\_case）。
...
**特定于钩子的字段** 因钩子类型而异。标记为 TS 的项仅在 TypeScript SDK 中可用：
...
| `agent_transcript_path` | `string` | 子代理的对话记录路径 | SubagentStopTS |
...
| `reason` | `string` | 会话为何结束：`clear`、`logout`、`prompt_input_exit`、`bypass_permissions_disabled` 或 `other` | SessionEndTS |
...
| `additionalContext` | `string` | PostToolUse、UserPromptSubmit、SessionStartTS、SubagentStartTS | 添加到对话的上下文 |
...
- 当代理达到 [`max_turns`](https://platform.claude.com/docs/zh-CN/agent-sdk/python#configuration-options) 限制时，钩子可能不会触发，因为会话在钩子执行前结束
...
- [权限](https://platform.claude.com/docs/zh-CN/agent-sdk/permissions)：控制你的代理可以做什么
- [自定义工具](https://platform.claude.com/docs/zh-CN/agent-sdk/custom-tools)：构建工具以扩展代理功能
- [TypeScript SDK 参考](https://platform.claude.com/docs/zh-CN/agent-sdk/typescript)
- [Python SDK 参考](https://platform.claude.com/docs/zh-CN/agent-sdk/python)

- [发送通知（仅 TypeScript）](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks#type-script)
- [systemMessage 未出现在输出中](https://platform.claude.com/docs/zh-CN/agent-sdk/hooks#system-message)
