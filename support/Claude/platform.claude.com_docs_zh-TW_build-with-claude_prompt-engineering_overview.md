---
url: "https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/overview"
title: "提示詞工程概述 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-TW%2Fbuild-with-claude%2Fprompt-engineering%2Foverview)
...
如果沒有，我們強烈建議您花時間先建立這些基礎。請查看 [定義您的成功標準](https://platform.claude.com/docs/zh-TW/test-and-evaluate/define-success) 和 [建立強大的實證評估](https://platform.claude.com/docs/zh-TW/test-and-evaluate/develop-tests) 以獲取提示和指導。

[提示詞生成器\\
\\
沒有初稿提示詞？試試 Claude 控制台中的提示詞生成器！](https://platform.claude.com/dashboard)
...
1. [提示詞生成器](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/prompt-generator)
2. [清晰直接](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/be-clear-and-direct)
3. [使用示例（多樣本）](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/multishot-prompting)
4. [讓 Claude 思考（思維鏈）](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/chain-of-thought)
5. [使用 XML 標籤](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/use-xml-tags)
6. [給 Claude 一個角色（系統提示詞）](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/system-prompts)
7. [預填 Claude 的回應](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/prefill-claudes-response)
8. [鏈接複雜提示詞](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/chain-prompts)
9. [長上下文提示](https://platform.claude.com/docs/zh-TW/build-with-claude/prompt-engineering/long-context-tips)
...
[GitHub 提示詞工程教程\\
\\
一個充滿示例的教程，涵蓋我們文檔中的提示詞工程概念。](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Google Sheets 提示詞工程教程\\
\\
通過互動式電子表格提供的我們提示詞工程教程的輕量級版本。](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)
