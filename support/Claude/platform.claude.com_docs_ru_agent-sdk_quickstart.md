---
url: "https://platform.claude.com/docs/ru/agent-sdk/quickstart"
title: "Быстрый старт - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fagent-sdk%2Fquickstart)
...
- [Предварительные требования](https://platform.claude.com/docs/ru/agent-sdk/quickstart#predvaritelnye-trebovaniya)
- [Настройка](https://platform.claude.com/docs/ru/agent-sdk/quickstart#nastroyka)
- [Создать файл с ошибками](https://platform.claude.com/docs/ru/agent-sdk/quickstart#sozdat-fayl-s-oshibkami)
- [Создать агента, который находит и исправляет ошибки](https://platform.claude.com/docs/ru/agent-sdk/quickstart#sozdat-agenta-kotoriy-nakhodit-i-ispravlyaet-oshibki)
- [Запустить ваш агент](https://platform.claude.com/docs/ru/agent-sdk/quickstart#zapustit-vash-agent)
- [Попробуйте другие подсказки](https://platform.claude.com/docs/ru/agent-sdk/quickstart#poprobuyte-drugie-podskazki)
- [Настроить ваш агент](https://platform.claude.com/docs/ru/agent-sdk/quickstart#nastroit-vash-agent)
- [Ключевые концепции](https://platform.claude.com/docs/ru/agent-sdk/quickstart#klyuchevye-kontseptsii)
- [Следующие шаги](https://platform.claude.com/docs/ru/agent-sdk/quickstart#sleduyuschie-shagi)