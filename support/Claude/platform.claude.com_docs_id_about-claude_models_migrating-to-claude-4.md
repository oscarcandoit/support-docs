---
url: "https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4"
title: "Migrasi ke Claude 4.5 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fabout-claude%2Fmodels%2Fmigrating-to-claude-4)
...
Sebelum memulai migrasi Anda, kami merekomendasikan untuk meninjau [Apa yang baru di Claude 4.5](https://platform.claude.com/docs/id/about-claude/models/whats-new-claude-4-5) untuk memahami fitur dan kemampuan baru yang tersedia di model ini, termasuk extended thinking, kesadaran konteks, dan peningkatan perilaku.
...
02. **Perbarui parameter sampling**
...
03. **Tangani alasan penghentian `refusal` yang baru**

    Perbarui aplikasi Anda untuk [menangani alasan penghentian `refusal`](https://platform.claude.com/docs/id/test-and-evaluate/strengthen-guardrails/handle-streaming-refusals):
...
04. **Perbarui alat editor teks (jika berlaku)**
    ...
    Lihat [dokumentasi alat editor teks](https://platform.claude.com/docs/id/agents-and-tools/tool-use/text-editor-tool) untuk detail.

05. **Perbarui alat eksekusi kode (jika berlaku)**

    Tingkatkan ke `code_execution_20250825`. Versi legacy `code_execution_20250522` masih berfungsi tetapi tidak direkomendasikan. Lihat [dokumentasi alat eksekusi kode](https://platform.claude.com/docs/id/agents-and-tools/tool-use/code-execution-tool#upgrade-to-latest-tool-version) untuk instruksi migrasi.

06. **Hapus header beta penggunaan alat yang efisien token**
    ...
    Hapus header beta `token-efficient-tools-2025-02-19` [beta header](https://platform.claude.com/docs/id/api/beta-headers) dari permintaan Anda:
...
07. **Hapus header beta output yang diperpanjang**

    Header beta `output-128k-2025-02-19` [beta header](https://platform.claude.com/docs/id/api/beta-headers) untuk output yang diperpanjang hanya tersedia di Claude Sonnet 3.7.
...
08. **Perbarui prompt Anda untuk perubahan perilaku**

    Claude Sonnet 4.5 memiliki gaya komunikasi yang lebih ringkas dan langsung serta memerlukan arahan eksplisit. Tinjau [praktik terbaik prompt engineering Claude 4](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/claude-4-best-practices) untuk panduan optimasi.

09. **Pertimbangkan untuk mengaktifkan extended thinking untuk tugas kompleks**

    Aktifkan [extended thinking](https://platform.claude.com/docs/id/build-with-claude/extended-thinking) untuk peningkatan performa yang signifikan pada tugas coding dan penalaran (dinonaktifkan secara default):
    ...
    Extended thinking mempengaruhi efisiensi [prompt caching](https://platform.claude.com/docs/id/build-with-claude/prompt-caching#caching-with-thinking-blocks).
...
- [ ] Tinjau dan perbarui prompt mengikuti [praktik terbaik Claude 4](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/claude-4-best-practices)
...
Untuk gambaran lengkap tentang kemampuan baru, lihat [Apa yang baru di Claude 4.5](https://platform.claude.com/docs/id/about-claude/models/whats-new-claude-4-5#key-improvements-in-haiku-4-5-over-haiku-3-5).

Harga Haiku 4.5 $1 per juta token input, $5 per juta token output. Lihat [harga Claude](https://platform.claude.com/docs/id/about-claude/pricing) untuk detail.
...
Haiku 4.5 memiliki batas laju terpisah dari Haiku 3.5. Lihat [dokumentasi batas laju](https://platform.claude.com/docs/id/api/rate-limits) untuk detail.
...
Lihat [Apa yang baru di Claude 4.5](https://platform.claude.com/docs/id/about-claude/models/whats-new-claude-4-5#key-improvements-in-haiku-4-5-over-haiku-3-5) untuk detail tentang kesadaran konteks, kapasitas output yang meningkat (64K token), kecerdasan yang lebih tinggi, dan kecepatan yang ditingkatkan.
...
- Periksa [dokumentasi API](https://platform.claude.com/docs/id/api/overview) kami untuk spesifikasi terperinci
...
- [Migrasi dari Claude Sonnet 3.7 ke Claude Sonnet 4.5](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#migrasi-dari-claude-sonnet-3-7-ke-claude-sonnet-4-5)
- [Langkah-langkah migrasi](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#langkah-langkah-migrasi)
- [Daftar periksa migrasi Sonnet 3.7 → 4.5](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#daftar-periksa-migrasi-sonnet-3-7-4-5)
- [Fitur yang dihapus dari Claude Sonnet 3.7](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#fitur-yang-dihapus-dari-claude-sonnet-3-7)
- [Migrasi dari Claude Haiku 3.5 ke Claude Haiku 4.5](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#migrasi-dari-claude-haiku-3-5-ke-claude-haiku-4-5)
- [Langkah-langkah migrasi](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#langkah-langkah-migrasi-2)
- [Daftar periksa migrasi Haiku 3.5 → 4.5](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#daftar-periksa-migrasi-haiku-3-5-4-5)
- [Memilih antara Sonnet 4.5 dan Haiku 4.5](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#memilih-antara-sonnet-4-5-dan-haiku-4-5)
- [Pilih Claude Sonnet 4.5 (paling cerdas) untuk:](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#pilih-claude-sonnet-4-5-paling-cerdas-untuk)
- [Pilih Claude Haiku 4.5 (tercepat dan paling cerdas Haiku) untuk:](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#pilih-claude-haiku-4-5-tercepat-dan-paling-cerdas-haiku-untuk)
- [Rekomendasi extended thinking](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#rekomendasi-extended-thinking)
- [Skenario migrasi lainnya](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#skenario-migrasi-lainnya)
- [Migrasi dari Claude Sonnet 4 → Sonnet 4.5](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#migrasi-dari-claude-sonnet-4-sonnet-4-5)
- [Migrasi dari Claude Opus 4.1 → Sonnet 4.5](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#migrasi-dari-claude-opus-4-1-sonnet-4-5)
- [Migrasi dari Claude Opus 4.1 → Opus 4.5](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#migrasi-dari-claude-opus-4-1-opus-4-5)
- [Migrasi antara model Claude 4.5](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#migrasi-antara-model-claude-4-5)
- [Butuh bantuan?](https://platform.claude.com/docs/id/about-claude/models/migrating-to-claude-4#butuh-bantuan)
