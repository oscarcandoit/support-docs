---
url: "https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/overview"
title: "Aperçu de l'ingénierie des invites - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fbuild-with-claude%2Fprompt-engineering%2Foverview)
...
Si ce n'est pas le cas, nous vous suggérons vivement de consacrer du temps à établir cela d'abord. Consultez [Définir vos critères de succès](https://platform.claude.com/docs/fr/test-and-evaluate/define-success) et [Créer des évaluations empiriques solides](https://platform.claude.com/docs/fr/test-and-evaluate/develop-tests) pour obtenir des conseils et des orientations.

[Générateur d'invites\\
\\
Vous n'avez pas de premier brouillon d'invite ? Essayez le générateur d'invites dans la Claude Console !](https://platform.claude.com/dashboard)
...
1. [Générateur d'invites](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/prompt-generator)
2. [Soyez clair et direct](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/be-clear-and-direct)
3. [Utilisez des exemples (multishot)](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/multishot-prompting)
4. [Laissez Claude réfléchir (chaîne de pensée)](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/chain-of-thought)
5. [Utilisez des balises XML](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/use-xml-tags)
6. [Donnez un rôle à Claude (invites système)](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/system-prompts)
7. [Préremplissez la réponse de Claude](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/prefill-claudes-response)
8. [Enchaînez les invites complexes](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/chain-prompts)
9. [Conseils pour le contexte long](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/long-context-tips)
...
\\
Un tutoriel rempli d'exemples qui couvre les concepts d'ingénierie des invites trouvés dans notre documentation.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutoriel de prompting Google Sheets\\
\\
Une version plus légère de notre tutoriel d'ingénierie des invites via une feuille de calcul interactive.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Avant l'ingénierie des invites](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/overview#avant-l-ingenierie-des-invites)
- [Quand faire de l'ingénierie des invites](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/overview#quand-faire-de-l-ingenierie-des-invites)
- [Comment faire de l'ingénierie des invites](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/overview#comment-faire-de-l-ingenierie-des-invites)
- [Tutoriel d'ingénierie des invites](https://platform.claude.com/docs/fr/build-with-claude/prompt-engineering/overview#tutoriel-d-ingenierie-des-invites)
