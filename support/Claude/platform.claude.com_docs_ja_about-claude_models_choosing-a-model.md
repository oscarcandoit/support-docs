---
url: "https://platform.claude.com/docs/ja/about-claude/models/choosing-a-model"
title: "適切なモデルの選択 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fabout-claude%2Fmodels%2Fchoosing-a-model)
...
1. [ユースケース固有のベンチマークテストを作成する](https://platform.claude.com/docs/ja/test-and-evaluate/develop-tests) \- 良い評価セットを持つことはプロセスで最も重要なステップです
...
[モデル比較チャート\\
\\
最新のClaudeモデルの詳細な仕様と価格を確認する](https://platform.claude.com/docs/ja/about-claude/models/overview) [Claude 4.5の新機能\\
\\
Claude 4.5モデルの最新の改善を探索する](https://platform.claude.com/docs/ja/about-claude/models/whats-new-claude-4-5) [構築を開始する\\
\\
最初のAPI呼び出しを開始する](https://platform.claude.com/docs/ja/get-started)

- [オプション1：高速でコスト効率の良いモデルから始める](https://platform.claude.com/docs/ja/about-claude/models/choosing-a-model#1)
- [オプション2：最も機能豊富なモデルから始める](https://platform.claude.com/docs/ja/about-claude/models/choosing-a-model#2)
