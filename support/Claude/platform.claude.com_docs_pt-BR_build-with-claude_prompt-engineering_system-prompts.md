---
url: "https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/system-prompts"
title: "Dando um papel ao Claude com um prompt de sistema - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Fbuild-with-claude%2Fprompt-engineering%2Fsystem-prompts)
...
Dê um papel ao Claude (prompts do sistema)
...
**Dicas de prompt de sistema**: Use o parâmetro `system` para definir o papel do Claude. Coloque tudo mais, como instruções específicas da tarefa, na vez do `user` em vez disso.
...
Use o parâmetro `system` na [API de Mensagens](https://platform.claude.com/docs/pt-BR/api/messages) para definir o papel do Claude:
...
**Dica de role prompting**: Experimente com papéis! Um `data scientist` pode ver insights diferentes de um `marketing strategist` para os mesmos dados. Um `data scientist specializing in customer insight analysis for Fortune 500 companies` pode gerar resultados ainda diferentes!
...
\\
Uma versão mais leve de nosso tutorial de engenharia de prompts por meio de uma planilha interativa.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Por que usar role prompting?](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/system-prompts#por-que-usar-role-prompting)
- [Como dar um papel ao Claude](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/system-prompts#como-dar-um-papel-ao-claude)
- [Exemplos](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/system-prompts#exemplos)
- [Exemplo 1: Análise de contrato jurídico](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/system-prompts#exemplo-1-analise-de-contrato-juridico)
- [Exemplo 2: Análise financeira](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/system-prompts#exemplo-2-analise-financeira)
