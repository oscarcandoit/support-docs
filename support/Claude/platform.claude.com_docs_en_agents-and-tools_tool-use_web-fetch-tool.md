...
title: "Web fetch tool - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagents-and-tools%2Ftool-use%2Fweb-fetch-tool)
...
- [Supported models](https://platform.claude.com/docs/en/agents-and-tools/tool-use/web-fetch-tool#supported-models)
