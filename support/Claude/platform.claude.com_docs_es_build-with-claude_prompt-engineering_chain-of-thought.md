---
url: "https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/chain-of-thought"
title: "Deja que Claude piense (prompting de cadena de pensamiento) para mejorar el rendimiento - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fbuild-with-claude%2Fprompt-engineering%2Fchain-of-thought)
...
Usa CoT para tareas que un humano necesitaría pensar, como matemáticas complejas, análisis de múltiples pasos, escritura de documentos complejos, o decisiones con muchos factores.
...
**Consejo de CoT**: Siempre haz que Claude produzca su pensamiento. ¡Sin producir su proceso de pensamiento, no ocurre ningún pensamiento!

- **Prompt básico**: Incluye "Piensa paso a paso" en tu prompt.

  - Carece de orientación sobre _cómo_ pensar (lo cual es especialmente no ideal si una tarea es muy específica para tu aplicación, caso de uso u organización)

### Ejemplo: Escribir correos electrónicos de donantes (CoT básico)
...
### Ejemplo: Escribir correos electrónicos de donantes (CoT guiado)
...
### Ejemplo: Escribir correos electrónicos de donantes (CoT guiado estructurado)


### Ejemplos

### Ejemplo: Análisis financiero sin pensamiento

### Ejemplo: Análisis financiero con pensamiento

* * *

[Biblioteca de prompts\\
\\
Inspírate con una selección curada de prompts para varias tareas y casos de uso.](https://platform.claude.com/docs/es/resources/prompt-library/library) [Tutorial de prompting de GitHub\\
\\
Un tutorial lleno de ejemplos que cubre los conceptos de ingeniería de prompts encontrados en nuestra documentación.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutorial de prompting de Google Sheets\\
\\
Una versión más ligera de nuestro tutorial de ingeniería de prompts a través de una hoja de cálculo interactiva.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Antes de implementar CoT](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/chain-of-thought#antes-de-implementar-co-t)
- [¿Por qué dejar que Claude piense?](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/chain-of-thought#por-que-dejar-que-claude-piense)
- [¿Por qué no dejar que Claude piense?](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/chain-of-thought#por-que-no-dejar-que-claude-piense)
- [Cómo hacer prompting para el pensamiento](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/chain-of-thought#como-hacer-prompting-para-el-pensamiento)
- [Ejemplos](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/chain-of-thought#ejemplos)
