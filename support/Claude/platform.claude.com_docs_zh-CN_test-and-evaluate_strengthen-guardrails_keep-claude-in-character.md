---
url: "https://platform.claude.com/docs/zh-CN/test-and-evaluate/strengthen-guardrails/keep-claude-in-character"
title: "通过角色提示和预填充保持Claude的角色特征 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fkeep-claude-in-character)
...
- **使用系统提示来设定角色：** 使用 [系统提示](https://platform.claude.com/docs/zh-CN/build-with-claude/prompt-engineering/system-prompts) 来定义Claude的角色和个性。这为保持一致的回应奠定了坚实的基础。
