---
url: "https://platform.claude.com/docs/ja/home"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fhome)
...
Claude Developer Platformと Claude Codeの使い始め方を学びます。
...
[はじめに\\
\\
数分で最初のAPI呼び出しを行います。](https://platform.claude.com/docs/ja/get-started) [機能概要\\
\\
Claudeで利用可能な高度な機能と機能を探索します。](https://platform.claude.com/docs/ja/api/overview) [Claude 4.5の新機能\\
\\
Claude 4.5モデルの最新の進歩を発見します。](https://platform.claude.com/docs/ja/about-claude/models/whats-new-claude-4-5) [APIリファレンス\\
\\
当社のAPIとSDKを使用して統合およびスケーリングします。](https://platform.claude.com/docs/ja/api/overview) [Claude Console\\
\\
ブラウザで直接強力なプロンプトを作成およびテストします。](https://platform.claude.com/) [リリースノート\\
\\
Claude Developer Platformの変更と新機能について学びます。](https://platform.claude.com/docs/ja/release-notes/api)

## Claude Code

[Claude Codeクイックスタート\\
\\
Claude Codeの使い始め方。](https://code.claude.com/docs/ja/quickstart) [Claude Codeリファレンス\\
\\
機能の実装と設定の詳細については、Claude Codeリファレンスドキュメントを参照してください。](https://code.claude.com/docs/ja/overview) [Claude Codeチェンジログ\\
\\
Claude Codeの変更と新機能について学びます。](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md)

## 学習リソース

[Anthropicコース\\
\\
Anthropicの教育コースとプロジェクトを探索します。](https://anthropic.skilljar.com/) [Claude Cookbook\\
\\
再現可能なコードサンプルと実装を参照してください。](https://github.com/anthropics/anthropic-cookbook) [Claude Quickstarts\\
\\
当社のAPIで構築されたデプロイ可能なアプリケーション。](https://github.com/anthropics/anthropic-quickstarts)
