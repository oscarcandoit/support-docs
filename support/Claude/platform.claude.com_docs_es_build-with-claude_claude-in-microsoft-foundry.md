---
url: "https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry"
title: "Claude en Microsoft Foundry - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fbuild-with-claude%2Fclaude-in-microsoft-foundry)
...
Los [SDK de cliente](https://platform.claude.com/docs/es/api/client-sdks) de Anthropic admiten Foundry a través de paquetes específicos de la plataforma.
...
Claude en Foundry admite la mayoría de las poderosas características de Claude. Puedes encontrar todas las características actualmente admitidas [aquí](https://platform.claude.com/docs/es/build-with-claude/overview).
...
Las respuestas de API de Claude en Foundry siguen el [formato de respuesta estándar de la API de Anthropic](https://platform.claude.com/docs/es/api/messages). Esto incluye el objeto `usage` en los cuerpos de respuesta, que proporciona información detallada sobre el consumo de tokens para tus solicitudes. El objeto `usage` es consistente en todas las plataformas (API de primera parte, Foundry, Amazon Bedrock y Google Vertex AI).

Para más detalles sobre los encabezados de respuesta específicos de Foundry, consulta la [sección de IDs de solicitud de correlación](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#correlation-request-ids).
...
- **Detalles de precios de Anthropic**: [Documentación de precios](https://platform.claude.com/docs/es/about-claude/pricing#third-party-platform-pricing)
- **Guía de autenticación**: Consulta la [sección de autenticación](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#authentication) arriba
- **Portal de Azure**: [portal.azure.com](https://portal.azure.com/)

- [Vista previa](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#vista-previa)
- [Requisitos previos](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#requisitos-previos)
- [Instalar un SDK](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#instalar-un-sdk)
- [Aprovisionamiento](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#aprovisionamiento)
- [Aprovisionamiento de recursos de Foundry](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#aprovisionamiento-de-recursos-de-foundry)
- [Creación de implementaciones de Foundry](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#creacion-de-implementaciones-de-foundry)
- [Autenticación](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#autenticacion)
- [Autenticación con clave de API](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#autenticacion-con-clave-de-api)
- [Autenticación de Microsoft Entra](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#autenticacion-de-microsoft-entra)
- [IDs de solicitud de correlación](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#ids-de-solicitud-de-correlacion)
- [Características admitidas](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#caracteristicas-admitidas)
- [Características no admitidas](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#caracteristicas-no-admitidas)
- [Respuestas de API](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#respuestas-de-api)
- [IDs de modelo de API e implementaciones](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#ids-de-modelo-de-api-e-implementaciones)
- [Monitoreo y registro](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#monitoreo-y-registro)
- [Solución de problemas](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#solucion-de-problemas)
- [Errores de autenticación](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#errores-de-autenticacion)
- [Limitación de velocidad](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#limitacion-de-velocidad)
- [Errores de modelo e implementación](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#errores-de-modelo-e-implementacion)
- [Recursos adicionales](https://platform.claude.com/docs/es/build-with-claude/claude-in-microsoft-foundry#recursos-adicionales)
