---
url: "https://platform.claude.com/docs/de/about-claude/glossary"
title: "Glossar - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fde%2Fabout-claude%2Fglossary)
...
Siehe unseren [Leitfaden zum Verständnis von Kontextfenstern](https://platform.claude.com/docs/de/build-with-claude/context-windows), um mehr zu erfahren.
...
- [Kontextfenster](https://platform.claude.com/docs/de/about-claude/glossary#kontextfenster)
- [Fine-Tuning](https://platform.claude.com/docs/de/about-claude/glossary#fine-tuning)
- [HHH](https://platform.claude.com/docs/de/about-claude/glossary#hhh)
- [Latenz](https://platform.claude.com/docs/de/about-claude/glossary#latenz)
- [LLM](https://platform.claude.com/docs/de/about-claude/glossary#llm)
- [MCP (Model Context Protocol)](https://platform.claude.com/docs/de/about-claude/glossary#mcp-model-context-protocol)
- [MCP-Connector](https://platform.claude.com/docs/de/about-claude/glossary#mcp-connector)
- [Pretraining](https://platform.claude.com/docs/de/about-claude/glossary#pretraining)
- [RAG (Retrieval augmented generation)](https://platform.claude.com/docs/de/about-claude/glossary#rag-retrieval-augmented-generation)
- [RLHF](https://platform.claude.com/docs/de/about-claude/glossary#rlhf)
- [Temperature](https://platform.claude.com/docs/de/about-claude/glossary#temperature)
- [TTFT (Time to first token)](https://platform.claude.com/docs/de/about-claude/glossary#ttft-time-to-first-token)
- [Tokens](https://platform.claude.com/docs/de/about-claude/glossary#tokens)
