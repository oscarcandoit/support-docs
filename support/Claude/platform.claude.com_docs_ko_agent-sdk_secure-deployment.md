---
url: "https://platform.claude.com/docs/ko/agent-sdk/secure-deployment"
title: "AI 에이전트 안전하게 배포하기 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fko%2Fagent-sdk%2Fsecure-deployment)
...
- [Agent SDK 호스팅](https://platform.claude.com/docs/ko/agent-sdk/hosting)
- [권한 처리](https://platform.claude.com/docs/ko/agent-sdk/permissions)
...
- [gVisor](https://platform.claude.com/docs/ko/agent-sdk/secure-deployment#g-visor)
- [Claude Code를 프록시를 사용하도록 구성](https://platform.claude.com/docs/ko/agent-sdk/secure-deployment#claude-code)
