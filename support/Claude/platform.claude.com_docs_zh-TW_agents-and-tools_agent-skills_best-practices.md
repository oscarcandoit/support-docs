---
url: "https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/best-practices"
title: "技能編寫最佳實踐 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-TW%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
有關技能如何運作的概念背景，請參閱 [技能概述](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/overview)。

## 核心原則

### 簡潔是關鍵

[上下文窗口](https://platform.claude.com/docs/zh-TW/build-with-claude/context-windows) 是一項公共資源。您的技能與 Claude 需要了解的所有其他內容共享上下文窗口，包括：
...
有關完整的技能結構詳情，請參閱 [技能概述](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/overview#skill-structure)。
...
SKILL.md 作為概述，根據需要指向詳細材料，就像入職指南中的目錄一樣。有關漸進式披露如何工作的解釋，請參閱概述中的 [技能如何工作](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/overview#how-skills-work)。
...
![顯示 YAML 前置事項和 markdown 正文的簡單 SKILL.md 文件](https://platform.claude.com/docs/images/agent-skills-simple-file.png)

隨著您的技能增長，您可以捆綁 Claude 根據需要加載的其他內容：

![捆綁其他參考文件，如 reference.md 和 forms.md。](https://platform.claude.com/docs/images/agent-skills-bundling-content.png)
...
有關此基於文件系統的架構如何啟用漸進式披露的詳情，請參閱下面高級部分中的 [運行時環境](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/best-practices#runtime-environment) 部分。
...
這展示了使用參考文檔而不是腳本的驗證循環模式。"驗證器"是 STYLE\_GUIDE.md，Claude 通過讀取和比較來執行檢查。
...
下面的部分重點關注包含可執行腳本的技能。如果您的技能只使用 markdown 說明，請跳到 [有效技能清單](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/best-practices#checklist-for-effective-skills)。
...
![將可執行腳本與指令文件捆綁在一起](https://platform.claude.com/docs/images/agent-skills-executable-scripts.png)
...
對於大多數實用腳本，執行是首選，因為它更可靠和高效。有關腳本執行如何工作的詳情，請參閱下面的 [運行時環境](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/best-practices#runtime-environment) 部分。
...
**實現提示**：使用詳細的特定錯誤消息製作驗證腳本，如"字段'signature\_date'未找到。可用字段：customer\_name、order\_total、signature\_date\_signed"以幫助 Claude 修復問題。
...
在您的 SKILL.md 中列出所需的包並驗證它們在 [代碼執行工具文檔](https://platform.claude.com/docs/zh-TW/agents-and-tools/tool-use/code-execution-tool) 中可用。

### 運行時環境

技能在具有文件系統訪問、bash 命令和代碼執行能力的代碼執行環境中運行。有關此架構的概念解釋，請參閱概述中的 [技能架構](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/overview#the-skills-architecture)。
...
有關技術架構的完整詳情，請參閱技能概述中的 [技能如何工作](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/overview#how-skills-work)。
...
有關完整結構詳情，請參閱 [技能概述](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/overview#skill-structure)。

### 令牌預算

保持 SKILL.md 正文在 500 行以下以獲得最佳性能。如果您的內容超過此限制，使用前面描述的漸進式披露模式將其分成單獨的文件。有關架構詳情，請參閱 [技能概述](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/overview#how-skills-work)。
...
[開始使用代理技能\\
\\
創建您的第一個技能](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/quickstart) [在 Claude Code 中使用技能\\
\\
在 Claude Code 中創建和管理技能](https://code.claude.com/docs/skills) [在代理 SDK 中使用技能\\
\\
在 TypeScript 和 Python 中以編程方式使用技能](https://platform.claude.com/docs/zh-TW/agent-sdk/skills) [使用 API 使用技能\\
\\
以編程方式上傳和使用技能](https://platform.claude.com/docs/zh-TW/build-with-claude/skills-guide)

- [與 Claude 一起迭代開發技能](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/best-practices#claude)
- [觀察 Claude 如何導航技能](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/best-practices#claude-2)
- [避免 Windows 風格的路徑](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/best-practices#windows)
- [MCP 工具參考](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/best-practices#mcp)
- [YAML 前置事項要求](https://platform.claude.com/docs/zh-TW/agents-and-tools/agent-skills/best-practices#yaml)
