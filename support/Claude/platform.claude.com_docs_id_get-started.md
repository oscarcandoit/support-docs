...
title: "Mulai dengan Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fget-started)
...
- Akun [Konsol](https://platform.claude.com/) Anthropic
...
\\
Pelajari pola umum untuk API Pesan.](https://platform.claude.com/docs/id/build-with-claude/working-with-messages) [Ikhtisar Fitur\\
\\
Jelajahi fitur dan kemampuan canggih Claude.](https://platform.claude.com/docs/id/api/overview) [SDK Klien\\
\\
Temukan perpustakaan klien Anthropic.](https://platform.claude.com/docs/id/api/client-sdks) [Buku Resep Claude\\
\\
Pelajari dengan notebook Jupyter interaktif.](https://github.com/anthropics/anthropic-cookbook)

- [Prasyarat](https://platform.claude.com/docs/id/get-started#prasyarat)
- [Panggil API](https://platform.claude.com/docs/id/get-started#panggil-api)
- [Langkah berikutnya](https://platform.claude.com/docs/id/get-started#langkah-berikutnya)
