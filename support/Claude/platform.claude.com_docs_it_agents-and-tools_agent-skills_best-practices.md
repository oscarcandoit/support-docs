---
url: "https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices"
title: "Migliori pratiche per la creazione di Skills - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
Per informazioni concettuali su come funzionano le Skills, consulta la [panoramica delle Skills](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/overview).

## Principi fondamentali

### La concisione è fondamentale

La [finestra di contesto](https://platform.claude.com/docs/it/build-with-claude/context-windows) è un bene pubblico. La tua Skill condivide la finestra di contesto con tutto il resto che Claude deve sapere, incluso:
...
Per i dettagli completi della struttura della Skill, consulta la [panoramica delle Skills](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/overview#skill-structure).
...
![File SKILL.md semplice che mostra frontmatter YAML e corpo markdown](https://platform.claude.com/docs/images/agent-skills-simple-file.png)

Man mano che la tua Skill cresce, puoi raggruppare contenuti aggiuntivi che Claude carica solo quando necessario:

![Raggruppamento di file di riferimento aggiuntivi come reference.md e forms.md.](https://platform.claude.com/docs/images/agent-skills-bundling-content.png)
...
Per i dettagli su come questa architettura basata su filesystem abilita la divulgazione progressiva, consulta la sezione [Ambiente di runtime](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#runtime-environment) nella sezione Avanzate sottostante.
...
Questo mostra il modello di ciclo di convalida usando documenti di riferimento invece di script. Il "validatore" è STYLE\_GUIDE.md e Claude esegue il controllo leggendo e confrontando.
...
Le sezioni sottostanti si concentrano su Skills che includono script eseguibili. Se la tua Skill usa solo istruzioni markdown, salta a [Checklist per Skills efficaci](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#checklist-per-skills-efficaci).
...
![Raggruppamento di script eseguibili insieme ai file di istruzioni](https://platform.claude.com/docs/images/agent-skills-executable-scripts.png)
...
Per la maggior parte degli script di utilità, l'esecuzione è preferita perché è più affidabile ed efficiente. Consulta la sezione [Ambiente di runtime](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#runtime-environment) sottostante per i dettagli su come funziona l'esecuzione dello script.
...
**Suggerimento di implementazione**: Rendi gli script di convalida dettagliati con messaggi di errore specifici come "Campo 'signature\_date' non trovato. Campi disponibili: customer\_name, order\_total, signature\_date\_signed" per aiutare Claude a correggere i problemi.
...
Elenca i pacchetti richiesti nel tuo SKILL.md e verifica che siano disponibili nella [documentazione dello strumento di esecuzione del codice](https://platform.claude.com/docs/it/agents-and-tools/tool-use/code-execution-tool).

### Ambiente di runtime

Le Skills vengono eseguite in un ambiente di esecuzione del codice con accesso al filesystem, comandi bash e capacità di esecuzione del codice. Per la spiegazione concettuale di questa architettura, consulta [L'architettura delle Skills](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/overview#the-skills-architecture) nella panoramica.
...
Per i dettagli tecnici completi sull'architettura, consulta [Come funzionano le Skills](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/overview#how-skills-work) nella panoramica delle Skills.
...
Consulta la [panoramica delle Skills](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/overview#skill-structure) per i dettagli completi della struttura.

### Budget di token

Mantieni il corpo di SKILL.md sotto 500 righe per prestazioni ottimali. Se il tuo contenuto supera questo, dividilo in file separati usando i modelli di divulgazione progressiva descritti in precedenza. Per i dettagli architettonici, consulta la [panoramica delle Skills](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/overview#how-skills-work).
...
\\
Crea la tua prima Skill](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/quickstart) [Usa Skills in Claude Code\\
\\
Crea e gestisci Skills in Claude Code](https://code.claude.com/docs/skills) [Usa Skills in Agent SDK\\
\\
Usa le Skills a livello di programmazione in TypeScript e Python](https://platform.claude.com/docs/it/agent-sdk/skills) [Usa Skills con l'API\\
\\
Carica e usa le Skills a livello di programmazione](https://platform.claude.com/docs/it/build-with-claude/skills-guide)

- [Principi fondamentali](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#principi-fondamentali)
- [La concisione è fondamentale](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#la-concisione-e-fondamentale)
- [Imposta gradi di libertà appropriati](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#imposta-gradi-di-liberta-appropriati)
- [Testa con tutti i modelli che intendi utilizzare](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#testa-con-tutti-i-modelli-che-intendi-utilizzare)
- [Struttura della Skill](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#struttura-della-skill)
- [Convenzioni di denominazione](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#convenzioni-di-denominazione)
- [Scrivere descrizioni efficaci](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#scrivere-descrizioni-efficaci)
- [Modelli di divulgazione progressiva](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#modelli-di-divulgazione-progressiva)
- [Evita riferimenti profondamente annidati](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#evita-riferimenti-profondamente-annidati)
- [Struttura file di riferimento più lunghi con indice dei contenuti](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#struttura-file-di-riferimento-piu-lunghi-con-indice-dei-contenuti)
- [Flussi di lavoro e cicli di feedback](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#flussi-di-lavoro-e-cicli-di-feedback)
- [Usa flussi di lavoro per compiti complessi](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#usa-flussi-di-lavoro-per-compiti-complessi)
- [Implementa cicli di feedback](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#implementa-cicli-di-feedback)
- [Linee guida sui contenuti](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#linee-guida-sui-contenuti)
- [Evita informazioni sensibili al tempo](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#evita-informazioni-sensibili-al-tempo)
- [Usa terminologia coerente](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#usa-terminologia-coerente)
- [Modelli comuni](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#modelli-comuni)
- [Modello di template](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#modello-di-template)
- [Modello di esempi](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#modello-di-esempi)
- [Modello di flusso di lavoro condizionale](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#modello-di-flusso-di-lavoro-condizionale)
- [Valutazione e iterazione](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#valutazione-e-iterazione)
- [Costruisci valutazioni per prime](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#costruisci-valutazioni-per-prime)
- [Sviluppa Skills in modo iterativo con Claude](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#sviluppa-skills-in-modo-iterativo-con-claude)
- [Osserva come Claude naviga le Skills](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#osserva-come-claude-naviga-le-skills)
- [Anti-modelli da evitare](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#anti-modelli-da-evitare)
- [Evita percorsi in stile Windows](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#evita-percorsi-in-stile-windows)
- [Evita di offrire troppe opzioni](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#evita-di-offrire-troppe-opzioni)
- [Avanzate: Skills con codice eseguibile](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#avanzate-skills-con-codice-eseguibile)
- [Risolvi, non rimandare](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#risolvi-non-rimandare)
- [Fornisci script di utilità](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#fornisci-script-di-utilita)
- [Usa analisi visiva](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#usa-analisi-visiva)
- [Crea output intermedi verificabili](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#crea-output-intermedi-verificabili)
- [Pacchetto dipendenze](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#pacchetto-dipendenze)
- [Ambiente di runtime](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#ambiente-di-runtime)
- [Riferimenti a strumenti MCP](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#riferimenti-a-strumenti-mcp)
- [Evita di assumere che gli strumenti siano installati](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#evita-di-assumere-che-gli-strumenti-siano-installati)
- [Note tecniche](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#note-tecniche)
- [Requisiti del frontmatter YAML](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#requisiti-del-frontmatter-yaml)
- [Budget di token](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#budget-di-token)
- [Checklist per Skills efficaci](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#checklist-per-skills-efficaci)
- [Qualità di base](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#qualita-di-base)
- [Codice e script](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#codice-e-script)
- [Test](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#test)
- [Prossimi passaggi](https://platform.claude.com/docs/it/agents-and-tools/agent-skills/best-practices#prossimi-passaggi)
