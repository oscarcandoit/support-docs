---
url: "https://platform.claude.com/docs/it/about-claude/pricing"
title: "Prezzi - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fabout-claude%2Fpricing)
...
I modelli Claude sono disponibili su [AWS Bedrock](https://platform.claude.com/docs/it/build-with-claude/claude-on-amazon-bedrock), [Google Vertex AI](https://platform.claude.com/docs/it/build-with-claude/claude-on-vertex-ai), e [Microsoft Foundry](https://platform.claude.com/docs/it/build-with-claude/claude-in-microsoft-foundry). Per i prezzi ufficiali, visita:
...
- [Endpoint globali e regionali di AWS Bedrock](https://platform.claude.com/docs/it/build-with-claude/claude-on-amazon-bedrock#global-vs-regional-endpoints)
- [Endpoint globali e regionali di Google Vertex AI](https://platform.claude.com/docs/it/build-with-claude/claude-on-vertex-ai#global-vs-regional-endpoints)
...
Per ulteriori informazioni sull'elaborazione in batch, consulta la nostra [documentazione sull'elaborazione in batch](https://platform.claude.com/docs/it/build-with-claude/batch-processing).

### Prezzi del contesto lungo

Quando si utilizza Claude Sonnet 4 o Sonnet 4.5 con la [finestra di contesto di 1M token abilitata](https://platform.claude.com/docs/it/build-with-claude/context-windows#1m-token-context-window), le richieste che superano 200K token di input vengono automaticamente addebitate ai tassi di contesto lungo premium:

La finestra di contesto di 1M token è attualmente in beta per le organizzazioni nel [livello di utilizzo](https://platform.claude.com/docs/it/api/rate-limits) 4 e per le organizzazioni con limiti di velocità personalizzati. La finestra di contesto di 1M token è disponibile solo per Claude Sonnet 4 e Sonnet 4.5.
...
- Lo [sconto dell'API Batch del 50%](https://platform.claude.com/docs/it/about-claude/pricing#batch-processing) si applica ai prezzi del contesto lungo
- I [moltiplicatori del prompt caching](https://platform.claude.com/docs/it/about-claude/pricing#model-pricing) si applicano in aggiunta ai prezzi del contesto lungo
...
Per ulteriori informazioni sull'oggetto `usage`, consulta la [documentazione della risposta API](https://platform.claude.com/docs/it/api/messages#response-usage).
...
Per i prezzi attuali per modello, fai riferimento alla nostra sezione [prezzi dei modelli](https://platform.claude.com/docs/it/about-claude/pricing#model-pricing) sopra.

Per ulteriori informazioni sull'implementazione dell'uso degli strumenti e le best practice, consulta la nostra [documentazione sull'uso degli strumenti](https://platform.claude.com/docs/it/agents-and-tools/tool-use/overview).
...
Consulta [prezzi dell'uso degli strumenti](https://platform.claude.com/docs/it/about-claude/pricing#tool-use-pricing) per i dettagli completi sui prezzi.
...
Per una procedura dettagliata di questo calcolo, consulta la nostra [guida all'agente di supporto clienti](https://platform.claude.com/docs/it/about-claude/use-case-guides/customer-support-chat).
...
Per una guida completa sui modelli di prezzi degli agenti, consulta la nostra [guida ai casi d'uso degli agenti](https://platform.claude.com/docs/it/about-claude/use-case-guides).
...
Per informazioni dettagliate sui limiti di velocità, consulta la nostra [documentazione sui limiti di velocità](https://platform.claude.com/docs/it/api/rate-limits).
...
Contatta il nostro team di vendita a [sales@anthropic.com](mailto:sales@anthropic.com) o tramite la [Console Claude](https://platform.claude.com/settings/limits) per discutere le opzioni di prezzi Enterprise.
...
- Il tracciamento dell'utilizzo è disponibile nella [Console Claude](https://platform.claude.com/)
...
- [Prezzi dei modelli](https://platform.claude.com/docs/it/about-claude/pricing#prezzi-dei-modelli)
- [Prezzi delle piattaforme di terze parti](https://platform.claude.com/docs/it/about-claude/pricing#prezzi-delle-piattaforme-di-terze-parti)
- [Prezzi specifici delle funzionalità](https://platform.claude.com/docs/it/about-claude/pricing#prezzi-specifici-delle-funzionalita)
- [Elaborazione in batch](https://platform.claude.com/docs/it/about-claude/pricing#elaborazione-in-batch)
- [Prezzi del contesto lungo](https://platform.claude.com/docs/it/about-claude/pricing#prezzi-del-contesto-lungo)
- [Prezzi dell'uso degli strumenti](https://platform.claude.com/docs/it/about-claude/pricing#prezzi-dell-uso-degli-strumenti)
- [Prezzi di strumenti specifici](https://platform.claude.com/docs/it/about-claude/pricing#prezzi-di-strumenti-specifici)
- [Esempi di prezzi per i casi d'uso degli agenti](https://platform.claude.com/docs/it/about-claude/pricing#esempi-di-prezzi-per-i-casi-d-uso-degli-agenti)
- [Esempio di agente di supporto clienti](https://platform.claude.com/docs/it/about-claude/pricing#esempio-di-agente-di-supporto-clienti)
- [Prezzi del flusso di lavoro generale dell'agente](https://platform.claude.com/docs/it/about-claude/pricing#prezzi-del-flusso-di-lavoro-generale-dell-agente)
- [Strategie di ottimizzazione dei costi](https://platform.claude.com/docs/it/about-claude/pricing#strategie-di-ottimizzazione-dei-costi)
- [Considerazioni aggiuntive sui prezzi](https://platform.claude.com/docs/it/about-claude/pricing#considerazioni-aggiuntive-sui-prezzi)
- [Limiti di velocità](https://platform.claude.com/docs/it/about-claude/pricing#limiti-di-velocita)
- [Sconti per volume](https://platform.claude.com/docs/it/about-claude/pricing#sconti-per-volume)
- [Prezzi Enterprise](https://platform.claude.com/docs/it/about-claude/pricing#prezzi-enterprise)
- [Fatturazione e pagamento](https://platform.claude.com/docs/it/about-claude/pricing#fatturazione-e-pagamento)
- [Domande frequenti](https://platform.claude.com/docs/it/about-claude/pricing#domande-frequenti)
