...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fapi%2Ftypescript%2Fcompletions%2Fcreate)
...
client.completions.create(CompletionCreateParamsparams, RequestOptionsoptions?): [Completion](https://platform.claude.com/docs/en/api/completions#completion) {id, completion, model, 2 more} \|Stream<[Completion](https://platform.claude.com/docs/en/api/completions#completion) {id, completion, model, 2 more} >
