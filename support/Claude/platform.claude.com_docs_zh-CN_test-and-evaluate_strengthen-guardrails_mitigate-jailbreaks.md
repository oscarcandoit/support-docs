...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fmitigate-jailbreaks)
...
- [harmlessness\_screen工具内的提示](https://platform.claude.com/docs/zh-CN/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#harmlessness-screen)
