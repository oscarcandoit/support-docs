...
title: "Claude on Amazon Bedrock - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fbuild-with-claude%2Fclaude-on-amazon-bedrock)
...
- [Install and configure the AWS CLI](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#install-and-configure-the-aws-cli)
- [Install an SDK for accessing Bedrock](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#install-an-sdk-for-accessing-bedrock)
- [Accessing Bedrock](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#accessing-bedrock)
- [Subscribe to Anthropic models](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#subscribe-to-anthropic-models)
- [List available models](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#list-available-models)
- [Making requests](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#making-requests)
- [Activity logging](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#activity-logging)
- [Feature support](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#feature-support)
- [PDF Support on Bedrock](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#pdf-support-on-bedrock)
- [1M token context window](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#1-m-token-context-window)
- [Global vs regional endpoints](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#global-vs-regional-endpoints)
- [When to use each option](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#when-to-use-each-option)
- [Implementation](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#implementation)
- [Additional resources](https://platform.claude.com/docs/en/build-with-claude/claude-on-amazon-bedrock#additional-resources)
