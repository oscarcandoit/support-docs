---
url: "https://platform.claude.com/docs/ja/agents-and-tools/remote-mcp-servers"
title: "リモートMCPサーバー - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fagents-and-tools%2Fremote-mcp-servers)
...
Claude APIでリモートMCPサーバーを使用することについての詳細情報は、 [MCPコネクタドキュメント](https://platform.claude.com/docs/ja/agents-and-tools/mcp-connector) を参照してください。
...
- [リモートMCPサーバーへの接続](https://platform.claude.com/docs/ja/agents-and-tools/remote-mcp-servers#mcp)
- [リモートMCPサーバーの例](https://platform.claude.com/docs/ja/agents-and-tools/remote-mcp-servers#mcp-2)
