---
url: "https://platform.claude.com/docs/ja/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks"
title: "ジェイルブレイクとプロンプトインジェクションを軽減する - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fmitigate-jailbreaks)
...
### 例: 金融アドバイザーチャットボットのための多層保護

これらの戦略を層状に組み合わせることで、ジェイルブレイクとプロンプトインジェクションに対する堅牢な防御を構築し、Claudeを活用したアプリケーションが最高水準の安全性とコンプライアンスを維持することを確保できます。

- [harmlessness\_screenツール内のプロンプト](https://platform.claude.com/docs/ja/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks#harmlessness-screen)
