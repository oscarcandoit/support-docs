---
url: "https://platform.claude.com/docs/ru/build-with-claude/working-with-messages"
title: "Использование Messages API - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fbuild-with-claude%2Fworking-with-messages)
...
Это руководство охватывает распространённые паттерны работы с Messages API, включая базовые запросы, многоходовые диалоги, техники предзаполнения и возможности работы с изображениями. Полные спецификации API см. в [справочнике Messages API](https://platform.claude.com/docs/ru/api/messages).

## Базовый запрос и ответ

- [Базовый запрос и ответ](https://platform.claude.com/docs/ru/build-with-claude/working-with-messages#bazoviy-zapros-i-otvet)
- [Несколько ходов диалога](https://platform.claude.com/docs/ru/build-with-claude/working-with-messages#neskolko-khodov-dialoga)
- [Вкладываем слова в уста Claude](https://platform.claude.com/docs/ru/build-with-claude/working-with-messages#vkladyvaem-slova-v-usta-claude)
- [Работа с изображениями](https://platform.claude.com/docs/ru/build-with-claude/working-with-messages#rabota-s-izobrazheniyami)
- [Использование инструментов и управление компьютером](https://platform.claude.com/docs/ru/build-with-claude/working-with-messages#ispolzovanie-instrumentov-i-upravlenie-kompyuterom)