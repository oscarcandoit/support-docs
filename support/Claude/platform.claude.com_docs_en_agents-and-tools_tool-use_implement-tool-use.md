...
title: "How to implement tool use - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagents-and-tools%2Ftool-use%2Fimplement-tool-use)
...
If using Claude with tool use and extended thinking, refer to our guide [here](https://platform.claude.com/docs/en/build-with-claude/extended-thinking) for more information.
...
| `input_examples` | (Optional, beta) An array of example input objects to help Claude understand how to use the tool. See [Providing tool use examples](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#providing-tool-use-examples). |
...
- **Prioritize descriptions, but consider using `input_examples` for complex tools.** Clear descriptions are most important, but for tools with complex inputs, nested objects, or format-sensitive parameters, you can use the `input_examples` field (beta) to provide schema-validated examples. See [Providing tool use examples](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#providing-tool-use-examples) for details.
...
Tool use examples is a beta feature. Include the appropriate [beta header](https://platform.claude.com/docs/en/api/beta-headers) for your provider:
...
Claude Sonnet 3.7 may be less likely to make make parallel tool calls in a response, even when you have not set `disable_parallel_tool_use`. We recommend [upgrading to Claude 4 models](https://platform.claude.com/docs/en/about-claude/models/migrating-to-claude-4), which have built-in token-efficient tool use and improved parallel tool calling.
...
- [Choosing a model](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#choosing-a-model)
- [Specifying client tools](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#specifying-client-tools)
- [Tool use system prompt](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#tool-use-system-prompt)
- [Best practices for tool definitions](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#best-practices-for-tool-definitions)
- [Providing tool use examples](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#providing-tool-use-examples)
- [Basic usage](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#basic-usage)
- [Requirements and limitations](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#requirements-and-limitations)
- [Tool runner (beta)](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#tool-runner-beta)
- [Basic usage](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#basic-usage-2)
- [Iterating over the tool runner](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#iterating-over-the-tool-runner)
- [Advanced usage](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#advanced-usage)
- [Streaming](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#streaming)
- [Basic usage](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#basic-usage-3)
- [Iterating over the tool runner](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#iterating-over-the-tool-runner-2)
- [Advanced usage](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#advanced-usage-2)
- [Streaming](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#streaming-2)
- [Basic usage](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#basic-usage-4)
- [Iterating over the tool runner](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#iterating-over-the-tool-runner-3)
- [Advanced usage](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#advanced-usage-3)
- [Streaming](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#streaming-3)
- [Basic usage](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#basic-usage-5)
- [Iterating over the tool runner](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#iterating-over-the-tool-runner-4)
- [Advanced usage](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#advanced-usage-4)
- [Streaming](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#streaming-4)
- [Controlling Claude's output](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#controlling-claudes-output)
- [Forcing tool use](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#forcing-tool-use)
- [JSON output](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#json-output)
- [Model responses with tools](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#model-responses-with-tools)
- [Parallel tool use](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#parallel-tool-use)
- [Handling tool use and tool result content blocks](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#handling-tool-use-and-tool-result-content-blocks)
- [Handling results from client tools](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#handling-results-from-client-tools)
- [Handling results from server tools](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#handling-results-from-server-tools)
- [Handling the max\_tokens stop reason](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#handling-the-max-tokens-stop-reason)
- [Troubleshooting errors](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use#troubleshooting-errors)
