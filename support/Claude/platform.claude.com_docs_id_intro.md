...
title: "Pengenalan Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fintro)
...
[Memulai\\
\\
Siapkan lingkungan pengembangan Anda untuk membangun dengan Claude.](https://platform.claude.com/docs/id/get-started) [Pelajari tentang Claude\\
\\
Pelajari tentang keluarga model Claude.](https://platform.claude.com/docs/id/about-claude/models/overview) [Perpustakaan Prompt\\
\\
Jelajahi contoh prompt untuk inspirasi.](https://platform.claude.com/docs/id/resources/prompt-library/library)
...
[Developer Console\\
\\
Nikmati prompting yang lebih mudah dan lebih kuat di browser Anda dengan Workbench dan alat pembuat prompt.](https://platform.claude.com/) [Referensi API\\
\\
Jelajahi, implementasikan, dan skalakan dengan Claude API dan SDK.](https://platform.claude.com/docs/id/api/overview) [Claude Cookbook\\
\\
Pelajari dengan notebook Jupyter interaktif yang mendemonstrasikan pengunggahan PDF, embeddings, dan banyak lagi.](https://github.com/anthropics/anthropic-cookbook)
...
\\
Ringkas teks, jawab pertanyaan, ekstrak data, terjemahkan teks, dan jelaskan serta hasilkan kode.](https://platform.claude.com/docs/id/build-with-claude/text-generation) [Visi\\
\\
Proses dan analisis input visual serta hasilkan teks dan kode dari gambar.](https://platform.claude.com/docs/id/build-with-claude/vision)
...
[Pusat Bantuan\\
\\
Temukan jawaban atas pertanyaan akun dan penagihan yang sering diajukan.](https://support.claude.com/en/) [Status Layanan\\
\\
Periksa status layanan Anthropic.](https://status.claude.com/)

- [Memulai](https://platform.claude.com/docs/id/intro#memulai)
- [Kembangkan dengan Claude](https://platform.claude.com/docs/id/intro#kembangkan-dengan-claude)
- [Kemampuan utama](https://platform.claude.com/docs/id/intro#kemampuan-utama)
- [Dukungan](https://platform.claude.com/docs/id/intro#dukungan)
