---
url: "https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/system-prompts"
title: "Dare a Claude un ruolo con un prompt di sistema - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fbuild-with-claude%2Fprompt-engineering%2Fsystem-prompts)
...
Dai a Claude un ruolo (prompt di sistema)
...
**Suggerimenti per il prompt di sistema**: Usa il parametro `system` per impostare il ruolo di Claude. Metti tutto il resto, come le istruzioni specifiche del compito, nel turno `user` invece.
...
Usa il parametro `system` nell' [API Messages](https://platform.claude.com/docs/it/api/messages) per impostare il ruolo di Claude:
...
**Suggerimento per il role prompting**: Sperimenta con i ruoli! Un `data scientist` potrebbe vedere intuizioni diverse rispetto a un `marketing strategist` per gli stessi dati. Un `data scientist specializing in customer insight analysis for Fortune 500 companies` potrebbe produrre risultati ancora diversi!
...
- [Perché usare il role prompting?](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/system-prompts#perche-usare-il-role-prompting)
- [Come assegnare un ruolo a Claude](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/system-prompts#come-assegnare-un-ruolo-a-claude)
- [Esempi](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/system-prompts#esempi)
- [Esempio 1: Analisi di contratti legali](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/system-prompts#esempio-1-analisi-di-contratti-legali)
- [Esempio 2: Analisi finanziaria](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/system-prompts#esempio-2-analisi-finanziaria)
