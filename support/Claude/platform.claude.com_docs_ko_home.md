---
url: "https://platform.claude.com/docs/ko/home"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fko%2Fhome)
...
Claude 개발자 플랫폼 및 Claude Code를 시작하는 방법을 알아보세요.

Claude에게 문서에 대해 물어보세요...
...
[시작하기\\
\\
몇 분 안에 첫 번째 API 호출을 만드세요.](https://platform.claude.com/docs/ko/get-started) [기능 개요\\
\\
Claude에서 이제 사용 가능한 고급 기능 및 기능을 살펴보세요.](https://platform.claude.com/docs/ko/api/overview) [Claude 4.5의 새로운 기능\\
\\
Claude 4.5 모델의 최신 발전 사항을 발견하세요.](https://platform.claude.com/docs/ko/about-claude/models/whats-new-claude-4-5) [API 참조\\
\\
API 및 SDK를 사용하여 통합하고 확장하세요.](https://platform.claude.com/docs/ko/api/overview) [Claude 콘솔\\
\\
브라우저에서 직접 강력한 프롬프트를 작성하고 테스트하세요.](https://platform.claude.com/) [릴리스 노트\\
\\
Claude 개발자 플랫폼의 변경 사항 및 새로운 기능에 대해 알아보세요.](https://platform.claude.com/docs/ko/release-notes/api)

## Claude Code

[Claude Code 빠른 시작\\
\\
Claude Code를 시작하세요.](https://code.claude.com/docs/ko/quickstart) [Claude Code 참조\\
\\
기능 구현 및 구성에 대한 세부 정보는 Claude Code 참조 문서를 참조하세요.](https://code.claude.com/docs/ko/overview) [Claude Code 변경 로그\\
\\
Claude Code의 변경 사항 및 새로운 기능에 대해 알아보세요.](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md)

## 학습 리소스

[Anthropic 과정\\
\\
Anthropic의 교육 과정 및 프로젝트를 살펴보세요.](https://anthropic.skilljar.com/) [Claude Cookbook\\
\\
재현 가능한 코드 샘플 및 구현을 확인하세요.](https://github.com/anthropics/anthropic-cookbook) [Claude 빠른 시작\\
\\
API로 빌드된 배포 가능한 애플리케이션입니다.](https://github.com/anthropics/anthropic-quickstarts)
