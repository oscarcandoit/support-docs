---
url: "https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices"
title: "Melhores práticas de autoria de Skills - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
Para informações conceituais sobre como Skills funcionam, consulte a [visão geral de Skills](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/overview).

## Princípios principais

### Concisão é fundamental

A [janela de contexto](https://platform.claude.com/docs/pt-BR/build-with-claude/context-windows) é um bem público. Sua Skill compartilha a janela de contexto com tudo mais que Claude precisa saber, incluindo:
...
Para detalhes completos da estrutura de Skill, consulte a [visão geral de Skills](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/overview#skill-structure).
...
SKILL.md serve como uma visão geral que aponta Claude para materiais detalhados conforme necessário, como um índice em um guia de integração. Para uma explicação de como a divulgação progressiva funciona, consulte [Como Skills funcionam](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/overview#how-skills-work) na visão geral.
...
![Arquivo SKILL.md simples mostrando frontmatter YAML e corpo markdown](https://platform.claude.com/docs/images/agent-skills-simple-file.png)

Conforme sua Skill cresce, você pode agrupar conteúdo adicional que Claude carrega apenas quando necessário:

![Agrupando arquivos de referência adicionais como reference.md e forms.md.](https://platform.claude.com/docs/images/agent-skills-bundling-content.png)
...
Para detalhes sobre como essa arquitetura baseada em sistema de arquivos permite divulgação progressiva, consulte a seção [Ambiente de execução](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#runtime-environment) na seção Avançado abaixo.
...
Isso mostra o padrão de loop de validação usando documentos de referência em vez de scripts. O "validador" é STYLE\_GUIDE.md, e Claude realiza a verificação lendo e comparando.
...
As seções abaixo focam em Skills que incluem scripts executáveis. Se sua Skill usa apenas instruções markdown, pule para [Lista de verificação para Skills eficazes](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#checklist-for-effective-skills).
...
![Agrupando scripts executáveis junto com arquivos de instrução](https://platform.claude.com/docs/images/agent-skills-executable-scripts.png)
...
Para a maioria dos scripts utilitários, execução é preferida porque é mais confiável e eficiente. Consulte a seção [Ambiente de execução](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#runtime-environment) abaixo para detalhes sobre como execução de script funciona.
...
**Dica de implementação**: Faça scripts de validação verbosos com mensagens de erro específicas como "Campo 'signature\_date' não encontrado. Campos disponíveis: customer\_name, order\_total, signature\_date\_signed" para ajudar Claude a corrigir problemas.
...
Liste pacotes necessários em seu SKILL.md e verifique se estão disponíveis na [documentação da ferramenta de execução de código](https://platform.claude.com/docs/pt-BR/agents-and-tools/tool-use/code-execution-tool).

### Ambiente de execução

Skills executam em um ambiente de execução de código com acesso ao sistema de arquivos, comandos bash e capacidades de execução de código. Para a explicação conceitual dessa arquitetura, consulte [A arquitetura de Skills](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/overview#the-skills-architecture) na visão geral.
...
Para detalhes técnicos completos, consulte [Como Skills funcionam](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/overview#how-skills-work) na visão geral de Skills.
...
Consulte a [visão geral de Skills](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/overview#skill-structure) para detalhes completos de estrutura.

### Orçamentos de token

Mantenha o corpo de SKILL.md abaixo de 500 linhas para desempenho ideal. Se seu conteúdo exceder isso, divida-o em arquivos separados usando os padrões de divulgação progressiva descritos anteriormente. Para detalhes arquiteturais, consulte a [visão geral de Skills](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/overview#how-skills-work).
...
\\
Crie sua primeira Skill](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/quickstart) [Use Skills no Claude Code\\
\\
Crie e gerencie Skills no Claude Code](https://code.claude.com/docs/skills) [Use Skills no Agent SDK\\
\\
Use Skills programaticamente em TypeScript e Python](https://platform.claude.com/docs/pt-BR/agent-sdk/skills) [Use Skills com a API\\
\\
Carregue e use Skills programaticamente](https://platform.claude.com/docs/pt-BR/build-with-claude/skills-guide)

- [Princípios principais](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#principios-principais)
- [Concisão é fundamental](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#concisao-e-fundamental)
- [Defina graus apropriados de liberdade](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#defina-graus-apropriados-de-liberdade)
- [Teste com todos os modelos que você planeja usar](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#teste-com-todos-os-modelos-que-voce-planeja-usar)
- [Estrutura de Skill](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#estrutura-de-skill)
- [Convenções de nomenclatura](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#convencoes-de-nomenclatura)
- [Escrevendo descrições eficazes](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#escrevendo-descricoes-eficazes)
- [Padrões de divulgação progressiva](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#padroes-de-divulgacao-progressiva)
- [Evite referências profundamente aninhadas](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#evite-referencias-profundamente-aninhadas)
- [Estruture arquivos de referência mais longos com índice](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#estruture-arquivos-de-referencia-mais-longos-com-indice)
- [Fluxos de trabalho e loops de feedback](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#fluxos-de-trabalho-e-loops-de-feedback)
- [Use fluxos de trabalho para tarefas complexas](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#use-fluxos-de-trabalho-para-tarefas-complexas)
- [Implemente loops de feedback](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#implemente-loops-de-feedback)
- [Diretrizes de conteúdo](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#diretrizes-de-conteudo)
- [Evite informações sensíveis ao tempo](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#evite-informacoes-sensiveis-ao-tempo)
- [Use terminologia consistente](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#use-terminologia-consistente)
- [Padrões comuns](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#padroes-comuns)
- [Padrão de modelo](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#padrao-de-modelo)
- [Padrão de exemplos](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#padrao-de-exemplos)
- [Padrão de fluxo de trabalho condicional](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#padrao-de-fluxo-de-trabalho-condicional)
- [Avaliação e iteração](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#avaliacao-e-iteracao)
- [Construa avaliações primeiro](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#construa-avaliacoes-primeiro)
- [Desenvolva Skills iterativamente com Claude](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#desenvolva-skills-iterativamente-com-claude)
- [Observe como Claude navega Skills](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#observe-como-claude-navega-skills)
- [Anti-padrões a evitar](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#anti-padroes-a-evitar)
- [Evite caminhos de estilo Windows](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#evite-caminhos-de-estilo-windows)
- [Evite oferecer muitas opções](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#evite-oferecer-muitas-opcoes)
- [Avançado: Skills com código executável](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#avancado-skills-com-codigo-executavel)
- [Resolva, não transfira](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#resolva-nao-transfira)
- [Forneça scripts utilitários](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#forneca-scripts-utilitarios)
- [Use análise visual](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#use-analise-visual)
- [Crie saídas intermediárias verificáveis](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#crie-saidas-intermediarias-verificaveis)
- [Empacote dependências](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#empacote-dependencias)
- [Ambiente de execução](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#ambiente-de-execucao)
- [Referências de ferramenta MCP](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#referencias-de-ferramenta-mcp)
- [Evite assumir que ferramentas estão instaladas](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#evite-assumir-que-ferramentas-estao-instaladas)
- [Notas técnicas](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#notas-tecnicas)
- [Requisitos de frontmatter YAML](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#requisitos-de-frontmatter-yaml)
- [Orçamentos de token](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#orcamentos-de-token)
- [Lista de verificação para Skills eficazes](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#lista-de-verificacao-para-skills-eficazes)
- [Qualidade principal](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#qualidade-principal)
- [Código e scripts](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#codigo-e-scripts)
- [Teste](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#teste)
- [Próximos passos](https://platform.claude.com/docs/pt-BR/agents-and-tools/agent-skills/best-practices#proximos-passos)
