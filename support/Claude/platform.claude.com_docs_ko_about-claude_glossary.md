---
url: "https://platform.claude.com/docs/ko/about-claude/glossary"
title: "용어집 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fko%2Fabout-claude%2Fglossary)
...
자세한 내용은 [컨텍스트 윈도우 이해 가이드](https://platform.claude.com/docs/ko/build-with-claude/context-windows) 를 참조하세요.
...
Model Context Protocol(MCP)은 애플리케이션이 LLM에 컨텍스트를 제공하는 방법을 표준화하는 개방형 프로토콜입니다. AI 애플리케이션을 위한 USB-C 포트와 같이, MCP는 AI 모델을 다양한 데이터 소스와 도구에 연결하는 통합된 방법을 제공합니다. MCP는 AI 시스템이 상호작용 간에 일관된 컨텍스트를 유지하고 표준화된 방식으로 외부 리소스에 액세스할 수 있게 합니다. 자세한 내용은 [MCP 문서](https://platform.claude.com/docs/ko/mcp) 를 참조하세요.

## MCP 커넥터

MCP 커넥터는 API 사용자가 MCP 클라이언트를 구축하지 않고도 Messages API에서 직접 MCP 서버에 연결할 수 있게 하는 기능입니다. 이를 통해 Claude API를 통해 MCP 호환 도구 및 서비스와 원활하게 통합할 수 있습니다. MCP 커넥터는 도구 호출과 같은 기능을 지원하며 공개 베타로 제공됩니다. 자세한 내용은 [MCP 커넥터 문서](https://platform.claude.com/docs/ko/agents-and-tools/mcp-connector) 를 참조하세요.
...
- [HHH](https://platform.claude.com/docs/ko/about-claude/glossary#hhh)
- [LLM](https://platform.claude.com/docs/ko/about-claude/glossary#llm)
- [MCP (Model Context Protocol)](https://platform.claude.com/docs/ko/about-claude/glossary#mcp-model-context-protocol)
- [MCP 커넥터](https://platform.claude.com/docs/ko/about-claude/glossary#mcp)
- [RAG (검색 증강 생성)](https://platform.claude.com/docs/ko/about-claude/glossary#rag)
- [RLHF](https://platform.claude.com/docs/ko/about-claude/glossary#rlhf)
- [TTFT (첫 번째 토큰까지의 시간)](https://platform.claude.com/docs/ko/about-claude/glossary#ttft)
