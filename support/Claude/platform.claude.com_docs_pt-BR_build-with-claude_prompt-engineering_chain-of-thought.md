---
url: "https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/chain-of-thought"
title: "Deixe Claude pensar (prompting de cadeia de pensamento) para aumentar o desempenho - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Fbuild-with-claude%2Fprompt-engineering%2Fchain-of-thought)
...
- **Prompt básico**: Inclua "Pense passo a passo" em seu prompt.
  ...
  - Falta orientação sobre _como_ pensar (o que é especialmente não ideal se uma tarefa é muito específica para seu aplicativo, caso de uso ou organização)

### Exemplo: Escrevendo emails de doadores (CoT básico)
...
### Exemplo: Escrevendo emails de doadores (CoT orientado)
...
### Exemplo: Escrevendo emails de doadores (CoT orientado estruturado)


### Exemplos

### Exemplo: Análise financeira sem pensamento

### Exemplo: Análise financeira com pensamento

* * *

[Biblioteca de prompts\\
\\
Obtenha inspiração de uma seleção curada de prompts para várias tarefas e casos de uso.](https://platform.claude.com/docs/pt-BR/resources/prompt-library/library) [Tutorial de prompting do GitHub\\
\\
...
\\
Uma versão mais leve de nosso tutorial de engenharia de prompts através de uma planilha interativa.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Antes de implementar CoT](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/chain-of-thought#antes-de-implementar-co-t)
- [Por que deixar Claude pensar?](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/chain-of-thought#por-que-deixar-claude-pensar)
- [Por que não deixar Claude pensar?](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/chain-of-thought#por-que-nao-deixar-claude-pensar)
- [Como fazer prompting para pensamento](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/chain-of-thought#como-fazer-prompting-para-pensamento)
- [Exemplos](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/chain-of-thought#exemplos)
