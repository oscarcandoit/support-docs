---
url: "https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview"
title: "Habilidades del Agente - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fagents-and-tools%2Fagent-skills%2Foverview)
...
**Las Habilidades del Agente precompiladas** están disponibles para todos los usuarios en claude.ai y a través de la API de Claude. Consulta la sección [Habilidades disponibles](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#available-skills) a continuación para obtener la lista completa.
...
- Para Habilidades del Agente precompiladas: Consulta el [tutorial de inicio rápido](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/quickstart) para comenzar a usar las habilidades de PowerPoint, Excel, Word y PDF en la API
...
**Código**: Scripts ejecutables (fill\_form.py, validate.py) que Claude ejecuta a través de bash; los scripts proporcionan operaciones deterministas sin consumir contexto
...
Para obtener más información, consulta [Usar Habilidades con la API de Claude](https://platform.claude.com/docs/es/build-with-claude/skills-guide).
...
El [Claude Agent SDK](https://platform.claude.com/docs/es/agent-sdk/overview) admite Habilidades personalizadas a través de configuración basada en el sistema de archivos.
...
Para obtener más información, consulta [Habilidades del Agente en el SDK](https://platform.claude.com/docs/es/agent-sdk/skills).
...
La `description` debe incluir tanto qué hace la Habilidad como cuándo Claude debe usarla. Para obtener orientación completa de autoría, consulta la [guía de mejores prácticas](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/best-practices).
...
Estas Habilidades están disponibles en la API de Claude y claude.ai. Consulta el [tutorial de inicio rápido](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/quickstart) para comenzar a usarlas en la API.
...
- **Solo dependencias preconfiguradas**: Consulta la [documentación de la herramienta de ejecución de código](https://platform.claude.com/docs/es/agents-and-tools/tool-use/code-execution-tool) para obtener la lista de paquetes disponibles

Planifica tus Habilidades para que funcionen dentro de estas restricciones.

## Próximos pasos

[Comenzar con Habilidades del Agente\\
\\
Crea tu primera Habilidad](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/quickstart) [Guía de API\\
\\
Usar Habilidades con la API de Claude](https://platform.claude.com/docs/es/build-with-claude/skills-guide) [Usar Habilidades en Claude Code\\
\\
Crear y administrar Habilidades personalizadas en Claude Code](https://code.claude.com/docs/skills) [Usar Habilidades en el Agent SDK\\
\\
Usar Habilidades programáticamente en TypeScript y Python](https://platform.claude.com/docs/es/agent-sdk/skills) [Mejores prácticas de autoría\\
\\
Escribir Habilidades que Claude pueda usar efectivamente](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/best-practices)

- [Por qué usar Habilidades](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#por-que-usar-habilidades)
- [Usar Habilidades](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#usar-habilidades)
- [Cómo funcionan las Habilidades](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#como-funcionan-las-habilidades)
- [Tres tipos de contenido de Habilidad, tres niveles de carga](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#tres-tipos-de-contenido-de-habilidad-tres-niveles-de-carga)
- [Nivel 1: Metadatos (siempre cargados)](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#nivel-1-metadatos-siempre-cargados)
- [Nivel 2: Instrucciones (cargadas cuando se activan)](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#nivel-2-instrucciones-cargadas-cuando-se-activan)
- [Nivel 3: Recursos y código (cargados según sea necesario)](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#nivel-3-recursos-y-codigo-cargados-segun-sea-necesario)
- [La arquitectura de Habilidades](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#la-arquitectura-de-habilidades)
- [Ejemplo: Cargando una habilidad de procesamiento de PDF](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#ejemplo-cargando-una-habilidad-de-procesamiento-de-pdf)
- [Dónde funcionan las Habilidades](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#donde-funcionan-las-habilidades)
- [Claude API](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#claude-api)
- [Claude Code](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#claude-code)
- [Claude Agent SDK](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#claude-agent-sdk)
- [Claude.ai](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#claude-ai)
- [Estructura de Habilidad](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#estructura-de-habilidad)
- [Consideraciones de seguridad](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#consideraciones-de-seguridad)
- [Habilidades disponibles](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#habilidades-disponibles)
- [Habilidades del Agente precompiladas](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#habilidades-del-agente-precompiladas)
- [Ejemplos de Habilidades personalizadas](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#ejemplos-de-habilidades-personalizadas)
- [Limitaciones y restricciones](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#limitaciones-y-restricciones)
- [Disponibilidad entre superficies](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#disponibilidad-entre-superficies)
- [Alcance de compartición](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#alcance-de-comparticion)
- [Restricciones del entorno de ejecución](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#restricciones-del-entorno-de-ejecucion)
- [Próximos pasos](https://platform.claude.com/docs/es/agents-and-tools/agent-skills/overview#proximos-pasos)
