---
url: "https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices"
title: "Best Practices für die Skill-Erstellung - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fde%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
[Einführung in Claude](https://platform.claude.com/docs/de/intro) [Schnelleinstieg](https://platform.claude.com/docs/de/get-started)

Modelle & Preise

[Modellübersicht](https://platform.claude.com/docs/de/about-claude/models/overview) [Modell auswählen](https://platform.claude.com/docs/de/about-claude/models/choosing-a-model) [Neuerungen in Claude 4.5](https://platform.claude.com/docs/de/about-claude/models/whats-new-claude-4-5) [Migration zu Claude 4.5](https://platform.claude.com/docs/de/about-claude/models/migrating-to-claude-4) [Modellabschreibungen](https://platform.claude.com/docs/de/about-claude/model-deprecations) [Preise](https://platform.claude.com/docs/de/about-claude/pricing)

Mit Claude erstellen

[Funktionsübersicht](https://platform.claude.com/docs/de/build-with-claude/overview) [Messages API verwenden](https://platform.claude.com/docs/de/build-with-claude/working-with-messages) [Kontextfenster](https://platform.claude.com/docs/de/build-with-claude/context-windows) [Best Practices für Prompts](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/claude-4-best-practices)

Fähigkeiten

[Prompt Caching](https://platform.claude.com/docs/de/build-with-claude/prompt-caching) [Kontext-Bearbeitung](https://platform.claude.com/docs/de/build-with-claude/context-editing) [Extended Thinking](https://platform.claude.com/docs/de/build-with-claude/extended-thinking) [Aufwand](https://platform.claude.com/docs/de/build-with-claude/effort) [Streaming Messages](https://platform.claude.com/docs/de/build-with-claude/streaming) [Batch-Verarbeitung](https://platform.claude.com/docs/de/build-with-claude/batch-processing) [Zitate](https://platform.claude.com/docs/de/build-with-claude/citations) [Mehrsprachige Unterstützung](https://platform.claude.com/docs/de/build-with-claude/multilingual-support) [Token-Zählung](https://platform.claude.com/docs/de/build-with-claude/token-counting) [Embeddings](https://platform.claude.com/docs/de/build-with-claude/embeddings) [Vision](https://platform.claude.com/docs/de/build-with-claude/vision) [PDF-Unterstützung](https://platform.claude.com/docs/de/build-with-claude/pdf-support) [Files API](https://platform.claude.com/docs/de/build-with-claude/files) [Suchergebnisse](https://platform.claude.com/docs/de/build-with-claude/search-results) [Strukturierte Ausgaben](https://platform.claude.com/docs/de/build-with-claude/structured-outputs)

Tools

[Übersicht](https://platform.claude.com/docs/de/agents-and-tools/tool-use/overview) [Tool-Nutzung implementieren](https://platform.claude.com/docs/de/agents-and-tools/tool-use/implement-tool-use) [Feingranulares Tool-Streaming](https://platform.claude.com/docs/de/agents-and-tools/tool-use/fine-grained-tool-streaming) [Bash-Tool](https://platform.claude.com/docs/de/agents-and-tools/tool-use/bash-tool) [Code-Ausführungs-Tool](https://platform.claude.com/docs/de/agents-and-tools/tool-use/code-execution-tool) [Programmatischer Tool-Aufruf](https://platform.claude.com/docs/de/agents-and-tools/tool-use/programmatic-tool-calling) [Computer-Use-Tool](https://platform.claude.com/docs/de/agents-and-tools/tool-use/computer-use-tool) [Text-Editor-Tool](https://platform.claude.com/docs/de/agents-and-tools/tool-use/text-editor-tool) [Web-Abruf-Tool](https://platform.claude.com/docs/de/agents-and-tools/tool-use/web-fetch-tool) [Web-Such-Tool](https://platform.claude.com/docs/de/agents-and-tools/tool-use/web-search-tool) [Memory-Tool](https://platform.claude.com/docs/de/agents-and-tools/tool-use/memory-tool) [Tool-Such-Tool](https://platform.claude.com/docs/de/agents-and-tools/tool-use/tool-search-tool)

Agent Skills

[Übersicht](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/overview) [Schnelleinstieg](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/quickstart) [Best Practices](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices) [Skills mit der API verwenden](https://platform.claude.com/docs/de/build-with-claude/skills-guide)

Agent SDK

[Übersicht](https://platform.claude.com/docs/de/agent-sdk/overview) [Schnelleinstieg](https://platform.claude.com/docs/de/agent-sdk/quickstart) [TypeScript SDK](https://platform.claude.com/docs/de/agent-sdk/typescript) [TypeScript V2 (Vorschau)](https://platform.claude.com/docs/de/agent-sdk/typescript-v2-preview) [Python SDK](https://platform.claude.com/docs/de/agent-sdk/python) [Migrationsleitfaden](https://platform.claude.com/docs/de/agent-sdk/migration-guide)

Leitfäden

MCP in der API

[MCP-Connector](https://platform.claude.com/docs/de/agents-and-tools/mcp-connector) [Remote MCP-Server](https://platform.claude.com/docs/de/agents-and-tools/remote-mcp-servers)

Claude auf Plattformen von Drittanbietern

[Amazon Bedrock](https://platform.claude.com/docs/de/build-with-claude/claude-on-amazon-bedrock) [Microsoft Foundry](https://platform.claude.com/docs/de/build-with-claude/claude-in-microsoft-foundry) [Vertex AI](https://platform.claude.com/docs/de/build-with-claude/claude-on-vertex-ai)

Prompt Engineering

[Übersicht](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/overview) [Prompt-Generator](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/prompt-generator) [Prompt-Vorlagen verwenden](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/prompt-templates-and-variables) [Prompt-Verbesserer](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/prompt-improver) [Klar und direkt sein](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/be-clear-and-direct) [Beispiele verwenden (Multishot Prompting)](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/multishot-prompting) [Claude denken lassen (CoT)](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/chain-of-thought) [XML-Tags verwenden](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/use-xml-tags) [Claude eine Rolle geben (System-Prompts)](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/system-prompts) [Claudeʼs Antwort vorausfüllen](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/prefill-claudes-response) [Komplexe Prompts verketten](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/chain-prompts) [Tipps für langen Kontext](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/long-context-tips) [Extended Thinking Tipps](https://platform.claude.com/docs/de/build-with-claude/prompt-engineering/extended-thinking-tips)

Testen & Evaluieren

[Erfolgskriterien definieren](https://platform.claude.com/docs/de/test-and-evaluate/define-success) [Testfälle entwickeln](https://platform.claude.com/docs/de/test-and-evaluate/develop-tests) [Evaluierungs-Tool verwenden](https://platform.claude.com/docs/de/test-and-evaluate/eval-tool) [Latenz reduzieren](https://platform.claude.com/docs/de/test-and-evaluate/strengthen-guardrails/reduce-latency)

Schutzmaßnahmen verstärken

[Halluzinationen reduzieren](https://platform.claude.com/docs/de/test-and-evaluate/strengthen-guardrails/reduce-hallucinations) [Ausgabekonsistenz erhöhen](https://platform.claude.com/docs/de/test-and-evaluate/strengthen-guardrails/increase-consistency) [Jailbreaks abschwächen](https://platform.claude.com/docs/de/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks) [Streaming-Ablehnungen](https://platform.claude.com/docs/de/test-and-evaluate/strengthen-guardrails/handle-streaming-refusals) [Prompt-Leak reduzieren](https://platform.claude.com/docs/de/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak) [Claude im Charakter halten](https://platform.claude.com/docs/de/test-and-evaluate/strengthen-guardrails/keep-claude-in-character)

Verwaltung und Überwachung

[Admin API Übersicht](https://platform.claude.com/docs/de/build-with-claude/administration-api) [Nutzungs- und Kosten-API](https://platform.claude.com/docs/de/build-with-claude/usage-cost-api) [Claude Code Analytics API](https://platform.claude.com/docs/de/build-with-claude/claude-code-analytics-api)
...
Für konzeptionelle Hintergrundinformationen zur Funktionsweise von Skills siehe die [Skills-Übersicht](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/overview).

## Kernprinzipien

### Prägnanz ist der Schlüssel

Das [Kontextfenster](https://platform.claude.com/docs/de/build-with-claude/context-windows) ist ein öffentliches Gut. Ihr Skill teilt sich das Kontextfenster mit allem anderen, das Claude wissen muss, einschließlich:
...
Vollständige Details zur Skill-Struktur finden Sie in der [Skills-Übersicht](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/overview#skill-structure).
...
![Einfache SKILL.md-Datei mit YAML-Frontmatter und Markdown-Text](https://platform.claude.com/docs/images/agent-skills-simple-file.png)

Mit dem Wachstum Ihres Skills können Sie zusätzliche Inhalte bündeln, die Claude nur bei Bedarf lädt:

![Bündelung zusätzlicher Referenzdateien wie reference.md und forms.md.](https://platform.claude.com/docs/images/agent-skills-bundling-content.png)
...
Weitere Details zur Funktionsweise dieser dateisystembasierten Architektur für Progressive Disclosure finden Sie im Abschnitt [Runtime-Umgebung](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#runtime-environment) im Abschnitt Erweitert unten.
...
Dies zeigt das Validierungsschleifen-Muster mit Referenzdokumenten anstelle von Skripten. Der „Validator" ist STYLE\_GUIDE.md, und Claude führt die Überprüfung durch Lesen und Vergleichen durch.
...
Die folgenden Abschnitte konzentrieren sich auf Skills, die ausführbare Skripte enthalten. Wenn Ihr Skill nur Markdown-Anweisungen verwendet, fahren Sie mit [Checkliste für effektive Skills](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#checklist-for-effective-skills) fort.
...
![Bündelung ausführbarer Skripte neben Anweisungsdateien](https://platform.claude.com/docs/images/agent-skills-executable-scripts.png)
...
Für die meisten Utility-Skripte ist die Ausführung bevorzugt, da sie zuverlässiger und effizienter ist. Siehe den Abschnitt [Runtime-Umgebung](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#runtime-environment) unten für Details zur Funktionsweise der Skriptausführung.
...
**Implementierungstipp**: Machen Sie Validierungsskripte ausführlich mit spezifischen Fehlermeldungen wie „Feld ‚signature\_date' nicht gefunden. Verfügbare Felder: customer\_name, order\_total, signature\_date\_signed", um Claude bei der Behebung von Problemen zu helfen.
...
Listen Sie erforderliche Pakete in Ihrem SKILL.md auf und überprüfen Sie, ob sie in der [Code-Ausführungs-Tool-Dokumentation](https://platform.claude.com/docs/de/agents-and-tools/tool-use/code-execution-tool) verfügbar sind.

### Runtime-Umgebung

Skills laufen in einer Code-Ausführungsumgebung mit Dateisystemzugriff, Bash-Befehlen und Code-Ausführungsfähigkeiten. Für die konzeptionelle Erklärung dieser Architektur siehe [Die Skills-Architektur](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/overview#the-skills-architecture) in der Übersicht.
...
Vollständige Details zur technischen Architektur finden Sie unter [Wie Skills funktionieren](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/overview#how-skills-work) in der Skills-Übersicht.
...
Siehe die [Skills-Übersicht](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/overview#skill-structure) für vollständige Strukturdetails.

### Token-Budgets

Halten Sie den SKILL.md-Text unter 500 Zeilen für optimale Leistung. Wenn Ihr Inhalt diesen Wert überschreitet, teilen Sie ihn in separate Dateien auf, indem Sie die oben beschriebenen Progressive-Disclosure-Muster verwenden. Für Architekturdetails siehe die [Skills-Übersicht](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/overview#how-skills-work).
...
\\
Erstellen Sie Ihren ersten Skill](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/quickstart) [Verwenden Sie Skills in Claude Code\\
\\
Erstellen und verwalten Sie Skills in Claude Code](https://code.claude.com/docs/skills) [Verwenden Sie Skills im Agent SDK\\
\\
Verwenden Sie Skills programmgesteuert in TypeScript und Python](https://platform.claude.com/docs/de/agent-sdk/skills) [Verwenden Sie Skills mit der API\\
\\
Laden Sie Skills programmgesteuert hoch und verwenden Sie sie](https://platform.claude.com/docs/de/build-with-claude/skills-guide)

- [Kernprinzipien](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#kernprinzipien)
- [Prägnanz ist der Schlüssel](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#praegnanz-ist-der-schluessel)
- [Legen Sie angemessene Freiheitsgrade fest](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#legen-sie-angemessene-freiheitsgrade-fest)
- [Testen Sie mit allen Modellen, die Sie verwenden möchten](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#testen-sie-mit-allen-modellen-die-sie-verwenden-moechten)
- [Skill-Struktur](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#skill-struktur)
- [Benennungskonventionen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#benennungskonventionen)
- [Schreiben Sie effektive Beschreibungen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#schreiben-sie-effektive-beschreibungen)
- [Progressive Disclosure-Muster](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#progressive-disclosure-muster)
- [Vermeiden Sie tief verschachtelte Referenzen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#vermeiden-sie-tief-verschachtelte-referenzen)
- [Strukturieren Sie längere Referenzdateien mit Inhaltsverzeichnis](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#strukturieren-sie-laengere-referenzdateien-mit-inhaltsverzeichnis)
- [Workflows und Feedback-Schleifen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#workflows-und-feedback-schleifen)
- [Verwenden Sie Workflows für komplexe Aufgaben](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#verwenden-sie-workflows-fuer-komplexe-aufgaben)
- [Implementieren Sie Feedback-Schleifen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#implementieren-sie-feedback-schleifen)
- [Inhaltsrichtlinien](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#inhaltsrichtlinien)
- [Vermeiden Sie zeitempfindliche Informationen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#vermeiden-sie-zeitempfindliche-informationen)
- [Verwenden Sie konsistente Terminologie](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#verwenden-sie-konsistente-terminologie)
- [Häufige Muster](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#haeufige-muster)
- [Vorlagenmuster](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#vorlagenmuster)
- [Beispielmuster](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#beispielmuster)
- [Bedingtes Workflow-Muster](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#bedingtes-workflow-muster)
- [Bewertung und Iteration](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#bewertung-und-iteration)
- [Erstellen Sie Bewertungen zuerst](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#erstellen-sie-bewertungen-zuerst)
- [Entwickeln Sie Skills iterativ mit Claude](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#entwickeln-sie-skills-iterativ-mit-claude)
- [Beobachten Sie, wie Claude Skills navigiert](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#beobachten-sie-wie-claude-skills-navigiert)
- [Anti-Muster zu vermeiden](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#anti-muster-zu-vermeiden)
- [Vermeiden Sie Windows-Pfade](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#vermeiden-sie-windows-pfade)
- [Vermeiden Sie zu viele Optionen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#vermeiden-sie-zu-viele-optionen)
- [Erweitert: Skills mit ausführbarem Code](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#erweitert-skills-mit-ausfuehrbarem-code)
- [Lösen Sie, anstatt zu verschieben](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#loesen-sie-anstatt-zu-verschieben)
- [Stellen Sie Utility-Skripte bereit](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#stellen-sie-utility-skripte-bereit)
- [Verwenden Sie visuelle Analyse](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#verwenden-sie-visuelle-analyse)
- [Erstellen Sie überprüfbare Zwischenergebnisse](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#erstellen-sie-ueberpruefbare-zwischenergebnisse)
- [Paketabhängigkeiten](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#paketabhaengigkeiten)
- [Runtime-Umgebung](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#runtime-umgebung)
- [MCP-Tool-Referenzen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#mcp-tool-referenzen)
- [Nehmen Sie nicht an, dass Tools installiert sind](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#nehmen-sie-nicht-an-dass-tools-installiert-sind)
- [Technische Hinweise](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#technische-hinweise)
- [YAML-Frontmatter-Anforderungen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#yaml-frontmatter-anforderungen)
- [Token-Budgets](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#token-budgets)
- [Checkliste für effektive Skills](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#checkliste-fuer-effektive-skills)
- [Kernqualität](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#kernqualitaet)
- [Code und Skripte](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#code-und-skripte)
- [Testen](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#testen)
- [Nächste Schritte](https://platform.claude.com/docs/de/agents-and-tools/agent-skills/best-practices#naechste-schritte)
