---
url: "https://platform.claude.com/docs/it/agents-and-tools/remote-mcp-servers"
title: "Server MCP remoti - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fagents-and-tools%2Fremote-mcp-servers)
...
Server MCP remoti disponibili per sviluppatori
...
I server MCP remoti elencati di seguito sono servizi di terze parti progettati per funzionare con l'API Claude. Questi server
non sono di proprietà, gestiti o approvati da Anthropic. Gli utenti dovrebbero connettersi solo a server MCP remoti di cui si fidano e
dovrebbero rivedere le pratiche di sicurezza e i termini di ciascun server prima di connettersi.
...
- [Connessione ai server MCP remoti](https://platform.claude.com/docs/it/agents-and-tools/remote-mcp-servers#connessione-ai-server-mcp-remoti)
- [Esempi di server MCP remoti](https://platform.claude.com/docs/it/agents-and-tools/remote-mcp-servers#esempi-di-server-mcp-remoti)
