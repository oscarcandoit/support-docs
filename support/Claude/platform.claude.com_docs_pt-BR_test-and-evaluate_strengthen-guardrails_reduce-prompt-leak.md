---
url: "https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak"
title: "Reduzir vazamento de prompt - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Freduce-prompt-leak)
...
- [Antes de tentar reduzir o vazamento de prompt](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak#antes-de-tentar-reduzir-o-vazamento-de-prompt)
- [Estratégias para reduzir vazamento de prompt](https://platform.claude.com/docs/pt-BR/test-and-evaluate/strengthen-guardrails/reduce-prompt-leak#estrategias-para-reduzir-vazamento-de-prompt)
