---
url: "https://platform.claude.com/docs/fr/agent-sdk/mcp"
title: "MCP dans le SDK - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fagent-sdk%2Fmcp)
...
Serveurs en processus s'exécutant dans votre application. Pour des informations détaillées sur la création d'outils personnalisés, consultez le [guide des outils personnalisés](https://platform.claude.com/docs/fr/agent-sdk/custom-tools) :
...
- [Guide des outils personnalisés](https://platform.claude.com/docs/fr/agent-sdk/custom-tools) \- Guide détaillé sur la création de serveurs MCP SDK
- [Référence SDK TypeScript](https://platform.claude.com/docs/fr/agent-sdk/typescript)
- [Référence SDK Python](https://platform.claude.com/docs/fr/agent-sdk/python)
- [Permissions SDK](https://platform.claude.com/docs/fr/agent-sdk/permissions)
- [Flux de travail courants](https://code.claude.com/docs/common-workflows)

- [Vue d'ensemble](https://platform.claude.com/docs/fr/agent-sdk/mcp#vue-d-ensemble)
- [Configuration](https://platform.claude.com/docs/fr/agent-sdk/mcp#configuration)
- [Configuration de base](https://platform.claude.com/docs/fr/agent-sdk/mcp#configuration-de-base)
- [Utilisation des serveurs MCP dans le SDK](https://platform.claude.com/docs/fr/agent-sdk/mcp#utilisation-des-serveurs-mcp-dans-le-sdk)
- [Types de transport](https://platform.claude.com/docs/fr/agent-sdk/mcp#types-de-transport)
- [Serveurs stdio](https://platform.claude.com/docs/fr/agent-sdk/mcp#serveurs-stdio)
- [Serveurs HTTP/SSE](https://platform.claude.com/docs/fr/agent-sdk/mcp#serveurs-http-sse)
- [Serveurs MCP SDK](https://platform.claude.com/docs/fr/agent-sdk/mcp#serveurs-mcp-sdk)
- [Gestion des ressources](https://platform.claude.com/docs/fr/agent-sdk/mcp#gestion-des-ressources)
- [Authentification](https://platform.claude.com/docs/fr/agent-sdk/mcp#authentification)
- [Variables d'environnement](https://platform.claude.com/docs/fr/agent-sdk/mcp#variables-d-environnement)
- [Authentification OAuth2](https://platform.claude.com/docs/fr/agent-sdk/mcp#authentification-o-auth2)
- [Gestion des erreurs](https://platform.claude.com/docs/fr/agent-sdk/mcp#gestion-des-erreurs)
- [Ressources connexes](https://platform.claude.com/docs/fr/agent-sdk/mcp#ressources-connexes)
