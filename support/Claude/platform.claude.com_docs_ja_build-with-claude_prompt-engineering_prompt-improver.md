---
url: "https://platform.claude.com/docs/ja/build-with-claude/prompt-engineering/prompt-improver"
title: "プロンプト改善ツールを使用してプロンプトを最適化する - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fbuild-with-claude%2Fprompt-engineering%2Fprompt-improver)
...
私たちのプロンプト改善ツールは、拡張思考機能を持つモデルを含む、すべてのClaudeモデルと互換性があります。拡張思考モデル固有のプロンプトのヒントについては、 [こちら](https://platform.claude.com/docs/ja/build-with-claude/extended-thinking) をご覧ください。
...
- 改善する [プロンプトテンプレート](https://platform.claude.com/docs/ja/build-with-claude/prompt-engineering/prompt-templates-and-variables)
...
まだ例がありませんか？私たちの [テストケースジェネレーター](https://platform.claude.com/docs/ja/test-and-evaluate/eval-tool#creating-test-cases) を使用して：
...
[プロンプトライブラリ\\
\\
さまざまなタスクの例プロンプトからインスピレーションを得る。](https://platform.claude.com/docs/ja/resources/prompt-library/library) [GitHubプロンプトチュートリアル\\
\\
インタラクティブなチュートリアルでプロンプトのベストプラクティスを学ぶ。](https://github.com/anthropics/prompt-eng-interactive-tutorial) [プロンプトをテストする\\
\\
評価ツールを使用して改善されたプロンプトをテストする。](https://platform.claude.com/docs/ja/test-and-evaluate/eval-tool)
