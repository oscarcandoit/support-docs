---
url: "https://platform.claude.com/docs/fr/agent-sdk/python"
title: "Référence du SDK Agent - Python - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fagent-sdk%2Fpython)
...
| `output_format` | [`OutputFormat`](https://platform.claude.com/docs/fr/agent-sdk/python#outputformat)` | None` | `None` | Définir le format de sortie pour les résultats de l'agent. Voir [Sorties structurées](https://platform.claude.com/docs/fr/agent-sdk/structured-outputs) pour plus de détails |
...
| `plugins` | `list[SdkPluginConfig]` | `[]` | Charger des plugins personnalisés à partir de chemins locaux. Voir [Plugins](https://platform.claude.com/docs/fr/agent-sdk/plugins) pour plus de détails |
| `sandbox` | [`SandboxSettings`](https://platform.claude.com/docs/fr/agent-sdk/python#sandboxsettings)` | None` | `None` | Configurer le comportement du sandbox par programmation. Voir [Paramètres du sandbox](https://platform.claude.com/docs/fr/agent-sdk/python#sandboxsettings) pour plus de détails |
...
Pour des informations complètes sur la création et l'utilisation de plugins, voir [Plugins](https://platform.claude.com/docs/fr/agent-sdk/plugins).
...
Pour un guide complet sur l'utilisation des hooks avec des exemples et des modèles courants, consultez le [guide des hooks](https://platform.claude.com/docs/fr/agent-sdk/hooks).
...
- `input_data` : Données d'entrée spécifiques au hook (voir [guide des hooks](https://platform.claude.com/docs/fr/agent-sdk/hooks#input-data))
...
**Sortie (mode files\_with\_matches) :**
...
| `allowUnsandboxedCommands` | `bool` | `False` | Permettre au modèle de demander l'exécution de commandes en dehors du bac à sable. Lorsque `True`, le modèle peut définir `dangerouslyDisableSandbox` dans l'entrée de l'outil, ce qui revient au [système de permissions](https://platform.claude.com/docs/fr/agent-sdk/python#permissions-fallback-for-unsandboxed-commands) |
| `network` | [`SandboxNetworkConfig`](https://platform.claude.com/docs/fr/agent-sdk/python#sandboxnetworkconfig) | `None` | Configuration du bac à sable spécifique au réseau |
| `ignoreViolations` | [`SandboxIgnoreViolations`](https://platform.claude.com/docs/fr/agent-sdk/python#sandboxignoreviolations) | `None` | Configurer les violations du bac à sable à ignorer |
...
- [Guide du SDK Python](https://platform.claude.com/docs/fr/agent-sdk/python) \- Tutoriel et exemples
- [Aperçu du SDK](https://platform.claude.com/docs/fr/agent-sdk/overview) \- Concepts généraux du SDK
- [Référence du SDK TypeScript](https://platform.claude.com/docs/fr/agent-sdk/typescript) \- Documentation du SDK TypeScript
...
- [Installation](https://platform.claude.com/docs/fr/agent-sdk/python#installation)
- [Choisir entre query() et ClaudeSDKClient](https://platform.claude.com/docs/fr/agent-sdk/python#choisir-entre-query-et-claude-sdk-client)
- [Comparaison rapide](https://platform.claude.com/docs/fr/agent-sdk/python#comparaison-rapide)
- [Quand utiliser query() (Nouvelle session à chaque fois)](https://platform.claude.com/docs/fr/agent-sdk/python#quand-utiliser-query-nouvelle-session-a-chaque-fois)
- [Quand utiliser ClaudeSDKClient (Conversation continue)](https://platform.claude.com/docs/fr/agent-sdk/python#quand-utiliser-claude-sdk-client-conversation-continue)
- [Fonctions](https://platform.claude.com/docs/fr/agent-sdk/python#fonctions)
- [query()](https://platform.claude.com/docs/fr/agent-sdk/python#query)
- [tool()](https://platform.claude.com/docs/fr/agent-sdk/python#tool)
- [create\_sdk\_mcp\_server()](https://platform.claude.com/docs/fr/agent-sdk/python#create-sdk-mcp-server)
- [Classes](https://platform.claude.com/docs/fr/agent-sdk/python#classes)
- [ClaudeSDKClient](https://platform.claude.com/docs/fr/agent-sdk/python#claude-sdk-client)
- [Types](https://platform.claude.com/docs/fr/agent-sdk/python#types)
- [SdkMcpTool](https://platform.claude.com/docs/fr/agent-sdk/python#sdk-mcp-tool)
- [ClaudeAgentOptions](https://platform.claude.com/docs/fr/agent-sdk/python#claude-agent-options)
- [OutputFormat](https://platform.claude.com/docs/fr/agent-sdk/python#output-format)
- [SystemPromptPreset](https://platform.claude.com/docs/fr/agent-sdk/python#system-prompt-preset)
- [SettingSource](https://platform.claude.com/docs/fr/agent-sdk/python#setting-source)
- [AgentDefinition](https://platform.claude.com/docs/fr/agent-sdk/python#agent-definition)
- [PermissionMode](https://platform.claude.com/docs/fr/agent-sdk/python#permission-mode)
- [McpSdkServerConfig](https://platform.claude.com/docs/fr/agent-sdk/python#mcp-sdk-server-config)
- [McpServerConfig](https://platform.claude.com/docs/fr/agent-sdk/python#mcp-server-config)
- [SdkPluginConfig](https://platform.claude.com/docs/fr/agent-sdk/python#sdk-plugin-config)
- [Types de messages](https://platform.claude.com/docs/fr/agent-sdk/python#types-de-messages)
- [Message](https://platform.claude.com/docs/fr/agent-sdk/python#message)
- [UserMessage](https://platform.claude.com/docs/fr/agent-sdk/python#user-message)
- [AssistantMessage](https://platform.claude.com/docs/fr/agent-sdk/python#assistant-message)
- [SystemMessage](https://platform.claude.com/docs/fr/agent-sdk/python#system-message)
- [ResultMessage](https://platform.claude.com/docs/fr/agent-sdk/python#result-message)
- [Types de blocs de contenu](https://platform.claude.com/docs/fr/agent-sdk/python#types-de-blocs-de-contenu)
- [ContentBlock](https://platform.claude.com/docs/fr/agent-sdk/python#content-block)
- [TextBlock](https://platform.claude.com/docs/fr/agent-sdk/python#text-block)
- [ThinkingBlock](https://platform.claude.com/docs/fr/agent-sdk/python#thinking-block)
- [ToolUseBlock](https://platform.claude.com/docs/fr/agent-sdk/python#tool-use-block)
- [ToolResultBlock](https://platform.claude.com/docs/fr/agent-sdk/python#tool-result-block)
- [Types d'erreur](https://platform.claude.com/docs/fr/agent-sdk/python#types-d-erreur)
- [ClaudeSDKError](https://platform.claude.com/docs/fr/agent-sdk/python#claude-sdk-error)
- [CLINotFoundError](https://platform.claude.com/docs/fr/agent-sdk/python#cli-not-found-error)
- [CLIConnectionError](https://platform.claude.com/docs/fr/agent-sdk/python#cli-connection-error)
- [ProcessError](https://platform.claude.com/docs/fr/agent-sdk/python#process-error)
- [CLIJSONDecodeError](https://platform.claude.com/docs/fr/agent-sdk/python#clijson-decode-error)
- [Types de hook](https://platform.claude.com/docs/fr/agent-sdk/python#types-de-hook)
- [HookEvent](https://platform.claude.com/docs/fr/agent-sdk/python#hook-event)
- [HookCallback](https://platform.claude.com/docs/fr/agent-sdk/python#hook-callback)
- [HookContext](https://platform.claude.com/docs/fr/agent-sdk/python#hook-context)
- [HookMatcher](https://platform.claude.com/docs/fr/agent-sdk/python#hook-matcher)
- [Exemple d'utilisation de hook](https://platform.claude.com/docs/fr/agent-sdk/python#exemple-d-utilisation-de-hook)
- [Types d'entrée/sortie d'outil](https://platform.claude.com/docs/fr/agent-sdk/python#types-d-entree-sortie-d-outil)
- [Task](https://platform.claude.com/docs/fr/agent-sdk/python#task)
- [Bash](https://platform.claude.com/docs/fr/agent-sdk/python#bash)
- [Edit](https://platform.claude.com/docs/fr/agent-sdk/python#edit)
- [Read](https://platform.claude.com/docs/fr/agent-sdk/python#read)
- [Write](https://platform.claude.com/docs/fr/agent-sdk/python#write)
- [Glob](https://platform.claude.com/docs/fr/agent-sdk/python#glob)
- [Grep](https://platform.claude.com/docs/fr/agent-sdk/python#grep)
- [NotebookEdit](https://platform.claude.com/docs/fr/agent-sdk/python#notebook-edit)
- [WebFetch](https://platform.claude.com/docs/fr/agent-sdk/python#web-fetch)
- [WebSearch](https://platform.claude.com/docs/fr/agent-sdk/python#web-search)
- [TodoWrite](https://platform.claude.com/docs/fr/agent-sdk/python#todo-write)
- [BashOutput](https://platform.claude.com/docs/fr/agent-sdk/python#bash-output)
- [KillBash](https://platform.claude.com/docs/fr/agent-sdk/python#kill-bash)
- [ExitPlanMode](https://platform.claude.com/docs/fr/agent-sdk/python#exit-plan-mode)
- [ListMcpResources](https://platform.claude.com/docs/fr/agent-sdk/python#list-mcp-resources)
- [ReadMcpResource](https://platform.claude.com/docs/fr/agent-sdk/python#read-mcp-resource)
- [Fonctionnalités avancées avec ClaudeSDKClient](https://platform.claude.com/docs/fr/agent-sdk/python#fonctionnalites-avancees-avec-claude-sdk-client)
- [Construire une interface de conversation continue](https://platform.claude.com/docs/fr/agent-sdk/python#construire-une-interface-de-conversation-continue)
- [Utiliser les hooks pour la modification du comportement](https://platform.claude.com/docs/fr/agent-sdk/python#utiliser-les-hooks-pour-la-modification-du-comportement)
- [Surveillance de la progression en temps réel](https://platform.claude.com/docs/fr/agent-sdk/python#surveillance-de-la-progression-en-temps-reel)
- [Exemple d'utilisation](https://platform.claude.com/docs/fr/agent-sdk/python#exemple-d-utilisation)
- [Opérations de fichier de base (utilisant query)](https://platform.claude.com/docs/fr/agent-sdk/python#operations-de-fichier-de-base-utilisant-query)
- [Gestion des erreurs](https://platform.claude.com/docs/fr/agent-sdk/python#gestion-des-erreurs)
- [Mode de diffusion en continu avec client](https://platform.claude.com/docs/fr/agent-sdk/python#mode-de-diffusion-en-continu-avec-client)
- [Utiliser des outils personnalisés avec ClaudeSDKClient](https://platform.claude.com/docs/fr/agent-sdk/python#utiliser-des-outils-personnalises-avec-claude-sdk-client)
- [Configuration du bac à sable](https://platform.claude.com/docs/fr/agent-sdk/python#configuration-du-bac-a-sable)
- [SandboxSettings](https://platform.claude.com/docs/fr/agent-sdk/python#sandbox-settings)
- [SandboxNetworkConfig](https://platform.claude.com/docs/fr/agent-sdk/python#sandbox-network-config)
- [SandboxIgnoreViolations](https://platform.claude.com/docs/fr/agent-sdk/python#sandbox-ignore-violations)
- [Système de permissions de secours pour les commandes non sandboxées](https://platform.claude.com/docs/fr/agent-sdk/python#systeme-de-permissions-de-secours-pour-les-commandes-non-sandboxees)
- [Voir aussi](https://platform.claude.com/docs/fr/agent-sdk/python#voir-aussi)
