...
title: "Intro to Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fintro)
...
[Get started\\
\\
Set up your development environment for building with Claude.](https://platform.claude.com/docs/en/get-started) [Learn about Claude\\
\\
Learn about the family of Claude models.](https://platform.claude.com/docs/en/about-claude/models/overview) [Prompt Library\\
\\
...
[Developer Console\\
\\
Enjoy easier, more powerful prompting in your browser with the Workbench and the prompt generator tool.](https://platform.claude.com/) [API Reference\\
\\
Explore, implement, and scale with the Claude API and SDKs.](https://platform.claude.com/docs/en/api/overview) [Claude Cookbook\\
\\
...
- [Get started](https://platform.claude.com/docs/en/intro#get-started)
