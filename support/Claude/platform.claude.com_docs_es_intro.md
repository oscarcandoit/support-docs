---
url: "https://platform.claude.com/docs/es/intro"
title: "Introducción a Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fintro)
...
Claude es una plataforma de IA altamente eficiente, confiable e inteligente construida por Anthropic. Claude destaca en tareas que implican lenguaje, razonamiento, análisis, codificación y más.
...
¿Buscas chatear con Claude? ¡Visita [claude.ai](http://www.claude.ai/)!

## Comenzar

Si eres nuevo en Claude, comienza aquí para aprender lo esencial y hacer tu primera llamada a la API.

[Comenzar\\
\\
Configura tu entorno de desarrollo para construir con Claude.](https://platform.claude.com/docs/es/get-started) [Aprende sobre Claude\\
\\
Aprende sobre la familia de modelos Claude.](https://platform.claude.com/docs/es/about-claude/models/overview) [Biblioteca de Prompts\\
\\
Explora prompts de ejemplo para inspirarte.](https://platform.claude.com/docs/es/resources/prompt-library/library)

* * *

## Desarrolla con Claude

Anthropic tiene herramientas de desarrollador de clase mundial para construir aplicaciones escalables con Claude.

[Consola de Desarrollador\\
\\
Disfruta de un prompting más fácil y poderoso en tu navegador con Workbench y la herramienta generadora de prompts.](https://platform.claude.com/) [Referencia de API\\
\\
Explora, implementa y escala con la API de Claude y los SDKs.](https://platform.claude.com/docs/es/api/overview) [Claude Cookbook\\
\\
Aprende con cuadernos Jupyter interactivos que demuestran carga de PDFs, embeddings y más.](https://github.com/anthropics/anthropic-cookbook)

* * *

## Capacidades clave

Claude puede ayudarte con muchas tareas que implican texto, código e imágenes.

[Generación de texto y código\\
\\
Resume texto, responde preguntas, extrae datos, traduce texto y explica y genera código.](https://platform.claude.com/docs/es/build-with-claude/text-generation) [Visión\\
\\
Procesa y analiza entrada visual y genera texto y código a partir de imágenes.](https://platform.claude.com/docs/es/build-with-claude/vision)
...
[Centro de Ayuda\\
\\
Encuentra respuestas a preguntas frecuentes sobre cuenta y facturación.](https://support.claude.com/en/) [Estado del Servicio\\
\\
Verifica el estado de los servicios de Anthropic.](https://status.claude.com/)

- [Comenzar](https://platform.claude.com/docs/es/intro#comenzar)
- [Desarrolla con Claude](https://platform.claude.com/docs/es/intro#desarrolla-con-claude)
- [Capacidades clave](https://platform.claude.com/docs/es/intro#capacidades-clave)
- [Soporte](https://platform.claude.com/docs/es/intro#soporte)
