---
url: "https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/keep-claude-in-character"
title: "Mantenere Claude nel personaggio con il role prompting e il prefilling - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fkeep-claude-in-character)
...
- **Usa i prompt di sistema per impostare il ruolo:** Usa i [prompt di sistema](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/system-prompts) per definire il ruolo e la personalità di Claude. Questo crea una solida base per risposte coerenti.
...
Quando imposti il personaggio, fornisci informazioni dettagliate sulla personalità, il background e eventuali tratti o peculiarità specifiche. Questo aiuterà il modello a emulare e generalizzare meglio i tratti del personaggio.
...
### Esempio: Chatbot aziendale per il role prompting
