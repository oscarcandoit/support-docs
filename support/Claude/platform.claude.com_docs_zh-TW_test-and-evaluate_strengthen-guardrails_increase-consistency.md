---
url: "https://platform.claude.com/docs/zh-TW/test-and-evaluate/strengthen-guardrails/increase-consistency"
title: "提高輸出一致性 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-TW%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Fincrease-consistency)
...
如果您需要 Claude 始終輸出符合特定架構的有效 JSON，請使用 [Structured Outputs](https://platform.claude.com/docs/zh-TW/build-with-claude/structured-outputs) 而不是下面的提示工程技術。Structured Outputs 提供保證的架構符合性，專門為此用例設計。
...
- [預填充 Claude 的回應](https://platform.claude.com/docs/zh-TW/test-and-evaluate/strengthen-guardrails/increase-consistency#claude)
