---
url: "https://platform.claude.com/docs/it/build-with-claude/working-with-messages"
title: "Utilizzo dell'API Messages - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Fbuild-with-claude%2Fworking-with-messages)
...
Questa guida copre i modelli comuni per lavorare con l'API Messages, incluse le richieste di base, le conversazioni multi-turno, le tecniche di prefill e le capacità di visione. Per le specifiche complete dell'API, consulta il [riferimento dell'API Messages](https://platform.claude.com/docs/it/api/messages).
...
Per ulteriori informazioni sulle tecniche di prefill, consulta la nostra [guida al prefill](https://platform.claude.com/docs/it/build-with-claude/prompt-engineering/prefill-claudes-response).

## Visione

Claude può leggere sia testo che immagini nelle richieste. Supportiamo sia i tipi di origine `base64` che `url` per le immagini, e i tipi di media `image/jpeg`, `image/png`, `image/gif` e `image/webp`. Consulta la nostra [guida alla visione](https://platform.claude.com/docs/it/build-with-claude/vision) per ulteriori dettagli.
...
Consulta la nostra [guida](https://platform.claude.com/docs/it/agents-and-tools/tool-use/overview) per esempi di come utilizzare gli strumenti con l'API Messages.
Consulta la nostra [guida all'utilizzo del computer](https://platform.claude.com/docs/it/agents-and-tools/tool-use/computer-use-tool) per esempi di come controllare gli ambienti desktop del computer con l'API Messages.
Per l'output JSON garantito, consulta [Output strutturati](https://platform.claude.com/docs/it/build-with-claude/structured-outputs).

- [Richiesta e risposta di base](https://platform.claude.com/docs/it/build-with-claude/working-with-messages#richiesta-e-risposta-di-base)
- [Turni conversazionali multipli](https://platform.claude.com/docs/it/build-with-claude/working-with-messages#turni-conversazionali-multipli)
- [Mettere parole in bocca a Claude](https://platform.claude.com/docs/it/build-with-claude/working-with-messages#mettere-parole-in-bocca-a-claude)
- [Visione](https://platform.claude.com/docs/it/build-with-claude/working-with-messages#visione)
- [Utilizzo di strumenti e utilizzo del computer](https://platform.claude.com/docs/it/build-with-claude/working-with-messages#utilizzo-di-strumenti-e-utilizzo-del-computer)
