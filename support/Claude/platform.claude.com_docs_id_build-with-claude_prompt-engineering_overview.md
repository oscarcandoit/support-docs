...
title: "Ikhtisar rekayasa prompt - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Fbuild-with-claude%2Fprompt-engineering%2Foverview)
...
Jika tidak, kami sangat menyarankan Anda meluangkan waktu untuk membangun itu terlebih dahulu. Lihat [Tentukan kriteria kesuksesan Anda](https://platform.claude.com/docs/id/test-and-evaluate/define-success) dan [Buat evaluasi empiris yang kuat](https://platform.claude.com/docs/id/test-and-evaluate/develop-tests) untuk tips dan panduan.

[Pembuat prompt\\
\\
Tidak memiliki draf prompt pertama? Coba pembuat prompt di Claude Console!](https://platform.claude.com/dashboard)
...
1. [Pembuat prompt](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/prompt-generator)
2. [Jadilah jelas dan langsung](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/be-clear-and-direct)
3. [Gunakan contoh (multishot)](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/multishot-prompting)
4. [Biarkan Claude berpikir (chain of thought)](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/chain-of-thought)
5. [Gunakan tag XML](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/use-xml-tags)
6. [Berikan Claude peran (system prompts)](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/system-prompts)
7. [Isi sebelumnya respons Claude](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/prefill-claudes-response)
8. [Rantai prompt kompleks](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/chain-prompts)
9. [Tips konteks panjang](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/long-context-tips)
...
\\
Tutorial yang penuh dengan contoh yang mencakup konsep rekayasa prompt yang ditemukan di dokumen kami.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutorial prompting Google Sheets\\
\\
Versi yang lebih ringan dari tutorial rekayasa prompt kami melalui spreadsheet interaktif.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Sebelum rekayasa prompt](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/overview#sebelum-rekayasa-prompt)
- [Kapan melakukan rekayasa prompt](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/overview#kapan-melakukan-rekayasa-prompt)
- [Cara melakukan rekayasa prompt](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/overview#cara-melakukan-rekayasa-prompt)
- [Tutorial rekayasa prompt](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/overview#tutorial-rekayasa-prompt)
