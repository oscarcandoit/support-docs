---
url: "https://platform.claude.com/docs/ja/agent-sdk/plugins"
title: "SDK のプラグイン - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fagent-sdk%2Fplugins)
...
- [スラッシュコマンド](https://platform.claude.com/docs/ja/agent-sdk/slash-commands) \- SDK でのスラッシュコマンドの使用
- [サブエージェント](https://platform.claude.com/docs/ja/agent-sdk/subagents) \- 特殊なエージェントの操作
- [スキル](https://platform.claude.com/docs/ja/agent-sdk/skills) \- Agent Skills の使用
