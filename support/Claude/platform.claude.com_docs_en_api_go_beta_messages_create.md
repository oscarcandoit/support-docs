...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fapi%2Fgo%2Fbeta%2Fmessages%2Fcreate)
...
Messages param.Field\[\[\][BetaMessageParamResp](https://platform.claude.com/docs/en/api/beta#beta_message_param)\]
...
Container param.Field\[[BetaMessageNewParamsContainerUnion](https://platform.claude.com/docs/en/api/beta/messages/create)\]optional
...
ContextManagement param.Field\[[BetaContextManagementConfig](https://platform.claude.com/docs/en/api/beta#beta_context_management_config)\]optional

Body param: Context management configuration.

This allows you to control how Claude manages context across multiple requests, such as whether to clear function results or not.

MCPServers param.Field\[\[\][BetaRequestMCPServerURLDefinition](https://platform.claude.com/docs/en/api/beta#beta_request_mcp_server_url_definition)\]optional
...
Metadata param.Field\[[BetaMetadata](https://platform.claude.com/docs/en/api/beta#beta_metadata)\]optional

Body param: An object describing metadata about the request.

OutputConfig param.Field\[[BetaOutputConfig](https://platform.claude.com/docs/en/api/beta#beta_output_config)\]optional
...
OutputFormat param.Field\[[BetaJSONOutputFormat](https://platform.claude.com/docs/en/api/beta#beta_json_output_format)\]optional

Body param:
A schema to specify Claude's output format in responses.

ServiceTier param.Field\[[BetaMessageNewParamsServiceTier](https://platform.claude.com/docs/en/api/beta/messages/create)\]optional

Body param: Determines whether to use priority capacity (if available) or standard capacity for this request.

Anthropic offers different levels of service for your API requests. See [service-tiers](https://docs.claude.com/en/api/service-tiers) for details.

const BetaMessageNewParamsServiceTierAuto [BetaMessageNewParamsServiceTier](https://platform.claude.com/docs/en/api/beta/messages/create) = "auto"

const BetaMessageNewParamsServiceTierStandardOnly [BetaMessageNewParamsServiceTier](https://platform.claude.com/docs/en/api/beta/messages/create) = "standard\_only"
...
System param.Field\[\[\][BetaTextBlockParamResp](https://platform.claude.com/docs/en/api/beta#beta_text_block_param)\]optional
...
Thinking param.Field\[[BetaThinkingConfigParamUnionResp](https://platform.claude.com/docs/en/api/beta#beta_thinking_config_param)\]optional
...
ToolChoice param.Field\[[BetaToolChoiceUnion](https://platform.claude.com/docs/en/api/beta#beta_tool_choice)\]optional

Body param: How the model should use the provided tools. The model can use a specific tool, any available tool, decide by itself, or not use tools at all.

Tools param.Field\[\[\][BetaToolUnion](https://platform.claude.com/docs/en/api/beta#beta_tool_union)\]optional
...
Configs map\[string,[BetaMCPToolConfig](https://platform.claude.com/docs/en/api/beta#beta_mcp_tool_config)\]optional
