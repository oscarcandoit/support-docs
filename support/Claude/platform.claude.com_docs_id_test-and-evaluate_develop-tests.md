...
title: "Buat evaluasi empiris yang kuat - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fid%2Ftest-and-evaluate%2Fdevelop-tests)
...
[Brainstorm evaluasi\\
\\
Pelajari cara membuat prompt yang memaksimalkan skor eval Anda.](https://platform.claude.com/docs/id/build-with-claude/prompt-engineering/overview) [Cookbook eval\\
\\
Lebih banyak contoh kode eval dinilai manusia, kode, dan LLM.](https://github.com/anthropics/anthropic-cookbook/blob/main/misc/building%5Fevals.ipynb)

- [Membangun eval dan kasus uji](https://platform.claude.com/docs/id/test-and-evaluate/develop-tests#membangun-eval-dan-kasus-uji)
- [Prinsip desain eval](https://platform.claude.com/docs/id/test-and-evaluate/develop-tests#prinsip-desain-eval)
- [Contoh eval](https://platform.claude.com/docs/id/test-and-evaluate/develop-tests#contoh-eval)
- [Menilai eval](https://platform.claude.com/docs/id/test-and-evaluate/develop-tests#menilai-eval)
- [Tips untuk penilaian berbasis LLM](https://platform.claude.com/docs/id/test-and-evaluate/develop-tests#tips-untuk-penilaian-berbasis-llm)
- [Langkah selanjutnya](https://platform.claude.com/docs/id/test-and-evaluate/develop-tests#langkah-selanjutnya)
