---
url: "https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/be-clear-and-direct"
title: "Sé claro, directo y detallado - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fes%2Fbuild-with-claude%2Fprompt-engineering%2Fbe-clear-and-direct)
...
**La regla de oro de las indicaciones claras**

Muestra tu indicación a un colega, idealmente alguien que tenga contexto mínimo sobre la tarea, y pídele que siga las instrucciones. Si están confundidos, Claude probablemente también lo estará.
...
### Ejemplo: Anonimizar comentarios de clientes

### Ejemplo: Crear una campaña de correo electrónico de marketing
...
\\
Inspírate con una selección curada de indicaciones para varias tareas y casos de uso.](https://platform.claude.com/docs/es/resources/prompt-library/library) [Tutorial de indicaciones de GitHub\\
\\
Un tutorial lleno de ejemplos que cubre los conceptos de ingeniería de indicaciones que se encuentran en nuestra documentación.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Tutorial de indicaciones de Google Sheets\\
\\
Una versión más ligera de nuestro tutorial de ingeniería de indicaciones a través de una hoja de cálculo interactiva.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Cómo ser claro, contextual y específico](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/be-clear-and-direct#como-ser-claro-contextual-y-especifico)
- [Ejemplos](https://platform.claude.com/docs/es/build-with-claude/prompt-engineering/be-clear-and-direct#ejemplos)
