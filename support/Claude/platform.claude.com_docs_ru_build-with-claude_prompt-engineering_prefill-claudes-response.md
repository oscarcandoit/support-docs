---
url: "https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/prefill-claudes-response"
title: "Предварительное заполнение ответа Claude для большего контроля над выводом - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fru%2Fbuild-with-claude%2Fprompt-engineering%2Fprefill-claudes-response)
...
**Совет для опытных пользователей**: Предварительное заполнение `{` заставляет Claude пропустить преамбулу и напрямую вывести объект JSON. Это чище, более лаконично и проще для программ парсить без дополнительной обработки.
Для гарантированного вывода JSON, соответствующего определённой схеме, рассмотрите использование [Структурированных выводов](https://platform.claude.com/docs/ru/build-with-claude/structured-outputs) вместо предварительного заполнения. Структурированные выводы гарантируют, что ответ Claude всегда соответствует вашей определённой схеме JSON, что идеально подходит для производственных приложений, требующих строгого соответствия формату.

### Пример: Извлечение структурированных данных без предварительного заполнения

### Пример: Извлечение структурированных данных с предварительным заполнением
...
### Пример: Сохранение персонажа без ролевого подсказывания

### Пример: Сохранение персонажа с ролевым подсказыванием

* * *

[Работа с сообщениями\\
\\
Смотрите больше примеров предварительного заполнения и других паттернов Messages API.](https://platform.claude.com/docs/ru/build-with-claude/working-with-messages) [Библиотека подсказок\\
\\
Вдохновитесь тщательно отобранной подборкой подсказок для различных задач и вариантов использования.](https://platform.claude.com/docs/ru/resources/prompt-library/library) [Учебник по подсказыванию GitHub\\
\\
Полный учебник с примерами, охватывающий концепции инженерии подсказок, найденные в нашей документации.](https://github.com/anthropics/prompt-eng-interactive-tutorial) [Учебник по подсказыванию Google Sheets\\
\\
Более лёгкая версия нашего учебника по инженерии подсказок через интерактивную электронную таблицу.](https://docs.google.com/spreadsheets/d/19jzLgRruG9kjUQNKtCg1ZjdD6l6weA6qRXG5zLIAhC8)

- [Как предварительно заполнить ответ Claude](https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/prefill-claudes-response#kak-predvaritelno-zapolnit-otvet-claude)
- [Примеры](https://platform.claude.com/docs/ru/build-with-claude/prompt-engineering/prefill-claudes-response#primery)
