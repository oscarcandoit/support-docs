---
url: "https://platform.claude.com/docs/zh-CN/build-with-claude/claude-on-amazon-bedrock"
title: "Amazon Bedrock 上的 Claude - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fzh-CN%2Fbuild-with-claude%2Fclaude-on-amazon-bedrock)
...
Anthropic 的 [客户端 SDK](https://platform.claude.com/docs/zh-CN/api/client-sdks) 支持 Bedrock。您也可以直接使用 AWS SDK，如 `boto3`。
...
有关区域与全局模型 ID 的更多信息，请参阅下面的 [全局与区域端点](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-on-amazon-bedrock#global-vs-regional-endpoints) 部分。
...
有关更多详情，请参阅我们的 [客户端 SDK](https://platform.claude.com/docs/zh-CN/api/client-sdks)，以及官方 Bedrock 文档 [此处](https://docs.aws.amazon.com/bedrock/)。
...
您可以在 [此处](https://platform.claude.com/docs/zh-CN/api/overview) 找到 Bedrock 上当前支持的所有功能。

### Bedrock 上的 PDF 支持

PDF 支持可通过 Converse API 和 InvokeModel API 在 Amazon Bedrock 上获得。有关 PDF 处理功能和限制的详细信息，请参阅 [PDF 支持文档](https://platform.claude.com/docs/zh-CN/build-with-claude/pdf-support#amazon-bedrock-pdf-support)。
...
有关两种文档处理模式及其限制的更多详情，请参阅 [PDF 支持指南](https://platform.claude.com/docs/zh-CN/build-with-claude/pdf-support#amazon-bedrock-pdf-support)。

### 100 万令牌上下文窗口

Claude Sonnet 4 和 4.5 在 Amazon Bedrock 上支持 [100 万令牌上下文窗口](https://platform.claude.com/docs/zh-CN/build-with-claude/context-windows#1m-token-context-window)。
...
- **Anthropic 定价详情：** [定价文档](https://platform.claude.com/docs/zh-CN/about-claude/pricing#third-party-platform-pricing)

- [安装和配置 AWS CLI](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-on-amazon-bedrock#aws-cli)
- [安装用于访问 Bedrock 的 SDK](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-on-amazon-bedrock#bedrock-sdk)
- [访问 Bedrock](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-on-amazon-bedrock#bedrock)
- [订阅 Anthropic 模型](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-on-amazon-bedrock#anthropic)
- [Bedrock 上的 PDF 支持](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-on-amazon-bedrock#bedrock-pdf)
- [100 万令牌上下文窗口](https://platform.claude.com/docs/zh-CN/build-with-claude/claude-on-amazon-bedrock#100)
