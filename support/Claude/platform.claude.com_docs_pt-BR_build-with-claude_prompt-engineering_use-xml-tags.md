---
url: "https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/use-xml-tags"
title: "Use XML tags to structure your prompts - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fpt-BR%2Fbuild-with-claude%2Fprompt-engineering%2Fuse-xml-tags)
...
### Exemplo: Gerando relatórios financeiros
...
- [Por que usar tags XML?](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/use-xml-tags#por-que-usar-tags-xml)
- [Melhores práticas de marcação](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/use-xml-tags#melhores-praticas-de-marcacao)
- [Exemplos](https://platform.claude.com/docs/pt-BR/build-with-claude/prompt-engineering/use-xml-tags#exemplos)
