---
url: "https://platform.claude.com/docs/ja/build-with-claude/batch-processing"
title: "バッチ処理 - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fja%2Fbuild-with-claude%2Fbatch-processing)
...
- [Message Batches APIの仕組み](https://platform.claude.com/docs/ja/build-with-claude/batch-processing#message-batches-api)
- [Message Batches APIの使用方法](https://platform.claude.com/docs/ja/build-with-claude/batch-processing#message-batches-api-2)
- [すべてのMessage Batchをリストする](https://platform.claude.com/docs/ja/build-with-claude/batch-processing#message-batch)
- [Message Batchのキャンセル](https://platform.claude.com/docs/ja/build-with-claude/batch-processing#message-batch-2)
- [Message Batches でプロンプトキャッシングを使用する](https://platform.claude.com/docs/ja/build-with-claude/batch-processing#message-batches)
- [FAQ](https://platform.claude.com/docs/ja/build-with-claude/batch-processing#faq)