...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fapi%2Fpython%2Fmessages%2Fcreate)
...
messages: [Iterable](https://platform.claude.com/docs/en/api/messages/create)\[[MessageParam](https://platform.claude.com/docs/en/api/messages#message_param)\]
...
stop\_sequences: Optional\[[SequenceNotStr](https://platform.claude.com/docs/en/api/messages/create)\[str\]\]
...
tools: Optional\[[Iterable](https://platform.claude.com/docs/en/api/messages/create)\[[ToolUnionParam](https://platform.claude.com/docs/en/api/messages#tool_union)\]\]
