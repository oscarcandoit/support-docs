---
url: "https://platform.claude.com/docs/fr/agents-and-tools/tool-search-tool"
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Ffr%2Fagents-and-tools%2Ftool-search-tool)
