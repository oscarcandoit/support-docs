---
url: "https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/reduce-hallucinations"
title: "Ridurre le allucinazioni - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fit%2Ftest-and-evaluate%2Fstrengthen-guardrails%2Freduce-hallucinations)
...
- [Strategie di base per minimizzare le allucinazioni](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/reduce-hallucinations#strategie-di-base-per-minimizzare-le-allucinazioni)
- [Tecniche avanzate](https://platform.claude.com/docs/it/test-and-evaluate/strengthen-guardrails/reduce-hallucinations#tecniche-avanzate)
