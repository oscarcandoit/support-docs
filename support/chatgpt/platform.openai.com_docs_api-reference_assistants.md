...
[The assistant object](https://platform.openai.com/docs/api-reference/assistants/object)
...
[PreviousStreaming](https://platform.openai.com/docs/api-reference/chat-streaming) [NextThreads](https://platform.openai.com/docs/api-reference/threads)