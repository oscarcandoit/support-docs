---
url: "https://platform.openai.com/docs/api-reference/images?locale=en"
...
[Create image](https://platform.openai.com/docs/api-reference/images/create?locale=en)

[Create image edit](https://platform.openai.com/docs/api-reference/images/createEdit?locale=en)

[Create image variation](https://platform.openai.com/docs/api-reference/images/createVariation?locale=en)

[The image generation response](https://platform.openai.com/docs/api-reference/images/object?locale=en)
...
[PreviousVideos](https://platform.openai.com/docs/api-reference/videos?locale=en) [NextImage Streaming](https://platform.openai.com/docs/api-reference/images-streaming?locale=en)
