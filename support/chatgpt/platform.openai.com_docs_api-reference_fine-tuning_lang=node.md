---
url: "https://platform.openai.com/docs/api-reference/fine-tuning?lang=node"
...
[Create fine-tuning job](https://platform.openai.com/docs/api-reference/fine-tuning/create?lang=node)

[List fine-tuning jobs](https://platform.openai.com/docs/api-reference/fine-tuning/list?lang=node)

[List fine-tuning events](https://platform.openai.com/docs/api-reference/fine-tuning/list-events?lang=node)

[List fine-tuning checkpoints](https://platform.openai.com/docs/api-reference/fine-tuning/list-checkpoints?lang=node)

[List checkpoint permissions](https://platform.openai.com/docs/api-reference/fine-tuning/list-permissions?lang=node)

[Create checkpoint permissions](https://platform.openai.com/docs/api-reference/fine-tuning/create-permission?lang=node)

[Delete checkpoint permission](https://platform.openai.com/docs/api-reference/fine-tuning/delete-permission?lang=node)

[Retrieve fine-tuning job](https://platform.openai.com/docs/api-reference/fine-tuning/retrieve?lang=node)

[Cancel fine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning/cancel?lang=node)

[Resume fine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning/resume?lang=node)

[Pause fine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning/pause?lang=node)

[Training format for chat models using the supervised method](https://platform.openai.com/docs/api-reference/fine-tuning/chat-input?lang=node)

[Training format for chat models using the preference method](https://platform.openai.com/docs/api-reference/fine-tuning/preference-input?lang=node)

[Training format for reasoning models using the reinforcement method](https://platform.openai.com/docs/api-reference/fine-tuning/reinforcement-input?lang=node)

[The fine-tuning job object](https://platform.openai.com/docs/api-reference/fine-tuning/object?lang=node)

[The fine-tuning job event object](https://platform.openai.com/docs/api-reference/fine-tuning/event-object?lang=node)

[The fine-tuning job checkpoint object](https://platform.openai.com/docs/api-reference/fine-tuning/checkpoint-object?lang=node)

[The fine-tuned model checkpoint permission object](https://platform.openai.com/docs/api-reference/fine-tuning/permission-object?lang=node)
...
[PreviousEvals](https://platform.openai.com/docs/api-reference/evals?lang=node) [NextGraders](https://platform.openai.com/docs/api-reference/graders?lang=node)
