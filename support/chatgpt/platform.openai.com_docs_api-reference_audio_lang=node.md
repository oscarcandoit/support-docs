---
url: "https://platform.openai.com/docs/api-reference/audio?lang=node"
...
[Create speech](https://platform.openai.com/docs/api-reference/audio/createSpeech?lang=node)

[Create voice](https://platform.openai.com/docs/api-reference/audio/createVoice?lang=node)

[Create voice consent](https://platform.openai.com/docs/api-reference/audio/createVoiceConsent?lang=node)

[List voice consents](https://platform.openai.com/docs/api-reference/audio/listVoiceConsents?lang=node)

[Retrieve voice consent](https://platform.openai.com/docs/api-reference/audio/getVoiceConsent?lang=node)

[Update voice consent](https://platform.openai.com/docs/api-reference/audio/updateVoiceConsent?lang=node)

[Delete voice consent](https://platform.openai.com/docs/api-reference/audio/deleteVoiceConsent?lang=node)

[Create transcription](https://platform.openai.com/docs/api-reference/audio/createTranscription?lang=node)

[Create translation](https://platform.openai.com/docs/api-reference/audio/createTranslation?lang=node)

[The voice object](https://platform.openai.com/docs/api-reference/audio/voice-object?lang=node)

[The voice consent object](https://platform.openai.com/docs/api-reference/audio/voice-consent-object?lang=node)

[The voice consent list object](https://platform.openai.com/docs/api-reference/audio/voice-consent-list?lang=node)

[The voice consent deletion object](https://platform.openai.com/docs/api-reference/audio/voice-consent-deleted?lang=node)

[The transcription object (JSON)](https://platform.openai.com/docs/api-reference/audio/json-object?lang=node)

[The transcription object (Diarized JSON)](https://platform.openai.com/docs/api-reference/audio/diarized-json-object?lang=node)

[The transcription object (Verbose JSON)](https://platform.openai.com/docs/api-reference/audio/verbose-json-object?lang=node)

[Stream Event (speech.audio.delta)](https://platform.openai.com/docs/api-reference/audio/speech-audio-delta-event?lang=node)

[Stream Event (speech.audio.done)](https://platform.openai.com/docs/api-reference/audio/speech-audio-done-event?lang=node)

[Stream Event (transcript.text.delta)](https://platform.openai.com/docs/api-reference/audio/transcript-text-delta-event?lang=node)

[Stream Event (transcript.text.segment)](https://platform.openai.com/docs/api-reference/audio/transcript-text-segment-event?lang=node)

[Stream Event (transcript.text.done)](https://platform.openai.com/docs/api-reference/audio/transcript-text-done-event?lang=node)
...
[PreviousWebhook Events](https://platform.openai.com/docs/api-reference/webhook-events?lang=node) [NextVideos](https://platform.openai.com/docs/api-reference/videos?lang=node)