---
url: "https://platform.openai.com/docs/api-reference/responses?lang=node"
...
[Create a model response](https://platform.openai.com/docs/api-reference/responses/create?lang=node)

[Get a model response](https://platform.openai.com/docs/api-reference/responses/get?lang=node)

[Delete a model response](https://platform.openai.com/docs/api-reference/responses/delete?lang=node)

[Cancel a response](https://platform.openai.com/docs/api-reference/responses/cancel?lang=node)

[Compact a response](https://platform.openai.com/docs/api-reference/responses/compact?lang=node)

[List input items](https://platform.openai.com/docs/api-reference/responses/input-items?lang=node)

[Get input token counts](https://platform.openai.com/docs/api-reference/responses/input-tokens?lang=node)

[The response object](https://platform.openai.com/docs/api-reference/responses/object?lang=node)

[The input item list](https://platform.openai.com/docs/api-reference/responses/list?lang=node)

[The compacted response object](https://platform.openai.com/docs/api-reference/responses/compacted-object?lang=node)
...
posthttps://api.openai.com/v1/responses/compact
...
A [compacted response object](https://platform.openai.com/docs/api-reference/responses/compacted-object).
...
[PreviousIntroduction](https://platform.openai.com/docs/api-reference/introduction?lang=node) [NextConversations](https://platform.openai.com/docs/api-reference/conversations?lang=node)