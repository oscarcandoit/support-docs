...
[The message delta object](https://platform.openai.com/docs/api-reference/assistants-streaming/message-delta-object)

[The run step delta object](https://platform.openai.com/docs/api-reference/assistants-streaming/run-step-delta-object)

[Assistant stream events](https://platform.openai.com/docs/api-reference/assistants-streaming/events)
...
[PreviousRun steps](https://platform.openai.com/docs/api-reference/run-steps) [NextAdministration](https://platform.openai.com/docs/api-reference/administration)