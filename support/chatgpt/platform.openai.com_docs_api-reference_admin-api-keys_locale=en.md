---
url: "https://platform.openai.com/docs/api-reference/admin-api-keys?locale=en"
...
[List all organization and project API keys.](https://platform.openai.com/docs/api-reference/admin-api-keys/list?locale=en)

[Create admin API key](https://platform.openai.com/docs/api-reference/admin-api-keys/create?locale=en)

[Retrieve admin API key](https://platform.openai.com/docs/api-reference/admin-api-keys/listget?locale=en)

[Delete admin API key](https://platform.openai.com/docs/api-reference/admin-api-keys/delete?locale=en)

[The admin API key object](https://platform.openai.com/docs/api-reference/admin-api-keys/object?locale=en)
...
[PreviousAdministration](https://platform.openai.com/docs/api-reference/administration?locale=en) [NextInvites](https://platform.openai.com/docs/api-reference/invite?locale=en)