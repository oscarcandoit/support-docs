---
url: "https://platform.openai.com/docs/api-reference/chatkit?locale=en"
...
[Create ChatKit session](https://platform.openai.com/docs/api-reference/chatkit/sessions/create?locale=en)

[Cancel chat session](https://platform.openai.com/docs/api-reference/chatkit/sessions/cancel?locale=en)

[List ChatKit threads](https://platform.openai.com/docs/api-reference/chatkit/threads/list?locale=en)

[Retrieve ChatKit thread](https://platform.openai.com/docs/api-reference/chatkit/threads/retrieve?locale=en)

[Delete ChatKit thread](https://platform.openai.com/docs/api-reference/chatkit/threads/delete?locale=en)

[List ChatKit thread items](https://platform.openai.com/docs/api-reference/chatkit/threads/list-items?locale=en)

[The chat session object](https://platform.openai.com/docs/api-reference/chatkit/sessions/object?locale=en)

[The thread object](https://platform.openai.com/docs/api-reference/chatkit/threads/object?locale=en)

[Thread Items](https://platform.openai.com/docs/api-reference/chatkit/threads/item-list?locale=en)
...
[PreviousVector store file batches](https://platform.openai.com/docs/api-reference/vector-stores-file-batches?locale=en) [NextContainers](https://platform.openai.com/docs/api-reference/containers?locale=en)
