...
[response](https://platform.openai.com/docs/api-reference/responses-streaming/response)

[.created](https://platform.openai.com/docs/api-reference/responses-streaming/response/created)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/in_progress)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/completed)

[.failed](https://platform.openai.com/docs/api-reference/responses-streaming/response/failed)

[.incomplete](https://platform.openai.com/docs/api-reference/responses-streaming/response/incomplete)

[.output\_item](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_item)

[.added](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_item/added)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_item/done)

[.content\_part](https://platform.openai.com/docs/api-reference/responses-streaming/response/content_part)

[.added](https://platform.openai.com/docs/api-reference/responses-streaming/response/content_part/added)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/content_part/done)

[response.output\_text.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text/delta)

[response.output\_text.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text/done)

[.refusal](https://platform.openai.com/docs/api-reference/responses-streaming/response/refusal)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/refusal/delta)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/refusal/done)

[.function\_call\_arguments](https://platform.openai.com/docs/api-reference/responses-streaming/response/function_call_arguments)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/function_call_arguments/delta)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/function_call_arguments/done)

[.file\_search\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/file_search_call)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/file_search_call/in_progress)

[.searching](https://platform.openai.com/docs/api-reference/responses-streaming/response/file_search_call/searching)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/file_search_call/completed)

[.web\_search\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/web_search_call)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/web_search_call/in_progress)

[.searching](https://platform.openai.com/docs/api-reference/responses-streaming/response/web_search_call/searching)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/web_search_call/completed)

[.reasoning\_summary\_part](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_part)

[.added](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_part/added)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_part/done)

[.reasoning\_summary\_text](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_text)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_text/delta)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_text/done)

[.reasoning\_text](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_text)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_text/delta)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_text/done)

[.image\_generation\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call/completed)

[.generating](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call/generating)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call/in_progress)

[.partial\_image](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call/partial_image)

[.mcp\_call\_arguments](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call_arguments)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call_arguments/delta)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call_arguments/done)

[.mcp\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call/completed)

[.failed](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call/failed)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call/in_progress)

[.mcp\_list\_tools](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_list_tools)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_list_tools/completed)

[.failed](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_list_tools/failed)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_list_tools/in_progress)

[.code\_interpreter\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call/in_progress)

[.interpreting](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call/interpreting)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call/completed)

[.code\_interpreter\_call\_code](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call_code)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call_code/delta)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call_code/done)

[.output\_text](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text)

[.annotation](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text/annotation)

[.added](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text/annotation/added)

[.queued](https://platform.openai.com/docs/api-reference/responses-streaming/response/queued)

[.custom\_tool\_call\_input](https://platform.openai.com/docs/api-reference/responses-streaming/response/custom_tool_call_input)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/custom_tool_call_input/delta)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/custom_tool_call_input/done)
...
[PreviousConversations](https://platform.openai.com/docs/api-reference/conversations) [NextWebhook Events](https://platform.openai.com/docs/api-reference/webhook-events)