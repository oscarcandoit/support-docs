---
url: "https://platform.openai.com/docs/api-reference/audio?locale=en"
...
[Create speech](https://platform.openai.com/docs/api-reference/audio/createSpeech?locale=en)

[Create voice](https://platform.openai.com/docs/api-reference/audio/createVoice?locale=en)

[Create voice consent](https://platform.openai.com/docs/api-reference/audio/createVoiceConsent?locale=en)

[List voice consents](https://platform.openai.com/docs/api-reference/audio/listVoiceConsents?locale=en)

[Retrieve voice consent](https://platform.openai.com/docs/api-reference/audio/getVoiceConsent?locale=en)

[Update voice consent](https://platform.openai.com/docs/api-reference/audio/updateVoiceConsent?locale=en)

[Delete voice consent](https://platform.openai.com/docs/api-reference/audio/deleteVoiceConsent?locale=en)

[Create transcription](https://platform.openai.com/docs/api-reference/audio/createTranscription?locale=en)

[Create translation](https://platform.openai.com/docs/api-reference/audio/createTranslation?locale=en)

[The voice object](https://platform.openai.com/docs/api-reference/audio/voice-object?locale=en)

[The voice consent object](https://platform.openai.com/docs/api-reference/audio/voice-consent-object?locale=en)

[The voice consent list object](https://platform.openai.com/docs/api-reference/audio/voice-consent-list?locale=en)

[The voice consent deletion object](https://platform.openai.com/docs/api-reference/audio/voice-consent-deleted?locale=en)

[The transcription object (JSON)](https://platform.openai.com/docs/api-reference/audio/json-object?locale=en)

[The transcription object (Diarized JSON)](https://platform.openai.com/docs/api-reference/audio/diarized-json-object?locale=en)

[The transcription object (Verbose JSON)](https://platform.openai.com/docs/api-reference/audio/verbose-json-object?locale=en)

[Stream Event (speech.audio.delta)](https://platform.openai.com/docs/api-reference/audio/speech-audio-delta-event?locale=en)

[Stream Event (speech.audio.done)](https://platform.openai.com/docs/api-reference/audio/speech-audio-done-event?locale=en)

[Stream Event (transcript.text.delta)](https://platform.openai.com/docs/api-reference/audio/transcript-text-delta-event?locale=en)

[Stream Event (transcript.text.segment)](https://platform.openai.com/docs/api-reference/audio/transcript-text-segment-event?locale=en)

[Stream Event (transcript.text.done)](https://platform.openai.com/docs/api-reference/audio/transcript-text-done-event?locale=en)
...
[PreviousWebhook Events](https://platform.openai.com/docs/api-reference/webhook-events?locale=en) [NextVideos](https://platform.openai.com/docs/api-reference/videos?locale=en)
