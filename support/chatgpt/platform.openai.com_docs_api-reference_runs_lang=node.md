---
url: "https://platform.openai.com/docs/api-reference/runs?lang=node"
...
[Create run](https://platform.openai.com/docs/api-reference/runs/createRun?lang=node)

[Create thread and run](https://platform.openai.com/docs/api-reference/runs/createThreadAndRun?lang=node)

[List runs](https://platform.openai.com/docs/api-reference/runs/listRuns?lang=node)

[Retrieve run](https://platform.openai.com/docs/api-reference/runs/getRun?lang=node)

[Modify run](https://platform.openai.com/docs/api-reference/runs/modifyRun?lang=node)

[Submit tool outputs to run](https://platform.openai.com/docs/api-reference/runs/submitToolOutputs?lang=node)

[Cancel a run](https://platform.openai.com/docs/api-reference/runs/cancelRun?lang=node)

[The run object](https://platform.openai.com/docs/api-reference/runs/object?lang=node)
...
[PreviousMessages](https://platform.openai.com/docs/api-reference/messages?lang=node) [NextRun steps](https://platform.openai.com/docs/api-reference/run-steps?lang=node)