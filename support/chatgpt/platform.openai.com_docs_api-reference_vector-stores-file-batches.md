---
url: "https://platform.openai.com/docs/api-reference/vector-stores-file-batches"
title: "Vector store file batches | OpenAI API Reference"
---
...
[The vector store files batch object](https://platform.openai.com/docs/api-reference/vector-stores-file-batches/batch-object)
...
[PreviousVector store files](https://platform.openai.com/docs/api-reference/vector-stores-files) [NextChatKit](https://platform.openai.com/docs/api-reference/chatkit)
