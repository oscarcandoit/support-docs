---
url: "https://platform.openai.com/docs/api-reference/realtime-sessions?lang=node"
...
[Create client secret](https://platform.openai.com/docs/api-reference/realtime-sessions/create-realtime-client-secret?lang=node)

[Session response object](https://platform.openai.com/docs/api-reference/realtime-sessions/create-secret-response?lang=node)
...
[PreviousRealtime](https://platform.openai.com/docs/api-reference/realtime?lang=node) [NextCalls](https://platform.openai.com/docs/api-reference/realtime-calls?lang=node)
