---
url: "https://platform.openai.com/docs/api-reference/realtime-client-events?locale=en"
title: "Client events | OpenAI API Reference"
---
...
[session](https://platform.openai.com/docs/api-reference/realtime-client-events/session?locale=en)

[.update](https://platform.openai.com/docs/api-reference/realtime-client-events/session/update?locale=en)

[input\_audio\_buffer](https://platform.openai.com/docs/api-reference/realtime-client-events/input_audio_buffer?locale=en)

[.append](https://platform.openai.com/docs/api-reference/realtime-client-events/input_audio_buffer/append?locale=en)

[.commit](https://platform.openai.com/docs/api-reference/realtime-client-events/input_audio_buffer/commit?locale=en)

[.clear](https://platform.openai.com/docs/api-reference/realtime-client-events/input_audio_buffer/clear?locale=en)

[conversation](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation?locale=en)

[.item](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item?locale=en)

[.create](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item/create?locale=en)

[.retrieve](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item/retrieve?locale=en)

[.truncate](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item/truncate?locale=en)

[.delete](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item/delete?locale=en)

[response](https://platform.openai.com/docs/api-reference/realtime-client-events/response?locale=en)

[.create](https://platform.openai.com/docs/api-reference/realtime-client-events/response/create?locale=en)

[.cancel](https://platform.openai.com/docs/api-reference/realtime-client-events/response/cancel?locale=en)

[output\_audio\_buffer](https://platform.openai.com/docs/api-reference/realtime-client-events/output_audio_buffer?locale=en)

[.clear](https://platform.openai.com/docs/api-reference/realtime-client-events/output_audio_buffer/clear?locale=en)
...
[PreviousCalls](https://platform.openai.com/docs/api-reference/realtime-calls?locale=en) [NextServer events](https://platform.openai.com/docs/api-reference/realtime-server-events?locale=en)