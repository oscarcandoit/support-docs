---
url: "https://platform.openai.com/docs/api-reference/project-users"
title: "Project users | OpenAI API Reference"
---
...
[List project users](https://platform.openai.com/docs/api-reference/project-users/list)

[Create project user](https://platform.openai.com/docs/api-reference/project-users/create)

[Retrieve project user](https://platform.openai.com/docs/api-reference/project-users/retrieve)

[Modify project user](https://platform.openai.com/docs/api-reference/project-users/modify)

[Delete project user](https://platform.openai.com/docs/api-reference/project-users/delete)

[The project user object](https://platform.openai.com/docs/api-reference/project-users/object)
...
[PreviousProjects](https://platform.openai.com/docs/api-reference/projects) [NextProject groups](https://platform.openai.com/docs/api-reference/project-groups)