---
url: "https://platform.openai.com/docs/api-reference/realtime-calls?locale=en"
title: "Calls | OpenAI API Reference"
---
...
[Accept call](https://platform.openai.com/docs/api-reference/realtime-calls/accept-call?locale=en)

[Reject call](https://platform.openai.com/docs/api-reference/realtime-calls/reject-call?locale=en)

[Refer call](https://platform.openai.com/docs/api-reference/realtime-calls/refer-call?locale=en)

[Hang up call](https://platform.openai.com/docs/api-reference/realtime-calls/hangup-call?locale=en)
...
[PreviousClient secrets](https://platform.openai.com/docs/api-reference/realtime-sessions?locale=en) [NextClient events](https://platform.openai.com/docs/api-reference/realtime-client-events?locale=en)
