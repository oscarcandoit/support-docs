---
url: "https://platform.openai.com/docs/api-reference/audit-logs?locale=en"
...
[List audit logs](https://platform.openai.com/docs/api-reference/audit-logs/list?locale=en)

[The audit log object](https://platform.openai.com/docs/api-reference/audit-logs/object?locale=en)
...
[PreviousProject rate limits](https://platform.openai.com/docs/api-reference/project-rate-limits?locale=en) [NextUsage](https://platform.openai.com/docs/api-reference/usage?locale=en)
