---
url: "https://platform.openai.com/docs/api-reference/administration?lang=node"
...
[PreviousStreaming](https://platform.openai.com/docs/api-reference/assistants-streaming?lang=node) [NextAdmin API Keys](https://platform.openai.com/docs/api-reference/admin-api-keys?lang=node)