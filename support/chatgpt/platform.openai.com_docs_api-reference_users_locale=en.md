---
url: "https://platform.openai.com/docs/api-reference/users?locale=en"
...
[List users](https://platform.openai.com/docs/api-reference/users/list?locale=en)

[Modify user](https://platform.openai.com/docs/api-reference/users/modify?locale=en)

[Retrieve user](https://platform.openai.com/docs/api-reference/users/retrieve?locale=en)

[Delete user](https://platform.openai.com/docs/api-reference/users/delete?locale=en)

[The user object](https://platform.openai.com/docs/api-reference/users/object?locale=en)
...
[PreviousInvites](https://platform.openai.com/docs/api-reference/invite?locale=en) [NextGroups](https://platform.openai.com/docs/api-reference/groups?locale=en)