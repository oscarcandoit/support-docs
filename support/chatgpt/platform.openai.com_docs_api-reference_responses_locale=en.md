---
url: "https://platform.openai.com/docs/api-reference/responses?locale=en"
...
[Create a model response](https://platform.openai.com/docs/api-reference/responses/create?locale=en)

[Get a model response](https://platform.openai.com/docs/api-reference/responses/get?locale=en)

[Delete a model response](https://platform.openai.com/docs/api-reference/responses/delete?locale=en)

[Cancel a response](https://platform.openai.com/docs/api-reference/responses/cancel?locale=en)

[Compact a response](https://platform.openai.com/docs/api-reference/responses/compact?locale=en)

[List input items](https://platform.openai.com/docs/api-reference/responses/input-items?locale=en)

[Get input token counts](https://platform.openai.com/docs/api-reference/responses/input-tokens?locale=en)

[The response object](https://platform.openai.com/docs/api-reference/responses/object?locale=en)

[The input item list](https://platform.openai.com/docs/api-reference/responses/list?locale=en)

[The compacted response object](https://platform.openai.com/docs/api-reference/responses/compacted-object?locale=en)
...
[PreviousIntroduction](https://platform.openai.com/docs/api-reference/introduction?locale=en) [NextConversations](https://platform.openai.com/docs/api-reference/conversations?locale=en)