---
url: "https://platform.openai.com/docs/api-reference/role-assignments?locale=en"
title: "Role assignments | OpenAI API Reference"
---
...
[List group organization role assignments](https://platform.openai.com/docs/api-reference/role-assignments/organization/groups/list?locale=en)

[Assign organization role to group](https://platform.openai.com/docs/api-reference/role-assignments/organization/groups/assign?locale=en)

[Unassign organization role from group](https://platform.openai.com/docs/api-reference/role-assignments/organization/groups/delete?locale=en)

[List user organization role assignments](https://platform.openai.com/docs/api-reference/role-assignments/organization/users/list?locale=en)

[Assign organization role to user](https://platform.openai.com/docs/api-reference/role-assignments/organization/users/assign?locale=en)

[Unassign organization role from user](https://platform.openai.com/docs/api-reference/role-assignments/organization/users/delete?locale=en)

[List project group role assignments](https://platform.openai.com/docs/api-reference/role-assignments/projects/groups/list?locale=en)

[Assign project role to group](https://platform.openai.com/docs/api-reference/role-assignments/projects/groups/assign?locale=en)

[Unassign project role from group](https://platform.openai.com/docs/api-reference/role-assignments/projects/groups/delete?locale=en)

[List project user role assignments](https://platform.openai.com/docs/api-reference/role-assignments/projects/users/list?locale=en)

[Assign project role to user](https://platform.openai.com/docs/api-reference/role-assignments/projects/users/assign?locale=en)

[Unassign project role from user](https://platform.openai.com/docs/api-reference/role-assignments/projects/users/delete?locale=en)

[The group role object](https://platform.openai.com/docs/api-reference/role-assignments/objects/group?locale=en)

[The user role object](https://platform.openai.com/docs/api-reference/role-assignments/objects/user?locale=en)
...
gethttps://api.openai.com/v1/organization/groups/{group\_id}/roles
...
posthttps://api.openai.com/v1/organization/groups/{group\_id}/roles
...
The created [group role object](https://platform.openai.com/docs/api-reference/role-assignments/objects/group).
...
deletehttps://api.openai.com/v1/organization/groups/{group\_id}/roles/{role\_id}
...
Confirmation of the deleted [group role object](https://platform.openai.com/docs/api-reference/role-assignments/objects/group).
...
gethttps://api.openai.com/v1/organization/users/{user\_id}/roles
...
posthttps://api.openai.com/v1/organization/users/{user\_id}/roles
...
The created [user role object](https://platform.openai.com/docs/api-reference/role-assignments/objects/user).
...
deletehttps://api.openai.com/v1/organization/users/{user\_id}/roles/{role\_id}
...
Confirmation of the deleted [user role object](https://platform.openai.com/docs/api-reference/role-assignments/objects/user).
...
gethttps://api.openai.com/v1/projects/{project\_id}/groups/{group\_id}/roles
...
posthttps://api.openai.com/v1/projects/{project\_id}/groups/{group\_id}/roles
...
deletehttps://api.openai.com/v1/projects/{project\_id}/groups/{group\_id}/roles/{role\_id}
...
gethttps://api.openai.com/v1/projects/{project\_id}/users/{user\_id}/roles
...
posthttps://api.openai.com/v1/projects/{project\_id}/users/{user\_id}/roles
...
deletehttps://api.openai.com/v1/projects/{project\_id}/users/{user\_id}/roles/{role\_id}
...
[PreviousRoles](https://platform.openai.com/docs/api-reference/roles?locale=en) [NextProjects](https://platform.openai.com/docs/api-reference/projects?locale=en)
