...
[Cancel a run](https://platform.openai.com/docs/api-reference/runs/cancelRun)

[The run object](https://platform.openai.com/docs/api-reference/runs/object)
...
[PreviousMessages](https://platform.openai.com/docs/api-reference/messages) [NextRun steps](https://platform.openai.com/docs/api-reference/run-steps)