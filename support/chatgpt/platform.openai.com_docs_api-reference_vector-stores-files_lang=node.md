---
url: "https://platform.openai.com/docs/api-reference/vector-stores-files?lang=node"
title: "Vector store files | OpenAI API Reference"
---
...
[Create vector store file](https://platform.openai.com/docs/api-reference/vector-stores-files/createFile?lang=node)

[List vector store files](https://platform.openai.com/docs/api-reference/vector-stores-files/listFiles?lang=node)

[Retrieve vector store file](https://platform.openai.com/docs/api-reference/vector-stores-files/getFile?lang=node)

[Retrieve vector store file content](https://platform.openai.com/docs/api-reference/vector-stores-files/getContent?lang=node)

[Update vector store file attributes](https://platform.openai.com/docs/api-reference/vector-stores-files/updateAttributes?lang=node)

[Delete vector store file](https://platform.openai.com/docs/api-reference/vector-stores-files/deleteFile?lang=node)

[The vector store file object](https://platform.openai.com/docs/api-reference/vector-stores-files/file-object?lang=node)
...
[PreviousVector stores](https://platform.openai.com/docs/api-reference/vector-stores?lang=node) [NextVector store file batches](https://platform.openai.com/docs/api-reference/vector-stores-file-batches?lang=node)
