---
url: "https://platform.openai.com/docs/api-reference/runs?locale=en"
...
[Create run](https://platform.openai.com/docs/api-reference/runs/createRun?locale=en)

[Create thread and run](https://platform.openai.com/docs/api-reference/runs/createThreadAndRun?locale=en)

[List runs](https://platform.openai.com/docs/api-reference/runs/listRuns?locale=en)

[Retrieve run](https://platform.openai.com/docs/api-reference/runs/getRun?locale=en)

[Modify run](https://platform.openai.com/docs/api-reference/runs/modifyRun?locale=en)

[Submit tool outputs to run](https://platform.openai.com/docs/api-reference/runs/submitToolOutputs?locale=en)

[Cancel a run](https://platform.openai.com/docs/api-reference/runs/cancelRun?locale=en)

[The run object](https://platform.openai.com/docs/api-reference/runs/object?locale=en)
...
[PreviousMessages](https://platform.openai.com/docs/api-reference/messages?locale=en) [NextRun steps](https://platform.openai.com/docs/api-reference/run-steps?locale=en)