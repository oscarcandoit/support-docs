---
url: "https://platform.openai.com/docs/api-reference/models?locale=en"
...
[List models](https://platform.openai.com/docs/api-reference/models/list?locale=en)

[Retrieve model](https://platform.openai.com/docs/api-reference/models/retrieve?locale=en)

[Delete a fine-tuned model](https://platform.openai.com/docs/api-reference/models/delete?locale=en)

[The model object](https://platform.openai.com/docs/api-reference/models/object?locale=en)
...
[PreviousUploads](https://platform.openai.com/docs/api-reference/uploads?locale=en) [NextModerations](https://platform.openai.com/docs/api-reference/moderations?locale=en)
