---
url: "https://platform.openai.com/docs/api-reference/graders?locale=en"
...
[String Check Grader](https://platform.openai.com/docs/api-reference/graders/string-check?locale=en)

[Text Similarity Grader](https://platform.openai.com/docs/api-reference/graders/text-similarity?locale=en)

[Score Model Grader](https://platform.openai.com/docs/api-reference/graders/score-model?locale=en)

[Label Model Grader](https://platform.openai.com/docs/api-reference/graders/label-model?locale=en)

[Python Grader](https://platform.openai.com/docs/api-reference/graders/python?locale=en)

[Multi Grader](https://platform.openai.com/docs/api-reference/graders/multi?locale=en)

[Run grader](https://platform.openai.com/docs/api-reference/graders/run?locale=en)

[Validate grader](https://platform.openai.com/docs/api-reference/graders/validate?locale=en)
...
[PreviousFine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning?locale=en) [NextBatch](https://platform.openai.com/docs/api-reference/batch?locale=en)