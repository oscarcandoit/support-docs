...
[The image generation response](https://platform.openai.com/docs/api-reference/images/object)
...
[PreviousVideos](https://platform.openai.com/docs/api-reference/videos) [NextImage Streaming](https://platform.openai.com/docs/api-reference/images-streaming)
