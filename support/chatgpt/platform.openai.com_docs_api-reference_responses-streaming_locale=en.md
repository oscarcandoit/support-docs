---
url: "https://platform.openai.com/docs/api-reference/responses-streaming?locale=en"
...
[response](https://platform.openai.com/docs/api-reference/responses-streaming/response?locale=en)

[.created](https://platform.openai.com/docs/api-reference/responses-streaming/response/created?locale=en)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/in_progress?locale=en)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/completed?locale=en)

[.failed](https://platform.openai.com/docs/api-reference/responses-streaming/response/failed?locale=en)

[.incomplete](https://platform.openai.com/docs/api-reference/responses-streaming/response/incomplete?locale=en)

[.output\_item](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_item?locale=en)

[.added](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_item/added?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_item/done?locale=en)

[.content\_part](https://platform.openai.com/docs/api-reference/responses-streaming/response/content_part?locale=en)

[.added](https://platform.openai.com/docs/api-reference/responses-streaming/response/content_part/added?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/content_part/done?locale=en)

[response.output\_text.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text/delta?locale=en)

[response.output\_text.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text/done?locale=en)

[.refusal](https://platform.openai.com/docs/api-reference/responses-streaming/response/refusal?locale=en)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/refusal/delta?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/refusal/done?locale=en)

[.function\_call\_arguments](https://platform.openai.com/docs/api-reference/responses-streaming/response/function_call_arguments?locale=en)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/function_call_arguments/delta?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/function_call_arguments/done?locale=en)

[.file\_search\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/file_search_call?locale=en)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/file_search_call/in_progress?locale=en)

[.searching](https://platform.openai.com/docs/api-reference/responses-streaming/response/file_search_call/searching?locale=en)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/file_search_call/completed?locale=en)

[.web\_search\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/web_search_call?locale=en)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/web_search_call/in_progress?locale=en)

[.searching](https://platform.openai.com/docs/api-reference/responses-streaming/response/web_search_call/searching?locale=en)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/web_search_call/completed?locale=en)

[.reasoning\_summary\_part](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_part?locale=en)

[.added](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_part/added?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_part/done?locale=en)

[.reasoning\_summary\_text](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_text?locale=en)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_text/delta?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_summary_text/done?locale=en)

[.reasoning\_text](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_text?locale=en)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_text/delta?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/reasoning_text/done?locale=en)

[.image\_generation\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call?locale=en)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call/completed?locale=en)

[.generating](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call/generating?locale=en)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call/in_progress?locale=en)

[.partial\_image](https://platform.openai.com/docs/api-reference/responses-streaming/response/image_generation_call/partial_image?locale=en)

[.mcp\_call\_arguments](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call_arguments?locale=en)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call_arguments/delta?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call_arguments/done?locale=en)

[.mcp\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call?locale=en)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call/completed?locale=en)

[.failed](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call/failed?locale=en)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_call/in_progress?locale=en)

[.mcp\_list\_tools](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_list_tools?locale=en)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_list_tools/completed?locale=en)

[.failed](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_list_tools/failed?locale=en)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/mcp_list_tools/in_progress?locale=en)

[.code\_interpreter\_call](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call?locale=en)

[.in\_progress](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call/in_progress?locale=en)

[.interpreting](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call/interpreting?locale=en)

[.completed](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call/completed?locale=en)

[.code\_interpreter\_call\_code](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call_code?locale=en)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call_code/delta?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/code_interpreter_call_code/done?locale=en)

[.output\_text](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text?locale=en)

[.annotation](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text/annotation?locale=en)

[.added](https://platform.openai.com/docs/api-reference/responses-streaming/response/output_text/annotation/added?locale=en)

[.queued](https://platform.openai.com/docs/api-reference/responses-streaming/response/queued?locale=en)

[.custom\_tool\_call\_input](https://platform.openai.com/docs/api-reference/responses-streaming/response/custom_tool_call_input?locale=en)

[.delta](https://platform.openai.com/docs/api-reference/responses-streaming/response/custom_tool_call_input/delta?locale=en)

[.done](https://platform.openai.com/docs/api-reference/responses-streaming/response/custom_tool_call_input/done?locale=en)

[error](https://platform.openai.com/docs/api-reference/responses-streaming/error?locale=en)
...
[PreviousConversations](https://platform.openai.com/docs/api-reference/conversations?locale=en) [NextWebhook Events](https://platform.openai.com/docs/api-reference/webhook-events?locale=en)
