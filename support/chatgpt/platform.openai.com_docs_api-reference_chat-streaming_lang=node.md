---
url: "https://platform.openai.com/docs/api-reference/chat-streaming?lang=node"
...
[The chat completion chunk object](https://platform.openai.com/docs/api-reference/chat-streaming/streaming?lang=node)
...
[PreviousChat Completions](https://platform.openai.com/docs/api-reference/chat?lang=node) [NextAssistants](https://platform.openai.com/docs/api-reference/assistants?lang=node)