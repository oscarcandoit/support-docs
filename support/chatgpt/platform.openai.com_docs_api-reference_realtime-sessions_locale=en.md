---
url: "https://platform.openai.com/docs/api-reference/realtime-sessions?locale=en"
...
[Create client secret](https://platform.openai.com/docs/api-reference/realtime-sessions/create-realtime-client-secret?locale=en)

[Session response object](https://platform.openai.com/docs/api-reference/realtime-sessions/create-secret-response?locale=en)
...
[PreviousRealtime](https://platform.openai.com/docs/api-reference/realtime?locale=en) [NextCalls](https://platform.openai.com/docs/api-reference/realtime-calls?locale=en)
