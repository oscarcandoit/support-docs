---
url: "https://platform.openai.com/docs/api-reference/realtime-client-events?lang=node"
...
[session](https://platform.openai.com/docs/api-reference/realtime-client-events/session?lang=node)

[.update](https://platform.openai.com/docs/api-reference/realtime-client-events/session/update?lang=node)

[input\_audio\_buffer](https://platform.openai.com/docs/api-reference/realtime-client-events/input_audio_buffer?lang=node)

[.append](https://platform.openai.com/docs/api-reference/realtime-client-events/input_audio_buffer/append?lang=node)

[.commit](https://platform.openai.com/docs/api-reference/realtime-client-events/input_audio_buffer/commit?lang=node)

[.clear](https://platform.openai.com/docs/api-reference/realtime-client-events/input_audio_buffer/clear?lang=node)

[conversation](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation?lang=node)

[.item](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item?lang=node)

[.create](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item/create?lang=node)

[.retrieve](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item/retrieve?lang=node)

[.truncate](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item/truncate?lang=node)

[.delete](https://platform.openai.com/docs/api-reference/realtime-client-events/conversation/item/delete?lang=node)

[response](https://platform.openai.com/docs/api-reference/realtime-client-events/response?lang=node)

[.create](https://platform.openai.com/docs/api-reference/realtime-client-events/response/create?lang=node)

[.cancel](https://platform.openai.com/docs/api-reference/realtime-client-events/response/cancel?lang=node)

[output\_audio\_buffer](https://platform.openai.com/docs/api-reference/realtime-client-events/output_audio_buffer?lang=node)

[.clear](https://platform.openai.com/docs/api-reference/realtime-client-events/output_audio_buffer/clear?lang=node)
...
[PreviousCalls](https://platform.openai.com/docs/api-reference/realtime-calls?lang=node) [NextServer events](https://platform.openai.com/docs/api-reference/realtime-server-events?lang=node)
