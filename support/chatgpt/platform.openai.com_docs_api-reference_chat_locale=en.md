---
url: "https://platform.openai.com/docs/api-reference/chat?locale=en"
...
[Create chat completion](https://platform.openai.com/docs/api-reference/chat/create?locale=en)

[Get chat completion](https://platform.openai.com/docs/api-reference/chat/get?locale=en)

[Get chat messages](https://platform.openai.com/docs/api-reference/chat/getMessages?locale=en)

[List Chat Completions](https://platform.openai.com/docs/api-reference/chat/list?locale=en)

[Update chat completion](https://platform.openai.com/docs/api-reference/chat/update?locale=en)

[Delete chat completion](https://platform.openai.com/docs/api-reference/chat/delete?locale=en)

[The chat completion object](https://platform.openai.com/docs/api-reference/chat/object?locale=en)

[The chat completion list object](https://platform.openai.com/docs/api-reference/chat/list-object?locale=en)

[The chat completion message list object](https://platform.openai.com/docs/api-reference/chat/message-list?locale=en)
...
[PreviousServer events](https://platform.openai.com/docs/api-reference/realtime-server-events?locale=en) [NextStreaming](https://platform.openai.com/docs/api-reference/chat-streaming?locale=en)
