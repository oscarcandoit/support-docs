...
[Completions](https://platform.openai.com/docs/api-reference/usage/completions)

[Completions usage object](https://platform.openai.com/docs/api-reference/usage/completions_object)

[Embeddings](https://platform.openai.com/docs/api-reference/usage/embeddings)

[Embeddings usage object](https://platform.openai.com/docs/api-reference/usage/embeddings_object)

[Moderations](https://platform.openai.com/docs/api-reference/usage/moderations)

[Moderations usage object](https://platform.openai.com/docs/api-reference/usage/moderations_object)

[Images](https://platform.openai.com/docs/api-reference/usage/images)

[Images usage object](https://platform.openai.com/docs/api-reference/usage/images_object)

[Audio speeches](https://platform.openai.com/docs/api-reference/usage/audio_speeches)

[Audio speeches usage object](https://platform.openai.com/docs/api-reference/usage/audio_speeches_object)

[Audio transcriptions](https://platform.openai.com/docs/api-reference/usage/audio_transcriptions)

[Audio transcriptions usage object](https://platform.openai.com/docs/api-reference/usage/audio_transcriptions_object)

[Vector stores](https://platform.openai.com/docs/api-reference/usage/vector_stores)

[Vector stores usage object](https://platform.openai.com/docs/api-reference/usage/vector_stores_object)

[Code interpreter sessions](https://platform.openai.com/docs/api-reference/usage/code_interpreter_sessions)

[Code interpreter sessions usage object](https://platform.openai.com/docs/api-reference/usage/code_interpreter_sessions_object)

[Costs](https://platform.openai.com/docs/api-reference/usage/costs)

[Costs object](https://platform.openai.com/docs/api-reference/usage/costs_object)
...
[PreviousAudit logs](https://platform.openai.com/docs/api-reference/audit-logs) [NextCertificates](https://platform.openai.com/docs/api-reference/certificates)