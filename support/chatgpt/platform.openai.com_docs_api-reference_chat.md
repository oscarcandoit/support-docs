...
[Get chat completion](https://platform.openai.com/docs/api-reference/chat/get)

[Get chat messages](https://platform.openai.com/docs/api-reference/chat/getMessages)

[List Chat Completions](https://platform.openai.com/docs/api-reference/chat/list)

[Update chat completion](https://platform.openai.com/docs/api-reference/chat/update)

[Delete chat completion](https://platform.openai.com/docs/api-reference/chat/delete)

[The chat completion object](https://platform.openai.com/docs/api-reference/chat/object)

[The chat completion list object](https://platform.openai.com/docs/api-reference/chat/list-object)

[The chat completion message list object](https://platform.openai.com/docs/api-reference/chat/message-list)
...
[PreviousServer events](https://platform.openai.com/docs/api-reference/realtime-server-events) [NextStreaming](https://platform.openai.com/docs/api-reference/chat-streaming)
