---
url: "https://platform.openai.com/docs/api-reference/batch?lang=node"
...
[Create batch](https://platform.openai.com/docs/api-reference/batch/create?lang=node)

[Retrieve batch](https://platform.openai.com/docs/api-reference/batch/retrieve?lang=node)

[Cancel batch](https://platform.openai.com/docs/api-reference/batch/cancel?lang=node)

[List batch](https://platform.openai.com/docs/api-reference/batch/list?lang=node)

[The batch object](https://platform.openai.com/docs/api-reference/batch/object?lang=node)

[The request input object](https://platform.openai.com/docs/api-reference/batch/request-input?lang=node)

[The request output object](https://platform.openai.com/docs/api-reference/batch/request-output?lang=node)
...
[PreviousGraders](https://platform.openai.com/docs/api-reference/graders?lang=node) [NextFiles](https://platform.openai.com/docs/api-reference/files?lang=node)