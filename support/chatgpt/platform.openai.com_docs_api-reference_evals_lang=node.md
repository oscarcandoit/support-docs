---
url: "https://platform.openai.com/docs/api-reference/evals?lang=node"
...
[Create eval](https://platform.openai.com/docs/api-reference/evals/create?lang=node)

[Get an eval](https://platform.openai.com/docs/api-reference/evals/get?lang=node)

[Update an eval](https://platform.openai.com/docs/api-reference/evals/update?lang=node)

[Delete an eval](https://platform.openai.com/docs/api-reference/evals/delete?lang=node)

[List evals](https://platform.openai.com/docs/api-reference/evals/list?lang=node)

[Get eval runs](https://platform.openai.com/docs/api-reference/evals/getRuns?lang=node)

[Get an eval run](https://platform.openai.com/docs/api-reference/evals/getRun?lang=node)

[Create eval run](https://platform.openai.com/docs/api-reference/evals/createRun?lang=node)

[Cancel eval run](https://platform.openai.com/docs/api-reference/evals/cancelRun?lang=node)

[Delete eval run](https://platform.openai.com/docs/api-reference/evals/deleteRun?lang=node)

[Get an output item of an eval run](https://platform.openai.com/docs/api-reference/evals/getRunOutputItem?lang=node)

[Get eval run output items](https://platform.openai.com/docs/api-reference/evals/getRunOutputItems?lang=node)

[The eval object](https://platform.openai.com/docs/api-reference/evals/object?lang=node)

[The eval run object](https://platform.openai.com/docs/api-reference/evals/run-object?lang=node)

[The eval run output item object](https://platform.openai.com/docs/api-reference/evals/run-output-item-object?lang=node)
...
[PreviousEmbeddings](https://platform.openai.com/docs/api-reference/embeddings?lang=node) [NextFine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning?lang=node)