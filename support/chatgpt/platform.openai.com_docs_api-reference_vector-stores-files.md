...
[Retrieve vector store file content](https://platform.openai.com/docs/api-reference/vector-stores-files/getContent)

[Update vector store file attributes](https://platform.openai.com/docs/api-reference/vector-stores-files/updateAttributes)
...
[PreviousVector stores](https://platform.openai.com/docs/api-reference/vector-stores) [NextVector store file batches](https://platform.openai.com/docs/api-reference/vector-stores-file-batches)