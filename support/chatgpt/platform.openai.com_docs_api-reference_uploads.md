...
[Create upload](https://platform.openai.com/docs/api-reference/uploads/create)

[Add upload part](https://platform.openai.com/docs/api-reference/uploads/add-part)

[Complete upload](https://platform.openai.com/docs/api-reference/uploads/complete)

[Cancel upload](https://platform.openai.com/docs/api-reference/uploads/cancel)

[The upload object](https://platform.openai.com/docs/api-reference/uploads/object)

[The upload part object](https://platform.openai.com/docs/api-reference/uploads/part-object)
...
[PreviousFiles](https://platform.openai.com/docs/api-reference/files) [NextModels](https://platform.openai.com/docs/api-reference/models)