...
[Create eval](https://platform.openai.com/docs/api-reference/evals/create)

[Get an eval](https://platform.openai.com/docs/api-reference/evals/get)

[Update an eval](https://platform.openai.com/docs/api-reference/evals/update)

[Delete an eval](https://platform.openai.com/docs/api-reference/evals/delete)

[List evals](https://platform.openai.com/docs/api-reference/evals/list)

[Get eval runs](https://platform.openai.com/docs/api-reference/evals/getRuns)

[Get an eval run](https://platform.openai.com/docs/api-reference/evals/getRun)

[Create eval run](https://platform.openai.com/docs/api-reference/evals/createRun)

[Cancel eval run](https://platform.openai.com/docs/api-reference/evals/cancelRun)

[Delete eval run](https://platform.openai.com/docs/api-reference/evals/deleteRun)

[Get an output item of an eval run](https://platform.openai.com/docs/api-reference/evals/getRunOutputItem)

[Get eval run output items](https://platform.openai.com/docs/api-reference/evals/getRunOutputItems)

[The eval object](https://platform.openai.com/docs/api-reference/evals/object)

[The eval run object](https://platform.openai.com/docs/api-reference/evals/run-object)

[The eval run output item object](https://platform.openai.com/docs/api-reference/evals/run-output-item-object)
...
[PreviousEmbeddings](https://platform.openai.com/docs/api-reference/embeddings) [NextFine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning)
