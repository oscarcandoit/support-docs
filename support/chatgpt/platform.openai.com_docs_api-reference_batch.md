...
[The batch object](https://platform.openai.com/docs/api-reference/batch/object)

[The request input object](https://platform.openai.com/docs/api-reference/batch/request-input)

[The request output object](https://platform.openai.com/docs/api-reference/batch/request-output)
...
[PreviousGraders](https://platform.openai.com/docs/api-reference/graders) [NextFiles](https://platform.openai.com/docs/api-reference/files)
