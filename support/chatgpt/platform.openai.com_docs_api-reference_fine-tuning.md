...
[List checkpoint permissions](https://platform.openai.com/docs/api-reference/fine-tuning/list-permissions)

[Create checkpoint permissions](https://platform.openai.com/docs/api-reference/fine-tuning/create-permission)

[Delete checkpoint permission](https://platform.openai.com/docs/api-reference/fine-tuning/delete-permission)
...
[Resume fine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning/resume)

[Pause fine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning/pause)

[Training format for chat models using the supervised method](https://platform.openai.com/docs/api-reference/fine-tuning/chat-input)

[Training format for chat models using the preference method](https://platform.openai.com/docs/api-reference/fine-tuning/preference-input)

[Training format for reasoning models using the reinforcement method](https://platform.openai.com/docs/api-reference/fine-tuning/reinforcement-input)

[The fine-tuning job object](https://platform.openai.com/docs/api-reference/fine-tuning/object)

[The fine-tuning job event object](https://platform.openai.com/docs/api-reference/fine-tuning/event-object)

[The fine-tuning job checkpoint object](https://platform.openai.com/docs/api-reference/fine-tuning/checkpoint-object)

[The fine-tuned model checkpoint permission object](https://platform.openai.com/docs/api-reference/fine-tuning/permission-object)
...
[PreviousEvals](https://platform.openai.com/docs/api-reference/evals) [NextGraders](https://platform.openai.com/docs/api-reference/graders)
