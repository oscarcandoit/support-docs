---
url: "https://platform.openai.com/docs/api-reference/fine-tuning?locale=en"
title: "Fine-tuning | OpenAI API Reference"
---

[DocsDocs](https://platform.openai.com/docs/guides/fine-tuning) [API referenceAPI](https://platform.openai.com/docs/api-reference/introduction)
...
[Create fine-tuning job](https://platform.openai.com/docs/api-reference/fine-tuning/create?locale=en)

[List fine-tuning jobs](https://platform.openai.com/docs/api-reference/fine-tuning/list?locale=en)

[List fine-tuning events](https://platform.openai.com/docs/api-reference/fine-tuning/list-events?locale=en)

[List fine-tuning checkpoints](https://platform.openai.com/docs/api-reference/fine-tuning/list-checkpoints?locale=en)

[List checkpoint permissions](https://platform.openai.com/docs/api-reference/fine-tuning/list-permissions?locale=en)

[Create checkpoint permissions](https://platform.openai.com/docs/api-reference/fine-tuning/create-permission?locale=en)

[Delete checkpoint permission](https://platform.openai.com/docs/api-reference/fine-tuning/delete-permission?locale=en)

[Retrieve fine-tuning job](https://platform.openai.com/docs/api-reference/fine-tuning/retrieve?locale=en)

[Cancel fine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning/cancel?locale=en)

[Resume fine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning/resume?locale=en)

[Pause fine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning/pause?locale=en)

[Training format for chat models using the supervised method](https://platform.openai.com/docs/api-reference/fine-tuning/chat-input?locale=en)

[Training format for chat models using the preference method](https://platform.openai.com/docs/api-reference/fine-tuning/preference-input?locale=en)

[Training format for reasoning models using the reinforcement method](https://platform.openai.com/docs/api-reference/fine-tuning/reinforcement-input?locale=en)

[The fine-tuning job object](https://platform.openai.com/docs/api-reference/fine-tuning/object?locale=en)

[The fine-tuning job event object](https://platform.openai.com/docs/api-reference/fine-tuning/event-object?locale=en)

[The fine-tuning job checkpoint object](https://platform.openai.com/docs/api-reference/fine-tuning/checkpoint-object?locale=en)

[The fine-tuned model checkpoint permission object](https://platform.openai.com/docs/api-reference/fine-tuning/permission-object?locale=en)
...
[PreviousEvals](https://platform.openai.com/docs/api-reference/evals?locale=en) [NextGraders](https://platform.openai.com/docs/api-reference/graders?locale=en)