...
However, when transferring a project between two teams owned by the same user, it is recommended to use the [Project Transfer flow](https://vercel.com/docs/projects/transferring-projects#starting-a-transfer) instead of the Claim Deployments flow.

## [Get started](https://vercel.com/docs/deployments/claim-deployments\#get-started)
...
## [Associated resources](https://vercel.com/docs/deployments/claim-deployments\#associated-resources)
...
For more details on the transfer process, see [Resources with Claim Deployments flows](https://vercel.com/docs/integrations/create-integration/marketplace-flows#resources-with-claim-deployments).

## [Important endpoints](https://vercel.com/docs/deployments/claim-deployments\#important-endpoints)

- Claim Deployments URL:`https://vercel.com/claim-deployment?[...]`

- Initiate a project transfer request: [POST /projects/:idOrName/transfer-request](https://vercel.com/docs/rest-api/reference/endpoints/projects/create-project-transfer-request)

- Complete a project transfer: [PUT /projects/transfer-request/:code](https://vercel.com/docs/rest-api/reference/endpoints/projects/accept-project-transfer-request)
  - _This endpoint is not needed if you are using the Claim Deployments URL_

## [Example use case: automated AI-generated deployment](https://vercel.com/docs/deployments/claim-deployments\#example-use-case:-automated-ai-generated-deployment)

1. File upload: The AI agent uploads the deployment files using the Vercel API: [POST /files](https://vercel.com/docs/rest-api/reference/endpoints/deployments/upload-deployment-files).

2. Deployment creation:
   - Create a new deployment using the [Vercel CLI](https://vercel.com/docs/cli/deploying-from-cli)
   - Or create a deployment with the Vercel API: [POST /files](https://vercel.com/docs/rest-api/reference/endpoints/deployments/upload-deployment-files) followed by [POST /deployments](https://vercel.com/docs/rest-api/reference/endpoints/deployments/create-a-new-deployment).
3. Project transfer request:
   - The agent initiates a transfer request with: [POST /projects/:idOrName/transfer-request](https://vercel.com/docs/rest-api/reference/endpoints/projects/create-project-transfer-request).
...
6. Project transfer completion:
   - After the user clicks Transfer, the Vercel API ( [PUT /projects/transfer-request/:code](https://vercel.com/docs/rest-api/reference/endpoints/projects/accept-project-transfer-request)) completes the project transfer, assigning it to the user’s selected team. This step is not necessary if you are using the Claim Deployments Flow.
...
## [Team restructuring](https://vercel.com/docs/deployments/claim-deployments\#team-restructuring)
...
## [Migrating personal projects to a company account](https://vercel.com/docs/deployments/claim-deployments\#migrating-personal-projects-to-a-company-account)
