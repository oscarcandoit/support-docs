---
url: "https://vercel.com/docs/fundamentals"
...
- [What is Compute?](https://vercel.com/docs/fundamentals/what-is-compute): Explains how Vercel manages building, rendering, and on-demand tasks. Including:
  - Dedicated servers vs. Vercel functions
  - Cold starts, region models, and maximum durations
  - Fluid compute
- [What is Streaming?](https://vercel.com/docs/fundamentals/what-is-streaming): Shows how to send data progressively from Vercel Functions using the Web Streams API. Including:
