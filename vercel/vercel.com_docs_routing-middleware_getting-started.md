...
## [What you will learn](https://vercel.com/docs/routing-middleware/getting-started\#what-you-will-learn)
...
## [Prerequisites](https://vercel.com/docs/routing-middleware/getting-started\#prerequisites)

- A Vercel project
- Basic knowledge of JavaScript/TypeScript

## [Creating a Routing Middleware](https://vercel.com/docs/routing-middleware/getting-started\#creating-a-routing-middleware)

The following steps will guide you through creating your first Routing Middleware.

1. ### [Create a new file for your Routing Middleware](https://vercel.com/docs/routing-middleware/getting-started\#create-a-new-file-for-your-routing-middleware)
...
[Open inOpen in v0](https://v0.app/chat?q=%20%20Create%20a%20minimal%20example%20app%20for%20this%20code:%20export%20const%20config%20=%20{%20%20runtime:%20%27nodejs%27,%20//%20optional:%20use%20%27nodejs%27%20or%20omit%20for%20%27edge%27%20(default)};%20export%20default%20function%20middleware(request:%20Request)%20{%20%20console.log(%27Request%20to:%27,%20request.url);%20%20return%20new%20Response(%27Logging%20request%20URL%20from%20Middleware%27);}%20In%20your%20response:%20%201.%20Keep%20the%20example%20simple%20and%20focused%20on%20demonstrating%20the%20core%20functionality%20of%20the%20code%20%202.%20DO%20NOT%20include%20unnecessary%20features%20or%20complexity,%20aim%20to%20only%20showcase%20the%20essential%20parts%20%203.%20Show%20the%20code%20in%20a%20way%20that%20is%20easy%20to%20understand%20and%20implement%20%204.%20Provide%20clear%20and%20concise%20explanations%20for%20each%20part%20of%20the%20code)
...
2. ### [Redirecting users](https://vercel.com/docs/routing-middleware/getting-started\#redirecting-users)
...
[Open inOpen in v0](https://v0.app/chat?q=%20%20Create%20a%20minimal%20example%20app%20for%20this%20code:%20export%20const%20config%20=%20{%20%20runtime:%20%27nodejs%27,%20//%20optional:%20use%20%27nodejs%27%20or%20omit%20for%20%27edge%27%20(default)};%20export%20default%20function%20middleware(request:%20Request)%20{%20%20const%20url%20=%20new%20URL(request.url);%20%20%20//%20Redirect%20old%20blog%20path%20to%20new%20one%20%20if%20(url.pathname%20===%20%27/old-blog%27)%20{%20%20%20%20return%20new%20Response(null,%20{%20%20%20%20%20%20status:%20302,%20%20%20%20%20%20headers:%20{%20Location:%20%27/blog%27%20},%20%20%20%20});%20%20}%20%20%20//%20Let%20other%20requests%20continue%20normally%20%20return%20new%20Response(%27Other%20pages%20work%20normally%27);}%20In%20your%20response:%20%201.%20Keep%20the%20example%20simple%20and%20focused%20on%20demonstrating%20the%20core%20functionality%20of%20the%20code%20%202.%20DO%20NOT%20include%20unnecessary%20features%20or%20complexity,%20aim%20to%20only%20showcase%20the%20essential%20parts%20%203.%20Show%20the%20code%20in%20a%20way%20that%20is%20easy%20to%20understand%20and%20implement%20%204.%20Provide%20clear%20and%20concise%20explanations%20for%20each%20part%20of%20the%20code)
...
3. ### [Configure which paths trigger the middleware](https://vercel.com/docs/routing-middleware/getting-started\#configure-which-paths-trigger-the-middleware)
...
[Open inOpen in v0](https://v0.app/chat?q=%20%20Create%20a%20minimal%20example%20app%20for%20this%20code:%20export%20default%20function%20middleware(request:%20Request)%20{%20%20const%20url%20=%20new%20URL(request.url);%20%20%20//%20Only%20handle%20specific%20redirects%20%20if%20(url.pathname%20===%20%27/old-blog%27)%20{%20%20%20%20return%20new%20Response(null,%20{%20%20%20%20%20%20status:%20302,%20%20%20%20%20%20headers:%20{%20Location:%20%27/blog%27%20},%20%20%20%20});%20%20}%20%20%20return%20new%20Response(%27Middleware%20processed%20this%20request%27);}%20//%20Configure%20which%20paths%20trigger%20the%20Middlewareexport%20const%20config%20=%20{%20%20matcher:%20[%20%20%20%20//%20Run%20on%20all%20paths%20except%20static%20files%20%20%20%20%27/((?!_next/static|_next/image|favicon.ico).*)%27,%20%20%20%20//%20Or%20be%20more%20specific:%20%20%20%20//%20%27/blog/:path*%27,%20%20%20%20//%20%27/api/:path*%27%20%20],};%20In%20your%20response:%20%201.%20Keep%20the%20example%20simple%20and%20focused%20on%20demonstrating%20the%20core%20functionality%20of%20the%20code%20%202.%20DO%20NOT%20include%20unnecessary%20features%20or%20complexity,%20aim%20to%20only%20showcase%20the%20essential%20parts%20%203.%20Show%20the%20code%20in%20a%20way%20that%20is%20easy%20to%20understand%20and%20implement%20%204.%20Provide%20clear%20and%20concise%20explanations%20for%20each%20part%20of%20the%20code)
...
4. ### [Debugging Routing Middleware](https://vercel.com/docs/routing-middleware/getting-started\#debugging-routing-middleware)
...
1. Check the logs: Use `console.log()` liberally and check your [Vercel dashboard](https://vercel.com/dashboard) Logs tab
...
## [More resources](https://vercel.com/docs/routing-middleware/getting-started\#more-resources)
...
- [Prerequisites](https://vercel.com/docs/routing-middleware/getting-started#prerequisites)
- [Creating a Routing Middleware](https://vercel.com/docs/routing-middleware/getting-started#creating-a-routing-middleware)
- [Create a new file for your Routing Middleware](https://vercel.com/docs/routing-middleware/getting-started#create-a-new-file-for-your-routing-middleware)
- [Redirecting users](https://vercel.com/docs/routing-middleware/getting-started#redirecting-users)
- [Configure which paths trigger the middleware](https://vercel.com/docs/routing-middleware/getting-started#configure-which-paths-trigger-the-middleware)
- [Debugging Routing Middleware](https://vercel.com/docs/routing-middleware/getting-started#debugging-routing-middleware)
- [More resources](https://vercel.com/docs/routing-middleware/getting-started#more-resources)
