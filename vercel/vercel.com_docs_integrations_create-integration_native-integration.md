---
url: "https://vercel.com/docs/integrations/create-integration/native-integration"
...
## [Team installations](https://vercel.com/docs/integrations/create-integration/native-integration\#team-installations)
...
### [Limits](https://vercel.com/docs/integrations/create-integration/native-integration\#limits)
...
## [Products](https://vercel.com/docs/integrations/create-integration/native-integration\#products)
...
| [Billing plan](https://vercel.com/docs/integrations/create-integration/native-integration#billing-and-usage) | Each product has an associated pricing structure that the provider specifies when creating products. |

## [Resources](https://vercel.com/docs/integrations/create-integration/native-integration\#resources)
...
### [Resource usage patterns](https://vercel.com/docs/integrations/create-integration/native-integration\#resource-usage-patterns)
...
## [Relationships](https://vercel.com/docs/integrations/create-integration/native-integration\#relationships)
...
## [Billing and usage](https://vercel.com/docs/integrations/create-integration/native-integration\#billing-and-usage)
...
## [More resources](https://vercel.com/docs/integrations/create-integration/native-integration\#more-resources)

To successfully implement your native integration, you'll need to handle several key flows:

- [Storage product creation flow](https://vercel.com/docs/integrations/create-integration/marketplace-flows#create-a-storage-product-flow)
- [Data synchronization flows between Vercel and the provider](https://vercel.com/docs/integrations/create-integration/marketplace-flows#connections-between-vercel-and-the-provider)
- [Provider dashboard access](https://vercel.com/docs/integrations/create-integration/marketplace-flows#open-in-provider-button-flow)
- [Credential management](https://vercel.com/docs/integrations/create-integration/marketplace-flows#rotate-credentials-in-provider-flow)
- [Experimentation integrations flows](https://vercel.com/docs/integrations/create-integration/marketplace-flows#flows-for-the-experimentation-category)
- [Flows for resource handling with claim deployments](https://vercel.com/docs/integrations/create-integration/marketplace-flows#resources-with-claim-deployments)
