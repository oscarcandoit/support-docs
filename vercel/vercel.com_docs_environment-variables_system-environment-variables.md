...
1. Navigate to your project on your [dashboard](https://vercel.com/dashboard).
...
If you disable this setting, no deployment ID will be made available for supported frameworks (like Next.js) to use, which means [Skew Protection](https://vercel.com/docs/skew-protection) will also be disabled.

## [System environment variables](https://vercel.com/docs/environment-variables/system-environment-variables\#system-environment-variables)
...
`process.env.CI = true`\\
error?](https://vercel.com/kb/guide/how-do-i-resolve-a-process-env-ci-true-error)

### [VERCEL](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL)
...
### [CI](https://vercel.com/docs/environment-variables/system-environment-variables\#CI)
...
### [VERCEL\_ENV](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_ENV)
...
### [VERCEL\_TARGET\_ENV](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_TARGET_ENV)
...
### [VERCEL\_URL](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_URL)
...
### [VERCEL\_BRANCH\_URL](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_BRANCH_URL)
...
### [VERCEL\_PROJECT\_PRODUCTION\_URL](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_PROJECT_PRODUCTION_URL)
...
### [VERCEL\_REGION](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_REGION)

**Available at:** Runtime

The ID of the [Region](https://vercel.com/docs/regions) where the app is running.
...
### [VERCEL\_DEPLOYMENT\_ID](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_DEPLOYMENT_ID)

**Available at:** Both build and runtime

The unique identifier for the deployment, which can be used to implement [Skew Protection](https://vercel.com/docs/skew-protection).
...
### [VERCEL\_PROJECT\_ID](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_PROJECT_ID)
...
### [VERCEL\_SKEW\_PROTECTION\_ENABLED](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_SKEW_PROTECTION_ENABLED)

**Available at:** Both build and runtime

When [Skew Protection](https://vercel.com/docs/skew-protection) is enabled in Project Settings, this value is set to`1`.
...
### [VERCEL\_AUTOMATION\_BYPASS\_SECRET](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_AUTOMATION_BYPASS_SECRET)

**Available at:** Both build and runtime

The [Protection Bypass for Automation](https://vercel.com/docs/security/deployment-protection/methods-to-bypass-deployment-protection/protection-bypass-automation) value, if the secret has been generated in the project's [Deployment Protection](https://vercel.com/docs/security/deployment-protection) settings.
...
### [VERCEL\_OIDC\_TOKEN](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_OIDC_TOKEN)

**Available at:** Build time

When Secure Backend Access with [OpenID Connect (OIDC) Federation](https://vercel.com/docs/oidc) is enabled in Project Settings, this value is set to a Vercel-issued OIDC token. At runtime, the token is set to the`x-vercel-oidc-token` header on your functions' `Request` object. In local development, you can download the token using the CLI command`vercel env pull`.
...
### [VERCEL\_GIT\_PROVIDER](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_PROVIDER)
...
### [VERCEL\_GIT\_REPO\_SLUG](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_REPO_SLUG)
...
### [VERCEL\_GIT\_REPO\_OWNER](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_REPO_OWNER)
...
### [VERCEL\_GIT\_REPO\_ID](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_REPO_ID)
...
### [VERCEL\_GIT\_COMMIT\_REF](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_COMMIT_REF)
...
### [VERCEL\_GIT\_COMMIT\_SHA](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_COMMIT_SHA)
...
### [VERCEL\_GIT\_COMMIT\_MESSAGE](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_COMMIT_MESSAGE)
...
### [VERCEL\_GIT\_COMMIT\_AUTHOR\_LOGIN](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_COMMIT_AUTHOR_LOGIN)
...
### [VERCEL\_GIT\_COMMIT\_AUTHOR\_NAME](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_COMMIT_AUTHOR_NAME)
...
### [VERCEL\_GIT\_PREVIOUS\_SHA](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_PREVIOUS_SHA)
...
### [VERCEL\_GIT\_PULL\_REQUEST\_ID](https://vercel.com/docs/environment-variables/system-environment-variables\#VERCEL_GIT_PULL_REQUEST_ID)
