...
## [Troubleshoot](https://vercel.com/docs/errors/INTERNAL_EDGE_FUNCTION_INVOCATION_TIMEOUT\#troubleshoot)
...
3. Verify return value: Ensure the function begins responding within [25 seconds](https://vercel.com/docs/functions/limitations#max-duration)
