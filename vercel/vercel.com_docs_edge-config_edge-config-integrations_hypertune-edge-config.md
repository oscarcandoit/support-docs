---
url: "https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config"
...
## [Prerequisites](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config\#prerequisites)
...
## [Get Started](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config\#get-started)
...
1. ### [Set up your local environment](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config\#set-up-your-local-environment)
...
2. ### [Manage your flags in Hypertune](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config\#manage-your-flags-in-hypertune)
...
3. ### [Generate a type-safe client](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config\#generate-a-type-safe-client)
...
4. ### [Declare flags in your code](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config\#declare-flags-in-your-code)
...
See the [more resources](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#more-resources) section for more information about
the Hypertune and Flags SDK.

5. ### [Use flags in your app](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config\#use-flags-in-your-app)
...
## [Next steps](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config\#next-steps)

Learn more about Edge Config:

- [Get started with Edge Config](https://vercel.com/docs/edge-config/get-started)
- [Manage Edge Config on the dashboard](https://vercel.com/docs/edge-config/edge-config-dashboard)
- [View the Edge Config SDK reference](https://vercel.com/docs/edge-config/edge-config-sdk)
- [View Edge Config limits](https://vercel.com/docs/edge-config/edge-config-limits)

## [More resources](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config\#more-resources)
...
- [Prerequisites](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#prerequisites)
- [Get Started](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#get-started)
- [Set up your local environment](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#set-up-your-local-environment)
- [Manage your flags in Hypertune](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#manage-your-flags-in-hypertune)
- [Generate a type-safe client](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#generate-a-type-safe-client)
- [Declare flags in your code](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#declare-flags-in-your-code)
- [Use flags in your app](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#use-flags-in-your-app)
- [Next steps](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#next-steps)
- [More resources](https://vercel.com/docs/edge-config/edge-config-integrations/hypertune-edge-config#more-resources)
