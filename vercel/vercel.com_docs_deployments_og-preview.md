...
4. Select the Open Graph tab:![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fog-tab-light.png&w=1080&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fog-tab-dark.png&w=1080&q=75)
...
## [Filter by pathname](https://vercel.com/docs/deployments/og-preview\#filter-by-pathname)

You can use the Path dropdown to view the OG card for any page on that particular deployment.

## [Metadata](https://vercel.com/docs/deployments/og-preview\#metadata)
...
| `og:image` | Absolute URL to image. | Use the [OG Image Generation](https://vercel.com/docs/og-image-generation) documentation to create new images. |
...
### [Twitter-specific metadata](https://vercel.com/docs/deployments/og-preview\#twitter-specific-metadata)
