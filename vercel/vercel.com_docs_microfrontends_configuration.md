...
The `microfrontends.json` file is used to configure your microfrontends. If this file is not deployed with your [default application](https://vercel.com/docs/microfrontends/quickstart#key-concepts), the deployment will not be a microfrontend.

## [Schema](https://vercel.com/docs/microfrontends/configuration\#schema)

### [Config](https://vercel.com/docs/microfrontends/configuration\#config)
...
| `applications` | [ApplicationRouting](https://vercel.com/docs/microfrontends/configuration#applicationrouting) | Mapping of Vercel project names to their microfrontend configurations. | Required |
| `options` | [Options](https://vercel.com/docs/microfrontends/configuration#options) | Optional configuration options for the microfrontend. |  |

### [ApplicationRouting](https://vercel.com/docs/microfrontends/configuration\#applicationrouting)

\[key: string\]: [Application](https://vercel.com/docs/microfrontends/configuration#application)
...
See. [application naming](https://vercel.com/docs/microfrontends/configuration#application-naming).

### [Application](https://vercel.com/docs/microfrontends/configuration\#application)

[DefaultApplication](https://vercel.com/docs/microfrontends/configuration#defaultapplication) or [ChildApplication](https://vercel.com/docs/microfrontends/configuration#childapplication).

The configuration for a microfrontend application. There must always be one default application.

### [DefaultApplication](https://vercel.com/docs/microfrontends/configuration\#defaultapplication)

| Property | Type | Description | Required |
| --- | --- | --- | --- |
| `packageName` | `string` | The name used to run the application, e.g. the \`name\` field in the \`package.json\`.<br>This is used by the local proxy to map the application config to the locally running app.<br>This is only necessary when the application name does not match the \`name\` used in \`package.json\`.<br>See. [application naming](https://vercel.com/docs/microfrontends/configuration#application-naming). |  |
| `development` | [DefaultDevelopment](https://vercel.com/docs/microfrontends/configuration#defaultdevelopment) | Development configuration for the default application. | Required |

### [DefaultDevelopment](https://vercel.com/docs/microfrontends/configuration\#defaultdevelopment)

| Property | Type | Description | Required |
| --- | --- | --- | --- |
| `local` | `number | string` | A local port number or host that this application runs on when it is running locally. If passing a string, include the protocol (optional), host (required) and port (optional).<br>Examples of valid values: 8080, my.localhost.me, my.localhost.me:8080, https://my.localhost.me, https://my.localhost.me:8080.<br>The default value is http://localhost:<port> where port is a stable, unique port number (based on the application name).<br>See. [local development](https://vercel.com/docs/microfrontends/local-development). |  |
| `task` | `string` | The task to run when starting the development server. Should reference a script in the package.json of the application.<br>The default value is "dev".<br>See. [local development](https://vercel.com/docs/microfrontends/local-development). |  |
| `fallback` | `string` | Fallback for local development, could point to any environment. This is required for the default app. This value is used as the fallback for child apps as well if they do not have a fallback.<br>If passing a string, include the protocol (optional), host (required) and port (optional). For example: \`https://this.ismyhost:8080\`. If omitted, the protocol defaults to HTTPS. If omitted, the port defaults to \`80\` for HTTP and \`443\` for HTTPS.<br>See. [local development](https://vercel.com/docs/microfrontends/local-development). | Required |

### [ChildApplication](https://vercel.com/docs/microfrontends/configuration\#childapplication)

| Property | Type | Description | Required |
| --- | --- | --- | --- |
| `packageName` | `string` | The name used to run the application, e.g. the \`name\` field in the \`package.json\`.<br>This is used by the local proxy to map the application config to the locally running app.<br>This is only necessary when the application name does not match the \`name\` used in \`package.json\`.<br>See. [application naming](https://vercel.com/docs/microfrontends/configuration#application-naming). |  |
| `development` | [ChildDevelopment](https://vercel.com/docs/microfrontends/configuration#childdevelopment) | Development configuration for the child application. |  |
| `routing` | [Routing](https://vercel.com/docs/microfrontends/configuration#routing) | Groups of path expressions that are routed to this application.<br>See. [path routing](https://vercel.com/docs/microfrontends/path-routing). | Required |
| `assetPrefix` | `string` | The name of the asset prefix to use instead of the auto-generated name.<br>The asset prefix is used to prefix all paths to static assets, such as JS, CSS, or images that are served by a specific application. It is necessary to ensure there are no conflicts with other applications on the same domain.<br>An auto-generated asset prefix of the form \`vc-ap-<hash>\` is used when this field is not provided.<br>When this field is provided, \`/${assetPrefix}/:path\*\` must also be added to the list of paths in the \`routing\` field. Changing the asset prefix after a microfrontend application has already been deployed is not a forwards and backwards compatible change, and the asset prefix should be added to the \`routing\` field and deployed before setting the \`assetPrefix\` field.<br>The default value is the auto-generated asset prefix of the form \`vc-ap-<hash>\`.<br>See. [asset prefix](https://vercel.com/docs/microfrontends/path-routing#asset-prefix). |  |

### [ChildDevelopment](https://vercel.com/docs/microfrontends/configuration\#childdevelopment)

| Property | Type | Description | Required |
| --- | --- | --- | --- |
| `local` | `number | string` | A local port number or host that this application runs on when it is running locally. If passing a string, include the protocol (optional), host (required) and port (optional).<br>Examples of valid values: 8080, my.localhost.me, my.localhost.me:8080, https://my.localhost.me, https://my.localhost.me:8080.<br>The default value is http://localhost:<port> where port is a stable, unique port number (based on the application name).<br>See. [local development](https://vercel.com/docs/microfrontends/local-development). |  |
| `task` | `string` | The task to run when starting the development server. Should reference a script in the package.json of the application.<br>The default value is "dev".<br>See. [local development](https://vercel.com/docs/microfrontends/local-development). |  |
| `fallback` | `string` | Fallback for local development, could point to any environment. If not provided for child apps, the fallback of the default app will be used.<br>If passing a string, include the protocol (optional), host (required) and port (optional). For example: \`https://this.ismyhost:8080\`. If omitted, the protocol defaults to HTTPS. If omitted, the port defaults to \`80\` for HTTP and \`443\` for HTTPS.<br>See. [local development](https://vercel.com/docs/microfrontends/local-development). |  |

### [Routing](https://vercel.com/docs/microfrontends/configuration\#routing)

[PathGroup\[\]](https://vercel.com/docs/microfrontends/configuration#pathgroup)
...
| `flag` | `string` | The name of the feature flag that controls routing for this group of paths. See. [routing changes safely with flags](https://vercel.com/docs/microfrontends/path-routing#routing-changes-safely-with-flags). |  |
| `paths` | `string[]` | A list of path expressions that are routed to this application. See. [supported path expressions](https://vercel.com/docs/microfrontends/path-routing#supported-path-expressions). | Required |

### [Options](https://vercel.com/docs/microfrontends/configuration\#options)

| Property | Type | Description | Required |
| --- | --- | --- | --- |
| `disableOverrides` | `boolean` | If you want to disable the overrides for the site. For example, if you are managing rewrites between applications externally, you may wish to disable the overrides on the toolbar as they will have no effect.<br>See. [routing overrides](https://vercel.com/docs/microfrontends/managing-microfrontends/vercel-toolbar#routing-overrides). |  |
| `localProxyPort` | `number` | The port number used by the local proxy server.<br>The default value is 3024.<br>See. [local development](https://vercel.com/docs/microfrontends/local-development). |  |

## [Example](https://vercel.com/docs/microfrontends/configuration\#example)
...
## [Application Naming](https://vercel.com/docs/microfrontends/configuration\#application-naming)
...
## [File Naming](https://vercel.com/docs/microfrontends/configuration\#file-naming)

The microfrontends configuration file can be named either `microfrontends.json` or `microfrontends.jsonc`.

You can also define a custom configuration file by setting the `VC_MICROFRONTENDS_CONFIG_FILE_NAME` environment variable — for example, `microfrontends-dev.json`. The file name must end with either `.json` or `.jsonc`, and it may include a path, such as `/path/to/microfrontends.json`. The filename / path specified is relative to the [root directory](https://vercel.com/docs/builds/configure-a-build#root-directory) for the [default application](https://vercel.com/docs/microfrontends/quickstart#key-concepts).

Be sure to add the [environment variable](https://vercel.com/docs/environment-variables/managing-environment-variables) to all projects within the microfrontends group.
