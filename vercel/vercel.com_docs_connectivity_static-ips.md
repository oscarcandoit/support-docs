...
Static IPsare availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans

With Static IPs (shared pool), you can access backend services that require IP allowlisting through static egress IPs. It's designed for Pro and Enterprise teams who need static IP functionality without the advanced networking or security features of [Secure Compute](https://vercel.com/docs/connectivity/secure-compute).

If you need dedicated infrastructure, VPC peering, or complete network isolation, consider [Secure Compute](https://vercel.com/docs/connectivity/secure-compute).

## [When to use Static IPs](https://vercel.com/docs/connectivity/static-ips\#when-to-use-static-ips)
...
## [When not to use Static IPs](https://vercel.com/docs/connectivity/static-ips\#when-not-to-use-static-ips)
...
### [Static IPs or Secure Compute](https://vercel.com/docs/connectivity/static-ips\#static-ips-or-secure-compute)
...
### [Static IPs with Secure Compute](https://vercel.com/docs/connectivity/static-ips\#static-ips-with-secure-compute)
...
Read our [getting started guide](https://vercel.com/docs/connectivity/static-ips/getting-started) to learn how to set up Static IPs.

## [How it works](https://vercel.com/docs/connectivity/static-ips\#how-it-works)
...
## [Managing your static IPs](https://vercel.com/docs/connectivity/static-ips\#managing-your-static-ips)

### [Routing build traffic](https://vercel.com/docs/connectivity/static-ips\#routing-build-traffic)
...
This setting is disabled by default. When enabled, both your project's build and deployed function traffic will route through static IPs and count as [Private Data Transfer](https://vercel.com/docs/connectivity/static-ips#pricing).

### [Routing Middleware support](https://vercel.com/docs/connectivity/static-ips\#routing-middleware-support)
...
### [Checking usage](https://vercel.com/docs/connectivity/static-ips\#checking-usage)
...
### [Static IPs with deployment environments](https://vercel.com/docs/connectivity/static-ips\#static-ips-with-deployment-environments)
...
### [Regional considerations](https://vercel.com/docs/connectivity/static-ips\#regional-considerations)

- Choose regions close to your backend services to reduce latency
- Each configured region has its own static IP pair

## [Limits and pricing](https://vercel.com/docs/connectivity/static-ips\#limits-and-pricing)

### [Limits](https://vercel.com/docs/connectivity/static-ips\#limits)
...
### [Pricing](https://vercel.com/docs/connectivity/static-ips\#pricing)

Static IPs are priced at $100/month per project for Pro plus Private Data Transfer priced regionally based on [regional pricing documentation](https://vercel.com/docs/pricing/regional-pricing).
