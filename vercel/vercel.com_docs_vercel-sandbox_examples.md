...
## [Using a private repository](https://vercel.com/docs/vercel-sandbox/examples\#using-a-private-repository)

In this example, you create an isolated environment from a private Git repository by authenticating with a [GitHub personal access token](https://vercel.com/docs/vercel-sandbox/examples#fine-grained-personal-access-token) or [GitHub App token](https://vercel.com/docs/vercel-sandbox/examples#other-github-methods), and run a simple command inside the sandbox.
...
### [GitHub access token options](https://vercel.com/docs/vercel-sandbox/examples\#github-access-token-options)

There are several ways to authenticate with private GitHub repositories.

#### [Fine-grained personal access token](https://vercel.com/docs/vercel-sandbox/examples\#fine-grained-personal-access-token)
...
#### [Other Github methods](https://vercel.com/docs/vercel-sandbox/examples\#other-github-methods)
...
## [Install system packages](https://vercel.com/docs/vercel-sandbox/examples\#install-system-packages)
...
## [Extend the timeout of a running sandbox](https://vercel.com/docs/vercel-sandbox/examples\#extend-the-timeout-of-a-running-sandbox)
...
for your plan](https://vercel.com/docs/vercel-sandbox/pricing#maximum-runtime-duration) has been reached.
