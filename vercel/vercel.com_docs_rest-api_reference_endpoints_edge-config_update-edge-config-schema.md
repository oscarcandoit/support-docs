---
url: "https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-schema"
title: "Update Edge Config schema - Vercel API Docs"
---

[Skip to main content](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-schema#content-area)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-schema#authorization-authorization)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-schema#parameter-edge-config-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-schema#parameter-dry-run)

dryRun

string

[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-schema#parameter-team-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-schema#parameter-slug)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-schema#body-definition)
...
[Get Edge Config schema](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-schema) [Delete an Edge Config's schema](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/delete-an-edge-configs-schema)
