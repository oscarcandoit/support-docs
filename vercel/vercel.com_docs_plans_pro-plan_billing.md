...
## [Payments](https://vercel.com/docs/plans/pro-plan/billing\#payments)

### [What is the price of the Pro plan?](https://vercel.com/docs/plans/pro-plan/billing\#what-is-the-price-of-the-pro-plan)

See the [pricing page](https://vercel.com/docs/pricing).

### [When are payments taken?](https://vercel.com/docs/plans/pro-plan/billing\#when-are-payments-taken)

At the beginning of each [billing cycle](https://vercel.com/docs/plans/pro-plan/billing#what-is-a-billing-cycle). Each invoice charges for the upcoming billing cycle. It includes any additional usage that occurred during the previous billing cycle.

### [What payment methods are available?](https://vercel.com/docs/plans/pro-plan/billing\#what-payment-methods-are-available)

Credit/Debit card only.

### [What card types can I pay with?](https://vercel.com/docs/plans/pro-plan/billing\#what-card-types-can-i-pay-with)
...
### [What currency can I pay in?](https://vercel.com/docs/plans/pro-plan/billing\#what-currency-can-i-pay-in)

You can pay in any currency so long as the credit card provider allows charging in USD _after_ conversion.

### [What happens when I cannot pay?](https://vercel.com/docs/plans/pro-plan/billing\#what-happens-when-i-cannot-pay)
...
For subscription renewals, payment must be successfully made within 14 days,
...
### [Can I delay my payment?](https://vercel.com/docs/plans/pro-plan/billing\#can-i-delay-my-payment)

No, you cannot delay your payment.

### [Can I pay annually?](https://vercel.com/docs/plans/pro-plan/billing\#can-i-pay-annually)
...
### [Can I change my payment method?](https://vercel.com/docs/plans/pro-plan/billing\#can-i-change-my-payment-method)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fscope-selector-light.png&w=640&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fscope-selector-dark.png&w=640&q=75)

Scope selector to switch between teams and accounts.

## [Invoices](https://vercel.com/docs/plans/pro-plan/billing\#invoices)

### [Can I pay by invoice?](https://vercel.com/docs/plans/pro-plan/billing\#can-i-pay-by-invoice)
...
### [Why am I overdue?](https://vercel.com/docs/plans/pro-plan/billing\#why-am-i-overdue)
...
See [What happens when I cannot pay](https://vercel.com/docs/plans/pro-plan/billing#what-happens-when-i-cannot-pay) for more information.

### [Can I change an existing invoice detail?](https://vercel.com/docs/plans/pro-plan/billing\#can-i-change-an-existing-invoice-detail)
...
### [Does Vercel possess and display their VAT ID on invoices?](https://vercel.com/docs/plans/pro-plan/billing\#does-vercel-possess-and-display-their-vat-id-on-invoices)
...
### [Can invoices be sent to my email?](https://vercel.com/docs/plans/pro-plan/billing\#can-invoices-be-sent-to-my-email)

Yes. By default, invoices are sent to the email address of the first [owner](https://vercel.com/docs/accounts/team-members-and-roles/access-roles#owner-role) of the team. To set a custom destination email address for your invoices, follow these steps:

1. From your [dashboard](https://vercel.com/dashboard), navigate to the Settings tab
...
### [Can I repay an invoice if I've used the wrong payment method?](https://vercel.com/docs/plans/pro-plan/billing\#can-i-repay-an-invoice-if-i've-used-the-wrong-payment-method)
...
## [Billing](https://vercel.com/docs/plans/pro-plan/billing\#billing)

### [How are add-ons billed?](https://vercel.com/docs/plans/pro-plan/billing\#how-are-add-ons-billed)

Pro add-ons are billed in the subsequent billing cycle as a line item on your invoice.

### [What happens if I purchase an add-on by mistake?](https://vercel.com/docs/plans/pro-plan/billing\#what-happens-if-i-purchase-an-add-on-by-mistake)

[Open a support ticket](https://vercel.com/help#issues) for your request and our team will assist you.

### [What do I do if I think my bill is wrong?](https://vercel.com/docs/plans/pro-plan/billing\#what-do-i-do-if-i-think-my-bill-is-wrong)
...
### [Do I get billed for DDoS?](https://vercel.com/docs/plans/pro-plan/billing\#do-i-get-billed-for-ddos)
...
You can monitor usage in the [Vercel Dashboard](https://vercel.com/dashboard) under the Usage tab, although you will [receive notifications](https://vercel.com/docs/notifications#on-demand-usage-notifications) when nearing your usage limits.

### [What is a billing cycle?](https://vercel.com/docs/plans/pro-plan/billing\#what-is-a-billing-cycle)
...
### [What if my usage goes over the included credit?](https://vercel.com/docs/plans/pro-plan/billing\#what-if-my-usage-goes-over-the-included-credit)

You will be charged for on-demand usage, which is billed at the end of the month.

### [What's the benefit of the credit-based model?](https://vercel.com/docs/plans/pro-plan/billing\#what's-the-benefit-of-the-credit-based-model)
...
## [Access](https://vercel.com/docs/plans/pro-plan/billing\#access)

### [What can the Viewer seat do?](https://vercel.com/docs/plans/pro-plan/billing\#what-can-the-viewer-seat-do)

[Viewer seats](https://vercel.com/docs/plans/pro-plan#viewer-team-seat) can:
...
- [Does Vercel possess and display their VAT ID on invoices?](https://vercel.com/docs/plans/pro-plan/billing#does-vercel-possess-and-display-their-vat-id-on-invoices)
- [Can invoices be sent to my email?](https://vercel.com/docs/plans/pro-plan/billing#can-invoices-be-sent-to-my-email)
- [Can I repay an invoice if I've...](https://vercel.com/docs/plans/pro-plan/billing#can-i-repay-an-invoice-if-i've-used-the-wrong-payment-method)
- [Billing](https://vercel.com/docs/plans/pro-plan/billing#billing)
- [How are add-ons billed?](https://vercel.com/docs/plans/pro-plan/billing#how-are-add-ons-billed)
- [What happens if I purchase an add-on by mistake?](https://vercel.com/docs/plans/pro-plan/billing#what-happens-if-i-purchase-an-add-on-by-mistake)
- [What do I do if I think my bil...](https://vercel.com/docs/plans/pro-plan/billing#what-do-i-do-if-i-think-my-bill-is-wrong)
- [Do I get billed for DDoS?](https://vercel.com/docs/plans/pro-plan/billing#do-i-get-billed-for-ddos)
- [What is a billing cycle?](https://vercel.com/docs/plans/pro-plan/billing#what-is-a-billing-cycle)
- [What if my usage goes over the included credit?](https://vercel.com/docs/plans/pro-plan/billing#what-if-my-usage-goes-over-the-included-credit)
- [What's the benefit of the credit-based model?](https://vercel.com/docs/plans/pro-plan/billing#what's-the-benefit-of-the-credit-based-model)
