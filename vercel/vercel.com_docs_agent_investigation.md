...
Agent Investigationis availablein [Beta](https://vercel.com/docs/release-phases#beta)on[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans with [Observability Plus](https://vercel.com/docs/observability/observability-plus)
...
## [Getting started with Agent Investigation](https://vercel.com/docs/agent/investigation\#getting-started-with-agent-investigation)

You'll need two things before you can use Agent Investigation:

1. An [Observability Plus](https://vercel.com/docs/observability/observability-plus) subscription, which includes 10 investigations per billing cycle
2. [Sufficient credits](https://vercel.com/docs/agent/pricing) to cover the cost of additional investigations

To allow investigations to run automatically for every error alert, you should [enable Vercel Agent Investigations](https://vercel.com/docs/agent/investigation#enable-agent-investigations) for your team.

You can [run an investigation manually](https://vercel.com/docs/agent/investigation#run-an-investigation-manually) if you want to investigate an alert that has already fired.

Agent Investigation will not automatically start running if you had previously only enabled Vercel Agent for code review. You will need to [enable Agent Investigations](https://vercel.com/docs/agent/investigation#enable-agent-investigations) separately.

### [Enable Agent Investigations](https://vercel.com/docs/agent/investigation\#enable-agent-investigations)
...
Once enabled, investigations will run automatically when an error alert fires. You'll need to make sure your team has [enough credits](https://vercel.com/docs/agent/pricing#adding-credits) to cover the cost of investigations beyond the 10 included in your subscription.

## [How to use Agent Investigation](https://vercel.com/docs/agent/investigation\#how-to-use-agent-investigation)

When [Agent Investigations are enabled](https://vercel.com/docs/agent/investigation#enable-agent-investigations), they run automatically when an error alert fires. The AI queries your logs and metrics around the time of the alert, looks for patterns that might explain the issue, checks for related errors or anomalies, and provides insights about what it found.
...
### [Run an investigation manually](https://vercel.com/docs/agent/investigation\#run-an-investigation-manually)
...
## [Pricing](https://vercel.com/docs/agent/investigation\#pricing)
...
Pro teams can redeem a $100 USD promotional credit when enabling Agent. You can [purchase credits and enable auto-reload](https://vercel.com/docs/agent/pricing#adding-credits) in the Agent tab of your dashboard. For complete pricing details, credit management, and cost tracking information, see [Vercel Agent Pricing](https://vercel.com/docs/agent/pricing).

## [Disable Agent Investigation](https://vercel.com/docs/agent/investigation\#disable-agent-investigation)
...
Once disabled, Agent Investigation won't run automatically on any new alerts. You can re-enable Agent Investigation at any time from the same menu or [run an investigation manually](https://vercel.com/docs/agent/investigation#run-an-investigation-manually) from the alert details page.
