...
- [Platform-wide firewall](https://vercel.com/docs/vercel-firewall#platform-wide-firewall): With [DDoS mitigation](https://vercel.com/docs/security/ddos-mitigation), it protects against large-scale attacks such as DDoS and TCP floods and is available for free for all customers without any configuration required.
- [Web Application Firewall (WAF)](https://vercel.com/docs/vercel-firewall#vercel-waf): A customizable layer for fine-tuning security measures with logic tailored to your needs and [observability](https://vercel.com/docs/vercel-firewall#observability) into your web traffic.

### [Concepts](https://vercel.com/docs/vercel-firewall\#concepts)

Understand the fundamentals:

- How [Vercel protects every request](https://vercel.com/docs/security/firewall-concepts#how-vercel-secures-requests).
- Why [DDoS](https://vercel.com/docs/security/firewall-concepts#understanding-ddos) needs to be mitigated.
- How the firewall decides [which rule to apply first](https://vercel.com/docs/vercel-firewall#rule-execution-order).
- How the firewall uses [JA3 and JA4 TLS fingerprints](https://vercel.com/docs/security/firewall-concepts#ja3-and-ja4-tls-fingerprints) to identify and restrict malicious traffic.

## [Rule execution order](https://vercel.com/docs/vercel-firewall\#rule-execution-order)
...
1. [DDoS mitigation rules](https://vercel.com/docs/security/ddos-mitigation)
2. [WAF IP blocking rules](https://vercel.com/docs/security/vercel-waf/ip-blocking)
3. [WAF custom rules](https://vercel.com/docs/security/vercel-waf/custom-rules)
4. [Managed rulesets](https://vercel.com/docs/security/vercel-waf/managed-rulesets)

When you have more than one custom rule, you can [customize](https://vercel.com/docs/security/vercel-waf/custom-rules#custom-rule-configuration) their order in the Firewall tab of the project.

## [Platform-wide firewall](https://vercel.com/docs/vercel-firewall\#platform-wide-firewall)

DDoS Mitigationis availableon [all plans](https://vercel.com/docs/plans)

Vercel provides automated [DDoS mitigation](https://vercel.com/docs/security/ddos-mitigation) for all deployments, regardless of the plan that you are on. With this automated DDoS mitigation, we block incoming traffic if we identify abnormal or suspicious levels of incoming requests.

## [Vercel WAF](https://vercel.com/docs/vercel-firewall\#vercel-waf)

Vercel WAFis availableon [all plans](https://vercel.com/docs/plans)

Those with the[member](https://vercel.com/docs/rbac/access-roles#member-role), [viewer](https://vercel.com/docs/rbac/access-roles#viewer-role), [developer](https://vercel.com/docs/rbac/access-roles#developer-role) and [administrator](https://vercel.com/docs/rbac/access-roles#project-administrators)rolescan access this feature

The [Vercel WAF](https://vercel.com/docs/security/vercel-waf) complements the platform-wide firewall by allowing you to define custom protection strategies using the following tools:

- [Custom Rules](https://vercel.com/docs/security/vercel-waf/custom-rules)
...
## [Observability](https://vercel.com/docs/vercel-firewall\#observability)

You can use the following tools to [monitor the internet traffic](https://vercel.com/docs/vercel-firewall/firewall-observability) at your team or project level:

- The [Monitoring](https://vercel.com/docs/observability/monitoring) feature at the team level allows you to create [queries](https://vercel.com/docs/observability/monitoring/monitoring-reference#example-queries) to visualize the traffic across your Vercel projects.
- The Firewall tab of the Vercel dashboard on every project allows you to monitor the internet traffic to your deployments with a [traffic monitoring view](https://vercel.com/docs/vercel-firewall/firewall-observability#traffic) that includes a live traffic window.
- [Firewall alerts](https://vercel.com/docs/vercel-firewall/firewall-observability#firewall-alerts) allow you to react quickly to potential security threats.
- Use [Log Drains](https://vercel.com/docs/drains/using-drains) to send your application logs to a Security Information and Event Management (SIEM) system.
