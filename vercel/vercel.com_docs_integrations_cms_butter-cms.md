...
## [Getting started](https://vercel.com/docs/integrations/cms/butter-cms\#getting-started)

To get started with the ButterCMS on Vercel deploy the template below:

[![Next.JS ButterCMS Starter Project](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F3M9Q0UMYCuodFBOXTMLxPr%2F58fba6c49550df129bac7f1bec502cd6%2FButter_Vercel_Thumbnail_Compressed_-_Maria_Violante.png&w=3840&q=75)\\
\\
Next.JS ButterCMS Starter Project\\
\\
A fully-functional, drop-in proof-of-concept Next.js app, fully integrated with your ButterCMS account](https://vercel.com/templates/next.js/NextJS-starter-buttercms)

Or, follow the steps below to install the integration:

1. ### [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/butter-cms\#install-the-vercel-cli)



To pull in environment variables from ButterCMS to your Vercel project, you need to install the [Vercel CLI](https://vercel.com/docs/cli). Run the following command in your terminal:
...
2. ### [Install your CMS integration](https://vercel.com/docs/integrations/cms/butter-cms\#install-your-cms-integration)



Navigate to the [ButterCMS integration](https://vercel.com/integrations/buttercms) and follow the steps to install the integration.

3. ### [Pull in environment variables](https://vercel.com/docs/integrations/cms/butter-cms\#pull-in-environment-variables)
...
- [Getting started](https://vercel.com/docs/integrations/cms/butter-cms#getting-started)
- [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/butter-cms#install-the-vercel-cli)
- [Install your CMS integration](https://vercel.com/docs/integrations/cms/butter-cms#install-your-cms-integration)
- [Pull in environment variables](https://vercel.com/docs/integrations/cms/butter-cms#pull-in-environment-variables)
