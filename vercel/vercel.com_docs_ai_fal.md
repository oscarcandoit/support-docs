...
## [Use cases](https://vercel.com/docs/ai/fal\#use-cases)
...
### [Available models](https://vercel.com/docs/ai/fal\#available-models)
...
## [Getting started](https://vercel.com/docs/ai/fal\#getting-started)

The Vercel fal integration can be accessed through the AI tab on your [Vercel dashboard](https://vercel.com/dashboard).

### [Prerequisites](https://vercel.com/docs/ai/fal\#prerequisites)
...
### [Add the provider to your project](https://vercel.com/docs/ai/fal\#add-the-provider-to-your-project)

#### [Using the dashboard](https://vercel.com/docs/ai/fal\#using-the-dashboard)

01. Navigate to the AI tab in your [Vercel dashboard](https://vercel.com/dashboard)
02. Select fal from the list of providers, and press Add
...
10. Connect your project using the code below:
    ...
    ```ts
    1// app/api/fal/proxy/route.ts

    2


    3import { route } from '@fal-ai/serverless-proxy/nextjs';

    4


    5export const { GET, POST } = route;

    6
    ```


#### [Using the CLI](https://vercel.com/docs/ai/fal\#using-the-cli)
...
## [More resources](https://vercel.com/docs/ai/fal\#more-resources)
