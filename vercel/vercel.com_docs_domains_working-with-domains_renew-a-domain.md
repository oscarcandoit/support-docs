...
Custom domains purchased through or registered with Vercel are [automatically renewed](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#auto-renewal) by default with the option to [manually renew](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#manual-renewal) them.

You can see the expiration or [renewal date](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#filter-on-renewal-status) of your Vercel-managed domains in the list of domains on the [Domains tab of your team's dashboard](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fdomains&title=Go+to+team%27s+domains+page).

## [Auto renewal](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#auto-renewal)

To enable automatic renewal, follow these steps:

1. ### [Select the Domains tab](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#select-the-domains-tab)
...
2. ### [View the auto renewal status](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#view-the-auto-renewal-status)
...
![Domain row with auto renewal status.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Fdomains-list-item-light.png&w=2048&q=75)![Domain row with auto renewal status.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Fdomains-list-item-dark.png&w=2048&q=75)Domain row with auto renewal status.
3. ### [Toggle the auto renewal status](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#toggle-the-auto-renewal-status)
...
### [Auto renewal off](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#auto-renewal-off)
...
### [Auto renewal on](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#auto-renewal-on)
...
## [Manual renewal](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#manual-renewal)
...
2. ### [Find your domain from the list](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#find-your-domain-from-the-list)
...
3. ### [Click the Renew button](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#click-the-renew-button)
...
4. ### [Confirm your renewal](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#confirm-your-renewal)


![The Renew Domain Modal](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Frenew-domain-modal-light.png&w=1080&q=75)![The Renew Domain Modal](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Frenew-domain-modal-dark.png&w=1080&q=75)The Renew Domain Modal

## [Domain redemptions](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#domain-redemptions)

For expired domains with a redemption period (typically 30 days), you can now recover them directly in the dashboard:

![The Redeem Domain Modal](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Fredeem-domain-modal-light.png&w=1080&q=75)![The Redeem Domain Modal](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Fredeem-domain-modal-dark.png&w=1080&q=75)The Redeem Domain Modal

A redemption fee will be applied, depending on the domain registry.

Not all top-level domains (TLDs) support redemptions.

## [Filter on renewal status](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#filter-on-renewal-status)
...
![Filter Domains table by renewal status.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fcustom-domains%2Frenew-domain-light.png&w=1080&q=75)![Filter Domains table by renewal status.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fcustom-domains%2Frenew-domain-dark.png&w=1080&q=75)Filter Domains table by renewal status.

## [Renewing third-party domains](https://vercel.com/docs/domains/working-with-domains/renew-a-domain\#renewing-third-party-domains)
...
- [Auto renewal](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#auto-renewal)
- [Select the Domains tab](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#select-the-domains-tab)
- [View the auto renewal status](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#view-the-auto-renewal-status)
- [Toggle the auto renewal status](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#toggle-the-auto-renewal-status)
- [Auto renewal off](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#auto-renewal-off)
- [Auto renewal on](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#auto-renewal-on)
- [Manual renewal](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#manual-renewal)
- [Select the Domains Tab](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#select-the-domains-tab)
- [Find your domain from the list](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#find-your-domain-from-the-list)
- [Click the Renew button](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#click-the-renew-button)
- [Confirm your renewal](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#confirm-your-renewal)
- [Domain redemptions](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#domain-redemptions)
- [Filter on renewal status](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#filter-on-renewal-status)
- [Renewing third-party domains](https://vercel.com/docs/domains/working-with-domains/renew-a-domain#renewing-third-party-domains)
