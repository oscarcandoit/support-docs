...
## [Transfer a domain to another Vercel user or Team](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#transfer-a-domain-to-another-vercel-user-or-team)

1. ### [Select the Domains tab](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#select-the-domains-tab)
...
2. ### [Select the domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#select-the-domain)
...
![Selecting which domains to move from the Domains tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fdomains%2Fmove-light.png&w=1920&q=75)![Selecting which domains to move from the Domains tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fdomains%2Fmove-dark.png&w=1920&q=75)Selecting which domains to move from the Domains tab.
3. ### [Select the team](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#select-the-team)
...
![Entering a new profile or team destination for a domain.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fdomains%2Fmove-modal.png&w=1080&q=75)![Entering a new profile or team destination for a domain.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fdomains%2Fmove-modal-dark.png&w=1080&q=75)Entering a new profile or team destination for a domain.
...
When moving domains to another team or user, all existing project domains
associated with them will remain and not be moved to prevent service
disruption. However, any [custom aliases](https://vercel.com/docs/cli/alias) that are not part
of project domains will be removed immediately.

4. ### [Confirm the change](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#confirm-the-change)
...
## [Transferring domains between projects](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#transferring-domains-between-projects)

You can use the Dashboard to remove a domain from a project and then re-add it to another. However, this could potentially end up with some site down-time. For more information on transferring domains with zero downtime, see [How to move a domain between Vercel projects with "Zero Downtime"?](https://vercel.com/kb/guide/how-to-move-a-domain-between-vercel-projects-with-zero-downtime)

## [Transferring domains out of Vercel](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#transferring-domains-out-of-vercel)

1. ### [Verifying Transfer Eligibility](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#verifying-transfer-eligibility)
...
2. ### [Select the **Domains** tab](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#select-the-domains-tab)
...
3. ### [Select the "Transfer out" option](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#select-the-transfer-out-option)
...
![Menu item button for getting domain's transfer authorization code.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fdomains%2Ftransfer-light.png&w=1920&q=75)![Menu item button for getting domain's transfer authorization code.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fdomains%2Ftransfer-dark.png&w=1920&q=75)Menu item button for getting domain's transfer authorization code.



If under a Team scope, only [Team Owners](https://vercel.com/docs/rbac/access-roles#owner-role)
will see the menu-item button.

4. ### [Use the authorization code with the new registrar](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#use-the-authorization-code-with-the-new-registrar)
...
If you encounter problems with the transfer code, ensure you've entered it correctly without typos or extra spaces. If the code seems correct but still doesn't work, please contact [Vercel support](https://vercel.com/help) for further assistance.
![Modal for domain's transfer authorization code.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fcustom-domains%2Ftransfer-out-modal.png&w=1080&q=75)![Modal for domain's transfer authorization code.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fcustom-domains%2Ftransfer-out-modal-dark.png&w=1080&q=75)Modal for domain's transfer authorization code.

## [Transfer a domain to Vercel](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#transfer-a-domain-to-vercel)
...
2. ### [Unlock the Domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#unlock-the-domain)
...
3. ### [Obtain Authorization Code](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#obtain-authorization-code)
...
4. ### [Transferring to Vercel](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#transferring-to-vercel)
...
In a case where your domain cannot be transferred, check that it has been over
60 days since the domain has been registered or previously transferred. If it
still does not work, contact your registrar.

5. ### [Configure domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#configure-domain)
...
Follow the [detailed guide](https://vercel.com/docs/domains/pre-generating-ssl-certs) to set up SSL certificates before finalizing the domain transfer.

Set DNS records in your registrar

Once you have pre-generated the SSL certificates, you need to add the new TXT records to your DNS records in your domain registrar dashboard. Learn how to do that [here](https://vercel.com/docs/domains/managing-dns-records#migrating-dns-records-from-an-external-registrar).

6. ### [Deploy the domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain\#deploy-the-domain)
...
- [Transfer a domain to another Vercel user or Team](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transfer-a-domain-to-another-vercel-user-or-team)
- [Select the Domains tab](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-domains-tab)
- [Select the domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-domain)
- [Select the team](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-team)
- [Confirm the change](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#confirm-the-change)
- [Transferring domains between projects](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-domains-between-projects)
- [Transferring domains out of Vercel](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-domains-out-of-vercel)
- [Verifying Transfer Eligibility](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#verifying-transfer-eligibility)
- [Select the Domains tab](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-domains-tab)
- [Select the "Transfer out" option](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-transfer-out-option)
- [Use the authorization code with the new registrar](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#use-the-authorization-code-with-the-new-registrar)
- [Transfer a domain to Vercel](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transfer-a-domain-to-vercel)
- [Verifying Transfer Eligibility](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#verifying-transfer-eligibility)
- [Unlock the Domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#unlock-the-domain)
- [Obtain Authorization Code](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#obtain-authorization-code)
- [Transferring to Vercel](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-to-vercel)
- [Configure domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#configure-domain)
- [Deploy the domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#deploy-the-domain)
