...
- Install the [Vercel SDK](https://vercel.com/docs/rest-api/sdk) and use the [security methods](https://github.com/vercel/sdk/blob/HEAD/docs/sdks/security/README.md).
...
## [Examples](https://vercel.com/docs/vercel-firewall/firewall-api\#examples)
...
- [Challenge cookieless requests on a specific path](https://vercel.com/kb/guide/challenge-cookieless-requests-on-a-specific-path)
...
- [Vercel Firewall Terraform configuration](https://vercel.com/kb/guide/firewall-terraform-configuration)
