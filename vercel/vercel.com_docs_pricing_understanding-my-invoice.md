...
## [Understanding your invoice](https://vercel.com/docs/pricing/understanding-my-invoice\#understanding-your-invoice)
...
![Invoice overview](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Ffull-invoice-light.png&w=1920&q=75)![Invoice overview](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Ffull-invoice-dark.png&w=1920&q=75)Invoice overview
...
### [Pro plan invoices](https://vercel.com/docs/pricing/understanding-my-invoice\#pro-plan-invoices)
...
### [Enterprise plan invoices](https://vercel.com/docs/pricing/understanding-my-invoice\#enterprise-plan-invoices)

Enterprise customer's invoicing gets tailored around a flexible usage model. It's based on a periodic commitment to [Managed Infrastructure Units (MIU)](https://vercel.com/docs/pricing/understanding-my-invoice#managed-infrastructure-units-miu).

The top of the invoice shows a summary of the commitment period, the total MIUs committed, and the current usage towards that commitment. If the commitment has been exceeded, the on-demand charges will be listed under the [On-demand Charges](https://vercel.com/docs/pricing/understanding-my-invoice#enterprise-on-demand-charges) section.

#### [Managed Infrastructure Units (MIU)](https://vercel.com/docs/pricing/understanding-my-invoice\#managed-infrastructure-units-miu)
...
#### [Enterprise on-demand charges](https://vercel.com/docs/pricing/understanding-my-invoice\#enterprise-on-demand-charges)
...
## [More resources](https://vercel.com/docs/pricing/understanding-my-invoice\#more-resources)
