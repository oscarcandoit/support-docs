...
Scopes define what data is included in the [ID Token](https://vercel.com/docs/sign-in-with-vercel/tokens#id-token) and whether to issue a [Refresh Token](https://vercel.com/docs/sign-in-with-vercel/tokens#refresh-token). Permissions control what APIs and team resource an [Access Token](https://vercel.com/docs/sign-in-with-vercel/tokens#access-token) can interact with.

## [Scopes](https://vercel.com/docs/sign-in-with-vercel/scopes-and-permissions\#scopes)

The following scopes are available:

| Scope | Description |
| --- | --- |
| `openid` | Required permission, needed to issue an [ID Token](https://vercel.com/docs/sign-in-with-vercel/tokens#id-token) for user identification. |
| `email` | Enabling this scope grants access to the user's email address in the [ID Token](https://vercel.com/docs/sign-in-with-vercel/tokens#id-token). |
| `profile` | Enabling this scope grants access to the user's basic profile information, including name, username, and profile picture, in the [ID Token](https://vercel.com/docs/sign-in-with-vercel/tokens#id-token). |
| `offline_access` | Enabling this scope issues a [Refresh Token](https://vercel.com/docs/sign-in-with-vercel/tokens#refresh-token). |

## [Permissions](https://vercel.com/docs/sign-in-with-vercel/scopes-and-permissions\#permissions)
