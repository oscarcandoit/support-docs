...
This guide is for existing customers who would like to switch to the [new pricing model](https://vercel.com/docs/plans/pro-plan), which you can do in [a few steps](https://vercel.com/docs/plans/pro-plan/switching#switch-to-the-new-pricing-model). For a smooth transition and to optimize your usage in advance, this guide includes [recommended tasks](https://vercel.com/docs/plans/pro-plan/switching#before-switching-to-the-new-pricing-model) you can perform before making the switch.

- Learn more about the [new pricing model](https://vercel.com/docs/plans/pro-plan#pro-plan-features) before switching.
...
automatically. The [legacy Pro plan](https://vercel.com/docs/plans/pro) is still supported, but
all teams will move to the new pricing model later this year.

## [Before switching to the new pricing model](https://vercel.com/docs/plans/pro-plan/switching\#before-switching-to-the-new-pricing-model)

### [Enable the new Image Optimization pricing](https://vercel.com/docs/plans/pro-plan/switching\#enable-the-new-image-optimization-pricing)

If your team is still using the [legacy Image Optimization pricing](https://vercel.com/docs/image-optimization/legacy-pricing), enabling the [new pricing model](https://vercel.com/docs/image-optimization/limits-and-pricing) before switching will typically lower your overall usage.
...
### [Ensure Fluid compute is enabled](https://vercel.com/docs/plans/pro-plan/switching\#ensure-fluid-compute-is-enabled)

[Fluid compute](https://vercel.com/docs/fluid-compute) with active CPU pricing optimizes Vercel Function costs. It is enabled by default for all recent projects. You can ensure it is enabled for other projects by following the steps below:

1. Navigate to the Settings tab of your [project](https://vercel.com/docs/projects/project-dashboard).
2. Select Functions from the left sidebar.
3. Under Fluid compute, ensure that the toggle is enabled.

### [Plan for Viewer seats](https://vercel.com/docs/plans/pro-plan/switching\#plan-for-viewer-seats)

[Viewer seats](https://vercel.com/docs/plans/pro-plan#viewer-team-seat) are unlimited and free on the new pricing model. To maximize savings, review your team and switch non-deploying team members to the Viewer role after switching.
...
## [Switch to the new pricing model](https://vercel.com/docs/plans/pro-plan/switching\#switch-to-the-new-pricing-model)

If you are an existing customer, you can choose to switch to the new pricing model now or continue using the [legacy Pro plan](https://vercel.com/docs/plans/pro) until you are transitioned automatically.

You can switch by doing one of the following:

- Clicking the Pro badge button to the right of your team name in the [dashboard](https://vercel.com/dashboard) if this team is on the Pro plan.
