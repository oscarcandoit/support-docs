...
## [Getting started](https://vercel.com/docs/functions/streaming-functions\#getting-started)

The following example shows how to send a message to one of OpenAI's models and streams:

### [Prerequisites](https://vercel.com/docs/functions/streaming-functions\#prerequisites)

1. You should understand how to setup a Vercel Function. See the [Functions quickstart](https://vercel.com/docs/functions/quickstart) for more information.
2. You should also have a fundamental understanding of how streaming works on Vercel. To learn more see [What is streaming?](https://vercel.com/docs/fundamentals/what-is-streaming).
3. You should be using Node.js 20 or later and the [latest version](https://vercel.com/docs/cli#updating-vercel-cli) of the Vercel CLI.
...
[Open inOpen in v0](https://v0.app/chat?q=%20%20Create%20a%20minimal%20example%20app%20for%20this%20code:%20import%20{%20streamText%20}%20from%20%27ai%27;import%20{%20openai%20}%20from%20%27@ai-sdk/openai%27;%20//%20This%20method%20must%20be%20named%20GETexport%20async%20function%20GET()%20{%20%20//%20Make%20a%20request%20to%20OpenAI%27s%20API%20based%20on%20%20//%20a%20placeholder%20prompt%20%20const%20response%20=%20streamText({%20%20%20%20model:%20openai(%27gpt-4o-mini%27),%20%20%20%20messages:%20[{%20role:%20%27user%27,%20content:%20%27What%20is%20the%20capital%20of%20Australia?%27%20}],%20%20});%20%20//%20Respond%20with%20the%20stream%20%20return%20response.toTextStreamResponse({%20%20%20%20headers:%20{%20%20%20%20%20%20%27Content-Type%27:%20%27text/event-stream%27,%20%20%20%20},%20%20});}%20In%20your%20response:%20%201.%20Keep%20the%20example%20simple%20and%20focused%20on%20demonstrating%20the%20core%20functionality%20of%20the%20code%20%202.%20DO%20NOT%20include%20unnecessary%20features%20or%20complexity,%20aim%20to%20only%20showcase%20the%20essential%20parts%20%203.%20Show%20the%20code%20in%20a%20way%20that%20is%20easy%20to%20understand%20and%20implement%20%204.%20Provide%20clear%20and%20concise%20explanations%20for%20each%20part%20of%20the%20code)

## [Function duration](https://vercel.com/docs/functions/streaming-functions\#function-duration)

If your workload requires longer durations, you should consider enabling [fluid compute](https://vercel.com/docs/fluid-compute), which has [higher default max durations and limits across plans](https://vercel.com/docs/fluid-compute#default-settings-by-plan).

Maximum durations can be configured for Node.js functions to enable streaming responses for longer periods. See [max durations](https://vercel.com/docs/functions/limitations#max-duration) for more information.

## [Streaming Python functions](https://vercel.com/docs/functions/streaming-functions\#streaming-python-functions)

You can stream responses from Vercel Functions that use the Python runtime.

When your function is streaming, it will be able to take advantage of the extended [runtime logs](https://vercel.com/docs/functions/logs#runtime-logs), which will show you the real-time output of your function, in addition to larger and more frequent log entries. Because of this potential increase in frequency and format, your [Log Drains](https://vercel.com/docs/drains) may be affected. We recommend ensuring that your ingestion can handle both the new format and frequency.

## [More resources](https://vercel.com/docs/functions/streaming-functions\#more-resources)

- [What is streaming?](https://vercel.com/docs/functions/streaming)
- [AI SDK](https://sdk.vercel.ai/docs/getting-started)
- [Vercel Functions](https://vercel.com/docs/functions)
- [Fluid compute](https://vercel.com/docs/fluid-compute)
- [Streaming and SEO: Does streaming affect SEO?](https://vercel.com/kb/guide/does-streaming-affect-seo)
- [Processing data chunks: Learn how to process data chunks](https://vercel.com/kb/guide/processing-data-chunks)
- [Handling backpressure: Learn how to handle backpressure](https://vercel.com/kb/guide/handling-backpressure)
