...
## [Prerequisites](https://vercel.com/docs/microfrontends/quickstart\#prerequisites)
...
## [Key concepts](https://vercel.com/docs/microfrontends/quickstart\#key-concepts)
...
## [Set up microfrontends on Vercel](https://vercel.com/docs/microfrontends/quickstart\#set-up-microfrontends-on-vercel)

1. ### [Create a microfrontends group](https://vercel.com/docs/microfrontends/quickstart\#create-a-microfrontends-group)
...
2. ### [Define `microfrontends.json`](https://vercel.com/docs/microfrontends/quickstart\#define-microfrontends.json)
...
3. ### [Install the `@vercel/microfrontends` package](https://vercel.com/docs/microfrontends/quickstart\#install-the-@vercel/microfrontends-package)
...
4. ### [Set up microfrontends with your framework](https://vercel.com/docs/microfrontends/quickstart\#set-up-microfrontends-with-your-framework)
...
prefix](https://vercel.com/docs/microfrontends/path-routing#asset-prefix) to the application so
...
5. ### [Run through steps 3 and 4 for all microfrontend applications in the group](https://vercel.com/docs/microfrontends/quickstart\#run-through-steps-3-and-4-for-all-microfrontend-applications-in-the-group)



Set up the other microfrontends in the group by running through steps [3](https://vercel.com/docs/microfrontends/quickstart#install-the-@vercel/microfrontends-package) and [4](https://vercel.com/docs/microfrontends/quickstart#set-up-microfrontends-with-your-framework) for every application.

6. ### [Set up the local development proxy](https://vercel.com/docs/microfrontends/quickstart\#set-up-the-local-development-proxy)
...
7. ### [Deploy your microfrontends to Vercel](https://vercel.com/docs/microfrontends/quickstart\#deploy-your-microfrontends-to-vercel)
...
Microfrontends functionality can be tested in
[Preview](https://vercel.com/docs/deployments/environments#preview-environment-pre-production)
before deploying the code to production.


## [Next steps](https://vercel.com/docs/microfrontends/quickstart\#next-steps)
...
- [Key concepts](https://vercel.com/docs/microfrontends/quickstart#key-concepts)
- [Set up microfrontends on Vercel](https://vercel.com/docs/microfrontends/quickstart#set-up-microfrontends-on-vercel)
- [Create a microfrontends group](https://vercel.com/docs/microfrontends/quickstart#create-a-microfrontends-group)
- [Define microfrontends.json](https://vercel.com/docs/microfrontends/quickstart#define-microfrontends.json)
- [Install the @vercel/microfrontends package](https://vercel.com/docs/microfrontends/quickstart#install-the-@vercel/microfrontends-package)
- [Set up microfrontends with your framework](https://vercel.com/docs/microfrontends/quickstart#set-up-microfrontends-with-your-framework)
- [Run through steps 3 and 4 for ...](https://vercel.com/docs/microfrontends/quickstart#run-through-steps-3-and-4-for-all-microfrontend-applications-in-the-group)
- [Set up the local development proxy](https://vercel.com/docs/microfrontends/quickstart#set-up-the-local-development-proxy)
- [Deploy your microfrontends to Vercel](https://vercel.com/docs/microfrontends/quickstart#deploy-your-microfrontends-to-vercel)
- [Next steps](https://vercel.com/docs/microfrontends/quickstart#next-steps)
