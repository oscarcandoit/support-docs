...
## [Project name](https://vercel.com/docs/project-configuration/general-settings\#project-name)
...
## [Build and development settings](https://vercel.com/docs/project-configuration/general-settings\#build-and-development-settings)
...
## [Nodejs version](https://vercel.com/docs/project-configuration/general-settings\#nodejs-version)

Learn more about how to customize the Node.js version of your project in the [Node.js runtime](https://vercel.com/docs/functions/runtimes/node-js/node-js-versions#setting-the-node.js-version-in-project-settings) documentation.

You can also learn more about [all supported versions](https://vercel.com/docs/functions/runtimes/node-js/node-js-versions#default-and-available-versions) of Node.js.

## [Project ID](https://vercel.com/docs/project-configuration/general-settings\#project-id)
...
## [Vercel Toolbar settings](https://vercel.com/docs/project-configuration/general-settings\#vercel-toolbar-settings)
