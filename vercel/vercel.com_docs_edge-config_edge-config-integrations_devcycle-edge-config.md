---
url: "https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config"
...
The DevCycle Edge Config integrationis availablein [Beta](https://vercel.com/docs/release-phases#beta)on [all plans](https://vercel.com/docs/plans)
...
## [Prerequisites](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config\#prerequisites)
...
1. ### [Set up the DevCycle integration](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config\#set-up-the-devcycle-integration)



Visit [the DevCycle page in the Integration Marketplace](https://vercel.com/integrations/devcycle) and select the Add Integration button. From the modal that opens:
...
2. ### [Install the DevCycle Edge Config package](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config\#install-the-devcycle-edge-config-package)
...
3. ### [Use the DevCycle integration in your code](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config\#use-the-devcycle-integration-in-your-code)
...
## [Next steps](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config\#next-steps)
...
- [Prerequisites](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config#prerequisites)
- [Set up the DevCycle integration](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config#set-up-the-devcycle-integration)
- [Install the DevCycle Edge Config package](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config#install-the-devcycle-edge-config-package)
- [Use the DevCycle integration in your code](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config#use-the-devcycle-integration-in-your-code)
- [Next steps](https://vercel.com/docs/edge-config/edge-config-integrations/devcycle-edge-config#next-steps)
