...
Monitoring will be [sunset](https://vercel.com/docs/query/monitoring#monitoring-sunset) for Pro plans at the end of your next billing cycle in November 2025. To continue using full query abilities, consider migrating to [Observability Query](https://vercel.com/docs/observability/query), which is included with [Observability Plus](https://vercel.com/docs/observability/observability-plus).
...
Monitoringis availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans

Those with the[owner, member, developer](https://vercel.com/docs/rbac/access-roles#owner,%20member,%20developer-role)rolecan access this feature

![Monitoring in the Vercel dashboard.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fmonitoring-tab-light.png&w=1920&q=75)![Monitoring in the Vercel dashboard.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fmonitoring-tab-dark.png&w=1920&q=75)Monitoring in the Vercel dashboard.

## [Monitoring chart](https://vercel.com/docs/query/monitoring\#monitoring-chart)
...
![Graph view to visualize data and usage of your application.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fquery-graphs.png&w=1920&q=75)![Graph view to visualize data and usage of your application.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fquery-graphs-dark.png&w=1920&q=75)Graph view to visualize data and usage of your application.
...
## [Save new queries](https://vercel.com/docs/query/monitoring\#save-new-queries)
...
### [Manage saved queries](https://vercel.com/docs/query/monitoring\#manage-saved-queries)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fmanage-query.png&w=1920&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fmanage-query-dark.png&w=1920&q=75)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fmanage-query-from-sidebar.png&w=750&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fmanage-query-from-sidebar-dark.png&w=750&q=75)
...
## [Error messages](https://vercel.com/docs/query/monitoring\#error-messages)
...
## [Enable Monitoring](https://vercel.com/docs/query/monitoring\#enable-monitoring)

To enable monitoring on [Pro](https://vercel.com/docs/plans/pro) plans:
...
Enabling and disabling Observability Plusare availableon [Pro plans](https://vercel.com/docs/plans/pro)

Those with the[owner](https://vercel.com/docs/rbac/access-roles#owner-role)rolecan access this feature

[Enterprise](https://vercel.com/docs/plans/enterprise) teams can [contact sales](https://vercel.com/contact/sales)
to get a customized plan based on their requirements.

## [Disable Monitoring](https://vercel.com/docs/query/monitoring\#disable-monitoring)

1. Go to your team Settings \> Billing
2. Scroll to the Observability Plus section
3. Set the toggle to the disabled state

## [Manage IP Address visibility for Monitoring](https://vercel.com/docs/query/monitoring\#manage-ip-address-visibility-for-monitoring)

Managing IP Address visibilityis availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans

Those with the[owner, admin](https://vercel.com/docs/rbac/access-roles#owner,%20admin-role)rolecan access this feature
...
1. Go to the Vercel [dashboard](https://vercel.com/dashboard) and ensure your team is selected in the scope selector.
...
## [Monitoring sunset](https://vercel.com/docs/query/monitoring\#monitoring-sunset)
...
If you want to continue using the full Monitoring capabilities or purchase a product similar to Monitoring, consider moving to [Query](https://vercel.com/docs/observability/query).

- Enable [Observability Plus](https://vercel.com/docs/observability/observability-plus) to continue using query features.
- Save queries in Observability [Notebooks](https://vercel.com/docs/observability/query#save-query).

## [More resources](https://vercel.com/docs/query/monitoring\#more-resources)

For more information on what to do next, we recommend the following articles:

- [Quickstart](https://vercel.com/docs/observability/monitoring/quickstart): Learn how to create and run a query to understand the top bandwidth images on
your website
- [Reference](https://vercel.com/docs/observability/monitoring/monitoring-reference): Learn about the clauses, fields, and variables used to create a Monitoring
- [Limits and Pricing](https://vercel.com/docs/observability/monitoring/limits-and-pricing): Learn about our limits and pricing when using Monitoring. Different limitations are applied depending on your plan.
