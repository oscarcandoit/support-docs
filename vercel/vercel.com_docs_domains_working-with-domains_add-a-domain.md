...
You can manage all domain settings related to a project in the Domains section of the Settings tab of the project, regardless of whether you are using [apex domains](https://vercel.com/docs/domains/working-with-domains/add-a-domain#apex-domains) or [subdomains](https://vercel.com/docs/domains/working-with-domains/add-a-domain#subdomains) in your project. This document will guide you through both options.

Hobby teams have a limit of 50 custom domains per project.

## [Add and configure domain](https://vercel.com/docs/domains/working-with-domains/add-a-domain\#add-and-configure-domain)

The following steps provide an overview of how to add and configure a custom domain in Vercel:

1. ### [Navigate to Domain Settings](https://vercel.com/docs/domains/working-with-domains/add-a-domain\#navigate-to-domain-settings)
...
![Selecting the Domains menu item from the Project Settings page.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fcustom-domains%2Fselect-domains-light.png&w=828&q=75)![Selecting the Domains menu item from the Project Settings page.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fcustom-domains%2Fselect-domains-dark.png&w=828&q=75)Selecting the Domains menu item from the Project Settings page.
2. ### [Add your domain](https://vercel.com/docs/domains/working-with-domains/add-a-domain\#add-your-domain)
...
3. ### [Using wildcard domain](https://vercel.com/docs/domains/working-with-domains/add-a-domain\#using-wildcard-domain)
...
4. ### [Configure the domain](https://vercel.com/docs/domains/working-with-domains/add-a-domain\#configure-the-domain)
...
#### [Apex domains](https://vercel.com/docs/domains/working-with-domains/add-a-domain\#apex-domains)
...
#### [Subdomains](https://vercel.com/docs/domains/working-with-domains/add-a-domain\#subdomains)
...
#### [Vercel Nameservers](https://vercel.com/docs/domains/working-with-domains/add-a-domain\#vercel-nameservers)
...
5. ### [Verify domain access](https://vercel.com/docs/domains/working-with-domains/add-a-domain\#verify-domain-access)
...
it](https://vercel.com/docs/domains/deploying-and-redirecting#redirecting-domains).
...
- [Add and configure domain](https://vercel.com/docs/domains/working-with-domains/add-a-domain#add-and-configure-domain)
- [Navigate to Domain Settings](https://vercel.com/docs/domains/working-with-domains/add-a-domain#navigate-to-domain-settings)
- [Add your domain](https://vercel.com/docs/domains/working-with-domains/add-a-domain#add-your-domain)
- [Using wildcard domain](https://vercel.com/docs/domains/working-with-domains/add-a-domain#using-wildcard-domain)
- [Configure the domain](https://vercel.com/docs/domains/working-with-domains/add-a-domain#configure-the-domain)
- [Apex domains](https://vercel.com/docs/domains/working-with-domains/add-a-domain#apex-domains)
- [Subdomains](https://vercel.com/docs/domains/working-with-domains/add-a-domain#subdomains)
- [Vercel Nameservers](https://vercel.com/docs/domains/working-with-domains/add-a-domain#vercel-nameservers)
- [Verify domain access](https://vercel.com/docs/domains/working-with-domains/add-a-domain#verify-domain-access)
