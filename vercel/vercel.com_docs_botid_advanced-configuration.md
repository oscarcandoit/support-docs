---
url: "https://vercel.com/docs/botid/advanced-configuration"
...
## [Route-by-Route configuration](https://vercel.com/docs/botid/advanced-configuration\#route-by-route-configuration)
...
### [Client-side configuration](https://vercel.com/docs/botid/advanced-configuration\#client-side-configuration)
...
### [Server-side configuration](https://vercel.com/docs/botid/advanced-configuration\#server-side-configuration)
...
## [Separate backend domains](https://vercel.com/docs/botid/advanced-configuration\#separate-backend-domains)
...
### [When to use `extraAllowedHosts`](https://vercel.com/docs/botid/advanced-configuration\#when-to-use-extraallowedhosts)
...
### [Example with advanced options](https://vercel.com/docs/botid/advanced-configuration\#example-with-advanced-options)
...
## [Next.js Pages Router configuration](https://vercel.com/docs/botid/advanced-configuration\#next.js-pages-router-configuration)
