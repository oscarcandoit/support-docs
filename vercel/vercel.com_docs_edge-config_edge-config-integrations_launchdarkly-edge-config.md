---
url: "https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config"
...
The LaunchDarkly Edge Config integration is only available to Enterprise
LaunchDarkly customers. However, you do not need to have a Vercel
[Enterprise](https://vercel.com/docs/plans/enterprise) account.

## [Prerequisites](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config\#prerequisites)
...
1. ### [Set up the LaunchDarkly integration](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config\#set-up-the-launchdarkly-integration)



Visit [the LaunchDarkly page in the Integration Marketplace](https://vercel.com/integrations/launchdarkly) and select the Add Integration button. From the Integration dialog:
...
2. ### [Get your client-side ID](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config\#get-your-client-side-id)
...
3. ### [Use the LaunchDarkly integration in your code](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config\#use-the-launchdarkly-integration-in-your-code)
...
## [Next steps](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config\#next-steps)
...
- [Prerequisites](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config#prerequisites)
- [Set up the LaunchDarkly integration](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config#set-up-the-launchdarkly-integration)
- [Get your client-side ID](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config#get-your-client-side-id)
- [Use the LaunchDarkly integration in your code](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config#use-the-launchdarkly-integration-in-your-code)
- [Next steps](https://vercel.com/docs/edge-config/edge-config-integrations/launchdarkly-edge-config#next-steps)
