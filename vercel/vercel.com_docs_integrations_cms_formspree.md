...
## [Getting started](https://vercel.com/docs/integrations/cms/formspree\#getting-started)

To get started with Formspree on Vercel, follow the steps below to install the integration:

1. ### [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/formspree\#install-the-vercel-cli)



To pull in environment variables from Formspree to your Vercel project, you need to install the [Vercel CLI](https://vercel.com/docs/cli). Run the following command in your terminal:
...
2. ### [Install your CMS integration](https://vercel.com/docs/integrations/cms/formspree\#install-your-cms-integration)



Navigate to the [Formspree integration](https://vercel.com/integrations/formspree) and follow the steps to install the integration.

3. ### [Pull in environment variables](https://vercel.com/docs/integrations/cms/formspree\#pull-in-environment-variables)
...
- [Getting started](https://vercel.com/docs/integrations/cms/formspree#getting-started)
- [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/formspree#install-the-vercel-cli)
- [Install your CMS integration](https://vercel.com/docs/integrations/cms/formspree#install-your-cms-integration)
- [Pull in environment variables](https://vercel.com/docs/integrations/cms/formspree#pull-in-environment-variables)
