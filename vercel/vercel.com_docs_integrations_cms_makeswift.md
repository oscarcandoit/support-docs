...
## [Getting started](https://vercel.com/docs/integrations/cms/makeswift\#getting-started)

To get started with the Makeswift on Vercel deploy the template below:

[![Makeswift Next.js Starter](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F1UJXkxJYZ7R3SWG8XThNHy%2F8a531778bb3ac3737612ffe523bdd340%2Fmakeswift-template-thumbnail-1.png&w=3840&q=75)\\
\\
Makeswift Next.js Starter\\
\\
A Next.js application configured out of the box to work with the Makeswift builder.](https://vercel.com/templates/next.js/makeswift-starter)

Or, follow the steps below to install the integration:

1. ### [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/makeswift\#install-the-vercel-cli)



To pull in environment variables from Makeswift to your Vercel project, you need to install the [Vercel CLI](https://vercel.com/docs/cli). Run the following command in your terminal:
...
2. ### [Install your CMS integration](https://vercel.com/docs/integrations/cms/makeswift\#install-your-cms-integration)



Navigate to the [Makeswift integration](https://vercel.com/integrations/makeswift) and follow the steps to install the integration.

3. ### [Pull in environment variables](https://vercel.com/docs/integrations/cms/makeswift\#pull-in-environment-variables)
...
- [Getting started](https://vercel.com/docs/integrations/cms/makeswift#getting-started)
- [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/makeswift#install-the-vercel-cli)
- [Install your CMS integration](https://vercel.com/docs/integrations/cms/makeswift#install-your-cms-integration)
- [Pull in environment variables](https://vercel.com/docs/integrations/cms/makeswift#pull-in-environment-variables)
