...
To learn more about how to configure the `sampleRate` option, see the [Sending a sample of events to Speed Insights](https://vercel.com/guides/sending-sample-to-speed-insights) recipe.
...
- [Sending a sample of your events](https://vercel.com/guides/sending-sample-to-speed-insights)
