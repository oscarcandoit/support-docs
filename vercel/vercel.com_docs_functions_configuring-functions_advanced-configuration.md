...
## [Adding utility files to the `/api` directory](https://vercel.com/docs/functions/configuring-functions/advanced-configuration\#adding-utility-files-to-the-/api-directory)
