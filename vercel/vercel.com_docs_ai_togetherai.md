...
## [Use cases](https://vercel.com/docs/ai/togetherai\#use-cases)
...
### [Available models](https://vercel.com/docs/ai/togetherai\#available-models)
...
## [Getting started](https://vercel.com/docs/ai/togetherai\#getting-started)
...
### [Prerequisites](https://vercel.com/docs/ai/togetherai\#prerequisites)
...
### [Add the provider to your project](https://vercel.com/docs/ai/togetherai\#add-the-provider-to-your-project)

#### [Using the dashboard](https://vercel.com/docs/ai/togetherai\#using-the-dashboard)

01. Navigate to the AI tab in your [Vercel dashboard](https://vercel.com/dashboard)
02. Select Together AI from the list of providers, and press Add
...
10. Connect your project using the code below:
    ...
    3import { togetherai } from '@ai-sdk/togetherai';
    ...
    7  model: togetherai('meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo'),

    8  prompt: 'Write a vegetarian lasagna recipe for 4 people.',
...
## [More resources](https://vercel.com/docs/ai/togetherai\#more-resources)
...
[Next\\
\\
Workflow](https://vercel.com/docs/workflow)
