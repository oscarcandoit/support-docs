---
url: "https://vercel.com/docs/code-owners/changelog"
...
Code Ownersis availableon [Enterprise plans](https://vercel.com/docs/plans/enterprise)

## [Upgrade instructions](https://vercel.com/docs/code-owners/changelog\#upgrade-instructions)
...
## [Releases](https://vercel.com/docs/code-owners/changelog\#releases)

### [`1.0.7`](https://vercel.com/docs/code-owners/changelog\#1.0.7)

This patch adds support for underscores in usernames and team slugs to match Github.

### [`1.0.6`](https://vercel.com/docs/code-owners/changelog\#1.0.6)

This patch updates the minimum length of Github username to match Github's validation.

### [`1.0.5`](https://vercel.com/docs/code-owners/changelog\#1.0.5)

This patch updates some dependencies for performance and security.

### [`1.0.4`](https://vercel.com/docs/code-owners/changelog\#1.0.4)

This patch updates some dependencies for performance and security.

### [`1.0.3`](https://vercel.com/docs/code-owners/changelog\#1.0.3)
...
### [`1.0.2`](https://vercel.com/docs/code-owners/changelog\#1.0.2)

This patch updates some dependencies for performance and security.

### [`1.0.1`](https://vercel.com/docs/code-owners/changelog\#1.0.1)
...
### [`1.0.0`](https://vercel.com/docs/code-owners/changelog\#1.0.0)
