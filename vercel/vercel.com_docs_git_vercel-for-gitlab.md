...
- [Self-Managed GitLab](https://vercel.com/docs/git/vercel-for-gitlab#using-gitlab-pipelines)

## [Deploying a GitLab Repository](https://vercel.com/docs/git/vercel-for-gitlab\#deploying-a-gitlab-repository)

The [Deploying a Git repository](https://vercel.com/docs/git#deploying-a-git-repository) guide outlines how to create a new Vercel Project from a GitLab repository, and enable automatic deployments on every branch push.

## [Changing the GitLab Repository of a Project](https://vercel.com/docs/git/vercel-for-gitlab\#changing-the-gitlab-repository-of-a-project)
...
### [A Deployment for Each Push](https://vercel.com/docs/git/vercel-for-gitlab\#a-deployment-for-each-push)
...
### [Updating the Production Domain](https://vercel.com/docs/git/vercel-for-gitlab\#updating-the-production-domain)
...
### [Preview URLs for Each Merge Request](https://vercel.com/docs/git/vercel-for-gitlab\#preview-urls-for-each-merge-request)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fguides%2Fgetting-started-with-vercel-for-gitlab%2Fmerge-request-alias.png&w=1920&q=75)

A preview URL created from a merge request.

### [System environment variables](https://vercel.com/docs/git/vercel-for-gitlab\#system-environment-variables)
...
### [VERCEL\_GIT\_PROVIDER](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_PROVIDER)

The Git Provider the deployment is triggered from. In the case of GitLab, the value is always `gitlab`.

### [VERCEL\_GIT\_REPO\_SLUG](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_REPO_SLUG)
...
### [VERCEL\_GIT\_REPO\_OWNER](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_REPO_OWNER)
...
### [VERCEL\_GIT\_REPO\_ID](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_REPO_ID)
...
### [VERCEL\_GIT\_COMMIT\_REF](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_COMMIT_REF)
...
### [VERCEL\_GIT\_COMMIT\_SHA](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_COMMIT_SHA)
...
### [VERCEL\_GIT\_COMMIT\_MESSAGE](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_COMMIT_MESSAGE)
...
### [VERCEL\_GIT\_COMMIT\_AUTHOR\_LOGIN](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_COMMIT_AUTHOR_LOGIN)
...
### [VERCEL\_GIT\_COMMIT\_AUTHOR\_NAME](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_COMMIT_AUTHOR_NAME)
...
### [VERCEL\_GIT\_PULL\_REQUEST\_ID](https://vercel.com/docs/git/vercel-for-gitlab\#VERCEL_GIT_PULL_REQUEST_ID)
...
## [Missing Git repository](https://vercel.com/docs/git/vercel-for-gitlab\#missing-git-repository)
...
## [Silence comments](https://vercel.com/docs/git/vercel-for-gitlab\#silence-comments)
...
## [Using GitLab Pipelines](https://vercel.com/docs/git/vercel-for-gitlab\#using-gitlab-pipelines)
...
[Learn more about how to configure GitLab Pipelines and Vercel](https://vercel.com/kb/guide/how-can-i-use-gitlab-pipelines-with-vercel) for custom CI/CD workflows.

In some cases, your GitLab merge pipeline can fail while your branch pipeline
...
CLI](https://vercel.com/docs/cli/deploying-from-cli) to deploy your projects.
