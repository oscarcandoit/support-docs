...
## [Troubleshoot](https://vercel.com/docs/errors/DEPLOYMENT_PAUSED\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/DEPLOYMENT\_PAUSED to understand what's happening.
...
2. Review your spend management: You may have configured your deployments to pause once your spend amount is reached. Review your [spend management settings](https://vercel.com/docs/spend-management#managing-your-spend-amount) to either adjust your limit or review your usage
3. Verify account status: Ensure your account is in good standing and hasn't exceeded any [limits or quotas](https://vercel.com/docs/limits)
...
5. Check for terms of service violations: If the pause is due to a breach of the [terms of service](https://vercel.com/legal/terms) or [fair use guidelines](https://vercel.com/docs/limits/fair-use-guidelines), review the specific usage limits and policies in the Vercel dashboard to understand the reasons for the pause
...
7. Contact support: If you've verified the above and are still experiencing the issue, [contact support](https://vercel.com/help#issues) for further assistance
