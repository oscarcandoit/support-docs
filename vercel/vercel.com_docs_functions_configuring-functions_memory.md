...
## [Memory configuration considerations](https://vercel.com/docs/functions/configuring-functions/memory\#memory-configuration-considerations)
...
## [Setting your default function memory / CPU size](https://vercel.com/docs/functions/configuring-functions/memory\#setting-your-default-function-memory-/-cpu-size)
...
### [Memory / CPU type](https://vercel.com/docs/functions/configuring-functions/memory\#memory-/-cpu-type)
...
| Type | Memory / CPU | Use |
| --- | --- | --- |
| Standard <br>Default | 2 GB / 1 vCPU | Predictable performance for production workloads. Default for [fluid compute](https://vercel.com/docs/fluid-compute). |
...
Project created before 2019-11-08 have the default function memory size
...
## [Viewing your function memory size](https://vercel.com/docs/functions/configuring-functions/memory\#viewing-your-function-memory-size)
...
## [Memory limits](https://vercel.com/docs/functions/configuring-functions/memory\#memory-limits)
...
## [Pricing](https://vercel.com/docs/functions/configuring-functions/memory\#pricing)
...
You can also view [Invocations](https://vercel.com/docs/functions/usage-and-pricing#managing-function-invocations)
to see the number of times your Functions have been invoked. To learn more about
the cost of Vercel Functions, see [Vercel Function Pricing](https://vercel.com/docs/pricing/serverless-functions).
