...
- [Get started with deploying MCP servers on Vercel](https://vercel.com/docs/mcp/deploy-mcp-servers-to-vercel)
- Try out [Vercel's MCP server](https://vercel.com/docs/mcp/vercel-mcp)

## [Connecting LLMs to external systems](https://vercel.com/docs/mcp\#connecting-llms-to-external-systems)
...
## [Standardizing LLM interaction with MCP](https://vercel.com/docs/mcp\#standardizing-llm-interaction-with-mcp)
...
## [MCP servers, hosts and clients](https://vercel.com/docs/mcp\#mcp-servers-hosts-and-clients)
...
## [More resources](https://vercel.com/docs/mcp\#more-resources)

Learn more about Model Context Protocol and explore available MCP servers.

- [Deploy your own MCP servers on Vercel](https://vercel.com/docs/mcp/deploy-mcp-servers-to-vercel)
