...
## [Prerequisites](https://vercel.com/docs/query/monitoring/quickstart\#prerequisites)

- Make sure you upgrade to [Pro](https://vercel.com/docs/plans/pro) or [Enterprise](https://vercel.com/docs/plans/enterprise) plan.
...
## [Create a new query](https://vercel.com/docs/query/monitoring/quickstart\#create-a-new-query)

In the following guide you will learn how to view the most requested posts on your website.

1. ### [Go to the dashboard](https://vercel.com/docs/query/monitoring/quickstart\#go-to-the-dashboard)
...
![Add clauses through query editor.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fedit-query-light.png&w=3840&q=75)![Add clauses through query editor.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fedit-query-dark.png&w=3840&q=75)Add clauses through query editor.
2. ### [Add Visualize clause](https://vercel.com/docs/query/monitoring/quickstart\#add-visualize-clause)
...
![Configure Visualize clause to fetch requests.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fset-visualize-light.png&w=1920&q=75)![Configure Visualize clause to fetch requests.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fset-visualize-dark.png&w=1920&q=75)Configure Visualize clause to fetch requests.
3. ### [Add Where clause](https://vercel.com/docs/query/monitoring/quickstart\#add-where-clause)
...
4. ### [Add Group By clause](https://vercel.com/docs/query/monitoring/quickstart\#add-group-by-clause)
...
![Configure Group By clause to segment events into groups.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fset-groupby-light.png&w=1920&q=75)![Configure Group By clause to segment events into groups.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Fset-groupby-dark.png&w=1920&q=75)Configure Group By clause to segment events into groups.
5. ### [Add Limit clause](https://vercel.com/docs/query/monitoring/quickstart\#add-limit-clause)
...
6. ### [Save and Run Query](https://vercel.com/docs/query/monitoring/quickstart\#save-and-run-query)
...
![In-depth and full-scale monitoring for your five most requested posts.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Ftop-posts-eg-light.png&w=1920&q=75)![In-depth and full-scale monitoring for your five most requested posts.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdashboard%2Ftop-posts-eg-dark.png&w=1920&q=75)In-depth and full-scale monitoring for your five most requested posts.
...
- [Prerequisites](https://vercel.com/docs/query/monitoring/quickstart#prerequisites)
- [Create a new query](https://vercel.com/docs/query/monitoring/quickstart#create-a-new-query)
- [Go to the dashboard](https://vercel.com/docs/query/monitoring/quickstart#go-to-the-dashboard)
- [Add Visualize clause](https://vercel.com/docs/query/monitoring/quickstart#add-visualize-clause)
- [Add Where clause](https://vercel.com/docs/query/monitoring/quickstart#add-where-clause)
- [Add Group By clause](https://vercel.com/docs/query/monitoring/quickstart#add-group-by-clause)
- [Add Limit clause](https://vercel.com/docs/query/monitoring/quickstart#add-limit-clause)
- [Save and Run Query](https://vercel.com/docs/query/monitoring/quickstart#save-and-run-query)
