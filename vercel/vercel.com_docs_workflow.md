...
Vercel Workflowis availablein [Beta](https://vercel.com/docs/release-phases#beta)on[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
![Workflow diagram.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fworkflow%2Fworkflow-diagram-light.avif&w=1920&q=75)![Workflow diagram.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fworkflow%2Fworkflow-diagram-dark.avif&w=1920&q=75)Workflow diagram.

## [Getting started](https://vercel.com/docs/workflow\#getting-started)
...
## [Concepts](https://vercel.com/docs/workflow\#concepts)
...
### [Workflow](https://vercel.com/docs/workflow\#workflow)
...
### [Step](https://vercel.com/docs/workflow\#step)
...
### [Sleep](https://vercel.com/docs/workflow\#sleep)
...
### [Hook](https://vercel.com/docs/workflow\#hook)
...
## [Observability](https://vercel.com/docs/workflow\#observability)
...
## [Pricing](https://vercel.com/docs/workflow\#pricing)
...
During the Beta period, Workflow observability is free for all plans. Workflow Steps and Workflow Storage remain priced.
Advance notice will be given before any charges begin when Workflow goes to General Availability (GA).

All resources are billed based on usage with each plan having an [included allotment](https://vercel.com/docs/pricing).
...
| Resource | Hobby Included | On-demand Rates |
| --- | --- | --- |
| [Workflow Storage](https://vercel.com/docs/workflow#pricing) | 1 GB | $0.50 per 1 GB per month |
| [Workflow Steps](https://vercel.com/docs/workflow#pricing) | 50,000 | $25.00 per 1,000,000 Steps |

Managed Infrastructure pricing

Functions invoked by Workflows continue to be charged at the [existing compute\\
rates](https://vercel.com/docs/functions/usage-and-pricing). We encourage you to use [Fluid compute](https://vercel.com/docs/fluid-compute) with Workflow.

## [More resources](https://vercel.com/docs/workflow\#more-resources)
...
[Next\\
\\
API / Build Output API](https://vercel.com/docs/build-output-api)
