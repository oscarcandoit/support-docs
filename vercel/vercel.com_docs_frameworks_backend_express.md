...
![](https://api-frameworks.vercel.sh/framework-logos/express.svg)
...
## [Get started with Express on Vercel](https://vercel.com/docs/frameworks/backend/express\#get-started-with-express-on-vercel)
...
[Deploy](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fvercel%2Ftree%2Fmain%2Fexamples%2Fexpress&template=express) [Live Example](https://express-vercel-example-demo.vercel.app/)

### [Get started with Vercel CLI](https://vercel.com/docs/frameworks/backend/express\#get-started-with-vercel-cli)

Get started by initializing a new Express project using [Vercel CLI init command](https://vercel.com/docs/cli/init):
...
## [Exporting the Express application](https://vercel.com/docs/frameworks/backend/express\#exporting-the-express-application)
...
### [Using a default export](https://vercel.com/docs/frameworks/backend/express\#using-a-default-export)
...
### [Using a port listener](https://vercel.com/docs/frameworks/backend/express\#using-a-port-listener)
...
### [Local development](https://vercel.com/docs/frameworks/backend/express\#local-development)
...
### [Deploying the application](https://vercel.com/docs/frameworks/backend/express\#deploying-the-application)
...
## [Serving static assets](https://vercel.com/docs/frameworks/backend/express\#serving-static-assets)
...
## [Vercel Functions](https://vercel.com/docs/frameworks/backend/express\#vercel-functions)
...
## [Limitations](https://vercel.com/docs/frameworks/backend/express\#limitations)

- `express.static()` will not serve static assets. You must use [the `public/**` directory](https://vercel.com/docs/frameworks/backend/express#serving-static-assets).
...
## [More resources](https://vercel.com/docs/frameworks/backend/express\#more-resources)
