---
url: "https://vercel.com/docs/conformance/rules/NO_EXTERNAL_CSS_AT_IMPORTS"
...
Note that this rule currently only parses CSS and not CSS written in Less,
Sass, or other CSS preprocessor syntaxes.

## [How to fix](https://vercel.com/docs/conformance/rules/NO_EXTERNAL_CSS_AT_IMPORTS\#how-to-fix)
