...
## [Getting started](https://vercel.com/docs/tracing/instrumentation\#getting-started)
...
## [Configuring context propagation](https://vercel.com/docs/tracing/instrumentation\#configuring-context-propagation)
...
### [For outgoing requests](https://vercel.com/docs/tracing/instrumentation\#for-outgoing-requests)
...
### [From incoming requests](https://vercel.com/docs/tracing/instrumentation\#from-incoming-requests)
...
## [Adding custom spans](https://vercel.com/docs/tracing/instrumentation\#adding-custom-spans)
...
## [OpenTelemetry configuration options](https://vercel.com/docs/tracing/instrumentation\#opentelemetry-configuration-options)
...
## [Limitations](https://vercel.com/docs/tracing/instrumentation\#limitations)

- If your app uses manual OpenTelemetry SDK configuration without the usage of `@vercel/otel`, you will not be able to use [Session Tracing](https://vercel.com/docs/tracing/session-tracing) or [Trace Drains](https://vercel.com/docs/drains/reference/traces).
