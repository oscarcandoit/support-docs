---
url: "https://vercel.com/docs/cli/about-telemetry"
title: "Telemetry"
---
...
[opt-out](https://vercel.com/docs/cli/about-telemetry#how-do-i-opt-out-of-vercel-cli-telemetry) if you would prefer not
to share any telemetry information.

## [Why is telemetry collected?](https://vercel.com/docs/cli/about-telemetry\#why-is-telemetry-collected)
...
## [What is being collected?](https://vercel.com/docs/cli/about-telemetry\#what-is-being-collected)
...
## [What about sensitive data?](https://vercel.com/docs/cli/about-telemetry\#what-about-sensitive-data)
...
## [How do I opt-out of Vercel CLI telemetry?](https://vercel.com/docs/cli/about-telemetry\#how-do-i-opt-out-of-vercel-cli-telemetry)

You may use the [vercel telemetry](https://vercel.com/docs/cli/telemetry) command to manage the telemetry collection status. This sets a global configuration value on your computer.
