...
## [Pricing](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#pricing)
...
## [Usage](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#usage)
...
### [Storage](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#storage)
...
### [Written data](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#written-data)

The total amount of Write Units used to durably store new ISR data, measured in 8KB units.

### [Read data](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#read-data)
...
## [ISR reads and writes price](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#isr-reads-and-writes-price)

ISR Reads and Writes are priced regionally based on the [Vercel function region(s)](https://vercel.com/docs/functions/configuring-functions/region) set at your project level. See the regional [pricing documentation](https://vercel.com/docs/pricing/regional-pricing) and [ISR cache region](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing#isr-cache-region) for more information.

### [ISR cache region](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#isr-cache-region)

The ISR cache region for your deployment is set at build time and is based on the [default Function region](https://vercel.com/docs/functions/configuring-functions/region#setting-your-default-region) set at your project level. If you have multiple regions set, the region that will give you the best [cost](https://vercel.com/docs/pricing/regional-pricing) optimization is selected. For example, if `iad1` (Washington, D.C., USA) is one of your regions, it is always selected.
...
## [Optimizing ISR reads and writes](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#optimizing-isr-reads-and-writes)
...
- For content that rarely changes, set a longer [time-based revalidation](https://vercel.com/docs/incremental-static-regeneration/quickstart#background-revalidation) interval
- If you have events that trigger data updates, use [on-demand revalidation](https://vercel.com/docs/incremental-static-regeneration/quickstart#on-demand-revalidation)
...
## [ISR reads chart](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#isr-reads-chart)
...
## [ISR writes chart](https://vercel.com/docs/incremental-static-regeneration/limits-and-pricing\#isr-writes-chart)
