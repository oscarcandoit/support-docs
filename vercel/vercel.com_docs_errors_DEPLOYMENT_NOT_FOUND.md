...
## [Troubleshoot](https://vercel.com/docs/errors/DEPLOYMENT_NOT_FOUND\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/DEPLOYMENT\_NOT\_FOUND to understand what's happening.
...
2. Check deployment existence: Verify that the [deployment exists](https://vercel.com/docs/projects/project-dashboard#deployments) and has not been deleted
...
6. Contact support: If you've checked the above and are still unable to resolve the issue, [contact support](https://vercel.com/help#issues) for further assistance
