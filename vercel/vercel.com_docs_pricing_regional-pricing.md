...
| --- | --- | --- |
| [Fast Data Transfer](https://vercel.com/docs/edge-network/manage-usage#fast-data-transfer) | First 1 TB | 1 GB for $0.15 \- $0.35 |
| [Edge Requests](https://vercel.com/docs/edge-network/manage-usage#edge-requests) | First 10,000,000 | 1,000,000 Requests for $2.00 \- $3.20 |
...
| [Fast Origin Transfer](https://vercel.com/docs/edge-network/manage-usage#fast-origin-transfer) | 1 GB for $0.06 \- $0.43 |
| [Edge Request Additional CPU Duration](https://vercel.com/docs/edge-network/manage-usage#edge-request-cpu-duration) | 1 Hour for $0.30 \- $0.48 |
...
| [Blob Storage Size](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | 1 GB for $0.02 \- $0.04 |
...
| [Blob Data Transfer](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | 1 GB for $0.05 \- $0.12 |
| [Private Data Transfer](https://vercel.com/docs/connectivity/static-ips) | 1 GB for $0.15 \- $0.31 |

## [Specific region pricing](https://vercel.com/docs/pricing/regional-pricing\#specific-region-pricing)
...
For more information on Managed Infrastructure pricing, see the [pricing documentation](https://vercel.com/docs/pricing#managed-infrastructure).
