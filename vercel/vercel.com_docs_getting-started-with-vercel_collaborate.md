...
## [Make Changes](https://vercel.com/docs/getting-started-with-vercel/collaborate\#make-changes)
...
Vercel provides a [URL](https://vercel.com/docs/deployments/generated-urls#generated-from-git) that reflects the latest pushes to that branch. You can find this either on your dashboard, or in a pull request, which you'll see in the next step
...
## [Create a preview deployment](https://vercel.com/docs/getting-started-with-vercel/collaborate\#create-a-preview-deployment)

1. ### [Make your changes](https://vercel.com/docs/getting-started-with-vercel/collaborate\#make-your-changes)



Create a new branch in your project and make some changes

2. ### [Commit your changes](https://vercel.com/docs/getting-started-with-vercel/collaborate\#commit-your-changes)
...
![Vercel for GitHub deploying a pull request automatically.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fgit%2Fgithub-comment-light.png&w=1920&q=75)![Vercel for GitHub deploying a pull request automatically.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fgit%2Fgithub-comment-dark.png&w=1920&q=75)Vercel for GitHub deploying a pull request automatically.
3. ### [Inspect your deployment information](https://vercel.com/docs/getting-started-with-vercel/collaborate\#inspect-your-deployment-information)



Select Inspect to explore the build within your dashboard. You can see the build is within the preview environment and additional information about the deployment including: [build information](https://vercel.com/docs/deployments/builds), a [deployment summary](https://vercel.com/docs/deployments#resources-tab-and-deployment-summary), checks, and [domain assignment](https://vercel.com/docs/domains). These happen for every deployment
![Vercel dashboard showing the preview deployment.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fgetting-started-with-vercel%2Fpreview-dashboard-light.png&w=3840&q=75)![Vercel dashboard showing the preview deployment.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fgetting-started-with-vercel%2Fpreview-dashboard-dark.png&w=3840&q=75)Vercel dashboard showing the preview deployment.
4. ### [View your deployment URL](https://vercel.com/docs/getting-started-with-vercel/collaborate\#view-your-deployment-url)
...
## [Commenting on previews](https://vercel.com/docs/getting-started-with-vercel/collaborate\#commenting-on-previews)

[Comments](https://vercel.com/docs/comments) provide a way for your team [or friends](https://vercel.com/docs/comments/how-comments-work#sharing) to give direct feedback on [preview deployments](https://vercel.com/docs/deployments/environments#preview-environment-pre-production). Share with others by doing the following:

1. ### [Open your deployment](https://vercel.com/docs/getting-started-with-vercel/collaborate\#open-your-deployment)



Open the preview deployment that you’d like to share by selecting the Domain from the deployment information as shown in step 3 above. Alternatively, you can find it by selecting your project from the [dashboard](https://vercel.com/dashboard), and selecting the most recent commit under Active Branches:
![Active branch section showing all non-production branches](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fgetting-started-with-vercel%2Factive-branches-light.png&w=3840&q=75)![Active branch section showing all non-production branches](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fgetting-started-with-vercel%2Factive-branches-dark.png&w=3840&q=75)Active branch section showing all non-production branches
2. ### [Authenticate with your Vercel account](https://vercel.com/docs/getting-started-with-vercel/collaborate\#authenticate-with-your-vercel-account)



From the Comments toolbar at the bottom of the screen, select Log in to comment and sign in with your Vercel account.

3. ### [Adjust the share settings](https://vercel.com/docs/getting-started-with-vercel/collaborate\#adjust-the-share-settings)



Select Share in the [Toolbar](https://vercel.com/docs/vercel-toolbar) menu. Add the emails of people you would like to share the preview with. If you are previewing a specific commit, you may have the option to share the preview for your branch instead. This option allows you to share a preview that updates with the latest commit to the branch.

To learn more, including other ways to share, see [Sharing Deployments](https://vercel.com/docs/deployments/sharing-deployments).

4. ### [Collaborator needs to sign-in](https://vercel.com/docs/getting-started-with-vercel/collaborate\#collaborator-needs-to-sign-in)
...
5. ### [Collaborator can comment](https://vercel.com/docs/getting-started-with-vercel/collaborate\#collaborator-can-comment)
...
For more information on using Comments, see [Using comments](https://vercel.com/docs/comments/using-comments).

[What's next?](https://vercel.com/docs/getting-started-with-vercel/next-steps)
...
- [Make Changes](https://vercel.com/docs/getting-started-with-vercel/collaborate#make-changes)
- [Create a preview deployment](https://vercel.com/docs/getting-started-with-vercel/collaborate#create-a-preview-deployment)
- [Make your changes](https://vercel.com/docs/getting-started-with-vercel/collaborate#make-your-changes)
- [Commit your changes](https://vercel.com/docs/getting-started-with-vercel/collaborate#commit-your-changes)
- [Inspect your deployment information](https://vercel.com/docs/getting-started-with-vercel/collaborate#inspect-your-deployment-information)
- [View your deployment URL](https://vercel.com/docs/getting-started-with-vercel/collaborate#view-your-deployment-url)
- [Commenting on previews](https://vercel.com/docs/getting-started-with-vercel/collaborate#commenting-on-previews)
- [Open your deployment](https://vercel.com/docs/getting-started-with-vercel/collaborate#open-your-deployment)
- [Authenticate with your Vercel account](https://vercel.com/docs/getting-started-with-vercel/collaborate#authenticate-with-your-vercel-account)
- [Adjust the share settings](https://vercel.com/docs/getting-started-with-vercel/collaborate#adjust-the-share-settings)
- [Collaborator needs to sign-in](https://vercel.com/docs/getting-started-with-vercel/collaborate#collaborator-needs-to-sign-in)
- [Collaborator can comment](https://vercel.com/docs/getting-started-with-vercel/collaborate#collaborator-can-comment)
