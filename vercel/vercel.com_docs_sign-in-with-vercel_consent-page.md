...
## [When users click Allow](https://vercel.com/docs/sign-in-with-vercel/consent-page\#when-users-click-allow)
...
Your application exchanges this code for tokens using the [Token Endpoint](https://vercel.com/docs/sign-in-with-vercel/authorization-server-api#token-endpoint).

## [When users click Cancel](https://vercel.com/docs/sign-in-with-vercel/consent-page\#when-users-click-cancel)
...
## [Returning users](https://vercel.com/docs/sign-in-with-vercel/consent-page\#returning-users)
...
To force users to see the consent page again, include `prompt=consent` in your authorization request. Learn more in the [Authorization Endpoint](https://vercel.com/docs/sign-in-with-vercel/authorization-server-api#authorization-endpoint) documentation.
