---
url: "https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item"
title: "Get an Edge Config item - Vercel API Docs"
---

[Skip to main content](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#content-area)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#authorization-authorization)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#parameter-edge-config-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#parameter-edge-config-item-key)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#parameter-team-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#parameter-slug)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#response-key)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#response-value)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#response-edge-config-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#response-created-at)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#response-updated-at)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-an-edge-config-item#response-description)

description

string

[Delete an Edge Config's schema](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/delete-an-edge-configs-schema) [Get all tokens of an Edge Config](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-all-tokens-of-an-edge-config)
