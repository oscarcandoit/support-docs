---
url: "https://vercel.com/docs/connectivity/static-ips/getting-started"
...
## [Prerequisites](https://vercel.com/docs/connectivity/static-ips/getting-started\#prerequisites)
...
1. ### [Access the Connectivity settings](https://vercel.com/docs/connectivity/static-ips/getting-started\#access-the-connectivity-settings)
...
2. ### [Configure your region](https://vercel.com/docs/connectivity/static-ips/getting-started\#configure-your-region)
...
3. ### [Get your static IP addresses and configure your backend service](https://vercel.com/docs/connectivity/static-ips/getting-started\#get-your-static-ip-addresses-and-configure-your-backend-service)
...
4. ### [Verify your connection](https://vercel.com/docs/connectivity/static-ips/getting-started\#verify-your-connection)
...
## [Next steps](https://vercel.com/docs/connectivity/static-ips/getting-started\#next-steps)

- Learn how to [monitor usage and billing](https://vercel.com/docs/connectivity/static-ips#managing-your-static-ips) for your Static IPs
- Understand [how Static IPs work](https://vercel.com/docs/connectivity/static-ips#how-it-works)
- Review [limits and pricing](https://vercel.com/docs/connectivity/static-ips#limits-and-pricing)
...
- [Prerequisites](https://vercel.com/docs/connectivity/static-ips/getting-started#prerequisites)
- [Access the Connectivity settings](https://vercel.com/docs/connectivity/static-ips/getting-started#access-the-connectivity-settings)
- [Configure your region](https://vercel.com/docs/connectivity/static-ips/getting-started#configure-your-region)
- [Get your static IP addresses and configure your backend service](https://vercel.com/docs/connectivity/static-ips/getting-started#get-your-static-ip-addresses-and-configure-your-backend-service)
- [Verify your connection](https://vercel.com/docs/connectivity/static-ips/getting-started#verify-your-connection)
- [Next steps](https://vercel.com/docs/connectivity/static-ips/getting-started#next-steps)
