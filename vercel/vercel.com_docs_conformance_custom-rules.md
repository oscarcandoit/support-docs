---
url: "https://vercel.com/docs/conformance/custom-rules"
...
## [Available custom rule types](https://vercel.com/docs/conformance/custom-rules\#available-custom-rule-types)

We support the following custom rules types:

| Type | Description |
| --- | --- |
| [`forbidden-code`](https://vercel.com/docs/conformance/custom-rules/forbidden-code) | Disallows code and code patterns through string and regular expression matches. |
| [`forbidden-properties`](https://vercel.com/docs/conformance/custom-rules/forbidden-properties) | Disallows properties from being read, written, and/or called. |
| [`forbidden-dependencies`](https://vercel.com/docs/conformance/custom-rules/forbidden-dependencies) | Disallows one or more files from depending on one or more predefined modules. |
| [`forbidden-imports`](https://vercel.com/docs/conformance/custom-rules/forbidden-imports) | Disallows one or more files from importing one or more predefined modules. |
| [`forbidden-packages`](https://vercel.com/docs/conformance/custom-rules/forbidden-packages) | Disallows packages from being listed as dependencies in `package.json` files. |

## [Getting started](https://vercel.com/docs/conformance/custom-rules\#getting-started)

The no-code custom rules are defined and [configured](https://vercel.com/docs/conformance/customize) in `conformance.config.jsonc`.

In this example, you will set up a custom rule with the [`forbidden-imports`](https://vercel.com/docs/conformance/custom-rules/forbidden-imports) type. This rule disallows importing a package
called `api-utils`, and suggests to users that they should instead use a newer
version of that package.

1. ### [Create your config file](https://vercel.com/docs/conformance/custom-rules\#create-your-config-file)



At the root of your directory, create a file named `conformance.config.jsonc`. If one already exists, skip to the next step.

2. ### [Define a custom rule](https://vercel.com/docs/conformance/custom-rules\#define-a-custom-rule)
...
3. ### [Enable the custom rule](https://vercel.com/docs/conformance/custom-rules\#enable-the-custom-rule)



As all custom rules are disabled by default, you'll need to [enable rules](https://vercel.com/docs/conformance/customize#managing-a-conformance-rule)
...
4. ### [Restrict the rule to a workspace](https://vercel.com/docs/conformance/custom-rules\#restrict-the-rule-to-a-workspace)
...
- [Available custom rule types](https://vercel.com/docs/conformance/custom-rules#available-custom-rule-types)
- [Getting started](https://vercel.com/docs/conformance/custom-rules#getting-started)
- [Create your config file](https://vercel.com/docs/conformance/custom-rules#create-your-config-file)
- [Define a custom rule](https://vercel.com/docs/conformance/custom-rules#define-a-custom-rule)
- [Enable the custom rule](https://vercel.com/docs/conformance/custom-rules#enable-the-custom-rule)
- [Restrict the rule to a workspace](https://vercel.com/docs/conformance/custom-rules#restrict-the-rule-to-a-workspace)
