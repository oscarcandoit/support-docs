...
The Vercel [AI Gateway](https://vercel.com/docs/ai-gateway) integrates with popular community AI frameworks and tools,
enabling you to build powerful AI applications while
leveraging the Gateway's features like [cost tracking](https://vercel.com/docs/ai-gateway/observability) and [unified API access](https://vercel.com/docs/ai-gateway/models-and-providers).

### [Integration overview](https://vercel.com/docs/ai-gateway/framework-integrations\#integration-overview)

You can integrate the AI Gateway with popular frameworks in several ways:

- OpenAI Compatibility Layer: Use the AI Gateway's [OpenAI-compatible endpoints](https://vercel.com/docs/ai-gateway/openai-compat)
- Native Support: Direct integration through plugins or official support
- AI SDK Integration: Leverage the [AI SDK](https://vercel.com/docs/ai-sdk) to access [AI Gateway](https://vercel.com/docs/ai-gateway) capabilities directly

### [Supported frameworks](https://vercel.com/docs/ai-gateway/framework-integrations\#supported-frameworks)
