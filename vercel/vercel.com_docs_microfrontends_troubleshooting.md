...
## [Testing](https://vercel.com/docs/microfrontends/troubleshooting\#testing)

The `@vercel/microfrontends` package includes test utilities to help avoid common misconfigurations.

### [`validateMiddlewareConfig`](https://vercel.com/docs/microfrontends/troubleshooting\#validatemiddlewareconfig)
...
### [`validateMiddlewareOnFlaggedPaths`](https://vercel.com/docs/microfrontends/troubleshooting\#validatemiddlewareonflaggedpaths)
...
### [`validateRouting`](https://vercel.com/docs/microfrontends/troubleshooting\#validaterouting)
...
## [Debugging routing](https://vercel.com/docs/microfrontends/troubleshooting\#debugging-routing)

### [Debug logs when running locally](https://vercel.com/docs/microfrontends/troubleshooting\#debug-logs-when-running-locally)

See [debug routing](https://vercel.com/docs/microfrontends/local-development#debug-routing) for how to enable debug logs to see where and why the local proxy routed the request.

### [Debug headers when deployed](https://vercel.com/docs/microfrontends/troubleshooting\#debug-headers-when-deployed)
...
You can enable debug headers in the [Vercel Toolbar](https://vercel.com/docs/microfrontends/managing-microfrontends/vercel-toolbar#enable-routing-debug-mode), or by setting a cookie `VERCEL_MFE_DEBUG` to `1` in your browser.
...
## [Observability](https://vercel.com/docs/microfrontends/troubleshooting\#observability)

Microfrontends routing information is stored in [Observability](https://vercel.com/docs/observability) and can be viewed in the team or project scopes. Click on the Observability tab, and then find Microfrontends in the Edge Network section.

## [Tracing](https://vercel.com/docs/microfrontends/troubleshooting\#tracing)

Microfrontends routing is captured by Vercel [Session tracing](https://vercel.com/docs/tracing/session-tracing). Once you have captured a trace, you can inspect the Microfrontends span in the [logs tab](https://vercel.com/docs/tracing#viewing-traces-in-the-dashboard).
...
## [Troubleshooting](https://vercel.com/docs/microfrontends/troubleshooting\#troubleshooting)

The following are common issues you might face with debugging tips:

### [Microfrontends aren't working in local development](https://vercel.com/docs/microfrontends/troubleshooting\#microfrontends-aren't-working-in-local-development)

See [debug routing](https://vercel.com/docs/microfrontends/local-development#debug-routing) for how to enable debug logs to see where and why the local proxy routed the request.

### [Requests are not routed to the correct microfrontend in production](https://vercel.com/docs/microfrontends/troubleshooting\#requests-are-not-routed-to-the-correct-microfrontend-in-production)

To validate where requests are being routed to in production, follow these steps:

1. [Verify](https://vercel.com/docs/microfrontends/path-routing#identifying-microfrontends-by-path) that the path is covered by the microfrontends routing configuration.
2. Inspect the [debug headers](https://vercel.com/docs/microfrontends/troubleshooting#debug-headers) or view a [page trace](https://vercel.com/docs/microfrontends/troubleshooting#tracing) to verify the expected path was matched.
