...
[XSS](https://vercel.com/kb/guide/understanding-xss-attacks) remains one of the most prevalent web application vulnerabilities. In an XSS attack, malicious scripts are injected into websites, which run on the end user's browser, potentially leading to stolen data, session hijacking, and other malicious actions.
...
While input sanitization and secure coding practices are essential, CSP acts as a second line of defense, reducing the risk of [XSS exploits](https://vercel.com/kb/guide/understanding-xss-attacks).
...
## [Content Security Policy headers](https://vercel.com/docs/headers/security-headers\#content-security-policy-headers)
...
## [Best Practices](https://vercel.com/docs/headers/security-headers\#best-practices)
