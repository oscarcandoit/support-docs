---
url: "https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items"
title: "Get Edge Config items - Vercel API Docs"
---

[Skip to main content](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#content-area)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#authorization-authorization)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#parameter-edge-config-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#parameter-team-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#parameter-slug)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#response-key)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#response-value)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#response-edge-config-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#response-created-at)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#response-updated-at)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-items#response-description)

description

string

[Delete an Edge Config](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/delete-an-edge-config) [Update Edge Config items in batch](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-items-in-batch)
