...
## [Getting started](https://vercel.com/docs/frameworks/full-stack/tanstack-start\#getting-started)
...
[![](https://api-frameworks.vercel.sh/framework-logos/tanstack-start.svg)Deploy our TanStack Start template, or view a live example.](https://vercel.com/templates/starter/tanstack-start-on-vercel)

[Deploy](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fvercel%2Ftree%2Fmain%2Fexamples%2Ftanstack-start&template=tanstack-start) [Live Example](https://tanstack-start-vercel-example-demo.vercel.app/)

## [Nitro Configuration](https://vercel.com/docs/frameworks/full-stack/tanstack-start\#nitro-configuration)
...
### [Vercel Functions](https://vercel.com/docs/frameworks/full-stack/tanstack-start\#vercel-functions)

TanStack Start apps on Vercel benefit from the advantages of [Vercel Functions](https://vercel.com/docs/functions) and use [Fluid Compute](https://vercel.com/docs/fluid-compute) by default. This means your TanStack Start app will automatically scale up and down based on traffic.

## [More resources](https://vercel.com/docs/frameworks/full-stack/tanstack-start\#more-resources)
