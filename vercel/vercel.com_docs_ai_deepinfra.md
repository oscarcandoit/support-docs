...
## [Use cases](https://vercel.com/docs/ai/deepinfra\#use-cases)
...
### [Available models](https://vercel.com/docs/ai/deepinfra\#available-models)
...
## [Getting started](https://vercel.com/docs/ai/deepinfra\#getting-started)

The Vercel Deep Infra integration can be accessed through the AI tab on your [Vercel dashboard](https://vercel.com/dashboard).

### [Prerequisites](https://vercel.com/docs/ai/deepinfra\#prerequisites)
...
### [Add the provider to your project](https://vercel.com/docs/ai/deepinfra\#add-the-provider-to-your-project)

#### [Using the dashboard](https://vercel.com/docs/ai/deepinfra\#using-the-dashboard)

01. Navigate to the AI tab in your [Vercel dashboard](https://vercel.com/dashboard)
02. Select Deep Infra from the list of providers, and press Add
...
10. Connect your project using the code below:
    ...
    3import { deepinfra } from '@ai-sdk/deepinfra';
    ...
    15    model: deepinfra('deepseek-ai/DeepSeek-R1-Distill-Llama-70B'),
...
#### [Using the CLI](https://vercel.com/docs/ai/deepinfra\#using-the-cli)
...
## [More resources](https://vercel.com/docs/ai/deepinfra\#more-resources)
