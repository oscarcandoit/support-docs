...
## [Pricing](https://vercel.com/docs/analytics/limits-and-pricing\#pricing)

The Web Analytics pricing model is based on the number of [collected events](https://vercel.com/docs/analytics/limits-and-pricing#what-is-an-event-in-vercel-web-analytics) across all projects of your team.
...
| [Custom Events](https://vercel.com/docs/analytics/custom-events) | - | Included | Included | Included |
| Properties on Custom Events | - | 2 | 8 | 8 |
| [UTM Parameters](https://vercel.com/docs/analytics/filtering#using-filters) | - | - | Included | Included |
...
If your team is on the Hobby plan, we will [pause](https://vercel.com/docs/analytics/limits-and-pricing#hobby) the collection, as you cannot be charged for extra events.

Pro teams can also purchase the [Web Analytics Plus add-on](https://vercel.com/docs/analytics/limits-and-pricing#pro-with-web-analytics-plus) for an additional $10/month per team, which grants access to more features and an extended reporting window.

## [Usage](https://vercel.com/docs/analytics/limits-and-pricing\#usage)
...
## [Billing information](https://vercel.com/docs/analytics/limits-and-pricing\#billing-information)

### [Hobby](https://vercel.com/docs/analytics/limits-and-pricing\#hobby)

Web Analytics are free for Hobby users within the usage limits detailed above.

Vercel will [send you notifications](https://vercel.com/docs/notifications#on-demand-usage-notifications) as you are nearing your usage limits.
...
If you're expecting large number of page views, make sure to deploy your project to a Vercel [Team](https://vercel.com/docs/accounts/create-a-team) on the [Pro](https://vercel.com/docs/plans/pro) plan.

### [Pro](https://vercel.com/docs/analytics/limits-and-pricing\#pro)

For Teams on a Pro trial, the [trial will end](https://vercel.com/docs/plans/pro-plan/trials#post-trial-decision) after 14 days.
...
You will be charged $0.00003 per event. These numbers are based on a per-billing cycle basis. Vercel will [send you notifications](https://vercel.com/docs/notifications#on-demand-usage-notifications) when you get closer to spending your included credit.
...
### [Pro with Web Analytics Plus](https://vercel.com/docs/analytics/limits-and-pricing\#pro-with-web-analytics-plus)

Teams on the Pro plan can optionally extend usage and capabilities through the Web Analytics Plus [add-on](https://vercel.com/docs/pricing#pro-plan-add-ons) for an additional $10/month per team.
...
## [FAQ](https://vercel.com/docs/analytics/limits-and-pricing\#faq)

### [What is an event in Vercel Web Analytics?](https://vercel.com/docs/analytics/limits-and-pricing\#what-is-an-event-in-vercel-web-analytics)

An event in Vercel Web Analytics is either an automatically tracked page view or a [custom event](https://vercel.com/docs/analytics/custom-events).
...
### [What happens when you reach the maximum number of events?](https://vercel.com/docs/analytics/limits-and-pricing\#what-happens-when-you-reach-the-maximum-number-of-events)
...
### [Is usage shared across projects?](https://vercel.com/docs/analytics/limits-and-pricing\#is-usage-shared-across-projects)
...
### [What is the reporting window?](https://vercel.com/docs/analytics/limits-and-pricing\#what-is-the-reporting-window)
