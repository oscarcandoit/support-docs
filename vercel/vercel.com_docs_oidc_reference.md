...
## [Helper libraries](https://vercel.com/docs/oidc/reference\#helper-libraries)
...
### [AWS SDK credentials provider](https://vercel.com/docs/oidc/reference\#aws-sdk-credentials-provider)
...
#### [AWS S3 usage example](https://vercel.com/docs/oidc/reference\#aws-s3-usage-example)
...
### [Other cloud providers](https://vercel.com/docs/oidc/reference\#other-cloud-providers)
...
#### [Azure / CosmosDB example](https://vercel.com/docs/oidc/reference\#azure-/-cosmosdb-example)
...
In the Vercel function environments, you cannot execute the
...
## [Team and project name changes](https://vercel.com/docs/oidc/reference\#team-and-project-name-changes)
...
## [OIDC token anatomy](https://vercel.com/docs/oidc/reference\#oidc-token-anatomy)
...
### [Example token](https://vercel.com/docs/oidc/reference\#example-token)
...
### [Standard OpenID Connect claims](https://vercel.com/docs/oidc/reference\#standard-openid-connect-claims)
...
### [Additional claims](https://vercel.com/docs/oidc/reference\#additional-claims)
...
### [JWT headers](https://vercel.com/docs/oidc/reference\#jwt-headers)
