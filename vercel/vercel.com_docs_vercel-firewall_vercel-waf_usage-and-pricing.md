---
url: "https://vercel.com/docs/vercel-firewall/vercel-waf/usage-and-pricing"
...
Vercel Firewall features that are available under all plans, are free to use. This includes [DDoS mitigation](https://vercel.com/docs/security/ddos-mitigation), [IP blocking](https://vercel.com/docs/security/vercel-waf/ip-blocking), and [custom rules](https://vercel.com/docs/security/vercel-waf/custom-rules). Vercel WAF plan-specific features such as [rate limiting](https://vercel.com/docs/security/vercel-waf/rate-limiting) and [managed rulesets](https://vercel.com/docs/security/vercel-waf/managed-rulesets) are priced as described in [priced features](https://vercel.com/docs/vercel-firewall/vercel-waf/usage-and-pricing#priced-features-usage).

## [Free features usage](https://vercel.com/docs/vercel-firewall/vercel-waf/usage-and-pricing\#free-features-usage)

Although you are not charged for Firewall features available under all plans, you may incur [Edge Requests (ER)](https://vercel.com/docs/manage-cdn-usage#edge-requests) and [incoming Fast Data Transfer (FDT)](https://vercel.com/docs/manage-cdn-usage#fast-data-transfer) charges as described below.

| Feature | ER | FDT | Note |
| --- | --- | --- | --- |
| [WAF custom rule](https://vercel.com/docs/security/vercel-waf/custom-rules) | Charged | Charged | When a custom rule is active, you incur usage for every challenged or denied request. |
| [WAF custom rule with persistent actions](https://vercel.com/docs/security/vercel-waf/custom-rules#persistent-actions) | Not charged | Not charged | As the requests are now blocked before being processed by the firewall, they do not count towards usage. |
| [DDoS mitigation](https://vercel.com/docs/security/ddos-mitigation) | Not charged | Not charged | Review [Do I get billed for DDoS?](https://vercel.com/docs/security/ddos-mitigation#do-i-get-billed-for-ddos) for an explanation. |
| [Attack Challenge Mode](https://vercel.com/docs/attack-challenge-mode) | Not charged | Not charged | When attack challenge mode is turned on, requests that do not pass the challenge will not count towards usage. |
| [Account level IP Blocking](https://vercel.com/docs/security/vercel-waf/ip-blocking#account-level-ip-blocking) | Not charged | Not charged | Requests originating from these blocked IP addresses do not count towards usage. |
| [Project level IP Blocking](https://vercel.com/docs/security/vercel-waf/ip-blocking#project-level-ip-blocking) | Charged | Charged | This falls under custom rules. |

## [Priced features usage](https://vercel.com/docs/vercel-firewall/vercel-waf/usage-and-pricing\#priced-features-usage)

Enterprise only features are priced as described below.

### [Rate limiting pricing](https://vercel.com/docs/vercel-firewall/vercel-waf/usage-and-pricing\#rate-limiting-pricing)
...
### [Managed ruleset pricing](https://vercel.com/docs/vercel-firewall/vercel-waf/usage-and-pricing\#managed-ruleset-pricing)
