...
The browser extensionsare availableon [all plans](https://vercel.com/docs/plans)
...
- Remembers your [personal preferences](https://vercel.com/docs/vercel-toolbar/browser-extension#setting-user-preferences) for when the toolbar hides and activates.
- Allows you to [take screenshots](https://vercel.com/docs/vercel-toolbar/browser-extension#taking-screenshots-with-the-extension) and attach them to comments.
- Click the extension to hide and show the toolbar, and pin it to your browser bar for quick access.

## [Installing the browser extension](https://vercel.com/docs/vercel-toolbar/browser-extension\#installing-the-browser-extension)
...
## [Setting user preferences](https://vercel.com/docs/vercel-toolbar/browser-extension\#setting-user-preferences)
...
## [Taking screenshots with the extension](https://vercel.com/docs/vercel-toolbar/browser-extension\#taking-screenshots-with-the-extension)
