...
Last updatedOctober 3, 2025

## [Deploying your Domain](https://vercel.com/docs/domains/working-with-domains/deploying-and-redirecting\#deploying-your-domain)
...
When you assign a custom domain to a project that's using [Git](https://vercel.com/docs/git), each push (including merges) that you make to the [production branch](https://vercel.com/docs/git#production-branch) (commonly `main`) will trigger a deployment to the domain.
...
## [Redirecting domains](https://vercel.com/docs/domains/working-with-domains/deploying-and-redirecting\#redirecting-domains)
...
![Edit domain modal.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Fredirect-domain-light.png&w=1200&q=75)![Edit domain modal.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdomains%2Fredirect-domain-dark.png&w=1200&q=75)Edit domain modal.

A domain redirect that redirects requests made to `www.acme.com` to
`acme.com`.

## [Redirecting `www` domains](https://vercel.com/docs/domains/working-with-domains/deploying-and-redirecting\#redirecting-www-domains)

Adding an [apex domain](https://vercel.com/docs/domains/working-with-domains#apex-domain) to a [Project](https://vercel.com/docs/projects/overview) on Vercel will automatically suggest adding its `www` counterpart. Using both of these domains ensures that visitors can always access your site, regardless of whether or not they use `www` when entering the URL.

We recommend using the `www` subdomain as your primary domain, with a redirect from the non-`www` domain to it. This allows the [Vercel CDN](https://vercel.com/docs/cdn) more control over incoming traffic for improved reliability, speed, and security. The redirect is also cached on visitor's browsers for faster subsequent visits.
...
## [Additional technical information about Domain redirects](https://vercel.com/docs/domains/working-with-domains/deploying-and-redirecting\#additional-technical-information-about-domain-redirects)
...
## [Programmatic redirects](https://vercel.com/docs/domains/working-with-domains/deploying-and-redirecting\#programmatic-redirects)

You can also add redirects programmatically using frameworks and Vercel Functions. [Learn more](https://vercel.com/docs/redirects).
