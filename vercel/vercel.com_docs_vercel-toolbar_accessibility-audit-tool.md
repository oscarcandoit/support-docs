...
Accessibility Audit Toolis availableon [all plans](https://vercel.com/docs/plans)

The accessibility audit tool automatically checks the [Web Content Accessibility Guidelines 2.0](https://www.w3.org/TR/WCAG20/) level A and AA rules, grouping them by impact as defined by [deque axe](https://github.com/dequelabs/axe-core/blob/develop/doc/rule-descriptions.md#wcag-21-level-a--aa-rules), and runs in the background on [all environments the toolbar and added to](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost).

## [Accessing the accessibility audit tool](https://vercel.com/docs/vercel-toolbar/accessibility-audit-tool\#accessing-the-accessibility-audit-tool)

To access the accessibility audit tool:

1. [Open the Toolbar Menu](https://vercel.com/docs/vercel-toolbar#using-the-toolbar-menu)
...
## [Enabling or disabling the accessibility audit tool](https://vercel.com/docs/vercel-toolbar/accessibility-audit-tool\#enabling-or-disabling-the-accessibility-audit-tool)
...
## [Inspecting accessibility issues](https://vercel.com/docs/vercel-toolbar/accessibility-audit-tool\#inspecting-accessibility-issues)
...
![Using the Accessibility Audit Tool](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fvercel-toolbar%2Faccessibility-audit-panel-light.png&w=1080&q=75)![Using the Accessibility Audit Tool](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fvercel-toolbar%2Faccessibility-audit-panel-dark.png&w=1080&q=75)Using the Accessibility Audit Tool

## [Recording accessibility issues](https://vercel.com/docs/vercel-toolbar/accessibility-audit-tool\#recording-accessibility-issues)
...
## [More resources](https://vercel.com/docs/vercel-toolbar/accessibility-audit-tool\#more-resources)
