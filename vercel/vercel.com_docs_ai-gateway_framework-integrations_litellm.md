...
## [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/litellm\#getting-started)

1. ### [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/litellm\#create-a-new-project)
...
2. ### [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/litellm\#install-dependencies)
...
3. ### [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/litellm\#configure-environment-variables)
...
4. ### [Create your LiteLLM application](https://vercel.com/docs/ai-gateway/framework-integrations/litellm\#create-your-litellm-application)
...
5. ### [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/litellm\#running-the-application)
...
- [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/litellm#getting-started)
- [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/litellm#create-a-new-project)
- [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/litellm#install-dependencies)
- [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/litellm#configure-environment-variables)
- [Create your LiteLLM application](https://vercel.com/docs/ai-gateway/framework-integrations/litellm#create-your-litellm-application)
- [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/litellm#running-the-application)
