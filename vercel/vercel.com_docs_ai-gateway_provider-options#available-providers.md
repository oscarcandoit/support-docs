---
url: "https://vercel.com/docs/ai-gateway/provider-options#available-providers"
...
If you want to customize individual AI model provider settings rather than
...
## [Basic provider ordering](https://vercel.com/docs/ai-gateway/provider-options\#basic-provider-ordering)

You can use the `order` array to specify the sequence in which providers should be attempted. Providers are specified using their `slug` string. You can find the slugs in the [table of available providers](https://vercel.com/docs/ai-gateway/provider-options#available-providers).
...
### [Getting started with adding a provider option](https://vercel.com/docs/ai-gateway/provider-options\#getting-started-with-adding-a-provider-option)

1. ### [Install the AI SDK package](https://vercel.com/docs/ai-gateway/provider-options\#install-the-ai-sdk-package)
...
2. ### [Configure the provider order in your request](https://vercel.com/docs/ai-gateway/provider-options\#configure-the-provider-order-in-your-request)
...
3. ### [Test the routing behavior](https://vercel.com/docs/ai-gateway/provider-options\#test-the-routing-behavior)
...
## [Example provider metadata output](https://vercel.com/docs/ai-gateway/provider-options\#example-provider-metadata-output)
...
## [Restrict providers with the `only` filter](https://vercel.com/docs/ai-gateway/provider-options\#restrict-providers-with-the-only-filter)
...
## [Using `only` together with `order`](https://vercel.com/docs/ai-gateway/provider-options\#using-only-together-with-order)
...
## [Model fallbacks with the `models` option](https://vercel.com/docs/ai-gateway/provider-options\#model-fallbacks-with-the-models-option)
...
### [Combining `models` with provider options](https://vercel.com/docs/ai-gateway/provider-options\#combining-models-with-provider-options)
...
## [Combining AI Gateway provider options with provider-specific options](https://vercel.com/docs/ai-gateway/provider-options\#combining-ai-gateway-provider-options-with-provider-specific-options)
...
## [Reasoning](https://vercel.com/docs/ai-gateway/provider-options\#reasoning)
...
## [Available providers](https://vercel.com/docs/ai-gateway/provider-options\#available-providers)
...
Provider availability may vary by model. Some models may only be available
...
- [Basic provider ordering](https://vercel.com/docs/ai-gateway/provider-options#basic-provider-ordering)
- [Getting started with adding a provider option](https://vercel.com/docs/ai-gateway/provider-options#getting-started-with-adding-a-provider-option)
- [Install the AI SDK package](https://vercel.com/docs/ai-gateway/provider-options#install-the-ai-sdk-package)
- [Configure the provider order in your request](https://vercel.com/docs/ai-gateway/provider-options#configure-the-provider-order-in-your-request)
- [Test the routing behavior](https://vercel.com/docs/ai-gateway/provider-options#test-the-routing-behavior)
- [Example provider metadata output](https://vercel.com/docs/ai-gateway/provider-options#example-provider-metadata-output)
- [Restrict providers with the only filter](https://vercel.com/docs/ai-gateway/provider-options#restrict-providers-with-the-only-filter)
- [Using only together with order](https://vercel.com/docs/ai-gateway/provider-options#using-only-together-with-order)
- [Model fallbacks with the models option](https://vercel.com/docs/ai-gateway/provider-options#model-fallbacks-with-the-models-option)
