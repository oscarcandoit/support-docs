...
## [Pricing](https://vercel.com/docs/feature-flags/flags-explorer/limits-and-pricing\#pricing)
...
Unlimited overrides can be managed in your [team's billing settings](https://vercel.com/d?to=%2Fteams%2F%5Bteam%5D%2Fsettings%2Fbilling&title=Go+to+Billing+Settings). Alternatively, if you have the necessary permissions, you can enable this feature directly in the Flags Explorer once you reach the limit.

### [Limits per plan](https://vercel.com/docs/feature-flags/flags-explorer/limits-and-pricing\#limits-per-plan)
