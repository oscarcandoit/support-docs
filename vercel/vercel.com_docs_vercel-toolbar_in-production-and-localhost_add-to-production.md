...
## [Adding the toolbar using the browser extension](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#adding-the-toolbar-using-the-browser-extension)
...
## [Adding the toolbar using the `@vercel/toolbar` package](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#adding-the-toolbar-using-the-@vercel/toolbar-package)
...
1. ### [Install the `@vercel/toolbar` package and link your project](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#install-the-@vercel/toolbar-package-and-link-your-project)
...
2. ### [Add the toolbar to your project](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#add-the-toolbar-to-your-project)
...
3. ### [Managing notifications and integrations for Comments on production](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#managing-notifications-and-integrations-for-comments-on-production)
...
## [Enabling the Vercel Toolbar](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#enabling-the-vercel-toolbar)

Alternatively to using the package, you can enable access to the Vercel Toolbar for your production environment at the team or project level. Once enabled, team members can access the toolbar using the [Vercel Browser Extension](https://vercel.com/docs/vercel-toolbar/browser-extension) or by [enabling it in the toolbar menu](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#accessing-the-toolbar-using-the-toolbar-menu).

1. Navigate to [your Vercel dashboard](https://vercel.com/dashboard) and make sure that you have selected your team from the [scope selector](https://vercel.com/docs/dashboard-features#scope-selector). To manage the toolbar at the project level, ensure that you have selected the project.
...
### [Disabling the toolbar](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#disabling-the-toolbar)
...
## [Acessing the toolbar using the Vercel dashboard](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#acessing-the-toolbar-using-the-vercel-dashboard)
...
## [Accessing the toolbar using the Browser extension](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#accessing-the-toolbar-using-the-browser-extension)

Provided [the Vercel toolbar is enabled](https://vercel.com/docs/vercel-toolbar/managing-toolbar#enable-or-disable-the-toolbar-project-wide) for your project, any team member can use the Vercel Toolbar in your production environment by installing the [Vercel Browser Extension](https://vercel.com/docs/vercel-toolbar/browser-extension). The extension allows you to access the toolbar on any website hosted on Vercel that your team(s) own:
...
## [Accessing the toolbar using the toolbar menu](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production\#accessing-the-toolbar-using-the-toolbar-menu)

Provided [the Vercel toolbar is enabled](https://vercel.com/docs/vercel-toolbar/managing-toolbar#enable-or-disable-the-toolbar-project-wide) for your project, you can enable the toolbar on production environments from the toolbar menu:
...
- [Adding the toolbar using the browser extension](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#adding-the-toolbar-using-the-browser-extension)
- [Adding the toolbar using the @vercel/toolbar package](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#adding-the-toolbar-using-the-@vercel/toolbar-package)
- [Install the @vercel/toolbar package and link your project](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#install-the-@vercel/toolbar-package-and-link-your-project)
- [Add the toolbar to your project](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#add-the-toolbar-to-your-project)
- [Managing notifications and integrations for Comments on production](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#managing-notifications-and-integrations-for-comments-on-production)
- [Enabling the Vercel Toolbar](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#enabling-the-vercel-toolbar)
- [Disabling the toolbar](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#disabling-the-toolbar)
- [Acessing the toolbar using the Vercel dashboard](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#acessing-the-toolbar-using-the-vercel-dashboard)
- [Accessing the toolbar using the Browser extension](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost/add-to-production#accessing-the-toolbar-using-the-browser-extension)
