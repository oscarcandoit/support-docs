---
url: "https://vercel.com/docs/edge-config/edge-config-integrations"
...
Edge Config integrationsare availableon [all plans](https://vercel.com/docs/plans)
...
[![Optimizely Feature Experimentation](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F3LaP5zEajoLOuxjuhXR4WY%2F0eb9b810d9c23d1e2ad60946068a1701%2Fdemo.png&w=3840&q=75)\\
\\
Optimizely Feature Experimentation\\
\\
Fast and safe experimentation with Next.js App Router, Vercel Feature Flags, and Optimizely Feature Experimentation](https://vercel.com/templates/next.js/optimizely-feature-experimentation) [![Flags SDK with OpenFeature adapter](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F6NZAIOOPoxyPrKN3ZCVHCR%2F6b6de6a4f0503e9249f9cdf51773a043%2FFlags___launchdarkly_-_Light.png&w=3840&q=75)\\
\\
Flags SDK with OpenFeature adapter\\
\\
Use OpenFeature providers with the Flags SDK](https://vercel.com/templates/next.js/flags-sdk-openfeature) [![Experimentation with Statsig](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F3iWLIPxEQc7e5plRHDW5Nd%2Fdf781629a2e72f6ae5d05879787c4c79%2Fvercel_statsig.png&w=3840&q=75)\\
\\
Experimentation with Statsig\\
\\
Reduce CLS and improve performance from client-loaded experiments at the edge with Statsig](https://vercel.com/templates/next.js/ab-testing-statsig)

[View All Templates](https://vercel.com/templates/)

You can get started with any of these Edge Config integrations by following the quickstart:

- [LaunchDarkly](https://vercel.com/docs/edge-config/integrations/launchdarkly-edge-config)
- [Statsig](https://vercel.com/docs/edge-config/integrations/statsig-edge-config)
- [Hypertune](https://vercel.com/docs/edge-config/integrations/hypertune-edge-config)
- [Split](https://vercel.com/docs/edge-config/integrations/split-edge-config)
- [DevCycle](https://vercel.com/docs/edge-config/integrations/devcycle-edge-config)

## [More resources](https://vercel.com/docs/edge-config/edge-config-integrations\#more-resources)
