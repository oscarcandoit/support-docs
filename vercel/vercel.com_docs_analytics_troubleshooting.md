...
## [No data visible in Web Analytics dashboard](https://vercel.com/docs/analytics/troubleshooting\#no-data-visible-in-web-analytics-dashboard)
...
1. Make sure that you have [enabled Analytics](https://vercel.com/docs/analytics/quickstart#enable-web-analytics-in-vercel) in the dashboard.
...
## [Web Analytics is not working with a proxy (e.g., Cloudflare)](https://vercel.com/docs/analytics/troubleshooting\#web-analytics-is-not-working-with-a-proxy-e.g.-cloudflare)
...
## [Routes are not visible in Web Analytics dashboard](https://vercel.com/docs/analytics/troubleshooting\#routes-are-not-visible-in-web-analytics-dashboard)
