...
## [Routing Middleware file location and name](https://vercel.com/docs/routing-middleware/api\#routing-middleware-file-location-and-name)
...
## [`config` object](https://vercel.com/docs/routing-middleware/api\#config-object)

Routing Middleware will be invoked for every route in your project. If you only want it to be run on specific paths, you can define those either with a [custom matcher config](https://vercel.com/docs/routing-middleware/api#match-paths-based-on-custom-matcher-config) or with [conditional statements](https://vercel.com/docs/routing-middleware/api#match-paths-based-on-conditional-statements).

You can also use the [`runtime` option](https://vercel.com/docs/routing-middleware/api#config-properties) to [specify which runtime](https://vercel.com/docs/routing-middleware/api#specify-runtime) you would like to use. The default is `edge`.
...
### [Match paths based on custom matcher config](https://vercel.com/docs/routing-middleware/api\#match-paths-based-on-custom-matcher-config)
...
#### [Match a single path](https://vercel.com/docs/routing-middleware/api\#match-a-single-path)
...
#### [Match multiple paths](https://vercel.com/docs/routing-middleware/api\#match-multiple-paths)
...
#### [Match using regex](https://vercel.com/docs/routing-middleware/api\#match-using-regex)
...
#### [Match based on a negative lookahead](https://vercel.com/docs/routing-middleware/api\#match-based-on-a-negative-lookahead)
...
#### [Match based on character matching](https://vercel.com/docs/routing-middleware/api\#match-based-on-character-matching)
...
### [Match paths based on conditional statements](https://vercel.com/docs/routing-middleware/api\#match-paths-based-on-conditional-statements)
...
See the [helper methods](https://vercel.com/docs/routing-middleware/api#routing-middleware-helper-methods) below for more information on using the `@vercel/functions` package.

### [Specify runtime](https://vercel.com/docs/routing-middleware/api\#specify-runtime)
...
To use the Bun runtime with Routing Middleware, set the [`bunVersion`](https://vercel.com/docs/project-configuration#bunversion) property in your `vercel.json` file as well as using the `runtime` config shown above to `nodejs`:
...
### [`config` properties](https://vercel.com/docs/routing-middleware/api\#config-properties)
...
## [Routing Middleware signature](https://vercel.com/docs/routing-middleware/api\#routing-middleware-signature)
...
| --- | --- | --- | --- |
| `request` | An instance of the [Request](https://vercel.com/docs/functions/edge-functions/edge-functions-api#request) object | [`Request`](https://developer.mozilla.org/docs/Web/API/Request) or [`NextRequest`](https://nextjs.org/docs/api-reference/next/server#nextrequest) | [`Request`](https://developer.mozilla.org/docs/Web/API/Request) |
| `context` | An extension to the standard [`Request`](https://developer.mozilla.org/docs/Web/API/Request) object | [`NextFetchEvent`](https://nextjs.org/docs/api-reference/next/server#nextfetchevent) | [`RequestContext`](https://vercel.com/docs/functions/edge-functions/edge-functions-api#requestcontext) |
...
[See the section on Routing Middleware helpers for more information](https://vercel.com/docs/routing-middleware/api#routing-middleware-helper-methods).
...
If you're not using a framework, you must either add`"type": "module"` to your`package.json` or change your JavaScript Functions'
file extensions from `.js` to`.mjs`

### [Request](https://vercel.com/docs/routing-middleware/api\#request)
...
#### [Request properties](https://vercel.com/docs/routing-middleware/api\#request-properties)
...
### [`waitUntil()`](https://vercel.com/docs/routing-middleware/api\#waituntil)
...
#### [Context properties](https://vercel.com/docs/routing-middleware/api\#context-properties)
...
## [Routing Middleware helper methods](https://vercel.com/docs/routing-middleware/api\#routing-middleware-helper-methods)

You can use Vercel-specific helper methods to access a request's [geolocation](https://vercel.com/docs/routing-middleware/api#geolocation), [IP Address](https://vercel.com/docs/functions/functions-api-reference/vercel-functions-package#ipaddress), and more when deploying Middleware on Vercel.
...
### [Geolocation](https://vercel.com/docs/routing-middleware/api\#geolocation)
...
| `region` | The [CDN region](https://vercel.com/docs/regions) that received the request |
...
### [IP Address](https://vercel.com/docs/routing-middleware/api\#ip-address)
...
### [`RequestContext`](https://vercel.com/docs/routing-middleware/api\#requestcontext)

The `RequestContext` is an extension of the standard `Request` object, which contains the [`waitUntil`](https://vercel.com/docs/routing-middleware/api#waitUntil) function. The following example works in middleware for all frameworks:
...
### [Rewrites](https://vercel.com/docs/routing-middleware/api\#rewrites)
...
### [Continuing the Routing Middleware chain](https://vercel.com/docs/routing-middleware/api\#continuing-the-routing-middleware-chain)
...
#### [`next()` no-op example](https://vercel.com/docs/routing-middleware/api\#next-no-op-example)
...
## [More resources](https://vercel.com/docs/routing-middleware/api\#more-resources)

- [Redirect with unique tokens](https://vercel.com/kb/guide/use-crypto-web-api)
