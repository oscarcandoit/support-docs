...
Vercel for Bitbucket automatically deploys your Bitbucket projects with [Vercel](https://vercel.com/), providing [Preview Deployment URLs](https://vercel.com/docs/deployments/environments#preview-environment-pre-production#preview-urls), and automatic [Custom Domain](https://vercel.com/docs/domains/add-a-domain) updates.

## [Supported Bitbucket Products](https://vercel.com/docs/git/vercel-for-bitbucket\#supported-bitbucket-products)
...
- [Bitbucket Data Center (Self-Hosted)](https://vercel.com/docs/git/vercel-for-bitbucket#using-bitbucket-pipelines)

## [Deploying a Bitbucket Repository](https://vercel.com/docs/git/vercel-for-bitbucket\#deploying-a-bitbucket-repository)

The [Deploying a Git repository](https://vercel.com/docs/git#deploying-a-git-repository) guide outlines how to create a new Vercel Project from a Bitbucket repository, and enable automatic deployments on every branch push.

## [Changing the Bitbucket Repository of a Project](https://vercel.com/docs/git/vercel-for-bitbucket\#changing-the-bitbucket-repository-of-a-project)
...
### [A Deployment for Each Push](https://vercel.com/docs/git/vercel-for-bitbucket\#a-deployment-for-each-push)
...
### [Updating the Production Domain](https://vercel.com/docs/git/vercel-for-bitbucket\#updating-the-production-domain)
...
### [Preview URLs for Each Pull Request](https://vercel.com/docs/git/vercel-for-bitbucket\#preview-urls-for-each-pull-request)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fgit%2Fbitbucket-comment.png&w=1920&q=75)

A preview URL created from a pull request.

### [System environment variables](https://vercel.com/docs/git/vercel-for-bitbucket\#system-environment-variables)
...
### [VERCEL\_GIT\_PROVIDER](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_PROVIDER)

The Git Provider the deployment is triggered from. In the case of Bitbucket, the value is always `bitbucket`.

### [VERCEL\_GIT\_REPO\_SLUG](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_REPO_SLUG)
...
### [VERCEL\_GIT\_REPO\_OWNER](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_REPO_OWNER)
...
### [VERCEL\_GIT\_REPO\_ID](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_REPO_ID)
...
### [VERCEL\_GIT\_COMMIT\_REF](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_COMMIT_REF)
...
### [VERCEL\_GIT\_COMMIT\_SHA](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_COMMIT_SHA)
...
### [VERCEL\_GIT\_COMMIT\_MESSAGE](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_COMMIT_MESSAGE)
...
### [VERCEL\_GIT\_COMMIT\_AUTHOR\_LOGIN](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_COMMIT_AUTHOR_LOGIN)
...
### [VERCEL\_GIT\_COMMIT\_AUTHOR\_NAME](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_COMMIT_AUTHOR_NAME)
...
### [VERCEL\_GIT\_PULL\_REQUEST\_ID](https://vercel.com/docs/git/vercel-for-bitbucket\#VERCEL_GIT_PULL_REQUEST_ID)
...
### [Repository Permissions](https://vercel.com/docs/git/vercel-for-bitbucket\#repository-permissions)
...
#### [Organization Permissions](https://vercel.com/docs/git/vercel-for-bitbucket\#organization-permissions)
...
#### [User Permissions](https://vercel.com/docs/git/vercel-for-bitbucket\#user-permissions)
...
permission scopes, please [contact Vercel Support](https://vercel.com/help#issues).
...
## [Missing Git repository](https://vercel.com/docs/git/vercel-for-bitbucket\#missing-git-repository)
...
## [Silence comments](https://vercel.com/docs/git/vercel-for-bitbucket\#silence-comments)
...
## [Using Bitbucket Pipelines](https://vercel.com/docs/git/vercel-for-bitbucket\#using-bitbucket-pipelines)
...
[Learn more about how to configure Bitbucket Pipelines and Vercel](https://vercel.com/kb/guide/how-can-i-use-bitbucket-pipelines-with-vercel) for custom CI/CD workflows.
