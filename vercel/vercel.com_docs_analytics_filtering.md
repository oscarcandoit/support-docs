...
## [Using filters](https://vercel.com/docs/analytics/filtering\#using-filters)
...
- Routes (if your application is based on a [supported framework](https://vercel.com/docs/analytics/quickstart#add-the-analytics-component-to-your-app))
- Pages
- Hostname
- Referrers
...
- Devices
- Operating System
- If configured: [Custom Events](https://vercel.com/docs/analytics/custom-events) and [Feature Flags](https://vercel.com/docs/feature-flags)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fweb-analytics%2Ffilter-us-light.png&w=3840&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fweb-analytics%2Ffilter-us-dark.png&w=3840&q=75)

## [Examples of using filters](https://vercel.com/docs/analytics/filtering\#examples-of-using-filters)

By using the filtering feature in Web Analytics, you can gain a deeper understanding of your website traffic and make
data-driven decisions.

### [Find where visitors of a specific page came from](https://vercel.com/docs/analytics/filtering\#find-where-visitors-of-a-specific-page-came-from)
...
### [Understand content popularity in a specific country](https://vercel.com/docs/analytics/filtering\#understand-content-popularity-in-a-specific-country)
...
### [Discover route popularity from a specific referrer](https://vercel.com/docs/analytics/filtering\#discover-route-popularity-from-a-specific-referrer)
...
## [Drill-downs](https://vercel.com/docs/analytics/filtering\#drill-downs)
...
- The Custom Events panel lets you drill down into your custom event data to find out which events are occurring and how many times they are occurring. The options available will depend on the [custom data you have configured](https://vercel.com/docs/analytics/custom-events#tracking-an-event-with-custom-data).

## [Find Tweets from t.co referrer](https://vercel.com/docs/analytics/filtering\#find-tweets-from-t.co-referrer)
