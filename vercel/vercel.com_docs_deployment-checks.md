...
1. ### [Ensure prerequisites are enabled](https://vercel.com/docs/deployment-checks\#ensure-prerequisites-are-enabled)
...
2. ### [Select your Deployment Checks](https://vercel.com/docs/deployment-checks\#select-your-deployment-checks)
...
3. ### [Update workflows (if necessary)](https://vercel.com/docs/deployment-checks\#update-workflows-if-necessary)
...
4. ### [Create a new production deployment](https://vercel.com/docs/deployment-checks\#create-a-new-production-deployment)
...
5. ### [Run GitHub Actions to fulfill all Deployment Checks](https://vercel.com/docs/deployment-checks\#run-github-actions-to-fulfill-all-deployment-checks)



To meet Deployment Checks, run their corresponding GitHub Actions.

If you're using [`repository_dispatch`](https://docs.github.com/en/actions/writing-workflows/choosing-when-your-workflow-runs/events-that-trigger-workflows#repository_dispatch) to trigger a workflow in response to Vercel deployments, you must use the [`vercel.deployment.ready` event](https://vercel.com/docs/git/vercel-for-github#repository-dispatch-events). This event triggers after the deployment is created, and before checks are run.

6. ### [Promote to production once all Deployment Checks are met](https://vercel.com/docs/deployment-checks\#promote-to-production-once-all-deployment-checks-are-met)
...
You can bypass Deployment Checks by selecting [Force Promote](https://vercel.com/docs/deployments/promoting-a-deployment) from the deployment details page.
