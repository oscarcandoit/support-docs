---
url: "https://vercel.com/docs/pricing/sales-tax"
title: "Sales Tax"
---
...
### [Do you charge sales tax on your services?](https://vercel.com/docs/pricing/sales-tax\#do-you-charge-sales-tax-on-your-services)
...
### [Why are you starting to collect sales tax now?](https://vercel.com/docs/pricing/sales-tax\#why-are-you-starting-to-collect-sales-tax-now)
...
### [Will all customers be charged sales tax?](https://vercel.com/docs/pricing/sales-tax\#will-all-customers-be-charged-sales-tax)
...
### [How will sales tax appear on my invoice?](https://vercel.com/docs/pricing/sales-tax\#how-will-sales-tax-appear-on-my-invoice)
...
### [Do I need to take any action regarding sales tax?](https://vercel.com/docs/pricing/sales-tax\#do-i-need-to-take-any-action-regarding-sales-tax)
...
### [What if my organization is tax-exempt?](https://vercel.com/docs/pricing/sales-tax\#what-if-my-organization-is-tax-exempt)
...
### [Are international customers charged any additional fees or taxes?](https://vercel.com/docs/pricing/sales-tax\#are-international-customers-charged-any-additional-fees-or-taxes)
...
### [When will US customers start being charged for sales tax?](https://vercel.com/docs/pricing/sales-tax\#when-will-us-customers-start-being-charged-for-sales-tax)
...
### [Where can I find more information about Vercel’s terms of service about tax?](https://vercel.com/docs/pricing/sales-tax\#where-can-i-find-more-information-about-vercel%E2%80%99s-terms-of-service-about-tax)

You can refer to our [terms of service](https://vercel.com/legal/terms#payments) on collecting sales tax.

### [Who can I contact with tax-related questions?](https://vercel.com/docs/pricing/sales-tax\#who-can-i-contact-with-tax-related-questions)
...
- [Are international customers charged any additional fees or taxes?](https://vercel.com/docs/pricing/sales-tax#are-international-customers-charged-any-additional-fees-or-taxes)
- [When will US customers start being charged for sales tax?](https://vercel.com/docs/pricing/sales-tax#when-will-us-customers-start-being-charged-for-sales-tax)
- [Where can I find more informat...](https://vercel.com/docs/pricing/sales-tax#where-can-i-find-more-information-about-vercel%E2%80%99s-terms-of-service-about-tax)
- [Who can I contact with tax-related questions?](https://vercel.com/docs/pricing/sales-tax#who-can-i-contact-with-tax-related-questions)
