---
url: "https://vercel.com/docs/pricing/regional-pricing/fra1"
...
The table below shows Managed Infrastructure products with pricing specific to the Frankfurt, Germany (fra1) region. This pricing is available only to [Pro plan](https://vercel.com/docs/plans/pro) users. Your team will be charged based on the usage of your projects for each resource in this region.
...
| [Edge Requests](https://vercel.com/docs/pricing/regional-pricing) | Included 10,000,000, then $2.60 per 1,000,000 Requests |
| [ISR Reads](https://vercel.com/docs/data-cache) | $0.52 per 1,000,000 Read Units |
| [ISR Writes](https://vercel.com/docs/data-cache) | $5.20 per 1,000,000 Write Units |
| [Edge Request Additional CPU Duration](https://vercel.com/docs/pricing/regional-pricing) | $0.39 per 1 Hour |
| [Image Optimization Transformations](https://vercel.com/docs/image-optimization) | $0.0601 per 1K |
| [Image Optimization Cache Reads](https://vercel.com/docs/image-optimization) | $0.52 per 1M |
| [Image Optimization Cache Writes](https://vercel.com/docs/image-optimization) | $5.20 per 1M |
| [WAF Rate Limiting](https://vercel.com/docs/vercel-firewall/vercel-waf/rate-limiting) | $0.65 per 1,000,000 Allowed Requests |
| [OWASP CRS per request number](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets) | $1.04 per 1,000,000 Inspected Requests |
| [OWASP CRS per request size](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets) | $0.26 per 1 GB of inspected request payload |
| [Blob Storage Size](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $0.025 per GB |
| [Blob Simple Operations](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $0.430 per 1M |
| [Blob Advanced Operations](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $5.400 per 1M |
| [Blob Data Transfer](https://vercel.com/docs/vercel-blob/usage-and-pricing#pricing) | $0.050 per GB |
| [Private Data Transfer](https://vercel.com/docs/connectivity/static-ips) | $0.173 per 1 GB |
| [Workflow Storage](https://vercel.com/docs/workflow#pricing) | $0.65 per 1 GB per month |
| [Workflow Steps](https://vercel.com/docs/workflow#pricing) | $32.50 per 1,000,000 Steps |
