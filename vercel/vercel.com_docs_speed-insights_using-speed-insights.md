...
## [Accessing Speed Insights](https://vercel.com/docs/speed-insights/using-speed-insights\#accessing-speed-insights)

To access Speed Insights:

1. Select a project from your dashboard and navigate to the Speed Insights tab.
2. Select the [timeframe](https://vercel.com/docs/analytics/using-web-analytics#specifying-a-timeframe) and [environment](https://vercel.com/docs/analytics/using-web-analytics#viewing-environment-specific-data) you want to view data for.
3. Use the panels to [filter](https://vercel.com/docs/analytics/filtering) the page or event data you want to view.

## [Breaking down data in Speed Insights](https://vercel.com/docs/speed-insights/using-speed-insights\#breaking-down-data-in-speed-insights)
...
### [Breakdown by route or path](https://vercel.com/docs/speed-insights/using-speed-insights\#breakdown-by-route-or-path)

To view metrics for a specific route or path:

1. Select a project from your dashboard and navigate to the Speed Insights tab.
2. From the left-hand panel, select the [metric](https://vercel.com/docs/speed-insights/metrics) you want to view data for.
...
![Speed Insights URL view for routes and paths of your project.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fkanban-light.png&w=3840&q=75)![Speed Insights URL view for routes and paths of your project.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fkanban-dark.png&w=3840&q=75)Speed Insights URL view for routes and paths of your project.

### [Breakdown by HTML elements](https://vercel.com/docs/speed-insights/using-speed-insights\#breakdown-by-html-elements)

To view a detailed breakdown of the performance of individual HTML elements on your site:

1. Select a project from your dashboard and navigate to the Speed Insights tab.
2. From the left-hand panel, select the [metric](https://vercel.com/docs/speed-insights/metrics) you want to view data for. HTML element attribution is only available for the following metrics:
...
### [Breakdown by country](https://vercel.com/docs/speed-insights/using-speed-insights\#breakdown-by-country)
...
![Geographic map of the P75 score where the color intensity indicates the relative amount of data points per country](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fcountry-map-light.png&w=3840&q=75)![Geographic map of the P75 score where the color intensity indicates the relative amount of data points per country](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fcountry-map-dark.png&w=3840&q=75)Geographic map of the P75 score where the color intensity indicates the relative amount of data points per country

## [Disabling Speed Insights](https://vercel.com/docs/speed-insights/using-speed-insights\#disabling-speed-insights)

You may want to disable Speed Insights in your project if you find you no longer need it. You can disable Speed Insights from within the project settings in the Vercel dashboard. If you are unsure if a project has Speed Insights enabled, see [Identifying if Speed Insights is enabled](https://vercel.com/docs/speed-insights/using-speed-insights#identifying-if-speed-insights-is-enabled).
...
documented in the [pricing docs](https://vercel.com/docs/speed-insights/limits-and-pricing).
This means that Speed Insights will be added to your Pro plan invoice
automatically.

1. Select a project from your [dashboard](https://vercel.com/dashboard).
...
## [Identifying if Speed Insights is enabled](https://vercel.com/docs/speed-insights/using-speed-insights\#identifying-if-speed-insights-is-enabled)
...
![Speed Insights not enabled for a project.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fready-to-enable-light.png&w=828&q=75)![Speed Insights not enabled for a project.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fready-to-enable-dark.png&w=828&q=75)Speed Insights not enabled for a project.

If Speed Insights is enabled but no data points have been collected yet then it will show an empty circle, like the below:

![Speed Insights enabled for a project but no data points have been collected.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fenabled-no-data-light.png&w=828&q=75)![Speed Insights enabled for a project but no data points have been collected.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fenabled-no-data-dark.png&w=828&q=75)Speed Insights enabled for a project but no data points have been collected.
...
![Speed Insights enabled for a project and has data points.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fenabled-light.png&w=828&q=75)![Speed Insights enabled for a project and has data points.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fspeed-insights%2Fv2%2Fenabled-dark.png&w=828&q=75)Speed Insights enabled for a project and has data points.
