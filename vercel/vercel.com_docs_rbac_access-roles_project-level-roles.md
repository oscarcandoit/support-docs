---
url: "https://vercel.com/docs/rbac/access-roles/project-level-roles"
...
## [Equivalency roles](https://vercel.com/docs/rbac/access-roles/project-level-roles\#equivalency-roles)
...
- The [Developer](https://vercel.com/docs/rbac/access-roles#developer-role) team role is equivalent to the [Project Developer](https://vercel.com/docs/rbac/access-roles#project-developer) role
- The [Viewer Pro](https://vercel.com/docs/rbac/access-roles#viewer-pro-role), [Viewer Enterprise](https://vercel.com/docs/rbac/access-roles#viewer-enterprise-role), and [Billing](https://vercel.com/docs/rbac/access-roles#billing-role) team roles are equivalent to the [Project Viewer](https://vercel.com/docs/rbac/access-roles#project-viewer) role
- The [Owner](https://vercel.com/docs/rbac/access-roles#owner-role) and [Member](https://vercel.com/docs/rbac/access-roles#member-role) team roles are equivalent to the [Project Admin](https://vercel.com/docs/rbac/access-roles#project-administrators) role

All project level roles can be assigned to those with the [Contributor](https://vercel.com/docs/rbac/access-roles#team-level-roles) team role.

See our [Access roles docs](https://vercel.com/docs/rbac/access-roles) for a more comprehensive breakdown of the different roles.

## [Project level permissions](https://vercel.com/docs/rbac/access-roles/project-level-roles\#project-level-permissions)
...
| Resource | Admin | Project Developer | Project Viewer |
| --- | --- | --- | --- |
| Alias |  |  |  |
| Alias Protection Bypass |  |  |  |
| Build Machine |  |  |  |
| Check |  |  |  |
| Check Run |  |  |  |
...
| Deployment Check |  |  |  |
| Deployment Check Preview |  |  |  |
| Deployment Check Re-Run From Production Branch |  |  |  |
| Deployment Hook |  |  |  |
| Deployment Preview |  |  |  |
| Deployment Private |  |  |  |
| Deployment Production Git |  |  |  |
| Deployment Promote |  |  |  |
| Deployment Rollback |  |  |  |
| Edge Cache Namespace |  |  |  |
| Environments |  |  |  |
| Logs |  |  |  |
| Logs Preset |  |  |  |
| Observability Data |  |  |  |
...
| Production Alias Protection Bypass |  |  |  |
| Production Project Environment Variable |  |  |  |
| Project |  |  |  |
| Project Analytics Sampling |  |  |  |
| Project Analytics Usage |  |  |  |
| Project Deployment Expiration |  |  |  |
| Project Domain |  |  |  |
| Project Domain Move |  |  |  |
...
| Project Usage |  |  |  |
| Protection Bypass |  |  |  |
| Shared Environment Variable Connection |  |  |  |
| Skew Protection |  |  |  |
| Speed Insight |  |  |  |
| Trusted IPs |  |  |  |
| Web Analytics |  |  |  |
