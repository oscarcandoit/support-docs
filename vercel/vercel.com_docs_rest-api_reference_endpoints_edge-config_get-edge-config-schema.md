---
url: "https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-schema"
title: "Get Edge Config schema - Vercel API Docs"
---

[Skip to main content](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-schema#content-area)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-schema#authorization-authorization)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-schema#parameter-edge-config-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-schema#parameter-team-id)
...
[​](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/get-edge-config-schema#parameter-slug)
...
[Update Edge Config items in batch](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-items-in-batch) [Update Edge Config schema](https://vercel.com/docs/rest-api/reference/endpoints/edge-config/update-edge-config-schema)
