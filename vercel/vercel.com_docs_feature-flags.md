...
## [Choose how you work with flags](https://vercel.com/docs/feature-flags\#choose-how-you-work-with-flags)
...
- [Implement flags as code](https://vercel.com/docs/feature-flags#implementing-feature-flags-in-your-codebase), using the [Flags SDK](https://vercel.com/docs/feature-flags/feature-flags-pattern) in Next.js or SvelteKit, or use an SDK from your existing feature flag provider.
- [Manage feature flags](https://vercel.com/docs/feature-flags#managing-feature-flags-from-the-toolbar) through the Vercel Toolbar to view, override, and share your application's feature flags.
- [Observe your flags](https://vercel.com/docs/feature-flags#observing-your-flags) using Vercel's observability features.
- [Optimize your feature flags](https://vercel.com/docs/feature-flags#optimizing-your-feature-flags) by using an [Edge Config integration](https://vercel.com/docs/edge-config/integrations).

### [Implementing Feature Flags in your codebase](https://vercel.com/docs/feature-flags\#implementing-feature-flags-in-your-codebase)
...
- [Flags SDK](https://vercel.com/docs/feature-flags/feature-flags-pattern): A free open-source library that gives you the tools you need to use feature flags in Next.js and SvelteKit applications

### [Managing Feature Flags from the Toolbar](https://vercel.com/docs/feature-flags\#managing-feature-flags-from-the-toolbar)

Flags Exploreris availableon [all plans](https://vercel.com/docs/plans)

Using the [Vercel Toolbar](https://vercel.com/docs/vercel-toolbar), you're able to view, override, and share feature flags for your application without leaving your browser tab.

You can manage feature flags from the toolbar in any development environment that your team has [enabled the toolbar for](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost). This includes local development, preview deployments, and production deployments.

- [Using Feature Flags in the Vercel Toolbar](https://vercel.com/docs/feature-flags/flags-explorer): Learn how to view and override your application's feature flags from the Vercel Toolbar.
- [Implementing Feature Flags in the Vercel Toolbar](https://vercel.com/docs/feature-flags/flags-explorer/getting-started): Learn how to set up the Vercel Toolbar so you can see and override your application's feature flags.

### [Observing your flags](https://vercel.com/docs/feature-flags\#observing-your-flags)

Web Analyticsare availableon [all plans](https://vercel.com/docs/plans)
...
- [Integrate Feature Flags with Runtime Logs](https://vercel.com/docs/feature-flags/integrate-with-runtime-logs): Learn how to send feature flag data to Vercel logs.
- [Integrate Feature Flags with Web Analytics](https://vercel.com/docs/feature-flags/integrate-with-web-analytics): Learn how to tag your page views and custom events with feature flags.

### [Optimizing your feature flags](https://vercel.com/docs/feature-flags\#optimizing-your-feature-flags)

Edge Configis availableon [all plans](https://vercel.com/docs/plans)
...
- [Vercel Edge Config](https://vercel.com/docs/edge-config): Experiment with A/B testing by storing feature flags in your Edge Config.
- [Vercel Edge Config Quickstart](https://vercel.com/docs/edge-config/get-started): Get started with reading data from Edge Config.
