...
you can also integrate with the [OpenAI SDK](https://vercel.com/docs/ai-gateway/openai-compat)
or other [community frameworks](https://vercel.com/docs/ai-gateway/framework-integrations).

1. ### [Set up your application](https://vercel.com/docs/ai-gateway/getting-started\#set-up-your-application)
...
2. ### [Install dependencies](https://vercel.com/docs/ai-gateway/getting-started\#install-dependencies)
...
3. ### [Set up your API key](https://vercel.com/docs/ai-gateway/getting-started\#set-up-your-api-key)
...
tokens](https://vercel.com/docs/ai-gateway/authentication#oidc-token-authentication) to
authenticate your requests.

The AI Gateway provider will default to using the `AI_GATEWAY_API_KEY` environment variable.

4. ### [Create and run your script](https://vercel.com/docs/ai-gateway/getting-started\#create-and-run-your-script)
...
5. ### [Next steps](https://vercel.com/docs/ai-gateway/getting-started\#next-steps)



Continue with the [AI SDK documentation](https://ai-sdk.dev/getting-started) to learn advanced configuration, set up [provider and model routing with fallbacks](https://vercel.com/docs/ai-gateway/provider-options), and explore more integration examples.


## [Using OpenAI SDK](https://vercel.com/docs/ai-gateway/getting-started\#using-openai-sdk)
...
Learn more about using the OpenAI SDK with the AI Gateway in the [OpenAI-Compatible API page](https://vercel.com/docs/ai-gateway/openai-compat).

## [Using other community frameworks](https://vercel.com/docs/ai-gateway/getting-started\#using-other-community-frameworks)

The AI Gateway is designed to work with any framework that supports the OpenAI API or AI SDK 5.

Read more about using the AI Gateway with other community frameworks in the [framework integrations](https://vercel.com/docs/ai-gateway/framework-integrations) section.
...
- [Set up your application](https://vercel.com/docs/ai-gateway/getting-started#set-up-your-application)
- [Install dependencies](https://vercel.com/docs/ai-gateway/getting-started#install-dependencies)
- [Set up your API key](https://vercel.com/docs/ai-gateway/getting-started#set-up-your-api-key)
- [Create and run your script](https://vercel.com/docs/ai-gateway/getting-started#create-and-run-your-script)
- [Next steps](https://vercel.com/docs/ai-gateway/getting-started#next-steps)
- [Using OpenAI SDK](https://vercel.com/docs/ai-gateway/getting-started#using-openai-sdk)
- [Using other community frameworks](https://vercel.com/docs/ai-gateway/getting-started#using-other-community-frameworks)
