...
The Hobby plan is designed for personal projects and developers. It includes CLI and personal [Git integrations](https://vercel.com/docs/git), built-in CI/CD, [automatic HTTPS/SSL](https://vercel.com/docs/security/encryption), and [previews deployments](https://vercel.com/docs/deployments/environments#preview-environment-pre-production) for every Git push.

It also provides base resources for [Vercel Functions](https://vercel.com/docs/functions), [Middleware](https://vercel.com/docs/routing-middleware), and [Image Optimization](https://vercel.com/docs/image-optimization), along with 100 GB of Fast Data Transfer and 1 hour of [runtime logs](https://vercel.com/docs/runtime-logs).

See the [Hobby plan](https://vercel.com/docs/plans/hobby) page for more details.

## [Pro](https://vercel.com/docs/plans\#pro)

The Pro plan is designed for professional developers, freelancers, and businesses who need enhanced features and team collaboration. It includes all features of the [Hobby plan](https://vercel.com/docs/plans/hobby) with significant improvements in resource management and team capabilities.
...
See the [Pro plan](https://vercel.com/docs/plans/pro-plan) page for more details.

## [Pro (Legacy)](https://vercel.com/docs/plans\#pro-legacy)
...
See the [legacy Pro plan](https://vercel.com/docs/plans/pro) page for more details or learn about [switching to the new Pro plan](https://vercel.com/docs/plans/pro-plan/switching).
...
Enterprise customers benefit from [Single Sign-On (SSO)](https://vercel.com/docs/saml), enhanced [observability and logging](https://vercel.com/docs/observability), isolated build infrastructure, dedicated customer success managers, and SLAs.

See the [Enterprise plan](https://vercel.com/docs/plans/enterprise) page for more details.

## [General billing information](https://vercel.com/docs/plans\#general-billing-information)

### [Where do I understand my usage?](https://vercel.com/docs/plans\#where-do-i-understand-my-usage)
...
### [What happens when I reach 100% usage?](https://vercel.com/docs/plans\#what-happens-when-i-reach-100%-usage)

All plans [receive notifications](https://vercel.com/docs/notifications#on-demand-usage-notifications) by email and on the dashboard when they are approaching and exceed their usage limits.

- Hobby plans will be paused when they exceed the included free tier usage
- Pro and legacy Pro plans users can configure [Spend Management](https://vercel.com/docs/spend-management) to automatically pause deployments, trigger a webhook, or send SMS notifications when they reach 100% usage
