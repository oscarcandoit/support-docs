...
## [Types of flows enabled by Checks API](https://vercel.com/docs/checks\#types-of-flows-enabled-by-checks-api)
...
## [Checks lifecycle](https://vercel.com/docs/checks\#checks-lifecycle)

![The depiction of how the Checks lifecycle works.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fchecks%2Fchecks-overview-light.png&w=3840&q=75)![The depiction of how the Checks lifecycle works.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fchecks%2Fchecks-overview-dark.png&w=3840&q=75)The depiction of how the Checks lifecycle works.

The diagram shows the complete lifecycle of how a check works:

1. When a [deployment](https://vercel.com/docs/deployments) is created, Vercel triggers the `deployment.created` webhook. This tells integrators that checks can now be registered
...
## [Checks integrations](https://vercel.com/docs/checks\#checks-integrations)

You can create a [native](https://vercel.com/docs/integrations#native-integrations) or [connectable account](https://vercel.com/docs/integrations#connectable-accounts) integration that works with the checks API to facilitate testing of deployments for Vercel users.

### [Install integrations](https://vercel.com/docs/checks\#install-integrations)

Vercel users can find and install your integration from the [Marketplace](https://vercel.com/marketplace) under [testing](https://vercel.com/marketplace/category/testing), [monitoring](https://vercel.com/marketplace/category/monitoring) or [observability](https://vercel.com/marketplace/category/observability).

### [Build your Checks integration](https://vercel.com/docs/checks\#build-your-checks-integration)

Once you have [created your integration](https://vercel.com/docs/integrations/create-integration/marketplace-product), [publish](https://vercel.com/docs/integrations/create-integration/submit-integration) it to the marketplace by following these guidelines:
