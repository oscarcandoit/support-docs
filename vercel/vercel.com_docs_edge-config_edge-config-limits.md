---
url: "https://vercel.com/docs/edge-config/edge-config-limits"
...
An [Edge Config](https://vercel.com/edge-config) is a global data store that [enables experimentation with feature flags, A/B testing, critical redirects, and IP blocking](https://vercel.com/edge-config#use-cases). It enables you to read data at the edge without querying an external database or hitting upstream servers.

Keep the number of stores to a minimum. Fewer large stores improve your overall latency.

## [Pricing](https://vercel.com/docs/edge-config/edge-config-limits\#pricing)
...
| Resource | Hobby Included | On-demand Rates |
| --- | --- | --- |
| [Edge Config Reads](https://vercel.com/docs/edge-config/using-edge-config) | First 100,000 | $3.00/1,000,000 Reads |
| [Edge Config Writes](https://vercel.com/docs/edge-config/using-edge-config) | First 100 | $5.00/500 Writes |

Managed Infrastructure hobby and pro resources

## [Limits by plan](https://vercel.com/docs/edge-config/edge-config-limits\#limits-by-plan)

The following table outlines the limits for each resource according to the plan you are on:

|  | Hobby | Pro | Enterprise |
| --- | --- | --- | --- |
| [Maximum store size](https://vercel.com/docs/edge-config/edge-config-limits#maximum-store-size) | 8 KB | 64 KB | 512 KB<br>Can request higher limit by [contacting customer success](https://vercel.com/help) |
| [Maximum number of stores (total)](https://vercel.com/docs/edge-config/edge-config-limits#maximum-number-of-stores) | 1 | 3 | 10<br>Can request higher limit by [contacting customer success](https://vercel.com/help) |
| [Maximum number of stores connected to a project](https://vercel.com/docs/edge-config/edge-config-limits#maximum-number-of-stores-connected-to-a-project) | 1 | 3 | 3 |
| [Maximum item key name length](https://vercel.com/docs/edge-config/edge-config-limits#maximum-item-key-name-length) | 256 characters | 256 characters | 256 characters |
| [Write propagation](https://vercel.com/docs/edge-config/edge-config-limits#write-propagation) | Up to 10 seconds globally | Up to 10 seconds globally | Up to 10 seconds globally |
| [Backup retention](https://vercel.com/docs/edge-config/edge-config-limits#backup-retention) | 7 days | 90 days | 365 days |

## [Usage](https://vercel.com/docs/edge-config/edge-config-limits\#usage)
...
### [Reads](https://vercel.com/docs/edge-config/edge-config-limits\#reads)
...
### [Writes](https://vercel.com/docs/edge-config/edge-config-limits\#writes)

Writes represent how often you updated your Edge Config through the SDK or the REST API.

### [Maximum store size](https://vercel.com/docs/edge-config/edge-config-limits\#maximum-store-size)
...
### [Maximum number of stores](https://vercel.com/docs/edge-config/edge-config-limits\#maximum-number-of-stores)
...
### [Maximum number of stores connected to a project](https://vercel.com/docs/edge-config/edge-config-limits\#maximum-number-of-stores-connected-to-a-project)

The maximum number of stores connected to a project represents the total number of Edge Config stores that you can connect to a single project. Exceeding this amount will result in an [error](https://vercel.com/docs/edge-config/edge-config-limits#edge-config-limit-reached).

### [Maximum item key name length](https://vercel.com/docs/edge-config/edge-config-limits\#maximum-item-key-name-length)
...
### [Write propagation](https://vercel.com/docs/edge-config/edge-config-limits\#write-propagation)
...
### [Backup retention](https://vercel.com/docs/edge-config/edge-config-limits\#backup-retention)

Backups are automatically saved when you make any changes, allowing you to [restore](https://vercel.com/docs/edge-config/edge-config-dashboard#restoring-edge-config-backups) to a previous version. See the table above to learn about how long backups are saved for.
...
## [Reviewing Edge Config reads](https://vercel.com/docs/edge-config/edge-config-limits\#reviewing-edge-config-reads)
...
### [Optimizing Edge Config reads](https://vercel.com/docs/edge-config/edge-config-limits\#optimizing-edge-config-reads)

- Select the Project tab to identify which project has the most Edge Config reads
- Review how you access the stores through both the [REST API](https://vercel.com/docs/edge-config/vercel-api) and the [SDK](https://vercel.com/docs/edge-config/edge-config-sdk). They both count toward your reads
- Where possible, use [`getAll()`](https://vercel.com/docs/edge-config/edge-config-sdk#read-multiple-values) instead of separate [`get(key)`](https://vercel.com/docs/edge-config/edge-config-sdk#read-a-single-value) calls with the SDK, ensuring they count as a single read.

## [Managing Edge Config writes](https://vercel.com/docs/edge-config/edge-config-limits\#managing-edge-config-writes)
...
### [Optimizing Edge Config writes](https://vercel.com/docs/edge-config/edge-config-limits\#optimizing-edge-config-writes)

- Select the Edge Configs tab to identify which Edge Config has the most Edge Config writes
- Review your points of updating the stores through the [REST API](https://vercel.com/docs/edge-config/vercel-api) as they count towards your writes

## [Troubleshooting](https://vercel.com/docs/edge-config/edge-config-limits\#troubleshooting)

If reading from your Edge Config seems slower than expected, ensure that the following are true:

- You've set [the connection string](https://vercel.com/docs/edge-config/using-edge-config#using-a-connection-string) as an environment variable
- You are using the [SDK](https://vercel.com/docs/edge-config/edge-config-sdk) to read from your Edge Config
...
when you deploy to Vercel![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fstorage%2Fedge-config%2Fedge-config-env-icon-light.png&w=1920&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fstorage%2Fedge-config%2Fedge-config-env-icon-dark.png&w=1920&q=75)
...
### [Edge Config Limit reached](https://vercel.com/docs/edge-config/edge-config-limits\#edge-config-limit-reached)
...
To learn how to prevent this error, see [best practices](https://vercel.com/docs/edge-config/edge-config-limits#edge-config-best-practices).

### [Edge Config update rejected](https://vercel.com/docs/edge-config/edge-config-limits\#edge-config-update-rejected)

Updates to items in your Edge Config will be rejected if the resulting size of your Edge Config would exceed your account plan's limits. When this happens, all members of your team will receive a [notification](https://vercel.com/docs/notifications) from Vercel, whether the error originated in the dashboard, an API request, or an [Integration](https://vercel.com/docs/edge-config/integrations). The Edge Config editor in your dashboard can detect many cases where the final size would exceed the limit and warn you upfront without triggering the notification.
...
## [Edge Config best practices](https://vercel.com/docs/edge-config/edge-config-limits\#edge-config-best-practices)
...
## [Security](https://vercel.com/docs/edge-config/edge-config-limits\#security)
