...
Interaction Timing Toolis availableon [all plans](https://vercel.com/docs/plans)

As you navigate your site, the interaction timing tool allows you to inspect in detail each interaction's latency and get notified with toasts for interactions taking > 200ms. This can help you ensure your site's [Interaction to Next Paint (INP)](https://vercel.com/blog/first-input-delay-vs-interaction-to-next-paint) (a Core Web Vitals) has a good score.

## [Accessing the Interaction Timing Tool](https://vercel.com/docs/vercel-toolbar/interaction-timing-tool\#accessing-the-interaction-timing-tool)
...
## [Interaction Timing Tool Preferences](https://vercel.com/docs/vercel-toolbar/interaction-timing-tool\#interaction-timing-tool-preferences)
...
## [More resources](https://vercel.com/docs/vercel-toolbar/interaction-timing-tool\#more-resources)
