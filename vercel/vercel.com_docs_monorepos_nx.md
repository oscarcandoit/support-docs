...
1. ### [Ensure your Nx project is configured correctly](https://vercel.com/docs/monorepos/nx\#ensure-your-nx-project-is-configured-correctly)
...
2. ### [Import your project](https://vercel.com/docs/monorepos/nx\#import-your-project)
...
3. ### [Next steps](https://vercel.com/docs/monorepos/nx\#next-steps)
...
1. ### [Install the `@vercel/remote-nx` plugin](https://vercel.com/docs/monorepos/nx\#install-the-@vercel/remote-nx-plugin)
...
2. ### [Configure the `@vercel/remote-nx` runner](https://vercel.com/docs/monorepos/nx\#configure-the-@vercel/remote-nx-runner)
...
3. ### [Clear cache and run](https://vercel.com/docs/monorepos/nx\#clear-cache-and-run)
