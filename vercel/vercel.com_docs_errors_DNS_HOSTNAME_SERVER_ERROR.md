...
## [Troubleshoot](https://vercel.com/docs/errors/DNS_HOSTNAME_SERVER_ERROR\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/DNS\_HOSTNAME\_SERVER\_ERROR to understand what's happening.
...
4. Verify domain registration: Ensure that the domain has been [registered](https://vercel.com/docs/domains/working-with-domains/view-and-search-domains) and is currently active
