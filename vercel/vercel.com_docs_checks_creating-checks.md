...
If a check is "rerequestable", your integration users get an option to [rerequest and rerun the failing checks](https://vercel.com/docs/checks/creating-checks#rerunning-checks).

### [Types of Checks](https://vercel.com/docs/checks/creating-checks\#types-of-checks)
...
### [Associations](https://vercel.com/docs/checks/creating-checks\#associations)

Checks are always associated with a specific deployment that is tested and validated.

### [Body attributes](https://vercel.com/docs/checks/creating-checks\#body-attributes)
...
| `rerequestable` | Boolean (optional) | Tells Vercel if the check can rerun. Users can trigger a `deployment.check-rerequested` [webhook](https://vercel.com/docs/webhooks/webhooks-api#deployment.check-rerequested), through a button on the deployment page |
| `conclusion` | String (optional) | The result of a running check. For [blocking checks](https://vercel.com/docs/checks/creating-checks#types-of-checks) the values can be `canceled`, `failed`, `neutral`, `succeeded`, `skipped`. `canceled` and `failed` |
...
### [Response](https://vercel.com/docs/checks/creating-checks\#response)
...
### [Response codes](https://vercel.com/docs/checks/creating-checks\#response-codes)
...
## [Rich results](https://vercel.com/docs/checks/creating-checks\#rich-results)

### [Output](https://vercel.com/docs/checks/creating-checks\#output)

The `output` property can store any data like [Web Vitals](https://vercel.com/docs/speed-insights) and [Virtual Experience Score](https://vercel.com/docs/speed-insights/metrics#predictive-performance-metrics-with-virtual-experience-score). It is defined under a `metrics` field:

| Key | [Type](https://vercel.com/docs/checks/creating-checks#api-basics/types) | Description |
| --- | --- | --- |
| `TBT` | [Map](https://vercel.com/docs/checks/creating-checks#api-basics/types) | The [Total Blocking Time](https://vercel.com/docs/speed-insights/metrics#total-blocking-time-tbt), measured by the check |
| `LCP` | [Map](https://vercel.com/docs/checks/creating-checks#api-basics/types) | The [Largest Contentful Paint](https://vercel.com/docs/speed-insights/metrics#largest-contentful-paint-lcp), measured by the check |
| `FCP` | [Map](https://vercel.com/docs/checks/creating-checks#api-basics/types) | The [First Contentful Paint](https://vercel.com/docs/speed-insights/metrics#first-contentful-paint-fcp), measured by the check |
| `CLS` | [Map](https://vercel.com/docs/checks/creating-checks#api-basics/types) | The [Cumulative Layout Shift](https://vercel.com/docs/speed-insights/metrics#cumulative-layout-shift-cls), measured by the check |
| `virtualExperienceScore` | [Map](https://vercel.com/docs/checks/creating-checks#api-basics/types) | The overall [Virtual Experience Score](https://vercel.com/docs/speed-insights/metrics#predictive-performance-metrics-with-virtual-experience-score) measured by the check |

Each of these keys has the following properties:

| Key | [Type](https://vercel.com/docs/checks/creating-checks#api-basics/types) | Description |
| --- | --- | --- |
| `value` | [Float](https://vercel.com/docs/checks/creating-checks#api-basics/types) | The value measured for a particular metric, in milliseconds. For `virtualExperienceScore` this value is the percentage between 0 and 1 |
| `previousValue` | [Float](https://vercel.com/docs/checks/creating-checks#api-basics/types) | A previous value for comparison purposes |
| `source` | [Enum](https://vercel.com/docs/checks/creating-checks#api-basics/types) | `web-vitals` |

### [Metrics](https://vercel.com/docs/checks/creating-checks\#metrics)
...
### [Rerunning checks](https://vercel.com/docs/checks/creating-checks\#rerunning-checks)
...
### [Skipping Checks](https://vercel.com/docs/checks/creating-checks\#skipping-checks)
...
### [Availability of URLs](https://vercel.com/docs/checks/creating-checks\#availability-of-urls)

For "Running Checks", only the [Automatic Deployment URL](https://vercel.com/docs/deployments/generated-urls) is available. [Automatic Branch URL](https://vercel.com/docs/deployments/generated-urls#generated-from-git) and [Custom Domains](https://vercel.com/docs/domains/add-a-domain) will apply once the checks finish.

### [Order of execution](https://vercel.com/docs/checks/creating-checks\#order-of-execution)
...
### [Status and conclusion](https://vercel.com/docs/checks/creating-checks\#status-and-conclusion)
