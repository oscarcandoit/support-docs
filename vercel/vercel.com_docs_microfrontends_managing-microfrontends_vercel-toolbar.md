...
Using the [Vercel Toolbar](https://vercel.com/docs/vercel-toolbar), you can visualize and independently test your microfrontends so you can develop microfrontends in isolation. The Microfrontends panel of the toolbar shows all microfrontends that you have [configured in `microfrontends.json`](https://vercel.com/docs/microfrontends/quickstart#define-microfrontends.json).

You can access it in all microfrontends that you have [enabled the toolbar for](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost).

This requires version `0.1.33` or newer of the `@vercel/toolbar` package.

## [View all microfrontends](https://vercel.com/docs/microfrontends/managing-microfrontends/vercel-toolbar\#view-all-microfrontends)
...
![Panel in the Toolbar showing all microfrontends.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fmicrofrontends%2Ftoolbar%2Fmicrofrontends-panel-2-light.png&w=750&q=75)![Panel in the Toolbar showing all microfrontends.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fmicrofrontends%2Ftoolbar%2Fmicrofrontends-panel-2-dark.png&w=750&q=75)Panel in the Toolbar showing all microfrontends.

## [Microfrontends zone indicator](https://vercel.com/docs/microfrontends/managing-microfrontends/vercel-toolbar\#microfrontends-zone-indicator)
...
![Indicator for which microfrontend served the current page.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fmicrofrontends%2Ftoolbar%2Fzone-indicator-3-light.png&w=640&q=75)![Indicator for which microfrontend served the current page.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fmicrofrontends%2Ftoolbar%2Fzone-indicator-3-dark.png&w=640&q=75)Indicator for which microfrontend served the current page.

You find the Zone Indicator toggle at the bottom of the Microfrontends panel in the Vercel toolbar.

## [Routing overrides](https://vercel.com/docs/microfrontends/managing-microfrontends/vercel-toolbar\#routing-overrides)
