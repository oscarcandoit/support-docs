...
This command is available in Vercel CLI v48.10.0 and later. If you're using an older version, see [Updating Vercel CLI](https://vercel.com/docs/cli#updating-vercel-cli).

This command requires your directory to be [linked to a Vercel project](https://vercel.com/docs/cli/project-linking). If you haven't linked your project yet, run [`vercel link`](https://vercel.com/docs/cli/link) first.

## [Usage](https://vercel.com/docs/cli/open\#usage)
...
## [How it works](https://vercel.com/docs/cli/open\#how-it-works)
...
## [Examples](https://vercel.com/docs/cli/open\#examples)

### [Open the current project](https://vercel.com/docs/cli/open\#open-the-current-project)
...
## [Troubleshooting](https://vercel.com/docs/cli/open\#troubleshooting)

### [Project not linked](https://vercel.com/docs/cli/open\#project-not-linked)
...
## [Global Options](https://vercel.com/docs/cli/open\#global-options)

The following [global options](https://vercel.com/docs/cli/global-options) can be passed when using the `vercel open` command:
...
## [Related](https://vercel.com/docs/cli/open\#related)
