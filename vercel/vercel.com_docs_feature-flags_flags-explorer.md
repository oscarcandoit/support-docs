...
## [View and override flags in the toolbar](https://vercel.com/docs/feature-flags/flags-explorer\#view-and-override-flags-in-the-toolbar)

Before you can use with the Flags Explorer, ensure that your team has set up both [feature flags](https://vercel.com/docs/feature-flags/flags-explorer/getting-started) and the [Vercel Toolbar](https://vercel.com/docs/vercel-toolbar/in-production-and-localhost) in the environment you are using,
...
4. Select an override value for the desired feature flag. Note that by default, overrides are not persisted and only affect the user applying them, in the environment in which they were set. To share overrides, see [Sharing flag overrides](https://vercel.com/docs/feature-flags/flags-explorer#sharing-flag-overrides).
5. Apply the changes. This will trigger a soft reload. If you have applied changes, the Vercel Toolbar will turn blue.

## [Sharing flag overrides](https://vercel.com/docs/feature-flags/flags-explorer\#sharing-flag-overrides)
...
- [Setting overrides as recommended for a given branch](https://vercel.com/docs/feature-flags/flags-explorer#branch-based-recommendations)
- Explicitly [sharing a set of overrides through a URL](https://vercel.com/docs/feature-flags/flags-explorer#url-based-recommendations) with a team member

### [Branch based recommendations](https://vercel.com/docs/feature-flags/flags-explorer\#branch-based-recommendations)
...
### [URL based recommendations](https://vercel.com/docs/feature-flags/flags-explorer\#url-based-recommendations)
...
## [More resources](https://vercel.com/docs/feature-flags/flags-explorer\#more-resources)
