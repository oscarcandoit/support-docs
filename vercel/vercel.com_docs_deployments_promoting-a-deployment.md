...
- [Promote preview to production](https://vercel.com/docs/deployments/promoting-a-deployment#promote-a-deployment-from-preview-to-production): You can use this as a way to promote a preview deployment to production through a complete rebuild
- [Promote a staged production build](https://vercel.com/docs/deployments/promoting-a-deployment#staging-and-promoting-a-production-deployment): You can use this option to promote a production deployment which has never served production traffic. To use this option, you must turn off the auto-assignment of domains. This option won't trigger a rebuild

## [Instant Rollback](https://vercel.com/docs/deployments/promoting-a-deployment\#instant-rollback)
...
## [Promote a deployment from preview to production](https://vercel.com/docs/deployments/promoting-a-deployment\#promote-a-deployment-from-preview-to-production)
...
If you have different [Environment\\
Variables](https://vercel.com/docs/environment-variables#environments) set for preview and
...
## [Staging and promoting a production deployment](https://vercel.com/docs/deployments/promoting-a-deployment\#staging-and-promoting-a-production-deployment)
...
### [CLI](https://vercel.com/docs/deployments/promoting-a-deployment\#cli)
...
### [Dashboard](https://vercel.com/docs/deployments/promoting-a-deployment\#dashboard)
...
Vercel will instantly promote the deployment; it doesn't require a rebuild. Once promoted, the deployment is marked as [Current](https://vercel.com/docs/deployments/promoting-a-deployment#production-deployment-state).

## [Production deployment state](https://vercel.com/docs/deployments/promoting-a-deployment\#production-deployment-state)
