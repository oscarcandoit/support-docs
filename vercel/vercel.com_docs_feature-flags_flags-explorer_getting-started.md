...
## [Prerequisites](https://vercel.com/docs/feature-flags/flags-explorer/getting-started\#prerequisites)
...
## [Quickstart](https://vercel.com/docs/feature-flags/flags-explorer/getting-started\#quickstart)

1. ### [Add the Flags SDK to your project](https://vercel.com/docs/feature-flags/flags-explorer/getting-started\#add-the-flags-sdk-to-your-project)
...
2. ### [Adding a `FLAGS_SECRET`](https://vercel.com/docs/feature-flags/flags-explorer/getting-started\#adding-a-flags_secret)
...
If you prefer to create the secret manually, see the instructions in the [Flags Explorer Reference](https://vercel.com/docs/feature-flags/flags-explorer/reference#flags_secret-environment-variable).

3. ### [Creating the Flags Discovery Endpoint](https://vercel.com/docs/feature-flags/flags-explorer/getting-started\#creating-the-flags-discovery-endpoint)
...
Learn how to manually return feature flag definitions in the [Flags Explorer Reference](https://vercel.com/docs/feature-flags/flags-explorer/reference#verifying-a-request-to-the-api-endpoint).

4. ### [Handling overrides](https://vercel.com/docs/feature-flags/flags-explorer/getting-started\#handling-overrides)
...
Learn how to read the overrides cookie in the [Flags Explorer Reference](https://vercel.com/docs/feature-flags/flags-explorer/reference#override-cookie).

5. ### [Emitting flag values (optional)](https://vercel.com/docs/feature-flags/flags-explorer/getting-started\#emitting-flag-values-optional)



You can optionally make the Flags Explorer aware of the actual value each feature flag resolved to while rendering the current page by rendering a `<FlagValues />` component. This is useful for debugging. Learn how to emit flag values in the [Flags Explorer Reference](https://vercel.com/docs/feature-flags/flags-explorer/reference#values).
...
If you emit flag values to the client it's further possible to annotate your Web Analytics events with the feature flags you emitted. Learn how to [integrate with Web Analytics](https://vercel.com/docs/feature-flags/integrate-with-web-analytics).

6. ### [Review](https://vercel.com/docs/feature-flags/flags-explorer/getting-started\#review)
...
## [More resources](https://vercel.com/docs/feature-flags/flags-explorer/getting-started\#more-resources)

- [Flags Explorer Reference](https://vercel.com/docs/feature-flags/flags-explorer/reference)
- [Flags SDK](https://vercel.com/docs/feature-flags/feature-flags-pattern)
- [Feature Flags using Next.js example](https://vercel.com/templates/next.js/shirt-shop-feature-flags)
...
- [Prerequisites](https://vercel.com/docs/feature-flags/flags-explorer/getting-started#prerequisites)
- [Quickstart](https://vercel.com/docs/feature-flags/flags-explorer/getting-started#quickstart)
- [Add the Flags SDK to your project](https://vercel.com/docs/feature-flags/flags-explorer/getting-started#add-the-flags-sdk-to-your-project)
- [Adding a FLAGS\_SECRET](https://vercel.com/docs/feature-flags/flags-explorer/getting-started#adding-a-flags_secret)
- [Creating the Flags Discovery Endpoint](https://vercel.com/docs/feature-flags/flags-explorer/getting-started#creating-the-flags-discovery-endpoint)
- [Handling overrides](https://vercel.com/docs/feature-flags/flags-explorer/getting-started#handling-overrides)
- [Emitting flag values (optional)](https://vercel.com/docs/feature-flags/flags-explorer/getting-started#emitting-flag-values-optional)
- [Review](https://vercel.com/docs/feature-flags/flags-explorer/getting-started#review)
- [More resources](https://vercel.com/docs/feature-flags/flags-explorer/getting-started#more-resources)
