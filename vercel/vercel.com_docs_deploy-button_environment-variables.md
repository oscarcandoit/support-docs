---
url: "https://vercel.com/docs/deploy-button/environment-variables"
...
## [Required environment variables](https://vercel.com/docs/deploy-button/environment-variables\#required-environment-variables)
...
You cannot pass environment variable values using this parameter because the
URL is saved in the browser history, making it insecure.

## [Environment variables default values](https://vercel.com/docs/deploy-button/environment-variables\#environment-variables-default-values)
...
Never use default values for sensitive data like passwords, API keys, tokens,
...
Default values only apply if the environment variable is listed in the `env`
parameter. Users can still modify or clear these values before deploying.

## [Environment variables description](https://vercel.com/docs/deploy-button/environment-variables\#environment-variables-description)
...
The description provided through this parameter only shows if required
...
## [Environment variables link](https://vercel.com/docs/deploy-button/environment-variables\#environment-variables-link)
...
The link provided through this parameter only shows if required environment
variables are set.
