---
url: "https://vercel.com/docs/rbac/access-roles/team-level-roles"
...
While the [Enterprise](https://vercel.com/docs/plans/enterprise) plan supports all the below
roles, the [Pro](https://vercel.com/docs/plans/pro) plan only supports
[Owner](https://vercel.com/docs/rbac/access-roles#owner-role),
[Member](https://vercel.com/docs/rbac/access-roles#owner-role), and
...
| Resource | Owner | Member | Developer | Viewer | Billing | Security |
| --- | --- | --- | --- | --- | --- | --- |
| Activity Log Event |  |  |  |  |  |  |
| Alerts |  |  |  |  |  |  |
| Alias |  |  |  |  |  |  |
