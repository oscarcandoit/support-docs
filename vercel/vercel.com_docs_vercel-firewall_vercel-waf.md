...
The Vercel WAF, part of the [Firewall](https://vercel.com/docs/vercel-firewall), provides security controls to [monitor](https://vercel.com/docs/vercel-firewall/firewall-observability#traffic) and [control](https://vercel.com/docs/vercel-firewall/firewall-observability#traffic) the internet traffic to your site through logging, blocking and challenging. When you apply a configuration change to the firewall, it takes effect globally within 300ms and can be instantly [rolled back](https://vercel.com/docs/vercel-firewall/vercel-waf#instant-rollback) to prior configurations.

- [Configure your first Custom Rule](https://vercel.com/docs/security/vercel-waf/custom-rules)
- [Add IP Blocks](https://vercel.com/docs/security/vercel-waf/ip-blocking)
- [Explore Managed Rulesets](https://vercel.com/docs/security/vercel-waf/managed-rulesets)

## [Traffic control](https://vercel.com/docs/vercel-firewall/vercel-waf\#traffic-control)
...
## [Instant rollback](https://vercel.com/docs/vercel-firewall/vercel-waf\#instant-rollback)
...
## [Limits](https://vercel.com/docs/vercel-firewall/vercel-waf\#limits)

Depending on your plan, there are limits for each Vercel WAF feature.

| Feature | Hobby | Pro | Enterprise |
| --- | --- | --- | --- |
| [Project level IP Blocking](https://vercel.com/docs/security/vercel-waf/ip-blocking#project-level-ip-blocking) | Up to 10 | Up to 100 | Custom |
| [Account-level IP Blocking](https://vercel.com/docs/security/vercel-waf/ip-blocking#account-level-ip-blocking) | N/A | N/A | Custom |
| [Custom Rules](https://vercel.com/docs/security/vercel-waf/custom-rules) | Up to 3 | Up to 40 | Up to 1000 |
| [Custom Rule Parameters](https://vercel.com/docs/security/vercel-waf/rule-configuration#parameters) | All | All | All |
| [Managed Rulesets](https://vercel.com/docs/security/vercel-waf/managed-rulesets) | N/A | N/A | Contact sales |
