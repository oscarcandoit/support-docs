...
## [Team configuration](https://vercel.com/docs/deployments/troubleshoot-project-collaboration\#team-configuration)

### [Hobby teams](https://vercel.com/docs/deployments/troubleshoot-project-collaboration\#hobby-teams)

The [Hobby Plan](https://vercel.com/docs/plans/hobby) does not support collaboration for private repositories. If you need collaboration, upgrade to the [Pro Plan](https://vercel.com/docs/plans/pro).
...
2. Link your git provider to your Vercel account in [Account Settings](https://vercel.com/docs/accounts#sign-up-with-a-git-provider)

If your account is not connected to your git provider, make sure you've properly configured your [Vercel email address](https://vercel.com/docs/accounts#managing-emails) so that it matches the email associated with the commit.

For the most reliable experience, ensure both your project and account are properly connected to your git provider.

For more information, see [Using Hobby teams](https://vercel.com/docs/git#using-hobby-teams)

### [Pro teams](https://vercel.com/docs/deployments/troubleshoot-project-collaboration\#pro-teams)

The [Pro Plan](https://vercel.com/docs/plans/pro) allows for collaboration through team membership. Each person committing to your codebase should be added as a team member.
...
1. Each person committing code can be [added as a team member](https://vercel.com/docs/rbac/managing-team-members).
2. Make sure the commit author is a confirmed [member of your team](https://vercel.com/docs/accounts#team-membership).
3. Team members should link their git provider to their Vercel account in [Account Settings](https://vercel.com/docs/accounts#sign-up-with-a-git-provider)

For more information, see [Using Pro teams](https://vercel.com/docs/git#using-pro-teams)

### [Bot access](https://vercel.com/docs/deployments/troubleshoot-project-collaboration\#bot-access)

Ensure your bots are properly configured and that their commits are clearly identified as automated.

## [Account configuration](https://vercel.com/docs/deployments/troubleshoot-project-collaboration\#account-configuration)

### [Connecting Git provider accounts](https://vercel.com/docs/deployments/troubleshoot-project-collaboration\#connecting-git-provider-accounts)
...
2. Navigate to the [Login Connections](https://vercel.com/docs/accounts#login-methods-and-connections) section
3. Connect your GitHub, GitLab, or Bitbucket account

### [Managing multiple email addresses](https://vercel.com/docs/deployments/troubleshoot-project-collaboration\#managing-multiple-email-addresses)
