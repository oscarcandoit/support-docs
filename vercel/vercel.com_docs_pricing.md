...
## [Managed Infrastructure](https://vercel.com/docs/pricing\#managed-infrastructure)
...
Each product's usage breaks down into resources, with each one billed based on the usage of a specific metric. For example, [Function Duration](https://vercel.com/docs/functions/configuring-functions/duration) generates bills based on the total execution time of a Vercel Function.

### [Managed Infrastructure billable resources](https://vercel.com/docs/pricing\#managed-infrastructure-billable-resources)
...
- [Edge Config](https://vercel.com/docs/edge-config/edge-config-limits)
- [Web Analytics](https://vercel.com/docs/analytics/limits-and-pricing)
- [Speed Insights](https://vercel.com/docs/speed-insights/limits-and-pricing)
- [Drains](https://vercel.com/docs/drains#usage-and-pricing)
- [Monitoring](https://vercel.com/docs/monitoring/limits-and-pricing)
- [Observability](https://vercel.com/docs/observability/limits-and-pricing)
- [Blob](https://vercel.com/docs/vercel-blob/usage-and-pricing)
- [Microfrontends](https://vercel.com/docs/microfrontends#limits-and-pricing)
- [Bulk redirects](https://vercel.com/docs/redirects/bulk-redirects#limits-and-pricing)

For [Enterprise](https://vercel.com/docs/plans/enterprise) pricing, contact our [sales team](https://vercel.com/contact/sales).

#### [Pro plan add-ons](https://vercel.com/docs/pricing\#pro-plan-add-ons)

To enable any of the Pro plan add-ons:

1. Visit the Vercel [dashboard](https://vercel.com/dashboard) and select your team from the [scope selector](https://vercel.com/docs/dashboard-features#scope-selector).
...
See the [regional pricing](https://vercel.com/docs/pricing/regional-pricing) page for more information on Managed Infrastructure pricing in different regions.

## [Developer Experience Platform](https://vercel.com/docs/pricing\#developer-experience-platform)
...
### [DX Platform billable resources](https://vercel.com/docs/pricing\#dx-platform-billable-resources)
...
| --- | --- | --- |
| [Team seats](https://vercel.com/docs/plans/pro#team-seats) | N/A | $20 / month per additional paid seat |
| [Preview Deployment Suffix](https://vercel.com/docs/deployments/generated-urls#preview-deployment-suffix)<br>Pro add-on | N/A | $100 / month |
| [SAML Single Sign-On](https://vercel.com/docs/saml)<br>Pro add-on | N/A | $300 / month |
| [HIPAA BAA](https://vercel.com/docs/security/compliance#hipaa)<br>Pro add-on | N/A | $350 / month |
| [Flags Explorer](https://vercel.com/docs/feature-flags/flags-explorer)<br>Pro add-on | N/A | $250 / month |
| [Observability Plus](https://vercel.com/docs/observability/observability-plus)<br>Pro add-on | N/A | $10 / month |
| [Web Analytics Plus](https://vercel.com/docs/analytics/limits-and-pricing#pro-with-web-analytics-plus)<br>Pro add-on | N/A | $10 / month |
| [Speed Insights](https://vercel.com/docs/speed-insights)<br>Pro add-on | N/A | $10 / month per project |

DX Platform pricing

To learn more about DX Platform on the Pro plan, and how to understand your invoices, see [understanding my invoice.](https://vercel.com/docs/plans/pro)
...
## [More resources](https://vercel.com/docs/pricing\#more-resources)
...
- [Improved infrastructure pricing](https://vercel.com/blog/improved-infrastructure-pricing)
- [Regional pricing](https://vercel.com/docs/pricing/regional-pricing)
