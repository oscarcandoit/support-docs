...
## [Getting started](https://vercel.com/docs/integrations/cms/dato-cms\#getting-started)

To get started with DatoCMS on Vercel, follow the steps below to install the integration:

1. ### [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/dato-cms\#install-the-vercel-cli)



To pull in environment variables from DatoCMS to your Vercel project, you need to install the [Vercel CLI](https://vercel.com/docs/cli). Run the following command in your terminal:
...
2. ### [Install your CMS integration](https://vercel.com/docs/integrations/cms/dato-cms\#install-your-cms-integration)



Navigate to the [DatoCMS integration](https://vercel.com/integrations/datocms) and follow the steps to install the integration.

3. ### [Pull in environment variables](https://vercel.com/docs/integrations/cms/dato-cms\#pull-in-environment-variables)
...
### [Content Link](https://vercel.com/docs/integrations/cms/dato-cms\#content-link)
...
- [Getting started](https://vercel.com/docs/integrations/cms/dato-cms#getting-started)
- [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/dato-cms#install-the-vercel-cli)
- [Install your CMS integration](https://vercel.com/docs/integrations/cms/dato-cms#install-your-cms-integration)
- [Pull in environment variables](https://vercel.com/docs/integrations/cms/dato-cms#pull-in-environment-variables)
- [Content Link](https://vercel.com/docs/integrations/cms/dato-cms#content-link)
