...
## [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse\#getting-started)

1. ### [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse\#create-a-new-project)
...
2. ### [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse\#install-dependencies)
...
3. ### [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse\#configure-environment-variables)
...
4. ### [Create your LangFuse application](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse\#create-your-langfuse-application)
...
5. ### [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse\#running-the-application)
...
- [Getting started](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse#getting-started)
- [Create a new project](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse#create-a-new-project)
- [Install dependencies](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse#install-dependencies)
- [Configure environment variables](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse#configure-environment-variables)
- [Create your LangFuse application](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse#create-your-langfuse-application)
- [Running the application](https://vercel.com/docs/ai-gateway/framework-integrations/langfuse#running-the-application)
