...
## [Understanding Vercel resources](https://vercel.com/docs/pricing/how-does-vercel-calculate-usage-of-resources\#understanding-vercel-resources)
...
The site also uses [Middleware](https://vercel.com/docs/routing-middleware) to A/B test a product carousel, showing different variants to different users based on their behavior or demographics.

The following sections outline the resources used at each stage of the user journey.

### [1\. User enters the site](https://vercel.com/docs/pricing/how-does-vercel-calculate-usage-of-resources\#1.-user-enters-the-site)

![1. User enters your site](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Fenters-site-light.png&w=3840&q=75)![1. User enters your site](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Fenters-site-dark.png&w=3840&q=75)1\. User enters your site

The browser requests the page from Vercel. Since it's static and cached on our global [CDN](https://vercel.com/docs/cdn), this only involves [Edge Requests](https://vercel.com/docs/manage-cdn-usage#edge-requests) (the network requests required to get the content of the page) and [Fast Data Transfer](https://vercel.com/docs/manage-cdn-usage#fast-data-transfer) (the amount of content sent back to the browser).
...
### [2\. Product browsing](https://vercel.com/docs/pricing/how-does-vercel-calculate-usage-of-resources\#2.-product-browsing)
...
### [3\. Viewing updated product details](https://vercel.com/docs/pricing/how-does-vercel-calculate-usage-of-resources\#3.-viewing-updated-product-details)

![3. User browses updated products](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Fupdated-product-light.png&w=3840&q=75)![3. User browses updated products](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Fupdated-product-dark.png&w=3840&q=75)3\. User browses updated products
...
Behind the scenes the site uses [Incremental Static Regeneration (ISR)](https://vercel.com/docs/incremental-static-regeneration) to update the products description and image. The new information for the product is then cached on Vercel's [CDN](https://vercel.com/docs/cdn) for future requests, and the revalidation period is reset.
...
### [4\. Dynamic interactions (Cart)](https://vercel.com/docs/pricing/how-does-vercel-calculate-usage-of-resources\#4.-dynamic-interactions-cart)

![4. User interacts with dynamic cart](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Fdynamic-cart-light.png&w=3840&q=75)![4. User interacts with dynamic cart](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Fdynamic-cart-dark.png&w=3840&q=75)4\. User interacts with dynamic cart
...
### [5\. Engaging with A/B testing for personalized content](https://vercel.com/docs/pricing/how-does-vercel-calculate-usage-of-resources\#5.-engaging-with-a/b-testing-for-personalized-content)

![5. User is shown a variant of the site based on their behavior or demographics](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Fa-b-test-light.png&w=3840&q=75)![5. User is shown a variant of the site based on their behavior or demographics](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fpricing%2Fa-b-test-dark.png&w=3840&q=75)5\. User is shown a variant of the site based on their behavior or demographics

Having added an item to the cart, the user decides to continue browsing the site. They scroll to the bottom of the page and are shown a product carousel. This carousel is part of an A/B test using [Middleware](https://vercel.com/docs/routing-middleware), and the user is shown a variant based on their behavior or demographics.
...
## [Summary and next steps](https://vercel.com/docs/pricing/how-does-vercel-calculate-usage-of-resources\#summary-and-next-steps)
...
Schedule a call to learn more about Enterprise on Vercel.

Schedule Call

## [More resources](https://vercel.com/docs/pricing/how-does-vercel-calculate-usage-of-resources\#more-resources)

For more information on Vercel's pricing, guidance on optimizing consumption, and invoices, see the following resources:

- [Learn about Vercel's pricing model and how it works](https://vercel.com/docs/pricing)
- [Learn how Vercel usage is calculated and how it accrues](https://vercel.com/docs/pricing/manage-and-optimize-usage)
- [Learn how to understand your Vercel invoice](https://vercel.com/docs/pricing/understanding-my-invoice)
