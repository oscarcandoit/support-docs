...
## [Troubleshoot](https://vercel.com/docs/errors/DEPLOYMENT_BLOCKED\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/DEPLOYMENT\_BLOCKED to understand what's happening.
...
2. Check your account plan: If you have recently downgraded to the [Hobby plan](https://vercel.com/docs/plans/hobby), you may need to redeploy your projects to make them available once again
...
4. Verify account status: Ensure your account is in good standing and hasn't exceeded any [limits or quotas](https://vercel.com/docs/limits)
5. Review policies: Ensure that your deployment complies with all platform [policies](https://vercel.com/legal/privacy-policy) and isn't in violation of any [terms](https://vercel.com/legal/terms)
