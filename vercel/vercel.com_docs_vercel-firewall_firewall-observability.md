---
url: "https://vercel.com/docs/vercel-firewall/firewall-observability"
...
The project Firewall page of your Vercel dashboard provides a consolidated view of traffic and event analysis across Vercel's [platform-wide firewall](https://vercel.com/docs/vercel-firewall#platform-wide-firewall) (including DDoS mitigations), Web Application Firewall, and Bot Management.

## [Overview](https://vercel.com/docs/vercel-firewall/firewall-observability\#overview)
...
## [Traffic](https://vercel.com/docs/vercel-firewall/firewall-observability\#traffic)
...
- JA4 (TLS Fingerprints): Identify clients by their [JA4](https://vercel.com/docs/vercel-firewall/firewall-concepts#ja4) TLS fingerprints
- Country: Geographic distribution of traffic by country

![Incoming web traffic view with popular filter breakdowns](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fvercel-waf-traffic-tab-light.png&w=3840&q=75)![Incoming web traffic view with popular filter breakdowns](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fsecurity%2Fvercel-waf-traffic-tab-dark.png&w=3840&q=75)Incoming web traffic view with popular filter breakdowns

## [Firewall Alerts](https://vercel.com/docs/vercel-firewall/firewall-observability\#firewall-alerts)

Firewall Alertsare availableon [all plans](https://vercel.com/docs/plans)

### [How alerts work](https://vercel.com/docs/vercel-firewall/firewall-observability\#how-alerts-work)
...
### [DDoS attack alerts](https://vercel.com/docs/vercel-firewall/firewall-observability\#ddos-attack-alerts)
