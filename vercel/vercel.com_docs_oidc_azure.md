---
url: "https://vercel.com/docs/oidc/azure"
...
Secure backend access with OIDC federationis availableon [all plans](https://vercel.com/docs/plans)
...
## [Configure your Azure account](https://vercel.com/docs/oidc/azure\#configure-your-azure-account)

1. ### [Create a Managed Identity](https://vercel.com/docs/oidc/azure\#create-a-managed-identity)
...
2. ### [Create a Federated Credential](https://vercel.com/docs/oidc/azure\#create-a-federated-credential)
...
Azure does not allow for partial claim conditions so you must specify the
...
3. ### [Grant access to the Azure service](https://vercel.com/docs/oidc/azure\#grant-access-to-the-azure-service)
...
## [Example](https://vercel.com/docs/oidc/azure\#example)

In the following example, you create a [Vercel function](https://vercel.com/docs/functions/quickstart#create-a-vercel-function) in a Vercel project where you have [defined Azure account environment variables](https://vercel.com/docs/environment-variables#creating-environment-variables). The function will connect to Azure using OIDC and use a specific resource that you have allowed the Managed Identity to access.

### [Query an Azure CosmosDB instance](https://vercel.com/docs/oidc/azure\#query-an-azure-cosmosdb-instance)
...
- [Configure your Azure account](https://vercel.com/docs/oidc/azure#configure-your-azure-account)
- [Create a Managed Identity](https://vercel.com/docs/oidc/azure#create-a-managed-identity)
- [Create a Federated Credential](https://vercel.com/docs/oidc/azure#create-a-federated-credential)
- [Grant access to the Azure service](https://vercel.com/docs/oidc/azure#grant-access-to-the-azure-service)
- [Example](https://vercel.com/docs/oidc/azure#example)
- [Query an Azure CosmosDB instance](https://vercel.com/docs/oidc/azure#query-an-azure-cosmosdb-instance)
