---
url: "https://vercel.com/docs/conformance/rules/NEXTJS_USE_NEXT_IMAGE"
...
provider (see [below](https://vercel.com/docs/conformance/rules/NEXTJS_USE_NEXT_IMAGE#important-note-on-costs) for more information)

By default, this rule is disabled. Enable it by
[customizing Conformance](https://vercel.com/docs/conformance/customize).
...
## [Important note on costs](https://vercel.com/docs/conformance/rules/NEXTJS_USE_NEXT_IMAGE\#important-note-on-costs)
...
## [Important note on self-hosting](https://vercel.com/docs/conformance/rules/NEXTJS_USE_NEXT_IMAGE\#important-note-on-self-hosting)
...
## [Examples](https://vercel.com/docs/conformance/rules/NEXTJS_USE_NEXT_IMAGE\#examples)
...
## [How to fix](https://vercel.com/docs/conformance/rules/NEXTJS_USE_NEXT_IMAGE\#how-to-fix)
