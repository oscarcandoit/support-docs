...
## [Creating a Deploy Hook](https://vercel.com/docs/deploy-hooks\#creating-a-deploy-hook)
...
![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fgit%2Fdeploy-hooks-light.png&w=1920&q=75)![](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fgit%2Fdeploy-hooks-dark.png&w=1920&q=75)
...
## [Triggering a Deploy Hook](https://vercel.com/docs/deploy-hooks\#triggering-a-deploy-hook)

To trigger a Deploy Hook, send a GET or POST request to the provided URL.

Deploy Hooks will not be triggered if you have the `github.enabled = false` [configuration](https://vercel.com/docs/project-configuration/git-configuration#github.enabled)
present in your `vercel.json` file.

Here's an example request and response you can use for testing:

#### [Example Request](https://vercel.com/docs/deploy-hooks\#example-request)
...
#### [Example Response](https://vercel.com/docs/deploy-hooks\#example-response)
...
You do not need to add an authorization header. See [Security](https://vercel.com/docs/deploy-hooks#security) to
learn more.
...
## [Security](https://vercel.com/docs/deploy-hooks\#security)
...
## [Build Cache](https://vercel.com/docs/deploy-hooks\#build-cache)

Builds triggered by a Deploy Hook are automatically provided with
an appropriate [Build Cache](https://vercel.com/docs/deployments/troubleshoot-a-build#what-is-cached) by default, if it exists.

Caching helps speed up the [Build Step](https://vercel.com/docs/deployments/configure-a-build), so we encourage you to keep the default behavior.
...
## [Other Optimizations](https://vercel.com/docs/deploy-hooks\#other-optimizations)
...
## [Limits](https://vercel.com/docs/deploy-hooks\#limits)
...
## [Troubleshooting](https://vercel.com/docs/deploy-hooks\#troubleshooting)

If your deploy hook fails to create a deployment, check the status check on the commit associated with the deploy hook to identify any failures. See [Troubleshooting project collaboration](https://vercel.com/docs/deployments/troubleshoot-project-collaboration) for more information.
