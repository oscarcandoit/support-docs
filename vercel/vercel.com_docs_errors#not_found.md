...
## [Application errors](https://vercel.com/docs/errors\#application-errors)

- [**BODY\_NOT\_A\_STRING\_FROM\_FUNCTION** \\
\\
Function\\
\\
502](https://vercel.com/docs/errors/BODY_NOT_A_STRING_FROM_FUNCTION)
- [**DEPLOYMENT\_BLOCKED** \\
\\
Deployment\\
\\
403](https://vercel.com/docs/errors/DEPLOYMENT_BLOCKED)
- [**DEPLOYMENT\_DELETED** \\
\\
Deployment\\
\\
410](https://vercel.com/docs/errors/DEPLOYMENT_DELETED)
- [**DEPLOYMENT\_DISABLED** \\
\\
Deployment\\
\\
402](https://vercel.com/docs/errors/DEPLOYMENT_DISABLED)
- [**DEPLOYMENT\_NOT\_FOUND** \\
\\
Deployment\\
\\
404](https://vercel.com/docs/errors/DEPLOYMENT_NOT_FOUND)
- [**DEPLOYMENT\_NOT\_READY\_REDIRECTING** \\
\\
Deployment\\
\\
303](https://vercel.com/docs/errors/DEPLOYMENT_NOT_READY_REDIRECTING)
- [**DEPLOYMENT\_PAUSED** \\
\\
Deployment\\
\\
503](https://vercel.com/docs/errors/DEPLOYMENT_PAUSED)
- [**DNS\_HOSTNAME\_EMPTY** \\
\\
DNS\\
\\
502](https://vercel.com/docs/errors/DNS_HOSTNAME_EMPTY)
- [**DNS\_HOSTNAME\_NOT\_FOUND** \\
\\
DNS\\
\\
502](https://vercel.com/docs/errors/DNS_HOSTNAME_NOT_FOUND)
- [**DNS\_HOSTNAME\_RESOLVE\_FAILED** \\
\\
DNS\\
\\
502](https://vercel.com/docs/errors/DNS_HOSTNAME_RESOLVE_FAILED)
- [**DNS\_HOSTNAME\_RESOLVED\_PRIVATE** \\
\\
DNS\\
\\
404](https://vercel.com/docs/errors/DNS_HOSTNAME_RESOLVED_PRIVATE)
- [**DNS\_HOSTNAME\_SERVER\_ERROR** \\
\\
DNS\\
\\
502](https://vercel.com/docs/errors/DNS_HOSTNAME_SERVER_ERROR)
- [**EDGE\_FUNCTION\_INVOCATION\_FAILED** \\
\\
Function\\
\\
500](https://vercel.com/docs/errors/EDGE_FUNCTION_INVOCATION_FAILED)
- [**EDGE\_FUNCTION\_INVOCATION\_TIMEOUT** \\
\\
Function\\
\\
504](https://vercel.com/docs/errors/EDGE_FUNCTION_INVOCATION_TIMEOUT)
- [**FALLBACK\_BODY\_TOO\_LARGE** \\
\\
Cache\\
\\
502](https://vercel.com/docs/errors/FALLBACK_BODY_TOO_LARGE)
- [**FUNCTION\_INVOCATION\_FAILED** \\
\\
Function\\
\\
500](https://vercel.com/docs/errors/FUNCTION_INVOCATION_FAILED)
- [**FUNCTION\_INVOCATION\_TIMEOUT** \\
\\
Function\\
\\
504](https://vercel.com/docs/errors/FUNCTION_INVOCATION_TIMEOUT)
- [**FUNCTION\_PAYLOAD\_TOO\_LARGE** \\
\\
Function\\
\\
413](https://vercel.com/docs/errors/FUNCTION_PAYLOAD_TOO_LARGE)
- [**FUNCTION\_RESPONSE\_PAYLOAD\_TOO\_LARGE** \\
\\
Function\\
\\
500](https://vercel.com/docs/errors/FUNCTION_RESPONSE_PAYLOAD_TOO_LARGE)
- [**FUNCTION\_THROTTLED** \\
\\
Function\\
\\
503](https://vercel.com/docs/errors/FUNCTION_THROTTLED)
- [**INFINITE\_LOOP\_DETECTED** \\
\\
Runtime\\
\\
508](https://vercel.com/docs/errors/INFINITE_LOOP_DETECTED)
- [**INVALID\_IMAGE\_OPTIMIZE\_REQUEST** \\
\\
Image\\
\\
400](https://vercel.com/docs/errors/INVALID_IMAGE_OPTIMIZE_REQUEST)
- [**INVALID\_REQUEST\_METHOD** \\
\\
Request\\
\\
405](https://vercel.com/docs/errors/INVALID_REQUEST_METHOD)
- [**MALFORMED\_REQUEST\_HEADER** \\
\\
Request\\
\\
400](https://vercel.com/docs/errors/MALFORMED_REQUEST_HEADER)
- [**MICROFRONTENDS\_MIDDLEWARE\_ERROR** \\
\\
Function\\
\\
500](https://vercel.com/docs/errors/MICROFRONTENDS_MIDDLEWARE_ERROR)
- [**MICROFRONTENDS\_MISSING\_FALLBACK\_ERROR** \\
\\
Function\\
\\
400](https://vercel.com/docs/errors/MICROFRONTENDS_MISSING_FALLBACK_ERROR)
- [**MIDDLEWARE\_INVOCATION\_FAILED** \\
\\
Function\\
\\
500](https://vercel.com/docs/errors/MIDDLEWARE_INVOCATION_FAILED)
- [**MIDDLEWARE\_INVOCATION\_TIMEOUT** \\
\\
Function\\
\\
504](https://vercel.com/docs/errors/MIDDLEWARE_INVOCATION_TIMEOUT)
- [**MIDDLEWARE\_RUNTIME\_DEPRECATED** \\
\\
Runtime\\
\\
503](https://vercel.com/docs/errors/MIDDLEWARE_RUNTIME_DEPRECATED)
- [**NO\_RESPONSE\_FROM\_FUNCTION** \\
\\
Function\\
\\
502](https://vercel.com/docs/errors/NO_RESPONSE_FROM_FUNCTION)
- [**NOT\_FOUND** \\
\\
Deployment\\
\\
404](https://vercel.com/docs/errors/NOT_FOUND)
- [**OPTIMIZED\_EXTERNAL\_IMAGE\_REQUEST\_FAILED** \\
\\
Image\\
\\
502](https://vercel.com/docs/errors/OPTIMIZED_EXTERNAL_IMAGE_REQUEST_FAILED)
- [**OPTIMIZED\_EXTERNAL\_IMAGE\_REQUEST\_INVALID** \\
\\
Image\\
\\
502](https://vercel.com/docs/errors/OPTIMIZED_EXTERNAL_IMAGE_REQUEST_INVALID)
- [**OPTIMIZED\_EXTERNAL\_IMAGE\_REQUEST\_UNAUTHORIZED** \\
\\
Image\\
\\
502](https://vercel.com/docs/errors/OPTIMIZED_EXTERNAL_IMAGE_REQUEST_UNAUTHORIZED)
- [**OPTIMIZED\_EXTERNAL\_IMAGE\_TOO\_MANY\_REDIRECTS** \\
\\
Image\\
\\
502](https://vercel.com/docs/errors/OPTIMIZED_EXTERNAL_IMAGE_TOO_MANY_REDIRECTS)
- [**RANGE\_END\_NOT\_VALID** \\
\\
Request\\
\\
416](https://vercel.com/docs/errors/RANGE_END_NOT_VALID)
- [**RANGE\_GROUP\_NOT\_VALID** \\
\\
Request\\
\\
416](https://vercel.com/docs/errors/RANGE_GROUP_NOT_VALID)
- [**RANGE\_MISSING\_UNIT** \\
\\
Request\\
\\
416](https://vercel.com/docs/errors/RANGE_MISSING_UNIT)
- [**RANGE\_START\_NOT\_VALID** \\
\\
Request\\
\\
416](https://vercel.com/docs/errors/RANGE_START_NOT_VALID)
- [**RANGE\_UNIT\_NOT\_SUPPORTED** \\
\\
Request\\
\\
416](https://vercel.com/docs/errors/RANGE_UNIT_NOT_SUPPORTED)
- [**REQUEST\_HEADER\_TOO\_LARGE** \\
\\
Request\\
\\
431](https://vercel.com/docs/errors/REQUEST_HEADER_TOO_LARGE)
- [**RESOURCE\_NOT\_FOUND** \\
\\
Request\\
\\
404](https://vercel.com/docs/errors/RESOURCE_NOT_FOUND)
- [**ROUTER\_CANNOT\_MATCH** \\
\\
Routing\\
\\
502](https://vercel.com/docs/errors/ROUTER_CANNOT_MATCH)
- [**ROUTER\_EXTERNAL\_TARGET\_CONNECTION\_ERROR** \\
\\
Routing\\
\\
502](https://vercel.com/docs/errors/ROUTER_EXTERNAL_TARGET_CONNECTION_ERROR)
- [**ROUTER\_EXTERNAL\_TARGET\_ERROR** \\
\\
Routing\\
\\
502](https://vercel.com/docs/errors/ROUTER_EXTERNAL_TARGET_ERROR)
- [**ROUTER\_EXTERNAL\_TARGET\_HANDSHAKE\_ERROR** \\
\\
Routing\\
\\
502](https://vercel.com/docs/errors/ROUTER_EXTERNAL_TARGET_HANDSHAKE_ERROR)
- [**ROUTER\_TOO\_MANY\_HAS\_SELECTIONS** \\
\\
Routing\\
\\
502](https://vercel.com/docs/errors/ROUTER_TOO_MANY_HAS_SELECTIONS)
- [**SANDBOX\_NOT\_FOUND** \\
\\
Sandbox\\
\\
404](https://vercel.com/docs/errors/SANDBOX_NOT_FOUND)
- [**SANDBOX\_NOT\_LISTENING** \\
\\
Sandbox\\
\\
502](https://vercel.com/docs/errors/SANDBOX_NOT_LISTENING)
- [**SANDBOX\_STOPPED** \\
\\
Sandbox\\
\\
410](https://vercel.com/docs/errors/SANDBOX_STOPPED)
- [**TOO\_MANY\_FILESYSTEM\_CHECKS** \\
\\
Routing\\
\\
502](https://vercel.com/docs/errors/TOO_MANY_FILESYSTEM_CHECKS)
- [**TOO\_MANY\_FORKS** \\
\\
Routing\\
\\
502](https://vercel.com/docs/errors/TOO_MANY_FORKS)
- [**TOO\_MANY\_RANGES** \\
\\
Request\\
\\
416](https://vercel.com/docs/errors/TOO_MANY_RANGES)
- [**URL\_TOO\_LONG** \\
\\
Request\\
\\
414](https://vercel.com/docs/errors/URL_TOO_LONG)

## [Platform errors](https://vercel.com/docs/errors\#platform-errors)

The following errors are related to the Vercel platform. If you encounter one of these errors, contact [Vercel support](https://vercel.com/help).

- [**FUNCTION\_THROTTLED** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/FUNCTION_THROTTLED)
- [**INTERNAL\_CACHE\_ERROR** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_CACHE_ERROR)
- [**INTERNAL\_CACHE\_KEY\_TOO\_LONG** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_CACHE_KEY_TOO_LONG)
- [**INTERNAL\_CACHE\_LOCK\_FULL** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_CACHE_LOCK_FULL)
- [**INTERNAL\_CACHE\_LOCK\_TIMEOUT** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_CACHE_LOCK_TIMEOUT)
- [**INTERNAL\_DEPLOYMENT\_FETCH\_FAILED** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_DEPLOYMENT_FETCH_FAILED)
- [**INTERNAL\_EDGE\_FUNCTION\_INVOCATION\_FAILED** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_EDGE_FUNCTION_INVOCATION_FAILED)
- [**INTERNAL\_EDGE\_FUNCTION\_INVOCATION\_TIMEOUT** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_EDGE_FUNCTION_INVOCATION_TIMEOUT)
- [**INTERNAL\_FUNCTION\_INVOCATION\_FAILED** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_FUNCTION_INVOCATION_FAILED)
- [**INTERNAL\_FUNCTION\_INVOCATION\_TIMEOUT** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_FUNCTION_INVOCATION_TIMEOUT)
- [**INTERNAL\_FUNCTION\_NOT\_FOUND** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_FUNCTION_NOT_FOUND)
- [**INTERNAL\_FUNCTION\_NOT\_READY** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_FUNCTION_NOT_READY)
...
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_MICROFRONTENDS_BUILD_ERROR)
- [**INTERNAL\_MICROFRONTENDS\_INVALID\_CONFIGURATION\_ERROR** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_MICROFRONTENDS_INVALID_CONFIGURATION_ERROR)
- [**INTERNAL\_MICROFRONTENDS\_UNEXPECTED\_ERROR** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_MICROFRONTENDS_UNEXPECTED_ERROR)
- [**INTERNAL\_MISSING\_RESPONSE\_FROM\_CACHE** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_MISSING_RESPONSE_FROM_CACHE)
- [**INTERNAL\_OPTIMIZED\_IMAGE\_REQUEST\_FAILED** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_OPTIMIZED_IMAGE_REQUEST_FAILED)
- [**INTERNAL\_ROUTER\_CANNOT\_PARSE\_PATH** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_ROUTER_CANNOT_PARSE_PATH)
- [**INTERNAL\_STATIC\_REQUEST\_FAILED** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_STATIC_REQUEST_FAILED)
- [**INTERNAL\_UNARCHIVE\_FAILED** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_UNARCHIVE_FAILED)
- [**INTERNAL\_UNEXPECTED\_ERROR** \\
\\
Internal\\
\\
500](https://vercel.com/docs/errors/INTERNAL_UNEXPECTED_ERROR)
