---
url: "https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference"
...
## [View an integration's permissions](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference\#view-an-integration's-permissions)
...
## [Permission Types](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference\#permission-types)
...
## [Confirming Permission Changes](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference\#confirming-permission-changes)

Integrations can request more permissions over time.
Individual users and team owners are [notified](https://vercel.com/docs/notifications#notification-details) by Vercel when an integration installation has pending permission changes. You'll also be alerted to any new permissions on the [dashboard](https://vercel.com/dashboard/marketplace). The permission request contains information on which permissions are changing and the reasoning behind the changes.
...
## [Manage project access](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference\#manage-project-access)
...
### [Disabled integrations](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference\#disabled-integrations)
...
If a disabled integration is not re-enabled, it will be automatically removed
