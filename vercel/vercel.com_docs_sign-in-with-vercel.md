...
For users to be able to use Sign in with Vercel in your application, they must
have a Vercel account.

To learn how to set up Sign in with Vercel, see the [getting started with Sign in with Vercel](https://vercel.com/docs/sign-in-with-vercel/getting-started) guide.

## [When to use Sign in with Vercel](https://vercel.com/docs/sign-in-with-vercel\#when-to-use-sign-in-with-vercel)
...
## [High level overview](https://vercel.com/docs/sign-in-with-vercel\#high-level-overview)
...
### [Scopes and permissions](https://vercel.com/docs/sign-in-with-vercel\#scopes-and-permissions)
...
## [More resources](https://vercel.com/docs/sign-in-with-vercel\#more-resources)

- [Getting started with Sign in with Vercel](https://vercel.com/docs/sign-in-with-vercel/getting-started)
- [Tokens](https://vercel.com/docs/sign-in-with-vercel/tokens)
- [Scopes and permissions](https://vercel.com/docs/sign-in-with-vercel/scopes-and-permissions)
- [Authorization Server API](https://vercel.com/docs/sign-in-with-vercel/authorization-server-api)
- [Manage Sign in with Vercel from the dashboard](https://vercel.com/docs/sign-in-with-vercel/manage-from-dashboard)
- [Consent page](https://vercel.com/docs/sign-in-with-vercel/consent-page)
- [Troubleshooting](https://vercel.com/docs/sign-in-with-vercel/troubleshooting)
