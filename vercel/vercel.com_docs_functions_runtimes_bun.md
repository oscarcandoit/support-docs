...
The Bun runtimeis availablein [Beta](https://vercel.com/docs/release-phases#beta)on [all plans](https://vercel.com/docs/plans)
...
## [Configuring the runtime](https://vercel.com/docs/functions/runtimes/bun\#configuring-the-runtime)
...
## [Framework-specific considerations](https://vercel.com/docs/functions/runtimes/bun\#framework-specific-considerations)

### [Next.js](https://vercel.com/docs/functions/runtimes/bun\#next.js)
...
### [Routing Middleware](https://vercel.com/docs/functions/runtimes/bun\#routing-middleware)
...
## [Feature support](https://vercel.com/docs/functions/runtimes/bun\#feature-support)
...
## [Supported APIs](https://vercel.com/docs/functions/runtimes/bun\#supported-apis)
...
## [Using TypeScript with Bun](https://vercel.com/docs/functions/runtimes/bun\#using-typescript-with-bun)
...
## [Performance considerations](https://vercel.com/docs/functions/runtimes/bun\#performance-considerations)
...
## [When to use Bun](https://vercel.com/docs/functions/runtimes/bun\#when-to-use-bun)
