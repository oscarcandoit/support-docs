...
## [Troubleshoot](https://vercel.com/docs/errors/FUNCTION_PAYLOAD_TOO_LARGE\#troubleshoot)

I'm encountering an error and reviewing the docs at /docs/errors/FUNCTION\_PAYLOAD\_TOO\_LARGE to understand what's happening.
...
3. Client-side uploads: For large file uploads, consider using client-side uploads directly to [Vercel Blob](https://vercel.com/docs/storage/vercel-blob#server-and-client-uploads), where the file is sent securely from the client to Vercel Blob without going through the server
