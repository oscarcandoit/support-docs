...
# Vercel Perplexity Integration  Connectable Account
...
[Perplexity API](https://perplexity.ai/) specializes in providing
...
## [Use cases](https://vercel.com/docs/ai/perplexity\#use-cases)
...
### [Available models](https://vercel.com/docs/ai/perplexity\#available-models)
...
## [Getting started](https://vercel.com/docs/ai/perplexity\#getting-started)
...
### [Prerequisites](https://vercel.com/docs/ai/perplexity\#prerequisites)
...
### [Add the provider to your project](https://vercel.com/docs/ai/perplexity\#add-the-provider-to-your-project)

#### [Using the dashboard](https://vercel.com/docs/ai/perplexity\#using-the-dashboard)

01. Navigate to the AI tab in your [Vercel dashboard](https://vercel.com/dashboard)
02. Select Perplexity API from the list of providers, and press Add
...
10. Connect your project using the code below:
    ...
    2import { perplexity } from '@ai-sdk/perplexity';
    ...
    9  // Extract the `messages` from the body of the request
    ...
    12  // Call the language model

    13  const result = streamText({

    14    model: perplexity('sonar-pro'),
...
## [More resources](https://vercel.com/docs/ai/perplexity\#more-resources)

[**Perplexity API Website** \\
\\
Learn more about Perplexity API by visiting their website.](https://perplexity.ai/) [**Perplexity API Pricing** \\
\\
Learn more about Perplexity API pricing.](https://docs.perplexity.ai/guides/pricing) [**Perplexity API Documentation** \\
\\
Visit the Perplexity API documentation.](https://docs.perplexity.ai/)
