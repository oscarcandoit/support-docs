---
url: "https://vercel.com/docs/vercel-firewall/vercel-waf/system-bypass-rules"
...
WAF System Bypass Rulesare availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
Rules](https://vercel.com/docs/vercel-waf/custom-rules), use another [custom rule with a bypass\\
action](https://vercel.com/docs/vercel-firewall/vercel-waf/managed-rulesets#bypassing-custom-rules).

## [Get started](https://vercel.com/docs/vercel-firewall/vercel-waf/system-bypass-rules\#get-started)
...
## [Limits](https://vercel.com/docs/vercel-firewall/vercel-waf/system-bypass-rules\#limits)

System Bypass Rules have limits based on your [account plan](https://vercel.com/docs/plans).

| Resource | [Hobby](https://vercel.com/docs/plans/hobby) | [Pro](https://vercel.com/docs/plans/pro) | [Enterprise](https://vercel.com/docs/plans/enterprise) |
| --- | --- | --- | --- |
