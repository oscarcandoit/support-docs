...
You can use this command to view either a deployment's information or its [build logs](https://vercel.com/docs/cli/inspect#logs).
...
Using the `vercel inspect` command with the`--logs` and `--wait` options,
