---
url: "https://vercel.com/docs/deploy-button/build-settings"
...
Last updatedAugust 8, 2025

## [Build Command](https://vercel.com/docs/deploy-button/build-settings\#build-command)
...
## [Install Command](https://vercel.com/docs/deploy-button/build-settings\#install-command)
...
| --- | --- | --- |
| `pnpm-lock.yaml` | `pnpm install` | `pnpm 6/7/8/9/10` See [supported package managers](https://vercel.com/docs/package-managers#supported-package-managers) for pnpm detection details |
...
## [Development Command](https://vercel.com/docs/deploy-button/build-settings\#development-command)
...
## [Ignored Build Command](https://vercel.com/docs/deploy-button/build-settings\#ignored-build-command)
...
## [Root Directory](https://vercel.com/docs/deploy-button/build-settings\#root-directory)
...
## [Output Directory](https://vercel.com/docs/deploy-button/build-settings\#output-directory)
