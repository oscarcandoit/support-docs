...
Queryis availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
## [Getting started](https://vercel.com/docs/query\#getting-started)
...
### [Enable Observability Plus](https://vercel.com/docs/query\#enable-observability-plus)

Enabling and disabling Observability Plusare availableon[Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
### [Create a new query](https://vercel.com/docs/query\#create-a-new-query)

1. ### [Access the Observability dashboard](https://vercel.com/docs/query\#access-the-observability-dashboard)



   - At the Team level: Go to the [Vercel dashboard](https://vercel.com/dashboard) and click the Observability tab
   - At the Project level: Go to the [Vercel dashboard](https://vercel.com/dashboard), select the project you would like to monitor from the scope selector, and click the Observability tab
2. ### [Initiate a new query](https://vercel.com/docs/query\#initiate-a-new-query)
...
3. ### [Define query parameters](https://vercel.com/docs/query\#define-query-parameters)
...
4. ### [Visualize Query](https://vercel.com/docs/query\#visualize-query)
...
5. ### [Save and Share Query](https://vercel.com/docs/query\#save-and-share-query)
...
## [Using Query](https://vercel.com/docs/query\#using-query)
...
- You can [save your queries](https://vercel.com/docs/query#save-and-share-query) in [notebooks](https://vercel.com/docs/notebooks) either for personal use or to share with your team.
- In the dashboard, you can [create a new query](https://vercel.com/docs/query#create-a-new-query) using the query [form fields](https://vercel.com/docs/query/reference#group-by-and-where-fields) or the AI assistant at top of the new query form.

## [Manage IP Address visibility for Query](https://vercel.com/docs/query\#manage-ip-address-visibility-for-query)
...
## [More resources](https://vercel.com/docs/query\#more-resources)

- Learn about available metrics and aggregations and how you can group and filter the data in [Query Reference](https://vercel.com/docs/observability/query/query-reference).
...
- [Enable Observability Plus](https://vercel.com/docs/query#enable-observability-plus)
- [Create a new query](https://vercel.com/docs/query#create-a-new-query)
- [Access the Observability dashboard](https://vercel.com/docs/query#access-the-observability-dashboard)
- [Initiate a new query](https://vercel.com/docs/query#initiate-a-new-query)
- [Define query parameters](https://vercel.com/docs/query#define-query-parameters)
- [Visualize Query](https://vercel.com/docs/query#visualize-query)
- [Save and Share Query](https://vercel.com/docs/query#save-and-share-query)
- [Using Query](https://vercel.com/docs/query#using-query)
- [Manage IP Address visibility for Query](https://vercel.com/docs/query#manage-ip-address-visibility-for-query)
- [More resources](https://vercel.com/docs/query#more-resources)
