...
| Vercel Function maximum duration | 10s (default) - [configurable up to 60s (1 minute)](https://vercel.com/docs/functions/limitations#max-duration) | 15s (default) - [configurable up to 300s (5 minutes)](https://vercel.com/docs/functions/configuring-functions/duration) |
