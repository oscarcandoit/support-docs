...
Data Cacheis availablein [Beta](https://vercel.com/docs/release-phases#beta)on [all plans](https://vercel.com/docs/plans)

The Vercel Data Cache is a specialized, granular cache that was introduced with Next.js 13 for storing [segment-level data](https://nextjs.org/docs/app/building-your-application/data-fetching/fetching-caching-and-revalidating) while using [Next.js App Router](https://vercel.com/docs/frameworks/nextjs).
...
## [Features](https://vercel.com/docs/data-cache\#features)
...
## [Comparing with ISR and Vercel Cache](https://vercel.com/docs/data-cache\#comparing-with-isr-and-vercel-cache)

Next.js combines Vercel Data Cache with [Incremental Static Regeneration](https://vercel.com/docs/incremental-static-regeneration) (ISR) to provide an optimized caching infrastructure for your pages.
...
[Vercel's Cache](https://vercel.com/docs/edge-cache) is used for caching entire static assets at the edge, such as images, fonts, and JavaScript bundles. The Vercel Data Cache is used for caching data fetched during a function's execution, such as API responses.

## [Managing Data Cache](https://vercel.com/docs/data-cache\#managing-data-cache)
...
### [Observing your Data Cache usage](https://vercel.com/docs/data-cache\#observing-your-data-cache-usage)
...
### [Manually purging Data Cache](https://vercel.com/docs/data-cache\#manually-purging-data-cache)
...
## [Using Data Cache examples](https://vercel.com/docs/data-cache\#using-data-cache-examples)
...
### [Time-based revalidation](https://vercel.com/docs/data-cache\#time-based-revalidation)
...
[Open inOpen in v0](https://v0.app/chat?q=%20%20Create%20a%20minimal%20example%20app%20for%20this%20code:%20export%20default%20async%20function%20Page()%20{%20%20const%20res%20=%20await%20fetch(%27https://api.vercel.app/blog%27,%20{%20%20%20%20next:%20{%20%20%20%20%20%20revalidate:%203600,%20//%201%20hour%20%20%20%20},%20%20});%20%20const%20data%20=%20await%20res.json();%20%20%20return%20(%20%20%20%20%3Cmain%3E%20%20%20%20%20%20%3Cpre%3E{JSON.stringify(data,%20null,%202)}%3C/pre%3E%20%20%20%20%3C/main%3E%20%20);}%20In%20your%20response:%20%201.%20Keep%20the%20example%20simple%20and%20focused%20on%20demonstrating%20the%20core%20functionality%20of%20the%20code%20%202.%20DO%20NOT%20include%20unnecessary%20features%20or%20complexity,%20aim%20to%20only%20showcase%20the%20essential%20parts%20%203.%20Show%20the%20code%20in%20a%20way%20that%20is%20easy%20to%20understand%20and%20implement%20%204.%20Provide%20clear%20and%20concise%20explanations%20for%20each%20part%20of%20the%20code)

### [Tag-based revalidation](https://vercel.com/docs/data-cache\#tag-based-revalidation)
...
[Open inOpen in v0](https://v0.app/chat?q=%20%20Create%20a%20minimal%20example%20app%20for%20this%20code:%20export%20default%20async%20function%20Page()%20{%20%20const%20res%20=%20await%20fetch(%27https://api.vercel.app/blog%27,%20{%20%20%20%20next:%20{%20%20%20%20%20%20tags:%20[%27blog%27],%20//%20Invalidate%20with%20revalidateTag(%27blog%27)%20on-demand%20%20%20%20},%20%20});%20%20const%20data%20=%20await%20res.json();%20%20%20return%20%27...%27;}%20In%20your%20response:%20%201.%20Keep%20the%20example%20simple%20and%20focused%20on%20demonstrating%20the%20core%20functionality%20of%20the%20code%20%202.%20DO%20NOT%20include%20unnecessary%20features%20or%20complexity,%20aim%20to%20only%20showcase%20the%20essential%20parts%20%203.%20Show%20the%20code%20in%20a%20way%20that%20is%20easy%20to%20understand%20and%20implement%20%204.%20Provide%20clear%20and%20concise%20explanations%20for%20each%20part%20of%20the%20code)
...
[Open inOpen in v0](https://v0.app/chat?q=%20%20Create%20a%20minimal%20example%20app%20for%20this%20code:%20%27use%20server%27;%20import%20{%20revalidateTag%20}%20from%20%27next/cache%27;%20export%20default%20async%20function%20action()%20{%20%20revalidateTag(%27blog%27);}%20In%20your%20response:%20%201.%20Keep%20the%20example%20simple%20and%20focused%20on%20demonstrating%20the%20core%20functionality%20of%20the%20code%20%202.%20DO%20NOT%20include%20unnecessary%20features%20or%20complexity,%20aim%20to%20only%20showcase%20the%20essential%20parts%20%203.%20Show%20the%20code%20in%20a%20way%20that%20is%20easy%20to%20understand%20and%20implement%20%204.%20Provide%20clear%20and%20concise%20explanations%20for%20each%20part%20of%20the%20code)

## [Revalidation behavior](https://vercel.com/docs/data-cache\#revalidation-behavior)

The Vercel Data Cache infrastructure isolates cached data per Vercel project and [deployment environment](https://vercel.com/docs/deployments/environments) (`production` or `preview`).

Vercel persists cached data across deployments, unless you explicitly invalidate it using framework api's like `res.revalidate`, `revalidateTag` and `revalidatePath`, or by [manually purging Vercel Cache](https://vercel.com/docs/edge-cache#manually-purging-vercel-cache). It is not updated at build time. When invalidated, Vercel updates the data at run time, triggered by the next request to the invalidated path.
...
## [Limits](https://vercel.com/docs/data-cache\#limits)
...
## [More resources](https://vercel.com/docs/data-cache\#more-resources)

- [Explore Vercel regions](https://vercel.com/docs/regions)
- [Next.js App Router template](https://vercel.com/templates/next.js/app-directory)
- [Usage of Data Cache with ISR](https://vercel.com/docs/data-cache#comparing-with-isr-and-vercel-cache)
