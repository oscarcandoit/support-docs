...
Runtime Logs integrationis availablein [Beta](https://vercel.com/docs/release-phases#beta)on [all plans](https://vercel.com/docs/plans)

On your dashboard, the [Logs](https://vercel.com/docs/runtime-logs) tab displays your [runtime logs](https://vercel.com/docs/runtime-logs#what-are-runtime-logs). It can also display any feature flags your application evaluated while handling requests.
...
## [Limits](https://vercel.com/docs/feature-flags/integrate-with-runtime-logs\#limits)
