...
Shareable Linksare availableon [all plans](https://vercel.com/docs/plans)

Shareable links allow external users to securely access your deployments through a query string parameter.
Shareable links include the ability to leave [Comments](https://vercel.com/docs/comments) on deployments which have them enabled.

## [Who can create Shareable Links?](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links\#who-can-create-shareable-links)

- Non-Production Domains:
  - [Team members](https://vercel.com/docs/rbac/access-roles#team-level-roles) with at least the [Developer](https://vercel.com/docs/rbac/access-roles#developer-role) role
  - [Project members](https://vercel.com/docs/rbac/access-roles#project-level-roles) with at least the [Project Developer](https://vercel.com/docs/rbac/access-roles#project-developer) role
- Production Domains:
  - [Team members](https://vercel.com/docs/rbac/access-roles#team-level-roles) with at least the [Member](https://vercel.com/docs/rbac/access-roles#member-role) role
  - [Project members](https://vercel.com/docs/rbac/access-roles#project-level-roles) with the [Project Administrator](https://vercel.com/docs/rbac/access-roles#project-administrators) role

## [Creating Sharable Links](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links\#creating-sharable-links)
...
1. ### [Select your project](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links\#select-your-project)
...
2. ### [Select the deployment](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links\#select-the-deployment)



From the list of Preview Deployments, select the deployment you wish to share.

3. ### [Click Share button](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links\#click-share-button)
...
![The Share settings modal.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fshareable-links-light.png&w=1200&q=75)![The Share settings modal.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fdeployments%2Fsharable-links-dark.png&w=1200&q=75)The Share settings modal.
4. ### [Revoking a Sharable Link](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links\#revoking-a-sharable-link)
...
## [Managing Shareable Links](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links\#managing-shareable-links)
...
- [Who can create Shareable Links?](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links#who-can-create-shareable-links)
- [Creating Sharable Links](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links#creating-sharable-links)
- [Select your project](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links#select-your-project)
- [Select the deployment](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links#select-the-deployment)
- [Click Share button](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links#click-share-button)
- [Revoking a Sharable Link](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links#revoking-a-sharable-link)
- [Managing Shareable Links](https://vercel.com/docs/deployment-protection/methods-to-bypass-deployment-protection/sharable-links#managing-shareable-links)
