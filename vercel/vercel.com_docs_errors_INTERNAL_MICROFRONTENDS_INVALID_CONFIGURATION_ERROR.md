---
url: "https://vercel.com/docs/errors/INTERNAL_MICROFRONTENDS_INVALID_CONFIGURATION_ERROR"
...
## [Troubleshoot](https://vercel.com/docs/errors/INTERNAL_MICROFRONTENDS_INVALID_CONFIGURATION_ERROR\#troubleshoot)

To troubleshoot this error, follow these steps:

1. Ensure the config in your `microfrontends.json` file is valid, see the [documentation](https://vercel.com/docs/microfrontends/quickstart).
...
3. We have been notified of this error. For more information, check the [Vercel status page](https://www.vercel-status.com/) or [contact Vercel support](https://vercel.com/help#issues)
