...
1. ### [Navigate to the Domains tab](https://vercel.com/docs/domains/working-with-domains/remove-a-domain\#navigate-to-the-domains-tab)
...
2. ### [Click remove button](https://vercel.com/docs/domains/working-with-domains/remove-a-domain\#click-remove-button)
...
3. ### [Remove domain from your account](https://vercel.com/docs/domains/working-with-domains/remove-a-domain\#remove-domain-from-your-account)
...
![Option to delete domain(s) from the Domains tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fcustom-domains%2Fremove-domains.png&w=1920&q=75)![Option to delete domain(s) from the Domains tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fconcepts%2Fprojects%2Fcustom-domains%2Fremove-domains-dark.png&w=1920&q=75)Option to delete domain(s) from the Domains tab.



If the domain was purchased through Vercel, you must first wait for the domain
to expire before you can remove it from your account.


## [Using cURL](https://vercel.com/docs/domains/working-with-domains/remove-a-domain\#using-curl)

To remove a domain from a project using cURL, you can use the following command. To create an Authorization Bearer token, see the [access token](https://vercel.com/docs/rest-api/reference/welcome#creating-an-access-token) section of the API documentation.
...
- [Navigate to the Domains tab](https://vercel.com/docs/domains/working-with-domains/remove-a-domain#navigate-to-the-domains-tab)
- [Click remove button](https://vercel.com/docs/domains/working-with-domains/remove-a-domain#click-remove-button)
- [Remove domain from your account](https://vercel.com/docs/domains/working-with-domains/remove-a-domain#remove-domain-from-your-account)
- [Using cURL](https://vercel.com/docs/domains/working-with-domains/remove-a-domain#using-curl)
