...
## [Deploy a template monorepo](https://vercel.com/docs/monorepos\#deploy-a-template-monorepo)
...
## [Add a monorepo through the Vercel Dashboard](https://vercel.com/docs/monorepos\#add-a-monorepo-through-the-vercel-dashboard)

1. Go to the [Vercel Dashboard](https://vercel.com/dashboard) and ensure your team is selected from the [scope selector](https://vercel.com/docs/dashboard-features#scope-selector).
...
6. Repeat steps 2-5 to [import each directory](https://vercel.com/docs/git#deploying-a-git-repository) from your monorepo that you want to deploy.
...
## [Add a monorepo through Vercel CLI](https://vercel.com/docs/monorepos\#add-a-monorepo-through-vercel-cli)
...
See this [example](https://github.com/vercel-support/yarn-ws-monorepo) of a
monorepo with Yarn Workspaces.

## [When does a monorepo build occur?](https://vercel.com/docs/monorepos\#when-does-a-monorepo-build-occur)
...
- [Ignore the build step](https://vercel.com/docs/monorepos#ignoring-the-build-step) for projects whose files have not changed.
...
This setting does not occupy [concurrent build slots](https://vercel.com/docs/deployments/concurrent-builds), unlike the [Ignored Build Step](https://vercel.com/docs/project-configuration/git-settings#ignored-build-step) feature, reducing build queue times.

#### [Requirements](https://vercel.com/docs/monorepos\#requirements)
...
#### [Disable the skipping unaffected projects feature](https://vercel.com/docs/monorepos\#disable-the-skipping-unaffected-projects-feature)
...
### [Ignoring the build step](https://vercel.com/docs/monorepos\#ignoring-the-build-step)
...
script](https://vercel.com/kb/guide/how-do-i-use-the-ignored-build-step-field-on-vercel) when
...
## [How to link projects together in a monorepo](https://vercel.com/docs/monorepos\#how-to-link-projects-together-in-a-monorepo)
...
Traditionally, referencing one project from another requires manually setting URLs or environment variables for each deployment, in _every_ environment.
...
### [Getting started](https://vercel.com/docs/monorepos\#getting-started)

1. ### [Define Related Projects](https://vercel.com/docs/monorepos\#define-related-projects)
...
2. ### [Retrieve Related Project Information](https://vercel.com/docs/monorepos\#retrieve-related-project-information)
...
- [Requirements](https://vercel.com/docs/monorepos#requirements)
- [Getting started](https://vercel.com/docs/monorepos#getting-started)
- [Define Related Projects](https://vercel.com/docs/monorepos#define-related-projects)
- [Retrieve Related Project Information](https://vercel.com/docs/monorepos#retrieve-related-project-information)
